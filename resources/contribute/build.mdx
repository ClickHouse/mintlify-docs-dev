...
If you are not changing ClickHouse source code, you can install pre-built ClickHouse as described in [Quick Start](/get-started/setup/overview).
</Info>
...
First, see the generic [prerequisites documentation](/resources/contribute/developer-instruction).
