...
These instructions assume that the host machine is Linux x86_64/ARM and has all the tooling required to build natively based on the [build instructions](/resources/contribute/build). It also assumes that the host is Ubuntu 22.04 but the following instructions should also work on Ubuntu 20.04.
