...
Note. `python -m ci.praktika run` invocations run a specific continuous integration job, you can read more about ClickHouse CI [here](/resources/contribute/continuous-integration#running-stateless-tests).
...
Code style rules are described [here](/resources/contribute/style).
