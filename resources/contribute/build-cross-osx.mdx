...
If you want to build ClickHouse directly on macOS, proceed with the [native build instructions](/resources/contribute/build-osx).

The cross-build for macOS is based on the [Build instructions](/resources/contribute/build), follow them first.
