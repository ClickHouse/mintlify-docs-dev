...
| 1     | Data                             | Same as [client data](/resources/contribute/native-protocol/client#data)                            |
...
Response to [client hello](/resources/contribute/native-protocol/client#hello).
...
Response for [client ping](/resources/contribute/native-protocol/client#ping), no packet body.
