...
### Can't import GPG keys from keyserver.ubuntu.com with apt-key <a id="cant-import-gpg-keys-from-keyserverubuntucom-with-apt-key"></a>
...
### Can't import GPG keys from keyserver.ubuntu.com with gpg <a id="cant-import-gpg-keys-from-keyserverubuntucom-with-gpg"></a>
...
### Can't get deb packages from ClickHouse repository with apt-get <a id="cant-get-deb-packages-from-clickhouse-repository-with-apt-get"></a>
...
### Can't update deb packages from ClickHouse repository with apt-get <a id="cant-update-deb-packages-from-clickhouse-repository-with-apt-get"></a>
...
### You get different warnings with `apt-get update` <a id="you-get-different-warnings-with-apt-get-update"></a>
...
### Can't get packages with Yum because of wrong signature <a id="cant-get-packages-with-yum-because-of-wrong-signature"></a>
...
## Connecting to the server <a id="connecting-to-the-server"></a>
...
### Server isn't running <a id="server-is-not-running"></a>

#### Check if server is running <a id="check-if-server-is-running"></a>
...
#### Check the logs <a id="check-the-logs"></a>
...
#### See system.d logs <a id="see-systemd-logs"></a>
...
#### Start clickhouse-server in interactive mode <a id="start-clickhouse-server-in-interactive-mode"></a>
...
## Query processing <a id="query-processing"></a>
...
## Efficiency of query processing <a id="efficiency-of-query-processing"></a>
