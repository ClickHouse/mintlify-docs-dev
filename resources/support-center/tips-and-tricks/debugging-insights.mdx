...
[Official recommendation](/core/concepts/best-practices/selecting-an-insert-strategy#batch-inserts-if-synchronous): minimum 1,000 rows per insert, ideally 10,000 to 100,000.
...
**Related docs**
- [Custom partitioning key](/core/reference/engines/table-engines/mergetree-family/custom-partitioning-key)
