...
*If you're experiencing slow queries and want more examples, we also have a [Query Optimization](/core/guides/clickhouse/performance-and-monitoring/query-optimization) guide.*
...
- [Choosing a Primary Key](/core/concepts/best-practices/choosing-a-primary-key)
- [Primary indexes](/core/concepts/core-concepts/primary-indexes)
...
**Read Next**:
- [Query Optimization Guide](/core/guides/clickhouse/performance-and-monitoring/query-optimization)
