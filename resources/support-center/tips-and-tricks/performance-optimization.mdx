...
*If you're experiencing slow queries and want more examples, we also have a [Query Optimization](/guides/cloud-oss/performance-and-monitoring/query-optimization) guide.*
...
**Read Next**:
- [Query Optimization Guide](/guides/cloud-oss/performance-and-monitoring/query-optimization)
