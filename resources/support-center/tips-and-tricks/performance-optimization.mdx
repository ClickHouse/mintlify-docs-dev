...
## Order by cardinality (lowest to highest) <a id="cardinality-ordering"></a>
...
## Time granularity matters <a id="time-granularity"></a>
...
## Focus on individual queries, not averages <a id="focus-on-individual-queries-not-averages"></a>
...
## Memory and row scanning <a id="memory-and-row-scanning"></a>
...
## Sentry's bit mask optimization <a id="bit-mask-optimization"></a>
