...
<Image img="/static/images/knowledgebase/lets-encrypt-ssl/port_80_security_group.png" size="md" alt="AWS Security Group configuration showing port 80 open" border />
