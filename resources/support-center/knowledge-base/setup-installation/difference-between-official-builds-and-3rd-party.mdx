...
We recommend running the latest version of ClickHouse using the official builds following the [install instructions](/get-started/setup/self-managed/install) in the documentation:
