...
We recommend running the latest version of ClickHouse using the official builds following the [install instructions](/core/get-started/setup/install) in the documentation:
