...
<Image img="/static/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="MSSQL database and table structure" border />

MSSQL Login User, `sql_user`:  

<Image img="/static/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="MSSQL login user configuration" border />

Database membership roles for `sql_user`:

<Image img="/static/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="MSSQL database membership roles" border />

Database User with Login:  

<Image img="/static/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="MSSQL database user with login" border />
