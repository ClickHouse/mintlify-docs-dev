...
## From Google Chrome <a id="from-google-chrome"></a>
...
## From Mozilla Firefox <a id="from-mozilla-firefox"></a>
...
## Sending the .HAR file <a id="sending-har-file"></a>
