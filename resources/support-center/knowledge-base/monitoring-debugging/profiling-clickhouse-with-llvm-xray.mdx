...
<Image img="/static/images/knowledgebase/profiling-clickhouse-with-llvm-xray/profile.png" size="md" alt="time-order" />
...
<Image img="/static/images/knowledgebase/profiling-clickhouse-with-llvm-xray/time-order.png" size="md" alt="time-order" />

#### Left Heavy \{#left-heavy\}

<Image img="/static/images/knowledgebase/profiling-clickhouse-with-llvm-xray/left-heavy.png" size="md" alt="left-heavy" />

#### Sandwitch \{#sandwitch\}

<Image img="/static/images/knowledgebase/profiling-clickhouse-with-llvm-xray/sandwich.png" size="md" alt="sandwich" />
