...
## Types of profilers <a id="types-of-profilers"></a>
...
## Profiling ClickHouse using XRay's integration <a id="profiling-clickhouse-using-xray-integration"></a>
...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/profile.png" size="md" alt="time-order" />

## Profiling a native application using XRay <a id="profiling-a-native-application-using-xray"></a>
...
### Instrument the code <a id="instrument-the-code"></a>
...
### Run the process with proper env var values to collect the trace <a id="run-the-process-with-proper-env-var-values-to-collect-the-trace"></a>
...
### Convert the trace <a id="convert-the-trace"></a>
...
### Visualize the trace <a id="visualize-the-trace"></a>
...
#### Time Order <a id="time-order"></a>
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/time-order.png" size="md" alt="time-order" />

#### Left Heavy <a id="left-heavy"></a>
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/left-heavy.png" size="md" alt="left-heavy" />

#### Sandwitch <a id="sandwitch"></a>
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/sandwich.png" size="md" alt="sandwich" />

## Check out the docs <a id="check-out-the-docs"></a>
