...
PROFILE](/core/reference/statements/system#instrument-add-profile)
statement. The functions to be instrumented can be collected from
[system.symbols](/core/reference/system-tables/symbols) system table. Say we
...
format](/core/reference/system-tables/trace_log#chrome-event-trace-format) to
...
- [SYSTEM INSTRUMENT](/core/reference/statements/system#instrument) — Add
  or remove instrumentation points.
- [system.instrumentation](/core/reference/system-tables/instrumentation)
  — Inspect instrumented points.
- [system.symbols](/core/reference/system-tables/symbols) — Inspect
  symbols to add instrumentation points.
- [system.trace_log](/core/reference/system-tables/trace_log) — Inspect data
