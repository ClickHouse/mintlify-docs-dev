...
The query result will show the locations in the ClickHouse source code where the threads are running or waiting. (You will need to set `allow_introspection_functions` to `1` to enable the [introspection functions](/core/reference/functions/regular-functions/introspection).) The response looks like:
...
- [system.processes](/core/reference/system-tables/processes)
- [system.query_log](/core/reference/system-tables/query_log)
- [system.metric_log](/core/reference/system-tables/metric_log)
- [system.asynchronous_metric_log](/core/reference/system-tables/asynchronous_metric_log)
- [system.trace_log](/core/reference/system-tables/trace_log)
- [system.processor_profile_log](/core/reference/system-tables/processors_profile_log)

And there is handy info in the [other system tables](/core/reference/system-tables) also.
</Tip>