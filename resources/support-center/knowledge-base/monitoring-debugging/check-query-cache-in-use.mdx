...
See this example using [clickhouse client](/core/concepts/features/interfaces/cli) and ClickHouse Cloud service.
...
You can find more detailed info on ClickHouse Query Cache [here](/core/concepts/features/performance/caches/query-cache)
