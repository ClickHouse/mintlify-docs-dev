...
## How can I check that query cache is being used in my query? <a id="how-can-i-check-that-query-cache-is-being-used-in-my-query"></a>
...
## Using clickhouse client <a id="using-clickhouse-client"></a>
```sql
...
## Using just SQL <a id="using-just-sql"></a>
