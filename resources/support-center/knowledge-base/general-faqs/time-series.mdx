...
First of all, there are **[specialized codecs](/core/reference/statements/create/table#specialized-codecs)** which make typical time-series. Either common algorithms like `DoubleDelta` and `Gorilla` or specific to ClickHouse like `T64`.
...
Even though it's against ClickHouse philosophy of storing and processing raw data, you can use [materialized views](/core/reference/statements/create/view) to fit into even tighter latency or costs requirements.
