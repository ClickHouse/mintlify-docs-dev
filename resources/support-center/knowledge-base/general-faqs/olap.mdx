...
## OLAP from the business perspective <a id="olap-from-the-business-perspective"></a>
...
## OLAP from the technical perspective <a id="olap-from-the-technical-perspective"></a>
