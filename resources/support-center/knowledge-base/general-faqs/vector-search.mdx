...
## ClickHouse for Vector Search! <a id="clickhouse-for-vector-search"></a>
...
## 1. Create embeddings <a id="1-create-embeddings"></a>
...
## 2. Store the embeddings <a id="2-store-the-embeddings"></a>
...
## 3. Search for related embeddings <a id="3-search-for-related-embeddings"></a>
