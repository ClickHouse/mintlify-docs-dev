...
<Image img="/static/images/row-oriented.gif" alt="Illustration of traditional row-oriented database storage" size="md" />

**Columnar**
<Image img="/static/images/column-oriented.gif" alt="Illustration of columnar database storage" size="md" />
