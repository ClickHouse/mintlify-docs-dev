...
## Advantages of a columnar database <a id="advantages-of-a-columnar-database"></a>
...
## Row-oriented vs column-oriented databases <a id="row-oriented-vs-column-oriented-databases"></a>
...
<Image img="/images/row-oriented.gif" alt="Illustration of traditional row-oriented database storage" size="md" />

**Columnar**
<Image img="/images/column-oriented.gif" alt="Illustration of columnar database storage" size="md" />
