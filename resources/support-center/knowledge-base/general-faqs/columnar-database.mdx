...
<Image img="/images/row-oriented.gif" alt="Traditional row-oriented database" size="md" border />

**Columnar**
<Image img="/images/column-oriented.gif" alt="Columnar database" size="md" border />
