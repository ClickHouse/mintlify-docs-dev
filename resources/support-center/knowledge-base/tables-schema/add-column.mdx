...
## Adding a Column to a Table <a id="adding-a-column-to-a-table"></a>
...
## Adding a new column <a id="adding-a-new-column"></a>
...
## Modifying a column's default value <a id="modifying-a-columns-default-value"></a>
...
## Controlling column position in table <a id="controlling-column-position-in-table"></a>
