...
[Quotas](/core/concepts/features/configuration/server-config/quotas) and [query complexity](/core/concepts/features/configuration/settings/query-complexity) are powerful ways to limit and restrict what users can do in ClickHouse.
