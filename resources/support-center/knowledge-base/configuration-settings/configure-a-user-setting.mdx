...
## Configure a setting for a single query <a id="configure-a-setting-for-a-single-query"></a>
...
## Configure a setting for a session <a id="configure-a-setting-for-a-session"></a>
...
## Configure a setting for a particular user <a id="configure-a-setting-for-a-particular-user"></a>
