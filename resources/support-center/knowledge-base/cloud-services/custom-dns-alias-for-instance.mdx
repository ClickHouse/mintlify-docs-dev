...
create a certificate called `MyCertificate.crt`. Refer to ["Create SSL certificates"](/core/concepts/features/security/tls/configuring-tls#2-create-tls-certificates)
for further details.
