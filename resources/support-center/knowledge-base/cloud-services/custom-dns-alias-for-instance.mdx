...
<br/>
<br/>
# Custom DNS alias by setting up reverse proxy <a id="custom-dns-alias"></a>
...
## Create a self-signed certificate <a id="create-certificate"></a>
<Note>
...
## Update Nginx configuration <a id="update-nginx-config"></a>
...
## Update hosts file <a id="update-hosts-file"></a>
<Note>
...
## Connect to Cloud using alias <a id="connect-to-cloud-using-alias"></a>
