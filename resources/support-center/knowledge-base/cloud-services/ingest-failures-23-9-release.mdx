...
## Resolving Ingest Failures After ClickHouse 23.9 Release <a id="resolving-ingest-failures-after-clickhouse-239-release"></a>
...
## Add necessary GRANTs to affected tables and dictionaries <a id="add-necessary-grants-to-affected-tables-and-dictionaries"></a>
```
