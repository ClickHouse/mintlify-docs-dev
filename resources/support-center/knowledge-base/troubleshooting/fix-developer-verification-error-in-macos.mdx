...
## Fix the Developer Verification Error in MacOS <a id="fix-the-developer-verification-error-in-macos"></a>
...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="MacOS developer verification error dialog" border />
