...
<Image img="/static/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="MacOS developer verification error dialog" border />
