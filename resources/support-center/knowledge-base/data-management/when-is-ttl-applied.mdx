...
Check the docs for how to modify the [`background_pool_size` setting](/core/reference/settings/server-settings/settings#background_pool_size), which is configured as:
