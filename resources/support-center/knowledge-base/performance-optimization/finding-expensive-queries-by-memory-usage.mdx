...
<Note>
If you do not have a `system.query_log` table, then you likely do not have query logging enabled. View the details of the [`query_log` setting](/core/reference/settings/server-settings/settings#server_configuration_parameters-query-log) for details on how to enable it.
</Note>
