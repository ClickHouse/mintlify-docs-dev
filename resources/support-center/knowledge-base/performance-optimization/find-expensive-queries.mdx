...
It turns out to be the query we used to insert a few billion rows of data into a table named `youtube` (see the [YouTube dislikes dataset](/core/get-started/sample-datasets/youtube-dislikes)):
...
As for other System Tables, you can find more details about the meaning of each field in our [docs](/core/reference/system-tables/query_log).
