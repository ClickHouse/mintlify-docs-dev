...
## Understanding aggregate function combinators <a id="understanding-aggregate-function-combinators"></a>
...
## Real-World Application: UK housing prices dataset <a id="real-world-application-uk-housing-prices-dataset"></a>
...
### Grouping and aggregating by decade <a id="grouping-and-aggregating-by-decade"></a>
...
## Combining multiple aggregations <a id="combining-multiple-aggregations"></a>
...
## Applying functions to map values <a id="applying-functions-to-map-values"></a>
...
## Flexible grouping: counties, districts, and postcodes <a id="flexible-grouping-counties-districts-and-postcodes"></a>
