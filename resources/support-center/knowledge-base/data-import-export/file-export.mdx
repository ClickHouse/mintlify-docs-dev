...
## Using INTO OUTFILE Clause <a id="using-into-outfile-clause"></a>
...
## Using the File table engine <a id="using-a-file-engine-table"></a>
...
## Using Command-Line Redirection <a id="using-command-line-redirection"></a>
``` bash
