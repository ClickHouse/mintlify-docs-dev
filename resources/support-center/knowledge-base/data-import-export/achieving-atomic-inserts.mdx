...
## Recommended solution <a id="recommended-solution"></a>
...
## Step-by-step for single-table atomicity <a id="step-by-step"></a>
<Steps>
<Step>
### Create a staging table <a id="create-staging-table"></a>
...
<Step>
### Insert data into the staging table <a id="insert-into-staging"></a>
...
<Step>
### If the insert fails, truncate and retry <a id="on-failure"></a>
...
<Step>
### If the insert succeeds, move the partitions to production <a id="on-success"></a>
...
<Step>
### Clean up the staging table <a id="clean-up"></a>
...
## Multi-table consistency <a id="multi-table-consistency"></a>
...
## Requirements and constraints <a id="requirements-and-constraints"></a>
