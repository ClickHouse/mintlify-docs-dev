...
## Kafka and the JSON Data Type <a id="kafka-and-the-json-data-type"></a>
...
## Setup Kafka <a id="setup-kafka"></a>
...
## Ingest data into Kafka <a id="ingest-data-into-kafka"></a>
...
## Ingest data into ClickHouse <a id="ingest-data-into-clickhouse"></a>
...
## Querying JSON data in ClickHouse <a id="querying-json-data-in-clickhouse"></a>
