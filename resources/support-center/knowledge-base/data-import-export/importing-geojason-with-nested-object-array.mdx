...
To do so, we can use the function [arrayMap(func,arr1,...)](/reference/functions/regular-functions/array-functions#arraymapfunc-arr1-).
...
For any other JSON-related requirements, please refer to our [documentation](/integrations/connectors/data-ingestion/data-formats/json/intro).
