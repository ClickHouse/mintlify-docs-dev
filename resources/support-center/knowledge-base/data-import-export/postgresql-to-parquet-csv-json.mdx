...
The output format can be any of the supported [ouput formats](/core/reference/formats) in ClickHouse. Let's look at a few examples...
...
<Note>
You don't have to stop here - you can use `clickhouse-local` to pull data from PostgreSQL and send it to [all types of output formats](/core/reference/formats).
