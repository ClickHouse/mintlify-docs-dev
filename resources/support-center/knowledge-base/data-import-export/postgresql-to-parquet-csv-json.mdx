...
## How to export PostgreSQL data to Parquet, CSV or JSON <a id="how-to-export-postgresql-data-to-parquet-csv-or-json"></a>
...
## Export PostgreSQL to Parquet <a id="export-postgresql-to-parquet"></a>
...
## Export PostgreSQL to CSV <a id="export-postgresql-to-csv"></a>
...
## Export PostgreSQL to JSON <a id="export-postgresql-to-json"></a>
