...
## Exporting MySQL Data to Parquet, CSV, or JSON Using ClickHouse <a id="exporting-mysql-data-to-parquet-csv-or-json-using-clickhouse"></a>
...
## Export MySQL to Parquet <a id="export-mysql-to-parquet"></a>
...
## Export MySQL to CSV <a id="export-mysql-to-csv"></a>
...
## Export MySQL to JSON <a id="export-mysql-to-json"></a>
