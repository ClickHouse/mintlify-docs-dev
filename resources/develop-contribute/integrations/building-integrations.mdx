...
### Path A: ClickPipes (managed, ClickHouse Cloud only) <a id="path-a-clickpipes"></a>
...
### Path B: Self-driven ingestion via an official language client <a id="path-b-language-client"></a>
...
## Consumption <a id="consumption"></a>
...
### Result-set sizing <a id="result-set-sizing"></a>
...
## User-agent string convention <a id="user-agent-string-convention"></a>
...
## Sandbox and trial access <a id="sandbox-and-trial-access"></a>
