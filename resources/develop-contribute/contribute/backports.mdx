...
## Release Model <a id="release-model"></a>
...
## Backport Policy <a id="backport-policy"></a>
...
## Backport Tool <a id="backport-tool"></a>
...
## Active Release Branches <a id="active-release-branches"></a>
...
### Branch and PR Naming <a id="branch-and-pr-naming"></a>
...
### Step-by-Step Process <a id="step-by-step-process"></a>

#### 1. Discover active releases <a id="discover-active-releases"></a>
...
#### 2. Find PRs to backport <a id="find-prs-to-backport"></a>
...
#### 3. Rolling-out branch handling <a id="rolling-out-branch-handling"></a>
...
#### 4. Cherry-pick stage (`ReleaseBranch.create_cherrypick`) <a id="cherry-pick-stage"></a>
...
#### 5. Auto-merge of conflict-free cherry-pick PRs <a id="auto-merge-conflict-free-cherry-pick-prs"></a>
...
#### 6. Backport stage (`ReleaseBranch.create_backport`) <a id="backport-stage"></a>
...
### Stale Cherry-pick PR Handling <a id="stale-cherry-pick-pr-handling"></a>
...
### CI for Backport PRs <a id="ci-for-backport-prs"></a>
...
### GitHub API Cache <a id="github-api-cache"></a>
