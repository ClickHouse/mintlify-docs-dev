...
## Merge with master <a id="merge-with-master"></a>
...
## Description check <a id="description-check"></a>
...
### Official docker library tests <a id="official-docker-library-tests"></a>
...
## Marker check <a id="marker-check"></a>
...
## Style check <a id="style-check"></a>
...
### Running the style check job locally <a id="running-style-check-locally"></a>
...
#### Prerequisites <a id="ci-prerequisites"></a>
...
#### Run a CI Job Locally <a id="run-ci-job-locally"></a>
...
#### Run Specific Tests Within a CI Job <a id="run-specific-tests-within-ci-job"></a>
...
#### Additional Customization Options <a id="additional-customization-options"></a>
...
## Build check <a id="build-check"></a>

Builds ClickHouse in various configurations for use in further steps.

### Running Builds Locally <a id="running-builds-locally"></a>
...
#### Available Build Jobs <a id="available-build-jobs"></a>
...
#### Example <a id="example-run-local"></a>
...
## Functional stateless tests <a id="functional-stateless-tests"></a>
...
## Bugfix validate check <a id="bugfix-validate-check"></a>
