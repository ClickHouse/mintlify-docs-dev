...
If it fails, fix the style issues according to the [code style guide](/resources/develop-contribute/contribute/style).
...
Download the binary from [CI build checks page](/core/get-started/setup/self-managed/advanced), or build it locally.
