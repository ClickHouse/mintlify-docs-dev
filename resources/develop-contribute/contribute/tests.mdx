...
## Functional tests <a id="functional-tests"></a>
...
### Running a test locally <a id="running-a-test-locally"></a>
...
### Running fast tests <a id="running-fast-tests"></a>
...
### Running stateless tests <a id="running-stateless-tests"></a>
...
### Adding a new test <a id="adding-a-new-test"></a>
...
### Templated tests with Jinja <a id="templated-tests-with-jinja"></a>
...
### Restricting test runs <a id="restricting-test-runs"></a>
...
### Specifying limits for random settings <a id="specifying-limits-for-random-settings"></a>
...
### Choosing the test name <a id="choosing-the-test-name"></a>
...
### Checking for an error that must occur <a id="checking-for-an-error-that-must-occur"></a>
...
### Testing a distributed query <a id="testing-a-distributed-query"></a>
...
### Working with temporary files <a id="working-with-temporary-files"></a>
...
## Test tools and scripts <a id="test-tools-and-scripts"></a>
...
## Miscellaneous tests <a id="miscellaneous-tests"></a>
...
## Build tests <a id="build-tests"></a>
...
## Testing for protocol compatibility <a id="testing-for-protocol-compatibility"></a>
...
## Help from the Compiler <a id="help-from-the-compiler"></a>
...
### Valgrind (memcheck) <a id="valgrind-memcheck"></a>
...
## Stress test <a id="stress-test"></a>
...
## Thread fuzzer <a id="thread-fuzzer"></a>
...
## Static analyzers <a id="static-analyzers"></a>
...
## Runtime integrity checks <a id="runtime-integrity-checks"></a>
...
## Tests for tests <a id="tests-for-tests"></a>
...
## Test automation <a id="test-automation"></a>
