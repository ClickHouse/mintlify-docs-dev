...
## Building ClickHouse for s390x <a id="building-clickhouse-for-s390x"></a>
...
These instructions assume that the host machine is Linux x86_64/ARM and has all the tooling required to build natively based on the [build instructions](/resources/develop-contribute/build/build). It also assumes that the host is Ubuntu 22.04 but the following instructions should also work on Ubuntu 20.04.
...
## Visual Studio Code integration <a id="visual-studio-code-integration"></a>
...
#### cmake-variants.yaml <a id="cmake-variantsyaml"></a>
```yaml
buildType:
...
#### settings.json <a id="settingsjson"></a>
...
#### run-debug.sh <a id="run-debugsh"></a>
```sh
#! /bin/sh
