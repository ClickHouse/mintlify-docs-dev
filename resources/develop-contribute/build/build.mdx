...
## Install prerequisites <a id="install-prerequisites"></a>
...
## Install the Clang compiler <a id="install-the-clang-compiler"></a>
...
## Install the Rust compiler (optional) <a id="install-the-rust-compiler-optional"></a>
...
```
## Build ClickHouse <a id="build-clickhouse"></a>
...
## Running the ClickHouse Executable <a id="running-the-clickhouse-executable"></a>
...
### Minimal Build <a id="minimal-build"></a>
...
### Running the ClickHouse Executable <a id="running-the-clickhouse-executable-1"></a>
...
### Building on Any Linux <a id="building-on-any-linux"></a>
...
### Building in docker <a id="building-in-docker"></a>
