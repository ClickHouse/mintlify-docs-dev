...
## Create a Repository on GitHub <a id="create-a-repository-on-github"></a>
...
## Clone the repository to your development machine <a id="clone-the-repository-to-your-development-machine"></a>
...
## Writing code <a id="writing-code"></a>
...
## Create a pull request <a id="create-a-pull-request"></a>
...
## Write documentation <a id="write-documentation"></a>
...
## Using test data <a id="using-test-data"></a>
