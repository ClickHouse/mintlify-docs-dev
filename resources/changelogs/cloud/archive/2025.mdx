...
- Alerting is now available for ClickStack users in ClickHouse Cloud.
  ...
  For more information see the [alerting documentation](/products/clickstack/features/alerts).
...
<Image img="/static/images/cloud/reference/may-30-dashboards.png" size="md" alt="Dashboards improvements" border />
