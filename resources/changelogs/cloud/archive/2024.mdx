...
## December 20, 2024 <a id="december-20-2024"></a>

### Marketplace subscription organization attachment <a id="marketplace-subscription-organization-attachment"></a>
...
<Image img="/images/cloud/reference/add_marketplace.png" size="md" alt="ClickHouse Cloud interface showing how to add a marketplace subscription to an existing organization" border />

### Force OpenAPI key expiration <a id="force-openapi-key-expiration"></a>
...
### Custom emails for notifications <a id="custom-emails-for-notifications"></a>
...
## December 6, 2024 <a id="december-6-2024"></a>

### BYOC (beta) <a id="byoc-beta"></a>
...
### Postgres Change Data Capture (CDC) connector in ClickPipes <a id="postgres-change-data-capture-cdc-connector-in-clickpipes"></a>
...
### Dashboards (beta) <a id="dashboards-beta"></a>
...
<Image img="/images/cloud/reference/beta_dashboards.png" size="lg" alt="ClickHouse Cloud interface showing the new Dashboards Beta feature with visualizations" border />

### Query API endpoints (GA) <a id="query-api-endpoints-ga"></a>
...
<Image img="/images/cloud/reference/api_endpoints.png" size="lg" alt="ClickHouse Cloud interface showing the API Endpoints configuration with various settings" border />

### Native JSON support (Beta) <a id="native-json-support-beta"></a>
...
### Vector search using vector similarity indexes (early access) <a id="vector-search-using-vector-similarity-indexes-early-access"></a>
...
### ClickHouse-connect (Python) and ClickHouse Kafka Connect users <a id="clickhouse-connect-python-and-clickhouse-kafka-connect-users"></a>
...
### ClickPipes now supports cross-VPC resource access on AWS <a id="clickpipes-now-supports-cross-vpc-resource-access-on-aws"></a>
...
<Image img="/images/cloud/reference/cross-vpc-clickpipes.png" size="lg" alt="Diagram showing the Cross-VPC resource access architecture for ClickPipes connecting to AWS MSK" border />

### ClickPipes now supports IAM for AWS MSK <a id="clickpipes-now-supports-iam-for-aws-msk"></a>
...
### Maximum replica size for new services on AWS <a id="maximum-replica-size-for-new-services-on-aws"></a>

From now on, any new services created on AWS will allow a maximum available replica size of 236 GiB.

## November 22, 2024 <a id="november-22-2024"></a>

### Built-in advanced observability dashboard for ClickHouse Cloud <a id="built-in-advanced-observability-dashboard-for-clickhouse-cloud"></a>
...
<Image img="/images/cloud/reference/nov-22-dashboard.png" size="lg" alt="ClickHouse Cloud advanced observability dashboard showing server metrics and resource utilization" border />

### AI-powered SQL autocomplete <a id="ai-powered-sql-autocomplete"></a>
...
### New "billing" role <a id="new-billing-role"></a>
...
## November 8, 2024 <a id="november-8-2024"></a>

### Customer Notifications in ClickHouse Cloud <a id="customer-notifications-in-clickhouse-cloud"></a>
...
<Image img="/images/cloud/reference/nov-8-notifications.png" size="lg" alt="ClickHouse Cloud notification center interface showing configuration options for different notification types" border />

<br />

## October 4, 2024 <a id="october-4-2024"></a>

### ClickHouse Cloud now offers HIPAA-ready services in Beta for GCP <a id="clickhouse-cloud-now-offers-hipaa-ready-services-in-beta-for-gcp"></a>
...
### Compute-compute separation is now in private preview for GCP and Azure <a id="compute-compute-separation-is-now-in-private-preview-for-gcp-and-azure"></a>
...
### Self-service MFA recovery codes <a id="self-service-mfa-recovery-codes"></a>
...
### ClickPipes update: custom certificates, latency insights, and more. <a id="clickpipes-update-custom-certificates-latency-insights-and-more"></a>
...
<Image img="/images/cloud/reference/oct-4-latency-insights.png" size="lg" alt="ClickPipes interface showing latency metrics graph for data ingestion performance" border />
...
### New Terraform provider version - v1.0.0 <a id="new-terraform-provider-version---v100"></a>
...
### 2024 SOC 2 Type II report and updated ISO 27001 certificate <a id="2024-soc-2-type-ii-report-and-updated-iso-27001-certificate"></a>
...
## August 15, 2024 <a id="august-15-2024"></a>

### Compute-compute separation is now in Private Preview for AWS <a id="compute-compute-separation-is-now-in-private-preview-for-aws"></a>
...
<Image img="/images/cloud/reference/aug-15-compute-compute.png" size="lg" alt="Diagram showing example architecture for compute-compute separation with read-write and read-only service groups" border />

### ClickPipes for S3 and GCS now in GA, Continuous mode support <a id="clickpipes-for-s3-and-gcs-now-in-ga-continuous-mode-support"></a>
...
### Prometheus endpoint for metrics is now generally available <a id="prometheus-endpoint-for-metrics-is-now-generally-available"></a>
...
### Table inspector in Cloud console <a id="table-inspector-in-cloud-console"></a>
...
<Image img="/images/cloud/reference/july-18-table-inspector.png" size="lg" alt="ClickHouse Cloud Table Inspector interface showing detailed schema and storage information" border />

### New Java Client API <a id="new-java-client-api"></a>
...
### New Analyzer is enabled by default <a id="new-analyzer-is-enabled-by-default"></a>
...
## June 28, 2024 <a id="june-28-2024"></a>

### ClickHouse Cloud for Microsoft Azure is now generally available <a id="clickhouse-cloud-for-microsoft-azure-is-now-generally-available"></a>
...
### Query log insights <a id="query-log-insights"></a>
...
<Image img="/images/cloud/reference/june-28-query-insights.png" size="lg" alt="ClickHouse Cloud Query Insights UI showing query performance metrics and analysis" border />

### Prometheus endpoint for metrics (private preview) <a id="prometheus-endpoint-for-metrics-private-preview"></a>
...
<Image img="/images/cloud/reference/june-28-prometheus.png" size="lg" alt="Grafana dashboard showing Prometheus metrics from ClickHouse Cloud" border />
...
## June 13, 2024 <a id="june-13-2024"></a>

### Configurable offsets for Kafka ClickPipes Connector (Beta) <a id="configurable-offsets-for-kafka-clickpipes-connector-beta"></a>
...
<Image img="/images/cloud/reference/june-13-kafka-config.png" size="lg" alt="ClickPipes Kafka connector configuration interface showing offset selection options" border />

### Enroll services to the Fast release channel <a id="enroll-services-to-the-fast-release-channel"></a>
...
<Image img="/images/cloud/reference/june-13-fast-releases.png" size="lg" alt="ClickHouse Cloud settings page showing the option to enroll in fast releases" border />

### Terraform support for horizontal scaling <a id="terraform-support-for-horizontal-scaling"></a>
...
## May 30, 2024 <a id="may-30-2024"></a>

### Share queries with your teammates <a id="share-queries-with-your-teammates"></a>
...
<Image img="/images/cloud/reference/may-30-share-queries.png" size="lg" alt="ClickHouse Cloud query editor showing the share functionality with permission options" border />

### ClickHouse Cloud for Microsoft Azure is now in beta <a id="clickhouse-cloud-for-microsoft-azure-is-now-in-beta"></a>
...
### Set up Private Link via the Cloud console <a id="set-up-private-link-via-the-cloud-console"></a>
...
<Image img="/images/cloud/reference/may-30-private-endpoints.png" size="lg" alt="ClickHouse Cloud console showing private endpoint setup interface in the security settings" border />

## May 17, 2024 <a id="may-17-2024"></a>

### Ingest data from Amazon Kinesis using ClickPipes (beta) <a id="ingest-data-from-amazon-kinesis-using-clickpipes-beta"></a>
...
<Image img="/images/cloud/reference/may-17-kinesis.png" size="lg" alt="ClickPipes interface showing Amazon Kinesis integration configuration options" border />

### Configurable backups (private preview) <a id="configurable-backups-private-preview"></a>
...
### Create APIs from your SQL queries (Beta) <a id="create-apis-from-your-sql-queries-beta"></a>
...
<Image img="/images/cloud/reference/may-17-query-endpoints.png" size="lg" alt="ClickHouse Cloud interface showing Query Endpoints configuration with output format options" border />

### Official ClickHouse Certification is now available <a id="official-clickhouse-certification-is-now-available"></a>
...
## April 25, 2024 <a id="april-25-2024"></a>

### Load data from S3 and GCS using ClickPipes <a id="load-data-from-s3-and-gcs-using-clickpipes"></a>
...
<Image img="/images/cloud/reference/clickpipes-s3-gcs.png" size="lg" alt="ClickPipes interface showing configuration options for loading data from S3 and GCS buckets" border />

### Use Fivetran to load data from 500+ sources into ClickHouse Cloud <a id="use-fivetran-to-load-data-from-500-sources-into-clickhouse-cloud"></a>
...
## April 18, 2024 <a id="april-18-2024"></a>

### AWS Tokyo region is now available for ClickHouse Cloud <a id="aws-tokyo-region-is-now-available-for-clickhouse-cloud"></a>
...
<Image img="/images/cloud/reference/create-tokyo-service.png" size="lg" alt="ClickHouse Cloud service creation interface showing Tokyo region selection" border />

Other changes:

### Console changes <a id="console-changes"></a>
...
### Integrations changes <a id="integrations-changes"></a>
...
## April 4, 2024 <a id="april-4-2024"></a>

### Introducing the new ClickHouse Cloud console <a id="introducing-the-new-clickhouse-cloud-console"></a>
...
<Image img="/images/cloud/reference/new-cloud-console.gif" size="lg" alt="Animation showing the new ClickHouse Cloud console interface with integrated SQL editor and management features" border />

## March 28, 2024 <a id="march-28-2024"></a>

This release introduces support for Microsoft Azure, Horizontal Scaling via API, and Release Channels in Private Preview.

### General updates <a id="general-updates"></a>
...
### Administration changes <a id="administration-changes"></a>
...
### Console changes <a id="console-changes-1"></a>
...
### Integrations changes <a id="integrations-changes-1"></a>
...
### Security updates <a id="security-updates"></a>
...
## March 14, 2024 <a id="march-14-2024"></a>
...
### Console changes <a id="console-changes-2"></a>
...
### ClickHouse version upgrade <a id="clickhouse-version-upgrade"></a>
...
### Integrations changes <a id="integrations-changes-2"></a>
...
## February 29, 2024 <a id="february-29-2024"></a>
...
### Console changes <a id="console-changes-3"></a>
...
### Integrations changes <a id="integrations-changes-3"></a>
...
## February 15, 2024 <a id="february-15-2024"></a>
...
### ClickHouse version upgrade <a id="clickhouse-version-upgrade-1"></a>
...
### Console changes <a id="console-changes-4"></a>
...
### Integrations changes <a id="integrations-changes-4"></a>
* Kafka Connect
...
### Settings changes <a id="settings-changes"></a>
...
## February 2, 2024 <a id="february-2-2024"></a>
...
## January 18, 2024 <a id="january-18-2024"></a>
...
### General changes <a id="general-changes"></a>
- New AWS Region: London (eu-west-2)

### Console changes <a id="console-changes-6"></a>
...
### Integrations changes <a id="integrations-changes-6"></a>
- Java client:
...
### Reliability changes <a id="reliability-changes"></a>
