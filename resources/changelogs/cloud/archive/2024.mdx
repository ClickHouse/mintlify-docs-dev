...
<Image img="/static/images/cloud/reference/add_marketplace.png" size="md" alt="ClickHouse Cloud interface showing how to add a marketplace subscription to an existing organization" border />
...
<Image img="/static/images/cloud/reference/beta_dashboards.png" size="lg" alt="ClickHouse Cloud interface showing the new Dashboards Beta feature with visualizations" border />
...
<Image img="/static/images/cloud/reference/api_endpoints.png" size="lg" alt="ClickHouse Cloud interface showing the API Endpoints configuration with various settings" border />
...
<Image img="/static/images/cloud/reference/cross-vpc-clickpipes.png" size="lg" alt="Diagram showing the Cross-VPC resource access architecture for ClickPipes connecting to AWS MSK" border />
...
<Image img="/static/images/cloud/reference/nov-22-dashboard.png" size="lg" alt="ClickHouse Cloud advanced observability dashboard showing server metrics and resource utilization" border />
...
<Image img="/static/images/cloud/reference/nov-22-copilot.gif" size="lg" alt="Animation showing the AI Copilot providing SQL autocompletion suggestions as a user types" border />
...
<Image img="/static/images/cloud/reference/nov-8-notifications.png" size="lg" alt="ClickHouse Cloud notification center interface showing configuration options for different notification types" border />
...
<Image img="/static/images/cloud/reference/oct-4-latency-insights.png" size="lg" alt="ClickPipes interface showing latency metrics graph for data ingestion performance" border />
...
<Image img="/static/images/cloud/reference/aug-15-compute-compute.png" size="lg" alt="Diagram showing example architecture for compute-compute separation with read-write and read-only service groups" border />
...
<Image img="/static/images/cloud/reference/july-18-table-inspector.png" size="lg" alt="ClickHouse Cloud Table Inspector interface showing detailed schema and storage information" border />
...
<Image img="/static/images/cloud/reference/june-28-query-insights.png" size="lg" alt="ClickHouse Cloud Query Insights UI showing query performance metrics and analysis" border />
...
<Image img="/static/images/cloud/reference/june-28-prometheus.png" size="lg" alt="Grafana dashboard showing Prometheus metrics from ClickHouse Cloud" border />
...
<Image img="/static/images/cloud/reference/june-13-kafka-config.png" size="lg" alt="ClickPipes Kafka connector configuration interface showing offset selection options" border />
...
<Image img="/static/images/cloud/reference/june-13-fast-releases.png" size="lg" alt="ClickHouse Cloud settings page showing the option to enroll in fast releases" border />
...
<Image img="/static/images/cloud/reference/may-30-share-queries.png" size="lg" alt="ClickHouse Cloud query editor showing the share functionality with permission options" border />
...
<Image img="/static/images/cloud/reference/may-30-private-endpoints.png" size="lg" alt="ClickHouse Cloud console showing private endpoint setup interface in the security settings" border />
...
<Image img="/static/images/cloud/reference/may-17-kinesis.png" size="lg" alt="ClickPipes interface showing Amazon Kinesis integration configuration options" border />
...
<Image img="/static/images/cloud/reference/may-17-query-endpoints.png" size="lg" alt="ClickHouse Cloud interface showing Query Endpoints configuration with output format options" border />
...
<Image img="/static/images/cloud/reference/clickpipes-s3-gcs.png" size="lg" alt="ClickPipes interface showing configuration options for loading data from S3 and GCS buckets" border />
...
<Image img="/static/images/cloud/reference/create-tokyo-service.png" size="lg" alt="ClickHouse Cloud service creation interface showing Tokyo region selection" border />
...
<Image img="/static/images/cloud/reference/new-cloud-console.gif" size="lg" alt="Animation showing the new ClickHouse Cloud console interface with integrated SQL editor and management features" border />
