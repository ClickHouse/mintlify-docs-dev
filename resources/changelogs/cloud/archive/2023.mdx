...
## December 18, 2023 <a id="december-18-2023"></a>
...
### General changes <a id="general-changes-1"></a>
...
### Console changes <a id="console-changes-7"></a>
...
### Integrations changes <a id="integrations-changes-7"></a>
...
### Security announcements <a id="security-announcements"></a>
...
## November 22, 2023 <a id="november-22-2023"></a>
...
### ClickHouse version upgrade <a id="clickhouse-version-upgrade-2"></a>
...
## November 2, 2023 <a id="november-2-2023"></a>
...
### General updates <a id="general-updates-1"></a>
...
### Console changes <a id="console-changes-9"></a>
- Added ability to configure granular tax settings when adding a credit card

### Integrations changes <a id="integrations-changes-9"></a>
- MySQL
...
## October 19, 2023 <a id="october-19-2023"></a>
...
### Console changes <a id="console-changes-10"></a>
...
### Integrations changes <a id="integrations-changes-10"></a>
- Java client:
...
## September 28, 2023 <a id="september-28-2023"></a>
...
### Console changes <a id="console-changes-11"></a>
...
### Integrations changes <a id="integrations-changes-11"></a>
...
## September 7, 2023 <a id="september-7-2023"></a>
...
### Console changes <a id="console-changes-12"></a>
- Added remaining credits and payment retries to support charges from India

### Integrations changes <a id="integrations-changes-12"></a>
...
## Aug 24, 2023 <a id="aug-24-2023"></a>
...
### General updates <a id="general-updates-2"></a>
...
### Console changes <a id="console-changes-13"></a>
- Added support for "Running Queries" view in SQL Console

### ClickHouse 23.7 version upgrade <a id="clickhouse-237-version-upgrade"></a>
...
### Integrations changes <a id="integrations-changes-13"></a>
...
## July 27, 2023 <a id="july-27-2023"></a>
...
### Integrations changes <a id="integrations-changes-14"></a>
...
### Console changes <a id="console-changes-14"></a>
...
## July 14, 2023 <a id="july-14-2023"></a>
...
### General updates <a id="general-updates-3"></a>
...
### Console changes <a id="console-changes-15"></a>
...
### Integrations changes <a id="integrations-changes-15"></a>
...
### Core database changes <a id="core-database-changes"></a>
...
## June 20, 2023 <a id="june-20-2023"></a>
...
### General updates <a id="general-updates-4"></a>
...
### ClickHouse 23.4 version upgrade <a id="clickhouse-234-version-upgrade"></a>
...
### Administration changes <a id="administration-changes-1"></a>
- Expanded local dictionary creation for non "default" users

## May 30, 2023 <a id="may-30-2023"></a>
...
### General changes <a id="general-changes-2"></a>
...
### Scaling changes <a id="scaling-changes"></a>
...
### Console changes <a id="console-changes-17"></a>
...
### Integrations changes <a id="integrations-changes-17"></a>
...
### Performance and reliability <a id="performance-and-reliability"></a>
...
## May 11, 2023 <a id="may-11-2023"></a>
...
### ClickHouse Cloud on GCP is now available in public beta <a id="clickhouse-cloud-on-gcp-is-now-available-in-public-beta-now-ga-see-june-20th-entry-above"></a>
...
### Integrations changes <a id="integrations-changes-18"></a>
...
### Integrations changes <a id="integrations-changes-19"></a>
...
### Performance and reliability <a id="performance-and-reliability-2"></a>
...
## April 20, 2023 <a id="april-20-2023"></a>
...
### Console changes <a id="console-changes-20"></a>
- Added an option for real-time chat with support

### Integrations changes <a id="integrations-changes-20"></a>
...
## April 6, 2023 <a id="april-6-2023"></a>
...
### Console changes <a id="console-changes-21"></a>
...
### Integrations changes <a id="integrations-changes-21"></a>
...
## March 23, 2023 <a id="march-23-2023"></a>
...
## March 9, 2023 <a id="march-9-2023"></a>
...
### Console changes <a id="console-changes-23"></a>
...
### Reliability and performance <a id="reliability-and-performance"></a>
- Optimized backup schedule to run backups only if data was modified
- Improved time to complete large backups

### Configuration changes <a id="configuration-changes-1"></a>
...
##  February 23, 2023 <a id="february-23-2023"></a>
...
### ClickHouse 23.1 version upgrade <a id="clickhouse-231-version-upgrade"></a>
...
### Integrations changes <a id="integrations-changes-23"></a>
...
### Console changes <a id="console-changes-24"></a>
...
### Reliability and performance <a id="reliability-and-performance-1"></a>
...
## February 2, 2023 <a id="february-2-2023"></a>
...
### Integrations changes <a id="integrations-changes-24"></a>
...
### Console changes <a id="console-changes-25"></a>
- Added support for views and materialized views in SQL console

### Performance and reliability <a id="performance-and-reliability-4"></a>
...
## January 12, 2023 <a id="january-12-2023"></a>
...
### Console changes <a id="console-changes-26"></a>
...
### Integrations changes <a id="integrations-changes-25"></a>
...
### Reliability and performance <a id="reliability-and-performance-2"></a>
