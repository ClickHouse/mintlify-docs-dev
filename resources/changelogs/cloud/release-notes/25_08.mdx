...
### JSON and data format changes <a id="json-and-data-format-changes"></a>
...
### Storage and partitioning <a id="storage-and-partitioning"></a>
...
### Function enhancements <a id="function-enhancements"></a>
...
### Data type improvements <a id="data-type-improvements"></a>
...
### Performance and resource management <a id="performance-and-resource-management"></a>
...
### Schema and SQL syntax <a id="schema-and-sql-syntax"></a>
...
### Security and permissions <a id="security-and-permissions"></a>
...
## New features <a id="new-feature"></a>
...
### System tables <a id="system-tables"></a>
...
### Iceberg and DeltaLake <a id="iceberg-and-deltalake"></a>
...
### MergeTree and storage <a id="mergetree-and-storage"></a>
...
### Protocol and client Support <a id="protocol-and-client-support"></a>
...
### SQL and query features <a id="sql-and-query-features"></a>
...
### Server configuration and workload management <a id="server-configuration-and-workload-management"></a>
...
### Cloud storage <a id="cloud-storage"></a>
...
### Table engines and table functions <a id="table-engines-and-table-functions"></a>
...
### Text index improvements <a id="text-index-improvements"></a>
...
### Feature maturity updates <a id="feature-maturity-updates"></a>
...
### Query execution and aggregation <a id="query-execution-and-aggregation"></a>
...
### JOIN optimizations <a id="join-optimizations"></a>
...
### Distributed query improvements <a id="distributed-query-improvements"></a>
...
### Index improvements <a id="index-improvements"></a>
...
### Subquery optimizations <a id="subquery-optimizations"></a>
...
### Azure Blob Storage improvements <a id="azure-blob-storage-improvements"></a>
...
### Storage engine improvements <a id="storage-engine-improvements"></a>
...
### Format improvements <a id="format-improvements"></a>
...
### Data type and serialization optimizations <a id="data-type-and-serialization-optimizations"></a>
...
### Pipeline and execution improvements <a id="pipeline-and-execution-improvements"></a>
...
### Memory and resource optimizations <a id="memory-and-resource-optimizations"></a>
...
### Query planning and analysis <a id="query-planning-and-analysis"></a>
...
### Keeper improvements <a id="keeper-improvements"></a>
...
### Data lake improvements <a id="data-lake-improvements"></a>
...
### Access control and security <a id="access-control-and-security"></a>
...
### Backup and restore <a id="backup-and-restore"></a>
...
### Data integrity and validation <a id="data-integrity-and-validation"></a>
...
### Iceberg table engine <a id="iceberg-table-engine"></a>
...
### DeltaLake table engine <a id="deltalake-table-engine"></a>
...
### Data lake integration <a id="data-lake-integration"></a>
...
### S3 and object storage <a id="s3-and-object-storage"></a>
...
### S3Queue table engine <a id="s3queue-table-engine"></a>
...
### Kafka integration <a id="kafka-integration"></a>
...
### ClickHouse Keeper improvements <a id="clickhouse-keeper-improvements"></a>
...
### JSON and Dynamic types <a id="json-and-dynamic-types"></a>
...
### Parquet and ORC formats <a id="parquet-and-orc-formats"></a>
...
### Distributed queries and parallel replicas <a id="distributed-queries-and-parallel-replicas"></a>
...
### Settings and configuration <a id="settings-and-configuration"></a>
...
### System tables and observability <a id="system-tables-and-observability"></a>
...
### Database engines <a id="database-engines"></a>

### System and internal improvements <a id="system-and-internal-improvements"></a>
...
### Replication and synchronization <a id="replication-and-synchronization"></a>

### SystemAndInternalImprovements <a id="systemandinternalimprovements"></a>
...
### Functions and expressions <a id="functions-and-expressions"></a>
...
### MergeTree improvements <a id="mergetree-improvements"></a>
...
### Cache and memory management <a id="cache-and-memory-management"></a>
...
### Vector similarity index <a id="vector-similarity-index"></a>
...
### Error handling and messages <a id="error-handling-and-messages"></a>
...
### SQL formatting improvements <a id="sql-formatting-improvements"></a>
...
### External integrations <a id="external-integrations"></a>
...
### Miscellaneous improvements <a id="miscellaneous-improvements"></a>
...
#### Bug fixes (user-visible misbehavior in an official stable release) <a id="bug-fixes"></a>
...
### Query execution fixes <a id="query-execution-fixes"></a>
...
### Iceberg and DataLake fixes <a id="iceberg-and-datalake-fixes"></a>
...
### DeltaLake fixes <a id="deltalake-fixes"></a>
...
### TTL and MergeTree fixes <a id="ttl-and-mergetree-fixes"></a>
...
### Projection fixes <a id="projection-fixes"></a>
...
### Parallel replicas fixes <a id="parallel-replicas-fixes"></a>
...
### Authentication and security <a id="authentication-and-security"></a>
...
### Backup and restore fixes <a id="backup-and-restore-fixes"></a>
...
### Window and aggregate functions <a id="window-and-aggregate-functions"></a>
...
### Parquet and file format fixes <a id="parquet-and-file-format-fixes"></a>
...
### Replicated database fixes <a id="replicated-database-fixes"></a>
...
### Lightweight updates fixes <a id="lightweight-updates-fixes"></a>
...
### S3 and object storage fixes <a id="s3-and-object-storage-fixes"></a>
...
### DynamicAndVariantTypeFixes <a id="dynamicandvarianttypefixes"></a>
...
### Keeper fixes <a id="keeper-fixes"></a>
...
### Indexing fixes <a id="indexing-fixes"></a>
...
### Materialized view fixes <a id="materialized-view-fixes"></a>
...
### Azure and cloud storage fixes <a id="azure-and-cloud-storage-fixes"></a>
...
### Crash and stability fixes <a id="crash-and-stability-fixes"></a>
...
### Glue and catalog fixes <a id="glue-and-catalog-fixes"></a>
...
### Function fixes <a id="function-fixes"></a>
...
### Distributed query fixes <a id="distributed-query-fixes"></a>
...
### Metrics and monitoring fixes <a id="metrics-and-monitoring-fixes"></a>
...
### Data type and conversion fixes <a id="data-type-and-conversion-fixes"></a>
...
### Memory and resource management <a id="memory-and-resource-management"></a>
...
### Configuration and settings fixes <a id="configuration-and-settings-fixes"></a>
...
### MongoDB fixes <a id="mongodb-fixes"></a>
...
### Miscellaneous fixes <a id="miscellaneous-fixes"></a>
