...
### Query and function changes <a id="query-and-function-changes"></a>
...
### Client changes <a id="client-changes"></a>
...
### Statistics format changes <a id="statistics-format-changes"></a>
...
### Iceberg and data lakes <a id="iceberg-and-data-lakes"></a>
...
### Client and CLI features <a id="client-and-cli-features"></a>
...
### Server configuration and monitoring <a id="server-configuration-and-monitoring"></a>
...
### Input/Output formats <a id="input-output-formats"></a>
...
### Other new features <a id="other-new-features"></a>
...
### Query execution and optimization <a id="query-execution-and-optimization"></a>
...
### MergeTree and storage optimizations <a id="mergetree-and-storage-optimizations"></a>
...
### Index and text search optimizations <a id="index-and-text-search-optimizations"></a>
...
### Aggregation optimizations <a id="aggregation-optimizations"></a>
...
### S3 and backup optimizations <a id="s3-and-backup-optimizations"></a>
...
### Data lake optimizations <a id="data-lake-optimizations"></a>
...
### Query optimization and execution <a id="query-optimization-and-execution"></a>
...
### Storage and MergeTree improvements <a id="storage-and-mergetree-improvements"></a>
...
### System tables and monitoring <a id="system-tables-and-monitoring"></a>
...
### Client and UI improvements <a id="client-and-ui-improvements"></a>
...
### S3 and cloud storage improvements <a id="s3-and-cloud-storage-improvements"></a>
...
### Data lakes improvements <a id="data-lakes-improvements"></a>
...
### Kafka improvements <a id="kafka-improvements"></a>
...
### Input/Output format improvements <a id="input-output-format-improvements"></a>
...
### Data type and JSON fixes <a id="data-type-and-json-fixes"></a>
...
### Parquet and format fixes <a id="parquet-and-format-fixes"></a>
...
### Iceberg and data lake fixes <a id="iceberg-and-data-lake-fixes"></a>
...
### Memory and crash fixes <a id="memory-and-crash-fixes"></a>
...
### Security and access fixes <a id="security-and-access-fixes"></a>
...
### Other notable fixes <a id="other-notable-fixes"></a>
