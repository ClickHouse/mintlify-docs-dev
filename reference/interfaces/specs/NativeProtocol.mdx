...
### Transport security (TLS) <a id="transport-security"></a>
...
### Inter-server secret <a id="inter-server-secret"></a>
...
## Versioning and feature gates <a id="versioning-and-feature-gates"></a>

### Version negotiation <a id="version-negotiation"></a>
...
### Feature gates <a id="feature-gates"></a>
...
### Feature table <a id="feature-table"></a>
...
## Packet envelope <a id="packet-envelope"></a>
...
### Chunked framing (v54470+) <a id="chunked-framing"></a>
...
## Connection lifecycle <a id="connection-lifecycle"></a>
...
### Handshake phase <a id="handshake-phase"></a>
...
### Query phase <a id="query-phase"></a>
...
### INSERT phase <a id="insert-phase"></a>
...
## Message reference <a id="message-reference"></a>
...
### ClientHello (packet type 0) <a id="clienthello"></a>
...
### ServerHello (packet type 0) <a id="serverhello"></a>
...
### Addendum (no packet type) <a id="addendum"></a>
...
### Ping (packet type 4) <a id="ping"></a>
...
### Pong (packet type 4) <a id="pong"></a>
...
### Exception (packet type 2) <a id="exception"></a>
...
### Query (packet type 1) <a id="query"></a>
...
### ClientInfo (embedded in Query) <a id="clientinfo"></a>
...
### Inter-server authentication <a id="inter-server-authentication"></a>
...
### Data (packet type 1 server→client, packet type 2 client→server) <a id="data"></a>
...
### Progress (packet type 3) <a id="progress"></a>
...
### ProfileInfo (packet type 6) <a id="profileinfo"></a>
...
### Totals (packet type 7) <a id="totals"></a>
...
### Extremes (packet type 8) <a id="extremes"></a>
...
### ProfileEvents (packet type 14) <a id="profileevents"></a>
...
### TableColumns (packet type 11) <a id="tablecolumns"></a>
...
### TimezoneUpdate (packet type 17) <a id="timezoneupdate"></a>
...
### SSH challenge-response authentication (packet types 11, 12, 18) <a id="ssh-authentication"></a>
...
## Packet type reference <a id="packet-type-reference"></a>

### Client → Server <a id="client-to-server"></a>
...
### Server → Client <a id="server-to-client"></a>
...
### Transport-layer settings <a id="transport-layer-settings"></a>

#### Socket options <a id="socket-options"></a>
...
#### Connection limits <a id="connection-limits"></a>
...
### Application-layer settings <a id="application-layer-settings"></a>
...
#### Compression <a id="compression-settings"></a>
...
#### Progress reporting <a id="progress-reporting"></a>
...
#### Result envelope <a id="result-envelope"></a>
...
#### Async INSERT <a id="async-insert"></a>
...
#### Distributed tracing <a id="distributed-tracing"></a>
...
### Settings out of scope <a id="settings-out-of-scope"></a>
