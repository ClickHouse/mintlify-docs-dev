...
## Wire primitives <a id="wire-primitives"></a>
...
### Fixed-width integers <a id="fixed-width-integers"></a>
...
## Block and column structure <a id="block-and-column-structure"></a>

### Block wire layout <a id="block-wire-layout"></a>
...
### Column wire layout <a id="column-wire-layout"></a>
...
#### kind_stack and sparse encoding <a id="kind-stack-and-sparse-encoding"></a>
...
### Block variants <a id="block-variants"></a>
...
### Byte-level examples <a id="byte-level-examples"></a>
...
### Fixed-width types <a id="fixed-width-types"></a>
...
#### Integer types <a id="integer-types"></a>
...
#### Float32 and Float64 <a id="float32-and-float64"></a>
...
#### Date and Date32 <a id="date-and-date32"></a>
...
#### DateTime64(scale[, timezone]) <a id="datetime64"></a>
...
#### Time and Time64(scale) <a id="time-and-time64"></a>
...
#### IPv4 and IPv6 <a id="ipv4-and-ipv6"></a>
...
#### Enum8 and Enum16 <a id="enum8-and-enum16"></a>
...
### Variable-length types <a id="variable-length-types"></a>

Each value carries its own length on the wire.

#### String <a id="string-type"></a>
...
#### FixedString(N) <a id="fixedstring"></a>
...
### Composite types <a id="composite-types"></a>
...
#### Nested(name1 T1, name2 T2, ...) <a id="nested"></a>
...
### Versioned types <a id="versioned-types"></a>
...
#### Serialization version: concept <a id="serialization-version-concept"></a>
...
#### Serialization version reference <a id="serialization-version-reference"></a>
...
#### LowCardinality(T) <a id="lowcardinality"></a>
...
#### JSON (Tier 1: String fallback) <a id="json-tier-1-string-fallback"></a>
...
#### JSON (Tier 2: FLATTENED Object) <a id="json-tier-2-flattened-object"></a>
...
#### JSON non-flat (V2/V3) <a id="json-non-flat"></a>
...
## Compression frame <a id="compression-frame"></a>
...
### Frame format <a id="frame-format"></a>
...
### Method byte values <a id="method-byte-values"></a>
...
### Per-block boundaries <a id="per-block-boundaries"></a>
...
### Negotiation <a id="compression-negotiation"></a>
