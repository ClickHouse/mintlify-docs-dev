...
old-slug: /sql-reference/aggregate-functions/reference/quantilesExactExclusive
...
- `level` — Levels of quantiles. Constant floating-point numbers from 0 to 1 (exclusive). We recommend using `level` values in the range of `(0.01, 0.99)`. [`Float*`](/sql-reference/data-types/float)
