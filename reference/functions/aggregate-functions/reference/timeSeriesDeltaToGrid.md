...
- `start_timestamp` — Specifies start of the grid. [`UInt32`](/sql-reference/data-types/int-uint) or [`DateTime`](/sql-reference/data-types/datetime)
- `end_timestamp` — Specifies end of the grid. [`UInt32`](/sql-reference/data-types/int-uint) or [`DateTime`](/sql-reference/data-types/datetime)
- `grid_step` — Specifies step of the grid in seconds. [`UInt32`](/sql-reference/data-types/int-uint)
- `staleness` — Specifies the maximum staleness in seconds of the considered samples. The staleness window is a left-open and right-closed interval. [`UInt32`](/sql-reference/data-types/int-uint)
