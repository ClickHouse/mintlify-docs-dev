...
- `buckets` — The number of segments. [`(U)Int*`](/sql-reference/data-types/int-uint)
- `min_x` — Optional. The interval start. [`(U)Int*`](/sql-reference/data-types/int-uint) or [`Float*`](/sql-reference/data-types/float) or [`Decimal`](/sql-reference/data-types/decimal)
- `max_x` — Optional. The interval end. [`(U)Int*`](/sql-reference/data-types/int-uint) or [`Float*`](/sql-reference/data-types/float) or [`Decimal`](/sql-reference/data-types/decimal)
