...
old-slug: /sql-reference/aggregate-functions/reference/quantileExactExclusive
...
- `level` — Level of quantile. Constant floating-point number from 0 to 1 (exclusive). We recommend using a `level` value in the range of `(0.01, 0.99)`. [`Float*`](/sql-reference/data-types/float)
