...
- `population_variance_x` — Variance for population x. [`Float*`](/sql-reference/data-types/float)
- `population_variance_y` — Variance for population y. [`Float*`](/sql-reference/data-types/float)
- `confidence_level` — Confidence level in order to calculate confidence intervals. [`Float*`](/sql-reference/data-types/float)
