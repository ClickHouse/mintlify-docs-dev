...
## GROUPING SETS <a id="grouping-sets"></a>
...
### Simple queries <a id="simple-queries"></a>
...
### Comparing multiple GROUP BY statements with GROUPING SETS <a id="comparing-multiple-group-by-statements-with-grouping-sets"></a>
...
### Comparing CUBE with GROUPING SETS <a id="comparing-cube-with-grouping-sets"></a>
