...
Combines the [`groupArray`](/reference/functions/aggregate-functions/groupArray) function with the [Array](/reference/functions/aggregate-functions/combinators#-array) combinator.
