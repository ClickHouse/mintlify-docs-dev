...
### Reading with `storage_account_url` form <a id="reading-with-storage-account-url"></a>
...
### Reading with `connection_string` form <a id="reading-with-connection-string"></a>
...
### Writing with partitions <a id="writing-with-partitions"></a>
...
## Using Shared Access Signatures (SAS) <a id="using-shared-access-signatures-sas-sas-tokens"></a>
