...
### Returned value <a id="returned-value"></a>
...
## Defining a named collection <a id="defining-a-named-collection"></a>
...
## Using a data catalog <a id="iceberg-writes-catalogs"></a>
...
## Partition Pruning <a id="partition-pruning"></a>
...
## Processing of tables with deleted rows <a id="deleted-rows"></a>
...
#### Scenario 1: Schema Changes Without New Snapshots <a id="scenario-1"></a>
...
#### Scenario 2:  Historical vs. Current Schema Differences <a id="scenario-2"></a>
...
#### Scenario 3:  Historical vs. Current Schema Differences <a id="scenario-3"></a>
...
## Metadata File Resolution <a id="metadata-file-resolution"></a>
...
### Candidate Search (in Priority Order) <a id="candidate-search"></a>
...
### Selecting the Most Recent File <a id="most-recent-file"></a>
...
## Metadata cache <a id="metadata-cache"></a>
...
## Writes into iceberg table <a id="writes-into-iceberg-table"></a>
...
### Creating table <a id="create-iceberg-table"></a>
...
### Example <a id="example-iceberg-writes-create"></a>
...
### DELETE <a id="iceberg-writes-delete"></a>
...
### Example <a id="example-iceberg-writes-delete"></a>
...
### Compaction <a id="iceberg-writes-compaction"></a>
...
### Expire Snapshots <a id="iceberg-expire-snapshots"></a>
...
#### Snapshot Retention Policy <a id="iceberg-snapshot-retention-policy"></a>
...
### Remove Orphan Files <a id="iceberg-remove-orphan-files"></a>
