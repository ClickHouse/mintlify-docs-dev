...
### Selecting data from a remote server: <a id="selecting-data-from-a-remote-server"></a>
...
### Inserting data into a table on a remote server: <a id="inserting-data-into-a-table-on-a-remote-server"></a>
...
#### On the destination ClickHouse system <a id="on-the-destination-clickhouse-system"></a>
...
#### Back on the source deployment <a id="back-on-the-source-deployment"></a>
...
## Globbing <a id="globs-in-addresses"></a>
