...
| [mergeTreeTextIndex](/sql-reference/table-functions/mergeTreeTextIndex) | Represents the dictionary of a text index in a MergeTree table. It can be used for introspection. |
...
| [paimon](/sql-reference/table-functions/paimon) | Provides a read-only table-like interface to Apache Paimon tables in Amazon S3, Azure, HDFS or locally stored. |
...
| [paimonCluster](/sql-reference/table-functions/paimonCluster) | An extension to the paimon table function which allows processing files from Apache Paimon in parallel from many nodes in a specified cluster. |
...
| [timeSeriesSelector](/sql-reference/table-functions/timeSeriesSelector) | Reads time series from a TimeSeries table filtered by a selector and with timestamps in a specified interval. |
...
| [prometheusQueryRange](/sql-reference/table-functions/prometheusQueryRange) | Evaluates a prometheus query using data from a TimeSeries table. |
...
| [primes](/sql-reference/table-functions/primes) | Returns a table with a single `prime` column that contains prime numbers. |
...
| [numbers](/sql-reference/table-functions/numbers) | Returns a table with a single `number` column that contains a sequence of integers. |
| [prometheusQuery](/sql-reference/table-functions/prometheusQuery) | Evaluates a prometheus query using data from a TimeSeries table. |
...
| [arrowFlight](/sql-reference/table-functions/arrowflight) | Allows to perform queries on data exposed via an Apache Arrow Flight server. |
