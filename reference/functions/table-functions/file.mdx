...
## Examples for Writing to a File <a id="examples-for-writing-to-a-file"></a>

### Write to a TSV file <a id="write-to-a-tsv-file"></a>
...
### Partitioned write to multiple TSV files <a id="partitioned-write-to-multiple-tsv-files"></a>
...
## Examples for Reading from a File <a id="examples-for-reading-from-a-file"></a>

### SELECT from a CSV file <a id="select-from-a-csv-file"></a>
...
### Inserting data from a file into a table <a id="inserting-data-from-a-file-into-a-table"></a>
...
## Globs in path <a id="globs-in-path"></a>
