...
## MVTEncodeGeom <a id="mvtencodegeom"></a>
...
### Property types <a id="property-types"></a>
...
### Naming the properties tuple <a id="naming-the-properties-tuple"></a>
...
## MVTBoundingBox <a id="mvtboundingbox"></a>
...
## MVTBoundingBoxMercator <a id="mvtboundingboxmercator"></a>
...
## Restricting rows to a tile <a id="restricting-rows-to-a-tile"></a>
...
## Serving tiles over HTTP <a id="serving-tiles-over-http"></a>
