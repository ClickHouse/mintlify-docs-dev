...
## flipCoordinates <a id="flipcoordinates"></a>
...
#### Example 1: Flipping a Single Point <a id="example-1"></a>
```sql
...
#### Example 2: Flipping an Array of Points (Ring) <a id="example-2"></a>
```sql
...
#### Example 3: Flipping a Polygon <a id="example-3"></a>
```sql
...
#### Example 4: Flipping a Multipolygon <a id="example-4"></a>
```sql
