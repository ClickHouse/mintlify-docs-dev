...
### Using Conditional Results Directly <a id="using-conditional-results-directly"></a>
...
### NULL Values in Conditionals <a id="null-values-in-conditionals"></a>
...
### CASE statement <a id="case-statement"></a>
