...
## evalMLMethod <a id="evalmlmethod"></a>

Prediction using fitted regression models uses `evalMLMethod` function. See link in `linearRegression`.

## stochasticLinearRegression <a id="stochasticlinearregression"></a>
...
## stochasticLogisticRegression <a id="stochasticlogisticregression"></a>
...
## naiveBayesClassifier <a id="naivebayesclassifier"></a>
...
### Model Configuration <a id="model-configuration"></a>
