...
### Named collection parameters <a id="named-collection-parameters"></a>
...
### Query-level settings <a id="query-level-settings"></a>
...
### Use in `DEFAULT` and `MATERIALIZED` columns <a id="default-and-materialized-columns"></a>
...
### Restricting endpoint hosts <a id="restricting-endpoint-hosts"></a>
...
## Supported providers <a id="supported-providers"></a>
...
## aiTranslate <a id="aiTranslate"></a>
