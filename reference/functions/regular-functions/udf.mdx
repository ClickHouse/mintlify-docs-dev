...
## Executable User Defined Functions <a id="executable-user-defined-functions"></a>
...
### UDF from inline script <a id="udf-inline"></a>
...
### UDF from Python script <a id="udf-python"></a>
...
### Read two values from `STDIN` and return their sum as a JSON object <a id="udf-stdin"></a>
...
### Use parameters in `command` setting <a id="udf-parameters-in-command"></a>
...
### UDF from shell script <a id="udf-shell-script"></a>
...
## Evaluation of Argument Expressions <a id="evaluation-of-argument-expressions"></a>
...
## Performing Functions for Distributed Query Processing <a id="performing-functions-for-distributed-query-processing"></a>
...
## SQL User Defined Functions <a id="sql-user-defined-functions"></a>
...
## WebAssembly User Defined Functions <a id="webassembly-user-defined-functions"></a>
