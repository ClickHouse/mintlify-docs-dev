...
## Standard window functions <a id="standard-window-functions"></a>
...
## Functions usable only as window functions <a id="functions"></a>
...
| [`nonNegativeDerivative(metric_column, timestamp_column[, INTERVAL X UNITS])`](/reference/functions/window-functions/nonNegativeDerivative) | Compute the non-negative derivative of `metric_column` with respect to `timestamp_column`. Specific to ClickHouse.               |

## Examples <a id="examples"></a>

Let's have a look at some examples of how window functions can be used.

### Numbering rows <a id="numbering-rows"></a>
...
### Aggregation functions <a id="aggregation-functions"></a>
...
### Partitioning by column <a id="partitioning-by-column"></a>
...
### Frame bounding <a id="frame-bounding"></a>
...
### Maximum/total salary per department <a id="maximumtotal-salary-per-department"></a>
...
### Moving / sliding average (per 3 rows) <a id="moving--sliding-average-per-3-rows"></a>
...
### Moving / sliding average (per 10 seconds) <a id="moving--sliding-average-per-10-seconds"></a>
...
### Moving / sliding average (per 10 days) <a id="moving--sliding-average-per-10-days"></a>
...
### Postgres Docs <a id="postgres-docs"></a>
