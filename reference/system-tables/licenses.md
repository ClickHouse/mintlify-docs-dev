...
<!--AUTOGENERATED_START-->
- `library_name` ([String](../../sql-reference/data-types/)) — Name of the library.
- `license_type` ([String](../../sql-reference/data-types/)) — License type — e.g. Apache, MIT.
- `license_path` ([String](../../sql-reference/data-types/)) — Path to the file with the license text.
- `license_text` ([String](../../sql-reference/data-types/)) — License text.
<!--AUTOGENERATED_END-->
