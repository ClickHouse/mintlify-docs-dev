...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — Role name.
- `id` ([UUID](../../sql-reference/data-types/)) — Role ID.
- `storage` ([String](../../sql-reference/data-types/)) — Path to the storage of roles. Configured in the `access_control_path` parameter.
<!--AUTOGENERATED_END-->
