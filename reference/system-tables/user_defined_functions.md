...
old-slug: /operations/system-tables/user_defined_functions
title: 'system.user_defined_functions'
doc_type: 'reference'
---

Contains loading status, error information, and configuration metadata for [User-Defined Functions (UDFs)](/sql-reference/functions/udf).
...
-   [User-Defined Functions](/sql-reference/functions/udf) — How to create and configure UDFs.