...
<!--AUTOGENERATED_START-->
- `dashboard` ([String](../../sql-reference/data-types/)) — The dashboard name.
- `title` ([String](../../sql-reference/data-types/)) — The title of a chart.
- `query` ([String](../../sql-reference/data-types/)) — The query to obtain data to be displayed.
<!--AUTOGENERATED_END-->
