...
<!--AUTOGENERATED_START-->
- `type` ([Enum8('Session' = 0, 'MergeTree' = 1)](../../sql-reference/data-types/)) — The group of settings (Session, MergeTree...)
- `version` ([String](../../sql-reference/data-types/)) — The ClickHouse server version.
- `changes` ([Array(Tuple(name String, previous_value String, new_value String, reason String))](../../sql-reference/data-types/)) — The list of changes in settings which changed the behaviour of ClickHouse.
<!--AUTOGENERATED_END-->
