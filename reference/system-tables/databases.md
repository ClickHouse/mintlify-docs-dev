...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — Database name.
- `engine` ([String](../../sql-reference/data-types/)) — Database engine.
- `data_path` ([String](../../sql-reference/data-types/)) — Data path.
- `metadata_path` ([String](../../sql-reference/data-types/)) — Metadata path.
- `uuid` ([UUID](../../sql-reference/data-types/)) — Database UUID.
- `engine_full` ([String](../../sql-reference/data-types/)) — Parameters of the database engine.
- `comment` ([String](../../sql-reference/data-types/)) — Database comment.
- `is_external` ([UInt8](../../sql-reference/data-types/)) — Database is external (i.e. PostgreSQL/DataLakeCatalog).
<!--AUTOGENERATED_END-->
