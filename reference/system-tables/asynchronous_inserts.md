...
<!--AUTOGENERATED_START-->
- `query` ([String](../../sql-reference/data-types/)) — Query text.
...
- `first_update` ([DateTime64(6)](../../sql-reference/data-types/)) — First insert time with microseconds resolution.
- `total_bytes` ([UInt64](../../sql-reference/data-types/)) — Total number of bytes waiting in the queue.
- `entries.query_id` ([Array(String)](../../sql-reference/data-types/)) — Array of query ids of the inserts waiting in the queue.
- `entries.bytes` ([Array(UInt64)](../../sql-reference/data-types/)) — Array of bytes of each insert query waiting in the queue.
<!--AUTOGENERATED_END-->
