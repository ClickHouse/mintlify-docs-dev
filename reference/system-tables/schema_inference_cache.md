...
<!--AUTOGENERATED_START-->
- `storage` ([String](../../sql-reference/data-types/)) — Storage name: File, URL, S3 or HDFS.
- `source` ([String](../../sql-reference/data-types/)) — File source.
- `format` ([String](../../sql-reference/data-types/)) — Format name.
- `additional_format_info` ([String](../../sql-reference/data-types/)) — Additional information required to identify the schema. For example, format specific settings.
- `registration_time` ([DateTime](../../sql-reference/data-types/)) — Timestamp when schema was added in cache.
- `schema` ([Nullable(String)](../../sql-reference/data-types/)) — Cached schema.
- `number_of_rows` ([Nullable(UInt64)](../../sql-reference/data-types/)) — Number of rows in the file in given format. It's used for caching trivial count() from data files and for caching number of rows from the metadata during schema inference.
- `schema_inference_mode` ([Nullable(String)](../../sql-reference/data-types/)) — Scheme inference mode.
<!--AUTOGENERATED_END-->
