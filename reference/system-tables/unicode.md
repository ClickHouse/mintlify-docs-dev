...
<!--AUTOGENERATED_START-->
- `code_point` ([String](../../sql-reference/data-types/)) — The Unicode code point represented as U+XXXX.
- `code_point_value` ([Int32](../../sql-reference/data-types/)) — The integer value of the Unicode code point.
- `notation` ([String](../../sql-reference/data-types/)) — The character notation (visual representation of the code point).
<!--AUTOGENERATED_END-->
