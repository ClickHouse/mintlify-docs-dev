...
<!--AUTOGENERATED_START-->
- `symbol` ([String](../../sql-reference/data-types/)) — Symbol name in the binary. It is mangled. You can apply demangle(symbol) to obtain a readable name.
- `address_begin` ([UInt64](../../sql-reference/data-types/)) — Start address of the symbol in the binary.
- `address_end` ([UInt64](../../sql-reference/data-types/)) — End address of the symbol in the binary.
<!--AUTOGENERATED_END-->
