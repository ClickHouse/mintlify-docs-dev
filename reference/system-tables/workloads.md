...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — The name of the workload.
- `parent` ([String](../../sql-reference/data-types/)) — The name of the parent workload.
- `create_query` ([String](../../sql-reference/data-types/)) — CREATE query of the workload.
<!--AUTOGENERATED_END-->
