...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — The name of the resource.
- `read_disks` ([Array(String)](../../sql-reference/data-types/)) — The list of disk names that uses this resource for read operations.
- `write_disks` ([Array(String)](../../sql-reference/data-types/)) — The list of disk names that uses this resource for write operations.
- `unit` ([String](../../sql-reference/data-types/)) — Resource unit used for cost measurements.
- `create_query` ([String](../../sql-reference/data-types/)) — CREATE query of the resource.
<!--AUTOGENERATED_END-->
