...
<!--AUTOGENERATED_START-->
- `disk_name` ([String](../../sql-reference/data-types/)) — Disk name.
- `path` ([String](../../sql-reference/data-types/)) — Disk path.
- `cache_base_path` ([String](../../sql-reference/data-types/)) — Base directory of cache files.
- `local_path` ([String](../../sql-reference/data-types/)) — Path of ClickHouse file, also used as metadata path.
- `remote_path` ([String](../../sql-reference/data-types/)) — Blob path in object storage, with which ClickHouse file is associated with.
- `size` ([UInt64](../../sql-reference/data-types/)) — Size of the file (compressed).
- `common_prefix_for_blobs` ([String](../../sql-reference/data-types/)) — Common prefix for blobs in object storage.
- `cache_paths` ([Array(String)](../../sql-reference/data-types/)) — Cache files for corresponding blob.
<!--AUTOGENERATED_END-->
