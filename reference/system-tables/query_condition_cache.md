...
<!--AUTOGENERATED_START-->
- `key_hash` ([UInt128](../../sql-reference/data-types/)) — Hash of (table_uuid, part_name, condition_hash).
- `entry_size` ([UInt64](../../sql-reference/data-types/)) — The size of the entry in bytes.
- `matching_marks` ([String](../../sql-reference/data-types/)) — Matching marks.
<!--AUTOGENERATED_END-->
