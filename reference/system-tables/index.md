...
| [system.iceberg_metadata_log](/operations/system-tables/iceberg_metadata_log) | System table containing information about metadata files read from Iceberg tables. Each entry represents either a root metadata file, metadata extracted from an Avro file, or an entry of some Avro file. |
| [system.instrumentation](/operations/system-tables/instrumentation) | System table containing the instrumentation points |
| [system.jemalloc_stats](/operations/system-tables/jemalloc_stats) | Returns jemalloc statistics in a single row with a single column. Equivalent to SYSTEM JEMALLOC STATS command. |
...
| [system.jemalloc_profile_text](/operations/system-tables/jemalloc_profile_text) | Displays the symbolized jemalloc heap profile. Run 'SYSTEM JEMALLOC FLUSH PROFILE' to generate a profile first. |
...
| [system.keywords](/operations/system-tables/keywords) | Contains a list of all keywords used in ClickHouse parser. |
...
| [system.macros](/operations/system-tables/macros) | Contains a list of all macros defined in server configuration. |
| [system.masking_policies](/operations/system-tables/masking_policies) | System table containing information about all masking policies in the system. |
...
| [system.models](/operations/system-tables/models) | Contains a list of CatBoost models loaded into a LibraryBridge's memory along with time when it was loaded. |
...
| [system.named_collections](/operations/system-tables/named_collections) | Contains a list of all named collections which were created via SQL query or parsed from configuration file. |
...
| [system.part_moves_between_shards](/operations/system-tables/part_moves_between_shards) | Contains information about parts which are currently in a process of moving between shards and their progress. |
...
| [system.predicate_statistics_log](/operations/system-tables/predicate_statistics_log) | System table containing sampled filter and index selectivity statistics collected from `MergeTree` read pipelines during query execution. |
...
| [system.zeros](/operations/system-tables/zeros) | Produces unlimited number of non-materialized zeros. |
| [system.zeros_mt](/operations/system-tables/zeros_mt) | Multithreaded version of system.zeros. |
| [system.zookeeper_watches](/operations/system-tables/zookeeper_watches) | System table showing currently active ZooKeeper watches registered by this ClickHouse server. |
| [system.zookeeper_info](/operations/system-tables/zookeeper_info) | System table which outputs introspection of all available keeper nodes. |
