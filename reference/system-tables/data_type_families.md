...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — Data type name.
- `case_insensitive` ([UInt8](../../sql-reference/data-types/)) — Property that shows whether you can use a data type name in a query in case insensitive manner or not. For example, `Date` and `date` are both valid.
- `alias_to` ([String](../../sql-reference/data-types/)) — Data type name for which `name` is an alias.
<!--AUTOGENERATED_END-->
