...
- [SYSTEM INSTRUMENT](/sql-reference/statements/system#instrument) — Add or remove instrumentation points.
- [system.trace_log](/operations/system-tables/trace_log) — Inspect profiling log.
- [system.symbols](/operations/system-tables/symbols) — Inspect symbols to add instrumentation points.