...
<!--AUTOGENERATED_START-->
- `hostname` ([String](../../sql-reference/data-types/)) — Hostname.
- `ip_address` ([String](../../sql-reference/data-types/)) — IP address.
- `ip_family` ([Enum8('IPv4' = 0, 'IPv6' = 1, 'UNIX_LOCAL' = 2)](../../sql-reference/data-types/)) — IP address family.
- `cached_at` ([DateTime](../../sql-reference/data-types/)) — Record cached timestamp.
<!--AUTOGENERATED_END-->
