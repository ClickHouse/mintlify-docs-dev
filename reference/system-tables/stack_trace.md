...
<!--AUTOGENERATED_START-->
- `thread_name` ([String](../../sql-reference/data-types/)) — The name of the thread.
- `thread_id` ([UInt64](../../sql-reference/data-types/)) — The thread identifier
- `query_id` ([String](../../sql-reference/data-types/)) — The ID of the query this thread belongs to.
- `trace` ([Array(UInt64)](../../sql-reference/data-types/)) — The stacktrace of this thread. Basically just an array of addresses.
- `untracked_memory` ([Int64](../../sql-reference/data-types/)) — Per-thread atomic-less counter of memory allocations not yet propagated to the parent MemoryTracker. May be negative if more was freed than allocated since the last flush.
<!--AUTOGENERATED_END-->
