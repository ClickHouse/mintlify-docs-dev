...
<!--AUTOGENERATED_START-->
- `metric` ([String](../../sql-reference/data-types/)) — Metric name.
- `value` ([Int64](../../sql-reference/data-types/)) — Metric value.
- `description` ([String](../../sql-reference/data-types/)) — Metric description.
<!--AUTOGENERATED_END-->
...
Number of queued or active jobs in the distributed idnex analysis thread pool.
