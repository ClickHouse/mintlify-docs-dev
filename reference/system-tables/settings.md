...
- `changed` ([UInt8](../../sql-reference/data-types/)) — Shows whether the setting was explicitly defined in the config or explicitly changed.
- `description` ([String](../../sql-reference/data-types/)) — Short setting description.
- `min` ([Nullable(String)](../../sql-reference/data-types/)) — Minimum value of the setting, if any is set via constraints. If the setting has no minimum value, contains NULL.
- `max` ([Nullable(String)](../../sql-reference/data-types/)) — Maximum value of the setting, if any is set via constraints. If the setting has no maximum value, contains NULL.
- `disallowed_values` ([Array(String)](../../sql-reference/data-types/)) — List of disallowed values
- `readonly` ([UInt8](../../sql-reference/data-types/)) — Shows whether the current user can change the setting: 0 — Current user can change the setting, 1 — Current user can't change the setting.
- `type` ([String](../../sql-reference/data-types/)) — The type of the value that can be assigned to this setting.
- `default` ([String](../../sql-reference/data-types/)) — Setting default value.
- `alias_for` ([String](../../sql-reference/data-types/)) — The name of the original setting if the setting is an alias for another setting.
- `is_obsolete` ([UInt8](../../sql-reference/data-types/)) — Shows whether a setting is obsolete.
