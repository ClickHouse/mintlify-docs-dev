...
- `parts_to_merge` ([Array(String)](../../sql-reference/data-types/)) — Names of parts to merge or update.
...
- `last_exception_time` ([DateTime](../../sql-reference/data-types/)) — Date and time when the last error occurred.
- `last_attempt_time` ([DateTime](../../sql-reference/data-types/)) — Date and time when the task was last attempted.
- `num_postponed` ([UInt32](../../sql-reference/data-types/)) — The number of times the action was postponed.
