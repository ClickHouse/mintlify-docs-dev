...
<!--AUTOGENERATED_START-->
- `name` ([String](../../sql-reference/data-types/)) — Server setting name.
- `value` ([String](../../sql-reference/data-types/)) — Server setting value.
- `default` ([String](../../sql-reference/data-types/)) — Server setting default value.
- `changed` ([UInt8](../../sql-reference/data-types/)) — Shows whether a setting was specified in config.xml
- `description` ([String](../../sql-reference/data-types/)) — Short server setting description.
- `type` ([String](../../sql-reference/data-types/)) — Server setting value type.
- `changeable_without_restart` ([Enum8('No' = 0, 'IncreaseOnly' = 1, 'DecreaseOnly' = 2, 'Yes' = 3)](../../sql-reference/data-types/)) — Shows whether a setting can be changed at runtime.
