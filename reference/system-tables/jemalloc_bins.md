...
<!--AUTOGENERATED_START-->
- `index` ([UInt16](../../sql-reference/data-types/)) — Index of the bin ordered by size.
- `large` ([UInt8](../../sql-reference/data-types/)) — True for large allocations and False for small.
- `size` ([UInt64](../../sql-reference/data-types/)) — Size of allocations in this bin.
- `allocations` ([Int64](../../sql-reference/data-types/)) — Number of allocations.
- `deallocations` ([Int64](../../sql-reference/data-types/)) — Number of deallocations.
- `nregs` ([Int64](../../sql-reference/data-types/)) — Number of regions per slab.
- `curslabs` ([Int64](../../sql-reference/data-types/)) — Current number of slabs.
- `curregs` ([Int64](../../sql-reference/data-types/)) — Current number of regions for this size class.
<!--AUTOGENERATED_END-->
