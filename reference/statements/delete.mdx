...
## Lightweight `DELETE` does not delete data immediately <a id="lightweight-delete-does-not-delete-data-immediately"></a>
...
## Deleting large amounts of data <a id="deleting-large-amounts-of-data"></a>
...
## Limitations of lightweight `DELETE` <a id="limitations-of-lightweight-delete"></a>

### Lightweight `DELETE`s with projections <a id="lightweight-deletes-with-projections"></a>
...
## Performance considerations when using lightweight `DELETE` <a id="performance-considerations-when-using-lightweight-delete"></a>
...
## Delete permissions <a id="delete-permissions"></a>
...
## How lightweight DELETEs work internally in ClickHouse <a id="how-lightweight-deletes-work-internally-in-clickhouse"></a>
