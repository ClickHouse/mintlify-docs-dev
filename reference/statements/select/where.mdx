...
The expression following the `WHERE` clause is often used with [comparison](/reference/operators/index#comparison-operators) and [logical operators](/reference/operators/index#operators-for-working-with-data-sets), or one of the many [regular functions](/reference/functions/regular-functions/regular-functions-index).
...
## Testing for `NULL` <a id="testing-for-null"></a>
...
## Filtering data with logical operators <a id="filtering-data-with-logical-operators"></a>
...
## Using UInt8 columns as a condition <a id="using-uint8-columns-as-a-condition"></a>
...
## Using comparison operators <a id="using-comparison-operators"></a>
...
## Pattern matching and conditional expressions <a id="pattern-matching-and-conditional-expressions"></a>
...
## Expression with literals, columns or subqueries <a id="expressions-with-literals-columns-subqueries"></a>
...
### Testing for `NULL` <a id="examples-testing-for-null"></a>
...
### Filtering data with logical operators <a id="example-filtering-with-logical-operators"></a>
...
### Using UInt8 columns as a condition <a id="example-uint8-column-as-condition"></a>
...
### Using comparison operators <a id="example-using-comparison-operators"></a>
...
### Pattern matching and conditional expressions <a id="examples-pattern-matching-and-conditional-expressions"></a>

The examples below use the table and data from the [example](#example-filtering-with-logical-operators) above. Results are omitted for sake of brevity.

#### LIKE examples <a id="like-examples"></a>
...
#### ILIKE examples <a id="ilike-examples"></a>
...
#### IF examples <a id="if-examples"></a>
...
#### multiIf examples <a id="multiif-examples"></a>
...
#### CASE examples <a id="case-examples"></a>
