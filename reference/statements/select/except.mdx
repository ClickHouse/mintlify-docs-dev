...
### Filtering Numbers Using the `EXCEPT` Clause <a id="filtering-numbers-using-the-except-clause"></a>
...
### Excluding Specific Columns Using `EXCEPT()` <a id="excluding-specific-columns-using-except"></a>
...
### Using `EXCEPT` and `INTERSECT` with Cryptocurrency Data <a id="using-except-and-intersect-with-cryptocurrency-data"></a>
...
### Using `EXCEPT DISTINCT` <a id="using-except-distinct"></a>
