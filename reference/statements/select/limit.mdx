...
## Negative limits <a id="negative-limits"></a>
...
## Fractional limits <a id="fractional-limits"></a>
...
## Combining limit types <a id="combining-limit-types"></a>
...
## LIMIT ... WITH TIES <a id="limit--with-ties-modifier"></a>
