...
## Common Table Expressions <a id="common-table-expressions"></a>
...
### Syntax <a id="common-table-expressions-syntax"></a>

```sql
WITH <identifier> AS [MATERIALIZED] <subquery expression>
```

### Example <a id="common-table-expressions-example"></a>
...
## Materialized Common Table Expressions <a id="materialized-common-table-expressions"></a>
...
### Syntax <a id="materialized-common-table-expressions-syntax"></a>
...
### When to use <a id="materialized-cte-when-to-use"></a>
...
### Examples <a id="materialized-common-table-expressions-examples"></a>
...
### Restrictions <a id="materialized-cte-restrictions"></a>
...
## Common Scalar Expressions <a id="common-scalar-expressions"></a>
...
### Syntax <a id="common-scalar-expressions-syntax"></a>

```sql
WITH <expression> AS <identifier>
```

### Examples <a id="common-scalar-expressions-examples"></a>
...
## Recursive Queries <a id="recursive-queries"></a>
...
### Search order <a id="search-order"></a>
...
### Cycle detection <a id="cycle-detection"></a>
...
### Infinite queries <a id="infinite-queries"></a>
...
## Trailing Comma <a id="trailing-comma"></a>
