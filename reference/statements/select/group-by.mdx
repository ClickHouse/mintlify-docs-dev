...
## ROLLUP Modifier <a id="rollup-modifier"></a>
...
## CUBE Modifier <a id="cube-modifier"></a>
...
## WITH TOTALS Modifier <a id="with-totals-modifier"></a>
...
### Configuring Totals Processing <a id="configuring-totals-processing"></a>
...
## GROUP BY ALL <a id="group-by-all"></a>
...
## GROUPING SETS modifier <a id="grouping-sets-modifier"></a>
...
### GROUP BY Optimization Depending on Table Sorting Key <a id="group-by-optimization-depending-on-table-sorting-key"></a>
...
### GROUP BY in External Memory <a id="group-by-in-external-memory"></a>
