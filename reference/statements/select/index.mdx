...
## SELECT Clause <a id="select-clause"></a>
...
### Dynamic column selection <a id="dynamic-column-selection"></a>
...
#### Select columns with `LIKE` or `ILIKE` <a id="select-columns-with-like-or-ilike"></a>
...
### Extreme Values <a id="extreme-values"></a>
...
## SELECT modifiers <a id="select-modifiers"></a>
...
### Modifier Combinations <a id="modifier-combinations"></a>
...
## SETTINGS in SELECT Query <a id="settings-in-select-query"></a>
