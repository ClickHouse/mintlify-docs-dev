...
## Supported types of JOIN <a id="supported-types-of-join"></a>
...
## ON section conditions <a id="on-section-conditions"></a>
...
## JOIN with inequality conditions for columns from different tables <a id="join-with-inequality-conditions-for-columns-from-different-tables"></a>
...
## NULL values in JOIN keys <a id="null-values-in-join-keys"></a>
...
## ASOF JOIN usage <a id="asof-join-usage"></a>
...
## PASTE JOIN usage <a id="paste-join-usage"></a>
...
## Distributed JOIN <a id="distributed-join"></a>
...
## Implicit type conversion <a id="implicit-type-conversion"></a>
...
## Usage recommendations <a id="usage-recommendations"></a>

### Processing of empty or NULL cells <a id="processing-of-empty-or-null-cells"></a>
...
### Syntax Limitations <a id="syntax-limitations"></a>
...
### Memory limitations <a id="memory-limitations"></a>
