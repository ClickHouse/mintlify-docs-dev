...
## Data Type Validation <a id="data-type-validation"></a>
...
## Inserting the Results of SELECT <a id="inserting-the-results-of-select"></a>
...
## Inserting Data from a File <a id="inserting-data-from-a-file"></a>
...
### Single file with FROM INFILE <a id="single-file-with-from-infile"></a>
...
### Multiple files with FROM INFILE using globs <a id="multiple-files-with-from-infile-using-globs"></a>
...
## Inserting using a Table Function <a id="inserting-using-a-table-function"></a>
...
## Inserting into ClickHouse Cloud <a id="inserting-into-clickhouse-cloud"></a>
...
## Inserting into a replicated setup <a id="inserting-into-a-replicated-setup"></a>
...
### Large or long-running inserts <a id="large-or-long-running-inserts"></a>
