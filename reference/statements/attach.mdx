...
## Attach Existing Table <a id="attach-existing-table"></a>
...
## Create New Table And Attach Data <a id="create-new-table-and-attach-data"></a>

### With Specified Path to Table Data <a id="with-specified-path-to-table-data"></a>
...
### With Specified Table UUID <a id="with-specified-table-uuid"></a>
...
## Attach MergeTree table as ReplicatedMergeTree <a id="attach-mergetree-table-as-replicatedmergetree"></a>
...
## Attach Existing Dictionary <a id="attach-existing-dictionary"></a>
...
## Attach Existing Database <a id="attach-existing-database"></a>
