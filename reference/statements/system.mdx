...
## SYSTEM RELOAD EMBEDDED DICTIONARIES <a id="reload-embedded-dictionaries"></a>
...
## SYSTEM RELOAD DICTIONARIES <a id="reload-dictionaries"></a>
...
## SYSTEM RELOAD DICTIONARY <a id="reload-dictionary"></a>
...
## SYSTEM RELOAD MODELS <a id="reload-models"></a>
...
## SYSTEM RELOAD MODEL <a id="reload-model"></a>
...
## SYSTEM RELOAD FUNCTIONS <a id="reload-functions"></a>
...
## SYSTEM RELOAD ASYNCHRONOUS METRICS <a id="reload-asynchronous-metrics"></a>
...
## SYSTEM CLEAR|DROP DNS CACHE <a id="drop-dns-cache"></a>
...
## SYSTEM CLEAR|DROP MARK CACHE <a id="drop-mark-cache"></a>

Clears the mark cache.

## SYSTEM CLEAR|DROP ICEBERG METADATA CACHE <a id="drop-iceberg-metadata-cache"></a>

Clears the iceberg metadata cache.

## SYSTEM CLEAR|DROP AVRO SCHEMA CACHE <a id="drop-avro-schema-cache"></a>
...
## SYSTEM DROP PARQUET METADATA CACHE <a id="drop-parquet-metadata-cache"></a>

Clears the parquet metadata cache.

## SYSTEM CLEAR|DROP TEXT INDEX CACHES <a id="drop-text-index-caches"></a>
...
## SYSTEM DROP REPLICA <a id="drop-replica"></a>
...
## SYSTEM DROP DATABASE REPLICA <a id="drop-database-replica"></a>
...
## SYSTEM CLEAR|DROP UNCOMPRESSED CACHE <a id="drop-uncompressed-cache"></a>
...
## SYSTEM CLEAR|DROP COMPILED EXPRESSION CACHE <a id="drop-compiled-expression-cache"></a>
...
## SYSTEM CLEAR|DROP QUERY CONDITION CACHE <a id="drop-query-condition-cache"></a>

Clears the query condition cache.

## SYSTEM CLEAR|DROP QUERY CACHE <a id="drop-query-cache"></a>
...
## SYSTEM CLEAR|DROP FORMAT SCHEMA CACHE <a id="system-drop-schema-format"></a>
...
## SYSTEM FLUSH LOGS <a id="flush-logs"></a>
...
## SYSTEM RELOAD CONFIG <a id="reload-config"></a>
...
## SYSTEM RELOAD USERS <a id="reload-users"></a>
...
### SYSTEM INSTRUMENT ADD <a id="instrument-add"></a>
...
#### SLEEP <a id="instrument-add-sleep"></a>
...
#### PROFILE <a id="instrument-add-profile"></a>
...
### SYSTEM INSTRUMENT REMOVE <a id="instrument-remove"></a>
...
## Managing Distributed Tables <a id="managing-distributed-tables"></a>
...
### SYSTEM STOP DISTRIBUTED SENDS <a id="stop-distributed-sends"></a>
...
### SYSTEM FLUSH DISTRIBUTED <a id="flush-distributed"></a>
...
### SYSTEM START DISTRIBUTED SENDS <a id="start-distributed-sends"></a>
...
### SYSTEM STOP LISTEN <a id="stop-listen"></a>
...
### SYSTEM START LISTEN <a id="start-listen"></a>
...
## Managing MergeTree Tables <a id="managing-mergetree-tables"></a>
...
### SYSTEM STOP MERGES <a id="stop-merges"></a>
...
### SYSTEM START MERGES <a id="start-merges"></a>
...
### SYSTEM STOP TTL MERGES <a id="stop-ttl-merges"></a>
...
### SYSTEM START TTL MERGES <a id="start-ttl-merges"></a>
...
### SYSTEM STOP MOVES <a id="stop-moves"></a>
...
### SYSTEM START MOVES <a id="start-moves"></a>
...
### SYSTEM UNFREEZE <a id="query_language-system-unfreeze"></a>
...
### SYSTEM WAIT LOADING PARTS <a id="wait-loading-parts"></a>
...
## Managing ReplicatedMergeTree Tables <a id="managing-replicatedmergetree-tables"></a>
...
### SYSTEM STOP FETCHES <a id="stop-fetches"></a>
...
### SYSTEM START FETCHES <a id="start-fetches"></a>
...
### SYSTEM STOP REPLICATED SENDS <a id="stop-replicated-sends"></a>
...
### SYSTEM START REPLICATED SENDS <a id="start-replicated-sends"></a>
...
### SYSTEM STOP REPLICATION QUEUES <a id="stop-replication-queues"></a>
...
### SYSTEM START REPLICATION QUEUES <a id="start-replication-queues"></a>
...
### SYSTEM STOP PULLING REPLICATION LOG <a id="stop-pulling-replication-log"></a>
...
### SYSTEM START PULLING REPLICATION LOG <a id="start-pulling-replication-log"></a>
...
### SYSTEM SYNC REPLICA <a id="sync-replica"></a>
...
### SYNC DATABASE REPLICA <a id="sync-database-replica"></a>
...
### SYSTEM RESTART REPLICA <a id="restart-replica"></a>
...
### SYSTEM RESTORE REPLICA <a id="restore-replica"></a>
...
### SYSTEM RESTORE DATABASE REPLICA <a id="restore-database-replica"></a>
...
### SYSTEM RESTART REPLICAS <a id="restart-replicas"></a>
...
### SYSTEM CLEAR|DROP FILESYSTEM CACHE <a id="drop-filesystem-cache"></a>
...
### SYSTEM SYNC FILE CACHE <a id="sync-file-cache"></a>
...
### SYSTEM LOAD PRIMARY KEY <a id="load-primary-key"></a>
...
### SYSTEM UNLOAD PRIMARY KEY <a id="unload-primary-key"></a>
...
## Managing Refreshable Materialized Views <a id="managing-refreshable-materialized-views"></a>
...
### SYSTEM STOP [REPLICATED] VIEW, STOP VIEWS <a id="stop-view-stop-views"></a>
...
### SYSTEM START [REPLICATED] VIEW, START VIEWS <a id="start-view-start-views"></a>
...
### SYSTEM PAUSE VIEW, PAUSE VIEWS <a id="pause-view-pause-views"></a>
...
### SYSTEM REFRESH VIEW <a id="refresh-view"></a>
...
### SYSTEM WAIT VIEW <a id="wait-view"></a>
...
### SYSTEM CANCEL VIEW <a id="cancel-view"></a>
...
## SYSTEM FLUSH OBJECT STORAGE QUEUE <a id="flush-object-storage-queue"></a>
