...
## EXPLAIN Types <a id="explain-types"></a>
...
### EXPLAIN AST <a id="explain-ast"></a>
...
### EXPLAIN SYNTAX <a id="explain-syntax"></a>
...
### EXPLAIN QUERY TREE <a id="explain-query-tree"></a>
...
### EXPLAIN PIPELINE <a id="explain-pipeline"></a>
      ...
      AggregatingTransform × 2
        ...
        ExpressionTransform × 2
          (SettingQuotaAndLimits)
            ...
            NumbersRange × 2 0 → 1
```
### EXPLAIN ESTIMATE <a id="explain-estimate"></a>
...
### EXPLAIN TABLE OVERRIDE <a id="explain-table-override"></a>
