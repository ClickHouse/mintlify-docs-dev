...
## Replacing vs. modifying settings <a id="replacing-vs-modifying"></a>
...
### Replacing form: bare `SETTINGS` / `INHERIT` <a id="replacing-form"></a>
...
### Incremental form: `ADD` / `MODIFY` / `DROP` <a id="incremental-form"></a>
...
```
## Incremental vs full replacement <a id="incremental-vs-full-replacement"></a>
...
## ADD vs MODIFY <a id="add-vs-modify"></a>
...
## Examples <a id="profile-examples"></a>
...
### MODIFY SETTINGS <a id="example-modify-settings"></a>
...
### ADD SETTINGS <a id="example-add-settings"></a>
...
### DROP SETTINGS <a id="example-drop-settings"></a>
...
### Working with inherited profiles <a id="example-profiles"></a>
