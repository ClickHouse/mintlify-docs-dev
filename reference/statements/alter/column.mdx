...
## DROP COLUMN <a id="drop-column"></a>
...
## RENAME COLUMN <a id="rename-column"></a>
...
## CLEAR COLUMN <a id="clear-column"></a>
...
## COMMENT COLUMN <a id="comment-column"></a>
...
## MODIFY COLUMN <a id="modify-column"></a>
...
## MODIFY COLUMN REMOVE <a id="modify-column-remove"></a>
...
## MODIFY COLUMN MODIFY SETTING <a id="modify-column-modify-setting"></a>
...
## MODIFY COLUMN RESET SETTING <a id="modify-column-reset-setting"></a>
...
## MODIFY COLUMN ADD ENUM VALUES <a id="modify-column-add-enum-values"></a>
...
## MATERIALIZE COLUMN <a id="materialize-column"></a>
