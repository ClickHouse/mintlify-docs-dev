...
<Note>
- It only works for tables in the [`MergeTree`](/engines/table-engines/mergetree-family/mergetree) family (including [replicated](/engines/table-engines/mergetree-family/replication) tables).
