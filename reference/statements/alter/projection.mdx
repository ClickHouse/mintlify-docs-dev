...
## Overview of projections <a id="overview"></a>
...
## Using projections <a id="examples"></a>

### Example filtering without using primary keys <a id="example-filtering-without-using-primary-keys"></a>
...
### Example pre-aggregation query <a id="example-pre-aggregation-query"></a>
...
### Creating and using projection indexes <a id="projection-indexes"></a>
...
## Manipulating projections <a id="manipulating-projections"></a>
...
### ADD PROJECTION <a id="add-projection"></a>
...
#### `WITH SETTINGS` Clause <a id="with-settings"></a>
...
### DROP PROJECTION <a id="drop-projection"></a>
...
### MATERIALIZE PROJECTION <a id="materialize-projection"></a>
...
### CLEAR PROJECTION <a id="clear-projection"></a>
...
### Controlling projection merge behavior <a id="control-projections-merges"></a>
