...
### Known Vulnerability of the ODBC Dictionary Functionality <a id="known-vulnerability-of-the-odbc-dictionary-functionality"></a>
...
### Example of Connecting Postgresql <a id="example-of-connecting-postgresql"></a>
...
### Example of Connecting MS SQL Server <a id="example-of-connecting-ms-sql-server"></a>
