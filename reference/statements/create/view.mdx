...
## Normal View <a id="normal-view"></a>
...
## Parameterized View <a id="parameterized-view"></a>
...
## Materialized View <a id="materialized-view"></a>
...
### CREATE OR REPLACE MATERIALIZED VIEW <a id="create-or-replace-materialized-view"></a>
...
## SQL security <a id="sql_security"></a>
...
## Refreshable Materialized View <a id="refreshable-materialized-view"></a>
...
### Refresh Schedule <a id="refresh-schedule"></a>
...
### In Replicated DB <a id="in-replicated-db"></a>
...
### Refresh Dependencies <a id="refresh-dependencies"></a>
...
#### Using DEPENDS ON for consistent propagation latency <a id="using-depends-on-for-consistent-propagation-latency"></a>
...
#### Using DEPENDS ON for batched stream processing <a id="using-depends-on-for-batched-stream-processing"></a>
...
### Refresh Settings <a id="refresh-settings"></a>
...
### Changing Refresh Parameters <a id="changing-refresh-parameters"></a>
...
### Other operations <a id="other-operations"></a>
...
## Window View <a id="window-view"></a>
...
### Time Window Functions <a id="time-window-functions"></a>
...
### TIME ATTRIBUTES <a id="time-attributes"></a>
...
### Monitoring New Windows <a id="monitoring-new-windows"></a>
...
### Window View Usage <a id="window-view-usage"></a>
...
## Temporary Views <a id="temporary-views"></a>
...
### Syntax <a id="temporary-views-syntax"></a>
...
### Examples <a id="temporary-views-examples"></a>
...
### Disallowed / limitations <a id="temporary-views-limitations"></a>
...
### Notes on distributed queries <a id="temporary-views-distributed-notes"></a>
...
#### Example <a id="temporary-views-distributed-example"></a>
