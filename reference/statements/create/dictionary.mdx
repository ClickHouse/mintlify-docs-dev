...
## Creating a dictionary with a DDL query <a id="creating-a-dictionary-with-a-ddl-query"></a>
...
## Creating a dictionary with a configuration file <a id="creating-a-dictionary-with-a-configuration-file"></a>
