...
## Syntax Forms <a id="syntax-forms"></a>

### With Explicit Schema <a id="with-explicit-schema"></a>
...
### With Schema of Existing Table <a id="with-a-schema-similar-to-other-table"></a>
...
### With Schema and Data of Existing Table <a id="with-a-schema-and-data-cloned-from-another-table"></a>
...
### From a Table Function <a id="from-a-table-function"></a>
...
### From SELECT query <a id="from-select-query"></a>
...
## NULL Or NOT NULL Modifiers <a id="null-or-not-null-modifiers"></a>
...
### MATERIALIZED <a id="materialized"></a>
...
## TTL Expression <a id="ttl-expression"></a>
...
## Column Compression Codecs <a id="column_compression_codec"></a>
...
### General Purpose Codecs <a id="general-purpose-codecs"></a>
...
#### Obsolete: ZSTD_QAT <a id="zstd_qat"></a>

<CloudNotSupportedBadge/>

#### Obsolete: DEFLATE_QPL <a id="deflate_qpl"></a>

<CloudNotSupportedBadge/>

### Specialized Codecs <a id="specialized-codecs"></a>
...
#### DoubleDelta <a id="doubledelta"></a>
...
### Encryption Codecs <a id="encryption-codecs"></a>
...
## Temporary Tables <a id="temporary-tables"></a>
...
## REPLACE TABLE <a id="replace-table"></a>
...
## COMMENT Clause <a id="comment-clause"></a>
