...
## Query Parsing <a id="query-parsing"></a>
...
<Note>
For more information about format parsers, see the [Formats](/reference/formats/index) section.
</Note>
...
- [Functions](#functions).
- [Data types](/reference/data-types/index).
...
For more information, see [Data types](/reference/data-types/index).
...
- Depending on the data format (input or output), `NULL` may have a different representation. For more information, see [data formats](/reference/formats/index).
...
## Defining and Using Query Parameters <a id="defining-and-using-query-parameters"></a>
...
<Accordion title="Example with the HTTP interface">
...
<Accordion title="Example with the Web UI">
...
## Data Types and Database Table Engines <a id="data-types-and-database-table-engines"></a>
...
- [CREATE](/reference/statements/create/index).
...
## Expression Aliases <a id="expression-aliases"></a>
...
### Notes on Usage <a id="notes-on-usage"></a>
...
For more information, see the section [SELECT](/reference/statements/select/index#asterisk).
