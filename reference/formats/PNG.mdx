...
### Implicit coordinates (row-per-pixel), RGB <a id="implicit-rgb"></a>
...
### Explicit coordinates, grayscale <a id="explicit-grayscale"></a>
...
## Displaying images in the terminal <a id="terminal-mode"></a>
