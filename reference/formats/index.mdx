...
# Formats for input and output data <a id="formats-for-input-and-output-data"></a>
...
## Input formats <a id="input-formats"></a>
...
## Formats overview <a id="formats-overview"></a>
...
## Format schema <a id="formatschema"></a>
...
## Skipping errors <a id="skippingerrors"></a>
