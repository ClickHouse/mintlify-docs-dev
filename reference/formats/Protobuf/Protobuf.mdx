...
### Reading and writing data <a id="basic-examples"></a>
...
### Reading and writing data using ClickHouse Cloud <a id="basic-examples-cloud"></a>
...
### `format_schema_source='string'` <a id="format-schema-source-string"></a>
...
### `format_schema_source='query'` <a id="format-schema-source-query"></a>
...
### Using autogenerated schema <a id="using-autogenerated-protobuf-schema"></a>
...
### Drop protobuf cache <a id="drop-protobuf-cache"></a>
