...
### Inserting data <a id="json-inserting-data"></a>
...
#### Omitted values processing <a id="omitted-values-processing"></a>
...
### Selecting data <a id="json-selecting-data"></a>
...
### Usage of Nested Structures <a id="jsoneachrow-nested"></a>

If you have a table with the [`Nested`](/reference/data-types/nested-data-structures/index) data type columns, you can insert JSON data with the same structure. Enable this feature with the [input_format_import_nested_json](/reference/settings/formats#input_format_import_nested_json) setting.
