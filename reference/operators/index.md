...
For tuple negation: [tupleNegate](/sql-reference/functions/tuple-functions#tupleNegate).

## Multiplication and Division Operators

`a * b` – The `multiply (a, b)` function.

For multiplying tuple by number: [tupleMultiplyByNumber](/sql-reference/functions/tuple-functions#tupleMultiplyByNumber), for scalar product: [dotProduct](/sql-reference/functions/array-functions#arrayDotProduct).

`a / b` – The `divide(a, b)` function.

For dividing tuple by number: [tupleDivideByNumber](/sql-reference/functions/tuple-functions#tupleDivideByNumber).
...
For tuple addiction: [tuplePlus](/sql-reference/functions/tuple-functions#tuplePlus).

`a - b` – The `minus(a, b)` function.

For tuple subtraction: [tupleMinus](/sql-reference/functions/tuple-functions#tupleMinus).
...
See [IN operators](/sql-reference/operators/in) and [EXISTS](/sql-reference/operators/exists) operator.
