...
### RENAME TABLE <a id="rename-table"></a>
...
### DROP/DETACH TABLE <a id="drop-detach-table"></a>
...
### EXCHANGE TABLES/DICTIONARIES <a id="exchange-tables"></a>
...
### ReplicatedMergeTree in atomic database <a id="replicatedmergetree-in-atomic-database"></a>
...
### Metadata disk <a id="metadata-disk"></a>
