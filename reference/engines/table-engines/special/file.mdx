...
## Usage in ClickHouse Server <a id="usage-in-clickhouse-server"></a>
...
## Usage in ClickHouse-local <a id="usage-in-clickhouse-local"></a>
...
## Details of Implementation <a id="details-of-implementation"></a>
