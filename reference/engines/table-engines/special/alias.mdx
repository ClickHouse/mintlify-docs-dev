...
### Operations on Target Table <a id="operations-on-target"></a>
...
### Operations on Alias Itself <a id="operations-on-alias"></a>
...
### Basic Alias Creation <a id="basic-alias-creation"></a>
...
### Cross-Database Alias <a id="cross-database-alias"></a>
...
### Write Operations Through Alias <a id="write-operations"></a>
...
### Schema Modification <a id="schema-modification"></a>
...
### Data Mutations <a id="data-mutations"></a>
...
### Partition Operations <a id="partition-operations"></a>
...
### Table Optimization <a id="table-optimization"></a>
...
### Alias Management <a id="alias-management"></a>
