...
### `after_processing_move_connection_string` <a id="after_processing_move_connection_string"></a>
...
### `after_processing_move_container` <a id="after_processing_move_container"></a>
...
## SELECT from AzureQueue table engine <a id="select"></a>
