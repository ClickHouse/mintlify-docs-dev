...
### Table in PostgreSQL <a id="table-in-postgresql"></a>
...
### Creating Table in ClickHouse, and connecting to  PostgreSQL table created above <a id="creating-table-in-clickhouse-and-connecting-to--postgresql-table-created-above"></a>
...
### Inserting initial data from PostgreSQL table into ClickHouse table, using a SELECT query <a id="inserting-initial-data-from-postgresql-table-into-clickhouse-table-using-a-select-query"></a>
...
### Inserting incremental data from PostgreSQL table into ClickHouse table <a id="inserting-incremental-data-from-postgresql-table-into-clickhouse-table"></a>
...
### Selecting data from the resulting ClickHouse table <a id="selecting-data-from-the-resulting-clickhouse-table"></a>
...
### Using non-default schema <a id="using-non-default-schema"></a>
