...
#### Supported by libhdfs3 <a id="supported-by-libhdfs3"></a>
...
#### ClickHouse extras <a id="clickhouse-extras"></a>
...
## Kerberos support <a id="kerberos-support"></a>
...
## HDFS Namenode HA support <a id="namenode-ha"></a>
