...
### How to use local cache for HDFS filesystem <a id="how-to-use-local-cache-for-hdfs-filesystem"></a>
...
### Query Hive table with ORC input format <a id="query-hive-table-with-orc-input-format"></a>

#### Create Table in Hive <a id="create-table-in-hive"></a>
...
#### Create Table in ClickHouse <a id="create-table-in-clickhouse"></a>
...
### Query Hive table with Parquet input format <a id="query-hive-table-with-parquet-input-format"></a>

#### Create Table in Hive <a id="create-table-in-hive-1"></a>
...
#### Create Table in ClickHouse <a id="create-table-in-clickhouse-1"></a>
...
### Query Hive table with Text input format <a id="query-hive-table-with-text-input-format"></a>

#### Create Table in Hive <a id="create-table-in-hive-2"></a>
...
#### Create Table in ClickHouse <a id="create-table-in-clickhouse-2"></a>
