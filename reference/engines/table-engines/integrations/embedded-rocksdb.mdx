...
##### Create and populate an EmbeddedRocksDB table <a id="create-and-populate-an-embeddedrocksdb-table"></a>
```sql
CREATE TABLE rdb
(
    `key` UInt32,
...
##### Create and populate a table to join with table `rdb` <a id="create-and-populate-a-table-to-join-with-table-rdb"></a>
...
##### Set the join algorithm to `direct` <a id="set-the-join-algorithm-to-direct"></a>

```sql
SET join_algorithm = 'direct'
```

##### An INNER JOIN <a id="an-inner-join"></a>
```sql
SELECT *
FROM
(
...
### More information on Joins <a id="more-information-on-joins"></a>
