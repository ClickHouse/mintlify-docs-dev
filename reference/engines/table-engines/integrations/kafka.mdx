...
### Kerberos support <a id="kafka-kerberos-support"></a>
...
## Mapping columns to Kafka message metadata <a id="mapping-columns-to-kafka-message-metadata"></a>
...
## Data formats support <a id="data-formats-support"></a>
...
## Engine to store committed offsets in ClickHouse Keeper <a id="engine-to-store-committed-offsets-in-clickhouse-keeper"></a>
