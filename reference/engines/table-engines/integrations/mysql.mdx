...
## Settings <a id="mysql-settings"></a>
...
### `connection_auto_close` <a id="connection-auto-close"></a>
...
### `connection_max_tries` <a id="connection-max-tries"></a>
...
### `connection_pool_size` <a id="connection-pool-size"></a>
...
### `connection_wait_timeout` <a id="connection-wait-timeout"></a>
...
### `connect_timeout` <a id="connect-timeout"></a>
...
### `read_write_timeout` <a id="read-write-timeout"></a>
...
### `enable_compression` <a id="enable-compression"></a>
