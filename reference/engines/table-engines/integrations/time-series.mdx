...
### Outer columns <a id="outer-columns"></a>
...
### Specifying outer columns <a id="specifying-outer-columns"></a>
...
### Samples table <a id="samples-table"></a>
...
### Metrics table <a id="metrics-table"></a>
...
## Creating a table AS existing table <a id="create-as"></a>
...
## Adjusting types of columns <a id="adjusting-column-types"></a>
...
## The `id` column <a id="id-column"></a>
...
## The `tags` and `all_tags` columns <a id="tags-and-all-tags"></a>
...
## Table engines of inner target tables <a id="inner-table-engines"></a>
...
## External target tables <a id="external-target-tables"></a>
...
## Altering settings <a id="altering-settings"></a>
