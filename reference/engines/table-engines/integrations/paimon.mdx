...
## Incremental read examples <a id="incremental-read-examples"></a>
...
### Query-level settings for incremental read <a id="query-level-settings-for-incremental-read"></a>
...
## Paimon to MergeTree via Refreshable Materialized View <a id="paimon-to-mergetree-via-refresh-mv"></a>
...
## Data Types supported <a id="data-types-supported"></a>
...
## Partition supported <a id="partition-supported"></a>
