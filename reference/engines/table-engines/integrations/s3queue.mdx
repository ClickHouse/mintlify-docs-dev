...
## Create table <a id="creating-a-table"></a>
...
### `after_processing` <a id="after_processing"></a>
...
### `after_processing_retries` <a id="after_processing_retries"></a>
...
### `after_processing_move_access_key_id` <a id="after_processing_move_access_key_id"></a>
...
### `after_processing_move_prefix` <a id="after_processing_move_prefix"></a>
...
### `after_processing_move_preserve_path` <a id="after_processing_move_preserve_path"></a>
...
### `after_processing_move_secret_access_key` <a id="after_processing_move_secret_access_key"></a>
...
### `after_processing_move_uri` <a id="after_processing_move_uri"></a>
...
### `after_processing_tag_key` <a id="after_processing_tag_key"></a>
...
### `after_processing_tag_value` <a id="after_processing_tag_value"></a>
...
### `keeper_path` <a id="keeper_path"></a>
...
### `loading_retries` <a id="loading_retries"></a>
...
### `enable_logging_to_queue_log` <a id="enable_logging_to_queue_log"></a>

Enable logging to `system.s3queue_log`.

Default value: `1`.

### `polling_min_timeout_ms` <a id="polling_min_timeout_ms"></a>
...
### `polling_max_timeout_ms` <a id="polling_max_timeout_ms"></a>
...
### `polling_backoff_ms` <a id="polling_backoff_ms"></a>
...
### `tracked_files_limit` <a id="tracked_files_limit"></a>
...
### `tracked_file_ttl_sec` <a id="tracked_file_ttl_sec"></a>
...
### `cleanup_interval_min_ms` <a id="cleanup_interval_min_ms"></a>
...
### `cleanup_interval_max_ms` <a id="cleanup_interval_max_ms"></a>
...
### `use_persistent_processing_nodes` <a id="use_persistent_processing_nodes"></a>
...
### `persistent_processing_node_ttl_seconds` <a id="persistent_processing_node_ttl_seconds"></a>
...
## S3-related settings <a id="s3-settings"></a>
...
## S3 role-based access <a id="s3-role-based-access"></a>
...
## S3Queue ordered mode <a id="ordered-mode"></a>
...
## SELECT from S3Queue table engine <a id="select"></a>
...
## Wildcards in path <a id="wildcards-in-path"></a>
