...
## Create a table <a id="creating-a-table"></a>
...
### Engine parameters <a id="parameters"></a>
...
#### Partition strategy <a id="partition-strategy"></a>
...
### Querying partitioned data <a id="querying-partitioned-data"></a>
...
#### Create the table <a id="create-the-table"></a>
```sql highlight={8}
CREATE TABLE p
(
    `column1` UInt32,
...
#### Insert data <a id="insert-data"></a>
```sql
INSERT INTO p VALUES (1, 2, 3), (3, 2, 1), (78, 43, 45)
```

#### Select from partition 3 <a id="select-from-partition-3"></a>
...
#### Select from partition 1 <a id="select-from-partition-1"></a>
```sql
SELECT *
...
#### Select from partition 45 <a id="select-from-partition-45"></a>
```sql
SELECT *
...
## Insert data <a id="inserting-data"></a>
...
## Storage settings <a id="storage-settings"></a>
...
## S3-related settings <a id="settings"></a>
...
## Endpoint-based settings <a id="endpoint-settings"></a>
...
## Working with archives <a id="working-with-archives"></a>
...
## Accessing public buckets <a id="accessing-public-buckets"></a>
...
## Optimizing performance <a id="optimizing-performance"></a>
...
## Role-based access <a id="role-based-access"></a>
