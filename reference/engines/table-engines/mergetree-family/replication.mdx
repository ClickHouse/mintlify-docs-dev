...
Compressed data for `INSERT` and `ALTER` queries is replicated (for more information, see the documentation for [ALTER](/reference/statements/alter/index).
...
ClickHouse uses [ClickHouse Keeper](/guides/oss/deployment-and-scaling/keeper/index) for storing replicas meta information. It is possible to use ZooKeeper version 3.4.5 or newer, but ClickHouse Keeper is recommended.
...
## Creating replicated tables <a id="creating-replicated-tables"></a>
...
### Replicated\*MergeTree parameters <a id="replicatedmergetree-parameters"></a>
...
## Recovery after failures <a id="recovery-after-failures"></a>
...
## Recovery after complete data loss <a id="recovery-after-complete-data-loss"></a>
...
## Converting from MergeTree to ReplicatedMergeTree <a id="converting-from-mergetree-to-replicatedmergetree"></a>
...
## Converting from ReplicatedMergeTree to MergeTree <a id="converting-from-replicatedmergetree-to-mergetree"></a>
...
## Recovery when metadata in the ClickHouse Keeper cluster is lost or damaged <a id="recovery-when-metadata-in-the-zookeeper-cluster-is-lost-or-damaged"></a>
