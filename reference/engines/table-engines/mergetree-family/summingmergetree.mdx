...
### Parameters of SummingMergeTree <a id="parameters-of-summingmergetree"></a>
...
### Query clauses <a id="query-clauses"></a>
...
### Common rules for summation <a id="common-rules-for-summation"></a>
...
### The summation in the AggregateFunction columns <a id="the-summation-in-the-aggregatefunction-columns"></a>
...
### Nested structures <a id="nested-structures"></a>
...
### Tuple element aggregation <a id="tuple-element-aggregation"></a>
