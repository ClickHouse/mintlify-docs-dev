...
## Creating a table <a id="creating-table"></a>
...
## Rollup configuration <a id="rollup-configuration"></a>
...
### Required columns <a id="required-columns"></a>

#### `path_column_name` <a id="path_column_name"></a>

`path_column_name` — The name of the column storing the metric name (Graphite sensor). Default value: `Path`.

#### `time_column_name` <a id="time_column_name"></a>
`time_column_name` — The name of the column storing the time of measuring the metric. Default value: `Time`.

#### `value_column_name` <a id="value_column_name"></a>
...
#### `version_column_name` <a id="version_column_name"></a>
...
### Configuration Example without rules types <a id="configuration-example"></a>
...
### Configuration Example with rules types <a id="configuration-typed-example"></a>
