...
## Exact vector search <a id="exact-nearest-neighbor-search"></a>
...
### Example <a id="exact-nearest-neighbor-search-example"></a>
...
## Approximate vector search <a id="approximate-nearest-neighbor-search"></a>

### Vector Similarity Indexes <a id="vector-similarity-index"></a>
...
#### Creating a Vector Similarity Index <a id="creating-a-vector-similarity-index"></a>
...
- Vector similarity indexes require that all arrays in the underlying column have `<dimension>`-many elements - this is checked during index creation. To detect violations of this requirement as early as possible, users can add a [constraint](/reference/statements/create/table#constraints) for the vector column, e.g., `CONSTRAINT same_length CHECK length(vectors) = 256`.
...
#### Using a Vector Similarity Index <a id="using-a-vector-similarity-index"></a>
...
More specifically, an error is returned if `<N>` is bigger than the value of setting [max_limit_for_vector_search_queries](/reference/settings/session-settings#max_limit_for_vector_search_queries) with default value 100.
...
This typically happens when data is [inserted](/concepts/features/operations/insert/inserting-data) or during [merges](/concepts/core-concepts/merges).
...
#### Administration and monitoring <a id="administration"></a>
...
#### Differences to regular skipping indexes <a id="differences-to-regular-skipping-indexes"></a>
...
#### Example <a id="approximate-nearest-neighbor-search-example"></a>
...
### Quantized Bit (QBit) <a id="approximate-nearest-neighbor-search-qbit"></a>
...
#### Creating a `QBit` Table and Adding Data <a id="qbit-create"></a>
...
#### Vector Search with `QBit` <a id="qbit-search"></a>
...
#### Performance Considerations <a id="qbit-performance"></a>
