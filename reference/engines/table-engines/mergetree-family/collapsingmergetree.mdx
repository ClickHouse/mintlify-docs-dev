...
## Collapsing <a id="table_engine-collapsingmergetree-collapsing"></a>
...
### Algorithm <a id="table_engine-collapsingmergetree-collapsing-algorithm"></a>
...
### Example of another approach <a id="example-of-another-approach"></a>
