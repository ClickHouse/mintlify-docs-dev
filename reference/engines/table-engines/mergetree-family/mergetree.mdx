...
## Creating tables <a id="table_engine-mergetree-creating-a-table"></a>
...
### Query clauses <a id="mergetree-query-clauses"></a>
...
#### PARTITION BY <a id="partition-by"></a>
...
#### PRIMARY KEY <a id="primary-key"></a>
...
## Data storage <a id="mergetree-data-storage"></a>
...
## Primary Keys and Indexes in Queries <a id="primary-keys-and-indexes-in-queries"></a>
...
### Selecting a primary key <a id="selecting-a-primary-key"></a>
...
### Choosing a primary key that differs from the sorting key <a id="choosing-a-primary-key-that-differs-from-the-sorting-key"></a>
...
[ALTER](/reference/statements/alter/index) of the sorting key is a lightweight operation because when a new column is simultaneously added to the table and to the sorting key, existing data parts do not need to be changed. Since the old sorting key is a prefix of the new sorting key and there is no data in the newly added column, the data is sorted by both the old and new sorting keys at the moment of table modification.

### Use of indexes and partitions in queries <a id="use-of-indexes-and-partitions-in-queries"></a>
...
### Use of index for deterministic expressions in primary keys <a id="use-of-index-for-deterministic-expressions-in-primary-keys"></a>
...
### Use of index for partially-monotonic primary keys <a id="use-of-index-for-partially-monotonic-primary-keys"></a>
...
### Data skipping indexes <a id="table_engine-mergetree-data_skipping-indexes"></a>
...
### Skip Index Types <a id="skip-index-types"></a>
...
#### MinMax skip index <a id="minmax"></a>
...
#### Bloom filter <a id="bloom-filter"></a>
...
#### N-gram bloom filter *(Deprecated)* <a id="n-gram-bloom-filter"></a>
...
#### Token bloom filter <a id="token-bloom-filter"></a>
...
#### Sparse grams bloom filter <a id="sparse-grams-bloom-filter"></a>
...
#### Vector similarity <a id="vector-similarity"></a>
...
### Functions support <a id="functions-support"></a>
...
### Projection query <a id="projection-query"></a>
...
### Projection indexes <a id="projection-index"></a>
...
#### Syntax <a id="projection-index-syntax"></a>
...
#### Index types <a id="projection-index-types"></a>
...
### Projection storage <a id="projection-storage"></a>
...
### Query analysis <a id="projection-query-analysis"></a>
...
## Concurrent data access <a id="concurrent-data-access"></a>

For concurrent table access, we use multi-versioning. In other words, when a table is simultaneously read and updated, data is read from a set of parts that is current at the time of the query. There are no lengthy locks. Inserts do not get in the way of read operations.

Reading from a table is automatically parallelized.

## TTL for columns and tables <a id="table_engine-mergetree-ttl"></a>
...
To define `interval`, use [time interval](/reference/operators/index#operators-for-working-with-dates-and-times) operators, for example:
...
### Column TTL <a id="mergetree-column-ttl"></a>
...
#### Creating a table with `TTL`: <a id="creating-a-table-with-ttl"></a>
...
#### Adding TTL to a column of an existing table <a id="adding-ttl-to-a-column-of-an-existing-table"></a>
...
#### Altering TTL of the column <a id="altering-ttl-of-the-column"></a>
...
### Table TTL <a id="mergetree-table-ttl"></a>
...
#### Creating a table with `TTL`: <a id="creating-a-table-with-ttl-1"></a>
...
#### Altering `TTL` of the table: <a id="altering-ttl-of-the-table"></a>
...
#### Creating a table, where expired rows are recompressed: <a id="creating-a-table-where-expired-rows-are-recompressed"></a>
...
### Removing expired data <a id="mergetree-removing-expired-data"></a>
...
## Using multiple block devices for data storage <a id="table_engine-mergetree-multiple-volumes"></a>
...
### Configuration <a id="table_engine-mergetree-multiple-volumes_configure"></a>
...
- During background merges and [mutations](/reference/statements/alter/index#mutations).
...
## Using external storage for data storage <a id="table_engine-mergetree-s3"></a>
...
### Using S3 disks with multiple volumes <a id="s3-multiple-volumes"></a>
...
## Virtual columns <a id="virtual-columns"></a>
...
## Column statistics <a id="column-statistics"></a>
...
#### Part Pruning with Statistics <a id="part-pruning-with-statistics"></a>
...
### Available types of column statistics <a id="available-types-of-column-statistics"></a>
...
## Column-level settings <a id="column-level-settings"></a>
