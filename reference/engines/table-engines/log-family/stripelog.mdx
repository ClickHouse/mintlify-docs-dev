...
## Creating a table <a id="table_engines-stripelog-creating-a-table"></a>
...
## Writing the data <a id="table_engines-stripelog-writing-the-data"></a>
...
## Reading the data <a id="table_engines-stripelog-reading-the-data"></a>
...
## Example of use <a id="table_engines-stripelog-example-of-use"></a>
