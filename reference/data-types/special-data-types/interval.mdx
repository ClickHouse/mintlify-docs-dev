...
The family of data types representing time and date intervals. The resulting types of the [INTERVAL](/reference/operators/index#interval) operator.
...
## Mixed-type Intervals <a id="mixed-type-intervals"></a>
...
- [INTERVAL](/reference/operators/index#interval) operator
