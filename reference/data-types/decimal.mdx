...
## Decimal Value Ranges <a id="decimal-value-ranges"></a>
...
## Internal Representation <a id="internal-representation"></a>
...
## Operations and Result Type <a id="operations-and-result-type"></a>
...
## Overflow Checks <a id="overflow-checks"></a>
