...
## Data Type Detection <a id="data-type-detection"></a>
...
## Referring to Tuple Elements <a id="referring-to-tuple-elements"></a>
...
## Comparison operations with Tuple <a id="comparison-operations-with-tuple"></a>
...
## Nullable(Tuple(T1, T2, ...)) <a id="nullable-tuple"></a>
