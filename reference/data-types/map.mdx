...
## Converting Tuple to Map <a id="converting-tuple-to-map"></a>
...
## Reading subcolumns of Map <a id="reading-subcolumns-of-map"></a>
...
## Bucketed Map Serialization in MergeTree <a id="bucketed-map-serialization"></a>
...
### Enabling Bucketed Serialization <a id="enabling-bucketed-serialization"></a>
...
### Settings <a id="bucketed-map-settings"></a>
...
### Performance Trade-offs <a id="performance-trade-offs"></a>
...
### Alternative Approaches <a id="map-alternatives"></a>
...
#### Using the JSON Data Type <a id="using-the-json-data-type"></a>
...
#### Manual Sharding into Multiple Map Columns <a id="manual-sharding-into-multiple-map-columns"></a>
