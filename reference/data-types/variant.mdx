...
## Creating Variant <a id="creating-variant"></a>
...
## Reading Variant nested types as subcolumns <a id="reading-variant-nested-types-as-subcolumns"></a>
...
## Conversion between a Variant column and other columns <a id="conversion-between-a-variant-column-and-other-columns"></a>

There are 4 possible conversions that can be performed with a column of type `Variant`.

### Converting a String column to a Variant column <a id="converting-a-string-column-to-a-variant-column"></a>
...
### Converting an ordinary column to a Variant column <a id="converting-an-ordinary-column-to-a-variant-column"></a>
...
### Converting a Variant column to an ordinary column <a id="converting-a-variant-column-to-an-ordinary-column"></a>
...
### Converting a Variant to another Variant <a id="converting-a-variant-to-another-variant"></a>
...
## Reading Variant type from the data <a id="reading-variant-type-from-the-data"></a>
...
## Comparing values of Variant type <a id="comparing-values-of-variant-data"></a>
...
## JSONExtract functions with Variant <a id="jsonextract-functions-with-variant"></a>
...
## Functions with Variant arguments <a id="functions-with-variant-arguments"></a>
...
### Type mismatch behavior <a id="variant-type-mismatch-behavior"></a>
