...
## Creating `JSON` <a id="creating-json"></a>

In this section we'll take a look at the various ways that you can create `JSON`.

### Using `JSON` in a table column definition <a id="using-json-in-a-table-column-definition"></a>
...
### Using CAST with `::JSON` <a id="using-cast-with-json"></a>

It is possible to cast various types using the special syntax `::JSON`.

#### CAST from `String` to `JSON` <a id="cast-from-string-to-json"></a>
...
#### CAST from `Tuple` to `JSON` <a id="cast-from-tuple-to-json"></a>
...
#### CAST from `Map` to `JSON` <a id="cast-from-map-to-json"></a>
...
## Reading JSON paths as sub-columns <a id="reading-json-paths-as-sub-columns"></a>
...
## Reading JSON sub-objects as sub-columns <a id="reading-json-sub-objects-as-sub-columns"></a>
...
## Reading JSON combined sub-columns <a id="reading-json-combined-sub-columns"></a>
...
## Type inference for paths <a id="type-inference-for-paths"></a>
...
## Handling arrays of JSON objects <a id="handling-arrays-of-json-objects"></a>
...
## Handling JSON keys with NULL <a id="handling-json-keys-with-nulls"></a>
...
## Handling JSON keys with dots <a id="handling-json-keys-with-dots"></a>
...
## Reading JSON type from data <a id="reading-json-type-from-data"></a>
...
## Reaching the limit of dynamic paths inside JSON <a id="reaching-the-limit-of-dynamic-paths-inside-json"></a>
...
### Reaching the limit during data parsing <a id="reaching-the-limit-during-data-parsing"></a>
...
### During merges of data parts in MergeTree table engines <a id="during-merges-of-data-parts-in-mergetree-table-engines"></a>
...
## Shared data structure <a id="shared-data-structure"></a>
...
### Shared data structure in memory <a id="shared-data-structure-in-memory"></a>
...
### Shared data structure in MergeTree parts <a id="shared-data-structure-in-merge-tree-parts"></a>
...
#### Map with buckets <a id="shared-data-map-with-buckets"></a>
...
#### Advanced <a id="shared-data-advanced"></a>
...
## Controlling the number of dynamic paths inside JSON in MergeTree parts <a id="controlling-the-number-of-dynamic-paths"></a>
...
## Introspection functions <a id="introspection-functions"></a>
...
## ALTER MODIFY COLUMN to JSON type <a id="alter-modify-column-to-json-type"></a>
...
## Lazy Type Hints (Experimental) <a id="lazy-type-hints"></a>
...
### Enabling Lazy Type Hints <a id="enabling-lazy-type-hints"></a>

```sql
SET allow_experimental_json_lazy_type_hints = 1;
```

### Example <a id="lazy-type-hints-example"></a>
...
### Verifying No Mutation Occurred <a id="verifying-no-mutation-occurred"></a>
...
### Materializing Type Hints <a id="materializing-type-hints"></a>
...
### Limitations <a id="lazy-type-hints-limitations"></a>
...
## Comparison between values of the JSON type <a id="comparison-between-values-of-the-json-type"></a>
...
## Data skipping indexes for JSON <a id="data-skipping-indexes-for-json"></a>
...
### Indexes on specific subcolumns <a id="json-indexes-on-subcolumns"></a>
...
#### Example <a id="json-indexes-on-subcolumns-example"></a>
...
### Path-based indexes with JSONAllPaths <a id="json-indexes-jsonallpaths"></a>
...
#### Supported index types <a id="json-indexes-jsonallpaths-supported-types"></a>
...
#### Example <a id="json-indexes-jsonallpaths-example"></a>
...
#### How it works <a id="json-indexes-jsonallpaths-how-it-works"></a>
...
#### Safety with missing paths <a id="json-indexes-jsonallpaths-safety-with-missing-paths"></a>
...
### Full-text search with JSONAllValues <a id="json-indexes-jsonallvalues"></a>
...
## Tips for better usage of the JSON type <a id="tips-for-better-usage-of-the-json-type"></a>
...
<!-- anchors from _when-to-use-json.mdx -->
<a id="when-to-use-json-type"></a>
<a id="use-json-type"></a>
<a id="use-string-type"></a>
<!-- anchors from _when-to-use-json.mdx -->
<a id="when-to-use-json-type"></a>
<a id="use-json-type"></a>
<a id="use-string-type"></a>