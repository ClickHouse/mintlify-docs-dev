...
## Using floating-point numbers <a id="using-floating-point-numbers"></a>
...
## NaN and Inf <a id="nan-and-inf"></a>
...
## NaN values in set semantics <a id="nan-values-in-set-semantics"></a>
