...
## Creating QBit <a id="creating-qbit"></a>
...
## Converting arrays to QBit <a id="converting-arrays-to-qbit"></a>
...
## QBit subcolumns <a id="qbit-subcolumns"></a>
...
## Vector search functions <a id="vector-search-functions"></a>
