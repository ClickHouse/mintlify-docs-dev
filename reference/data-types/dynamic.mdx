...
## Creating Dynamic <a id="creating-dynamic"></a>
...
## Reading Dynamic nested types as subcolumns <a id="reading-dynamic-nested-types-as-subcolumns"></a>
...
## Conversion between Dynamic column and other columns <a id="conversion-between-dynamic-column-and-other-columns"></a>

There are 4 possible conversions that can be performed with `Dynamic` column.

### Converting an ordinary column to a Dynamic column <a id="converting-an-ordinary-column-to-a-dynamic-column"></a>
...
### Converting a String column to a Dynamic column through parsing <a id="converting-a-string-column-to-a-dynamic-column-through-parsing"></a>
...
### Converting a Dynamic column to an ordinary column <a id="converting-a-dynamic-column-to-an-ordinary-column"></a>
...
### Converting a Variant column to Dynamic column <a id="converting-a-variant-column-to-dynamic-column"></a>
...
### Converting a Dynamic(max_types=N) column to another Dynamic(max_types=K) <a id="converting-a-dynamicmax_typesn-column-to-another-dynamicmax_typesk"></a>
...
## Reading Dynamic type from the data <a id="reading-dynamic-type-from-the-data"></a>
...
## Using Dynamic type in functions <a id="using-dynamic-type-in-functions"></a>
...
### Type mismatch behavior <a id="dynamic-type-mismatch-behavior"></a>
...
## Using Dynamic type in ORDER BY and GROUP BY <a id="using-dynamic-type-in-order-by-and-group-by"></a>
...
## Reaching the limit in number of different data types stored inside Dynamic <a id="reaching-the-limit-in-number-of-different-data-types-stored-inside-dynamic"></a>
...
## JSONExtract functions with Dynamic <a id="jsonextract-functions-with-dynamic"></a>
...
### Binary output format <a id="binary-output-format"></a>
