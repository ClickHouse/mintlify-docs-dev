...
description: 'Dictionary は、高速なルックアップのためにデータをキー・バリュー形式で表現する機能です。'
doc_type: 'guide'
---
...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="ClickHouse における Dictionary のユースケース" />
