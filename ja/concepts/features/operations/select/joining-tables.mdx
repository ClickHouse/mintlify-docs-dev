...
* クエリでダイレクト JOIN、つまり以下に示す `LEFT ANY JOIN` が必要な場合は、可能であれば [Dictionaries](/ja/concepts/features/dictionaries) を使用することを推奨します。
...
<Image img="/images/guides/joins-3.png" size="lg" alt="JOIN の機能" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="join のメモリ最適化の決定木" />
