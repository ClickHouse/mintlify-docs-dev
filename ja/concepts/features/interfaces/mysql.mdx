---
description: 'MySQL クライアントから ClickHouse に接続できるようにする、ClickHouse の MySQL プロトコル インターフェイスに関するドキュメント'
...
<Image img="/images/interfaces/mysql0.png" alt="認証情報画面 - Prompt" size="md" />

2. `Connect with` ドロップダウンを `MySQL` に変更します。

<br />

<Image img="/images/interfaces/mysql1.png" alt="認証情報画面 - MySQL を選択" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="認証情報画面 - MySQL が有効" size="md" />

表示されている MySQL 接続文字列をコピーします。

<Image img="/images/interfaces/mysql3.png" alt="認証情報画面 - 接続文字列" size="md" />
