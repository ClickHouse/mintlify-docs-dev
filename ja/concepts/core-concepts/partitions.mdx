...
<Image img="/images/managing-data/core-concepts/partitions.png" size="lg" alt="INSERT の処理" />
...
<Image img="/images/managing-data/core-concepts/merges_with_partitions.png" size="lg" alt="パーツのマージ" />
...
<Image img="/images/managing-data/core-concepts/partition-pruning.png" size="lg" alt="パーツマージ 2" />
