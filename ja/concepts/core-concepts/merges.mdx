...
① [MergeTree engine](/ja/reference/engines/table-engines/mergetree-family/index) ファミリーのテーブルへの insert では、ソート済みで不変の[データパーツ](/ja/concepts/core-concepts/parts)が作成されます。
...
<Image img="/images/managing-data/core-concepts/merges_01.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges-dashboard.gif" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_02.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_03.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_04.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_05.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_06.png" size="lg" alt="パーツマージ" />
...
<Image img="/images/managing-data/core-concepts/merges_07.png" size="lg" alt="パーツマージ" />
