...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="追加・削除された行数" size="md" />

**コミット数と著者数:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="コミット数と著者数" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Superset 著者マトリクス" size="md" />

Alexey は明らかに他の人のコードを削除するのが好きなようです。コード削除の傾向をよりバランスよく見るため、彼を除外しましょう。

<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Superset 著者マトリクス v2" size="md" />
