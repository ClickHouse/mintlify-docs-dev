...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="1日あたりのイベント数" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="蒸し暑い日" />