...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="ヨーロッパのポイントオブインタレストの密度マップ" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="日本の日本酒バー" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="ATM" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="ポイントオブインタレストを国別に分類したヨーロッパ地図" />