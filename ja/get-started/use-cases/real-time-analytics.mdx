...
<Image img="/images/use-cases/rta-considerations.png" alt="リアルタイム分析: 取り込み、変換、クエリにかかる時間" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="ClickHouseがリアルタイム分析を支える仕組み" />
  </div>
