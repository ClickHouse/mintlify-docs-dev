...
<div className="installContainer">
  <a href="/ja/install/quick-install" style={{textDecoration: 'none'}}>
    <Card title="クイックインストール" />
  </a>

  <a href="/ja/install/clickhousectl" style={{textDecoration: 'none'}}>
    <Card title="clickhousectl (CLI)" icon="console" />
  </a>

  <a href="/ja/install/docker" style={{textDecoration: 'none'}}>
    <Card title="Docker" />
  </a>

  <a href="/ja/install/advanced" style={{textDecoration: 'none'}}>
...
<div className="installContainer">
  <a href="/ja/install/debian_ubuntu" style={{textDecoration: 'none'}}>
    <Card title="Debian/Ubuntu" />
  </a>

  <a href="/ja/install/redhat" style={{textDecoration: 'none'}}>
    <Card title="Redhat" />
  </a>

  <a href="/ja/install/nixos" style={{textDecoration: 'none'}}>
    <Card title="NixOS" />
  </a>

  <a href="/ja/install/linux_other" style={{textDecoration: 'none'}}>
