...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="セルフマネージド ClickHouse の移行" />

現在使用しているデータベースシステムに対して、ClickHouse が提供する [インテグレーションエンジン](/ja/reference/engines/table-engines#integration-engines) または [テーブル関数](/ja/reference/functions/table-functions) のいずれか、あるいはベンダー提供の JDBC driver または ODBC ドライバが利用できる場合は、
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
