...
<Image img="/images/integrations/data-ingestion/dbms/postgres-replicas.png" size="md" alt="結果整合性" />
...
| `JSON`               | [String](/ja/reference/data-types/string), [Variant](/ja/reference/data-types/variant), [Nested](/ja/reference/data-types/nested-data-structures#nestedname1-type1-name2-type2-), [Tuple](/ja/reference/data-types/tuple) |
