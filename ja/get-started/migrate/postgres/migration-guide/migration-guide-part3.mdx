...
<Image img="/images/migrations/postgres-b-tree.png" size="lg" alt="PostgreSQL B-Tree 索引" />

<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="PostgreSQL スパース索引" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="PostgreSQLのパーティションからClickHouseのパーティションへ" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="ClickHouse における PostgreSQL の PROJECTION" />
