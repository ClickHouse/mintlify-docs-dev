---
sidebarTitle: 'remoteSecure を使う'
slug: /cloud/migration/clickhouse-to-cloud
title: 'セルフマネージド ClickHouse と ClickHouse Cloud 間の移行'
description: 'セルフマネージド ClickHouse と ClickHouse Cloud の間で移行する方法を説明するページ'
doc_type: 'guide'
keywords: ['移行', 'ClickHouse Cloud', 'OSS', 'セルフマネージドからCloudへ移行']
---
...
<Image img="/images/integrations/migration/self-managed-01.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/self-managed-02.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/self-managed-03.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/self-managed-04.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/self-managed-05.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
...
<Image img="/images/integrations/migration/self-managed-06.png" size="lg" alt="セルフマネージド ClickHouse の移行" />
