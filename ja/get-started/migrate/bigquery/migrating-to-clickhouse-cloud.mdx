...
<Image img="/images/migrations/bigquery-2.png" size="md" alt="ClickHouse と BigQuery の比較" />
...
<Image img="/images/migrations/bigquery-3.png" size="lg" alt="スキーマ" />
...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="一括ロード" />
...
[こちら](/ja/get-started/migrate/bigquery)で説明しているように、BigQueryと同様、ClickHouseはテーブルの主キーカラム値の一意性を強制しません。
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="ClickHouseの主キー" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="パーティション" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="プロジェクション" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="BigQuery クエリの書き換え" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="集約関数 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="集約関数 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="条件式と配列" />
