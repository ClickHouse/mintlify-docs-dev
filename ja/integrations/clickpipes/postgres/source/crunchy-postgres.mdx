...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/firewall_rules_crunchy_bridge.png" alt="Crunchy Bridge でファイアウォールルールはどこにありますか？" border />

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/add_firewall_rules_crunchy_bridge.png" alt="ClickPipes 用のファイアウォールルールを追加" border />
