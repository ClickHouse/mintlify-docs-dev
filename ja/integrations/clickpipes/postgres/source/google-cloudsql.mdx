...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="Cloud SQL Postgres の Edit ボタン" size="lg" border />

2. Flags に移動し、`cloudsql.logical_decoding` を on に変更します。この変更を反映するには、Postgres サーバーの再起動が必要です。

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="`cloudsql.logical_decoding` を on に変更する" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding3.png" alt="サーバーを再起動する" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="Cloud SQL の Connections セクション" size="lg" border />

2. Networking サブセクションに移動します

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="Cloud SQL の Networking サブセクション" size="lg" border />

3. [ClickPipes のパブリック IP アドレス](/ja/integrations/clickpipes/home#list-of-static-ips) を追加します

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="ClickPipes のネットワークをファイアウォールに追加" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="ClickPipes のネットワークがファイアウォールに追加された状態" size="lg" border />
