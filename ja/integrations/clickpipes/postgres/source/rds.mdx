...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="RDS でパラメータグループを確認する場所" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="新しいパラメータグループを使用して RDS Postgres を変更" size="lg" border />

3. 変更を反映するため、RDS インスタンスを再起動します

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="RDS Postgres の再起動" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="RDS Postgres でセキュリティグループはどこにありますか？" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="上記のセキュリティグループの Inbound rules を編集" size="lg" border />
