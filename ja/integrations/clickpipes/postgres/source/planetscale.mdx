...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="PlanetScale Consoleでwal_levelを調整" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="PlanetScale Consoleでmax_slot_wal_keep_sizeを調整" size="md" border />
