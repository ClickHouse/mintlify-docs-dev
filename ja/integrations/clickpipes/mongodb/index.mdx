...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="MongoDB を選択" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="接続情報を入力" size="lg" border />
...
5. ここでは、ClickPipe の宛先データベースを選択できます。既存のデータベースを選ぶことも、新しく作成することもできます。
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="宛先データベースを選択" size="lg" border />
