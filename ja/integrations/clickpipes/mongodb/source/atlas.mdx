...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-cluster-overview-configuration.png" alt="クラスター設定に移動" size="lg" border />

2. `Additional Settings` をクリックし、`More Configuration Options` までスクロールします。

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-expand-additional-settings.png" alt="追加設定を展開" size="lg" border />

3. `More Configuration Options` をクリックし、最小の oplog ウィンドウを `72 hours` 以上に設定します。

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-set-retention-hours.png" alt="oplog 保持時間を設定" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-add-new-database-user.png" alt="データベースユーザーを追加" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-database-user-privilege.png" alt="ユーザーロールを設定" size="lg" border />

さらに、ClickPipes ユーザーにアクセスを許可するクラスター/インスタンスを指定することもできます。

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-restrict-access.png" alt="クラスター/インスタンスへのアクセスを制限" size="lg" border />
