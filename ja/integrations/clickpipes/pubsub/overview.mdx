...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1_pubsub.png" alt="データソースとして GCP Pub/Sub を選択" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_pubsub.png" alt="接続の詳細を入力" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_pubsub.png" alt="Pub/Sub topic、フォーマット、開始オフセットを設定" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="table、スキーマ、設定を指定" size="lg" border />

用意されているコントロールを使って、詳細設定をカスタマイズすることもできます。

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="詳細設定を指定" size="lg" border />

7. あるいは、既存の ClickHouse table にデータを取り込むこともできます。その場合、UI ではソースのフィールドを、選択した宛先 table の ClickHouse フィールドにマッピングできます。

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="既存の table を使用" size="lg" border />
