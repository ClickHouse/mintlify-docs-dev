...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="MySQL を選択" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="接続情報を入力" size="lg" border />
...
5. ここでは、ClickPipe の宛先データベースを選択できます。既存のデータベースを選択することも、新しいデータベースを作成することもできます。
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="宛先データベースを選択" size="lg" border />
