...
| **OVH Object Storage** <br /> *S3 互換*  | <img src="/images/integrations/logos/ovh.png" alt="Cloud ストレージ ロゴ" width="32" />            | 継続的インジェストでは [辞書式順序](#continuous-ingestion-lexicographical-order) が必要です。順不同モードはサポートされていません。                                                        |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="S3 ClickPipes の IAM 認証情報" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="S3 ClickPipes の IAM 認証" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="ClickPipes の高度な設定" size="lg" border />
