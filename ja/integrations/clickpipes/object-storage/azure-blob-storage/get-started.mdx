...
<Steps>
  <Step>
    ...
    **ClickPipes** のドロップダウンを展開し、**Create ClickPipe** をクリックします
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/01-navigate-to-datasources.png" alt="データソースに移動する" size="md" />

    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/02-create-clickpipe.png" alt="ClickPipe を作成する" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/03-select-blob-storage.png" alt="Azure Blob Storage を選択する" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/04-configuration-details.png" alt="設定の詳細" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/05-choose-data-format.png" alt="データフォーマットを選択する" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/06-parse-information.png" alt="情報を解析する" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/07-permissions.png" alt="権限を構成する" size="md" />
  </Step>
