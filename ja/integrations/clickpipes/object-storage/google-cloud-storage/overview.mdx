...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="GCS ClickPipes の HMAC認証情報" size="lg" border />

HMACキーを持つサービス アカウントを作成するには、[このガイド](/ja/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret) に従ってください。
