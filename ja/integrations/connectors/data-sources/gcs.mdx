...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="データパーティションを含むフォルダ構造が表示された Google Cloud Storage 内のレプリカ1用バケット" />

<div id="bucket-for-replica-two">
  #### レプリカ2用のバケット
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="データパーティションを含むフォルダ構造が表示された Google Cloud Storage 内のレプリカ2のバケット" />