...
description: 'Holistics は、ガバナンスの効いたアクセスしやすいメトリクスを通じて、誰もがより適切な意思決定を行えるよう支援する、AI 搭載のセルフサービス BI および組み込みアナリティクスのプラットフォームです。'
...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="ClickHouse Cloud console における Connect ボタンの場所" border />
  </Step>
  ...
  <Step>
    ...
    1. **Direct Connection (推奨) :** ファイアウォールまたは ClickHouse Cloud の IP Access List で、Holistics の IP アドレスを許可リストに追加します。IP アドレスの一覧は [IP Whitelisting guide](https://docs.holistics.io/docs/connect/ip-whitelisting) で確認できます。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="ClickHouse Cloud での IP 許可リスト登録の例" border />
  ...
  <Step>
    ...
    1. Holistics で **Settings → データソース** に移動します。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="Holistics の設定で データソース に移動する" border />

    2. **New Data Source** をクリックし、**ClickHouse** を選択します。

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="新しい data source の一覧から ClickHouse を選択する" border />
    ...
    3. ステップ 1 で確認した情報をフォームに入力します。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="Holistics で ClickHouse の接続情報を入力する" border />

    4. **Test Connection** をクリックします。

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Holistics で ClickHouse 接続テストが成功した状態" border />
