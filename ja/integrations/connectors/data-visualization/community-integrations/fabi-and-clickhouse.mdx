...
keywords: ['ClickHouse', 'Fabi.ai', '接続', 'インテグレーション', 'ノートブック', 'UI', '分析']
description: 'Fabi.ai は、共同でデータ分析を行えるオールインワンプラットフォームです。SQL、Python、AI、ノーコードを活用して、これまで以上にすばやくダッシュボードやデータワークフローを構築できます'
title: 'ClickHouse と Fabi.ai を接続する'
doc_type: 'guide'
integration:
...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="Fabi.ai のデータ探索およびワークフロープラットフォーム" border />
...
1. アカウントを初めて作成すると、データベースへの接続を求められます。すでにアカウントをお持ちの場合は、任意の Smartbook の左側にあるデータソースパネルをクリックし、[Add Data Source] を選択します。
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="データソースを追加" border />

2. 次に、接続情報を入力します。

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="ClickHouse 認証情報フォーム" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="ClickHouse へのクエリ" border />
