...
<Image img="/images/integrations/data-visualization/explo_07.png" size="sm" alt="ダッシュボード" border />

2. 右上の **Create Dashboard** をクリックし、ダッシュボード名を入力します。これでダッシュボードの作成は完了です。

<Image img="/images/integrations/data-visualization/explo_08.png" size="sm" alt="ダッシュボードを作成" border />
