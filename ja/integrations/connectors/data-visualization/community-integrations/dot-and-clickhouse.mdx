...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Dot で ClickHouse 接続を設定する（ライトモード）" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="ClickHouse に接続する" size="sm" />
