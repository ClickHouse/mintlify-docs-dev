...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="NYC タクシーデータの可視化を表示する Splunk ダッシュボード" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Java Home の設定を表示する Splunk DB Connect の設定ページ" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="ClickHouse ドライバーが正常にインストールされていることを示す Splunk DB Connect のドライバーページ" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Splunk DB Connect の新規接続ボタン" />

<br />

ClickHouse のホスト情報を入力し、&quot;Enable SSL&quot; にチェックが入っていることを確認します。

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="ClickHouse 用の Splunk 接続設定ページ" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="ClickHouse への接続を選択している Splunk SQL Explorer" />

`trips` テーブルに対して、テーブル内の全レコード数を返す SQLクエリを実行します。

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="trips テーブルのレコード数を表示する Splunk SQLクエリの実行" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="上位 10 件の乗車地域を示す Splunk のカラムチャートの可視化" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="乗客数ごとの平均運賃を示すSplunkの棒グラフ" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="NYCのタクシーデータを複数の可視化で表示した完成版のSplunkダッシュボード" />
