...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="Published Data Source を作成するための「New」ボタンが表示された Tableau Online のインターフェイス" border />

<br />

使用可能なコネクタの一覧から &quot;MySQL&quot; を選択します。

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="MySQL オプションが強調表示された Tableau Online のコネクタ選択画面" border />

<br />

ClickHouse のセットアップ時に取得した接続情報を入力します。

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="server、port、database、認証情報の各フィールドがある Tableau Online の MySQL 接続設定画面" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="左側にデータベーステーブル、右側にドラッグアンドドロップ可能なキャンバスが表示された Tableau Online のデータソースページ" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="MySQL オプションが強調表示された Connect メニューを示す Tableau Desktop のインターフェイス" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="SSL オプションが有効になっており、server、username、password、certificate の各フィールドが表示された Tableau Desktop の MySQL 接続ダイアログ" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Publish Data Source オプションが強調表示された Server メニューを示す Tableau Desktop" border />

<br />

重要: &quot;Authentication&quot; オプションで &quot;Embedded password&quot; を選択する必要があります。

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="Embedded password が選択された Authentication オプションを示す Tableau Desktop の公開ダイアログ" border />

<br />

さらに、&quot;Update workbook to use the published data source&quot; を選択します。

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="'Update workbook to use the published data source' オプションがチェックされた Tableau Desktop の公開ダイアログ" border />
