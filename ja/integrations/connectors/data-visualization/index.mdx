...
データが ClickHouse に取り込まれたら、次は分析です。多くの場合、その際には BI ツールを使って可視化を行います。一般的な BI ツールや可視化ツールの多くは ClickHouse に接続できます。ClickHouse に標準で接続できるものもあれば、コネクタのインストールが必要なものもあります。以下をはじめ、いくつかのツールについてのドキュメントを用意しています。
...
* [Grafana](/ja/integrations/connectors/data-visualization/grafana)
...
* [Zing Data](/ja/integrations/connectors/data-visualization/community-integrations/zingdata-and-clickhouse)
...
| [Grafana](/ja/integrations/connectors/data-visualization/grafana)                                           | ClickHouse公式コネクタ  | ✅    | ✅        |                                                                                                                                  |
...
| [Zing Data](/ja/integrations/connectors/data-visualization/community-integrations/zingdata-and-clickhouse)  | ネイティブコネクタ         | ✅    | ✅        |                                                                                                                                  |