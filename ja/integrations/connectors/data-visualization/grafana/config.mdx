...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="セキュアなネイティブ設定の例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="追加の HTTP 設定オプション" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="追加設定の例" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="トレース設定" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="エイリアステーブル設定の例" border />

これで Grafana では、`DESC example_table` の結果ではなく、別名テーブル の結果が表示されます。

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="エイリアステーブル選択の例" border />
