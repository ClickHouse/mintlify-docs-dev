...
<Image size="lg" img="/images/integrations/data-visualization/omni_01.png" alt="Connections セクションの Add Connection ボタンを示す Omni の管理インターフェイス" border />

<br />

`ClickHouse` を選択し、フォームに認証情報を入力します。

<Image size="lg" img="/images/integrations/data-visualization/omni_02.png" alt="認証情報の入力フィールドが表示された、ClickHouse 用の Omni 接続設定インターフェイス" border />
