...
description: 'Lightdash は dbt を基盤としたモダンなオープンソース BI ツールで、チームはセマンティックレイヤーを通じて ClickHouse のデータを探索・可視化できます。Lightdash を ClickHouse に接続して、dbt を基盤とする高速で統制の取れた分析を実現する方法を紹介します。'
title: Lightdash
doc_type: 'guide'
integration:
