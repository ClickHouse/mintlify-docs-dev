...
description: 'Lightdash は dbt を基盤とするモダンなオープンソース BI ツールで、チームがセマンティックレイヤーを通じて ClickHouse のデータを探索・可視化できるようにします。dbt を活用した高速でガバナンスの効いた分析を実現するために、Lightdash を ClickHouse に接続する方法を紹介します。'
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Lightdash ダッシュボードの例" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="lightdash-clickhouse プロジェクト用の profiles.yml 設定例" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt=".yml ファイルでメトリクスが定義されている例" border />
  ...
  <Step>
    ...
    **Explore** ページは、次の 5 つの主要エリアで構成されています。
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="次元、フィルター、チャート、結果、SQL を表示する Lightdash の Explore ビュー" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Lightdash ダッシュボード内でチャートを作成して整理する" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="dbt のメトリクスを基盤にした自然言語クエリを表示する Lightdash の Ask AI インターフェイス" border />
