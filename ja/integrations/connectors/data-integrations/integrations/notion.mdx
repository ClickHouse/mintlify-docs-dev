...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="NotionのAdd connection pickerでClickHouseを選択している画面" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="ツールごとのトグルが表示された、Notionで展開されたClickHouse接続" />
