---
sidebarTitle: 'ClickHouse向け SQL Server CDC'
keywords: ['ClickHouse', 'Streamkap', 'CDC', 'SQL Server', '接続', 'インテグレーション', 'ETL', 'データインテグレーション', '変更データキャプチャ']
slug: /integrations/data-ingestion/etl-tools/sql-server-clickhouse
description: 'SQL Server から ClickHouse へデータをストリーミングして高速分析を実現'
title: 'SQL Server から ClickHouse へデータをストリーミングして高速分析を実現'
doc_type: 'guide'
---
...
<div id="streaming-data-from-sql-server-to-clickhouse-for-fast-analytics-step-by-step-guide">
  # SQL ServerからClickHouseへデータをストリーミングして高速分析を実現する: ステップバイステップガイド
</div>
