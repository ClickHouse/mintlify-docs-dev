...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="ノートブックで Spark 設定を行う" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Spark UI を使用した ClickHouse 設定の確認" border />

<div id="additional-resources">
  ## 追加リソース
</div>

* [ClickHouse Spark コネクタのドキュメント](/ja/integrations/connectors/data-ingestion/apache-spark)
