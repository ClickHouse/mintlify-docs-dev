...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="実行中の Pub/Sub から ClickHouse へのジョブが表示された Dataflow コンソール" />
