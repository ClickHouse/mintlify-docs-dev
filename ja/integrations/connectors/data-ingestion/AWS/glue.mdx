...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Glue Notebook の接続設定" force="true" />
  ...
  <Tab title="手動インストール">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Glue Notebook の JAR パスオプション" force="true" />
  </Tab>
</Tabs>
...
詳細は、[Spark のドキュメント](/ja/integrations/connectors/data-ingestion/apache-spark/index)をご覧ください。