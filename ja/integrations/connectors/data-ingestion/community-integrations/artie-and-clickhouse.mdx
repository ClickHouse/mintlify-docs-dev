...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Artie サインアップページ" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Artie パイプライン編集インターフェイス" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="分析ポータル" />

パイプラインおよびテーブルごとの監視

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="組み込みの監視" />

日次のスキーマ変更通知

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="スキーマ変更通知" />