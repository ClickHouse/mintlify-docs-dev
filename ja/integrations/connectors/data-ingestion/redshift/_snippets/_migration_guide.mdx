...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="PUSH Redshift から ClickHouse" />
...
* データ変換のユースケースにも対応できます (たとえば、[dbt のインテグレーションガイド](/ja/integrations/connectors/data-ingestion/etl-tools/dbt) を参照してください) 。
