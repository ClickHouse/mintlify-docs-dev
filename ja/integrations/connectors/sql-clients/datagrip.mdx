...
<Image img="/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="**+** アイコンが強調表示された DataGrip の Data Sources タブ" />
...
<Image img="/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="データソースの一覧から ClickHouse を選択している DataGrip" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="ClickHouse ドライバーのインストール画面を表示している DataGrip の Drivers タブ" />
...
<Image img="/images/integrations/sql-clients/datagrip-7.png" border alt="ClickHouse 設定を含む DataGrip の接続情報フォーム" />
