...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="ClickHouse に接続" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="新しいデータベースを追加" />

データベースの詳細を入力するよう求められます。

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="データベースの詳細を入力" />

続いて、接続を確立するためのセルが表示されるので、これを実行します。

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="ClickHouse に接続するためにセルを実行" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="SQL エンジンを選択" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="DataFrame 内の結果" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="ドロップダウン、テーブル、グラフの組み合わせ" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="App View の実行" />