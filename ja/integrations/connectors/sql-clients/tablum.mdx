...
<Image img="/images/integrations/sql-clients/tablum-ch-0.png" size="md" border alt="TABLUM.IO のログインページ" />
...
<Image img="/images/integrations/sql-clients/tablum-ch-1.png" size="lg" border alt="TABLUM.IO で ClickHouse コネクタを追加する" />
...
<Image img="/images/integrations/sql-clients/tablum-ch-2.png" size="lg" border alt="TABLUM.IO で ClickHouse コネクタを選択" />
...
<Image img="/images/integrations/sql-clients/tablum-ch-3.png" size="lg" border alt="TABLUM.IOでSQLクエリを実行する" />
