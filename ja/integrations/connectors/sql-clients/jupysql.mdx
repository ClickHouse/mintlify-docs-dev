...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="short-trips データセットにおける移動距離の分布を 10 個のビンで示したヒストグラム" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="50個のビンとグリッド付きで、移動距離の分布を示すヒストグラム。タイトルは「Trip distance from trips < 6.3」" border />