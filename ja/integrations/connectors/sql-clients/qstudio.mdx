...
<Image img="/images/integrations/sql-clients/qstudio-add-connection.png" size="lg" border alt="ClickHouse 接続設定を表示している QStudio のデータベース接続設定画面" />
...
<Image img="/images/integrations/sql-clients/qstudio-running-query.png" size="lg" border alt="ClickHouse データベースに対するサンプル SQL クエリの実行を示す QStudio インターフェイス" />
