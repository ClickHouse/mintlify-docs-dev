...
description: 'Python から ClickHouse に接続するための ClickHouse Connect スイート'
title: 'ClickHouse Connect を使用した ClickHouse 向け Python インテグレーション'
sidebarTitle: 'はじめに'
doc_type: 'guide'
integration:
  - support_level: 'core'
...
* `clickhouse_connect.cdriver` パッケージ内の Cython/C クラスは、純粋な Python と比べて大幅に高い性能が得られるよう、最も一般的なシリアライゼーションとデシリアライゼーションの一部を最適化しています。
