---
description: 'さまざまなプログラミング言語で利用可能なサードパーティ製クライアントライブラリの概要'
sidebarTitle: 'クライアントライブラリ'
slug: /interfaces/third-party/client-libraries
title: 'サードパーティ開発者提供のクライアントライブラリ'
doc_type: 'reference'
---

<Note>
  ClickHouse Inc は、以下に記載するライブラリを**保守しておらず**、品質を確認するための広範なテストも実施していません。
</Note>
...
* [userverフレームワーク向け ClickHouse ドライバー](https://userver.tech/dd/ddb/clickhouse_driver.html)
