...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/copy_api_key.png" alt="API key をコピー" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="HyperDX Kubernetes データ" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="Kubernetes 上の ClickHouse" size="lg" />