...
<Tabs>
  <Tab title="Managed ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="マネージド アーキテクチャ" size="lg" />
  ...
  <Tab title="オープンソース版 ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="アーキテクチャ" size="lg" />
