...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Bindplane 経由で ClickStack に送られるテレメトリーシグナル" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Bindplane 経由で ClickStack に送られるテレメトリーシグナル" size="lg" />
  </Step>
</Steps>
