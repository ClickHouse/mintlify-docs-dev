...
<Steps>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/hyperdx-visualization-2.png" alt="シンプルな可視化" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-visualization-3.png" alt="シンプルな可視化 2" size="lg" />
...
<Info>
  **必要なシステムテーブルへのアクセス権**
  ...
  このダッシュボードでは、主要なメトリクスを表示するために ClickHouse の [システムテーブル](/ja/reference/system-tables) をクエリします。次の権限が必要です。
