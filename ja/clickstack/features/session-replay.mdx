...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="セッションリプレイの検索ビュー" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="セッションリプレイの再生" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="ClickStack でセッションリプレイからバックエンドトレースへドリルダウンする" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Session replay のトレースビュー" size="lg" />
