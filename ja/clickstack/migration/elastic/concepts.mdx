...
<Image img="/images/use-cases/observability/clickhouse-execution.png" alt="ClickHouse の実行" size="lg" />
...
<Image img="/images/use-cases/observability/elasticsearch-execution.png" alt="Elasticsearch の実行" size="lg" />
