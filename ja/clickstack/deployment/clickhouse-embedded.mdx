  ...
  <Tab title="Docker">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="認証" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="ログソースを作成" size="lg" />
