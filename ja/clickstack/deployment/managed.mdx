  ...
  <Tab title="新しいサービスを作成">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/getting-started/new_service.png" size="lg" alt="サービス作成画面" border />
      </Step>
  ...
  <Tab title="既存のサービスを使用する">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/clickstack-ui-setup-ingestion.png" alt="ClickStack UI でインジェストを設定する" size="lg" />
        ...
        <Image img="/images/clickstack/select-source-clickstack-ui.png" size="lg" alt="ログソースを選択 - ClickStack UI" border />
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/otel-collector-start-clickstack-ui.png" size="md" alt="OTel collector ソース" />
            ...
            **このコマンドは、service の作成時に記録した service credentials に合わせて変更してください。**
            ...
            <Image img="/images/clickstack/advanced-otel-collector-clickstack-ui.png" size="lg" alt="高度な OTel collector ソース" />
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/vector-config-clickstack-ui.png" size="lg" alt="Vector の設定" />
      ...
      <Step>
        ...
        <Tabs>
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/create-vector-datasource.png" alt="データソースを作成 - Vector" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx_cloud_datasource.png" alt="ClickHouse Cloud HyperDX データソース" size="lg" />

traces と OTel メトリクスのソースを作成するには、上部メニューから `新しいソースを作成` を選択します。

<Image img="/images/use-cases/observability/hyperdx_create_new_source.png" alt="ClickStack 新しいソースを作成" size="lg" />

ここでは、必要なソースタイプを選択してから、適切なテーブルを選択します。たとえば traces の場合は、`otel_traces` テーブルを選択します。すべての設定は自動検出されます。

<Image img="/images/use-cases/observability/hyperdx_create_trace_datasource.png" alt="ClickStack トレースソースを作成" size="lg" />
