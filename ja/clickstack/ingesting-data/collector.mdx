...
<Tabs>
  ...
  <Tab title="オープンソース版 ClickStack">
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="インジェスト keys" size="lg" />
...
<Image img="/images/use-cases/observability/clickstack-with-gateways.png" alt="ゲートウェイによるスケーリング" size="lg" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="Kafka の追加" size="lg" />
