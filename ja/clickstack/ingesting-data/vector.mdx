  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Vector 用の ClickStack を起動" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource.png" alt="データソースの作成 - vector" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="ClickStack 内の Nginx ログ" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="オープンソース版 ClickStack">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="ClickStack の Play UI" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="ClickStack ログイン" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="データソースの作成 - vector" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="ClickStack の Nginx ログ" size="lg" />
      </Step>
    </Steps>
  </Tab>
</Tabs>
  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Vector 用の ClickStack の起動" size="lg" />
      </Step>
