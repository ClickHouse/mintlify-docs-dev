...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Searchビュー" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="ログビュー" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Kafkaログ ダッシュボードのインポート完了" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Kafkaログ のダッシュボード例" />
  </Step>
</Steps>
