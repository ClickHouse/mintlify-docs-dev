...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="ログビュー" />

    <Image img="/images/clickstack/log-view.png" alt="ログビュー" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="インポートの完了" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="ダッシュボードの例" />
  </Step>
</Steps>
