...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB ログの検索ビュー" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="MongoDB ログの詳細ビュー" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB ログの Search ビュー" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ja/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">ダウンロード</TrackedLink>してダッシュボード設定を取得します
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="ダッシュボードのインポート" />

    3. mongodb-logs-dashboard.json ファイルをアップロードし、インポートを完了します。

    <Image img="/images/clickstack/mongodb/finish-import.png" alt="MongoDB ログダッシュボードのインポート完了" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="MongoDB ログダッシュボード" />
  </Step>
</Steps>
