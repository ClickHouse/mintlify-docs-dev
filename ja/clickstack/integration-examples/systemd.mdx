...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="ログ検索ビュー" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="ログビュー" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="インポートの完了" />
  </Step>
  ...
  <Step>
    ...
    * エラー率
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="ダッシュボードの例" />
