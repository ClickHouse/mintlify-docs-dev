...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="EC2 ログの Search view" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="メタデータが表示された EC2 ログの詳細" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="EC2 ログの検索ビュー" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="メタデータ付きの EC2 ログ詳細" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ja/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">ダウンロード</TrackedLink> ダッシュボード設定
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="ダッシュボードのインポートボタン" />

    3. `host-logs-dashboard.json` ファイルをアップロードし、**Finish Import** をクリックします

    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="インポートの完了" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="EC2 ログダッシュボード" />
