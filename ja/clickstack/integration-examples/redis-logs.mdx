...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="ログビュー" />

    <Image img="/images/clickstack/redis/redis-log.png" alt="ログ" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="ダッシュボードをインポート" />

    3. redis-logs-dashboard.json ファイルをアップロードし、「finish import」をクリックします。

    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="インポートを完了" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="ダッシュボードの例" />
  </Step>
</Steps>
