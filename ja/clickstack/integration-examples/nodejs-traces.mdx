...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="トレース検索ビュー" />

    任意のトレースをクリックすると、span、タイミング、属性を含む詳細ビューを確認できます。

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="個別トレースビュー" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/trace-view.png" alt="個別のトレースビュー" />
