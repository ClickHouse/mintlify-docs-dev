...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Import Dashboard ボタン" />

    3. `postgres-metrics-dashboard.json` ファイルをアップロードし、**Finish Import** をクリックします

    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="Finish Import ダイアログ" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="PostgreSQL メトリクスダッシュボード" />
