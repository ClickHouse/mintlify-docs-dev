...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="インポート完了ダイアログ" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="Kafka メトリクスダッシュボード" />
