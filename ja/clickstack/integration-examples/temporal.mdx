...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Temporalメトリクス" size="md" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ja/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">ダウンロード</TrackedLink> ダッシュボード設定
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="インポート完了ダイアログ" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Temporal メトリクスのダッシュボード" />
  </Step>
</Steps>
