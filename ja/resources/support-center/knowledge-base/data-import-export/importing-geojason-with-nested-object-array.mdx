...
description: "深くネストされたオブジェクト配列を含むGeoJSONのインポート"
date: 2024-12-18
tags: ['データフォーマット']
keywords: ['GeoJSON']
---
...
これを行うには、関数 [arrayMap(func,arr1,...)](/ja/reference/functions/regular-functions/array-functions#arraymapfunc-arr1-) を使用できます。
