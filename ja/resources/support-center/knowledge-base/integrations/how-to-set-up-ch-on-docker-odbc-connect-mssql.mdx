...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="MSSQL のデータベースとテーブル構造" border />

MSSQL のログインユーザー `sql_user`:

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="MSSQL のログインユーザー設定" border />

`sql_user` のデータベース メンバーシップ ロール:

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="MSSQL のデータベース メンバーシップ ロール" border />

ログインに関連付けられたデータベースユーザー:

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="ログインに関連付けられた MSSQL データベースユーザー" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/ja/snippets/engines/table-engines/integrations/odbc)
