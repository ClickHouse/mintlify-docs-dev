...
[mutation](/ja/reference/statements/alter#mutations) の詳細も参照してください。
...
テーブルからすべてのデータを削除するのはかなり大胆な操作ですが、場合によっては、まさにそれが必要になることもあります。

詳細は[テーブルの TRUNCATE](/ja/reference/statements/truncate)を参照してください。