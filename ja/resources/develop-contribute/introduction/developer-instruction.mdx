...
関数の簡単な説明をここに記述します。関数の動作と典型的なユースケースを簡潔に説明してください。
...
- `arg1` — 引数の説明。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg2` — 引数の説明。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg3` — オプション引数の説明（省略可）。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}

**Implementation Details**

該当する場合は、実装の詳細についての説明をここに記述します。

**Returned value**

- {関数が返す値をここに記述} を返します。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
