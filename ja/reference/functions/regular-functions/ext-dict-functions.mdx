...
* `id_expr` — キーの値。UInt64/Tuple(T) を返す式。[`UInt64`](/ja/reference/data-types/int-uint) または [`Tuple(T)`](/ja/reference/data-types/tuple)
...
Dictionary の属性値を、Dictionary の設定にかかわらず `All` データ型に変換します。
...
-- キーが存在しない場合、指定されたデフォルト値（-1.0）を返す
...
Dictionary の設定にかかわらず、辞書の属性値を `IPv4` データ型に変換します。キーが見つからない場合は、指定したデフォルト値を返します。
...
辞書設定にかかわらず、辞書属性の値を `IPv6` データ型に変換します。キーが見つからない場合は、指定されたデフォルト値を返します。
...
* `dict_name` — Dictionary の名前。[`String`](/ja/reference/data-types/string)
* `attr_names` — Dictionary のカラム名、またはカラム名のタプル。[`String`](/ja/reference/data-types/string) または [`Tuple(String)`](/ja/reference/data-types/tuple)
* `id_expr` — キー値。UInt64/Tuple(T) を返す式。[`UInt64`](/ja/reference/data-types/int-uint) または [`Tuple(T)`](/ja/reference/data-types/tuple)
...
Dictionary の設定にかかわらず、辞書 attribute の値を `String` データ型に変換するか、秘密鍵が見つからない場合は指定したデフォルト値を返します。
...
* `dict_name` — 辞書名。[`String`](/ja/reference/data-types/string)
* `attr_name` — 辞書のカラム名。[`String`](/ja/reference/data-types/string) または [`Tuple(String)`](/ja/reference/data-types/tuple)
* `id_expr` — キーとして使用する値。辞書キー型の値またはタプル値を返す式 (辞書設定に依存) 。[`Expression`](/ja/reference/data-types/special-data-types/expression) または [`Tuple(T)`](/ja/reference/data-types/tuple)
* `default_value_expr` — 辞書に `id_expr` キーを持つ行が存在しない場合に返される値。[`Expression`](/ja/reference/data-types/special-data-types/expression) または [`Tuple(T)`](/ja/reference/data-types/tuple)
...
Dictionary の設定に関係なく、ディクショナリ属性の値を `UUID` データ型に変換します。キーが見つからない場合は、指定されたデフォルト値を返します。
