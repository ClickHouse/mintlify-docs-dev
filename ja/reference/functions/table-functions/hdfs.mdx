...
HDFS 内のファイルからテーブルを作成するテーブル関数です。このテーブル関数は、[url](/ja/reference/functions/table-functions/url) および [file](/ja/reference/functions/table-functions/file) テーブル関数に似ています。
