...
キー `user_name`、`ip_address`、`client_key`、`client_key, user_name`、`client_key, ip_address`、`normalized_query_hash` は、[system.quotas](/ja/reference/system-tables/quotas) テーブルのフィールドに対応します。
