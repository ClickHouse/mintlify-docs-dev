...
<Note>
  フォーマットパーサーの詳細については、[Formats](/ja/reference/formats) セクションを参照してください。
</Note>
...
詳細は、[データ型](/ja/reference/data-types) を参照してください。
...
<Note>
  ...
  * データのフォーマット (入力または出力) によって、`NULL` の表現は異なる場合があります。詳細は、[data formats](/ja/reference/formats) を参照してください。
...
* [CREATE](/ja/reference/statements/create).
...
詳しくは、[SELECT](/ja/reference/statements/select#asterisk)のセクションを参照してください。