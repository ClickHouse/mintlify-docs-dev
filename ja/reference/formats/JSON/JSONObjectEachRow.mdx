...
ClickHouse は、省略された値を対応する[data types](/ja/reference/data-types)のデフォルト値に置き換えます。
...
[`Nested`](/ja/reference/data-types/nested-data-structures) データ型のカラムを持つテーブルがある場合、同じ構造の JSON データを挿入できます。この機能は、[input&#95;format&#95;import&#95;nested&#95;json](/ja/reference/settings/formats#input_format_import_nested_json) 設定を有効にすることで使用できます。
