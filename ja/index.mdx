    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        links={[
          ...
          { label: "セットアップ/インストール", href: "/get-started/setup/cloud" },
          { label: "クイックスタートを見る", href: "/get-started/quickstarts/home" },
          { label: "移行ガイド", href: "/get-started/migrate/overview" },
          { label: "ClickHouse の基礎", href: "/concepts/core-concepts/index" },
          { label: "コンセプト（機能）", href: "/concepts/features/index" },
      ...
      <HeroCard
        ...
        links={[
          ...
          { label: "セッション設定", href: "/reference/settings/session-settings" },
          { label: "サーバー設定", href: "/reference/settings/server-settings/settings" },
