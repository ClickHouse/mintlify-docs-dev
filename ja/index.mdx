...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        title="はじめる"
        description="ここは初めてなので、ClickHouse の製品ドキュメントを読み始めるか、見てみたいです"
        icon={
      ...
      <HeroCard
        title="ガイド"
        description="ClickHouse の機能の活用方法や高度なトピックを学びたい"
        icon={
      ...
      <HeroCard
        title="当社のソリューション"
        description="ログ、メトリクス、トレースを取り込み、システムを監視し、オブザーバビリティダッシュボードを支えます。"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        <div className="col-span-2">
          <HeroCard
            ...
            links={[
                ...
                { label: "分析と成長のためにデータを整理するベストプラクティス", href: "/data-modeling/schema-design" },
                ...
                { label: "高いパフォーマンスを維持しながらコストを抑えるためのヒント", href: "/operations/best-practices" },
            ]}
          />
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="chDB" description="高速で信頼性が高く、スケーラブルなインプロセスデータベース。ClickHouse の力をインプロセスで体験してください。" href="/ja/products/chdb" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <HeroCard filename="product-chdb-light.png" title="chDB" description="高速で信頼性が高く、スケーラブルなインプロセスデータベース。インプロセスで ClickHouse のパワーを体感できます。" href="/ja/products/chdb" showArrow />
      </div>
    </div>
