    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="高速で信頼性が高く、スケーラブルなインプロセスデータベース。インプロセスで ClickHouse の性能を活用できます。" href="/ja/products/chdb/index" showArrow />
        </div>
      </div>
