...
<Info>
  **要点**
  ...
  データレイクのテーブルにクエリを実行し、MergeTree で高速化し、その結果を Iceberg に書き戻すまでの実践的な手順を紹介します。すべての手順で公開データセットを使用し、Cloud と OSS の両方で利用できます。
</Info>
...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Iceberg クエリ" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Iceberg クエリ" />
  ...
  <Step>
    ...
    カタログの種類ごとに、それぞれ専用の接続設定が必要です。サポートされているカタログの一覧と各カタログの設定オプションについては、[カタログ ガイド](/ja/guides/use-cases/data-warehousing/reference)を参照してください。
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Iceberg クエリ" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="ClickHouse クエリ" />
