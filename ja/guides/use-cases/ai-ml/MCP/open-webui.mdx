...
sidebarTitle: 'Open WebUI と統合する'
title: 'Open WebUI と ClickHouse Cloud で ClickHouse MCPサーバー をセットアップする'
description: 'このガイドでは、Docker を使用して、ClickHouse MCPサーバー と Open WebUI をセットアップする方法を説明します。'
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/0_endpoints.png" alt="Open API エンドポイント" size="md" />

    これらのエンドポイントを Open WebUI で使うには、設定画面に移動します。

    <Image img="/images/use-cases/AI_ML/MCP/1_settings.png" alt="Open WebUI の設定" size="md" />

    `Tools` をクリックします。

    <Image img="/images/use-cases/AI_ML/MCP/2_tools_page.png" alt="Open WebUI のツール" size="md" />

    ツール URL として http://localhost:8000 を追加します。

    <Image img="/images/use-cases/AI_ML/MCP/3_add_tool.png" alt="Open WebUI のツール" size="md" />

    設定が完了すると、チャットバーのツールアイコンの横に `1` が表示されます。

    <Image img="/images/use-cases/AI_ML/MCP/4_tools_available.png" alt="Open WebUI で利用可能なツール" size="md" />

    ツールアイコンをクリックすると、利用可能なツールの一覧を確認できます。

    <Image img="/images/use-cases/AI_ML/MCP/5_list_of_tools.png" alt="Open WebUI のツール一覧" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/6_connections.png" alt="Open WebUI の接続" size="md" />

    エンドポイントと OpenAI キーを追加しましょう。

    <Image img="/images/use-cases/AI_ML/MCP/7_add_connection.png" alt="Open WebUI - 接続として OpenAI を追加" size="md" />

    すると、OpenAI のモデルが上部メニューから利用できるようになります。

    <Image img="/images/use-cases/AI_ML/MCP/8_openai_models_more.png" alt="Open WebUI - モデル" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/9_conversation.png" alt="Open WebUI - ClickHouse MCPサーバーとチャットする" size="md" />
  </Step>
</Steps>