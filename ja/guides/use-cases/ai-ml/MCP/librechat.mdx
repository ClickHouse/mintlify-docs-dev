...
title: 'LibreChatとClickHouse CloudでClickHouse MCPサーバーを設定する'
...
<div id="using-clickhouse-mcp-server-with-librechat">
  # LibreChat で ClickHouse MCPサーバーを使用する
</div>

> このガイドでは、Docker を使用して ClickHouse MCPサーバーと連携する LibreChat をセットアップし、
...
<Steps>
  ...
  <Step>
    ## Docker composeにClickHouse MCPサーバーを追加する
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="MCPサーバーを選択" size="md" />
