...
このガイドでは、ClickHouse を基盤とする高速なインプロセス SQL OLAP Engine である [chDB](/ja/products/chdb) を使って、Marimo ノートブックで ClickHouse Cloud 上のデータセットを探索する方法を学びます。
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="UK price paid データセットを選択" />

次に `Import dataset` をクリックします。

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="UK price paid データセットをインポート" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Marimoのデータ可視化" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Marimo の動的チャート" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Marimo の動的チャート" />
