...
sidebarTitle: 'Jupyter ノートブックと chDB でデータを探索する'
title: 'chDB を使って Jupyter ノートブック内のデータを探索する'
description: 'このガイドでは、Jupyer ノートブックで ClickHouse Cloud またはローカルファイルのデータを探索するために、chDB の設定方法と使い方を説明します'
...
このガイドでは、ClickHouse を基盤とする高速なインプロセス SQL OLAP エンジン [chDB](/ja/products/chdb) を使って、Jupyter ノートブックで ClickHouse Cloud 上のデータセットを探索する方法を学びます。
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="サンプルデータセットを追加" />

UK property price paid data (4GB) のカードで `Get started` を選択します。

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="英国の不動産価格データセットを選択" />

次に `Import dataset` をクリックします。

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="英国の不動産価格データセットをインポート" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="新しいノートブックを作成" />

カーネルの選択を求められます。
使用可能な Python カーネルをどれでも選択できます。この例では `ipykernel` を選択します。

<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="カーネルを選択" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="データフレームのプレビュー" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="データフレームのプレビュー" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="データフレームのプレビュー" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="リモートデータセットとローカルデータセットのプロット" />
