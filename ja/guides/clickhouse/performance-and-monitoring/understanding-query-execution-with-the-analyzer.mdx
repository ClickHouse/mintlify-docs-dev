...
<Image img="/images/guides/developer/analyzer1.png" alt="EXPLAINクエリのステップ" size="md" />
...
<Image img="/images/guides/developer/analyzer2.png" alt="ASTの出力" size="md" />
...
2回の実行を比較すると、別名とプロジェクションの解決を確認できます。
...
これでもある程度の情報は得られますが、さらに詳しい情報を取得できます。たとえば、どのカラムに対してプロジェクションが必要なのか、そのカラム名を知りたい場合があります。ヘッダーをクエリに追加できます。
...
括弧内はクエリプランのステップ、その隣はプロセッサーです。有益な情報ですが、グラフ構造であるため、視覚的に表示できると便利です。`graph` 設定を 1 に設定し、出力フォーマットを TSV に指定することができます：
...
<Image img="/images/guides/developer/analyzer3.png" alt="グラフ出力" size="md" />
...
<Image img="/images/guides/developer/analyzer4.png" alt="コンパクトなグラフの出力" size="md" />
...
<Image img="/images/guides/developer/analyzer5.png" alt="並列グラフの出力" size="md" />
