...
<Image img="/images/data-compression/ch_compression_block.png" size="md" alt="ClickHouse の圧縮ブロック構造を示す図" />

ヘッダーは (raw&#95;size + data&#95;size + mode) で、raw size は len(header + compressed&#95;data) に相当します。
