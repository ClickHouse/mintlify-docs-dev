...
description: 'JSONスキーマを最適に設計するには'
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="JSON パスごとのカラム" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="JSON オフセット" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="共有 JSON カラム" />
