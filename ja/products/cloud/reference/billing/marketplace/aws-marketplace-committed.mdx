...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="AWS Marketplace のプライベートオファーメール" />
  </Step>
  ...
  <Step>
    ...
    この時点で ClickHouse Cloud にリダイレクトされたら、新しいアカウントを登録するか、既存のアカウントでサインインすることが非常に重要です。
    この手順を完了しないと、AWS Marketplace の契約を ClickHouse Cloud に関連付けることができません。

    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="AWS Marketplace のプライベートオファーメール" />
  </Step>
  ...
  <Step>
    ...
    この手順は、ClickHouse Cloud の組織を AWS Marketplace の請求に関連付けるために必要です。

    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="AWS Marketplace のプライベートオファーメール" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="この subscription の請求先となる組織を作成または選択する" />

    この手順を完了すると、組織が AWS の committed spend contract に接続され、すべての利用料金が AWS アカウント経由で請求されます。
    Billing ページで、請求が AWS Marketplace に正しくリンクされていることを ClickHouse UI 上で確認できます。

    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="セットアップが完了したことを確認する" />
