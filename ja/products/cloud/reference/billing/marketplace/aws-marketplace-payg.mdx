...
<Steps>
  <Step>
    ### ClickHouse Cloud - Pay as you go を検索する

    [AWS Marketplace](https://aws.amazon.com/marketplace) にアクセスし、「ClickHouse Cloud - Pay As You Go」を検索します。

    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-1.png" alt="ClickHouse を検索する AWS Marketplace" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-2.png" alt="購入オプションを表示する AWS Marketplace" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-3.png" alt="サブスクライブする AWS Marketplace" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-4.png" alt="アカウントを設定する" border />
    ...
    <Accordion title="新規ユーザー向けの手順">
      ...
      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-5.png" size="md" alt="ClickHouse Cloud サインアップ" />
      ...
      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-6.png" size="md" alt="開始前" />

      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-7.png" size="md" alt="開始前（続き）" />
    </Accordion>
  ...
  <Step>
    ### マーケットプレイスサブスクリプションを組織に追加する

    ログインに成功すると、このマーケットプレイスサブスクリプションに課金する新しい組織を作成するか、既存の組織を選択してこのサブスクリプションに課金するかを選べます。

    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.png" size="md" alt="マーケットプレイスサブスクリプションを追加する" border />
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-9.png" size="lg" alt="Billing ページを確認する" border />
  </Step>
</Steps>
