...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="UI で Billing を確認する場所" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="請求書" />
