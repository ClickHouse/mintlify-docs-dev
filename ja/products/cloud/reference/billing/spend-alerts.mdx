...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" size="lg" alt="Actions メニューが開き、Add spend alerts が強調表示された Billing ページ" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" size="md" alt="支出上限、自動しきい値アラート、通知チャネルが表示された Organization の支出アラート ダイアログ" />
  </Step>
</Steps>
