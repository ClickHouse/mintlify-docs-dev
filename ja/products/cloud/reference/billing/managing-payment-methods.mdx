...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="支払い方法を追加" size="lg" />

3. クレジットカードを編集する場合は、ページ上部にある **クレジットカードを編集** ボタンをクリックします。

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="クレジットカードを編集" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="支払い方法を編集" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="支払い方法を編集" size="lg" />
