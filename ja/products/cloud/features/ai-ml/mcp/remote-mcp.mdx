...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Connect モーダルで MCP を選択" size="md" />

サービスで MCP を有効にするには、ボタンをオンにします。

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="MCPサーバーを有効にする" size="md" />
...
ClickHouse Cloud のリモートMCPサーバーを Notion のカスタムエージェントに接続するには、専用のインテグレーションガイド [Notion を ClickHouse に接続する](/ja/integrations/connectors/data-integrations/integrations/notion) を参照してください。
