...
| [チャット](/ja/products/cloud/features/ai-ml/agents/chat)                  | 会話、ブックマーク、フォーク、複数会話、共有                        |
| [エージェントビルダー](/ja/products/cloud/features/ai-ml/agents/builder)         | エージェント、モデルパラメータ、接続ツール、MCPサーバー、スキル、サブエージェントの設定 |
