...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="左側で + ボタンが強調表示された プロンプト パネルと、右側で開かれた Create Prompt フォーム。Prompt Name、Text、Category、Special variables、Description、Command の各フィールドと、Create Prompt ボタンが表示されている" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="プロンプト パネルでプロンプトが選択され、右側にその詳細が表示され、Preview と Edit オプションを含むコンテキストメニューが開かれている" size="lg" />

プレビューには、プロンプトのテキストと、その著者および日付が表示されます。**Use Prompt** をクリックすると、内容がコンポーザーに挿入されます。プロンプトに変数がある場合は、先に入力してください。

<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="プロンプトのタイトル、著者、日付、本文テキスト、Use Prompt ボタンが表示されたプロンプトのプレビューモーダル" size="md" />
