...
Memory は、エージェントが会話をまたいで参照できる、ユーザーごとの保存領域です。複数のエントリで構成されており、それぞれがキー・バリューの組になっています。たとえば、希望する
...
<Image img="/images/cloud/agent-builder/memory/memories.png" alt="左側のナビゲーションで脳のアイコンが強調表示され、フィルター入力欄、Add ボタン、Use memory チェックボックス、編集および削除の操作が付いた Memory エントリ、Admin Settings ボタンが表示されている Memories パネル" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="Create Memory の + ボタンが強調表示された Memory パネル" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/filter.png" alt="「Memory を絞り込む」入力欄が強調表示され、「demo」と入力された Memory パネル" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/edit.png" alt="Edit Memory の鉛筆アイコンが強調表示されたMemoryエントリ" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/delete.png" alt="削除用のごみ箱アイコンが強調表示された Memory エントリ" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="上部の Use memory チェックボックスが強調表示された Memory パネル" size="sm" />
