...
<Image img="/images/cloud/agent-builder/run-code/run-code.png" alt="Capabilities パネルの Run Code セクション。Run Code のチェックボックスがオンになっており、Upload to Code Environment ボタンが表示されている" size="sm" />
