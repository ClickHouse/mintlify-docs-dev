...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="OpenAI Image Tools、DALL-E-3、Stable Diffusion などの画像モデルのインテグレーションが、ほかのサードパーティーツールとともに表示された Agent Tools モーダル" size="md" />
