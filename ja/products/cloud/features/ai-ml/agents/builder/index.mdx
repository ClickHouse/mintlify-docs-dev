...
<Tip>
  ClickHouse Agents を初めて使う方は、まず[クイックスタート](/ja/products/cloud/features/ai-ml/agents/quickstart)をご覧ください。以下のページでは、ビルダーの各機能を詳しく説明しています。
</Tip>
...
| ページ                                                                           | 説明                            |
| ----------------------------------------------------------------------------- | ----------------------------- |
| [モデルパラメータ](/ja/products/cloud/features/ai-ml/agents/builder/model-parameters)    | モデルを選択し、生成パラメータを調整します。        |
