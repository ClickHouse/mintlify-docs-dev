...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="Upload to Provider、Upload as Text、Upload to Code Environment の各オプションが表示された、クリップメニューを開いた状態のメッセージコンポーザー" size="lg" />
