...
ClickHouse Cloud なら、パッチ適用やアップグレードを気にする必要はありません。修正、新機能、パフォーマンス向上を含むアップグレードを定期的に実施しています。ClickHouse の最新情報の一覧については、[Cloud changelog](/ja/resources/changelogs/cloud/2026)を参照してください。
...
通常のアップグレードスケジュールに加えて、通常のリリーススケジュールより早くサービスを更新したい場合は、**Fast release** チャネルを利用できます。
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="リリースチャネルの種類を選択" border />
</div>

<br />

この**Fast release**チャネルは、重要度の低い環境で新機能をテストするのに適しています。**高い可用性と信頼性が求められる本番ワークロードには推奨されません。**
...
Enterprise tier のサービスでは、アップグレードの実施時間帯を設定できます。

アップグレードのスケジュールを指定するサービスを選択し、左側のメニューから `Settings` をクリックします。`Scheduled upgrades` までスクロールします。

<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="スケジュールされたアップグレード" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="スケジュールされたアップグレード時間帯" border />
</div>
