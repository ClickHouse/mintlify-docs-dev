...
ClickHouse Cloud なら、パッチ適用やアップグレードを気にする必要はありません。修正、新機能、パフォーマンス向上を含むアップグレードを定期的に実施しています。ClickHouse の最新情報の一覧については、[Cloud changelog](/ja/resources/changelogs/cloud)を参照してください。
