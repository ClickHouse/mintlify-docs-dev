...
通知は複数のチャネルで受け取れます。ClickHouse Cloud では、メール、ClickHouse Cloud UI、Slack で通知を受信できます。現在の通知を表示するには、左上のメニューにあるベルアイコンをクリックします。すると、フライアウトが開きます。フライアウト下部の **View All** ボタンをクリックすると、すべての通知のアクティビティログが表示されるページに移動します。

<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="ClickHouse Cloud の通知フライアウト" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="ClickHouse Cloud の通知アクティビティログ" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="ClickHouse Cloud 通知設定画面" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="ClickHouse Cloud 通知配信設定" border />
