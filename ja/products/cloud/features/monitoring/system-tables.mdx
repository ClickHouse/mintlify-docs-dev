...
description: 'システムテーブルを直接クエリしてClickHouse Cloudを監視する'
...
<div id="querying-clickhouses-system-database">
  # ClickHouse の system データベースをクエリする
</div>
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="ネイティブの高度なオブザーバビリティダッシュボード" border />
