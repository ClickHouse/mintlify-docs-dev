...
title: 'Prometheus 互換のメトリクス エンドポイント'
...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Grafana のメトリクス エンドポイントを設定" border />

<br />

設定が完了すると、ダッシュボードを構成する際に選択できるドロップダウンにメトリクスが表示されます。

<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Grafana メトリクス エクスプローラーのドロップダウン" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Grafana メトリクス エクスプローラーのグラフ" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Grafana メトリクスエクスプローラー" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Prometheus と Datadog のインテグレーション" />
