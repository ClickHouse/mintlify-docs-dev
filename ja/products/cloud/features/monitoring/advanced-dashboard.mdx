...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="高度なダッシュボード" />
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="高度なダッシュボード" />

各可視化には、その内容を表示するための SQL クエリが関連付けられています。ペンアイコンをクリックすると、このクエリを編集できます。

<Image img="/images/cloud/manage/monitoring/edit_visualization.png" size="lg" alt="高度なダッシュボード" />
...
<Image img="/images/cloud/manage/monitoring/inserted_rows_max_parts_for_partition.png" size="lg" alt="非バッチ挿入" />
...
<Image img="/images/cloud/manage/monitoring/resource_intensive_query.png" size="lg" alt="リソース負荷の高いクエリ" />
...
<Image img="/images/cloud/manage/monitoring/selected_rows_sec.png" size="lg" alt="リソース負荷の高いクエリ" />
