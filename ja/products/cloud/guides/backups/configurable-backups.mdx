...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="バックアップ設定を設定する" border />

クリックすると右側にタブが開き、バックアップ保持期間、頻度、開始時刻を選択できます。設定を反映するには、選択した内容を保存する必要があります。

<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="バックアップ保持期間と頻度を選択する" border />
