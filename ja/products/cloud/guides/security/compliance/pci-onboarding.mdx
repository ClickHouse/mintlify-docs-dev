...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_1.png" size="md" alt="PCI を有効化" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/pci_2.png" size="md" alt="PCI が有効" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_3.png" size="md" alt="PCI リージョンにデプロイ" background="black" />
