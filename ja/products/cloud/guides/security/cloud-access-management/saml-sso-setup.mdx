...
現在、サービスプロバイダー開始型 SSO、個別の接続を使用する複数の組織、ならびにジャストインタイムプロビジョニングをサポートしています。現時点では、System for Cross-domain Identity Management (SCIM) や属性マッピングには対応していません。
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="SAMLセットアップを開始" force />
  </Step>
  ...
  <Step>
    ...
    * [Duo SAML を設定する](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="ID プロバイダーのアプリケーションを作成する" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="メタデータURLを追加" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="検証するドメインを追加" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="ドメインを確認する" force />
  </Step>
