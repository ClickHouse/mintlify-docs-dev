...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-gcp-subnet.png" size="lg" alt="Private Google Access が有効で、プライマリおよびセカンダリ IPv4 範囲が表示された BYOC GCP サブネットの詳細" />
  </Step>
  ...
  <Step>
    ...
    ClickHouse Cloud コンソールで、新しいインフラストラクチャを設定する際に以下を構成します。
    ...
    <Image img="/images/cloud/reference/byoc-gcp-existing-vpc-ui.png" size="lg" alt="GCP 用に Use existing VPC が選択された ClickHouse Cloud BYOC セットアップ UI" />
  </Step>
</Steps>