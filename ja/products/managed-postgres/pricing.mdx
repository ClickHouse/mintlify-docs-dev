...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', margin: '24px 0'}}>
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>新しいアイデアの検証や小規模プロジェクトの立ち上げに最適です。ストレージとメモリには制限があります。</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>本番環境や大規模データ、プロフェッショナル用途に適しています。</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>本番環境での運用、非常に大規模なデータ処理、またはエンタープライズ向けのユースケースに適しています。</p>
    ...
    <ul style={{paddingLeft: '20px', margin: 0, fontSize: '0.9rem'}}>
      ...
      <li><a href="/ja/products/cloud/guides/infrastructure/deployment-options/clickhouse-private">プライベートリージョン</a></li>
