...
Managed Postgres には、PostGIS、pgvector、pg&#95;cron をはじめとする一般的なものを含め、100 種類以上の PostgreSQL 拡張機能が用意されています。利用可能な拡張機能の一覧とインストール手順については、[拡張機能](/ja/products/managed-postgres/extensions) のドキュメントを参照してください。
