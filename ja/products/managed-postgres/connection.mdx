...
<Image img="/images/managed-postgres/connect-button.png" alt="接続情報を表示するには、左側のサイドバーで Connect をクリックします" size="md" border />

**Connect** をクリックするとモーダルが開き、接続資格情報と複数のフォーマットの接続文字列が表示されます。

<Image img="/images/managed-postgres/connect-modal.png" alt="資格情報と接続文字列のフォーマットを表示する接続モーダル" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Settings タブから CA 証明書をダウンロード" size="md" border />
