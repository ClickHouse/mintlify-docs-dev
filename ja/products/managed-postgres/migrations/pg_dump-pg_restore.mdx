...
title: 'pg_dump と pg_restore を使用した PostgreSQL データの移行'
...
このガイドでは、`pg_dump` および `pg_restore` ユーティリティを使って PostgreSQL データベースを ClickHouse Managed Postgres に移行する手順を順を追って説明します。
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="ソース PostgreSQL データベースのセットアップ" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump コマンドの実行" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore コマンドの実行" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="移行先の Managed Postgres データベースのセットアップ" size="xl" border />
