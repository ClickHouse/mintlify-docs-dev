...
title: '論理レプリケーションを使用した PostgreSQL データの移行'
...
<div id="logical-replication-migration">
  # 論理レプリケーションを使用して Managed Postgres に移行する
</div>

このガイドでは、Postgres ネイティブの論理レプリケーションを使用して、PostgreSQL データベースを ClickHouse Managed Postgres に移行する手順を順を追って説明します。
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="ソース PostgreSQL レプリケーション設定" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="ソース PostgreSQL テーブルのセットアップ" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="ClickHouse Managed Postgres インスタンスを作成" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="移行先 ClickHouse Managed Postgres の初期セットアップ" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="論理レプリケーション後の移行結果" size="xl" border />
