...
sidebarTitle: 'PeerDB'
title: 'PeerDB を使用した PostgreSQL データの移行'
...
このガイドでは、PeerDB を使用して PostgreSQL データベースを ClickHouse Managed Postgres に移行する手順を順を追って説明します。
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="ソースピアの作成" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="ターゲットピアの作成" size="md" border />

これで、&quot;Peers&quot; セクションにソースピアとターゲットピアの両方が表示されるはずです。

<Image img="/images/managed-postgres/peerdb/peers.png" alt="ピア一覧" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="ミラーの作成" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="ミラー設定" size="md" border />

4. 移行するテーブルを選択します。特定のテーブルを選ぶことも、ソースデータベース内のすべてのテーブルを選ぶこともできます。

<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="テーブル選択" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="ミラー一覧" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="初期ロードの進捗" size="md" border />
