...
description: 'Managed Postgres のメトリクスを Prometheus、Grafana、Datadog、または任意の OpenMetrics 互換 collector にスクレイプします'
...
<Image img="/images/managed-postgres/monitoring/grafana-dashboard.png" alt="Managed Postgres Services の Grafana ダッシュボード" size="md" border />
