...
<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="IOPS、CPU 使用率、メモリ、ディスク、ネットワークトラフィック、データベースサイズ、接続数、スループット、トランザクション数、キャッシュヒット率、デッドロックを表示する監視ダッシュボード" size="lg" border />
