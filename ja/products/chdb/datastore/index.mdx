...
<div id="datastore-pandas-compatible-api-with-sql-optimization">
  # DataStore: SQL 最適化を備えたpandas互換API
</div>

DataStore は、使い慣れた pandas の DataFrame インターフェイスと SQL 最適化の力を組み合わせた、chDB の pandas 互換 API です。ClickHouse の性能を活かしながら、pandas スタイルのコードを記述できます。
