...
* **複数のデータフォーマット** - Parquet、CSV、JSON、Arrow、ORC、[さらに70種類以上のフォーマット](/ja/reference/formats)での入出力をサポート
...
詳細: [DataStore ドキュメント](/ja/products/chdb/datastore)
...
* [設定](/ja/products/chdb/configuration) - エンジン、ログ、プロファイリング
* [デバッグ](/ja/products/chdb/debugging) - explain()、プロファイリング、ログ
...
* **[DataStore と Pandas の比較](/ja/products/chdb/datastore#performance)** - 一般的な処理では pandas より最大20倍高速

<Image img="/images/chdb/df_bench.png" alt="DataFrame のベンチマーク結果" size="md" />
