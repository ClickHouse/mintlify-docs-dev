...
関連項目: [test&#95;stateful.py](https://github.com/chdb-io/chdb/blob/main/tests/test_stateful.py)。
...
class DatabaseReader(chdb.PyReader):
    ...
    def get_schema(self) -> List[Tuple[str, str]]:
        ...
        return [
            ...
            ("name", "String"),
            ("score", "Int64"),
            ("metadata", "String")  # JSON を文字列として保存
        ]
...
result = chdb.query("""
    ...
    SETTINGS pandas_analyze_sample = 1000  -- JSON 検出のためにすべての行を解析する
""", "Pretty")
print(result)
