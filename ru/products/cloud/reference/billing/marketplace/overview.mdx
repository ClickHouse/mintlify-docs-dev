...
<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="Регистрация в маркетплейсе и привязка организации" border />

Проверить, что биллинг действительно привязан к маркетплейсу, можно на странице billing организации. Если у вас возникнут какие-либо проблемы, обратитесь в [службу поддержки ClickHouse Cloud](https://clickhouse.com/support/program).
...
См. [страницу с обзором биллинга](/ru/products/cloud/reference/billing).
...
<div id="automatically-move-to-PAYG-when-running-out-of-credit">
  ### Если для моей организации ClickHouse используется биллинг через соглашение cloud маркетплейс committed spend, будет ли она автоматически переведена на тарификацию PAYG, когда закончатся кредиты?
</div>

Если ваш контракт маркетплейс committed spend активен и у вас заканчиваются кредиты, мы автоматически переведем вашу организацию на тарификацию PAYG. Однако когда срок действия текущего контракта истечет, вам нужно будет привязать к организации новый контракт маркетплейса или перейти на прямой биллинг с помощью кредитной карты.