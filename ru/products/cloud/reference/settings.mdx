...
Чтобы узнать больше о настройках, которые можно задать для вашего сервиса ClickHouse Cloud, см. [всю документацию по настройкам, сгруппированную по категориям](/ru/reference/settings).

<Image img="/images/cloud/manage/cloud-settings-sidebar.png" size="sm" alt="Боковая панель настроек Cloud" border />