...
<Image img="/images/cloud/manage/postman/postman1.png" size="md" alt="Сайт Postman" border />
...
<Image img="/images/cloud/manage/postman/postman2.png" size="md" alt="Создание рабочего пространства" border />
...
<Image img="/images/cloud/manage/postman/postman4.png" size="md" alt="Поле ввода URL API" border />
...
<Image img="/images/cloud/manage/postman/postman7.png" size="md" alt="Импортируйте свой API" border />

* Нажмите &quot;API spec for ClickHouse Cloud&quot;. На центральной панели выберите вкладку &#39;Authorization&#39;:

<Image img="/images/cloud/manage/postman/postman8.png" size="md" alt="Импорт завершён" border />
...
<Image img="/images/cloud/manage/postman/postman10.png" size="md" alt="учетные данные" border />
...
<Image img="/images/cloud/manage/postman/postman11.png" size="md" alt="Идентификатор организации и идентификатор сервиса" border />
...
<Image img="/images/cloud/manage/postman/postman12.png" size="md" alt="Проверка получения списка организаций" border />
...
<Image img="/images/cloud/manage/postman/postman13.png" size="md" alt="Статус" border />
...
<Image img="/images/cloud/manage/postman/postman14.png" size="md" alt="Проверка получения сведений об организации" border />
...
<Image img="/images/cloud/manage/postman/postman15.png" size="md" alt="Отправка теста" border />

* Нажав кнопку &quot;Save&quot;, затем нажмите синюю кнопку &quot;Send&quot; в правом верхнем углу экрана.

<Image img="/images/cloud/manage/postman/postman16.png" size="md" alt="Возвращаемое значение" border />
...
<Image img="/images/cloud/manage/postman/postman17.png" size="md" alt="Список сервисов" border />
