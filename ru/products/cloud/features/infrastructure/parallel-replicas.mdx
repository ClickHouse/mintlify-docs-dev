...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="архитектура с сегментированием" />
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="архитектура без сегментирования" />
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="Параллельные реплики" />
...
<Image img="/images/deployment-guides/parallel-replicas-4.png" size="md" alt="Уведомления" />
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="Динамическая координация — часть 1" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="Динамическая координация — часть 2" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="Динамическая координация — часть 3" />
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="EXPLAIN без parallel_replica" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="EXPLAIN с parallel_replica" />