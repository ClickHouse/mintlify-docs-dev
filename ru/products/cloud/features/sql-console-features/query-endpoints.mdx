...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/console-api-keys.png" size="md" alt="Ключи API" />

    2. Нажмите **Edit** рядом с ключом API, который используется для эндпоинтов Query API

    <Image img="/images/cloud/guides/query-endpoints/api-key-edit.png" size="md" alt="Изменить" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/specific-locations.png" size="md" alt="Конкретные местоположения" />
