...
Сервисы в ClickHouse Cloud включают готовые встроенные средства мониторинга, предоставляющие пользователям панели мониторинга и уведомления. По умолчанию доступ к этим панелям мониторинга есть у всех пользователей в консоли ClickHouse Cloud.
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Advanced dashboard в ClickHouse Cloud" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Обзор интерфейса Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="График задержки Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Таблица недавних запросов Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Интерфейс Query Insights: детализация запроса" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Интерфейс Query Insights: информация о запросе" border />
