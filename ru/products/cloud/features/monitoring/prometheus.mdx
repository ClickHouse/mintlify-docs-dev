...
title: 'Prometheus-совместимая конечная точка метрик'
...
Чтобы начать, [создайте API-ключ](/ru/products/cloud/features/admin-features/api/openapi).
...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Настройка конечной точки метрик в Grafana" border />

<br />

После настройки вы увидите метрики в раскрывающемся списке, где их можно выбрать для настройки панелей мониторинга:

<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Раскрывающийся список в обозревателе метрик Grafana" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Диаграмма в обозревателе метрик Grafana" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Обозреватель метрик Grafana" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Интеграция Prometheus с Datadog" />
