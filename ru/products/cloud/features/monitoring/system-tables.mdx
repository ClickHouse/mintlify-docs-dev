...
description: 'Отслеживайте состояние ClickHouse Cloud, выполняя запросы напрямую к системным таблицам'
keywords: ['облако', 'мониторинг', 'системные таблицы', 'query_log', 'clusterAllReplicas', 'панель мониторинга обсервабилити']
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Встроенная расширенная панель обсервабилити" border />
