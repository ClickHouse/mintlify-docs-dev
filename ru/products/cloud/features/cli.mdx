...
CLI также позволяет управлять локальными установками и серверами ClickHouse. Чтобы начать работу с локальной разработкой, см. страницу [быстрой установки](/ru/get-started/setup/self-managed/quick-install).
