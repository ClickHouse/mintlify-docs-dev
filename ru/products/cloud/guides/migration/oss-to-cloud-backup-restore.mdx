...
<div id="migrating-from-self-managed-clickhouse-to-clickhouse-cloud-using-backup-commands">
  # Миграция из самоуправляемого ClickHouse в ClickHouse Cloud с помощью команд резервного копирования
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="создать новый сервис" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="настройка параметров сервиса" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="настройка параметров сервиса" />
    ...
    1. Выполните шаги из [&quot;Безопасный доступ к данным в S3&quot;](/ru/products/cloud/guides/data-sources/accessing-s3-data-securely), чтобы создать роль доступа и получить ARN роли.
...
<Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="резервная копия, данные и метаданные" />
...
-- Возвращает управление сразу, вместе с идентификатором резервной копии
-- Пример результата:
-- ┌─id──────────────────────────────────┬─status────────────┐
