...
<Image img="/images/cloud/security/aws-privatelink-pe-create.png" size="md" alt="Частные конечные точки" border />
...
<Image img="/images/cloud/security/aws-privatelink-endpoint-settings.png" size="md" alt="Настройки конечной точки AWS PrivateLink" border />
...
<Image img="/images/cloud/security/aws-privatelink-select-vpc-and-subnets.png" size="md" alt="Выбор VPC и подсетей" border />
...
<Image img="/images/cloud/security/aws-privatelink-vpc-endpoint-id.png" size="md" alt="Endpoint ID конечной точки VPC" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-filters.png" size="md" alt="Фильтр частных конечных точек" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-dns-name.png" size="md" alt="DNS-имя частной конечной точки" border />
