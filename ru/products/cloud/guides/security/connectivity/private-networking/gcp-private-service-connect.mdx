---
title: 'Private Service Connect в GCP'
description: 'В этом документе описано, как подключиться к ClickHouse Cloud с помощью Private Service Connect (PSC) в Google Cloud Platform (GCP), а также как с помощью IP Access List в ClickHouse Cloud закрыть доступ к вашим сервисам ClickHouse Cloud с адресов, отличных от адресов GCP PSC.'
sidebarTitle: 'Private Service Connect в GCP'
...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Обзор Private Service Connect" border />

<Warning>
  По умолчанию сервис ClickHouse недоступен через Private Service Connect, даже если подключение PSC одобрено и установлено; необходимо явно добавить PSC ID в список разрешённых на уровне экземпляра, выполнив [шаг](#add-endpoint-id-to-services-allow-list) ниже.
</Warning>
...
<Image img="/images/cloud/security/gcp-privatelink-pe-create.png" size="lg" alt="Частные конечные точки" border />
...
<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="Откройте Private Service Connect в консоли Google Cloud" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="Включите Global Access для Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="Скопируйте PSC Connection ID" border />
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="Удаление частной конечной точки из ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="Фильтр частных конечных точек" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="DNS-имя частной конечной точки" border />
