...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Проверка примера запроса" />

    Затем сохраните запрос:

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Сохранение примера запроса" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="Настройка конечной точки запроса" />
    ...
    * Указать разрешенные домены CORS
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Команда curl для конечной точки" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="тест curl для конечной точки" />
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Мониторинг конечной точки" />
  </Step>
</Steps>
