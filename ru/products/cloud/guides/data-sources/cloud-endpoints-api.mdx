...
<Image img="/images/_snippets/aws-rds-mysql.png" size="lg" alt="Правила группы безопасности AWS" border />
...
<Image img="/images/_snippets/gcp-authorized-network.png" size="md" alt="Авторизованные сети GCP" border />