...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="Обзор безопасного доступа к S3 с ClickHouse" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="Получение ARN роли IAM сервиса ClickHouse" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="Вывод стека CloudFormation с IAM Role ARN" border />
