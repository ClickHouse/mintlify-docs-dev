...
<Image img="/images/managed-postgres/connect-button.png" alt="Нажмите Connect на левой боковой панели, чтобы просмотреть сведения о подключении" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Модальное окно подключения с учетными данными и форматами строк подключения" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Скачайте CA‑сертификат на вкладке Settings" size="md" border />
