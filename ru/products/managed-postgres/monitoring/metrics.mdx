...
На этой странице перечислены все метрики, доступные в
[конечной точке Prometheus для Managed Postgres](/ru/products/managed-postgres/monitoring/prometheus).
Сведения о настройке и аутентификации см. на странице [конечной точки Prometheus].
