...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Меню «Пользователи и роли»" size="md" border />
...
<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="Выбор сущности «Сервис Postgres»" size="md" border />

4. Выберите сервис Postgres, к которому будет применяться роль, затем укажите разрешения, которые нужно выдать.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="Настройка разрешений Postgres для роли" size="md" border />
