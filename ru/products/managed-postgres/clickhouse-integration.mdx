...
<Image img="/images/managed-postgres/clickhouse-integration-intro.png" alt="Страница Интеграция с ClickHouse с пунктом интеграции на боковой панели" size="md" border />
...
<Steps>
  <Step>
    ...
    * **Replication method**: выберите один из вариантов:
    ...
    <Image img="/images/managed-postgres/replication-service-step.png" alt="Настройка сервиса репликации с именем интеграции, целевым сервисом и параметрами метода репликации" size="md" border />
  ...
  <Step>
    ...
    * **Snapshot number of tables in parallel**: количество таблиц, для которых снимки создаются параллельно (по умолчанию: 1)
    ...
    <Image img="/images/managed-postgres/integration-replication-settings.png" alt="Шаг параметров репликации с интервалом синхронизации, параллельными потоками, размером pull-батча и параметрами снимка" size="md" border />
  ...
  <Step>
    ...
    * **Remove deleted rows during merges**: для таблиц [ReplacingMergeTree](/ru/reference/engines/table-engines/mergetree-family/replacingmergetree) физически удаляет помеченные как удалённые строки во время фоновых слияний
    ...
    <Image img="/images/managed-postgres/select-tables-step.png" alt="Шаг выбора таблиц с выбором базы данных, параметрами репликации и средством выбора таблиц, сгруппированным по схемам" size="md" border />
  ...
  <Step>
    ...
    <Image img="/images/managed-postgres/integration-running.png" alt="Список Интеграция с ClickHouse с работающим ClickPipe, его целевым сервисом и статусом" size="md" border />
