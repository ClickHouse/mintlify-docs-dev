...
<Image img="/images/managed-postgres/clickhouse-integration-intro.png" alt="Страница ClickHouse integration с пунктом интеграции на боковой панели" size="md" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/managed-postgres/integration-running.png" alt="Список ClickHouse integration с работающим ClickPipe, его целевым сервисом и статусом" size="md" border />
