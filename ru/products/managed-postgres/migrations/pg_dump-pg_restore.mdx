...
title: 'Миграция данных PostgreSQL в ClickHouse Managed Postgres с помощью pg_dump и pg_restore'
...
<div id="pg-dump-pg-restore">
  # Миграция в ClickHouse Managed Postgres с помощью pg_dump и pg_restore
</div>

В этом руководстве приведены пошаговые инструкции по переносу вашей базы данных PostgreSQL в ClickHouse Managed Postgres с помощью утилит `pg_dump` и `pg_restore`.
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Настройка исходной базы данных PostgreSQL" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="Выполнение команды pg_dump" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="Выполнение команды pg_restore" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Настройка целевой базы данных Managed Postgres" size="xl" border />
