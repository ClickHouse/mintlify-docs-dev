...
<div id="peerdb-migration">
  # Миграция в ClickHouse Managed Postgres с помощью PeerDB
</div>

В этом руководстве приведены пошаговые инструкции по миграции базы данных PostgreSQL в ClickHouse Managed Postgres с помощью PeerDB.
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="Создание peer для источника" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="Создание целевого peer" size="md" border />

Теперь в разделе &quot;Peers&quot; должны отображаться оба peer — исходный и целевой.

<Image img="/images/managed-postgres/peerdb/peers.png" alt="Список peer" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="Создание mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="Настройки mirror" size="md" border />

4. Выберите таблицы, которые хотите перенести. Можно выбрать конкретные таблицы или все таблицы из исходной базы данных.

<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="Выбор таблиц" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="Список mirrors" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="Прогресс Initial load" size="md" border />
