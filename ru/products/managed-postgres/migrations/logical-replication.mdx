...
title: 'Перенос данных PostgreSQL с помощью логической репликации'
...
<div id="logical-replication-migration">
  # Миграция в Managed Postgres с помощью логической репликации
</div>

В этом руководстве приведены пошаговые инструкции по миграции базы данных PostgreSQL в ClickHouse Managed Postgres с помощью встроенной логической репликации PostgreSQL.
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="Настройка репликации в исходном PostgreSQL" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Настройка таблиц в исходной базе PostgreSQL" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Создание экземпляра ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Начальная настройка целевого ClickHouse Managed Postgres" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="Результат миграции после логической репликации" size="xl" border />
