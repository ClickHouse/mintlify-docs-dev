...
<Image img="/images/managed-postgres/pgpg/overview.png" alt="Пункт источник данных на боковой панели сервиса Managed Postgres" size="lg" border />

Нажмите **Start import**.

<Image img="/images/managed-postgres/pgpg/startimport.png" alt="Страница источник данных с кнопкой Start import" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationform.png" alt="Шаг 1: форма подключения к исходной базе данных с вариантами метода ингестии" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlexport.png" alt="Вывод в терминале после запуска pg_dump" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.png" alt="Вывод терминала после запуска импорта схемы через psql" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="Шаг 5: панель выбора таблиц, сгруппированных по схемам, с кнопкой Create migration" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationlist.png" alt="Список источник данных с миграцией в статусе Running" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/initialload.png" alt="Подробное представление миграции со статистикой начальной загрузки по таблицам" size="lg" border />
