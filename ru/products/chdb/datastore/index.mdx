...
DataStore — это API chDB, совместимый с pandas, который сочетает знакомый интерфейс pandas DataFrame с возможностями SQL-оптимизации и позволяет писать код в стиле pandas, сохраняя при этом производительность ClickHouse.
