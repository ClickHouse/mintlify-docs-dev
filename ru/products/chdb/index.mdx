...
* **Поддержка множества форматов данных** - Поддерживаются ввод и вывод в форматах Parquet, CSV, JSON, Arrow, ORC и [ещё 70+ форматах](/ru/reference/formats)
...
Подробнее: [Документация DataStore](/ru/products/chdb/datastore)
...
* [Конфигурация](/ru/products/chdb/configuration) - движок, логирование, данные профилирования
* [Отладка](/ru/products/chdb/debugging) - explain(), данные профилирования, логирование
...
* **[DataStore против Pandas](/ru/products/chdb/datastore#performance)** - До 20 раз быстрее Pandas при выполнении типовых операций
