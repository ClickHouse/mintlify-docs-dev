...
<Steps>
  ...
  <Step title="Выберите модель">
    ...
    <Image img="/images/agentic-data-stack/select-model.png" alt="Селектор моделей LibreChat в левом верхнем углу, показывающий модель по умолчанию с подсказкой Select a model" size="md" />
    ...
    <Accordion title="Задайте ключ провайдера в интерфейсе">
      ...
      <Image img="/images/agentic-data-stack/set-api-key.png" alt="Селектор моделей LibreChat с кнопкой Set API Key рядом с провайдером Anthropic" size="md" />

      Вставьте свой ключ в диалоговое окно и нажмите **Submit**. Вы можете задать срок действия или сделать ключ бессрочным.

      <Image img="/images/agentic-data-stack/set-api-key-modal.png" alt="Диалоговое окно Set API Key for Anthropic с выпадающим списком срока действия, полем Key и кнопками Submit и Revoke" size="md" />
    </Accordion>
  </Step>
  ...
  <Step title="Выберите MCP-сервер">
    ...
    <Image img="/images/agentic-data-stack/select-clickhouse-local.png" alt="Открытое меню MCP Servers в поле ввода LibreChat, показывающее ClickHouse-Local с зеленой точкой подключения и ClickHouse-Cloud" size="md" />
  </Step>
  ...
  <Step title="Задайте свой первый вопрос">
    ...
    <Image img="/images/agentic-data-stack/prompt-chat.png" alt="LibreChat отвечает на пример вопроса, вызывая инструменты MCP ClickHouse-Local и перечисляя доступные базы данных и таблицы" size="md" />
  </Step>
</Steps>
