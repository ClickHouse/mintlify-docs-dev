...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-1.png" size="md" alt="BYOC Создание пирингового соединения" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-2.png" size="md" alt="BYOC Подтверждение пирингового соединения" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-3.png" size="lg" alt="BYOC Подтверждение пирингового соединения" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-1.png" size="lg" alt="Конечная точка BYOC PSC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-2.png" size="lg" alt="Конечная точка BYOC PSC" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-3.png" size="lg" alt="Конечная точка BYOC PSC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-4.png" size="lg" alt="Конечная точка BYOC PSC" border />
  </Step>
  ...
  <Step>
    ...
    * Статус конечной точки должен измениться на &quot;Accepted&quot;; если этого не произошло автоматически, обратитесь в ClickHouse Support.
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-5.png" size="lg" alt="Создание конечной точки PSC BYOC" border />
    ...
    * Откройте сведения о конечной точке и получите &quot;PSC Connection ID&quot;, который будет использоваться на шаге [Добавьте PSC Connection ID конечной точки в список разрешенных для сервиса](#step-5-add-endpoint-id-allowlist)
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-6.png" size="lg" alt="Сведения о конечной точке PSC BYOC" border />
  </Step>
  ...
  <Step>
    ...
    Вам нужно настроить все поддомены (wildcard) для &quot;DNS name&quot;, полученного на шаге [Получите имя сервиса GCP PSC и DNS-имя](#step-2-obtain-gcp-service-attachment-and-dns-name-for-private-service-connect), так, чтобы они указывали на IP-адрес конечной точки GCP PSC. Это гарантирует, что сервисы/компоненты в вашей VPC/сети смогут корректно разрешать это имя.
  </Step>
