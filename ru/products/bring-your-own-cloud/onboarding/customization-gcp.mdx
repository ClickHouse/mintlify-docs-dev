...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-gcp-existing-vpc-ui.png" size="lg" alt="Интерфейс настройки ClickHouse Cloud BYOC с выбранным Use existing VPC для GCP" />
  </Step>
</Steps>