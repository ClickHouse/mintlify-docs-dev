...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="Подсеть BYOC VPC" />

    <Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="Теги подсети BYOC VPC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="Конечная точка S3 BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="Интерфейс настройки BYOC в ClickHouse Cloud с выбранным пунктом Use existing VPC" />
