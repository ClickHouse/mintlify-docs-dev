...
| [`GEOGRAPHY`](https://docs.aws.amazon.com/redshift/latest/dg/geospatial-overview.html)                                               | [Гео-типы данных](/ru/reference/data-types/geo) (развиты меньше, например без систем координат — это можно эмулировать [с помощью функций](/ru/reference/functions/regular-functions/geo))                                                                     |
...
| [`SUPER`](https://docs.aws.amazon.com/redshift/latest/dg/r_SUPER_type.html)                                                          | [`Tuple`](/ru/reference/data-types/tuple), [`Nested`](/ru/reference/data-types/nested-data-structures), [`Array`](/ru/reference/data-types/array), [`JSON`](/ru/reference/data-types/newjson), [`Map`](/ru/reference/data-types/map)                                    |
