...
<Image img="/images/integrations/migration/object-storage-01.png" size="md" alt="Миграция самоуправляемого ClickHouse" />

Если вы используете объектное хранилище Cloud как озеро данных и хотите импортировать эти данные в ClickHouse Cloud,
или если ваша текущая система баз данных может напрямую выгружать данные в объектное хранилище Cloud, вы можете использовать одну из
