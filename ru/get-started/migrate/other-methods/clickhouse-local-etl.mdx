...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="Миграция самоуправляемого ClickHouse" />
...
предоставляемый ClickHouse [движок интеграции](/ru/reference/engines/table-engines#integration-engines), либо [табличная функция](/ru/reference/functions/table-functions),
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="Миграция самоуправляемого ClickHouse" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="Миграция с самоуправляемого ClickHouse" />
