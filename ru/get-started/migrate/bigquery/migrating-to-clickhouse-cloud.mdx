...
<Image img="/images/migrations/bigquery-2.png" size="md" alt="ClickHouse и BigQuery" />
...
<Image img="/images/migrations/bigquery-3.png" size="lg" alt="Схема" />
...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="Пакетная загрузка" />
...
Как описано [здесь](/ru/get-started/migrate/bigquery), ClickHouse, как и BigQuery, не обеспечивает уникальность значений в столбцах первичного ключа таблицы.
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="Первичные ключи ClickHouse" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="Партиции" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="Проекции" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="Как переписать запросы BigQuery" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="Агрегатные функции 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="Агрегатные функции 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="Условные выражения и массивы" />
