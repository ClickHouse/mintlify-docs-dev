...
<Steps>
  <Step>
    ...
    * Войдите, используя только что созданные имя пользователя и пароль
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="Выберите план" border />
    ...
    <Image img="/images/_snippets/createservice1.png" size="md" alt="Новый сервис ClickHouse" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="Пределы масштабирования" border />
  ...
  <Step>
    ...
    * Подключиться через ваше приложение
    ...
    <Image img="/images/_snippets/service_connect.png" size="md" alt="Подключение сервиса" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="Источники данных" border />
    ...
    * Загрузка данных по URL-адресу файла
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="Выберите источник данных" border />
    ...
    * в ClickHouse первичные ключи ***не уникальны*** для каждой строки таблицы
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="сведения о подключении клиента ClickHouse" border />
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="Новые строки из CSV-файла" />
