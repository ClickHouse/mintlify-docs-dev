...
<Columns cols={4}>
  <Card title="Быстрая установка" icon="/images/install/linux.svg" href="/ru/install/quick-install" />

  <Card title="clickhousectl (CLI)" icon="terminal" href="/ru/install/clickhousectl" />

  <Card title="Docker" icon="/images/install/docker.svg" href="/ru/install/docker" />

  <Card title="Сборка из исходного кода" icon="code" href="/ru/install/advanced" />
</Columns>
...
<Columns cols={4}>
  <Card title="Debian/Ubuntu" icon="/images/install/DebianUbuntu.svg" href="/ru/install/debian_ubuntu" />

  <Card title="Redhat" icon="/images/install/redhat.svg" href="/ru/install/redhat" />

  <Card title="NixOS" icon="/images/install/nixos.svg" href="/ru/install/nixos" />

  <Card title="Другие дистрибутивы Linux" icon="/images/install/linux.svg" href="/ru/install/linux_other" />
</Columns>