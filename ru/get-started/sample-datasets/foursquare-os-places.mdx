...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="Карта плотности точек интереса в Европе" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="Саке-бары в Японии" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="Банкоматы" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="Карта Европы с точками интереса, распределёнными по странам" />