...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="Для добавленных и удалённых строк" size="md" />

**Для коммитов и авторов:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="Для коммитов и авторов" size="md" />
...
20 строк в наборе. Прошло: 0.098 сек. Обработано 7.54 миллиона строк, 42.16 МБ (76.67 миллиона строк/с., 428.99 МБ/с.)
```
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Матрица авторов Superset" size="md" />

Алексею явно нравится удалять чужой код. Давайте исключим его, чтобы получить более сбалансированную картину удаления кода.

<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Матрица авторов Superset v2" size="md" />
