...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="Количество событий в день" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="Жаркие и влажные дни" />