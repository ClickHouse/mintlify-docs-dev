---
description: 'Обзор доступных сторонних клиентских библиотек для различных языков
  программирования'
sidebarTitle: 'Клиентские библиотеки'
...
<Note>
  ClickHouse Inc **не** поддерживает перечисленные ниже библиотеки и не проводила их всестороннего тестирования, чтобы гарантировать их качество.
</Note>
