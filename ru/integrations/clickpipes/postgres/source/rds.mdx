...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Где в RDS находятся группы параметров?" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/change_rds_logical_replication.png" alt="Изменение значения rds.logical_replication" size="lg" border />

2. Примените новую группу параметров к вашей базе данных RDS Postgres

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Изменение RDS Postgres с использованием новой группы параметров" size="lg" border />

3. Перезагрузите экземпляр RDS, чтобы изменения вступили в силу

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Перезагрузка RDS Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="Где найти группу безопасности в RDS Postgres?" size="lg" border />
