...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Server Parameters в Azure Flexible Server for Postgres" size="lg" border />

2. Измените значение `wal_level` на `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Изменение wal_level на logical в Azure Flexible Server for Postgres" size="lg" border />

3. Для применения этого изменения потребуется перезапуск сервера. Перезапустите его, когда появится запрос.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="Перезапуск сервера после изменения wal_level" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Добавление IP-адресов ClickPipes в брандмауэр Azure Flexible Server for Postgres" size="lg" />
