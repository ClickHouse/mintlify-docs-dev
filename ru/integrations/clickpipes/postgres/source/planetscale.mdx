...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="Настройка wal_level в консоли PlanetScale" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="Настройка max_slot_wal_keep_size в консоли PlanetScale" size="md" border />
