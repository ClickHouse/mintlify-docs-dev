...
<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Создание ключа сервисного аккаунта с разрешениями для BigQuery и Cloud Storage" size="lg" border />
