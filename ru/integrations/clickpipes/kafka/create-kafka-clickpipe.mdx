...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Выберите импорт" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Выберите тип источника данных" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Заполните сведения о подключении" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="Конфигурация SSH-туннеля" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Выберите топик" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Задайте таблицу, схему и настройки" size="md" />

    Вы также можете настроить дополнительные параметры с помощью доступных элементов управления

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Задайте дополнительные параметры" size="md" />
  </Step>
  ...
  <Step>
    ...
    * `Only destination table`: только с разрешением `INSERT` для целевой таблицы.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Разрешения" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Обзор" size="md" />
  </Step>
</Steps>