...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-kinesis-stream.png" size="lg" alt="Поток Kinesis для DynamoDB" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="Экспорт DynamoDB в S3" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="Сопоставление столбцов DynamoDB" border />
