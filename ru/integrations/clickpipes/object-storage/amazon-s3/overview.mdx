...
| **OVH Object Storage** <br /> *S3-compatible*  | <img src="/images/integrations/logos/ovh.png" alt="Логотип OVH Object Storage" width="32" />    | Для непрерывной ингестии требуется [лексикографический порядок](#continuous-ingestion-lexicographical-order). Неупорядоченный режим не поддерживается.                                                               |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="Учетные данные IAM для S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="Аутентификация через IAM для S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="Расширенные настройки ClickPipes" size="lg" border />
