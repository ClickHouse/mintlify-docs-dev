...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="Учетные данные HMAC для GCS ClickPipes" size="lg" border />

Следуйте [этому руководству](/ru/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret), чтобы создать сервисный аккаунт с ключом HMAC.
