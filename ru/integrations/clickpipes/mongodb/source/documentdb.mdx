...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="Выбор группы параметров" size="lg" border />

2. Найдите `change_stream_log_retention_duration`, выберите этот параметр и измените его значение на `259200` (72 часа)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="Изменение группы параметров" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="Применение группы параметров" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="Статус группы параметров" size="lg" border />
