...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-cluster-overview-configuration.png" alt="Перейдите к конфигурации кластера" size="lg" border />

2. Нажмите `Additional Settings` и прокрутите вниз до раздела `More Configuration Options`.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-expand-additional-settings.png" alt="Разверните дополнительные настройки" size="lg" border />

3. Нажмите `More Configuration Options` и установите минимальное окно oplog равным `72 hours` или больше.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-set-retention-hours.png" alt="Задайте количество часов хранения oplog" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-add-new-database-user.png" alt="Добавление пользователя базы данных" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-database-user-privilege.png" alt="Настройка ролей пользователя" size="lg" border />

Также можно указать кластеры/экземпляры, к которым нужно предоставить доступ пользователю ClickPipes:

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-restrict-access.png" alt="Ограничение доступа к кластеру/экземпляру" size="lg" border />
