...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="Выбор MongoDB" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="Заполните сведения о подключении" size="lg" border />
...
5. Здесь вы можете выбрать целевую базу данных для вашего ClickPipe. Можно выбрать существующую базу данных или создать новую.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="Выберите целевую базу данных" size="lg" border />
