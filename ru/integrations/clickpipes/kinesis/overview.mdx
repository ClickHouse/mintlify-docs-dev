...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Сервис ClickPipes" size="lg" border />

2. В левом меню нажмите кнопку `Data Sources`, затем — &quot;Set up a ClickPipe&quot;

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Выбор импорта" size="lg" border />

3. Выберите источник данных.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Выбор типа источника данных" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.png" alt="Заполнение сведений о подключении" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.png" alt="Настройка формата данных и топика" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Настройка таблицы, схемы и параметров" size="lg" border />

Вы также можете настроить дополнительные параметры с помощью доступных элементов управления

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="Настройка дополнительных элементов управления" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="Использование существующей таблицы" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Разрешения" border />

9. Нажмите &quot;Complete Setup&quot;, чтобы система зарегистрировала ClickPipe, после чего он появится в сводной таблице.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="Уведомление об успешной настройке" size="sm" border />

<Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="Уведомление об удалении" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_destination.png" alt="Просмотр пункта назначения" size="lg" border />

А также элементы управления для удаления ClickPipe и просмотра сводки по задаче приёма.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Просмотр обзора" size="lg" border />
