...
1. На вкладке «Источники данных» выберите MySQL ClickPipe, который хотите приостановить.
...
5. Примерно через 5 секунд (а также после обновления страницы) статус пайпа должен измениться на **Paused**.
