...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Сервис ClickHouse Cloud" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="Выберите MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="Заполните сведения о подключении" size="lg" border />
...
5. Здесь вы можете выбрать целевую базу данных для вашего ClickPipe. Можно выбрать существующую базу данных или создать новую.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="Выберите целевую базу данных" size="lg" border />
