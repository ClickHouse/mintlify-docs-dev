...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Включение PITR в Cloud SQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="Кнопка Edit в GCP MySQL" size="lg" border />

Затем прокрутите вниз до раздела `Flags` и добавьте указанные выше флаги.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="Настройка флагов binlog в GCP" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="Разрешённые IP-адреса в GCP MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="Загрузка сертификата GCP MySQL" size="lg" border />

5. В интерфейсе ClickPipes загрузите скачанный сертификат при создании нового ClickPipe для MySQL.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="Использование сертификата GCP MySQL" size="lg" border />