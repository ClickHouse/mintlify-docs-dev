...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="Настройка конфигурации Spark через notebook" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Проверка настроек ClickHouse в Spark UI" border />

<div id="additional-resources">
  ## Дополнительные ресурсы
</div>

* [Документация по коннектору ClickHouse Spark](/ru/integrations/connectors/data-ingestion/apache-spark)
