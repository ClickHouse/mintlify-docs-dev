...
description: 'Использование HTTP-интерфейса ClickHouse для переноса данных из Azure Data Factory в ClickHouse'
keywords: ['azure data factory', 'azure', 'microsoft', 'данные', 'HTTP-интерфейс']
title: 'Использование HTTP-интерфейса ClickHouse для переноса данных из Azure в ClickHouse'
doc_type: 'guide'
integration:
   - support_level: 'core'
...
1. Войдите в [Microsoft Azure Portal](https://portal.azure.com/) и нажмите
   **Create a resource**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-page.png" size="lg" alt="Домашняя страница Azure Portal" border />

2. На панели Categories слева выберите **Analytics**, затем нажмите
   **Data Factory** в списке популярных сервисов.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-resource-analytics.png" size="lg" alt="Новый ресурс в Azure Portal" border />

3. Выберите подписку и группу ресурсов, введите имя для нового экземпляра Data
   Factory, выберите регион и оставьте версию V2.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory.png" size="lg" alt="Новый Data Factory в Azure Portal" border />

4. Нажмите **Review + Create**, затем **Create**, чтобы запустить развертывание.

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-confirm.png" size="lg" alt="Подтверждение нового Data Factory в Azure Portal" border />

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-success.png" size="lg" alt="Успешное создание нового Data Factory в Azure Portal" border />
...
1. Войдите в Azure Portal и откройте свой экземпляр Data Factory.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.png" size="lg" alt="Главная страница Azure Portal с Data Factory" border />

2. На странице обзора Data Factory нажмите **Launch Studio**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-factory-page.png" size="lg" alt="Страница Data Factory в Azure Portal" border />

3. В меню слева выберите **Manage**, затем перейдите в **Linked services**
   и нажмите **+ New**, чтобы создать новую связанную службу.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.png" size="lg" alt="Кнопка New Linked Service в Azure Data Factory" border />
...
4. В **строке поиска New linked service** введите **REST**, выберите **REST** и нажмите **Continue**,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.png" size="lg" alt="Поиск New Linked Service в Azure Data Factory" border />
...
5. На панели конфигурации связанной службы введите имя новой службы,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-lined-service-pane.png" size="lg" alt="Панель New Lined Service" border />
...
6. На панели динамического содержимого можно создать параметризованный URL,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.png" size="lg" alt="Пустой Base URL в New Linked Service" border />
...
7. Нажмите **&quot;+&quot;** рядом с полем фильтра и добавьте новый параметр, назовите его
   ...
   Нажмите **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.png" size="lg" alt="Параметры New Linked Service" border />
...
8. В поле выражения введите следующий текст и нажмите **OK**. Замените
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.png" size="lg" alt="Заполненное поле Expression в New Linked Service" border />
...
9. Вернувшись в основную форму, выберите базовую аутентификацию, введите имя пользователя и
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-check-connection.png" size="lg" alt="Проверка соединения в New Linked Service" border />

10. Нажмите **Create**, чтобы завершить настройку.
    <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-linked-services-list.png" size="lg" alt="Список Linked Services" border />
...
2. В Azure Data Factory Studio выберите Author на левой панели. Наведите указатель
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-item.png" size="lg" alt="Элемент New Dataset" border />
...
3. В строке поиска введите **REST**, выберите **REST** и нажмите **Continue**.
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-page.png" size="lg" alt="Страница New Dataset" border />
...
4. Теперь в разделе Datasets
   ...
   content.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-properties.png" size="lg" alt="Свойства New Dataset" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-query.png" size="xl" alt="Запрос New Dataset" border />
...
6. Нажмите OK, чтобы сохранить выражение. Нажмите Test connection. Если всё
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-connection-successful.png" size="xl" alt="Успешное подключение New Dataset" border />
...
1. Откройте **Azure Data Factory Studio** и перейдите на вкладку **Author**. В
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-pipeline-item.png" size="lg" alt="Новый элемент Pipeline в ADF" border />

2. В панели **Activities** разверните раздел **Move and transform** и
   перетащите действие **Copy data** на холст.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-copy-data-item.png" size="lg" alt="Новый элемент Copy Data" border />

3. Выберите вкладку **Source** и укажите исходный набор данных, который вы создали ранее.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-source.png" size="lg" alt="Источник Copy Data" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-sink-select-post.png" size="lg" alt="Настройка Sink Copy Data с выбором POST" border />
...
5. Нажмите **Debug** в верхней части холста, чтобы запустить конвейер. После
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-debug-success.png" size="lg" alt="Успешный Debug для Copy Data" border />
