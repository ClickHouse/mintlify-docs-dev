...
title: 'Использование табличной функции azureBlobStorage в ClickHouse для переноса данных Azure в ClickHouse'
doc_type: 'guide'
integration:
   - support_level: 'core'
...
`TSV`, `ORC`, `Avro` и другие. Полный список см. в разделе [&quot;Форматы данных&quot;](/ru/reference/formats).
...
2. В меню слева в разделе **Security +
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="Настройки хранилища данных Azure" border />

3. Выберите **key1** или **key2** и нажмите кнопку **Show** рядом с
   полем **Connection string**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="Ключи доступа к хранилищу данных Azure" border />
...
* [Форматы входных и выходных данных](/ru/reference/formats)
