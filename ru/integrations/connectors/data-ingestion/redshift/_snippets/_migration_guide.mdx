...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="Передача из Redshift в ClickHouse" />
...
* Поддерживает сценарии преобразования данных (например, см. наше [руководство по интеграции с dbt](/ru/integrations/connectors/data-ingestion/etl-tools/dbt)).
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="PIVOT из Redshift через S3" />
