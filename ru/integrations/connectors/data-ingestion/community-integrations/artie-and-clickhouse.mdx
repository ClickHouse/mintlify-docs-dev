...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Страница регистрации Artie" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Интерфейс редактирования конвейера Artie" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="Портал аналитики" />

Мониторинг конвейеров и таблиц

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="Встроенный мониторинг" />

Ежедневные уведомления об изменениях схемы

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="Уведомление об изменении схемы" />