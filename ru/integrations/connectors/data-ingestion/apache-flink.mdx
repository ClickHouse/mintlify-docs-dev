...
Список доступных входных форматов ClickHouse можно найти [на этой странице документации](/ru/reference/formats#formats-overview) и в [ClickHouseFormat.java](https://github.com/ClickHouse/clickhouse-java/blob/main/clickhouse-data/src/main/java/com/clickhouse/data/ClickHouseFormat.java).
