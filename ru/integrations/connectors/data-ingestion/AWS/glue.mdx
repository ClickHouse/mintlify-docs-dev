...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Конфигурация подключений Glue Notebook" force="true" />
  ...
  <Tab title="Установка вручную">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Параметры пути к JAR-файлам в Glue Notebook" force="true" />
  </Tab>
</Tabs>
