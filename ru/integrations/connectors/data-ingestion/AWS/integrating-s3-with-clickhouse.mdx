...
<Image img="/images/integrations/data-ingestion/s3/s3-j.png" size="lg" border alt="Представление S3 бакета в консоли AWS, где показаны файлы данных ClickHouse, хранящиеся в S3" />
...
<Image img="/images/integrations/data-ingestion/s3/bucket1.png" size="lg" border alt="Размер данных в первом S3 бакете, показывающий метрики использования хранилища" />

<Image img="/images/integrations/data-ingestion/s3/bucket2.png" size="lg" border alt="Размер данных во втором S3 бакете, показывающий метрики использования хранилища" />
