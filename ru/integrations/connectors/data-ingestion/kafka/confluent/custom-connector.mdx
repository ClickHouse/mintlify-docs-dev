...
<div id="integrating-confluent-platform-with-clickhouse">
  # Интеграция Confluent Platform с ClickHouse
</div>
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="Интерфейс Confluent Platform с параметрами добавления пользовательского коннектора ClickHouse" border />
