...
| ----------------------------------------------------------------------------------------------------- | ---------------------------------- | :-------------------: | :-------------------: | :-------------------: |
| [ClickPipes for Kafka](/ru/integrations/clickpipes/kafka)                                                | [Cloud], [BYOC] (скоро!)           |           ✅           |           ✅           |                       |
...
* [**Confluent Cloud**](/ru/integrations/connectors/data-ingestion/kafka/confluent) - Confluent Platform предоставляет возможность загрузить и [запустить ClickHouse Connector Sink в Confluent Cloud](/ru/integrations/connectors/data-ingestion/kafka/confluent/custom-connector) или использовать [коннектор HTTP Sink для Confluent Platform](/ru/integrations/connectors/data-ingestion/kafka/confluent/kafka-connect-http), который интегрирует Apache Kafka с API по HTTP или HTTPS.
...
* **Собственный код** - Собственный код с использованием Kafka и [клиентских библиотек](/ru/integrations/language-clients) ClickHouse может быть уместен в случаях, когда требуется пользовательская обработка событий.
