...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="Консоль Dataflow с выполняющейся задачей Pub/Sub to ClickHouse" />
