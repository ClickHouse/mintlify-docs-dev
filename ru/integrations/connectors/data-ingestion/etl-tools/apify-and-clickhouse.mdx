...
<Steps>
  ...
  <Step>
    ...
    <Note>
      Apify также предоставляет [клиент Python](https://docs.apify.com/api/client/python). Если вы предпочитаете Python, установите `apify-client` через pip и используйте [clickhouse-connect](/ru/integrations/language-clients/python) для ClickHouse.
    </Note>
  </Step>
