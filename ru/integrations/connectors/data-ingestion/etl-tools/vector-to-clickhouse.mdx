...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_01.png" size="lg" border alt="Просмотр журналов ClickHouse в табличном формате" />
  </Step>
  ...
  <Step>
    ...
    **Materialized view** работает аналогично триггеру вставки в SQL. Когда строки данных вставляются в исходную таблицу, materialized view выполняет некоторое преобразование этих строк и вставляет результаты в целевую таблицу.
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_02.png" size="lg" border alt="Просмотр разобранных журналов ClickHouse в табличном формате" />
