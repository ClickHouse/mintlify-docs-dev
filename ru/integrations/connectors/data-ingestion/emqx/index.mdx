...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_1.png" size="sm" border alt="Интерфейс развертывания сервиса ClickHouse Cloud с выбором региона AWS" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_2.png" size="sm" border alt="Настройки подключения ClickHouse Cloud с конфигурацией IP-доступа" />

Затем сохраните имя пользователя и пароль для дальнейшего использования.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_3.png" size="sm" border alt="Экран учётных данных ClickHouse Cloud с именем пользователя и паролем" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_4.png" size="lg" border alt="Панель мониторинга запущенного экземпляра ClickHouse Cloud с вариантами подключения" />

Нажмите &quot;Connect to SQL Console&quot;, чтобы создать базу данных и таблицу для интеграции с EMQX Cloud.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_5.png" size="lg" border alt="Интерфейс SQL Console ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_6.png" size="lg" border alt="Выполнение SQL-запроса CREATE DATABASE и CREATE TABLE в ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_sign_up.png" size="lg" border alt="Страница регистрации EMQX Cloud с формой регистрации" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_create_1.png" size="lg" border alt="EMQX Cloud: создание развертывания, шаг 1 — показаны варианты развертывания" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_overview.png" size="lg" border alt="Панель мониторинга EMQX Cloud Overview с метриками брокера" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_auth.png" size="lg" border alt="Интерфейс настройки Authentication в EMQX Cloud для добавления учётных данных" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_nat_gateway.png" size="lg" border alt="Панель настройки NAT Gateway в EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_clickhouse.png" size="lg" border alt="Сведения о коннекторе интеграции данных ClickHouse в EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_resource.png" size="lg" border alt="Форма настройки ресурса EMQX Cloud ClickHouse со сведениями о подключении" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.png" size="md" border alt="Создание правила интеграции данных в EMQX Cloud, шаг 1: показан SQL-запрос" />

Вы можете использовать SQL-тест, чтобы проверить запрос и посмотреть результаты.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.png" size="md" border alt="Создание правила интеграции данных в EMQX Cloud, шаг 2: показаны результаты теста" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_action.png" size="md" border alt="Настройка действия правила интеграции данных EMQX Cloud с шаблоном SQL" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_details.png" size="md" border alt="Сведения о правиле интеграции данных EMQX Cloud со сводкой конфигурации" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-overview.png" size="lg" border alt="Обзор MQTTX с интерфейсом клиента" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-new.png" size="lg" border alt="Форма настройки нового подключения в MQTTX со сведениями о подключении" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-publish.png" size="lg" border alt="Интерфейс MQTTX Publish MQTT Messages, показывающий создание сообщения" />
...
<Image img="/images/integrations/data-ingestion/emqx/rule_monitor.png" size="lg" border alt="Панель мониторинга правил в EMQX Cloud, показывающая метрики обработки сообщений" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_result.png" size="lg" border alt="Результаты запроса к ClickHouse с сохранёнными данными IoT" />
