...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="Бакет первой реплики в Google Cloud Storage со структурой папок с партициями данных" />

<div id="bucket-for-replica-two">
  #### Бакет для второй реплики
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="Бакет второй реплики в Google Cloud Storage, показывающий структуру папок с партициями данных" />