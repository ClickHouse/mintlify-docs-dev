...
<Note>
  В ClickHouse Cloud вы также можете использовать [MySQL ClickPipe](/ru/integrations/clickpipes/mysql) (сейчас в публичной бете), чтобы легко переносить данные из таблиц MySQL в ClickHouse.
</Note>
