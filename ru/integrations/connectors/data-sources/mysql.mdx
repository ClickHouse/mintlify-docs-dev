...
<Note>
  В ClickHouse Cloud вы также можете использовать [MySQL ClickPipe](/ru/integrations/clickpipes/mysql) (сейчас в публичной бета-версии), чтобы без труда переносить данные из таблиц MySQL в ClickHouse.
</Note>
