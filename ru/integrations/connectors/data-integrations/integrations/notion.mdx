...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="Выбор ClickHouse в списке Add connection в Notion" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="Развёрнутое подключение ClickHouse в Notion с переключателями для отдельных инструментов" />
