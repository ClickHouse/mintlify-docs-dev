...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="Подключение к ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="Добавить новую базу данных" />

Затем вам будет предложено указать данные для подключения к базе данных.

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="Укажите данные для подключения к базе данных" />

После этого появится ячейка, которую можно запустить, чтобы установить соединение.

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="Запустите ячейку, чтобы подключиться к ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="Выберите SQL-движок" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="Результаты в датафрейме" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="Сочетание выпадающего списка, таблицы и диаграммы" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="Режим App View" />