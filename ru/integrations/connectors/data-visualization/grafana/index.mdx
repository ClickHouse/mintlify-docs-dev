...
2. Найдите **ClickHouse** и нажмите на подписанный плагин от Grafana Labs:
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/search.png" alt="Выберите плагин ClickHouse на странице Connections" border />

3. На следующем экране нажмите кнопку **Install**:

   <Image size="md" img="/images/integrations/data-visualization/grafana/install.png" alt="Установите плагин ClickHouse" border />
...
1. После завершения установки нажмите кнопку **Add new data source**. (Источник данных также можно добавить на вкладке **Data sources** на странице **Connections**.)
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/add_new_ds.png" alt="Создать источник данных ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/quick_config.png" alt="Страница конфигурации подключения" border />
...
4. Нажмите кнопку **Save &amp; test**, чтобы проверить, может ли Grafana подключиться к вашему сервису ClickHouse. Если все прошло успешно, вы увидите сообщение **Data source is working**:
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/valid_ds.png" alt="Выберите Save & test" border />
