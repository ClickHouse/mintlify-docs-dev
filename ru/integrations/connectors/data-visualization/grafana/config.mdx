...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="Пример безопасной конфигурации для native-протокола" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="Дополнительные параметры конфигурации HTTP" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="Пример дополнительных настроек" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="Конфигурация журналов" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="Конфигурация трассировки" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Пример конфигурации таблицы псевдонимов" border />

Теперь Grafana будет видеть результаты таблицы псевдонимов вместо результатов `DESC example_table`:

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Пример выборки из таблицы псевдонимов" border />
