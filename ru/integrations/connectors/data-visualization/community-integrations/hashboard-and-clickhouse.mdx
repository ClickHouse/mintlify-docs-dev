...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="Интерфейс Hashboard для исследования данных с интерактивным конструктором запросов и визуализацией" border />
