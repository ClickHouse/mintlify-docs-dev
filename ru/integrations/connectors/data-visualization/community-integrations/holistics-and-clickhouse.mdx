...
keywords: ['clickhouse', 'Holistics', 'AI', 'интеграция', 'bi', 'визуализация данных']
description: 'Holistics — это платформа BI самообслуживания и встроенной аналитикой на базе ИИ, которая помогает принимать более взвешенные решения благодаря управляемым и легкодоступным метрикам.'
...
<div id="connecting-clickhouse-to-holistics">
  # Подключение ClickHouse к Holistics
</div>

<CommunityMaintainedBadge />

[Holistics](https://www.holistics.io/) — это BI-платформа самообслуживания с ИИ и программируемым семантическим слоем для согласованных и надежных метрик.
...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="Расположение кнопки Connect в консоли ClickHouse Cloud" border />
  </Step>
  ...
  <Step>
    ...
    1. **Прямое подключение (рекомендуется):** Добавьте IP-адреса Holistics в список разрешённых в вашем межсетевом экране или в ClickHouse Cloud IP Access List. Список IP-адресов можно найти в руководстве [IP Whitelisting](https://docs.holistics.io/docs/connect/ip-whitelisting).
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="Пример добавления IP-адресов в список разрешённых в ClickHouse Cloud" border />
  ...
  <Step>
    ...
    1. В Holistics перейдите в **Settings → Data Sources**.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="Переход к Data Sources в настройках Holistics" border />

    2. Нажмите **New Data Source** и выберите **ClickHouse**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="Выбор ClickHouse из списка новых источников данных" border />
    ...
    3. Заполните форму данными, собранными на шаге 1.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="Заполнение сведений о подключении к ClickHouse в Holistics" border />

    4. Нажмите **Test Connection**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Успешная проверка подключения к ClickHouse в Holistics" border />
