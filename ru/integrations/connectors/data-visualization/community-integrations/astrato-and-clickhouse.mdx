...
<Image size="sm" img="/images/integrations/data-visualization/astrato_1_dataconnection.png" alt="Подключение к данным Astrato" border />

* Выберите **ClickHouse**.

<Image size="sm" img="/images/integrations/data-visualization/astrato_2a_clickhouse_connection.png" alt="Подключение Astrato к данным ClickHouse" border />

* Заполните обязательные поля в диалоговом окне подключения

<Image size="sm" img="/images/integrations/data-visualization/astrato_2b_clickhouse_connection.png" alt="Обязательные поля для подключения Astrato к ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/astrato_3_user_access.png" alt="Доступ пользователей для подключения Astrato к ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4a_clickhouse_data_view.png" alt="Astrato: подключение к ClickHouse User Access" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4b_clickhouse_data_view_joins.png" alt="Astrato: подключение к ClickHouse User Access" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4c_clickhouse_completed_data_view.png" alt="Astrato: подключение к ClickHouse User Access" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5a_clickhouse_build_chart.png" alt="Astrato: подключение к ClickHouse, доступ пользователей" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5b_clickhouse_view_sql.png" alt="Astrato: подключение к ClickHouse, доступ пользователей" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5c_clickhouse_complete_dashboard.png" alt="Astrato: подключение к ClickHouse, доступ пользователей" border />