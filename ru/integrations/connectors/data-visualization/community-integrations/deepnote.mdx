...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="Плитка интеграции ClickHouse" border />

2. Укажите сведения о подключении к вашему экземпляру ClickHouse:

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="Диалоговое окно с параметрами ClickHouse" border />

***ПРИМЕЧАНИЕ:*** Если подключение к ClickHouse защищено с помощью IP Access List, возможно, вам потребуется разрешить IP-адреса Deepnote. Подробнее см. в [документации Deepnote](https://docs.deepnote.com/integrations/authorize-connections-from-deepnote-ip-addresses).
...
1. Сначала подключитесь к интеграции ClickHouse в правой части ноутбука.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.png" alt="диалоговое окно с параметрами ClickHouse" border />
