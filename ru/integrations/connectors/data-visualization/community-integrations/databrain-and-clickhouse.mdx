...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="Интерфейс панели мониторинга Databrain с визуализацией данных ClickHouse" border />
...
Если для вашего экземпляра ClickHouse включена фильтрация IP-адресов, вам нужно будет добавить IP-адреса Databrain в список разрешённых.
...
<Tip>
  Актуальный список IP-адресов, которые нужно добавить в список разрешённых, см. в [документации Databrain по добавлению IP-адресов в белый список](https://docs.usedatabrain.com/guides/datasources/allow-access-to-our-ip).
</Tip>
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Меню источников данных Databrain" border />

3. Нажмите **Add a Data Source** или **Connect Data Source**.

4. Выберите **ClickHouse** из списка доступных коннекторов.

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="Выбор коннектора в Databrain с вариантом ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Форма подключения ClickHouse в Databrain с полями конфигурации" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="Обозреватель данных Databrain со списком таблиц ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="Панель мониторинга Databrain с несколькими визуализациями ClickHouse" border />
...
* [Создание панелей мониторинга](https://docs.usedatabrain.com/guides/dashboards/create-a-dashboard)
