...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Настройка подключения ClickHouse в Dot (светлый режим)" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="Подключение ClickHouse" size="sm" />
