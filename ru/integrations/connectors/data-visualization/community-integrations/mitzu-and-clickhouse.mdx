...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_01.png" alt="Страница входа в Mitzu с полями для электронной почты и пароля" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_02.png" alt="Страница настройки рабочего пространства Mitzu с шагами онбординга" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_03.png" alt="Страница настройки подключения Mitzu к ClickHouse с формой настройки" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_04.png" alt="Интерфейс выбора таблиц в Mitzu с таблицами базы данных" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_05.png" alt="Настройка каталога событий Mitzu с параметрами сопоставления столбцов" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_06.png" alt="Интерфейс запроса сегментации Mitzu с выбором событий и настройкой временного интервала" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_07.png" alt="Представление анализа воронки Mitzu с коэффициентами конверсии между шагами" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_08.png" alt="Анализ удержания в Mitzu с отображением коэффициентов удержания когорт" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_09.png" alt="Визуализация путей в Mitzu, показывающая переходы пользователей между событиями" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_10.png" alt="Панель мониторинга анализа выручки в Mitzu с метриками MRR" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_11.png" alt="Представление генерации SQL-кода в Mitzu с нативным запросом к ClickHouse" border />
