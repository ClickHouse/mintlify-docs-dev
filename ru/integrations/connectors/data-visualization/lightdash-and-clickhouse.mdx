...
keywords: ['clickhouse', 'lightdash', 'визуализация данных', 'BI', 'семантический слой', 'dbt', 'self-service аналитика', 'подключение']
description: 'Lightdash — современный BI-инструмент с открытым исходным кодом, построенный на базе dbt, который позволяет командам изучать и визуализировать данные из ClickHouse с помощью семантического слоя. Узнайте, как подключить Lightdash к ClickHouse для быстрой и контролируемой аналитики на базе dbt.'
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Пример панели мониторинга в Lightdash" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="Пример конфигурации profiles.yml для проекта lightdash-clickhouse" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="Пример определения метрик в файле .yml" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="Представление Explore в Lightdash с измерениями, фильтрами, диаграммой, результатами и SQL" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Создание и организация диаграмм в панели мониторинга Lightdash" border />
  ...
  <Step>
    ...
    **AI Agents** в Lightdash делают анализ данных по-настоящему самообслуживаемым.
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Интерфейс Lightdash Ask AI с запросом на естественном языке на основе метрик dbt" border />
