...
5. **Сквозной пример.** Как минимум один реалистичный пример от подключения до содержательного результата. Используйте [пример набора данных ClickHouse](/ru/get-started/sample-datasets), чтобы читатели могли его воспроизвести
