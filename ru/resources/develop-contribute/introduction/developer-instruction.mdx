...
Краткое описание функции. Здесь следует кратко описать, что она делает, и типичный сценарий использования.
...
- `arg1` — Описание аргумента. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg2` — Описание аргумента. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg3` — Описание необязательного аргумента (необязательный). [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}

**Implementation Details**

Описание подробностей реализации, если применимо.

**Returned value**

- Возвращает {укажите, что возвращает функция}. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
