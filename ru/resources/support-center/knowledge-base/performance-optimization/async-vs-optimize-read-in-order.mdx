...
Обычно настройка [max&#95;threads](/ru/reference/settings/session-settings#settings-max_threads) [определяет](https://clickhouse.com/company/events/query-performance-introspection) количество потоков для параллельного чтения и параллельной обработки запросов:
