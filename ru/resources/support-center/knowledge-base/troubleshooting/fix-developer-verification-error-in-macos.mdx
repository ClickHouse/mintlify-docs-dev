...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="Диалог ошибки проверки разработчика в macOS" border />
...
2. Перейдите в раздел **Конфиденциальность и безопасность**:
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="Стандартный вид настроек macOS «Конфиденциальность и безопасность»" border />
...
4. Нажмите **Все равно разрешить**.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="Настройки macOS «Конфиденциальность и безопасность» с кнопкой «Все равно разрешить»" border />
