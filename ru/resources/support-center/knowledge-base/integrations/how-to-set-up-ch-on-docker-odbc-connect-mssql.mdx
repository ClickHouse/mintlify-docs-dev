...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="База данных MSSQL и структура таблицы" border />

Пользователь входа в MSSQL, `sql_user`:

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="Конфигурация пользователя входа в MSSQL" border />

Роли членства в базе данных для `sql_user`:

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="Роли членства в базе данных MSSQL" border />

Пользователь базы данных, связанный с учётной записью входа:

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="Пользователь базы данных MSSQL, связанный с учётной записью входа" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/ru/snippets/engines/table-engines/integrations/odbc)
