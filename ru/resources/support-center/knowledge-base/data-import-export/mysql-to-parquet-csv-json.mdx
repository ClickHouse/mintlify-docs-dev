...
Впечатляет, насколько инструмент `clickhouse-local` прост и при этом действительно мощен. Вы можете легко читать данные из такой базы данных, как MySQL, и выводить их в [самых разных выходных форматах](/ru/reference/formats).