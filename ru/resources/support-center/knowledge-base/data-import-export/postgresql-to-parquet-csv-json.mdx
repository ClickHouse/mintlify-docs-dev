...
Форматом вывода может быть любой из поддерживаемых [форматов вывода](/ru/reference/formats) в ClickHouse. Рассмотрим несколько примеров...
...
<Note>
  На этом можно не останавливаться — `clickhouse-local` также позволяет забирать данные из PostgreSQL и отправлять их в [любые выходные форматы](/ru/reference/formats).
