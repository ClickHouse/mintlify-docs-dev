...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/profile.png" size="md" alt="по времени" />
...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/left-heavy.png" size="md" alt="перекос влево" />

<div id="sandwitch">
  #### Сэндвич
</div>

<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/sandwich.png" size="md" alt="сэндвич" />
