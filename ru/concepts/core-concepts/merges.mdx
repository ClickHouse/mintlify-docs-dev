...
① Вставки (в таблицы семейства движков [MergeTree](/ru/reference/engines/table-engines/mergetree-family)) создают отсортированные неизменяемые [части данных](/ru/concepts/core-concepts/parts).
...
<Image img="/images/managing-data/core-concepts/merges_01.png" size="lg" alt="СЛИЯНИЕ ЧАСТЕЙ" />

<br />

`merge level` части увеличивается на единицу с каждым очередным слиянием. Уровень `0` означает, что часть новая и еще не была объединена. Части, объединенные в более крупные, помечаются как [неактивные](/ru/reference/system-tables/parts) и затем удаляются через [настраиваемый](/ru/reference/settings/merge-tree-settings#old_parts_lifetime) промежуток времени (по умолчанию 8 минут). Со временем это образует **дерево** слитых частей. Отсюда и название таблицы [MergeTree](/ru/reference/engines/table-engines/mergetree-family).
...
<Image img="/images/managing-data/core-concepts/merges-dashboard.gif" size="lg" alt="СЛИЯНИЯ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_02.png" size="lg" alt="СЛИЯНИЯ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_03.png" size="lg" alt="СЛИЯНИЕ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_04.png" size="lg" alt="СЛИЯНИЯ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_05.png" size="lg" alt="СЛИЯНИЕ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_06.png" size="lg" alt="СЛИЯНИЕ ЧАСТЕЙ" />
...
<Image img="/images/managing-data/core-concepts/merges_07.png" size="lg" alt="СЛИЯНИЕ ЧАСТЕЙ" />
