...
Данные каждой таблицы ClickHouse из [семейства движков MergeTree](/ru/reference/engines/table-engines/mergetree-family) хранятся на диске в виде набора неизменяемых `data parts`.
