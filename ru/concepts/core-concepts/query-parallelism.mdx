...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="Анализ индекса" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 параллельные линии обработки" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 параллельных линий обработки" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="Распределённые линии" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="Конвейер запроса" />
