...
Профиль настроек — это набор [настроек](/ru/reference/settings). Профиль настроек содержит настройки и ограничения, а также список ролей и/или пользователей, для которых применяется этот профиль.
