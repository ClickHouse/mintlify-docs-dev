...
description: 'В этом руководстве описаны простые минимальные настройки, необходимые для того, чтобы ClickHouse использовал сертификаты OpenSSL для проверки соединений.'
keywords: ['Настройка ACME', 'Настройка TLS', 'Сертификаты OpenSSL', 'защищённые соединения', 'Руководство для SRE', 'Let`s Encrypt']
doc_type: 'guide'
---
