...
<Image img="/images/interfaces/mysql0.png" alt="Экран учетных данных — промпт" size="md" />

2. В раскрывающемся списке `Connect with` выберите `MySQL`.

<br />

<Image img="/images/interfaces/mysql1.png" alt="Экран учетных данных — выбран MySQL" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="Экран учетных данных — MySQL включен" size="md" />

Скопируйте показанную строку подключения MySQL.

<Image img="/images/interfaces/mysql3.png" alt="Экран учетных данных — строка подключения" size="md" />
