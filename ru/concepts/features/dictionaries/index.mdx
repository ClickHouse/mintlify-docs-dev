...
description: 'Словарь обеспечивает представление данных в формате ключ-значение для быстрого поиска по ключу.'
doc_type: 'guide'
---
...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="Сценарии использования словаря в ClickHouse" />
...
<Image img="/images/dictionary/dictionary-left-any-join.png" size="sm" alt="Использование словаря с LEFT ANY JOIN" />
