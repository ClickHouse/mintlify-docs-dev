...
title: 'Резервное копирование в конечную точку S3 и восстановление из неё'
doc_type: 'guide'
---
...
<div id="backup-to-a-local-disk">
  # Резервное копирование / восстановление в/из конечной точки S3
</div>

В этой статье рассматриваются создание резервных копий в S3 бакете и восстановление резервных копий из него
