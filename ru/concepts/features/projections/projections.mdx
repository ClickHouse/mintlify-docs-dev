...
В некотором смысле проекции похожи на [Materialized Views](/ru/concepts/features/materialized-views)
...
<Image img="/images/data-modeling/projections_1.png" size="md" alt="Проекции в ClickHouse" />
...
<Image img="/images/data-modeling/projections_2.png" size="md" alt="Визуализация основной таблицы uk_price_paid_with_projections и двух её проекций" />
...
* [Materialized Views](/ru/concepts/features/materialized-views)
