...
* Если вашему запросу нужен прямой JOIN, то есть `LEFT ANY JOIN`, как показано ниже, мы рекомендуем по возможности использовать [Dictionaries](/ru/concepts/features/dictionaries).
...
<Image img="/images/guides/joins-3.png" size="lg" alt="возможности JOIN" />
...
<Image img="/images/guides/joins-4.png" size="lg" alt="блок-схема JOIN" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="Дерево решений для оптимизации использования памяти JOIN" />
