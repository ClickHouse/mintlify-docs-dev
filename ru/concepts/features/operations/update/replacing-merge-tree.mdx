...
<Image img="/images/migrations/postgres-replacingmergetree.png" size="md" alt="Процесс ReplacingMergeTree" />
...
Чтобы получать корректные результаты, нужно дополнить фоновые слияния дедупликацией и удалением на этапе выполнения запроса. Этого можно добиться с помощью оператора `FINAL`.
