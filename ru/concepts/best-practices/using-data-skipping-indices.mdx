...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="Построение индексов пропуска данных" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="Использование индексов пропуска" />
