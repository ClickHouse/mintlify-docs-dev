...
<Image img="/images/bestpractices/create_primary_key.gif" size="lg" alt="Первичный ключ" />
...
<Image img="/images/bestpractices/primary_key.gif" size="lg" alt="Первичный ключ" />
