    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          <HeroCard title="ClickStack" description="Универсальный стек обсервабилити на базе ClickHouse, который обеспечивает молниеносно быстрые запросы и мощные агрегации по журналам, метрикам, трассировкам, воспроизведениям сеансов и ошибкам." href="/ru/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Managed Postgres" description="Быстрый, масштабируемый сервис Postgres корпоративного уровня, нативно интегрированный с ClickHouse. Легко объединяйте Postgres для транзакций и ClickHouse для аналитики." href="/ru/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Интеграции" description="Более 100 интеграций, чтобы подключить любимые инструменты и сервисы к ClickHouse." href="/ru/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
