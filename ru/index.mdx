...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      ...
      <HeroCard
        title="Наши решения"
        description="Настройте приём журналов, метрик и трассировок для мониторинга систем и работы панелей мониторинга обсервабилити."
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
        ...
        <div className="col-span-2">
          <HeroCard
            ...
            links={[
                ...
                { label: "Лучшие практики организации данных для аналитики и роста", href: "/data-modeling/schema-design" },
                ...
                { label: "Как снизить затраты без потери производительности", href: "/operations/best-practices" },
            ]}
          />
        </div>
