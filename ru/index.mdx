...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        title="Начало работы"
        description="Я здесь впервые и хочу начать работу или изучить документацию по продуктам ClickHouse"
        icon={
      ...
      <HeroCard
        title="Руководства"
        description="Я хочу узнать, как использовать возможности ClickHouse, или углубиться в более сложные темы"
        icon={
      ...
      <HeroCard
        title="Наши решения"
        description="Настройте приём журналов, метрик и трассировок для мониторинга систем и визуализации данных на панелях мониторинга обсервабилити."
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="chDB" description="Быстрая, надёжная и масштабируемая встраиваемая база данных. Оцените возможности ClickHouse прямо в процессе приложения." href="/ru/products/chdb" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="product-langfuse-light.png" title="LangFuse" description="Платформа LLM-инжиниринга с открытым исходным кодом для обсервабилити, метрик, оценивания и управления промптами." href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="product-cloud-light.png" title="Оператор Kubernetes" description="Автоматизирует развертывание, настройку и управление кластерами ClickHouse и ClickHouse Keeper в Kubernetes." href="/ru/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="product-chdb-light.png" title="chDB" description="Быстрая, надежная и масштабируемая встраиваемая база данных. Оцените мощь ClickHouse прямо в приложении." href="/ru/products/chdb" showArrow />
      </div>
    </div>
