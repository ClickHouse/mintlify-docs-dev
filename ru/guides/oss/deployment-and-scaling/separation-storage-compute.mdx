...
<Image img="/images/guides/s3_bucket_example.png" size="md" alt="Пример S3 бакета при использовании разделения хранилища и вычислительных ресурсов" border />
...
* [Репликация одного сегмента в двух регионах AWS с использованием объектного хранилища S3](/ru/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse#s3-multi-region).
