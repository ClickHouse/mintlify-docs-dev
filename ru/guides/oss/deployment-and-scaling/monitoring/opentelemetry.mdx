...
ClickHouse поддерживает трассировку OpenTelemetry для запросов [ClickHouse Keeper](/ru/guides/oss/deployment-and-scaling/keeper) (сервиса координации, совместимого с ZooKeeper). Эта возможность обеспечивает подробную видимость всего жизненного цикла операций Keeper — от отправки клиентского запроса до его обработки на стороне сервера.
