...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="Схема архитектуры для 1 сегмента и 2 реплик с ReplicatedMergeTree" />
...
<Steps>
  <Step>
    ...
    # Создание директорий clickhouse-server
    for i in {01..02}; do
