...
Для кластеров ClickHouse рекомендуется использовать ClickHouse Keeper вместо ZooKeeper. См. документацию по [ClickHouse Keeper](/ru/guides/oss/deployment-and-scaling/keeper)
