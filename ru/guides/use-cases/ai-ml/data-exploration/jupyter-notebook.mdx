...
description: 'Это руководство объясняет, как настроить chDB и использовать его для исследования данных из ClickHouse Cloud или локальных файлов в Jupyter Notebook'
...
В этом руководстве вы узнаете, как исследовать набор данных из ClickHouse Cloud в Jupyter Notebook с помощью [chDB](/ru/products/chdb) — быстрого встраиваемого SQL OLAP-движка на базе ClickHouse.
...
* Выполнять запросы к удалённым наборам данных и преобразовывать результаты в DataFrame Pandas
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Добавление примера набора данных" />

Выберите `Get started` на карточке `UK property price paid data` (4 GB):

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Выбор набора данных UK price paid" />

Затем нажмите `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Импорт набора данных UK price paid" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="Создание нового ноутбука" />

Затем вам будет предложено выбрать ядро.
Выберите любое доступное ядро Python; в этом примере мы выберем `ipykernel`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="Выбор ядра" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="предварительный просмотр DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="предварительный просмотр DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="предварительный просмотр DataFrame" />
...
# Строим график продаж домов по левой оси Y
color = 'tab:blue'
ax1.set_xlabel('Year')
...
# Создаём вторую ось Y для данных о ценах
ax2 = ax1.twinx()
color = 'tab:red'
ax2.set_ylabel('Average Price (£)', color=color)

# Строим график данных о ценах до 2019 года включительно
ax2.plot(df[df['year'] <= 2019]['year'], df[df['year'] <= 2019]['avg_price'], marker='s', color=color, label='Average Price', linewidth=2)
ax2.tick_params(axis='y', labelcolor=color)

# Форматируем ось цен в денежном формате
ax2.yaxis.set_major_formatter(plt.FuncFormatter(lambda x, p: f'£{x:,.0f}'))

# Задаём заголовок и отображаем каждый второй год
plt.title('London Housing Market: Sales Volume vs Prices Over Time', fontsize=14, pad=20)

# Используем годы только до 2019 для обоих наборов данных
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="График удалённого набора данных и локального набора данных" />
