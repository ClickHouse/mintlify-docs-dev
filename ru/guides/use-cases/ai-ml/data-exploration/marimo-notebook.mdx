...
В этом руководстве вы узнаете, как анализировать набор данных из ClickHouse Cloud в ноутбуке Marimo с помощью [chDB](/ru/products/chdb) — быстрого встраиваемого SQL OLAP-движка на базе ClickHouse.
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Добавить пример набора данных" />

На карточке данных о ценах продажи недвижимости в Великобритании (4 GB) выберите `Get started`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Выбрать набор данных о ценах в Великобритании" />

Затем нажмите `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Импортировать набор данных о ценах в Великобритании" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="Интерфейс Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Визуализация данных Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Динамически обновляемый график Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Динамический график Marimo" />
