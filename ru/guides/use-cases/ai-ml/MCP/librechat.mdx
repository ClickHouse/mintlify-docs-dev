...
title: 'Настройка MCP-сервера ClickHouse с LibreChat и ClickHouse Cloud'
...
> В этом руководстве показано, как настроить LibreChat для работы с MCP-сервером ClickHouse с помощью Docker
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="Выберите MCP-сервер" size="md" />
