...
title: 'Как создать AI-агента с CopilotKit и MCP-сервером ClickHouse'
...
свой кластер ClickHouse, задав следующие переменные окружения:
...
Вы можете протестировать агент с помощью, например, такого промпта:
