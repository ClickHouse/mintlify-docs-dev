...
title: 'Настройка MCP-сервера ClickHouse для AnythingLLM и ClickHouse Cloud'
description: 'В этом руководстве показано, как настроить AnythingLLM с MCP-сервером ClickHouse с помощью Docker.'
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="Значок инструмента" size="md" />

    Нажмите `Agent Skills` и найдите раздел `MCP servers`.
    Подождите, пока `Mcp ClickHouse` не перейдет в состояние `On`

    <Image img="/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="MCP-серверы готовы" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/allm_conversation.png" alt="Диалог" size="md" />
  </Step>
</Steps>