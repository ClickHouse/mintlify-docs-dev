...
Grafana — предпочтительный инструмент визуализации данных обсервабилити в ClickHouse. Это обеспечивается официальным плагином ClickHouse для Grafana. Инструкции по установке можно найти [здесь](/ru/integrations/connectors/data-visualization/grafana).
...
<Image img="/images/use-cases/observability/observability-15.png" alt="Конфигурация коннектора" size="sm" />
...
<Image img="/images/use-cases/observability/observability-16.png" alt="Настройка журналов коннектора" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-17.png" alt="От журналов к трассировкам" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-18.png" alt="Трассировки" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-20.png" alt="Переход от трассировок к журналам" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-21.png" alt="Панели мониторинга" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-22.png" alt="Временные ряды" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-23.png" alt="Диаграммы с несколькими линиями" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-24.png" alt="Визуализация геоданных" size="lg" border />