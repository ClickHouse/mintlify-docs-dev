...
Databricks поддерживает несколько форматов данных для своего lakehouse. В ClickHouse можно выполнять запросы к таблицам Unity Catalog как к таблицам Delta и Iceberg.
