---
title: 'Начало работы с открытыми форматами таблиц'
...
<Info>
  **Кратко**
  ...
  Практическое руководство по выполнению запросов к таблицам в озере данных, их ускорению с помощью MergeTree и записи результатов обратно в Iceberg. Во всех шагах используются публичные наборы данных, и они подходят как для Cloud, так и для OSS.
</Info>

Снимки экрана в этом руководстве взяты из SQL-консоли [ClickHouse Cloud](https://console.clickhouse.cloud). Все запросы работают как в Cloud, так и в самоуправляемых развертываниях.
...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Запрос к Iceberg" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Запрос к Iceberg" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Запрос Iceberg" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="Запрос к ClickHouse" />
