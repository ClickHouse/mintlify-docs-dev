---
sidebarTitle: 'Нативный и двоичный'
slug: /integrations/data-formats/binary-native
title: 'Использование нативного и двоичных форматов в ClickHouse'
description: 'Страница с описанием использования нативного и двоичных форматов в ClickHouse'
keywords: ['двоичные форматы', 'нативный формат', 'rowbinary', 'rawblob', 'messagepack', 'protobuf', 'capn proto', 'форматы данных', 'производительность', 'сжатие']
doc_type: 'guide'
---
...
Для демонстрации мы будем использовать таблицу [some&#95;data](/ru/assets/some_data.sql) и [данные](/ru/assets/some_data.tsv); при желании вы можете воспроизвести это на своём экземпляре ClickHouse.
...
Это создаст файл [data.clickhouse](/ru/assets/data.clickhouse) в формате Native.
...
В результате будет создан файл [data.binary](/ru/assets/data.binary) в бинарном формате строк.
...
Чтобы импортировать данные из файла [MessagePack](/ru/assets/data.msgpk):
...
Чтобы работать с [Protocol Buffers](/ru/reference/formats/Protobuf/Protobuf), сначала нужно определить [файл схемы](/ru/assets/schema.proto):
...
ClickHouse также поддерживает ещё один популярный бинарный формат сериализации — [Cap&#39;n Proto](https://capnproto.org/). Как и в случае с форматом `Protobuf`, в нашем примере нужно определить файл схемы ([`schema.capnp`](/ru/assets/schema.capnp)):
