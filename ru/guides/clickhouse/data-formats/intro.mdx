...
Если вы хотите подключить BI-инструмент, например Grafana, Tableau или другие, ознакомьтесь с категорией [Visualize](/ru/integrations/connectors/data-visualization) в документации.