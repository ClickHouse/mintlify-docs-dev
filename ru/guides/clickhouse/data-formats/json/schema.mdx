...
description: 'Как спроектировать оптимальную схему JSON'
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="Столбец для каждого JSON-пути" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="JSON-смещения" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="Общий JSON-столбец" />
