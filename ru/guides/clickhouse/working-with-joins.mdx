...
<Image img="/images/starter_guides/joins/imdb_schema.png" alt="Схема IMDB" />
...
<Image img="/images/starter_guides/joins/outer_join.png" alt="Внешнее JOIN-соединение" />
