...
description: 'Простое руководство по оптимизации запросов, в котором описаны распространённые способы повышения производительности запросов'
doc_type: 'guide'
...
<div id="a-simple-guide-for-query-optimization">
...
<Image img="/images/guides/best-practices/query_optimization_diagram_1.png" size="lg" alt="Процесс оптимизации" />
