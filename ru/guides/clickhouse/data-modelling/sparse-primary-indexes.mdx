...
<Image img="/images/guides/best-practices/sparse-primary-indexes-01.png" size="lg" alt="Разреженные первичные индексы 01" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-02.png" size="lg" alt="Разреженные первичные индексы 02" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-03a.png" size="lg" alt="Разреженные первичные индексы 03a" />

Всего индекс содержит 1083 записи для нашей таблицы с 8,87 миллиона строк и 1083 гранулами:

<Image img="/images/guides/best-practices/sparse-primary-indexes-03b.png" size="lg" alt="Разреженные первичные индексы 03b" />
...
<Accordion title="Просмотр содержимого первичного индекса">
  <p>
    ...
    Для этого сначала нужно скопировать файл первичного индекса в <a href="/ru/reference/settings/server-settings/settings#server_configuration_parameters-user_files_path" target="_blank">user&#95;files&#95;path</a> одного из узлов работающего кластера:
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-04.png" size="lg" alt="Разреженные первичные индексы 04" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-05.png" size="lg" alt="Разреженные первичные индексы 05" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-13a.png" size="lg" alt="Разреженные первичные индексы 13a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-10.png" size="lg" alt="Разреженные первичные индексы 10" />

Вот получившийся первичный ключ:

<Image img="/images/guides/best-practices/sparse-primary-indexes-11.png" size="lg" alt="Разреженные первичные индексы 11" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-14a.png" size="lg" alt="Разреженные первичные индексы 14a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-14b.png" size="lg" alt="Разреженные первичные индексы 14b" />
