...
title: 'Хранимые процедуры и параметры запроса'
doc_type: 'guide'
---
...
В этом руководстве объясняется, как ClickHouse подходит к этим концепциям, и приводятся рекомендуемые альтернативы.
...
О том, как использовать параметры запроса в [клиентских библиотеках](/ru/integrations/language-clients), см. документацию
