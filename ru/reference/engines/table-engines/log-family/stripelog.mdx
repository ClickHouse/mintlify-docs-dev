...
Этот движок относится к семейству движков Log. Об общих свойствах движков Log и различиях между ними см. в статье [Семейство движков Log](/ru/reference/engines/table-engines/log-family).
