...
Этот движок относится к семейству log engines. Общие свойства движков этого семейства и различия между ними описаны в разделе [Семейство движков Log](/ru/reference/engines/table-engines/log-family).
