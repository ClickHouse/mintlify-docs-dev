...
Этот движок относится к семейству движков `Log`. Общие свойства движков `Log` и различия между ними см. в статье [Семейство движков Log](/ru/reference/engines/table-engines/log-family).
