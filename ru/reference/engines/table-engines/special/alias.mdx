...
<Info>
  ...
  с помощью настройки [allow&#95;experimental&#95;alias&#95;table&#95;engine](/ru/reference/settings/session-settings#allow_experimental_alias_table_engine).
  Выполните команду `set allow_experimental_alias_table_engine = 1`.
</Info>
