...
Пунктом назначения резервной копии может быть любой допустимый [пункт назначения](/ru/concepts/features/backup-restore/local-disk#configure-backup-destinations-for-disk), например `Disk`, `S3`, `File`.
