...
Создаёт таблицу из файлов в HDFS. Эта табличная функция похожа на табличные функции [url](/ru/reference/functions/table-functions/url) и [file](/ru/reference/functions/table-functions/file).
