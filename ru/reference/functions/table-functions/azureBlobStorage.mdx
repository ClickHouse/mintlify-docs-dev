...
Предоставляет интерфейс в виде таблицы для выборки/вставки файлов в [Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs). Эта табличная функция аналогична [функции s3](/ru/reference/functions/table-functions/s3).
