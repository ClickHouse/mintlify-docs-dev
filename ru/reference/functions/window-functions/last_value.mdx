...
<Note>
  ...
  Подробнее см. в разделе [обработка NULL](/ru/reference/functions/aggregate-functions#null-processing).

  Псевдоним: `lastValueRespectNulls`
</Note>

Подробнее о синтаксисе оконных функций см.: [Оконные функции — синтаксис](/ru/reference/functions/window-functions#syntax).
