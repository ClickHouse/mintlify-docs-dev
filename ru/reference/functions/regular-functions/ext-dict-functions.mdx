...
Преобразует значение атрибута словаря в тип данных `All` вне зависимости от конфигурации словаря.
...
SELECT
    ...
    -- Совпадёт со ВСЕМИ подходящими шаблонами регулярных выражений
