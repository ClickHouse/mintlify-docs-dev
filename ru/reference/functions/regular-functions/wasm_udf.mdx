---
description: 'Документация по пользовательским функциям (UDF) WebAssembly'
sidebarTitle: 'WebAssembly пользовательские функции (UDF)'
slug: /sql-reference/functions/wasm_udf
title: 'Пользовательские функции (UDF) WebAssembly'
doc_type: 'guide'
---
