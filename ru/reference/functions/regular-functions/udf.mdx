...
2. Укажите в [`user_defined_executable_function_drivers_config`](/ru/reference/settings/server-settings/settings#user_defined_executable_function_drivers_config) один или несколько файлов конфигурации драйверов (поддерживаются glob-шаблоны) и при необходимости задайте [`dynamic_user_defined_executable_functions_path`](/ru/reference/settings/server-settings/settings#dynamic_user_defined_executable_functions_path) — каталог, где хранятся сгенерированные конфигурации исполняемых UDF:
