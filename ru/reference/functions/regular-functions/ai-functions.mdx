...
Функции ИИ используют **именованную коллекцию**, в которой хранятся учетные данные провайдера и конфигурация. Первым аргументом каждой функции является имя этой коллекции.
