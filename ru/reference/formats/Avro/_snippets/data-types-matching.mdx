...
В таблице ниже показаны все типы данных, поддерживаемые форматом Apache Avro, и их соответствия с [типами данных](/ru/reference/data-types) ClickHouse в запросах `INSERT` и `SELECT`.
