...
Вложенные сообщения подходят для ввода и вывода [вложенных структур данных](/ru/reference/data-types/nested-data-structures).
...
ClickHouse принимает и выводит protobuf-сообщения в формате `length-delimited`.
