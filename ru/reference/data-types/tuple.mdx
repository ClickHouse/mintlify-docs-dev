...
Tuple из элементов, каждый из которых имеет отдельный [тип](/ru/reference/data-types). Tuple должен содержать как минимум один элемент.
...
<Warning>
  **Экспериментальные возможности**
  ...
  Это экспериментальная возможность; в будущих версиях она может измениться.
</Warning>
