...
Семейство типов данных, представляющих интервалы времени и даты. Результирующие типы оператора [INTERVAL](/ru/reference/operators#interval).
...
* оператор [INTERVAL](/ru/reference/operators#interval)
