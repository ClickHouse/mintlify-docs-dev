...
Все столбцы в структурах данных [Nested](/ru/reference/data-types/nested-data-structures) описываются отдельно. Имя каждого столбца начинается с имени родительского столбца и точки.
