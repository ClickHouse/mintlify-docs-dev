...
Эта операция выполняется как [мутация](/ru/reference/statements/alter#mutations).
...
Это реализовано как [мутация](/ru/reference/statements/alter#mutations).
...
<Note>
  Операции с проекциями поддерживаются только для таблиц с движком [`*MergeTree`](/ru/reference/engines/table-engines/mergetree-family/mergetree) (включая [реплицируемые](/ru/reference/engines/table-engines/mergetree-family/replication) варианты).
</Note>
