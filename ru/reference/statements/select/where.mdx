...
Выражение после предложения `WHERE` часто используется с [операторами сравнения](/ru/reference/operators#comparison-operators) и [логическими операторами](/ru/reference/operators#operators-for-working-with-data-sets), а также с одной из множества [обычных функций](/ru/reference/functions/regular-functions/regular-functions-index).
...
* [`IS NULL`](/ru/reference/operators#is_null) или [`isNull`](/ru/reference/functions/regular-functions/functions-for-nulls#isNull)
* [`IS NOT NULL`](/ru/reference/operators#is_not_null)   или [`isNotNull`](/ru/reference/functions/regular-functions/functions-for-nulls#isNotNull)
...
Можно использовать следующие [операторы сравнения](/ru/reference/operators#comparison-operators):
