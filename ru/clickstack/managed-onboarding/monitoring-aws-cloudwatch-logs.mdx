...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-v2.png" size="lg" alt="Запуск ClickStack" border />
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view-clickstack.png" size="lg" alt="Представление Search в ClickStack с журналами CloudWatch" />
    ...
    * `Body`: исходная строка журнала
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-attributes-clickstack.png" size="lg" alt="Представление Search в ClickStack с журналами CloudWatch и атрибутами" />

    Выберите запись в журнале, чтобы просмотреть её метаданные:

    <Image img="/images/clickstack/cloudwatch/error-log-column-values-clickstack.png" size="lg" alt="Атрибуты CloudWatch в представлении сведений о журнале" />
  ...
  <Step>
    ...
    <TrackedLink href={'/ru/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Скачать `cloudwatch-logs-dashboard.json`</TrackedLink>, затем в интерфейсе ClickStack перейдите в **Панели мониторинга** и нажмите **Импортировать**.

    <Image img="/images/clickstack/clickstack-import-dashboard.png" size="lg" alt="Кнопка импорта панели мониторинга" />

    Загрузите JSON‑файл и нажмите **Завершить импорт**.

    <Image img="/images/clickstack/cloudwatch/finish-clickstack-import.png" size="lg" alt="Диалог завершения импорта" />
  </Step>
