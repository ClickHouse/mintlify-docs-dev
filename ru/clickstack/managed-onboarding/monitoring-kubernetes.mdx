...
<Steps>
  ...
  <Step>
    ## Создайте secret для аутентификации и ConfigMap
  ...
  <Step>
    ## Передавайте атрибуты Kubernetes в приложения (рекомендуется)
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-search-with-k8-logs.png" size="lg" alt="Представление ClickStack Search с журналами Kubernetes" />
    ...
    <Image img="/images/use-cases/observability/clickstack-dashboard-kubernetes.png" size="lg" alt="Панель мониторинга Kubernetes в ClickStack" border />
