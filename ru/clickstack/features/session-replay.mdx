...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Экран поиска воспроизведений сеансов" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="Воспроизведение сеанса" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="Переход от воспроизведения сеанса к серверным трассировкам в ClickStack" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Представление трассировки в воспроизведении сеанса" size="lg" />
