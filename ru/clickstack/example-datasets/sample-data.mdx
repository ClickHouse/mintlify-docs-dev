...
title: 'ClickStack — примеры журналов, трассировок и метрик'
  ...
  <Tab title="Управляемый ClickStack">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="Выберите сервис" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx.png" alt="Интерфейс ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-10.png" alt="Поиск HyperDX" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-11.png" alt="Сеансы" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-12.png" alt="Воспроизведение сеанса" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-13.png" alt="Ошибка в сеансе" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-14.png" alt="Трассировка сеанса" size="lg" />

        Прокрутите трассировку вниз, чтобы увидеть источник ошибки — спан сервиса `checkout`. Выберите спан сервиса `Payment`.

        <Image img="/images/use-cases/observability/hyperdx-15.png" alt="Спан" size="lg" />

        Выберите вкладку `Column Values` и прокрутите вниз. Видно, что проблема связана с переполнением кэша.

        <Image img="/images/use-cases/observability/hyperdx-16.png" alt="Значения столбцов" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-17.png" alt="Коррелированный журнал" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-18.png" alt="Журналы" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-19.png" alt="Метрики" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack с открытым исходным кодом">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/copy_api_key.png" alt="Копирование ключа API" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-17.png" alt="Скоррелированный журнал" size="lg" />
