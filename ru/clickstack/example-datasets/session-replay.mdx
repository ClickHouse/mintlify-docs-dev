...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="Демо-приложение для воспроизведения сеанса" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Поиск воспроизведения сеанса" />

    Вы увидите свой сеанс в списке с его длительностью и количеством событий. Нажмите кнопку ▶️, чтобы воспроизвести его.

    <Image img="/images/clickstack/session-replay/session-replay.png" alt="Воспроизведение сеанса" />
