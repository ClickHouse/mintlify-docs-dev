...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Интерфейс HyperDX" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="Данные HyperDX в Kubernetes" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="ClickHouse в Kubernetes" size="lg" />