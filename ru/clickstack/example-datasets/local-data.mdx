...
<Tabs>
  <Tab title="Управляемый ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="Локальные журналы HyperDX" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Использование памяти с течением времени" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Формат числа" size="lg" />

        В следующем меню выберите `Percentage` в раскрывающемся списке `Output format`, затем нажмите `Apply`.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Процент использования памяти с течением времени" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack с открытым исходным кодом">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory с течением времени" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Память, % времени" size="lg" />
  </Tab>
</Tabs>