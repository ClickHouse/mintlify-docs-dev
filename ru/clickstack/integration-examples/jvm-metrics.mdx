...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Кнопка импорта дашборда" />

    3. Загрузите файл `jvm-metrics-dashboard.json` и нажмите **Finish Import**

    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Дашборд Kafka Metrics" />
