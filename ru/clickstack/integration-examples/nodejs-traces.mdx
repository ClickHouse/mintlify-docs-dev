...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="Ключ API ClickStack" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Экран поиска трассировок" />

    Нажмите на любую трассировку, чтобы открыть подробный просмотр со спанами, длительностью и атрибутами:

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Подробный просмотр трассировки" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Представление поиска трассировок" />

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Представление отдельной трассировки" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Импорт панели мониторинга" />

    3. Загрузите файл `nodejs-traces-dashboard.json` и нажмите **Finish Import**

    <Image img="/images/clickstack/nodejs/finish-import.png" alt="Завершение импорта" />
  </Step>

  <Step>
    #### Панель мониторинга будет создана со всеми преднастроенными визуализациями

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="Пример панели мониторинга" />
