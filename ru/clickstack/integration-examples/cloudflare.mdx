...
<Steps>
  ...
  <Step>
    ...
    * **Порядок**: Лексикографический порядок
    ...
    <Image img="/images/clickstack/cloudflare/continuous-ingestion.png" alt="Непрерывная ингестия" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="Добавить источник" />

    2. Нажмите **Add source** и задайте следующие параметры. Чтобы получить доступ ко всем полям, нажмите **Configure Optional Fields**:

    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="Настроить необязательные поля" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="Сохранить источник" />
  ...
  <Step>
    ...
    * Атрибуты, доступные для поиска, такие как `http.status_code`, `client.country`, `cache.status` и `bot.score`
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Представление Search" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Представление поиска" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="Импорт панели мониторинга" />

    2. Загрузите `cloudflare-logs-dashboard.json` → **Finish Import**

    <Image img="/images/clickstack/cloudflare/finish-import.png" alt="Импорт панели мониторинга" />
  </Step>

  <Step>
    #### Просмотр панели мониторинга

    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="Пример панели мониторинга" />
