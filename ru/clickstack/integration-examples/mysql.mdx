...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="Представление поиска" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/finish-import.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/example-dashboard.png" alt="Пример панели мониторинга" />
