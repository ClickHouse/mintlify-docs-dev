...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="Представление поиска" />

    <Image img="/images/clickstack/host-logs/log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="Представление Search" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Панель мониторинга журналов" />
