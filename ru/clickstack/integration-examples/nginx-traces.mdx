...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Просмотр трассировок" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="Пример панели мониторинга" />
  </Step>
</Steps>
