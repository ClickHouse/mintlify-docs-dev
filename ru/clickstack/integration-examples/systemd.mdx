...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Представление поиска по логам" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Представление поиска по журналам" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    * Уровня ошибок
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Пример панели мониторинга" />
