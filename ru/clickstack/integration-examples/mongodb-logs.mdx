...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Экран поиска журналов MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Экран сведений о записи журнала MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Представление поиска журналов MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Представление подробностей журнала MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="Завершение импорта панели мониторинга журналов MongoDB" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="Панель мониторинга журналов MongoDB" />
  </Step>
</Steps>
