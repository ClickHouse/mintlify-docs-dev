...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="Диалог завершения импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="Панель мониторинга метрик Kafka" />
