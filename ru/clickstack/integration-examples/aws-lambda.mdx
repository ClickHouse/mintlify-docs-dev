...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/lambda/lambda-log-view.png" alt="Представление логов Lambda" />

    <Image img="/images/clickstack/lambda/lambda-log.png" alt="Подробности лога Lambda" />
