...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Представление поиска по журналам" />

    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Представление поиска журналов" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="Панель мониторинга журналов" />
