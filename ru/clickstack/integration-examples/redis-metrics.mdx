...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="Диалог завершения импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Панель мониторинга Redis Metrics" />
