...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="Представление Search для журналов EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="Подробная информация о журнале EC2 с метаданными" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="Представление поиска журналов EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="Подробная информация о журнале EC2 с метаданными" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ru/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Скачать</TrackedLink> конфигурацию панели мониторинга
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Кнопка импорта панели мониторинга" />

    3. Загрузите файл `host-logs-dashboard.json` и нажмите **Finish Import**

    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Панель мониторинга журналов EC2" />
