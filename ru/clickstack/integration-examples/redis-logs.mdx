...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="Представление логов" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="представление журналов" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="Завершение импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="Пример панели мониторинга" />
  </Step>
</Steps>
