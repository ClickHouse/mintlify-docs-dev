...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="Раздел поиска журналов" />
    ...
    * `Body`: фактическое содержимое сообщения журнала
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="Значения столбца журнала ошибок" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="Демонстрационный экран поиска" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="Диалог завершения импорта" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="Панель мониторинга CloudWatch Logs" />
