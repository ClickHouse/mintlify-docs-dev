...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Представление Search" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="Представление логов" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Завершение импорта панели мониторинга журналов Kafka" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Пример панели мониторинга журналов Kafka" />
  </Step>
</Steps>
