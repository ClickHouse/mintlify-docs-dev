...
export const INFRA = [
  ...
  { title: 'Журналы хоста',     img: '/images/logo-hostlogs.svg',            href: '/clickstack/integration-examples/host-logs' },
  { title: 'Systemd',       img: '/images/systemd-logomark.svg',               href: '/clickstack/integration-examples/systemd' },
  { title: 'Метрики JVM',   img: '/images/logo-java.svg',                 href: '/clickstack/integration-examples/jvm-metrics' },
  { title: 'Трейсы Node.js',img: '/images/logo-nodejs.svg',               href: '/clickstack/integration-examples/nodejs-traces' },
];
