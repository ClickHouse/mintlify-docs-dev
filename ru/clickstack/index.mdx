...
export const INFRA = [
  ...
  { title: 'Host журналы',     img: '/images/logo-hostlogs.svg',            href: '/clickstack/integration-examples/host-logs' },
  { title: 'Systemd',       img: '/images/systemd-logomark.svg',               href: '/clickstack/integration-examples/systemd' },
  { title: 'JVM метрики',   img: '/images/logo-java.svg',                 href: '/clickstack/integration-examples/jvm-metrics' },
  { title: 'Node.js трейсы',img: '/images/logo-nodejs.svg',               href: '/clickstack/integration-examples/nodejs-traces' },
];

export const DATABASES = [
  { title: 'Журналы PostgreSQL',    img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-logs' },
  { title: 'Метрики PostgreSQL', img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-metrics' },
  { title: 'MySQL',              img: '/images/logo-mysql.svg',     href: '/clickstack/integration-examples/mysql' },
  { title: 'Журналы Redis',         img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-logs' },
  { title: 'Метрики Redis',      img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-metrics' },
  { title: 'MongoDB',            img: '/images/mongodb-logo.svg',        href: '/clickstack/integration-examples/mongodb-logs' },
  { title: 'Журналы Kafka',         img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-logs' },
  { title: 'Метрики Kafka',      img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-metrics' },
  { title: 'Журналы Nginx',         img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-logs' },
  { title: 'Трейсы Nginx',       img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-traces' },
