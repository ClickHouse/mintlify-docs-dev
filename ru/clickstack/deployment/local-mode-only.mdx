...
<Steps>
  ...
  <Step>
    ...
    **Вам не будет предложено создать пользователя, так как в этом режиме развертывания аутентификация не включена.**
    ...
    <Image img="/images/use-cases/observability/hyperdx-2.png" alt="Создание входа в систему" size="md" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-logs.png" alt="Создание источника логов" size="md" />
  </Step>
</Steps>
