  ...
  <Tab title="Docker">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="Аутентификация" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="Создать источник" size="lg" />
