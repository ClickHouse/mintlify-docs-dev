  ...
  <Tab title="Управляемый ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Запуск ClickStack для Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource.png" alt="Создание источника данных — vector" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Журналы Nginx в ClickStack" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack с открытым исходным кодом">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="Интерфейс play в ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Вход в ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="Создание источника данных — Vector" size="lg" />
  ...
  <Tab title="Управляемый ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Интерфейс HyperDX" size="lg" />
      </Step>
    </Steps>
  </Tab>
