...
<Steps>
<Step>
## Install WSL <a id="install-wsl"></a>
...
<Step>
## Install ClickHouse via script using curl <a id="install-clickhouse-via-script-using-curl"></a>
...
<Step>
## Start clickhouse-local <a id="start-clickhouse-local"></a>
