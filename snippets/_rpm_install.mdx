...
# Install ClickHouse on rpm-based distributions <a id="from-rpm-packages"></a>
...
<Step>
## Set up the RPM repository <a id="setup-the-rpm-repository"></a>
...
<Step>
## Install ClickHouse server and client <a id="install-clickhouse-server-and-client-1"></a>
...
<Step>
## Start ClickHouse server <a id="start-clickhouse-server-1"></a>
...
<Step>
## Install standalone ClickHouse Keeper <a id="install-standalone-clickhouse-keeper-1"></a>
...
<Step>
## Enable and start ClickHouse Keeper <a id="enable-and-start-clickhouse-keeper-1"></a>
