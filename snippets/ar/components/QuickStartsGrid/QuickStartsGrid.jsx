                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="space-y-5">
                        <FilterGroup label="حالات الاستخدام" options={useCaseOptions} selectedOptions={selectedUseCases} onToggle={toggleUseCase} />
                        <FilterGroup label="مجال المنتج" options={productOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">لا توجد أدلة بدء سريع تطابق معايير البحث.</p>
