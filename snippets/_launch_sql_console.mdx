...
<Image img="/static/images/_snippets/cloud-connect-to-sql-console.png"  alt="Connect to SQL Console" size="lg" force border/>

This will redirect you to the SQL console.

<Image img="/static/images/_snippets/createservice8.png"  alt="SQL Console" size="lg" force border/>
</Accordion>
