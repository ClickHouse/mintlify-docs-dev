Please refer to [the official documentation](/core/concepts/features/interfaces/mysql)
...
[Double SHA1 password encryption](/core/concepts/features/configuration/settings/settings-users#user-namepassword)
