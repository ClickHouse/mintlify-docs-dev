...
<Step>
## Setup your ClickPipe connection <a id="2-setup-your-clickpipe-connection"></a>
...
<Step>
## Select data format <a id="3-select-data-format"></a>
...
<Step>
## Configure table, schema and settings <a id="5-configure-table-schema-settings"></a>
