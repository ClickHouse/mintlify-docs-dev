...
import GCSSDataSource from '/snippets/clickpipes/object-storage/google-cloud-storage/_1-data-source.mdx';
import ABSDataSource from '/snippets/clickpipes/object-storage/azure-blob-storage/_1-data-source.mdx';
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step3_object_storage.png" alt="Set data format and topic" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissions" size="lg" border/>
