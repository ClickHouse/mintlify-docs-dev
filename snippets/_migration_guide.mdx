...
<Image img="/static/images/integrations/data-ingestion/redshift/redshift-to-clickhouse.png" size="md" alt="Redshift to ClickHouse Migration Options"/>
...
<Image img="/static/images/integrations/data-ingestion/redshift/push.png" size="md" alt="PUSH Redshift to ClickHouse"/>
...
<Image img="/static/images/integrations/data-ingestion/redshift/pull.png" size="md" alt="PULL from Redshift to ClickHouse"/>
...
<Image img="/static/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="PIVOT from Redshift using S3"/>
...
<Image img="/static/images/integrations/data-ingestion/redshift/s3-1.png" size="md" alt="UNLOAD from Redshift to S3" background="white"/>

It will generate part files containing the raw data in S3

<Image img="/static/images/integrations/data-ingestion/redshift/s3-2.png" size="md" alt="Data in S3" background="white"/>
