...
## Why avoid? <a id="why-avoid"></a>

### It's expensive <a id="its-expensive"></a>
...
### It ignores safety limits <a id="it-ignores-safety-limits"></a>
...
## Let background merges do the work <a id="let-background-merges-do-the-work"></a>
