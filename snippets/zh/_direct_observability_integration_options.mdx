...
有关插件安装和配置的详细信息，请参阅 ClickHouse [数据源插件](/zh/integrations/connectors/data-visualization/grafana)。如需了解如何使用包含预构建仪表盘和告警规则的 Prometheus-Grafana mix-in 搭建完整的监控方案，请参阅[使用新的 Prometheus-Grafana mix-in 监控 ClickHouse](https://clickhouse.com/blog/monitor-with-new-prometheus-grafana-mix-in)。
