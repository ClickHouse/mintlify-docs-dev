...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/tls-settings.png" alt="TLS 设置" size="lg" border />

或者在已暂停的 ClickPipe 的 *Settings* 选项卡中的 *Connection settings* 部分进行编辑：

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-connection-settings.png" alt="连接设置 -> 编辑连接" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-edit-connection.png" alt="编辑连接" size="lg" border />
