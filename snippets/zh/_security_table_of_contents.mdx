...
| [云访问管理指南](/zh/products/cloud/guides/security/cloud-access-management)           | 本节包含在 ClickHouse Cloud 中管理访问权限的分步指南。                                 |
| [设置 IP 过滤器](/zh/products/cloud/guides/security/connectivity/setting-ip-filters) | 介绍如何创建或修改 IP 访问列表。                                                   |
| [私有网络](/zh/products/cloud/guides/security/connectivity/private-networking)      | ClickHouse Cloud 支持将您的服务连接到云虚拟网络。有关您的提供商的配置步骤，请参阅这些指南。               |
...
| [审计日志](/zh/products/cloud/guides/security/audit-logging)                        | 介绍如何在 ClickHouse Cloud 控制台中访问和查看审计事件，以及客户在制定其 BYOC 安全计划时可参考的日志样本和查询。 |
