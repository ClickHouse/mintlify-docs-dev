...
import GCSSDataSource from '/snippets/zh/clickpipes/object-storage/google-cloud-storage/_1-data-source.mdx';
...
<Steps>
  <Step>
    ...
    **1.** 在 ClickHouse Cloud 中，先在主导航菜单中选择 **数据源**，然后点击 **Create ClickPipe**。
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="选择导入源" size="lg" border />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_object_storage.png" alt="设置数据格式和 topic" size="lg" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="设置高级选项" size="lg" border />
  ...
  <Step>
    ...
    * `Only destination table`：仅拥有对目标表的 `INSERT` 权限。
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="权限" size="lg" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="成功提示" size="sm" border />

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="移除提示" size="lg" border />
