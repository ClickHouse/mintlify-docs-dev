...
<Image size="lg" img="/static/images/_snippets/mysql1.png" alt="ClickHouse Cloud credentials screen showing MySQL interface selection dropdown" border />
...
<Image size="lg" img="/static/images/_snippets/mysql2.png" alt="ClickHouse Cloud MySQL interface enabling toggle and connection details" border />
...
<Image size="lg" img="/static/images/_snippets/mysql3.png" alt="ClickHouse Cloud service connection screen with Connect option highlighted" border />

#### Choose `MySQL` \{#choose-mysql\}

Select `MySQL` from the `Connect With` drop down.

<Image size="md" img="/static/images/_snippets/mysql4.png" alt="ClickHouse Cloud connection screen showing MySQL option selection" border />
...
<Image size="md" img="/static/images/_snippets/mysql5.png" alt="ClickHouse Cloud connection screen with MySQL interface enabled showing connection details" border />
