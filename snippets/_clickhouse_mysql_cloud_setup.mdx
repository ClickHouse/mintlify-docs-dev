...
<Steps>
<Step>
#### Select `Connect your app` <a id="select-connect-your-app"></a>
After creating your ClickHouse Cloud Service, on the `Connect your app` screen, select MySQL from the drop down.

<Image size="lg" img="/images/_snippets/mysql1.png" alt="ClickHouse Cloud credentials screen showing MySQL interface selection dropdown" border />
</Step>
<Step>
#### Enable the MySQL interface <a id="enable-mysql-interface"></a>
...
<Image size="lg" img="/images/_snippets/mysql2.png" alt="ClickHouse Cloud MySQL interface enabling toggle and connection details" border />

Alternatively, in order to enable the MySQL interface for an existing service:
</Step>
<Step>
#### Select `Connect` <a id="select-connect"></a>
...
<Image size="lg" img="/images/_snippets/mysql3.png" alt="ClickHouse Cloud service connection screen with Connect option highlighted" border />
</Step>
<Step>
#### Choose `MySQL` <a id="choose-mysql"></a>
Select `MySQL` from the `Connect With` drop down.

<Image size="md" img="/images/_snippets/mysql4.png" alt="ClickHouse Cloud connection screen showing MySQL option selection" border />
</Step>
<Step>
#### Enable the MySQL interface <a id="enable-mysql-interface"></a>
Toggle the switch to enable the MySQL interface for this specific service.
...
<Image size="md" img="/images/_snippets/mysql5.png" alt="ClickHouse Cloud connection screen with MySQL interface enabled showing connection details" border />

## Creating a readonly MySQL user in ClickHouse Cloud <a id="creating-multiple-mysql-users-in-clickhouse-cloud"></a>
...
<Steps>
<Step>
#### Create a readonly settings profile <a id="create-a-custom-settings-user"></a>
...
<Step>
#### Create a new readonly MySQL user <a id="create-a-readonly-mysql-user"></a>
...
<Step>
#### Grant the new user permissions to access the desired tables <a id="grant-the-new-user-the-necessary-permissions"></a>
