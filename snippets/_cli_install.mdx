...
<Steps>
<Step>
## Install the ClickHouse CLI <a id="install-the-cli"></a>
...
<Step>
## Install ClickHouse <a id="cli-install-clickhouse"></a>
...
<Step>
## Start clickhouse-server <a id="cli-start-clickhouse-server"></a>
...
<Step>
## Start clickhouse-client <a id="cli-start-clickhouse-client"></a>
