...
### Choosing a return mode <a id="choosing-a-return-mode"></a>
...
### Adaptive async inserts <a id="adaptive-async-inserts"></a>
...
### Deduplication and reliability <a id="deduplication-and-reliability"></a>
...
### Enabling asynchronous inserts <a id="enabling-asynchronous-inserts"></a>
...
### Flushing buffers on shutdown <a id="flushing-buffers-on-shutdown"></a>
...
### Comparison with buffer tables <a id="comparison-with-buffer-tables"></a>
