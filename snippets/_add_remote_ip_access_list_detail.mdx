...
<Image size="md" img="/static/images/_snippets/ip-allow-list-check-list.png" alt="Check to see if the service allows traffic from your IP address in the IP Access List" border />
...
<Image size="md" img="/static/images/_snippets/ip-allow-list-add-current-ip.png" alt="Add your current IP address to the IP Access List in ClickHouse Cloud" border />
</Accordion>
