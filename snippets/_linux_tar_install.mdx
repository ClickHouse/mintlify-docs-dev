...
<Step>
## Download and install the latest stable version <a id="install-latest-stable"></a>
...
<Step>
## Get the latest ClickHouse version <a id="get-latest-version"></a>
...
<Step>
## Detect your system architecture <a id="detect-system-architecture"></a>
...
<Step>
## Download tarballs for each ClickHouse component <a id="download-tarballs"></a>
...
<Step>
## Extract and install packages <a id="extract-and-install"></a>
