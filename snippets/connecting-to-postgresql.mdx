...
## Using the PostgreSQL table engine <a id="using-the-postgresql-table-engine"></a>
...
### 1. Setting up PostgreSQL <a id="1-setting-up-postgresql"></a>
...
### 2. Define a Table in ClickHouse <a id="2-define-a-table-in-clickhouse"></a>
...
### 3 Test the Integration <a id="3-test-the-integration"></a>
...
## Using the MaterializedPostgreSQL database engine <a id="using-the-materializedpostgresql-database-engine"></a>
...
### 1. In PostgreSQL <a id="1-in-postgresql"></a>
...
### 2. In ClickHouse <a id="2-in-clickhouse"></a>
...
### 3. Test basic replication <a id="3-test-basic-replication"></a>
