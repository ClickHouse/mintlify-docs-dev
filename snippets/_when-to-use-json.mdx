## When to use the `JSON` Type <a id="when-to-use-json-type"></a>
...
### Use the `JSON` type when: <a id="use-json-type"></a>
...
### Use a `String` column (or structured types) when: <a id="use-string-type"></a>
