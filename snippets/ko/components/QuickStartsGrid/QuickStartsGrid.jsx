export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  // `featured`에 나열된 순서대로 표시되는 추천 빠른 시작 항목입니다. 배너 아트는
  // 제목을 기반으로 코드에서 렌더링되므로(아래 참조) 로케일별 이미지가 필요하지 않습니다.
  // 데이터가 아직 로드되지 않은 경우에도 카드를 즉시 클릭할 수 있도록
  // href가 기본 빠른 시작 경로로 폴백됩니다.
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {featuredQuickStarts.map((quickStart) => (
                  ...
                  >
                    {/* 배너 아트는 제목을 기반으로 코드에서 생성되므로
                        자동으로 번역됩니다 — 로케일별 PNG가 필요하지 않습니다. */}
