...
For deleting data, you can also consider [Lightweight deletes](/concepts/operations/delete/lightweight-delete) or the management of data through [partitions](/concepts/best-practices/partitioning-keys) which allow entire parts to be [dropped efficiently](/reference/statements/alter/partition#drop-partitionpart).
