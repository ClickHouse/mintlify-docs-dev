...
For deleting data, you can also consider [Lightweight deletes](/core/concepts/features/operations/delete/lightweight-delete) or the management of data through [partitions](/core/concepts/best-practices/partitioning-keys) which allow entire parts to be [dropped efficiently](/core/reference/statements/alter/partition#drop-partitionpart).
