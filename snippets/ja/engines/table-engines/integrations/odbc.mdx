...
This engine supports the [Nullable](../../../sql-reference/data-types/nullable.md){/* MIGRATE: unresolved relative link */} data type.
...
See a detailed description of the [CREATE TABLE](/sql-reference/statements/create/table){/* MIGRATE: unknown slug */} query.
...
- Column types may differ from those in the source table. ClickHouse tries to [cast](/sql-reference/functions/type-conversion-functions#CAST){/* MIGRATE: unknown slug */} values to the ClickHouse data types.
- The [external_table_functions_use_nulls](/operations/settings/settings#external_table_functions_use_nulls){/* MIGRATE: unknown slug */} setting defines how to handle Nullable columns. Default value: 1. If 0, the table function does not make Nullable columns and inserts default values instead of nulls. This is also applicable for NULL values inside arrays.
...
These parameters can also be passed using [named collections](/operations/named-collections.md){/* MIGRATE: unknown slug */}.
...
- [ODBC dictionaries](/sql-reference/statements/create/dictionary/sources/odbc){/* MIGRATE: unknown slug */}
- [ODBC table function](../../../sql-reference/table-functions/odbc.md){/* MIGRATE: unresolved relative link */}
