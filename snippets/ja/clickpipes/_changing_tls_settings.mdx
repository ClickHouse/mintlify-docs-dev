...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/tls-settings.png" alt="TLS 設定" size="lg" border />

または、一時停止中の ClickPipe の *Settings* タブにある *Connection settings* セクションで編集することもできます。

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-connection-settings.png" alt="接続設定 -> 接続を編集" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-edit-connection.png" alt="接続を編集" size="lg" border />
