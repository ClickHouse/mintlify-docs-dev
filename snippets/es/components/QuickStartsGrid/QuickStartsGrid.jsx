export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  // Guías de inicio rápido destacadas, en el orden indicado en `featured`. El arte del banner
  // se genera en código a partir del título (véase más abajo), por lo que no se necesita
  // una imagen por idioma. El href recurre a la ruta convencional de la guía de inicio rápido
  // si los datos aún no se han cargado, de modo que las tarjetas sean clicables de inmediato.
