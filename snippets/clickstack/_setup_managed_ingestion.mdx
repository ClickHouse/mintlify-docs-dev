...
While this command uses the `default` user to connect Managed ClickStack, you should create a dedicated user when [going to production](/clickstack/managing/overview#create-a-database-ingestion-user-managed) and modifying your configuration.
</Info>
