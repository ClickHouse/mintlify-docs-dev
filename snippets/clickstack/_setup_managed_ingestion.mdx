<img src="/images/clickstack/getting-started/start_ingestion.png" alt="" />
...
<img src="/images/clickstack/getting-started/select_source.png" alt="" />
...
<img src="/images/clickstack/getting-started/otel_collector_start.png" alt="" />
...
While this command uses the `default` user to connect Managed ClickStack, you should create a dedicated user when [going to production](/products/clickstack/managing/overview#create-a-database-ingestion-user-managed) and modifying your configuration.
</Info>
...
- [Example dataset](/products/clickstack/example-datasets/sample-data) - Load an example dataset from our public demo. Diagnose a simple issue.
- [Local files and metrics](/products/clickstack/example-datasets/local-data) - Load local files and monitor the system on OSX or Linux using a local OTel collector.
...
<img src="/images/clickstack/getting-started/vector_config.png" alt="" />
