export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  const useCaseOptions = ["Todos", "Analytics em tempo real", "Armazenamento de dados", "Observabilidade", "AI/ML"]
  const productOptions = ["Todos", "Autogerenciado", "Cloud", "ClickPipes", "Cliente por linguagem", "ClickStack", "chDB"]
      ...
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          ...
          {featuredQuickStarts.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Guias de início rápido em destaque</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative w-full">
                        ...
                        <input
                          type="text"
                          placeholder="Buscar guias de início rápido..."
                          value={searchTerm}
                    ...
                    <div>
                      <div className="space-y-5">
                        ...
                        <FilterGroup label="Área do produto" options={productOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Explorar guias de início rápido</h2>
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">Nenhum guia de início rápido encontrado para os critérios informados.</p>
