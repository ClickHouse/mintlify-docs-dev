...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/tls-settings.png" alt="Configurações de TLS" size="lg" border />

Ou editadas na seção *Connection settings* da aba *Settings* do seu ClickPipe pausado:

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-connection-settings.png" alt="Configurações de conexão -> Editar conexão" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-edit-connection.png" alt="Editar conexão" size="lg" border />
