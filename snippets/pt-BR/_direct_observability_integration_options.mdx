...
Para detalhes sobre a instalação e a configuração do plugin, consulte o [plugin de fonte de dados](/pt-BR/integrations/connectors/data-visualization/grafana) do ClickHouse. Para uma configuração completa de monitoramento usando o mix-in Prometheus-Grafana com dashboards pré-configurados e regras de alerta, consulte [Monitor ClickHouse with the new Prometheus-Grafana mix-in](https://clickhouse.com/blog/monitor-with-new-prometheus-grafana-mix-in).
