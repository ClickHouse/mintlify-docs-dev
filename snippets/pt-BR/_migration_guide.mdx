...
* Permite cenários de transformação de dados (por exemplo, consulte nosso [guia de integração para dbt](/pt-BR/integrations/connectors/data-ingestion/etl-tools/dbt)).
