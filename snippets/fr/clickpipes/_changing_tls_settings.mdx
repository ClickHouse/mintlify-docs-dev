...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/tls-settings.png" alt="Paramètres TLS" size="lg" border />

Ou modifiés dans la section *Paramètres de connexion* de l’onglet *Paramètres* de votre ClickPipe en pause :

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-connection-settings.png" alt="Paramètres de connexion -> Modifier la connexion" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pipe-edit-connection.png" alt="Modifier la connexion" size="lg" border />
