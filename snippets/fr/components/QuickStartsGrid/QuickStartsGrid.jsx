export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  // Guides de démarrage rapide à la une, dans l'ordre défini dans `featured`. La bannière est
  // générée en code à partir du titre (voir ci-dessous), aucune image spécifique à la locale n'est donc nécessaire.
  // L'href revient au chemin de guide de démarrage rapide conventionnel si les données n'ont pas
  // encore été chargées, afin que les cartes soient cliquables immédiatement.
