...
> Рекомендуется использовать официальные предварительно собранные `rpm`-пакеты для **CentOS**, **RedHat** и других
> Linux-дистрибутивов на базе rpm.
...
<Steps>
  ...
  <Step>
    ...
    от того, какой пакетный менеджер вы используете.
  </Step>
