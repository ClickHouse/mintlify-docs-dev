      ...
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          ...
          {featuredQuickStarts.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Рекомендуемые быстрые старты</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative w-full">
                        ...
                        <input
                          type="text"
                          placeholder="Поиск по быстрым стартам..."
                          value={searchTerm}
                    ...
                    <div>
                      <div className="space-y-5">
                        <FilterGroup label="Сценарии использования" options={useCaseOptions} selectedOptions={selectedUseCases} onToggle={toggleUseCase} />
                        <FilterGroup label="Область продукта" options={productOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Все быстрые старты</h2>
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">Не найдено руководств по быстрому старту, соответствующих вашим критериям.</p>
                  <p className="text-gray-500 dark:text-gray-500 text-sm mt-2 block">Попробуйте изменить фильтры или поисковый запрос.</p>
                </div>
              )}
            </div>
          </div>
