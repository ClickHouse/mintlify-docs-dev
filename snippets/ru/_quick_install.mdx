...
<Steps>
  <Step>
    ...
    В Linux и macOS это также устанавливает [`clickhousectl`](https://github.com/ClickHouse/clickhousectl)
    в `~/.local/bin` (с символьной ссылкой `chctl`), чтобы вы могли управлять локальными версиями
    ClickHouse и серверами.
