...
## How to use this image <a id="how-to-use-image"></a>

### Start server instance <a id="start-server-instance"></a>
...
### Connect to it from a native client <a id="connect-to-it-from-native-client"></a>
...
### Connect to it using curl <a id="connect-to-it-using-curl"></a>
...
### Stopping / removing the container <a id="stopping-removing-container"></a>
...
## Linux capabilities <a id="linear-capabilities"></a>
...
### Start server instance with custom configuration <a id="start-server-instance-with-custom-config"></a>

```bash
docker run -d --name some-clickhouse-server --ulimit nofile=262144:262144 -v /path/to/your/config.xml:/etc/clickhouse-server/config.xml clickhouse/clickhouse-server
```

### Start server as custom user <a id="start-server-custom-user"></a>
...
### Start server from root <a id="start-server-from-root"></a>
...
### How to create default database and user on start <a id="how-to-create-default-db-and-user"></a>
...
#### Managing `default` user <a id="managing-default-user"></a>
...
## How to extend this image <a id="how-to-extend-image"></a>
