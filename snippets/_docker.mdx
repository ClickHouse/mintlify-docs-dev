...
See [ClickHouse client](/core/concepts/features/interfaces/cli) for more information about ClickHouse client.
...
See [ClickHouse HTTP Interface](/core/concepts/features/interfaces/http) for more information about the HTTP interface.
...
The container exposes port 8123 for the [HTTP interface](/core/concepts/features/interfaces/http) and port 9000 for the [native client](/core/concepts/features/interfaces/tcp).

ClickHouse configuration is represented with a file "config.xml" ([documentation](/core/concepts/features/configuration/server-config/configuration-files))
