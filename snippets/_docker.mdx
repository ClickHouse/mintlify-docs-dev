...
See [ClickHouse client](/integrations/connectors/data-integrations/drivers-and-interfaces/cli) for more information about ClickHouse client.
...
See [ClickHouse HTTP Interface](/integrations/connectors/data-integrations/drivers-and-interfaces/http) for more information about the HTTP interface.
...
The container exposes port 8123 for the [HTTP interface](/integrations/connectors/data-integrations/drivers-and-interfaces/http) and port 9000 for the [native client](/integrations/connectors/data-integrations/drivers-and-interfaces/tcp).
