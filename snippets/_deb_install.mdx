...
# Install ClickHouse on Debian/Ubuntu <a id="install-from-deb-packages"></a>
...
<Step>
## Set up the Debian repository <a id="setup-the-debian-repository"></a>
...
<Step>
## Install ClickHouse server and client <a id="install-clickhouse-server-and-client"></a>
...
<Step>
## Start ClickHouse <a id="start-clickhouse-server"></a>
...
<Step>
## Install standalone ClickHouse Keeper <a id="install-standalone-clickhouse-keeper"></a>
...
<Step>
## Enable and start ClickHouse Keeper <a id="enable-and-start-clickhouse-keeper"></a>
