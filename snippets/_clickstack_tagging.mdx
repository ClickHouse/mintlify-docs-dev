...
<Image img="/static/images/use-cases/observability/clickstack-tags-search.png" alt="Tags in saved search" size="md" border />

You can also select multiple tags to filter and view items across different categories:

<Image img="/static/images/use-cases/observability/clickstack-tags-dashboard.png" alt="Multiple tags selected in dashboard" size="md" border />