...
<Steps>
  <Step>
    ### organization settings로 이동하여 Users and roles를 선택합니다
  ...
  <Step>
    ### 왼쪽 상단에서 &#39;Invite members&#39;를 선택합니다
  ...
  <Step>
    ### `Send invites`를 클릭합니다

    화면 하단에서 `Send invites`를 클릭합니다. 사용자는 조직에 참여할 수 있는 링크가 포함된 이메일을 받게 됩니다. 초대 수락에 대한 자세한 내용은 [내 계정 관리](/ko/products/cloud/guides/security/cloud-access-management/manage-my-account)를 참조하십시오.
...
<Steps>
  <Step>
    ### organization settings로 이동한 다음 Users and roles를 선택합니다
