...
현재 서비스 제공자 시작 SSO, 각기 별도의 연결을 사용하는 여러 조직, 그리고 Just-in-Time 프로비저닝을 지원합니다. 아직 System for Cross-domain Identity Management(SCIM) 또는 속성 매핑은 지원하지 않습니다.
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="SAML 설정 시작" force />
  </Step>
  ...
  <Step>
    ...
    * [Duo SAML 구성](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="아이덴티티 공급자 애플리케이션 만들기" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="메타데이터 URL 추가" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="확인할 도메인 추가" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="도메인 확인" force />
  </Step>
...
<Accordion title="Google 웹 앱 만들기">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Google SAML 앱" force />
...
<Accordion title="Azure Enterprise 애플리케이션 만들기">
  ...
  5. 이름을 입력하고 **Integrate any other application you don&#39;t find in the gallery (Non-gallery)**를 선택한 다음 **Create**를 클릭합니다.
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Azure 비갤러리 앱" force />
  ...
  10. Attributes &amp; Claims 아래에서 다음 항목을 추가(A)하거나 업데이트(U)합니다.
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="속성 및 클레임" force />
