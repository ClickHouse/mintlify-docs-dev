...
더 긴 보존 기간이나 로그 내구성이 필요한 고객은 materialized view를 사용해 이러한 목표를 달성할 수 있습니다. materialized view가 무엇인지, 어떤 이점이 있는지, 어떻게 구현하는지에 대한 자세한 내용은 [materialized view](/ko/concepts/features/materialized-views) 동영상과 문서를 참조하십시오.

<div id="exporting-logs">
  ## 로그 내보내기
</div>

시스템 로그는 SIEM 시스템과 호환되는 다양한 포맷을 사용해 저장 위치에 기록하거나 내보낼 수 있습니다. 자세한 내용은 [테이블 함수](/ko/reference/functions/table-functions) 문서를 참조하십시오. 가장 일반적인 방법은 다음과 같습니다.
