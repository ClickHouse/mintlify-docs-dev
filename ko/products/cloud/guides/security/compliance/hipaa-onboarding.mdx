...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="HIPAA 활성화 요청" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="BAA 요청 제출" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA 활성화됨" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="HIPAA 리전에 배포" background="black" />
