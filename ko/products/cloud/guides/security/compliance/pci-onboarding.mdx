...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_1.png" size="md" alt="PCI 활성화" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/pci_2.png" size="md" alt="PCI 활성화됨" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_3.png" size="md" alt="PCI 리전에 배포" background="black" />
