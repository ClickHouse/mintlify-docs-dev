...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="PrivateLink 개요" background="white" />
...
<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="Azure Private Center 열기" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Private Endpoint Basic 만들기" border />
...
<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="Private Endpoint 리소스 선택" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Private Endpoint Virtual Network 선택" border />

**Next: Tags** 버튼을 클릭합니다.

***

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Private Endpoint DNS 구성" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Private Endpoint 태그" border />

마지막으로 **Create** 버튼을 클릭합니다.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="Private Endpoint 검토" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="Private Endpoint IP 주소" border />
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="Private Endpoint 보기" border />
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Private Link DNS 와일드카드 설정" border />
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Private Endpoint 제거" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="Private Endpoints 필터" border />
