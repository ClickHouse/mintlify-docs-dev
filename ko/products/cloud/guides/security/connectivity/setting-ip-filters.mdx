...
<Info>
  **PrivateLink 외부 연결에만 적용됩니다**
  ...
  IP 액세스 목록은 [PrivateLink](/ko/products/cloud/guides/security/connectivity/private-networking) 외부의 퍼블릭 인터넷에서 오는 연결에만 적용됩니다.
...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="ClickHouse Cloud의 기존 액세스 목록" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="ClickHouse Cloud의 액세스 목록에 단일 IP 추가" border />
