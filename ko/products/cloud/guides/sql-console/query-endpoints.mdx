...
description: '저장된 쿼리로 REST API 엔드포인트를 손쉽게 만듭니다'
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="예시 쿼리 테스트" />

    다음으로 쿼리를 저장합니다:

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="예시 쿼리 저장" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="쿼리 엔드포인트 구성" />
    ...
    * CORS(Cross-Origin Resource Sharing) 허용 도메인 지정
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="엔드포인트 curl 명령" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="엔드포인트 curl 테스트" />

    첫 번째 요청을 보내면 **Share** 버튼 바로 오른쪽에 새 버튼이 즉시 나타납니다. 이 버튼을 클릭하면 쿼리에 대한 모니터링 데이터가 포함된 플라이아웃이 열립니다:

    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="엔드포인트 모니터링" />
  </Step>
</Steps>
