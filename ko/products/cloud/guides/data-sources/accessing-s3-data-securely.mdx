...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="ClickHouse를 사용한 안전한 S3 액세스 개요" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="ClickHouse 서비스의 IAM role ARN 확인하기" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="IAM Role ARN을 보여주는 CloudFormation 스택 출력" border />
