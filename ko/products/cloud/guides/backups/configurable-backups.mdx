...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="백업 설정 구성" border />

그러면 오른쪽에 탭이 열리며, 여기에서 보존 기간, 빈도, 시작 시간 값을 선택할 수 있습니다. 선택한 설정을 적용하려면 저장해야 합니다.

<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="백업 보존 기간 및 빈도 선택" border />
