...
<Image img="/images/cloud/manage/backup-chain.png" size="lg" alt="ClickHouse Cloud의 백업 체인 예시" />
...
<Steps>
  <Step>
    ...
    또한 자체 클라우드 계정으로 내보내는 [구성 가능한](/ko/products/cloud/guides/backups/configurable-backups) 백업도 지원하므로, 사용자 지정 일정을 설정할 수 있습니다.
