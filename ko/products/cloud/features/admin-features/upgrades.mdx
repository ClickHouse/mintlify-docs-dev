...
ClickHouse Cloud를 사용하면 패치와 업그레이드를 따로 걱정할 필요가 없습니다. 수정 사항, 새로운 기능, 성능 개선이 포함된 업그레이드를 정기적으로 배포합니다. ClickHouse의 새로운 변경 사항 전체 목록은 [Cloud changelog](/ko/resources/changelogs/cloud)에서 확인하십시오.
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="릴리스 채널 유형 선택" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="예약된 업그레이드" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="예약된 업그레이드 시간대" border />
</div>
