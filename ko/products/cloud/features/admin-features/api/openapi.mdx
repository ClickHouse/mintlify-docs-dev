...
title: 'API Key 관리'
description: 'ClickHouse Cloud는 OpenAPI 기반 API를 제공하며, 이를 통해 계정과 서비스의 여러 측면을 프로그래밍 방식으로 관리할 수 있습니다.'
doc_type: 'guide'
keywords: ['api', 'openapi', 'rest api', 'documentation', 'Cloud 관리']
---
...
<Image img="/images/cloud/manage/openapi1.png" size="sm" alt="API Key 탭" border />
...
<Image img="/images/cloud/manage/openapi2.png" size="md" alt="API Key 페이지" border />
...
<Image img="/images/cloud/manage/openapi4.png" size="md" alt="API Key 세부 정보" border />
...
<Image img="/images/cloud/manage/openapi5.png" size="md" alt="API Key 관리 페이지" border />
