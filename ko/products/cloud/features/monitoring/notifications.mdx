...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="ClickHouse Cloud 알림 플라이아웃" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="ClickHouse Cloud 알림 활동 로그" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="ClickHouse Cloud 알림 설정 화면" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="ClickHouse Cloud 알림 전달 설정" border />
