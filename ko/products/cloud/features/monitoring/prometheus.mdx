...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Grafana 메트릭 엔드포인트 구성" border />

<br />

구성이 완료되면 대시보드 구성에 사용할 수 있도록 선택 가능한 드롭다운에 메트릭이 표시됩니다:

<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Grafana 메트릭 탐색기 드롭다운" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Grafana 메트릭 탐색기 차트" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Grafana 메트릭 탐색기" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Prometheus Datadog 통합" />
