...
description: '시스템 테이블을 직접 쿼리해 ClickHouse Cloud를 모니터링합니다'
keywords: ['cloud', '모니터링', '시스템 테이블', 'query_log', 'clusterAllReplicas', '관측성 대시보드']
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="네이티브 고급 관측성 대시보드" border />
