...
<div id="monitoring-in-the-clickhouse-cloud-console">
  # ClickHouse Cloud 콘솔의 모니터링
</div>

ClickHouse Cloud의 서비스에는 대시보드와 알림을 제공하는 기본 제공 모니터링 구성 요소가 포함되어 있습니다. 기본적으로 Cloud Console의 모든 사용자가 이러한 대시보드에 액세스할 수 있습니다.
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="ClickHouse Cloud의 Advanced dashboard" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="쿼리 인사이트 UI 개요" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="쿼리 인사이트 지연 시간 차트" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="쿼리 인사이트 최근 쿼리 테이블" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="쿼리 인사이트 UI 쿼리 드릴다운" border />

**쿼리 정보** 탭의 모든 메트릭은 집계 메트릭이지만, **쿼리 이력** 탭을 선택하면 개별 실행의 메트릭도 확인할 수 있습니다:

<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="쿼리 인사이트 UI 쿼리 정보" border />
