...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="세그먼트 아키텍처" />
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="세그먼트 분할이 없는 아키텍처" />
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="병렬 레플리카" />
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="동적 조정 - 파트 1" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="동적 조정 - 파트 2" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="동적 조정 - 파트 3" />
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="parallel_replica 없이 EXPLAIN" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="parallel_replica를 사용한 EXPLAIN" />