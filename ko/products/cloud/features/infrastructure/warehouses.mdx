...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="ClickHouse Cloud의 단일 서비스" />
...
<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="ClickHouse Cloud의 컴퓨트 분리" />
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="기본 서비스와 보조 서비스가 있는 웨어하우스 예시" background="white" />
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="동일한 데이터를 공유하는 서비스 간 사용자 액세스" />
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="네트워크 액세스 제어 설정" />
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="웨어하우스의 읽기-쓰기 및 읽기 전용 서비스" />
...
<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="웨어하우스에서 새 서비스 생성하기" />
