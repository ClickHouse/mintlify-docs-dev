...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Connect 모달에서 MCP 선택" size="md" />

서비스에서 MCP를 활성화하려면 버튼을 켭니다:

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="MCP 서버 활성화" size="md" />
...
Notion 사용자 지정 에이전트에 ClickHouse Cloud 원격 MCP 서버를 연결하려면 전용 [Notion을 ClickHouse에 연결하기](/ko/integrations/connectors/data-integrations/integrations/notion) 통합 가이드를 참조하십시오.
