...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="OpenAI Image Tools, DALL-E-3, Stable Diffusion을 포함한 이미지 모델 통합과 기타 서드파티 도구가 표시된 Agent Tools 모달" size="md" />
