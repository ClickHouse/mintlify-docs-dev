...
<Image img="/images/cloud/agent-builder/run-code/run-code.png" alt="Capabilities 패널의 Run Code 섹션으로, Run Code 체크박스가 활성화되어 있고 Upload to Code Environment 버튼이 표시되어 있습니다" size="sm" />
