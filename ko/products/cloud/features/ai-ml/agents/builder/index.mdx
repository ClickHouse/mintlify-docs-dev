...
<Tip>
  ClickHouse Agents가 처음이신가요? [Quickstart](/ko/products/cloud/features/ai-ml/agents/quickstart)부터 시작하세요. 아래 페이지에서는 빌더의 각 부분을 자세히 설명합니다.
</Tip>
...
| 페이지                                                                        | 설명                       |
| -------------------------------------------------------------------------- | ------------------------ |
| [모델 매개변수](/ko/products/cloud/features/ai-ml/agents/builder/model-parameters)  | 모델을 선택하고 생성 매개변수를 조정합니다. |
