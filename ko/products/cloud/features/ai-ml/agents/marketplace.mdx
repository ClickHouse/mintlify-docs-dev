...
<Image img="/images/cloud/agent-builder/marketplace/marketplace.png" alt="왼쪽 사이드바에서 에이전트 마켓플레이스 옵션이 강조 표시된 채팅 화면" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/browse.png" alt="제목, 검색창, 범주 탭(General, Human Resources, Research and Development, Finance, IT, Sales, After Sales, All), 그리고 에이전트 카드가 표시된 에이전트 마켓플레이스 화면" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/use-agent.png" alt="에이전트 이름, 아이콘, Pin, Copy link, Start Chat 작업이 표시된 에이전트 상세 정보 모달" size="md" />
