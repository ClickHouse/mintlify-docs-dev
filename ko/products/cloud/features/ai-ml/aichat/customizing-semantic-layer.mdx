...
title: '시맨틱 레이어로 ClickHouse Assistant 에이전트 대화 최적화'
...
AGENTS.md 파일을 만들면 각 대화의 시작 부분에 삽입되는 맞춤형 지침을 제공할 수 있으며, 이를 통해 조직 고유의 요구 사항, 계산 방식, 규약에 따라 SQL 쿼리 생성과 데이터 분석을 안내할 수 있습니다.
