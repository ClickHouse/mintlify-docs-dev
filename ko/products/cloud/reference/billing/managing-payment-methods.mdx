...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="결제 수단 추가" size="lg" />

3. 신용카드를 수정하려면 페이지 상단에서 **신용카드 수정** 버튼을 클릭합니다.

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="신용카드 수정" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="결제 수단 편집" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="결제 수단 편집" size="lg" />
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="백업 신용카드 추가" size="lg" />
