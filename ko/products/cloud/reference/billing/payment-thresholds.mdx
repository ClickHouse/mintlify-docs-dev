...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="UI에서 청구를 찾는 위치" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="인보이스" />
