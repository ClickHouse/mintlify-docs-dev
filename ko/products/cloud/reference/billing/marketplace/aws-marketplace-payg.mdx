...
<Steps>
  <Step>
    ### ClickHouse Cloud - Pay as you go 검색

    [AWS Marketplace](https://aws.amazon.com/marketplace)로 이동한 다음 &quot;ClickHouse Cloud - Pay As You Go&quot;를 검색합니다.

    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-1.png" alt="ClickHouse용 AWS Marketplace 검색" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-2.png" alt="AWS Marketplace 구매 옵션 보기" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-3.png" alt="AWS Marketplace 구독" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-4.png" alt="계정 설정" border />
    ...
    <Accordion title="신규 사용자를 위한 단계">
      ...
      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-5.png" size="md" alt="ClickHouse Cloud 가입" />
      ...
      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-6.png" size="md" alt="시작하기 전에" />

      <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-7.png" size="md" alt="시작하기 전에, 계속" />
    </Accordion>
  ...
  <Step>
    ### marketplace subscription을 조직에 추가

    로그인에 성공하면 이 marketplace subscription으로 청구할 새 조직을 만들거나, 이 subscription으로 청구할 기존 조직을 선택할 수 있습니다.

    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.png" size="md" alt="marketplace subscription 추가" border />
    ...
    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-9.png" size="lg" alt="Billing page 확인" border />
  </Step>
</Steps>
