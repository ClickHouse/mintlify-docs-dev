...
<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="마켓플레이스 가입 및 조직 연결" border />
...
자세한 내용은 [청구 개요 페이지](/ko/products/cloud/reference/billing)를 참조하십시오.
...
<div id="automatically-move-to-PAYG-when-running-out-of-credit">
  ### ClickHouse 조직의 청구가 클라우드 마켓플레이스 사용 약정 계약을 통해 이루어지는 경우, 제보을 모두 소진하면 자동으로 PAYG 청구로 전환됩니까?
</div>

마켓플레이스 사용 약정 계약이 활성 상태이고 제보을 모두 소진한 경우, 조직은 자동으로 PAYG 청구로 전환됩니다. 다만 기존 계약이 만료되면 새 마켓플레이스 계약을 조직에 연결하거나, 신용카드를 통한 직접 청구로 조직을 전환해야 합니다.