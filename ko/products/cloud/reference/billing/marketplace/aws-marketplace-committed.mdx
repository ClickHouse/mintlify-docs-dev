...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="AWS Marketplace Private Offer 이메일" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="AWS Marketplace Private Offer 이메일" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="AWS Marketplace Private Offer 이메일" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="이 subscription에 청구할 organization 생성 또는 선택" />
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="설정 완료 확인" />
