...
ClickHouse Cloud 서비스에서 지정할 수 있는 설정에 대해 자세히 알아보려면 [문서](/ko/reference/settings)에서 범주별 전체 설정 목록을 참조하십시오.

<Image img="/images/cloud/manage/cloud-settings-sidebar.png" size="sm" alt="Cloud 설정 사이드바" border />