...
* **다양한 데이터 포맷** - Parquet, CSV, JSON, Arrow, ORC 및 [70개 이상의 추가 포맷](/ko/reference/formats)에 대한 입력 및 출력 지원
...
자세히 알아보기: [DataStore 문서](/ko/products/chdb/datastore)
...
* [구성](/ko/products/chdb/configuration) - Engine, 로깅, 프로파일링
...
* **[DataStore와 Pandas 비교](/ko/products/chdb/datastore#performance)** - 일반적인 작업에서 Pandas보다 최대 20배 더 빠름

<Image img="/images/chdb/df_bench.png" alt="DataFrame 벤치마크 결과" size="md" />
