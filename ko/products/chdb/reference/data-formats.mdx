...
* `DataFrame`을 입력 및 출력 포맷으로 지원하며, 유형은 Python `pandas.DataFrame`입니다. 예시는 [`test_joindf.py`](https://github.com/chdb-io/chdb/blob/main/tests/test_joindf.py)를 참조하십시오.
...
자세한 정보와 예시는 [ClickHouse 입력 및 출력 데이터 포맷](/ko/reference/formats) 문서를 참조하십시오.