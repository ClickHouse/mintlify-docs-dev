...
sidebarTitle: '빠른 시작'
title: '빠른 시작'
description: 'NVMe 기반 Postgres 성능을 경험하고 네이티브 ClickHouse 통합으로 실시간 분석 기능을 추가할 수 있습니다'
...
<Image img="/images/managed-postgres/create-service.png" alt="Managed Postgres 서비스 생성" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Managed Postgres 연결 모달" size="md" border />
...
<Image img="/images/managed-postgres/integration-landing.png" alt="비어 있는 Managed Postgres 통합" size="md" border />
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="Managed Postgres 통합 양식" size="md" border />
...
<Image img="/images/managed-postgres/table-picker.png" alt="Managed Postgres 테이블 선택기" size="md" border />
...
`pg_clickhouse` 확장 기능을 사용하면 표준 SQL로 Postgres에서 ClickHouse 데이터를 직접 쿼리할 수 있습니다. 즉, 애플리케이션에서 Postgres를 트랜잭션 데이터와 분석 데이터를 모두 아우르는 단일 쿼리 계층으로 사용할 수 있습니다. 자세한 내용은 [전체 문서](/ko/integrations/connectors/tools/pg_clickhouse/introduction)를 참조하십시오.
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="ClickHouse 호스트 가져오기" size="md" border />
...
<Image img="/images/managed-postgres/analytics-list.png" alt="Managed Postgres 분석 목록" size="md" border />

서비스 이름을 클릭해 ClickHouse 콘솔을 열고 복제된 테이블을 확인하세요.

<Image img="/images/managed-postgres/replicated-tables.png" alt="ClickHouse의 Managed Postgres 복제된 테이블" size="md" border />
