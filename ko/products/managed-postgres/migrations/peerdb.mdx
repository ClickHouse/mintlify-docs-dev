...
sidebarTitle: 'PeerDB'
title: 'PeerDB를 사용한 PostgreSQL 데이터 마이그레이션'
...
<div id="peerdb-migration">
  # PeerDB를 사용해 Managed Postgres로 마이그레이션하기
</div>

이 가이드는 PeerDB를 사용해 PostgreSQL 데이터베이스를 ClickHouse Managed Postgres로 마이그레이션하는 방법을 단계별로 안내합니다.
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="원본 피어 생성" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="대상 피어 생성" size="md" border />

이제 &quot;Peers&quot; 섹션에 소스 피어와 대상 피어가 모두 표시되는 것을 확인할 수 있습니다.

<Image img="/images/managed-postgres/peerdb/peers.png" alt="피어 목록" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="미러 생성" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="미러 설정" size="md" border />

4. 마이그레이션할 테이블을 선택하십시오. 특정 테이블만 선택하거나 원본 DB의 모든 테이블을 선택할 수 있습니다.

<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="테이블 선택기" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="미러 목록" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="초기 적재 진행 상황" size="md" border />
