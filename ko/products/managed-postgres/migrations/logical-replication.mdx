...
sidebarTitle: '논리적 복제'
title: '논리적 복제를 사용하여 PostgreSQL 데이터를 ClickHouse Managed Postgres로 이전하기'
...
<div id="logical-replication-migration">
  # 논리적 복제를 사용해 Managed Postgres로 마이그레이션하기
</div>

이 가이드에서는 Postgres의 네이티브 논리적 복제를 사용하여 PostgreSQL 데이터베이스를 ClickHouse Managed Postgres로 마이그레이션하는 방법을 단계별로 안내합니다.
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="소스 PostgreSQL 복제 설정" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="소스 PostgreSQL 테이블 설정" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="ClickHouse Managed Postgres 인스턴스 생성" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="대상 ClickHouse Managed Postgres 초기 설정" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="논리적 복제 후 마이그레이션 결과" size="xl" border />
