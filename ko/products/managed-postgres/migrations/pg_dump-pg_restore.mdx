...
title: 'pg_dump 및 pg_restore를 사용하여 PostgreSQL 데이터 마이그레이션'
...
<div id="pg-dump-pg-restore">
  # pg_dump 및 pg_restore를 사용해 Managed Postgres로 마이그레이션하기
</div>

이 가이드에서는 `pg_dump` 및 `pg_restore` 유틸리티를 사용해 PostgreSQL 데이터베이스를 ClickHouse Managed Postgres로 마이그레이션하는 방법을 단계별로 안내합니다.
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="원본 PostgreSQL 데이터베이스 설정" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump 명령 실행" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore 명령 실행" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="대상 Managed Postgres 데이터베이스 설정" size="xl" border />
