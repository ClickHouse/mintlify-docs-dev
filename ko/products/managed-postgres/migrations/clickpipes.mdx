...
<Image img="/images/managed-postgres/pgpg/migrationform.png" alt="1단계: 수집 메서드 옵션이 있는 원본 데이터베이스 연결 양식" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/nextexport.png" alt="2단계: 스키마 내보내기용 pg_dump 명령" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.png" alt="psql 스키마 가져오기 실행 후 터미널 출력" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/advancedsettings.png" alt="Step 4: publication 및 고급 복제 옵션이 포함된 수집 설정 양식" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="5단계: Create migration 버튼이 있는 스키마별 그룹화된 테이블 선택기" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/initialload.png" alt="테이블별 초기 적재 통계가 표시된 마이그레이션 상세 보기" size="lg" border />
