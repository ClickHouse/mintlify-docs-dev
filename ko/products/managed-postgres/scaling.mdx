...
<Image img="/images/managed-postgres/instance-types.png" alt="인스턴스 유형" size="md" border />
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="스케일링 설정" size="md" border />
