...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="IO 집약적 읽기+쓰기 벤치마크 결과" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="IO 집약적 읽기 전용 벤치마크 결과" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="CPU 집약적 벤치마크 결과" size="md" border />
