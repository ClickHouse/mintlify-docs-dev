...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Users and roles 메뉴" size="md" border />

2. **Roles** 탭으로 전환한 다음 **Create role**을 클릭합니다.
3. 역할 이름을 입력한 다음 **+ Allow**를 클릭하고 엔터티 목록에서 **Postgres 서비스**를 선택합니다.

<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="Postgres 서비스 엔터티 선택" size="md" border />

4. 역할의 범위를 지정할 Postgres 서비스를 선택한 다음, 부여할 권한을 선택합니다.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="역할의 Postgres 권한 구성" size="md" border />
