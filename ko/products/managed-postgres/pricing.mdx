...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', margin: '24px 0'}}>
  <div style={{border: '1px solid var(--ifm-color-emphasis-300)', borderTop: '3px solid var(--ifm-color-primary)', borderRadius: '8px', padding: '20px', background: 'var(--ifm-background-surface-color)'}}>
    ...
    <ul style={{paddingLeft: '20px', margin: 0, fontSize: '0.9rem'}}>
      ...
      <li><a href="/ko/es/products/managed-postgres/migrations/clickhouse-cloud">완전 관리형 데이터 마이그레이션</a></li>
  ...
  <div style={{border: '1px solid var(--ifm-color-emphasis-300)', borderTop: '3px solid var(--ifm-color-primary)', borderRadius: '8px', padding: '20px', background: 'var(--ifm-background-surface-color)'}}>
    ...
    <ul style={{paddingLeft: '20px', margin: 0, fontSize: '0.9rem'}}>
      ...
      <li><a href="/ko/es/products/managed-postgres/migrations/clickhouse-cloud">컨설팅 기반 마이그레이션 가이드</a></li>
