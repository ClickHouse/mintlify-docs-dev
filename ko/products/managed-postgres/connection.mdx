...
<Image img="/images/managed-postgres/connect-button.png" alt="연결 정보를 보려면 왼쪽 사이드바에서 Connect를 클릭하십시오" size="md" border />

**Connect**를 클릭하면 여러 포맷의 연결 자격 증명과 연결 문자열을 표시하는 모달이 열립니다.

<Image img="/images/managed-postgres/connect-modal.png" alt="자격 증명과 연결 문자열 포맷을 보여주는 연결 모달" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="설정 탭에서 CA 인증서 다운로드" size="md" border />
