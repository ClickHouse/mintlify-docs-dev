...
Managed Postgres에는 PostGIS, pgvector, pg&#95;cron 등 널리 사용되는 PostgreSQL 확장 기능을 포함해 100개 이상의 PostgreSQL 확장 기능이 제공됩니다. 사용 가능한 확장 기능의 전체 목록과 설치 방법은 [확장 기능](/ko/products/managed-postgres/extensions) 문서를 참조하십시오.
