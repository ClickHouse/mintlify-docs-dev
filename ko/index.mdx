  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        ...
        <HeroCard title="데이터 웨어하우징" description="인사이트와 앱을 위해 데이터를 즉시 분석하고 탐색합니다. 무거운 워크로드를 오프로드해 더 빠르게 확장할 수 있습니다." href="/ko/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="에이전트형 분석" description="AI 에이전트가 실시간 데이터를 직접 쿼리해 즉각적이고 대화형 인사이트와 시각화를 제공하도록 합니다" href="/ko/get-started/use-cases/agentic-analytics" showArrow />
      </div>
