  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-center gap-3 mx-auto mt-8">
        <button type="button" id="home-search-entry" className="flex pointer-events-auto items-center text-sm leading-6 h-9 pl-3.5 pr-3 text-gray-500 dark:text-white/50 dark:brightness-[1.1] dark:hover:brightness-[1.25] justify-between truncate gap-2 min-w-[43px] w-[320px] bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 shadow-none border border-white/10 ring-0 dark:ring-0 rounded" aria-label="검색 열기">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "설치", href: "/get-started/setup/cloud" },
        { label: "빠른 시작", href: "/get-started/quickstarts/home" },
        { label: "ClickHouse 개념", href: "/concepts/core-concepts/index" },
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "데이터 모델링", href: "/guides/clickhouse/data-modelling/schema-design" },
        { label: "성능 최적화", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/products/cloud/guides" },
        { label: "사용 사례", href: "/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "SQL 참고", href: "/reference/statements" },
        { label: "설정", href: "/reference/settings/index" },
        { label: "함수", href: "/reference/functions/regular-functions/overview" },
        { label: "엔진", href: "/reference/engines/engines" },
        { label: "시스템 테이블", href: "/reference/system-tables" },
        { label: "포맷", href: "/reference/formats/index" },
        { label: "데이터 타입", href: "/reference/data-types/index" }
    ]}
        />

        <HeroCard
          title="솔루션"
          description="ClickHouse 솔루션을 살펴보고 싶습니다"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        ...
        <HeroCard title="관측성" description="ClickHouse로 구동되는 오픈 소스 관측성 스택인 ClickStack을 사용해 대규모 로그, 메트릭, 트레이스를 저장하고 쿼리할 수 있습니다." href="/ko/clickstack/overview" showArrow />

        <HeroCard title="데이터 웨어하우징" description="인사이트 도출과 앱 구축을 위해 데이터를 즉시 분석하고 탐색합니다. 무거운 워크로드를 오프로드해 더 빠르게 확장할 수 있습니다." href="/ko/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="에이전트형 분석" description="AI 에이전트가 실시간 데이터를 직접 쿼리하여 즉각적인 대화형 인사이트와 시각화를 제공하도록 합니다" href="/ko/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        {/* 1행: ClickHouse Cloud (col-span-2) + 세로로 쌓인 카드 3개 (col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              href="/ko/products/cloud/getting-started/cloud-get-started"
          ...
          <div className="flex flex-col gap-4">
            <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="ClickHouse로 구동되는 올인원 관측성 스택으로, 로그, 메트릭, 트레이스, 세션 리플레이, 오류에 대해 매우 빠른 쿼리와 강력한 집계를 제공합니다." href="/ko/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="ClickHouse와 네이티브로 통합된 빠르고 확장 가능하며 엔터프라이즈급 Postgres 서비스입니다. 트랜잭션에는 Postgres를, 분석에는 ClickHouse를 손쉽게 함께 사용할 수 있습니다." href="/ko/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-integration.svg" logoInvert title="Integrations" description="자주 사용하는 도구와 서비스를 ClickHouse에 연결할 수 있는 100개 이상의 통합을 제공합니다." href="/ko/integrations/home" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="관측성, 메트릭, 평가, 프롬프트 관리를 위한 오픈 소스 LLM 엔지니어링 플랫폼입니다." href="https://langfuse.com/docs" showArrow external />
          ...
          <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="빠르고 안정적이며 확장 가능한 인프로세스 데이터베이스입니다. 인프로세스 환경에서 ClickHouse의 강력함을 경험해 보세요." href="/ko/products/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">코딩 에이전트에 ClickHouse 스킬 추가</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">에이전트에 ClickHouse 전문 지식과 모범 사례를 제공하려면 ClickHouse 스킬을 설치하세요.</p>
