...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        title="시작하기"
        description="처음 방문했습니다. 시작하고 더 알아보고 싶습니다"
        icon={
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="Integrations" description="자주 사용하는 도구와 서비스를 ClickHouse에 연결할 수 있는 100개 이상의 통합을 제공합니다." href="/ko/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
