...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Bindplane을 통해 ClickStack으로 들어오는 텔레메트리 신호" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Bindplane을 통해 ClickStack으로 들어오는 텔레메트리 신호" size="lg" />
  </Step>
</Steps>
