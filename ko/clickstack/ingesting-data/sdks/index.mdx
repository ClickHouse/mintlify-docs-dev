...
OpenTelemetry를 지원하는 대부분의 [language SDKs](/ko/clickstack/ingesting-data/sdks) 및 텔레메트리 라이브러리에서는 애플리케이션에서 `OTEL_EXPORTER_OTLP_ENDPOINT` 환경 변수를 설정하거나 SDK를 초기화할 때 이를 지정하면 됩니다:
