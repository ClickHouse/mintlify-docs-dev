    ...
    **이 환경 변수들은 커넥터가 포함된 모든 Docker 배포판에서 사용할 수 있습니다.**
    ...
    <Info>
      **운영 환경용 사용자**
      ...
      운영 환경에서는 [적절한 자격 증명을 갖춘 사용자](/ko/clickstack/ingesting-data/collector#creating-an-ingestion-user)를 사용해야 합니다.
    </Info>
    ...
    OpenTelemetry collector는 환경 변수 `OPAMP_SERVER_URL`, `CLICKHOUSE_ENDPOINT`, `CLICKHOUSE_USERNAME`, `CLICKHOUSE_PASSWORD`를 통해 ClickHouse 인스턴스를 사용하도록 구성할 수 있습니다. 이 변수들을 설정하는 방법은 배포 방식에 따라 다릅니다.
...
<Image img="/images/use-cases/observability/clickstack-with-gateways.png" alt="gateway를 사용한 스케일링" size="lg" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="Kafka 추가" size="lg" />
