...
<Tabs>
  <Tab title="Managed ClickStack">
    <Image img="/images/use-cases/observability/clickstack-managed-architecture-with-flow.png" alt="흐름이 포함된 관리형 아키텍처" size="md" />
  </Tab>

  <Tab title="Open Source ClickStack">
    <Image img="/images/use-cases/observability/clickstack-oss-architecture-with-flow.png" alt="흐름이 포함된 단순 아키텍처" size="md" />
  </Tab>
</Tabs>
