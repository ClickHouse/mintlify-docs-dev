  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Vector용 ClickStack 실행" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="CLickStack의 Nginx 로그" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="오픈 소스 ClickStack">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="ClickStack 로그인" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="데이터 소스 생성 - vector" size="lg" />
  ...
  <Tab title="오픈소스 ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="실행 UI ClickStack" size="lg" />
