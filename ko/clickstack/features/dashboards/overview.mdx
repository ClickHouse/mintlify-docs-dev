...
<Steps>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-2.png" alt="단순 시각화" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-3.png" alt="단순 시각화 2" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-duplicate-series.png" alt="차트 시리즈 행의 Duplicate series 복사 아이콘과 해당 툴팁" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-1.png" alt="대시보드 생성" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * 별칭: `Average Time`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-2.png" alt="대시보드 시각화 생성" size="lg" />

    시각화가 대시보드 전체 너비를 차지하도록 크기를 조정합니다.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-3.png" alt="시각화가 있는 대시보드" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * 별칭: `Count of events`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-4.png" alt="대시보드 시각화 2" size="lg" />

    시각화 크기를 조정해 대시보드 전체 너비를 차지하도록 합니다.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-5.png" alt="시각 자료가 있는 대시보드 2" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Count**: `count()`
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-editor.png" alt="스팬 지속 시간 기본값이 미리 채워지고 ServiceName payment 필터와 Display Settings 버튼이 표시된 히트맵 타일 편집기" size="lg" />

    저장된 타일은 대시보드에 히트맵으로 표시됩니다. 셀 위에 마우스를 올리면 버킷 경계와 이벤트 수를 확인할 수 있습니다.

    <Image img="/images/clickstack/dashboards/heatmap-tile-rendered.png" alt="24시간 동안 payment 서비스의 스팬 지속 시간 분포를 보여 주는 히트맵 대시보드 타일" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-drilldown.png" alt="View in Event Deltas 작업이 표시되는 히트맵 셀 클릭" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-filter.png" alt="필터링이 적용된 대시보드" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-save.png" alt="대시보드 저장" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-edit.png" alt="대시보드 편집" size="lg" />
...
<Image img="/images/clickstack/dashboards/number-tile-background-chart.png" alt="Number 타일의 Display Settings 드로어에서 Background chart가 Area로 설정된 상태" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-search.png" alt="대시보드 검색" size="lg" />
...
<Image img="/images/clickstack/dashboards/filter-dropdown.png" alt="사용 가능한 서비스 이름을 보여주는 서비스 드롭다운 필터" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/edit-filters.png" alt="대시보드 도구 모음의 Edit Filters 버튼" size="lg" />
  </Step>
  ...
  <Step>
    ...
    **Add new filter**를 클릭합니다. **Name**을 입력하고, **Data source**를 선택하고, **Filter expression**(드롭다운을 채울 고유값을 가져오는 SQL 컬럼 또는 표현식)을 입력해 필터를 구성합니다. 그런 다음 **Save filter**를 클릭합니다.
    ...
    <Image img="/images/clickstack/dashboards/add-filter.png" alt="Name, Data source, Filter expression 필드가 있는 필터 추가 대화상자" size="md" />

    Filters 모달에는 대시보드에 구성된 모든 필터가 표시됩니다. 여기에서 기존 필터를 편집하거나 삭제하고, 추가 필터를 더 만들 수 있습니다.

    <Image img="/images/clickstack/dashboards/saved-filters.png" alt="구성된 Services 필터를 보여주는 Filters 모달" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/filtered-dashboard.png" alt="frontend 서비스로 필터링된 대시보드" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/save-filter-values.png" alt="Save Query and Filters as Default 옵션을 보여주는 대시보드 메뉴" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/drilldown.png" alt="모든 이벤트 보기 및 그룹으로 필터링 옵션이 표시된 드릴다운 컨텍스트 메뉴" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-clickhouse.png" alt="ClickHouse 대시보드" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-services.png" alt="ClickHouse 서비스" size="lg" />
