...
<Tabs>
  <Tab title="Managed ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="관리형 아키텍처" size="lg" />
  ...
  <Tab title="오픈 소스 ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="아키텍처" size="lg" />
