...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="HyperDX Kubernetes 데이터" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="Kubernetes용 ClickHouse" size="lg" />