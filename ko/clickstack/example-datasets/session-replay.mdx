...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="세션 리플레이 데모 앱" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="세션 리플레이 검색" />

    지속 시간과 이벤트 수가 표시된 세션이 목록에 나타나야 합니다. ▶️ 버튼을 클릭해 재생하십시오.

    <Image img="/images/clickstack/session-replay/session-replay.png" alt="세션 리플레이" />
