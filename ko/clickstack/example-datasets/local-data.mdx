...
<Tabs>
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="HyperDX 로컬 로그" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="시간 경과에 따른 메모리" size="lg" />

        값은 부동소수점 `%`로 반환됩니다. 더 명확하게 표시하려면 `Set number format`을 선택합니다.

        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="숫자 형식" size="lg" />

        다음 메뉴에서 `Output format` 드롭다운에서 `Percentage`를 선택한 후 `Apply`를 클릭합니다.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="시간에 따른 메모리 %" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="시간에 따른 메모리" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="시간 대비 메모리 비율" size="lg" />
  </Tab>
</Tabs>