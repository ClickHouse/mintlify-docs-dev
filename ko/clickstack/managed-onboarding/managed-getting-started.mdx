...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-first-time.png" size="lg" alt="ClickStack 실행" border />
    ...
    <Image img="/images/use-cases/observability/clickstack-start-ingestion.png" size="lg" alt="ClickStack 수집 시작" border />

    ClickStack이 테이블과 텔레메트리 데이터를 자동으로 감지하므로 계속 진행할 수 있습니다. 데이터 탐색을 시작하려면 **탐색 시작**을 선택합니다.

    <Image img="/images/use-cases/observability/clickstack-start-exploring.png" size="lg" alt="ClickStack 탐색 시작" border />
