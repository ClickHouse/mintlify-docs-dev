...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Traces 보기" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### 대시보드 구성 <TrackedLink href={'/ko/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">다운로드</TrackedLink>
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="예시 대시보드" />
  </Step>
</Steps>
