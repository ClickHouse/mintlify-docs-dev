...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="로그 Search view" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="로그 view" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="로그 대시보드" />
