...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="소스 추가" />

    2. **Add source**를 클릭하고 다음 설정을 구성합니다. 모든 필드에 액세스하려면 **Configure Optional Fields**를 클릭합니다:

    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="선택 필드 구성" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="소스 저장" />
  ...
  <Step>
    ...
    * `http.status_code`, `client.country`, `cache.status`, `bot.score`와 같은 검색 가능한 속성
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="검색 보기" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="로그 보기" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="검색 뷰" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="로그 뷰" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="대시보드 가져오기" />

    2. `cloudflare-logs-dashboard.json` 업로드 → **Finish Import**

    <Image img="/images/clickstack/cloudflare/finish-import.png" alt="대시보드 가져오기" />
  </Step>

  <Step>
    #### 대시보드 보기

    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="예시 대시보드" />
