...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Temporal 메트릭" size="md" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ko/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">다운로드</TrackedLink>하여 대시보드 구성 파일 받기
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="가져오기 완료 대화상자" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Temporal 메트릭 대시보드" />
  </Step>
</Steps>
