...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Kafka 메트릭 대시보드" />
...
* 관측성 데이터를 통합할 수 있는 [다른 ClickStack 통합](/ko/clickstack/integration-examples)도 살펴보세요
