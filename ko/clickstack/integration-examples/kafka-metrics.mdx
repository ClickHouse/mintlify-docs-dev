...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="가져오기 완료 대화상자" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="Kafka 메트릭 대시보드" />
