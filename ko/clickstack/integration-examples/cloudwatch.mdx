...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="로그 검색 보기" />
    ...
    * `Body`: 실제 로그 메시지 내용
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="오류 로그 컬럼 값" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="데모 검색 보기" />
...
<Steps>
  <Step>
    #### 대시보드 구성 파일 <TrackedLink href={'/ko/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">다운로드</TrackedLink>
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="가져오기 완료 대화상자" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="CloudWatch Logs 대시보드" />
