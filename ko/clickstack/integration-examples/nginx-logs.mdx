...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="로그 보기" />

    <Image img="/images/clickstack/log-view.png" alt="로그 보기" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="예시 대시보드" />
  </Step>
</Steps>
