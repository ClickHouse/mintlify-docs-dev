...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="로그 검색 view" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="로그 view" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    * 오류율
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="예시 대시보드" />
