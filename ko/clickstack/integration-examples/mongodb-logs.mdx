...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB 로그 검색 화면" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="MongoDB 로그 상세 화면" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB 로그 검색 보기" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="MongoDB 로그 상세 보기" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="MongoDB 로그 대시보드 가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="MongoDB 로그 대시보드" />
  </Step>
</Steps>
