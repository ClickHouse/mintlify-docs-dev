...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="트레이스 검색 보기" />

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="개별 트레이스 보기" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ko/examples/nodejs-traces-dashboard.json'} download="nodejs-traces-dashboard.json" eventName="docs.node_traces_monitoring.dashboard_download">다운로드</TrackedLink> 대시보드 구성
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="대시보드 가져오기" />

    3. `nodejs-traces-dashboard.json` 파일을 업로드하고 **Finish Import**를 클릭합니다

    <Image img="/images/clickstack/nodejs/finish-import.png" alt="가져오기 완료" />
  </Step>

  <Step>
    #### 모든 시각화가 미리 구성된 상태로 대시보드가 생성됩니다

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="예시 대시보드" />
