...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="검색 뷰" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="로그 뷰" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="검색 보기" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="로그 보기" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Kafka 로그 대시보드 가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Kafka 로그 예시 대시보드" />
  </Step>
</Steps>
