...
<Steps>
  <Step>
    #### <TrackedLink href={'/ko/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.host_logs_monitoring.dashboard_download">다운로드</TrackedLink> 대시보드 구성
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="로그 대시보드" />
