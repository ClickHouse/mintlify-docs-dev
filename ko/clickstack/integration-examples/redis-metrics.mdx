...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="가져오기 완료 대화상자" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Redis Metrics 대시보드" />
