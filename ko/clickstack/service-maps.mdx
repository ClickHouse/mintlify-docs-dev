...
<Image img="/images/clickstack/service-maps/service-map-overview.png" alt="서비스 노드와 그 사이의 요청 흐름을 보여주는 서비스 맵" size="lg" />
...
<Image img="/images/clickstack/service-maps/source-selector.png" alt="서비스 맵 도구 모음에서 강조 표시된 소스 셀렉터" size="lg" />

**샘플링 슬라이더** — 성능과 정확성의 균형을 맞출 수 있도록 샘플링 비율을 조정합니다. 비율이 낮을수록 대용량 클러스터에서 더 빠르게 로드됩니다.

<Image img="/images/clickstack/service-maps/sampling.png" alt="서비스 맵 도구 모음에서 강조 표시된 샘플링 슬라이더" size="lg" />

**날짜 범위 선택기** — 맵을 생성하는 데 사용하는 트레이스 데이터의 시간 범위를 설정합니다.

<Image img="/images/clickstack/service-maps/date-selector.png" alt="서비스 맵 도구 모음에서 강조 표시된 날짜 범위 선택기" size="lg" />
