...
<Image img="/images/use-cases/observability/clickhouse-execution.png" alt="ClickHouse 실행" size="lg" />
...
<Image img="/images/use-cases/observability/elasticsearch-execution.png" alt="Elasticsearch 실행" size="lg" />
...
* **쿼리 페더레이션**: [외부 딕셔너리](/ko/concepts/features/dictionaries)와 [테이블 함수](/ko/reference/functions/table-functions)을 사용해 레이크하우스 테이블, 기존 데이터베이스, ClickHouse 테이블을 포함한 여러 소스의 데이터를 연관시킬 수 있습니다.
