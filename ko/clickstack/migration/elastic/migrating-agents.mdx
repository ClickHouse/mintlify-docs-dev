...
<Image img="/images/use-cases/observability/clickstack-migrating-agents.png" alt="에이전트 마이그레이션" size="lg" background />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="수집용 키" size="lg" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/add-logstash-output.png" alt="Logstash 출력 추가" size="md" />
    ...
    <Image img="/images/use-cases/observability/agent-output-settings.png" alt="Agent 설정" size="md" />
...
<Image img="/images/use-cases/observability/ingestion-keys.png" alt="수집 키" size="lg" />
