...
<Image img="/images/use-cases/observability/hyperdx-notebook-hero.png" alt="Visa 캐시 포화 장애를 조사하는 AI Notebook" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-ai-consent.png" alt="Team Settings의 Generative AI 토글" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-list.png" alt="노트북 목록 페이지" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-tiles.png" alt="AI가 생성한 타일이 있는 노트북" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branch-modal.png" alt="새 브랜치 생성 대화 상자" size="md" />

타일에 브랜치가 여러 개 생기면, 타일 헤더에 왼쪽 및 오른쪽 화살표 버튼이 표시되며 브랜치 수를 나타내는 배지(예: **1/2**)도 함께 표시됩니다. 화살표를 클릭하여 브랜치 간에 전환합니다.

<Image img="/images/use-cases/observability/hyperdx-notebook-branching.png" alt="타일의 브랜치 탐색 화살표와 1/2 배지" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-manual-tiles.png" alt="노트북 하단의 수동 타일 버튼" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-agent-context.png" alt="사용자 지정 컨텍스트를 위한 Agent Settings 패널" size="lg" />