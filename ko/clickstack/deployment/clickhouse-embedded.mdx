  ...
  <Tab title="Docker">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="인증" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="소스 생성" size="lg" />
