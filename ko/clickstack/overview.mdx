...
<Image img="/images/use-cases/observability/hyperdx-landing.png" alt="랜딩 페이지" size="lg" />
...
시작하려면 [시작하기 가이드](/ko/clickstack/getting-started)를 먼저 확인한 다음 [샘플 데이터셋](/ko/clickstack/example-datasets)을 로드하십시오. [배포 옵션](/ko/clickstack/deployment/overview)과 [프로덕션 모범 사례](/ko/clickstack/managing/production)에 대한 문서도 살펴볼 수 있습니다.
...
<Tabs>
  <Tab title="Managed ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-managed-architecture.png" alt="Managed ClickStack 아키텍처" size="md" />
  ...
  <Tab title="Open Source ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-oss-architecture.png" alt="OSS 단순 아키텍처" size="md" />
