...
<Image img="/images/starter_guides/joins/imdb_schema.png" alt="IMDB 스키마" />
...
<Image img="/images/starter_guides/joins/outer_join.png" alt="외부 조인" />
...
<Image img="/images/starter_guides/joins/cross_join.png" alt="크로스 조인" />
...
<Image img="/images/starter_guides/joins/anti_join.png" alt="안티 조인" />
...
다음 예시는 [values](https://github.com/ClickHouse/ClickHouse/blob/23.2/src/TableFunctions/TableFunctionValues.h) [테이블 함수](/ko/reference/functions/table-functions)로 생성한 두 개의 임시 테이블(`left_table` 및 `right_table`)을 사용해 `LEFT ANY JOIN`을 추상적인 예로 보여줍니다:
