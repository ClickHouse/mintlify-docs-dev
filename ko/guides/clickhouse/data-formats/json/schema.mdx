...
description: 'JSON 스키마를 효율적으로 설계하는 방법'
keywords: ['json', 'ClickHouse', '삽입', '로딩', '포맷', '스키마', '정형', '반정형']
score: 20
doc_type: 'guide'
---
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="JSON 경로별 컬럼" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="JSON 오프셋" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="공유 JSON 컬럼" />
