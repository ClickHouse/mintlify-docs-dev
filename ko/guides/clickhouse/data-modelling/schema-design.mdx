...
<Image img="/images/data-modeling/stackoverflow-schema.png" size="lg" alt="Stack Overflow 스키마" />
...
<Image img="/images/data-modeling/schema-design-indices.png" size="md" alt="ClickHouse의 희소 인덱싱" />
...
* [**Dictionaries**](/ko/concepts/features/dictionaries) - Direct JOIN 및 키-값 조회를 처리하기 위한 ClickHouse 고유 기능입니다.
