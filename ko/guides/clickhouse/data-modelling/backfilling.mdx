...
과거 데이터는 객체 스토리지에서 백필할 것을 권장합니다. 가능하면 최적의 읽기 성능과 압축(네트워크 전송량 감소)을 위해 데이터를 Parquet로 내보내야 합니다. 일반적으로 파일 크기는 약 150MB가 적절하지만, ClickHouse는 [70개 이상의 파일 포맷](/ko/reference/formats)을 지원하며 크기에 관계없이 파일을 처리할 수 있습니다.
...
<Image img="/images/data-modeling/null_table_mv.png" size="md" alt="ClickHouse의 비정규화" />
