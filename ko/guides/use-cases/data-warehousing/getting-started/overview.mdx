...
<div id="data-lake-getting-started">
  # 데이터 레이크 시작하기
</div>
...
<Info>
  **핵심 요약**
  ...
  데이터 레이크 테이블을 쿼리하고, MergeTree로 성능을 높인 뒤, 결과를 Iceberg에 다시 쓰는 과정을 직접 따라 해보는 안내서입니다. 모든 단계는 공개 데이터셋을 사용하며 Cloud와 OSS 모두에서 사용할 수 있습니다.
</Info>

이 가이드의 스크린샷은 [ClickHouse Cloud](https://console.clickhouse.cloud) SQL 콘솔에서 캡처했습니다. 모든 쿼리는 Cloud와 자가 관리형 배포 환경 모두에서 작동합니다.
...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Iceberg 쿼리" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Iceberg 쿼리" />
  ...
  <Step>
    ...
    각 카탈로그 유형에는 각각의 연결 설정이 필요합니다. 지원되는 카탈로그의 전체 목록과 해당 구성 옵션은 [Catalogs 가이드](/ko/guides/use-cases/data-warehousing/reference)에서 확인하십시오.
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Iceberg 쿼리" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="ClickHouse 쿼리" />
...
* [직접 쿼리하기](/ko/guides/use-cases/data-warehousing/getting-started/querying-directly) — 4가지 포맷 모두, 클러스터 변형, 테이블 엔진, 캐싱
* [카탈로그 연결](/ko/guides/use-cases/data-warehousing/getting-started/connecting-catalogs) — Delta 및 Iceberg를 포함한 Unity Catalog 전체 안내
* [분석 가속화](/ko/guides/use-cases/data-warehousing/getting-started/accelerating-analytics) — 스키마 최적화, 인덱싱, 약 40배 속도 향상 데모
* [데이터 레이크에 쓰기](/ko/guides/use-cases/data-warehousing/getting-started/writing-data) — 원시 데이터 쓰기, 집계 데이터 쓰기, 타입 매핑
* [지원 매트릭스](/ko/guides/use-cases/data-warehousing/support-matrix) — 포맷과 스토리지 백엔드 전반의 기능 비교