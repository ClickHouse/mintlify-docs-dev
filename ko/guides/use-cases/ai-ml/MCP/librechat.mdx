...
title: 'LibreChat 및 ClickHouse Cloud용 ClickHouse MCP 서버 설정'
...
> 이 가이드에서는 Docker를 사용해 LibreChat과 ClickHouse MCP 서버를 설정하고,
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="MCP 서버 선택" size="md" />
