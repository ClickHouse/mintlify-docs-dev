...
<div id="using-grafana-and-clickhouse-for-observability">
  # Grafana와 ClickHouse를 사용한 관측성
</div>

Grafana는 ClickHouse의 관측성 데이터를 시각화하는 데 권장되는 도구입니다. 이는 Grafana용 공식 ClickHouse 플러그인을 통해 구현됩니다. 설치 지침은 [여기](/ko/integrations/connectors/data-visualization/grafana)에서 확인할 수 있습니다.
...
<Image img="/images/use-cases/observability/observability-15.png" alt="커넥터 구성" size="sm" />
...
<Image img="/images/use-cases/observability/observability-16.png" alt="커넥터 로그 구성" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-17.png" alt="로그에서 트레이스로" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-19.png" alt="트레이스 세부 정보" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-20.png" alt="트레이스에서 로그로" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-21.png" alt="대시보드" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-22.png" alt="시계열" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-23.png" alt="여러 선이 있는 차트" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-24.png" alt="Geo 데이터 시각화" size="lg" border />