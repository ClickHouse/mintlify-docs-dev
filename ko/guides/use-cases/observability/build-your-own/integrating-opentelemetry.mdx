...
description: '관측성을 위한 OpenTelemetry 및 ClickHouse 통합'
...
<Image img="/images/use-cases/observability/observability-3.png" alt="로그 수집" size="md" />
...
<Image img="/images/use-cases/observability/observability-4.png" alt="otlp를 통한 로그 수집" size="md" />
...
<Image img="/images/use-cases/observability/observability-5.png" alt="파일 로그 수신기" size="md" />
...
<Image img="/images/use-cases/observability/observability-7.png" alt="에이전트 전용" size="md" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="게이트웨이를 사용한 스케일링" size="md" />
...
<Image img="/images/use-cases/observability/observability-9.png" alt="Kafka 추가" size="md" />
