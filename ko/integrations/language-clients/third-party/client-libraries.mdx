---
description: '다양한 프로그래밍 언어에서 사용할 수 있는 서드파티 클라이언트 라이브러리 개요'
sidebarTitle: '클라이언트 라이브러리'
slug: /interfaces/third-party/client-libraries
title: '서드파티 개발자가 제공하는 클라이언트 라이브러리'
doc_type: 'reference'
---

<Note>
  ClickHouse Inc는 아래 나열된 라이브러리를 유지 관리하지 않으며, 품질 보장을 위한 광범위한 테스트도 수행하지 않았습니다.
</Note>
...
* [kolya7k ClickHouse PHP 확장 기능](https://github.com//kolya7k/clickhouse-php)
...
* [userver 프레임워크용 ClickHouse 드라이버](https://userver.tech/dd/ddb/clickhouse_driver.html)
