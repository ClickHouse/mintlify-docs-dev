...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="short-trips 데이터셋의 이동 거리 분포를 10개 bin으로 나타낸 히스토그램" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="이동 거리 분포를 보여주는 히스토그램으로, 50개의 구간과 격자가 표시되어 있으며 제목은 'Trip distance from trips < 6.3'" border />