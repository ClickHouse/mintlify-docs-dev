...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="ClickHouse에 연결" />
...
marimo 편집기 왼쪽의 데이터 소스 패널로 이동한 다음 &quot;Add database&quot;를 클릭하세요.

<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="새 데이터베이스 추가" />

데이터베이스 정보를 입력하라는 메시지가 표시됩니다.

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="데이터베이스 정보 입력" />

그러면 연결을 설정할 수 있는 셀이 생성됩니다.

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="ClickHouse에 연결하려면 셀 실행" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="SQL 엔진 선택" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="데이터프레임 결과" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="드롭다운, 테이블, 차트 조합" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="App View 실행" />