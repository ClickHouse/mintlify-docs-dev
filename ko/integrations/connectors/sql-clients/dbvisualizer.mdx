...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="ClickHouse JDBC 드라이버 구성을 보여주는 DbVisualizer Driver Manager 인터페이스" />
