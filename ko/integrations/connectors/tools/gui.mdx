...
[CHouse UI](https://chouse-ui.com)는 **팀 협업**과 **안전한 데이터 액세스**를 위해 특별히 설계된 오픈소스 ClickHouse 웹 인터페이스입니다. 직접 데이터베이스 자격 증명이 필요한 기존 클라이언트와 달리, CHouse UI는 강력한 **역할 기반 접근 제어(RBAC)** 계층을 구현하여 관리자가 내부 시크릿을 노출하지 않고도 세분화된 권한을 부여할 수 있게 합니다.
...
[Yandex DataLens](https://cloud.yandex.ru/services/datalens)은 데이터 시각화 및 분석 서비스입니다.
...
DataLens는 낮은 부하의 프로젝트에서는 상업적 용도를 포함해 [무료로 사용 가능](https://cloud.yandex.com/docs/datalens/pricing)합니다.
