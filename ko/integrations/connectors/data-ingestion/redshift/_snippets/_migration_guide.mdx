...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="PUSH Redshift에서 ClickHouse로" />
...
* 데이터 변환 시나리오를 지원합니다(예를 들어, [dbt 통합 가이드](/ko/integrations/connectors/data-ingestion/etl-tools/dbt)를 참조하십시오).
...
<Image img="/images/integrations/data-ingestion/redshift/pull.png" size="md" alt="Redshift에서 ClickHouse로 가져오기" />
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="S3를 사용한 Redshift 데이터 피벗" />
