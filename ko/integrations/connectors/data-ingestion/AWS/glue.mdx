...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Glue 노트북 연결 구성" force="true" />
  ...
  <Tab title="수동 설치">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Glue 노트북 JAR 경로 옵션" force="true" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Python">
    ...
    # ClickHouse에 DataFrame 쓰기
    df.writeTo("clickhouse.default.example_table").append()

    # ClickHouse에서 DataFrame 읽기
...
자세한 내용은 [Spark 문서](/ko/integrations/connectors/data-ingestion/apache-spark/index)를 확인하십시오.