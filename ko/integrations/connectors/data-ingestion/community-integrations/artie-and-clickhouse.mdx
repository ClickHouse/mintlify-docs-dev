...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Artie 가입 페이지" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Artie 파이프라인 편집 인터페이스" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="분석 포털" />

파이프라인 및 테이블별 모니터링

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="기본 제공 모니터링" />

일일 스키마 변경 알림

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="스키마 변경 알림" />