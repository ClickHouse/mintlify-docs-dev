...
| [Apache Spark](/ko/integrations/connectors/data-ingestion/apache-spark)                         | 단일 노드 머신 또는 클러스터에서 데이터 엔지니어링, 데이터 과학, 머신 러닝을 실행하기 위한 멀티 언어 엔진입니다.                                                                 |
...
| [Azure Data Factory](/ko/integrations/connectors/data-ingestion/azure/azure-data-factory)       | 대규모 데이터 워크플로를 생성, 예약, 오케스트레이션할 수 있는 클라우드 기반 데이터 통합 서비스입니다.                                                                        |
...
| [dbt](/ko/integrations/connectors/data-ingestion/etl-tools/dbt)                                 | 분석 엔지니어가 select 문만 작성해 warehouse에서 데이터를 변환할 수 있도록 지원합니다.                                                                          |
...
| [Fivetran](/ko/integrations/connectors/data-ingestion/etl-tools/fivetran)                       | 클라우드 데이터 플랫폼 전반에서 데이터를 외부로, 내부로, 그리고 플랫폼 간에 이동시키는 자동화된 데이터 이동 플랫폼입니다.                                                             |
