...
* **자가 관리형:** Confluent 패키지를 다운로드하여 로컬에 설치합니다. 커넥터 설치는 [여기](https://docs.confluent.io/kafka-connect-http/current/overview.html)에 문서화된 설치 지침을 따르십시오.
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="HTTP Sink 커넥터를 생성하는 방법을 보여주는 Confluent Cloud 인터페이스" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="HTTP Sink 커넥터의 인증 설정을 보여주는 Confluent Cloud 인터페이스" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="HTTP Sink 커넥터의 고급 구성 옵션을 보여주는 Confluent Cloud 인터페이스" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Kafka 토픽에서 테스트 메시지를 생성하는 방법을 보여주는 Confluent Cloud 인터페이스" border />
...
Kafka에 메시지를 전송합니다. 아래에서는 [kcat](https://github.com/edenhill/kcat)을 사용해 메시지 1만 개를 전송합니다.
