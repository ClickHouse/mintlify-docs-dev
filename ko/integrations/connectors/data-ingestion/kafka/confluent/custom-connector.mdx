...
'Connector type' - Sink
'Sensitive properties' - 'password'. 이렇게 하면 구성 중에 ClickHouse 비밀번호 항목이 마스킹됩니다.
```

예시:

<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="사용자 지정 ClickHouse Connector 추가 설정 화면이 표시된 Confluent Platform UI" border />
