...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="실행 중인 Pub/Sub-ClickHouse 작업을 보여주는 Dataflow 콘솔" />

템플릿은 또한 `PubSubToClickHouse` 네임스페이스 아래에 다음과 같은 사용자 지정 메트릭을 내보내며, Dataflow 작업 페이지에서 확인할 수 있습니다:
