...
<Tabs>
  <Tab title="Google Cloud Console">
    ...
    1. `CREATE JOB FROM TEMPLATE` 버튼을 클릭합니다.
       <Image img="/images/integrations/data-ingestion/google-dataflow/create_job_from_template_button.png" border alt="DataFlow 콘솔" />
    2. Template 양식이 열리면 작업 이름을 입력하고 원하는 리전을 선택합니다.
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_initial_form.png" border alt="DataFlow Template 초기 양식" />
    3. `DataFlow Template` 입력란에 `ClickHouse` 또는 `BigQuery`를 입력한 다음 `BigQuery to ClickHouse` Template를 선택합니다.
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_clickhouse_search.png" border alt="BigQuery to ClickHouse Template 선택" />
    ...
    <Image img="/images/integrations/data-ingestion/google-dataflow/extended_template_form.png" border alt="BigQuery to ClickHouse 확장 Template 양식" />
...
<Image img="/images/integrations/data-ingestion/google-dataflow/dataflow-inqueue-job.png" size="lg" border alt="실행 중인 BigQuery-ClickHouse 작업을 보여주는 Dataflow 콘솔" />
