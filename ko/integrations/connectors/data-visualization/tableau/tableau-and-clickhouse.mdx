...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="ClickHouse by ClickHouse 옵션이 강조 표시된 커넥터 선택 메뉴가 보이는 Tableau 연결 화면" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="ClickHouse JDBC 커넥터 세부 정보와 설치 버튼이 표시된 Tableau 커넥터 설치 대화 상자" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="서버, 포트, 데이터베이스, 사용자 이름 및 비밀번호 필드가 표시된 Tableau의 ClickHouse 연결 대화 상자" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="데이터베이스 선택 옵션이 표시된 초기 연결 화면을 보여주는 새 Tableau 워크북" border />

<br />

8. **Schema** 드롭다운에서 **TPCD**를 선택하면 **TPCD**의 테이블 목록이 표시됩니다:

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="CUSTOMER, LINEITEM, NATION, ORDERS 등 TPCD 데이터베이스 테이블이 표시된 Tableau 스키마 선택 화면" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="컬럼 헤더는 표시되지만 데이터는 없는 상태로 CUSTOMER 테이블이 캔버스에 추가된 Tableau 워크북" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="Custkey 필드를 사용해 CUSTOMER 테이블과 ORDERS 테이블 간 연결을 보여주는 Tableau 관계 편집기" border />

<br />

4. 이제 **ORDERS** 테이블과 **LINEITEM** 테이블이 데이터 소스에서 서로 연결되었으므로, 이 관계를 사용해 데이터에 관한 질문에 답할 수 있습니다. 워크북 하단의 **Sheet 1** 탭을 선택하십시오.

<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="분석에 사용할 수 있는 ClickHouse 테이블의 dimensions와 measures를 보여주는 Tableau 워크시트" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="ClickHouse 데이터를 기준으로 연도별 주문 수량을 보여주는 Tableau 선 차트" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="열에는 분기, 행에는 배송 방식이 표시된 Tableau 크로스탭 보기" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="분기 및 배송 방식별 총 주문 금액 합계를 보여주는 Tableau 크로스탭" border />

<br />

8. **SUM**을 클릭하고 **Measure**를 **Average**로 변경하십시오. 같은 드롭다운 메뉴에서 **Format**을 선택한 다음 **Numbers**를 **Currency (Standard)**로 변경하십시오:

<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="통화 포맷이 적용된 상태로 분기 및 배송 방식별 평균 주문 금액을 보여주는 Tableau 크로스탭" border />
