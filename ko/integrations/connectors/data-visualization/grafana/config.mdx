...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="보안 네이티브 구성 예시" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="추가 HTTP 구성 옵션" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="추가 설정 예시" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="로그 구성" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="트레이스 구성" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="예시 별칭 테이블 구성" border />

이제 Grafana는 `DESC example_table`의 결과 대신 alias table의 결과를 확인합니다:

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="예시 별칭 테이블 선택" border />
