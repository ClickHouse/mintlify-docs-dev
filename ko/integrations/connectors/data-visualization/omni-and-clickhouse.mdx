...
<Image size="lg" img="/images/integrations/data-visualization/omni_01.png" alt="Connections 섹션에서 Add Connection 버튼을 보여주는 Omni 관리자 인터페이스" border />

<br />

`ClickHouse`를 선택하세요. 양식에 자격 증명을 입력하세요.

<Image size="lg" img="/images/integrations/data-visualization/omni_02.png" alt="자격 증명 입력 필드를 보여주는 ClickHouse용 Omni 연결 구성 인터페이스" border />
