...
<Image size="md" img="/images/integrations/data-visualization/looker_01.png" alt="Looker의 데이터베이스 관리 인터페이스에서 새 연결을 추가하는 모습" border />

<br />

데이터 소스 이름을 지정하고, 방언 드롭다운에서 `ClickHouse`를 선택합니다. 그런 다음 양식에 자격 증명을 입력합니다.

<Image size="md" img="/images/integrations/data-visualization/looker_02.png" alt="Looker 연결 양식에 ClickHouse 자격 증명을 입력하는 모습" border />

<br />

ClickHouse Cloud를 사용 중이거나 배포에 SSL이 필요한 경우, 추가 설정에서 SSL이 활성화되어 있는지 확인합니다.

<Image size="md" img="/images/integrations/data-visualization/looker_03.png" alt="Looker 설정에서 ClickHouse 연결에 SSL을 활성화하는 모습" border />

<br />

먼저 연결을 테스트한 후, 완료되면 새 ClickHouse 데이터 소스에 연결합니다.

<Image size="md" img="/images/integrations/data-visualization/looker_04.png" alt="ClickHouse 데이터 소스를 테스트하고 연결하는 모습" border />
