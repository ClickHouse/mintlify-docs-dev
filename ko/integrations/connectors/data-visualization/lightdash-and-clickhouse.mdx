...
description: 'Lightdash는 dbt 기반의 최신 오픈 소스 BI 도구로, 팀이 시맨틱 레이어를 통해 ClickHouse 데이터를 탐색하고 시각화할 수 있도록 지원합니다. dbt 기반의 빠르고 체계적으로 관리되는 분석을 위해 Lightdash를 ClickHouse에 연결하는 방법을 알아보십시오.'
title: 'Lightdash를 ClickHouse에 연결'
doc_type: 'guide'
integration:
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Lightdash 대시보드 예시" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="lightdash-clickhouse 프로젝트용 profiles.yml 구성 예시" border />

    <br />
  </Step>

  <Step>
    ### ClickHouse에 연결된 Lightdash 프로젝트 생성하기
  ...
  <Step>
    ### Lightdash에서 ClickHouse 데이터를 탐색하세요
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt=".yml 파일에 메트릭을 정의한 예시" border />
  ...
  <Step>
    ...
    **Explore** 페이지는 5개의 주요 영역으로 구성됩니다.
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="차원, 필터, 차트, 결과, SQL이 표시된 Lightdash Explore 화면" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Lightdash 대시보드 내에서 차트 만들기 및 정리하기" border />
  ...
  <Step>
    ### Ask AI: dbt 기반 셀프서비스 분석

    Lightdash의 **AI Agents**를 사용하면 데이터를 진정한 셀프서비스 방식으로 탐색할 수 있습니다.
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="dbt 메트릭 기반 자연어 쿼리를 보여주는 Lightdash Ask AI 인터페이스" border />
