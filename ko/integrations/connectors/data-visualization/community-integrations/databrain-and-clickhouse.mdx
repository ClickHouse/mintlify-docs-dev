...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="ClickHouse 데이터 시각화를 보여주는 Databrain 대시보드 인터페이스" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Databrain 데이터 소스 메뉴" border />

3. **Add a Data Source** 또는 **데이터 소스 연결**을 클릭합니다.

4. 사용 가능한 커넥터 목록에서 **ClickHouse**를 선택합니다.

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="ClickHouse 옵션이 표시된 Databrain 커넥터 선택 화면" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="구성 필드가 있는 Databrain ClickHouse 연결 양식" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="ClickHouse 테이블이 표시된 Databrain 데이터 탐색기" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="여러 ClickHouse 시각화가 있는 Databrain 대시보드" border />
