...
description: 'Fabi.ai는 올인원 협업형 데이터 분석 플랫폼입니다. SQL, Python, AI 및 노코드로 대시보드와 데이터 워크플로를 그 어느 때보다 빠르게 구축할 수 있습니다'
...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="Fabi.ai 데이터 탐색 및 워크플로 플랫폼" border />
...
1. 계정을 처음 만들면 데이터베이스를 연결하라는 안내가 표시됩니다. 이미 계정이 있다면 Smartbook 왼쪽의 데이터 소스 패널을 클릭한 다음 Add Data Source를 선택하세요.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="데이터 소스 추가" border />

2. 그러면 연결 정보를 입력하라는 안내가 표시됩니다.

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="ClickHouse 자격 증명 양식" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="ClickHouse 쿼리" border />
