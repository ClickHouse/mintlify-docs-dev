...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Dot에서 ClickHouse 연결 구성(라이트 모드)" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="ClickHouse 연결" size="sm" />
