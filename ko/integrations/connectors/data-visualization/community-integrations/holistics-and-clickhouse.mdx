...
description: 'Holistics는 셀프 서비스 BI와 임베디드 애널리틱스를 위한 AI 기반 플랫폼으로, 누구나 거버넌스가 적용되어 쉽게 활용할 수 있는 메트릭을 바탕으로 더 나은 의사결정을 내릴 수 있도록 지원합니다.'
...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="ClickHouse Cloud 콘솔에서 Connect 버튼 위치" border />
  </Step>
  ...
  <Step>
    ...
    1. **직접 연결(권장):** 방화벽 또는 ClickHouse Cloud IP 액세스 목록에 Holistics&#39; IP 주소를 허용 목록에 추가하십시오. IP 목록은 [IP Whitelisting guide](https://docs.holistics.io/docs/connect/ip-whitelisting)에서 확인할 수 있습니다.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="ClickHouse Cloud에서 IP 허용 목록 추가 예시" border />
  ...
  <Step>
    ...
    1. Holistics에서 **Settings → Data Sources**로 이동하십시오.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="Holistics 설정에서 Data Sources로 이동" border />

    2. **New Data Source**를 클릭하고 **ClickHouse**를 선택하십시오.

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="새 데이터 소스 목록에서 ClickHouse 선택" border />
    ...
    3. 1단계에서 수집한 정보로 양식을 작성하십시오.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="Holistics에서 ClickHouse 연결 정보 입력" border />

    4. **Test Connection**을 클릭하십시오.

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Holistics에서 ClickHouse 연결 테스트 성공" border />
