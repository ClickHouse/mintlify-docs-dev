...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="ClickHouse 통합 타일" border />

2. ClickHouse 인스턴스의 연결 정보를 입력합니다.

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="ClickHouse 세부 정보 대화 상자" border />
...
1. 먼저 노트북 오른쪽에 있는 ClickHouse 통합에 연결하세요.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.png" alt="ClickHouse 세부 정보 대화상자" border />
