...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="NYC 택시 데이터 시각화를 보여주는 Splunk 대시보드" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Java Home 구성을 보여주는 Splunk DB Connect 설정 페이지" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="ClickHouse 드라이버가 성공적으로 설치된 것으로 표시된 Splunk DB Connect 드라이버 페이지" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Splunk DB Connect 새 연결 버튼" />

<br />

ClickHouse 호스트 정보를 추가하고 &quot;Enable SSL&quot;이 선택되어 있는지 확인합니다:

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="ClickHouse용 Splunk 연결 구성 페이지" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="ClickHouse 연결 정보를 선택하는 Splunk SQL Explorer" />

테이블의 전체 레코드 수를 반환하는 `trips` 테이블에 대해 SQL 쿼리를 실행합니다:

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="trips 테이블의 레코드 수를 보여주는 Splunk SQL 쿼리 실행 화면" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="상위 10개 승차 지역을 보여주는 Splunk 컬럼 차트 시각화" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="승객 수별 평균 요금을 보여주는 Splunk 막대 차트" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="NYC 택시 데이터에 대한 여러 시각화를 보여주는 최종 Splunk 대시보드" />
