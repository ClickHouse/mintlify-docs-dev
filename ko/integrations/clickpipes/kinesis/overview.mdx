...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="데이터 소스 유형 선택" size="lg" border />

4. ClickPipe 이름, 설명(선택 사항), IAM 역할 또는 자격 증명, 기타 연결 정보를 입력하여 양식을 작성합니다.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.png" alt="연결 정보 입력" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.png" alt="데이터 포맷 및 topic 설정" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="테이블, 스키마 및 설정" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="기존 테이블 사용" size="lg" border />
