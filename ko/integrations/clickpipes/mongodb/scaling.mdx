...
**스케일을 늘리면 ClickPipes 컴퓨트 비용도 그에 비례해 증가합니다.** 초기 적재만을 위해 스케일 업하는 경우, 예기치 않은 청구를 피하려면 스냅샷이 완료된 후 반드시 스케일 다운해야 합니다. 가격에 대한 자세한 내용은 [ClickPipes 요금](/ko/products/cloud/reference/billing/clickpipes)을 참조하십시오.
