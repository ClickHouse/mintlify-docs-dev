...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="ClickPipes 서비스" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="데이터 소스 선택" size="lg" border />

4. `Reverse private endpoint` 옵션을 선택합니다.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Reverse private endpoint 선택" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Reverse private endpoint 선택" size="lg" border />

6. 선택한 endpoint 유형에 필요한 매개변수를 입력합니다.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Reverse private endpoint 선택" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Reverse private endpoint 선택" size="lg" border />
...
1. 사이드바에서 `Settings` 버튼을 찾아 클릭합니다.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="ClickHouse Cloud 설정" size="lg" border />

2. `ClickPipe reverse private endpoints` 섹션에서 `Reverse private endpoints`를 클릭합니다.

   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="ClickHouse Cloud 설정" size="md" border />
