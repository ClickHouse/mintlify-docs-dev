...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="MySQL 선택" size="lg" border />

<div id="add-your-source-mysql-database-connection">
  ### 소스 MySQL 데이터베이스 연결 추가
</div>

4. 사전 준비 단계에서 구성한 소스 MySQL 데이터베이스의 연결 정보를 입력합니다.
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="연결 정보 입력" size="lg" border />
...
5. 여기에서 ClickPipe의 대상 데이터베이스를 선택할 수 있습니다. 기존 데이터베이스를 선택하거나 새 데이터베이스를 만들 수 있습니다.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="대상 데이터베이스 선택" size="lg" border />
