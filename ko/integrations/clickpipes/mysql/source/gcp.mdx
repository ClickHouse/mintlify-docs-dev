...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Cloud SQL에서 PITR 활성화" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="GCP MySQL의 Edit 버튼" size="lg" border />

그런 다음 `Flags` 섹션까지 스크롤한 뒤 위 플래그를 추가하십시오.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="GCP에서 바이너리 로그 플래그 설정" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="GCP MySQL에서 IP 허용 목록 설정" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="GCP MySQL 인증서 다운로드" size="lg" border />

5. ClickPipes UI에서 새 MySQL ClickPipe를 만들 때 다운로드한 인증서를 업로드합니다.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="GCP MySQL 인증서 사용" size="lg" border />