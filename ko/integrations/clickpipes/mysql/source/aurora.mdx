...
이제 Amazon Aurora MySQL 인스턴스에서 binlog 복제가 설정되고 ClickHouse Cloud와의 보안 연결도 구성되었으므로, [첫 번째 MySQL ClickPipe를 생성할 수 있습니다](/ko/integrations/clickpipes/mysql/index#create-your-clickpipe). MySQL CDC에 관한 일반적인 질문은 [MySQL FAQ 페이지](/ko/integrations/clickpipes/mysql/faq)를 참조하십시오.