...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="GCS ClickPipes용 HMAC 자격 증명" size="lg" border />

HMAC 키가 포함된 서비스 계정을 생성하려면 [이 가이드](/ko/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret)를 따르십시오.
