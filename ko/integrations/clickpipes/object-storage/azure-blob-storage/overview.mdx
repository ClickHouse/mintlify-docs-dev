...
| `Object storage polling interval`    | 30s           | ClickHouse 클러스터에 데이터를 삽입하기 전까지의 최대 대기 주기를 설정합니다.                                                                         |
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="ClickPipes 고급 설정" size="lg" border />
