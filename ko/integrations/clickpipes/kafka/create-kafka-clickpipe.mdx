---
sidebarTitle: '첫 번째 Kafka ClickPipe 만들기'
description: '첫 번째 Kafka ClickPipe를 만드는 단계별 가이드입니다.'
slug: /integrations/clickpipes/kafka/create-your-first-kafka-clickpipe
title: '첫 번째 Kafka ClickPipe 만들기'
doc_type: 'guide'
...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="가져오기 선택" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="데이터 소스 유형 선택" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="연결 정보 입력" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="SSH 터널 구성" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="토픽 선택" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="테이블, 스키마 및 설정 지정" size="md" />

    제공된 컨트롤을 사용해 고급 설정도 사용자 지정할 수 있습니다.

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="고급 설정 지정" size="md" />
  </Step>
  ...
  <Step>
    ...
    * `Only destination table`: 대상 테이블에 대한 `INSERT` 권한만 부여합니다.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="권한" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="개요 보기" size="md" />
  </Step>
</Steps>