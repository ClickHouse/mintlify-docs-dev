...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="RDS에서 파라미터 그룹을 찾는 위치" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="새 파라미터 그룹을 사용하도록 RDS Postgres 수정" size="lg" border />

3. 변경 사항을 적용하려면 RDS 인스턴스를 재부팅합니다

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="RDS Postgres 재부팅" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="RDS Postgres에서 보안 그룹을 어디서 찾을 수 있습니까?" size="lg" border />
