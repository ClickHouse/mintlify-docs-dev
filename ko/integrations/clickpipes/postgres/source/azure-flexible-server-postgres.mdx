...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Azure Flexible Server for Postgres의 Server parameters" size="lg" border />

2. `wal_level`을 `logical`로 변경합니다.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Azure Flexible Server for Postgres에서 wal_level을 logical로 변경" size="lg" border />

3. 이 변경 사항을 적용하려면 서버를 다시 시작해야 합니다. 다시 시작하라는 메시지가 표시되면 서버를 다시 시작하십시오.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="wal_level 변경 후 서버 다시 시작" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Azure Flexible Server for Postgres의 방화벽에 ClickPipes IP 추가" size="lg" />
