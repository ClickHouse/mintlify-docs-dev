...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="PlanetScale 콘솔에서 wal_level 조정" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="PlanetScale 콘솔에서 max_slot_wal_keep_size 조정" size="md" border />
