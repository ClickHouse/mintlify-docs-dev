...
description: 'Postgres를 ClickHouse Cloud에 손쉽게 연결합니다.'
...
3. `Postgres CDC` 타일을 선택합니다.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/postgres/postgres-tile.png" alt="Postgres 선택" size="lg" border />
