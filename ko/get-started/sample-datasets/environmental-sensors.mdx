...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="일별 이벤트 수" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="무덥고 습한 날" />