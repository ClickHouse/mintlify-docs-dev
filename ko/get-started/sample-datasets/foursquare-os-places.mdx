...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="유럽 내 관심 지점의 밀도 지도" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="일본의 사케 바" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="ATM" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="국가별로 분류된 관심 지점이 표시된 유럽 지도" />