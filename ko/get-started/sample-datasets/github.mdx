...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="추가 및 삭제된 라인의 경우" size="md" />

**커밋 및 작성자의 경우:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="커밋 및 작성자의 경우" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Superset 작성자 매트릭스" size="md" />

Alexey는 다른 사람의 코드를 제거하는 경향이 뚜렷합니다. 코드 제거 양상을 더 균형 있게 보기 위해 Alexey는 제외하겠습니다.

<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Superset 작성자 매트릭스 v2" size="md" />
