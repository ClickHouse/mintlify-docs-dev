...
<Image img="/images/use-cases/rta-considerations.png" alt="실시간 분석: 수집, 변환, 쿼리까지 걸리는 시간" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="ClickHouse가 실시간 분석을 지원하는 방식" />
  </div>
