...
<Image img="/images/migrations/bigquery-2.png" size="md" alt="ClickHouse와 BigQuery 비교" />
...
<Image img="/images/migrations/bigquery-3.png" size="lg" alt="스키마" />
...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="대량 적재" />
...
[여기](/ko/get-started/migrate/bigquery)에 설명했듯이, BigQuery와 마찬가지로 ClickHouse는 테이블의 프라이머리 키(primary key) 컬럼 값에 고유성을 강제하지 않습니다.
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="ClickHouse 프라이머리 키" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="파티션" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="PROJECTION" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="BigQuery 쿼리 재작성하기" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="집계 함수 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="집계 함수 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="조건식과 배열" />
