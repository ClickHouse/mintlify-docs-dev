...
<Image img="/images/integrations/data-ingestion/dbms/postgres-replicas.png" size="md" alt="최종 일관성" />
...
| `JSON`               | [String](/ko/reference/data-types/string), [Variant](/ko/reference/data-types/variant), [Nested](/ko/reference/data-types/nested-data-structures#nestedname1-type1-name2-type2-), [Tuple](/ko/reference/data-types/tuple) |
