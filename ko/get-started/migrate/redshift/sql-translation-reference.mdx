...
| [`GEOGRAPHY`](https://docs.aws.amazon.com/redshift/latest/dg/geospatial-overview.html)                                               | [Geo 데이터 타입](/ko/reference/data-types/geo) (아직 덜 발전되어 있으며, 예를 들어 좌표계는 없지만 [함수로](/ko/reference/functions/regular-functions/geo) 에뮬레이션할 수 있음)                                                                                  |
...
| [`SUPER`](https://docs.aws.amazon.com/redshift/latest/dg/r_SUPER_type.html)                                                          | [`Tuple`](/ko/reference/data-types/tuple), [`Nested`](/ko/reference/data-types/nested-data-structures), [`배열`](/ko/reference/data-types/array), [`JSON`](/ko/reference/data-types/newjson), [`맵`](/ko/reference/data-types/map)       |
