...
<div id="snowflake-to-clickhouse-migration">
  # Snowflake에서 ClickHouse로의 마이그레이션
</div>
...
<Image img="/images/cloud/onboard/discover/use_cases/snowflake_architecture.png" size="md" alt="Snowflake 아키텍처" />
...
<Image img="/images/cloud/onboard/discover/use_cases/cloud_architecture.png" size="md" alt="ClickHouse Cloud 아키텍처" />
