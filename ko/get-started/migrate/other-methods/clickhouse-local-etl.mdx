...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="자가 관리형 ClickHouse 마이그레이션" />
...
단, 현재 사용 중인 데이터베이스 시스템에 대해 ClickHouse에서 제공하는 [integration 엔진](/ko/reference/engines/table-engines#integration-engines) 또는 [테이블 함수](/ko/reference/functions/table-functions)를 사용할 수 있거나,
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="자가 관리형 ClickHouse 마이그레이션" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="자가 관리형 ClickHouse 마이그레이션" />
