...
<Steps>
  <Step>
    ...
    * 방금 생성한 사용자 이름과 비밀번호로 로그인합니다
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="요금제 선택" border />

    <br />

    로그인하면 ClickHouse Cloud에서 새 ClickHouse 서비스 생성을 안내하는 온보딩 마법사가 시작됩니다. 서비스를 배포할 리전(Region)을 선택하고 새 서비스의 이름을 지정합니다:

    <Image img="/images/_snippets/createservice1.png" size="md" alt="새 ClickHouse 서비스" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="스케일링 한도" border />
  ...
  <Step>
    ...
    * 애플리케이션에서 연결
    ...
    <Image img="/images/_snippets/createservice8.png" size="md" alt="SQL 콘솔" border />
    ...
    <Image img="/images/_snippets/show_databases.png" size="md" alt="SQL 콘솔" border />
    ...
    <Image img="/images/_snippets/service_connect.png" size="md" alt="서비스 연결" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="데이터 소스" border />
    ...
    * 파일 URL을 통해 데이터 업로드
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="데이터 소스 선택" border />
    ...
    * ClickHouse에서 기본 키(primary key)는 테이블의 각 행에 대해 ***고유하지 않습니다***
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="clickhouse client 접속 정보" border />
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="CSV 파일에서 가져온 새 행" />
