...
<Note>
  구문, 사용 가능한 절, 옵션에 대한 자세한 내용은 [SQL 참고](/ko/reference/statements/select)를 참조하십시오.
</Note>
...
`FORMAT` 절을 추가해 [ClickHouse가 지원하는 다양한 출력 형식 중 하나](/ko/reference/formats#formats-overview)를 지정합니다:
