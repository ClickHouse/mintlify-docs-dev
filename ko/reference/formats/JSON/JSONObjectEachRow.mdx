...
[`Nested`](/ko/reference/data-types/nested-data-structures) 데이터 타입 컬럼이 있는 테이블에서는 동일한 구조의 JSON 데이터를 삽입할 수 있습니다. 이 기능은 [input&#95;format&#95;import&#95;nested&#95;json](/ko/reference/settings/formats#input_format_import_nested_json) 설정을 활성화하면 사용할 수 있습니다.
