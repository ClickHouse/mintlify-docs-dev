...
지정된 필터링 표현식과 일치하는 데이터를 수정합니다. [뮤테이션](/ko/reference/statements/alter#mutations)으로 구현됩니다.
...
* [ALTER 쿼리의 동기 여부](/ko/reference/statements/alter#synchronicity-of-alter-queries)
