...
지정한 필터링 표현식과 일치하는 지정된 파티션의 데이터를 수정합니다. [뮤테이션](/ko/reference/statements/alter#mutations)으로 구현됩니다.
...
지정한 필터링 표현식과 일치하는 데이터를 지정한 파티션에서 삭제합니다. [뮤테이션](/ko/reference/statements/alter#mutations)으로 구현됩니다.
