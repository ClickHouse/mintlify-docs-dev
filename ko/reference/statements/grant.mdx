...
[SELECT](/ko/reference/statements/select) 쿼리를 실행할 수 있습니다.
...
다음 권한 계층에 따라 [ALTER](/ko/reference/statements/alter) 쿼리 실행을 허용합니다:
...
다음 권한 계층에 따라 [CREATE](/ko/reference/statements/create) 및 [ATTACH](/ko/reference/statements/attach) DDL 쿼리의 실행을 허용합니다:
...
외부 데이터 소스를 사용할 수 있도록 허용합니다. [테이블 엔진](/ko/reference/engines/table-engines) 및 [테이블 함수](/ko/reference/functions/table-functions)에 적용됩니다.
...
테이블을 생성할 때 지정된 테이블 엔진을 사용할 수 있도록 허용합니다. [테이블 엔진](/ko/reference/engines/table-engines)에 적용됩니다.
