...
`Join` 엔진에서는 `CREATE TABLE` 문에서 [join&#95;use&#95;nulls](/ko/reference/settings/session-settings#join_use_nulls) 설정을 지정할 수 있습니다. [SELECT](/ko/reference/statements/select) 쿼리에서도 `join_use_nulls` 값이 동일해야 합니다.
