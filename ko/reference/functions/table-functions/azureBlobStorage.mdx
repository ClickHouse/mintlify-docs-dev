...
[Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs)의 파일을 조회하거나 삽입할 수 있는 테이블형 인터페이스를 제공합니다. 이 테이블 함수는 [s3 함수](/ko/reference/functions/table-functions/s3)와 유사합니다.
