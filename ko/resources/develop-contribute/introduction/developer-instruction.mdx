...
함수에 대한 간략한 설명을 여기에 작성하십시오. 함수의 기능과 일반적인 사용 사례를 간략히 설명해야 합니다.
...
- `arg1` — 인수 설명. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg2` — 인수 설명. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg3` — 선택적 인수 설명 (선택 사항). [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}

**구현 세부 사항**

해당하는 경우 구현 세부 사항을 설명하십시오.

**반환 값**

- {함수가 반환하는 값을 여기에 작성하십시오}를 반환합니다. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
