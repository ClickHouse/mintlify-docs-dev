...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="macOS 개발자 확인 오류 대화상자" border />
...
2. **Privacy &amp; Security**로 이동하십시오.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="MacOS Privacy & Security 설정 기본 보기" border />
...
4. **Allow Anyway**를 클릭하십시오.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="Allow Anyway 버튼이 표시된 MacOS Privacy & Security 설정" border />
