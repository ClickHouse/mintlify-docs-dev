...
ClickHouse가 파일 확장자로 포맷을 판별할 수 없으면, 출력 데이터의 [출력 형식](/ko/reference/formats)은 기본적으로 [TabSeparated](/ko/reference/formats)로 설정됩니다. [출력 형식](/ko/reference/formats)을 지정하려면 [FORMAT 절](/ko/reference/statements/select/format)을 사용하십시오.
