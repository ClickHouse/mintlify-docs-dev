...
출력 형식은 ClickHouse에서 지원하는 [출력 형식](/ko/reference/formats) 중 아무 것이나 사용할 수 있습니다. 몇 가지 예시를 살펴보겠습니다...
...
<Note>
  여기서 끝낼 필요는 없습니다. `clickhouse-local`을 사용하면 PostgreSQL에서 데이터를 가져와 [모든 출력 포맷](/ko/reference/formats)으로 보낼 수 있습니다.
