...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/profile.png" size="md" alt="시간 순서" />
...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/time-order.png" size="md" alt="시간순" />

<div id="left-heavy">
  #### 왼쪽 편중
</div>

<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/left-heavy.png" size="md" alt="왼쪽 편중" />

<div id="sandwitch">
  #### 샌드위치
</div>

<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/sandwich.png" size="md" alt="샌드위치" />
