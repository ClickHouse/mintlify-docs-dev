...
<Note>
  이 예시는 Microsoft Clarity의 데이터 시나리오에 특화된 예시입니다. 모든 데이터가 ClickHouse에 있거나 데이터를 ClickHouse로 옮기는 데 제약이 없다면, 대신 [Dictionaries](/ko/concepts/features/dictionaries)를 사용해 보십시오.
</Note>
