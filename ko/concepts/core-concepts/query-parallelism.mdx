...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="인덱스 분석" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4개의 병렬 처리 레인" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8개의 병렬 처리 레인" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="분산 레인" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="쿼리 파이프라인" />
