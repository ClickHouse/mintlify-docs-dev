...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="ClickHouse 딕셔너리의 사용 사례" />
...
* [딕셔너리 모범 사례](/ko/concepts/features/dictionaries/best-practices) — 레이아웃 선택, 딕셔너리와 조인 비교, 모니터링
* [딕셔너리를 사용해 쿼리 가속화하기](https://clickhouse.com/blog/faster-queries-dictionaries-clickhouse)
* [딕셔너리용 고급 구성](/ko/reference/statements/create/dictionary)