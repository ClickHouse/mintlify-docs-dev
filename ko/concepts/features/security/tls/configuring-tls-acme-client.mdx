...
sidebarTitle: 'ACME를 통한 TLS 자동 프로비저닝 구성'
title: 'ACME 클라이언트 구성'
...
ACME를 지원하면 ClickHouse는 [Let&#39;s Encrypt](https://letsencrypt.org/)나 [ZeroSSL](https://zerossl.com/) 같은 제공업체에서 인증서를 자동으로 발급받고 갱신할 수 있습니다.
