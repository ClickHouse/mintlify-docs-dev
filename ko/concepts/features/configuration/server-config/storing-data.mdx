...
<Note>
  Google Cloud Storage(GCS)도 `s3` 유형을 사용해 지원됩니다. [GCS backed MergeTree](/ko/integrations/connectors/data-ingestion/GCP)를 참조하십시오.
</Note>
...
[뮤테이션](/ko/reference/statements/alter#mutations)과 테이블 복제는 지원되지 않습니다.
...
[`ALTER TABLE`](/ko/reference/statements/alter), [`RENAME TABLE`](/ko/reference/statements/rename#rename-table),
