...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="스킵 인덱스 구축" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="스킵 인덱스 사용" />
