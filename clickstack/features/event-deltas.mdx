...
<Image img="/images/clickstack/event-deltas/overview.png" alt="Event deltas overview on the payment service with the bright band climbing mid-window and no recovery in frame" size="lg"/>
...
## The heatmap <a id="the-heatmap"></a>
...
## Distribution mode: cardinality outliers <a id="distribution-mode"></a>
...
## Comparison mode: deviations from normal <a id="comparison-mode"></a>
...
### Use case 1: Before vs after a regression <a id="before-vs-after"></a>
...
<Image img="/images/clickstack/event-deltas/before-after.png" alt="Comparison mode on the payment service with the rectangle drawn from the climb inflection to the right edge, bottom resting on the 1 ms baseline" size="lg"/>
...
### Use case 2: Slow versus fast <a id="slow-vs-fast"></a>
...
<Image img="/images/clickstack/event-deltas/slow-vs-fast.png" alt="Slow vs fast comparison on frontend-proxy with the rectangle covering only the cleanly-separated upper band, well clear of the dense bulk" size="lg"/>
...
## Iterative drill-down <a id="drill-down"></a>
...
<Image img="/images/clickstack/event-deltas/drill-down.png" alt="Click popover on a ScopeVersion bar showing Selection vs Background percentages and filter, exclude, copy actions" size="lg"/>
...
## Customize the heatmap <a id="customize"></a>

The gear icon in the top-right of the heatmap opens the **Display Settings** drawer.

<Image img="/images/clickstack/event-deltas/settings-drawer.png" alt="Display Settings drawer with Scale, Value, and Count fields" size="lg"/>
...
## Tips for effective use <a id="tips"></a>
...
### Event Deltas tab isn't visible <a id="tab-not-visible"></a>
...
### Attribute charts show few or no results <a id="few-results"></a>
