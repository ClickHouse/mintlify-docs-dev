...
## Instrumenting your application <a id="instrumentation"></a>
...
## Viewing session replays <a id="viewing-replays"></a>
...
### From session to trace <a id="session-to-trace"></a>
...
### From trace to session <a id="trace-to-session"></a>
...
## How session data is stored <a id="data-storage"></a>
