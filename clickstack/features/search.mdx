...
## Search features <a id="search-features"></a>

### Natural language search syntax <a id="natural-language-syntax"></a>
...
<Image img="/images/use-cases/observability/hyperdx-27.png" alt="Search" size="md"/>

#### Column/property search <a id="column-search"></a>
...
### SQL search syntax <a id="sql-syntax"></a>
...
### Select statement <a id="select-statement"></a>
...
## Saved searches <a id="saved-searches"></a>
...
<Image img="/images/use-cases/observability/clickstack-saved-search-listing.png" alt="Saved Search Listing Page" size="lg" />
...
<Image img="/images/use-cases/observability/clickstack-saved-search.png" alt="Saving a Search" size="md" />

### Adding alerts to saved searches <a id="alerts-on-saved-searches"></a>
