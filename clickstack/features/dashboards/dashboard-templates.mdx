...
## Browsing available templates <a id="browsing-templates"></a>
...
## Importing a template <a id="importing-a-template"></a>
...
## Pre-built templates <a id="pre-built-templates"></a>

### OTel runtime metrics <a id="otel-runtime-metrics"></a>
