...
## Creating visualizations <a id="creating-visualizations"></a>
...
<Steps>
<Step>
### Navigate to Chart Explorer <a id="navigate-chart-explorer"></a>
...
<Step>
### Create visualization <a id="create-visualization"></a>
...
## Creating dashboards <a id="creating-dashboards"></a>
...
<Steps>
<Step>
### Navigate to Dashboards <a id="navigate-dashboards"></a>
...
<Step>
### Create a visualization – average request time by service <a id="create-a-tile"></a>
...
<Step>
### Create a visualization – events over time by service <a id="create-a-tile-2"></a>
...
<Step>
### Add a heatmap tile for span duration <a id="create-a-tile-heatmap"></a>
...
#### Drill down to Event Deltas <a id="heatmap-tile-drilldown"></a>
...
<Step>
### Filter dashboard <a id="filter-dashboards"></a>
...
## Dashboards - editing visualizations <a id="dashboards-editing-visualizations"></a>
...
## Dashboard - Listing and search <a id="dashboard-listing-search"></a>
...
## Dashboards - tagging <a id="tagging"></a>
<Tagging />

## Custom filters <a id="custom-filters"></a>
...
<Steps>
<Step>
### Open the Edit Filters dialog <a id="open-edit-filters"></a>
...
<Step>
### Add a new filter <a id="add-new-filter"></a>
...
<Step>
### Use the filter <a id="use-filter"></a>
...
<Step>
### (Optional) Save filter values as default <a id="save-default-filters"></a>
...
## Drilldown to search <a id="drilldown-to-search"></a>
...
## Presets <a id="presets"></a>

HyperDX is deployed with out-of-the-box dashboards.

### ClickHouse dashboard <a id="clickhouse-dashboard"></a>
...
### Services dashboard <a id="services-dashboard"></a>
...
### Kubernetes dashboard <a id="kubernetes-dashboard"></a>
...
<!-- anchors from _clickstack_tagging.mdx -->
<a id="how-tags-work"></a>
<!-- anchors from _clickstack_tagging.mdx -->
<a id="how-tags-work"></a>