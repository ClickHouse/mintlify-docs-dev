...
## Inspect a service in its own dashboard <a id="inspect-in-dashboard"></a>
...
<Steps>
<Step>
### Build the detail dashboard <a id="detail-dashboard"></a>
...
<Step>
### Build the service inventory <a id="service-inventory"></a>
...
<Image img="/images/clickstack/dashboards/row-click-catalog.png" alt="Service inventory table with RED columns (Requests, Errors, P95 Duration) for each service, ordered by request volume, above a requests-over-time trend" size="lg"/>
...
<Step>
### Wire up the row click <a id="wire-dashboard"></a>
...
<Step>
### Click a row <a id="click-dashboard"></a>
...
<Image img="/images/clickstack/dashboards/row-click-drilldown.png" alt="Service Detail dashboard after a row click, with the Service filter set to the clicked service and the RED key figures, latency percentiles, and per-endpoint breakdown all scoped to it" size="lg"/>
</Step>
</Steps>

## Jump from a service to its traces <a id="jump-to-traces"></a>
...
<Steps>
<Step>
### Point the row click at Search <a id="wire-search"></a>
...
<Step>
### Click a row <a id="click-search"></a>
...
<Image img="/images/clickstack/dashboards/row-click-search-drilldown.png" alt="Search page opened on the traces source after a row click, filtered to the clicked service" size="lg"/>
</Step>
</Steps>
...
## Set up a row-click action <a id="set-up"></a>
...
<Image img="/images/clickstack/dashboards/row-click-drawer.png" alt="Row Click Action drawer in Dashboard mode, with the Service Detail dashboard selected as the target and a ServiceName filter templated from the clicked row" size="lg"/>
...
## How the destination and filters resolve <a id="how-it-resolves"></a>
...
## Validation and limitations <a id="validation"></a>
