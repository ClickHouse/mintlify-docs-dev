...
## Types of alerts <a id="types-of-alerts"></a>
...
### 1. Search alerts <a id="search-alerts"></a>
...
<Steps>
<Step>
#### Open alert creation dialog <a id="open-dialog"></a>
...
<Image img="/images/use-cases/observability/alerts_search_view.png" alt="Alerts search view" size="lg"/>
</Step>
<Step>
#### Create the alert <a id="create-the-alert"></a>
...
<Image img="/images/use-cases/observability/search_alert.png" alt="Search alerts" size="lg"/>
</Step>
</Steps>
...
<Image img="/images/use-cases/observability/multiple_search_alerts.png" alt="Multiple alerts" size="md"/>

### 2. Dashboard chart alerts <a id="dashboard-alerts"></a>
...
<Steps>
<Step>
#### Open the chart edit dialog <a id="open-chart-dialog"></a>

Open the chart's configuration menu and select the alert button. This will show the chart edit dialog.

<Image img="/images/use-cases/observability/edit_chart_alert.png" alt="Edit chart alert" size="lg"/>
</Step>
<Step>
#### Add the alert <a id="add-chart-alert"></a>

Select **Add Alert**.

<Image img="/images/use-cases/observability/add_chart_alert.png" alt="Add alert to chart" size="lg"/>
</Step>
<Step>
#### Define the alert conditions <a id="define-alert-conditions"></a>
...
<Image img="/images/use-cases/observability/create_chart_alert.png" alt="Create alert for chart" size="lg"/>

You can add a new webhook directly from this view. See [Adding a webhook](#add-webhook) for details.
</Step>
</Steps>

## Adding a webhook <a id="add-webhook"></a>
...
<Image img="/images/use-cases/observability/add_new_webhook.png" alt="Add new webhook" size="lg"/>

This opens the webhook creation dialog, where you can create a new webhook:

<Image img="/images/use-cases/observability/add_webhook_dialog.png" alt="Webhook creation" size="md"/>
...
### Service type integrations <a id="integrations"></a>
...
## Managing alerts <a id="managing-alerts"></a>

Alerts can be centrally managed through the alerts panel on the left-hand side of HyperDX.

<Image img="/images/use-cases/observability/manage_alerts.png" alt="Manage alerts" size="lg"/>

From this view, you can see all alerts that have been created and are currently running in ClickStack.

<Image img="/images/use-cases/observability/alerts_view.png" alt="Alerts view" size="lg"/>
...
### Deleting an alert <a id="deleting-alerts"></a>
...
<Image img="/images/use-cases/observability/remove_chart_alert.png" alt="Remove chart alert" size="lg"/>

## SQL-based chart alerts <a id="sql-based-alerts"></a>
...
### Supported chart types <a id="supported-chart-types"></a>
...
### Creating a SQL alert <a id="create-sql-based-alert"></a>

To create an alert on a SQL-based chart:

<Steps>
<Step>
#### Create or open a SQL-based chart on a dashboard <a id="open-sql-chart"></a>
...
<Image img="/images/use-cases/observability/open_sql_chart_mode.png" alt="Create SQL chart" size="lg"/>
</Step>
<Step>
#### Add the alert <a id="add-sql-alert"></a>
...
<Image img="/images/use-cases/observability/add_raw_sql_alert.png" alt="Edit chart alert" size="lg"/>
...
<Step>
#### Save the dashboard <a id="save-sql-dashboard"></a>

Save the dashboard to activate the alert. The alert will begin evaluating on the configured interval.
</Step>
</Steps>

### How query results are interpreted <a id="sql-result-interpretation"></a>
...
### Query parameters and macros <a id="query-params"></a>
...
#### Required and Recommended Parameters <a id="required-alert-parameters"></a>
...
### Example alert queries <a id="example-queries"></a>

#### Error rate per service (time-series) <a id="example-error-rate"></a>
...
#### Anomaly detection with lagging average (time-series) <a id="example-anomaly-detection"></a>
...
## Common alert scenarios <a id="common-alert-scenarios"></a>
