...
While both systems support the aggregation of data, ClickHouse offers significantly [more functions](/core/reference/functions/aggregate-functions/reference-index), including statistical, approximate, and specialized analytical functions.
...
Note that all [aggregate functions](/core/reference/functions/aggregate-functions/reference-index) (over 90 of them), including their combinations with aggregate function [combinators](https://www.youtube.com/watch?v=7ApwD0cfAFI), support [partial aggregation states](/core/reference/data-types/aggregatefunction). 
