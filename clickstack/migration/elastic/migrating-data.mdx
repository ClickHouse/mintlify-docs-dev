...
## Parallel operation strategy <a id="parallel-operation-strategy"></a>
...
### Implementation steps <a id="implementation-steps"></a>

<Steps>
<Step>
#### Configure dual ingestion <a id="configure-dual-ingestion"></a>
...
<Step>
#### Adjust retention periods <a id="adjust-retention-period"></a>
...
<Step>
#### Validate and compare <a id="validate-and-compare"></a>
...
<Step>
#### Gradual transition <a id="graudal-transition"></a>
...
### Long-term retention <a id="long-term-retention"></a>
...
### Migration timeline <a id="migration-timeline"></a>
...
## Migrating settings <a id="migration-settings"></a>
...
### When to shard <a id="when-to-shard"></a>
...
### Retention and TTL <a id="retention-and-ttl"></a>
...
<Steps>
<Step>
### Migrate schema <a id="migrate-scheme"></a>
...
<Step>
### Install `elasticdump` <a id="install-elasticdump"></a>
...
<Step>
### Install ClickHouse client <a id="install-clickhouse-client"></a>
...
<Step>
### Stream data <a id="stream-data"></a>
...
<Step>
### Transform data (optional) <a id="transform-data"></a>
