...
## Search in ClickStack and Elastic <a id="search-in-clickstack-and-elastic"></a>
...
## ClickStack search syntax vs Elasticsearch query string <a id="clickstack-vs-elasticsearch-query-string"></a>
...
## Exists/missing differences <a id="empty-value-differences"></a>
