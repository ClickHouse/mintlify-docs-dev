...
ClickHouse not only supports full SQL but extends it with a range of observability-focused functions, such as [`argMax`](/core/reference/functions/aggregate-functions/argMax), [`histogram`](/core/reference/functions/aggregate-functions/parametric-functions#histogram), and [`quantileTiming`](/core/reference/functions/aggregate-functions/quantileTiming), that simplify querying structured logs, metrics, and traces.
