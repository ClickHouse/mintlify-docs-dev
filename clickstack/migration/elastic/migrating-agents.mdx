...
## Migrating agents from Elastic <a id="migrating-agents-from-elastic"></a>
...
## Preferred migration path <a id="prefered-migration-path"></a>
...
## ClickHouse OpenTelemetry endpoint <a id="clickhouse-otel-endpoint"></a>
...
## Migrating from beats <a id="migrating-to-beats"></a>
...
<Steps>
<Step>
### Install vector <a id="install-vector"></a>
...
<Step>
### Configure vector <a id="configure-vector"></a>
...
<Step>
### Configure Filebeat <a id="configure-filebeat"></a>
...
## Migrating from Elastic Agent <a id="migrating-from-elastic-agent"></a>
...
### Sending data via Vector <a id="sending-data-via-vector"></a>

<Steps>
<Step>
#### Install and configure Vector <a id="install-configure-vector"></a>

Install and configure Vector using the [same steps](#install-vector) as those documented for migrating from Filebeat.
</Step>
<Step>
#### Configure Elastic Agent <a id="configure-elastic-agent"></a>
...
### Run Elastic Agent as OpenTelemetry collector <a id="run-agent-as-otel"></a>
...
## Migrating from the Elastic OpenTelemetry collector <a id="migrating-from-elastic-otel-collector"></a>
