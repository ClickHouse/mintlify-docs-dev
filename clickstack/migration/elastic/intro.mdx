...
- You require a business intelligence (BI) dashboarding platform. ClickStack intentionally has opinionated visual workflows for SREs and developers and isn't designed as a Business Intelligence (BI) tool. For equivalent capabilities, we recommend using [Grafana with the ClickHouse plugin](/integrations/connectors/data-visualization/grafana) or [Superset](/integrations/connectors/data-visualization/superset-and-clickhouse).
