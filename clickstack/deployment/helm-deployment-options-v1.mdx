...
## External ClickHouse <a id="external-clickhouse"></a>
...
### Option 1: Inline configuration (development/testing) <a id="external-clickhouse-inline"></a>
...
### Option 2: External secret (production recommended) <a id="external-clickhouse-secret"></a>

For production deployments where you want to keep credentials separate from your Helm configuration:

#### Create your configuration files <a id="create-configuration"></a>
```bash
...
#### Create the Kubernetes secret <a id="create-kubernetes-secret"></a>
```bash
...
#### Configure Helm to use the secret <a id="configure-helm-secret"></a>
```yaml
...
## External OTEL Collector <a id="external-otel-collector"></a>
...
## Minimal deployment <a id="minimal-deployment"></a>
