...
### Suitable for <a id="suitable-for"></a>
...
## Setup steps <a id="setup-steps"></a>
...
<Steps>
<Step>
### Create a new service <a id="create-a-service"></a>
...
<Step>
### Specify your provider, region and resource <a id="specify-your-region-and-resources"></a>

<ProviderSelection/>
</Step>
<Step>
### Setup ingestion <a id="setup-ingestion-create-new"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-cloud-create-new"></a>
...
<Steps>
<Step>
### Select a service <a id="select-service"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-the-clickstack-ui-existing"></a>
...
<Step>
### Setup ingestion <a id="setup-ingestion-existing-service"></a>
...
### Start a collector <a id="start-a-collector-existing"></a>
...
### Configure existing collectors <a id="configure-existing-collectors-existing"></a>
...
### Start ingestion (optional) <a id="start-ingestion-existing"></a>
...
### Create a database and table <a id="create-database-and-tables"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-existing-service"></a>
...
## Additional tasks <a id="additional-tasks"></a>

### Granting access to Managed ClickStack <a id="configure-access"></a>
...
### Using ClickStack with read-only compute <a id="clickstack-read-only-compute"></a>
...
#### How ClickStack selects compute <a id="how-clickstack-selects-compute"></a>
...
#### Recommended setup <a id="recommended-setup"></a>
...
### Adding more data sources <a id="adding-data-sources"></a>
...
#### Using OpenTelemetry schemas <a id="using-otel-schemas"></a>
...
<!-- anchors from _json_support.mdx -->
<a id="schema-choice-map-vs-json"></a>
<!-- anchors from _json_support.mdx -->
<a id="schema-choice-map-vs-json"></a>