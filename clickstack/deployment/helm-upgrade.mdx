...
## Two-phase installation <a id="two-phase-installation"></a>
...
### Storage class <a id="storage-class"></a>
...
## HyperDX values reorganization <a id="hyperdx-values-reorganization"></a>
...
### Unified ConfigMap and Secret <a id="unified-configmap-and-secret"></a>
...
## MongoDB migration <a id="mongodb-migration"></a>

### Removed values <a id="mongodb-removed-values"></a>
...
### New values <a id="mongodb-new-values"></a>
...
## ClickHouse migration <a id="clickhouse-migration"></a>

### Removed values <a id="clickhouse-removed-values"></a>
...
### New values <a id="clickhouse-new-values"></a>
...
## OTEL Collector migration <a id="otel-collector-migration"></a>

### Removed values <a id="otel-removed-values"></a>
...
### New values <a id="otel-new-values"></a>
...
## Unchanged values <a id="unchanged-values"></a>

The following sections are **not affected** by this migration:

- `global.*` (imageRegistry, imagePullSecrets)

## Fresh install vs. in-place upgrade <a id="fresh-install-vs-in-place-upgrade"></a>
