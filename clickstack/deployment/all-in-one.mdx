...
<Steps>
<Step>
### Deploy with Docker <a id="deploy-with-docker"></a>
...
<Step>
### Navigate to the HyperDX UI <a id="navigate-to-hyperdx-ui"></a>
...
<Step>
### Ingest data <a id="ingest-data"></a>

To ingest data see ["Ingesting data"](/clickstack/ingesting-data/index).
</Step>
</Steps>

## Persisting data and settings <a id="persisting-data-and-settings"></a>
...
## Deploying to production <a id="deploying-to-production"></a>
...
## Customizing ports <a id="customizing-ports-deploy"></a>
...
## Configuring the OpenTelemetry collector <a id="configuring-collector"></a>
