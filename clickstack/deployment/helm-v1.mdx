...
## Deployment steps <a id="deployment-steps"></a>
<br/>
...
<Step>
### Add the ClickStack Helm repository <a id="add-the-clickstack-helm-repository"></a>
...
<Step>
### Installing ClickStack <a id="installing-clickstack"></a>
...
<Step>
### Forward ports <a id="forward-ports"></a>
...
<Step>
### Navigate to the UI <a id="navigate-to-the-ui"></a>
...
<Step>
### Customizing values (optional) <a id="customizing-values"></a>
...
<Step>
### Using secrets (optional) <a id="using-secrets"></a>
...
#### Using pre-configured secrets <a id="using-pre-configured-secrets"></a>
...
#### Creating a custom secret <a id="creating-a-custom-secret"></a>
...
#### Referencing a secret <a id="referencing-a-secret"></a>
...
## Using ClickHouse Cloud <a id="using-clickhouse-cloud"></a>
...
## Production notes <a id="production-notes"></a>
...
## Task configuration <a id="task-configuration"></a>
...
## Upgrading the chart <a id="upgrading-the-chart"></a>
...
## Uninstalling ClickStack <a id="uninstalling-clickstack"></a>
...
### Checking logs <a id="checking-logs"></a>
```shell
kubectl logs -l app.kubernetes.io/name=clickstack
```

### Debugging a failed install <a id="debugging-a-failed-install"></a>
```shell
helm install my-clickstack clickstack/clickstack --debug --dry-run
```

### Verifying deployment <a id="verifying-deployment"></a>
```shell
kubectl get pods -l app.kubernetes.io/name=clickstack
```
...
### v1.x deployment guides <a id="deployment-guides"></a>
...
### v2.x documentation <a id="v2x-documentation"></a>
