...
<Steps>
<Step>
### Deploy with Docker <a id="deploy-hyperdx-with-docker"></a>
...
<Image img="/images/use-cases/observability/hyperdx-2.png" alt="HyperDX Login" size="md"/>
...
## Using Docker Compose <a id="using-docker-compose"></a>
...
## ClickStack OpenTelemetry collector <a id="otel-collector"></a>
