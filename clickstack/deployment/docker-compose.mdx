...
<Steps>
<Step>
### Clone the repo <a id="clone-the-repo"></a>
...
<Step>
### Complete connection details <a id="complete-connection-details"></a>
...
<Image img="/images/use-cases/observability/hyperdx-logs.png" alt="Create logs source" size="md"/>
</Step>
</Steps>

## Modifying compose settings <a id="modifying-settings"></a>
