...
## Values organization <a id="values-organization"></a>
...
### Method 1: Update via Helm upgrade with values file <a id="api-key-values-file"></a>
...
### Method 2: Update via Helm upgrade with --set flag <a id="api-key-set-flag"></a>
```shell
helm upgrade my-clickstack clickstack/clickstack \
  --set hyperdx.secrets.HYPERDX_API_KEY="your-api-key-here"
```

### Restart pods to apply changes <a id="restart-pods"></a>
...
### Default secret values <a id="default-secret-values"></a>
...
### Using an external secret <a id="using-external-secret"></a>
...
### General ingress configuration <a id="general-ingress-configuration"></a>
```yaml
hyperdx:
...
### Enabling TLS (HTTPS) <a id="enabling-tls"></a>
...
### Example ingress configuration <a id="example-ingress-configuration"></a>
...
### Common ingress pitfalls <a id="common-ingress-pitfalls"></a>
...
## OTEL collector ingress <a id="otel-collector-ingress"></a>
...
## OTEL collector configuration <a id="otel-collector-configuration"></a>
...
## MongoDB configuration <a id="mongodb-configuration"></a>
...
## ClickHouse configuration <a id="clickhouse-configuration"></a>
...
## Troubleshooting ingress <a id="troubleshooting-ingress"></a>
...
## Customizing values <a id="customizing-values"></a>
