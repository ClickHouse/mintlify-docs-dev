...
<Step>
## Create the auth secret and ConfigMap <a id="create-secret-and-configmap"></a>
...
<Step>
## Deploy the cluster collector <a id="deploy-cluster-collector"></a>
...
<Step>
## Deploy the node collector <a id="deploy-node-collector"></a>
...
<Step>
## Forward Kubernetes attributes to your apps (recommended) <a id="forward-k8s-attributes"></a>
