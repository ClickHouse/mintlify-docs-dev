...
<Steps>
<Step>
## Gather your credentials <a id="gather-credentials"></a>

<GatherCredentials />
</Step>
<Step>
## Create an ingestion user <a id="create-ingestion-user"></a>

<CreateIngestionUser />
</Step>
<Step>
## Deploy the collector <a id="deploy-collector"></a>
...
<Step>
## Clone and run the application <a id="clone-and-run-the-application"></a>
...
<Step>
## Connect the application to your collector <a id="connect-the-application"></a>
...
<Step>
## Instrument the application <a id="instrument-the-application"></a>
...
### Install the SDKs <a id="install-sdks"></a>
...
### Use the opentelemetry-instrument CLI <a id="use-open-telemetry-cli"></a>
...
### Enable the browser SDK <a id="enable-browser-sdk"></a>
...
<Step>
## Generate traffic <a id="generate-traffic"></a>
...
<Step>
## Launch ClickStack and explore your telemetry <a id="launch-clickstack"></a>
