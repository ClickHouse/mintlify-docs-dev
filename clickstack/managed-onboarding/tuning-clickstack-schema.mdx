...
<Steps>
<Step title="Materialize frequently queried attributes">
...
<Step title="Pre-compute repeated aggregations">
...
<Step title="Choose a primary key for your access pattern">
