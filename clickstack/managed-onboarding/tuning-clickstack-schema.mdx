...
<Steps>
<Step>
## Materialize frequently queried attributes <a id="materialize-attributes"></a>
...
<Step>
## Add skip indexes <a id="add-skip-indexes"></a>
...
<Step>
## Pre-compute repeated aggregations <a id="materialized-views"></a>
...
<Step>
## Choose a primary key for your access pattern <a id="choose-primary-key"></a>
