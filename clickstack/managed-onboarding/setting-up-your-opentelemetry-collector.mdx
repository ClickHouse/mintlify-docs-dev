...
<Step>
## Verify the endpoint <a id="verify-the-endpoint"></a>
...
<Steps>
<Step>
## Gather your credentials <a id="gather-credentials-existing"></a>

<GatherCredentials />
</Step>
<Step>
## Create an ingestion user <a id="create-ingestion-user-existing"></a>

<CreateIngestionUser />
</Step>
<Step>
## Adapt your collector configuration <a id="adapt-collector"></a>
...
<Step>
## Verify the endpoint <a id="verify-the-endpoint-existing"></a>
...
<Step>
## Confirm in the ClickStack UI <a id="confirm-in-ui-existing"></a>
...
## Next steps: send your own data <a id="next-steps"></a>
