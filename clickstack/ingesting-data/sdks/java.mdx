...
### Download OpenTelemetry Java agent <a id="download-opentelemetry-java-agent"></a>
...
### Run the application with OpenTelemetry Java agent <a id="run-the-application-with-otel-java-agent"></a>
