...
## Additional configuration <a id="additional-configuration"></a>
...
### Auto capture React error boundary errors <a id="auto-capture-react-error-boundary-errors"></a>
...
### Send custom actions <a id="send-custom-actions"></a>
...
### Enable network capture dynamically <a id="enable-network-capture-dynamically"></a>
...
### Enable resource timing for CORS requests <a id="enable-resource-timing-for-cors-requests"></a>
