...
### Install OpenTelemetry instrumentation packages <a id="install-opentelemetry"></a>
...
### Native HTTP server example (net/http) <a id="native-http-server-example"></a>
...
### Gin application example <a id="gin-application-example"></a>
