...
### Install via NPM <a id="install-via-npm"></a>
...
### Initialize ClickStack <a id="initialize-clickstack"></a>
...
### Attach user information or metadata (Optional) <a id="attach-user-information-metadata"></a>
...
### Instrument lower versions <a id="instrument-lower-versions"></a>
...
## View navigation <a id="view-navigation"></a>
