...
### Enable instrumentation hook (required for v15 and below) <a id="enable-instrumentation-hook"></a>
...
### Install ClickHouse OpenTelemetry SDK <a id="install-sdk"></a>
...
### Create instrumentation files <a id="create-instrumentation-files"></a>
