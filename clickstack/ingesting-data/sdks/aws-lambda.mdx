...
## Installing the OpenTelemetry Lambda layers <a id="installing-the-otel-lambda-layers"></a>
...
### Adding the language-specific auto-instrumentation layer <a id="adding-language-specific-auto-instrumentation"></a>
...
### Installing the OpenTelemetry collector Lambda layer <a id="installing-the-otel-collector-layer"></a>
...
## Checking the installation <a id="checking-the-installation"></a>
...
## Troubleshooting <a id="troubleshoting"></a>

### Custom instrumentation not sending <a id="custom-instrumentation-not-sending"></a>
...
### Enabling SDK debug logs <a id="enabling-sdk-debug-logs"></a>
...
### Enabling collector debug logs <a id="enabling-collector-debug-logs"></a>
