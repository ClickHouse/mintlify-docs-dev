...
### Install HyperDX OpenTelemetry instrumentation package <a id="install-hyperdx-opentelemetry-instrumentation-package"></a>
...
### Initializing the SDK <a id="initializin-the-sdk"></a>
...
### Setup log collection <a id="setup-log-collection"></a>
...
### Setup error collection <a id="setup-error-collection"></a>
...
## Advanced instrumentation configuration <a id="advanced-instrumentation-configuration"></a>

### Capture console logs <a id="capture-console-logs"></a>
...
### Attach user information or metadata <a id="attach-user-information-or-metadata"></a>
...
### Google Cloud Run <a id="google-cloud-run"></a>
...
### Auto-instrumented libraries <a id="auto-instrumented-libraries"></a>
...
## Alternative installation <a id="alternative-installation"></a>

### Run the Application with ClickStack OpenTelemetry CLI <a id="run-the-application-with-cli"></a>
...
### Enabling exception capturing <a id="enabling-exception-capturing"></a>
...
### Auto-instrumented libraries <a id="auto-instrumented-libraries-2"></a>
