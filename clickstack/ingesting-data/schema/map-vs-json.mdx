...
## Why Map is the recommended default <a id="why-map"></a>
...
## Why not JSON by default <a id="why-not-json"></a>
...
## When you might still consider JSON <a id="when-to-consider-json"></a>
...
## Beta status <a id="beta-status"></a>
...
## Enabling JSON support <a id="enabling-json-support"></a>
...
### Managed ClickStack <a id="managed-clickstack"></a>
...
### Open source ClickStack <a id="oss-clickstack"></a>
...
## Migrating from a Map-based schema to JSON <a id="migrating-from-map-to-json"></a>
...
<Steps>
<Step>
### Stop the OTel collector <a id="stop-the-collector"></a>
</Step>
<Step>
### Rename existing tables and update sources <a id="rename-existing-tables-sources"></a>
...
<Step>
### Deploy the collector <a id="deploy-the-collector"></a>

Deploy the collector with `OTEL_AGENT_FEATURE_GATE_ARG` set.
</Step>
<Step>
### Restart the HyperDX container with JSON schema support <a id="restart-the-hyperdx-container"></a>
...
<Step>
### Create new data sources <a id="create-new-data-sources"></a>

Create new data sources in HyperDX pointing to the JSON tables.
</Step>
</Steps>

### Migrating existing data (optional) <a id="migrating-existing-data"></a>
