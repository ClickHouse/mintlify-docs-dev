...
## Collector roles <a id="collector-roles"></a>
...
## Deploying the collector <a id="configuring-the-collector"></a>
<br/>
<Tabs>
...
### Modifying configuration <a id="modifying-otel-collector-configuration-managed"></a>

#### Configuring Managed ClickStack instance <a id="configuring-managed-clickstack"></a>
...
#### Docker Compose <a id="docker-compose-otel-managed"></a>
...
### Modifying configuration <a id="modifying-otel-collector-configuration"></a>

#### Configuring ClickHouse instance <a id="configuring-clickhouse-instance"></a>
...
#### Docker Compose <a id="docker-compose-otel"></a>
...
## Securing the collector <a id="securing-the-collector"></a>
...
### Creating an ingestion user <a id="creating-an-ingestion-user"></a>
...
### Creating an ingestion user <a id="creating-an-ingestion-user-oss"></a>
...
## Processing - filtering, transforming, and enriching <a id="processing-filtering-transforming-enriching"></a>
...
### Example <a id="example-processing"></a>
...
## Schema choice: Map vs JSON <a id="schema-choice"></a>
...
<!-- anchors from _extending_config.mdx -->
<a id="extending-collector-config"></a>
