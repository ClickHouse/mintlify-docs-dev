...
## Sending data with Vector <a id="sending-data-with-vector"></a>
<br/>
<Tabs>
...
<Steps>
<Step>
### Create a database and table <a id="create-a-database-table"></a>
...
<Step>
### Add ClickHouse sink to vector configuration <a id="add-clickhouse-sink-to-config"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui"></a>
...
<Image img="/images/clickstack/launch-clickstack-vector.png" alt="Launch ClickStack for vector" size="lg"/>
</Step>
<Step>
### Create a datasource <a id="create-a-datasource-managed"></a>
...
<Step>
### Explore the data <a id="explore-the-data-managed"></a>

Navigate to the logs view to explore the data and begin using ClickStack.

<Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Nginx logs in CLickStack" size="lg"/>
</Step>
</Steps>
...
<Steps>
<Step>
### Create a database and table <a id="create-a-database-table-oss"></a>
...
<Image img="/images/clickstack/play-ui-clickstack.png" alt="Play UI ClickStack" size="lg"/>
...
<Step>
### Add ClickHouse sink to vector configuration <a id="add-clickhouse-config-to-sink-oss"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-oss"></a>
...
<Image img="/images/use-cases/observability/hyperdx-login.png" alt="ClickStack login" size="lg"/>
</Step>
<Step>
### Create a datasource <a id="create-a-datasource-oss"></a>

Navigate to Team Settings and add a new data source.

<Image img="/images/clickstack/create-vector-datasource-oss.png" alt="Create datasource - vector" size="lg"/>
...
<Step>
### Explore the data <a id="explore-the-data-oss"></a>
...
## Example dataset with Vector <a id="example-dataset-with-vector"></a>
...
<Steps>
<Step>
### Installing Vector <a id="installing-vector"></a>

<InstallingVector/>
</Step>
<Step>
### Download the sample data <a id="download-the-sample-data"></a>

<VectorSampleData/>
</Step>
<Step>
### Create a database and table <a id="create-database-table-nginx-managed"></a>
...
<Step>
### Copy Vector configuration <a id="copy-vector-configuration"></a>
...
<Step>
### Start Vector <a id="start-vector"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-nginx-managed"></a>
...
<Step>
### Create a datasource <a id="create-a-datasource-nginx-managed"></a>
...
<Step>
### Explore the data <a id="explore-the-data-nginx-managed"></a>

Navigate to the search view for `October 20th, 2025` to explore the data and begin using ClickStack.

<Image img="/images/clickstack/nginx-logs-vector-search.png" alt="HyperDX UI" size="lg"/>
</Step>
</Steps>
...
<Steps>
<Step>
### Installing vector <a id="installing-vector-oss"></a>

<InstallingVector/>
</Step>
<Step>
### Download the sample data <a id="download-the-sample-data-oss"></a>

<VectorSampleData/>
</Step>
<Step>
### Create a database and table <a id="create-a-database-table-nginx-oss"></a>
...
<Step>
### Copy Vector configuration <a id="copy-vector-configuration-nginx-oss"></a>
...
<Step>
### Start Vector <a id="start-vector-oss-nginx"></a>
...
<Step>
### Create a datasource <a id="create-a-datasource-nginx-oss"></a>
...
<Step>
### Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-nginx-oss"></a>
...
<Step>
### Explore the data <a id="explore-the-data-nginx-oss"></a>
