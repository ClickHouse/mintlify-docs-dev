...
## Sending OpenTelemetry data <a id="sending-otel-data"></a>

<Tabs>
<Tab title="Managed ClickStack">

### Installing ClickStack OpenTelemetry collector <a id="installing-otel-collector-managed"></a>
...
### Sending data to the collector <a id="sending-data-to-collector-managed"></a>
...
### Installing ClickStack OpenTelemetry collector <a id="installing-otel-collector"></a>
...
### Sending data to the collector <a id="sending-data-to-collector-oss"></a>
