...
## Configuring the sample rate expression <a id="configuring"></a>
...
<Image img="/images/clickstack/trace-sampling-source-settings.png" alt="Sample Rate Expression field in ClickStack Source Settings" size="lg"/>
