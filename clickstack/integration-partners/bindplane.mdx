...
## What is Bindplane? <a id="what-is-bindplane"></a>
...
## Why Bindplane + ClickStack? <a id="why-bindplane-clickstack"></a>
...
## Integrate ClickStack with Bindplane <a id="integrate-bindplane-clickstack"></a>

<Steps>
<Step>
#### Configure ClickStack as a destination <a id="configure-destination"></a>
...
<Step>
#### Create a configuration <a id="create-configuration"></a>
...
<Step>
#### Add processors (optional) <a id="add-processors"></a>
...
<Step>
#### Deploy collectors and start rollout <a id="deploy-collectors"></a>
...
<Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Telemetry Signals in ClickStack via Bindplane" size="lg"/>
</Step>
<Step>
#### Verify telemetry in ClickStack <a id="verify-telemetry"></a>
...
<Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Telemetry Signals in ClickStack via Bindplane" size="lg"/>
</Step>
</Steps>

## Advanced configuration <a id="advanced-configuration"></a>

### Fan-out routing <a id="fan-out-routing"></a>
...
### Compression and performance <a id="compression"></a>
