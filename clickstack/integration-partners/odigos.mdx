...
{/* vale off */}
## What is Odigos? <a id="what-is-odigos"></a>
{/* vale on */}
...
{/* vale off */}
## Why Odigos + ClickStack? <a id="why-odigos-clickstack"></a>
{/* vale on */}
...
{/* vale off */}
## Integrate ClickStack with Odigos <a id="integrate-odigos-clickstack"></a>
{/* vale on */}

<Steps>
<Step>
#### Deploy Odigos with Helm <a id="deploy-odigos"></a>
...
<Step>
#### Add sources in the Odigos UI <a id="add-sources"></a>
...
<Step>
#### Add ClickStack as a destination in the Odigos UI <a id="add-destination-ui"></a>
...
### HyperDX log normalizer <a id="hyperdx-log-normalizer"></a>
...
### Native ClickHouse destination <a id="native-clickhouse-destination"></a>
...
### Configure destinations with Kubernetes manifests <a id="destination-manifest"></a>
...
{/* vale off */}
### Odigos VM Agent <a id="odigos-vm-agent"></a>
{/* vale on */}
...
{/* vale off */}
### Odigos Central <a id="odigos-central"></a>
{/* vale on */}
