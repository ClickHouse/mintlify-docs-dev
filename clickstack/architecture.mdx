...
<Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="Managed Architecture" size="lg"/>

### ClickHouse Cloud: the engine <a id="clickhouse-cloud"></a>
...
### OpenTelemetry collector: data ingestion <a id="open-telemetry-collector-managed"></a>
...
### ClickStack UI (HyperDX): the interface <a id="hyperdx"></a>
...
<Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="Architecture" size="lg"/>

### ClickHouse: the database engine <a id="clickhouse"></a>
...
### OpenTelemetry collector: data ingestion <a id="open-telemetry-collector"></a>
...
### ClickStack UI (HyperDX): the interface <a id="hyperdx-ui"></a>
...
### MongoDB: application state <a id="mongo"></a>
