...
## API reference documentation <a id="api-docs"></a>
...
<Image img="/images/clickstack/api-key-personal.png" alt="ClickStack API Key"/>
...
## Base URL and request format <a id="base-url"></a>
...
### Example: List dashboards <a id="list-dashboards-managed"></a>
...
### Example: Create an alert <a id="create-alert-managed"></a>
...
### Example: List dashboards <a id="list-dashboards-oss"></a>
...
### Example: Create an alert <a id="create-alert-oss"></a>
...
### Example: Query chart series data <a id="query-series-data"></a>
