...
## Running the demo <a id="running-the-demo"></a>

<Steps>
<Step>
### Clone the repository <a id="clone-repository"></a>
...
<Step>
### Get your API key <a id="get-api-key"></a>
...
<Step>
### Start the demo application <a id="start-demo-app"></a>
...
### Try it yourself <a id="try-it-yourself"></a>
...
### Sessions not appearing in HyperDX <a id="sessions-not-appearing"></a>
...
### 401 Unauthorized errors <a id="401-errors"></a>
