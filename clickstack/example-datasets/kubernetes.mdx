...
## Deployment options <a id="deployment-options"></a>
...
<Steps>
<Step>
### Install cert-manager (Optional) <a id="install-cert-manager"></a>
...
<Step>
### Deploy the OpenTelemetry Demo (Optional) <a id="deploy-otel-demo"></a>
...
<Step>
### Add the ClickStack Helm chart repository <a id="add-helm-clickstack"></a>
...
<Step>
### Deploy ClickStack <a id="deploy-clickstack"></a>
...
<Step>
### Access the HyperDX UI <a id="access-the-hyperdx-ui"></a>
...
<Step>
### Retrieve ingestion API key <a id="retrieve-ingestion-api-key"></a>
...
<Step>
### Create API Key Kubernetes Secret <a id="create-api-key-kubernetes-secret"></a>
...
<Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="HyperDX Kubernetes Data" size="lg"/>
</Step>
<Step>
### Add the OpenTelemetry Helm repo <a id="add-otel-helm-repo"></a>
...
<Step>
### Deploy Kubernetes collector components <a id="deploy-kubernetes-collector-components"></a>
...
<Step>
### Explore Kubernetes data in HyperDX <a id="explore-kubernetes-data-hyperdx"></a>
