...
<Steps>
<Step>
### Prerequisites <a id="prerequisites-managed"></a>
...
<Step>
### Install telemetrygen <a id="install-telemetrygen-managed"></a>
...
<Step>
### Set environment variables <a id="set-env-vars-managed"></a>
...
<Step>
### Generate logs <a id="generate-logs-managed"></a>
...
<Step>
### Generate traces <a id="generate-traces-managed"></a>
...
<Step>
### Generate metrics <a id="generate-metrics-managed"></a>
...
<Step>
### Verify in ClickStack <a id="verify-managed"></a>
...
<Steps>
<Step>
### Prerequisites <a id="prerequisites-oss"></a>
...
<Step>
### Install telemetrygen <a id="install-telemetrygen-oss"></a>
...
<Step>
### Set environment variables <a id="set-env-vars-oss"></a>
...
<Step>
### Generate logs <a id="generate-logs-oss"></a>
...
<Step>
### Generate traces <a id="generate-traces-oss"></a>
...
<Step>
### Generate metrics <a id="generate-metrics-oss"></a>
...
<Step>
### Verify in ClickStack <a id="verify-oss"></a>
