...
<Steps>
<Step>
### Create a custom OpenTelemetry configuration <a id="create-otel-configuration"></a>
...
<Step>
### Start the OpenTelemetry collector <a id="start-the-otel-collector"></a>
...
<Step>
### Select your service <a id="select-your-service"></a>
...
<Step>
### Explore system logs <a id="navigate-to-the-hyperdx-ui"></a>
...
<Image img="/images/use-cases/observability/hyperdx-20.png" alt="HyperDX Local logs" size="lg"/>
</Step>
<Step>
### Explore system metrics <a id="explore-system-metrics"></a>
...
<Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory over time" size="lg"/>

Note the number is returned as a floating point `%`. To render it more clearly, select `Set number format`. 

<Image img="/images/use-cases/observability/hyperdx-22.png" alt="Number format" size="lg"/>

From the subsequent menu you can select `Percentage` from the `Output format` drop down before clicking `Apply`.

<Image img="/images/use-cases/observability/hyperdx-23.png" alt="Memory % of time" size="lg"/>
</Step>
</Steps>
...
### Create a custom OpenTelemetry configuration <a id="create-otel-configuration-oss"></a>
...
### Start ClickStack with custom configuration <a id="start-clickstack"></a>
...
### Explore system logs <a id="navigate-to-the-hyperdx-ui-oss"></a>
...
### Explore system metrics <a id="explore-system-metrics-oss"></a>
