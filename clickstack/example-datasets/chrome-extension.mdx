...
<Steps>
<Step>
### Clone the extension repository <a id="clone-extension"></a>
...
<Step>
### Install the extension <a id="install-extension"></a>
...
<Step>
### Configure the extension <a id="configure-extension"></a>
...
<Step>
### Browse a site and generate a session <a id="browse-site"></a>
...
## URL filtering <a id="url-filtering"></a>
...
## Verify injection <a id="verify-injection"></a>
