...
## ClickStack on ClickHouse Cloud <a id="managed-clickstack"></a>
...
### Prerequisites <a id="managed-prerequisites"></a>
...
### Endpoint <a id="managed-endpoint"></a>
...
### Connecting an MCP client <a id="managed-connecting-a-client"></a>
...
### Targeting a specific service <a id="managed-service-override"></a>
...
<Image img="/images/clickstack/api-key-personal.png" alt="Personal API Access Key in Team Settings" size="md" border/>
...
### Connecting an MCP client <a id="oss-connecting-a-client"></a>
...
## What can you do with MCP? <a id="capabilities"></a>
...
## Multi-team usage (OSS/BYOC) <a id="multi-team"></a>
...
### ClickStack on ClickHouse Cloud <a id="troubleshooting-managed"></a>
...
### Open Source and BYOC <a id="troubleshooting-oss"></a>
