...
## Principles <a id="clickstack-principles"></a>
...
### Easy to set up in minutes <a id="clickstack-easy-to-setup"></a>
...
### User-friendly and purpose-built <a id="user-friendly-purpose-built"></a>
...
### End-to-end observability <a id="end-to-end-observability"></a>
...
### Built for ClickHouse <a id="built-for-clickhouse"></a>
...
### OpenTelemetry-native <a id="open-telemetry-native"></a>
...
### Open source and fully customizable <a id="open-source-and-customizable"></a>
...
## Architectural overview <a id="architectural-overview"></a>
