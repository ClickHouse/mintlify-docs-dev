...
To get started, visit the [Getting started guide](/clickstack/getting-started) before loading a [sample dataset](/clickstack/example-datasets). You can also explore documentation on [deployment options](/clickstack/deployment) and [production best practices](/clickstack/managing/production).
