...
## Using Text-to-Chart <a id="using-text-to-chart"></a>
...
<Step>
### Select a data source <a id="select-data-source"></a>
...
<Step>
### Enter a text prompt <a id="enter-text-prompt"></a>
...
## Trying it with demo data <a id="demo-data"></a>
