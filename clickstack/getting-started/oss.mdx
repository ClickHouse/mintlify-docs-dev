...
<Steps>
<Step>
## Deploy the stack with docker <a id="deploy-stack-with-docker"></a>
...
<Step>
## Navigate to the ClickStack UI <a id="navigate-to-hyperdx-ui"></a>
...
<Step>
## Explore the product <a id="explore-the-product"></a>
...
## Alternative deployment models <a id="alternative-deployment-models"></a>

### Local mode <a id="local-mode"></a>
...
### Hosted version <a id="hosted-version"></a>
...
### Self-hosted version <a id="self-hosted-version"></a>

<Steps>
<Step>
### Run with docker <a id="run-local-with-docker"></a>
...
<Step>
### Complete connection credentials <a id="complete-connection-credentials"></a>
