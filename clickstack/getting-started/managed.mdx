...
<Steps>
<Step>
## Signup to ClickHouse Cloud <a id="signup-to-clickhouse-cloud"></a>
...
<Step>
## Setup ingestion <a id="setup-ingestion"></a>
...
<Step>
## Navigate to the ClickStack UI <a id="navigate-to-clickstack-ui-cloud"></a>
