...
## Split trace view and extended trace view <a id="split-trace-view-and-extended-trace-view"></a>
...
## Source-level required filters <a id="source-level-required-filters"></a>
...
## Fit Y-axis to data <a id="fit-y-axis-to-data"></a>
...
## Anomaly alerts <a id="anomaly-alerts"></a>
...
## Clearer configuration for API and AI agents <a id="clearer-configuration-for-api-and-ai-agents"></a>
...
## Color selection for number charts <a id="color-selection-for-number-charts"></a>
...
## Out-of-the-box browser RUM dashboards <a id="out-of-the-box-browser-rum-dashboards"></a>
...
## Dependent dashboard filters <a id="dependent-dashboard-filters"></a>
