...
## Version-aware improved schema filtering <a id="version-aware-improved-schema-filtering"></a>
...
## Better log parsing <a id="better-log-parsing"></a>
...
## MCP server improvements <a id="mcp-server-improvements"></a>
...
## New series color palette <a id="new-series-color-palette"></a>
...
## New page layout with sticky header <a id="new-page-layout-with-sticky-header"></a>
...
## New datasource selector and color picking for series <a id="new-datasource-selector-and-color-picking-for-series"></a>
...
## Better hints for dashboard actions <a id="better-hints-for-dashboard-actions"></a>
