...
## Summarize logs and traces <a id="summarize-logs-and-traces"></a>
...
## Event deltas heatmap into chart builder <a id="event-deltas-heatmap-into-chart-builder"></a>
...
## Benchmarking for schema improvements <a id="benchmarking-for-schema-improvements"></a>
...
## Improvements to autocomplete <a id="improvements-to-autocomplete"></a>
...
## Improvements to alerting with SQL <a id="improvements-to-alerting-with-sql"></a>
...
## Errors during alert execution <a id="errors-during-alert-execution"></a>
