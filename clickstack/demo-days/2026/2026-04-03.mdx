...
## New dashboard and saved search listing pages <a id="new-dashboard-and-saved-search-listing-pages"></a>
...
## Filters for filters <a id="filters-for-filters"></a>
...
## RBAC for predefined dashboards <a id="rbac-for-predefined-dashboards"></a>
...
## Optimizations for searching <a id="optimizations-for-searching"></a>
...
## Copy row and configurable filter sizes <a id="copy-row-and-configurable-filter-sizes"></a>
...
## Tabs and groups in dashboards <a id="tabs-and-groups-in-dashboards"></a>
...
## ClickStack CLI <a id="clickstack-cli"></a>
