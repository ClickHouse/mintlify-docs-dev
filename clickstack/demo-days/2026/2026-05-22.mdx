...
## ClickCannon data generation update <a id="clickcannon-data-generation-update"></a>
...
## Date input for full-screen tiles and source-scoped filters <a id="date-input-for-full-screen-tiles-and-source-scoped-filters"></a>
...
## Text index recognised on lower(Body) <a id="text-index-recognised-on-lower-body"></a>
...
## Simpler event deltas experience <a id="simpler-event-deltas-experience"></a>
...
## Dashboard table of contents and bulk collapse <a id="dashboard-table-of-contents-and-bulk-collapse"></a>
...
## Column resize persisted across sessions <a id="column-resize-persisted-across-sessions"></a>
