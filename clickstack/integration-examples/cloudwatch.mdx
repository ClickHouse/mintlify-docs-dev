...
## Integration with existing CloudWatch log groups <a id="existing-cloudwatch"></a>
...
<Steps>
<Step>
#### Get ClickStack API key <a id="get-api-key"></a>
...
<Image img="/images/clickstack/api-key.png" alt="ClickStack API Key"/>
...
<Step>
#### Configure AWS credentials <a id="configure-aws"></a>
...
<Step>
#### Configure the CloudWatch receiver <a id="configure-receiver"></a>
...
<Step>
#### Start the collector <a id="start-collector"></a>
...
<Step>
#### Verify logs in HyperDX <a id="verify-logs"></a>
...
<Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="Log Search View"/>
...
<Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="Error Log Column Values"/>
</Step>
</Steps>
...
<Step>
#### Start ClickStack <a id="start-clickstack"></a>
...
<Step>
#### Import the demo dataset <a id="import-demo-data"></a>
...
<Step>
#### Verify the demo data <a id="verify-demo-logs"></a>
...
<Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="Demo search view"/>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
#### Import the dashboard <a id="import-dashboard"></a>
...
<Image img="/images/clickstack/cloudwatch/finish-import.png" alt="Finish import dialog"/>
</Step>
<Step>
...
<Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="CloudWatch Logs dashboard"/>
...
### Only seeing old logs or missing recent logs <a id="missing-recent"></a>
...
### Invalid security token / credentials expired <a id="expired-credentials"></a>
...
### High latency or missing recent logs <a id="latency"></a>
...
### Collector using too much memory <a id="memory"></a>
