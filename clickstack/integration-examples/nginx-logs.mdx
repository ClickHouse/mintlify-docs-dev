...
## Integration with existing Nginx <a id="existing-nginx"></a>
...
<Steps>
<Step>
#### Configure Nginx log format <a id="configure-nginx"></a>
...
<Image img="/images/clickstack/nginx-logs-search-view.png" alt="Log view"/>

<Image img="/images/clickstack/log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/nginx-logs-dashboard.json'} download="nginx-logs-dashboard.json" eventName="docs.nginx_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/finish-nginx-logs-import.png" alt="Finish Import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/nginx-logs-dashboard.png" alt="Example Dashboard"/>
</Step>
</Steps>
