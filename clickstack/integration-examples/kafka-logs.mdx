...
## Integration with existing Kafka <a id="existing-kafka"></a>
...
<Steps>
<Step>
#### Verify Kafka logging configuration <a id="verify-kafka"></a>
...
<Step>
#### Create a custom OTel collector configuration for Kafka <a id="custom-otel"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/kafka-logs-dashboard.json'} download="kafka-logs-dashboard.json" eventName="docs.kafka_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
