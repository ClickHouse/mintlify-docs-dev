...
## Integration with existing Cloudflare Logpush <a id="existing-cloudflare"></a>
...
<Steps>
<Step>
#### Configure S3 authentication <a id="configure-auth"></a>
...
<Step>
#### Create ClickPipes job <a id="create-clickpipes"></a>

1. ClickHouse Cloud Console → **Data Sources** → **Create ClickPipe**
2. **Source**: Amazon S3

<Image img="/images/clickstack/cloudflare/clickpipe-s3.png" alt="Clickpipe s3"/>
...
<Image img="/images/clickstack/cloudflare/continuous-ingestion.png" alt="Continuous ingestion"/>
...
<Image img="/images/clickstack/cloudflare/parse-information.png" alt="Parse information"/>
...
<Step>
#### Configure HyperDX data source <a id="configure-source"></a>
...
<Image img="/images/clickstack/cloudflare/add-source.png" alt="Add source"/>

2. Click **Add source** and configure the following settings. Click **Configure Optional Fields** to access all fields:

<Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="Configure optional"/>
...
<Image img="/images/clickstack/cloudflare/save-source.png" alt="Save source"/>
...
<Step>
#### Verify data in HyperDX <a id="verify-hyperdx"></a>
...
<Image img="/images/clickstack/cloudflare/search-view.png" alt="Search view"/>

<Image img="/images/clickstack/cloudflare/log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### Start ClickPipes with the demo dataset <a id="start-demo"></a>
...
<Step>
#### Configure HyperDX data source <a id="configure-demo-source"></a>
...
<Step>
#### Verify demo data <a id="verify-demo"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/cloudflare-logs-dashboard.json'} download="cloudflare-logs-dashboard.json" eventName="docs.cloudflare_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
#### Import dashboard <a id="import-dashboard"></a>

1. HyperDX → **Dashboards** → **Import Dashboard**

<Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="Import dashboard"/>

2. Upload `cloudflare-logs-dashboard.json` → **Finish Import**

<Image img="/images/clickstack/cloudflare/finish-import.png" alt="Import dashboard"/>
</Step>
<Step>
#### View dashboard <a id="view-dashboard"></a>

<Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="Example dashboard"/>
...
### Data not appearing in ClickHouse <a id="no-data"></a>
...
### Logs not appearing in HyperDX <a id="no-hyperdx"></a>
