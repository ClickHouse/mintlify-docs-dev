...
| Section | Description |
|------|-------------|
| [Generic Host Logs](/clickstack/integration-examples/host-logs) | Collect host system logs |
| [EC2 Host Logs](/clickstack/integration-examples/host-logs/ec2) | Monitor EC2 instance logs |
