...
## Integration with existing MySQL <a id="existing-mysql"></a>
...
<Steps>
<Step>
#### Configure MySQL logging <a id="configure-mysql"></a>
...
<Image img="/images/clickstack/mysql/search-view.png" alt="Search view"/>

<Image img="/images/clickstack/mysql/log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/mysql-logs-dashboard.json'} download="mysql-logs-dashboard.json" eventName="docs.mysql_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/mysql/finish-import.png" alt="Finish import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/mysql/example-dashboard.png" alt="Example dashboard"/>
...
### Slow query logs not appearing <a id="no-slow-queries"></a>
