...
## Integration with existing EC2 instance <a id="existing-ec2"></a>
...
<Steps>
<Step>
#### Verify EC2 metadata is accessible <a id="verify-metadata"></a>
...
<Step>
#### Verify syslog files exist <a id="verify-syslog"></a>
...
<Step>
#### Install OpenTelemetry Collector <a id="install-collector"></a>
...
<Step>
#### Create collector configuration <a id="create-config"></a>
...
<Step>
#### Set ClickStack API key <a id="set-api-key"></a>
...
<Step>
#### Run the collector <a id="run-collector"></a>
...
<Step>
#### Verifying Logs in HyperDX <a id="verifying-logs"></a>
...
<Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="EC2 logs search view"/>
<Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="EC2 log detail showing metadata"/>
</Step>
</Steps>

## Demo dataset <a id="demo-dataset"></a>
...
<Steps>
<Step>
#### Download the sample dataset <a id="download-sample"></a>
...
<Step>
#### Create test collector configuration <a id="test-config"></a>
...
<Step>
#### Run ClickStack with demo configuration <a id="run-demo"></a>
...
<Step>
#### Verify logs in HyperDX <a id="verify-demo-logs"></a>
...
<Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="EC2 logs search view"/>
<Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="EC2 log detail with metadata"/>
...
## Dashboards and visualization <a id="dashboards"></a>

To help you get started monitoring EC2 host logs with ClickStack, we provide essential visualizations with cloud context.

<Steps>
<Step>
#### <TrackedLink href={'/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
#### Import the pre-built dashboard <a id="import-dashboard"></a>

1. Open HyperDX and navigate to the Dashboards section
2. Click **Import Dashboard** in the upper right corner under the ellipses

<Image img="/images/clickstack/import-dashboard.png" alt="Import dashboard button"/>

3. Upload the `host-logs-dashboard.json` file and click **Finish Import**

<Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Finish import"/>
</Step>
<Step>
#### View the dashboard <a id="created-dashboard"></a>

The dashboard will be created with all visualizations pre-configured:

<Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="EC2 logs dashboard"/>
...
### EC2 metadata not appearing in logs <a id="no-metadata"></a>
...
### No logs appearing in HyperDX <a id="no-logs"></a>
...
### Logs parsing incorrectly <a id="logs-not-parsing"></a>
...
### Collector not starting as systemd service <a id="systemd-issues"></a>
...
## Going to production <a id="going-to-production"></a>
