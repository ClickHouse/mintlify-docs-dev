...
## Integration with an existing Kafka deployment <a id="existing-kafka"></a>
...
<Step>
#### Download the OpenTelemetry JMX Metric Gatherer <a id="download-jmx"></a>
...
<Step>
#### Verify Kafka JMX is enabled <a id="verify-jmx"></a>
...
<Step>
#### Deploy JMX Metric Gatherer with Docker Compose <a id="deploy-jmx"></a>
...
<Step>
#### Verify metrics in HyperDX <a id="verify-metrics"></a>
...
<Steps>
<Step>
#### Download the sample metrics dataset <a id="download-sample"></a>
...
<Step>
#### Load metrics into ClickStack <a id="load-metrics"></a>
...
<Step>
#### Verify metrics in HyperDX <a id="verify-demo-metrics"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/kafka-metrics-dashboard.json'} download="kafka-metrics-dashboard.json" eventName="docs.kafka_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="Finish import dialog"/>
</Step>
<Step>
...
<Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="Kafka Metrics dashboard"/>
...
### No metrics appearing in HyperDX <a id="no-metrics"></a>
...
### Authentication errors <a id="auth-errors"></a>
...
### Port conflicts with Kafka client commands <a id="port-conflicts"></a>
...
### Network connectivity issues <a id="network-issues"></a>
