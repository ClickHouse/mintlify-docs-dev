...
<Step>
#### Configure Nginx to send traces to ClickStack <a id="configure-nginx"></a>
...
##### Understanding the configuration <a id="understanding-configuration"></a>
...
<Step>
#### Verifying traces in HyperDX <a id="verifying-traces"></a>
...
<Image img="/images/clickstack/nginx-traces-search-view.png" alt="View Traces"/>
</Step>
</Steps>
...
<Step>
#### Send traces to ClickStack <a id="send-traces"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="Finish Import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/nginx-traces-dashboard.png" alt="Example Dashboard"/>
</Step>
</Steps>
