...
## Integration with existing Redis <a id="existing-redis"></a>
...
<Steps>
<Step>
#### Verify Redis logging configuration <a id="verify-redis"></a>
...
<Step>
#### Create custom OTel collector configuration <a id="custom-otel"></a>
...
<Step>
#### Configure ClickStack to load custom configuration <a id="load-custom"></a>
...
##### Option 1: Docker Compose <a id="docker-compose"></a>
...
##### Option 2: Docker Run (All-in-One Image) <a id="all-in-one"></a>
...
<Image img="/images/clickstack/redis/redis-log-view.png" alt="Log view"/>

<Image img="/images/clickstack/redis/redis-log.png" alt="Log"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/redis-logs-dashboard.json'} download="redis-logs-dashboard.json" eventName="docs.redis_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
#### Import Pre-built Dashboard <a id="import-dashboard"></a>
...
<Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="Finish Import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="Example Dashboard"/>
</Step>
</Steps>

## Troubleshooting <a id="troubleshooting"></a>

### Custom config not loading <a id="troubleshooting-not-loading"></a>
...
### Logs not parsing correctly <a id="logs-not-parsing"></a>
