...
## Integration with existing hosts <a id="existing-hosts"></a>
...
<Image img="/images/clickstack/host-logs/search-view.png" alt="Search view"/>
<Image img="/images/clickstack/host-logs/log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.host_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Logs dashboard"/>
