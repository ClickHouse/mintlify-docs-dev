...
## Creating the OTel Helm chart configuration files <a id="creating-the-otel-helm-chart-config-files"></a>
...
### Creating a API key secret <a id="create-api-key-secret"></a>
...
### Creating the DaemonSet configuration <a id="creating-the-daemonset-configuration"></a>
...
### Creating the deployment configuration <a id="creating-the-deployment-configuration"></a>
...
## Deploying the OpenTelemetry collector <a id="deploying-the-otel-collector"></a>
...
## Forwarding resource tags to pods (Recommended) <a id="forwarding-resouce-tags-to-pods"></a>
