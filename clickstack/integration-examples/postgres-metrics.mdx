...
<Steps>
<Step>
#### Ensure monitoring user has required permissions <a id="monitoring-permissions"></a>
...
<Step>
#### Create custom OTel collector configuration <a id="create-custom-config"></a>
...
<Step>
#### Deploy ClickStack with custom configuration <a id="deploy-clickstack"></a>
...
<Step>
#### Verify metrics collection <a id="verify-metrics"></a>
...
<Step>
#### Verify metrics in HyperDX <a id="verify-metrics-demo"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/postgres-metrics-dashboard.json'} download="postgres-metrics-dashboard.json" eventName="docs.postgres_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/postgres/import-dashboard.png" alt="Finish import dialog"/>
</Step>
<Step>
...
<Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="PostgreSQL metrics dashboard"/>
