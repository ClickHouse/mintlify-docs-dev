...
## Integration with existing PostgreSQL <a id="existing-postgres"></a>
...
<Steps>
<Step>
#### Configure PostgreSQL logging <a id="configure-postgres"></a>
...
<Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Logs search view"/>

<Image img="/images/clickstack/postgres/postgres-log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/postgres-logs-dashboard.json'} download="postgresql-logs-dashboard.json" eventName="docs.postgres_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="Finish import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="Logs dashboard"/>
