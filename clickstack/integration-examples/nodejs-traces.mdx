...
## Integration with existing Node.js application <a id="existing-nodejs"></a>
...
<Steps>
<Step>
#### Install and configure OpenTelemetry <a id="install-configure"></a>
...
<Step>
#### Run your application <a id="run-application"></a>
...
<Step>
#### Generate some traffic <a id="generate-traffic"></a>
...
<Step>
#### Verify traces in HyperDX <a id="verify-traces"></a>
...
<Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Traces search view"/>

Click on any trace to see the detailed view with spans, timing, and attributes:

<Image img="/images/clickstack/nodejs/trace-view.png" alt="Individual trace view"/>
</Step>
</Steps>
...
<Step>
#### Get ClickStack API key <a id="get-api-key-demo"></a>
...
<Step>
#### Send the traces to ClickStack <a id="send-traces"></a>
...
<Step>
#### Verify traces in HyperDX <a id="verify-demo-traces"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/nodejs-traces-dashboard.json'} download="nodejs-traces-dashboard.json" eventName="docs.node_traces_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download-dashboard"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/import-dashboard.png" alt="Import Dashboard"/>

3. Upload the `nodejs-traces-dashboard.json` file and click **Finish Import**

<Image img="/images/clickstack/nodejs/finish-import.png" alt="Finish import"/>
</Step>
<Step>
#### The dashboard will be created with all visualizations pre-configured <a id="created-dashboard"></a>

<Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="Example dashboard"/>
...
### Demo traces not appearing via curl <a id="demo-traces-not-appearing"></a>
...
### No traces appearing in HyperDX <a id="no-traces"></a>
