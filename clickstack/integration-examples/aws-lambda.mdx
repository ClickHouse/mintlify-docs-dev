...
## Integration with existing Lambda functions <a id="existing-lambda"></a>
...
<Steps>
<Step>
#### Choose the appropriate Rotel Lambda Extension layer <a id="choose-layer"></a>
...
<Step>
#### Add the Rotel layer to your Lambda function <a id="add-layer"></a>

_In these examples replace `{arch}`, `{region}`, and `{version}` with the appropriate values above._

##### Option 1: AWS Console <a id="console"></a>
...
<Step>
#### Configure the extension to export to ClickStack <a id="configure-extension"></a>
...
##### Basic configuration (environment variables) <a id="basic-config"></a>
...
##### Advanced configuration (using .env file) <a id="advanced-config"></a>
...
##### Using AWS Secrets Manager or Parameter Store <a id="secrets"></a>
...
<Step>
#### Test the integration <a id="test-integration"></a>
...
<Image img="/images/clickstack/lambda/lambda-log-view.png" alt="Lambda Log View"/>

<Image img="/images/clickstack/lambda/lambda-log.png" alt="Lambda Log Detail"/>
...
## Disabling CloudWatch Logs (cost optimization) <a id="disable-cloudwatch"></a>
...
<Steps>
<Step>
#### Remove CloudWatch permissions from the execution role <a id="remove-permissions"></a>
...
<Step>
#### Verify CloudWatch logging is disabled <a id="verify-disabled"></a>
...
## Adding OpenTelemetry auto-instrumentation <a id="auto-instrumentation"></a>
...
<Steps>
<Step>
#### Choose your language instrumentation layer <a id="choose-instrumentation"></a>
...
<Step>
#### Add both layers to your function <a id="add-both-layers"></a>
...
<Step>
#### Configure the auto-instrumentation <a id="configure-instrumentation"></a>
...
## Join the Rotel community <a id="join-rotel-community"></a>
