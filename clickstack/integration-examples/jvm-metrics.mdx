...
## Integration with existing JVM application <a id="existing-jvm"></a>
...
<Step>
#### Download OpenTelemetry Java agent <a id="download-agent"></a>
...
##### Option 2: Environment variables <a id="env-vars"></a>
...
<Step>
#### Verify the demo data <a id="verify-demo-metrics"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/jvm-metrics-dashboard.json'} download="jvm-metrics-dashboard.json" eventName="docs.kafka_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="Finish import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Kafka Metrics dashboard"/>
...
### Agent not starting <a id="troubleshooting-not-loading"></a>
