...
## Integration with existing Temporal Cloud <a id="existing-temporal"></a>
...
<Steps>
<Step>
#### Create Temporal Cloud key <a id="create-temporal-cloud-key"></a>
...
<Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Temporal Metrics" size="md"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="Finish import dialog"/>
</Step>
<Step>
...
<Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Temporal Metrics dashboard"/>
</Step>
</Steps>
