...
## Integration with existing systems <a id="existing-systems"></a>
...
<Step>
#### Verify systemd journal is running <a id="verify-systemd"></a>
...
<Step>
#### Create OpenTelemetry Collector configuration <a id="create-otel-config"></a>
...
<Step>
#### Deploy with Docker Compose <a id="deploy-docker-compose"></a>
...
<Step>
#### Verify logs in HyperDX <a id="verifying-logs"></a>
...
<Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Log search view"/>

<Image img="/images/clickstack/systemd/systemd-log-view.png" alt="Log view"/>
</Step>
</Steps>
...
<Step>
#### Create demo collector configuration <a id="demo-config"></a>
...
<Step>
#### Run ClickStack with demo data <a id="run-demo"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/systemd-logs-dashboard.json'} download="systemd-logs-dashboard.json" eventName="docs.systemd_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="Finish import"/>
</Step>
<Step>
...
<Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Example dashboard"/>
...
### journalctl not found error <a id="journalctl-not-found"></a>
