...
<Steps>
<Step>
#### Verify Redis connection <a id="verify-redis"></a>
...
<Step>
#### Verify metrics in HyperDX <a id="verifying-metrics"></a>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/redis-metrics-dashboard.json'} download="redis-metrics-dashboard.json" eventName="docs.redis_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="Finish import dialog"/>
</Step>
<Step>
...
<Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Redis Metrics dashboard"/>
