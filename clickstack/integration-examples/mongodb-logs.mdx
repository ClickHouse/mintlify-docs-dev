...
## Integration with existing MongoDB <a id="existing-mongodb"></a>
...
<Steps>
<Step>
#### Verify MongoDB logging configuration <a id="verify-mongodb"></a>
...
<Step>
#### Create a custom OTel collector configuration for MongoDB <a id="custom-otel"></a>
...
<Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB logs search view"/>

<Image img="/images/clickstack/mongodb/log-view.png" alt="MongoDB log detail view"/>
</Step>
</Steps>
...
<Steps>
<Step>
#### <TrackedLink href={'/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration <a id="download"></a>
</Step>
<Step>
...
<Image img="/images/clickstack/mongodb/finish-import.png" alt="Finish importing MongoDB logs dashboard"/>
</Step>
<Step>
...
<Image img="/images/clickstack/mongodb/example-dashboard.png" alt="MongoDB logs dashboard"/>
</Step>
</Steps>
