...
<Image img="/images/clickstack/service-maps/service-map-overview.png" alt="Service map showing service nodes and request flow between them" size="lg"/>

## Exploring the service map <a id="exploring-the-service-map"></a>
...
<Image img="/images/clickstack/service-maps/source-selector.png" alt="Source selector highlighted in the service map toolbar" size="lg"/>
...
<Image img="/images/clickstack/service-maps/sampling.png" alt="Sampling slider highlighted in the service map toolbar" size="lg"/>

**Date range picker** — set the time window for the trace data used to build the map.

<Image img="/images/clickstack/service-maps/date-selector.png" alt="Date range picker highlighted in the service map toolbar" size="lg"/>

Use the **+/-** buttons in the bottom-left corner of the map or scroll to zoom in and out.

## Trace-level service maps <a id="trace-level-service-maps"></a>
