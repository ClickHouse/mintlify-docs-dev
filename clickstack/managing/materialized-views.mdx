...
## What are incremental materialized views <a id="what-are-incremental-materialized-views"></a>
...
## Selecting visualizations for acceleration <a id="selecting-visualizatons-for-acceleration"></a>
...
### Identify high-impact visualizations <a id="identify-high-impact-visualizations"></a>
...
### Balance benefit against insert-time cost <a id="balance-benefit-against-insert-time-cost"></a>
...
### Consolidate visualizations into shared views <a id="consolidate-visualizations-into-shared-views"></a>
...
## Creating a materialized view <a id="creating-a-materialized-view"></a>
...
### Example materialized view <a id="example-materialized-view"></a>
...
## Using materialized view usage in ClickStack <a id="materialized-view-usage-in-clickstack"></a>
...
### Registering a Materialized for usage <a id="registering-a-view"></a>
...
<Steps>
<Step>
#### Edit the source <a id="edit-the-source"></a>
...
<Step>
#### Add the materialized view <a id="add-the-materialized-view"></a>
...
<Step>
#### Select metrics <a id="select-metrics"></a>
...
<Step>
#### Select the time granularity <a id="select-time-granularity"></a>
...
<Step>
#### Select the minimum date <a id="specify-the-minimum-date"></a>
...
<Step>
#### Save the source <a id="save-the-source"></a>
...
### Verifying acceleration in dashboards and visualizations <a id="verifying-acceleration-in-dashboards-and-visualizations"></a>
...
### How materialized views are selected for visualizations <a id="how-views-are-selected"></a>
...
#### Example of choosing materialized views <a id="example-of-choosing-materialized-view"></a>
...
## Backfilling a materialized view <a id="backfilling-a-materialized-view"></a>
...
### Backfilling approaches <a id="backfilling-approaches"></a>
...
#### Direct backfill using `INSERT INTO SELECT` <a id="direct-backfill"></a>
...
<Steps>
<Step>
##### Determine the current coverage of the view <a id="determine-current-coverage-of-view"></a>
...
<Step>
##### Decide whether backfilling is necessary <a id="decide-whether-backfilling-is-neccessary"></a>
...
<Step>
##### Backfill missing historical data <a id="backfill-missing-historical-data"></a>
...
#### Incremental backfilling using a Null table <a id="incremental-backfill-null-table"></a>
...
<Steps>
<Step>
##### Create a Null table for backfilling <a id="create-null-table"></a>
...
<Step>
##### Attach a materialized view to the Null table <a id="attach-mv-to-null-table"></a>
...
<Step>
##### Backfill data incrementally <a id="incremental-backfill"></a>
...
### Granularity selection and alignment <a id="granularity-selection-and-alignment"></a>
...
### Limit and consolidate materialized views <a id="limit-and-consolidate-materialized-views"></a>
...
### Choose dimensions carefully <a id="choose-dimensions-carefully"></a>
...
### Naming conventions for aggregation columns <a id="naming-conventions-for-aggregation-columns"></a>
...
### Quantiles and sketch selection <a id="quantiles-and-sketch-selection"></a>
...
### Validate effectiveness continuously <a id="validate-effectiveness-continously"></a>
...
### Advanced configurations <a id="advanced-configurations"></a>
...
### Common incompatibility reasons <a id="common-incompatibility-reasons"></a>
...
### Design and operational constraints <a id="design-and-operational-constraints"></a>
...
### Materialized view not being used <a id="materialied-view-not-being-used"></a>
...
### Slow materialized view queries <a id="slow-mv-queries"></a>
...
### Configuration errors <a id="config-errors"></a>
