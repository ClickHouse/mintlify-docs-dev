...
## Settings for open source distributions <a id="modifying-settings"></a>
...
## ClickStack UI (HyperDX) application <a id="hyperdx"></a>

### Data source settings <a id="datasource-settings"></a>
...
#### Highlighted Attributes <a id="highlighted-attributes"></a>
...
### Correlated sources <a id="correlated-sources"></a>
...
### Application configuration settings <a id="application-configuration-settings"></a>
...
## OpenTelemetry collector <a id="otel-collector"></a>
