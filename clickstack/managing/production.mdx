...
### Secure ingestion <a id="secure-ingestion-managed"></a>
...
#### Create an ingestion user <a id="create-a-database-ingestion-user-managed"></a>
...
### Configure Time To Live (TTL) <a id="configure-ttl-managed"></a>
...
#### Isolating observability workloads <a id="isolating-workloads"></a>
...
### Network and port security <a id="network-security"></a>
...
### Session secret configuration <a id="session-secret"></a>
...
### Secure ingestion <a id="secure-ingestion"></a>
...
#### Create an ingestion user <a id="create-a-database-ingestion-user-oss"></a>
...
#### Security best practices <a id="self-managed-security"></a>
...
#### User permissions for ClickStack UI <a id="user-permissions"></a>
...
### Configure Time To Live (TTL) <a id="configure-ttl"></a>
...
### MongoDB guidelines <a id="mongodb-guidelines"></a>
