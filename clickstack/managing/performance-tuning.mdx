...
## ClickHouse concepts <a id="clickhouse-concepts"></a>
...
## Optimization 1. Materialize frequently queried attributes <a id="materialize-frequently-queried-attributes"></a>
...
### Why materialize attributes <a id="why-materialize-attributes"></a>
...
### Example <a id="materialize-column-example"></a>
...
### Materializing historical data <a id="materializing-historical-data"></a>
...
## Optimization 2. Adding skip indexes <a id="adding-skip-indexes"></a>
...
### Bloom filters <a id="bloom-filters"></a>
...
### Text indexes <a id="text-indexes"></a>
...
#### Array tokenizer for Map and array columns <a id="array-tokenizer"></a>
...
#### `splitByNonAlpha` for log bodies <a id="text-index-body"></a>
...
#### Text indexes in the default logs schema <a id="text-indexes-in-default-logs-schema"></a>
...
### Min-max indexes <a id="min-max-indexes"></a>
...
### Materialize skip index <a id="materialize-skip-index"></a>
...
### Evaluating skip index effectiveness <a id="evaluating-skip-index-effectiveness"></a>
...
### When to add skip indexes <a id="when-to-add-skip-indexes"></a>
...
## Optimization 3. Map direct read <a id="map-direct-read-optimization"></a>
...
### Schema <a id="map-direct-read-schema"></a>
...
### Query rewrite <a id="map-direct-read-rewrite"></a>
...
### ClickHouse version requirements <a id="map-direct-read-version"></a>
...
## Optimization 4. Modifying the primary key <a id="modifying-the-primary-key"></a>
...
### Choosing a primary key <a id="choosing-a-primary-key"></a>
...
### Changing the primary key <a id="changing-the-primary-key"></a>
...
<Steps>
<Step>
#### Create new table <a id="create-new-table-with-key"></a>
...
<Step>
#### Exchange and drop table <a id="exhange-and-drop-table"></a>
...
<Steps>
<Step>
#### Create new table <a id="create-new-table-with-key-2"></a>
...
<Step>
#### Create a Merge table <a id="create-merge-table"></a>
...
<Step>
#### Update the ClickStack UI to read from the merge table <a id="update-clickstack-ui-to-read-from-merge-tree"></a>
...
<Step>
#### Exchange the tables <a id="exchange-the-tables"></a>
...
<Steps>
<Step>
#### Create new table <a id="create-new-table-with-key-3"></a>
...
<Step>
#### Exchange the tables <a id="exchange-the-tables-v2"></a>
...
### Row lookup acceleration with block columns <a id="row-lookup-block-columns"></a>
...
## Optimization 5. Exploiting materialized views <a id="exploiting-materialized-views"></a>
...
## Optimization 6. Exploiting Projections <a id="exploting-projections"></a>
...
### Example projections <a id="example-projections"></a>
...
### Costs and guidance <a id="projection-costs-and-guidance"></a>
...
### Lightweight projections with `_part_offset` <a id="lightweight-projections"></a>
...
### Alternatives <a id="projection-alternatives"></a>
