...
All optimizations described below can be applied directly to the underlying tables using standard ClickHouse SQL, either through the [ClickHouse Cloud SQL console](/products/cloud/features/sql-console-features/sql-console) or via the [ClickHouse client](/concepts/features/interfaces/cli).
