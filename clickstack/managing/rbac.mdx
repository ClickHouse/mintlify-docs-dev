...
## User access prerequisites <a id="user-access-prerequisites"></a>
...
## Built-in roles <a id="built-in-roles"></a>
...
## Assigning roles to team members <a id="assigning-roles"></a>
...
### Default new user role <a id="default-new-user-role"></a>
...
## Creating a custom role <a id="creating-a-role"></a>

<Steps>
<Step>
### Navigate to Team Settings <a id="step-navigate"></a>
...
<Step>
### Add a new role <a id="step-add-role"></a>

Click **+ Add Role**. Enter a **Role Name** and optionally add a **Description**.
</Step>
<Step>
### Configure permissions and save <a id="step-configure"></a>
...
## Role permissions <a id="role-permissions"></a>

### Resource permissions <a id="resource-permissions"></a>
...
### Administrative permissions <a id="administrative-permissions"></a>
...
### Fine-grained access rules <a id="fine-grained-access-rules"></a>
...
#### Default access vs. fine-grained controls <a id="access-control-modes"></a>
...
#### Configuring access rules <a id="configuring-access-rules"></a>
