...
<Image img="/images/cloud/onboard/discover/use_cases/0_rta.png" size="md" border alt="batch analytics diagram" />
...
<Image img="/images/cloud/onboard/discover/use_cases/1_rta.png" size="md" border alt="Real-time analytics diagram" />
...
<Image img="/images/cloud/onboard/discover/use_cases/2_rta.png" size="md" border alt="Real-time analytics for fraud detection" />
...
<Image img="/images/cloud/onboard/discover/use_cases/3_rta.png" size="md" border alt="Real-time analutics for time-sensitive decision making" />
