...
## ClickHouse for observability <a id="clickstack"></a>
...
<Tabs>
  <Tab title="OpenTelemetry" icon="/images/integrations/logos/logo_otel.png">
  ...
  <Tab title="HyperDX" icon="/images/hyperdx-logo.png">
