...
<CardGroup cols={4}>
    ...
    <Card href="/get-started/use_cases/observability" title="Observability" icon="chart-mixed">
    </Card>
    <Card href="/get-started/use_cases/data_warehousing" title="Data warehousing" icon="database">
    </Card>
    <Card href="/get-started/use_cases/machine_learning_and_genAI/machine_learning" title="AI & Generative ML" icon="brain-circuit">
    </Card>
</CardGroup>