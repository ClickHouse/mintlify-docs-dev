...
## What this architecture provides <a id="benefits"></a>
...
## How ClickHouse powers your data warehouse <a id="architecture"></a>
...
<Columns cols={2}>
  <div>
    <Image img="/images/cloud/onboard/discover/use_cases/data-warehousing.png" alt="ClickHouse data warehousing architecture"/>
  </div>
...
## Hybrid architecture: The best of both worlds <a id="hybrid-architecture-the-best-of-both-worlds"></a>
