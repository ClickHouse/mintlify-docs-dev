...
## ClickHouse for agentic workloads <a id="agentic-workloads"></a>
...
## Convergence of data warehousing and observability <a id="convergence-dwh-o11y"></a>
...
## The platform layer: Agent-ready interfaces and LLM observability <a id="platform-layer"></a>
