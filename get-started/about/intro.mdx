...
<Image img="/static/images/column-oriented-example-query.png" alt="Example query in a column-oriented database" size="lg"/>
...
<Image img="/static/images/row-oriented.gif" alt="Row-oriented database structure" size="lg"/>
...
<Image img="/static/images/column-oriented.gif" alt="Column-oriented database structure" size="lg"/>
