...
## What are analytics? <a id="what-are-analytics"></a>
...
## Row-oriented vs. column-oriented storage <a id="row-oriented-vs-column-oriented-storage"></a>
...
## Data replication and integrity <a id="data-replication-and-integrity"></a>
...
## SQL support <a id="sql-support"></a>
...
## Approximate calculation <a id="approximate-calculation"></a>
...
## Adaptive join algorithms <a id="adaptive-join-algorithms"></a>
...
## Superior query performance <a id="superior-query-performance"></a>
...
{/*
## What is OLAP? <a id="what-is-olap"></a>
...
## Column-oriented vs row-oriented databases <a id="column-oriented-vs-row-oriented-databases"></a>
...
## Why column-oriented databases work better in the OLAP scenario <a id="why-column-oriented-databases-work-better-in-the-olap-scenario"></a>
...
## Why is ClickHouse so fast? <a id="why-is-clickhouse-so-fast"></a>
...
## Processing analytical queries in real time <a id="processing-analytical-queries-in-real-time"></a>
...
### Key properties of the OLAP scenario <a id="key-properties-of-olap-scenario"></a>
...
### Input/output <a id="inputoutput"></a>
