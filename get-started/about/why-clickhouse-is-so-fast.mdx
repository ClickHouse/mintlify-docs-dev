...
## Storage layer: concurrent inserts are isolated from each other <a id="storage-layer-concurrent-inserts-are-isolated-from-each-other"></a>
<Frame>
...
## Storage layer: concurrent inserts and selects are isolated <a id="storage-layer-concurrent-inserts-and-selects-are-isolated"></a>
<Frame>
...
## Storage layer: merge-time computation <a id="storage-layer-merge-time-computation"></a>
<Frame>
...
## Storage layer: data pruning <a id="storage-layer-data-pruning"></a>
<Frame>
...
## Storage layer: data compression <a id="storage-layer-data-compression"></a>
<Frame>
...
## State-of-the-art query processing layer <a id="state-of-the-art-query-processing-layer"></a>
<Frame>
...
## Meticulous attention to detail <a id="meticulous-attention-to-detail"></a>
<Frame>
...
## VLDB 2024 paper <a id="vldb-2024-paper"></a>
