...
🤿 Deep dive into this in the [On-Disk Format](/academic_overview#3-1-on-disk-format) section of the web version of our VLDB 2024 paper.
...
🤿 Deep dive into this in the [Storage Layer](/academic_overview#3-storage-layer) section of the web version of our VLDB 2024 paper.
...
🤿 Deep dive into this in the [Merge-time Data Transformation](/academic_overview#3-3-merge-time-data-transformation) section of the web version of our VLDB 2024 paper.
...
🤿 Deep dive into this in the [Data Pruning](/academic_overview#3-2-data-pruning) section of the web version of our VLDB 2024 paper.
...
You can read a [PDF of the paper](https://www.vldb.org/pvldb/vol17/p3731-schulze.pdf) or our [web version](/academic_overview) of it, which gives a concise description of ClickHouse's most interesting architectural and system design components that make it so fast.
