...
<Image img="/static/images/deployment-modes/ch-server.png" alt="ClickHouse Server" size="sm"/>
...
<Image img="/static/images/deployment-modes/ch-cloud.png" alt="ClickHouse Cloud" size="sm"/>
...
<Image img="/static/images/deployment-modes/ch-local.png" alt="clickHouse-local" size="sm"/>
...
<Image img="/static/images/deployment-modes/chdb.png" alt="chDB - Embedded ClickHouse" size="sm"/>
