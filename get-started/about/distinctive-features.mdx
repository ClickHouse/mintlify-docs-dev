...
## True column-oriented database management system <a id="true-column-oriented-database-management-system"></a>
...
## Disk storage of data <a id="disk-storage-of-data"></a>
...
## Parallel processing on multiple cores <a id="parallel-processing-on-multiple-cores"></a>

Large queries are parallelized naturally, taking all the necessary resources available on the current server.

## Distributed processing on multiple servers <a id="distributed-processing-on-multiple-servers"></a>
...
## Vector computation engine <a id="vector-engine"></a>
...
## Real-time data inserts <a id="real-time-data-updates"></a>
...
## Primary indexes <a id="primary-index"></a>
...
## Secondary indexes <a id="secondary-indexes"></a>
...
## Suitable for online queries <a id="suitable-for-online-queries"></a>
...
## Support for approximated calculations <a id="support-for-approximated-calculations"></a>
...
## Adaptive join algorithm <a id="adaptive-join-algorithm"></a>
...
## Data replication and data integrity support <a id="data-replication-and-data-integrity-support"></a>
...
## Features that can be considered disadvantages <a id="clickhouse-features-that-can-be-considered-disadvantages"></a>
