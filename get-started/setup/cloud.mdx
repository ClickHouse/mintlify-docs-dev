...
<Image img="/static/images/_snippets/signup_page.png" size="md" alt='Select Plan' border/>
<br/>
...
<Image img="/static/images/_snippets/createservice1.png" size="md" alt='New ClickHouse Service' border/>
<br/>
...
<Image img="/static/images/_snippets/scaling_limits.png" size="md" alt='Scaling Limits' border/>
<br/>
...
<Image img="/static/images/_snippets/createservice8.png" size="md" alt='SQL Console' border/>
...
<Image img="/static/images/_snippets/show_databases.png" size="md" alt='SQL Console' border/>
<br/>
...
<Image img="/static/images/_snippets/service_connect.png" size="md" alt='Service Connect' border/>
<br/>
...
<Image img="/static/images/_snippets/data_sources.png" size="md" alt='Data sources' border/>
<br/>
...
<Image img="/static/images/_snippets/select_data_source.png" size="md" alt='Select data source' border/>
<br/>
...
For a deep dive into core ClickHouse concepts, see ["Core Concepts"](/concepts/core-concepts).
...
<Note>
Notice the `timestamp` column is populated using various [**Date**](/reference/data-types/date) and [**DateTime**](/reference/data-types/datetime) functions. ClickHouse has hundreds of useful functions that you can [view in the **Functions** section](/reference/functions/regular-functions).
</Note>
...
You can also connect to your ClickHouse Cloud service using a command-line tool named [**clickhouse client**](/integrations/connectors/data-integrations/drivers-and-interfaces/cli). Click `Connect` on the left menu to access these details. From the dialog select `Native` from the drop-down:

<Image img="/static/images/_snippets/client_details.png" size="md" alt='clickhouse client connection details' border/>
<br/>

1. Install [ClickHouse](/integrations/connectors/data-integrations/drivers-and-interfaces/cli).
...
4. Add a [`FORMAT`](/reference/statements/select/format) clause to specify one of the [many supported output formats of ClickHouse](/reference/formats):
...
<Image img="/static/images/_snippets/new_rows_from_csv.png" size="md" alt='New rows from CSV file' />
<br/>
