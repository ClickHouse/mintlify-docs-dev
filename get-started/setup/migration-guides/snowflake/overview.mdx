...
<Image img="/static/images/cloud/onboard/discover/use_cases/snowflake_architecture.png" size="md" alt="Snowflake architecture" />
...
<Image img="/static/images/cloud/onboard/discover/use_cases/cloud_architecture.png" size="md" alt="ClickHouse Cloud architecture" />
