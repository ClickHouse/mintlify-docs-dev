...
Where possible, you should leverage ClickHouse aggregate functions. Below we show the use of the [argMax](/reference/functions/aggregate-functions/reference/argMax) function to compute the most viewed question of each year.
...
[Click here for Part 3](/get-started/setup/migration-guides/postgres/migration-guide/migration-guide-part3)
