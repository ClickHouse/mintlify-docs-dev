...
<Image img="/static/images/integrations/migration/self-managed-01.png" size='lg' alt='Migrating Self-managed ClickHouse'/>
...
<Image img="/static/images/integrations/migration/self-managed-02.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
<Image img="/static/images/integrations/migration/self-managed-03.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
<Image img="/static/images/integrations/migration/self-managed-04.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
<Image img="/static/images/integrations/migration/self-managed-05.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
<Image img="/static/images/integrations/migration/self-managed-06.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
