...
<Image img="/static/images/integrations/migration/object-storage-01.png" size='md' alt='Migrating Self-managed ClickHouse'/>
...
If your current database system isn't able to directly offload data into a Cloud Object Storage, you could use a [third-party ETL/ELT tool](/get-started/setup/migration-guides/other-methods/etl-tool-to-clickhouse) or [clickhouse-local](/get-started/setup/migration-guides/other-methods/clickhouse-local-etl) for moving data
