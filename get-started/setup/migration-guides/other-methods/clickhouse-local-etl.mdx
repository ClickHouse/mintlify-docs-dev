...
<Image img="/static/images/integrations/migration/ch-local-01.png" size='lg' alt='Migrating Self-managed ClickHouse'/>
...
ClickHouse-provided [integration engine](/reference/engines/table-engines#integration-engines)  or [table function](/reference/functions/table-functions), respectively,
...
<Image img="/static/images/integrations/migration/ch-local-02.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
<Image img="/static/images/integrations/migration/ch-local-03.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
