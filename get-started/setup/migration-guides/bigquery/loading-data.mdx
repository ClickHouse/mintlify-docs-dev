...
Once the export is complete, we can import this data into a ClickHouse table. You can use the [ClickHouse SQL console](/integrations/connectors/data-integrations/sql-clients/sql-console) or [`clickhouse-client`](/integrations/connectors/data-integrations/drivers-and-interfaces/cli) to execute the commands below.
