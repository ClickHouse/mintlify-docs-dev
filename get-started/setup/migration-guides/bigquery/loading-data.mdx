...
Once the export is complete, we can import this data into a ClickHouse table. You can use the [ClickHouse SQL console](/products/cloud/features/sql-console-features/sql-console) or [`clickhouse-client`](/concepts/features/interfaces/cli) to execute the commands below.
