...
For the full BigQuery-to-ClickHouse type mapping, see the Data types section of the SQL translation reference.
...
For the ClickHouse equivalents of BigQuery array functions and `UNNEST`-based patterns, see the Array functions section of the SQL translation reference.
