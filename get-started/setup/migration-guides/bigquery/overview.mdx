...
<Image img="/static/images/migrations/bigquery-1.png" size="md" alt="Resource organizations"/>
...
| [JSON](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-types#json_type)     | [JSON](/integrations/connectors/data-ingestion/data-formats/json/inference)                                                                                                                                 |
...
| [STRUCT](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-types#constructing_a_struct)   | [Tuple](/reference/data-types/tuple), [Nested](/reference/data-types/nested-data-structures)                                                                       |
...
In ClickHouse, data is automatically [clustered on disk](/guides/cloud-oss/data-modelling/sparse-primary-indexes#optimal-compression-ratio-of-data-files) based on a table's primary key columns and logically organized in blocks that can be quickly located or pruned by queries utilizing the primary index data structure.
...
[groupArray](/reference/functions/aggregate-functions/reference/groupArray) aggregate function
