...
<Columns cols={4}>
  <Card title="Quick install" icon="/images/install/linux.svg" href="/install/quick-install" />
  <Card title="clickhousectl (CLI)" icon="terminal" href="/install/clickhousectl" />
  <Card title="Docker" icon="/images/install/docker.svg" href="/install/docker" />
...
<Columns cols={4}>
  <Card title="Debian/Ubuntu" icon="/images/install/DebianUbuntu.svg" href="/install/debian_ubuntu" />
  <Card title="Redhat" icon="/images/install/redhat.svg" href="/install/redhat" />
  <Card title="NixOS" icon="/images/install/nixos.svg" href="/install/nixos" />
  <Card title="Other Linux" icon="/images/install/linux.svg" href="/install/linux_other" />
</Columns>
