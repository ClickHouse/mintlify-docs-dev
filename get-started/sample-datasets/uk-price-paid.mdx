...
## Preprocess and insert the data <a id="preprocess-import-data"></a>
...
### Query 1. Average price per year <a id="average-price"></a>
...
### Query 2. average price per year in London <a id="average-price-london"></a>
...
### Query 3. The most expensive neighborhoods <a id="most-expensive-neighborhoods"></a>
...
## Speeding up queries with projections <a id="speeding-up-queries-with-projections"></a>
...
### Test it in the playground <a id="playground"></a>
