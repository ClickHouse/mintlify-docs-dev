...
import ActionsMenu from '/snippets/_service_actions_menu.mdx';
import SQLConsoleDetail from '/snippets/_launch_sql_console.mdx';
import SupersetDocker from '/snippets/_add_superset_detail.mdx';
...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Dashboard of cell towers by radio type in mcc 204"/>

## Get the dataset <a id="get-the-dataset"></a>
...
### Load the sample data <a id="load-the-sample-data"></a>
...
<Image img="/images/_snippets/cloud-load-data-sample.png" size='md' alt='Load cell towers dataset' />

### Examine the schema of the cell_towers table <a id="examine-the-schema-of-the-cell_towers-table"></a>
```sql
...
## Run some example queries <a id="examples"></a>
...
You may want to create a [Dictionary](/reference/statements/create/dictionary) in ClickHouse to decode these values.

## Use case: incorporate geo data <a id="use-case"></a>

Using the [`pointInPolygon`](/reference/functions/regular-functions/geo/coordinates#pointinpolygon) function.
...
## Review of the schema <a id="review-of-the-schema"></a>
...
## Build visualizations with Apache Superset <a id="build-visualizations-with-apache-superset"></a>
...
### Add your ClickHouse service as a Superset database <a id="add-your-clickhouse-service-as-a-superset-database"></a>
...
<ConnectionDetails />
  ...
  <Image img="/images/getting-started/example-datasets/superset-add.png" size="md" alt="Add a database"/>
  
  Choose **ClickHouse Connect** from the list:

  <Image img="/images/getting-started/example-datasets/superset-choose-a-database.png" size="md" alt="Choose clickhouse connect as database type"/>
...
#### Add your connection details <a id="add-your-connection-details"></a>
...
<Tip>
  ...
  <Image img="/images/getting-started/example-datasets/superset-connect-a-database.png" size="md" alt="Add ClickHouse as a Superset data source"/>

### Add the table **cell_towers** as a Superset **dataset** <a id="add-the-table-cell_towers-as-a-superset-dataset"></a>
...
<Image img="/images/getting-started/example-datasets/superset-add-dataset.png" size="md" alt="Add cell_towers table as a dataset"/>

### Create some **charts** <a id="create-some-charts"></a>
...
<Image img="/images/getting-started/example-datasets/superset-create-map.png" size="md" alt="Create a map in Superset"/>

#### Specify the query used for the map <a id="specify-the-query-used-for-the-map"></a>
...
<Image img="/images/getting-started/example-datasets/superset-lon-lat.png" size="md" alt="Specify longitude and latitude fields"/>

Add a filter with `mcc` = `204` (or substitute any other `mcc` value):

<Image img="/images/getting-started/example-datasets/superset-mcc-204.png" size="md" alt="Filter on MCC 204"/>
...
<Image img="/images/getting-started/example-datasets/superset-radio-umts.png" size="md" alt="Filter on radio equal to UMTS"/>

This is the full configuration for the chart that filters on `radio = 'UMTS'` and `mcc = 204`:

<Image img="/images/getting-started/example-datasets/superset-umts-netherlands.png" size="md" alt="Chart for UMTS radios in MCC 204"/>

Click on **UPDATE CHART** to render the visualization.

### Add the charts to a **dashboard** <a id="add-the-charts-to-a-dashboard"></a>
...
<!-- anchors from _add_superset_detail.mdx -->
<a id="official-clickhouse-connect-driver"></a>
<a id="mapbox"></a>
<a id="deploy-superset-version-200"></a>
<!-- anchors from _add_superset_detail.mdx -->
<a id="official-clickhouse-connect-driver"></a>
<a id="mapbox"></a>
<a id="deploy-superset-version-200"></a>