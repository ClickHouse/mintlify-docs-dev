...
<Image img="/static/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Dashboard of cell towers by radio type in mcc 204"/>
...
<Image img="/static/images/_snippets/cloud-load-data-sample.png" size='md' alt='Load cell towers dataset' />
...
<ConnectionDetails />
  ...
  <Image img="/static/images/getting-started/example-datasets/superset-add.png" size="md" alt="Add a database"/>
  
  Choose **ClickHouse Connect** from the list:

  <Image img="/static/images/getting-started/example-datasets/superset-choose-a-database.png" size="md" alt="Choose clickhouse connect as database type"/>
...
<Tip>
  ...
  <Image img="/static/images/getting-started/example-datasets/superset-connect-a-database.png" size="md" alt="Add ClickHouse as a Superset data source"/>
...
<Image img="/static/images/getting-started/example-datasets/superset-add-dataset.png" size="md" alt="Add cell_towers table as a dataset"/>
...
<Image img="/static/images/getting-started/example-datasets/superset-create-map.png" size="md" alt="Create a map in Superset"/>
...
<Image img="/static/images/getting-started/example-datasets/superset-lon-lat.png" size="md" alt="Specify longitude and latitude fields"/>

Add a filter with `mcc` = `204` (or substitute any other `mcc` value):

<Image img="/static/images/getting-started/example-datasets/superset-mcc-204.png" size="md" alt="Filter on MCC 204"/>
...
<Image img="/static/images/getting-started/example-datasets/superset-radio-umts.png" size="md" alt="Filter on radio equal to UMTS"/>

This is the full configuration for the chart that filters on `radio = 'UMTS'` and `mcc = 204`:

<Image img="/static/images/getting-started/example-datasets/superset-umts-netherlands.png" size="md" alt="Chart for UMTS radios in MCC 204"/>
