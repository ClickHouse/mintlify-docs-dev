...
<Step>
### Sample the data <a id="sampling"></a>
...
<Step>
### Load the data with schema inference <a id="loading-the-data"></a>
...
<Step>
### Define a schema <a id="define-a-schema"></a>
...
<Step>
### Run sample queries <a id="run-sample-queries"></a>

Some sample queries are presented below to give you inspiration for writing your
own queries.

#### How pervasive a topic is "ClickHouse" in Hacker News? <a id="how-pervasive"></a>
...
#### Who are the top commenters on ClickHouse related articles? <a id="top-commenters"></a>
...
#### Which comments generate the most interest? <a id="comments-by-most-interest"></a>
...
<Steps>
<Step>
### Insert the data <a id="insert-the-data"></a>
...
<Step>
### Add a skipping-index to speed up queries <a id="add-skipping-index"></a>
