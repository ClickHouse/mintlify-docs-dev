...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="Number of events per day"/>
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="Hot and humid days"/>
