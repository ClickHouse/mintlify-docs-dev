...
<Step>
### Count the number of rows <a id="count-row-numbers"></a>
...
### If someone disables comments does it lower the chance someone will actually click like or dislike? <a id="if-someone-disables-comments-does-it-lower-the-chance-someone-will-actually-click-like-or-dislike"></a>
...
### How does the number of videos change over time - notable events? <a id="how-does-the-number-of-videos-change-over-time---notable-events"></a>
...
### More subtitles over time and when <a id="more-subtitles-over-time-and-when"></a>
...
### Top uploaders over time <a id="top-uploaders-over-time"></a>
...
### How do like ratio changes as views go up? <a id="how-do-like-ratio-changes-as-views-go-up"></a>
...
### How are views distributed? <a id="how-are-views-distributed"></a>
