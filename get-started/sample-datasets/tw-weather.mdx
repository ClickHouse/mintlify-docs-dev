...
### Pre-processed data <a id="pre-processed-data"></a>
...
### Original raw data <a id="original-raw-data"></a>
...
#### Retrieve the Taiwan weather stations <a id="retrieve-the-taiwan-weather-stations"></a>
...
## Create table schema <a id="create-table-schema"></a>
...
## Inserting into ClickHouse <a id="inserting-into-clickhouse"></a>

### Inserting from local file <a id="inserting-from-local-file"></a>
...
### Inserting from URL <a id="inserting-from-url"></a>
...
## Check data rows and sizes <a id="check-data-rows-and-sizes"></a>
...
## Sample queries <a id="sample-queries"></a>

### Q1: Retrieve the highest dew point temperature for each weather station in the specific year <a id="q1-retrieve-the-highest-dew-point-temperature-for-each-weather-station-in-the-specific-year"></a>
...
### Q2: Raw data fetching with the specific duration time range, fields and weather station <a id="q2-raw-data-fetching-with-the-specific-duration-time-range-fields-and-weather-station"></a>
