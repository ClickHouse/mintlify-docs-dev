...
<Image img="/images/getting-started/example-datasets/stackoverflow.png" alt="Stack Overflow schema" size="md"/>
...
## Pre-prepared data <a id="pre-prepared-data"></a>
...
### PostHistory <a id="posthistory"></a>
...
## Original dataset <a id="original-dataset"></a>
...
## Example queries <a id="example-queries"></a>

A few simple questions to you get started.

### Most popular tags on Stack Overflow <a id="most-popular-tags-on-stack-overflow"></a>
...
### User with the most answers (active accounts) <a id="user-with-the-most-answers-active-accounts"></a>
...
### ClickHouse related posts with the most views <a id="clickhouse-related-posts-with-the-most-views"></a>
...
### Most controversial posts <a id="most-controversial-posts"></a>
