...
<Step>
### Run a brute-force vector similarity search <a id="run-a-brute-force-vector-similarity-search"></a>
...
<Step>
### Build a vector similarity index <a id="build-vector-similarity-index"></a>
...
<Step>
### Perform ANN search <a id="perform-ann-search"></a>
...
<Step>
### Generate embeddings for search query <a id="generating-embeddings-for-search-query"></a>
