...
<Image img="/static/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="For lines added and deleted" size="md"/>

**For commits and authors:**

<Image img="/static/images/getting-started/example-datasets/superset-commits-authors.png" alt="For commits and authors" size="md"/>
...
<Image img="/static/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Superset authors matrix" size="md"/>

Alexey clearly likes removing other peoples code. Lets exclude him for a more balanced view of code removal.

<Image img="/static/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Superset authors matrix v2" size="md"/>
