...
You can make queries to Playground using any HTTP client, for example [curl](https://curl.haxx.se) or [wget](https://www.gnu.org/software/wget/), or set up a connection using [JDBC](/integrations/connectors/data-integrations/drivers-and-interfaces/jdbc) or [ODBC](/integrations/connectors/data-integrations/drivers-and-interfaces/odbc) drivers. More information about software products that support ClickHouse is available [here](/integrations/connectors/home).
...
TCP endpoint example with [CLI](/integrations/connectors/data-integrations/drivers-and-interfaces/cli):
