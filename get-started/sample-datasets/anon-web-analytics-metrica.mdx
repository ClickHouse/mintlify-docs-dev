...
## Download and ingest the data <a id="download-and-ingest-the-data"></a>

### Download the hits compressed TSV file <a id="download-the-hits-compressed-tsv-file"></a>
...
### Create the database and table <a id="create-the-database-and-table"></a>
...
### Import the hits data <a id="import-the-hits-data"></a>
...
### Download the visits compressed TSV file <a id="download-the-visits-compressed-tsv-file"></a>
...
### Create the visits table <a id="create-the-visits-table"></a>
...
### Import the visits data <a id="import-the-visits-data"></a>
```bash
...
## An example JOIN <a id="an-example-join"></a>
