...
## Create the table trips <a id="create-the-table-trips"></a>
...
## Load the data directly from object storage <a id="load-the-data-directly-from-object-storage"></a>
...
## Download of prepared partitions <a id="download-of-prepared-partitions"></a>
...
## Results on single server <a id="results-on-single-server"></a>
