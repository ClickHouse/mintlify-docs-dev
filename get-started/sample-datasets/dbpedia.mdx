...
## Semantic search <a id="semantic-search"></a>
...
## Generating embeddings for search query <a id="generating-embeddings-for-search-query"></a>
...
## Q&A demo application <a id="q-and-a-demo-application"></a>
