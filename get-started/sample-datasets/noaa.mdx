...
### Original data <a id="original-data"></a>
...
#### Sampling the data <a id="sampling-the-data"></a>
...
### Enriching the data <a id="enriching-the-data"></a>
...
### Inserting from S3 <a id="inserting-from-s3"></a>
...
### Highest temperature ever <a id="highest-temperature-ever"></a>
...
### Best ski resorts <a id="best-ski-resorts"></a>
