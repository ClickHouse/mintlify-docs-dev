...
<Image img="/static/images/getting-started/example-datasets/visualization_1.png" size="md" alt="Density map of points of interest in Europe"/>

<Image img="/static/images/getting-started/example-datasets/visualization_2.png" size="md" alt="Sake bars in Japan"/>

<Image img="/static/images/getting-started/example-datasets/visualization_3.png" size="md" alt="ATMs"/>

<Image img="/static/images/getting-started/example-datasets/visualization_4.png" size="md" alt="Map of Europe with points of interest categorised by country"/>
