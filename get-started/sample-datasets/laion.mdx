...
## Run an approximate vector similarity search with a vector similarity index <a id="run-an-approximate-vector-similarity-search-with-a-vector-similarity-index"></a>
...
## Creating embeddings with UDFs <a id="creating-embeddings-with-udfs"></a>
...
### Text embeddings <a id="text-embeddings"></a>
...
### Image embeddings <a id="image-embeddings"></a>
