...
<Tip>
If you need to perform frequent updates, consider using [deduplication](/concepts/operations/insert/deduplication) in ClickHouse, which allows you to update 
and/or delete rows without generating a mutation event. Alternatively, use [lightweight updates](/reference/statements/update)
or [lightweight deletes](/concepts/operations/delete/lightweight-delete)
</Tip>
