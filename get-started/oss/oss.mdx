...
If you're looking to install a production instance of ClickHouse, please see the [install page](/get-started/setup/self-managed/install).
</Note>
...
- The user guide on [primary keys](/guides/cloud-oss/data-modelling/sparse-primary-indexes) is everything you need to know about primary keys and how to define them.
