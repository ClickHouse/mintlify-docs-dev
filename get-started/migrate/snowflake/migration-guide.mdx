...
<Steps>
<Step>
## Export data from Snowflake <a id="1-exporting-data-from-snowflake"></a>
...
<Step>
## Import to ClickHouse <a id="2-importing-to-clickhouse"></a>
...
<Step>
## Test successful data export <a id="3-testing-successful-data-export"></a>
