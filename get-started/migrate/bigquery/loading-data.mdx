...
## How long will exporting data to ClickHouse take? <a id="how-long-will-exporting-data-to-clickhouse-take"></a>
...
<Steps>
<Step>
## Export table data to GCS <a id="1-export-table-data-to-gcs"></a>
...
<Step>
## Importing data into ClickHouse from GCS <a id="2-importing-data-into-clickhouse-from-gcs"></a>
...
<Step>
## Testing successful data export <a id="3-testing-successful-data-export"></a>
...
## Further reading and support <a id="further-reading-and-support"></a>
