...
## Why use ClickHouse Cloud over BigQuery? <a id="why-use-clickhouse-cloud-over-bigquery"></a>
...
## Loading data from BigQuery to ClickHouse Cloud <a id="loading-data-from-bigquery-to-clickhouse-cloud"></a>
...
### Migrating data <a id="migrating-data"></a>
...
#### Bulk loading via Google Cloud Storage (GCS) <a id="bulk-loading-via-google-cloud-storage-gcs"></a>
...
### Real-time replication or CDC via scheduled queries <a id="real-time-replication-or-cdc-via-scheduled-queries"></a>
...
## Designing schemas <a id="designing-schemas"></a>
...
### Optimizing types <a id="optimizing-types"></a>
...
## How are ClickHouse Primary keys different? <a id="how-are-clickhouse-primary-keys-different"></a>
...
### Choosing an ordering key <a id="choosing-an-ordering-key"></a>
...
## Data modeling techniques <a id="data-modeling-techniques"></a>
...
## Materialized views vs projections <a id="materialized-views-vs-projections"></a>
...
### When to use projections <a id="when-to-use-projections"></a>
...
## Rewriting BigQuery queries in ClickHouse <a id="rewriting-bigquery-queries-in-clickhouse"></a>
...
## Conditionals and arrays <a id="conditionals-and-arrays"></a>
