...
## Resource organization <a id="resource-organization"></a>
...
### BigQuery Projects vs ClickHouse Cloud Services <a id="bigquery-projects-vs-clickhouse-cloud-services"></a>
...
### BigQuery Datasets vs ClickHouse Cloud Databases <a id="bigquery-datasets-vs-clickhouse-cloud-databases"></a>
...
### BigQuery Folders <a id="bigquery-folders"></a>

ClickHouse Cloud currently has no concept equivalent to BigQuery folders.

### BigQuery Slot reservations and Quotas <a id="bigquery-slot-reservations-and-quotas"></a>
...
## Query acceleration techniques <a id="query-acceleration-techniques"></a>

### Primary and Foreign keys and Primary index <a id="primary-and-foreign-keys-and-primary-index"></a>
...
## Secondary indexes (Only available in ClickHouse) <a id="secondary-indexes-only-available-in-clickhouse"></a>
...
## Search indexes <a id="search-indexes"></a>
...
## Vector indexes <a id="vector-indexes"></a>
...
## Querying materialized views <a id="querying-materialized-views"></a>
...
## Data sources and file formats <a id="data-sources-and-file-formats"></a>
...
## SQL language features <a id="sql-language-features"></a>
