...
| [`GEOGRAPHY`](https://docs.aws.amazon.com/redshift/latest/dg/geospatial-overview.html)                                               | [Geo Data Types](/reference/data-types/geo) (less developed e.g. no coordinate systems - can be emulated [with functions](/reference/functions/regular-functions/geo))                                                                                                                                                                                                                        |
...
| [`SUPER`](https://docs.aws.amazon.com/redshift/latest/dg/r_SUPER_type.html)                                                          | [`Tuple`](/reference/data-types/tuple), [`Nested`](/reference/data-types/nested-data-structures), [`Array`](/reference/data-types/array), [`JSON`](/reference/data-types/newjson), [`Map`](/reference/data-types/map) |
