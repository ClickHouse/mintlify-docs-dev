...
## Postgres vs ClickHouse: Equivalent and different concepts <a id="postgres-vs-clickhouse-equivalent-and-different-concepts"></a>
...
### Shards vs replicas <a id="shards-vs-replicas"></a>
...
## User implications <a id="user-implications"></a>
...
## Consistent routing <a id="consistent-routing"></a>
...
## ClickHouse Cloud <a id="clickhouse-cloud"></a>
...
## ClickHouse OSS <a id="clickhouse-oss"></a>
...
## Sequential consistency <a id="sequential-consistency"></a>
...
## Transactional (ACID) support <a id="transactional-acid-support"></a>
...
## Data type mappings <a id="data-type-mappings"></a>
