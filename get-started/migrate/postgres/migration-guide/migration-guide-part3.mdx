...
## Primary (Ordering) Keys in ClickHouse <a id="primary-ordering-keys-in-clickhouse"></a>
...
### Applications of partitions <a id="applications-of-partitions"></a>
...
### Recommendations for partitions <a id="recommendations-for-partitions"></a>
...
## Denormalization <a id="denormalization"></a>
