...
## Why use ClickHouse over Postgres? <a id="why-use-clickhouse-over-postgres"></a>
...
## Migration strategies <a id="migration-strategies"></a>
...
### Real-time replication (CDC) <a id="real-time-replication-cdc"></a>
...
### Manual bulk load + periodic updates <a id="manual-bulk-load-periodic-updates"></a>
...
### Which strategy to choose? <a id="which-strategy-to-choose"></a>
