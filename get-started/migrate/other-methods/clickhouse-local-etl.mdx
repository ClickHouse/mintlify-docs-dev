...
## What is clickhouse-local? <a id="what-is-clickhouse-local"></a>
...
## Installing clickhouse-local <a id="installing-clickhouse-local"></a>
...
## Example: Migrating from MySQL to ClickHouse Cloud with an Integration engine <a id="example-1-migrating-from-mysql-to-clickhouse-cloud-with-an-integration-engine"></a>
...
### On the destination ClickHouse Cloud service: <a id="on-the-destination-clickhouse-cloud-service"></a>

#### Create the destination database: <a id="create-the-destination-database"></a>

  ```sql
  CREATE DATABASE db
  ```

#### Create a destination table that has a schema equivalent to the MySQL table: <a id="create-a-destination-table-that-has-a-schema-equivalent-to-the-mysql-table"></a>
...
### On the clickhouse-local host machine: <a id="on-the-clickhouse-local-host-machine"></a>

#### Run clickhouse-local with the migration query: <a id="run-clickhouse-local-with-the-migration-query"></a>
