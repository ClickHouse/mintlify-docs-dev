...
#### Keeper configuration settings <a id="keeper-configuration-settings"></a>
...
#### Internal coordination settings <a id="internal-coordination-settings"></a>
...
### Four letter word commands <a id="four-letter-word-commands"></a>
...
### HTTP control <a id="http-control"></a>
...
### Feature flags <a id="feature-flags"></a>
...
### Migration from ZooKeeper <a id="migration-from-zookeeper"></a>
...
#### Pre-migration preparation <a id="pre-migration-preparation"></a>
...
#### Migration steps <a id="migration-steps"></a>
...
#### Consolidating multiple ZooKeeper clusters <a id="consolidating-multiple-zookeeper-clusters"></a>
...
#### Handling encryption and ACLs <a id="handling-encryption-and-acls"></a>
...
#### Verifying the migration <a id="verifying-the-migration"></a>
...
#### Post-migration tuning <a id="post-migration-tuning"></a>
...
### Recovering after losing quorum <a id="recovering-after-losing-quorum"></a>
...
## Using disks with Keeper <a id="using-disks-with-keeper"></a>
...
### Changing disk setup <a id="changing-disk-setup"></a>
...
## Configuring logs cache <a id="configuring-logs-cache"></a>
...
## ClickHouse Keeper user guide <a id="clickhouse-keeper-user-guide"></a>
...
### 1. Configure nodes with Keeper settings <a id="1-configure-nodes-with-keeper-settings"></a>
...
### 2.  Configure a cluster in ClickHouse <a id="2--configure-a-cluster-in-clickhouse"></a>
...
### 3. Create and test distributed table <a id="3-create-and-test-distributed-table"></a>
...
## Configuring ClickHouse Keeper with unique paths <a id="configuring-clickhouse-keeper-with-unique-paths"></a>
...
### Example environment <a id="example-environment"></a>
...
### Procedures to set up tables to use `{uuid}` <a id="procedures-to-set-up-tables-to-use-uuid"></a>
...
## ClickHouse Keeper dynamic reconfiguration <a id="reconfiguration"></a>
...
## Converting a single-node keeper into a cluster <a id="converting-a-single-node-keeper-into-a-cluster"></a>
...
## Unsupported features <a id="unsupported-features"></a>
