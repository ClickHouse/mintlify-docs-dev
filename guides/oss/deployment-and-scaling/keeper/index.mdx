...
ClickHouse Keeper provides the coordination system for data [replication](/reference/engines/table-engines/mergetree-family/replication) and [distributed DDL](/snippets/distributed-ddl) queries execution. ClickHouse Keeper is compatible with ZooKeeper.
