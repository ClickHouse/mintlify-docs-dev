...
## What are table shards in ClickHouse? <a id="what-are-table-shards-in-clickhouse"></a>
...
## Distributed table creation <a id="distributed-table-creation"></a>
...
## INSERT routing <a id="insert-routing"></a>
...
## SELECT forwarding <a id="select-forwarding"></a>
...
## What are table replicas in ClickHouse? <a id="what-are-table-replicas-in-clickhouse"></a>
