...
<Image img="/static/images/managing-data/core-concepts/shards_01.png" size="lg" alt='SHARDS'/>

<br/>

In such a case the data can be split over multiple ClickHouse servers in the form of table shards:

<Image img="/static/images/managing-data/core-concepts/shards_02.png" size="lg" alt='SHARDS'/>
...
<Image img="/static/images/managing-data/core-concepts/shards_03.png" size="lg" alt='SHARDS'/>
...
<Image img="/static/images/managing-data/core-concepts/shards_04.png" size="lg" alt='SHARDS'/>
...
<Image img="/static/images/managing-data/core-concepts/shards_replicas_01.png" size="lg" alt='SHARDS'/>
