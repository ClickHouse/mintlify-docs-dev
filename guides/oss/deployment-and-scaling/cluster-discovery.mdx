...
## Remote servers configuration <a id="remote-servers-configuration"></a>

### Traditional manual configuration <a id="traditional-manual-configuration"></a>
...
### Using cluster discovery <a id="using-cluster-discovery"></a>
...
### Observer mode <a id="observer-mode"></a>
...
### Discovery of clusters <a id="discovery-of-clusters"></a>
...
## Use cases and limitations <a id="use-cases-and-limitations"></a>
