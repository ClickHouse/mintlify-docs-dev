...
## 1. Use S3 as a ClickHouse disk <a id="1-use-s3-as-a-clickhouse-disk"></a>
...
## 2. Create a table backed by S3 <a id="2-create-a-table-backed-by-s3"></a>
...
<Image img="/images/guides/s3_bucket_example.png" size="md" alt="S3 bucket example using separation of compute and storage" border/>

## 3. Implementing replication for fault tolerance (optional) <a id="3-implementing-replication-for-fault-tolerance-optional"></a>
