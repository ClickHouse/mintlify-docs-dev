...
<Image img="/images/deployment-guides/replication-sharding-examples/both.png" size='md' alt='Architecture diagram for 2 shards and 1 replica' />
...
#### Cluster configuration <a id="cluster-config"></a>
...
### User configuration <a id="cluster-configuration"></a>
...
<Step>
## Insert data into a distributed table <a id="inserting-data-using-distributed"></a>
