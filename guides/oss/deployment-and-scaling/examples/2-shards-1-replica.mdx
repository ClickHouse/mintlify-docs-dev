...
<Image img="/images/deployment-guides/replication-sharding-examples/sharding.png" size='md' alt='Architecture diagram for 2 shards and 1 replica' />

<DedicatedKeeperServers/>

## Prerequisites <a id="pre-requisites"></a>
...
<Steps>
<Step>
## Set up directory structure and test environment <a id="set-up"></a>
...
<Step>
## Configure ClickHouse nodes <a id="configure-clickhouse-servers"></a>
...
#### Networking and logging <a id="networking"></a>
...
#### Cluster configuration <a id="cluster-configuration"></a>
...
#### Keeper configuration <a id="keeper-config-explanation"></a>
...
#### Macros configuration <a id="macros-config-explanation"></a>
...
### User configuration <a id="user-config"></a>
...
<Step>
## Configure ClickHouse Keeper <a id="configure-clickhouse-keeper-nodes"></a>

### Keeper setup <a id="configuration-explanation"></a>
...
<Step>
## Test the setup <a id="test-the-setup"></a>
...
<Step>
## Create a database <a id="creating-a-database"></a>
...
<Step>
## Create a table on the cluster <a id="creating-a-table"></a>
...
<Step>
## Create a distributed table <a id="create-distributed-table"></a>
...
<Step>
## Insert data into a distributed table <a id="inserting-data-into-distributed-table"></a>
