...
import ConfigFileNote from '/snippets/_config-files.mdx';
import KeeperConfigFileNote from '/snippets/_keeper-config-files.mdx';
...
<Image img="/static/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="Architecture diagram for 1 shard and 2 replicas with ReplicatedMergeTree" />
