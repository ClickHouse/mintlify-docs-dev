...
## ClickHouse upgrade overview <a id="clickhouse-upgrade-overview"></a>
...
### Upgrade ClickHouse server separately from ClickHouse Keeper or ZooKeeper <a id="upgrade-clickhouse-server-separately-from-clickhouse-keeper-or-zookeeper"></a>
...
### Minor version upgrades should be adopted often <a id="minor-version-upgrades-should-be-adopted-often"></a>
...
### Test experimental features on a separate ClickHouse server running the target version <a id="test-experimental-features-on-a-separate-clickhouse-server-running-the-target-version"></a>
...
### Multiple ClickHouse server versions in a cluster <a id="multiple-clickhouse-server-versions-in-a-cluster"></a>
...
### Incremental upgrades <a id="incremental-upgrades"></a>
...
## Recommended plan <a id="recommended-plan"></a>
...
## ClickHouse server binary upgrade process <a id="clickhouse-server-binary-upgrade-process"></a>
