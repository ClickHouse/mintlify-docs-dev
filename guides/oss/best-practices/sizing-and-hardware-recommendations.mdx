...
### Optimizing for performance <a id="optimizing-for-performance"></a>
...
### Optimizing for storage costs <a id="optimizing-for-storage-costs"></a>
...
### Which CPU should I use? <a id="which-cpu-should-i-use"></a>
...
### What should CPU utilization be? <a id="what-should-cpu-utilization-be"></a>
...
### How many CPU cores should I use? <a id="how-many-cpu-cores-should-i-use"></a>
...
### What should the memory-to-storage ratio be? <a id="what-should-the-memory-to-storage-ratio-be"></a>
...
## Example configurations for large workloads <a id="example-configurations-for-large-workloads"></a>
...
### Fortune 500 B2B SaaS <a id="fortune-500-b2b-saas"></a>
...
### Fortune 500 Telecom Operator for a logging use case <a id="fortune-500-telecom-operator-for-a-logging-use-case"></a>
