...
## Test Data and Resources <a id="test-data-and-resources"></a>
...
## Join types supported in ClickHouse <a id="join-types-supported-in-clickhouse"></a>
...
## (LEFT / RIGHT / FULL) OUTER JOIN <a id="left--right--full-outer-join"></a>
...
<Image img="/images/starter_guides/joins/cross_join.png" alt="Cross Join" />
...
## (LEFT / RIGHT) SEMI JOIN <a id="left--right-semi-join"></a>
...
## (LEFT / RIGHT) ANTI JOIN <a id="left--right-anti-join"></a>
...
## (LEFT / RIGHT / INNER) ANY JOIN <a id="left--right--inner-any-join"></a>
