...
## Importing based on a template <a id="importing-based-on-a-template"></a>
...
### Skipping whitespaces <a id="skipping-whitespaces"></a>
...
## Exporting data using templates <a id="exporting-data-using-templates"></a>
...
### Exporting to HTML files <a id="exporting-to-html-files"></a>
...
### Exporting to XML <a id="exporting-to-xml"></a>
...
## Importing data based on regular expressions <a id="importing-data-based-on-regular-expressions"></a>
