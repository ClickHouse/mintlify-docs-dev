...
## Importing and exporting in Avro format <a id="importing-and-exporting-in-avro-format"></a>
...
To import from an [avro file](/assets/data.avro), we should use [Avro](/reference/formats/Avro/Avro) format in the `INSERT` statement:
...
### Avro and ClickHouse data types <a id="avro-and-clickhouse-data-types"></a>
...
### Avro messages in Kafka <a id="avro-messages-in-kafka"></a>
...
## Working with Arrow format <a id="working-with-arrow-format"></a>

Another columnar format is [Apache Arrow](https://arrow.apache.org/), also supported by ClickHouse for import and export. To import data from an [Arrow file](/assets/data.arrow), we use the [Arrow](/reference/formats/Arrow/Arrow) format:
...
### Arrow data streaming <a id="arrow-data-streaming"></a>
...
## Importing and exporting ORC data <a id="importing-and-exporting-orc-data"></a>

[Apache ORC](https://orc.apache.org/) format is a columnar storage format typically used for Hadoop. ClickHouse supports importing as well as exporting [Orc data](/assets/data.orc) using [ORC format](/reference/formats/ORC):
