...
## Overriding data types as strings <a id="overriding-data-types-as-strings"></a>
...
## Exporting metadata together with data <a id="exporting-metadata-together-with-data"></a>
...
## Compact way to export JSON data and structure <a id="compact-way-to-export-json-data-and-structure"></a>
...
## Exporting JSON to a file <a id="exporting-json-to-a-file"></a>
