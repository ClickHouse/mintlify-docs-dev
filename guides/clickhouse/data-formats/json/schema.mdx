...
## Static vs dynamic JSON <a id="static-vs-dynamic-json"></a>
...
## Handling static structures <a id="handling-static-structures"></a>
...
### Handling default values <a id="handling-default-values"></a>
...
### Handling new columns <a id="handling-new-columns"></a>
...
## Handling semi-structured/dynamic structures <a id="handling-semi-structured-dynamic-structures"></a>
...
### Single JSON column <a id="single-json-column"></a>
...
### Targeted JSON column <a id="targeted-json-column"></a>
...
### Using type hints and skipping paths <a id="using-type-hints-and-skipping-paths"></a>
...
#### Optimizing performance with type hints <a id="optimizing-performance-with-type-hints"></a>
...
### Configuring dynamic paths <a id="configuring-dynamic-paths"></a>
