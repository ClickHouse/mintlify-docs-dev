...
## When to use type inference <a id="when-to-use-type-inference"></a>
...
## Detecting types <a id="detecting-types"></a>
...
## Querying JSON <a id="querying-json"></a>
...
## Creating tables <a id="creating-tables"></a>
...
### Creating tables from snippets <a id="creating-tables-from-snippets"></a>
...
## Loading JSON data <a id="loading-json-data"></a>
...
## Working with semi-structured and dynamic data <a id="working-with-semi-structured-data"></a>
