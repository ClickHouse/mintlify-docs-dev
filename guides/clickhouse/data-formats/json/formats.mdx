...
## Reading JSON as an object <a id="reading-json-as-an-object"></a>
...
## Array of JSON objects <a id="array-of-json-objects"></a>
...
To import a list of JSON objects, we can use a [`JSONEachRow`](/reference/formats/JSON/JSONEachRow) format (inserting data from [list.json](/assets/list.json) file):
...
## JSON object keys <a id="json-object-keys"></a>
...
### Specifying parent object key values <a id="specifying-parent-object-key-values"></a>
...
## JSON arrays <a id="json-arrays"></a>

Sometimes, for the sake of saving space, JSON files are encoded in arrays instead of objects. In this case, we deal with a [list of JSON arrays](/assets/arrays.jsonl):
...
### Importing individual columns from JSON arrays <a id="importing-individual-columns-from-json-arrays"></a>
...
A more compact format is also supported when dealing with an [array of columns](/assets/columns-array.json) instead of an object using [`JSONCompactColumns`](/reference/formats/JSON/JSONCompactColumns) format:
...
## Saving JSON objects instead of parsing <a id="saving-json-objects-instead-of-parsing"></a>
...
## Schema for nested objects <a id="schema-for-nested-objects"></a>

In cases when we're dealing with [nested JSON objects](/assets/list-nested.json), we can additionally define an explicit schema and use complex types ([`Array`](/reference/data-types/array), [`JSON`](/guides/clickhouse/data-formats/json/intro) or [`Tuple`](/reference/data-types/tuple)) to load data:
...
## Accessing nested JSON objects <a id="accessing-nested-json-objects"></a>

We can refer to [nested JSON keys](/assets/list-nested.json) by enabling the [following settings option](/reference/settings/formats#input_format_import_nested_json):
...
## Skipping unknown columns <a id="skipping-unknown-columns"></a>
...
To import BSON data, we use the [BSONEachRow](/reference/formats/BSONEachRow) format. Let's import data from [this BSON file](/assets/data.bson):
