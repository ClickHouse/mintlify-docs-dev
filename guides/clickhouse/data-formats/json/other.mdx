...
## Using the String type <a id="using-string"></a>
...
### Simple JSON functions <a id="simple-json-functions"></a>
...
## Using the Map type <a id="using-map"></a>
...
#### Primitive values <a id="primitive-values"></a>
...
#### Object values <a id="object-values"></a>
...
## Using the Nested type <a id="using-nested"></a>
...
### flatten_nested <a id="flatten_nested"></a>

The setting `flatten_nested` controls the behavior of nested.

#### flatten_nested=1 <a id="flatten_nested1"></a>
...
#### flatten_nested=0 <a id="flatten_nested0"></a>
...
### Using pairwise arrays <a id="using-pairwise-arrays"></a>
