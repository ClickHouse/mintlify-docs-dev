...
## Loading structured JSON <a id="loading-structured-json"></a>
...
## Loading semi-structured JSON <a id="loading-semi-structured-json"></a>
...
### When to use the JSON type <a id="when-to-use-the-json-type"></a>
