...
## Importing data from a CSV file <a id="importing-data-from-a-csv-file"></a>
...
### CSV files with headers <a id="csv-files-with-headers"></a>
...
### CSV files with custom delimiters <a id="csv-files-with-custom-delimiters"></a>
...
### Skipping lines in a CSV file <a id="skipping-lines-in-a-csv-file"></a>
...
### Treating NULL values in CSV files <a id="treating-null-values-in-csv-files"></a>
...
## TSV (tab-separated) files <a id="tsv-tab-separated-files"></a>

Tab-separated data format is widely used as a data interchange format. To load data from a [TSV file](/assets/data_small.tsv) to ClickHouse, the [TabSeparated](/reference/formats/TabSeparated/TabSeparated) format is used:
...
## Exporting to CSV <a id="exporting-to-csv"></a>
...
### Saving exported data to a CSV file <a id="saving-exported-data-to-a-csv-file"></a>
...
### Exporting CSV with custom delimiters <a id="exporting-csv-with-custom-delimiters"></a>
...
### Exporting CSV for Windows <a id="exporting-csv-for-windows"></a>
...
## Schema inference for CSV files <a id="schema-inference-for-csv-files"></a>
...
### Exporting and importing CSV with explicit column types <a id="exporting-and-importing-csv-with-explicit-column-types"></a>
...
## Custom delimiters, separators, and escaping rules <a id="custom-delimiters-separators-and-escaping-rules"></a>
...
## Working with large CSV files <a id="working-with-large-csv-files"></a>
