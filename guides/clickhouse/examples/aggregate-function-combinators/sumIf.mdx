...
### Calculate trading volume by price direction <a id="calculate-trading-vol-price-direction"></a>
...
### Calculate trading volume by stock symbol <a id="calculate-trading-volume"></a>
