...
## Understand query performance <a id="understand-query-performance"></a>
...
## Spot the slow queries <a id="spot-the-slow-queries"></a>

### Query logs <a id="query-logs"></a>
...
### Explain statement <a id="explain-statement"></a>
...
<Image img="/images/guides/best-practices/query_optimization_diagram_1.png" size="lg" alt="Optimization workflow"/>
...
## Basic optimization <a id="basic-optimization"></a>
...
### Low cardinality <a id="low-cardinality"></a>
...
### Optimize data type <a id="optimize-data-type"></a>
...
### Apply the optimizations <a id="apply-the-optimizations"></a>
...
## The importance of primary keys <a id="the-importance-of-primary-keys"></a>
...
### Choose primary keys <a id="choose-primary-keys"></a>
