...
## Selecting columns that match a pattern <a id="selecting-columns"></a>
...
## Selecting multiple patterns <a id="selecting-multiple-patterns"></a>
...
## Apply functions to all columns <a id="applying-functions"></a>
...
## Replacing columns <a id="replacing-columns"></a>
...
## Excluding columns <a id="excluding-columns"></a>
