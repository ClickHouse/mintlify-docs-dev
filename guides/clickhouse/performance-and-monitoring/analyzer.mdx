...
## Known incompatibilities <a id="known-incompatibilities"></a>
...
### Invalid queries are no longer optimized <a id="invalid-queries-are-no-longer-optimized"></a>
...
### `CREATE VIEW` with an invalid query <a id="create-view-with-invalid-query"></a>
...
### Known incompatibilities of the `JOIN` clause <a id="known-incompatibilities-of-the-join-clause"></a>

#### `JOIN` using a column from a projection <a id="join-using-column-from-projection"></a>
...
#### Changes in behavior with `JOIN USING` and `ALIAS`/`MATERIALIZED` columns <a id="changes-in-behavior-with-join-using-and-aliasmaterialized-columns"></a>
...
#### Handling of type modifiers for columns in the `USING` clause <a id="handling-of-type-modifiers-for-columns-in-using-clause"></a>
...
### Projection column names changes <a id="projection-column-names-changes"></a>
...
### Incompatible function arguments types <a id="incompatible-function-arguments-types"></a>
...
### Heterogeneous clusters <a id="heterogeneous-clusters"></a>
...
### Mutations are interpreted by previous analyzer <a id="mutations-are-interpreted-by-previous-analyzer"></a>
...
## Cloud Migration <a id="cloud-migration"></a>
...
### Migration workflow <a id="migration-workflow"></a>
...
### Unknown expression identifier <a id="unknown-expression-identifier"></a>
...
### Non-Aggregated Columns in GROUP BY <a id="non-aggregated-columns-in-group-by"></a>
...
### Duplicate CTE names <a id="duplicate-cte-names"></a>
...
### Ambiguous column identifiers <a id="ambiguous-column-identifiers"></a>
...
### Invalid usage of FINAL <a id="invalid-usage-of-final"></a>
...
### `countDistinct()` function case-insensitivity <a id="countdistinct-case-insensitivity"></a>
