...
### Test machine <a id="test-machine"></a>
...
### A full table scan <a id="a-full-table-scan"></a>
...
## ClickHouse index design <a id="clickhouse-index-design"></a>

### An index design for massive data scales <a id="an-index-design-for-massive-data-scales"></a>
...
### A table with a primary key <a id="a-table-with-a-primary-key"></a>
...
### Data is stored on disk ordered by primary key columns <a id="data-is-stored-on-disk-ordered-by-primary-key-columns"></a>
...
ClickHouse is a <a href="/get-started/about/distinctive-features#true-column-oriented-dbms" target="_blank">column-oriented database management system</a>. As shown in the diagram below
...
### Data is organized into granules for parallel data processing <a id="data-is-organized-into-granules-for-parallel-data-processing"></a>
...
### The primary index has one entry per granule <a id="the-primary-index-has-one-entry-per-granule"></a>
...
### The primary index is used for selecting granules <a id="the-primary-index-is-used-for-selecting-granules"></a>
...
### Mark files are used for locating granules <a id="mark-files-are-used-for-locating-granules"></a>
...
## Using multiple primary indexes <a id="using-multiple-primary-indexes"></a>

<a name="filtering-on-key-columns-after-the-first"></a>

### Secondary key columns can (not) be inefficient <a id="secondary-key-columns-can-not-be-inefficient"></a>
...
### Generic exclusion search algorithm <a id="generic-exclusion-search-algorithm"></a>
...
### Note about data skipping index <a id="note-about-data-skipping-index"></a>
...
### A need to use multiple primary indexes <a id="a-need-to-use-multiple-primary-indexes"></a>
...
### Options for creating additional primary indexes <a id="options-for-creating-additional-primary-indexes"></a>
...
### Option 1: Secondary Tables <a id="option-1-secondary-tables"></a>
...
### Option 2: Materialized Views <a id="option-2-materialized-views"></a>
...
### Option 3: Projections <a id="option-3-projections"></a>
...
## Ordering key columns efficiently <a id="ordering-key-columns-efficiently"></a>
...
### Efficient filtering on secondary key columns <a id="efficient-filtering-on-secondary-key-columns"></a>
...
### Optimal compression ratio of data files <a id="optimal-compression-ratio-of-data-files"></a>
...
## Identifying single rows efficiently <a id="identifying-single-rows-efficiently"></a>
...
### A concrete example <a id="a-concrete-example"></a>
