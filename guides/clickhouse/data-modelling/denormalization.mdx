...
## Comparing Normalized vs. Denormalized Schemas <a id="comparing-normalized-vs-denormalized-schemas"></a>
...
<Image img="/images/data-modeling/denormalization-diagram.png" size="lg" alt="Denormalization in ClickHouse"/>
...
## When to use denormalization <a id="when-to-use-denormalization"></a>
...
## Avoid denormalization on frequently updated data <a id="avoid-denormalization-on-frequently-updated-data"></a>
...
## Practical cases for denormalization <a id="practical-cases-for-denormalization"></a>
...
### Posts and Votes <a id="posts-and-votes"></a>
...
### Users and Badges <a id="users-and-badges"></a>

Now let's consider our `Users` and `Badges`:

<Image img="/images/data-modeling/denormalization-schema.png" size="lg" alt="Users and Badges schema"/>
...
### Posts and PostLinks <a id="posts-and-postlinks"></a>
...
### Simple statistic example <a id="simple-statistic-example"></a>
...
### Exploiting complex types for one-to-many relationships <a id="exploiting-complex-types-for-one-to-many-relationships"></a>
...
## Orchestrating and scheduling denormalization <a id="orchestrating-and-scheduling-denormalization"></a>
