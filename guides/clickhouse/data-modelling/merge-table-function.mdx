...
## Setup tables <a id="setup-tables"></a>
...
## Schema of multiple tables <a id="schema-multiple-tables"></a>
...
## Querying multiple tables with merge <a id="querying-multiple-tables"></a>
...
## Which table do rows come from when using merge? <a id="which-table-merge"></a>
