...
## Backfilling scenarios <a id="backfilling-scenarios"></a>
...
## Using duplicate tables and views <a id="using-duplicate-tables-and-views"></a>
...
## Scenario 1: Backfilling data with existing data ingestion <a id="scenario-1-backfilling-data-with-existing-data-ingestion"></a>
...
## Scenario 2: Adding materialized views to existing tables <a id="scenario-2-adding-materialized-views-to-existing-tables"></a>
...
### Timestamp or Monotonically increasing column available <a id="timestamp-or-monotonically-increasing-column-available"></a>
...
#### Using a Null table engine for filling materialized views <a id="using-a-null-table-engine-for-filling-materialized-views"></a>
...
<Image img="/images/data-modeling/null_table_mv.png" size="md" alt="Denormalization in ClickHouse"/>
...
##### Tuning performance & resources <a id="tuning-performance--resources"></a>
...
### No timestamp or monotonically increasing column <a id="no-timestamp-or-monotonically-increasing-column"></a>
