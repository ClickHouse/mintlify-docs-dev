...
## Alternatives to stored procedures in ClickHouse <a id="alternatives-to-stored-procedures"></a>
...
#### Executable UDFs <a id="executable-udfs"></a>
...
### Parameterized views <a id="parameterized-views"></a>
...
### External orchestration <a id="external-orchestration"></a>
...
#### Using application code <a id="using-application-code"></a>
...
#### Using workflow orchestration tools <a id="using-workflow-orchestration-tools"></a>
...
## Alternatives to prepared statements in ClickHouse <a id="alternatives-to-prepared-statements-in-clickhouse"></a>
...
### Syntax <a id="query-parameters-syntax"></a>

There are two ways to define query parameters:

#### Method 1: using `SET` <a id="method-1-using-set"></a>
...
#### Method 2: using CLI parameters <a id="method-2-using-cli-parameters"></a>
...
### Parameter syntax <a id="parameter-syntax"></a>
...
### Data type examples <a id="data-type-examples"></a>
...
### Limitations of query parameters <a id="limitations-of-query-parameters"></a>
...
### MySQL protocol prepared statements <a id="mysql-protocol-prepared-statements"></a>
...
### ClickHouse alternatives to stored procedures <a id="summary-stored-procedures"></a>
...
### Use of query parameters <a id="summary-query-parameters"></a>
