...
## Simple uniform dataset <a id="simple-uniform-dataset"></a>
...
## Exponential distribution <a id="exponential-distribution"></a>
...
## Time-distributed events (Poisson) <a id="poisson-distribution"></a>
...
## Time-varying normal distribution <a id="time-varying-normal-distribution"></a>
...
## Categorical and nested data <a id="categorical-and-nested-data"></a>
...
## Generating random tables <a id="generating-random-tables"></a>
