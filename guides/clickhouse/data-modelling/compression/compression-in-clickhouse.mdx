...
## Choose the right data type to optimize compression <a id="choose-the-right-data-type-to-optimize-compression"></a>
...
## Choosing the right column compression codec <a id="choosing-the-right-column-compression-codec"></a>
...
### Compression in ClickHouse Cloud <a id="compression-in-clickhouse-cloud"></a>
