...
<Image img="/static/images/data-modeling/stackoverflow-schema.png" size="lg" alt="Stack Overflow Schema"/>
...
<Image img="/static/images/data-modeling/schema-design-indices.png" size="md" alt="Sparse Indexing in ClickHouse"/>
