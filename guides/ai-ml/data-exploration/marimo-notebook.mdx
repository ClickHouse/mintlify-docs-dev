...
In this guide, you will learn how you can explore a dataset on ClickHouse Cloud data in Marimo notebook with the help of [chDB](/products/chdb) - a fast in-process SQL OLAP Engine powered by ClickHouse.
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/1.png" alt="Add example data set"/>

Select `Get started` in the UK property price paid data (4GB) card:

<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/2.png" alt="Select UK price paid dataset"/>

Then click `Import dataset`:

<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/3.png" alt="Import UK price paid dataset"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/Marimo/4.png" alt="Marimo interface"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/Marimo/5.png" alt="Marimo hello world"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/Marimo/6.png" alt="Marimo data visualization"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/Marimo/7.gif" alt="Marimo dynamic chart"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/Marimo/8.gif" alt="Marimo dynamic chart"/>
