...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/4.png" alt="Create a new notebook"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/5.png" alt="Select kernel"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/6.png" alt="dataframe preview"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/7.png" alt="dataframe preview"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/8.png" alt="dataframe preview"/>
...
<Image size="md" img="/static/images/use-cases/AI_ML/jupyter/9.png" alt="Plot of remote data set and local data set"/>
