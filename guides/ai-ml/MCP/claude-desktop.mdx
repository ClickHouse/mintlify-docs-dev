...
<Image img="/static/images/use-cases/AI_ML/MCP/claude-desktop-config.png" alt="Claude Desktop configuration" size="md" />
...
<Image img="/static/images/use-cases/AI_ML/MCP/find-mcp-servers.gif" alt="Find MCP servers" size="md" />
<br/>
...
<Image img="/static/images/use-cases/AI_ML/MCP/mcp-permission.png" alt="Give permission to use the list_databases tool" size="md" />

Below you can see part of a conversation that includes some tool calls to the ClickHouse MCP server:

<Image img="/static/images/use-cases/AI_ML/MCP/claude-conversation.png" alt="Claude conversation" size="md" />
