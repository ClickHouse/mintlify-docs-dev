...
<Image img="/static/images/use-cases/AI_ML/MCP/0_endpoints.png" alt="Open API endpoints" size="md"/>

To use these endpoints with Open WebUI, we need to navigate to settings:

<Image img="/static/images/use-cases/AI_ML/MCP/1_settings.png" alt="Open WebUI settings" size="md"/>

Click on `Tools`:

<Image img="/static/images/use-cases/AI_ML/MCP/2_tools_page.png" alt="Open WebUI tools" size="md"/>

Add http://localhost:8000 as the tool URL:

<Image img="/static/images/use-cases/AI_ML/MCP/3_add_tool.png" alt="Open WebUI tool" size="md"/>

Once we've done this, we should see a `1` next to the tool icon on the chat bar:

<Image img="/static/images/use-cases/AI_ML/MCP/4_tools_available.png" alt="Open WebUI tools available" size="md"/>

If we click on the tool icon, we can then list the available tools:

<Image img="/static/images/use-cases/AI_ML/MCP/5_list_of_tools.png" alt="Open WebUI tool listing" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/MCP/6_connections.png" alt="Open WebUI connections" size="md"/>

Let's add the endpoint and our OpenAI key:

<Image img="/static/images/use-cases/AI_ML/MCP/7_add_connection.png" alt="Open WebUI - Add OpenAI as a connection" size="md"/>

The OpenAI models will then be available on the top menu:

<Image img="/static/images/use-cases/AI_ML/MCP/8_openai_models_more.png" alt="Open WebUI - Models" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/MCP/9_conversation.png" alt="Open WebUI - Chat with ClickHouse MCP server" size="md"/>
