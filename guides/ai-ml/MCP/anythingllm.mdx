...
<Image img="/static/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="Tool icon" size="md"/>

Click on `Agent Skills` and look under the `MCP servers` section. 
Wait until you see `Mcp ClickHouse` set to `On`

<Image img="/static/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="MCP servers ready" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/MCP/allm_conversation.png" alt="Conversation" size="md"/>
