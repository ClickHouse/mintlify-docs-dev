...
## Creating a connection between Lakehouse runtime catalog and ClickHouse <a id="creating-a-connection"></a>
...
## Querying Lakehouse runtime catalog tables using ClickHouse <a id="querying-lakehouse-runtime-tables"></a>
...
## Loading data from Lakehouse into ClickHouse <a id="loading-data-into-clickhouse"></a>
