...
## Why use ClickHouse with open table formats? <a id="why-clickhouse-uses-lake-formats"></a>

### Query existing data in place <a id="querying-data-in-place"></a>
...
### Real-time analytical workloads with ClickHouse <a id="real-time-with-clickhouse"></a>
...
### Read data directly <a id="read-data-directly"></a>
...
### Expose catalogs as databases <a id="expose-catalogs-as-databases"></a>
...
### Write back to open table formats <a id="write-back-to-lakehouse-formats"></a>
