...
### Setting up Local Nessie Catalog <a id="setting-up-local-nessie-catalog"></a>
...
### Connecting to Local Nessie Catalog <a id="connecting-to-local-nessie-catalog"></a>
...
## Querying Nessie catalog tables using ClickHouse <a id="querying-nessie-catalog-tables-using-clickhouse"></a>
