...
## Configuring Glue in AWS <a id="configuring"></a>
...
## Creating a connection between Glue data catalog and ClickHouse <a id="connecting"></a>
...
### AWS Access Key/Secret <a id="aws-access-key-secret"></a>
...
## Query the Glue data catalog using ClickHouse <a id="query-glue-catalog"></a>
...
## Loading data from your Data Lake into ClickHouse <a id="loading-data-into-clickhouse"></a>
