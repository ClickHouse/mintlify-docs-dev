...
<Steps>
<Step>
## Creating a connection between Polaris and ClickHouse <a id="connecting"></a>
...
<Step>
## Query the Polaris catalog using ClickHouse <a id="query-polaris-catalog"></a>
...
<Step>
## Loading data from Polaris into ClickHouse <a id="loading-data-into-clickhouse"></a>
