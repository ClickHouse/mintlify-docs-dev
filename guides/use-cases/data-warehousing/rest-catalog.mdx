...
### Setting up Local REST Catalog <a id="setting-up-local-rest-catalog"></a>
...
### Connecting to Local REST Catalog <a id="connecting-to-local-rest-catalog"></a>
...
## Querying REST catalog tables using ClickHouse <a id="querying-rest-catalog-tables-using-clickhouse"></a>
