...
## Configuring Unity in Databricks <a id="configuring-unity-in-databricks"></a>
...
### Required PAT token permissions <a id="required-pat-token-permissions"></a>
...
## Creating a connection between Unity Catalog and ClickHouse <a id="creating-a-connection-between-unity-catalog-and-clickhouse"></a>
...
### Read Iceberg <a id="read-iceberg"></a>
...
## Querying Unity catalog tables using ClickHouse <a id="querying-unity-catalog-tables-using-clickhouse"></a>
...
## Loading data from your Data Lake into ClickHouse <a id="loading-data-from-your-data-lake-into-clickhouse"></a>
