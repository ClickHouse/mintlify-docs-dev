...
## Connect to the catalog <a id="connect-catalog"></a>
...
### List tables <a id="list-tables"></a>
...
### Explore the schema <a id="explore-schema"></a>
...
## Query over the data lake table <a id="query-lakehouse"></a>
...
## Load data into MergeTree <a id="load-data"></a>

### Create an optimized table <a id="create-table"></a>
...
### Insert data from the catalog <a id="insert-data"></a>
...
## Re-execute the query <a id="reexecute-query"></a>
