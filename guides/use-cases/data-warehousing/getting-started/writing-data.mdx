...
## Prepare a source dataset <a id="prepare-source"></a>
...
### Create and populate a MergeTree table <a id="create-source-table"></a>
...
## Write data to an Iceberg table <a id="write-iceberg"></a>

### Create the Iceberg table <a id="create-iceberg-table"></a>
...
### Insert a subset of data <a id="insert-subset"></a>
...
### Query the Iceberg table <a id="query-iceberg"></a>
...
## Write aggregated results <a id="write-aggregates"></a>
...
### Create an Iceberg table for aggregates <a id="create-aggregate-table"></a>
...
### Insert aggregated data <a id="insert-aggregates"></a>
...
### Query the aggregated table <a id="query-aggregates"></a>
