...
<Steps>
<Step>
## Query Iceberg data directly <a id="query-directly"></a>
...
<Image img="/images/datalake/iceberg-query-direct.png" alt="Iceberg Query"/>
...
<Step>
## Create a persistent table engine <a id="table-engine"></a>
...
<Image img="/images/datalake/iceberg-query-engine.png" alt="Iceberg Query"/>
...
<Step>
## Connect to a catalog <a id="connect-catalog"></a>
...
<Step>
## Issue a query <a id="issue-query"></a>
...
<Step>
## Load a subset into ClickHouse <a id="load-data"></a>
...
<Image img="/images/datalake/iceberg-query.png" alt="Iceberg Query"/>
...
<Image img="/images/datalake/clickhouse-query.png" alt="ClickHouse Query"/>
...
<Step>
## Write back to Iceberg <a id="write-back"></a>
