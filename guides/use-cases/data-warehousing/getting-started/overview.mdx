...
Each catalog type requires its own connection settings — see the [Catalogs guides](/guides/use-cases/data-warehousing/reference) for the full list of supported catalogs and their configuration options.
