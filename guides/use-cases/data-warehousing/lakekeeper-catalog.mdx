...
## Local Development Setup <a id="local-development-setup"></a>
...
### Prerequisites <a id="local-prerequisites"></a>
...
### Setting up Local Lakekeeper Catalog <a id="setting-up-local-lakekeeper-catalog"></a>
...
### Connecting to Local Lakekeeper Catalog <a id="connecting-to-local-lakekeeper-catalog"></a>
...
## Querying Lakekeeper catalog tables using ClickHouse <a id="querying-lakekeeper-catalog-tables-using-clickhouse"></a>
