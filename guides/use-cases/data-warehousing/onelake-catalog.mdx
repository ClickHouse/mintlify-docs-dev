...
## Gathering Requirements OneLake <a id="gathering-requirements"></a>
...
## Creating a connection between OneLake and ClickHouse <a id="creating-a-connection-between-unity-catalog-and-clickhouse"></a>
...
### Connect to OneLake <a id="connect-onelake"></a>
...
## Querying OneLake using ClickHouse <a id="querying-onelake-using-clickhouse"></a>
...
## Loading data from your Data Lake into ClickHouse <a id="loading-data-from-onelake-into-clickhouse"></a>
