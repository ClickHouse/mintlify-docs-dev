...
## Advanced observability dashboard <a id="advanced-observability"></a>
...
## Query insights and resource monitoring <a id="query-insights"></a>
...
## Prometheus-compatible metrics endpoint <a id="prometheus"></a>
...
### ClickStack deployment options <a id="clickstack-deployment"></a>
...
## System impact considerations <a id="system-impact"></a>
...
<!-- anchors from _observability_integration_options.mdx -->
<a id="examples"></a>
<a id="grafana"></a>
<a id="datadog"></a>
<a id="clickstack"></a>
<!-- anchors from _direct_observability_integration_options.mdx -->
<a id="direct-grafana"></a>
<a id="direct-datadog"></a>
<a id="system-tables"></a>
<!-- anchors from _community_monitoring.mdx -->
<a id="community-monitoring"></a>
<!-- anchors from _observability_integration_options.mdx -->
<a id="examples"></a>
<a id="grafana"></a>
<a id="datadog"></a>
