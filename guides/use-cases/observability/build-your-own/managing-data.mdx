...
<Image img="/images/use-cases/observability/observability-14.png" alt="Partitions" size="md"/>
...
## Data management with TTL (Time-to-live) <a id="data-management-with-ttl-time-to-live"></a>
...
### Table level TTL <a id="table-level-ttl"></a>
...
### Column level TTL <a id="column-level-ttl"></a>
...
## Recompressing data <a id="recompressing-data"></a>
...
## Managing schema changes <a id="managing-schema-changes"></a>
...
### Use default values <a id="use-default-values"></a>
...
### Create new tables <a id="create-new-tables"></a>
