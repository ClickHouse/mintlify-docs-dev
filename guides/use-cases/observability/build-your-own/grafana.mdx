...
## OpenTelemetry Integration <a id="open-telemetry-integration"></a>
...
<Image img="/images/use-cases/observability/observability-15.png" alt="Connector config" size="sm"/>
...
<Image img="/images/use-cases/observability/observability-16.png" alt="Connector logs config" size="lg" border/>
...
### Logs to traces <a id="logs-to-traces"></a>

If logs contain trace Ids, you can benefit from being able to navigate through to a trace for a specific log line.

<Image img="/images/use-cases/observability/observability-17.png" alt="Logs to traces" size="lg" border/>
...
### View trace details <a id="view-trace-details"></a>
...
<Image img="/images/use-cases/observability/observability-19.png" alt="Trace Details" size="lg" border/>

### Traces to logs <a id="traces-to-logs"></a>
...
<Image img="/images/use-cases/observability/observability-20.png" alt="Traces to logs" size="lg" border/>
...
<Image img="/images/use-cases/observability/observability-22.png" alt="Time series" size="lg" border/>

### Multi-line charts <a id="multi-line-charts"></a>
...
<Image img="/images/use-cases/observability/observability-23.png" alt="Multi-line charts" size="lg" border/>

### Visualizing geo data <a id="visualizing-geo-data"></a>
...
<Image img="/images/use-cases/observability/observability-24.png" alt="Visualizing geo data" size="lg" border/>
