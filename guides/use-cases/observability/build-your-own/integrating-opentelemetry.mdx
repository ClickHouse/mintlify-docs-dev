...
## ClickHouse relevant components <a id="clickhouse-relevant-components"></a>
...
## Ingesting data with OTel <a id="ingesting-data-with-otel"></a>

### Collector deployment roles <a id="collector-deployment-roles"></a>
...
### Collecting logs <a id="collecting-logs"></a>
...
<Image img="/images/use-cases/observability/observability-3.png" alt="Collecting logs" size="md"/>
...
<Image img="/images/use-cases/observability/observability-4.png" alt="Collecting logs via otlp" size="md"/>
...
## Structured vs unstructured <a id="structured-vs-unstructured"></a>
...
## Collecting Kubernetes logs <a id="collecting-kubernetes-logs"></a>
...
## Collecting traces <a id="collecting-traces"></a>
...
## Processing - filtering, transforming and enriching <a id="processing---filtering-transforming-and-enriching"></a>
...
## Exporting to ClickHouse <a id="exporting-to-clickhouse"></a>
...
## Out of the box schema <a id="out-of-the-box-schema"></a>
...
## Optimizing inserts <a id="optimizing-inserts"></a>
...
### Use asynchronous inserts <a id="use-asynchronous-inserts"></a>
...
## Deployment architectures <a id="deployment-architectures"></a>
...
### Agents only <a id="agents-only"></a>
...
<Image img="/images/use-cases/observability/observability-7.png" alt="Agents only" size="md"/>
...
### Scaling with gateways <a id="scaling-with-gateways"></a>
...
<Image img="/images/use-cases/observability/observability-8.png" alt="Scaling with gateways" size="md"/>
...
### Adding Kafka <a id="adding-kafka"></a>
...
<Image img="/images/use-cases/observability/observability-9.png" alt="Adding kafka" size="md"/>
...
### Estimating resources <a id="estimating-resources"></a>
