...
## Extracting structure with SQL <a id="extracting-structure-with-sql"></a>
...
### Materialized columns <a id="materialized-columns"></a>
...
## Materialized views <a id="materialized-views"></a>
...
### Beware types <a id="beware-types"></a>
...
## Choosing a primary (ordering) key <a id="choosing-a-primary-ordering-key"></a>
...
## Using aliases <a id="using-aliases"></a>
...
## Using codecs <a id="using-codecs"></a>
...
## Using dictionaries <a id="using-dictionaries"></a>
...
<Image img="/images/use-cases/observability/observability-12.png" alt="Observability and dictionaries" size="md"/>
...
### Insert time vs query time <a id="insert-time-vs-query-time"></a>
...
### Using IP dictionaries <a id="using-ip-dictionaries"></a>
...
### Using regex dictionaries (user agent parsing) <a id="using-regex-dictionaries-user-agent-parsing"></a>
...
## Accelerating queries <a id="accelerating-queries"></a>
...
### Using Materialized views (incremental) for aggregations <a id="using-materialized-views-incremental-for-aggregations"></a>
...
#### A more complex example <a id="a-more-complex-example"></a>
...
### Using Materialized views (incremental)  for fast lookups <a id="using-materialized-views-incremental--for-fast-lookups"></a>
...
### Using projections <a id="using-projections"></a>
...
<Image img="/images/use-cases/observability/observability-13.png" alt="Observability and projections" size="md"/>
...
### Secondary/data skipping indices <a id="secondarydata-skipping-indices"></a>
...
### Text index for full text search <a id="text-index-for-full-text-search"></a>
...
#### Adding a text index <a id="adding-a-text-index"></a>
...
#### Using a preprocessor <a id="using-a-preprocessor"></a>
...
### Extracting from maps <a id="extracting-from-maps"></a>
...
## Measuring table size & compression <a id="measuring-table-size--compression"></a>
