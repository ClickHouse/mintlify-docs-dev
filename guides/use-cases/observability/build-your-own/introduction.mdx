...
<Image img="/images/use-cases/observability/observability-1.png" alt="Simple OTel" size="md"/>
...
## Why use ClickHouse? <a id="why-use-clickhouse"></a>
...
## When should you use ClickHouse for Observability <a id="when-should-you-use-clickhouse-for-observability"></a>
...
## Logs and traces <a id="logs-and-traces"></a>
...
<Image img="/images/use-cases/observability/observability-2.png" alt="Example trace" size="lg" border/>
