...
Starting from ClickHouse 25.7, [ClickHouse Client](/concepts/features/interfaces/cli) and [clickhouse-local](/concepts/features/tools-and-utilities/clickhouse-local) include [AI-powered functionality](/concepts/features/interfaces/cli#ai-sql-generation) that converts natural language descriptions into SQL queries. This feature allows you to describe your data requirements in plain text, which the system then translates into corresponding SQL statements.
...
Alternatively, you can [provide a configuration file](/concepts/features/interfaces/cli#ai-sql-generation-configuration).

## Connecting to the ClickHouse SQL playground <a id="connecting-to-the-clickhouse-sql-playground"></a>
...
## Asking ClickHouse questions in natural language <a id="asking-clickhouse-questions-in-natural-language"></a>
...
### Finding expensive housing markets <a id="finding-expensive-housing-markets"></a>
...
### Finding expensive properties in Greater London <a id="finding-expensive-properties-in-greater-london"></a>
