...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Add example data set"/>

Select `Get started` in the UK property price paid data (4GB) card:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Select UK price paid dataset"/>

Then click `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Import UK price paid dataset"/>
...
### Setting up credentials <a id="setting-up-credentials"></a>
...
### Installing Marimo <a id="installing-marimo"></a>
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="Marimo interface"/>
...
## Exploring the data <a id="exploring-the-data"></a>
...
### Querying ClickHouse Cloud data <a id="querying-clickhouse-cloud-data"></a>
...
### Visualizing the data <a id="visualizing-the-data"></a>
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Marimo data visualization"/>
...
### Interactive town selection <a id="interactive-town-selection"></a>
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Marimo dynamic chart"/>

### Exploring price distributions with interactive box plots <a id="exploring-price-distributions"></a>
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Marimo dynamic chart"/>
