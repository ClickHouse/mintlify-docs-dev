...
In this guide, you will learn how you can explore a dataset on ClickHouse Cloud data in Jupyter notebook with the help of [chDB](/products/chdb/index) - a fast in-process SQL OLAP Engine powered by ClickHouse.
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="Create a new notebook"/>
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="Select kernel"/>
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="dataframe preview"/>
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="dataframe preview"/>
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="dataframe preview"/>
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="Plot of remote data set and local data set"/>
