...
<Step>
## Clone the LibreChat repository <a id="clone-librechat-repo"></a>
...
<Step>
## Create and edit the .env file <a id="create-and-edit-env-file"></a>
...
<Step>
## Create a librechat.yaml file <a id="create-librechat-yaml-file"></a>
...
<Step>
## Add ClickHouse MCP server to Docker compose <a id="add-clickhouse-mcp-server-to-docker-compose"></a>
...
<Step>
## Configure MCP server in librechat.yaml <a id="configure-mcp-server-in-librechat-yaml"></a>
...
<Step>
## Add a local LLM using Ollama (optional) <a id="add-local-llm-using-ollama"></a>

### Install Ollama <a id="install-ollama"></a>
...
### Configure Ollama in librechat.yaml <a id="configure-ollama-in-librechat-yaml"></a>
...
<Step>
## Start all services <a id="start-all-services"></a>
...
<Step>
## Open LibreChat in your browser <a id="open-librechat-in-browser"></a>
...
<Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="Select your MCP server" size="md"/>
