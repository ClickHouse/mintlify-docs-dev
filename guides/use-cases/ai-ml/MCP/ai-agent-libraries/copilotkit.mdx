...
## Install dependencies manually <a id="install-dependencies-manually"></a>
...
## Configure the application <a id="configure-the-application"></a>

Copy the `env.example` file to `.env` and edit it to provide your `ANTHROPIC_API_KEY`.

## Use your own LLM <a id="use-your-own-llm"></a>
...
## Use your own ClickHouse cluster <a id="use-your-own-clickhouse-cluster"></a>
