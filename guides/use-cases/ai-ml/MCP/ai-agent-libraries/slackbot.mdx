...
<Steps>
<Step>
## Create a Slack App <a id="create-a-slack-app"></a>
...
<Step>
## Install the app to your workspace <a id="install-the-app-to-your-workspace"></a>
...
<Step>
## Configure Slack app settings <a id="configure-slack-app-settings"></a>
...
<Step>
## Add environment variables (`.env`) <a id="add-env-vars"></a>
...
<Step>
## Using the bot <a id="using-the-bot"></a>
