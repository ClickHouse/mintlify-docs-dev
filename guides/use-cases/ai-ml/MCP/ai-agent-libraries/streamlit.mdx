...
<Steps>
<Step>
## Install libraries <a id="install-libraries"></a>
...
<Step>
## Create utilities file <a id="create-utilities"></a>
...
<Step>
## Setup credentials <a id="setup-credentials"></a>
...
<Step>
## Import required libraries <a id="import-libraries"></a>
...
<Step>
## Define the agent streaming function <a id="define-agent-function"></a>
...
<Step>
## Add synchronous wrapper functions <a id="add-wrapper-functions"></a>
...
<Step>
## Create the Streamlit interface <a id="create-interface"></a>
...
<Step>
## Run the application <a id="run-application"></a>
