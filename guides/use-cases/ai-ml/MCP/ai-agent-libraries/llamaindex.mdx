...
<Step>
## Initialize MCP server <a id="initialize-mcp-and-agent"></a>
...
<Step>
## Create an agent <a id="create-agent"></a>
...
<Step>
## Initialize the LLM <a id="initialize-llm"></a>
...
<Step>
## Run the agent <a id="run-agent"></a>
