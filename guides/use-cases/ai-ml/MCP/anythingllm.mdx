...
<Step>
## Pull AnythingLLM Docker image <a id="pull-anythingllm-docker-image"></a>
...
<Step>
## Setup storage location <a id="setup-storage-location"></a>
...
<Step>
## Configure MCP server config file <a id="configure-mcp-server-config-file"></a>
...
<Step>
## Start the AnythingLLM Docker container <a id="start-anythingllm-docker-container"></a>
...
<Step>
## Wait for MCP servers to start up <a id="wait-for-mcp-servers-to-start-up"></a>

Click on the tool icon in the bottom left-hand side of the UI:

<Image img="/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="Tool icon" size="md"/>

Click on `Agent Skills` and look under the `MCP servers` section. 
Wait until you see `Mcp ClickHouse` set to `On`

<Image img="/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="MCP servers ready" size="md"/>
</Step>
<Step>
## Chat with ClickHouse MCP server with AnythingLLM <a id="chat-with-clickhouse-mcp-server-with-anythingllm"></a>
...
<Image img="/images/use-cases/AI_ML/MCP/allm_conversation.png" alt="Conversation" size="md"/>
</Step>
</Steps>
