...
## Vector search primer <a id="vector-search-primer"></a>
...
### Understanding embeddings <a id="understanding-embeddings"></a>
...
### Hierarchical Navigable Small World (HNSW) <a id="hnsw"></a>
...
### Comparison of approaches <a id="comparison-approaches"></a>
...
## QBit deep dive <a id="qbit-deepdive"></a>

### Quantised Bit (QBit) <a id="quantised-bit"></a>
...
### The data type <a id="the-data-type"></a>
...
### The distance calculation <a id="the-distance-calculation"></a>
...
### I/O Optimisation <a id="io-optimisation"></a>
...
### Calculation optimisation <a id="calculation-optimisation"></a>
...
#### BFloat16 Optimization <a id="bfloat16-optimization"></a>
...
#### Float64 Complexity <a id="float64-complexity"></a>
...
## Example with DBpedia <a id="example"></a>
...
### Search query <a id="search-query"></a>
...
### Key Insight <a id="key-insight"></a>
