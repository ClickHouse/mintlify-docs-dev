...
## Period-over-period changes <a id="time-series-period-over-period-changes"></a>
...
## Cumulative values <a id="time-series-cumulative-values"></a>
...
## Rate calculations <a id="time-series-rate-calculations"></a>
...
## Histograms <a id="time-series-histograms"></a>
