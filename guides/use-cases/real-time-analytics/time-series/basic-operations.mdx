...
## Aggregating by time bucket <a id="time-series-aggregating-time-bucket"></a>
...
## Custom grouping intervals <a id="time-series-custom-grouping-intervals"></a>
...
## Filling empty groups <a id="time-series-filling-empty-groups"></a>
...
## Rolling time windows <a id="time-series-rolling-time-windows"></a>
