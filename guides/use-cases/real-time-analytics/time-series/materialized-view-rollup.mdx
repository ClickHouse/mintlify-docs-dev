...
## When to use this pattern <a id="when-to-use"></a>
...
<Steps>
<Step>
## Create the raw events table <a id="create-raw-events-table"></a>
```sql
...
<Step>
## Design the rollup (aggregated) table <a id="design-rollup"></a>
...
<Step>
## Create a materialized view that populates the rollup <a id="create-materialized-view-to-populate-rollup"></a>
...
<Step>
## Insert some sample data <a id="insert-some-sample-data"></a>
...
<Step>
## Querying the rollup <a id="querying-the-rollup"></a>
...
<Step>
## Filter on fields in the primary key for best performance <a id="filtering-performance"></a>
...
<Step>
## Common variations <a id="common-variations"></a>
...
<Step>
## Clean-up and retention <a id="clean-up-and-retention"></a>
