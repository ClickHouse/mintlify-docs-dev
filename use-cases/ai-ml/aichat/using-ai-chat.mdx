...
<Image img="/static/images/use-cases/AI_ML/AIChat/1_open_chat.png" alt="Open AI Chat flyout" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/AIChat/2_consent.png" alt="Consent dialog" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/AIChat/3_modes.png" alt="Mode selection" size="sm"/>
...
<Image img="/static/images/use-cases/AI_ML/AIChat/4_thinking.png" alt="Thinking steps" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/AIChat/5_history.png" alt="Chat history list" size="md"/>
...
<Image img="/static/images/use-cases/AI_ML/AIChat/6_result_actions.png" alt="Result actions" size="md"/>

<Image img="/static/images/use-cases/AI_ML/AIChat/7_open_in_editor.png" alt="Open generated query in editor" size="md"/>
