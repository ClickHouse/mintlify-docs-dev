...
<Image img="/static/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Select MCP in the Connect Modal" size="md"/>

Toggle the button on to enable MCP for the service:

<Image img="/static/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="Enable MCP Server" size="md"/>
