    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              href="/zh/products/cloud/getting-started/cloud-get-started"
          ...
          <div className="flex flex-col gap-4">
            <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="由 ClickHouse 驱动的一体化可观测性技术栈，为你提供闪电般快速的查询，以及对日志、指标、链路追踪、会话回放和错误的强大聚合能力。" href="/zh/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="快速、可扩展、企业级的 Postgres 服务，与 ClickHouse 原生集成。轻松结合使用 Postgres 处理事务，使用 ClickHouse 进行分析。" href="/zh/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-integration.svg" logoInvert title="集成" description="100 多种集成，可将您喜爱的工具和服务连接到 ClickHouse。" href="/zh/integrations/home" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="面向可观测性、指标、评估和提示词管理的开源 LLM 工程平台。" href="https://langfuse.com/docs" showArrow external />
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">为您的编码智能体添加 ClickHouse 技能</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">安装 ClickHouse 技能，让您的智能体具备专家级的 ClickHouse 知识和最佳实践。</p>
