...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        title="开始使用"
        description="我是新用户，想开始使用或浏览 ClickHouse 产品文档"
        icon={
      ...
      <HeroCard
        title="指南"
        description="我想了解如何使用 ClickHouse 的各项功能，或探索进阶主题"
        icon={
      ...
      <HeroCard
        title="我们的解决方案"
        description="摄取日志、指标和链路追踪，用于监控系统并为可观测性仪表盘提供支持"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="space-y-4 mt-6">
      {/* 第 1 行：ClickHouse Cloud（col-span-2）+ 3 个纵向排列的卡片（col-span-1） */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          ...
          <HeroCard
            ...
            body={<>
                <p className="text-[#6b7280] dark:text-[#a1a1aa] mt-2 text-sm leading-[1.6]">
                    本部分介绍 ClickHouse 如何让数据仓库更快速、更简单且更可预测。你无需再与脆弱的管道和缓慢的查询引擎周旋，而是可以在几分钟内（而非几周）将来自应用、服务和工具的数据集中到一起。随后，你就可以在同一平台上构建实时仪表盘、触发告警、分析历史趋势，并打造事件驱动型产品。
                </p>
            </>}
            links={[
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="chDB" description="快速、可靠且可扩展的进程内数据库。在进程内即可体验 ClickHouse 的强大能力。" href="/zh/products/chdb" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="product-langfuse-light.png" title="LangFuse" description="面向可观测性、指标、评估和提示词管理的开源 LLM 工程平台。" href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="product-cloud-light.png" title="Kubernetes Operator" description="在 Kubernetes 上自动化部署、配置和管理 ClickHouse 与 ClickHouse Keeper 集群。" href="/zh/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="product-chdb-light.png" title="chDB" description="快速、可靠且可扩展的进程内数据库。在进程内体验 ClickHouse 的强大能力。" href="/zh/products/chdb" showArrow />
      </div>
    </div>
