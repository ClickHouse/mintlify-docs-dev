    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          <HeroCard title="ClickStack" description="由 ClickHouse 驱动的一体化可观测性技术栈，为你提供闪电般快速的查询，以及对日志、指标、链路追踪、会话回放和错误的强大聚合能力。" href="/zh/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Managed Postgres" description="快速、可扩展、企业级的 Postgres 服务，与 ClickHouse 原生集成。轻松结合使用 Postgres 处理事务，使用 ClickHouse 进行分析。" href="/zh/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="集成" description="100 多种集成，可将您喜爱的工具和服务连接到 ClickHouse。" href="/zh/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
