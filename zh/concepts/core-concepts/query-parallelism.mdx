...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="索引分析" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 个并行处理通道" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 个并行处理通道" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="分布式通道" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="查询管道" />
