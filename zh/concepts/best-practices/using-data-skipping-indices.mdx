...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="构建跳过索引" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="使用跳过索引" />
