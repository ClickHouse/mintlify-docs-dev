...
title: '概述'
keywords: ['字典', '字典']
description: '字典以键值形式表示数据，便于快速查找。'
doc_type: 'guide'
---
...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="ClickHouse 中字典的使用场景" />
...
<Image img="/images/dictionary/dictionary-left-any-join.png" size="sm" alt="将字典与 LEFT ANY JOIN 结合使用" />
