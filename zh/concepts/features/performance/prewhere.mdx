...
<Image img="/images/guides/best-practices/prewhere_01.gif" size="md" alt="未使用 PREWHERE 优化的查询处理" />
...
<Image img="/images/guides/best-practices/prewhere_02.gif" size="md" alt="使用 PREWHERE 优化的查询处理过程" />
...
<Image img="/images/guides/best-practices/prewhere_03.gif" size="md" alt="步骤 1：按 town 过滤" />
...
<Image img="/images/guides/best-practices/prewhere_04.gif" size="md" alt="步骤 2：按 date 过滤" />
...
<Image img="/images/guides/best-practices/prewhere_05.gif" size="md" alt="步骤 2：按 price 过滤" />
