...
此外还有其他[引擎类型](/zh/reference/engines/table-engines/mergetree-family)，但这些是最常用的几种。
...
这些方法适用于使用 [MergeTree 家族](/zh/reference/engines/table-engines/mergetree-family) 引擎的表。
