...
* 如果你的查询需要直接 JOIN，即 `LEFT ANY JOIN` (如下所示) ，我们建议在可能的情况下使用[字典](/zh/concepts/features/dictionaries)。
...
<Image img="/images/guides/joins-3.png" size="lg" alt="JOIN 特性" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="Join 内存优化决策树" />
