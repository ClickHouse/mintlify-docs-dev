...
*数据库是否被过多的 parts 拖慢了？请参阅 [Too Many Parts](/zh/resources/support-center/tips-and-tricks/too-many-parts) 社区经验指南。*
*进一步了解 [Materialized Views](/zh/concepts/features/materialized-views)。*
