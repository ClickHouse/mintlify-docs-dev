...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="MSSQL 数据库和表结构" border />

MSSQL 登录用户 `sql_user`：

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="MSSQL 登录用户配置" border />

`sql_user` 的数据库成员身份角色：

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="MSSQL 数据库成员身份角色" border />

具有登录名的数据库用户：

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="具有登录名的 MSSQL 数据库用户" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/zh/snippets/engines/table-engines/integrations/odbc)
