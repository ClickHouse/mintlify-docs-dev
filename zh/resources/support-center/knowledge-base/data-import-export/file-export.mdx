...
如果 ClickHouse 无法根据文件扩展名确定格式，则输出数据默认采用 [TabSeparated](/zh/reference/formats) [输出格式](/zh/reference/formats)。要指定[输出格式](/zh/reference/formats)，请使用 [FORMAT 子句](/zh/reference/statements/select/format)。
