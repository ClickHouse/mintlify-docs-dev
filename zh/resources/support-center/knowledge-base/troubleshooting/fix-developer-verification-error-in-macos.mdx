...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="MacOS 开发者验证错误对话框" border />
...
2. 前往**隐私与安全**：
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="MacOS 隐私与安全设置默认视图" border />

3. 滚动到窗口底部，找到一条消息：*&quot;clickhouse-macos-aarch64&quot; 因并非来自已识别的开发者而被阻止使用*。

4. 点击**仍要允许**。

   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="MacOS 隐私与安全设置中显示“仍要允许”按钮" border />
