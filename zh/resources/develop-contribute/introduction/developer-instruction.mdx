...
- `arg1` — 参数说明。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg2` — 参数说明。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg3` — 可选参数说明（可选）。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
...
- 返回 {此处填写函数返回内容}。[DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
