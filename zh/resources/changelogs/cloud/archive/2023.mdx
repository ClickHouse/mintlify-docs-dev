...
* [Go client](/zh/integrations/language-clients/go): 修复了 TLS 连接中空闲连接的存活检查问题
* [Python 客户端](/zh/integrations/language-clients/python)
  * 在查询方法中新增了对外部数据的支持
  * 为查询结果新增了时区支持
...
* [Python 客户端](/zh/integrations/language-clients/python)：增强了对 Pandas 的支持，并修复了与时区相关的问题
...
* [Kafka-Connect](/zh/integrations/connectors/data-ingestion/kafka)：支持隐式日期转换，并改进了对空值列的处理
...
* [Kafka-Connect](/zh/integrations/connectors/data-ingestion/kafka)：新增对亚马逊 MSK 的支持
...
* [DBT-clickhouse](/zh/integrations/connectors/data-ingestion/etl-tools/dbt)：新增对最新 DBT 版本 v1.4.1 的支持
* [Python client](/zh/integrations/language-clients/python)：改进了代理和 SSH 隧道支持，并针对 Pandas DataFrame 增加了多项修复和性能优化
* [Node.js 客户端](/zh/integrations/language-clients/js)：新增了可为查询结果附加 `query_id` 的功能，可用于从 `system.query_log` 中检索查询指标
* [Golang client](/zh/integrations/language-clients/go)：优化了与 ClickHouse Cloud 之间的网络连接
...
* [dbt](/zh/integrations/connectors/data-ingestion/etl-tools/dbt) 插件：新增对[多线程](https://github.com/ClickHouse/dbt-clickhouse/blob/main/CHANGELOG.md)的支持
* [Grafana](/zh/integrations/connectors/data-visualization/grafana) 插件：更好地处理连接错误
* [Python](/zh/integrations/language-clients/python) 客户端：为插入操作新增[流式支持](/zh/integrations/language-clients/python/advanced-querying#streaming-queries)
* [Go](/zh/integrations/language-clients/go) 客户端：[缺陷修复](https://github.com/ClickHouse/clickhouse-go/blob/main/CHANGELOG.md)：关闭已取消的连接，并更好地处理连接错误
