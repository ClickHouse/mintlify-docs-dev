...
如果你的表中包含 [`Nested`](/zh/reference/data-types/nested-data-structures) 数据类型的列，则可以插入具有相同结构的 JSON 数据。可通过 [input&#95;format&#95;import&#95;nested&#95;json](/zh/reference/settings/formats#input_format_import_nested_json) 设置启用此功能。
