...
如果你需要每次都向一组未知的分片和副本发送查询，则无需创建 `Distributed` 表，而应改用 `remote` 表函数。请参见 [表函数](/zh/reference/functions/table-functions) 部分。
...
* [虚拟列](/zh/reference/engines/table-engines#table_engines-virtual_columns) 的说明
