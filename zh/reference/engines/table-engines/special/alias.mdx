...
<Info>
  这是一项 Experimental 功能，未来的发行版中可能会发生不兼容旧版本的变更。
  通过 [allow&#95;experimental&#95;alias&#95;table&#95;engine](/zh/reference/settings/session-settings#allow_experimental_alias_table_engine) 设置
  启用 Alias 表引擎。
