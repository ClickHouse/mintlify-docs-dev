...
**提高扩缩容级别会按比例增加你的 ClickPipes compute 成本。** 如果你扩容只是为了完成初始加载，请务必在快照完成后及时缩容，以避免产生意外费用。有关定价的更多信息，请参阅 [ClickPipes 定价](/zh/products/cloud/reference/billing/clickpipes)。
