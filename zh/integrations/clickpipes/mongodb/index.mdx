...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="选择 MongoDB" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="填写连接信息" size="lg" border />
...
5. 在这里，您可以为 ClickPipe 选择目标数据库。您可以选择现有数据库，也可以新建一个。
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="选择目标数据库" size="lg" border />
