...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="选择参数组" size="lg" border />

2. 搜索 `change_stream_log_retention_duration`，选中后将其编辑为 `259200` (72 小时)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="修改参数组" size="lg" border />

3. 点击 `Apply Changes`，立即将修改后的参数组应用到你的 DocumentDB 集群。你应该会看到参数组的状态先变为 `applying`，变更应用后再变为 `in-sync`。

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="应用参数组" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="参数组状态" size="lg" border />
