...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="选择 MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="填写连接信息" size="lg" border />
...
5. 在此，您可以为 ClickPipe 选择目标数据库。您既可以选择现有数据库，也可以新建数据库。
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="选择目标数据库" size="lg" border />
