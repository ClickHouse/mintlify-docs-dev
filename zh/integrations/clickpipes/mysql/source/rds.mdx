...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="在 RDS 中启用自动备份" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/rds_config.png" alt="在 RDS 中查找参数组的位置" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="将 binlog format 设为 ROW" size="lg" border />

2. 将 `binlog_row_metadata` 设为 `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="将 binlog row metadata 设为 FULL" size="lg" border />

3. 将 `binlog_row_image` 设为 `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="将 binlog row image 设为 FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="在 RDS MySQL 中在哪里可以找到安全组？" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="编辑上述安全组的入站规则" size="lg" border />
