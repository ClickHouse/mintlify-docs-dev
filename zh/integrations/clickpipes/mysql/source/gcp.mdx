...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="在 Cloud SQL 中启用 PITR" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="GCP MySQL 中的 Edit 按钮" size="lg" border />

然后向下滚动到 `Flags` 部分，并添加上述标志。

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="在 GCP 中设置 binlog 标志" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="GCP MySQL 中的 IP 允许列表" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="下载 GCP MySQL 证书" size="lg" border />

5. 在 ClickPipes UI 中创建新的 MySQL ClickPipe 时，上传已下载的证书。

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="使用 GCP MySQL 证书" size="lg" border />