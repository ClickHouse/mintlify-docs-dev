...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="将 Binlog 行元数据设为 FULL" size="lg" border />

3. 将 `binlog_row_image` 设置为 `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="将 Binlog 行镜像设为 FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="在哪里可以找到 RDS 中的安全组（Security Group）？" size="lg" border />
