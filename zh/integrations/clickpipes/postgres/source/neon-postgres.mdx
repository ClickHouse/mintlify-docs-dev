...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enable-replication.png" alt="启用逻辑复制" border />

点击 **Enable** 即可完成此项设置。启用后，您应该会看到如下成功消息。

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enabled-replication.png" alt="逻辑复制已启用" border />
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-ip-allow.png" alt="允许 IP 的界面" border />
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-conn-details.png" alt="连接详情" border />
