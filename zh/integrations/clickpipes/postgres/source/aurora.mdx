...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="在 Aurora 中查找参数组的位置" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/change_rds_logical_replication.png" alt="更改 rds.logical_replication" size="lg" border />

2. 将新的参数组应用到您的 Aurora PostgreSQL 集群

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="使用新参数组修改 Aurora PostgreSQL" size="lg" border />

3. 重启您的 Aurora 集群以应用更改

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="重启 Aurora PostgreSQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="在 Aurora PostgreSQL 中在哪里可以找到安全组（Security Group）？" size="lg" border />
