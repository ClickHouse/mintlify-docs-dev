...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="Cloud SQL Postgres 中的 Edit 按钮" size="lg" border />

2. 进入 Flags，将 `cloudsql.logical_decoding` 设置为 on。此更改需要重启 Postgres 服务器。

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="将 cloudsql.logical_decoding 设置为 on" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding3.png" alt="重启服务器" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="Cloud SQL 中的 Connections 部分" size="lg" border />

2. 前往 **Networking** 子部分

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="Cloud SQL 中的 Networking 子部分" size="lg" border />

3. 添加 [ClickPipes 的公网 IP](/zh/integrations/clickpipes/home#list-of-static-ips)

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="将 ClickPipes 网络添加到防火墙" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="已将 ClickPipes 网络添加到防火墙" size="lg" border />
