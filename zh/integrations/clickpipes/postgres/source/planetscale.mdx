...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="在 PlanetScale Console 中调整 wal_level" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="在 PlanetScale Console 中调整 max_slot_wal_keep_size" size="md" border />
