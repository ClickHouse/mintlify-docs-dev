...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Azure PostgreSQL 灵活服务器中的 Server Parameters" size="lg" border />

2. 将 `wal_level` 设置为 `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="在 Azure PostgreSQL 灵活服务器中将 wal_level 更改为 logical" size="lg" border />

3. 此更改需要重启服务器，因此请在系统提示时进行重启。

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="更改 wal_level 后重启服务器" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="在 Azure PostgreSQL 灵活服务器中将 ClickPipes IP 地址添加到防火墙" size="lg" />
