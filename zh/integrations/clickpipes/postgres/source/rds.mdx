...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="在 RDS 中哪里可以找到参数组？" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="使用新参数组修改 RDS Postgres" size="lg" border />

3. 重启你的 RDS 实例以使更改生效

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="重启 RDS Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="在 RDS Postgres 中在哪里可以找到安全组？" size="lg" border />
