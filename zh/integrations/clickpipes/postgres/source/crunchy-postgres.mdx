...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/firewall_rules_crunchy_bridge.png" alt="在 Crunchy Bridge 中哪里可以找到防火墙规则？" border />

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/add_firewall_rules_crunchy_bridge.png" alt="为 ClickPipes 添加防火墙规则" border />
