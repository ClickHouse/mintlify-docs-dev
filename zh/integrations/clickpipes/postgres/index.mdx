---
sidebarTitle: '将 Postgres 数据摄取到 ClickHouse'
description: '将您的 Postgres 无缝连接到 ClickHouse Cloud。'
slug: /integrations/clickpipes/postgres
title: '将 Postgres 数据摄取到 ClickHouse（使用 CDC）'
...
3. 选择 `Postgres CDC` 卡片
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/postgres/postgres-tile.png" alt="选择 Postgres" size="lg" border />
