...
| **OVH Object Storage** <br /> *兼容 S3*  | <img src="/images/integrations/logos/ovh.png" alt="云存储标志" width="32" />                     | 持续摄取要求按[词典序](#continuous-ingestion-lexicographical-order)进行。不支持无序模式。                                                  |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="S3 ClickPipes 的 IAM 凭证" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="S3 ClickPipes 的 IAM 身份验证" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="ClickPipes 高级设置" size="lg" border />
