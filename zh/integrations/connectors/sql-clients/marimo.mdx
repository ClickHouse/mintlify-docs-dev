...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="连接到 ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="添加新数据库" />

系统会提示你填写数据库信息。

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="填写数据库信息" />

随后，你会看到一个可运行的单元格，用于建立连接。

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="运行单元格以连接到 ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="选择 SQL 引擎" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="DataFrame 中的结果" />

现在，你已经可以在 DataFrame 中查看结果了。接下来，我想将某个给定上车地点对应的最高费用下车点可视化。marimo 提供了多个 UI 组件来帮助你实现这一点。我会使用下拉菜单选择地点，并用 Altair 绘制图表。

<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="下拉菜单、表和图表的组合" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="运行 App View" />