...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="显示短途行程数据集中行程距离分布的直方图，共 10 个分箱" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="显示行程距离分布的直方图，包含 50 个分箱和网格，标题为“trips < 6.3 的行程距离”" border />