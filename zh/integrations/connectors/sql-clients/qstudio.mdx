...
<Image img="/images/integrations/sql-clients/qstudio-add-connection.png" size="lg" border alt="显示 ClickHouse 连接设置的 QStudio 数据库连接配置界面" />
...
<Image img="/images/integrations/sql-clients/qstudio-running-query.png" size="lg" border alt="QStudio 界面显示了针对 ClickHouse 数据库执行示例 SQL 查询的过程" />
