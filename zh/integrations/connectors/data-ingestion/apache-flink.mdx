...
你可以在[此文档页面](/zh/reference/formats#formats-overview)和 [ClickHouseFormat.java](https://github.com/ClickHouse/clickhouse-java/blob/main/clickhouse-data/src/main/java/com/clickhouse/data/ClickHouseFormat.java) 中查看可用的 ClickHouse 输入格式列表。
