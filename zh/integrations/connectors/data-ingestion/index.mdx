...
| [Apache Spark](/zh/integrations/connectors/data-ingestion/apache-spark)                         | 一个多语言引擎，用于在单节点机器或集群上执行数据工程、数据科学和机器学习任务。                                              |
...
| [Azure Data Factory](/zh/integrations/connectors/data-ingestion/azure/azure-data-factory)       | 一项基于云的数据集成服务，使您能够大规模创建、调度和编排数据工作流。                                                   |
...
| [dbt](/zh/integrations/connectors/data-ingestion/etl-tools/dbt)                                 | 让分析工程师只需编写 select 语句，即可在其数据仓库中转换数据。                                                  |
...
| [Fivetran](/zh/integrations/connectors/data-ingestion/etl-tools/fivetran)                       | 一个自动化数据移动平台，可在您的云数据平台之间以及进出这些平台传输数据。                                                 |
