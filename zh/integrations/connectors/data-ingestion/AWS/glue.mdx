...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Glue Notebook 连接配置" force="true" />
  ...
  <Tab title="手动安装">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Glue Notebook JAR 路径选项" force="true" />
  </Tab>
</Tabs>
...
更多详情，请参阅我们的 [Spark 文档](/zh/integrations/connectors/data-ingestion/apache-spark)。