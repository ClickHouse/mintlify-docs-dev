...
<Steps>
  ...
  <Step>
    ...
    2. 选择 `ClickHouse`，然后填写相关设置，包括 ClickHouse 的主机和端口、用户名和密码，并点击 &quot;Test Connection&quot;。
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_1.png" size="lg" border alt="将 ClickHouse 添加为目标" />
  ...
  <Step>
    ...
    2. 选择 `MySQL`，然后填写相关设置，输入 MySQL 主机和端口、用户名和密码，再点击 &quot;Test Connection&quot;。
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_2.png" size="lg" border alt="将 MySQL 添加为源" />
  ...
  <Step>
    ...
    2. 选择已添加的 MySQL 和 ClickHouse 实例，点击 &quot;Test Connection&quot;，确认 BladePipe 已连接到这些实例。然后，选择要迁移的数据库。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_3.png" size="lg" border alt="选择源和目标" />

    3. 在 DataJob Type 中选择 &quot;Incremental&quot;，同时勾选 &quot;Full Data&quot; 选项。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_4.png" size="lg" border alt="选择同步类型" />

    4. 选择要复制的表。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_5.png" size="lg" border alt="选择表" />

    5. 选择要复制的列。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_6.png" size="lg" border alt="选择列" />

    6. 确认创建 DataJob 后，DataJob 会自动运行。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_8.png" size="lg" border alt="DataJob 正在运行" />
  </Step>
  ...
  <Step>
    ...
    2. 创建一个 <a href="https://doc.bladepipe.com/operation/job_manage/create_job/create_period_verification_correction_job" target="_blank">验证 DataJob</a>。验证 DataJob 完成后，请检查结果，确认 ClickHouse 中的数据与 MySQL 中的数据一致。
       <Image img="/images/integrations/data-ingestion/etl-tools/bp_ck_9.png" size="lg" border alt="验证数据" />
  </Step>
</Steps>