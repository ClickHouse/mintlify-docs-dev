...
<Image img="/images/integrations/data-ingestion/redshift/pull.png" size="md" alt="从 Redshift 到 ClickHouse 的 拉取" />
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="使用 S3 从 Redshift 进行中转" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/redshift/s3-1.png" size="md" alt="从 Redshift UNLOAD 到 S3" background="white" />
