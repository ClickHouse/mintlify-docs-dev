...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="通过笔记本设置 Spark 配置" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="使用 Spark UI 验证 ClickHouse 设置" border />

<div id="additional-resources">
  ## 其他资源
</div>

* [ClickHouse Spark Connector 文档](/zh/integrations/connectors/data-ingestion/apache-spark)
