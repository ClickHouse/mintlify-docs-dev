...
description: '将 HTTP Sink 连接器与 Kafka Connect 和 ClickHouse 搭配使用'
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="展示如何创建 HTTP Sink 连接器的 Confluent Cloud 界面" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="展示 HTTP Sink 连接器身份验证设置的 Confluent Cloud 界面" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="展示 HTTP Sink 连接器高级配置选项的 Confluent Cloud 界面" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Confluent Cloud 界面，展示如何在 Kafka topic 中创建测试消息" border />
