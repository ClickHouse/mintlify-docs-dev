...
<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="Confluent Platform UI，显示添加自定义 ClickHouse 连接器的设置" border />
