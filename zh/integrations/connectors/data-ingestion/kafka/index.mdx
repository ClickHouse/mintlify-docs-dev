...
| ------------------------------------------------------------------------------------------------- | ------------------------------ | :--: | :----------------: | :----------------: |
| [ClickPipes for Kafka](/zh/integrations/clickpipes/kafka)                                            | [Cloud], [BYOC] (即将推出！)        |   ✅  |          ✅         |                    |
...
* [**Confluent Cloud**](/zh/integrations/connectors/data-ingestion/kafka/confluent) - Confluent Platform 支持在 [Confluent Cloud 上上传并运行 ClickHouse Connector Sink](/zh/integrations/connectors/data-ingestion/kafka/confluent/custom-connector)，也可以使用 [适用于 Confluent Platform 的 HTTP Sink 连接器](/zh/integrations/connectors/data-ingestion/kafka/confluent/kafka-connect-http)，通过 HTTP 或 HTTPS 将 Apache Kafka 与 API 集成。
...
* **自定义代码** - 如果需要对事件进行自定义处理，则可以使用基于 Kafka 和 ClickHouse [客户端库](/zh/integrations/language-clients) 的自定义代码。
