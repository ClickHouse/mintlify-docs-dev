...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="在 Notion 的“添加连接”选择器中选择 ClickHouse" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="Notion 中展开的 ClickHouse 连接，显示各个工具的开关" />
