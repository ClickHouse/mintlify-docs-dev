...
description: 'Lightdash 是一款基于 dbt 构建的现代开源 BI 工具，可帮助团队通过语义层探索并可视化 ClickHouse 中的数据。了解如何将 Lightdash 连接到 ClickHouse，以实现由 dbt 驱动的快速、可治理分析。'
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Lightdash 仪表盘示例" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="lightdash-clickhouse 项目的 profiles.yml 配置示例" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt=".yml 文件中定义指标的示例" border />
  ...
  <Step>
    ...
    **Explore** 页面由五个主要区域组成：
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="显示维度、过滤器、图表、结果和 SQL 的 Lightdash Explore 视图" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="在 Lightdash 仪表盘中创建和组织图表" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Lightdash Ask AI 界面，显示由 dbt 指标驱动的自然语言查询" border />
