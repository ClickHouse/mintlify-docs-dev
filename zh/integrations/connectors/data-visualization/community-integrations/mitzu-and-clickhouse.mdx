...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_01.png" alt="Mitzu 登录页面，包含电子邮箱和密码输入框" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_02.png" alt="显示入门步骤的 Mitzu 工作区设置页面" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_03.png" alt="Mitzu 的 ClickHouse 连接设置页面，包含配置表单" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_04.png" alt="显示数据库表的 Mitzu 表选择界面" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_05.png" alt="显示列映射选项的 Mitzu 事件目录配置" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_06.png" alt="Mitzu 细分查询界面，包含事件选择和时间配置" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_07.png" alt="显示各步骤间转化率的 Mitzu 漏斗分析视图" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_08.png" alt="Mitzu 留存分析显示 Cohort 留存率" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_09.png" alt="显示用户在事件之间路径流转的 Mitzu 旅程可视化" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_10.png" alt="显示 MRR 指标的 Mitzu 营收分析仪表板" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_11.png" alt="显示原生 ClickHouse 查询的 Mitzu SQL 代码生成视图" border />
