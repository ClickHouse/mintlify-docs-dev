...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="ClickHouse 集成卡片" border />

2. 填写 ClickHouse 实例的连接信息：

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="ClickHouse 详情对话框" border />
...
1. 首先，连接到 笔记本 右侧的 ClickHouse 集成。
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.png" alt="ClickHouse 详细信息对话框" border />
