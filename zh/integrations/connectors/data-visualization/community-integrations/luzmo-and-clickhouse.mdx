...
description: 'Luzmo 是一个嵌入式分析平台，原生集成 ClickHouse，专为软件和 SaaS 应用而设计。'
...
<Image img="/images/integrations/data-visualization/luzmo_01.png" size="md" alt="Luzmo 界面显示“Create a New Connection”对话框，且已选中 ClickHouse" border />

系统会要求你提供 **host**、**username** 和 **password**：

<Image img="/images/integrations/data-visualization/luzmo_02.png" size="md" alt="Luzmo 连接配置表单，显示 ClickHouse host、username 和 password 字段" border />
...
连接 ClickHouse 后，你可以按照[这里](https://academy.luzmo.com/article/ldx3iltg)的说明添加数据集。你可以选择 ClickHouse 中可用的一个或多个数据集，并在 Luzmo 中将它们[关联](https://academy.luzmo.com/article/gkrx48x5)，确保它们能够在同一个仪表盘中一起使用。此外，也建议阅读这篇关于[为分析准备数据](https://academy.luzmo.com/article/u492qov0)的文章。
...
<Image img="/images/integrations/data-visualization/luzmo_03.png" size="md" alt="Luzmo 仪表盘示例，展示来自 ClickHouse 数据的多个可视化图表" border />
