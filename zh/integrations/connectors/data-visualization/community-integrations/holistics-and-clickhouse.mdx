...
description: 'Holistics 是一个由 AI 驱动的平台，提供自助式 BI 和嵌入式分析，帮助每个人利用治理良好且易于获取的指标做出更明智的决策。'
title: '将 ClickHouse 连接至 Holistics'
doc_type: 'guide'
---
...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="ClickHouse Cloud 控制台中 Connect 按钮的位置" border />
  </Step>
  ...
  <Step>
    ...
    1. **Direct Connection (推荐) ：** 在你的防火墙或 ClickHouse Cloud IP Access List 中将 Holistics 的 IP 地址加入白名单。你可以在 [IP Whitelisting guide](https://docs.holistics.io/docs/connect/ip-whitelisting) 中查看 IP 列表。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="ClickHouse Cloud 中 IP 白名单配置示例" border />
  ...
  <Step>
    ...
    1. 在 Holistics 中，前往 **Settings → Data Sources**。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="在 Holistics 设置中前往 Data Sources" border />

    2. 点击 **New Data Source**，然后选择 **ClickHouse**。

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="从新建数据源列表中选择 ClickHouse" border />
    ...
    3. 使用步骤 1 中收集的信息填写表单。
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="在 Holistics 中填写 ClickHouse 连接信息" border />

    4. 点击 **Test Connection**。

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Holistics 中成功通过 ClickHouse 连接测试" border />
