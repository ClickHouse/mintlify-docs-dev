...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="在 Dot 中配置 ClickHouse 连接（浅色模式）" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="连接 ClickHouse" size="sm" />
