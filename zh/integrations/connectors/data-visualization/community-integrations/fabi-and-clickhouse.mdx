...
description: 'Fabi.ai 是一个一体化协作式数据分析平台。你可以利用 SQL、Python、AI 和无代码能力，以前所未有的速度构建 dashboard 和数据工作流'
...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="Fabi.ai 数据探索与工作流平台" border />
...
1. 首次创建账户时，系统会提示你连接数据库；如果你已经有账户，请点击任意 Smartbook 左侧的 数据源 面板，然后选择 Add Data Source。
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="添加数据源" border />

2. 接着，系统会提示你输入连接信息。

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="ClickHouse 凭证表单" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="查询 ClickHouse" border />
