...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="显示 ClickHouse 数据可视化的 Databrain 仪表盘界面" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Databrain 数据源菜单" border />

3. 点击 **Add a Data Source** 或 **Connect Data Source**。

4. 在可用连接器列表中选择 **ClickHouse**。

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="显示 ClickHouse 选项的 Databrain 连接器选择界面" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Databrain ClickHouse 连接表单，显示配置字段" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="显示 ClickHouse 表的 Databrain 数据浏览器" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="包含多个 ClickHouse 可视化图表的 Databrain 仪表盘" border />
