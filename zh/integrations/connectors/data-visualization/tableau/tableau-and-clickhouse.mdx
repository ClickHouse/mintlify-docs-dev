...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="显示连接器选择菜单且高亮 ClickHouse by ClickHouse 选项的 Tableau 连接界面" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="显示 ClickHouse JDBC 连接器详细信息和安装按钮的 Tableau 连接器安装对话框" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="Tableau 中的 ClickHouse 连接对话框，显示 server、port、database、username 和 password 字段" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="显示初始连接界面和 database 选择选项的新 Tableau workbook" border />

<br />

8. 从 **Schema** 下拉菜单中选择 **TPCD**，你应该会看到 **TPCD** 中的表列表：

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="Tableau schema 选择界面，显示 TPCD database 中的表，包括 CUSTOMER、LINEITEM、NATION、ORDERS 等" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="将 CUSTOMER 表拖到画布后的 Tableau 工作簿，显示列标题但没有数据" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="Tableau 关系编辑器，显示使用 Custkey 字段连接 CUSTOMER 和 ORDERS 表" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="Tableau 工作表，显示可用于分析的 ClickHouse 表中的维度和度量" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="Tableau 折线图，显示 ClickHouse 数据中按年份统计的订购数量" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="Tableau 交叉表视图，以季度为列、运输方式为行" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="Tableau 交叉表，显示按季度和运输方式统计的总订单金额之和" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="Tableau 交叉表，显示按季度和运输方式统计的平均订单金额，并采用货币格式" border />
