...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="Tableau Online 界面，显示用于创建已发布数据源的“New”按钮" border />

<br />

从可用连接器列表中选择“MySQL”。

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="Tableau Online 连接器选择界面，其中突出显示了 MySQL 选项" border />

<br />

填写在设置 ClickHouse 时收集到的连接详细信息。

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="Tableau Online MySQL 连接配置界面，包含服务器、端口、数据库和凭据字段" border />

<br />

Tableau Online 会自动识别数据库结构，并提供可用表列表。将所需的表拖到右侧画布上。此外，还可以点击“Update Now”预览数据，并进一步调整自动识别出的字段类型或名称。

<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="Tableau Online 数据源页面，左侧显示数据库表，右侧显示支持拖放功能的画布" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="Tableau Desktop 界面，显示 Connect 菜单，并高亮了 MySQL 选项" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="Tableau Desktop MySQL 连接对话框，已启用 SSL 选项，并包含 server、username、password 和 certificate 字段" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Tableau Desktop 显示 Server 菜单，并高亮了 Publish Data Source 选项" border />

<br />

重要提示：你需要在 &quot;Authentication&quot; 选项中选择 &quot;Embedded password&quot;。

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="Tableau Desktop 发布对话框，显示 Authentication 选项，并已选择 Embedded password" border />

<br />

此外，选择 &quot;Update workbook to use the 已发布数据源&quot;。

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="Tableau Desktop 发布对话框，已勾选“Update workbook to use the 已发布数据源”选项" border />
