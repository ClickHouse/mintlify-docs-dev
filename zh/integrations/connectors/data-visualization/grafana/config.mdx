...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="安全原生配置示例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="额外的 HTTP 配置选项" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="附加设置示例" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="日志配置" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="链路追踪配置" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="别名表配置示例" border />

现在，Grafana 看到的将是别名表的结果，而不是 `DESC example_table` 的结果：

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="别名表查询示例" border />
