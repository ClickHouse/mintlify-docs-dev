...
| 聚合       | [aggregate functions](/zh/reference/functions/aggregate-functions)列表。支持为函数和列设置自定义值。仅在聚合模式下可见。          |
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_table_query.png" alt="聚合表查询示例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="OTel 日志查询示例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="日志查询中的额外字段示例" border />
...
| 聚合   | [aggregate functions](/zh/reference/functions/aggregate-functions) 列表。支持为函数和列指定自定义值。仅在 Aggregate mode 下可见。 |
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="时间序列查询示例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="OTel trace 查询示例" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="原始 SQL 查询示例" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="表中的 trace 链接" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  日志中 trace 链接示例

  <Image size="md" img="/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="日志中的 trace 链接" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/images/integrations/data-visualization/grafana/demo_data_links.png" alt="数据链接跳转示例" border />
</div>
