...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="显示 NYC 出租车数据可视化的 Splunk 仪表盘" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="显示 Java Home 配置的 Splunk DB Connect 设置页面" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="Splunk DB Connect 驱动程序页面，显示 ClickHouse 驱动已成功安装" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Splunk DB Connect 新建连接按钮" />

<br />

添加 ClickHouse 主机详细信息，并确保已勾选“Enable SSL”：

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="ClickHouse 的 Splunk connection 配置页面" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="在 Splunk SQL Explorer 中选择到 ClickHouse 的连接" />

在 `trips` 表上执行一条 SQL 查询，返回该表中的记录总数：

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="Splunk SQL 查询执行，显示 trips 表中的记录总数" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="显示前 10 个上车街区的 Splunk 柱状图表可视化" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="显示按乘客数量统计平均车费的 Splunk 柱状图" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="最终的 Splunk 仪表盘，包含 NYC 出租车数据的多个可视化图表" />
