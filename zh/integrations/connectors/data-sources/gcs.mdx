...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="Google Cloud Storage 中副本一的存储桶，展示包含数据分区的文件夹结构" />

<div id="bucket-for-replica-two">
  #### 副本二的存储桶
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="Google Cloud Storage 中副本二的存储桶，显示带有数据分区的文件夹结构" />