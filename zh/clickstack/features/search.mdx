...
<Image img="/images/use-cases/observability/hyperdx-27.png" alt="搜索" size="md" />
...
<Image img="/images/use-cases/observability/clickstack-saved-search-listing.png" alt="已保存搜索列表页面" size="lg" />

要保存搜索，只需配置好搜索查询并点击保存按钮。你还可以为已保存的搜索指定一个便于识别的描述性名称。

<Image img="/images/use-cases/observability/clickstack-saved-search.png" alt="保存搜索" size="md" />
