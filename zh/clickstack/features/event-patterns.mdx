...
<Image img="/images/use-cases/observability/event_patterns.png" alt="事件模式" size="lg" />
...
<Image img="/images/use-cases/observability/event_patterns_highlight.png" alt="事件模式" size="lg" />
