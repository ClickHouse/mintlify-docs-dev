...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="会话回放搜索视图" size="lg" />

点击任意会话上的 play 按钮即可回放。回放视图右侧显示重建的用户体验，左侧则显示浏览器事件时间线，包括网络请求、控制台日志和错误。

<Image img="/images/clickstack/session-replay/session-replay.png" alt="会话回放播放" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="在 ClickStack 中从会话回放深入查看后端链路追踪" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="会话回放 trace 视图" size="lg" />
