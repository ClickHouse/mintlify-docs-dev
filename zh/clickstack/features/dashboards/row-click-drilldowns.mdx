...
<Image img="/images/clickstack/dashboards/row-click-drawer.png" alt="在 Dashboard 模式下的 Row Click Action 侧边抽屉中，Service Detail 仪表盘被选为目标端，并配置了从点击行中模板化出的 ServiceName 过滤器" size="lg" />
