...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/text-to-chart/chart-explorer.png" alt="图表浏览器" />
  </Step>
  ...
  <Step>
    ...
    * `按严重程度分组统计事件数量随时间的变化`
    ...
    <Image img="/images/clickstack/text-to-chart/text-to-chart.png" alt="文本生成图表" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/text-to-chart/create-connection.png" alt="创建连接" />
