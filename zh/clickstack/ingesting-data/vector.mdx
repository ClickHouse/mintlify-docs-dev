  ...
  <Tab title="托管 ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="为 Vector 启动 ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="ClickStack 中的 Nginx 日志" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="开源 ClickStack">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="ClickStack Play UI" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="ClickStack 登录" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="创建数据源 - vector" size="lg" />
