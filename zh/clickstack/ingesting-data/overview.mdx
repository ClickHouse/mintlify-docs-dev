...
<Tabs>
  <Tab title="托管 ClickStack">
    <Image img="/images/use-cases/observability/clickstack-managed-architecture-with-flow.png" alt="托管架构与流程" size="md" />
  </Tab>

  <Tab title="开源 ClickStack">
    <Image img="/images/use-cases/observability/clickstack-oss-architecture-with-flow.png" alt="简化架构与流程" size="md" />
  </Tab>
</Tabs>
