...
<Tabs>
  ...
  <Tab title="开源 ClickStack">
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="摄取 API key" size="lg" />
...
<Image img="/images/use-cases/observability/clickstack-with-gateways.png" alt="通过gateway进行扩缩容" size="lg" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="添加 Kafka" size="lg" />
