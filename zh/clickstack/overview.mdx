...
<Image img="/images/use-cases/observability/hyperdx-landing.png" alt="首页" size="lg" />
...
要开始使用，请先查看[入门指南](/zh/clickstack/getting-started)，然后再加载[示例数据集](/zh/clickstack/example-datasets)。您还可以查阅有关[部署选项](/zh/clickstack/deployment/overview)和[生产环境最佳实践](/zh/clickstack/managing/production)的文档。
...
<Tabs>
  <Tab title="托管 ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-managed-architecture.png" alt="托管 ClickStack 架构" size="md" />
  ...
  <Tab title="开源 ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-oss-architecture.png" alt="OSS 简化架构" size="md" />
