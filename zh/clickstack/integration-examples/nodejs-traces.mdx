...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="链路追踪搜索视图" />

    点击任意一个 trace，即可查看包含 spans、耗时和 attributes 的详细视图：

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="单个 trace 视图" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/finish-import.png" alt="完成导入" />
  </Step>

  <Step>
    #### 仪表盘创建后，所有可视化都会预先配置好

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="示例仪表盘" />
