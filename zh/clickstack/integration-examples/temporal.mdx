...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Temporal 指标" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="完成导入对话框" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Temporal 指标仪表盘" />
  </Step>
</Steps>
