...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="日志搜索视图" />
    ...
    * `Body`：实际的日志消息内容
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="错误日志列值" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="演示搜索视图" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/zh/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">下载</TrackedLink>仪表盘配置
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="导入仪表盘按钮" />

    3. 上传 `cloudwatch-logs-dashboard.json` 文件，然后点击 **Finish Import**

    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="完成导入对话框" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="CloudWatch 日志仪表盘" />
