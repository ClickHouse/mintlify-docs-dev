...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="完成导入对话框" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="PostgreSQL 指标仪表盘" />
