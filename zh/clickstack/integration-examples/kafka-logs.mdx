...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="搜索视图" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="日志视图" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="完成导入 Kafka 日志仪表盘" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Kafka 日志示例仪表盘" />
  </Step>
</Steps>
