...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="日志视图" />

    <Image img="/images/clickstack/redis/redis-log.png" alt="日志" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="完成导入" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="示例仪表盘" />
  </Step>
</Steps>
