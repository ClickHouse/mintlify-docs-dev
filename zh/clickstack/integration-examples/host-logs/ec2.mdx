...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="EC2 日志搜索视图" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="显示元数据的 EC2 日志详情" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="EC2 日志搜索视图" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="包含元数据的 EC2 日志详情" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="完成导入" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="EC2 日志仪表盘" />
