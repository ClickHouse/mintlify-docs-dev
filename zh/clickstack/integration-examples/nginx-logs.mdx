...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="日志视图" />

    <Image img="/images/clickstack/log-view.png" alt="日志视图" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/zh/examples/nginx-logs-dashboard.json'} download="nginx-logs-dashboard.json" eventName="docs.nginx_logs_monitoring.dashboard_download">下载</TrackedLink> 仪表盘配置
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="导入仪表盘" />

    3. 上传 nginx-logs-dashboard.json 文件，然后点击完成导入。

    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="完成导入" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="示例仪表盘" />
  </Step>
</Steps>
