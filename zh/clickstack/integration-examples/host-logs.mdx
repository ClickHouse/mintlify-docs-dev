...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="搜索视图" />

    <Image img="/images/clickstack/host-logs/log-view.png" alt="日志视图" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="日志仪表盘" />
