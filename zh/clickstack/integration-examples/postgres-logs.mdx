...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="日志搜索视图" />

    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="日志视图" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/zh/examples/postgres-logs-dashboard.json'} download="postgresql-logs-dashboard.json" eventName="docs.postgres_logs_monitoring.dashboard_download">下载</TrackedLink>仪表盘配置
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="完成导入" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="日志仪表盘" />
