...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="日志搜索视图" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="日志视图" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="完成导入" />
  </Step>
  ...
  <Step>
    ...
    * 错误率
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="仪表盘示例" />
