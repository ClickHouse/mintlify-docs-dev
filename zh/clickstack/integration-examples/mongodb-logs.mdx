...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="MongoDB 日志搜索视图" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="MongoDB 日志详情视图" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="完成导入 MongoDB 日志仪表盘" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="MongoDB 日志仪表盘" />
  </Step>
</Steps>
