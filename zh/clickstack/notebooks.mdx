...
<Image img="/images/use-cases/observability/hyperdx-notebook-hero.png" alt="AI Notebook 正在调查一次由 Visa 缓存已满引发的故障" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-ai-consent.png" alt="Team Settings 中的 Generative AI 开关" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-list.png" alt="笔记本列表页面" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-tiles.png" alt="包含 AI 生成卡片的笔记本" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branch-modal.png" alt="创建新分支对话框" size="md" />

当某个卡片有多个分支时，卡片标题栏上会显示左右箭头按钮，以及一个徽标 (例如 **1/2**) ，用于指示当前共有多少个分支。点击箭头即可在不同分支之间切换。

<Image img="/images/use-cases/observability/hyperdx-notebook-branching.png" alt="卡片上的分支导航箭头和 1/2 徽标" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-manual-tiles.png" alt="笔记本底部的手动卡片按钮" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-agent-context.png" alt="用于自定义上下文的 Agent Settings 面板" size="lg" />