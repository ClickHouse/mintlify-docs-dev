...
<Image img="/images/use-cases/observability/clickhouse-execution.png" alt="ClickHouse 执行" size="lg" />
...
<Image img="/images/use-cases/observability/elasticsearch-execution.png" alt="Elasticsearch 执行" size="lg" />
