...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="通过 Bindplane 在 ClickStack 中查看遥测信号" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="通过 Bindplane 在 ClickStack 中查看遥测信号" size="lg" />
  </Step>
</Steps>
