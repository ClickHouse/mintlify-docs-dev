...
<Accordion title="是否有用于浏览和搜索指标的 UI？">
  ![指标属性浏览器](/images/clickstack/faq/metrics-explorer.png)
...
* [Schemas](/zh/clickstack/ingesting-data/schemas) — 适用于日志、链路追踪和指标的 OpenTelemetry 数据 schema。
