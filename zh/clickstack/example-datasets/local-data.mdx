...
<Tabs>
  <Tab title="托管 ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="HyperDX 本地日志" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="内存随时间变化" size="lg" />

        注意，返回的数值是浮点数形式的 `%` 值。为了更清晰地显示，请选择 `Set number format`。

        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="数值格式" size="lg" />

        在随后出现的菜单中，从 `Output format` 下拉菜单里选择 `Percentage`，然后点击 `Apply`。

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="内存百分比随时间变化" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack 开源版">
    ...
    <Image img="/images/use-cases/observability/hyperdx-22.png" alt="数字格式" size="lg" />

    在随后出现的菜单中，您可以从 `Output format` 下拉菜单中选择 `Percentage`，然后点击 `Apply`。

    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="内存时间占比" size="lg" />
  </Tab>
</Tabs>