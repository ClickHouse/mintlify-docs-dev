...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="会话回放演示应用" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="会话回放搜索" />

    你应该会看到自己的会话已列出，并显示其耗时和事件数量。点击 ▶️ 按钮即可回放。

    <Image img="/images/clickstack/session-replay/session-replay.png" alt="会话回放" />
