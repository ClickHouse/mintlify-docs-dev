  ...
  <Tab title="托管 ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-10.png" alt="HyperDX 搜索" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-11.png" alt="会话" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-12.png" alt="会话回放" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-13.png" alt="会话中的错误" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-14.png" alt="会话 trace" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-16.png" alt="列值" size="lg" />

        向上滚动并回到 trace 视图后，我们可以看到日志已与该 span 关联，这得益于我们之前的配置。这些日志提供了更多上下文。

        <Image img="/images/use-cases/observability/hyperdx-17.png" alt="关联的日志" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-18.png" alt="日志" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-19.png" alt="指标" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack 开源版">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/copy_api_key.png" alt="复制 API key" size="lg" />
      </Step>
