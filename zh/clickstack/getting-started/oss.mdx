...
title: '开源 ClickStack 入门'
sidebarTitle: '开源'
description: '开源 ClickStack 入门'
doc_type: 'guide'
keywords: ['开源 ClickStack', '入门', 'Docker 部署', 'HyperDX UI', '本地部署']
---
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-2.png" alt="凭据" size="md" />
