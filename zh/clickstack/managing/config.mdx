...
<Image img="/images/use-cases/observability/hyperdx-25.png" alt="HyperDX 数据源配置" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-config.png" alt="高亮属性配置" size="md" />

点击日志或 span 后，这些属性会显示在侧边面板中：

<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes.png" alt="高亮属性" size="md" />

点击某个属性后，可以选择将该属性用作搜索值。如果在属性配置中提供了可选的 Lucene 表达式，搜索时将使用 Lucene 表达式而不是 SQL 表达式。

<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-search.png" alt="高亮属性搜索" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-26.png" alt="HyperDX 关联来源" size="md" />
