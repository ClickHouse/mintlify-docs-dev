...
<Image img="/images/materialized-view/materialized-view-diagram.png" size="md" alt="materialized view 示意图" />
...
<Image img="/images/clickstack/materialized_views/generated_sql.png" size="lg" alt="生成的 SQL" />
...
* [聚合函数与状态](/zh/reference/functions/aggregate-functions)
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/edit_source.png" size="lg" alt="编辑 source" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/add_view.png" size="lg" alt="编辑 source" />
  </Step>
  ...
  <Step>
    ...
    * materialized view 中对应的聚合列，例如 `avg__Duration`
    ...
    <Image img="/images/clickstack/materialized_views/select_metrics.png" size="lg" alt="选择指标" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_time_granularity.png" size="lg" alt="选择时间粒度" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_min_time.png" size="lg" alt="选择最小时间" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/save_source.png" size="lg" alt="保存 Source" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/materialized_views/accelerated_visual.png" size="lg" alt="加速的可视化" />
