...
<Tabs>
  <Tab title="托管 ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="托管架构" size="lg" />
  ...
  <Tab title="开源 ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="架构" size="lg" />
