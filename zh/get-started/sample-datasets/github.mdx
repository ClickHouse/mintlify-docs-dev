...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="按新增和删除的行数" size="md" />

**按提交和作者：**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="按提交和作者" size="md" />
...
结果集中有 20 行。耗时：0.098 秒。已处理 754 万行、42.16 MB（7667 万行/秒，428.99 MB/秒）。
```

Sankey 图表 (SuperSet) 可以很好地展示这一点。注意，我们将 `LIMIT BY` 增加到 3，以便找出每位作者对应的前 3 位“代码移除者”，从而让可视化结果更加丰富。

<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Superset 作者矩阵" size="md" />

Alexey 显然很喜欢删除别人的代码。为了让代码删除情况的视图更加均衡，我们把他排除掉。

<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Superset 作者矩阵 v2" size="md" />
