...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="每日事件数" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="闷热潮湿的日子" />