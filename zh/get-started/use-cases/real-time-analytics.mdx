...
<Image img="/images/use-cases/rta-considerations.png" alt="实时分析：摄取、转换和查询所需时间" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="ClickHouse 如何支撑实时分析" />
  </div>
