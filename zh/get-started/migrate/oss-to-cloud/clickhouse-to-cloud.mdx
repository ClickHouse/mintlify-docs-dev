...
<Image img="/images/integrations/migration/self-managed-01.png" size="lg" alt="迁移自管理 ClickHouse" />
...
<Image img="/images/integrations/migration/self-managed-02.png" size="lg" alt="迁移自管理 ClickHouse" />
...
在此示例中，自管理 ClickHouse server 是 *源端*，ClickHouse Cloud 服务是 *目标端*。
...
<Image img="/images/integrations/migration/self-managed-03.png" size="lg" alt="迁移自管理 ClickHouse" />
...
<Image img="/images/integrations/migration/self-managed-04.png" size="lg" alt="迁移自管理 ClickHouse" />
...
<Image img="/images/integrations/migration/self-managed-05.png" size="lg" alt="迁移自管理 ClickHouse" />
...
<Image img="/images/integrations/migration/self-managed-06.png" size="lg" alt="迁移自管理 ClickHouse" />
