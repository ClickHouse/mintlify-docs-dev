...
<Image img="/images/cloud/onboard/discover/use_cases/snowflake_architecture.png" size="md" alt="Snowflake 架构" />
...
<Image img="/images/cloud/onboard/discover/use_cases/cloud_architecture.png" size="md" alt="ClickHouse Cloud 架构" />
