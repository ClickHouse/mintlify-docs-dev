...
<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="PostgreSQL 稀疏索引" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="PostgreSQL 分区到 ClickHouse 分区" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="ClickHouse 中的 PostgreSQL PROJECTION" />
