...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="迁移自管理 ClickHouse" />
...
ClickHouse 提供的[integration engine](/zh/reference/engines/table-engines#integration-engines) 或 [表函数](/zh/reference/functions/table-functions)，
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="迁移自管理 ClickHouse" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="迁移自管理 ClickHouse" />
