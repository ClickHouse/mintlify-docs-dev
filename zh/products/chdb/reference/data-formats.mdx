...
* `DataFrame` 作为输入和输出格式，其类型为 Python `pandas.DataFrame`。示例请参见 [`test_joindf.py`](https://github.com/chdb-io/chdb/blob/main/tests/test_joindf.py)
...
有关更多信息和示例，请参阅 [ClickHouse 输入和输出数据格式](/zh/reference/formats)。