...
* **多种数据格式** - 支持 Parquet、CSV、JSON、Arrow、ORC 等输入与输出，以及[另外 70 多种格式](/zh/reference/formats)
...
了解更多：[DataStore 文档](/zh/products/chdb/datastore)
...
* [配置](/zh/products/chdb/configuration) - 引擎、日志、性能分析
* [调试](/zh/products/chdb/debugging) - explain()、性能分析、日志
...
* **[DataStore 对比 Pandas](/zh/products/chdb/datastore#performance)** - 常见操作下，速度最高可达 pandas 的 20 倍

<Image img="/images/chdb/df_bench.png" alt="DataFrame 基准测试结果" size="md" />
