---
title: 'DataStore - 与 Pandas 兼容的 API'
sidebarTitle: '概览'
slug: /chdb/datastore
...
<div id="datastore-pandas-compatible-api-with-sql-optimization">
  # DataStore：与 pandas 兼容的 API，且具备 SQL 优化能力
</div>

DataStore 是 chDB 提供的与 pandas 兼容的 API，它将熟悉的 pandas DataFrame 接口与 SQL 查询优化的强大能力结合起来，让你能够编写 pandas 风格的代码，同时获得 ClickHouse 级别的性能。
...
* [配置](/zh/products/chdb/configuration) - 所有配置选项
* [性能模式](/zh/products/chdb/configuration/performance-mode) - 以 SQL 为核心、实现最大吞吐量的模式
* [调试](/zh/products/chdb/debugging) - Explain、性能分析和日志
