...
<Tip>
  客户应定期执行备份恢复测试，以了解其服务规模和配置对应的具体 RTO。
</Tip>
...
默认情况下，ClickHouse Cloud 每 24 小时为您的[服务创建一次 Backup](/zh/products/cloud/guides/backups)。
...
2. 在要恢复的目标备份对应的“Actions”下，点击三点菜单。
3. 为新服务指定名称，然后从该备份中恢复

<Image img="/images/cloud/guides/restore_backup.png" size="md" alt="从备份中恢复" />
