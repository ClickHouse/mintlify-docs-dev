...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="添加付款方式" size="lg" />

3. 如果您要编辑信用卡，请点击页面顶部的 **编辑信用卡** 按钮。

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="编辑信用卡" size="lg" />
...
<div id="steps-switch-org-already-active">
  ### 将组织的计费方式从信用卡切换到已在你其他某个组织中启用的 Marketplace 订阅的步骤
</div>

1. 前往 ClickHouse Cloud 控制台中的 **Billing** 页面。
2. 点击 **付款方式** 旁边的编辑图标。

<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="编辑付款方式" size="lg" />

3. 在 **编辑付款方式** 对话框中，你会看到当前信用卡被列为主付款方式。
4. 在信用卡下方，会显示你其他组织中符合条件的 Marketplace 订阅。每个条目都会显示 Marketplace 类型 (例如 AWS Marketplace) 以及关联的组织名称。
5. 选择要用于为该组织用量计费的 Marketplace 订阅。
6. 点击 **更新付款方式** 以确认。

<div id="steps-switch-org-different-org">
  ### 将某个组织当前的 Marketplace 订阅切换为由另一个组织使用的订阅的步骤
</div>

1. 前往 ClickHouse Cloud 控制台中的 **Billing** 页面。
2. 点击 **付款方式** 旁边的编辑图标。

<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="编辑付款方式" size="lg" />

3. 在 **编辑付款方式** 对话框中，您会看到当前的 Marketplace 订阅被列为付款方式。
4. 在当前 Marketplace 订阅下方，会显示来自您其他组织的其他符合条件的 Marketplace 订阅。每个条目都会显示 Marketplace 类型 (例如 AWS Marketplace) 以及关联的组织名称。
5. 选择您希望用于为该组织用量计费的新 Marketplace 订阅。
6. 点击 **更新付款方式** 进行确认。
...
1. 前往 ClickHouse Cloud 控制台中的 **Billing** 页面。
2. 在 **Billing** 页面的顶部，你会看到主付款方式显示为 Marketplace 订阅，备用付款方式显示为 **None**。
3. 点击 **add credit card** 按钮，设置备用付款方式。

<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="添加备用信用卡" size="lg" />

4. 按照说明添加或更新信用卡的账单地址信息。保存后，**Billing** 页面将显示备用信用卡以及主要的 Marketplace 订阅。

<Note>
  配置备用信用卡后，你还可以点击按钮编辑信用卡，并将其设为主付款方式。
  但如果这样做，你的信用卡将成为该组织唯一的付款方式，而你的 Marketplace 订阅会从 ClickHouse Cloud 中完全移除。
