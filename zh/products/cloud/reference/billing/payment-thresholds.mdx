...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="在 UI 中哪里可以找到账单" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="账单" />
