...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="AWS Marketplace 专属报价电子邮件" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="AWS Marketplace 专属报价电子邮件" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="AWS Marketplace 专属报价电子邮件" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="创建或选择一个组织以对此订阅计费" />

    完成此步骤后，您的组织将连接到 AWS 承诺消费合同，所有用量都将通过您的 AWS 账户计费。
    您可以在 ClickHouse UI 的组织计费页面中确认计费现已关联到 AWS Marketplace。

    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="确认设置已完成" />
