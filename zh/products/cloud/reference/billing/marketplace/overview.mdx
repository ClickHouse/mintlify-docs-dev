...
<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="市场注册和组织关联" border />
...
请参阅[计费概览](/zh/products/cloud/reference/billing)。
