...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" size="lg" alt="Billing 页面中已打开 Actions 菜单，并高亮显示 Add spend alerts" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" size="md" alt="组织支出告警对话框，包含支出上限、自动阈值告警和通知渠道" />
  </Step>
</Steps>
