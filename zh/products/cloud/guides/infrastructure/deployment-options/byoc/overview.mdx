...
总体而言，BYOC 将 ClickHouse 控制平面 (运行在 ClickHouse VPC 中并由 ClickHouse Cloud 管理) 与数据平面分离；数据平面则完全运行在您的云账户中，包含您的 ClickHouse 集群、数据和备份。有关所涉组件及其之间流量流向的详细说明，请参阅[架构](/zh/products/bring-your-own-cloud/overview/architecture)页面。
...
* AWS (GA)
* GCP (GA)
* Azure (私有预览) 。如果您感兴趣，请在[这里](https://clickhouse.com/cloud/bring-your-own-cloud)加入等候名单。
