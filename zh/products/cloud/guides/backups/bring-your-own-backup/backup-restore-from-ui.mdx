...
<Note>
  系统已配置为每 24 小时自动向您的外部存储桶执行一次“完整”备份，且该频率不可调整。
</Note>
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/change_external_backup.png" alt="更改外部备份" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/configure_arn_s3_details.png" alt="配置 AWS IAM Role ARN 和 S3 存储桶 详细信息" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups.png" alt="查看存储在你的存储桶中的备份" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/backup_command.png" alt="获取用于恢复备份的 SQL 命令" size="md" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_configure.png" alt="配置 GCP HMAC Key 和 Secret" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_stored_backups.png" alt="查看存储在你的存储桶中的备份" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_restore_command.png" alt="获取用于恢复备份的 SQL 命令" size="md" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/azure_connection_details.png" alt="提供 Azure 存储账户的连接字符串和容器名称" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups_azure.png" alt="查看存储在您的存储桶中的备份" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/restore_backups_azure.png" alt="在 Azure 中恢复备份" size="md" />
