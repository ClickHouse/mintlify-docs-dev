...
本指南介绍 ClickHouse Cloud 中备份的工作原理、可为你的服务配置的备份选项，以及如何从备份中恢复。

**前置条件**

* 你已阅读[“ClickHouse Cloud 中备份的工作原理”](/zh/products/cloud/features/backups/overview#how-backups-work-in-clickhouse-cloud) (功能概览页)
...
<Image img="/images/cloud/manage/backup-status-list.png" size="md" alt="ClickHouse Cloud 中的备份状态列表" border />
...
<Image img="/images/cloud/manage/backup-usage.png" size="md" alt="ClickHouse Cloud 中的备份使用情况图表" border />
...
<Image img="/images/cloud/manage/backup-restore.png" size="md" alt="在 ClickHouse Cloud 中恢复备份" />

在新服务准备就绪之前，它会在服务列表中显示为 `Provisioning`：

<Image img="/images/cloud/manage/backup-service-provisioning.png" size="md" alt="服务正在预配中" border />
