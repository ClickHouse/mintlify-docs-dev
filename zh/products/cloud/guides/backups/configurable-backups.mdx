...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="配置备份设置" border />

这样会在右侧打开一个选项卡，你可以在其中为保留策略、频率和开始时间选择相应的值。保存所选设置后，它们才会生效。

<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="选择备份保留策略和频率" border />
