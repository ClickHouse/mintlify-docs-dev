...
description: '轻松将已保存的查询转换为 REST API 端点'
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="测试示例查询" />

    接下来，保存该查询：

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="保存示例查询" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="配置查询端点" />
    ...
    * 指定允许跨源资源共享 (CORS) 的域名
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="端点 curl 命令" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="端点 curl 测试" />

    发送第一个请求后，**共享** 按钮右侧应会立即出现一个新按钮。点击它会打开一个弹出面板，其中包含该查询的监控数据：

    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="端点监控" />
  </Step>
</Steps>
