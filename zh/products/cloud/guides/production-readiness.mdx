...
ClickHouse Cloud 中的[私有网络](/zh/products/cloud/guides/security/connectivity/private-networking)可让您将 ClickHouse 服务直接连接到云虚拟网络，确保数据不会经过公网传输。这对于有严格安全性或合规要求的组织，以及在私有子网中运行应用程序的用户而言至关重要。
...
详细了解[云访问管理](/zh/products/cloud/guides/security/cloud-access-management)和 [SAML 单点登录设置](/zh/products/cloud/guides/security/cloud-access-management/saml-sso-setup)。
...
如果当前的 [service 层级限制](/zh/products/cloud/features/cloud-tiers)已影响到您的生产环境运行，请考虑选择升级路径，以获得更完善的功能，例如[私有网络](/zh/products/cloud/guides/security/connectivity/private-networking)、[TDE/CMEK](/zh/products/cloud/guides/security/cmek) (使用客户管理加密密钥的透明数据加密) ，或[高级备份选项](/zh/products/cloud/guides/backups/configurable-backups)。