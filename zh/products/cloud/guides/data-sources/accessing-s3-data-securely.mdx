...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="ClickHouse 安全访问 S3 概览" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="获取 ClickHouse 服务的 IAM 角色 ARN" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="显示 IAM Role ARN 的 CloudFormation stack 输出" border />
