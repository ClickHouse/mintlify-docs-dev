...
在 Console 中执行的活动都会记录到审计日志中。如果你拥有 Admin 或 Developer 组织角色，则可以查看该日志，并将其集成到你的日志系统中。
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/security/activity_log1.png" size="md" alt="ClickHouse Cloud 活动选项卡" border />
  ...
  <Step>
    ...
    * **Time:** 事件的时间戳
    ...
    <Image img="/images/cloud/security/activity_log2.png" size="md" alt="ClickHouse Cloud 活动表" border />
...
<div class="eighty-percent">
  <Image img="/images/cloud/security/activity_log3.png" size="lg" alt="ClickHouse Cloud Activity CSV 导出" border />
</div>
