...
目前，我们支持服务提供商发起的单点登录、通过独立连接支持多个组织，以及即时预配。暂不支持跨域身份管理系统 (SCIM) 或属性映射。
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="开始设置 SAML" force />
  </Step>
  ...
  <Step>
    ...
    * [配置 Duo SAML](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="创建身份提供商应用程序" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="添加元数据 URL" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="添加要验证的域名" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="验证您的域名" force />
  </Step>
...
<Accordion title="创建 Google Web 应用">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Google SAML 应用" force />
...
<Accordion title="创建 Azure Enterprise 应用程序">
  ...
  5. 输入名称，选择 **Integrate any other application you don&#39;t find in the gallery (Non-gallery)**，然后点击 **Create**。
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Azure 非库应用" force />
  ...
  10. 在 Attributes &amp; Claims 下添加 (A) 或更新 (U) 以下内容：
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="属性和声明" force />
