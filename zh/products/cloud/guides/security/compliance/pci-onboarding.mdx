...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_1.png" size="md" alt="启用 PCI" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/pci_2.png" size="md" alt="已启用 PCI" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_3.png" size="md" alt="部署到 PCI 区域" background="black" />
