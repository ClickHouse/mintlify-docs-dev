...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="请求启用 HIPAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="提交 BAA 请求" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA 已启用" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="部署到 HIPAA 区域" background="black" />
