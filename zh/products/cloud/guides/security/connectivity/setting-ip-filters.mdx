...
<Info>
  **仅适用于 PrivateLink 外部的连接**
  ...
  IP 访问列表仅适用于来自公共互联网 (即 [PrivateLink](/zh/products/cloud/guides/security/connectivity/private-networking) 之外) 的连接。
...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="ClickHouse Cloud 中现有的访问列表" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="在 ClickHouse Cloud 的访问列表中添加单个 IP" border />
