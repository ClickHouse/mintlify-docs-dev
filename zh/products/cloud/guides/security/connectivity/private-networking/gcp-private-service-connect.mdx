...
description: '本文介绍如何通过 Google Cloud Platform (GCP) Private Service Connect (PSC) 连接到 ClickHouse Cloud，以及如何使用 ClickHouse Cloud IP 访问列表禁止非 GCP PSC 地址访问您的 ClickHouse Cloud 服务。'
...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Private Service Connect 概览" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-create.png" size="lg" alt="专用终结点" border />
...
<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="在 Google Cloud Console 中打开 Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="为 Private Service Connect 启用 Global Access" border />

要创建 PSC 端点，请点击 **ADD ENDPOINT** 按钮。

连接获批后，**Status** 列会从 **Pending** 变为 **Accepted**。

<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="复制 PSC Connection ID" border />
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="从 ClickHouse Cloud 移除专用终结点" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="专用终结点过滤器" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="专用终结点 DNS 名称" border />
