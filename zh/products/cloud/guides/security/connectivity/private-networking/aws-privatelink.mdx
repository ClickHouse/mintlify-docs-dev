...
<Image img="/images/cloud/security/aws-privatelink-pe-create.png" size="md" alt="专用终结点" border />
...
<Image img="/images/cloud/security/aws-privatelink-endpoint-settings.png" size="md" alt="AWS PrivateLink 端点设置" border />
...
<Image img="/images/cloud/security/aws-privatelink-select-vpc-and-subnets.png" size="md" alt="选择 VPC 和子网" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-filters.png" size="md" alt="专用终结点过滤器" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-dns-name.png" size="md" alt="专用终结点 DNS 名称" border />
