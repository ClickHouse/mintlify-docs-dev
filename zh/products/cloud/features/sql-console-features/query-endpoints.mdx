...
description: '通过已保存的查询轻松创建 REST API 端点'
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/console-api-keys.png" size="md" alt="API 密钥" />

    2. 点击用于查询 API 端点的 API 密钥旁边的 **Edit**

    <Image img="/images/cloud/guides/query-endpoints/api-key-edit.png" size="md" alt="编辑" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/specific-locations.png" size="md" alt="特定位置" />
