...
description: '借助 system.query_log 数据可视化，简化查询调试和性能优化'
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Query Insights UI 延迟图表" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Query Insights UI Recent Queries 表格" border />
