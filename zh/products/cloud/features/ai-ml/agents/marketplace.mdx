...
<Image img="/images/cloud/agent-builder/marketplace/marketplace.png" alt="聊天界面，左侧边栏中的 智能体市场 选项被高亮显示" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/browse.png" alt="智能体市场界面，显示标题、搜索栏、类别选项卡（通用、人力资源、研发、财务、IT、销售、售后、全部）以及一个可见的智能体卡片" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/use-agent.png" alt="显示智能体名称、图标以及“置顶”“复制链接”和“开始聊天”操作的智能体详情模态框" size="md" />
...
有关权限模型，请参阅[共享与访问](/zh/products/cloud/features/ai-ml/agents/sharing-and-access)。