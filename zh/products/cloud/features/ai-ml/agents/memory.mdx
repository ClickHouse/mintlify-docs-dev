...
<Image img="/images/cloud/agent-builder/memory/memories.png" alt="记忆面板，显示左侧导航中高亮的大脑图标、过滤输入框、Add 按钮、使用记忆复选框、一条带有编辑和删除控件的记忆条目，以及一个 Admin Settings 按钮" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="高亮显示 Create Memory + 按钮的 Memory 面板" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/filter.png" alt="Memory面板，已高亮显示“筛选Memory”输入框，并输入了“demo”" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/edit.png" alt="高亮显示 Edit Memory 铅笔图标的 Memory 条目" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/delete.png" alt="高亮显示“删除Memory”垃圾桶图标的Memory条目" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="Memory面板，顶部的“使用Memory”复选框已高亮显示" size="sm" />
