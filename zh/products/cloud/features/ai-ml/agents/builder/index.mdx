...
<Tip>
  刚开始接触 ClickHouse 智能体？请先阅读[快速入门](/zh/products/cloud/features/ai-ml/agents/quickstart)。下方页面将详细介绍构建器的各个部分。
</Tip>
...
| 页面                                                                      | 描述                 |
| ----------------------------------------------------------------------- | ------------------ |
| [模型参数](/zh/products/cloud/features/ai-ml/agents/builder/model-parameters)  | 选择模型并调整生成参数。       |
