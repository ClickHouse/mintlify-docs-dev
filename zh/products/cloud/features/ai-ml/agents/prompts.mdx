...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="提示词 面板中，左侧的 + 按钮被高亮显示，右侧打开了“创建提示词”表单，显示了“提示词名称”“文本”“分类”“特殊变量”“描述”和“命令”字段，以及“创建提示词”按钮" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="提示词面板中选中了一个提示词，右侧显示其详细信息，菜单中显示 Preview 和 Edit 选项" size="lg" />

预览中会显示提示词文本，以及作者和日期。点击 **Use Prompt** 可将正文插入输入框。如果提示词包含变量，请先填写。

<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="提示词预览模态框，显示提示词标题、作者、日期、正文文本以及 Use Prompt 按钮" size="md" />
