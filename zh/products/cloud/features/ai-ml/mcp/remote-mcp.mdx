...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="在 Connect 对话框中选择 MCP" size="md" />

打开切换开关，为该服务启用 MCP：

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="启用 MCP 服务器" size="md" />
...
如需将 ClickHouse Cloud 远程 MCP server 连接到 Notion 自定义智能体，请参阅专门的[将 Notion 连接到 ClickHouse](/zh/integrations/connectors/data-integrations/integrations/notion)集成指南。
