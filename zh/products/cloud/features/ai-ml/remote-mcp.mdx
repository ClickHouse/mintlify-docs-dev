...
<div id="remote-vs-oss">
  ## 远程 MCP 服务器 与开源 MCP server 对比
</div>

ClickHouse 提供两种 MCP server。

|          | Remote MCP server (Cloud)                            | 开源 MCP server                                                            |
| -------- | ---------------------------------------------------- | ------------------------------------------------------------------------ |
...
如需用于自托管 ClickHouse instance，请参阅[开源 MCP server 指南](/zh/guides/use-cases/ai-ml/MCP)。
