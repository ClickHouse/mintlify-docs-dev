...
<Image img="/images/cloud/manage/scaling-patch-request.png" size="lg" alt="扩缩容 PATCH 请求" border />

*用于更新 `numReplicas` 的 `PATCH` 请求*

<Image img="/images/cloud/manage/scaling-patch-response.png" size="md" alt="扩缩容 PATCH 响应" border />
...
<Image img="/images/cloud/manage/scaling-configure.png" size="md" alt="扩缩容配置" border />
...
<Image img="/images/cloud/manage/scaling-memory-allocation.png" size="md" alt="扩缩容内存分配" border />