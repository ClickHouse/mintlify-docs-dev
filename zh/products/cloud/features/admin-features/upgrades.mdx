...
使用 ClickHouse Cloud 时，您完全不必操心打补丁和升级。我们会定期推出升级，其中包含缺陷修复、新功能和性能改进。要查看 ClickHouse 的完整更新内容列表，请参阅我们的 [Cloud 更新日志](/zh/resources/changelogs/cloud/2026)。
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="选择发布渠道类型" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="计划升级" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="计划升级时间窗口" border />
</div>
