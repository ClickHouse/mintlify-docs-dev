...
<Image img="/images/cloud/manage/openapi1.png" size="sm" alt="API Key 选项卡" border />

2. **API Key** 页面初始会显示一个提示，指导您创建第一个 API Key，如下所示。创建第一个密钥后，您可以使用右上角出现的 `New API Key` 按钮创建新的密钥。

<Image img="/images/cloud/manage/openapi2.png" size="md" alt="API Key 页面" border />
...
<Image img="/images/cloud/manage/openapi4.png" size="md" alt="API Key 详细信息" border />
...
<Image img="/images/cloud/manage/openapi5.png" size="md" alt="API Key 管理页面" border />
