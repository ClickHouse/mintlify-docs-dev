...
<Image img="/images/cloud/manage/postman/postman1.png" size="md" alt="Postman 网站" border />
...
<Image img="/images/cloud/manage/postman/postman2.png" size="md" alt="创建工作区" border />
...
<Image img="/images/cloud/manage/postman/postman3.png" size="md" alt="Explore > 导入" border />

* 此时会弹出一个模态窗口：

<Image img="/images/cloud/manage/postman/postman4.png" size="md" alt="API URL 输入项" border />

* 输入 API 地址：&quot;https://api.clickhouse.cloud/v1&quot;，然后按下 &#39;Enter&#39;：

* 点击 &quot;Import&quot; 按钮，选择 &quot;Postman Collection&quot;：

<Image img="/images/cloud/manage/postman/postman6.png" size="md" alt="集合 > 导入" border />
...
<Image img="/images/cloud/manage/postman/postman7.png" size="md" alt="导入 API" border />

* 点击“ClickHouse Cloud 的 API 规范”，然后在中间面板中选择“Authorization”选项卡：

<Image img="/images/cloud/manage/postman/postman8.png" size="md" alt="导入完成" border />
...
<Image img="/images/cloud/manage/postman/postman10.png" size="md" alt="凭据" border />
...
<Image img="/images/cloud/manage/postman/postman11.png" size="md" alt="Organization ID 和 Service ID" border />
...
<Image img="/images/cloud/manage/postman/postman12.png" size="md" alt="测试获取组织信息" border />

* 返回结果应显示你的组织详细信息，且 `"status": 200`。 (如果你收到 `"status": 400`，但没有任何组织信息，则说明配置不正确。) 

<Image img="/images/cloud/manage/postman/postman13.png" size="md" alt="状态" border />
...
<Image img="/images/cloud/manage/postman/postman14.png" size="md" alt="测试获取组织详细信息" border />

* 将此值改为花括号中的 `orgid`：`{{orgid}}` (如果你之前已设置过该值，会出现一个包含该值的菜单) ：

<Image img="/images/cloud/manage/postman/postman15.png" size="md" alt="提交测试" border />

* 点击“Save”按钮后，再点击屏幕右上角蓝色的“Send”按钮。

<Image img="/images/cloud/manage/postman/postman16.png" size="md" alt="返回值" border />
...
<Image img="/images/cloud/manage/postman/postman17.png" size="md" alt="服务列表" border />
