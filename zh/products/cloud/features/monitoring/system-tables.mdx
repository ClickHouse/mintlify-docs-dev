...
description: '通过直接查询系统表来监控 ClickHouse Cloud'
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="原生高级可观测性仪表板" border />
