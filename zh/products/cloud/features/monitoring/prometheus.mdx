...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="配置 Grafana 指标端点" border />

<br />

配置完成后，你应该会在下拉列表中看到这些指标，可选择它们来配置仪表盘：

<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Grafana 指标浏览器下拉列表" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Grafana 指标浏览器图表" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Grafana 指标浏览器" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Prometheus 与 Datadog 集成" />
