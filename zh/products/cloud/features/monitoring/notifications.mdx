...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="ClickHouse Cloud 通知弹出面板" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="ClickHouse Cloud 通知活动日志" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="ClickHouse Cloud 通知设置界面" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="ClickHouse Cloud 通知投递设置" border />
