...
ClickHouse Cloud 中的服务内置开箱即用的监控组件，可为用户提供仪表盘和通知。默认情况下，Cloud 控制台中的所有用户都可以访问这些仪表盘。
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="ClickHouse Cloud 中的高级仪表板" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Query Insights UI 概览" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Query Insights 延迟图表" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Query Insights 最近查询表" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Query Insights UI 查询下钻" border />

**Query info** 选项卡中的所有指标都是聚合后的指标；如果选择 **Query history** 选项卡，还可以查看每次单独运行的指标：

<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Query Insights UI 查询信息" border />
