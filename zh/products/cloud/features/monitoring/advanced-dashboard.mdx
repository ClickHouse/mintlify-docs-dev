...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="高级仪表板" />
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="高级仪表板" />

每个可视化都关联了一个用于填充数据的 SQL 查询。您可以
点击铅笔图标编辑该查询。

<Image img="/images/cloud/manage/monitoring/edit_visualization.png" size="lg" alt="高级仪表板" />
...
<Image img="/images/cloud/manage/monitoring/inserted_rows_max_parts_for_partition.png" size="lg" alt="非批量插入" />
...
<Image img="/images/cloud/manage/monitoring/resource_intensive_query.png" size="lg" alt="资源密集型查询" />
...
<Image img="/images/cloud/manage/monitoring/selected_rows_sec.png" size="lg" alt="资源密集型查询" />
