...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="ClickHouse Cloud 中的单个服务" />
...
<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="ClickHouse Cloud 中的计算分离" />
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="包含主节点和次级服务的仓库示例" background="white" />
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="共享相同数据的服务之间的用户访问" />
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="网络访问控制设置" />
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="仓库中的读写与只读服务" />
...
<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="在仓库中创建新服务" />
