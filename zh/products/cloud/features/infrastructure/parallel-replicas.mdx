...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="分片架构" />
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="非分片架构" />
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="并行副本" />
...
<Image img="/images/deployment-guides/parallel-replicas-4.png" size="md" alt="通知" />
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="动态协调 - 第 1 部分" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="动态协调 - 第 2 部分" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="动态协调 - 第 3 部分" />
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="未使用 parallel_replica 的 EXPLAIN" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="使用 parallel_replica 的 EXPLAIN" />