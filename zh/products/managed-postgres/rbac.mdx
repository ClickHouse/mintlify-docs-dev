...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Users and roles 菜单" size="md" border />

2. 切换到 **Roles** 选项卡，然后点击 **Create role**。
3. 输入角色名称，然后点击 **+ Allow**，并从实体列表中选择 **Postgres Service**。

<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="选择 Postgres Service 实体" size="md" border />

4. 选择该角色要限定到的 Postgres 服务，然后选择要授予的权限。

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="为角色配置 Postgres 权限" size="md" border />
