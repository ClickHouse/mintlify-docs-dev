...
<div id="pg-dump-pg-restore">
  # 使用 pg_dump 和 pg_restore 迁移到 Managed Postgres
</div>

本指南将分步说明如何使用 `pg_dump` 和 `pg_restore` 工具，将您的 PostgreSQL 数据库迁移到 ClickHouse Managed Postgres。
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="源 PostgreSQL 数据库设置" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump 命令执行" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore 命令执行" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="目标 Managed Postgres 数据库配置" size="xl" border />
