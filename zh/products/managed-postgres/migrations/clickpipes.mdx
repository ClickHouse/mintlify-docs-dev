...
<Image img="/images/managed-postgres/pgpg/startimport.png" alt="带有“开始导入”按钮的数据源页面" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationform.png" alt="步骤 1：带有摄取方式选项的源数据库连接表单" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.png" alt="运行 psql 导入 schema 后的终端输出" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="第 5 步：按 schema 分组的表选择器，带有“Create migration”按钮" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationlist.png" alt="显示正在运行的迁移的数据源列表" size="lg" border />
