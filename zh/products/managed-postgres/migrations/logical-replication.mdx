...
本指南将分步说明如何使用 Postgres 原生逻辑复制将 PostgreSQL 数据库迁移到 ClickHouse Managed Postgres。
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="源 PostgreSQL 复制设置" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="源 PostgreSQL 表设置" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="创建 ClickHouse Managed Postgres 实例" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="目标 ClickHouse Managed Postgres 初始设置" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="逻辑复制后的迁移结果" size="xl" border />
