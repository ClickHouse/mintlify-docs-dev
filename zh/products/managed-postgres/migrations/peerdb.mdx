...
本指南将逐步说明如何使用 PeerDB 将 PostgreSQL 数据库迁移到 ClickHouse Managed Postgres。
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="创建源 Peer" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="创建目标 peer" size="md" border />

现在，你应该能在“Peers”部分看到源 peer 和目标 peer 都已列出。

<Image img="/images/managed-postgres/peerdb/peers.png" alt="Peers 列表" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="创建 Mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="Mirror 设置" size="md" border />

4. 选择你要迁移的表。你可以选择特定表，也可以选择源数据库中的所有表。

<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="表选择器" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="Mirrors 列表" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="初始加载进度" size="md" border />
