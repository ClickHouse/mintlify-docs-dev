...
<Image img="/images/managed-postgres/connect-button.png" alt="点击左侧边栏中的 Connect 以查看连接详细信息" size="md" border />

点击 **Connect** 会打开一个连接弹窗，以多种格式显示连接凭据和连接字符串。

<Image img="/images/managed-postgres/connect-modal.png" alt="显示凭据和连接字符串格式的连接弹窗" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="从 Settings 选项卡下载 CA 证书" size="md" border />
