...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="IO 密集型读+写基准测试结果" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="IO 密集型只读基准测试结果" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="CPU 密集型基准测试结果" size="md" border />
