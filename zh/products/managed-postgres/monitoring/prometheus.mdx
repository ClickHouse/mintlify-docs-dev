...
description: '将 Managed Postgres 的指标抓取到 Prometheus、Grafana、Datadog 或任何兼容 OpenMetrics 的 collector'
...
<Image img="/images/managed-postgres/monitoring/grafana-dashboard.png" alt="Managed Postgres 服务的 Grafana 仪表盘" size="md" border />
