...
实例左侧边栏中的 **监控** 选项卡会显示所选时间段内资源使用情况和数据库活动的实时图表。

<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="显示 IOPS、CPU 使用率、内存、磁盘、网络流量、数据库大小、连接数、吞吐量、事务、缓存命中率和死锁的 监控 仪表板" size="lg" border />&quot;
