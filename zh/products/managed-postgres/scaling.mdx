...
<Image img="/images/managed-postgres/instance-types.png" alt="实例类型" size="md" border />
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="扩缩容设置" size="md" border />
