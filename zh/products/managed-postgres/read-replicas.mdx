...
<Image img="/images/managed-postgres/warehouse-view.png" alt="带有编辑图标的仓库视图" size="md" border />

这将打开仓库对话框，您可以在其中查看现有服务并创建新的只读副本：

<Image img="/images/managed-postgres/read-replica-dialog.png" alt="只读副本管理对话框" size="md" border />
...
<Image img="/images/managed-postgres/read-replicas-flow.png" alt="显示主实例和副本拓扑的只读副本流视图" size="lg" border />

**Table** 视图会列出每个副本的服务名称、云提供商和区域、服务状态、创建时间，以及 **Detach service** 操作：

<Image img="/images/managed-postgres/read-replicas-table.png" alt="只读副本表格视图" size="lg" border />
