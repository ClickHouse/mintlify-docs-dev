...
sidebarTitle: '快速入门'
title: '快速入门'
description: '体验 NVMe 加速的 Postgres 性能，并通过原生 ClickHouse 集成实现实时分析'
keywords: ['Managed Postgres', '快速入门', '快速开始', '创建数据库', 'NVMe', '性能']
doc_type: 'guide'
---
...
<Image img="/images/managed-postgres/create-service.png" alt="创建 Managed Postgres 服务" size="md" border />

为数据库实例输入名称，然后点击 **Create service**。随后会进入概览页面。

<Image img="/images/managed-postgres/overview.png" alt="Managed Postgres 概览" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Managed Postgres 连接弹窗" size="md" border />
...
<Image img="/images/managed-postgres/integration-landing.png" alt="Managed Postgres 集成为空" size="md" border />
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="Managed Postgres 集成表单" size="md" border />
...
<Image img="/images/managed-postgres/table-picker.png" alt="Managed Postgres 表选择器" size="md" border />
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="获取 ClickHouse 主机名" size="md" border />
...
<Image img="/images/managed-postgres/analytics-list.png" alt="Managed Postgres 分析列表" size="md" border />

点击服务名称，打开 ClickHouse Console 并查看你的复制表。

<Image img="/images/managed-postgres/replicated-tables.png" alt="ClickHouse 中的 Managed Postgres 复制表" size="md" border />
