...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC 创建对等连接" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-2.png" size="lg" alt="BYOC 接受对等连接" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC 添加路由表" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC 添加路由表" border />
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-1.png" size="lg" alt="BYOC PrivateLink 服务端点" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-2.png" size="lg" alt="BYOC PrivateLink 批准" border />
  </Step>
  ...
  <Step>
    ...
    PrivateLink 端点格式与公共端点类似，但会包含一个 `vpce` 子域名。例如：
