...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="BYOC VPC 子网" />

    <Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="BYOC VPC 子网标签" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="BYOC S3 端点" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="已选择 Use existing VPC 的 ClickHouse Cloud BYOC 设置界面" />
