...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-1.png" size="md" alt="BYOC 创建对等连接" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-2.png" size="md" alt="BYOC 接受对等连接" border />

    两个连接都创建完成后，刷新 Google Cloud Console 页面，这 2 个连接的状态应变为 “Active”：

    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-3.png" size="lg" alt="BYOC 接受对等连接" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-1.png" size="lg" alt="BYOC PSC 端点" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-2.png" size="lg" alt="BYOC PSC 端点" border />

    您还可以在 GCP Private Service Connect 控制台的 &quot;Published services&quot; 中找到 PSC 服务名称 (可按服务名称过滤，或查找 ClickHouse 服务) 。

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-3.png" size="lg" alt="BYOC PSC 端点" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-4.png" size="lg" alt="BYOC PSC 端点" border />
  </Step>
  ...
  <Step>
    ...
    * 端点状态应变为“Accepted”；如果未自动接受，请联系 ClickHouse 支持团队。
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-5.png" size="lg" alt="BYOC PSC 端点创建" border />
    ...
    * 点击进入端点详情，获取“PSC Connection ID”，供步骤 [将端点的 PSC Connection ID 添加到服务允许列表](#step-5-add-endpoint-id-allowlist) 使用
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-6.png" size="lg" alt="BYOC PSC 端点详情" border />
  </Step>
