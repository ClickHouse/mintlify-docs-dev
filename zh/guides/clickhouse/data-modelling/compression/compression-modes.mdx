...
<Image img="/images/data-compression/ch_compression_block.png" size="md" alt="说明 ClickHouse 压缩块结构的示意图" />

头部为 (raw&#95;size + data&#95;size + mode)，raw&#95;size 的值为 len(header + compressed&#95;data)。
