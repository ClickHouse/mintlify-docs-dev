...
<Image img="/images/data-modeling/schema-design-indices.png" size="md" alt="ClickHouse 中的稀疏索引" />
...
* [**字典**](/zh/concepts/features/dictionaries) - ClickHouse 特有的一项功能，用于处理 direct joins 和键值查找。
