...
description: '如何优化 JSON schema 设计'
keywords: ['json', 'ClickHouse', '插入', '加载', '格式', 'schema', '结构化', '半结构化']
score: 20
doc_type: 'guide'
---
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="每个 JSON 路径一个列" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="JSON 偏移量" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="共享 JSON 列" />
