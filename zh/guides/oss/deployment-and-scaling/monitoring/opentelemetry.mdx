...
ClickHouse 支持对 [ClickHouse Keeper](/zh/guides/oss/deployment-and-scaling/keeper) 请求进行 OpenTelemetry 追踪 (ClickHouse 的兼容 ZooKeeper 语义的协调服务) 。该功能可让你详细了解 Keeper 操作的整个生命周期，从客户端提交请求到服务端处理。
