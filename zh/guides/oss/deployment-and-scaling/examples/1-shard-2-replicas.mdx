...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="使用 ReplicatedMergeTree 的 1 个分片和 2 个副本的架构图" />
...
<Steps>
  ...
  <Step>
    ...
    由于我们使用的是 ClickHouse Keeper cluster，需要指定该 cluster 中的每个 `<node>`，
