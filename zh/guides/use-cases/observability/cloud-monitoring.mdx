...
本指南为正在评估 ClickHouse Cloud 的企业团队全面介绍了生产部署中的监控与可观测性能力。企业客户经常会询问开箱即用的监控功能、如何与现有可观测性技术栈 (包括 Datadog 和 AWS CloudWatch 等工具) 集成，以及 ClickHouse 的监控能力与自托管部署相比有何差异。
...
这两个仪表板都能在不依赖外部工具的情况下立即提供服务健康状态和性能的可见性，这也是它们区别于 ClickStack 这类更侧重调试的外部工具之处。
