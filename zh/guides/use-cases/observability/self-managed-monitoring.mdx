...
本指南面向正在评估 ClickHouse 开源版的企业团队，全面介绍生产环境部署中的监控与可观测性能力。Enterprise 客户经常会询问开箱即用的监控功能、如何与现有可观测性技术栈 (包括 Datadog 和 AWS CloudWatch 等工具) 集成，以及 ClickHouse 的监控能力与自托管部署相比有何不同。
