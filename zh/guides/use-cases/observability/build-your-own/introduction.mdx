...
<Image img="/images/use-cases/observability/observability-1.png" alt="简单 OTel" size="md" />
...
<Image img="/images/use-cases/observability/observability-2.png" alt="示例 trace" size="lg" border />
