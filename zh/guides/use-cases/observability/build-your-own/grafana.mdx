---
title: '使用 Grafana'
description: '借助 Grafana 和 ClickHouse 实现可观测性'
...
Grafana 是在 ClickHouse 中可观测性数据的首选可视化工具。这是通过 Grafana 官方提供的 ClickHouse 插件实现的。你可以按照[此处](/zh/integrations/connectors/data-visualization/grafana)的安装说明进行操作。
...
<Image img="/images/use-cases/observability/observability-15.png" alt="连接器配置" size="sm" />
...
<Image img="/images/use-cases/observability/observability-16.png" alt="连接器日志配置" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-17.png" alt="从日志跳转到链路追踪" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-18.png" alt="链路追踪" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-19.png" alt="Trace 详情" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-20.png" alt="从链路追踪到日志" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-21.png" alt="仪表盘" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-22.png" alt="时间序列" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-23.png" alt="多折线图" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-24.png" alt="地理数据可视化" size="lg" border />