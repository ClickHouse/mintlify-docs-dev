...
title: '为 AnythingLLM 和 ClickHouse Cloud 设置 ClickHouse MCP 服务器'
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="工具图标" size="md" />

    点击 `Agent Skills`，然后查看 `MCP 服务器` 部分。
    等待直到 `Mcp ClickHouse` 显示为 `On`。

    <Image img="/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="MCP 服务器已就绪" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/allm_conversation.png" alt="对话" size="md" />
  </Step>
</Steps>