...
在本指南中，你将学习如何借助 [chDB](/zh/products/chdb) (一款由 ClickHouse 驱动的快速进程内 SQL OLAP Engine) ，在 Marimo 笔记本 中探索 ClickHouse Cloud 上的数据集。
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="选择英国房产成交价数据集" />

然后点击 `Import dataset`：

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="导入英国房产成交价数据集" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="Marimo 界面" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Marimo 数据可视化" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Marimo 动态图表" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Marimo 动态图表" />
