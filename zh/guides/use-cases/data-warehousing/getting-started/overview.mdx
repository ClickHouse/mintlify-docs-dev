...
<Info>
  **简而言之**
  ...
  本实操指南将演示如何查询数据湖表、通过 MergeTree 加速查询，并将结果写回 Iceberg。所有步骤均使用公开数据集，且同时适用于 Cloud 和 OSS。
</Info>

本指南中的截图来自 [ClickHouse Cloud](https://console.clickhouse.cloud) SQL 控制台。所有查询在 Cloud 和自管理部署中均可运行。
...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Iceberg 查询" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Iceberg 查询" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Iceberg 查询" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="ClickHouse 查询" />
