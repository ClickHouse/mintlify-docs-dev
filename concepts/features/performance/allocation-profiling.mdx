...
## Sampling allocations <a id="sampling-allocations"></a>
...
## Storing jemalloc samples in `system.trace_log` <a id="storing-jemalloc-samples-in-system-trace-log"></a>
...
### Example: analyzing memory usage of a query <a id="example-analyzing-memory-usage-trace-log"></a>
...
## Jemalloc web UI <a id="jemalloc-web-ui"></a>
...
## Fetching heap profiles from SQL <a id="fetching-heap-profiles-from-sql"></a>
...
### Additional settings <a id="fetching-heap-profiles-settings"></a>
...
### Example: generating a flame graph from SQL <a id="example-flamegraph-from-sql"></a>
...
## Flushing heap profiles to disk <a id="flushing-heap-profiles"></a>
...
## Analyzing heap profile files with `jeprof` <a id="analyzing-heap-profile-files-with-jeprof"></a>
...
### Symbolized heap profiles <a id="symbolized-heap-profiles"></a>
...
### Generating a flame graph <a id="generating-flame-graph"></a>
...
## Additional options for the profiler <a id="additional-options-for-profiler"></a>
...
### System table `asynchronous_metrics` <a id="system-table-asynchronous_metrics"></a>
...
### System table `jemalloc_bins` <a id="system-table-jemalloc_bins"></a>
...
### System table `jemalloc_stats` (26.2+) <a id="system-table-jemalloc_stats"></a>
...
### `jmst` 4LW command in Keeper <a id="jmst-4lw-command-in-keeper"></a>
