...
## Basic operation <a id="basic-operation"></a>
...
<Image img="/images/guides/best-practices/simple_skip.png" size="md" alt="Simple Skip"/>
...
### Bloom filter types <a id="bloom-filter-types"></a>
...
## Skip index functions <a id="skip-index-functions"></a>
...
## Skip index settings <a id="skip-index-settings"></a>
...
## Skip index best practices <a id="skip-best-practices"></a>
...
<Image img="/images/guides/best-practices/bad_skip.png" size="md" alt="Bad Skip"/>
...
columns is often incorrect.  This advanced functionality should only be used after investigating other alternatives, such as modifying the primary key (see [How to Pick a Primary Key](/guides/clickhouse/data-modelling/sparse-primary-indexes)), using projections, or using materialized views. Even when a data skipping index is appropriate, careful tuning both the index and the table
