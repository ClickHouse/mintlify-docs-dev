...
## MinMax index <a id="minmax-index"></a>
...
## Text index (text) for full text search <a id="textindex-for-full-text-search"></a>
...
## Generic Bloom filter (scalar) <a id="generic-bloom-filter-scalar"></a>
...
## N-gram Bloom filter (ngrambf\_v1) for substring search *(Deprecated)* <a id="n-gram-bloom-filter-ngrambf-v1-for-substring-search"></a>
...
## Token Bloom filter (tokenbf\_v1) for word-based search *(Deprecated)* <a id="token-bloom-filter-tokenbf-v1-for-word-based-search"></a>
...
## Add indexes during CREATE TABLE (multiple examples) <a id="add-indexes-during-create-table-multiple-examples"></a>
...
## Materializing on existing data and verifying <a id="materializing-on-existing-data-and-verifying"></a>
...
## When to use and when to avoid skipping indexes <a id="when-use-and-when-to-avoid"></a>
...
## Temporarily ignore or force indexes <a id="temporarily-ignore-or-force-indexes"></a>
...
## Related docs <a id="related-docs"></a>
