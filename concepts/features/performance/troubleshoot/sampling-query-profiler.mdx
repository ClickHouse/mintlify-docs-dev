...
ClickHouse provides the [`flameGraph`](/reference/functions/aggregate-functions/reference/flame_graph) aggregate function which builds a flame graph directly from stack traces stored in `trace_log`.
