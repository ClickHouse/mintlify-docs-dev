---
old-slug: /optimize/lazy-materialization
...
<Tip>
**Available from version 25.4** — Lazy materialization was introduced in version 25.4 of ClickHouse, and is turned on by default.
</Tip>
