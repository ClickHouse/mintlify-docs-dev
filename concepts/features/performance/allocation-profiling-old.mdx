...
sidebarTitle: 'Allocation profiling for versions before 25.9'
...
## Sampling allocations and flushing heap profiles <a id="sampling-allocations-and-flushing-heap-profiles"></a>
...
## Analyzing heap profiles <a id="analyzing-heap-profiles"></a>
...
## Controlling allocation profiler during runtime <a id="controlling-allocation-profiler-during-runtime"></a>
