...
## How do Projections work? <a id="how-do-projections-work"></a>
...
### Smarter storage with `_part_offset` <a id="smarter_storage_with_part_offset"></a>
...
### Filtering on columns which aren't in the primary key <a id="filtering-without-using-primary-keys"></a>
...
### Using projections to speed up UK price paid queries <a id="using-projections-to-speed-up-UK-price-paid"></a>
...
### Further examples <a id="further-examples"></a>
...
#### Build a Projection <a id="build-projection"></a>
...
#### Query 1. Average price per year <a id="average-price-projections"></a>
...
#### Query 2. Average price per year in London <a id="average-price-london-projections"></a>
...
#### Query 3. The most expensive neighborhoods <a id="most-expensive-neighborhoods-projections"></a>
...
### Combining projections in one query <a id="combining-projections"></a>
