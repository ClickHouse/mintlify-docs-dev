...
Projections are in some ways similar to [Materialized Views](/concepts/features/materialized-views)
...
<Image img="/static/images/data-modeling/projections_1.png" size="md" alt="Projections in ClickHouse"/>
...
<Image img="/static/images/data-modeling/projections_2.png" size="md" alt="Visualization of the main table uk_price_paid_with_projections and its two projections"/>
...
- [A Practical Introduction to Primary Indexes in ClickHouse](/guides/cloud-oss/data-modelling/sparse-primary-indexes#option-3-projections)
- [Materialized Views](/concepts/features/materialized-views)
