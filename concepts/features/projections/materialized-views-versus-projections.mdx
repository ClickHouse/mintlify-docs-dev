...
## Summary of key differences <a id="key-differences"></a>
...
## Comparing materialized views and projections <a id="choose-between"></a>

### When to choose materialized views <a id="choosing-materialized-views"></a>
...
### When to avoid materialized views <a id="avoid-materialized-views"></a>
...
### When to choose projections <a id="choosing-projections"></a>
...
### When to avoid projections <a id="avoid-projections"></a>
