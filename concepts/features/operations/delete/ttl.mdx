...
## Overview of TTL <a id="overview-of-ttl"></a>
...
## Triggering TTL events <a id="triggering-ttl-events"></a>
...
## Removing rows <a id="removing-rows"></a>
...
## Removing columns <a id="removing-columns"></a>
...
## Implementing a rollup <a id="implementing-a-rollup"></a>
...
## Implementing a hot/warm/cold architecture <a id="implementing-a-hotwarmcold-architecture"></a>
