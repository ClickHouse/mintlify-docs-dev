...
## Lightweight deletes <a id="lightweight-deletes"></a>
...
## Delete mutations <a id="delete-mutations"></a>
...
## Truncate table <a id="truncate-table"></a>
...
## Drop partition <a id="drop-partition"></a>
