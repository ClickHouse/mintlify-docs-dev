...
|||
|------|----|
|<Image img="/images/guides/developer/de_duplication.png"  alt="Deduplication Logo" size="sm"/>|ClickHouse provides free training on deduplication and many other topics.  The [Deleting and Updating Data training module](https://learn.clickhouse.com/visitor_catalog_class/show/1328954/?utm_source=clickhouse&utm_medium=docs) is a good place to start.|

</div>

## Options for deduplication <a id="options-for-deduplication"></a>
...
## Using ReplacingMergeTree for Upserts <a id="using-replacingmergetree-for-upserts"></a>
...
### Avoiding FINAL <a id="avoiding-final"></a>
...
## Using CollapsingMergeTree for updating columns frequently <a id="using-collapsingmergetree-for-updating-columns-frequently"></a>
...
## Real-time updates from multiple threads <a id="real-time-updates-from-multiple-threads"></a>
...
## Why aren't my rows being deduplicated? <a id="why-arent-my-rows-being-deduplicated"></a>
