...
### Uncertain insert status <a id="uncertain-insert-status"></a>
...
### Deduplication window limit <a id="deduplication-window-limit"></a>
...
## Enabling insert deduplication on retries <a id="enabling-insert-deduplication-on-retries"></a>

### Insert deduplication for tables <a id="insert-deduplication-for-tables"></a>
...
### Query-level insert deduplication <a id="query-level-insert-deduplication"></a>
...
## How insert deduplication works <a id="how-insert-deduplication-works"></a>
...
## Insert deduplication with materialized views <a id="insert-deduplication-with-materialized-views"></a>
...
### Identical blocks after materialized view transformations <a id="identical-blocks-after-materialized-view-transformations"></a>
...
### Identical blocks on insertion <a id="identical-blocks-on-insertion"></a>
...
### Identical blocks in insertion with `insert_deduplication_token` <a id="identical-blocks-in-insertion-with-insert_deduplication_token"></a>
...
### Different insert operations generate the same data after transformation in the underlying table of the materialized view <a id="different-insert-operations-generate-the-same-data-after-transformation-in-the-underlying-table-of-the-materialized-view"></a>
...
### Different materialized view inserts into one underlying table with equivalent data <a id="different-materialized-view-inserts-into-one-underlying-table-with-equivalent-data"></a>
