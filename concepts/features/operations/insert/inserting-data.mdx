...
## Inserting into ClickHouse vs. OLTP databases <a id="inserting-into-clickhouse-vs-oltp-databases"></a>
...
## Best practices for Inserts <a id="best-practices-for-inserts"></a>

### Insert in large batch sizes <a id="insert-in-large-batch-sizes"></a>
...
### Ensure consistent batches for idempotent retries <a id="ensure-consistent-batches-for-idempotent-retries"></a>
...
### Insert to a MergeTree table or a distributed table <a id="insert-to-a-mergetree-table-or-a-distributed-table"></a>
...
### Use asynchronous inserts for small batches <a id="use-asynchronous-inserts-for-small-batches"></a>
...
<Image img="/images/guides/postgres-inserts.png" size="md" alt="Postgres inserts"/>
...
### Use official ClickHouse clients <a id="use-official-clickhouse-clients"></a>
...
### Prefer the native format <a id="prefer-the-native-format"></a>
...
### Use the HTTP interface <a id="use-the-http-interface"></a>
...
## Loading data from Postgres <a id="loading-data-from-postgres"></a>
...
## Inserting data from the command line <a id="inserting-data-from-command-line"></a>
...
<Steps>
<Step>
### Download the CSV <a id="download-csv"></a>
...
<Step>
### Create the table <a id="create-table"></a>
...
<Step>
### Insert the data from the command line <a id="insert-data-via-cmd"></a>
...
<Step>
### inserting data via command line with curl <a id="insert-using-curl"></a>
