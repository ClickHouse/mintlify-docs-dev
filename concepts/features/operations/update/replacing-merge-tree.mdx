...
## Automatic upserts of inserted rows <a id="automatic-upserts-of-inserted-rows"></a>
...
<Image img="/images/migrations/postgres-replacingmergetree.png" size="md" alt="ReplacingMergeTree process"/>
...
## Choosing a primary/deduplication key <a id="choosing-a-primarydeduplication-key"></a>
...
## Querying ReplacingMergeTree <a id="querying-replacingmergetree"></a>
...
## FINAL performance <a id="final-performance"></a>
...
## Exploiting partitions with ReplacingMergeTree <a id="exploiting-partitions-with-replacingmergetree"></a>
...
## Merge behavior considerations <a id="merge-behavior-considerations"></a>
...
### Merge selection logic <a id="merge-selection-logic"></a>
...
### Merging behavior on large parts <a id="merging-behavior-on-large-parts"></a>
...
### Partitioning and merging across partitions <a id="partitioning-and-merging-across-partitions"></a>
...
### Tuning merges for better query performance <a id="tuning-merges-for-better-query-performance"></a>
...
### Recommended settings <a id="recommended-settings"></a>
