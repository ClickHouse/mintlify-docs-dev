...
## Choosing an update strategy <a id="choosing-an-update-strategy"></a>
...
### When to use specialized table engines <a id="when-to-choose-specialised-table-engines"></a>
...
### When to use declarative updates <a id="when-to-use-declaritive-updates"></a>
...
## Updates using specialized table engines <a id="insert-based-updates"></a>

### ReplacingMergeTree <a id="replacingmergetree"></a>
...
### CoalescingMergeTree <a id="coalescingmergetree"></a>
...
### CollapsingMergeTree <a id="collapsingmergetree"></a>
...
## Declarative updates <a id="sql-style-updates"></a>
...
#### On-the-fly mutations <a id="on-the-fly-mutations"></a>
...
##### Performance impact <a id="performance-impact"></a>
...
##### Support for subqueries and non-deterministic functions <a id="support-for-subqueries-and-non-deterministic-functions"></a>
...
### Lightweight updates <a id="lightweight-updates"></a>
...
## Comparison summary <a id="comparison-summary"></a>
