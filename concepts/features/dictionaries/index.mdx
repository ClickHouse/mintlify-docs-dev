...
<Image img="/static/images/dictionary/dictionary-use-cases.png" size="lg" alt="Use cases for Dictionary in ClickHouse"/>
...
<Image img="/static/images/dictionary/dictionary-left-any-join.png" size="sm" alt="Using Dictionary with LEFT ANY JOIN"/>
