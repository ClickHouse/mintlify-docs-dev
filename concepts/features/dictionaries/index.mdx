...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="Use cases for Dictionary in ClickHouse"/>

## Speeding up joins using a Dictionary <a id="speeding-up-joins-using-a-dictionary"></a>
...
<Image img="/images/dictionary/dictionary-left-any-join.png" size="sm" alt="Using Dictionary with LEFT ANY JOIN"/>
...
#### Applying a dictionary <a id="applying-a-dictionary"></a>
...
## Query time enrichment <a id="query-time-enrichment"></a>
...
## Index time enrichment <a id="index-time-enrichment"></a>
...
## Advanced dictionary topics <a id="advanced-dictionary-topics"></a>
...
### Refreshing dictionaries <a id="refreshing-dictionaries"></a>
...
### Other dictionary types <a id="other-dictionary-types"></a>
