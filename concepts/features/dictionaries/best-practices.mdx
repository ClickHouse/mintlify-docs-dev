...
## When to use dictionaries vs JOINs <a id="when-to-use-dictionaries-vs-joins"></a>
...
## Choosing a layout <a id="choosing-a-layout"></a>
...
## Monitoring dictionary usage <a id="monitoring-dictionary-usage"></a>
