...
## Source table for the materialized views <a id="source-table-for-the-materialized-views"></a>
...
## Monthly aggregated table and materialized view <a id="monthly-aggregated-table-and-materialized-view"></a>
...
## Yearly aggregated table and materialized view <a id="yearly-aggregated-table-and-materialized-view"></a>
...
## Combining multiple source tables to single target table <a id="combining-multiple-source-tables-to-single-target-table"></a>
