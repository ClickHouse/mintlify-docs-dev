...
<Image img="/images/materialized-view/refreshable-materialized-view-diagram.png" size="lg" alt="Refreshable materialized view diagram"/>
...
## When should refreshable materialized views be used? <a id="when-should-refreshable-materialized-views-be-used"></a>
...
## How do you refresh a refreshable materialized view? <a id="how-do-you-refresh-a-refreshable-materialized-view"></a>
...
## When was a refreshable materialized view last refreshed? <a id="when-was-a-refreshable-materialized-view-last-refreshed"></a>
...
## How can I change the refresh rate? <a id="how-can-i-change-the-refresh-rate"></a>
...
## Using `APPEND` to add new rows <a id="using-append-to-add-new-rows"></a>
...
### Stack Overflow <a id="stack-overflow"></a>
