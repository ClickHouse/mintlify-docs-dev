...
## Other applications <a id="other-applications"></a>
...
### Filtering and transformation <a id="filtering-and-transformation"></a>
...
### Lookup table <a id="lookup-table"></a>
...
### Chaining / cascading materialized views <a id="chaining"></a>
...
## Materialized views and JOINs <a id="materialized-views-and-joins"></a>
...
### Example <a id="materialized-views-and-joins-example"></a>
...
### Best practices for JOINs in materialized views <a id="join-best-practices"></a>
...
### Using source table in filters and joins <a id="using-source-table-in-filters-and-joins-in-materialized-views"></a>
...
#### Example scenario <a id="example-scenario"></a>
...
### Use cases and caveats <a id="use-cases-and-caveats"></a>
...
#### Example with stack overflow <a id="example-with-stack-overflow"></a>
...
## Materialized views and unions <a id="materialized-views-and-unions"></a>
...
## Parallel vs sequential processing <a id="materialized-views-parallel-vs-sequential"></a>
...
### When to use parallel processing <a id="materialized-views-when-to-use-parallel"></a>
...
## Materialized views and Common Table Expressions (CTE) <a id="materialized-views-common-table-expressions-ctes"></a>
