...
## Command-line options <a id="clickhouse-benchmark-command-line-options"></a>
...
If you want to apply some [settings](/concepts/features/configuration/settings/overview) for queries, pass them as a key `--<session setting name>= SETTING_VALUE`. For example, `--max_memory_usage=1048576`.

## Environment variable options <a id="clickhouse-benchmark-environment-variable-options"></a>
...
## Output <a id="clickhouse-benchmark-output"></a>
...
## Comparison Mode <a id="clickhouse-benchmark-comparison-mode"></a>
...
## Example <a id="clickhouse-benchmark-example"></a>
