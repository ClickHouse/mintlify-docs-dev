...
## Program-wide options <a id="program-wide-options"></a>
...
* `--log-level` -- What [type](/reference/settings/server-settings/settings#logger) of events to log, defaults to `none`.
...
## Lazy initialization <a id="lazy-initialization"></a>
...
## Default Disks <a id="default-disks"></a>
...
## Clickhouse-disks state <a id="clickhouse-disks-state"></a>
