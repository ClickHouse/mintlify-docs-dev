...
## When to use clickhouse-local vs. ClickHouse <a id="when-to-use-clickhouse-local-vs-clickhouse"></a>
...
## Download clickhouse-local <a id="download-clickhouse-local"></a>
...
## Query data in a file using SQL <a id="query_data_in_file"></a>
...
## Query data in a Parquet file in AWS S3 <a id="query-data-in-a-parquet-file-in-aws-s3"></a>
...
## Format Conversions <a id="format-conversions"></a>
...
### CLEAR command <a id="clear-command"></a>
...
## Related Content <a id="related-content-1"></a>
