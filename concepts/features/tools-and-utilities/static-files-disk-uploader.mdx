...
## Retrieve metadata path for the specified table <a id="retrieve-metadata-path-for-the-specified-table"></a>
...
## Output table metadata directory to the local filesystem <a id="output-table-metadata-directory-to-the-local-filesystem"></a>
...
## Output table metadata directory to an external URL <a id="output-table-metadata-directory-to-an-external-url"></a>
...
## Using the table metadata directory to create a ClickHouse table <a id="using-the-table-metadata-directory-to-create-a-clickhouse-table"></a>
