...
### Connecting to ClickHouse Cloud <a id="connecting-cloud"></a>
...
<Image img="/images/_snippets/cloud-connect-button.png"
  size="md"
...
<Image img="/images/_snippets/connection-details-native.png"
  size="md"
  alt="ClickHouse Cloud Native TCP connection details"
/>

### Storing connections in a configuration file <a id="connection-credentials"></a>
...
### Using interactive mode <a id="using-interactive-mode"></a>
...
### Query processing information <a id="processing-info"></a>
...
### Using batch mode <a id="using-batch-mode"></a>
...
### Inserting a CSV file into a remote ClickHouse service <a id="cloud-example"></a>
...
### Examples of inserting data from the command line <a id="more-examples"></a>
...
## Queries with parameters <a id="cli-queries-with-parameters"></a>
...
### Query syntax <a id="cli-queries-with-parameters-syntax"></a>
...
### Examples <a id="cli-queries-with-parameters-examples"></a>
...
## AI-powered SQL generation <a id="ai-sql-generation"></a>
...
### Usage <a id="ai-sql-generation-usage"></a>
...
### Example <a id="ai-sql-generation-example"></a>
...
### Configuration <a id="ai-sql-generation-configuration"></a>
...
#### Environment-based fallback <a id="ai-sql-generation-fallback"></a>
...
#### Configuration file <a id="ai-sql-generation-configuration-file"></a>
...
### Parameters <a id="ai-sql-generation-parameters"></a>
...
### How it works <a id="ai-sql-generation-how-it-works"></a>
...
### Limitations <a id="ai-sql-generation-limitations"></a>
...
### Security <a id="ai-sql-generation-security"></a>
...
## Connection string <a id="connection_string"></a>

### Usage <a id="connection-string-usage"></a>
...
### Notes <a id="connection-string-notes"></a>
...
### Examples <a id="connection_string_examples"></a>
...
## Query ID format <a id="query-id-format"></a>
...
## Environment variable options <a id="environment-variable-options"></a>
...
### General options <a id="command-line-options-general"></a>
...
### Connection options <a id="command-line-options-connection"></a>
...
| `-s [ --secure ]`                | Whether to use TLS. <br/><br/>Enabled automatically when connecting to port 9440 (the default secure port) or ClickHouse Cloud. <br/><br/>You might need to configure your CA certificates in the [configuration file](#configuration_files). The available configuration settings are the same as for [server-side TLS configuration](/reference/settings/server-settings/settings#openssl). | Auto-enabled when connecting to port 9440 or ClickHouse Cloud                                                   |
...
### Query options <a id="command-line-options-query"></a>
...
### Query settings <a id="command-line-options-query-settings"></a>
...
### Formatting options <a id="command-line-options-formatting"></a>
...
### Execution details <a id="command-line-options-execution-details"></a>
