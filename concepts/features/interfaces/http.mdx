...
## Web user interface <a id="web-ui"></a>
...
<Image img="/images/play.png" size="md" alt="ClickHouse Web UI screenshot" />
...
## Querying over HTTP/HTTPS <a id="querying"></a>
...
## Insert queries over HTTP/HTTPS <a id="insert-queries"></a>
...
## Examples <a id="examples-compression"></a>
...
## Using ClickHouse sessions in the HTTP protocol <a id="using-clickhouse-sessions-in-the-http-protocol"></a>
...
## Response buffering <a id="response-buffering"></a>
...
## Setting a role with query parameters <a id="setting-role-with-query-parameters"></a>
...
## HTTP response codes caveats <a id="http_response_codes_caveats"></a>
...
### Tabs in URL Parameters <a id="tabs-in-url-parameters"></a>
...
## Predefined HTTP Interface <a id="predefined_http_interface"></a>
...
### predefined_query_handler <a id="predefined_query_handler"></a>
...
#### Virtual parameter `_request_body` <a id="virtual-param-request-body"></a>
...
### dynamic_query_handler <a id="dynamic_query_handler"></a>
...
## HTTP response headers <a id="http-response-headers"></a>
...
## Valid JSON/XML response on exception during HTTP streaming <a id="valid-output-on-exception-http-streaming"></a>
