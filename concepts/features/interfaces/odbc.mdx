...
## Installation on Windows <a id="installation-on-windows"></a>
...
## Microsoft Power BI Integration <a id="powerbi-integration"></a>
...
## SQL compatibility settings <a id="sql-compatibility-settings"></a>
...
### ClickHouse settings enabled by SqlCompatibilitySettings configuration parameter <a id="sql-compatibility-settings-list"></a>
...
## Making SQL compatibility settings work for read-only users <a id="readonly-users"></a>
