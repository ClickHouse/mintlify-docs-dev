...
## Enabling and disabling the feature <a id="enabling-the-feature"></a>
...
## What the session looks like <a id="session"></a>
...
## Integration with `/play` <a id="play-integration"></a>
...
## Platform availability <a id="platform"></a>
