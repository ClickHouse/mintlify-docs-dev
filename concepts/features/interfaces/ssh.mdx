...
After creating a [database user identified by an SSH key](/resources/support-center/knowledge-base/cloud-services/how-to-connect-to-ch-cloud-using-ssh-keys):
```sql
...
## Configuring embedded client <a id="configuring-embedded-client"></a>
