...
### Installing and managing ClickHouse versions <a id="installing-versions"></a>
...
#### ClickHouse binary storage <a id="binary-storage"></a>
...
### Initializing a project <a id="initializing-project"></a>
...
### Running queries <a id="running-queries"></a>
...
### Creating and managing ClickHouse servers <a id="managing-servers"></a>
...
#### Custom config files for local servers <a id="custom-config-files"></a>
...
#### Project-local data directory <a id="project-local-data"></a>
...
### Running local Postgres <a id="local-postgres"></a>
...
### API key/secret (recommended) <a id="api-key"></a>
...
### OAuth login <a id="oauth-login"></a>
...
### Auth status and logout <a id="auth-status"></a>
...
### Debugging which credential source was used <a id="debug-credentials"></a>
...
#### Service create options <a id="service-create-options"></a>
...
#### Query API auth modes <a id="query-api-auth-modes"></a>
...
#### Query endpoint management <a id="query-endpoints"></a>
...
#### Private endpoint management <a id="private-endpoints"></a>
...
#### Backup configuration <a id="backup-config"></a>
...
### Postgres services <a id="postgres-services"></a>
...
#### Postgres service create options <a id="postgres-create-options"></a>
...
### JSON output <a id="json-output"></a>
...
### Non-interactive flags <a id="non-interactive-flags"></a>
...
## Self-update <a id="self-update"></a>
