...
ClickHouse can automatically determine the structure of input data in almost all supported [Input formats](/reference/formats/index).
...
## clickhouse-local <a id="clickhouse-local"></a>
...
## Using structure from insertion table <a id="using-structure-from-insertion-table"></a>
...
## Schema inference cache <a id="schema-inference-cache"></a>
...
## Text formats <a id="text-formats"></a>
...
### JSON formats <a id="json-formats"></a>
...
#### JSON settings <a id="json-settings"></a>

##### input_format_json_try_infer_numbers_from_strings <a id="input_format_json_try_infer_numbers_from_strings"></a>
...
##### input_format_json_try_infer_named_tuples_from_objects <a id="input_format_json_try_infer_named_tuples_from_objects"></a>
...
##### input_format_json_use_string_type_for_ambiguous_paths_in_named_tuples_inference_from_objects <a id="input_format_json_use_string_type_for_ambiguous_paths_in_named_tuples_inference_from_objects"></a>
...
##### input_format_json_read_objects_as_strings <a id="input_format_json_read_objects_as_strings"></a>
...
##### input_format_json_read_numbers_as_strings <a id="input_format_json_read_numbers_as_strings"></a>
...
##### input_format_json_read_bools_as_numbers <a id="input_format_json_read_bools_as_numbers"></a>
...
##### input_format_json_read_bools_as_strings <a id="input_format_json_read_bools_as_strings"></a>
...
└───────┴──────────────────┴──────────────┴────────────────────┴─────────┴──────────────────┴────────────────┘
```
##### input_format_json_read_arrays_as_strings <a id="input_format_json_read_arrays_as_strings"></a>
...
##### input_format_json_infer_incomplete_types_as_strings <a id="input_format_json_infer_incomplete_types_as_strings"></a>
...
#### CSV settings <a id="csv-settings"></a>

##### input_format_csv_try_infer_numbers_from_strings <a id="input_format_csv_try_infer_numbers_from_strings"></a>
...
### CustomSeparated <a id="custom-separated"></a>
...
### Settings for text formats <a id="settings-for-text-formats"></a>

#### input_format_max_rows_to_read_for_schema_inference/input_format_max_bytes_to_read_for_schema_inference <a id="input-format-max-rows-to-read-for-schema-inference"></a>
...
#### column_names_for_schema_inference <a id="column-names-for-schema-inference"></a>
...
#### schema_inference_hints <a id="schema-inference-hints"></a>
...
#### schema_inference_make_columns_nullable $ <a id="schema-inference-make-columns-nullable"></a>
...
#### input_format_try_infer_integers <a id="input-format-try-infer-integers"></a>
...
#### input_format_try_infer_datetimes <a id="input-format-try-infer-datetimes"></a>
...
#### input_format_try_infer_datetimes_only_datetime64 <a id="input-format-try-infer-datetimes-only-datetime64"></a>
...
#### input_format_try_infer_dates <a id="input-format-try-infer-dates"></a>
...
#### input_format_try_infer_exponent_floats <a id="input-format-try-infer-exponent-floats"></a>
...
## Self describing formats <a id="self-describing-formats"></a>
...
### Formats with -WithNamesAndTypes suffix <a id="formats-with-names-and-types"></a>
...
### JSON formats with metadata <a id="json-with-metadata"></a>
...
## Formats with external schema <a id="formats-with-external-schema"></a>
...
## Strong-typed binary formats <a id="strong-typed-binary-formats"></a>
...
### BSONEachRow <a id="bsoneachrow"></a>
...
## Formats with constant schema <a id="formats-with-constant-schema"></a>

Data in such formats always have the same schema.

### LineAsString <a id="line-as-string"></a>
...
### JSONAsString <a id="json-as-string"></a>
...
### JSONAsObject <a id="json-as-object"></a>
...
## Schema inference modes <a id="schema-inference-modes"></a>
...
### Default mode <a id="default-schema-inference-mode"></a>
...
### Union mode <a id="default-schema-inference-mode-1"></a>
...
## Automatic format detection <a id="automatic-format-detection"></a>
