...
## Including the library into your project <a id="including-library-into-project"></a>
...
### Setting the client object <a id="example-setup-client"></a>
...
### Creating tables and running queries without data <a id="example-create-table"></a>
...
### Inserting Data <a id="example-insert-data"></a>
...
### Selecting the data <a id="example-select"></a>
