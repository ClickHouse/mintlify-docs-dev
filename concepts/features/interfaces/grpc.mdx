...
## Introduction <a id="grpc-interface-introduction"></a>
...
## gRPC configuration <a id="grpc-interface-configuration"></a>
...
## Built-in client <a id="grpc-client"></a>
...
- `--format OUTPUT_FORMAT, -f OUTPUT_FORMAT` – A result output [format](/reference/formats/index). Default value for interactive mode: `PrettyCompact`.
