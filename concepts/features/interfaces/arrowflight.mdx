...
## Enabling the Arrow Flight Server <a id="enabling-server"></a>
...
### Basic Authentication <a id="basic-auth"></a>
...
### Bearer Token Authentication <a id="bearer-auth"></a>
...
### Python Example <a id="auth-python-example"></a>
...
## Server Configuration Reference <a id="configuration-reference"></a>
...
## Supported RPC Methods <a id="rpc-methods"></a>

### GetFlightInfo <a id="getflightinfo"></a>
...
### PollFlightInfo <a id="pollflightinfo"></a>
...
### DoAction <a id="doaction"></a>

Executes named actions. The following actions are supported:

#### CancelFlightInfo <a id="cancelflightinfo"></a>
...
#### SetSessionOptions <a id="setsessionoptions"></a>
...
#### GetSessionOptions <a id="getsessionoptions"></a>
...
#### CreatePreparedStatement <a id="createpreparedstatement"></a>
...
#### ClosePreparedStatement <a id="closepreparedstatement"></a>
...
## Flight SQL Commands <a id="flight-sql-commands"></a>
...
### Supported via GetFlightInfo / GetSchema <a id="flightsql-getflightinfo"></a>
...
### Supported via DoPut <a id="flightsql-doput"></a>
...
### Unsupported in ClickHouse <a id="flightsql-not-implemented"></a>
...
## Client-side ArrowFlight features <a id="client-side"></a>
