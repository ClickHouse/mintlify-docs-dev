...
### Duplicating source data somewhere else <a id="duplicating-source-data-somewhere-else"></a>
...
### Filesystem Snapshots <a id="filesystem-snapshots"></a>
...
### Manipulations with Parts <a id="manipulations-with-parts"></a>
