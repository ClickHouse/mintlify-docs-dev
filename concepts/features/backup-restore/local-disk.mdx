...
## Configure backup destinations for disk <a id="configure-backup-destinations-for-disk"></a>

### Configure a backup destination for local disk <a id="configure-a-backup-destination"></a>
...
### Configure a backup destination for S3 disk <a id="backuprestore-using-an-s3-disk"></a>
...
## Usage examples of backup/restore to local disk <a id="usage-examples"></a>

### Backup and restore a table <a id="backup-and-restore-a-table"></a>
...
### Incremental backups to disk <a id="incremental-backups"></a>
...
### Securing a backup <a id="assign-a-password-to-the-backup"></a>
...
### Backups as tar archives <a id="backups-as-tar-archives"></a>
...
### Compression settings <a id="compression-settings"></a>
...
### Restore specific partitions <a id="restore-specific-partitions"></a>
