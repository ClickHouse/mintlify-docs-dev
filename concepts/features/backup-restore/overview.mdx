...
## Backup types <a id="backup-types"></a>
...
## Synchronous vs asynchronous backups <a id="synchronous-vs-asynchronous"></a>
...
## Concurrent vs non-concurrent backups <a id="concurrent-vs-non-concurrent"></a>
...
## Compressed vs uncompressed backups <a id="compressed-vs-uncompressed"></a>
...
## Using named collections <a id="using-named-collections"></a>
...
## Backing up system, log or access management tables <a id="system-backups"></a>
...
## Administration and troubleshooting <a id="check-the-status-of-backups"></a>
