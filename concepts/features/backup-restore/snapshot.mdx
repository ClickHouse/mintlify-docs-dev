...
## Create a snapshot <a id="create-a-snapshot"></a>
...
## Restore to the same service <a id="restore-to-same-service"></a>
...
## Unlock a snapshot <a id="unlock-snapshot"></a>
...
### system.backups <a id="system-backups"></a>
...
### system.snapshot_locks <a id="system-snapshot-locks"></a>
...
### system.snapshot_parts <a id="system-snapshot-parts"></a>
