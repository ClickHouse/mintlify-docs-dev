...
<Steps>
<Step>
## Configure LDAP connection settings in ClickHouse <a id="1-configure-ldap-connection-settings-in-clickhouse"></a>
...
<Step>
## Configure ClickHouse database roles and permissions <a id="2-configure-clickhouse-database-roles-and-permissions"></a>
...
<Step>
## Test the LDAP configuration <a id="3-test-the-ldap-configuration"></a>
