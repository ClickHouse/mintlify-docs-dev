...
## Token claims <a id="token-claims"></a>

### Required claims <a id="required-claims"></a>
...
### Other recognized claims <a id="other-recognized-claims"></a>
...
### Optional claims <a id="optional-claims"></a>
...
### Example token header and payload <a id="example-token-header-and-payload"></a>
...
## Ephemeral user behavior <a id="ephemeral-user-behavior"></a>

JWT users differ from regular ClickHouse users in several important ways.

### Identity and naming <a id="identity-and-naming"></a>
...
### Access rights <a id="access-rights"></a>
...
### Token freshness <a id="token-freshness"></a>
...
### Lifetime and garbage collection <a id="lifetime-and-garbage-collection"></a>
...
### Persistent access assignments <a id="persistent-access-assignments"></a>
...
## Differences from regular users <a id="differences-from-regular-users"></a>
...
## SQL SECURITY DEFINER views <a id="sql-security-definer-views"></a>
...
## Client usage <a id="client-usage"></a>

### Passing a token directly <a id="passing-token-directly"></a>
...
### HTTP interface <a id="http-interface"></a>
...
### OAuth2 device code login <a id="oauth2-device-code-login"></a>
...
## ClickHouse Cloud built-in JWT authenticator <a id="clickhouse-cloud-built-in"></a>
...
## Interserver communication <a id="interserver-communication"></a>
