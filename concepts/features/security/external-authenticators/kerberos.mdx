...
## Enabling Kerberos in ClickHouse <a id="enabling-kerberos-in-clickhouse"></a>
...
## Kerberos as an external authenticator for existing users <a id="kerberos-as-an-external-authenticator-for-existing-users"></a>
...
### Enabling Kerberos in `users.xml` <a id="enabling-kerberos-in-users-xml"></a>
...
### Enabling Kerberos using SQL <a id="enabling-kerberos-using-sql"></a>
