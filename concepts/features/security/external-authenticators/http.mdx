...
## HTTP authentication server definition <a id="http-auth-server-definition"></a>
...
### Enabling HTTP authentication in `users.xml` <a id="enabling-http-auth-in-users-xml"></a>
...
### Enabling HTTP authentication using SQL <a id="enabling-http-auth-using-sql"></a>
...
### Passing session settings <a id="passing-session-settings"></a>
