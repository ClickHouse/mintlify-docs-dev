...
<Note>
View the [Quick Start](/get-started/setup/self-managed/install) for more details on how to install ClickHouse.
</Note>
...
5. Log into the Play UI using the `https` interface at `https://chnode1.marsnet.local:8443/play`.
    ...
    <Image img="/static/images/guides/sre/configuring-ssl_01.png" alt="Configuring TLS" size="md" border />
