...
<Steps>
<Step>
## Create a ClickHouse Deployment <a id="1-create-a-clickhouse-deployment"></a>
...
<Step>
## Create TLS certificates <a id="2-create-tls-certificates"></a>
<Note>
...
<Step>
## Create and Configure a directory to store certificates and keys. <a id="3-create-and-configure-a-directory-to-store-certificates-and-keys"></a>
...
<Step>
## Configure the environment with basic clusters using ClickHouse Keeper <a id="4-configure-the-environment-with-basic-clusters-using-clickhouse-keeper"></a>
...
<Step>
## Configure TLS interfaces on ClickHouse nodes <a id="5-configure-tls-interfaces-on-clickhouse-nodes"></a>
...
5. Log into the Play UI using the `https` interface at `https://chnode1.marsnet.local:8443/play`.
    ...
    <Image img="/images/guides/sre/configuring-ssl_01.png" alt="Configuring TLS" size="md" border />
...
## Configure OpenSSL for standalone ClickHouse Keeper <a id="configure-openssl-for-standalone-clickhouse-keeper"></a>
...
## OpenSSL verification modes and certificate handlers <a id="openssl-verification-modes"></a>
...
### Verification modes <a id="verification-modes"></a>
...
### Invalid certificate handlers <a id="invalid-certificate-handlers"></a>
...
### Example: disabling certificate verification <a id="disabling-certificate-verification"></a>
