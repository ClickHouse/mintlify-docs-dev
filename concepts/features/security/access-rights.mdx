...
Settings profile is a collection of [settings](/reference/settings). Settings profile contains settings and constraints, as well as a list of roles and/or users to which this profile is applied.
