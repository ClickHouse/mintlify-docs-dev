...
2. Configure OpenSSL in the ClickHouse [client config](/integrations/connectors/data-integrations/drivers-and-interfaces/client#configuration_files) with certificate and paths.
