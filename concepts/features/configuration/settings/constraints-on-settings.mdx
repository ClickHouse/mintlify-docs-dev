...
## Defining constraints <a id="defining-constraints"></a>
...
## Types of constraints <a id="types-of-constraints"></a>
...
## Multiple constraint profiles <a id="multiple-constraint-profiles"></a>
...
## Read-only mode <a id="read-only"></a>
...
### Example <a id="example-read-only"></a>
...
## Constraints on MergeTree settings <a id="constraints-on-merge-tree-settings"></a>
...
### Example <a id="example-mergetree"></a>
