...
## Standard SQL <a id="standard-sql"></a>
...
## Pipelined relational query language (PRQL) <a id="pipelined-relational-query-language-prql"></a>
...
## Kusto query language (KQL) <a id="kusto-query-language-kql"></a>
