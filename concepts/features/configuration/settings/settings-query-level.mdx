...
## Order of priority <a id="order-of-priority"></a>
...
## Converting a setting to its default value <a id="converting-a-setting-to-its-default-value"></a>
...
## Custom settings <a id="custom_settings"></a>
...
### Using SQL to apply a setting to a user directly <a id="using-sql-to-apply-a-setting-to-a-user-directly"></a>
...
#### Examine the settings profile and assignment <a id="examine-the-settings-profile-and-assignment"></a>
...
└────────────────────────────────────────────────────────────────────────────────────┘
```
### Using SQL to create a settings profile and assign to a user <a id="using-sql-to-create-a-settings-profile-and-assign-to-a-user"></a>
...
### Using XML to create a settings profile and user <a id="using-xml-to-create-a-settings-profile-and-user"></a>
...
#### Examine the settings profile and assignment <a id="examine-the-settings-profile-and-assignment-1"></a>
...
### Assign a setting to a session <a id="assign-a-setting-to-a-session"></a>
...
### Assign a setting during a query <a id="assign-a-setting-during-a-query"></a>
