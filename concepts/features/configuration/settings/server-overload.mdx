...
## Rejecting queries <a id="rejecting-queries"></a>
...
## Dropping connections <a id="dropping-connections"></a>
...
## Resource overload warnings <a id="resource-overload-warnings"></a>
