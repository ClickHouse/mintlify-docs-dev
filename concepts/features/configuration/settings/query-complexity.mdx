...
## `overflow_mode` settings <a id="overflow_mode_setting"></a>
...
## `group_by_overflow_mode` settings <a id="group_by_overflow_mode_settings"></a>
...
## List of settings <a id="relevant-settings"></a>
...
## Obsolete settings <a id="obsolete-settings"></a>

<Note>
The following settings are obsolete
</Note>

### max_pipeline_depth <a id="max-pipeline-depth"></a>
