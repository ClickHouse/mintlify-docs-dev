...
## Configure external storage <a id="configuring-external-storage"></a>
...
## refresh_parts_interval and table_disk <a id="refresh-parts-interval-and-table-disk"></a>
...
## Dynamic Configuration <a id="dynamic-configuration"></a>
...
### Using S3 Storage <a id="s3-storage"></a>

#### Required parameters <a id="required-parameters-s3"></a>
...
#### Optional parameters <a id="optional-parameters-s3"></a>
...
### Using Plain Storage <a id="plain-storage"></a>
...
### Using S3 Plain Rewritable Storage <a id="s3-plain-rewritable-storage"></a>
...
### Using Azure Blob Storage <a id="azure-blob-storage"></a>
...
#### Connection parameters <a id="azure-blob-storage-connection-parameters"></a>
...
#### Limit parameters <a id="azure-blob-storage-limit-parameters"></a>
...
#### Other parameters <a id="azure-blob-storage-other-parameters"></a>
...
## Using HDFS storage (Unsupported) <a id="using-hdfs-storage-unsupported"></a>
...
### Using Data Encryption <a id="encrypted-virtual-file-system"></a>
...
### Required Parameters <a id="required-parameters-encrypted-disk"></a>
...
### Optional Parameters <a id="optional-parameters-encrypted-disk"></a>
...
### Using local cache <a id="using-local-cache"></a>
...
## File Cache Query/Profile Settings <a id="file-cache-query-profile-settings"></a>
...
#### Cache system tables <a id="cache-system-tables-file-cache"></a>
...
#### Cache commands <a id="cache-commands-file-cache"></a>

##### `SYSTEM CLEAR|DROP FILESYSTEM CACHE (<cache_name>) (ON CLUSTER)` -- `ON CLUSTER` <a id="system-clear-filesystem-cache-on-cluster"></a>
...
##### `DESCRIBE FILESYSTEM CACHE '<cache_name>'` <a id="describe-filesystem-cache"></a>
...
### Using static Web storage (read-only) <a id="web-storage"></a>
...
#### Required parameters <a id="static-web-storage-required-parameters"></a>
...
#### Optional parameters <a id="optional-parameters-web"></a>
...
### Zero-copy Replication (not ready for production) <a id="zero-copy"></a>
