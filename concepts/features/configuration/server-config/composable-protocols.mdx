...
## Configuring composable protocols <a id="composable-protocols-section-is-denoted-as-protocols-in-configuration-xml"></a>
...
### Configuring protocol layers <a id="basic-modules-define-protocol-layers"></a>
...
### Configuring endpoints <a id="endpoint-ie-listening-port-is-denoted-by-port-and-optional-host-tags"></a>
...
### Configuring layer sequences <a id="layers-sequence-is-defined-by-impl-tag-referencing-another-module"></a>
...
### Attaching endpoints to layers <a id="endpoint-can-be-attached-to-any-layer"></a>
...
### Defining additional endpoints <a id="additional-endpoints-can-be-defined-by-referencing-any-module-and-omitting-type-tag"></a>
...
### Custom HTTP handlers per endpoint <a id="custom-http-handlers-per-endpoint"></a>
...
### Specifying additional layer parameters <a id="some-modules-can-contain-specific-for-its-layer-parameters"></a>
