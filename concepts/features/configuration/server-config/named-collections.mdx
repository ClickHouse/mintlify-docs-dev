...
## Storing named collections in the system database <a id="storing-named-collections-in-the-system-database"></a>

### DDL example <a id="ddl-example"></a>
...
### Permissions to create named collections with DDL <a id="permissions-to-create-named-collections-with-ddl"></a>
...
### Storage for named collections <a id="storage-for-named-collections"></a>
...
## Storing named collections in configuration files <a id="storing-named-collections-in-configuration-files"></a>

### XML example <a id="xml-example"></a>
...
## Modifying named collections <a id="modifying-named-collections"></a>
...
### Alter a DDL named collection <a id="alter-a-ddl-named-collection"></a>
...
### Drop the DDL named collection `collection2`: <a id="drop-the-ddl-named-collection-collection2"></a>
```sql
DROP NAMED COLLECTION collection2
```

## Named collections for accessing S3 <a id="named-collections-for-accessing-s3"></a>

The description of parameters see [s3 Table Function](/reference/functions/table-functions/s3).

### DDL example <a id="ddl-example-1"></a>
...
### XML example <a id="xml-example-1"></a>
...
### s3() function and S3 Table named collection examples <a id="s3-function-and-s3-table-named-collection-examples"></a>

Both of the following examples use the same named collection `s3_mydata`:

#### s3() function <a id="s3-function"></a>
...
## Named collections for accessing MySQL database <a id="named-collections-for-accessing-mysql-database"></a>

The description of parameters see [mysql](/reference/functions/table-functions/mysql).

### DDL example <a id="ddl-example-2"></a>
...
### XML example <a id="xml-example-2"></a>
...
### mysql() function, MySQL table, MySQL database, and Dictionary named collection examples <a id="mysql-function-mysql-table-mysql-database-and-dictionary-named-collection-examples"></a>

The four following examples use the same named collection `mymysql`:

#### mysql() function <a id="mysql-function"></a>
...
#### MySQL table <a id="mysql-table"></a>
...
#### MySQL database <a id="mysql-database"></a>
...
#### MySQL Dictionary <a id="mysql-dictionary"></a>
...
## Named collections for accessing PostgreSQL database <a id="named-collections-for-accessing-postgresql-database"></a>
...
### Example of using named collections with the postgresql function <a id="example-of-using-named-collections-with-the-postgresql-function"></a>
...
### Example of using named collections with database with engine PostgreSQL <a id="example-of-using-named-collections-with-database-with-engine-postgresql"></a>
...
### Example of using named collections with database with engine PostgreSQL <a id="example-of-using-named-collections-with-database-with-engine-postgresql-1"></a>
...
### Example of using named collections with a dictionary with source POSTGRESQL <a id="example-of-using-named-collections-with-a-dictionary-with-source-postgresql"></a>
...
## Named collections for accessing a remote ClickHouse database <a id="named-collections-for-accessing-a-remote-clickhouse-database"></a>
...
### Example of using named collections with the `remote`/`remoteSecure` functions <a id="example-of-using-named-collections-with-the-remoteremotesecure-functions"></a>
...
### Example of using named collections with a dictionary with source ClickHouse <a id="example-of-using-named-collections-with-a-dictionary-with-source-clickhouse"></a>
...
## Named collections for accessing Kafka <a id="named-collections-for-accessing-kafka"></a>

The description of parameters see [Kafka](/reference/engines/table-engines/integrations/kafka).

### DDL example <a id="ddl-example-3"></a>
...
```
### XML example <a id="xml-example-3"></a>
...
### Example of using named collections with a Kafka table <a id="example-of-using-named-collections-with-a-kafka-table"></a>
...
## Named collections for backups <a id="named-collections-for-backups"></a>

For the description of parameters see [Backup and Restore](/concepts/features/backup-restore/overview).

### DDL example <a id="ddl-example-4"></a>

```sql
BACKUP TABLE default.test to S3(named_collection_s3_backups, 'directory')
```

### XML example <a id="xml-example-4"></a>
...
## Named collections for accessing MongoDB Table and Dictionary <a id="named-collections-for-accessing-mongodb-table-and-dictionary"></a>

For the description of parameters see [mongodb](/reference/functions/table-functions/mongodb).

### DDL example <a id="ddl-example-5"></a>
...
### XML example <a id="xml-example-5"></a>
...
#### MongoDB table <a id="mongodb-table"></a>
...
#### MongoDB Dictionary <a id="mongodb-dictionary"></a>
