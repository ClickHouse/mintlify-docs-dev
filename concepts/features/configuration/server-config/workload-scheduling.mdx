...
## Disk configuration <a id="disk_config"></a>
...
## Workload markup <a id="workload_markup"></a>
...
## Resource scheduling hierarchy <a id="hierarchy"></a>
...
## Workload classifiers <a id="workload_classifiers"></a>
...
## Workload hierarchy <a id="workloads"></a>
...
## CPU scheduling <a id="cpu_scheduling"></a>
...
## Threads vs. CPUs <a id="threads_vs_cpus"></a>
...
## Query slot scheduling <a id="query_scheduling"></a>
...
## Workloads and resources storage <a id="workload_entity_storage"></a>
...
## Configuration-based workloads and resources <a id="config_based_workloads"></a>
...
### Configuration format <a id="config_based_workloads_format"></a>
...
### Usage recommendations <a id="config_based_workloads_usage_recommendations"></a>
...
## Strict resource access <a id="strict_resource_access"></a>
