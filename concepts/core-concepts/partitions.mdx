...
## What are table partitions in ClickHouse? <a id="what-are-table-partitions-in-clickhouse"></a>
<br/>
...
### Structure on disk <a id="structure-on-disk"></a>
...
<Image img="/images/managing-data/core-concepts/partitions.png" size="lg"  alt='INSERT PROCESSING' />
...
### Per partition merges <a id="per-partition-merges"></a>
...
<Image img="/images/managing-data/core-concepts/merges_with_partitions.png" size="lg"  alt='PART MERGES' />
...
## Monitoring partitions <a id="monitoring-partitions"></a>
...
## What are table partitions used for? <a id="what-are-table-partitions-used-for"></a>
...
<Image img="/images/managing-data/core-concepts/partition-pruning.png" size="lg"  alt='PART MERGES 2' />
...
### Partitioning is primarily a data management feature <a id="partitioning-is-primarily-a-data-management-feature"></a>
