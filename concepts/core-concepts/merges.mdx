...
## What are part merges in ClickHouse? <a id="what-are-part-merges-in-clickhouse"></a>
<br/>
...
## Monitoring merges <a id="monitoring-merges"></a>
...
## Concurrent merges <a id="concurrent-merges"></a>
...
## Memory optimized merges <a id="memory-optimized-merges"></a>
...
## Merge mechanics <a id="merge-mechanics"></a>
...
### Standard merges <a id="standard-merges"></a>
...
<Image img="/images/managing-data/core-concepts/merges_04.png" size="lg" alt='PART MERGES'/>
...
### Replacing merges <a id="replacing-merges"></a>
...
### Summing merges <a id="summing-merges"></a>
...
### Aggregating merges <a id="aggregating-merges"></a>
...
<Image img="/images/managing-data/core-concepts/merges_07.png" size="lg" alt='PART MERGES'/>
