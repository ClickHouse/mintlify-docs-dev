...
## How does the sparse primary index work in ClickHouse? <a id="how-does-the-sparse-primary-index-work-in-clickHouse"></a>
<br/>
...
### Sparse primary index creation <a id="sparse-primary-index-creation"></a>
...
<Image img="/images/managing-data/core-concepts/primary-index-light_01.gif" size="lg"/>
...
<Image img="/images/managing-data/core-concepts/primary-index-light_02.gif" size="lg"/>
...
### Primary index usage <a id="primary-index-usage"></a>
We sketch how the sparse primary index is used for query acceleration with another animation:

<Image img="/images/managing-data/core-concepts/primary-index-light_03.gif" size="lg"/>
...
## Monitoring primary indexes <a id="monitoring-primary-indexes"></a>
