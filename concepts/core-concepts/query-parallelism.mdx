...
## Step-by-step: How ClickHouse parallelizes an aggregation query <a id="step-by-step-how-clickHouse-parallelizes-an-aggregation-query"></a>
...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="Index analysis"/>

### Distributing work across processing lanes <a id="distributing-work-across-processing-lanes"></a>
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 parallel processing lanes"/>
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 parallel processing lanes"/>

<br/><br/>
Efficient lane distribution is key to maximizing CPU utilization and reducing total query time.

### Processing queries on sharded tables <a id="processing-queries-on-sharded-tables"></a>
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="Distributed lanes"/>
...
## Monitoring query parallelism <a id="monitoring-query-parallelism"></a>
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="Query pipeline"/>
...
### Load balancing across processing lanes <a id="load-balancing-across-processing-lanes"></a>
...
## Why max_threads isn't always respected <a id="why-max-threads-isnt-always-respected"></a>
...
## Where to find more information <a id="where-to-find-more-information"></a>
