...
<Image img="/static/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="Index analysis"/>
...
<Image img="/static/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 parallel processing lanes"/>
...
<Image img="/static/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 parallel processing lanes"/>
...
<Image img="/static/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="Distributed lanes"/>
...
<Image img="/static/images/guides/best-practices/query-parallelism_05.png" alt="Query pipeline"/>
