...
## Distributed table <a id="distributed-table"></a>
...
## Incremental materialized view <a id="incremental-materialized-view"></a>
...
## Lightweight update <a id="lightweight-update"></a>
...
## On-the-fly mutation <a id="on-the-fly-mutation"></a>
...
## Partitioning key <a id="partitioning-key"></a>
...
## Skipping index <a id="skipping-index"></a>
...
## Sorting key <a id="sorting-key"></a>
...
## Sparse index <a id="sparse-index"></a>
