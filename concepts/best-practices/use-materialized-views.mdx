...
<Image img="/images/bestpractices/incremental_materialized_view.gif" size="lg" alt="Materialized Views" />
...
<Image img="/images/bestpractices/refreshable_materialized_view.gif" size="lg" alt="Refreshable materialized view diagram"/>
...
## When to use incremental materialized views <a id="when-to-use-incremental-materialized-views"></a>
...
## When to use refreshable materialized views <a id="when-to-use-refreshable-materialized-views"></a>
...
### APPEND vs REPLACE mode <a id="append-vs-replace-mode"></a>
