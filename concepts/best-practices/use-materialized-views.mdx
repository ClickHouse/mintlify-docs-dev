...
<Image img="/static/images/bestpractices/incremental_materialized_view.gif" size="lg" alt="Materialized Views" />
...
<Image img="/static/images/bestpractices/refreshable_materialized_view.gif" size="lg" alt="Refreshable materialized view diagram"/>
