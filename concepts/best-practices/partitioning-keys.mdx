...
<Image img="/static/images/bestpractices/partitions.png" size="lg" alt="Partitions" />
...
<Image img="/static/images/bestpractices/merges_with_partitions.png" size="md" alt="Partitions" />
