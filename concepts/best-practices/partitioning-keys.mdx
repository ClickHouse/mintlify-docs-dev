...
<Image img="/images/bestpractices/partitions.png" size="lg" alt="Partitions" />
...
<Image img="/images/bestpractices/merges_with_partitions.png" size="md" alt="Partitions" />

## Applications of partitioning <a id="applications-of-partitioning"></a>
...
## Choose a low cardinality partitioning key <a id="choose-a-low-cardinality-partitioning-key"></a>
