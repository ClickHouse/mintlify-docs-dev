...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="Building skipping indices"/>
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="Using skipping indices"/>
