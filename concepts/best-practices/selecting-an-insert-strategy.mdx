...
## Synchronous inserts by default <a id="synchronous-inserts-by-default"></a>
...
<Image img="/images/bestpractices/insert_process.png" size="lg" alt="Insert processes" background="black"/>

#### Client-side steps <a id="client-side-steps"></a>
...
#### Server-side steps <a id="server-side-steps"></a>
...
### Batch inserts if synchronous <a id="batch-inserts-if-synchronous"></a>

<BulkInserts/>

### Ensure idempotent retries <a id="ensure-idempotent-retries"></a>
...
### Choose the right insert target <a id="choose-the-right-insert-target"></a>
...
### Choose the right format <a id="choose-the-right-format"></a>
...
### Use compression <a id="use-compression"></a>
...
#### Use LZ4 for speed, ZSTD for compression ratio <a id="use-lz4-for-speed-zstd-for-compression-ratio"></a>
...
#### Compression reduces resource usage <a id="compression-reduces-resource-usage"></a>
...
### Pre-sort if low cost <a id="pre-sort-if-low-cost"></a>
...
## Choose an interface—HTTP or native <a id="choose-an-interface"></a>

### Native <a id="choose-an-interface-native"></a>
...
### HTTP <a id="choose-an-interface-http"></a>
