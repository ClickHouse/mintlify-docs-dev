...
<Image img="/static/images/bestpractices/create_primary_key.gif" size="lg" alt="Primary key" />
...
<Image img="/static/images/bestpractices/primary_key.gif" size="lg" alt="Primary key" />
