...
<Image img="/static/images/guides/joins-1.png" size="sm" alt="Left any join"/>
...
<Image img="/static/images/guides/joins-2.png" size="lg" alt="speed by memory for joins"/>
...
<Image img="/static/images/guides/joins-3.png" size="lg" alt="join features"/>
...
<Image img="/static/images/guides/joins-4.png" size="lg" alt="join flowchart"/>
...
<Image img="/static/images/guides/joins-5.png" size="lg" alt="Join memory optimization decision tree" />
