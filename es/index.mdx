    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          <HeroCard title="ClickStack" description="El stack de observabilidad todo en uno impulsado por ClickHouse, que te ofrece consultas ultrarrápidas y agregaciones potentes sobre logs, métricas, trazas, repeticiones de sesión y errores." href="/es/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Managed Postgres" description="Servicio de Postgres rápido, escalable y de nivel Enterprise, integrado de forma nativa con ClickHouse. Combina fácilmente Postgres para transacciones y ClickHouse para analítica." href="/es/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Integraciones" description="Más de 100 integraciones para conectar con ClickHouse las herramientas y los servicios que te encantan." href="/es/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
