    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="/images/logo-claudecode-color.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Ejecute este comando en su terminal:</p>
            ...
            <Tab title="Claude Desktop" icon="/images/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Añada lo siguiente a <code>claude_desktop_config.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Cursor" icon="/images/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Añada lo siguiente a <code>.cursor/mcp.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="/images/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Añada lo siguiente a <code>~/.codeium/windsurf/mcp_config.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        links={[
          ...
          { label: "Configuración/instalación", href: "/get-started/setup/cloud" },
          { label: "Explorar guías de inicio rápido", href: "/get-started/quickstarts/home" },
          { label: "Guías de migración", href: "/get-started/migrate/overview" },
          { label: "Fundamentos de ClickHouse", href: "/concepts/core-concepts/index" },
          { label: "Conceptos (funcionalidades)", href: "/concepts/features/index" },
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="Una base de datos rápida, fiable y escalable integrada en el proceso. Experimenta la potencia de ClickHouse dentro del proceso." href="/es/products/chdb" showArrow />
      </div>
    </div>
