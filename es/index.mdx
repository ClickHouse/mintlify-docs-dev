  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        description="Soy nuevo aquí, quiero empezar o explorar la documentación de los productos de ClickHouse"
        icon={
      ...
      <HeroCard
        title="Guías"
        description="Quiero aprender a usar las funcionalidades de ClickHouse o explorar temas avanzados"
        icon={
      ...
      <HeroCard
        ...
        description="Ingeste logs, métricas y trazas para supervisar sistemas e impulsar los dashboards de observabilidad"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="chDB" description="Una base de datos rápida, fiable y escalable integrada en el proceso. Experimenta la potencia de ClickHouse dentro del proceso." href="/es/products/chdb" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="product-langfuse-light.png" title="LangFuse" description="Plataforma de ingeniería de LLM de código abierto para observabilidad, métricas, evaluaciones y gestión de prompts." href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="product-cloud-light.png" title="Operador de Kubernetes" description="Automatiza el despliegue, la configuración y la gestión de clústeres de ClickHouse y ClickHouse Keeper en Kubernetes." href="/es/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="product-chdb-light.png" title="chDB" description="Una base de datos rápida, fiable y escalable integrada en el proceso. Experimenta la potencia de ClickHouse dentro del proceso." href="/es/products/chdb" showArrow />
      </div>
    </div>
