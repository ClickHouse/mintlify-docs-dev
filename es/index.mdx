...
<style>
  {`
          ...
          /* Oculta la barra lateral inmediatamente en la página de inicio (evita el parpadeo) */
          #sidebar { display: none !important; }
          /* Haz que la barra de navegación ocupe todo el ancho, ya que la barra lateral está oculta */
          #navbar-transition-maple {
            width: 100vw !important;
            left: 0 !important;
            margin-left: 0 !important;
            /* Iguala el padding derecho de la barra de navegación (3rem) */
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        <HeroCard
          ...
          description="Soy nuevo aquí y quiero empezar y aprender más"
          icon={
        ...
        <HeroCard
          ...
          description="Quiero explorar las soluciones de ClickHouse"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              href="/es/products/cloud/getting-started/cloud-get-started"
...
{ label: "Consejos para mantener los costes bajos sin sacrificar el rendimiento", href: "/concepts/best-practices/index" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plataforma de ingeniería de LLM de código abierto para observabilidad, métricas, evaluaciones y gestión de prompts." href="https://langfuse.com/docs" showArrow external />
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Añade las skills de ClickHouse a tu agente de programación</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Instala las skills de ClickHouse para darle a tu agente conocimientos expertos de ClickHouse y buenas prácticas.</p>
