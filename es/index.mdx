...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="mx-auto px-4 -mt-5 text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      Documentación de la base de datos analítica más rápida
    </div>
    ...
    <div className="flex items-center justify-center gap-2 my-6 text-xs">
      ...
      <a className="inline-flex items-center gap-1.5 text-gray-500 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-[#fdff75] transition-colors font-normal no-underline" href="/es/get-started/quickstarts/create-your-first-service-on-cloud">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        links={[
            { label: "¿Qué es ClickHouse?", href: "/get-started/about/intro" },
            { label: "Instalación", href: "/get-started/setup/cloud" },
            { label: "Guía de inicio rápido", href: "/get-started/quickstarts/home" },
            { label: "Conceptos de ClickHouse", href: "/concepts/core-concepts/index" },
            { label: "Conjuntos de datos de ejemplo", href: "/get-started/sample-datasets/index" },
            { label: "Guías de migración", href: "/get-started/migrate/overview" },
            { label: "Buenas prácticas", href: "/concepts/best-practices/index" },
        ]}
      />
      ...
      <HeroCard
        ...
        links={[
            { label: "Modelado de datos", href: "/guides/clickhouse/data-modelling/schema-design" },
            { label: "Optimización del rendimiento", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
      ...
      <HeroCard
        ...
        links={[
            ...
            { label: "Ajustes", href: "/reference/settings/index" },
            { label: "Funciones", href: "/reference/functions/regular-functions/overview" },
            { label: "Motores", href: "/reference/engines/engines" },
            { label: "Tablas del sistema", href: "/reference/system-tables" },
            { label: "Formatos", href: "/reference/formats/index" },
            { label: "Tipos de datos", href: "/reference/data-types/index" }
        ]}
      />
...
{ label: "Buenas prácticas para organizar datos para analítica y crecimiento", href: "/guides/clickhouse/data-modelling/schema-design" },
{ label: "Formas de consultar grandes conjuntos de datos en tiempo real", href: "/get-started/use-cases/real-time-analytics" },
{ label: "Cómo crear dashboards, alertas y funciones basadas en eventos sobre la plataforma", href: "/get-started/use-cases/data-warehousing" },
{ label: "Consejos para mantener los costes bajos sin sacrificar el rendimiento", href: "/concepts/best-practices/index" },
]}
          />
        </div>

        <div className="flex flex-col gap-4">
          <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="El stack de observabilidad todo en uno impulsado por ClickHouse, que te ofrece consultas ultrarrápidas y agregaciones potentes sobre logs, métricas, trazas, repeticiones de sesión y errores." href="/es/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="Servicio de Postgres rápido, escalable y de nivel Enterprise, integrado de forma nativa con ClickHouse. Combina fácilmente Postgres para transacciones y ClickHouse para analítica." href="/es/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard logo="logo-integration.svg" logoInvert title="Integraciones" description="Más de 100 integraciones para conectar con ClickHouse las herramientas y los servicios que te encantan." href="/es/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plataforma de ingeniería de LLM de código abierto para observabilidad, métricas, evaluaciones y gestión de prompts." href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="thumbnail-kubernetes-light.png" title="Operador de Kubernetes" description="Automatiza el despliegue, la configuración y la gestión de clústeres de ClickHouse y ClickHouse Keeper en Kubernetes." href="/es/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="Una base de datos rápida, fiable y escalable integrada en el proceso. Experimenta la potencia de ClickHouse dentro del proceso." href="/es/products/chdb/index" showArrow />
      </div>
    </div>
