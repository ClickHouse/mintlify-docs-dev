  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="space-y-4 mt-6">
        ...
        <div className="col-span-2">
          <HeroCard
            ...
            links={[
                ...
                { label: "Buenas prácticas para organizar datos para analítica y crecimiento", href: "/data-modeling/schema-design" },
                ...
                { label: "Consejos para mantener los costes bajos sin sacrificar el rendimiento", href: "/operations/best-practices" },
            ]}
          />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <HeroCard filename="product-chdb-light.png" title="chDB" description="Una base de datos en proceso rápida, fiable y escalable. Descubre la potencia de ClickHouse en proceso." href="/es/products/chdb" showArrow />
      </div>
    </div>
