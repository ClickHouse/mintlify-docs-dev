...
Se recomienda ClickHouse Keeper para sustituir a ZooKeeper en los clusters de ClickHouse. Consulte la documentación de [ClickHouse Keeper](/es/guides/oss/deployment-and-scaling/keeper)
