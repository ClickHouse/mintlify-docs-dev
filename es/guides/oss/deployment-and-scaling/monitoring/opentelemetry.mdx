...
ClickHouse admite trazas de OpenTelemetry para las solicitudes de [ClickHouse Keeper](/es/guides/oss/deployment-and-scaling/keeper) (servicio de coordinación compatible con ZooKeeper). Esta función proporciona visibilidad detallada del ciclo de vida de las operaciones de Keeper, desde el envío de la solicitud por parte del cliente hasta su procesamiento en el servidor.
