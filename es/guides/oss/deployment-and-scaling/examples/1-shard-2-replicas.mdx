...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="Diagrama de arquitectura para 1 segmento y 2 réplicas con ReplicatedMergeTree" />
  ...
  <Step>
    ...
    <remote_servers>
        ...
        <cluster_1S_2R>
            ...
            <shard>
                <!-- Opcional. Indica si se deben escribir datos en una sola réplica. Valor predeterminado: false (escribe datos en todas las réplicas). -->
                <internal_replication>true</internal_replication>
                <replica>
                    <host>clickhouse-01</host>
                    <port>9000</port>
    ...
    En este ejemplo, el usuario predeterminado se configura sin contraseña para simplificar.
