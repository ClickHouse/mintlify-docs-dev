...
<Image img="/images/guides/developer/analyzer1.png" alt="Pasos de la consulta EXPLAIN" size="md" />
...
<Image img="/images/guides/developer/analyzer2.png" alt="Salida del AST" size="md" />
...
A continuación, puede copiar esta salida y pegarla [aquí](https://dreampuf.github.io/GraphvizOnline) para generar el siguiente gráfico:

<Image img="/images/guides/developer/analyzer3.png" alt="Resultado del gráfico" size="md" />
...
<Image img="/images/guides/developer/analyzer4.png" alt="Salida compacta del gráfico" size="md" />
...
<Image img="/images/guides/developer/analyzer5.png" alt="Salida del gráfico en paralelo" size="md" />

Así, el ejecutor decidió no paralelizar las operaciones porque el volumen de datos no era lo bastante alto. Al añadir más filas, el ejecutor pasó a usar varios hilos, como se muestra en el gráfico.
