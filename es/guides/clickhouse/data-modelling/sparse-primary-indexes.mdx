...
<Image img="/images/guides/best-practices/sparse-primary-indexes-01.png" size="lg" alt="Índices primarios dispersos 01" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-02.png" size="lg" alt="Índices primarios dispersos 02" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-03a.png" size="lg" alt="Índices primarios dispersos 03a" />

En total, el índice tiene 1083 entradas para nuestra tabla con 8,87 millones de filas y 1083 gránulos:

<Image img="/images/guides/best-practices/sparse-primary-indexes-03b.png" size="lg" alt="Índices primarios dispersos 03b" />
...
<Accordion title="Inspección del contenido del índice primario">
  <p>
    ...
    Para ello, primero debemos copiar el archivo del índice primario al <a href="/es/reference/settings/server-settings/settings#server_configuration_parameters-user_files_path" target="_blank">user&#95;files&#95;path</a> de un nodo del clúster en ejecución:
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-04.png" size="lg" alt="Índices primarios dispersos 04" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-05.png" size="lg" alt="Índices primarios dispersos 05" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-06.png" size="lg" alt="Índices primarios dispersos 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-07.png" size="lg" alt="Índices primarios dispersos 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-08.png" size="lg" alt="Índices primarios dispersos 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-13a.png" size="lg" alt="Índices primarios dispersos 13a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-10.png" size="lg" alt="Índices primarios dispersos 10" />

Esta es la clave primaria resultante:

<Image img="/images/guides/best-practices/sparse-primary-indexes-11.png" size="lg" alt="Índices primarios dispersos 11" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-15a.png" size="lg" alt="Índices primarios dispersos 15a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-15b.png" size="lg" alt="Índices primarios dispersos 15b" />
