...
<Image img="/images/data-modeling/stackoverflow-schema.png" size="lg" alt="Esquema de Stack Overflow" />
...
<Image img="/images/data-modeling/schema-design-indices.png" size="md" alt="Indexación dispersa en ClickHouse" />
...
* [**Dictionaries**](/es/concepts/features/dictionaries) - Una funcionalidad específica de ClickHouse para gestionar joins directos y búsquedas de clave-valor.
