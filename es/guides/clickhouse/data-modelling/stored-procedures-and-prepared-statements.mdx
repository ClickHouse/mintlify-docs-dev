...
title: 'Procedimientos almacenados y parámetros de consulta'
doc_type: 'guide'
---
...
Esta guía explica el enfoque de ClickHouse para estos conceptos y ofrece alternativas recomendadas.
...
Para usar parámetros de consulta en [clientes para lenguajes](/es/integrations/language-clients), consulta la documentación del
