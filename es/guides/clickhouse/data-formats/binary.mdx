...
Vamos a usar some&#95;data [tabla](/es/assets/some_data.sql) y [datos](/es/assets/some_data.tsv) para la demostración; no dudes en reproducirlo en tu instancia de ClickHouse.
