---
title: 'Diseño de esquemas JSON'
slug: /integrations/data-formats/json/schema
description: 'Cómo diseñar esquemas JSON de forma óptima'
keywords: ['json', 'clickhouse', 'insertar', 'carga', 'formatos', 'esquema', 'estructurados', 'semiestructurados']
score: 20
doc_type: 'guide'
---
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="Columna por ruta JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="Offsets JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="Columna JSON compartida" />
