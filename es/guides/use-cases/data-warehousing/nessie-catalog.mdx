...
Puedes usar la [configuración oficial de Docker Compose de Nessie](https://projectnessie.org/guides/setting-up/), que proporciona un entorno completo con Nessie, un almacén de versiones en memoria y MinIO para el almacenamiento de objetos.
...
services:
  ...
  clickhouse:
    ...
    volumes:
      ...
      - ./clickhouse/data_import:/var/lib/clickhouse/data_import  # Montar carpeta del conjunto de datos
    networks:
      - iceberg_net
    environment:
