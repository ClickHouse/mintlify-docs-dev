...
> Este tutorial te muestra cómo mantener rollups preagregados a partir de una tabla de eventos de alto volumen mediante [**vistas materializadas**](/es/concepts/features/materialized-views).
