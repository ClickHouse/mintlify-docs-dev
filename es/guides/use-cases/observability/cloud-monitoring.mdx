...
<div id="cloud-monitoring">
  # Monitorización de ClickHouse Cloud
</div>

Esta guía ofrece a los equipos empresariales que evalúan ClickHouse Cloud información detallada sobre las capacidades de monitorización y observabilidad para implementaciones en producción. Los clientes Enterprise suelen preguntar por las funciones de monitorización integradas, la integración con sus stacks de observabilidad existentes, incluidas herramientas como Datadog y AWS CloudWatch, y cómo se compara la monitorización de ClickHouse con las implementaciones autogestionadas.
