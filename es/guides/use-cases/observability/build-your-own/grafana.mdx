---
title: 'Uso de Grafana'
description: 'Uso de Grafana y ClickHouse para observabilidad'
...
Grafana es la herramienta de visualización preferida para los datos de observabilidad en ClickHouse. Esto se consigue mediante el plugin oficial de ClickHouse para Grafana. Puede seguir las instrucciones de instalación [aquí](/es/integrations/connectors/data-visualization/grafana).
...
<Image img="/images/use-cases/observability/observability-15.png" alt="Configuración del conector" size="sm" />
...
<Image img="/images/use-cases/observability/observability-16.png" alt="Configuración de logs del conector" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-17.png" alt="De logs a trazas" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-18.png" alt="Trazas" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-19.png" alt="Detalles de la traza" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-20.png" alt="De trazas a logs" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-21.png" alt="Paneles" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-22.png" alt="Serie temporal" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-23.png" alt="Gráficos de varias líneas" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-24.png" alt="Visualización de datos geográficos" size="lg" border />