...
<div id="cloud-monitoring">
  # Monitorización autogestionada
</div>

Esta guía ofrece a los equipos empresariales que evalúan ClickHouse de código abierto información detallada sobre las capacidades de monitoreo y observabilidad para implementaciones en producción. Los clientes empresariales suelen preguntar por las funciones de monitoreo listas para usar, la integración con las pilas de observabilidad existentes, incluidas herramientas como Datadog y AWS CloudWatch, y cómo se compara el monitoreo de ClickHouse con el de las implementaciones autohospedadas.
