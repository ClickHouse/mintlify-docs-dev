...
title: 'Configurar servidor MCP de ClickHouse con LibreChat y ClickHouse Cloud'
...
<div id="using-clickhouse-mcp-server-with-librechat">
  # Uso de servidor MCP de ClickHouse con LibreChat
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="Selecciona tu servidor MCP" size="md" />
