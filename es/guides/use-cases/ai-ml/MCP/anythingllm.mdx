...
title: 'Configurar el servidor MCP de ClickHouse con AnythingLLM y ClickHouse Cloud'
description: 'Esta guía explica cómo configurar AnythingLLM con el servidor MCP de ClickHouse mediante Docker.'
...
<div id="using-clickhouse-mcp-server-with-anythingllm">
  # Uso de servidor MCP de ClickHouse con AnythingLLM
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="Icono de herramientas" size="md" />

    Haz clic en `Agent Skills` y busca la sección `MCP servers`.
    Espera hasta que veas `Mcp ClickHouse` en `On`

    <Image img="/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="MCP servers listos" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/allm_conversation.png" alt="Conversación" size="md" />
  </Step>
</Steps>