...
| Section                                                                            | Description                                                                                                                                                                            |
| ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AI Chat](/es/products/cloud/features/ai-ml/aichat/using-ai-chat)                     | Esta guía explica cómo habilitar y usar la función AI Chat en la Console de ClickHouse Cloud.                                                                                          |
| [Capa semántica](/es/products/cloud/features/ai-ml/aichat/customizing-semantic-layer) | Aprende a personalizar el agente de chat ClickHouse Assistant con AGENTS.md para proporcionar reglas específicas del negocio, cálculos y orientación sobre la estructura de los datos. |
| [MCP](/es/guides/use-cases/ai-ml/MCP)                                                 | Una colección de guías para ayudarte a configurar y usar Model Context Protocol (MCP) con ClickHouse                                                                                   |
