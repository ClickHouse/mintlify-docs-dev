...
title: 'Explorar datos en Jupyter notebooks con chDB'
description: 'Esta guía explica cómo configurar y usar chDB para explorar datos de ClickHouse Cloud o archivos locales en Jupyer notebooks'
...
<div id="exploring-data-with-jupyter-notebooks-and-chdb">
  # Explorar datos con Jupyter notebooks y chDB
</div>

En esta guía, aprenderá a explorar un conjunto de datos de ClickHouse Cloud en un Jupyter notebook con la ayuda de [chDB](/es/products/chdb), un rápido motor SQL OLAP embebido impulsado por ClickHouse.
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Añadir conjunto de datos de ejemplo" />

Selecciona `Get started` en la tarjeta de datos de precios de compraventa de propiedades del Reino Unido (4GB):

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Seleccionar conjunto de datos de precios pagados del Reino Unido" />

Luego, haz clic en `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Importar conjunto de datos de precios pagados del Reino Unido" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="Crear un nuevo notebook" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="Seleccionar kernel" />
...
Con el conjunto de datos UK price paid ya configurado y chDB en ejecución en un Jupyter notebook, ya podemos empezar a explorar los datos.
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="vista previa del dataframe" />
...
# Mostrar cada 2 años para evitar saturación
years_to_show = df['year'][::2]  # Cada 2 años
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="vista previa del DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="vista previa del DataFrame" />
...
# Graficar casas vendidas en el eje y izquierdo
color = 'tab:blue'
ax1.set_xlabel('Year')
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="Gráfico del conjunto de datos remoto y del conjunto de datos local" />
