...
En esta guía, aprenderá a explorar un conjunto de datos de ClickHouse Cloud en un Jupyter notebook con la ayuda de [chDB](/es/products/chdb/index), un rápido motor SQL OLAP embebido impulsado por ClickHouse.
