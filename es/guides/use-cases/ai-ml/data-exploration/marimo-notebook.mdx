...
En esta guía, aprenderá a explorar en un notebook de Marimo un conjunto de datos alojado en ClickHouse Cloud con la ayuda de [chDB](/es/products/chdb), un rápido motor SQL OLAP en proceso basado en ClickHouse.
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="Interfaz de Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/5.png" alt="Marimo: hola mundo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Visualización de datos de Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Gráfico dinámico de Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="gráfico dinámico de Marimo" />
