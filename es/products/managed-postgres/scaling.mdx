...
<Image img="/images/managed-postgres/instance-types.png" alt="Tipos de instancia" size="md" border />
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="Configuración del escalado" size="md" border />
