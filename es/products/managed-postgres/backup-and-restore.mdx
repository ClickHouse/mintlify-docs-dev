...
<Image img="/images/managed-postgres/backup-and-restore.png" alt="Vista de Backups que muestra el historial de copias de seguridad y las opciones de recuperación a un punto en el tiempo" size="lg" border />
