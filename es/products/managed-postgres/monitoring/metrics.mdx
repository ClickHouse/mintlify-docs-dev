...
description: 'Lista completa de las métricas expuestas en el endpoint Prometheus de Managed Postgres'
...
<div id="metrics-reference">
  # Referencia de métricas
</div>

<BetaBadge />

Esta página enumera todas las métricas expuestas por el
[Managed Postgres endpoint de Prometheus](/es/products/managed-postgres/monitoring/prometheus).
Para la configuración y la autenticación, consulta la página [endpoint de Prometheus].
