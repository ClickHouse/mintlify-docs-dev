...
se está volcando a disco&quot; sin salir de la consola de Cloud.
...
<Image img="/images/managed-postgres/monitoring/query-insights-recent-queries.png" alt="Tabla de Recent queries con menús desplegables de filtro de Database, User, Operation y Application, y columnas para Time, Operation, Query, Duration, Rows, Database, User y Blks read" size="lg" border />
