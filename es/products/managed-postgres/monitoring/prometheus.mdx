...
title: 'endpoint de Prometheus de Managed Postgres'
description: 'Extraiga métricas de Managed Postgres en Prometheus, Grafana, Datadog o cualquier collector compatible con OpenMetrics'
...
<Image img="/images/managed-postgres/monitoring/grafana-dashboard.png" alt="Dashboard de Grafana de los servicios de Managed Postgres" size="md" border />
