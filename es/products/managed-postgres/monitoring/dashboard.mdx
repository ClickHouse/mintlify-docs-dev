...
sidebarTitle: 'Panel'
title: 'Panel de monitorización de Managed Postgres'
description: 'Panel integrado de Cloud Console para los servicios de Managed Postgres'
keywords: ['Managed Postgres', 'monitorización', 'panel', 'Cloud Console', 'CPU', 'memoria', 'IOPS']
doc_type: 'guide'
---
...
<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="Panel de Monitoring que muestra IOPS, uso de CPU, memoria, disco, tráfico de red, tamaño de la base de datos, conexiones, rendimiento, transacciones, tasa de aciertos de caché e interbloqueos" size="lg" border />
...
* [Endpoint de Prometheus](/es/products/managed-postgres/monitoring/prometheus) — recopila las mismas métricas en tu propio stack de observabilidad
