...
description: 'Prueba el rendimiento de Postgres con NVMe y añade análisis en tiempo real con integración nativa de ClickHouse'
keywords: ['Managed Postgres', 'inicio rápido', 'primeros pasos', 'crear base de datos', 'nvme', 'rendimiento']
doc_type: 'guide'
---
...
* **Parte 1:** Empiece a usar NVMe Postgres y compruebe su rendimiento
...
<Image img="/images/managed-postgres/create-service.png" alt="Crear un servicio de Managed Postgres" size="md" border />

Introduzca un nombre para su instancia de base de datos y haga clic en **Create service**. Se le llevará a la página Overview.

<Image img="/images/managed-postgres/overview.png" alt="Overview de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Modal de conexión de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/integration-landing.png" alt="Integración de Managed Postgres vacía" size="md" border />
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="Formulario de integración de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/table-picker.png" alt="Selector de tablas de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="Obtener el host de ClickHouse" size="md" border />
...
<Image img="/images/managed-postgres/analytics-list.png" alt="Lista de analíticas de Managed Postgres" size="md" border />

Haga clic en el nombre del servicio para abrir la consola de ClickHouse y ver sus tablas replicadas.

<Image img="/images/managed-postgres/replicated-tables.png" alt="Tablas replicadas de Managed Postgres en ClickHouse" size="md" border />
