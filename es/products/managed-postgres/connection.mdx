...
<Image img="/images/managed-postgres/connect-button.png" alt="Haga clic en Connect en la barra lateral izquierda para ver los detalles de conexión" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Ventana modal de conexión que muestra las credenciales y los formatos de cadena de conexión" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Descargue el certificado de la CA desde la pestaña Settings" size="md" border />
