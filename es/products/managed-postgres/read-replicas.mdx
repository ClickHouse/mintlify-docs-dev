...
<Image img="/images/managed-postgres/warehouse-view.png" alt="Vista del warehouse con el icono de Edit" size="md" border />

Esto abre el cuadro de diálogo del warehouse, donde puede ver los servicios existentes y crear nuevas réplicas de lectura:

<Image img="/images/managed-postgres/read-replica-dialog.png" alt="Cuadro de diálogo para administrar réplicas de lectura" size="md" border />
...
<Image img="/images/managed-postgres/read-replicas-flow.png" alt="Vista de flujo de réplicas de lectura que muestra la topología de la instancia primaria y las réplicas" size="lg" border />
...
<Image img="/images/managed-postgres/read-replicas-table.png" alt="Vista de tabla de réplicas de lectura" size="lg" border />
