...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="Resultados del benchmark de lectura+escritura intensiva en IO" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="Resultados del benchmark de solo lectura intensivo en IO" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="Resultados del benchmark de uso intensivo de CPU" size="md" border />
