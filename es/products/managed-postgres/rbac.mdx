...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Menú Usuarios y roles" size="md" border />
...
<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="Selección de la entidad Postgres Service" size="md" border />

4. Elija el servicio de Postgres al que se aplicará el rol y, a continuación, seleccione los permisos que desea otorgar.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="Configuración de permisos de Postgres en un rol" size="md" border />
