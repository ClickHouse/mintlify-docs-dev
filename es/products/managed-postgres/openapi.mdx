...
title: 'OpenAPI'
description: 'Controle sus servicios de Managed Postgres con nuestra OpenAPI'
...
<div id="managed-postgres-openapi">
...
{/*
  ...
  TODO: Descomentar e insertar la salida de ejemplo correcta cuando se lance la API.
...
{/*
  ...
  TODO: Ampliar cuando se implemente.
  ...
  La salida mostrará la configuración actualizada:
  ...
  * Cambiar el nombre de un servicio de Postgres (cambia el nombre de host)
