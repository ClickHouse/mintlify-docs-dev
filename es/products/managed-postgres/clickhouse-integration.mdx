...
<Image img="/images/managed-postgres/clickhouse-integration-intro.png" alt="Página principal de ClickHouse Integration que muestra la opción de integración en la barra lateral" size="md" border />
...
<Steps>
  <Step>
    ...
    * **Replication method**: Elige una de las siguientes opciones:
    ...
    <Image img="/images/managed-postgres/replication-service-step.png" alt="Configuración del servicio de replicación que muestra el nombre de la integración, el servicio de destino y las opciones del método de replicación" size="md" border />
  ...
  <Step>
    ...
    * **Snapshot number of tables in parallel**: Cuántas tablas se procesan en snapshot en paralelo (predeterminado: 1)
    ...
    <Image img="/images/managed-postgres/integration-replication-settings.png" alt="Paso de ajustes de replicación que muestra el intervalo de sincronización, los threads en paralelo, el tamaño del lote de extracción y las opciones de configuración del snapshot" size="md" border />
  ...
  <Step>
    ...
    * **Remove deleted rows during merges**: Para las tablas [ReplacingMergeTree](/es/reference/engines/table-engines/mergetree-family/replacingmergetree), elimina físicamente las filas borradas durante las background merges
    ...
    <Image img="/images/managed-postgres/select-tables-step.png" alt="Paso de selección de tablas que muestra la selección de la base de datos, las opciones de replicación y el selector de tablas agrupado por schema" size="md" border />
  ...
  <Step>
    ...
    <Image img="/images/managed-postgres/integration-running.png" alt="Lista de ClickHouse Integration que muestra un ClickPipe en ejecución con su servicio de destino y estado" size="md" border />
