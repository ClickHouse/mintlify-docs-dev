...
sidebarTitle: 'PeerDB'
title: 'Migrar datos de PostgreSQL con PeerDB'
...
<div id="peerdb-migration">
  # Migrar a Managed Postgres con PeerDB
</div>

Esta guía proporciona instrucciones paso a paso para migrar su base de datos PostgreSQL a ClickHouse Managed Postgres con PeerDB.
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="Creación del peer de origen" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="Creación del peer de destino" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="Crear mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="Configuración del mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="Selector de tablas" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="Progreso de la carga inicial" size="md" border />
