...
<Image img="/images/managed-postgres/pgpg/overview.png" alt="Entrada fuente de datos en la barra lateral del servicio de Managed Postgres" size="lg" border />

Haz clic en **Start import**.

<Image img="/images/managed-postgres/pgpg/startimport.png" alt="Página de fuente de datos con el botón Start import" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlexport.png" alt="Salida de la terminal tras ejecutar pg_dump" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/advancedsettings.png" alt="Paso 4: formulario de ajustes de ingestión con publicación y opciones avanzadas de replicación" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="Paso 5: selector de tablas agrupadas por esquema con el botón Crear migración" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/initialload.png" alt="Vista de detalles de la migración que muestra estadísticas de la carga inicial por tabla" size="lg" border />
