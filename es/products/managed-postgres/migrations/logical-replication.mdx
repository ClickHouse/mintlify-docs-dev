...
title: 'Migrar datos de PostgreSQL mediante replicación lógica'
...
<div id="logical-replication-migration">
  # Migra a Managed Postgres mediante replicación lógica
</div>

Esta guía proporciona instrucciones paso a paso para migrar tu base de datos PostgreSQL a ClickHouse Managed Postgres mediante la replicación lógica nativa de Postgres.
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="Configuración de la replicación de PostgreSQL de origen" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuración de las tablas PostgreSQL de origen" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Crear una instancia de ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Configuración inicial del destino ClickHouse Managed Postgres" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="Resultado de la migración después de la replicación lógica" size="xl" border />
