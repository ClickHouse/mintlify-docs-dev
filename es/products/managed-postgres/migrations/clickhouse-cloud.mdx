...
title: 'Migrar datos de PostgreSQL con fuentes de datos en ClickHouse Cloud'
...
ClickHouse Cloud incluye un asistente de importación integrado que migra su base de datos PostgreSQL externa a un servicio de Managed Postgres. El asistente gestiona la conexión de origen, la exportación e importación del esquema, la configuración de la replicación y la selección de tablas en cinco pasos guiados.
...
<Image img="/images/managed-postgres/pgpg/servicecard.png" alt="Tarjeta del servicio de Managed Postgres en la lista de servicios de ClickHouse Cloud" size="lg" border />

En la barra lateral izquierda, haz clic en **fuentes de datos**.

<Image img="/images/managed-postgres/pgpg/overview.png" alt="Entrada de fuentes de datos en la barra lateral del servicio de Managed Postgres" size="lg" border />

Haz clic en **Start import**.

<Image img="/images/managed-postgres/pgpg/startimport.png" alt="Página de fuentes de datos con el botón Start import" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationform.png" alt="Paso 1: formulario de conexión a la base de datos de origen con opciones de método de ingestión" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/nextexport.png" alt="Paso 2: comando `pg_dump` para exportar el esquema" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlexport.png" alt="Salida de la terminal después de ejecutar pg_dump" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/nextimport.png" alt="Paso 3: comando psql para importar el esquema" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.png" alt="Salida de la terminal tras ejecutar la importación del esquema con psql" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/advancedsettings.png" alt="Paso 4: formulario de configuración de ingestión con opciones de publicación y replicación avanzada" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="Paso 5: selector de tablas agrupado por esquema con el botón Crear migración" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationlist.png" alt="Lista de fuentes de datos que muestra una migración en ejecución" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/initialload.png" alt="Vista detallada de la migración que muestra estadísticas de la carga inicial por tabla" size="lg" border />
