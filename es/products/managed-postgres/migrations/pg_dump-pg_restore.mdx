...
title: 'Migrar datos de PostgreSQL con pg_dump y pg_restore'
...
Esta guía proporciona instrucciones paso a paso para migrar su base de datos PostgreSQL a ClickHouse Managed Postgres con las utilidades `pg_dump` y `pg_restore`.
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuración de la base de datos PostgreSQL de origen" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="Ejecución del comando pg_dump" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="Ejecución del comando pg_restore" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Configuración de la base de datos de destino de Managed Postgres" size="xl" border />
