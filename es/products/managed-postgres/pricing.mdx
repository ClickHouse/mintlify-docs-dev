...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', margin: '24px 0'}}>
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Ideal para probar ideas nuevas o proyectos iniciales. Almacenamiento y memoria limitados.</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Para entornos de producción, grandes volúmenes de datos o casos de uso profesionales.</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Para trabajar con entornos de producción, grandes volúmenes de datos a escala o casos de uso empresariales.</p>
    ...
    <ul style={{paddingLeft: '20px', margin: 0, fontSize: '0.9rem'}}>
      ...
      <li><a href="/es/products/cloud/guides/infrastructure/deployment-options/clickhouse-private">Regiones privadas</a></li>
...
* El escalado, la conmutación por error y el aprovisionamiento de instancias en espera ejecutan brevemente dos instancias en paralelo para mantener su base de datos en línea; es posible que vea cargos superpuestos por ambas instancias mientras se completa la transición. La duración de esta ventana varía según el tipo de instancia y el volumen de almacenamiento.
* Cuando el tipo de instancia seleccionado no esté disponible temporalmente en la región elegida, podemos aprovisionar un tipo de instancia comparable para mantener su base de datos en línea. Se le facturará según la tarifa de la instancia aprovisionada.
