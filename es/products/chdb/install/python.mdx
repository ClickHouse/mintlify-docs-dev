---
title: 'Instalación de chDB para Python'
sidebarTitle: 'Python'
...
Véase también: [test&#95;stateful.py](https://github.com/chdb-io/chdb/blob/main/tests/test_stateful.py).
...
# DataFrame con objetos JSON mixtos
