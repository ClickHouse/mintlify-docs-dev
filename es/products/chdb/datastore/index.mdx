---
title: 'DataStore - API compatible con pandas'
sidebarTitle: 'Descripción general'
slug: /chdb/datastore
description: 'DataStore ofrece una API compatible con pandas con optimización SQL para el análisis de datos de alto rendimiento'
...
<div id="datastore-pandas-compatible-api-with-sql-optimization">
  # DataStore: API compatible con pandas con optimización de consultas SQL
</div>

DataStore es la API compatible con pandas de chDB que combina la conocida interfaz DataFrame de pandas con la potencia de la optimización de consultas SQL y le permite escribir código al estilo de pandas mientras obtiene el rendimiento de ClickHouse.
