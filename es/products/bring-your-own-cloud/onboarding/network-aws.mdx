...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC Crear conexión de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-2.png" size="lg" alt="BYOC Aceptar conexión de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC Agregar tabla de rutas" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC Agregar tabla de rutas" border />
  </Step>
...
Opcionalmente, después de verificar que el peering funciona, puede solicitar la eliminación del load balancer público de ClickHouse BYOC.
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-1.png" size="lg" alt="Endpoint de servicio de PrivateLink de BYOC" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-2.png" size="lg" alt="Aprobación de PrivateLink de BYOC" border />
  </Step>
