...
Con ClickHouse Cloud, nunca tendrá que preocuparse por aplicar parches ni por las actualizaciones. Implementamos periódicamente actualizaciones que incluyen correcciones, nuevas características y mejoras de rendimiento. Para consultar la lista completa de novedades de ClickHouse, consulte nuestro [changelog de Cloud](/es/resources/changelogs/cloud/2026).
...
<div id="fast-release-channel-early-upgrades">
  ### Canal de lanzamiento Fast release (actualizaciones anticipadas)
</div>

<ScalePlanFeatureBadge feature="El canal de lanzamiento Fast release" />

Además del calendario de actualizaciones habitual, ofrecemos un canal de lanzamiento **Fast release** si desea que sus servicios reciban actualizaciones antes del calendario de versiones habitual.
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="Seleccione el tipo de canal de lanzamiento" border />
</div>

<br />

Este canal de lanzamiento **Fast release** es adecuado para probar nuevas funciones en entornos no críticos. **No se recomienda para cargas de trabajo de producción con requisitos estrictos de tiempo de actividad y fiabilidad.**
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="Actualizaciones programadas" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="Ventana de actualización programada" border />
</div>
