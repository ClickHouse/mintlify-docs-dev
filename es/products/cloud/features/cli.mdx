...
La CLI también gestiona instalaciones y servidores locales de ClickHouse. Consulta la página de [instalación rápida](/es/get-started/setup/self-managed/quick-install) para empezar a trabajar con el desarrollo local.
