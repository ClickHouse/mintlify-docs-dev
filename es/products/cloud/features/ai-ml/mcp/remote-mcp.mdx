...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Seleccione MCP en la ventana modal Conectar" size="md" />

Active el botón para habilitar MCP en el servicio:

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="Habilitar el servidor MCP" size="md" />
...
Consulte la guía específica de integración [Conectar Notion con ClickHouse](/es/integrations/connectors/data-integrations/integrations/notion) para conectar el servidor MCP remoto de ClickHouse Cloud a un Custom Agent de Notion.
