...
title: 'Optimizar las conversaciones del agente de ClickHouse Assistant con una capa semántica'
description: 'Guía para usar AGENTS.md para proporcionar al agente del chat de ClickHouse Assistant lógica de negocio personalizada e instrucciones específicas de los datos'
