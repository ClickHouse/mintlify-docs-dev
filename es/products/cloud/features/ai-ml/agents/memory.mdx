...
Memory es un almacén por usuario que el agente puede recuperar a lo largo de las conversaciones. Está compuesto por varias entradas, cada una un par clave-valor: tu formato
...
<Image img="/images/cloud/agent-builder/memory/memories.png" alt="Panel Memories con el icono de cerebro resaltado en la navegación izquierda, un campo de filtro, un botón Add, una casilla Use memory, una entrada de memoria con controles para editar y eliminar, y un botón Admin Settings" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="Panel de Memory con el botón + de Create Memory resaltado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/filter.png" alt="Panel de memoria con el campo Filtrar memorias resaltado y 'demo' escrito" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/edit.png" alt="Entrada de memoria con el icono de lápiz de Edit Memory resaltado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/delete.png" alt="Entrada de memoria con el icono de la papelera «Eliminar memoria» resaltado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="Panel de Memory con la casilla Use memory resaltada en la parte superior" size="sm" />
