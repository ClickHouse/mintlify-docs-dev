...
<Image img="/images/cloud/agent-builder/web-search/web-search.png" alt="Panel de Capabilities con la sección Web Search resaltada, que muestra la casilla de verificación de Web Search" size="sm" />
