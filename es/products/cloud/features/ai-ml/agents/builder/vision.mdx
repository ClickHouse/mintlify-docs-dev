...
Vision solo funciona con modelos que admiten entrada de imágenes. Si el modelo seleccionado no admite entrada de imágenes, el control de carga en el editor de mensajes se desactiva.
Cambia a un modelo compatible con Vision en [Parámetros del modelo](/es/products/cloud/features/ai-ml/agents/builder/model-parameters) para volver a habilitarlo.
...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="Editor de mensajes con el menú del clip abierto que muestra las opciones Upload to Provider, Upload as Text y Upload to Code Environment" size="lg" />
