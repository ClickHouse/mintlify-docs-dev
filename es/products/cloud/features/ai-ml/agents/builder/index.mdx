...
<Tip>
  ¿Eres nuevo en ClickHouse Agents? Empieza con la [guía de inicio rápido](/es/products/cloud/features/ai-ml/agents/quickstart). Las páginas siguientes describen en detalle cada parte del Agent Builder.
</Tip>
...
| Página                                                                                   | Descripción                                            |
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| [Parámetros del modelo](/es/products/cloud/features/ai-ml/agents/builder/model-parameters)  | Elige un modelo y ajusta los parámetros de generación. |
