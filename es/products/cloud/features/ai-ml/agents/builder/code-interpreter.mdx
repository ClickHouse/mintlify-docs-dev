...
<Image img="/images/cloud/agent-builder/run-code/run-code.png" alt="Sección Run Code del panel Capabilities, con la casilla Run Code habilitada y un botón Upload to Code Environment" size="sm" />
