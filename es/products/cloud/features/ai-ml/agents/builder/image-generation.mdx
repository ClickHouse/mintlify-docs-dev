...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="Modal de Agent Tools que muestra integraciones de modelos de imagen, incluidas OpenAI Image Tools, DALL-E-3 y Stable Diffusion, junto con otras herramientas de terceros" size="md" />
