...
<Image img="/images/cloud/agent-builder/marketplace/marketplace.png" alt="Interfaz de chat con la opción Agent Marketplace resaltada en la barra lateral izquierda" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/browse.png" alt="Vista de Agent Marketplace con el título, la barra de búsqueda, las pestañas de categorías (General, Recursos Humanos, Investigación y Desarrollo, Finanzas, TI, Ventas, Posventa, Todas) y una tarjeta de agente visible" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/use-agent.png" alt="Cuadro de diálogo de detalles del agente que muestra el nombre del agente, un icono y las acciones Fijar, Copiar enlace e Iniciar chat" size="md" />
