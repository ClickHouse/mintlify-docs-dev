...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/launch-ch-agents.png" alt="Navegación del servicio de Cloud con ClickHouse agents (Beta) seleccionado, mostrando el launchpad con el botón Launch ClickHouse agents" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Model** - elige un modelo en el menú desplegable. Ajusta la temperatura y otros parámetros de generación en [model parameters](/es/products/cloud/features/ai-ml/agents/builder/model-parameters).

    <Image img="/images/cloud/agent-builder/agent-builder.png" alt="Panel de Agent Builder que muestra el menú desplegable Create New Agent, los campos del formulario (Name, Description, Category, Instructions, Model) y la sección Capabilities" size="lg" />
  </Step>
  ...
  <Step>
    ...
    **Capabilities** en el panel principal — funciones nativas como [Run Code](/es/products/cloud/features/ai-ml/agents/builder/code-interpreter), [Web Search](/es/products/cloud/features/ai-ml/agents/builder/web-search), File Context, Artifacts, [MCP Servers](/es/products/cloud/features/ai-ml/agents/builder/mcp-servers) y [Skills](/es/products/cloud/features/ai-ml/agents/builder/skills). Activa las que necesite el agente.
    ...
    <Image img="/images/cloud/agent-builder/capabilities.png" alt="Sección Capabilities del panel de Agent Builder que muestra los interruptores de Run Code, Web Search, File Context, Artifacts, MCP Servers y Skills" size="sm" />
    ...
    **Tools** detrás del botón **Add Tools** en la parte inferior del panel — integraciones de terceros como [image generation](/es/products/cloud/features/ai-ml/agents/builder/image-generation), [vision](/es/products/cloud/features/ai-ml/agents/builder/vision), API de búsqueda y servicios externos.
    ...
    <Image img="/images/cloud/agent-builder/tools-button.png" alt="Parte inferior del panel de Agent Builder con el botón Add Tools resaltado" size="sm" />

    Haz clic en **Add Tools** para explorar el catálogo:

    <Image img="/images/cloud/agent-builder/tools-modal.png" alt="Modal de Agent Tools que muestra una cuadrícula de integraciones de terceros, incluidas Google, OpenAI Image Tools, Wolfram, DALL-E-3, Tavily Search, Calculator y Stable Diffusion" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/chat-query.png" alt="Intercambio de chat que muestra la pregunta '¿Cuáles son mis 10 tablas con más filas esta semana?' y la respuesta del agente: una tabla Markdown con la clasificación de las 10 tablas con más filas entre servicios, con Key Observations debajo" size="lg" />
  </Step>
</Steps>
