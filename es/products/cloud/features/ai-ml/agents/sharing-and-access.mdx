...
<Image img="/images/cloud/agent-builder/sharing/sharing.png" alt="Parte inferior del panel de Agent Builder con el icono share resaltado y una insignia que muestra una entidad compartida" size="sm" />
...
<Image img="/images/cloud/agent-builder/sharing/share-agent-modal.png" alt="Modal Share con la sección User and Group Permissions, un campo de búsqueda, un usuario existente con el rol Owner, un interruptor Share with everyone in ClickHouse y los botones Cancel y Save Changes" size="md" />
