...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="Panel Prompts con el botón + resaltado a la izquierda y el formulario Create Prompt abierto a la derecha, mostrando los campos Prompt Name, Text, Category, Special variables, Description y Command, con un botón Create Prompt" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="Panel de Prompts con un prompt seleccionado, sus detalles visibles a la derecha y un menú contextual que muestra las opciones Preview y Edit" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="Ventana modal de vista previa del prompt que muestra el título del prompt, el autor, la fecha, el texto del prompt y un botón Use Prompt" size="md" />
