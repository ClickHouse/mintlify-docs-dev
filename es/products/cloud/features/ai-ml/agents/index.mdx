...
| [Chat](/es/products/cloud/features/ai-ml/agents/chat)                             | Conversaciones, marcadores, ramificaciones, multi-conversation y compartir                                   |
| [Agent Builder](/es/products/cloud/features/ai-ml/agents/builder)                 | Configuración de agentes, parámetros del modelo y herramientas asociadas, servidores MCP, Skills y Subagents |
