...
<Image img="/images/cloud/features/autoscaling/scheduled-scaling-1.png" size="md" alt="La interfaz de Scaling Schedules en la consola de ClickHouse Cloud, que muestra reglas de escalado basadas en el tiempo" border />

<Image img="/images/cloud/features/autoscaling/scheduled-scaling-2.png" size="md" alt="Configuración de una regla de escalado programado en la consola de ClickHouse Cloud" border />
