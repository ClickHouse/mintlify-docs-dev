...
keywords: ['consola sql', 'cliente sql', 'cloud console', 'console']
title: 'Consola SQL'
doc_type: 'guide'
---
...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="md" alt="lista de tablas y esquema" />

Las tablas de la lista también se pueden desplegar para ver las columnas y los tipos

<Image img="/images/cloud/sqlconsole/view-columns.png" size="md" alt="ver columnas" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="md" alt="inspección del contenido de la celda" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="md" alt="ordenar de forma descendente por una columna" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="md" alt="filtro en la columna radio igual a GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="md" alt="Añadir un filtro con un rango mayor que 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="md" alt="Añadir un filtro de rango mayor que 2000" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="md" alt="Crear una consulta a partir de ordenaciones y filtros" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="md" alt="Crear una consulta" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="md" alt="ejecutar consulta seleccionada" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="md" alt="ejecutar en el cursor" />

* Seleccione &#39;Run at cursor&#39; en el menú contextual del SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="md" alt="ejecutar en el cursor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="md" alt="Cancelar una consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-save-query.png" size="md" alt="Guardar consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-rename.png" size="md" alt="Cambiar nombre de la consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="md" alt="Compartir consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="md" alt="Editar acceso" />
...
<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="md" alt="Agregar miembro del equipo" />

Después de seleccionar un miembro del equipo, debería aparecer una nueva fila con un selector de nivel de acceso:

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="md" alt="Editar acceso del miembro del equipo" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="md" alt="Acceder a consultas" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="md" alt="Buscar datos de Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="md" alt="Coincidencia en el cuerpo" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="md" alt="Opciones de paginación" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="md" alt="Navegación de paginación" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="md" alt="Descargar como CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="md" alt="Resultados tabulares de la consulta" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="md" alt="Cambiar de consulta a gráfico" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="md" alt="Total de viajes por semana" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="md" alt="Cambiar de gráfico de barras a área" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="md" alt="Actualizar nombre de la consulta" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="md" alt="Actualizar subtítulo, etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="md" alt="Ajustar escala del eje" />