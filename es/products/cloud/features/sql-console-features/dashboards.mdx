...
<Image img="/images/cloud/dashboards/2_dashboards.png" size="md" alt="Crear una consulta guardada" border />
...
<Image img="/images/cloud/dashboards/3_dashboards.png" size="md" alt="Guardar consulta" border />
...
<Image img="/images/cloud/dashboards/4_dashboards.png" size="md" alt="Una visualización de gráfico de barras de los resultados de una consulta" border />
...
<Image img="/images/cloud/dashboards/5_dashboards.png" size="md" alt="Crear un nuevo panel" border />
...
<Image img="/images/cloud/dashboards/6_dashboards.png" size="md" alt="Añadir una visualización" border />
...
<Image img="/images/cloud/dashboards/7_dashboards.png" size="md" alt="Visualizar los resultados de la consulta como una tabla" border />
...
<Image img="/images/cloud/dashboards/8_dashboards.png" size="md" alt="Editar la consulta subyacente" border />
...
<Image img="/images/cloud/dashboards/9_dashboards.png" size="md" alt="Ajustar los filtros globales" border />
...
<Image img="/images/cloud/dashboards/10_dashboards.png" size="md" alt="Cambiar el parámetro de consulta" border />
...
<Image img="/images/cloud/dashboards/11_dashboards.png" size="md" alt="Controlar el filtro en el gráfico de líneas" border />