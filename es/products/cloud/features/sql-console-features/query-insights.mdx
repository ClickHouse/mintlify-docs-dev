...
description: 'Visualiza los datos de system.query_log para simplificar la depuración de consultas y optimizar el rendimiento'
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Vista general de la interfaz de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Gráfico de latencia de la UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Tabla de consultas recientes en la UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Desglose de la consulta en la UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Información de la consulta en la UI de Query Insights" border />
