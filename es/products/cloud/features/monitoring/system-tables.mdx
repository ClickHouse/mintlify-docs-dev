---
title: 'Consultar las tablas del sistema'
slug: /cloud/monitoring/system-tables
description: 'Monitorea ClickHouse Cloud consultando directamente las tablas del sistema'
keywords: ['nube', 'monitorización', 'tablas del sistema', 'query_log', 'clusterAllReplicas', 'panel de observabilidad']
...
<div id="querying-clickhouses-system-database">
  # Consultar la base de datos del sistema de ClickHouse
</div>
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Panel avanzado de observabilidad nativo" border />
