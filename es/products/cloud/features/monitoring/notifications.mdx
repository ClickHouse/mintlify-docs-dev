...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="panel desplegable de notificaciones de ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="registro de actividad de notificaciones de ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="Pantalla de configuración de notificaciones de ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="Configuración de entrega de notificaciones de ClickHouse Cloud" border />
