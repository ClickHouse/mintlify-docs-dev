...
<div id="monitoring-in-the-clickhouse-cloud-console">
  # Monitoreo en la Consola de ClickHouse Cloud
</div>

Los servicios de ClickHouse Cloud incluyen componentes de monitoreo listos para usar que ofrecen a los usuarios paneles y notificaciones. De forma predeterminada, todos los usuarios de la Cloud Console pueden acceder a estos paneles.
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Panel avanzado en ClickHouse Cloud" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Descripción general de la UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="gráfico de latencia de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Tabla de consultas recientes de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Desglose de consultas en la UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Información de consultas en la UI de Query Insights" border />
...
* [panel avanzado](/es/products/cloud/features/monitoring/advanced-dashboard) — Referencia detallada de cada visualización del panel
* [Consultar tablas del sistema](/es/products/cloud/features/monitoring/system-tables) — Ejecuta consultas SQL personalizadas sobre tablas del sistema para una introspección más profunda
