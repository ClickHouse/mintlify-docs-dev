...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="arquitectura segmentada" />
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="arquitectura sin segmentos" />
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="Réplicas paralelas" />
...
<Image img="/images/deployment-guides/parallel-replicas-4.png" size="md" alt="Anuncios" />
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="Coordinación dinámica - parte 1" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="Coordinación dinámica - parte 2" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="Coordinación dinámica - parte 3" />
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="EXPLAIN sin parallel_replica" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="EXPLAIN con parallel_replica" />