...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="Servicio único en ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="Separación de cómputo en ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="Ejemplo de warehouse con servicio principal y servicios secundarios" background="white" />
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="Acceso de usuarios entre servicios que comparten los mismos datos" />
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="Configuración del control de acceso a la red" />
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="Servicios de lectura y escritura y de solo lectura en un warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="Crear un nuevo servicio en un warehouse" />
