...
Para obtener más información sobre los ajustes que puede especificar para su servicio de ClickHouse Cloud, consulte todos los ajustes posibles por categoría en [nuestra documentación](/es/reference/settings).

<Image img="/images/cloud/manage/cloud-settings-sidebar.png" size="sm" alt="Barra lateral de ajustes de Cloud" border />