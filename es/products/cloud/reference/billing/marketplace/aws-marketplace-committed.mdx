...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="Correo electrónico de oferta privada de AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="Correo electrónico de oferta privada de AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="Correo electrónico de oferta privada de AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="Crea o selecciona una organización a la que facturar esta suscripción" />

    Después de completar este paso, tu organización quedará conectada a tu contrato de gasto comprometido de AWS y todo el uso se facturará a través de tu cuenta de AWS.
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="Confirma que la configuración está completa" />
