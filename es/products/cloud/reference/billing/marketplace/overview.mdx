...
<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="Registro en el marketplace y vinculación de la organización" border />
...
Consulta la [página de resumen de facturación](/es/products/cloud/reference/billing).
