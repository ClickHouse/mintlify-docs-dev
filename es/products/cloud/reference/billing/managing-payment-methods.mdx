...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="Añadir un método de pago" size="lg" />
...
<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="Editar tu tarjeta de crédito" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="Editar método de pago" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="Editar método de pago" size="lg" />

3. En el cuadro de diálogo **Edit método de pago**, verá su suscripción actual de marketplace indicada como método de pago.
...
6. Haga clic en **Update método de pago** para confirmar.
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="Añadir tarjeta de crédito de respaldo" size="lg" />
