...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="Dónde encontrar la facturación en la UI" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="Factura" />
