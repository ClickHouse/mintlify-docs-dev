...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" size="lg" alt="Página de Billing con el menú Actions abierto y Add spend alerts resaltado" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" size="md" alt="Cuadro de diálogo de alertas de gasto de la organización con límite de gasto, alertas automáticas de umbral y canales de notificación" />
  </Step>
</Steps>
