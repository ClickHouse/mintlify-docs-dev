...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" alt="Página de Billing con el menú Actions abierto y Add spend alerts resaltado" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" alt="Cuadro de diálogo de alertas de gasto de la organización con límite de gasto, alertas automáticas de umbral y canales de notificación" size="md" />
  </Step>
</Steps>
