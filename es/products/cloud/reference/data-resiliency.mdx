...
De forma predeterminada, ClickHouse Cloud realiza una [copia de seguridad](/es/products/cloud/guides/backups) de su servicio cada 24 horas.
...
<Image img="/images/cloud/guides/restore_backup.png" size="md" alt="Restaurar a partir de una copia de seguridad" />
