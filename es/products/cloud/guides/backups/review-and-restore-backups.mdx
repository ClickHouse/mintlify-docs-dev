...
<div id="review-and-restore-backups">
  # Revisar y restaurar copias de seguridad
</div>

Esta guía explica cómo funcionan las copias de seguridad en ClickHouse Cloud, qué opciones tiene para configurar las copias de seguridad de su servicio y cómo restaurar a partir de una copia de seguridad.

**Requisitos previos**

* Ha leído [&quot;Cómo funcionan las copias de seguridad en ClickHouse Cloud&quot;](/es/products/cloud/features/backups/overview#how-backups-work-in-clickhouse-cloud) (página de información general de la funcionalidad)
...
<Image img="/images/cloud/manage/backup-status-list.png" size="md" alt="Lista del estado de las copias de seguridad en ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-usage.png" size="md" alt="Gráfico de uso de copias de seguridad en ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-restore.png" size="md" alt="Restauración de una copia de seguridad en ClickHouse Cloud" />

El nuevo servicio aparecerá en la lista de servicios como `Provisioning` hasta que esté listo:

<Image img="/images/cloud/manage/backup-service-provisioning.png" size="md" alt="Servicio en proceso de aprovisionamiento" border />
