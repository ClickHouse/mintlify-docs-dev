...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="Configurar las opciones de las copias de seguridad" border />
...
<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="Seleccionar la retención y la frecuencia de las copias de seguridad" border />
