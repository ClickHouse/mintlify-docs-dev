...
title: 'Crear una copia de seguridad o restaurar una copia de seguridad desde la UI'
...
<Note>
  Las copias de seguridad automatizadas en su bucket externo están configuradas para ejecutarse como copias de seguridad &quot;completas&quot; cada 24 horas, y esta frecuencia no se puede modificar.
</Note>
...
<Steps>
  ...
  <Step>
    ...
    * a. Obtenga el ARN en la página de configuración del servicio de ClickHouse Cloud, en la sección Información de seguridad de red, que tendrá un aspecto similar a este:
    ...
    <Image img="/images/cloud/manage/backups/arn.png" alt="ARN de AWS S3" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/change_external_backup.png" alt="Cambiar el backup externo" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/configure_arn_s3_details.png" alt="Configurar el ARN del rol de IAM de AWS y los detalles del bucket de S3" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups.png" alt="Ver los backups almacenados en tu bucket" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/backup_command.png" alt="Obtener el comando SQL usado para restaurar la copia de seguridad" size="md" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_configure.png" alt="Configurar la clave HMAC y el secreto de GCP" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_stored_backups.png" alt="Ver los backups almacenados en tu bucket" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_restore_command.png" alt="Obtener el comando SQL para restaurar la copia de seguridad" size="md" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/azure_connection_details.png" alt="Proporciona la cadena de conexión y el nombre del contenedor de tu cuenta de almacenamiento de Azure" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups_azure.png" alt="Ver los backups almacenados en tu bucket" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/restore_backups_azure.png" alt="Restaurar copias de seguridad en Azure" size="md" />
