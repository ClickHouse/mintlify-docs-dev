---
sidebarTitle: 'Hacer una copia de seguridad o restaurarla mediante comandos'
slug: /cloud/manage/backups/backup-restore-via-commands
title: 'Hacer una copia de seguridad o restaurarla mediante comandos'
description: 'Página que describe cómo hacer una copia de seguridad o restaurarla con su propio bucket mediante comandos'
doc_type: 'guide'
keywords: ['copias de seguridad', 'recuperación ante desastres', 'protección de datos', 'restaurar', 'funciones de Cloud']
---

<div id="commands-experience">
