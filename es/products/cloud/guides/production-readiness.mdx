...
Las [redes privadas](/es/products/cloud/guides/security/connectivity/private-networking) en ClickHouse Cloud le permiten conectar sus servicios de ClickHouse directamente a su red virtual en la nube, garantizando que los datos no atraviesen la Internet pública. Esto es esencial para las organizaciones con requisitos estrictos de seguridad o cumplimiento normativo, o para aquellas que ejecutan aplicaciones en subredes privadas.
...
<div id="user-lifecycle-management">
  ### Limitaciones de la gestión del ciclo de vida de los usuarios
</div>

ClickHouse Cloud no admite actualmente SCIM ni el aprovisionamiento y desaprovisionamiento automáticos mediante proveedores de identidad. Los usuarios deben eliminarse manualmente de la consola de ClickHouse Cloud después de haber sido eliminados de su IdP. Prevea procesos manuales de gestión de usuarios hasta que estas funciones estén disponibles.

Obtenga más información sobre [Cloud Access Management](/es/products/cloud/guides/security/cloud-access-management) y la [configuración de SAML SSO](/es/products/cloud/guides/security/cloud-access-management/saml-sso-setup).
...
Si las limitaciones actuales de los [niveles de servicio](/es/products/cloud/features/cloud-tiers) afectan a tus operaciones en producción, considera las opciones de actualización para obtener capacidades mejoradas, como [redes privadas](/es/products/cloud/guides/security/connectivity/private-networking), [TDE/CMEK](/es/products/cloud/guides/security/cmek) (Cifrado transparente de datos con claves de cifrado gestionadas por el cliente) u [opciones avanzadas de copia de seguridad](/es/products/cloud/guides/backups/configurable-backups).