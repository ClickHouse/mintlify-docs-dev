...
ClickHouse Cloud proporciona de forma predeterminada un servicio replicado y de alta disponibilidad. Como resultado, todos los motores de bases de datos y tablas son &quot;Replicated&quot;. No es necesario especificar &quot;Replicated&quot;; por ejemplo, `ReplicatedMergeTree` y `MergeTree` son idénticos cuando se usan en ClickHouse Cloud.

**Motores de tabla compatibles**

* ReplicatedMergeTree (predeterminado, cuando no se especifica ninguno)
* ReplicatedSummingMergeTree
* ReplicatedAggregatingMergeTree
* ReplicatedReplacingMergeTree
* ReplicatedCollapsingMergeTree
* ReplicatedVersionedCollapsingMergeTree
* MergeTree (se convierte en ReplicatedMergeTree)
* SummingMergeTree (se convierte en ReplicatedSummingMergeTree)
* AggregatingMergeTree (se convierte en ReplicatedAggregatingMergeTree)
* ReplacingMergeTree (se convierte en ReplicatedReplacingMergeTree)
* CollapsingMergeTree (se convierte en ReplicatedCollapsingMergeTree)
* VersionedCollapsingMergeTree (se convierte en ReplicatedVersionedCollapsingMergeTree)
* URL
* View
* MaterializedView
* GenerateRandom
