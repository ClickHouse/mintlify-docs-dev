...
description: 'Genere fácilmente endpoints de API REST a partir de sus consultas guardadas'
keywords: ['api', 'query api endpoints', 'query endpoints', 'query rest api']
title: 'endpoint de la API de consultas'
doc_type: 'guide'
---
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Probar la consulta de ejemplo" />

    A continuación, guarda la consulta:

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Guardar consulta de ejemplo" />
  ...
  <Step>
    ...
    * Especifiques los dominios permitidos para el uso compartido de recursos entre orígenes (CORS)
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Comando curl del endpoint" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="prueba curl del endpoint" />
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Monitorización del endpoint" />
  </Step>
</Steps>
