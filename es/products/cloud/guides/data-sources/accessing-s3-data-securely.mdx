...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="Descripción general del acceso seguro a S3 con ClickHouse" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="Obtención del ARN del rol de IAM del servicio de ClickHouse" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="Salida de la pila de CloudFormation que muestra el ARN del rol de IAM" border />
