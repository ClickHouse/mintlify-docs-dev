...
ClickHouse admite varias funciones de tabla para acceder a orígenes de datos externas. Para obtener más información, consulta [funciones de tabla](/es/reference/functions/table-functions) en la sección de referencia de SQL.