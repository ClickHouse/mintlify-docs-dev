...
<Image img="/images/_snippets/aws-rds-mysql.png" size="lg" alt="Reglas del grupo de seguridad de AWS" border />
...
<Image img="/images/_snippets/gcp-authorized-network.png" size="md" alt="Redes autorizadas de GCP" border />