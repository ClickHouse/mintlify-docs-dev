...
title: 'Migrar entre ClickHouse autogestionado y ClickHouse Cloud con BACKUP/RESTORE'
...
<div id="migrating-from-self-managed-clickhouse-to-clickhouse-cloud-using-backup-commands">
  # Migración de un ClickHouse autogestionado a ClickHouse Cloud con comandos de copia de seguridad
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="crear un nuevo servicio" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="configurar las preferencias del servicio" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="configurar las preferencias del servicio" />
...
<Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="copia de seguridad, datos y metadatos" />
