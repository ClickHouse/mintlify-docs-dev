...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_1.png" size="md" alt="Habilitar PCI" background="black" />

    <br />

    4. Una vez habilitado, se pueden implementar servicios PCI dentro de la organización.

    <br />

    <Image img="/images/cloud/security/compliance/pci_2.png" size="md" alt="PCI habilitado" background="black" />

    <br />
  </Step>

  <Step>
    ### Implemente servicios en regiones compatibles con PCI
    ...
    <Image img="/images/cloud/security/compliance/pci_3.png" size="md" alt="Implementar en una región PCI" background="black" />
