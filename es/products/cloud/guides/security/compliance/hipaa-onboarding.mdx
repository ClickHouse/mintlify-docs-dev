...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="Solicite la habilitación de HIPAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="Enviar una solicitud de BAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA habilitado" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="Desplegar en una región compatible con HIPAA" background="black" />
