...
<div id="console-audit-log">
  # Registro de auditoría de consola
</div>

Las actividades de consola se registran en el registro de auditoría. Si tienes un rol de organización Admin o Developer, puedes revisar el registro e integrarlo con tus sistemas de logging.
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/security/activity_log1.png" size="md" alt="Pestaña Activity de ClickHouse Cloud" border />
  ...
  <Step>
    ...
    * **Time:** La marca temporal del evento
    ...
    <Image img="/images/cloud/security/activity_log2.png" size="md" alt="Tabla Activity de ClickHouse Cloud" border />
...
<div class="eighty-percent">
  <Image img="/images/cloud/security/activity_log3.png" size="lg" alt="Exportación CSV de Activity de ClickHouse Cloud" border />
</div>
