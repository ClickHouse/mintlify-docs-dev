...
Actualmente admitimos SSO iniciado por el proveedor de servicios, múltiples organizaciones que usan conexiones independientes y aprovisionamiento just-in-time. Aún no admitimos System for Cross-domain Identity Management (SCIM) ni la correspondencia de atributos.
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="Iniciar la configuración de SAML" force />
  </Step>
  ...
  <Step>
    ...
    * [Configurar Duo SAML](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="Crear una aplicación en el proveedor de identidad" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="Agrega la URL de metadatos" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="Añadir dominio para verificar" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="Verifica tu dominio" force />
  </Step>
...
<Accordion title="Crear una aplicación web de Google">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Aplicación SAML de Google" force />
...
<Accordion title="Crear una aplicación Enterprise en Azure">
  ...
  5. Introduzca un nombre y seleccione **Integrate any other application you don&#39;t find in the gallery (Non-gallery)**; luego, haga clic en **Create**.
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Aplicación de Azure fuera de la galería" force />
  ...
  10. Agregue (A) o actualice (U) lo siguiente en Attributes &amp; Claims:
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="Atributos y claims" force />
