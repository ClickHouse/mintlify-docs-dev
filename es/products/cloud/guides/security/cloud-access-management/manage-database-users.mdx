...
<Image img="/images/cloud/security/cloud-access-management/user_grant_permissions_options.png" alt="Una ilustración que muestra las distintas formas en que se pueden conceder permisos a un usuario" size="md" background="black" />
...
<Steps>
  ...
  <Step>
    ...
    Asocie esta lista con los usuarios de Console que tienen acceso a la consola SQL.
