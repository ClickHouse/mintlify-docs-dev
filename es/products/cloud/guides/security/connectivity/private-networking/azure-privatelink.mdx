...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="Descripción general de PrivateLink" background="white" />
...
<Image img="/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="Puntos de conexión privados" border />
...
<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="Abrir Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Crear Private Endpoint básico" border />

***

Seleccione la opción **Connect to an Azure resource by resource ID or alias**.

En **Resource ID or alias**, use el `endpointServiceId` que obtuvo en el paso [Obtain Azure connection alias for Private Link](#obtain-azure-connection-alias-for-private-link).

Haga clic en el botón **Next: Virtual Network**.

<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="Selección de recursos de Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Selección de red virtual de Private Endpoint" border />

Haga clic en el botón **Next: Tags**.

***

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Configuración de DNS de Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Tags de Private Endpoint" border />

Por último, haga clic en el botón **Create**.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="Revisión de Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="Dirección IP de Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="Vista del Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Configuración de DNS con comodín de Private Link" border />
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Eliminar Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="Filtro de endpoints privados" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="Nombre DNS del Private Endpoint" border />
