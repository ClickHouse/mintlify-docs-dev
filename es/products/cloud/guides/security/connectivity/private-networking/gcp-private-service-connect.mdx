---
title: 'Private Service Connect de GCP'
description: 'Este documento describe cómo conectarse a ClickHouse Cloud mediante Private Service Connect (PSC) de Google Cloud Platform (GCP), y cómo deshabilitar el acceso a sus servicios de ClickHouse Cloud desde direcciones distintas de las de GCP PSC mediante listas de acceso IP de ClickHouse Cloud.'
...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Descripción general de Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="Abrir Private Service Connect en Google Cloud Console" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="Habilitar Global Access para Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="Copiar PSC Connection ID" border />
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="Eliminar Private Endpoint de ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="Filtro de Private Endpoints" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="Nombre DNS del endpoint privado" border />
