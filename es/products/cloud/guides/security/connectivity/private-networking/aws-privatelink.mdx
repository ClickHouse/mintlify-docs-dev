...
<Image img="/images/cloud/security/aws-privatelink-endpoint-settings.png" size="md" alt="Configuración del endpoint de AWS PrivateLink" border />
...
<Image img="/images/cloud/security/aws-privatelink-select-vpc-and-subnets.png" size="md" alt="Seleccione la VPC y las subredes" border />
...
<Image img="/images/cloud/security/aws-privatelink-vpc-endpoint-id.png" size="md" alt="ID del endpoint de VPC" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-filters.png" size="md" alt="Filtro de endpoints privados" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-dns-name.png" size="md" alt="Nombre DNS del endpoint privado" border />
...
Para ello, configura tus Security Groups de AWS para permitir conexiones desde ClickHouse Cloud a tu servicio de base de datos interno o privado. Consulta las [direcciones IP de salida predeterminadas de las regiones de ClickHouse Cloud](/es/products/cloud/guides/data-sources/cloud-endpoints-api), junto con las [direcciones IP estáticas disponibles](https://api.clickhouse.cloud/static-ips.json).