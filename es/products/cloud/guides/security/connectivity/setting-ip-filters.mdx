...
<Info>
  **Aplicable solo a conexiones fuera de PrivateLink**
  ...
  Las listas de acceso IP solo se aplican a conexiones desde la Internet pública, fuera de [PrivateLink](/es/products/cloud/guides/security/connectivity/private-networking).
...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="Lista de acceso existente en ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="Añadir una única IP a la lista de acceso en ClickHouse Cloud" border />
