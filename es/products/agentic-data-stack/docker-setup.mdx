...
<Steps>
  ...
  <Step title="Selecciona un modelo">
    ...
    <Image img="/images/agentic-data-stack/select-model.png" alt="El selector de modelos de LibreChat en la esquina superior izquierda, mostrando el modelo predeterminado con un tooltip que dice Select a model" size="md" />
    ...
    <Accordion title="Establece una clave del proveedor en la UI">
      ...
      <Image img="/images/agentic-data-stack/set-api-key.png" alt="Selector de modelos de LibreChat con el botón Set API Key junto al proveedor Anthropic" size="md" />
      ...
      <Image img="/images/agentic-data-stack/set-api-key-modal.png" alt="El cuadro de diálogo Set API Key for Anthropic con un desplegable de vencimiento, un campo Key y los botones Submit y Revoke" size="md" />
    </Accordion>
  </Step>
  ...
  <Step title="Selecciona el servidor MCP">
    ...
    <Image img="/images/agentic-data-stack/select-clickhouse-local.png" alt="El menú MCP Servers abierto en el editor de mensajes de LibreChat, mostrando ClickHouse-Local con un punto verde de conexión y ClickHouse-Cloud" size="md" />
  </Step>
  ...
  <Step title="Haz tu primera pregunta">
    ...
    <Image img="/images/agentic-data-stack/prompt-chat.png" alt="LibreChat respondiendo a la pregunta de ejemplo al invocar las herramientas MCP de ClickHouse-Local y listar las bases de datos y tablas disponibles" size="md" />
  </Step>
</Steps>
