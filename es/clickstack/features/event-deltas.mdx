...
<Image img="/images/clickstack/event-deltas/overview.png" alt="Vista general de Event deltas en el servicio de pagos, con la banda brillante ascendiendo a mitad de la ventana y sin recuperación dentro del encuadre" size="lg" />
...
<Image img="/images/clickstack/event-deltas/before-after.png" alt="Modo de comparación en el servicio de pagos, con el rectángulo trazado desde el punto de inflexión del ascenso hasta el borde derecho y la parte inferior apoyada en la línea base de 1 ms" size="lg" />
...
<Image img="/images/clickstack/event-deltas/slow-vs-fast.png" alt="Comparación de lento frente a rápido en frontend-proxy con el rectángulo cubriendo solo la banda superior claramente separada, bien alejada del grueso denso" size="lg" />
...
<Image img="/images/clickstack/event-deltas/drill-down.png" alt="Ventana emergente al hacer clic en una barra de ScopeVersion que muestra los porcentajes de Selección frente a Fondo y las acciones de filtrar, excluir y copiar" size="lg" />
...
<Image img="/images/clickstack/event-deltas/settings-drawer.png" alt="Panel lateral de Display Settings con campos de Scale, Value y Count" size="lg" />
