...
<Steps>
  <Step>
    ...
    Comience introduciendo una [búsqueda](/es/clickstack/features/search) y haciendo clic en el botón `Alerts` en la esquina superior derecha de la página `Search`.

    <Image img="/images/use-cases/observability/alerts_search_view.png" alt="Vista de búsqueda de alertas" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Especificar un valor `grouped by`. Esto permite que la búsqueda esté sujeta a una agregación, por ejemplo, `ServiceName`, lo que permite activar varias alertas a partir de la misma búsqueda.
    * Elegir un destino de webhook para las notificaciones. Puede añadir un nuevo webhook directamente desde esta vista. Consulte [Añadir un webhook](#add-webhook) para obtener más detalles.
    ...
    <Image img="/images/use-cases/observability/search_alert.png" alt="Alertas de búsqueda" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/multiple_search_alerts.png" alt="Múltiples alertas" size="md" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/edit_chart_alert.png" alt="Editar alerta del gráfico" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/add_chart_alert.png" alt="Añadir alerta al gráfico" size="lg" />
  </Step>

  <Step>
    #### Define las condiciones de la alerta
    ...
    <Image img="/images/use-cases/observability/create_chart_alert.png" alt="Crear alerta para el gráfico" size="lg" />
...
<Image img="/images/use-cases/observability/add_new_webhook.png" alt="Añadir nuevo webhook" size="lg" />

Esto abre el cuadro de diálogo de creación del webhook, donde puede crear un webhook nuevo:

<Image img="/images/use-cases/observability/add_webhook_dialog.png" alt="Creación de webhook" size="md" />
...
<Image img="/images/use-cases/observability/manage_alerts.png" alt="Gestionar alertas" size="lg" />

En esta vista, puedes ver todas las alertas que se han creado y que actualmente están activas en ClickStack.

<Image img="/images/use-cases/observability/alerts_view.png" alt="Vista de alertas" size="lg" />
...
<Image img="/images/use-cases/observability/remove_chart_alert.png" alt="Eliminar alerta del gráfico" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/open_sql_chart_mode.png" alt="Crear gráfico SQL" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Webhook**: el canal de notificación que se usará cuando se active la alerta. Consulte [Añadir un webhook](#add-webhook).
    ...
    <Image img="/images/use-cases/observability/add_raw_sql_alert.png" alt="Editar alerta del gráfico" size="lg" />
