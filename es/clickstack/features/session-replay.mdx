...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Vista de búsqueda de reproducciones de sesión" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="Reproducción de sesión" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="Profundizando desde una sesión reproducida hasta las trazas de backend en ClickStack" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Vista de traza de reproducción de sesiones" size="lg" />
