...
<Steps>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-2.png" alt="Visualización simple" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-3.png" alt="Visualización simple 2" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-duplicate-series.png" alt="El icono de copia Duplicate series y su descripción emergente en una fila de serie de un gráfico" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-1.png" alt="Crear dashboard" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-2.png" alt="Crear una visualización en el dashboard" size="lg" />

    Cambia el tamaño de la visualización para que ocupe todo el ancho del dashboard.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-3.png" alt="Dashboard con visualizaciones" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Alias: `Count of events`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-4.png" alt="Visualización del dashboard 2" size="lg" />

    Cambie el tamaño de la visualización para que ocupe todo el ancho del dashboard.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-5.png" alt="Dashboard con visualizaciones 2" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Count**: `count()`
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-editor.png" alt="Editor de tile de heatmap con valores predeterminados de duración de span ya completados, filtro ServiceName payment y botón Display Settings" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-rendered.png" alt="Tile de dashboard de heatmap que muestra la distribución de duración de spans del servicio payment durante 24 horas" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-drilldown.png" alt="Clic en una celda de heatmap que revela la acción View in Event Deltas" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-filter.png" alt="Dashboard con filtrado" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-save.png" alt="Guardado del dashboard" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-edit.png" alt="Edición de dashboards" size="lg" />
...
<Image img="/images/clickstack/dashboards/number-tile-background-chart.png" alt="Panel Configuración de visualización de un mosaico Number, con Gráfico de fondo establecido en Área" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-search.png" alt="Búsqueda de dashboards" size="lg" />
...
<Image img="/images/clickstack/dashboards/filter-dropdown.png" alt="Filtro desplegable de servicios que muestra los nombres de servicio disponibles" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/edit-filters.png" alt="Botón Edit Filters en la barra de herramientas del dashboard" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/add-filter.png" alt="Cuadro de diálogo Add filter con campos Name, Data source y Filter expression" size="md" />
    ...
    <Image img="/images/clickstack/dashboards/saved-filters.png" alt="Modal Filters que muestra un filtro Services configurado" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/filtered-dashboard.png" alt="Dashboard filtrado al servicio frontend" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/save-filter-values.png" alt="Menú del dashboard que muestra la opción Save Query and Filters as Default" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/drilldown.png" alt="Menú contextual de desglose que muestra las opciones Ver todos los eventos y Filtrar por grupo" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-clickhouse.png" alt="Dashboard de ClickHouse" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-services.png" alt="Servicios de ClickHouse" size="lg" />
