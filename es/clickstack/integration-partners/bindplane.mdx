...
<Steps>
  <Step>
    #### Configura ClickStack como destino
  ...
  <Step>
    ...
    4. Añade fuentes:
       ...
       * Para producción, añade fuentes para tu telemetría real (logs, metrics, traces)
    5. Añade el destino de ClickStack:
       ...
       * Elige qué tipos de telemetría enviar (Logs, Metrics, Traces o todos)
  ...
  <Step>
    #### Añade procesadores (opcional)

    Bindplane proporciona inteligencia de pipelines y recomendaciones de procesadores. Puedes añadir procesadores para:

    * **Filter**: Reducir el volumen de datos excluyendo telemetría innecesaria
    * **Sample**: Aplicar estrategias de sampling a traces de gran volumen
  ...
  <Step>
    #### Implementa collectors e inicia el rollout
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Señales de telemetría en ClickStack a través de Bindplane" size="lg" />
  </Step>

  <Step>
    #### Verifica la telemetría en ClickStack
    ...
    2. Ve al explorador de **Logs**, **Metrics** o **Traces**
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Señales de telemetría en ClickStack a través de Bindplane" size="lg" />
  </Step>
</Steps>
