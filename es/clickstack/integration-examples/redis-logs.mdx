...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="Vista de logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="Dashboard de ejemplo" />
  </Step>
</Steps>
