...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="Vista de registros" />

    <Image img="/images/clickstack/log-view.png" alt="Vista de registros" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="Dashboard de ejemplo" />
  </Step>
</Steps>
