...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Métricas de Temporal" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="Diálogo Finish Import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Dashboard de métricas de Temporal" />
  </Step>
</Steps>
