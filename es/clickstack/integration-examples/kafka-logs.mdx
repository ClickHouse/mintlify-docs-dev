...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Vista de búsqueda" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="Vista de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Vista Search" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="Vista Log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Finalizar la importación del dashboard de logs de Kafka" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Dashboard de ejemplo de logs de Kafka" />
  </Step>
</Steps>
