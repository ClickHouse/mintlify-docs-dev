...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Vista Search de logs" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="Vista de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Vista de búsqueda de logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    * Tasas de error
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Dashboard de ejemplo" />
