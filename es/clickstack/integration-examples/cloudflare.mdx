...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="Agregar fuente" />
    ...
    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="Configurar opcionales" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="Guardar fuente" />
  ...
  <Step>
    ...
    * Atributos por los que se puede buscar, como `http.status_code`, `client.country`, `cache.status` y `bot.score`
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Vista Search" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Vista de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Vista de búsqueda" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Vista de log" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/es/examples/cloudflare-logs-dashboard.json'} download="cloudflare-logs-dashboard.json" eventName="docs.cloudflare_logs_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="Importar dashboard" />

    2. Cargue `cloudflare-logs-dashboard.json` → **Finish Import**

    <Image img="/images/clickstack/cloudflare/finish-import.png" alt="Importar dashboard" />
  </Step>

  <Step>
    #### Ver el dashboard

    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="Dashboard de ejemplo" />
