...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="Vista de búsqueda de logs de EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="Detalle de log de EC2 con metadatos" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="Vista de búsqueda de logs de EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="Detalle de log de EC2 con metadatos" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/es/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botón para importar dashboard" />

    3. Sube el archivo `host-logs-dashboard.json` y haz clic en **Finish Import**

    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Dashboard de logs de EC2" />
