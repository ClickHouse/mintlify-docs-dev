...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Vista de búsqueda de logs" />

    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="Vista de log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="Dashboard de logs" />
