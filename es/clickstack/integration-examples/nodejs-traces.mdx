...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Vista de búsqueda de trazas" />

    Haz clic en cualquier traza para ver la vista detallada con spans, duración y atributos:

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Vista de una traza individual" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/finish-import.png" alt="Finalizar importación" />
  </Step>

  <Step>
    #### El dashboard se creará con todas las visualizaciones ya preconfiguradas

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="Dashboard de ejemplo" />
