...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Ver trazas" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/es/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="Dashboard de ejemplo" />
  </Step>
</Steps>
