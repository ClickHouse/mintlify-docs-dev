...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Vista de búsqueda de logs de MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Vista detallada del log de MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Vista Search de logs de MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Vista detallada de un log de MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="Finalizar la importación del dashboard de logs de MongoDB" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="Dashboard de logs de MongoDB" />
  </Step>
</Steps>
