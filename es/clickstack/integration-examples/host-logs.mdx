...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="Vista de Búsqueda" />

    <Image img="/images/clickstack/host-logs/log-view.png" alt="Vista de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Dashboard de logs" />
