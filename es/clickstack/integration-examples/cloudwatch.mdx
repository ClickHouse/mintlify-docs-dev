...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="API key de ClickStack" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="Vista de búsqueda de logs" />
    ...
    * `Body`: El contenido real del mensaje de log
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="Valores de la columna del log de error" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="Vista de búsqueda de demostración" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/es/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botón Import Dashboard" />

    3. Sube el archivo `cloudwatch-logs-dashboard.json` y haz clic en **Finish Import**

    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="Diálogo Finish Import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="Dashboard de CloudWatch Logs" />
