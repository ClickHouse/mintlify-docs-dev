...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Dashboard de métricas de Kafka" />
...
* Explora [otras integraciones de ClickStack](/es/clickstack/integration-examples) para unificar tus datos de observabilidad
