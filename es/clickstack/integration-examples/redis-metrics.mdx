...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="Diálogo para finalizar la importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Dashboard de Redis Metrics" />
