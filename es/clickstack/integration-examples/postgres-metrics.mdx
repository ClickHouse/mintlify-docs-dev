...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="Cuadro de diálogo para finalizar la importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="Dashboard de métricas de PostgreSQL" />
