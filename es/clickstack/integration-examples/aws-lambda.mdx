...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/lambda/lambda-log-view.png" alt="Vista de logs de Lambda" />

    <Image img="/images/clickstack/lambda/lambda-log.png" alt="Detalle del log de Lambda" />
