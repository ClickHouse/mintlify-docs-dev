...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="Vista de búsqueda" />

    <Image img="/images/clickstack/mysql/log-view.png" alt="Vista de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/finish-import.png" alt="Finalizar importación" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/example-dashboard.png" alt="Dashboard de ejemplo" />
