...
<Image img="/images/use-cases/observability/hyperdx-landing.png" alt="Página de inicio" size="lg" />
...
Para empezar, visita la [guía de introducción](/es/clickstack/getting-started) antes de cargar un [conjunto de datos de ejemplo](/es/clickstack/example-datasets). También puedes consultar la documentación sobre [opciones de despliegue](/es/clickstack/deployment/overview) y [buenas prácticas de producción](/es/clickstack/managing/production).
...
<Tabs>
  <Tab title="Managed ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-managed-architecture.png" alt="Arquitectura de Managed ClickStack" size="md" />
  ...
  <Tab title="Open Source ClickStack">
    <Image img="/images/use-cases/observability/clickstack-simple-oss-architecture.png" alt="Arquitectura simple de OSS" size="md" />
