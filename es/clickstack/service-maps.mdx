...
<Image img="/images/clickstack/service-maps/service-map-overview.png" alt="Mapa de servicios que muestra nodos de servicio y el flujo de solicitudes entre ellos" size="lg" />
...
<Image img="/images/clickstack/service-maps/source-selector.png" alt="Selector de fuente resaltado en la barra de herramientas del mapa de servicios" size="lg" />
...
<Image img="/images/clickstack/service-maps/sampling.png" alt="Control deslizante de muestreo resaltado en la barra de herramientas del mapa de servicios" size="lg" />

**Selector de intervalo de fechas** — establezca la ventana temporal de los datos de trazas usados para crear el mapa.

<Image img="/images/clickstack/service-maps/date-selector.png" alt="Selector de intervalo de fechas resaltado en la barra de herramientas del mapa de servicios" size="lg" />
...
<Frame>
  <video src="/images/clickstack/service-maps/service-map-demo.mp4" autoPlay loop muted playsInline width="100%" />
</Frame>