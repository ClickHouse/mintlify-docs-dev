...
La UI de ClickStack requiere que el usuario defina un origen para cada uno de los tipos o pilares de datos de observabilidad:
...
<Image img="/images/use-cases/observability/hyperdx-25.png" alt="Configuración de origen en HyperDX" size="lg" />
...
Si se utiliza el [esquema predeterminado de OpenTelemetry (OTel)](/es/guides/use-cases/observability/build-your-own/integrating-opentelemetry#out-of-the-box-schema) incluido con ClickStack, estas columnas pueden inferirse automáticamente para cada uno de los orígenes. Si se [modifica el esquema](#clickhouse) o se usa un esquema personalizado, los usuarios deben especificar y actualizar estas asignaciones.
...
Los Atributos destacados y los Atributos de traza destacados se pueden configurar en los orígenes de datos de Log y Trace.
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-config.png" alt="Configuración de atributos destacados" size="md" />

Estos atributos se muestran en el panel lateral después de hacer clic en un log o span:

<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes.png" alt="Atributos destacados" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-search.png" alt="Búsqueda de atributos destacados" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-26.png" alt="Fuente correlacionada de HyperDX" size="md" />
