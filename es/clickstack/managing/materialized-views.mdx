...
<Image img="/images/materialized-view/materialized-view-diagram.png" size="md" alt="Diagrama de vista materializada" />
...
<Image img="/images/clickstack/materialized_views/generated_sql.png" size="lg" alt="SQL generado" />
...
* [Funciones de agregación y estados](/es/reference/functions/aggregate-functions)
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/edit_source.png" size="lg" alt="Editar fuentes" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/add_view.png" size="lg" alt="Editar fuentes" />
  </Step>
  ...
  <Step>
    ...
    * La columna agregada correspondiente en la vista materializada, por ejemplo `avg__Duration`
    ...
    <Image img="/images/clickstack/materialized_views/select_metrics.png" size="lg" alt="Seleccionar métricas" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_time_granularity.png" size="lg" alt="Seleccionar granularidad temporal" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_min_time.png" size="lg" alt="Seleccionar tiempo mínimo" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/save_source.png" size="lg" alt="Guardar fuente" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/materialized_views/accelerated_visual.png" size="lg" alt="Visualización acelerada" />
