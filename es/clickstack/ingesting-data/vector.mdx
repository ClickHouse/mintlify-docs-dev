  ...
  <Tab title="ClickStack gestionado">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Iniciar ClickStack para Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Logs de Nginx en ClickStack" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack de código abierto">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="UI Play de ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="inicio de sesión en ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="Crear origen de datos - vector" size="lg" />
  ...
  <Tab title="ClickStack gestionado">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Interfaz de HyperDX" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="Interfaz Play de ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Inicio de sesión de ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="UI de HyperDX" size="lg" />
      </Step>
    </Steps>
  </Tab>
</Tabs>