...
<Tabs>
  ...
  <Tab title="ClickStack de código abierto">
    ...
    La instancia de ClickHouse de destino se configura mediante las variables de entorno `CLICKHOUSE_ENDPOINT`, `CLICKHOUSE_USERNAME` y `CLICKHOUSE_PASSWORD`. El valor de `CLICKHOUSE_ENDPOINT` debe ser el endpoint HTTP completo de ClickHouse, incluido el protocolo y el puerto; por ejemplo, `http://localhost:8123`.
    ...
    **Estas variables de entorno pueden utilizarse con cualquiera de las distribuciones de Docker que incluyen el conector.**
    ...
    <Info>
      **Usuario de producción**
      ...
      Debes usar en producción un usuario con las [credenciales adecuadas](/es/clickstack/ingesting-data/collector#creating-an-ingestion-user).
    </Info>
...
<Tabs>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="API keys de ingesta" size="lg" />
...
<Image img="/images/use-cases/observability/observability-6.png" alt="Inserciones asíncronas" size="md" />
...
<Image img="/images/use-cases/observability/clickstack-with-gateways.png" alt="Escalado con gateways" size="lg" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="Añadir Kafka" size="lg" />
...
Para ver la comparación completa, cuándo conviene usar cada uno, las variables de entorno necesarias para habilitar el esquema de tipo `JSON` y la guía de migración, consulta [Map vs tipo JSON](/es/clickstack/ingesting-data/schema/map-vs-json).