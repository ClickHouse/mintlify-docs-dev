...
<Image img="/images/clickstack/trace-sampling-source-settings.png" alt="Campo Expresión de tasa de muestreo en la Configuración de la fuente de ClickStack" size="lg" />
