...
<Tabs>
  <Tab title="ClickStack gestionado">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="logs locales de HyperDX" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memoria a lo largo del tiempo" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Formato de número" size="lg" />

        En el siguiente menú, puedes seleccionar `Percentage` en la lista desplegable `Output format` antes de hacer clic en `Apply`.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Memoria % a lo largo del tiempo" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory con el tiempo" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Formato numérico" size="lg" />

    En el menú siguiente, puede seleccionar `Percentage` en el desplegable `Output format` antes de hacer clic en `Apply`.

    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Memoria (% del tiempo)" size="lg" />
  </Tab>
</Tabs>