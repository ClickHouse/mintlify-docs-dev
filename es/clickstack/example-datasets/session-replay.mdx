...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="Aplicación de demostración de session replay" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Búsqueda de session replay" />
...
* [Primeros pasos con ClickStack](/es/clickstack/getting-started/index) — despliegue ClickStack e ingeste sus primeros datos
