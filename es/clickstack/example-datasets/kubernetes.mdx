...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="Datos de Kubernetes en HyperDX" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="ClickHouse en Kubernetes" size="lg" />