...
<Tabs>
  <Tab title="ClickStack gestionado">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="Arquitectura gestionada" size="lg" />
  ...
  <Tab title="ClickStack de código abierto">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="Arquitectura" size="lg" />
