...
<Image img="/images/use-cases/observability/clickstack-migrating-agents.png" alt="Migración de agentes" size="lg" background />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="Claves de ingestión" size="lg" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/add-logstash-output.png" alt="Añadir salida de Logstash" size="md" />
    ...
    <Image img="/images/use-cases/observability/agent-output-settings.png" alt="Configuración del agente" size="md" />
