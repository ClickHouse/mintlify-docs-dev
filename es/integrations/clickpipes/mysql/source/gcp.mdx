...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Habilitación de PITR en Cloud SQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="Botón Edit en GCP MySQL" size="lg" border />

Luego, desplácese hasta la sección `Flags` y agregue las flags anteriores.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="Configuración de las flags de binlog en GCP" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="Lista de IP permitidas en GCP MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="Descarga del certificado de GCP MySQL" size="lg" border />

5. En la UI de ClickPipes, carga el certificado descargado al crear un nuevo ClickPipe para MySQL.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="Uso del certificado de GCP MySQL" size="lg" border />