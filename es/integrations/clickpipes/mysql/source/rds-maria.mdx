...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Habilitación de copias de seguridad automatizadas en RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Metadatos de fila de binlog en FULL" size="lg" border />

3. `binlog_row_image` en `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Imagen de fila de binlog en FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="¿Dónde encontrar el grupo de seguridad en RDS?" size="lg" border />
