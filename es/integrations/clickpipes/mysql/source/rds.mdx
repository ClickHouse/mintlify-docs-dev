...
Esta guía paso a paso le muestra cómo configurar Amazon RDS MySQL para replicar datos en ClickHouse Cloud mediante [ClickPipe para MySQL](/es/integrations/clickpipes/mysql). Para consultas frecuentes sobre MySQL CDC, consulte la [página de preguntas frecuentes de MySQL](/es/integrations/clickpipes/mysql/faq).

<div id="enable-binlog-retention-rds">
  ## Habilitar la retención del binlog
</div>

El binlog es un conjunto de archivos de registro que contienen información sobre las modificaciones de datos realizadas en una instancia de servidor MySQL, y estos archivos son necesarios para la replicación. Para configurar la retención del binlog en RDS MySQL, debe [habilitar el registro binario](#enable-binlog-logging) y [aumentar el intervalo de retención del binlog](#binlog-retention-interval).
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Habilitar copias de seguridad automatizadas en RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/rds_config.png" alt="Dónde encontrar el grupo de parámetros en RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/edit_button.png" alt="Botón Edit del grupo de parámetros" size="lg" border />

Los siguientes parámetros deben configurarse de la siguiente manera:

1. `binlog_format` en `ROW`.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="Binlog format en ROW" size="lg" border />

2. `binlog_row_metadata` en `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Metadatos de fila del binlog en FULL" size="lg" border />

3. `binlog_row_image` en `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Imagen de fila del binlog en FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/enable_gtid.png" alt="GTID habilitado" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="¿Dónde encontrar el grupo de seguridad en RDS MySQL?" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="Editar las reglas de entrada del grupo de seguridad anterior" size="lg" border />
...
Ahora que su instancia de Amazon RDS MySQL está configurada para la replicación de binlog y se conecta de forma segura a ClickHouse Cloud, puede [crear su primer ClickPipe para MySQL](/es/integrations/clickpipes/mysql#create-your-clickpipe). Si tiene preguntas frecuentes sobre MySQL CDC, consulte la [página de preguntas frecuentes de MySQL](/es/integrations/clickpipes/mysql/faq).