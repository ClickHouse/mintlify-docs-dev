...
Esta guía paso a paso le muestra cómo configurar Amazon Aurora MySQL para replicar datos en ClickHouse Cloud mediante [ClickPipe de MySQL](/es/integrations/clickpipes/mysql). Para ver las preguntas frecuentes sobre el CDC de MySQL, consulte la [página de preguntas frecuentes de MySQL](/es/integrations/clickpipes/mysql/faq).
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Activación de copias de seguridad automatizadas en Aurora" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/aurora_config.png" alt="Dónde encontrar el grupo de parámetros en Aurora" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/edit_button.png" alt="Editar grupo de parámetros" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="Formato de binlog en ROW" size="lg" border />

2. `binlog_row_metadata` en `FULL`.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Metadatos de fila de binlog" size="lg" border />

3. `binlog_row_image` en `FULL`.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Imagen de fila de binlog" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="¿Dónde encontrar el grupo de seguridad en Aurora MySQL?" size="lg" border />
...
Ahora que su instancia de Amazon Aurora MySQL está configurada para la replicación mediante binlog y se conecta de forma segura a ClickHouse Cloud, puede [crear su primer ClickPipe de MySQL](/es/integrations/clickpipes/mysql#create-your-clickpipe). Si tiene preguntas frecuentes sobre el CDC de MySQL, consulte la [página de preguntas frecuentes de MySQL](/es/integrations/clickpipes/mysql/faq).