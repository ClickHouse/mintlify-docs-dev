...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="Seleccionar MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="Completa los datos de conexión" size="lg" border />
...
5. Aquí puedes seleccionar la base de datos de destino para tu ClickPipe. Puedes elegir una base de datos existente o crear una nueva.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="Selecciona la base de datos de destino" size="lg" border />
