...
**Aumentar la escala incrementará proporcionalmente sus costes de cómputo de ClickPipes.** Si está escalando solo para las cargas iniciales, es importante reducir la escala una vez finalice el snapshot para evitar cargos inesperados. Para obtener más información sobre los precios, consulte [los precios de ClickPipes](/es/products/cloud/reference/billing/clickpipes).
