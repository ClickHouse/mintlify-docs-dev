...
2. En ClickHouse en particular, puede que hayas tenido que cambiar las claves de ORDER BY de las tablas de destino. Puedes hacer Resync para volver a cargar los datos en la nueva tabla con la clave de ordenación correcta.
