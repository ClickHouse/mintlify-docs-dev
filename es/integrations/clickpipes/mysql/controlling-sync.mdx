...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Botón Edit sync" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="tabla de sincronizaciones de CDC" size="md" />