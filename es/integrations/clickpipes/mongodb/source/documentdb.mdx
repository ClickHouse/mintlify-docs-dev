...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="Seleccionar grupo de parámetros" size="lg" border />

2. Busque `change_stream_log_retention_duration`, selecciónelo y cámbielo a `259200` (72 horas)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="Modificar grupo de parámetros" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="Aplicar grupo de parámetros" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="Estado del grupo de parámetros" size="lg" border />
