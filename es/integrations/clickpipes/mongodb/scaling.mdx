...
**Aumentar la escala incrementará proporcionalmente sus costos de cómputo de ClickPipes.** Si está escalando solo para las cargas iniciales, es importante reducir la escala después de que finalice la instantánea para evitar cargos inesperados. Para obtener más información sobre precios, consulte [precios de ClickPipes](/es/products/cloud/reference/billing/clickpipes).
