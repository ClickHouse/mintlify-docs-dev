...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="Crear ajustes de sincronización" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Botón para editar la sincronización" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="Editar ajustes de sincronización" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="tabla CDC Syncs" size="md" />