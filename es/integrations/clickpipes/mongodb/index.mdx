...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="Seleccionar MongoDB" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="Completa los datos de conexión" size="lg" border />
...
5. Aquí puedes seleccionar la base de datos de destino para tu ClickPipe. Puedes seleccionar una base de datos existente o crear una nueva.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="Selecciona la base de datos de destino" size="lg" border />
