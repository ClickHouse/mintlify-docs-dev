...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Servicio de ClickPipes" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="Seleccionar fuente de datos" size="lg" border />

4. Selecciona la opción `Reverse private endpoint`.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Seleccionar endpoint privado inverso" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Seleccionar endpoint privado inverso" size="lg" border />

6. Proporciona los parámetros obligatorios para el tipo de endpoint seleccionado.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Seleccionar endpoint privado inverso" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Seleccionar endpoint privado inverso" size="lg" border />
...
1. En la barra lateral, busque el botón `Settings` y haga clic en él.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="Configuración de ClickHouse Cloud" size="lg" border />

2. Haga clic en `Reverse private endpoints` en la sección `ClickPipe reverse private endpoints`.

   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="Configuración de ClickHouse Cloud" size="md" border />
