...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="Credenciales HMAC para GCS ClickPipes" size="lg" border />

Sigue [esta guía](/es/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret) para crear una cuenta de servicio con una clave HMAC.
