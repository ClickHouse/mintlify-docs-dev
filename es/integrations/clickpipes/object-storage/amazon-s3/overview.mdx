...
| **OVH Object Storage** <br /> *Compatible con S3*  | <img src="/images/integrations/logos/ovh.png" alt="logo de Cloud Storage" width="32" />         | La ingestión continua requiere [orden lexicográfico](#continuous-ingestion-lexicographical-order). El modo no ordenado no es compatible.                                                                                         |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="Credenciales de IAM para ClickPipes de S3" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="Autenticación IAM para S3 ClickPipes" size="lg" border />
