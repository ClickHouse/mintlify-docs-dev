---
sidebarTitle: 'Ingesta de datos desde Postgres a ClickHouse'
description: 'Conecta fácilmente tu Postgres a ClickHouse Cloud.'
slug: /integrations/clickpipes/postgres
title: 'Ingesta de datos desde Postgres a ClickHouse (con CDC)'
...
3. Selecciona la tarjeta `Postgres CDC`
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/postgres/postgres-tile.png" alt="Seleccionar Postgres" size="lg" border />
