...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Dónde encontrar los grupos de parámetros en Aurora" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/change_rds_logical_replication.png" alt="Cambiar rds.logical_replication" size="lg" border />

2. Aplique el nuevo grupo de parámetros a su clúster de Aurora PostgreSQL

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modificar Aurora PostgreSQL con el nuevo grupo de parámetros" size="lg" border />

3. Reinicie su clúster de Aurora para aplicar los cambios

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Reiniciar Aurora PostgreSQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="¿Dónde encontrar el grupo de seguridad en Aurora PostgreSQL?" size="lg" border />
