...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="Ajuste de wal_level en la consola de PlanetScale" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="Ajuste de max_slot_wal_keep_size en la consola de PlanetScale" size="md" border />
