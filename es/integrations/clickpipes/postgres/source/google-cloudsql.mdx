...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="Botón Edit en Cloud SQL Postgres" size="lg" border />

2. Ve a Flags y cambia `cloudsql.logical_decoding` a on. Este cambio requerirá reiniciar el servidor de Postgres.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="Cambiar cloudsql.logical_decoding a on" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="Sección Conexiones en Cloud SQL" size="lg" border />

2. Ve a la subsección Redes

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="Subsección Redes en Cloud SQL" size="lg" border />

3. Añade las [IP públicas de ClickPipes](/es/integrations/clickpipes/home#list-of-static-ips)

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="Añadir redes de ClickPipes al firewall" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="Redes de ClickPipes añadidas al firewall" size="lg" border />
