...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="¿Dónde encontrar los grupos de parámetros en RDS?" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modificar RDS Postgres con el nuevo grupo de parámetros" size="lg" border />

3. Reinicia tu instancia de RDS para aplicar los cambios

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Reiniciar RDS Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="¿Dónde encontrar el grupo de seguridad en RDS Postgres?" size="lg" border />
