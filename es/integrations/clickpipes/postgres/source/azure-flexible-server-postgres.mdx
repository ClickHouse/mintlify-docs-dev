...
<div id="azure-flexible-server-for-postgres-source-setup-guide">
  # Guía de configuración del origen de Azure Flexible Server for Postgres
</div>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Server Parameters en Azure Flexible Server for Postgres" size="lg" border />

2. Cambia `wal_level` a `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Cambiar wal_level a logical en Azure Flexible Server for Postgres" size="lg" border />

3. Este cambio requiere reiniciar el servidor. Reinícialo cuando se te solicite.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="Reiniciar el servidor después de cambiar wal_level" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Agrega las IP de ClickPipes al firewall en Azure Flexible Server for Postgres" size="lg" />
