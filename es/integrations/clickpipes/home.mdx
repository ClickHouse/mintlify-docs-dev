...
<Image img="/images/integrations/data-ingestion/clickpipes/clickpipes_stack.png" alt="stack de ClickPipes" size="lg" border />
...
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Apache Kafka](/es/integrations/clickpipes/kafka)              | <img src="/images/integrations/logos/kafka.svg" alt="logo de Apache Kafka" width="32" />                  | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde Apache Kafka hacia ClickHouse Cloud.                                                                                                                                           |
...
| Redpanda                                                    | <img src="/images/integrations/logos/logo_redpanda.png" alt="logo de Redpanda" width="32" />              | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde Redpanda hacia ClickHouse Cloud.                                                                                                                                               |
| AWS MSK                                                     | <img src="/images/integrations/logos/msk.svg" alt="logo de AWS MSK" width="32" />                         | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde AWS MSK hacia ClickHouse Cloud.                                                                                                                                                |
| Azure Event Hubs                                            | <img src="/images/integrations/logos/azure_event_hubs.svg" alt="logo de Azure Event Hubs" width="32" />   | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde Azure Event Hubs hacia ClickHouse Cloud. Consulte las [preguntas frecuentes de Azure Event Hubs](/es/integrations/clickpipes/kafka/faq#azure-eventhubs) para obtener orientación. |
| WarpStream                                                  | <img src="/images/integrations/logos/warpstream.svg" alt="logo de WarpStream" width="32" />               | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde WarpStream hacia ClickHouse Cloud.                                                                                                                                             |
...
| [Amazon Kinesis](/es/integrations/clickpipes/kinesis/overview) | <img src="/images/integrations/logos/amazon_kinesis_logo.svg" alt="logo de Amazon Kenesis" width="32" />  | Streaming                 | Estable              | Configure ClickPipes y comience a ingerir datos de streaming desde Amazon Kinesis hacia ClickHouse Cloud.                                                                                                                                         |
| [Postgres](/es/integrations/clickpipes/postgres)               | <img src="/images/integrations/logos/postgresql.svg" alt="logo de Postgres" width="32" />                 | DBMS                      | Estable              | Configure ClickPipes y comience a ingerir datos desde Postgres hacia ClickHouse Cloud.                                                                                                                                                            |
| [MySQL](/es/integrations/clickpipes/mysql)                     | <img src="/images/integrations/logos/mysql.svg" alt="logo de MySQL" width="32" />                         | DBMS                      | Beta pública         | Configure ClickPipes y comience a ingerir datos desde MySQL hacia ClickHouse Cloud.                                                                                                                                                               |
| [MongoDB](/es/integrations/clickpipes/mongodb)                 | <img src="/images/integrations/logos/mongodb.svg" alt="logo de MongoDB" width="32" />                     | DBMS                      | Vista previa privada | Configure ClickPipes y comience a ingerir datos desde MongoDB hacia ClickHouse Cloud.                                                                                                                                                             |
...
Los servicios de las regiones de Google Cloud que se enumeran en la tabla de Google Cloud a continuación usan esas IP de Google Cloud solo si el servicio se creó el 27 de mayo de 2026 o después. Los servicios de esas regiones creados antes del 27 de mayo de 2026 siguen usando las IP predeterminadas de región que se indican a continuación.
...
* **eu-central-1**: Para todas las regiones de la UE no enumeradas explícitamente, además de las regiones de Azure en la UE y los servicios de Google Cloud creados antes del 27 de mayo de 2026.
...
* **us-east-2**: Para todas las demás regiones que no coincidan con ninguna de las reglas anteriores, incluidas las regiones de Azure y los servicios de Google Cloud creados antes del 27 de mayo de 2026.
...
| **us-east-1** - Norte de Virginia                                   | `54.82.38.199`, `3.90.133.29`, `52.5.177.8`, `3.227.227.145`, `3.216.6.184`, `54.84.202.92`, `3.131.130.196`, `3.23.172.68`, `3.20.208.150` |
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_custom_role.png" alt="Asignar un rol personalizado" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="Configuración avanzada de ClickPipes" size="lg" border />
...
* **¿Usar ClickPipes implica un costo adicional?**
  ...
  ClickPipes se factura en dos dimensiones: Ingested Data y Compute. Los detalles completos de los precios están disponibles en [esta página](/es/products/cloud/reference/billing/clickpipes). Ejecutar ClickPipes también puede generar un costo indirecto de cómputo y almacenamiento en el servicio de ClickHouse Cloud de destino, como ocurre con cualquier carga de trabajo de ingesta.
