...
<div id="creating-your-first-kafka-clickpipe">
  # Crear tu primer Kafka ClickPipe
</div>
...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Seleccionar importaciones" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Selecciona el tipo de fuente de datos" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Completa los datos de conexión" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="Configuración del túnel SSH" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Selecciona tu topic" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Configurar tabla, esquema y configuración" size="md" />

    También puede personalizar la configuración avanzada con los controles proporcionados

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Configurar controles avanzados" size="md" />
  </Step>
  ...
  <Step>
    ...
    * `Only destination table`: solo con permisos de `INSERT` en la tabla de destino.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permisos" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Ver descripción general" size="md" />
  </Step>
</Steps>