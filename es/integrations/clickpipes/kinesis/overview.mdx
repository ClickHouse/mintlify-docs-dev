...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Seleccionar tipo de fuente de datos" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.png" alt="Completar los detalles de conexión" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.png" alt="Definir el formato de los datos y el topic" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Definir la tabla, el esquema y la configuración" size="lg" border />

También puedes personalizar la configuración avanzada con los controles proporcionados

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="Definir controles avanzados" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Ver resumen" size="lg" border />
