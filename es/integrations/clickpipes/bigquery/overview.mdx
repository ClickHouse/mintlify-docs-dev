...
ClickPipes se autentica en tu proyecto de Google Cloud mediante una [clave de cuenta de servicio](https://docs.cloud.google.com/iam/docs/keys-create-delete). Recomendamos crear una cuenta de servicio dedicada con el mínimo de [permisos](#permissions) necesarios para que ClickPipes pueda exportar datos desde BigQuery, cargarlos en el bucket de GCS de staging y leerlos en ClickHouse.

<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Creación de una clave de cuenta de servicio con permisos de BigQuery y Cloud Storage" size="lg" border />
