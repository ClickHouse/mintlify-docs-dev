---
description: 'Descripción general de las bibliotecas cliente de terceros disponibles para
  distintos lenguajes de programación'
sidebarTitle: 'Bibliotecas cliente'
slug: /interfaces/third-party/client-libraries
title: 'Bibliotecas cliente de terceros'
doc_type: 'reference'
---

<Note>
  ClickHouse Inc **no** mantiene las bibliotecas que se enumeran a continuación ni ha realizado pruebas exhaustivas para garantizar su calidad.
</Note>
...
* [client de SeasClick para C++](https://github.com/SeasX/SeasClick)
...
* [extensión de PHP para ClickHouse de kolya7k](https://github.com//kolya7k/clickhouse-php)
...
* [Driver de ClickHouse para el framework userver](https://userver.tech/dd/ddb/clickhouse_driver.html)
