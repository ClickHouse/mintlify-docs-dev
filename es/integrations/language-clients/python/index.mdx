...
description: 'La suite de proyectos de ClickHouse Connect para conectar Python con ClickHouse'
title: 'Integración de Python con ClickHouse Connect'
...
* La interfaz principal es el objeto `Client` del paquete `clickhouse_connect.driver`. Ese paquete principal también incluye varias clases auxiliares y funciones de utilidad para comunicarse con el servidor ClickHouse, así como implementaciones de &quot;context&quot; para la gestión avanzada de consultas de inserción y selección.
