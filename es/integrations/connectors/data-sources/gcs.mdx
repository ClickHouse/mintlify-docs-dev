...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="Bucket de la réplica 1 en Google Cloud Storage con la estructura de carpetas y las particiones de datos" />

<div id="bucket-for-replica-two">
  #### Bucket para la réplica dos
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="Bucket de la segunda réplica en Google Cloud Storage que muestra la estructura de carpetas con particiones de datos" />