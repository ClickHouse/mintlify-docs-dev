...
<Note>
  Para ClickHouse Cloud, también puede usar [ClickPipe para MySQL](/es/integrations/clickpipes/mysql) (actualmente en beta pública) para mover fácilmente datos desde sus tablas de MySQL a ClickHouse.
</Note>
