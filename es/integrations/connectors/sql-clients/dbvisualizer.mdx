...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="Interfaz del gestor de controladores de DbVisualizer que muestra la configuración del controlador JDBC de ClickHouse" />
