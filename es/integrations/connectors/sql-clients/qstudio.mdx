...
<Image img="/images/integrations/sql-clients/qstudio-add-connection.png" size="lg" border alt="Pantalla de configuración de conexión a base de datos de QStudio que muestra la configuración de conexión de ClickHouse" />
...
<Image img="/images/integrations/sql-clients/qstudio-running-query.png" size="lg" border alt="Interfaz de QStudio que muestra la ejecución de una consulta SQL de ejemplo en la base de datos ClickHouse" />
