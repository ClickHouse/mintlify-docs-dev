...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="lg" border alt="Vista de la lista de tablas y del esquema que muestra las tablas de la base de datos en la barra lateral izquierda" />

Las tablas de la lista también se pueden expandir para ver las columnas y los tipos de datos

<Image img="/images/cloud/sqlconsole/view-columns.png" size="lg" border alt="Vista de una tabla expandida que muestra los nombres de las columnas y los tipos de datos" />
...
<Image img="/images/cloud/sqlconsole/abc.png" size="lg" border alt="Vista de tabla que muestra datos que se pueden seleccionar y copiar" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="lg" border alt="Cuadro de diálogo de Cell Inspector que muestra el contenido de una celda seleccionada" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="lg" border alt="Cuadro de diálogo de ordenación que muestra la configuración para ordenar una columna en orden descendente" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="lg" border alt="Diálogo de filtro que muestra la configuración para filtrar la columna de radio con el valor GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="lg" border alt="Diálogo que muestra cómo añadir un filtro adicional para un rango mayor que 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="lg" border alt="Interfaz que muestra el filtrado y la ordenación aplicados simultáneamente" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="lg" border alt="Interfaz que muestra el botón Create Query, que genera SQL a partir de filtros y ordenaciones" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="lg" border alt="Interfaz que muestra cómo crear una nueva consulta con el botón + o el botón New Query" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="lg" border alt="Interfaz que muestra cómo ejecutar una parte seleccionada de una consulta SQL" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="lg" border alt="Opción Run at cursor en el menú ampliado de opciones de ejecución" />

* Seleccionando &#39;Run at cursor&#39; en el menú contextual del SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="lg" border alt="Opción Run at cursor en el menú contextual del SQL Editor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="lg" border alt="Botón 'Cancel' que aparece durante la ejecución de una consulta" />
...
<Image img="/images/cloud/sqlconsole/give-a-query-a-name.png" size="lg" border alt="Interfaz que muestra cómo cambiar el nombre de una consulta desde Untitled Query" />

También puedes usar el botón Guardar o el atajo de teclado `cmd / ctrl + s` para guardar una consulta.

<Image img="/images/cloud/sqlconsole/save-the-query.png" size="lg" border alt="Botón Guardar en la barra de herramientas del editor de consultas" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="lg" border alt="Buscar datos de Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="lg" border alt="Coincidencia en el cuerpo" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="lg" border alt="Opciones de paginación" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="lg" border alt="Navegación de paginación" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="lg" border alt="Descargar como CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="lg" border alt="Resultados tabulares de la consulta" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="lg" border alt="Cambiar de consulta a gráfico" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="lg" border alt="Total de viajes por semana" />
...
<Image img="/images/cloud/sqlconsole/bar-chart.png" size="lg" border alt="Gráfico de barras" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="lg" border alt="Cambiar de gráfico de Bar a Area" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="lg" border alt="Actualizar nombre de la consulta" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="lg" border alt="Actualizar subtítulo, etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="lg" border alt="Ajustar la escala del eje" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="lg" border alt="Botón Share en la barra de herramientas de la consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="lg" border alt="Cuadro de diálogo para editar el acceso a una consulta compartida" />

<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="lg" border alt="Interfaz para añadir un equipo a una consulta compartida" />

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="lg" border alt="Interfaz para editar el acceso de un miembro a una consulta compartida" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="lg" border alt="Sección Compartidas conmigo en la lista de consultas" />