...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="Histograma que muestra la distribución de las distancias de los viajes en 10 intervalos del conjunto de datos short-trips" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="Histograma que muestra la distribución de las distancias de viaje con 50 intervalos y cuadrícula, titulado 'Distancia de viaje en trayectos < 6.3'" border />