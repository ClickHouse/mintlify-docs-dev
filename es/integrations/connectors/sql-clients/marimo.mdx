...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="Conectar a ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="Agregar una nueva base de datos" />

Se te pedirá que completes los datos de la base de datos.

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="Completa los datos de la base de datos" />

A continuación, tendrás una celda que puedes ejecutar para establecer una conexión.

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="Ejecuta la celda para conectarte a ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="Elegir motor SQL" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="Resultados en un DataFrame" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="Combinación de menú desplegable, tabla y gráfico" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="Ejecutar vista de aplicación" />