...
<Image img="/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="Pestaña Data Sources de DataGrip con el icono + resaltado" />
...
<Image img="/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="DataGrip seleccionando ClickHouse de la lista de fuentes de datos" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="Pestaña Drivers de DataGrip que muestra la instalación del driver de ClickHouse" />
...
<Image img="/images/integrations/sql-clients/datagrip-7.png" border alt="Formulario de datos de conexión de DataGrip con la configuración de ClickHouse" />
