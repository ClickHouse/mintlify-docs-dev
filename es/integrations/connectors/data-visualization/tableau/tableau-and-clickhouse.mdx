...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="Pantalla de conexión de Tableau que muestra el menú de selección de conectores con la opción ClickHouse by ClickHouse resaltada" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="Cuadro de diálogo de instalación del conector de Tableau que muestra los detalles del conector ClickHouse JDBC y el botón de instalación" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="Cuadro de diálogo de conexión de ClickHouse en Tableau que muestra campos para server, port, database, username y password" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="Nuevo libro de trabajo de Tableau que muestra la pantalla de conexión inicial con opciones de selección de base de datos" border />

<br />

8. Selecciona **TPCD** en el desplegable **Schema** y deberías ver la lista de tablas en **TPCD**:

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="Selección de schema en Tableau que muestra las tablas de la base de datos TPCD, incluidas CUSTOMER, LINEITEM, NATION, ORDERS y otras" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="Libro de trabajo de Tableau con la tabla CUSTOMER arrastrada al lienzo, mostrando encabezados de columnas pero sin datos" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="Editor de relaciones de Tableau que muestra la conexión entre las tablas CUSTOMER y ORDERS mediante el campo Custkey" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="Hoja de trabajo de Tableau que muestra las dimensiones y medidas de las tablas de ClickHouse disponibles para el análisis" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="Gráfico de líneas de Tableau que muestra la cantidad pedida por año a partir de datos de ClickHouse" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="Vista de tabla cruzada de Tableau con trimestres como columnas y modos de envío como filas" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="Tabla cruzada de Tableau que muestra la suma del precio total por trimestre y modo de envío" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="Tabla cruzada de Tableau que muestra el precio medio de los pedidos por trimestre y modo de envío con formato de moneda" border />
