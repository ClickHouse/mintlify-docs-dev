...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="Interfaz de Tableau Online que muestra el botón 'New' para crear un origen de datos publicado" border />

<br />

Selecciona &quot;MySQL&quot; en la lista de conectores disponibles.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="Pantalla de selección de conectores de Tableau Online con la opción MySQL resaltada" border />

<br />

Especifica los datos de conexión recopilados durante la configuración de ClickHouse.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="Pantalla de configuración de la conexión MySQL de Tableau Online con campos para servidor, puerto, base de datos y credenciales" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="Página de origen de datos de Tableau Online que muestra las tablas de la base de datos a la izquierda y el lienzo a la derecha con funcionalidad de arrastrar y soltar" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="Interfaz de Tableau Desktop que muestra el menú Conectar con la opción MySQL resaltada" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="Cuadro de diálogo de conexión MySQL de Tableau Desktop con la opción SSL habilitada y campos para servidor, nombre de usuario, contraseña y certificado" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Tableau Desktop mostrando el menú Servidor con la opción Publicar origen de datos resaltada" border />

<br />

IMPORTANTE: debe seleccionar &quot;Contraseña incrustada&quot; en las opciones de &quot;Autenticación&quot;.

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="Cuadro de diálogo de publicación de Tableau Desktop que muestra las opciones de Autenticación con Contraseña incrustada seleccionada" border />

<br />

Además, elija &quot;Actualizar libro de trabajo para usar el origen de datos publicado&quot;.

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="Cuadro de diálogo de publicación de Tableau Desktop con la opción 'Actualizar libro de trabajo para usar el origen de datos publicado' marcada" border />
