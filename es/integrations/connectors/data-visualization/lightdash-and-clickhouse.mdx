...
description: 'Lightdash es una moderna herramienta de BI de código abierto basada en dbt que permite a los equipos explorar y visualizar datos de ClickHouse mediante una capa semántica. Aprende a conectar Lightdash a ClickHouse para obtener una analítica rápida y gobernada con tecnología de dbt.'
title: 'Conectar Lightdash a ClickHouse'
doc_type: 'guide'
integration:
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Ejemplo de dashboard de Lightdash" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="Ejemplo de configuración de profiles.yml para un proyecto lightdash-clickhouse" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="Ejemplo de métricas definidas en el archivo .yml" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="Vista de Explore de Lightdash que muestra dimensiones, filtros, gráfico, resultados y SQL" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Creación y organización de gráficos dentro de un dashboard de Lightdash" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Interfaz de Ask AI de Lightdash que muestra una consulta en lenguaje natural impulsada por métricas de dbt" border />
