...
* Selecciona **Data** en la barra lateral y, a continuación, la pestaña **Data Connection**
  ...
  ​
* Haz clic en el botón **New Data Connection** en la esquina superior derecha de la pantalla.

<Image size="sm" img="/images/integrations/data-visualization/astrato_1_dataconnection.png" alt="Conexión de datos de Astrato" border />

* Selecciona **ClickHouse**.

<Image size="sm" img="/images/integrations/data-visualization/astrato_2a_clickhouse_connection.png" alt="Conexión de datos de ClickHouse de Astrato" border />

* Completa los campos obligatorios en el cuadro de diálogo de conexión

<Image size="sm" img="/images/integrations/data-visualization/astrato_2b_clickhouse_connection.png" alt="Campos obligatorios para conectarse a ClickHouse en Astrato" border />
...
* Configura el **user access** de la conexión de datos y haz clic en **connect.**

<Image size="md" img="/images/integrations/data-visualization/astrato_3_user_access.png" alt="Acceso de usuario para conectarse a ClickHouse en Astrato" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4a_clickhouse_data_view.png" alt="Astrato se conecta a ClickHouse Acceso de usuario" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4b_clickhouse_data_view_joins.png" alt="Astrato se conecta a ClickHouse Acceso de usuario" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4c_clickhouse_completed_data_view.png" alt="Astrato se conecta a ClickHouse Acceso de usuario" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5a_clickhouse_build_chart.png" alt="Astrato conectado a ClickHouse: Acceso de usuario" border />

<div id="view-generated-sql-supporting-each-visualization">
  ### Ver el SQL generado de cada visualización
</div>
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5b_clickhouse_view_sql.png" alt="Astrato conectado a ClickHouse: acceso de usuario" border />

<div id="example-completed-dashboard">
  ### Ejemplo de dashboard completo
</div>

Ahora estás muy cerca de tener un dashboard o una data app completos y atractivos. Para ver más de lo que hemos creado, visita la galería de demostraciones de nuestro sitio web. https://astrato.io/gallery

<Image size="lg" img="/images/integrations/data-visualization/astrato_5c_clickhouse_complete_dashboard.png" alt="Acceso de usuario de Astrato conectado a ClickHouse" border />