...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Configuración de la conexión de ClickHouse en Dot (modo claro)" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="Conectando ClickHouse" size="sm" />
