...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="Interfaz de dashboard de Databrain que muestra visualizaciones de datos de ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Menú Data Sources de Databrain" border />

3. Haz clic en **Add a Data Source** o **Connect Data Source**.

4. Selecciona **ClickHouse** de la lista de conectores disponibles.

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="Selección de conectores de Databrain que muestra la opción ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Formulario de conexión de ClickHouse en Databrain con campos de configuración" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="Explorador de datos de Databrain que muestra tablas de ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="Dashboard de Databrain con múltiples visualizaciones de ClickHouse" border />
