...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="tarjeta de integración de ClickHouse" border />

2. Introduce los datos de conexión de tu instancia de ClickHouse:

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="cuadro de diálogo de detalles de ClickHouse" border />
...
1. Empieza conectándote a la integración de ClickHouse, a la derecha de tu notebook.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.png" alt="Cuadro de diálogo de detalles de ClickHouse" border />
