...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="Interfaz de exploración de datos de Hashboard que muestra un constructor de consultas interactivo y una visualización" border />
