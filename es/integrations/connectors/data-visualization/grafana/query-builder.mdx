...
| Aggregates   | Una lista de [funciones de agregación](/es/reference/functions/aggregate-functions). Permite definir valores personalizados para la función y la columna. Solo es visible en el modo Aggregate.                                |
...
| Limit        | Añade una sentencia [LIMIT](/es/reference/statements/select/limit) al final de la consulta. Si se establece en `0`, se omitirá. Algunas visualizaciones pueden requerir que se establezca en `0` para mostrar todos los datos. |
| Filters      | Una lista de filtros que se aplicarán en la cláusula `WHERE`.                                                                                                                                                               |

<Image size="md" img="/images/integrations/data-visualization/grafana/demo_table_query.png" alt="Ejemplo de consulta de tabla con agregación" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="Ejemplo de consulta de logs de OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="Ejemplo de campos adicionales en la consulta de logs" border />
...
| Aggregates   | Una lista de [funciones de agregación](/es/reference/functions/aggregate-functions). Permite valores personalizados para la función y la columna. Solo es visible en Aggregate mode.                                                                |
| Group By     | Una lista de expresiones [GROUP BY](/es/reference/statements/select/group-by). Solo es visible en Aggregate mode.                                                                                                                                   |
| Order By     | Una lista de expresiones [ORDER BY](/es/reference/statements/select/order-by).                                                                                                                                                                      |
| Limit        | Añade una sentencia [LIMIT](/es/reference/statements/select/limit) al final de la consulta. Si se establece en `0`, se omitirá; esto se recomienda para algunos conjuntos de datos de series temporales a fin de mostrar la visualización completa. |
| Filters      | Una lista de filtros que se aplicarán en la cláusula `WHERE`.                                                                                                                                                                                    |

<Image size="md" img="/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="Consulta de series temporales de ejemplo" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="Consulta de trazas OTel de ejemplo" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="Ejemplo de consulta SQL sin formato" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="Enlaces de trazas en una tabla" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  Ejemplo de enlaces de trazas en logs

  <Image size="md" img="/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="Enlaces de trazas en logs" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/images/integrations/data-visualization/grafana/demo_data_links.png" alt="Ejemplo de enlaces de datos" border />
</div>
