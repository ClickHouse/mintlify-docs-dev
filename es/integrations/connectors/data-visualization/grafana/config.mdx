...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="Ejemplo de configuración nativa segura" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="Opciones adicionales de configuración HTTP" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="Ejemplo de ajustes adicionales" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="Configuración de logs" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="Configuración de trazas" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Ejemplo de configuración de una tabla de alias" border />

Ahora Grafana verá los resultados de la tabla de alias en lugar de los resultados de `DESC example_table`:

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Ejemplo de selección de una tabla de alias" border />
