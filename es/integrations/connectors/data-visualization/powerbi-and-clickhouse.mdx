...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_install.png" alt="Asistente de instalación del ODBC Driver de ClickHouse con las opciones de instalación" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.png" alt="Búsqueda de Windows que muestra la opción ODBC Data Sources (64-bit)" border />

<br />

Compruebe que el controlador de ClickHouse aparezca en la lista.

<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_verify.png" alt="Administrador de orígenes de datos ODBC que muestra los controladores de ClickHouse en la pestaña Drivers" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="Pantalla de inicio de Power BI Desktop con el botón «Get Data»" border />

<br />

Busque «ClickHouse».

<Image size="md" img="/images/integrations/data-visualization/powerbi_search_clickhouse.png" alt="Cuadro de diálogo «Get Data» de Power BI con «ClickHouse» buscado en la barra de búsqueda" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_db.png" alt="Cuadro de diálogo de conexión de ClickHouse que muestra los campos de host, puerto, base de datos y modo de conectividad" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_user.png" alt="Cuadro de diálogo de credenciales de conexión de ClickHouse para nombre de usuario y contraseña" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Vista Navigator de Power BI con las tablas de la base de datos de ClickHouse y datos de muestra" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.png" alt="Búsqueda de Windows que muestra la opción Orígenes de datos ODBC (64 bits)" border />

<br />

Aquí debes agregar un nuevo DSN de usuario. Haz clic en el botón «Add» de la izquierda.

<Image size="md" img="/images/integrations/data-visualization/powerbi_add_dsn.png" alt="Administrador de orígenes de datos ODBC con el botón Add resaltado para crear un nuevo DSN" border />

<br />

Elige la versión Unicode del controlador ODBC.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_unicode.png" alt="Cuadro de diálogo Crear nuevo origen de datos que muestra la selección de ClickHouse Unicode Driver" border />

<br />

Completa los datos de conexión.

<Image size="sm" img="/images/integrations/data-visualization/powerbi_connection_details.png" alt="Cuadro de diálogo de configuración de ClickHouse ODBC Driver con parámetros de conexión" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="Pantalla de inicio de Power BI Desktop que muestra el botón Get Data" border />

<br />

Seleccione &quot;Other&quot; -&gt; &quot;ODBC&quot;.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_odbc.png" alt="Cuadro de diálogo Get Data de Power BI con la opción ODBC seleccionada en la categoría Other" border />

<br />

Seleccione en la lista la fuente de datos que creó anteriormente.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_dsn.png" alt="Cuadro de diálogo de selección del controlador ODBC que muestra el DSN de ClickHouse configurado" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_dsn_credentials.png" alt="Cuadro de diálogo de credenciales para la conexión DSN de ODBC" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Vista Navigator de Power BI que muestra tablas de bases de datos de ClickHouse y datos de ejemplo" border />
...
**Enfoque recomendado para grandes conjuntos de datos:** En lugar de consultar directamente las tablas sin procesar, cree `vistas materializadas` dedicadas en ClickHouse para cada visualización del dashboard. Esto le proporciona:
...
<Warning>
  Si sus dashboards son lentos, consulte el [`query_log`](/es/reference/system-tables/query_log) de ClickHouse para ver qué consultas SQL está ejecutando realmente Power BI. Entre los problemas habituales se incluyen las subconsultas anidadas, el escaneo de tablas completas o los joins ineficientes. Una vez que identifique el problema, cree [vistas materializadas](/es/concepts/features/materialized-views) que resuelvan esos problemas específicos.
</Warning>
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_16.png" alt="Power Query Editor mostrando la transformación del tipo de datos de la columna UInt64" border />
