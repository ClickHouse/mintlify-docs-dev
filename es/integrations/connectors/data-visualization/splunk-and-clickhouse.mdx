...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="Dashboard de Splunk que muestra visualizaciones de datos de taxis de Nueva York" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Página de configuración de Splunk DB Connect que muestra la configuración de Java Home" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="Página de drivers de Splunk DB Connect que muestra el driver de ClickHouse instalado correctamente" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Botón de nueva conexión de Splunk DB Connect" />

<br />

Agregue los datos del host de ClickHouse y asegúrese de que &quot;Enable SSL&quot; esté marcado:

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="Página de configuración de la conexión de Splunk para ClickHouse" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="SQL Explorer de Splunk seleccionando la conexión a ClickHouse" />

Ejecuta una consulta SQL en la tabla `trips` que devuelva el recuento de todos los registros de la tabla:

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="Ejecución de una consulta SQL en Splunk que muestra el recuento de registros en la tabla trips" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="Visualización del gráfico de columnas de Splunk que muestra los 10 principales barrios de recogida" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="Gráfico de barras de Splunk que muestra la tarifa media por número de pasajeros" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="Dashboard final de Splunk con varias visualizaciones de datos de taxis de NYC" />
