...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Configuración de conexiones de Notebook de Glue" force="true" />
  ...
  <Tab title="Instalación manual">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Opciones de ruta de JAR del Notebook de Glue" force="true" />
  </Tab>
</Tabs>
...
Para obtener más información, consulte nuestra [documentación de Spark](/es/integrations/connectors/data-ingestion/apache-spark).