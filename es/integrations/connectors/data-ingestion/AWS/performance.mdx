...
<Image img="/images/integrations/data-ingestion/s3/insert_mechanics.png" size="lg" border alt="Mecánica del tamaño del bloque de inserción en ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/pull.png" size="lg" border alt="Extracción de datos desde fuentes externas en ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/merges.png" size="lg" border alt="Fusiones en segundo plano en ClickHouse" />
...
Ten en cuenta que [aumentar](https://clickhouse.com/blog/supercharge-your-clickhouse-data-loads-part1#hardware-size) el número de núcleos de CPU y el tamaño de la RAM aumenta el throughput de las fusiones en segundo plano.
...
<Image img="/images/integrations/data-ingestion/s3/resource_usage.png" size="lg" border alt="Uso de recursos del paralelismo de inserción" />
...
<Image img="/images/integrations/data-ingestion/s3/insert_threads.png" size="lg" border alt="Hilos de inserción en paralelo en ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/hardware_size.png" size="lg" border alt="Impacto del tamaño del hardware en el rendimiento de ClickHouse" />
...
ClickHouse puede leer archivos almacenados en buckets de S3 en los [formatos compatibles](/es/reference/formats#formats-overview) mediante la función `s3` y el motor `S3`. Si se leen archivos sin procesar, algunos de estos formatos ofrecen ventajas claras:
...
<Image img="/images/integrations/data-ingestion/s3/s3Cluster.png" size="lg" border alt="función s3Cluster en ClickHouse" />
