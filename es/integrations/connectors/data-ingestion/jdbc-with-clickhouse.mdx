...
La forma más sencilla de usar ClickHouse JDBC Bridge es instalarlo y ejecutarlo en el mismo host en el que también se ejecuta ClickHouse:<Image img="/images/integrations/data-ingestion/dbms/jdbc-02.png" size="lg" alt="Diagrama de implementación local de ClickHouse JDBC Bridge" background="white" />
...
<Image img="/images/integrations/data-ingestion/dbms/jdbc-03.png" size="lg" alt="Diagrama de implementación externa de ClickHouse JDBC Bridge" background="white" />
...
2. En cada host de ClickHouse, añada el siguiente bloque de configuración a la <a href="/es/concepts/features/configuration/server-config/configuration-files#configuration_files" target="_blank">configuración del servidor de ClickHouse</a> (según el formato de configuración que haya elegido, use la versión XML o YAML):
