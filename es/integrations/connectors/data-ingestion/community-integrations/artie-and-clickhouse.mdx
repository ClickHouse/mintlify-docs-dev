...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Página de registro de Artie" />
  </Step>

  <Step>
    ## Encuentre sus credenciales de ClickHouse
  ...
  <Step>
    ## Cree un nuevo pipeline en Artie
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Interfaz Edit Pipeline de Artie" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="Portal de análisis" />

Monitores específicos para pipelines y tablas

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="Monitorización integrada" />

Notificaciones diarias de cambios de esquema

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="Notificación de esquema" />