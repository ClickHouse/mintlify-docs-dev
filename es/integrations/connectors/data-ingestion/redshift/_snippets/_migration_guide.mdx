...
<Note>
  En este tutorial usamos Redshift como fuente de datos. Sin embargo, los enfoques de migración que se presentan aquí no son exclusivos de Redshift, y pueden seguirse pasos similares para cualquier fuente de datos compatible.
</Note>
...
En un escenario Push, la idea es aprovechar una herramienta o servicio de terceros (ya sea código personalizado o un [ETL/ELT](https://en.wikipedia.org/wiki/Extract,_transform,_load#ETL_vs._ELT)) para enviar los datos a su instancia de ClickHouse. Por ejemplo, puede usar software como [Airbyte](https://www.airbyte.com/) para mover datos entre su instancia de Redshift (como origen) y ClickHouse como destino ([consulte nuestra guía de integración de Airbyte](/es/integrations/connectors/data-ingestion/etl-tools/airbyte-and-clickhouse))
...
* Permite escenarios de transformación de datos (por ejemplo, consulta nuestra [guía de integración para dbt](/es/integrations/connectors/data-ingestion/etl-tools/dbt)).
...
<Steps>
  ...
  <Step>
    #### Configura tu origen de datos de Redshift
  ...
  <Step>
    #### Consulta tu instancia de Redshift desde ClickHouse
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="PIVOT desde Redshift con S3" />
...
<Steps>
  <Step>
    #### Exporta datos a un bucket de S3 con UNLOAD
