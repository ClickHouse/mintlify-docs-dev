...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_1.png" size="sm" border alt="Interfaz de implementación del servicio de ClickHouse Cloud que muestra la selección de la región de AWS" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_2.png" size="sm" border alt="Configuración de conexión de ClickHouse Cloud que muestra la configuración de acceso por IP" />

A continuación, deberá guardar su nombre de usuario y contraseña para usarlos más adelante.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_3.png" size="sm" border alt="Pantalla de credenciales de ClickHouse Cloud que muestra el nombre de usuario y la contraseña" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_4.png" size="lg" border alt="Panel de la instancia en ejecución de ClickHouse Cloud con opciones de conexión" />

Haga clic en &quot;Connect to consola SQL&quot; para crear la base de datos y la tabla para la integración con EMQX Cloud.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_5.png" size="lg" border alt="Interfaz de consola SQL de ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_6.png" size="lg" border alt="Ejecución de una consulta SQL para crear una base de datos y una tabla en ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_sign_up.png" size="lg" border alt="Página de registro de EMQX Cloud con formulario de registro" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_create_1.png" size="lg" border alt="EMQX Cloud Create Deployment Step 1 mostrando las opciones de Implementación" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_overview.png" size="lg" border alt="Dashboard de información general de EMQX Cloud que muestra las métricas del broker" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_auth.png" size="lg" border alt="Interfaz de configuración de autenticación de EMQX Cloud para añadir credenciales" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_nat_gateway.png" size="lg" border alt="Panel de configuración de NAT Gateway de EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_clickhouse.png" size="lg" border alt="Detalles del conector de Data Integration de ClickHouse en EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_resource.png" size="lg" border alt="Formulario de configuración del recurso de EMQX Cloud ClickHouse con detalles de conexión" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.png" size="md" border alt="Paso 1 de creación de la regla de integración de datos de EMQX Cloud, que muestra una consulta SQL" />

Puede usar la prueba de SQL para comprobar los resultados.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.png" size="md" border alt="Paso 2 de creación de la regla de integración de datos de EMQX Cloud, que muestra los resultados de la prueba" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_action.png" size="md" border alt="Configuración de la acción de regla de Data Integration de EMQX Cloud con plantilla SQL" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_details.png" size="md" border alt="Detalles de la regla de Data Integration de EMQX Cloud que muestran un resumen de la configuración" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-overview.png" size="lg" border alt="Vista general de MQTTX que muestra la interfaz del cliente" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-new.png" size="lg" border alt="Formulario de configuración de New Connection de MQTTX con los detalles de conexión" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-publish.png" size="lg" border alt="Interfaz de MQTTX Publish MQTT Messages que muestra la composición del mensaje" />
...
<Image img="/images/integrations/data-ingestion/emqx/rule_monitor.png" size="lg" border alt="Panel de monitorización de reglas de EMQX Cloud que muestra métricas de procesamiento de mensajes" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_result.png" size="lg" border alt="Resultados de una consulta de ClickHouse que muestran datos de IoT almacenados" />
