...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="Consola de Dataflow que muestra un trabajo de Pub/Sub a ClickHouse en ejecución" />
