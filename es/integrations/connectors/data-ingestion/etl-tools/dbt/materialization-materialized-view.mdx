...
keywords: ['clickhouse', 'dbt', 'materialized_view', 'refreshable', 'vistas materializadas', 'catchup']
title: 'Materialización: materialized_view'
doc_type: 'guide'
---
