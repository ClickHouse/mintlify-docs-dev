...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_01.png" size="lg" border alt="Ver los logs de ClickHouse en formato tabular" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_02.png" size="lg" border alt="Ver los logs de ClickHouse analizados en formato de tabla" />
