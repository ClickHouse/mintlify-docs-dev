...
Prepare la tabla de destino. En el ejemplo siguiente usamos el esquema reducido de GitHub por brevedad. Tenga en cuenta que, aunque usamos un motor de tabla MergeTree, este ejemplo puede adaptarse fácilmente a cualquier miembro de la [familia MergeTree](/es/reference/engines/table-engines/mergetree-family).
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_02.png" size="lg" alt="Diagrama del motor de tabla Kafka con inserciones" />
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_03.png" size="lg" alt="Diagrama del motor de tabla Kafka con vistas materializadas" />
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_04.png" size="lg" alt="Diagrama del motor de tabla Kafka con clústeres de ClickHouse" />
