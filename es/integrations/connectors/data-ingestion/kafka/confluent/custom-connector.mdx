...
keywords: ['integración de ClickHouse con Confluent', 'conector Kafka de ClickHouse', 'sink de ClickHouse para Kafka Connect', 'Confluent Platform ClickHouse', 'conector personalizado de Confluent']
doc_type: 'guide'
---
...
<div id="integrating-confluent-platform-with-clickhouse">
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="UI de Confluent Platform con la configuración para agregar un conector personalizado de ClickHouse" border />
