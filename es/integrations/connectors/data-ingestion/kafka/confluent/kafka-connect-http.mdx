---
sidebarTitle: 'HTTP Sink Connector para Confluent Platform'
slug: /integrations/kafka/cloud/confluent/http
description: 'Uso del HTTP Sink Connector con Kafka Connect y ClickHouse'
title: 'Confluent HTTP Sink Connector'
doc_type: 'guide'
keywords: ['Confluent HTTP Sink Connector', 'HTTP Sink ClickHouse', 'conector HTTP de Kafka
', 'integración HTTP de ClickHouse', 'Confluent Cloud HTTP Sink']
---
...
<div id="confluent-http-sink-connector">
  # Conector HTTP Sink de Confluent
</div>

El HTTP Sink Connector es independiente del tipo de datos, por lo que no necesita un esquema de Kafka y, además, admite tipos de datos específicos de ClickHouse, como Maps y Arrays. Esta flexibilidad adicional conlleva un ligero aumento de la complejidad de la configuración.
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="Interfaz de Confluent Cloud que muestra cómo crear un conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="Interfaz de Confluent Cloud que muestra la configuración de autenticación para el conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="Interfaz de Confluent Cloud que muestra opciones de configuración avanzada para el conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Interfaz de Confluent Cloud que muestra cómo crear un mensaje de prueba en un topic de Kafka" border />
