...
| ------------------------------------------------------------------------------------------------- | -------------------------------- | :-------------------: | :-------------------: | :-------------------: |
| [ClickPipes for Kafka](/es/integrations/clickpipes/kafka)                                            | [Cloud], [BYOC] (¡próximamente!) |           ✅           |           ✅           |                       |
...
* [**Confluent Cloud**](/es/integrations/connectors/data-ingestion/kafka/confluent) - Confluent Platform ofrece la opción de cargar y [ejecutar ClickHouse Connector Sink en Confluent Cloud](/es/integrations/connectors/data-ingestion/kafka/confluent/custom-connector) o usar [HTTP Sink Connector para Confluent Platform](/es/integrations/connectors/data-ingestion/kafka/confluent/kafka-connect-http), que integra Apache Kafka con una API mediante HTTP o HTTPS.
...
* **Código personalizado** - El código personalizado que utiliza Kafka y las [bibliotecas cliente](/es/integrations/language-clients) de ClickHouse puede ser adecuado cuando se requiere un procesamiento personalizado de eventos.
