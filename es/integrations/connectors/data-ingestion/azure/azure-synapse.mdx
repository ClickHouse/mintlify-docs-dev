...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="Configuración de Spark mediante notebook" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Verificación de la configuración de ClickHouse mediante la UI de Spark" border />

<div id="additional-resources">
  ## Recursos adicionales
</div>

* [Documentación de ClickHouse Spark Connector](/es/integrations/connectors/data-ingestion/apache-spark)
* [Información general sobre los grupos de Apache Spark en Azure Synapse](https://learn.microsoft.com/en-us/azure/synapse-analytics/spark/apache-spark-overview)
...
* [Administrar bibliotecas para los grupos de Apache Spark en Synapse](https://learn.microsoft.com/en-us/azure/synapse-analytics/spark/apache-spark-manage-pool-packages)
