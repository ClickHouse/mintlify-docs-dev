...
title: 'Uso de la función de tabla azureBlobStorage de ClickHouse para llevar datos de Azure a ClickHouse'
doc_type: 'guide'
integration:
   - support_level: 'core'
...
`TSV`, `ORC`, `Avro` y más. Para ver la lista completa, consulte [&quot;Formatos de datos&quot;](/es/reference/formats).
...
2. En el menú de la izquierda, seleccione **Claves de acceso** en la sección **Seguridad +
   redes**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="Configuración del almacén de datos de Azure" border />

3. Elija **key1** o **key2** y haga clic en el botón **Mostrar** junto al
   campo **Cadena de conexión**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="Claves de acceso del almacén de datos de Azure" border />
...
* [Formatos de datos de entrada y salida](/es/reference/formats)
