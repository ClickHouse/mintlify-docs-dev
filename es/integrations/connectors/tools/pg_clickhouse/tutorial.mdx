...
description: 'Aprende a conectar pg_clickhouse con ClickHouse y a consultar un conjunto de datos de ejemplo de taxis de la ciudad de Nueva York.'
...
Compila e instala pg&#95;clickhouse desde [PGXN] o [GitHub]. O bien, crea un
contenedor Docker con la [imagen de pg&#95;clickhouse], que no hace más que añadir
...
Observa con qué rapidez se ejecutó la consulta. pg&#95;clickhouse envía la consulta completa,
