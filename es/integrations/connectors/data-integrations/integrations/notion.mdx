...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="Selección de ClickHouse en el selector Add connection de Notion" />
...
4. Expande la nueva conexión de ClickHouse en la configuración del agent y activa las herramientas que quieras que use este agent. Para cada herramienta, también puedes elegir si el agent debe ejecutarla automáticamente o pedir aprobación siempre. Todas las herramientas expuestas por el ClickHouse Remote MCP server son de solo lectura. Consulta la referencia de [herramientas disponibles](/es/products/cloud/features/ai-ml/remote-mcp#available-tools) para ver la lista completa y actualizada.

<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="La conexión de ClickHouse expandida en Notion, con los controles por herramienta" />
