...
* Si tu consulta requiere un direct join, es decir, un `LEFT ANY JOIN`, como se muestra a continuación, recomendamos usar [Dictionaries](/es/concepts/features/dictionaries) siempre que sea posible.
...
<Image img="/images/guides/joins-3.png" size="lg" alt="características de join" />
...
<Image img="/images/guides/joins-4.png" size="lg" alt="diagrama de flujo de join" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="Árbol de decisión para optimizar el uso de memoria en joins" />
