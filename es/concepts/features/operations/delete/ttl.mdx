...
sidebarTitle: 'TTL (Tiempo de vida)'
keywords: ['ttl', 'tiempo de vida', 'clickhouse', 'antiguos', 'datos']
...
title: 'Gestionar datos con TTL (tiempo de vida)'
...
<div id="manage-data-with-ttl-time-to-live">
  # Gestionar los datos con TTL (tiempo de vida)
</div>
