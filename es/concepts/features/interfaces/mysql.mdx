---
description: 'Documentación de la interfaz del protocolo MySQL de ClickHouse, que permite
  a los clientes MySQL conectarse a ClickHouse'
...
<Image img="/images/interfaces/mysql0.png" alt="Pantalla de credenciales - Prompt" size="md" />

2. Cambia el menú desplegable `Connect with` a `MySQL`.

<br />

<Image img="/images/interfaces/mysql1.png" alt="Pantalla de credenciales - MySQL seleccionado" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="Pantalla de credenciales - MySQL habilitado" size="md" />

Copia la cadena de conexión MySQL que se muestra.

<Image img="/images/interfaces/mysql3.png" alt="Pantalla de credenciales - Cadena de conexión" size="md" />
