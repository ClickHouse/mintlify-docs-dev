...
<Image img="/images/_snippets/cloud-connect-button.png" size="md" alt="Botón Connect del servicio de ClickHouse Cloud" />
...
<Image img="/images/_snippets/connection-details-native.png" size="md" alt="Detalles de la conexión TCP Native de ClickHouse Cloud" />
