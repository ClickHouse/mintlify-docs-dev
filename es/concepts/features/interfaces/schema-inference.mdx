...
ClickHouse puede determinar automáticamente la estructura de los datos de entrada en casi todos los [formatos de entrada](/es/reference/formats) compatibles.
