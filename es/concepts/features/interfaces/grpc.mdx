...
* `--format OUTPUT_FORMAT, -f OUTPUT_FORMAT` – Un [formato](/es/reference/formats) de salida para el resultado. Valor predeterminado en modo interactivo: `PrettyCompact`.
