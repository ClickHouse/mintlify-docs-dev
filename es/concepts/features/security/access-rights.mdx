...
Un perfil de configuración es una colección de [configuraciones](/es/reference/settings). Un perfil de configuración contiene configuraciones y restricciones, así como una lista de roles y/o usuarios a los que se aplica este perfil.
