...
<Steps>
  ...
  <Step>
    ...
    Para obtener más información, visita https://clickhouse.com/docs/operations/server-configuration-parameters/settings/#server&#95;configuration&#95;parameters-openssl
  ...
  <Step>
    ...
    3. Verifique el estado de ClickHouse Keeper
       Los comandos típicos de [4 letter word (4lW)](/es/guides/oss/deployment-and-scaling/keeper#four-letter-word-commands) no funcionarán con `echo` sin TLS; a continuación se explica cómo usar estos comandos con `openssl`.
    ...
    * En la sesión de OpenSSL, envíe los comandos 4LW
    ...
    5. Inicie sesión en la UI de Play mediante la interfaz `https` en `https://chnode1.marsnet.local:8443/play`.
       ...
       <Image img="/images/guides/sre/configuring-ssl_01.png" alt="Configurar TLS" size="md" border />
