...
ClickHouse reconoce por la extensión del nombre del archivo que usa un formato separado por tabulaciones. Si necesitas especificar el formato explícitamente, simplemente agrega uno de los [muchos formatos de entrada de ClickHouse](/es/reference/formats):
...
* `--echo` — imprime la consulta antes de ejecutarla.
