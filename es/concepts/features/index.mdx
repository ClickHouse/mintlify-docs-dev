...
description: 'Explora conceptos de ClickHouse, incluidas las vistas materializadas, los diccionarios, la optimización del rendimiento, las operaciones, la configuración, la seguridad y más.'
mode: wide
---

<CardGroup cols={2}>
  <Card title="Vistas materializadas" icon="layer-group" href="/es/concepts/features/materialized-views">
    Aprende sobre las vistas materializadas incrementales, actualizables y en cascada.
  </Card>

  <Card title="Diccionarios" icon="book" href="/es/concepts/features/dictionaries">
  ...
  <Card title="Rendimiento" icon="gauge-high" href="/es/concepts/features/performance">
    Prewhere, cachés, índices de omisión, materialización diferida y resolución de problemas.
  </Card>

  <Card title="Operaciones" icon="gears" href="/es/concepts/features/operations/update">
  ...
  <Card title="Seguridad y autenticación" icon="shield-halved" href="/es/concepts/features/security">
    Control de acceso, TLS, autenticadores externos y seguridad de red.
  </Card>

  <Card title="Copia de seguridad y restauración" icon="box-archive" href="/es/concepts/features/backup-restore/overview">
    Copias de seguridad en disco local, S3, Azure Blob Storage y métodos alternativos.
  </Card>

  <Card title="Herramientas y utilidades" icon="wrench" href="/es/concepts/features/tools-and-utilities">
