...
* **Prefiera Dictionaries para lookups simples**. Use [Dictionaries](/es/concepts/features/dictionaries) para lookups de clave-valor (por ejemplo, de ID de usuario a nombre) y así evitar operaciones JOIN costosas.
