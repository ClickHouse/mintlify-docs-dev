...
<Image img="/images/materialized-view/refreshable-materialized-view-diagram.png" size="lg" alt="Diagrama de vista materializada actualizable" />
...
En la [guía de integración de dbt y ClickHouse](/es/integrations/connectors/data-ingestion/etl-tools/dbt) rellenamos un conjunto de datos de IMDb con las siguientes tablas: `actors`, `directors`, `genres`, `movie_directors`, `movies` y `roles`.
