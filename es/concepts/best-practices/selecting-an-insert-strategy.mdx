...
<Info>
  **Utilice inserciones sincrónicas si puede agrupar los datos en lotes en el cliente**

  Si no es posible, consulte [Inserciones asincrónicas](#asynchronous-inserts) a continuación.
</Info>

A continuación, resumimos brevemente cómo funcionan las inserciones de MergeTree en ClickHouse:

<Image img="/images/bestpractices/insert_process.png" size="lg" alt="Procesos de inserción" background="black" />
...
A diferencia de muchas bases de datos tradicionales, ClickHouse también admite una interfaz HTTP. **Esta, en cambio, prioriza la compatibilidad y la flexibilidad.** Permite enviar datos en [cualquier formato compatible](/es/guides/clickhouse/data-formats/intro), incluidos JSON, CSV, Parquet y otros, y tiene amplio soporte en la mayoría de los clientes de ClickHouse, incluidos los de Python, Java, JavaScript y Rust.
