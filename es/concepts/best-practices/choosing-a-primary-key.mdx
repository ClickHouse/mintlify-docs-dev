...
Supongamos que una tabla `posts_ordered`, que contiene los mismos datos, se define con `ORDER BY` como `(PostTypeId, toDate(CreationDate))`, es decir:
...
<Image img="/images/bestpractices/create_primary_key.gif" size="lg" alt="Clave primaria" />
...
<Image img="/images/bestpractices/primary_key.gif" size="lg" alt="Clave primaria" />
