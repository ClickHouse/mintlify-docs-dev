...
<Image img="/images/bestpractices/incremental_materialized_view.gif" size="lg" alt="Vistas materializadas" />
...
<Image img="/images/bestpractices/refreshable_materialized_view.gif" size="lg" alt="Diagrama de vista materializada actualizable" />
