...
El motor se diferencia de [MergeTree](/es/reference/engines/table-engines/mergetree-family/versionedcollapsingmergetree) en que elimina las entradas duplicadas con el mismo valor de la [clave de ordenación](/es/reference/engines/table-engines/mergetree-family/mergetree) (sección de la tabla `ORDER BY`, no `PRIMARY KEY`).
