...
El motor pertenece a la familia de motores `Log`. Consulte las propiedades comunes de los motores `Log` y sus diferencias en el artículo [Familia de motores Log](/es/reference/engines/table-engines/log-family).
