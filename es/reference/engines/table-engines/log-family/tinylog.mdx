...
Este motor pertenece a la familia de motores Log. Consulte [Familia de motores Log](/es/reference/engines/table-engines/log-family) para conocer las propiedades comunes de los motores Log y sus diferencias.
