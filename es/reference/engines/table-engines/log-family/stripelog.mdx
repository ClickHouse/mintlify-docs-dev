...
Este motor pertenece a la familia de motores log. Consulte las propiedades comunes de los motores log y sus diferencias en el artículo [Familia de motores Log](/es/reference/engines/table-engines/log-family).
