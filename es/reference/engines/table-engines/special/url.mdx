...
* `Format` debe ser uno que ClickHouse pueda usar en consultas `SELECT` y, si es necesario, en `INSERTs`. Para ver la lista completa de formatos admitidos, consulte [Formats](/es/reference/formats#formats-overview).
