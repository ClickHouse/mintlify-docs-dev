...
El motor de tabla File guarda los datos en un archivo en uno de los [formatos de archivo](/es/reference/formats#formats-overview) compatibles (`TabSeparated`, `Native`, etc.).
...
sección [Formatos](/es/reference/formats#formats-overview).
