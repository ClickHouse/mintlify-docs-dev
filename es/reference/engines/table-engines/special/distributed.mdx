...
Si necesita enviar una consulta a un conjunto desconocido de segmentos y réplicas cada vez, no necesita crear una tabla `Distributed`; use en su lugar la función de tabla `remote`. Consulte la sección [Funciones de tabla](/es/reference/functions/table-functions).
...
* Descripción de las [columnas virtuales](/es/reference/engines/table-engines#table_engines-virtual_columns)
