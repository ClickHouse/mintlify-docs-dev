...
* `rabbitmq_format` – Formato del mensaje. Utiliza la misma notación que la función SQL `FORMAT`, por ejemplo `JSONEachRow`. Para más información, consulta la sección [Formatos](/es/reference/formats).
...
El motor RabbitMQ admite todos los [formatos](/es/reference/formats) compatibles con ClickHouse.
