...
* `kafka_format` — Formato del mensaje. Usa la misma notación que la función SQL `FORMAT`, como `JSONEachRow`. Para obtener más información, consulte la sección [Formatos](/es/reference/formats).
...
El motor Kafka admite todos los [formatos](/es/reference/formats) compatibles con ClickHouse.
