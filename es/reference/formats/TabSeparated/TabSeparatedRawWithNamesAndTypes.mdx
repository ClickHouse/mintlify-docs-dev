...
description: 'Documentación del formato TabSeparatedRawWithNamesAndTypes'
input_format: true
...
Se diferencia del formato [`TabSeparatedWithNamesAndTypes`](/es/reference/formats/TabSeparated/TabSeparatedWithNamesAndTypes)
en que las filas se escriben sin caracteres de escape.
