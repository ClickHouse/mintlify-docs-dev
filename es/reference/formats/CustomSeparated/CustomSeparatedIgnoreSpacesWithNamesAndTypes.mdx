---
description: 'Documentación del formato CustomSeparatedIgnoreSpacesWithNamesAndTypes'
...
Usa el siguiente archivo txt, llamado `football.txt`:
...
Configure los ajustes personalizados para el delimitador:
