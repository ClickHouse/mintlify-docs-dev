...
La siguiente tabla compara los tipos de datos ORC compatibles y sus correspondientes [tipos de datos](/es/reference/data-types) de ClickHouse en las consultas `INSERT` y `SELECT`.
