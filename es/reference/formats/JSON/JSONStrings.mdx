---
alias: []
description: 'Documentación del formato JSONStrings'
input_format: true
...
Se diferencia del formato [JSON](/es/reference/formats/JSON/JSON) únicamente en que los campos de datos se devuelven como cadenas, no como valores JSON tipados.
...
Con un archivo JSON que contiene los siguientes datos, llamado `football.json`:
