...
Si tiene una tabla con columnas del tipo de dato [`Nested`](/es/reference/data-types/nested-data-structures), puede insertar datos JSON con la misma estructura. Habilite esta función con la SETTING [input&#95;format&#95;import&#95;nested&#95;json](/es/reference/settings/formats#input_format_import_nested_json).
