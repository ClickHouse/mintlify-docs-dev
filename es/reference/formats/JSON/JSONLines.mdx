...
Este formato también se conoce como `JSONEachRow`, `NDJSON` (JSON delimitado por saltos de línea) o `JSONL` (`JSONLines`). Todos estos nombres son alias del mismo formato y pueden usarse indistintamente.
