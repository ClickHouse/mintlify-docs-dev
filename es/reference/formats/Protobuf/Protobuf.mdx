...
Los mensajes anidados son adecuados para la entrada o salida de [estructuras de datos anidadas](/es/reference/data-types/nested-data-structures).

Los valores predeterminados definidos en un esquema de protobuf como el siguiente no se aplican; en su lugar, se usan los [valores predeterminados de la tabla](/es/reference/statements/create/table#default_values):
...
Para recargar el esquema de Protobuf cargado desde [`format_schema_path`](/es/reference/settings/server-settings/settings#format_schema_path), use la sentencia [`SYSTEM DROP ... FORMAT CACHE`](/es/reference/statements/system#system-drop-schema-format).
