...
Permite ejecutar consultas [SELECT](/es/reference/statements/select).
...
Permite ejecutar consultas [ALTER](/es/reference/statements/alter) según la siguiente jerarquía de privilegios:
...
Permite ejecutar las consultas DDL [CREATE](/es/reference/statements/create) y [ATTACH](/es/reference/statements/attach) según la siguiente jerarquía de privilegios:
...
Permite usar fuentes de datos externas. Se aplica a los [motores de tabla](/es/reference/engines/table-engines) y a las [funciones de tabla](/es/reference/functions/table-functions).
...
Permite usar un motor de tabla específico al crear una tabla. Se aplica a los [motores de tabla](/es/reference/engines/table-engines).
