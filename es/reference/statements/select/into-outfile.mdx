...
* El [formato de salida](/es/reference/formats) predeterminado es `TabSeparated` (como en el modo por lotes del cliente de línea de comandos). Use la cláusula [FORMAT](/es/reference/statements/select/format) para cambiarlo.
