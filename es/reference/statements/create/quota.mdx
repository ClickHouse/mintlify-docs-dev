...
Las claves `user_name`, `ip_address`, `client_key`, `client_key, user_name`, `client_key, ip_address` y `normalized_query_hash` se corresponden con los campos de la tabla [system.quotas](/es/reference/system-tables/quotas).
