...
La eliminación ligera se implementa como una [mutación](/es/reference/statements/alter#mutations) que marca las filas como eliminadas, pero no las elimina físicamente de inmediato.
