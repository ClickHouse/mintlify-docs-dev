...
Manipula los datos de la partición especificada que coinciden con la expresión de filtrado indicada. Se implementa como una [mutación](/es/reference/statements/alter#mutations).
...
Elimina los datos de la partición especificada que coinciden con la expresión de filtrado indicada. Se implementa como una [mutación](/es/reference/statements/alter#mutations).
