...
title: 'Sentencia DELETE de ALTER TABLE'
doc_type: 'reference'
---
...
La sincronía del procesamiento de la consulta se define mediante la configuración [mutations&#95;sync](/es/reference/settings/session-settings#mutations_sync). De forma predeterminada, es asíncrona.
