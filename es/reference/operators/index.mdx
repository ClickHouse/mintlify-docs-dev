...
Los operadores posfijos `AT TIME ZONE` y `AT LOCAL` convierten un valor `DateTime` o `DateTime64` a una zona horaria diferente. Son azúcar sintáctico de la función [`toTimeZone`](/es/reference/functions/regular-functions/date-time-functions#totimezone):
...
* [`toTimeZone`](/es/reference/functions/regular-functions/date-time-functions#totimezone)
* [`timeZone`](/es/reference/functions/regular-functions/date-time-functions#timezone)
