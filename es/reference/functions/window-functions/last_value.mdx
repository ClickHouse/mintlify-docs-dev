...
<Note>
  ...
  Consulta [el procesamiento de NULL](/es/reference/functions/aggregate-functions#null-processing) para obtener más información.

  Alias: `lastValueRespectNulls`
</Note>

Para obtener más información sobre la sintaxis de las funciones de ventana, consulta: [Window Functions - Syntax](/es/reference/functions/window-functions#syntax).
