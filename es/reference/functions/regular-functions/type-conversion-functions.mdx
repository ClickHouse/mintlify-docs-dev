...
Convierte un valor a un tipo de dato específico.
...
* `x` — Un valor de cualquier tipo. [`Any`](/es/reference/data-types)
* `T` — El tipo de datos de destino. [`String`](/es/reference/data-types/string)

**Valor devuelto**

Devuelve el valor convertido al tipo de datos de destino. [`Any`](/es/reference/data-types)
...
* `x` — Un valor para convertir. [`Any`](/es/reference/data-types)
* `T` — El nombre del tipo de dato de destino. [`String`](/es/reference/data-types/string)

**Valor devuelto**

Devuelve el valor convertido al tipo de dato de destino. [`Any`](/es/reference/data-types)
...
Convierte un valor a un tipo de datos especificado.
...
* `x` — Un valor que se convertirá. [`Any`](/es/reference/data-types)
* `T` — El nombre del tipo de dato de destino. [`const String`](/es/reference/data-types/string)
* `default_value` — Opcional. Valor por defecto que se devuelve si la conversión falla. [`Any`](/es/reference/data-types)

**Valor devuelto**

Devuelve el valor convertido al tipo de dato de destino, o el valor por defecto si la conversión no es posible. [`Any`](/es/reference/data-types)
...
* `x` — Un valor que se va a convertir. [`Any`](/es/reference/data-types)
* `T` — El nombre del tipo de dato de destino. [`String`](/es/reference/data-types/string)

**Valor devuelto**

Devuelve el valor convertido al tipo de dato de destino, o `NULL` si la conversión no es posible. [`Any`](/es/reference/data-types)
...
* `x, y, ...` — Expresiones. [`Any`](/es/reference/data-types)
...
* `x` — Cualquier tipo. [`Any`](/es/reference/data-types)
...
Valor del tipo de destino. [`Any`](/es/reference/data-types)
...
* `value` — Valor que se convertirá en cadena. [`Any`](/es/reference/data-types)
