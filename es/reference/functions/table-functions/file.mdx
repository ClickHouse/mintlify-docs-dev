---
description: 'Un motor de tabla que proporciona una interfaz similar a una tabla para
  hacer SELECT desde archivos e INSERT en ellos, de forma similar a la función de
  tabla s3. Use `file()` al trabajar con archivos locales y `s3()` al trabajar con
  buckets de almacenamiento de objetos, como S3, GCS o MinIO.'
sidebarTitle: 'file'
