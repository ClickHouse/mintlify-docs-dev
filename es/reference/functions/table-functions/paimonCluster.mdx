---
description: 'Una extensión de la función de tabla paimon que permite procesar archivos
  de Apache Paimon en paralelo desde varios nodos de un clúster especificado.'
sidebarTitle: 'paimonCluster'
slug: /sql-reference/table-functions/paimonCluster
title: Función de tabla paimonCluster
doc_type: 'reference'
---
