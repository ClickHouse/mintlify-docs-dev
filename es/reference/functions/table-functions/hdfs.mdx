...
<div id="hdfs-table-function">
  # hdfs Función de tabla
</div>

Crea una tabla a partir de archivos en HDFS. Esta función de tabla es similar a las funciones de tabla [url](/es/reference/functions/table-functions/url) y [file](/es/reference/functions/table-functions/file).
