...
Una tupla de elementos, cada uno con un [tipo](/es/reference/data-types). Tuple debe contener al menos un elemento.
...
<Warning>
  **Funcionalidad experimental**
  ...
  Requiere `SET allow_experimental_nullable_tuple_type = 1`
