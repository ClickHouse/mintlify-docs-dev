...
Consulte [Adición de fecha y hora](/es/reference/operators#date-time-addition) para obtener más información sobre todas las combinaciones admitidas y los tipos de resultado.
...
* [Operadores para trabajar con fechas y horas](/es/reference/operators#operators-for-working-with-dates-and-times)
* [Tipo de datos `Date`](/es/reference/data-types/date)
* [Tipo de datos `Time`](/es/reference/data-types/time)
* [Tipo de datos `DateTime`](/es/reference/data-types/datetime)