...
Aquí va una breve descripción de la función. Debe describir brevemente qué hace y un caso de uso típico.
...
- `arg1` — Descripción del argumento. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg2` — Descripción del argumento. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
- `arg3` — Descripción del argumento opcional (opcional). [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}

**Implementation Details**

Una descripción de los detalles de implementación, si corresponde.

**Returned value**

- Devuelve {insertar aquí lo que devuelve la función}. [DataType](../data-types/float.md){/* MIGRATE: unresolved relative link */}
