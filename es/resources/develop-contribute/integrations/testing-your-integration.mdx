...
El conjunto completo se encuentra en la sección [**Conjuntos de datos de ejemplo**](/es/get-started/sample-datasets). Los siguientes cuatro conjuntos de datos cubren la mayoría de las necesidades de pruebas de integración:
