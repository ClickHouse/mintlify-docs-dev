...
5. **Ejemplo de extremo a extremo.** Al menos un ejemplo realista, desde la conexión hasta un resultado significativo. Usa un [conjunto de datos de ejemplo de ClickHouse](/es/get-started/sample-datasets) para que los lectores puedan reproducirlo
