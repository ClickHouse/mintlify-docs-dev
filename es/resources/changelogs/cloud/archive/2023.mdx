...
* [Go client](/es/integrations/language-clients/go): Se corrigió la comprobación del estado de las conexiones inactivas en conexiones TLS
* [Python client](/es/integrations/language-clients/python)
...
* [Cliente de Python](/es/integrations/language-clients/python): Compatibilidad mejorada con Pandas y corrección de problemas relacionados con la zona horaria
...
* [Kafka-Connect](/es/integrations/connectors/data-ingestion/kafka): Conversión implícita de fechas y mejor manejo de columnas NULL
...
* [Kafka-Connect](/es/integrations/connectors/data-ingestion/kafka): Se añadió compatibilidad con Amazon MSK
* [Metabase](/es/integrations/connectors/data-visualization/metabase-and-clickhouse): Primera release estable 1.0.0
  * El conector pasó a estar disponible en [Metabase Cloud](https://www.metabase.com/start/)
...
* [DBT-clickhouse](/es/integrations/connectors/data-ingestion/etl-tools/dbt): Se añadió compatibilidad con la última versión de DBT, la v1.4.1
* [Python client](/es/integrations/language-clients/python): Se mejoró la compatibilidad con proxies y túneles SSH; se añadieron varias correcciones y optimizaciones de rendimiento para DataFrames de Pandas
...
* [Golang client](/es/integrations/language-clients/go): Se optimizó la conexión de red con ClickHouse Cloud
...
* plugin de [dbt](/es/integrations/connectors/data-ingestion/etl-tools/dbt): se añadió soporte para [múltiples hilos](https://github.com/ClickHouse/dbt-clickhouse/blob/main/CHANGELOG.md)
* plugin de [Grafana](/es/integrations/connectors/data-visualization/grafana): mejor gestión de los errores de conexión
* cliente de [Python](/es/integrations/language-clients/python): [soporte para streaming](/es/integrations/language-clients/python/advanced-querying#streaming-queries) para la operación de inserción
* cliente de [Go](/es/integrations/language-clients/go): [Correcciones de errores](https://github.com/ClickHouse/clickhouse-go/blob/main/CHANGELOG.md): cierre de conexiones canceladas y mejor gestión de los errores de conexión
