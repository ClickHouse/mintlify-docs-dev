...
Consulta la [documentación](/es/reference/settings/server-settings/settings#max-thread-pool-size) para obtener más información sobre los ajustes anteriores y otros ajustes que afectan al Global Thread pool.