...
<Image img="/images/knowledgebase/lets-encrypt-ssl/port_80_security_group.png" size="md" alt="Configuración del grupo de seguridad de AWS que muestra el puerto 80 abierto" border />
