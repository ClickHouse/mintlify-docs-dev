...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="Cuadro de diálogo del error de verificación del desarrollador en MacOS" border />
...
2. Ve a **Privacy &amp; Security**:
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="vista predeterminada de Privacy & Security en MacOS" border />
...
4. Haz clic en **Allow Anyway**.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="configuración de Privacy & Security en MacOS que muestra el botón Allow Anyway" border />
