...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="Estructura de la base de datos y la tabla en MSSQL" border />

Usuario de inicio de sesión en MSSQL, `sql_user`:

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="Configuración del usuario de inicio de sesión en MSSQL" border />

Roles de pertenencia a la base de datos para `sql_user`:

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="Roles de pertenencia a la base de datos en MSSQL" border />

Usuario de base de datos con inicio de sesión:

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="Usuario de base de datos en MSSQL con inicio de sesión" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/es/snippets/engines/table-engines/integrations/odbc)
