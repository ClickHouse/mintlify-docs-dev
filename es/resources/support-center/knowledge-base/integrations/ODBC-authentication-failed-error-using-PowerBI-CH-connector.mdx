...
<Image img="/images/knowledgebase/powerbi_odbc_authentication_error.png" size="md" alt="Cuadro de diálogo de error de autenticación de ODBC en Power BI" border />
