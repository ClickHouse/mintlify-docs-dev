---
title: Cómo configurar SETTINGS para un usuario en ClickHouse
description: Aprende a definir SETTINGS en ClickHouse para consultas individuales, sesiones de cliente o usuarios específicos mediante los comandos `SET` y `ALTER USER`.
date: 2023-03-01
tags: ['Ajustes']
