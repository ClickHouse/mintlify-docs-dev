...
<Image img="/images/row-oriented.gif" alt="Ilustración del almacenamiento tradicional de una base de datos orientada a filas" size="md" />

**Columnar**

<Image img="/images/column-oriented.gif" alt="Ilustración del almacenamiento de una base de datos columnar" size="md" />
