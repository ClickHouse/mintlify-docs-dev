...
description: "Aprende a ingestar datos de un topic de Kafka en ClickHouse mediante el motor de tabla de Kafka, vistas materializadas y tablas MergeTree."
date: 2024-04-27
...
Este artículo explica el proceso de envío de datos desde un topic de Kafka a una tabla de ClickHouse. Usaremos el feed de cambios recientes de Wiki, que proporciona un [flujo de eventos](https://stream.wikimedia.org/v2/stream/recentchange) que representa los cambios realizados en varias propiedades de Wikimedia. Los pasos incluyen:
