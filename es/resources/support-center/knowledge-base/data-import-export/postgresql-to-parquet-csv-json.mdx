...
El formato de salida puede ser cualquiera de los [formatos de salida](/es/reference/formats) admitidos en ClickHouse. Veamos algunos ejemplos...
...
<Note>
  No tienes por qué detenerte aquí: puedes usar `clickhouse-local` para extraer datos de PostgreSQL y enviarlos a [todos los formatos de salida](/es/reference/formats).
