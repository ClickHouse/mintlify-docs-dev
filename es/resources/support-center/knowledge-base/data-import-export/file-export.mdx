...
Si ClickHouse no puede determinar el formato a partir de la extensión del archivo, el formato de salida predeterminado para los datos de salida es [TabSeparated](/es/reference/formats). Para especificar el [formato de salida](/es/reference/formats), use la [cláusula FORMAT](/es/reference/statements/select/format).
