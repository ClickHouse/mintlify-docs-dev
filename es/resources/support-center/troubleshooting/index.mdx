...
<Accordion title="Mostrar soluciones de conexión">
  ...
  * [Problemas al analizar formatos de datos](/es/reference/formats)
</Accordion>
...
<Accordion title="Mostrar soluciones de instalación y configuración">
  ...
  * [Elegir el motor de tabla adecuado](/es/reference/engines/table-engines)

  {/* - [Modificar los esquemas de forma segura](/reference/statements/alter) */}
  ...
  * [Resolver problemas de formato de datos](/es/reference/formats)
  ...
  * [Configurar tablas distribuidas](/es/reference/engines/table-engines/special/distributed)
  ...
  {/* - [Configuración de ClickHouse Keeper](/guides/oss/deployment-and-scaling/keeper) */}
...
1. **Pregunta a la IA**
2. **Consulta las tablas del sistema** - [Información general](/es/reference/system-tables/overview)
3. **Revisa los logs del servidor** - Busca mensajes de error en los logs de ClickHouse
4. **Pregunta a la comunidad** - [Únete a nuestra comunidad de Slack](https://clickhouse.com/slack), [Debates en GitHub](https://github.com/ClickHouse/ClickHouse/discussions)
