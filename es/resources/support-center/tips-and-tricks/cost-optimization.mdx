...
<Note>
  Este es un ejemplo usado específicamente para el caso de datos de Microsoft Clarity. Si tienes todos tus datos en ClickHouse o no tienes restricciones para mover datos a ClickHouse, prueba a usar [diccionarios](/es/concepts/features/dictionaries) en su lugar.
</Note>
