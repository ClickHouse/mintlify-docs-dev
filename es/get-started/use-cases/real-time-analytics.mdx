...
<Image img="/images/use-cases/rta-considerations.png" alt="Análisis en tiempo real: tiempo de ingestión, transformación y consulta" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="Cómo ClickHouse impulsa el análisis en tiempo real" />
  </div>
