---
title: 'Uso de almacenamiento de objetos'
description: 'Mover datos desde almacenamiento de objetos a ClickHouse Cloud'
keywords: ['almacenamiento de objetos', 'S3', 'azure blob', 'gcs', 'migración']
...
<div id="move-data-from-cloud-object-storage-to-clickhouse-cloud">
  # Mover datos desde el almacenamiento de objetos en la nube a ClickHouse Cloud
</div>

<Image img="/images/integrations/migration/object-storage-01.png" size="md" alt="Migración de ClickHouse autogestionado" />
