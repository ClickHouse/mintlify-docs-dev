...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="Migración de ClickHouse autogestionado" />
...
[motor de integración](/es/reference/engines/table-engines#integration-engines) proporcionado por ClickHouse o una [función de tabla](/es/reference/functions/table-functions), respectivamente,
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="Migración de ClickHouse autogestionado" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="Migración de ClickHouse autogestionado" />
