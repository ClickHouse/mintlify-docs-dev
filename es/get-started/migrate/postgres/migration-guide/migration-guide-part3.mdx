...
<Image img="/images/migrations/postgres-b-tree.png" size="lg" alt="Índice B-Tree de PostgreSQL" />

<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="Índice disperso de PostgreSQL" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="Particiones de PostgreSQL a particiones de ClickHouse" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="Proyecciones de PostgreSQL en ClickHouse" />
