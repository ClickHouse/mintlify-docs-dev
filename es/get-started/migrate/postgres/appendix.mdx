...
<Image img="/images/integrations/data-ingestion/dbms/postgres-replicas.png" size="md" alt="Consistencia eventual" />
...
| `JSON`                   | [String](/es/reference/data-types/string), [Variant](/es/reference/data-types/variant), [Nested](/es/reference/data-types/nested-data-structures#nestedname1-type1-name2-type2-), [Tuple](/es/reference/data-types/tuple) |
