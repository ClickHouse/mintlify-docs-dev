...
mediante el tipo [`Nested`](/es/reference/data-types/nested-data-structures),
...
| [`VARIANT`](https://docs.snowflake.com/en/sql-reference/data-types-semistructured#variant)                                                                                                                                                                                                                                                                                                                                                                                      | [`JSON`, `Tuple`, `Nested`](/es/reference/formats)                                                                                                                    | El tipo `JSON` es experimental en ClickHouse. Este tipo infiere los tipos de las columnas al insertar. Como alternativa, `Tuple`, `Nested` y `Array` también pueden usarse para crear estructuras con tipos definidos explícitamente.                                                                                                                                                                                              |   |
| [`OBJECT`](https://docs.snowflake.com/en/sql-reference/data-types-semistructured#object)                                                                                                                                                                                                                                                                                                                                                                                        | [`Tuple`, `Map`, `JSON`](/es/reference/formats)                                                                                                                       | Tanto `OBJECT` como `Map` son análogos al tipo `JSON` de ClickHouse, donde las claves son de tipo `String`. ClickHouse requiere que el valor sea consistente y esté fuertemente tipado, mientras que Snowflake usa `VARIANT`. Esto significa que los valores de distintas claves pueden ser de tipos diferentes. Si esto es necesario en ClickHouse, defina explícitamente la jerarquía mediante `Tuple` o recurra al tipo `JSON`. |   |
| [`ARRAY`](https://docs.snowflake.com/en/sql-reference/data-types-semistructured#array)                                                                                                                                                                                                                                                                                                                                                                                          | [`Array`](/es/reference/data-types/array), [`Nested`](/es/reference/data-types/nested-data-structures)                                                                   | `ARRAY` en Snowflake usa `VARIANT` para los elementos, un supertipo. En cambio, en ClickHouse estos están tipados de forma estricta.                                                                                                                                                                                                                                                                                               |   |
