...
description: 'Migrar de Snowflake a ClickHouse'
keywords: ['Snowflake']
title: 'Migrar de Snowflake a ClickHouse'
...
<div id="migrate-from-snowflake-to-clickhouse">
  # Migrar de Snowflake a ClickHouse
</div>
...
<Steps>
  <Step>
    ...
    <Image img="/images/migrations/migrate_snowflake_clickhouse.png" size="md" alt="Migración de Snowflake a ClickHouse" />
