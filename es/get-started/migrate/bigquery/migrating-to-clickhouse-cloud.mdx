...
<Image img="/images/migrations/bigquery-3.png" size="lg" alt="Esquema" />
...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="Carga masiva" />
...
* GCS admite la [gestión del ciclo de vida de objetos](https://cloud.google.com/storage/docs/lifecycle), lo que permite eliminar, después de un período especificado, los datos que ya se hayan exportado e importado en ClickHouse.
* [Google permite exportar hasta 50 TB por día a GCS de forma gratuita](https://cloud.google.com/bigquery/quotas#export_jobs). Los usuarios solo pagan por el almacenamiento en GCS.
...
Antes de probar los ejemplos siguientes, recomendamos a los usuarios revisar los [permisos necesarios para la exportación](https://cloud.google.com/bigquery/docs/exporting-data#required_permissions) y las [recomendaciones de ubicación de los datos](https://cloud.google.com/bigquery/docs/exporting-data#data-locations) para maximizar el rendimiento de la exportación y la importación.
...
Como se describe [aquí](/es/get-started/migrate/bigquery), al igual que en BigQuery, ClickHouse no impone unicidad sobre los valores de la columna de clave primaria de una tabla.
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="Claves primarias de ClickHouse" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="Particiones" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="Proyecciones" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="Reescritura de consultas de BigQuery" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="Funciones de agregación 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="Funciones de agregación 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="Condicionales y Arrays" />
