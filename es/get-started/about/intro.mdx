...
<Image img="/images/column-oriented-example-query.png" alt="Consulta de ejemplo en una base de datos orientada a columna" size="lg" />
...
<Image img="/images/column-oriented.gif" alt="Estructura de base de datos orientada a columna" size="lg" />
