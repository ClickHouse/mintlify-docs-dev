...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="Para líneas añadidas y eliminadas" size="md" />

**Para commits y autores:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="Para commits y autores" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Matriz de autores de Superset" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Matriz de autores de Superset v2" size="md" />
