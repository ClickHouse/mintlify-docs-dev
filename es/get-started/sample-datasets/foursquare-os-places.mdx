...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="Mapa de densidad de puntos de interés en Europa" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="Bares de sake en Japón" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="Cajeros automáticos" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="Mapa de Europa con puntos de interés clasificados por país" />