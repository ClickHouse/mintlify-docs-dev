...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Dashboard de torre de telefonía móvil por tipo de radio en el MCC 204" />
...
<Tabs>
  <Tab title="ClickHouse Cloud">
    ...
    <Image img="/images/_snippets/cloud-load-data-sample.png" size="md" alt="Cargar el conjunto de datos de torres de telefonía móvil" />
...
<Image img="/images/getting-started/example-datasets/superset-add.png" size="md" alt="Agregar una base de datos" />

Elige **ClickHouse Connect** de la lista:

<Image img="/images/getting-started/example-datasets/superset-choose-a-database.png" size="md" alt="Elegir ClickHouse Connect como tipo de base de datos" />
...
<Image img="/images/getting-started/example-datasets/superset-connect-a-database.png" size="md" alt="Añadir ClickHouse como fuente de datos en Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-add-dataset.png" size="md" alt="Añadir la tabla cell_towers como un conjunto de datos" />
...
<Image img="/images/getting-started/example-datasets/superset-create-map.png" size="md" alt="Crear un mapa en Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-lon-lat.png" size="md" alt="Especificar campos de longitud y latitud" />
...
<Image img="/images/getting-started/example-datasets/superset-umts-netherlands.png" size="md" alt="Gráfico para radios UMTS en MCC 204" />
...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Dashboard de torres de telefonía móvil por tipo de radio en mcc 204" />
