...
<Note>
  Consulta la [Referencia SQL](/es/reference/statements/select) para obtener más información sobre la sintaxis, las cláusulas disponibles y otras opciones.
</Note>
...
Añada una cláusula `FORMAT` para especificar uno de los [numerosos formatos de salida que admite ClickHouse](/es/reference/formats#formats-overview):
