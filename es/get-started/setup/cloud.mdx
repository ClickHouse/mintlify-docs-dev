...
<Steps>
  <Step>
    ...
    * Inicia sesión con el nombre de usuario y la contraseña que acabas de crear
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="Seleccionar plan" border />
    ...
    <Image img="/images/_snippets/createservice1.png" size="md" alt="Nuevo servicio de ClickHouse" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="Límites de escalado" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="Fuentes de datos" border />
    ...
    * Cargar datos desde la URL del archivo
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="Seleccionar fuente de datos" border />
    ...
    * las claves primarias de ClickHouse ***no son únicas*** para cada fila de una tabla
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="detalles de conexión del cliente de ClickHouse" border />
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="Nuevas filas de un archivo CSV" />
