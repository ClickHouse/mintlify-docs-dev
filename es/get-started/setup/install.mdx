...
<div className="installContainer">
  <a href="/es/install/quick-install" style={{textDecoration: 'none'}}>
    <Card title="Instalación rápida" />
  </a>

  <a href="/es/install/clickhousectl" style={{textDecoration: 'none'}}>
    <Card title="clickhousectl (CLI)" icon="console" />
  </a>

  <a href="/es/install/docker" style={{textDecoration: 'none'}}>
    <Card title="Docker" />
  </a>

  <a href="/es/install/advanced" style={{textDecoration: 'none'}}>
...
<div className="installContainer">
  <a href="/es/install/debian_ubuntu" style={{textDecoration: 'none'}}>
    <Card title="Debian/Ubuntu" />
  </a>

  <a href="/es/install/redhat" style={{textDecoration: 'none'}}>
    <Card title="Redhat" />
  </a>

  <a href="/es/install/nixos" style={{textDecoration: 'none'}}>
    <Card title="NixOS" />
  </a>

  <a href="/es/install/linux_other" style={{textDecoration: 'none'}}>
