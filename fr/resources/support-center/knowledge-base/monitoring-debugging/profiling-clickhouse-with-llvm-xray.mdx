...
<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/time-order.png" size="md" alt="ordre-temporel" />

<div id="left-heavy">
  #### Chargé à gauche
</div>

<Image img="/images/knowledgebase/profiling-clickhouse-with-llvm-xray/left-heavy.png" size="md" alt="chargé-à-gauche" />
