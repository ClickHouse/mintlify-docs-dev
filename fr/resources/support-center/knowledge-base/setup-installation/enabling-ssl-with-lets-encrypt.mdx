...
<Image img="/images/knowledgebase/lets-encrypt-ssl/port_80_security_group.png" size="md" alt="Configuration du Security Group AWS avec le port 80 ouvert" border />
