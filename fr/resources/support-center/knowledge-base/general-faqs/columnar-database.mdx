...
<Image img="/images/row-oriented.gif" alt="Illustration du stockage traditionnel d'une base de données orientée lignes" size="md" />

**En colonnes**

<Image img="/images/column-oriented.gif" alt="Illustration du stockage d'une base de données colonnaire" size="md" />
