...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="Boîte de dialogue d’erreur de vérification du développeur sur MacOS" border />
...
2. Accédez à **Confidentialité et sécurité** :
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="Vue par défaut des réglages MacOS Confidentialité et sécurité" border />
...
4. Cliquez sur **Autoriser quand même**.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="Réglages MacOS Confidentialité et sécurité affichant le bouton Autoriser quand même" border />
