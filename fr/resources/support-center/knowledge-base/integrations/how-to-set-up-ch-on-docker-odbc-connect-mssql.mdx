...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="Structure de la base de données et de la table MSSQL" border />

Compte de connexion MSSQL, `sql_user` :

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="Configuration du compte de connexion MSSQL" border />

Rôles de base de données attribués à `sql_user` :

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="Rôles de base de données MSSQL attribués" border />

Utilisateur de base de données associé à une connexion :

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="Utilisateur de base de données MSSQL associé à une connexion" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/fr/snippets/engines/table-engines/integrations/odbc)
