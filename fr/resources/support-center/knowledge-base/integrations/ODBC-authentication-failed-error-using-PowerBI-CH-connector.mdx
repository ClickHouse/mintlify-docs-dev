...
<Image img="/images/knowledgebase/powerbi_odbc_authentication_error.png" size="md" alt="Boîte de dialogue d’erreur d’authentification ODBC dans Power BI" border />
