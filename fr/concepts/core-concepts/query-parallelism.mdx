...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="Analyse de l’index" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 voies de traitement parallèles" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 voies de traitement parallèles" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="Lanes distribuées" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="Pipeline de requête" />
