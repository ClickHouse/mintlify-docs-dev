...
<Image img="/images/managing-data/core-concepts/partitions.png" size="lg" alt="TRAITEMENT DE L’INSERTION" />
...
<Image img="/images/managing-data/core-concepts/merges_with_partitions.png" size="lg" alt="FUSIONS DE PARTIES" />
