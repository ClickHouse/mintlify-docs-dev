...
<Image img="/images/bestpractices/incremental_materialized_view.gif" size="lg" alt="Vues matérialisées" />
...
<Image img="/images/bestpractices/refreshable_materialized_view.gif" size="lg" alt="Schéma d’une vue matérialisée rafraîchissable" />
