...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="Construction des index de saut de données" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="Utilisation des index de saut" />
