...
<Image img="/images/interfaces/mysql0.png" alt="Écran des identifiants - Prompt" size="md" />

2. Dans le menu déroulant `Connect with`, sélectionnez `MySQL`.

<br />

<Image img="/images/interfaces/mysql1.png" alt="Écran des identifiants - MySQL sélectionné" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="Écran des identifiants - MySQL activé" size="md" />

Copiez la chaîne de connexion MySQL affichée.

<Image img="/images/interfaces/mysql3.png" alt="Écran des identifiants - Chaîne de connexion" size="md" />
