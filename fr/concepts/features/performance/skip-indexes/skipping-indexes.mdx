...
<Image img="/images/guides/best-practices/simple_skip.png" size="md" alt="Saut simple" />
...
<Image img="/images/guides/best-practices/bad_skip.png" size="md" alt="Skip inefficace" />
