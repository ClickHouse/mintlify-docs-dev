...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="Cas d'utilisation des dictionnaires dans ClickHouse" />
...
<Image img="/images/dictionary/dictionary-left-any-join.png" size="sm" alt="Utilisation d’un dictionnaire avec LEFT ANY JOIN" />
