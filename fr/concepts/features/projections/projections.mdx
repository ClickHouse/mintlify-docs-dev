...
En pratique, une projection peut être considérée comme une table cachée
supplémentaire associée à la table d’origine. La projection peut avoir un ordre de tri différent, et donc un
...
<Image img="/images/data-modeling/projections_1.png" size="md" alt="Projections dans ClickHouse" />
...
<Image img="/images/data-modeling/projections_2.png" size="md" alt="Visualisation de la table principale uk_price_paid_with_projections et de ses deux projections" />
...
* [Introduction pratique aux index primaires dans ClickHouse](/fr/guides/clickhouse/data-modelling/sparse-primary-indexes#option-3-projections)
