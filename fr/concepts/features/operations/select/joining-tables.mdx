...
<Image img="/images/guides/joins-3.png" size="lg" alt="fonctionnalités des jointures" />
...
<Image img="/images/guides/joins-4.png" size="lg" alt="organigramme de jointure" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="Arbre de décision pour l’optimisation mémoire des jointures" />
