...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="Export DynamoDB vers S3" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="Mappage des colonnes DynamoDB" border />
