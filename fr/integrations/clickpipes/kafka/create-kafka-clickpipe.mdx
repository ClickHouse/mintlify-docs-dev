...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Sélectionner les importations" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Sélectionner le type de source de données" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Renseignez les informations de connexion" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="Configuration du tunnel SSH" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Sélectionnez votre topic" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Définir la table, le schéma et les paramètres" size="md" />

    Vous pouvez également personnaliser les paramètres avancés à l’aide des options proposées

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Définir les options avancées" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Voir l’aperçu" size="md" />
  </Step>
</Steps>