...
<Steps>
  <Step>
    ...
    **2.** Cliquez sur la tuile **BigQuery**.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step1.png" alt="Sélectionner la tuile BigQuery" size="lg" border />
  </Step>
  ...
  <Step>
    ...
    **1.** Téléversez la clé `.json` du compte de service que vous avez créé pour ClickPipes. Assurez-vous que le compte de service dispose du minimum d’[autorisations](/fr/integrations/clickpipes/bigquery/overview#permissions) requis.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step2.png" alt="Téléverser la clé du compte de service" size="lg" border />
