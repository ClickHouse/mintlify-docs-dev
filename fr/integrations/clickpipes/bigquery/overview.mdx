...
<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Création d'une clé de compte de service avec des autorisations BigQuery et Cloud Storage" size="lg" border />
