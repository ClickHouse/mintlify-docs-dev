...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1_pubsub.png" alt="Sélectionner GCP Pub/Sub comme source de données" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_pubsub.png" alt="Renseigner les détails de connexion" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_pubsub.png" alt="Définir le topic Pub/Sub, le format et l'offset de départ" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="Notification de réussite" size="sm" border />

<Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="Notification de suppression" size="lg" border />
...
ClickPipes for Pub/Sub s’authentifie auprès de GCP à l’aide d’une clé JSON de compte de service. Vous importez le fichier de clé lors de la création du pipe ; ClickPipes le chiffre au repos et l’utilise à l’exécution pour consommer les messages et gérer le cycle de vie de l’abonnement géré.

Pour la liste exacte des autorisations IAM requises et une définition recommandée de rôle personnalisé, consultez le [guide des autorisations IAM Pub/Sub](/fr/integrations/clickpipes/pubsub/auth).