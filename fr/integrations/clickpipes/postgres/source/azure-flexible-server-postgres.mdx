...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Paramètres du serveur dans Azure Flexible Server for Postgres" size="lg" border />

2. Modifiez `wal_level` pour le définir sur `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Définir wal_level sur logical dans Azure Flexible Server for Postgres" size="lg" border />

3. Cette modification nécessite un redémarrage du serveur. Redémarrez-le donc lorsqu&#39;on vous le demande.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="Redémarrer le serveur après avoir modifié wal_level" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Ajouter les adresses IP de ClickPipes au pare-feu dans Azure Flexible Server for Postgres" size="lg" />
