...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Où trouver les groupes de paramètres dans RDS ?" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modification de RDS Postgres avec le nouveau groupe de paramètres" size="lg" border />

3. Redémarrez votre instance RDS pour appliquer les modifications

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Redémarrage de RDS Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="Où trouver le groupe de sécurité dans RDS Postgres ?" size="lg" border />
