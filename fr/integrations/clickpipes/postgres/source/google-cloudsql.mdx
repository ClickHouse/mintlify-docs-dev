...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="Bouton Edit dans Cloud SQL Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="Définir cloudsql.logical_decoding sur on" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding3.png" alt="Redémarrer le serveur" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="Section Connections dans Cloud SQL" size="lg" border />

2. Accédez à la sous-section Networking

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="Sous-section Networking dans Cloud SQL" size="lg" border />

3. Ajoutez les [IP publiques de ClickPipes](/fr/integrations/clickpipes/home#list-of-static-ips)

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="Ajouter les réseaux ClickPipes au pare-feu" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="Réseaux ClickPipes ajoutés au pare-feu" size="lg" border />
