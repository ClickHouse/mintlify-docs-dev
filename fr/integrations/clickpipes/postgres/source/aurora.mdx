...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Où trouver les groupes de paramètres dans Aurora" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/change_rds_logical_replication.png" alt="Modification de rds.logical_replication" size="lg" border />

2. Appliquez le nouveau groupe de paramètres à votre cluster Aurora PostgreSQL

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modification d’Aurora PostgreSQL avec le nouveau groupe de paramètres" size="lg" border />

3. Redémarrez votre cluster Aurora pour appliquer les modifications

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Redémarrage d’Aurora PostgreSQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="Où trouver le groupe de sécurité dans Aurora PostgreSQL ?" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="Modifier les `Inbound rules` du groupe de sécurité ci-dessus" size="lg" border />
