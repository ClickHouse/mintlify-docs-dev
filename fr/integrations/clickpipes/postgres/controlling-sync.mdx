...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="Créer les paramètres de synchronisation" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Bouton de modification des paramètres de synchronisation" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="Modifier les paramètres de synchronisation" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="tableau CDC Syncs" size="md" />