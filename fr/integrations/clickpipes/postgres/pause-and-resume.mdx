...
<div id="pause-clickpipe-steps">
  ## Étapes pour mettre en pause un Postgres ClickPipe
</div>

1. Dans l’onglet Sources de données, cliquez sur le Postgres ClickPipe que vous souhaitez mettre en pause.
2. Accédez à l’onglet **Paramètres**.
3. Cliquez sur le bouton **Pause**.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pause_button.png" border size="md" />

4. Une boîte de dialogue de confirmation devrait s’afficher. Cliquez de nouveau sur Pause.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pause_dialog.png" border size="md" />
...
<Warning>
  Mettre en pause un Postgres ClickPipe n’arrête pas l’augmentation des slots de réplication.
</Warning>

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/pause_status.png" border size="md" />

<div id="resume-clickpipe-steps">
  ## Étapes pour reprendre un Postgres ClickPipe
</div>

1. Dans l’onglet Sources de données, cliquez sur le Postgres ClickPipe que vous souhaitez reprendre. Le statut du miroir doit initialement être **En pause**.
2. Accédez à l’onglet **Paramètres**.
3. Cliquez sur le bouton **Reprendre**.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/resume_button.png" border size="md" />

4. Une boîte de dialogue de confirmation s’affiche. Cliquez de nouveau sur Reprendre.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/resume_dialog.png" border size="md" />
