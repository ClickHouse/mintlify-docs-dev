...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="Sélectionner le groupe de paramètres" size="lg" border />

2. Recherchez `change_stream_log_retention_duration`, sélectionnez-le et remplacez sa valeur par `259200` (72 heures)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="Modifier le groupe de paramètres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="Appliquer le groupe de paramètres" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="Statut du groupe de paramètres" size="lg" border />
