...
| **OVH Object Storage** <br /> *compatible S3*  | <img src="/images/integrations/logos/ovh.png" alt="logo Cloud Storage" width="32" />          | L’ingestion continue nécessite un [ordre lexicographique](#continuous-ingestion-lexicographical-order). Le mode non ordonné n’est pas pris en charge.                                                                                |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="Identifiants IAM pour les S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="Authentification IAM pour les ClickPipes S3" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="Paramètres avancés de ClickPipes" size="lg" border />
