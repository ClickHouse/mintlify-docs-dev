...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Bouton de modification de la synchronisation" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="Table CDC Syncs" size="md" />