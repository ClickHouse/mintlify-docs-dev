...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="Sélectionner MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="Renseignez les informations de connexion" size="lg" border />
...
5. Ici, vous pouvez sélectionner la base de données de destination de votre ClickPipe. Vous pouvez soit sélectionner une base de données existante, soit en créer une nouvelle.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="Sélectionner la base de données de destination" size="lg" border />
