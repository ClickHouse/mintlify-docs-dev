...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Activation des sauvegardes automatisées dans RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/rds_config.png" alt="Où trouver le groupe de paramètres dans RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="Format du binlog défini sur ROW" size="lg" border />

2. `binlog_row_metadata` sur `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Métadonnées de ligne du binlog définies sur FULL" size="lg" border />

3. `binlog_row_image` sur `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Image de ligne du binlog définie sur FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Où trouver le groupe de sécurité dans RDS MySQL ?" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="Modifier les règles entrantes du groupe de sécurité ci-dessus" size="lg" border />
