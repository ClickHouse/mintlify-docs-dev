...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Activation des sauvegardes automatiques dans RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="Définir le format du binlog sur ROW" size="lg" border />

2. `binlog_row_metadata` sur `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Définir les métadonnées de ligne du binlog sur FULL" size="lg" border />

3. `binlog_row_image` sur `FULL`

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Définir l’image de ligne du binlog sur FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Où trouver le groupe de sécurité dans RDS ?" size="lg" border />
