...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Activation de PITR dans Cloud SQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="Bouton Edit dans GCP MySQL" size="lg" border />

Faites ensuite défiler la page jusqu’à la section `Flags`, puis ajoutez les flags ci-dessus.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="Définition des flags binlog dans GCP" size="lg" border />
...
Vous pouvez le faire soit en modifiant l’instance, soit en accédant à l’onglet `Connections` dans la barre latérale de la Cloud Console.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="Liste d’autorisation d’adresses IP dans GCP MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="Téléchargement du certificat MySQL GCP" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="Utilisation du certificat MySQL GCP" size="lg" border />