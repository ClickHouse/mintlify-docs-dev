...
<Tabs>
  <Tab title="Autoriser les IP de ClickPipes">
    ...
    3. Dans la section **Firewall rules**, saisissez la [liste des adresses IP statiques de ClickPipes](/fr/integrations/clickpipes/home#list-of-static-ips) correspondant à la région dans laquelle votre service est déployé.
       ...
       <Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/azure-flexible-server-mysql/1_configure_network_security.png" alt="Configurer le réseau pour un accès public avec une liste d’autorisation d’IP" size="lg" border />
