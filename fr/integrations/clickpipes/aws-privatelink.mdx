...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Service ClickPipes" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="Sélectionner la source de données" size="lg" border />

4. Sélectionnez l’option `Reverse private endpoint`.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Sélectionner le reverse private endpoint" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Sélectionner le reverse private endpoint" size="lg" border />

6. Fournissez les paramètres requis pour le type d’endpoint sélectionné.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Sélectionner le reverse private endpoint" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Sélectionner le reverse private endpoint" size="lg" border />
...
1. Dans la barre latérale, repérez le bouton `Settings` et cliquez dessus.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="Paramètres de ClickHouse Cloud" size="lg" border />

2. Cliquez sur `Reverse private endpoints` dans la section `ClickPipe reverse private endpoints`.

   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="Paramètres de ClickHouse Cloud" size="md" border />
