...
<Image img="/images/integrations/data-ingestion/clickpipes/clickpipes_stack.png" alt="pile technologique ClickPipes" size="lg" border />
...
| Redpanda                                                    | <img src="/images/integrations/logos/logo_redpanda.png" alt="logo Redpanda" width="32" />              | Streaming         | Stable        | Configurez ClickPipes et commencez à ingérer des données en streaming depuis Redpanda dans ClickHouse Cloud.                                                                                                                           |
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_custom_role.png" alt="Attribuer un rôle personnalisé" size="lg" border />
