...
2. Dans le menu de gauche, sélectionnez **Access keys** dans la section **Security +
   networking**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="Paramètres d’Azure Data Store" border />

3. Choisissez **key1** ou **key2**, puis cliquez sur le bouton **Show** à côté
   du champ **Connection string**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="Clés d’accès d’Azure Data Store" border />
...
Ceci n’est qu’une simple introduction à l’utilisation de la fonction azureBlobStorage. Pour
des options plus avancées et plus de détails sur la configuration, veuillez consulter la
