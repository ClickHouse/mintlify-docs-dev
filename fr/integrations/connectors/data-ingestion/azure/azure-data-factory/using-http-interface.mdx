...
1. Connectez-vous au [Microsoft Azure Portal](https://portal.azure.com/) et cliquez sur
   **Créer une ressource**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-page.png" size="lg" alt="Page d’accueil du portail Azure" border />
...
2. Dans le volet Catégories à gauche, sélectionnez **Analytics**, puis cliquez sur
   **Data Factory** dans la liste des services populaires.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-resource-analytics.png" size="lg" alt="Nouvelle ressource dans le portail Azure" border />
...
3. Sélectionnez votre abonnement et votre groupe de ressources, saisissez un nom pour la nouvelle instance
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory.png" size="lg" alt="Nouveau Data Factory dans le portail Azure" border />

4. Cliquez sur **Vérifier + créer**, puis sur **Créer** pour lancer le déploiement.

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-confirm.png" size="lg" alt="Confirmation du nouveau Data Factory dans le portail Azure" border />

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-success.png" size="lg" alt="Création du nouveau Data Factory réussie dans le portail Azure" border />
...
1. Connectez-vous au Microsoft Azure Portal et ouvrez votre instance Data Factory.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.png" size="lg" alt="Page d’accueil de l’Azure Portal avec Data Factory" border />

2. Sur la page de vue d’ensemble de Data Factory, cliquez sur **Launch Studio**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-factory-page.png" size="lg" alt="Page Data Factory de l’Azure Portal" border />
...
3. Dans le menu de gauche, sélectionnez **Manage**, puis accédez à **Linked services**,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.png" size="lg" alt="Bouton de nouveau service lié Azure Data Factory" border />
...
4. Dans la **barre de recherche New linked service**, saisissez **REST**, sélectionnez **REST** et cliquez sur **Continue**
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.png" size="lg" alt="Recherche d’un nouveau service lié dans Azure Data Factory" border />
...
5. Dans le volet de configuration du service lié, entrez un nom pour votre nouveau service,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-lined-service-pane.png" size="lg" alt="Volet New Lined Service" border />
...
6. Dans le volet de contenu dynamique, vous pouvez créer une URL paramétrée, ce qui
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.png" size="lg" alt="URL de base vide du nouveau service lié" border />
...
7. Cliquez sur le **&quot;+&quot;** à côté du champ de filtre et ajoutez un nouveau paramètre, nommez-le
   ...
   Cliquez sur **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.png" size="lg" alt="Paramètres du nouveau service lié" border />
...
8. Dans le champ d’expression, saisissez ce qui suit et cliquez sur **OK**. Remplacez
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.png" size="lg" alt="Champ d’expression du nouveau service lié rempli" border />
...
9. De retour dans le formulaire principal, sélectionnez l’authentification de base, saisissez le nom d’utilisateur et le
   ...
   s’affichera.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-check-connection.png" size="lg" alt="Tester la connexion du nouveau service lié" border />

10. Cliquez sur **Create** pour finaliser la configuration.
    <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-linked-services-list.png" size="lg" alt="Liste des services liés" border />
...
2. Dans Azure Data Factory Studio, sélectionnez Author dans le volet de gauche. Survolez
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-item.png" size="lg" alt="Nouvel élément jeu de données" border />
...
3. Dans la barre de recherche, saisissez **REST**, sélectionnez **REST**, puis cliquez sur **Continue**.
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-page.png" size="lg" alt="Page New jeu de données" border />
...
4. Vous devriez maintenant voir votre jeu de données nouvellement créé dans la section Datasets
   ...
   content.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-properties.png" size="lg" alt="Propriétés du nouveau jeu de données" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-query.png" size="xl" alt="Requête du nouveau jeu de données" border />
...
6. Cliquez sur OK pour enregistrer l’expression. Cliquez sur Test connection. Si tout est
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-connection-successful.png" size="xl" alt="Connexion du nouveau jeu de données réussie" border />
...
1. Ouvrez **Azure Data Factory Studio**, puis accédez à l’**onglet Author**. Dans le volet **Factory Resources**, survolez **Pipeline**, cliquez sur l’icône à trois points, puis sélectionnez **New pipeline**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-pipeline-item.png" size="lg" alt="Nouvel élément de pipeline ADF" border />
...
2. Dans le volet **Activities**, développez la section **Move and transform**, puis faites glisser l’activité **Copy data** sur le canevas.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-copy-data-item.png" size="lg" alt="Nouvel élément Copy Data" border />

3. Sélectionnez l’**onglet Source**, puis choisissez le jeu de données source que vous avez créé précédemment.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-source.png" size="lg" alt="Source Copy Data" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-sink-select-post.png" size="lg" alt="Sink Copy Data sélectionner POST" border />
...
5. Cliquez sur **Debug** en haut du canevas pour exécuter le pipeline. Après un court instant, l’activité sera mise en file d’attente puis exécutée. Si tout est correctement configuré, la tâche devrait se terminer avec le statut **Success**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-debug-success.png" size="lg" alt="Succès du débogage Copy Data" border />
