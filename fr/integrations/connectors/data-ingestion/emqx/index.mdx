...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_1.png" size="sm" border alt="Interface de déploiement du service ClickHouse Cloud affichant la sélection de la région AWS" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_2.png" size="sm" border alt="Paramètres de connexion ClickHouse Cloud affichant la configuration de l’accès IP" />

Ensuite, vous devez enregistrer votre nom d’utilisateur et votre mot de passe pour une utilisation ultérieure.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_3.png" size="sm" border alt="Écran des identifiants ClickHouse Cloud affichant le nom d’utilisateur et le mot de passe" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_4.png" size="lg" border alt="Tableau de bord de l’instance ClickHouse Cloud en cours d’exécution avec les options de connexion" />

Cliquez sur &quot;Connect to SQL Console&quot; pour créer la base de données et la table pour l’intégration avec EMQX Cloud.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_5.png" size="lg" border alt="Interface SQL Console de ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_6.png" size="lg" border alt="Exécution de la requête SQL de création de la base de données et de la table dans ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_sign_up.png" size="lg" border alt="Page d'inscription à EMQX Cloud avec formulaire d'inscription" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_create_1.png" size="lg" border alt="Étape 1 de création d’un déploiement EMQX Cloud montrant les options de déploiement" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_overview.png" size="lg" border alt="Tableau de bord de vue d’ensemble EMQX Cloud montrant les métriques du broker" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_auth.png" size="lg" border alt="Interface de configuration de l’authentification EMQX Cloud pour ajouter des identifiants" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_nat_gateway.png" size="lg" border alt="Panneau de configuration de la passerelle NAT d’EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_clickhouse.png" size="lg" border alt="Détails du connecteur Data Integration ClickHouse d’EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_resource.png" size="lg" border alt="Formulaire de configuration de la ressource ClickHouse dans EMQX Cloud avec les détails de connexion" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.png" size="md" border alt="Étape 1 de la création d'une règle Data Integration dans EMQX Cloud montrant la requête SQL" />

Vous pouvez utiliser le test SQL pour vérifier le résultat.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.png" size="md" border alt="Étape 2 de la création d'une règle Data Integration dans EMQX Cloud montrant les résultats du test" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_action.png" size="md" border alt="Configuration de l’action de règle Data Integration d’EMQX Cloud avec modèle SQL" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_details.png" size="md" border alt="Détails de la règle Data Integration d’EMQX Cloud affichant un résumé de la configuration" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-overview.png" size="lg" border alt="Vue d’ensemble de MQTTX montrant l’interface du client" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-new.png" size="lg" border alt="Formulaire de configuration d’une nouvelle connexion MQTTX avec les détails de connexion" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-publish.png" size="lg" border alt="Interface de publication MQTTX affichant la composition des messages MQTT" />
...
<Image img="/images/integrations/data-ingestion/emqx/rule_monitor.png" size="lg" border alt="tableau de bord de surveillance des règles EMQX Cloud affichant les métriques de traitement des messages" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_result.png" size="lg" border alt="Résultats de la requête ClickHouse montrant les données IoT persistées" />
