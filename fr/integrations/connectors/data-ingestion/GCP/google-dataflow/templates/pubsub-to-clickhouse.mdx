...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="Console Dataflow affichant une tâche Pub/Sub vers ClickHouse en cours d’exécution" />
