...
<Image img="/images/integrations/data-ingestion/s3/s3-j.png" size="lg" border alt="Vue du bucket S3 dans la console AWS montrant les fichiers de données ClickHouse stockés dans S3" />
...
<Image img="/images/integrations/data-ingestion/s3/bucket1.png" size="lg" border alt="Taille des données dans le premier bucket S3 affichant les métriques d'utilisation du stockage" />

<Image img="/images/integrations/data-ingestion/s3/bucket2.png" size="lg" border alt="Taille des données dans le deuxième bucket S3 affichant les métriques d'utilisation du stockage" />
