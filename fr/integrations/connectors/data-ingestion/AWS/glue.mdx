...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Glue Notebook connections config" force="true" />
  ...
  <Tab title="Manual Installation">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Glue Notebook JAR path options" force="true" />
  </Tab>
</Tabs>
...
Pour en savoir plus, veuillez consulter notre [documentation Spark](/fr/integrations/connectors/data-ingestion/apache-spark/index).