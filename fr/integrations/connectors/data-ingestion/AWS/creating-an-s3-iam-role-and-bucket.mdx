...
<Image size="lg" img="/images/_snippets/s3/2025/s3-1.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

3. Saisissez un nom d&#39;utilisateur

<Image size="lg" img="/images/_snippets/s3/2025/s3-2.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

4. Sélectionnez `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-3.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

5. Sélectionnez `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-4.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-5.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

7. Sélectionnez `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-6.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

8. Sélectionnez `Application running outside AWS`

<Image size="lg" img="/images/_snippets/s3/2025/s3-7.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

9. Sélectionnez `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-8.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />

10. Téléchargez votre clé d&#39;accès et votre clé secrète au format .csv pour les utiliser ultérieurement

<Image size="lg" img="/images/_snippets/s3/2025/s3-9.png" alt="AWS IAM Management Console - Ajout d'un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-10.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />

2. Saisissez un nom de bucket et laissez les autres options par défaut

<Image size="lg" img="/images/_snippets/s3/2025/s3-11.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-12.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />

4. Sélectionnez **Create Bucket** en bas de la page

<Image size="lg" img="/images/_snippets/s3/2025/s3-13.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-14.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-15.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-16.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />

9. Le dossier doit maintenant apparaître dans la liste du bucket

<Image size="lg" img="/images/_snippets/s3/2025/s3-17.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-18.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />

11. Sélectionnez l’onglet **Permissions** et cliquez sur le bouton **Edit** dans la section **Bucket Policy**

<Image size="lg" img="/images/_snippets/s3/2025/s3-19.png" alt="AWS IAM Management Console - Ajout d’un nouvel utilisateur" />
