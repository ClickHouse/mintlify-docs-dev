...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Page d’inscription Artie" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Interface Edit Pipeline d’Artie" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="Portail d’analyse" />

Supervision spécifique aux pipelines et aux tables

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="Supervision intégrée" />

Notifications quotidiennes de modification du schéma

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="Notification de schéma" />