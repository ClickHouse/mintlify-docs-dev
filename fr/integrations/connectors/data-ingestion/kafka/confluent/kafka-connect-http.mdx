...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="Interface Confluent Cloud montrant comment créer un connecteur HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="Interface Confluent Cloud montrant les paramètres d'authentification du connecteur HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="Interface Confluent Cloud montrant les options de configuration avancée du connecteur HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Interface Confluent Cloud montrant comment créer un message de test dans un topic Kafka" border />
