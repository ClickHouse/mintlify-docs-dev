...
<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="UI de Confluent Platform montrant les paramètres pour ajouter un connecteur ClickHouse personnalisé" border />
