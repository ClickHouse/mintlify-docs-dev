...
<Image img="/images/integrations/data-ingestion/kafka/kafka_01.png" size="lg" alt="Schéma d’architecture du moteur de table Kafka" style={{width: '80%'}} />
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_02.png" size="lg" alt="Schéma du moteur de table Kafka avec des insertions" />
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_03.png" size="lg" alt="Schéma du moteur de table Kafka avec des vues matérialisées" />
...
<Image img="/images/integrations/data-ingestion/kafka/kafka_04.png" size="lg" alt="Schéma du moteur de table Kafka avec des clusters ClickHouse" />
