...
<Image img="/images/integrations/data-ingestion/dbms/jdbc-01.png" size="lg" alt="Schéma d’architecture de ClickHouse JDBC Bridge" background="white" />
...
Le moyen le plus simple d’utiliser ClickHouse JDBC Bridge est de l’installer et de l’exécuter sur le même hôte que celui sur lequel ClickHouse s’exécute :<Image img="/images/integrations/data-ingestion/dbms/jdbc-02.png" size="lg" alt="Schéma de déploiement local de ClickHouse JDBC Bridge" background="white" />
...
<Image img="/images/integrations/data-ingestion/dbms/jdbc-03.png" size="lg" alt="Schéma de déploiement externe de ClickHouse JDBC Bridge" background="white" />
