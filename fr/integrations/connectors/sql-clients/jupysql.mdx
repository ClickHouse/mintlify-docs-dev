...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="Histogramme montrant la répartition des distances de trajet en 10 classes à partir du jeu de données short-trips" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="Histogramme montrant la répartition des distances de trajet en 50 classes, avec grille, intitulé « Distance de trajet pour les trajets < 6,3 »" border />