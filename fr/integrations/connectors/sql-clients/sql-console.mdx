...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="lg" border alt="Vue de la liste des tables et du schéma montrant les tables de la base de données dans la barre latérale gauche" />

Vous pouvez également développer les tables de la liste pour afficher les colonnes et les types

<Image img="/images/cloud/sqlconsole/view-columns.png" size="lg" border alt="Vue d’une table développée montrant les noms de colonnes et les types de données" />
...
<Image img="/images/cloud/sqlconsole/abc.png" size="lg" border alt="Table View affichant des données pouvant être sélectionnées et copiées" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="lg" border alt="Boîte de dialogue Cell Inspector affichant le contenu d’une cellule sélectionnée" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="lg" border alt="Boîte de dialogue Sort affichant la configuration d’un tri décroissant sur une colonne" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="lg" border alt="Boîte de dialogue de filtre montrant la configuration permettant de filtrer la colonne radio sur la valeur GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="lg" border alt="Boîte de dialogue montrant comment ajouter un filtre supplémentaire sur une plage supérieure à 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="lg" border alt="Interface montrant le filtrage et le tri appliqués simultanément" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="lg" border alt="Interface montrant le bouton Create Query qui génère du SQL à partir de filtres et de tris" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="lg" border alt="Interface montrant comment créer une nouvelle requête à l’aide du bouton + ou du bouton New Query" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="lg" border alt="Interface montrant comment exécuter une partie sélectionnée d'une requête SQL" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="lg" border alt="Option d'exécution au niveau du curseur dans le menu étendu des options d'exécution" />

* Sélectionnez « Run at cursor » dans le menu contextuel du SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="lg" border alt="Option Run at cursor dans le menu contextuel du SQL Editor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="lg" border alt="Bouton 'Cancel' affiché pendant l'exécution d'une requête" />
...
<Image img="/images/cloud/sqlconsole/give-a-query-a-name.png" size="lg" border alt="Interface montrant comment renommer une requête intitulée Untitled Query" />
...
<Image img="/images/cloud/sqlconsole/save-the-query.png" size="lg" border alt="Bouton d'enregistrement dans la barre d'outils de l'éditeur de requêtes" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="lg" border alt="Recherche dans les données Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="lg" border alt="Correspondance dans le corps" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="lg" border alt="Options de pagination" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="lg" border alt="Navigation de pagination" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="lg" border alt="Télécharger au format CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="lg" border alt="Résultats tabulaires de la requête" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="lg" border alt="Passer de la requête au graphique" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="lg" border alt="Total des trajets par semaine" />
...
<Image img="/images/cloud/sqlconsole/bar-chart.png" size="lg" border alt="Graphique à barres" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="lg" border alt="Passer d’un graphique Bar à Area" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="lg" border alt="Mettre à jour le nom de la requête" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="lg" border alt="Mettre à jour le sous-titre, etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="lg" border alt="Ajuster l’échelle des axes" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="lg" border alt="Bouton Share dans la barre d'outils des requêtes" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="lg" border alt="Boîte de dialogue permettant de modifier l'accès à une requête partagée" />

<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="lg" border alt="Interface permettant d'ajouter une équipe à une requête partagée" />

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="lg" border alt="Interface permettant de modifier l'accès d'un membre à une requête partagée" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="lg" border alt="Section Partagé avec moi dans la liste des requêtes" />