...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="Se connecter à ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="Ajouter une nouvelle base de données" />

Vous serez ensuite invité à renseigner les informations de la base de données.

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="Renseignez les informations de la base de données" />

Vous aurez alors une cellule que vous pourrez exécuter pour établir une connexion.

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="Exécutez la cellule pour vous connecter à ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="Choisir le moteur SQL" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="Résultats dans un DataFrame" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="Combinaison d’une liste déroulante, d’une table et d’un graphique" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="Exécuter App View" />