...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="Interface du gestionnaire de pilotes de DbVisualizer affichant la configuration du pilote JDBC ClickHouse" />
