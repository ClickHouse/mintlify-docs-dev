...
<Image img="/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="Onglet Data Sources de DataGrip avec l’icône + mise en évidence" />
...
<Image img="/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="DataGrip sélectionnant ClickHouse dans la liste des sources de données" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="Onglet Drivers de DataGrip montrant l’installation du pilote ClickHouse" />
...
<Image img="/images/integrations/sql-clients/datagrip-7.png" border alt="Formulaire des informations de connexion DataGrip avec les paramètres ClickHouse" />
