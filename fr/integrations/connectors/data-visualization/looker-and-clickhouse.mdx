...
<Image size="md" img="/images/integrations/data-visualization/looker_01.png" alt="Ajout d’une nouvelle connexion dans l’interface de gestion des bases de données de Looker" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_02.png" alt="Saisie de vos identifiants ClickHouse dans le formulaire de connexion Looker" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_03.png" alt="Activation de SSL pour la connexion ClickHouse dans les paramètres de Looker" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_04.png" alt="Test et connexion à la source de données ClickHouse" border />
