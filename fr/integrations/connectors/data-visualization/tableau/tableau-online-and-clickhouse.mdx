...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="Interface de Tableau Online affichant le bouton 'New' pour créer une source de données publiée" border />

<br />

Sélectionnez &quot;MySQL&quot; dans la liste des connecteurs disponibles.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="Écran de sélection des connecteurs de Tableau Online avec l'option MySQL mise en évidence" border />

<br />

Renseignez les informations de connexion recueillies lors de la configuration de ClickHouse.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="Écran de configuration de la connexion MySQL de Tableau Online avec les champs server, port, database et d'identifiants" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="Page de source de données de Tableau Online affichant les tables de la base de données à gauche et le canevas à droite avec une fonctionnalité de glisser-déposer" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="Interface de Tableau Desktop affichant le menu Connect avec l’option MySQL mise en évidence" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="Boîte de dialogue de connexion MySQL de Tableau Desktop avec l’option SSL activée et des champs pour le server, le username, le password et le certificat" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Tableau Desktop affichant le menu Server avec l’option Publish Data Source mise en évidence" border />

<br />

IMPORTANT : vous devez sélectionner &quot;Embedded password&quot; dans les options &quot;Authentication&quot;.

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="Boîte de dialogue de publication de Tableau Desktop affichant les options Authentication avec Embedded password sélectionné" border />

<br />

En outre, choisissez &quot;Update workbook to use the published data source&quot;.

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="Boîte de dialogue de publication de Tableau Desktop avec l’option 'Update workbook to use the published data source' cochée" border />
