...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="Écran de connexion de Tableau montrant le menu de sélection du connecteur, avec l'option ClickHouse by ClickHouse mise en évidence" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="Boîte de dialogue d'installation du connecteur Tableau affichant les détails du connecteur ClickHouse JDBC et le bouton d'installation" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="Boîte de dialogue de connexion ClickHouse dans Tableau affichant les champs server, port, database, username et password" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="Nouveau workbook Tableau affichant l'écran de connexion initial avec les options de sélection de base de données" border />

<br />

8. Sélectionnez **TPCD** dans la liste déroulante **Schema** et vous devriez voir la liste des tables dans **TPCD** :

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="Sélection du schéma dans Tableau affichant les tables de la base de données TPCD, notamment CUSTOMER, LINEITEM, NATION, ORDERS et d'autres" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="Workbook Tableau avec la table CUSTOMER glissée sur le canevas, montrant les en-têtes de colonnes mais aucune donnée" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="Éditeur de relations Tableau montrant la connexion entre les tables CUSTOMER et ORDERS à l'aide du champ Custkey" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="Feuille de calcul Tableau montrant les dimensions et mesures des tables ClickHouse disponibles pour l'analyse" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="Graphique linéaire Tableau montrant la quantité commandée par année à partir de données ClickHouse" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="Vue en tableau croisé Tableau avec les trimestres en colonnes et les modes d'expédition en lignes" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="Tableau croisé Tableau montrant la somme du prix total par trimestre et par mode d'expédition" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="Tableau croisé Tableau montrant le prix moyen des commandes par trimestre et par mode d'expédition avec format monétaire" border />
