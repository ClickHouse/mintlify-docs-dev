...
<Image size="lg" img="/images/integrations/data-visualization/omni_01.png" alt="Interface d’administration d’Omni montrant le bouton Add Connection dans la section Connections" border />

<br />

Sélectionnez `ClickHouse`. Saisissez vos identifiants dans le formulaire.

<Image size="lg" img="/images/integrations/data-visualization/omni_02.png" alt="Interface de configuration de la connexion Omni pour ClickHouse, avec les champs du formulaire d’identification" border />
