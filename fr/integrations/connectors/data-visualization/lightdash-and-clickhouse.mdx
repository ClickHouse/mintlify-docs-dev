...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Exemple de tableau de bord Lightdash" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="Exemple de configuration profiles.yml pour un projet lightdash-clickhouse" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="Exemple de métriques définies dans le fichier .yml" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="Vue Explore de Lightdash montrant les dimensions, les filtres, le graphique, les résultats et SQL" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Création et organisation de graphiques dans un dashboard Lightdash" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Interface Ask AI de Lightdash affichant une requête en langage naturel propulsée par des métriques dbt" border />
