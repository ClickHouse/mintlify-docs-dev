...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="Exemple de configuration native sécurisée" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="Options de configuration HTTP supplémentaires" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="Exemple de paramètres supplémentaires" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="Configuration des logs" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="Configuration des traces" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Exemple de configuration d’une table d’alias" border />

Grafana verra alors les résultats de la table d’alias au lieu de ceux de `DESC example_table` :

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Exemple de sélection d’une table d’alias" border />
