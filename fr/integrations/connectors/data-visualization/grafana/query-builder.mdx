...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_table_query.png" alt="Exemple de requête de tableau agrégée" border />
...
Des valeurs par défaut peuvent être configurées dans la [configuration des logs](/fr/integrations/connectors/data-visualization/grafana/config#logs) de la source de données afin de précharger le query builder avec une base de données/table et des colonnes par défaut.
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="Exemple de requête de logs OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="Exemple de champs supplémentaires dans une requête de logs" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="Exemple de requête de séries temporelles" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="Exemple de requête de trace OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="Exemple de requête Raw SQL" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="Liens de traces dans un tableau" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  Exemple de liens de traces dans les logs

  <Image size="md" img="/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="Liens de traces dans les logs" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/images/integrations/data-visualization/grafana/demo_data_links.png" alt="Exemple de liaison avec des data links" border />
</div>
