...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_install.png" alt="Assistant d’installation du pilote ODBC ClickHouse affichant les options d’installation" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.png" alt="Recherche Windows affichant l’option ODBC Data Sources (64-bit)" border />

<br />

Vérifiez que le pilote ClickHouse figure bien dans la liste.

<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_verify.png" alt="ODBC Data Source Administrator affichant les pilotes ClickHouse dans l’onglet Drivers" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="Écran d’accueil de Power BI Desktop avec le bouton Get Data" border />

<br />

Recherchez « ClickHouse »

<Image size="md" img="/images/integrations/data-visualization/powerbi_search_clickhouse.png" alt="Boîte de dialogue Get Data de Power BI avec ClickHouse saisi dans la barre de recherche" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_db.png" alt="Boîte de dialogue de connexion à ClickHouse affichant les champs hôte, port, base de données et mode de connectivité" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_user.png" alt="Boîte de dialogue des identifiants de connexion à ClickHouse pour le nom d’utilisateur et le mot de passe" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Vue Navigator de Power BI affichant les tables des bases de données ClickHouse et des exemples de données" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_add_dsn.png" alt="ODBC Data Source Administrator avec le bouton Add mis en évidence pour créer un nouveau DSN" border />

<br />

Choisissez la version Unicode du pilote ODBC.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_unicode.png" alt="Boîte de dialogue Create New Data Source affichant la sélection du ClickHouse Unicode Driver" border />

<br />

Renseignez les informations de connexion.

<Image size="sm" img="/images/integrations/data-visualization/powerbi_connection_details.png" alt="Boîte de dialogue de configuration du pilote ODBC ClickHouse avec les paramètres de connexion" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="Écran d’accueil de Power BI Desktop affichant le bouton Get Data" border />

<br />

Sélectionnez &quot;Other&quot; -&gt; &quot;ODBC&quot;.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_odbc.png" alt="Boîte de dialogue Power BI Get Data avec l’option ODBC sélectionnée dans la catégorie Other" border />

<br />

Sélectionnez la source de données que vous avez créée précédemment dans la liste.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_dsn.png" alt="Boîte de dialogue de sélection du pilote ODBC affichant le DSN ClickHouse configuré" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_dsn_credentials.png" alt="Boîte de dialogue des identifiants pour la connexion DSN ODBC" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Vue Navigator de Power BI affichant les tables de la base de données ClickHouse et un échantillon de données" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_16.png" alt="Power Query Editor montrant la transformation du type de données de la colonne UInt64" border />
