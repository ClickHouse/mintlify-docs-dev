...
<Image size="md" img="/images/integrations/data-visualization/metabase_08.png" alt="Visualisation Metabase sous forme de diagramme circulaire affichant des données de ClickHouse" border />
...
3. Si l’installation de votre pilote a fonctionné, **ClickHouse** apparaîtra dans le menu déroulant **Type de base de données** :
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_01.png" alt="Sélection de base de données Metabase montrant ClickHouse comme option" border />
...
5. Saisissez les informations de connexion de votre base de données ClickHouse. Activez une connexion sécurisée si votre serveur ClickHouse est configuré pour utiliser SSL. Par exemple :
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_02.png" alt="Formulaire des informations de connexion Metabase pour la base de données ClickHouse" border />
...
2. Dans l’angle supérieur droit, cliquez sur le menu **+ New** et notez que vous pouvez poser des questions, exécuter des requêtes SQL et créer un tableau de bord :
   ...
   <Image size="sm" img="/images/integrations/data-visualization/metabase_03.png" alt="Menu + New de Metabase affichant les options permettant de créer des questions, des requêtes SQL et des tableaux de bord" border />
...
3. Par exemple, voici une requête SQL exécutée sur une table appelée `uk_price_paid`, qui renvoie le prix moyen payé par année de 1995 à 2022 :
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_04.png" alt="Éditeur SQL de Metabase affichant une requête sur les données UK price paid" border />
...
1. Cliquez sur **+ New** et sélectionnez **Question**. Notez que vous pouvez créer une question en partant d’une base de données et d’une table. Par exemple, la question suivante porte sur une table nommée `uk_price_paid` dans la base de données `default`. Voici une question simple qui calcule le prix moyen par ville, dans le comté du Grand Manchester :
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_06.png" alt="Interface de création de questions Metabase avec des données de prix au Royaume-Uni" border />

2. Cliquez sur le bouton **Visualize** pour afficher les résultats sous forme de tableau.

   <Image size="md" img="/images/integrations/data-visualization/metabase_07.png" alt="Visualisation Metabase affichant les résultats tabulaires des prix moyens par ville" border />
...
3. Sous les résultats, cliquez sur le bouton **Visualization** pour choisir un graphique en barres (ou toute autre option disponible) :
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_08.png" alt="Visualisation Metabase en diagramme circulaire des prix moyens par ville dans le Grand Manchester" border />
