...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="Tableau de bord Splunk affichant des visualisations des données des taxis de New York" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Page des paramètres de Splunk DB Connect affichant la configuration de Java Home" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="Page des pilotes de Splunk DB Connect montrant le pilote ClickHouse correctement installé" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Bouton de nouvelle connexion de Splunk DB Connect" />

<br />

Renseignez les informations de l’hôte ClickHouse et assurez-vous que &quot;Enable SSL&quot; est coché :

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="Page de configuration de la connexion Splunk pour ClickHouse" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="SQL Explorer de Splunk sélectionnant la connexion à ClickHouse" />

Exécutez une requête SQL sur la table `trips` qui renvoie le nombre total d’enregistrements de la table :

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="Exécution d’une requête SQL dans Splunk affichant le nombre d’enregistrements dans la table trips" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="Visualisation d’un graphique en colonnes Splunk montrant les 10 principaux quartiers de prise en charge" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="Graphique en barres Splunk montrant le tarif moyen selon le nombre de passagers" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="Tableau de bord Splunk final avec plusieurs visualisations des données de taxis de New York" />
