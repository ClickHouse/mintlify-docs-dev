...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_01.png" alt="Page de connexion à Mitzu avec des champs e-mail et mot de passe" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_02.png" alt="Page de configuration de l’espace de travail Mitzu montrant les étapes d’onboarding" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_03.png" alt="Page de configuration de la connexion Mitzu à ClickHouse avec formulaire de configuration" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_04.png" alt="Interface de sélection des tables Mitzu affichant les tables de la base de données" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_05.png" alt="Configuration du catalogue d’événements Mitzu affichant les options de mappage des colonnes" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_06.png" alt="Interface de requête de segmentation Mitzu avec sélection d’événements et configuration de la période" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_07.png" alt="Vue d’analyse de funnel Mitzu montrant les taux de conversion entre les étapes" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_08.png" alt="Analyse de rétention Mitzu montrant les taux de rétention des cohortes" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_09.png" alt="Visualisation de parcours Mitzu montrant le flux du parcours utilisateur entre les événements" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_10.png" alt="Tableau de bord d’analyse du chiffre d’affaires de Mitzu affichant les métriques de MRR" border />
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_11.png" alt="Vue de génération du code SQL de Mitzu montrant une requête ClickHouse native" border />
