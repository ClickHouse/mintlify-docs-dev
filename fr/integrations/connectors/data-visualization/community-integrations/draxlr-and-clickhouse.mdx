...
<Image size="md" img="/images/integrations/data-visualization/draxlr_01.png" alt="Formulaire de connexion Draxlr affichant les options de configuration de la base de données ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/draxlr_02.png" alt="Interface d’exploration des données Draxlr affichant des filtres et des options de tri" border />

4. Vous pouvez également utiliser le bouton **Graph** et sélectionner le type de graphique pour visualiser les données.

<Image size="md" img="/images/integrations/data-visualization/draxlr_05.png" alt="Options de visualisation de graphiques Draxlr pour les données ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/draxlr_03.png" alt="Interface de requête SQL de Draxlr pour ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/draxlr_04.png" alt="Boîte de dialogue d’enregistrement de requête Draxlr avec options de tableau de bord" border />
...
<Image size="md" img="/images/integrations/data-visualization/draxlr_06.png" alt="Interface de gestion des tableaux de bord Draxlr" border />
