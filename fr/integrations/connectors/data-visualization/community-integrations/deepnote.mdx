...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="Vignette d’intégration ClickHouse" border />

2. Saisissez les informations de connexion de votre instance ClickHouse :

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="Boîte de dialogue des détails de ClickHouse" border />

***REMARQUE :*** Si votre connexion à ClickHouse est protégée par une IP Access List, vous devrez peut-être autoriser les adresses IP de Deepnote. Pour en savoir plus, consultez la [documentation de Deepnote](https://docs.deepnote.com/integrations/authorize-connections-from-deepnote-ip-addresses).
