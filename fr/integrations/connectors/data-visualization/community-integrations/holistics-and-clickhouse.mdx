...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="Emplacement du bouton Connect dans la console ClickHouse Cloud" border />
  </Step>
  ...
  <Step>
    ...
    1. **Connexion directe (recommandée) :** autorisez les adresses IP de Holistics dans votre firewall ou dans l’IP Access List de ClickHouse Cloud. Vous trouverez la liste des IP dans le [guide IP Whitelisting](https://docs.holistics.io/docs/connect/ip-whitelisting).
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="Exemple d’autorisation d’IP dans ClickHouse Cloud" border />
  ...
  <Step>
    ...
    1. Dans Holistics, accédez à **Settings → sources de données**.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="Accès à sources de données dans les paramètres de Holistics" border />

    2. Cliquez sur **New Data Source** et sélectionnez **ClickHouse**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="Sélection de ClickHouse dans la liste des nouvelles sources de données" border />
    ...
    3. Remplissez le formulaire avec les informations recueillies à l’étape 1.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="Saisie des détails de connexion ClickHouse dans Holistics" border />

    4. Cliquez sur **Test Connection**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Test de connexion ClickHouse réussi dans Holistics" border />
