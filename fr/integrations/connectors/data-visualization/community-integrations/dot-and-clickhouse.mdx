...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Configuration de la connexion ClickHouse dans Dot (mode clair)" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="Connexion à ClickHouse" size="sm" />
