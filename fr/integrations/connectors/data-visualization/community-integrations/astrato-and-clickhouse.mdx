...
<Image size="sm" img="/images/integrations/data-visualization/astrato_1_dataconnection.png" alt="Connexion de données Astrato" border />

* Sélectionnez **ClickHouse**.

<Image size="sm" img="/images/integrations/data-visualization/astrato_2a_clickhouse_connection.png" alt="Connexion de données ClickHouse Astrato" border />

* Renseignez les champs requis dans la boîte de dialogue de connexion

<Image size="sm" img="/images/integrations/data-visualization/astrato_2b_clickhouse_connection.png" alt="Champs requis pour connecter Astrato à ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/astrato_3_user_access.png" alt="Accès utilisateur pour connecter Astrato à ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4a_clickhouse_data_view.png" alt="Astrato se connecter à ClickHouse Accès utilisateur" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4b_clickhouse_data_view_joins.png" alt="Astrato se connecter à ClickHouse Accès utilisateur" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4c_clickhouse_completed_data_view.png" alt="Astrato se connecter à ClickHouse Accès utilisateur" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5a_clickhouse_build_chart.png" alt="Astrato : se connecter à l’accès utilisateur ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5b_clickhouse_view_sql.png" alt="Connexion d’Astrato à ClickHouse accès utilisateur" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5c_clickhouse_complete_dashboard.png" alt="Connexion d’Astrato à ClickHouse — Accès utilisateur" border />