...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="Interface de tableau de bord Databrain affichant une visualisation de données ClickHouse" border />
...
<div id="2-allow-databrain-ip-addresses">
  ### 2. Autoriser les adresses IP de Databrain (si nécessaire)
</div>
...
<div id="3-add-clickhouse-as-a-data-source">
  ### 3. Ajouter ClickHouse comme source de données dans Databrain
</div>
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Menu Data Sources de Databrain" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="Sélection du connecteur Databrain affichant l’option ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Formulaire de connexion ClickHouse de Databrain avec champs de configuration" border />
...
<div id="4-configure-user-permissions">
  ### 4. Configurer les autorisations de l’utilisateur
</div>
...
Remplacez `your_databrain_user` et `your_database` par votre nom d’utilisateur réel et le nom de votre base de données.
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="Explorateur de données Databrain affichant des tables ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="Tableau de bord Databrain avec plusieurs visualisations ClickHouse" border />
...
* [Créer des tableaux de bord](https://docs.usedatabrain.com/guides/dashboards/create-a-dashboard)
* [Créer des métriques](https://docs.usedatabrain.com/guides/metrics/create-metrics)