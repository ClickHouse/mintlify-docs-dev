...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="Interface d’exploration de données Hashboard montrant un générateur de requêtes interactif et une visualisation" border />
