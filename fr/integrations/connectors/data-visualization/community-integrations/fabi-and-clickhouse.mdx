...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="Plateforme Fabi.ai d’exploration de données et de workflows" border />
...
1. Lors de la création de votre compte, il vous sera demandé de connecter votre base de données. Si vous avez déjà un compte, cliquez sur le panneau des sources de données à gauche de n’importe quel Smartbook, puis sélectionnez Add Data Source.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="Ajouter une source de données" border />

2. Il vous sera ensuite demandé de saisir vos informations de connexion.

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="Formulaire d’identifiants ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="Interroger ClickHouse" border />
