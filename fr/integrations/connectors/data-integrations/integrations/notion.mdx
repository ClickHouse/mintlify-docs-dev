...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="Sélection de ClickHouse dans le sélecteur Add connection de Notion" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="La connexion ClickHouse développée dans Notion, avec les bascules par outil" />
