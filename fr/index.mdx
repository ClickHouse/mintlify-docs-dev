    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                ...
                <CodeBlock language="bash">{`claude mcp add --transport http clickhouse-docs https://clickhouse.com/docs/mcp --scope user`}</CodeBlock>
            </Tab>
...
<style>
  {`
      ...
      /* Masquer immédiatement la barre latérale sur la page d’accueil (évite l’effet de scintillement) */
      ...
      #navbar-transition-maple {
        ...
        /* Correspondre au remplissage droit de la barre de navigation (3rem) */
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plateforme open-source d’ingénierie LLM pour l’observabilité, les métriques, les évaluations et la gestion des prompts." href="https://langfuse.com/docs" showArrow />
