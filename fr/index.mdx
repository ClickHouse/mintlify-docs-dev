...
export const HeroCard = ({ filename, darkFilename: darkFilenameProp, title, description, body, href, links, icon, showArrow, external, arrowBottom, extraClassName, logo, logoInvert, overlayImg, fullWidthImage, imageHeight = 'h-48' }) => {
...
export const HighlightedClickHouse = () => {
    ...
    return (
        <span className="relative inline-block px-8 py-3 -ml-4">
            <img src={`${assetBase}/images/highlight-lightmode.png`} className="block dark:hidden absolute top-0 right-0 bottom-0 left-[10px] w-full h-full object-fill pointer-events-none select-none" alt="" aria-hidden="true" />
            <img src={`${assetBase}/images/highlight-darkmode.png`} className="hidden dark:block absolute top-0 right-0 bottom-0 left-[10px] w-full h-full object-fill pointer-events-none select-none" alt="" aria-hidden="true" />
...
<style>
  {`
            ...
            /* Masquer immédiatement la barre latérale sur la page d'accueil (évite l'effet de flash) */
            #sidebar { display: none !important; }
            /* Faire en sorte que la barre de navigation occupe toute la largeur puisque la barre latérale est masquée */
            #navbar-transition-maple {
              width: 100vw !important;
              left: 0 !important;
              margin-left: 0 !important;
              /* Faire correspondre le padding gauche au padding droit de la barre de navigation (3rem) */
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="mx-auto px-4 -mt-5 text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
        Documentation de la base de données analytique la plus rapide
      </div>

      <div className="flex items-center justify-center gap-3 mx-auto mt-8">
        <button type="button" id="home-search-entry" className="flex pointer-events-auto items-center text-sm leading-6 h-9 pl-3.5 pr-3 text-gray-500 dark:text-white/50 dark:brightness-[1.1] dark:hover:brightness-[1.25] justify-between truncate gap-2 min-w-[43px] w-[320px] bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 shadow-none border border-white/10 ring-0 dark:ring-0 rounded" aria-label="Ouvrir la recherche">
        ...
        <button type="button" className="flex-none hidden lg:flex items-center justify-center gap-1.5 pl-3 pr-3.5 h-9 shadow-none bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 border border-white/10 rounded" id="home-assistant-entry" aria-label="Ouvrir l’assistant IA" onClick={() => {
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        <HeroCard
          title="Prise en main"
          description="Je suis nouveau ici, je veux commencer et en savoir plus"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Qu’est-ce que ClickHouse ?", href: "/get-started/about/intro" },
        { label: "Installation", href: "/get-started/setup/cloud" },
        { label: "Guides de démarrage rapide", href: "/get-started/quickstarts/home" },
        { label: "Concepts ClickHouse", href: "/concepts/core-concepts/index" },
        { label: "Jeux de données d’exemple", href: "/get-started/sample-datasets/index" },
        { label: "Guides de migration", href: "/get-started/migrate/overview" },
        { label: "Bonnes pratiques", href: "/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "Modélisation des données", href: "/guides/clickhouse/data-modelling/schema-design" },
        { label: "Optimisation des performances", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/products/cloud/guides" },
        { label: "Cas d’usage", href: "/guides/use-cases" }
    ]}
        />

        <HeroCard
          title="Référence"
          description="Je sais ce que je veux faire - j’ai juste besoin des détails"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Référence SQL", href: "/reference/statements" },
        { label: "Paramètres", href: "/reference/settings/index" },
        { label: "Fonctions", href: "/reference/functions/regular-functions/overview" },
        { label: "Moteurs", href: "/reference/engines/engines" },
        { label: "Tables système", href: "/reference/system-tables" },
        { label: "Formats", href: "/reference/formats/index" },
        { label: "Types de données", href: "/reference/data-types/index" }
    ]}
        />
        ...
        { label: "ClickHouse Cloud", href: "/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/products/managed-postgres/overview" },
        { label: "Operator Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Découvrez comment ClickHouse propulse l&#39;analytique en temps réel, l&#39;observabilité, l&#39;entreposage de données et l&#39;IA agentique à n&#39;importe quelle échelle.</p>

      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analyses en temps réel" description="Obtenez des insights et des dashboards instantanés à grande échelle. Analysez des milliards de lignes en temps réel avec des résultats en quelques millisecondes." href="/fr/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilité" description="Stockez et interrogez logs, métriques et traces à grande échelle avec ClickStack, la stack d'observabilité open source propulsée par ClickHouse." href="/fr/clickstack/overview" showArrow />

        <HeroCard title="Entrepôt de données" description="Analysez et explorez instantanément vos données pour en tirer des insights et alimenter vos applications. Passez plus rapidement à l'échelle en déchargeant les workloads les plus lourds." href="/fr/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analytique agentique" description="Permettez à des agents IA d'interroger directement vos données en temps réel pour fournir instantanément des insights conversationnels et des visualisations" href="/fr/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        {/* 1re ligne : ClickHouse Cloud (col-span-2) + 3 cartes empilées (col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              href="/fr/products/cloud/getting-started/intro"
              extraClassName="h-full"
              body={<>
  <p className="text-[#6b7280] dark:text-[#a1a1aa] mt-2 text-sm leading-[1.6]">
      Cette section montre comment ClickHouse rend le data warehousing rapide, simple et prévisible. Au lieu de vous débattre avec des pipelines fragiles et des moteurs de requête lents, vous centralisez les données de vos applications, services et outils en quelques minutes plutôt qu’en quelques semaines. Vous pouvez ensuite alimenter des dashboards en temps réel, déclencher des alertes, analyser les tendances historiques et créer des produits pilotés par les événements sur une seule et même plateforme.
  </p>
</>}
              links={[
  { label: "Comment ingérer des données depuis des sources courantes avec un minimum d'effort", href: "/integrations" },
  { label: "Bonnes pratiques pour organiser les données au service de l’analytics et de la croissance", href: "/guides/clickhouse/data-modelling/schema-design" },
  { label: "Comment interroger de grands jeux de données en temps réel", href: "/get-started/use-cases/real-time-analytics" },
  { label: "Comment créer des dashboards, des alertes et des fonctionnalités pilotées par les événements", href: "/get-started/use-cases/data-warehousing" },
  { label: "Conseils pour maîtriser les coûts sans compromettre les performances", href: "/concepts/best-practices/index" },
]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="La stack d’observabilité tout-en-un propulsée par ClickHouse, qui vous offre des requêtes ultra-rapides et de puissantes agrégations sur les logs, metrics, traces, session replays et erreurs." href="/fr/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="Service Postgres rapide, évolutif et taillé pour l’entreprise, intégré nativement à ClickHouse. Combinez facilement Postgres pour les transactions et ClickHouse pour l’analytics." href="/fr/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-integration.svg" logoInvert title="Integrations" description="Plus de 100 intégrations pour connecter à ClickHouse les outils et services que vous utilisez déjà." href="/fr/integrations/home" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>

        {/* Ligne 2 : 3 cartes de même taille */}

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plateforme open-source d’ingénierie LLM pour l’observabilité, les métriques, les évaluations et la gestion des prompts." href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.png" title="Opérateur Kubernetes" description="Automatise le déploiement, la configuration et la gestion des clusters ClickHouse et ClickHouse Keeper sur Kubernetes." href="/fr/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="Une base de données in-process rapide, fiable et évolutive. Découvrez la puissance de ClickHouse en mode in-process." href="/fr/products/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">Configurer le serveur MCP de la documentation</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Interrogez directement la documentation de ClickHouse depuis vos outils d’IA via le Model Context Protocol.</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Ajoutez les skills ClickHouse à votre agent de développement</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Installez les skills ClickHouse pour donner à votre agent une expertise de ClickHouse et les bonnes pratiques associées.</p>
