...
<Steps>
  ...
  <Step>
    ...
    **Il ne vous sera pas demandé de créer un utilisateur, car l’authentification n’est pas activée dans ce mode de déploiement.**
    ...
    <Image img="/images/use-cases/observability/hyperdx-2.png" alt="Créer une connexion" size="md" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-logs.png" alt="Créer une source de logs" size="md" />
  </Step>
</Steps>
