  ...
  <Tab title="Utiliser un service existant">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="Sélectionner un service" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/clickstack-ui-setup-ingestion.png" alt="Configurer l’ingestion dans l’interface utilisateur de ClickStack" size="lg" />
        ...
        <Image img="/images/clickstack/select-source-clickstack-ui.png" size="lg" alt="Sélection de la source - ClickStack UI" border />
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/otel-collector-start-clickstack-ui.png" size="md" alt="source du collecteur OTel" />
            ...
            **Modifiez cette commande avec les identifiants de votre service, enregistrés lors de la création de celui-ci.**
            ...
            <Image img="/images/clickstack/advanced-otel-collector-clickstack-ui.png" size="lg" alt="source avancée du collecteur OTel" />
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/vector-config-clickstack-ui.png" size="lg" alt="Configuration de Vector" />
      ...
      <Step>
        ...
        <Tabs>
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/create-vector-datasource.png" alt="Créer une source de données - Vector" size="lg" />
...
<Image img="/images/clickstack/read-only-access.png" alt="ClickHouse Cloud Lecture seule" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx_cloud_datasource.png" alt="Source de données HyperDX ClickHouse Cloud" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx_create_new_source.png" alt="ClickStack créer une nouvelle source" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx_create_trace_datasource.png" alt="ClickStack créer une source de traces" size="lg" />
