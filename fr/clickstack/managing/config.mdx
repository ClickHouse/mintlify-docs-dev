...
<Image img="/images/use-cases/observability/hyperdx-25.png" alt="Configuration de la source HyperDX" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-config.png" alt="Configuration des Highlighted Attributes" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-search.png" alt="Recherche des Highlighted Attributes" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-26.png" alt="Source corrélée HyperDX" size="md" />
