...
<Image img="/images/materialized-view/materialized-view-diagram.png" size="md" alt="Schéma d’une vue matérialisée" />
...
<Image img="/images/clickstack/materialized_views/generated_sql.png" size="lg" alt="SQL généré" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/edit_source.png" size="lg" alt="Modifier les sources" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/add_view.png" size="lg" alt="Modifier les sources" />
  </Step>
  ...
  <Step>
    ...
    * la colonne d’agrégation correspondante dans la vue matérialisée, par exemple `avg__Duration`
    ...
    <Image img="/images/clickstack/materialized_views/select_metrics.png" size="lg" alt="Sélectionner les métriques" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_time_granularity.png" size="lg" alt="Sélectionner la granularité temporelle" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_min_time.png" size="lg" alt="Sélectionner l’heure minimale" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/save_source.png" size="lg" alt="Enregistrer la source" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/materialized_views/accelerated_visual.png" size="lg" alt="Visualisation accélérée" />
