...
<Tabs>
  <Tab title="Utilisateurs et rôles Cloud">
    <Image img="/images/clickstack/rbac/team-page-cloud.png" alt="Page Utilisateurs et rôles de ClickHouse Cloud" size="lg" />
  </Tab>

  <Tab title="ClickStack Team Settings">
    <Image img="/images/clickstack/rbac/team-page-clickstack.png" alt="Page ClickStack Team Settings affichant les membres de l’équipe et leurs rôles" size="lg" />
  </Tab>
</Tabs>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/rbac/add-role-modal.png" alt="Boîte de dialogue Add Role" size="md" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/rbac/default-vs-fine-grained.png" alt="Modes Accès par défaut et Contrôles granulaires dans l’éditeur de rôle" size="md" />
...
<Image img="/images/clickstack/rbac/condition-tip.png" alt="Infobulle de condition : faire correspondre les ressources par nom ou par tag (indiqué par le titre), ou par ID (visible dans l’URL)" size="md" />
...
<Image img="/images/clickstack/rbac/dashboard-id-and-tag-example.png" alt="Dashboard montrant l’ID de la ressource dans la barre d’URL et un tag dans l’angle supérieur droit" size="lg" />
...
<Image img="/images/clickstack/rbac/access-rules-tip.png" alt="Infobulle des règles d’accès avec logique OR" size="md" />
...
<Image img="/images/clickstack/rbac/dashboard-fine-grained-example.png" alt="Deux règles d’accès granulaires reliées par OR : Name contains testing avec accès Read, et Tag is testing avec accès Read" size="md" />
