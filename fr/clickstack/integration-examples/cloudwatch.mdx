...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="API key ClickStack" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="Vue de recherche des logs" />
    ...
    * `Body` : le contenu réel du message de log
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="Valeurs de colonne des logs d’erreur" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="Vue de recherche de démonstration" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/fr/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Télécharger</TrackedLink> la configuration du tableau de bord
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="Boîte de dialogue de fin d’import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="Tableau de bord CloudWatch Logs" />
