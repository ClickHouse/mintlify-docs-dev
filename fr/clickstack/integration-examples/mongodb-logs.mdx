...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="vue Search des logs MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="vue détaillée d’un log MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="Terminer l'importation du tableau de bord des logs MongoDB" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="Tableau de bord des logs MongoDB" />
  </Step>
</Steps>
