...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Métriques Temporal" size="md" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/fr/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">Télécharger</TrackedLink> la configuration du tableau de bord
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Bouton Import Dashboard" />

    3. Téléversez le fichier `temporal-metrics-dashboard.json`, puis cliquez sur **Finish Import**

    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="Boîte de dialogue Finish Import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Tableau de bord des métriques Temporal" />
  </Step>
</Steps>
