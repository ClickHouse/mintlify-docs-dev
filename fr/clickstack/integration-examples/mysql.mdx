...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="Vue Search" />

    <Image img="/images/clickstack/mysql/log-view.png" alt="Vue Log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/finish-import.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/example-dashboard.png" alt="Exemple de tableau de bord" />
