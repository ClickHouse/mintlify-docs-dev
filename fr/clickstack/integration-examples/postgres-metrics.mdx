...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="Boîte de dialogue de finalisation de l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="Tableau de bord des métriques PostgreSQL" />
