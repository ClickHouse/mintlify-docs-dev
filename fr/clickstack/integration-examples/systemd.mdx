...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Vue de recherche des logs" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="Vue des logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    * Les taux d’erreur
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Exemple de tableau de bord" />
