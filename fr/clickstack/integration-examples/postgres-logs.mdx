...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Vue Search des logs" />

    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="Vue Log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="Vue d’un log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Bouton d’importation de tableau de bord" />

    3. Téléversez le fichier `postgresql-logs-dashboard.json` et cliquez sur **Terminer l’importation**

    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="Tableau de bord des logs" />
