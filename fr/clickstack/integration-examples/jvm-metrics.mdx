...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="Clé API ClickStack" />
  </Step>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/fr/examples/jvm-metrics-dashboard.json'} download="jvm-metrics-dashboard.json" eventName="docs.kafka_metrics_monitoring.dashboard_download">Télécharger</TrackedLink> la configuration du tableau de bord
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Bouton d’importation du tableau de bord" />

    3. Téléversez le fichier `jvm-metrics-dashboard.json` et cliquez sur **Finish Import**

    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Tableau de bord des métriques Kafka" />
