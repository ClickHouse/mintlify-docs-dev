...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="Boîte de dialogue de fin d’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Tableau de bord Redis Metrics" />
