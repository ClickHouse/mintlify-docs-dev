...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="Vue Search des logs EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="Détail d’un log EC2 affichant les métadonnées" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="Vue de recherche des logs EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="Détail d’un log EC2 avec métadonnées" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/fr/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Télécharger</TrackedLink> la configuration du tableau de bord
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Bouton d’import du tableau de bord" />

    3. Téléversez le fichier `host-logs-dashboard.json` et cliquez sur **Terminer l’import**

    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Terminer l’import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Tableau de bord des logs EC2" />
...
Ce guide installe l’OpenTelemetry Collector directement sur des instances EC2, ce qui correspond au modèle recommandé en production pour la supervision au niveau de l’hôte. Pour gérer des collectors sur un grand nombre d’instances, envisagez d’utiliser des outils de gestion de configuration (Ansible, Chef, Puppet) ou l’OpenTelemetry Operator dans des environnements Kubernetes. Consultez [Envoyer des données OpenTelemetry](/fr/clickstack/ingesting-data/opentelemetry) pour la configuration de production.