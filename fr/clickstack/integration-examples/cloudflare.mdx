...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="Ajouter une source" />
    ...
    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="Configurer les champs facultatifs" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="Enregistrer la source" />
  ...
  <Step>
    ...
    * Des attributs sur lesquels vous pouvez effectuer des recherches, comme `http.status_code`, `client.country`, `cache.status` et `bot.score`
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Vue Search" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Vue Log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Vue de recherche" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Vue des logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="Importer un tableau de bord" />

    2. Téléversez `cloudflare-logs-dashboard.json` → **Finish Import**

    <Image img="/images/clickstack/cloudflare/finish-import.png" alt="Importer un tableau de bord" />
  </Step>

  <Step>
    #### Afficher le tableau de bord

    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="Exemple de tableau de bord" />
