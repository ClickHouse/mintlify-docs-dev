...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Afficher les traces" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Voir les traces" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/fr/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">Télécharger</TrackedLink> la configuration du tableau de bord
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Importer le tableau de bord" />

    3. Téléversez le fichier nginx-trace-dashboard.json, puis cliquez sur Finish Import.

    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="Exemple de tableau de bord" />
  </Step>
</Steps>
