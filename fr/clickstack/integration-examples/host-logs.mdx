...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="Vue Search" />

    <Image img="/images/clickstack/host-logs/log-view.png" alt="Vue Log" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Terminer l’importation" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Tableau de bord des logs" />
