...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Vue de recherche des traces" />

    Cliquez sur une trace pour afficher la vue détaillée avec les spans, les durées et les attributs :

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Vue d’une trace individuelle" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Importer un tableau de bord" />

    3. Téléversez le fichier `nodejs-traces-dashboard.json`, puis cliquez sur **Finish Import**

    <Image img="/images/clickstack/nodejs/finish-import.png" alt="Terminer l’import" />
  </Step>

  <Step>
    #### Le tableau de bord sera créé avec toutes les visualisations préconfigurées

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="Exemple de tableau de bord" />
