...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Vue Search" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="Vue des logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Finaliser l’importation du tableau de bord des logs Kafka" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Exemple de tableau de bord des logs Kafka" />
  </Step>
</Steps>
