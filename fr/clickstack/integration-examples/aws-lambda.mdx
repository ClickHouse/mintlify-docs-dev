...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/lambda/lambda-log-view.png" alt="Vue des logs Lambda" />

    <Image img="/images/clickstack/lambda/lambda-log.png" alt="Détail des logs Lambda" />
