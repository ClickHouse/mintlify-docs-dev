...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-search-with-k8-logs.png" size="lg" alt="Vue Search de ClickStack avec les logs Kubernetes" />
    ...
    <Image img="/images/use-cases/observability/clickstack-dashboard-kubernetes.png" size="lg" alt="Tableau de bord Kubernetes de ClickStack" border />
