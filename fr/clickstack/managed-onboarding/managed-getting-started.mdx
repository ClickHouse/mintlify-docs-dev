...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/getting-started/hackernews_main.png" alt="L’application Analyseur HackerNews exécutée localement" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-first-time.png" size="lg" alt="Lancer ClickStack" border />
