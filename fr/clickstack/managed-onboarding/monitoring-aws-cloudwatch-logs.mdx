...
<Steps>
  ...
  <Step>
    ## Configurer le receiver CloudWatch
  ...
  <Step>
    ## Démarrer le collector receiver
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-v2.png" size="lg" alt="Lancer ClickStack" border />
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view-clickstack.png" size="lg" alt="Vue Search de ClickStack avec les logs CloudWatch" />
    ...
    * `Body` : la ligne de log d’origine
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-attributes-clickstack.png" size="lg" alt="Vue Search de ClickStack avec les logs CloudWatch et les attributs" />

    Sélectionnez une entrée de log pour inspecter ses métadonnées :

    <Image img="/images/clickstack/cloudwatch/error-log-column-values-clickstack.png" size="lg" alt="Attributs CloudWatch dans la vue détaillée du log" />
  ...
  <Step>
    ## Importer le dashboard CloudWatch (facultatif)
    ...
    <TrackedLink href={'/fr/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Télécharger `cloudwatch-logs-dashboard.json`</TrackedLink>, puis, dans la ClickStack UI, accédez à **Dashboards** et cliquez sur **Import**.

    <Image img="/images/clickstack/clickstack-import-dashboard.png" size="lg" alt="Bouton d’importation du dashboard" />

    Téléversez le fichier JSON, puis cliquez sur **Finish Import**.

    <Image img="/images/clickstack/cloudwatch/finish-clickstack-import.png" size="lg" alt="Boîte de dialogue de finalisation de l’importation" />
  </Step>
