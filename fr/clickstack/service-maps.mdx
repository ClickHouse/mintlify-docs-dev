...
<Image img="/images/clickstack/service-maps/service-map-overview.png" alt="Carte de services montrant les nœuds de service et le flux des requêtes entre eux" size="lg" />
...
<Image img="/images/clickstack/service-maps/source-selector.png" alt="Sélecteur de source mis en évidence dans la barre d’outils de la carte de services" size="lg" />
...
<Image img="/images/clickstack/service-maps/sampling.png" alt="Curseur d’échantillonnage mis en évidence dans la barre d’outils de la carte de services" size="lg" />

**Sélecteur de plage de dates** — définissez la fenêtre temporelle des données de trace utilisées pour créer la carte.

<Image img="/images/clickstack/service-maps/date-selector.png" alt="Sélecteur de plage de dates mis en évidence dans la barre d’outils de la carte de services" size="lg" />
