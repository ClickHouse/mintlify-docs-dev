...
<Tabs>
  <Tab title="ClickStack managé">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="Sélectionner le service" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="Logs locaux HyperDX" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Mémoire au fil du temps" size="lg" />

        Notez que la valeur renvoyée est un `%` en virgule flottante. Pour l’afficher plus clairement, sélectionnez `Set number format`.

        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Format de nombre" size="lg" />

        Dans le menu suivant, vous pouvez sélectionner `Percentage` dans la liste déroulante `Output format`, puis cliquer sur `Apply`.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="% de mémoire au fil du temps" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory au fil du temps" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Format numérique" size="lg" />

    Dans le menu qui s&#39;affiche, sélectionnez `Percentage` dans le menu déroulant `Output format`, puis cliquez sur `Apply`.

    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Pourcentage de mémoire au fil du temps" size="lg" />
  </Tab>
</Tabs>