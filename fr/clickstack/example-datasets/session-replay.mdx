...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="Application de démonstration de rejeu de session" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Recherche de rejeu de session" />
    ...
    <Image img="/images/clickstack/session-replay/session-replay.png" alt="Rejeu de session" />
