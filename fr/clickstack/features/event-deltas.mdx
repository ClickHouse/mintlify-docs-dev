...
<Image img="/images/clickstack/event-deltas/overview.png" alt="Vue d’ensemble d’Event deltas sur le service de paiement, avec la bande lumineuse qui monte au milieu de la fenêtre et aucune récupération visible dans le cadre" size="lg" />
...
<Image img="/images/clickstack/event-deltas/before-after.png" alt="Mode de comparaison sur le service de paiement avec le rectangle tracé depuis le point d’inflexion de la hausse jusqu’au bord droit, le bas reposant sur la baseline de 1 ms" size="lg" />
...
<Image img="/images/clickstack/event-deltas/slow-vs-fast.png" alt="Comparaison lent/rapide sur frontend-proxy avec un rectangle couvrant uniquement la bande supérieure nettement séparée, bien à l’écart de la masse dense" size="lg" />
...
<Image img="/images/clickstack/event-deltas/drill-down.png" alt="Cliquer sur le popover d'une barre ScopeVersion affichant les pourcentages Selection vs Background et les actions filtrer, exclure, copier" size="lg" />
...
<Image img="/images/clickstack/event-deltas/settings-drawer.png" alt="Drawer Display Settings avec les champs Scale, Value et Count" size="lg" />
