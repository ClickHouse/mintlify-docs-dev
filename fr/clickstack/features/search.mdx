...
<Image img="/images/use-cases/observability/clickstack-saved-search-listing.png" alt="Page listant les recherches enregistrées" size="lg" />
...
<Image img="/images/use-cases/observability/clickstack-saved-search.png" alt="Enregistrement d’une recherche" size="md" />
