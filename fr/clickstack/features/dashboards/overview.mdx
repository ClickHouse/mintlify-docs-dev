...
<Steps>
  ...
  <Step>
    ...
    * Alias : `Average Time`
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-2.png" alt="Visualisation simple" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-3.png" alt="Visualisation simple 2" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-duplicate-series.png" alt="L'icône de copie Duplicate series et son infobulle sur une ligne de série de graphique" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-1.png" alt="Créer un tableau de bord" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Alias : `Average Time`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-2.png" alt="Créer une visualisation pour le tableau de bord" size="lg" />

    Redimensionnez la visualisation pour qu’elle occupe toute la largeur du tableau de bord.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-3.png" alt="Tableau de bord avec des visualisations" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Alias : `Count of events`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-4.png" alt="Visualisation du dashboard 2" size="lg" />

    Redimensionnez la visualisation pour qu&#39;elle occupe toute la largeur du dashboard.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-5.png" alt="Dashboard avec visualisations 2" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Count** : `count()`
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-editor.png" alt="Éditeur de tuile Heatmap avec les valeurs par défaut de durée de span préremplies, le filtre ServiceName payment et le bouton Display Settings" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-rendered.png" alt="Tuile de dashboard Heatmap montrant la distribution de durée des spans du service payment sur 24 heures" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-drilldown.png" alt="Clic sur une cellule de heatmap révélant l’action View in Event Deltas" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-filter.png" alt="Tableau de bord avec filtrage" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-save.png" alt="Enregistrement du tableau de bord" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-edit.png" alt="Modifier le tableau de bord" size="lg" />
...
<Image img="/images/clickstack/dashboards/number-tile-background-chart.png" alt="Volet Paramètres d’affichage pour une tuile Number, avec Graphique d’arrière-plan défini sur Zone" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-search.png" alt="Recherche de tableau de bord" size="lg" />
...
<Image img="/images/clickstack/dashboards/filter-dropdown.png" alt="Filtre déroulant des services affichant les noms de service disponibles" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/edit-filters.png" alt="Bouton Edit Filters dans la barre d’outils du tableau de bord" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/add-filter.png" alt="Boîte de dialogue Add filter avec les champs Name, Data source et Filter expression" size="md" />
    ...
    <Image img="/images/clickstack/dashboards/saved-filters.png" alt="Fenêtre modale Filters affichant un filtre Services configuré" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/filtered-dashboard.png" alt="Tableau de bord filtré sur le service frontend" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/save-filter-values.png" alt="Menu du tableau de bord affichant l’option Save Query and Filters as Default" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/drilldown.png" alt="Menu contextuel d’exploration détaillée affichant les options Afficher tous les événements et Filtrer par groupe" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-clickhouse.png" alt="Tableau de bord ClickHouse" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-services.png" alt="Services ClickHouse" size="lg" />
