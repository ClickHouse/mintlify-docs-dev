...
<Image img="/images/use-cases/observability/browse-dashboard-template.png" alt="Bouton Parcourir les modèles de tableaux de bord" size="lg" />
...
<Image img="/images/use-cases/observability/dashboard-template-gallery.png" alt="Galerie de modèles de tableaux de bord" size="lg" />
...
<Image img="/images/use-cases/observability/import-dashboard-template.png" alt="Importation d’un modèle de tableau de bord" size="lg" />
...
<div id="otel-runtime-metrics">
  ### Métriques runtime OTel
</div>

Les modèles intégrés OTel Runtime Metrics sont conçus pour les applications instrumentées avec les [métriques runtime OpenTelemetry](https://opentelemetry.io/docs/specs/semconv/runtime/).

| Modèle                      | Description                                                                                                                  |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **.NET Runtime Metrics**    | Collections du GC, taille du tas, utilisation du pool de threads et nombre d’assemblys pour les applications .NET            |
...
| **Node.js Runtime Metrics** | Latence de la boucle d’événements, utilisation du tas, utilisation du CPU et mémoire V8 pour les applications Node.js        |
...
* Chaque modèle est configuré avec un [filtre personnalisé](/fr/clickstack/features/dashboards/overview#custom-filters) pour les services dont l’attribut de ressource [`telemetry.sdk.language`](https://opentelemetry.io/docs/specs/semconv/registry/attributes/telemetry/#telemetry-sdk-language) correspond au runtime du tableau de bord.
  * Les environnements avec des schémas de tables de métriques ClickHouse personnalisés peuvent devoir ajuster ce filtre pour interroger les bonnes colonnes Service Name et Resource Attributes.
