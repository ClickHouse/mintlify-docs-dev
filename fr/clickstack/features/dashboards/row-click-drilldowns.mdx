...
<Steps>
  ...
  <Step>
    ...
    * `P95 Duration` : 95e centile de `Duration`. Définissez le format numérique de la colonne sur une durée afin qu’elle s’affiche comme `288ms`, et non en nanosecondes brutes.
    ...
    <Image img="/images/clickstack/dashboards/row-click-catalog.png" alt="Table d’inventaire des services avec colonnes RED (Requests, Errors, P95 Duration) pour chaque service, triée par volume de requêtes, au-dessus d’une tendance des requêtes dans le temps" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/row-click-drilldown.png" alt="Tableau de bord Service Detail après un clic sur une ligne, avec le filtre ServiceName défini sur le service cliqué et les indicateurs clés RED, les percentiles de latence et la ventilation par endpoint tous limités à celui-ci" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/row-click-search-drilldown.png" alt="Page Search ouverte sur la source de traces après un clic sur une ligne, filtrée sur le service sélectionné" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/row-click-drawer.png" alt="Panneau Row Click Action en mode Dashboard, avec le tableau de bord Service Detail sélectionné comme cible et un filtre ServiceName généré à partir de la ligne cliquée" size="lg" />
