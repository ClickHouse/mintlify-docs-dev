...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Vue de recherche des relectures de session" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="Lecture d’une relecture de session" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="Explorer les traces backend dans ClickStack à partir d’une relecture de session" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Vue de trace de Relecture de session" size="lg" />
