...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Signaux de télémétrie dans ClickStack via Bindplane" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Signaux de télémétrie dans ClickStack via Bindplane" size="lg" />
  </Step>
</Steps>
