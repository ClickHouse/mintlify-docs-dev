...
<Image img="/images/use-cases/observability/hyperdx-notebook-hero.png" alt="AI Notebook enquêtant sur une panne due à un cache Visa saturé" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-ai-consent.png" alt="Bascule Generative AI dans Team Settings" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-list.png" alt="Page de liste des notebooks" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-tiles.png" alt="Notebook avec des tuiles générées par l’IA" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branch-modal.png" alt="Boîte de dialogue Create New Branch" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branching.png" alt="Flèches de navigation entre les branches et badge 1/2 sur une tuile" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-manual-tiles.png" alt="Boutons de tuiles manuelles en bas d’un notebook" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-agent-context.png" alt="Panneau Agent Settings pour le contexte personnalisé" size="lg" />