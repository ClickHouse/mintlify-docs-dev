...
<Image img="/images/clickstack/trace-sampling-source-settings.png" alt="Champ Expression du taux d’échantillonnage dans les paramètres de la source ClickStack" size="lg" />
