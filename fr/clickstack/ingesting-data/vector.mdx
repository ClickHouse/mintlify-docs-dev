  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Lancer ClickStack pour Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Logs Nginx dans CLickStack" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack open source">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="Interface Play de ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Connexion à ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="Créer une source de données - vector" size="lg" />
  ...
  <Tab title="ClickStack managé">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Launch ClickStack pour Vector" size="lg" />
      </Step>
