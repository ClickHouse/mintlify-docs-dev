...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="Création du peer source" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="Création du peer cible" size="md" border />

Vous devriez maintenant voir les peers source et cible dans la section &quot;Peers&quot;.

<Image img="/images/managed-postgres/peerdb/peers.png" alt="Liste des peers" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="Créer un mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="Paramètres du mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="Sélecteur de tables" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="Liste des mirrors" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="Progression du chargement initial" size="md" border />
