...
<Image img="/images/managed-postgres/pgpg/overview.png" alt="Entrée Sources de données dans la barre latérale du service Managed Postgres" size="lg" border />

Cliquez sur **Démarrer l&#39;importation**.

<Image img="/images/managed-postgres/pgpg/startimport.png" alt="Page Sources de données avec le bouton Démarrer l'importation" size="lg" border />
...
L’assistant affiche une commande `pg_dump` préremplie avec les informations de connexion de votre base source. Exécutez-la dans un terminal :
...
<Image img="/images/managed-postgres/pgpg/nextimport.png" alt="Étape 3 : commande psql pour l’importation du schéma" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="Étape 5 : sélecteur de tables regroupées par schéma avec le bouton Créer la migration" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationlist.png" alt="Liste des sources de données affichant une migration en cours d’exécution" size="lg" border />
...
* [Démarrage rapide de Managed Postgres](/fr/products/managed-postgres/quickstart)
