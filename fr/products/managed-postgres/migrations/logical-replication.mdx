...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="Configuration de la réplication de la source PostgreSQL" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuration des tables PostgreSQL sources" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Création d’une instance ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Configuration initiale de la cible ClickHouse Managed Postgres" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="Résultat de la migration après la réplication logique" size="xl" border />
