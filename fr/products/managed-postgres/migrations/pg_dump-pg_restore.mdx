...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuration de la base de données source PostgreSQL" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="Exécution de la commande pg_dump" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Créer une instance ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="Exécution de la commande pg_restore" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Configuration cible de la base de données Managed Postgres" size="xl" border />
