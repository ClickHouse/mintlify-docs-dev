...
<Image img="/images/managed-postgres/create-service.png" alt="Créer un service Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/overview.png" alt="Vue d’ensemble de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Fenêtre modale Connect de Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/integration-landing.png" alt="Intégration Managed Postgres vide" size="md" border />
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="Formulaire d’intégration Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/table-picker.png" alt="Sélecteur de tables Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="Obtenir l’hôte ClickHouse" size="md" border />
...
<Image img="/images/managed-postgres/analytics-list.png" alt="Liste analytique Managed Postgres" size="md" border />

Cliquez sur le nom du service pour ouvrir la console ClickHouse et voir vos tables répliquées.

<Image img="/images/managed-postgres/replicated-tables.png" alt="Tables répliquées Managed Postgres dans ClickHouse" size="md" border />
