...
<Image img="/images/managed-postgres/connect-button.png" alt="Cliquez sur Connect dans la barre latérale gauche pour afficher les informations de connexion" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Fenêtre modale de connexion affichant les identifiants et les formats de chaîne de connexion" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Télécharger le certificat CA depuis l’onglet Settings" size="md" border />
