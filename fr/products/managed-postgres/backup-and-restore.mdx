...
<Image img="/images/managed-postgres/backup-and-restore.png" alt="Vue sauvegarde affichant l’historique des sauvegardes et les options de restauration à un instant donné" size="lg" border />
