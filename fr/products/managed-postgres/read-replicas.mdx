...
<Image img="/images/managed-postgres/warehouse-view.png" alt="Vue du warehouse avec l’icône de modification" size="md" border />
...
<Image img="/images/managed-postgres/read-replica-dialog.png" alt="Boîte de dialogue de gestion des répliques de lecture" size="md" border />
...
<Image img="/images/managed-postgres/read-replicas-flow.png" alt="Vue Flux des répliques de lecture montrant la topologie de l’instance primaire et des répliques" size="lg" border />
...
<Image img="/images/managed-postgres/read-replicas-table.png" alt="Vue Tableau des répliques de lecture" size="lg" border />
