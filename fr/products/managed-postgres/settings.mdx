...
<Image img="/images/managed-postgres/service-actions.png" alt="Service actions et mise à l’échelle" size="md" border />
...
<Image img="/images/managed-postgres/postgres-parameters.png" alt="Configuration des paramètres Postgres" size="md" border />
