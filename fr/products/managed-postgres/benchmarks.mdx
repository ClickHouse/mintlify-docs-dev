...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="Résultats du benchmark E/S intensives Lecture+écriture" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="Résultats du benchmark E/S intensives en lecture seule" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="Résultats du benchmark à forte charge CPU" size="md" border />
...
* [PeerDB : comparaison des services Postgres managés](https://blog.peerdb.io/comparing-postgres-managed-services-aws-azure-gcp-and-supabase)
* [Documentation de pgbench](https://www.postgresql.org/docs/current/pgbench.html)
* [Présentation de Managed Postgres](/fr/products/managed-postgres/overview)
