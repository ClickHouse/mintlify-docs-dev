...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Menu Utilisateurs et rôles" size="md" border />
...
<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="Sélection de l’entité Service Postgres" size="md" border />

4. Choisissez le service Postgres auquel limiter le rôle, puis sélectionnez les permissions à accorder.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="Configuration des permissions Postgres pour un rôle" size="md" border />
