...
<Image img="/images/managed-postgres/instance-types.png" alt="Types d’instance" size="md" border />
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="Paramètres de mise à l’échelle" size="md" border />
