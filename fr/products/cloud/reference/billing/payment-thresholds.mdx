...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="Où trouver la facturation dans l’UI" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="Facture" />
