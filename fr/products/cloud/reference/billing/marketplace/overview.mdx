...
Vous devrez vous abonner à ClickHouse Cloud via le marketplace de votre fournisseur cloud. Une fois l’abonnement finalisé sur le marketplace et après votre redirection vers ClickHouse Cloud, vous aurez la possibilité d’associer une organisation ClickHouse Cloud existante à la facturation via le marketplace. À partir de ce moment-là, vos ressources existantes seront facturées via le marketplace.

<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="Inscription au marketplace et association de l'organisation" border />
...
<Note>
  Vos services et organisations existants issus d’inscriptions antérieures à ClickHouse Cloud resteront inchangés et ne seront pas associés à la facturation via le marketplace.
</Note>
...
<div id="automatically-move-to-PAYG-when-running-out-of-credit">
  ### Si mon organisation ClickHouse est facturée via un contrat d&#39;engagement de dépenses sur un marketplace cloud, passerai-je automatiquement à la facturation PAYG lorsque j&#39;aurai épuisé mes crédits ?
</div>

Si votre contrat d&#39;engagement de dépenses sur le marketplace est actif et que vous épuisez vos crédits, nous ferons automatiquement passer votre organisation à la facturation PAYG. En revanche, à l&#39;expiration de votre contrat actuel, vous devrez associer un nouveau contrat de marketplace à votre organisation ou faire passer votre organisation à une facturation directe par carte de crédit.