...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="E-mail de Private Offer AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="E-mail de Private Offer AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="E-mail de Private Offer AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="Créer ou sélectionner une organisation à facturer dans le cadre de cet abonnement" />
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="Confirmer que la configuration est terminée" />
