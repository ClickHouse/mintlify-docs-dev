...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" alt="Page Billing avec le menu Actions ouvert et Add spend alerts mis en évidence" size="lg" />
  </Step>
