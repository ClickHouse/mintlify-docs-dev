...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="Ajouter un mode de paiement" size="lg" />

3. Si vous souhaitez modifier votre carte de crédit, cliquez sur le bouton **edit your credit card** en haut de la page.

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="Modifier votre carte de crédit" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="Modifier le mode de paiement" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="Modifier le mode de paiement" size="lg" />
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="Ajouter une carte de crédit de secours" size="lg" />
