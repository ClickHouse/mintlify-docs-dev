...
<Image img="/images/cloud/features/autoscaling/scheduled-scaling-1.png" size="md" alt="Interface des planifications de mise à l’échelle dans la console ClickHouse Cloud, avec des règles de mise à l’échelle définies selon l’heure" border />

<Image img="/images/cloud/features/autoscaling/scheduled-scaling-2.png" size="md" alt="Configuration d’une règle de mise à l’échelle planifiée dans la console ClickHouse Cloud" border />
