...
<Image img="/images/cloud/features/mbb/vertical_scaling.png" size="lg" alt="Schéma d’exemple pour un cluster de 3 répliques faisant l’objet d’une mise à l’échelle verticale" />
