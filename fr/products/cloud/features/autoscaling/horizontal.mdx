...
<Image img="/images/cloud/manage/scaling-patch-request.png" size="lg" alt="Requête PATCH de mise à l’échelle" border />

*Requête `PATCH` pour mettre à jour `numReplicas`*

<Image img="/images/cloud/manage/scaling-patch-response.png" size="md" alt="Réponse PATCH de mise à l’échelle" border />
...
<Image img="/images/cloud/manage/scaling-configure.png" size="md" alt="Paramètres de configuration de la mise à l’échelle" border />
...
<Image img="/images/cloud/manage/scaling-memory-allocation.png" size="md" alt="Allocation mémoire de la mise à l’échelle" border />