...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="Service unique dans ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="Compute separation dans ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="Exemple de warehouse avec services principal et secondaire" background="white" />
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="Accès des utilisateurs entre des services partageant les mêmes données" />
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="Paramètres de contrôle d’accès réseau" />
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="Services read-write et read-only dans un warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="Création d’un nouveau service dans un warehouse" />
