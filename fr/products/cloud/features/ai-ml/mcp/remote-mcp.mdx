...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Sélectionner MCP dans la fenêtre modale Connect" size="md" />

Activez le bouton pour activer MCP sur le service :

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="Activer le serveur MCP" size="md" />
