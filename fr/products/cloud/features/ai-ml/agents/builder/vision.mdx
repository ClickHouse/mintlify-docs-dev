...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="Composeur de messages avec le menu du trombone ouvert, affichant les options Téléverser vers le fournisseur, Téléverser comme texte et Téléverser vers l’environnement de code" size="lg" />
