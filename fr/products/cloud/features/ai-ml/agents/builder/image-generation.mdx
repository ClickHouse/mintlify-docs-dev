...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="Fenêtre modale des outils de l’agent affichant des intégrations de génération d’images, notamment OpenAI Image Tools, DALL-E-3 et Stable Diffusion, aux côtés d’autres outils tiers" size="md" />
