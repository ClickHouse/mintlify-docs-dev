...
<Image img="/images/cloud/agent-builder/web-search/web-search.png" alt="Panneau Capabilities avec la section Web Search mise en évidence, montrant la case à cocher Web Search" size="sm" />
