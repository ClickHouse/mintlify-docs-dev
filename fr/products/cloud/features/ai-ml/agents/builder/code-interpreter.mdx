...
<Image img="/images/cloud/agent-builder/run-code/run-code.png" alt="Section Run Code du panneau Capabilities avec la case à cocher Run Code activée et un bouton Upload to Code Environment" size="sm" />
