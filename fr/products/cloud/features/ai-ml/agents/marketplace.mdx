...
<Image img="/images/cloud/agent-builder/marketplace/marketplace.png" alt="Interface de chat avec l’option Agent Marketplace mise en évidence dans la barre latérale de gauche" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/browse.png" alt="Vue de l’Agent Marketplace avec le titre, la barre de recherche, les onglets de catégorie (Général, Ressources humaines, Recherche et développement, Finance, IT, Ventes, Après-vente, Tous) et une carte d’agent visible" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/use-agent.png" alt="Fenêtre modale des détails de l’agent affichant le nom de l’agent, une icône, ainsi que les actions Épingler, Copier le lien et Démarrer une discussion" size="md" />
