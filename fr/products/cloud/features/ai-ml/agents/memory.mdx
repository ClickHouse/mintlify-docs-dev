...
Ouvrez le panneau de mémoire à partir de l’icône **Memories** (cerveau) dans le volet de navigation de gauche. Le panneau répertorie vos mémoires enregistrées, avec des commandes pour créer, modifier, supprimer et filtrer les entrées.

<Image img="/images/cloud/agent-builder/memory/memories.png" alt="Panneau Memories montrant l’icône en forme de cerveau mise en évidence dans le volet de navigation de gauche, un champ de filtre, un bouton Add, une case à cocher Use memory, une entrée de mémoire avec des commandes de modification et de suppression, ainsi qu’un bouton Admin Settings" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="Panneau Memory avec le bouton + Create Memory mis en évidence" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/filter.png" alt="Panneau Memory avec le champ Filter memories mis en évidence et « demo » saisi" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/edit.png" alt="Entrée de Memory avec l’icône en forme de crayon Edit Memory mise en évidence" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/delete.png" alt="Entrée de Memory avec l’icône de corbeille « Supprimer la Memory » mise en évidence" size="sm" />

<div id="toggle-memory">
  ## Activer ou désactiver la mémoire
</div>

Activez ou désactivez la mémoire à l’aide de la case à cocher **Use memory** en haut du panneau de mémoire. Désactivez-la pour les sujets sensibles que vous ne souhaitez pas enregistrer, ou pour les conversations ponctuelles où la personnalisation n’apporte rien.

Lorsque la mémoire est désactivée, l’agent ne lit pas dans votre stockage de mémoire et n’y écrit pas non plus.

<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="Panneau de mémoire avec la case à cocher Use memory mise en évidence en haut" size="sm" />
