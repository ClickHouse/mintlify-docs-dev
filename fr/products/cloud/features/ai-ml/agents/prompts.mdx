...
* **Text** (obligatoire) - le texte qui sera effectivement inséré dans la zone de saisie.
...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="Panneau Prompts avec le bouton + mis en évidence à gauche et le formulaire Create Prompt ouvert à droite, affichant les champs Prompt Name, Text, Category, Special variables, Description et Command, avec un bouton Create Prompt" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="Panneau Prompts avec un prompt sélectionné, ses détails visibles à droite et un menu contextuel affichant les options Preview et Edit" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="Fenêtre modale d'aperçu du prompt affichant le titre du prompt, l'auteur, la date, le contenu du texte et un bouton Use Prompt" size="md" />
