...
<Image img="/images/cloud/agent-builder/sharing/sharing.png" alt="Bas du panneau Agent Builder avec l’icône share mise en évidence et un badge indiquant qu’un principal partagé a accès" size="sm" />
...
<Image img="/images/cloud/agent-builder/sharing/share-agent-modal.png" alt="Fenêtre modale Share avec la section des autorisations des utilisateurs et des groupes, un champ de recherche, un utilisateur existant avec un rôle Owner, un bouton bascule Share with everyone in ClickHouse, ainsi que les boutons Cancel et Save Changes" size="md" />
