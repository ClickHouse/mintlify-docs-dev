...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/launch-ch-agents.png" alt="Navigation du service Cloud avec ClickHouse agents (Beta) sélectionné, affichant la page de lancement avec le bouton Launch ClickHouse agents" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Model** - choisissez un modèle dans la liste déroulante.
    ...
    <Image img="/images/cloud/agent-builder/agent-builder.png" alt="Panneau Agent Builder affichant le menu déroulant Create New Agent, les champs du formulaire (Name, Description, Category, Instructions, Model) et la section Capabilities" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/capabilities.png" alt="Section Capabilities du panneau Agent Builder affichant les interrupteurs Run Code, Web Search, File Context, Artifacts, MCP Servers et Skills" size="sm" />
    ...
    <Image img="/images/cloud/agent-builder/tools-button.png" alt="Bas du panneau Agent Builder avec le bouton Add Tools mis en évidence" size="sm" />

    Cliquez sur **Add Tools** pour parcourir le catalogue :

    <Image img="/images/cloud/agent-builder/tools-modal.png" alt="Fenêtre modale Agent Tools affichant une grille d’intégrations tierces, dont Google, OpenAI Image Tools, Wolfram, DALL-E-3, Tavily Search, Calculator et Stable Diffusion" size="lg" />
