...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/console-api-keys.png" size="md" alt="Clés API" />

    2. Cliquez sur **Edit** à côté de la clé API utilisée pour les Query API endpoints

    <Image img="/images/cloud/guides/query-endpoints/api-key-edit.png" size="md" alt="Modifier" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/specific-locations.png" size="md" alt="Emplacements spécifiques" />
