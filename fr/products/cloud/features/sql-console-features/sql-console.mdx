...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="md" alt="liste des tables et schéma" />

Les tables de la liste peuvent également être développées pour afficher les colonnes et les types

<Image img="/images/cloud/sqlconsole/view-columns.png" size="md" alt="afficher les colonnes" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="md" alt="inspection du contenu d’une cellule" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="md" alt="tri décroissant sur une colonne" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="md" alt="filtre sur la colonne radio avec la valeur GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="md" alt="Ajouter un filtre sur une plage supérieure à 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="md" alt="Ajouter un filtre sur une plage supérieure à 2000" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="md" alt="Créer une requête à partir de tris et de filtres" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="md" alt="Créer une requête" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="md" alt="exécuter la requête sélectionnée" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="md" alt="exécuter au curseur" />

* Sélectionnez &#39;Run at cursor&#39; dans le menu contextuel du SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="md" alt="exécuter au curseur" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="md" alt="Annuler une requête" />
...
<Image img="/images/cloud/sqlconsole/sql-console-save-query.png" size="md" alt="Enregistrer une requête" />
...
<Image img="/images/cloud/sqlconsole/sql-console-rename.png" size="md" alt="Renommer une requête" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="md" alt="Accéder aux requêtes" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="md" alt="Rechercher dans les données Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="md" alt="Correspondance dans le contenu" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="md" alt="Options de pagination" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="md" alt="Navigation de pagination" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="md" alt="Télécharger au format CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="md" alt="Résultats de requête sous forme de tableau" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="md" alt="Passer de la requête au graphique" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="md" alt="Total des trajets par semaine" />
...
<Image img="/images/cloud/sqlconsole/bar-chart.png" size="md" alt="Graphique à barres" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="md" alt="Passer du graphique Bar à Area" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="md" alt="Mettre à jour le nom de la requête" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="md" alt="Mettre à jour le sous-titre, etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="md" alt="Ajuster l’échelle des axes" />