...
<Image img="/images/cloud/dashboards/2_dashboards.png" size="md" alt="Créer une requête enregistrée" border />
...
<Image img="/images/cloud/dashboards/3_dashboards.png" size="md" alt="Enregistrer la requête" border />
...
<Image img="/images/cloud/dashboards/4_dashboards.png" size="md" alt="Visualisation en graphique à barres des résultats d'une requête" border />
...
<Image img="/images/cloud/dashboards/5_dashboards.png" size="md" alt="Créer un nouveau tableau de bord" border />
...
<Image img="/images/cloud/dashboards/6_dashboards.png" size="md" alt="Ajouter une visualisation" border />
...
<Image img="/images/cloud/dashboards/7_dashboards.png" size="md" alt="Visualiser les résultats de la requête sous forme de tableau" border />
...
<Image img="/images/cloud/dashboards/8_dashboards.png" size="md" alt="Modifier la requête d’origine" border />
...
<Image img="/images/cloud/dashboards/9_dashboards.png" size="md" alt="Ajuster les filtres globaux" border />
...
<Image img="/images/cloud/dashboards/10_dashboards.png" size="md" alt="Modifier le paramètre de requête" border />
...
<Image img="/images/cloud/dashboards/11_dashboards.png" size="md" alt="Contrôler le filtre du graphique en courbes" border />