...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Graphique de latence de l’UI Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Tableau des requêtes récentes dans l’UI Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="UI de Query Insights, drill-down sur une requête" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="UI de Query Insights, informations sur la requête" border />
