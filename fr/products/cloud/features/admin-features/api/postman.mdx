...
<Image img="/images/cloud/manage/postman/postman1.png" size="md" alt="Site Postman" border />
...
<Image img="/images/cloud/manage/postman/postman2.png" size="md" alt="Créer un espace de travail" border />
...
<Image img="/images/cloud/manage/postman/postman4.png" size="md" alt="Saisie de l’URL de l’API" border />
...
<Image img="/images/cloud/manage/postman/postman7.png" size="md" alt="Importez votre API" border />

* Cliquez sur « API spec for ClickHouse Cloud ». Dans le volet central, sélectionnez l’onglet « Authorization » :

<Image img="/images/cloud/manage/postman/postman8.png" size="md" alt="Importation terminée" border />
...
<Image img="/images/cloud/manage/postman/postman10.png" size="md" alt="données d’authentification" border />
...
<Image img="/images/cloud/manage/postman/postman11.png" size="md" alt="ID de l’organisation et ID du service" border />
...
<Image img="/images/cloud/manage/postman/postman12.png" size="md" alt="Tester la récupération des organisations" border />
...
<Image img="/images/cloud/manage/postman/postman13.png" size="md" alt="Statut" border />
...
<Image img="/images/cloud/manage/postman/postman14.png" size="md" alt="Tester la récupération des détails de l’organisation" border />
...
<Image img="/images/cloud/manage/postman/postman15.png" size="md" alt="Soumettre le test" border />

* Après avoir cliqué sur le bouton &quot;Save&quot;, cliquez sur le bouton bleu &quot;Send&quot; en haut à droite de l’écran.

<Image img="/images/cloud/manage/postman/postman16.png" size="md" alt="Valeur renvoyée" border />
...
<Image img="/images/cloud/manage/postman/postman17.png" size="md" alt="Liste des services" border />
