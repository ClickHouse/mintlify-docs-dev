...
Avec ClickHouse Cloud, vous n’avez jamais à vous soucier de l’application des correctifs ni des mises à niveau. Nous déployons régulièrement des mises à niveau qui incluent des correctifs, de nouvelles fonctionnalités et des améliorations de performances. Pour obtenir la liste complète des nouveautés de ClickHouse, consultez notre [Cloud changelog](/fr/resources/changelogs/cloud/2026).
...
En plus du calendrier de mise à niveau habituel, nous proposons un canal **Fast release** si vous souhaitez que vos services reçoivent des mises à jour avant le calendrier de release habituel.
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="Sélectionner le type de canal de release" border />
</div>

<br />

Ce canal **Fast release** convient pour tester de nouvelles fonctionnalités dans des environnements non critiques. **Il n&#39;est pas recommandé pour les workloads de production ayant des exigences strictes en matière de disponibilité et de fiabilité.**
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="Mises à niveau planifiées" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="Fenêtre de mise à niveau planifiée" border />
</div>
