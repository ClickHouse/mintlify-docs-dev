...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Tableau de bord avancé natif d’observabilité" border />

<Note>
  Ce tableau de bord nécessite une authentification directe auprès de l’instance ClickHouse et est distinct du [tableau de bord avancé de la Cloud Console](/fr/products/cloud/features/monitoring/cloud-console#advanced-dashboard), accessible depuis l’UI de Cloud Console sans authentification supplémentaire.
</Note>

Pour en savoir plus sur les visualisations disponibles et sur leur utilisation pour le troubleshooting, consultez la [documentation du tableau de bord avancé](/fr/products/cloud/features/monitoring/advanced-dashboard).
...
* [Monitoring de Cloud Console](/fr/products/cloud/features/monitoring/cloud-console) — Des dashboards sans configuration qui n’affectent pas les performances du service
* [Endpoint Prometheus](/fr/products/cloud/features/monitoring/prometheus) — Exportez des metrics vers des outils de monitoring externes
* [tableau de bord avancé](/fr/products/cloud/features/monitoring/advanced-dashboard) — Référence détaillée des visualisations du dashboard