...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="Panneau latéral des notifications ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="Journal d’activité des notifications ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="Écran des paramètres des notifications ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="Paramètres de diffusion des notifications ClickHouse Cloud" border />
