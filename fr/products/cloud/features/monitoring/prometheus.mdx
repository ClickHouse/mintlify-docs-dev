...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Configurer l’endpoint de métrique Grafana" border />
...
<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Menu déroulant de Grafana Metrics Explorer" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Graphique de Grafana Metrics Explorer" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Explorateur de métriques Grafana" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Intégration Prometheus-Datadog" />
