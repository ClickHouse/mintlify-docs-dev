...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Tableau de bord avancé dans ClickHouse Cloud" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Vue d’ensemble de l’UI de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Graphique de latence de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Tableau des requêtes récentes de Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Analyse détaillée d’une requête dans l’UI Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Informations sur la requête dans l’UI Query Insights" border />
