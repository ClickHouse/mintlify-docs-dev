...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="créer un nouveau service" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="configurer les préférences du service" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="configurer les préférences du service" />
...
<Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="sauvegarde, données et métadonnées" />
