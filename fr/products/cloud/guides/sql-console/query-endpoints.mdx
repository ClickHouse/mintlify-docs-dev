...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Tester la requête d’exemple" />

    Ensuite, enregistrez la requête :

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Enregistrer la requête d’exemple" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="Configurer le point de terminaison de requête" />
    ...
    * Spécifier les domaines autorisés pour le partage de ressources entre origines (CORS)
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Commande curl du point de terminaison" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="test curl du point de terminaison" />
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Monitoring du point de terminaison" />
  </Step>
</Steps>
