...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="Aperçu de l’accès sécurisé à S3 avec ClickHouse" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="Récupération de l’ARN du rôle IAM du service ClickHouse" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="Sortie de la stack CloudFormation affichant l’ARN du rôle IAM" border />
