...
<Steps>
  ...
  <Step>
    ...
    Cet ARN est requis dans la politique d’approbation du rôle AWS IAM qui accédera à vos données Iceberg.

    <Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="Obtention de l’ARN du rôle IAM du service ClickHouse" border />
  </Step>
</Steps>
