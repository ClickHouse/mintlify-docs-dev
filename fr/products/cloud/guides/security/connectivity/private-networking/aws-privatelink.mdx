...
<Image img="/images/cloud/security/aws-privatelink-pe-create.png" size="md" alt="Points de terminaison privés" border />
...
<Image img="/images/cloud/security/aws-privatelink-endpoint-settings.png" size="md" alt="Paramètres de l’endpoint AWS PrivateLink" border />
...
<Image img="/images/cloud/security/aws-privatelink-select-vpc-and-subnets.png" size="md" alt="Sélectionner le VPC et les sous-réseaux" border />

À titre facultatif, attribuez des Security groups/Tags :
...
<Image img="/images/cloud/security/aws-privatelink-vpc-endpoint-id.png" size="md" alt="ID du VPC Endpoint" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-filters.png" size="md" alt="Filtre des endpoints privés" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-dns-name.png" size="md" alt="Nom DNS du Private Endpoint" border />
...
Supposons que vous essayiez d’utiliser les table functions [MySQL](/fr/reference/functions/table-functions/mysql) ou [PostgreSQL](/fr/reference/functions/table-functions/postgresql) dans ClickHouse Cloud pour vous connecter à votre base de données hébergée dans un VPC Amazon Web Services (AWS). AWS PrivateLink ne permet pas de sécuriser cette connexion. PrivateLink est une connexion unidirectionnelle à sens unique. Il permet à votre réseau interne ou à votre VPC Amazon de se connecter de manière sécurisée à ClickHouse Cloud, mais il ne permet pas à ClickHouse Cloud de se connecter à votre réseau interne.
...
Pour cela, configurez vos groupes de sécurité AWS de façon à autoriser les connexions depuis ClickHouse Cloud vers votre service de base de données interne/privé. Consultez les [adresses IP d’egress par défaut des régions ClickHouse Cloud](/fr/products/cloud/guides/data-sources/cloud-endpoints-api), ainsi que les [adresses IP statiques disponibles](https://api.clickhouse.cloud/static-ips.json).