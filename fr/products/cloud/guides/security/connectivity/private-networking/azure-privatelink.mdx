...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="Vue d’ensemble de PrivateLink" background="white" />
...
<Image img="/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="Points de terminaison privés" border />
...
<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="Ouvrir Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Créer un Private Endpoint - Basic" border />
...
<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="Sélection de la ressource Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Sélection du réseau virtuel du Private Endpoint" border />

Cliquez sur le bouton **Next: Tags**.

***

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Configuration DNS du Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Tags du Private Endpoint" border />

Enfin, cliquez sur le bouton **Create**.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="Vérification du Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="Adresse IP du Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="Vue du Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Configuration d’un DNS générique pour Private Link" border />
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Supprimer le Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="Filtre des Private Endpoints" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="Nom DNS du Private Endpoint" border />
