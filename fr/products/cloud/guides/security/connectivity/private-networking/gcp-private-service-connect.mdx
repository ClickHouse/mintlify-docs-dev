...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Vue d’ensemble de Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="Ouvrir Private Service Connect dans la console Google Cloud" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="Activer Global Access pour Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="Copier l’ID de connexion PSC" border />
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="Supprimer un endpoint privé de ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="Filtre des endpoints privés" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="Nom DNS du Private Endpoint" border />
