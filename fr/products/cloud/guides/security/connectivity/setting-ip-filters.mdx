...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="Liste d’accès existante dans ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="Ajout d’une seule IP à la liste d’accès dans ClickHouse Cloud" border />
