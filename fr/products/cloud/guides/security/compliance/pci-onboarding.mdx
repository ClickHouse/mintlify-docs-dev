...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_1.png" size="md" alt="Activer PCI" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/pci_2.png" size="md" alt="PCI activé" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/pci_3.png" size="md" alt="Déployer dans une région PCI" background="black" />
