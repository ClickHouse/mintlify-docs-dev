...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="Demander l'activation de HIPAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="Soumettre une demande de BAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA activé" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="Déployer dans une région HIPAA" background="black" />
