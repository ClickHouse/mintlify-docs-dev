...
<Steps>
  <Step>
    ...
    ![Accéder à l’onglet de configuration SCIM dans Organization settings](/images/cloud/security/scim-okta/scim-okta-01.png)
    ...
    ![Activer le bouton Enable SCIM](/images/cloud/security/scim-okta/scim-okta-02.png)
  ...
  <Step>
    ...
    ![Générer une nouvelle API key SCIM](/images/cloud/security/scim-okta/scim-okta-07.png)
  </Step>
...
<Steps>
  <Step>
    ...
    ![Définissez le mode de provisionnement sur SCIM dans les paramètres de l’application Okta](/images/cloud/security/scim-okta/scim-okta-03.png)

    L’application affiche maintenant un onglet **Provisioning**.

    ![L’onglet Provisioning apparaît maintenant dans l’application](/images/cloud/security/scim-okta/scim-okta-05.png)
  </Step>
  ...
  <Step>
    ...
    * **Mode d’authentification** — `Basic Auth`.
    ...
    ![Saisissez l’URL du connecteur SCIM et définissez l’identifiant unique sur userName](/images/cloud/security/scim-okta/scim-okta-06.png)

    ![Saisissez les informations d’identification de l’API pour l’authentification SCIM](/images/cloud/security/scim-okta/scim-okta-08.png)
    ...
    ![Tester la connexion SCIM](/images/cloud/security/scim-okta/scim-okta-09.png)
  ...
  <Step>
    ...
    ![Activer les actions de provisionnement SCIM pour les utilisateurs](/images/cloud/security/scim-okta/scim-okta-10.png)
    ...
    ![Enregistrer les paramètres de provisionnement et revenir à l’onglet Sign On](/images/cloud/security/scim-okta/scim-okta-10b.png)
  </Step>
  ...
  <Step>
    ...
    **Créez des groupes dans Okta.** Pour chaque role mapping configuré précédemment, créez ou identifiez un groupe Okta portant **exactement le même nom d’affichage**. Par exemple, si votre mapping indique `ClickHouse-Admins → Admin`, créez dans Okta un groupe nommé `ClickHouse-Admins`.
    ...
    ![Créer un nouveau groupe dans Okta](/images/cloud/security/scim-okta/scim-okta-13.png)

    Ouvrez le groupe que vous venez de créer et cliquez sur `Assign people` pour y ajouter un membre.

    ![Cliquez sur Assign people pour le groupe](/images/cloud/security/scim-okta/scim-okta-14.png)

    ![Attribuer l’utilisateur au groupe](/images/cloud/security/scim-okta/scim-okta-15.png)
    ...
    ![Attribuer l’application au groupe](/images/cloud/security/scim-okta/scim-okta-16.png)
    ...
    **Poussez les groupes.** Dans l’onglet **Provisioning** de l’application, cliquez sur `Push Groups → Find groups by name`, recherchez votre groupe, puis cliquez sur `Save`. Répétez l’opération pour chaque groupe de rôles. Une fois provisionné, chacun doit afficher un **Push Status** de **Active (Pushed)**.
    ...
    ![Configurer Group Push par nom dans l’onglet Push Groups de l’application](/images/cloud/security/scim-okta/scim-okta-17.png)
...
![Vérifier la synchronisation des utilisateurs dans Users and roles](/images/cloud/security/scim-okta/scim-okta-18.png)
