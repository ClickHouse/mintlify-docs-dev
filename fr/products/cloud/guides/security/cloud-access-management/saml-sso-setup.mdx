...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="Commencer la configuration SAML" force />
  </Step>
  ...
  <Step>
    ...
    * [Configurer Duo SAML](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="Créer une application dans le fournisseur d’identité" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="Ajouter l’URL de métadonnées" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="Ajouter un domaine à vérifier" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="Vérifiez votre domaine" force />
  </Step>
...
<Accordion title="Créer une application Web Google">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Application Google SAML" force />
...
<Accordion title="Créer une application Azure Enterprise">
  ...
  5. Saisissez un nom et sélectionnez **Integrate any other application you don&#39;t find in the gallery (Non-gallery)**, puis cliquez sur **Create**.
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Application Azure non répertoriée dans la galerie" force />
  ...
  10. Ajoutez (A) ou mettez à jour (U) les éléments suivants dans **Attributes &amp; Claims** :
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="Attributs et revendications" force />
