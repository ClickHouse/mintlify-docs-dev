...
<Image img="/images/cloud/security/cloud-access-management/user_grant_permissions_options.png" alt="Une illustration montrant les différentes manières d’accorder des permissions à un utilisateur" size="md" background="black" />
