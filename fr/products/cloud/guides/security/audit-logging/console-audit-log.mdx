...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/security/activity_log1.png" size="md" alt="Onglet Activity de ClickHouse Cloud" border />
  ...
  <Step>
    ...
    * **Time :** L’horodatage de l’événement
    ...
    <Image img="/images/cloud/security/activity_log2.png" size="md" alt="Tableau Activity de ClickHouse Cloud" border />
...
<div class="eighty-percent">
  <Image img="/images/cloud/security/activity_log3.png" size="lg" alt="Export CSV d’Activity dans ClickHouse Cloud" border />
</div>
