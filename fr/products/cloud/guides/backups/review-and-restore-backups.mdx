...
<Image img="/images/cloud/manage/backup-status-list.png" size="md" alt="Liste des statuts des sauvegardes dans ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-usage.png" size="md" alt="Graphique d’utilisation des sauvegardes dans ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-restore.png" size="md" alt="Restauration d’une sauvegarde dans ClickHouse Cloud" />

Le nouveau service apparaîtra dans la liste des services avec l’état `Provisioning` jusqu’à ce qu’il soit prêt :

<Image img="/images/cloud/manage/backup-service-provisioning.png" size="md" alt="Service en cours de provisionnement" border />
