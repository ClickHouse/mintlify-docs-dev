...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="Configurer les paramètres de sauvegarde" border />
...
<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="Sélectionner la rétention et la fréquence des sauvegardes" border />
