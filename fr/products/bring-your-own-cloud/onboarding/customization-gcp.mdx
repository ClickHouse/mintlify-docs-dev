...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-gcp-subnet.png" size="lg" alt="Détails du sous-réseau GCP BYOC montrant les plages IPv4 primaires et secondaires avec Private Google Access activé" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-gcp-existing-vpc-ui.png" size="lg" alt="Interface de configuration BYOC de ClickHouse Cloud avec Use existing VPC sélectionné pour GCP" />
  </Step>
</Steps>