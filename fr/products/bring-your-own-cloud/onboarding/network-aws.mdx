...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC Créer une connexion de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-2.png" size="lg" alt="BYOC Accepter une connexion de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC Ajouter une table de routage" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC Ajouter une table de routage" border />
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-1.png" size="lg" alt="Point de terminaison de service BYOC PrivateLink" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-2.png" size="lg" alt="Approbation BYOC PrivateLink" border />
  </Step>
