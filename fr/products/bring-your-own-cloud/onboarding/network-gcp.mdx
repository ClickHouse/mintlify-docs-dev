...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-1.png" size="md" alt="BYOC Créer une connexion de peering" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-2.png" size="md" alt="BYOC Accepter une connexion de peering" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-3.png" size="lg" alt="BYOC Accepter une connexion de peering" border />
...
<Steps>
  <Step>
    ### Demander la mise en place du service PSC
  ...
  <Step>
    ### Obtenir le nom du service PSC GCP et le nom DNS
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-1.png" size="lg" alt="Point de terminaison PSC BYOC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-2.png" size="lg" alt="Point de terminaison PSC BYOC" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-3.png" size="lg" alt="Point de terminaison PSC BYOC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-4.png" size="lg" alt="Point de terminaison PSC BYOC" border />
  </Step>

  <Step>
    ### Créer un point de terminaison PSC dans votre réseau
    ...
    * L’état du point de terminaison devrait passer à &quot;Accepted&quot; ; contactez ClickHouse Support si ce n’est pas accepté automatiquement.
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-5.png" size="lg" alt="Création d’un point de terminaison PSC BYOC" border />
    ...
    * Ouvrez le détail du point de terminaison et récupérez le &quot;PSC Connection ID&quot;, qui sera utilisé à l’étape [Ajouter l’ID de connexion PSC du point de terminaison à la liste d’autorisation du service](#step-5-add-endpoint-id-allowlist)
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-6.png" size="lg" alt="Détail du point de terminaison PSC BYOC" border />
  </Step>
  ...
  <Step>
    ### Ajouter l&#39;ID de connexion PSC de l&#39;endpoint à la liste d’autorisation du service
  ...
  <Step>
    ### Se connecter à ClickHouse via PSC
