...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="Sous-réseau VPC BYOC" />

    <Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="Tags de sous-réseau VPC BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="Point de terminaison S3 BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="UI de configuration BYOC de ClickHouse Cloud avec Use existing VPC sélectionné" />
