...
<Steps>
  ...
  <Step title="Sélectionner un modèle">
    ...
    <Image img="/images/agentic-data-stack/select-model.png" alt="Le sélecteur de modèles de LibreChat dans le coin supérieur gauche, affichant le modèle par défaut avec une info-bulle Select a model" size="md" />
    ...
    <Accordion title="Définir une clé de fournisseur dans l'UI">
      ...
      <Image img="/images/agentic-data-stack/set-api-key.png" alt="Le sélecteur de modèles de LibreChat avec le bouton Set API Key à côté du fournisseur Anthropic" size="md" />
      ...
      <Image img="/images/agentic-data-stack/set-api-key-modal.png" alt="La boîte de dialogue Set API Key for Anthropic avec une liste déroulante pour l'expiration, un champ Key, et les boutons Submit et Revoke" size="md" />
    </Accordion>
  </Step>
  ...
  <Step title="Sélectionner le serveur MCP">
    ...
    <Image img="/images/agentic-data-stack/select-clickhouse-local.png" alt="Le menu MCP Servers ouvert dans la zone de saisie de LibreChat, affichant ClickHouse-Local avec un point vert de connexion et ClickHouse-Cloud" size="md" />
  </Step>
  ...
  <Step title="Poser votre première question">
    ...
    <Image img="/images/agentic-data-stack/prompt-chat.png" alt="LibreChat répondant à la question d'exemple en appelant les outils MCP ClickHouse-Local et en listant les bases de données et tables disponibles" size="md" />
  </Step>
</Steps>
