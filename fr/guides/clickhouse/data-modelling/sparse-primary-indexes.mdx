...
<Image img="/images/guides/best-practices/sparse-primary-indexes-02.png" size="lg" alt="Indices primaires creux 02" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-03a.png" size="lg" alt="Index primaires clairsemés 03a" />

Au total, l’index comporte 1083 entrées pour notre table de 8,87 millions de lignes et 1083 granules :

<Image img="/images/guides/best-practices/sparse-primary-indexes-03b.png" size="lg" alt="Index primaires clairsemés 03b" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-04.png" size="lg" alt="Index primaires clairsemés 04" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-05.png" size="lg" alt="Index primaires clairsemés 05" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-06.png" size="lg" alt="Index primaires clairsemés 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-13a.png" size="lg" alt="Indices primaires épars 13a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-09a.png" size="lg" alt="Indices primaires clairsemés 09a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-09b.png" size="lg" alt="Indices primaires clairsemés 09b" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-09c.png" size="lg" alt="Indices primaires clairsemés 09c" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-10.png" size="lg" alt="Indices primaires creux 10" />

Voici la clé primaire obtenue :

<Image img="/images/guides/best-practices/sparse-primary-indexes-11.png" size="lg" alt="Indices primaires creux 11" />
...
<Note>
  ...
  * En pratique, la table créée implicitement a le même ordre de lignes et le même index primaire que la [table secondaire que nous avons créée explicitement](/fr/guides/clickhouse/data-modelling/sparse-primary-indexes#option-1-secondary-tables) :
  ...
  <Image img="/images/guides/best-practices/sparse-primary-indexes-12b-1.png" size="lg" alt="Index primaires clairsemés 12b1" />
  ...
  <Image img="/images/guides/best-practices/sparse-primary-indexes-12b-2.png" size="md" alt="Index primaires clairsemés 12b2" />
</Note>
