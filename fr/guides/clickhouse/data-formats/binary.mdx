...
Nous allons utiliser la table some&#95;data [table](/fr/assets/some_data.sql) et les [données](/fr/assets/some_data.tsv) pour cette démonstration ; n’hésitez pas à reproduire cela sur votre instance ClickHouse.
