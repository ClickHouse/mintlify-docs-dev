...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="Une colonne par chemin JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="Colonne JSON partagée" />
