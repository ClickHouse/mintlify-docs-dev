...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="Schéma d’architecture pour 1 shard et 2 répliques avec ReplicatedMergeTree" />
