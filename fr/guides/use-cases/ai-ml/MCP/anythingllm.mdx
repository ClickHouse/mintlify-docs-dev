...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/alm_tool-icon.png" alt="Icône d’outil" size="md" />

    Cliquez sur `Agent Skills` et regardez dans la section `MCP servers`.
    Attendez que `Mcp ClickHouse` passe à `On`

    <Image img="/images/use-cases/AI_ML/MCP/allm_mcp-servers.png" alt="Serveurs MCP prêts" size="md" />
  </Step>
