...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/0_janai_openai.png" alt="Activer les modèles OpenAI" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/1_janai_mcp_servers.png" alt="Activer les serveurs MCP" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/2_janai_mcp_servers_list.png" alt="Liste des serveurs MCP" size="md" />
    ...
    <Image img="/images/use-cases/AI_ML/MCP/3_janai_add_mcp_server.png" alt="Ajouter un serveur MCP" size="md" />

    Une fois cela fait, nous devrons activer le ClickHouse Server s&#39;il ne l&#39;est pas déjà :

    <Image img="/images/use-cases/AI_ML/MCP/4_janai_toggle.png" alt="Activer le serveur MCP" size="md" />

    Les outils du ClickHouse MCP server seront alors visibles dans la fenêtre de discussion :

    <Image img="/images/use-cases/AI_ML/MCP/5_jani_tools.png" alt="Outils du ClickHouse MCP server" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/7_janai_tool_confirmation.png" alt="Confirmation de l’outil" size="md" />

    Il affichera ensuite la liste des appels d&#39;outils effectués :

    <Image img="/images/use-cases/AI_ML/MCP/8_janai_tools_called.png" alt="Outils appelés" size="md" />

    Si nous cliquons sur un appel d&#39;outil, nous pourrons en voir les détails :

    <Image img="/images/use-cases/AI_ML/MCP/9_janai_tools_called_expanded.png" alt="Outils appelés développés" size="md" />

    Et juste en dessous, nous verrons le résultat :

    <Image img="/images/use-cases/AI_ML/MCP/10_janai_result.png" alt="Résultat" size="md" />
  </Step>
</Steps>