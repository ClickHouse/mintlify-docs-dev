...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Sélectionner le jeu de données UK price paid" />

Cliquez ensuite sur `Import dataset` :

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Importer le jeu de données UK price paid" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="interface Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Visualisation de données Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Graphique dynamique Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Graphique dynamique de Marimo" />
