...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Ajouter un exemple de jeu de données" />

Sélectionnez `Get started` sur la carte des données de prix de l’immobilier au Royaume-Uni (4GB) :

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Sélectionner le jeu de données des prix de l’immobilier au Royaume-Uni" />

Cliquez ensuite sur `Import dataset` :

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Importer le jeu de données des prix de l’immobilier au Royaume-Uni" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="Créer un nouveau notebook" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="Sélectionner un noyau" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="aperçu du dataframe" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="aperçu du DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="aperçu du DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="Graphique du jeu de données distant et du jeu de données local" />
