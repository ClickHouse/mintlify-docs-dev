...
<Image img="/images/use-cases/observability/observability-15.png" alt="Configuration du connecteur" size="sm" />
...
<Image img="/images/use-cases/observability/observability-16.png" alt="Config des logs du connecteur" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-17.png" alt="Des logs aux traces" size="lg" border />
...
Les utilisateurs qui souhaitent écrire des requêtes plus complexes peuvent basculer vers le `SQL Editor`.
...
<Image img="/images/use-cases/observability/observability-19.png" alt="Détails de la trace" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-20.png" alt="Des traces aux logs" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-21.png" alt="Tableaux de bord" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-22.png" alt="Série temporelle" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-23.png" alt="Graphiques à plusieurs courbes" size="lg" border />
...
<Image img="/images/use-cases/observability/observability-24.png" alt="Visualisation de données géographiques" size="lg" border />