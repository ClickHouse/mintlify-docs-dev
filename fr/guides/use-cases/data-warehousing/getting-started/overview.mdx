...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Requête Iceberg" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Requête Iceberg" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Requête Iceberg" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="Requête ClickHouse" />
