...
[chDB](/fr/products/chdb/index) est ClickHouse embarqué sous forme de moteur de base de données in-process, Python en étant l’implémentation principale, bien qu’il soit également disponible pour Go, Rust, NodeJS et Bun. Cette option de déploiement intègre directement les puissantes capacités OLAP de ClickHouse au processus de votre application, sans nécessiter d’installation distincte d’une base de données.

<Image img="/images/deployment-modes/chdb.png" alt="chDB - ClickHouse intégré" size="sm" />
