...
<Image img="/images/column-oriented-example-query.png" alt="Exemple de requête dans une base de données orientée colonnes" size="lg" />
...
<Image img="/images/row-oriented.gif" alt="Structure de base de données orientée lignes" size="lg" />
...
<Image img="/images/column-oriented.gif" alt="Structure d'une base de données orientée colonnes" size="lg" />
