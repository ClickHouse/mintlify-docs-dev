...
<Image img="/images/use-cases/rta-considerations.png" alt="Analytique en temps réel : temps d’ingestion, de transformation et de requête" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="Comment ClickHouse propulse l’analytique en temps réel" />
  </div>
