...
<Image img="/images/migrations/postgres-b-tree.png" size="lg" alt="Index B-Tree PostgreSQL" />

<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="Index épars PostgreSQL" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="Partitions PostgreSQL vers partitions ClickHouse" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="Projections PostgreSQL dans ClickHouse" />
