...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="Migration de ClickHouse autogéré" />
...
comme outil ETL pour migrer des données de votre système de base de données actuel vers ClickHouse Cloud, à condition que ce système dispose soit d’un [integration engine](/fr/reference/engines/table-engines/index#integration-engines) ou d’une [fonction de table](/fr/reference/functions/table-functions/index) fournis par ClickHouse,
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="Migration de ClickHouse autogéré" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="Migration de ClickHouse autogéré" />
