...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="Carte de densité des points d'intérêt en Europe" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="Bars à saké au Japon" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="Distributeurs automatiques de billets" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="Carte de l'Europe avec des points d'intérêt classés par pays" />