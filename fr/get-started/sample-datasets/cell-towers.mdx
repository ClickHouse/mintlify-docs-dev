...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Tableau de bord des antennes-relais par technologie radio dans le mcc 204" />
...
<Tabs>
  <Tab title="ClickHouse Cloud">
    ...
    <Image img="/images/_snippets/cloud-load-data-sample.png" size="md" alt="Charger le jeu de données des antennes-relais" />
...
<Image img="/images/getting-started/example-datasets/superset-add.png" size="md" alt="Ajouter une base de données" />

Choisissez **ClickHouse Connect** dans la liste :

<Image img="/images/getting-started/example-datasets/superset-choose-a-database.png" size="md" alt="Choisir ClickHouse Connect comme type de base de données" />
...
<Image img="/images/getting-started/example-datasets/superset-connect-a-database.png" size="md" alt="Ajouter ClickHouse en tant que source de données Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-add-dataset.png" size="md" alt="Ajouter la table cell_towers comme jeu de données" />
...
<Image img="/images/getting-started/example-datasets/superset-create-map.png" size="md" alt="Créer une carte dans Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-lon-lat.png" size="md" alt="Spécifier les champs de longitude et de latitude" />

Ajoutez un filtre avec `mcc` = `204` (ou remplacez-le par n’importe quelle autre valeur de `mcc`) :

<Image img="/images/getting-started/example-datasets/superset-mcc-204.png" size="md" alt="Filtrer sur MCC 204" />
...
<Image img="/images/getting-started/example-datasets/superset-radio-umts.png" size="md" alt="Filtrer sur une valeur radio égale à UMTS" />

Voici la configuration complète du graphique avec les filtres `radio = 'UMTS'` et `mcc = 204` :

<Image img="/images/getting-started/example-datasets/superset-umts-netherlands.png" size="md" alt="Graphique des radios UMTS dans le MCC 204" />
...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" size="md" alt="Tableau de bord des antennes-relais par type de radio dans le mcc 204" />
