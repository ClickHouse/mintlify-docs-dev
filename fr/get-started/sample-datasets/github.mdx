...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="Pour les lignes ajoutées et supprimées" size="md" />

**Pour les commits et les auteurs :**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="Pour les commits et les auteurs" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Matrice des auteurs Superset" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Matrice des auteurs Superset v2" size="md" />
