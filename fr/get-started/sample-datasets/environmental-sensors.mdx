...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="Nombre d’événements par jour" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="Journées chaudes et humides" />