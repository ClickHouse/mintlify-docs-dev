...
<div className="installContainer">
  <a href="/fr/install/quick-install" style={{textDecoration: 'none'}}>
    <Card title="Installation rapide" />
  </a>

  <a href="/fr/install/clickhousectl" style={{textDecoration: 'none'}}>
    <Card title="clickhousectl (CLI)" icon="console" />
  </a>

  <a href="/fr/install/docker" style={{textDecoration: 'none'}}>
    <Card title="Docker" />
  </a>

  <a href="/fr/install/advanced" style={{textDecoration: 'none'}}>
...
<div className="installContainer">
  <a href="/fr/install/debian_ubuntu" style={{textDecoration: 'none'}}>
    <Card title="Debian/Ubuntu" />
  </a>

  <a href="/fr/install/redhat" style={{textDecoration: 'none'}}>
    <Card title="Redhat" />
  </a>

  <a href="/fr/install/nixos" style={{textDecoration: 'none'}}>
    <Card title="NixOS" />
  </a>

  <a href="/fr/install/linux_other" style={{textDecoration: 'none'}}>
