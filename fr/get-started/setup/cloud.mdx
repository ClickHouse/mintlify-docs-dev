...
<Steps>
  <Step>
    ...
    * Connectez-vous avec le nom d’utilisateur et le mot de passe que vous venez de créer
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="Sélectionner un forfait" border />
    ...
    <Image img="/images/_snippets/createservice1.png" size="md" alt="Nouveau service ClickHouse" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="Limites de mise à l’échelle" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="Sources de données" border />
    ...
    * Téléversez des données depuis l’URL d’un fichier
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="Sélectionner une source de données" border />
    ...
    * les clés primaires dans ClickHouse ne sont ***pas uniques*** pour chaque ligne d’une table
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="détails de connexion du client ClickHouse" border />
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="Nouvelles lignes provenant du fichier CSV" />
