...
<CardGroup cols={2}>
  <Card title="Real-time analytics" icon="chart-line" href="/core/guides/use-cases/real-time-analytics">
    Build low-latency analytical applications with ClickHouse — including time-series workloads.
  </Card>
  <Card title="Observability" icon="eye" href="/core/guides/use-cases/observability">
    Set up logs, metrics, and traces on ClickHouse, either self-hosted or via the build-your-own stack.
  </Card>
  <Card title="Data warehousing" icon="warehouse" href="/core/guides/use-cases/data-warehousing">
    Use ClickHouse as a data warehouse, including data-lake integrations and federated query patterns.
  </Card>
  <Card title="AI/ML and GenAI" icon="brain" href="/core/guides/use-cases/ai-ml">
