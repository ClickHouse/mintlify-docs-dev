...
["Playground specifications"](/core/get-started/sample-datasets/playground#specifications).
</Note>
...
<Note>
This query is using a [projection](/core/concepts/features/projections/projections) to speed up performance.
</Note>
