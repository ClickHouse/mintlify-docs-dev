...
You can make queries to Playground using any HTTP client, for example [curl](https://curl.haxx.se) or [wget](https://www.gnu.org/software/wget/), or set up a connection using [JDBC](/core/concepts/features/interfaces/jdbc) or [ODBC](/core/concepts/features/interfaces/odbc) drivers. More information about software products that support ClickHouse is available [here](/integrations/connectors/home).
...
TCP endpoint example with [CLI](/core/concepts/features/interfaces/cli):
