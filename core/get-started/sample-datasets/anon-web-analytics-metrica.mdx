...
[A Practical Introduction to Sparse Primary Indexes in ClickHouse](/core/guides/clickhouse/data-modelling/sparse-primary-indexes) uses the hits dataset to discuss the differences in ClickHouse indexing compared to traditional relational databases, how ClickHouse builds and uses a sparse primary index, and indexing best practices.
