...
Insert the data using `INSERT INTO SELECT` and the [s3 function](/core/reference/functions/table-functions/s3). For example, below, we insert the ClickHouse files into each of their respective tables:
