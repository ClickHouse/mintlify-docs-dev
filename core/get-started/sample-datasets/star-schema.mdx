...
The Star Schema Benchmark is roughly based on the [TPC-H](/core/get-started/sample-datasets/tpch)'s tables and queries but unlike TPC-H, it uses a star schema layout.
