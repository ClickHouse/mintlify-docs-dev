...
The difference is best explained with an example query running over 100 million rows of [real-world anonymized web analytics data](/core/get-started/sample-datasets/anon-web-analytics-metrica):
...
<Image img="/images/column-oriented-example-query.png" alt="Example query in a column-oriented database" size="lg"/>
...
<Image img="/images/row-oriented.gif" alt="Row-oriented database structure" size="lg"/>
...
<Image img="/images/column-oriented.gif" alt="Column-oriented database structure" size="lg"/>
...
ClickHouse supports a [declarative query language based on SQL](/core/reference/home) that is identical to the ANSI SQL standard in many cases. Supported query clauses include [GROUP BY](/core/reference/statements/select/group-by), [ORDER BY](/core/reference/statements/select/order-by), subqueries in [FROM](/core/reference/statements/select/from), [JOIN](/core/reference/statements/select/join) clause, [IN](/core/reference/statements/in) operator, [window functions](/core/reference/functions/window-functions) and scalar subqueries.
...
To learn why ClickHouse is so fast, see the [Why is ClickHouse fast?](/core/get-started/about/why-clickhouse-is-so-fast) guide.
...
The rest of this article explains why column-oriented databases work well for these scenarios, and why ClickHouse in particular [outperforms](/core/get-started/about/why-clickhouse-is-so-fast#storage-layer-concurrent-inserts-and-selects-are-isolated) others in this category.
...
- [ClickHouse Performance](/core/get-started/about/why-clickhouse-is-so-fast)
- [Distinctive Features of ClickHouse](/core/get-started/about/distinctive-features)
- [FAQ: Why is ClickHouse so fast?](/core/get-started/about/why-clickhouse-is-so-fast)
