...
The examples here covers common query patterns and show how to optimize them with ClickHouse. They use the full [Stack Overflow dataset](/core/get-started/sample-datasets/stackoverflow) (up to April 2024) on equivalent resources in PostgreSQL and ClickHouse (8 cores, 32GiB RAM).
...
Where possible, you should leverage ClickHouse aggregate functions. Below we show the use of the [argMax](/core/reference/functions/aggregate-functions/reference/argMax) function to compute the most viewed question of each year.
...
[Click here for Part 3](/core/get-started/setup/migration-guides/postgres/migration-guide/migration-guide-part3)
