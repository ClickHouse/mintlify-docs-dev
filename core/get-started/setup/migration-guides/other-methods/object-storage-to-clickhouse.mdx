...
- [s3](/core/reference/functions/table-functions/s3) or [s3Cluster](/core/reference/functions/table-functions/s3Cluster)
- [gcs](/core/reference/functions/table-functions/gcs)
- [azureBlobStorage](/core/reference/functions/table-functions/azureBlobStorage)

If your current database system isn't able to directly offload data into a Cloud Object Storage, you could use a [third-party ETL/ELT tool](/core/get-started/setup/migration-guides/other-methods/etl-tool-to-clickhouse) or [clickhouse-local](/core/get-started/setup/migration-guides/other-methods/clickhouse-local-etl) for moving data
...
Also you can leverage sophisticated and compressed formats like [Parquet](/core/reference/formats/Parquet/Parquet).
