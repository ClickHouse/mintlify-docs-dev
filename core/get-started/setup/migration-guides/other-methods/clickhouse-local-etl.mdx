...
<Image img="/images/integrations/migration/ch-local-01.png" size='lg' alt='Migrating Self-managed ClickHouse'/>

You can use ClickHouse, or to be more specific,[`clickhouse-local`](/core/concepts/features/tools-and-utilities/clickhouse-local)
...
ClickHouse-provided [integration engine](/core/reference/engines/table-engines#integration-engines)  or [table function](/core/reference/functions/table-functions), respectively,
...
ClickHouse provides integration engines and table functions (that create integration engines on-the-fly) for [MySQL](/core/reference/engines/table-engines/integrations/mysql), [PostgreSQL](/core/reference/engines/table-engines/integrations/postgresql), [MongoDB](/core/reference/engines/table-engines/integrations/mongodb) and [SQLite](/core/reference/engines/table-engines/integrations/sqlite).
...
<Image img="/images/integrations/migration/ch-local-02.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
...
We will use the [integration table engine](/core/reference/engines/table-engines/integrations/mysql) (created on-the-fly by the [mysql table function](/core/reference/functions/table-functions/mysql)) for reading data from the source MySQL database and we will use the [remoteSecure table function](/core/reference/functions/table-functions/remote)
for writing the data into a destination table on your ClickHouse cloud service.

<Image img="/images/integrations/migration/ch-local-03.png" size='lg' alt='Migrating Self-managed ClickHouse'  />
