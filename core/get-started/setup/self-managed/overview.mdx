...
<CardGroup cols={2}>
  ...
  <Card title="clickhousectl (CLI)" href="/core/get-started/setup/self-managed/clickhousectl" icon="terminal">
  ...
  <Card title="Source build" href="/core/get-started/setup/self-managed/advanced" icon="code">
