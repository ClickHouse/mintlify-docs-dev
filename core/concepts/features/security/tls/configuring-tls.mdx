---
slug: /core/guides/sre/tls/configuring-tls
...
<Note>
View the [Quick Start](/core/get-started/setup/install) for more details on how to install ClickHouse.
</Note>
</Step>
<Step>
...
The typical [4 letter word (4lW)](/core/guides/oss/deployment-and-scaling/keeper#four-letter-word-commands) commands won't work using `echo` without TLS, here is how to use the commands with `openssl`.
