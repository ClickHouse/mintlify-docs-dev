...
- Server [configuration files](/core/concepts/features/configuration/server-config/configuration-files) `users.xml` and `config.xml`.
...
3.  [Restrict permissions](/core/concepts/features/configuration/settings/permissions-for-queries) for the `default` user and disable SQL-driven access control and account management for it.
...
- [Privileges](/core/reference/statements/grant#privileges) that define the scope of queries the user can execute.
...
Privileges can be granted to a user account by the [GRANT](/core/reference/statements/grant) query or by assigning [roles](#role-management). To revoke privileges from a user, ClickHouse provides the [REVOKE](/core/reference/statements/revoke) query. To list privileges for a user, use the [SHOW GRANTS](/core/reference/statements/show#show-grants) statement.

Management queries:

- [CREATE USER](/core/reference/statements/create/user)
- [ALTER USER](/core/reference/statements/alter/user)
- [DROP USER](/core/reference/statements/drop)
- [SHOW CREATE USER](/core/reference/statements/show#show-create-user)
...
4.  Settings applied to the entire server by default or from the [default profile](/core/reference/settings/server-settings/settings#default_profile).
...
- [Privileges](/core/reference/statements/grant#privileges)
- Settings and constraints
- List of assigned roles

Management queries:

- [CREATE ROLE](/core/reference/statements/create/role)
- [ALTER ROLE](/core/reference/statements/alter/role)
- [DROP ROLE](/core/reference/statements/drop#drop-role)
- [SET ROLE](/core/reference/statements/set-role)
- [SET DEFAULT ROLE](/core/reference/statements/set-role)
- [SHOW CREATE ROLE](/core/reference/statements/show#show-create-role)
- [SHOW ROLES](/core/reference/statements/show#show-roles)

Privileges can be granted to a role by the [GRANT](/core/reference/statements/grant) query. To revoke privileges from a role ClickHouse provides the [REVOKE](/core/reference/statements/revoke) query.
...
- [CREATE ROW POLICY](/core/reference/statements/create/row-policy)
- [ALTER ROW POLICY](/core/reference/statements/alter/row-policy)
- [DROP ROW POLICY](/core/reference/statements/drop#drop-row-policy)
- [SHOW CREATE ROW POLICY](/core/reference/statements/show#show-create-row-policy)
- [SHOW POLICIES](/core/reference/statements/show#show-policies)

### Settings profile {#settings-profiles-management}

Settings profile is a collection of [settings](/core/reference/settings). Settings profile contains settings and constraints, as well as a list of roles and/or users to which this profile is applied.

Management queries:

- [CREATE SETTINGS PROFILE](/core/reference/statements/create/settings-profile)
- [ALTER SETTINGS PROFILE](/core/reference/statements/alter/settings-profile)
- [DROP SETTINGS PROFILE](/core/reference/statements/drop#drop-settings-profile)
- [SHOW CREATE SETTINGS PROFILE](/core/reference/statements/show#show-create-settings-profile)
- [SHOW PROFILES](/core/reference/statements/show#show-profiles)

### Quota {#quotas-management}

Quota limits resource usage. See [Quotas](/core/concepts/features/configuration/server-config/quotas).

Quota contains a set of limits for some durations, as well as a list of roles and/or users which should use this quota.

Management queries:

- [CREATE QUOTA](/core/reference/statements/create/quota)
- [ALTER QUOTA](/core/reference/statements/alter/quota)
- [DROP QUOTA](/core/reference/statements/drop#drop-quota)
- [SHOW CREATE QUOTA](/core/reference/statements/show#show-create-quota)
