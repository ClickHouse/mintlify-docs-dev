...
slug: /core/guides/sre/configuring-ldap
...
<Note>
    View the [LDAP doc page](/core/concepts/features/security/external-authenticators/ldap) for more details on the LDAP settings.
</Note>
...
<Note>
The procedures in this section assumes that SQL Access Control and Account Management in ClickHouse has been enabled. To enable, view the [SQL Users and Roles guide](/core/concepts/features/security/access-rights).
</Note>
