...
This version of ClickStack is great for local debugging and quick investigation, but isn't meant for production environments. For production ready full-featured ClickStack, see [Open Source ClickStack](/products/clickstack/getting-started/oss).
</Info>
