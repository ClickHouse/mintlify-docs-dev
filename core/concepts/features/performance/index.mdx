...
<CardGroup cols={2}>
  <Card title="PREWHERE optimization" icon="filter" href="/core/concepts/features/performance/prewhere">
    How `PREWHERE` reduces I/O by filtering data before reading non-filter columns, and how to monitor its effectiveness.
  </Card>
  <Card title="Allocation profiling" icon="chart-line" href="/core/concepts/features/performance/allocation-profiling">
    Profile memory allocations to diagnose memory pressure and tune resource usage in ClickHouse.
  </Card>
  <Card title="Caches" icon="bolt" href="/core/concepts/features/performance/caches/caches">
    Query cache, query-condition cache, and userspace page cache for accelerating repeated workloads.
  </Card>
  <Card title="Skip indexes" icon="forward" href="/core/concepts/features/performance/skip-indexes/skipping-indexes">
    Use secondary skip indexes to prune irrelevant data blocks and accelerate filtered queries.
  </Card>
  <Card title="Lazy materialization" icon="clock" href="/core/concepts/features/performance/lazy-materialization">
    Defer column reads until they are needed to reduce I/O for selective queries.
  </Card>
  <Card title="Troubleshooting" icon="bug" href="/core/concepts/features/performance/troubleshoot/sampling-query-profiler">
