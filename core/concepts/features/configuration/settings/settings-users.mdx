...
This setting enables or disables using of SQL-driven [access control and account management](/core/concepts/features/security/access-rights#access-control-usage) for the user.
...
You can assign a settings profile for the user. Settings profiles are configured in a separate section of the `users.xml` file. For more information, see [Profiles of Settings](/core/concepts/features/configuration/settings/settings-profiles).
...
You can assign a quotas set for the user. For a detailed description of quotas configuration, see [Quotas](/core/concepts/features/configuration/server-config/quotas).
