...
Projections are in some ways similar to [Materialized Views](/core/concepts/features/materialized-views)
...
<Image img="/images/data-modeling/projections_1.png" size="md" alt="Projections in ClickHouse"/>
...
using the table from our [UK Property Price Paid](/core/get-started/sample-datasets/uk-price-paid)
...
refer to ["The UK property prices dataset"](/core/get-started/sample-datasets/uk-price-paid)
page.
...
The [`mutations_sync`](/core/reference/settings/session-settings#mutations_sync) setting is
...
<Image img="/images/data-modeling/projections_2.png" size="md" alt="Visualization of the main table uk_price_paid_with_projections and its two projections"/>
...
The following queries contrast performance with and without projections. To disable projection use we use the setting [`optimize_use_projections`](/core/reference/settings/session-settings#optimize_use_projections), which is enabled by default.
...
- [A Practical Introduction to Primary Indexes in ClickHouse](/core/guides/clickhouse/data-modelling/sparse-primary-indexes#option-3-projections)
- [Materialized Views](/core/concepts/features/materialized-views)
- [ALTER PROJECTION](/core/reference/statements/alter/projection)
