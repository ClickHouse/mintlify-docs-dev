...
<Steps>
<Step title="Open the data catalog flyout">
...
<Step title="Add your catalog connection">

<a id="add-your-catalog-connection"></a>
...
<Tab title="Unity Catalog (Iceberg)">
...
<Steps>
<Step title="View your catalog tables">
