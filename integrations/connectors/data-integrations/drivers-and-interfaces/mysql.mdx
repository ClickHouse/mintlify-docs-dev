...
<Image img="/static/images/interfaces/mysql0.png" alt="Credentials screen - Prompt" size="md"/>

2. Change the `Connect with` drop-down to `MySQL`. 

<br/>

<Image img="/static/images/interfaces/mysql1.png" alt="Credentials screen - MySQL selected" size="md" />
...
<Image img="/static/images/interfaces/mysql2.png" alt="Credentials screen - Enabled MySQL" size="md"/>

Copy the MySQL connection string shown.

<Image img="/static/images/interfaces/mysql3.png" alt="Credentials screen - Connection String" size="md"/>
