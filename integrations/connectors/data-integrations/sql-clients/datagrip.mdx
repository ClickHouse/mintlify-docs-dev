...
<Image img="/static/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="DataGrip Data Sources tab with + icon highlighted" />
...
<Image img="/static/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="DataGrip selecting ClickHouse from the data sources list" />
...
<Image img="/static/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="DataGrip Drivers tab showing ClickHouse driver installation" />
...
<Image img="/static/images/integrations/sql-clients/datagrip-7.png" border alt="DataGrip connection details form with ClickHouse settings" />
