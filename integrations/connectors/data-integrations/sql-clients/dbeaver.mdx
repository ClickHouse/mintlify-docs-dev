...
<Image img="/static/images/integrations/sql-clients/dbeaver-add-database.png" size="md" border alt="Add a new database" />

- Select **Analytical** and then **ClickHouse**:

- Build the JDBC URL. On the **Main** tab set the Host, Port, Username, Password, and Database:

<Image img="/static/images/integrations/sql-clients/dbeaver-host-port.png" size="md" border alt="Set the hostname, port, user, password, and database name" />
...
<Image img="/static/images/integrations/sql-clients/dbeaver-use-ssl.png" size="md" border alt="Enable SSL if required" />

- Test the connection:

<Image img="/static/images/integrations/sql-clients/dbeaver-test-connection.png" size="md" border alt="Test the connection" />

If DBeaver detects that you don't have the ClickHouse driver installed it will offer to download them for you:

<Image img="/static/images/integrations/sql-clients/dbeaver-download-driver.png" size="md" border alt="Download the ClickHouse driver" />
...
<Image img="/static/images/integrations/sql-clients/dbeaver-sql-editor.png" size="md" border alt="Open the SQL editor" />

- An example query against `system.query_log`:

<Image img="/static/images/integrations/sql-clients/dbeaver-query-log-select.png" size="md" border alt="A sample query" />
