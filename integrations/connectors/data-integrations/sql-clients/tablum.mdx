...
<Image img="/static/images/integrations/sql-clients/tablum-ch-0.png" size="md" border alt="TABLUM.IO login page" />
...
<Image img="/static/images/integrations/sql-clients/tablum-ch-1.png" size="lg" border alt="Adding a ClickHouse connector in TABLUM.IO" />
...
<Image img="/static/images/integrations/sql-clients/tablum-ch-2.png" size="lg" border alt="Selecting the ClickHouse connector in TABLUM.IO" />
...
<Image img="/static/images/integrations/sql-clients/tablum-ch-3.png" size="lg" border alt="Running a SQL query in TABLUM.IO" />
