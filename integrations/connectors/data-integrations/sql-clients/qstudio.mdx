...
<Image img="/static/images/integrations/sql-clients/qstudio-add-connection.png" size="lg" border alt="QStudio database connection configuration screen showing ClickHouse connection settings" />
...
<Image img="/static/images/integrations/sql-clients/qstudio-running-query.png" size="lg" border alt="QStudio interface showing sample SQL query execution against ClickHouse database" />
