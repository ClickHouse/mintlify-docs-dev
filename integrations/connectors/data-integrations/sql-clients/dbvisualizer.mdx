...
<Image img="/static/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="DbVisualizer driver manager interface showing ClickHouse JDBC driver configuration" />
