...
## 2. Create a ClickHouse resource <a id="2-create-a-clickhouse-resource"></a>

Login to your Retool account and navigate to the _Resources_ tab. Choose "Create New" -> "Resource":

<Image img="/images/integrations/tools/data-integration/retool/retool_01.png" size="lg" border alt="Creating a new resource" />
<br/>

Select "JDBC" from the list of available connectors:

<Image img="/images/integrations/tools/data-integration/retool/retool_02.png" size="lg" border alt="Choosing JDBC connector" />
<br/>

In the setup wizard, make sure you select `com.clickhouse.jdbc.ClickHouseDriver` as the "Driver name":

<Image img="/images/integrations/tools/data-integration/retool/retool_03.png" size="lg" border alt="Selecting the right driver" />
<br/>
...
<Image img="/images/integrations/tools/data-integration/retool/retool_04.png" size="lg" border alt="Specifying your credentials" />
<br/>

After that, test your connection:

<Image img="/images/integrations/tools/data-integration/retool/retool_05.png" size="lg" border alt="Testing your connection" />
<br/>
