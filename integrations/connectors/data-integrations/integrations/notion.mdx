...
5. Expand the new connection to review the [available ClickHouse tools](/products/cloud/features/ai-ml/remote-mcp#available-tools) and toggle on the ones you want this agent to use. All ClickHouse Remote MCP tools are read-only.
...
For the full set of natural-language patterns and tools, see the [Remote MCP example usage](/products/cloud/features/ai-ml/mcp/remote-mcp#example-usage) section.
