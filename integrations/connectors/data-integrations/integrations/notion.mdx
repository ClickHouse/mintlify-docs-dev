...
## Connect ClickHouse to a Notion custom agent <a id="connect-clickhouse-to-notion"></a>
...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="Selecting ClickHouse in the Notion Add connection picker"/>
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="The expanded ClickHouse connection in Notion showing the per-tool toggles"/>
