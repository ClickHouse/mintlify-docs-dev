...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx-cloud-artitecture.png" size="lg" border alt="EMQX Cloud Architecture diagram showing cloud infrastructure components" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_1.png" size="sm" border alt="ClickHouse Cloud Service Deployment interface showing AWS region selection" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_2.png" size="sm" border alt="ClickHouse Cloud Connection Settings showing IP access configuration" />

Then you need to save your username and password for future use.

<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_3.png" size="sm" border alt="ClickHouse Cloud Credentials screen showing username and password" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_4.png" size="lg" border alt="ClickHouse Cloud Running Instance dashboard with connection options" />

Click "Connect to SQL Console" to create database and table for integration with EMQX Cloud.

<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_5.png" size="lg" border alt="ClickHouse Cloud SQL Console interface" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_cloud_6.png" size="lg" border alt="ClickHouse Cloud Create Database and Table SQL query execution" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_sign_up.png" size="lg" border alt="EMQX Cloud Signup Page with registration form" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_create_1.png" size="lg" border alt="EMQX Cloud Create Deployment Step 1 showing deployment options" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_create_2.png" size="lg" border alt="EMQX Cloud Create Deployment Step 2 showing region selection" />

Now click the panel to go to the cluster view. On this dashboard, you will see the overview of your MQTT broker.

<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_overview.png" size="lg" border alt="EMQX Cloud Overview Dashboard showing broker metrics" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_auth.png" size="lg" border alt="EMQX Cloud Authentication Setup interface for adding credentials" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_nat_gateway.png" size="lg" border alt="EMQX Cloud NAT Gateway Configuration panel" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/emqx_cloud_data_integration.png" size="lg" border alt="EMQX Cloud Data Integration Options showing available connectors" />

EMQX Cloud offers more than 30 native integrations with popular data systems. ClickHouse is one of them.

<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_clickhouse.png" size="lg" border alt="EMQX Cloud ClickHouse Data Integration connector details" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_resource.png" size="lg" border alt="EMQX Cloud ClickHouse Resource Setup form with connection details" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_rule_1.png" size="md" border alt="EMQX Cloud Data Integration Rule Creation Step 1 showing SQL query" />

You can use the SQL test to test and see the results.

<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_rule_2.png" size="md" border alt="EMQX Cloud Data Integration Rule Creation Step 2 showing test results" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_rule_action.png" size="md" border alt="EMQX Cloud Data Integration Rule Action Setup with SQL template" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/data_integration_details.png" size="md" border alt="EMQX Cloud Data Integration Rule Details showing configuration summary" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/work-flow.png" size="lg" border alt="EMQX Cloud to ClickHouse Workflow diagram showing data flow" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/mqttx-overview.png" size="lg" border alt="MQTTX Overview showing the client interface" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/mqttx-new.png" size="lg" border alt="MQTTX New Connection Setup form with connection details" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/mqttx-publish.png" size="lg" border alt="MQTTX Publish MQTT Messages interface showing message composition" />

### View rules monitoring {#view-rules-monitoring}

Check the rule monitoring and add one to the number of success.

<Image img="/static/images/integrations/data-ingestion/emqx/rule_monitor.png" size="lg" border alt="EMQX Cloud Rule Monitoring dashboard showing message processing metrics" />
...
<Image img="/static/images/integrations/data-ingestion/emqx/clickhouse_result.png" size="lg" border alt="ClickHouse Query Results showing persisted IoT data" />
