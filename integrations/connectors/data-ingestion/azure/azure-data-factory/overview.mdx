...
| [Using the ClickHouse HTTP interface](/integrations/connectors/data-ingestion/azure/azure-data-factory/using-http-interface)           | Uses the [ClickHouse HTTP interface](/integrations/connectors/data-integrations/drivers-and-interfaces/http) as a data source within Azure Data Factory, allowing you to copy data or use it in data flow activities as part of your pipelines. |
