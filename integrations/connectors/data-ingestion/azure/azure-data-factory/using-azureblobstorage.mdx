...
`TSV`, `ORC`, `Avro`, and more. For the full list see ["Data formats"](/reference/formats).
...
2. In the left-hand menu, select **Access keys** under the **Security +
   networking** section.
   <Image img="/static/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="Azure Data Store Settings" border/>

3. Choose either **key1** or **key2**, and click the **Show** button next to
   the **Connection string** field.
   <Image img="/static/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="Azure Data Store Access Keys" border/>
...
inference from input data](/integrations/connectors/data-integrations/drivers-and-interfaces/schema-inference)
</Info>
...
- [Formats for Input and Output Data](/reference/formats)
