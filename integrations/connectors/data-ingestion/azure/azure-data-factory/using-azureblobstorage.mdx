...
`TSV`, `ORC`, `Avro`, and more. For the full list see ["Data formats"](/core/reference/formats).
...
[`azureBlobStorage` Table Function documentation page](/core/reference/functions/table-functions/azureBlobStorage)
...
1. Download a [sample file](https://clickhouse-public-datasets.s3.eu-central-1.amazonaws.com/sensors/monthly/2019-06_bmp180.csv.zst)
   from the [Environmental Sensors Dataset](/core/get-started/sample-datasets/environmental-sensors)
...
inference from input data](/core/concepts/features/interfaces/schema-inference)
</Info>
...
- [Formats for Input and Output Data](/core/reference/formats)
