...
The [`azureBlobStorage` Table Function](/core/reference/functions/table-functions/azureBlobStorage)
...
[ClickHouse HTTP interface](/core/concepts/features/interfaces/http)
...
using the [ClickHouse HTTP interface](/core/concepts/features/interfaces/http).
You can learn more in the [ClickHouse HTTP Interface
documentation](/core/concepts/features/interfaces/http).
...
1. Log in to the [Microsoft Azure Portal](https://portal.azure.com/) and click
   **Create a resource**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-page.png" size="lg" alt="Azure Portal Home Page" border/>

2. In the Categories pane on the left, select **Analytics**, then click on
   **Data Factory** in the list of popular services.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-resource-analytics.png" size="lg" alt="Azure Portal New Resource" border/>
...
3. Select your subscription and resource group, enter a name for the new Data
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory.png" size="lg" alt="Azure Portal New Data Factory" border/>

3. Click **Review + Create**, then click **Create** to launch the deployment.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-confirm.png" size="lg" alt="Azure Portal New Data Factory Confirm" border/>

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-success.png" size="lg" alt="Azure Portal New Data Factory Success" border/>
...
1. Log in to the Microsoft Azure Portal and open your Data Factory instance.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.png" size="lg" alt="Azure Portal Home Page with Data Factory" border/>

2. On the Data Factory overview page, click **Launch Studio**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-factory-page.png" size="lg" alt="Azure Portal Data Factory Page" border/>

3. In the left-hand menu, select **Manage**, then go to **Linked services**,
   and click **+ New** to create a new linked service.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.png" size="lg" alt="Azure Data Factory New Linked Service Button" border/>
...
4. In the **New linked service search bar**, type **REST**, select **REST**, and click **Continue**
   ...
   instance.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.png" size="lg" alt="Azure Data Factory New Linked Service Search" border/>
...
5. In the linked service configuration pane enter a name for your new service,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-lined-service-pane.png" size="lg" alt="New Lined Service Pane" border/>
...
6. In the dynamic content pane you can create a parameterized URL, which
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.png" size="lg" alt="New Linked ServiceBase Url Empty" border/>
...
7. Click the **"+"** next to the filter input and add a new parameter, name it
   ...
   Click **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.png" size="lg" alt="New Linked Service Parameters" border/>
...
8. In the expression field, enter the following and click **OK**. Replace
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.png" size="lg" alt="New Linked Service Expression Field Filled" border/>
...
9. Back in the main form select Basic authentication, enter the username and
   ...
   message.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-check-connection.png" size="lg" alt="New Linked Service Check Connection" border/>

10. Click **Create** to finalize the setup.
    <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-linked-services-list.png" size="lg" alt="Linked Services List" border/>
...
Data](/core/get-started/sample-datasets/environmental-sensors).
...
2. In Azure Data Factory Studio, select Author in the left-hand pane. Hover
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-item.png" size="lg" alt="New Dataset Item" border/>
...
3. In the search bar, type **REST**, select **REST**, and click **Continue**.
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-page.png" size="lg" alt="New Dataset Page" border/>
...
4. You should now see your newly created dataset listed under the Datasets
   ...
   content.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-properties.png" size="lg" alt="New Dataset Properties" border/>
...
<Warning>
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-query.png" size="xl" alt="New Dataset Query" border/>
...
6. Click OK to save the expression. Click Test connection. If everything is
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-connection-successful.png" size="xl" alt="New Dataset Connection Successful" border/>
...
1. Open **Azure Data Factory Studio**, go to the **Author tab**. In the
   **Factory Resources** pane, hover over **Pipeline**, click the three-dot
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-pipeline-item.png" size="lg" alt="ADF New Pipeline Item" border/>

2. In the **Activities** pane, expand the **Move and transform** section and
   drag the **Copy data** activity onto the canvas.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-copy-data-item.png" size="lg" alt="New Copy DataItem" border/>
...
<Info>
   ...
   [Selecting an Insert Strategy / Batch inserts if synchronous](/core/concepts/best-practices/selecting-an-insert-strategy#batch-inserts-if-synchronous)
   for more details.
</Info>
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-sink-select-post.png" size="lg" alt="Copy Data Sink Select Post" border/>
...
- [HTTP Interface](/core/concepts/features/interfaces/http)
...
- [Selecting an Insert Strategy](/core/concepts/best-practices/selecting-an-insert-strategy)
