...
## Turning ClickHouse into a REST service <a id="turning-clickhouse-to-a-rest-service"></a>
...
## Creating an Azure data factory instance <a id="create-an-azure-data-factory-instance"></a>
...
## Creating a new REST-Based linked service <a id="-creating-new-rest-based-linked-service"></a>
...
## Creating a new dataset for the ClickHouse HTTP Interface <a id="creating-a-new-dataset-for-the-clickhouse-http-interface"></a>
...
### Setting up an example dataset <a id="setting-up-an-example-dataset"></a>
...
## Creating a Copy Activity to transfer data to ClickHouse <a id="creating-the-copy-activity-to-transfer-data-to-clickhouse"></a>
