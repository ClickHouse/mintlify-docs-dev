...
<Image img="/static/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="Setting Spark configurations via notebook" border/>
...
<Image img="/static/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Verifying ClickHouse settings using Spark UI" border/>

## Additional resources {#additional-resources}

- [ClickHouse Spark Connector Docs](/integrations/connectors/data-ingestion/apache-spark)
