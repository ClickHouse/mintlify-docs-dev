...
## Add the connector's dependencies <a id="add-connector-dependencies"></a>
...
## Add ClickHouse as a catalog <a id="add-clickhouse-as-catalog"></a>
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="Setting Spark configurations via notebook" border/>
...
## Setup verification <a id="setup-verification"></a>
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Verifying ClickHouse settings using Spark UI" border/>
