...
#### 1. Install Kafka Connect and Connector <a id="1-install-kafka-connect-and-connector"></a>
...
#### 2. Download and install the JDBC Driver <a id="2-download-and-install-the-jdbc-driver"></a>
...
#### 3. Prepare configuration <a id="3-prepare-configuration"></a>
...
#### 4. Create the ClickHouse table <a id="4-create-the-clickhouse-table"></a>
...
#### 5. Start Kafka Connect <a id="5-start-kafka-connect"></a>
...
#### 6. Add data to Kafka <a id="6-add-data-to-kafka"></a>
...
### Recommended further reading <a id="recommended-further-reading"></a>
