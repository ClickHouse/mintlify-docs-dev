...
### Kafka to ClickHouse <a id="kafka-to-clickhouse"></a>
...
##### 2. Configure ClickHouse <a id="2-configure-clickhouse"></a>
...
##### 3. Create the destination table <a id="3-create-the-destination-table"></a>
...
##### 4. Create and populate the topic <a id="4-create-and-populate-the-topic"></a>
...
##### 5. Create the Kafka table engine <a id="5-create-the-kafka-table-engine"></a>
...
##### 6. Create the materialized view <a id="6-create-the-materialized-view"></a>
...
##### 7. Confirm rows have been inserted <a id="7-confirm-rows-have-been-inserted"></a>
...
##### Stopping & restarting message consumption <a id="stopping--restarting-message-consumption"></a>
...
##### Adding Kafka metadata <a id="adding-kafka-metadata"></a>
...
##### Modify Kafka engine settings <a id="modify-kafka-engine-settings"></a>
...
##### Debugging Issues <a id="debugging-issues"></a>
...
##### Handling malformed messages <a id="handling-malformed-messages"></a>
...
##### Delivery Semantics and challenges with duplicates <a id="delivery-semantics-and-challenges-with-duplicates"></a>
...
##### Quorum based Inserts <a id="quorum-based-inserts"></a>
...
### ClickHouse to Kafka <a id="clickhouse-to-kafka"></a>
...
##### 1. Inserting rows directly <a id="1-inserting-rows-directly"></a>
...
##### 2. Using materialized views <a id="2-using-materialized-views"></a>
...
### Clusters and performance <a id="clusters-and-performance"></a>

#### Working with ClickHouse Clusters <a id="working-with-clickhouse-clusters"></a>
...
#### Tuning performance <a id="tuning-performance"></a>
...
#### Additional settings <a id="additional-settings"></a>
