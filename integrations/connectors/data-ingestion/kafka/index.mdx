...
## Available options <a id="available-options"></a>
...
### ClickPipes for Kafka <a id="clickpipes-for-kafka"></a>
...
#### Main features <a id="clickpipes-for-kafka-main-features"></a>
...
#### Getting started <a id="clickpipes-for-kafka-getting-started"></a>
...
### Kafka Connect Sink <a id="kafka-connect-sink"></a>
...
#### Main features <a id="kafka-connect-sink-main-features"></a>

* Can be configured to support exactly-once semantics
* Supports most common serialization formats (JSON, Avro, Protobuf)
* Tested continuously against ClickHouse Cloud

#### Getting started <a id="kafka-connect-sink-getting-started"></a>
...
### Kafka table engine <a id="kafka-table-engine"></a>
...
#### Main features <a id="kafka-table-engine-main-features"></a>
...
#### Getting started <a id="kafka-table-engine-getting-started"></a>
...
### Choosing an option <a id="choosing-an-option"></a>
