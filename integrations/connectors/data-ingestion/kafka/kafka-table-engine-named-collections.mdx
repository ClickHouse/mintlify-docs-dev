...
Refer to the [User Management Guide](/core/concepts/features/security/access-rights) for more details on enabling access control.
...
2. The section before `<kafka>` contains ClickHouse Kafka engine parameters. For a full list of parameters, refer to the [Kafka engine parameters ](/core/reference/engines/table-engines/integrations/kafka).
