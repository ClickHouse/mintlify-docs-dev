...
### Configuration notes <a id="configuration-notes"></a>
...
## Creating tables and databases <a id="creating-tables-and-databases"></a>
...
### Create the database <a id="create-the-database"></a>

```sql
CREATE DATABASE kafka_testing ON CLUSTER LAB_CLICKHOUSE_CLUSTER;
```

### Create Kafka tables <a id="create-kafka-tables"></a>
...
### Create replicated tables <a id="create-replicated-tables"></a>
...
### Create materialized views <a id="create-materialized-views"></a>
