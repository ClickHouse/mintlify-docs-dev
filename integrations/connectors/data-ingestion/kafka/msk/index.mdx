...
## The official Kafka connector from ClickHouse with Amazon MSK <a id="the-official-kafka-connector-from-clickhouse-with-amazon-msk"></a>
...
## Recommended IAM permissions (least privilege) <a id="iam-least-privilege"></a>
...
## Notes on networking for MSK Connect <a id="notes-on-networking-for-msk-connect"></a>
