...
## The official Kafka connector from ClickHouse with Confluent Platform <a id="the-official-kafka-connector-from-clickhouse-with-confluent-platform"></a>

### Installing on Confluent platform <a id="installing-on-confluent-platform"></a>
...
#### Create a Topic <a id="create-a-topic"></a>
...
#### Install connector <a id="install-connector"></a>
...
```
Example:
<Image img="/images/integrations/data-ingestion/kafka/confluent/AddCustomConnectorPlugin.png" size="md" alt="Confluent Platform UI showing settings for adding a custom ClickHouse connector" border/>

#### Gather your connection details <a id="gather-your-connection-details"></a>
<ConnectionDetails />

#### Configure the connector <a id="configure-the-connector"></a>
...
#### Specify the connection endpoints <a id="specify-the-connection-endpoints"></a>
