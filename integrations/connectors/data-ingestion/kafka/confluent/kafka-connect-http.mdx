...
### Quick start steps <a id="quick-start-steps"></a>

#### 1. Gather your connection details <a id="1-gather-your-connection-details"></a>
<ConnectionDetails />

#### 2. Run Kafka Connect and the HTTP sink connector <a id="2-run-kafka-connect-and-the-http-sink-connector"></a>
...
#### 3. Create destination table in ClickHouse <a id="3-create-destination-table-in-clickhouse"></a>
...
#### 4. Configure HTTP Sink <a id="4-configure-http-sink"></a>
Create a Kafka topic and an instance of HTTP Sink Connector:
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="Confluent Cloud interface showing how to create an HTTP Sink connector" border/>
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="Confluent Cloud interface showing authentication settings for the HTTP Sink connector" border/>
<br/>
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="Confluent Cloud interface showing advanced configuration options for the HTTP Sink connector" border/>

#### 5. Testing the connectivity <a id="5-testing-the-connectivity"></a>
Create an message in a topic configured by your HTTP Sink
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Confluent Cloud interface showing how to create a test message in a Kafka topic" border/>
...
#### HTTP Sink doesn't batch messages <a id="http-sink-doesnt-batch-messages"></a>
...
##### CANNOT_PARSE_QUOTED_STRING <a id="cannot_parse_quoted_string"></a>
...
### Load the GitHub dataset (optional) <a id="load-the-github-dataset-optional"></a>
...
##### 1. Prepare configuration <a id="1-prepare-configuration"></a>
...
##### 2. Create the ClickHouse table <a id="2-create-the-clickhouse-table"></a>
...
##### 3. Add data to Kafka <a id="3-add-data-to-kafka"></a>
