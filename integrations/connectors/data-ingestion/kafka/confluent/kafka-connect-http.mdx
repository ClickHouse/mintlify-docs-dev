...
<Image img="/static/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="Confluent Cloud interface showing how to create an HTTP Sink connector" border/>
...
<Image img="/static/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="Confluent Cloud interface showing authentication settings for the HTTP Sink connector" border/>
<br/>
...
<Image img="/static/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="Confluent Cloud interface showing advanced configuration options for the HTTP Sink connector" border/>

#### 5. Testing the connectivity {#5-testing-the-connectivity}
Create an message in a topic configured by your HTTP Sink
<Image img="/static/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Confluent Cloud interface showing how to create a test message in a Kafka topic" border/>
