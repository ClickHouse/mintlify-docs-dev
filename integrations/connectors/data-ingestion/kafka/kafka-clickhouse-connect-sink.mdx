...
### Requirements for the environment <a id="requirements-for-the-environment"></a>
...
### Version compatibility matrix <a id="version-compatibility-matrix"></a>
...
#### Gather your connection details <a id="gather-your-connection-details"></a>

<ConnectionDetails />

#### General installation instructions <a id="general-installation-instructions"></a>
...
### Target tables <a id="target-tables"></a>
...
### Configuration recipes <a id="configuration-recipes"></a>
...
#### Basic configuration with multiple topics <a id="basic-configuration-with-multiple-topics"></a>
...
#### Basic configuration with DLQ <a id="basic-configuration-with-dlq"></a>
...
#### Using with different data formats <a id="using-with-different-data-formats"></a>

##### Avro schema support <a id="avro-schema-support"></a>
...
###### Avro type mapping <a id="avro-type-mapping"></a>
...
###### Unsupported Avro schemas <a id="unsupported-avro-schemas"></a>
...
##### Protobuf schema support <a id="protobuf-schema-support"></a>
...
###### Protobuf type mapping <a id="proto-type-mapping"></a>
...
###### Note on translating `oneof` fields to ClickHouse columns <a id="oneof-translation"></a>
...
###### Unsupported Protobuf schemas <a id="unsupported-proto-schemas"></a>
...
##### JSON schema support <a id="json-schema-support"></a>
...
##### String support <a id="string-support"></a>
...
### Internal buffering <a id="internal-buffering"></a>
...
#### ClickHouse-Specific Metrics <a id="clickhouse-specific-metrics"></a>
...
#### Kafka Producer/Consumer Metrics <a id="kafka-producer-consumer-metrics"></a>
...
#### Kafka Connect Framework Metrics <a id="kafka-connect-framework-metrics"></a>
...
#### Monitoring Best Practices <a id="monitoring-best-practices"></a>
...
### Performance tuning and throughput optimization <a id="tuning-performance"></a>
...
#### When is performance tuning needed? <a id="when-is-performance-tuning-needed"></a>
...
#### Understanding the data flow <a id="understanding-the-data-flow"></a>
...
#### Kafka Connect batch size tuning <a id="connect-fetch-vs-connector-poll"></a>

The first level of optimization is controlling how much data the connector receives per batch from Kafka.

##### Fetch settings <a id="fetch-settings"></a>
...
##### Poll settings <a id="poll-settings"></a>
...
##### Recommended settings for high throughput <a id="recommended-batch-settings"></a>
...
#### Asynchronous inserts <a id="asynchronous-inserts"></a>
...
##### When to use async inserts <a id="when-to-use-async-inserts"></a>
...
##### How async inserts work <a id="how-async-inserts-work"></a>
...
##### Enabling async inserts <a id="enabling-async-inserts"></a>
...
##### Tuning async insert behavior <a id="tuning-async-inserts"></a>
...
##### Async inserts with exactly-once semantics <a id="async-inserts-with-exactly-once"></a>
...
#### Connector parallelism <a id="connector-parallelism"></a>

Increase parallelism to improve throughput:

##### Tasks per connector <a id="tasks-per-connector"></a>
...
##### Ignoring partitions when batching <a id="ignoring-partitions"></a>
...
#### Multiple high throughput topics <a id="multiple-high-throughput-topics"></a>
...
#### ClickHouse table engine considerations <a id="table-engine-considerations"></a>
...
#### Connection pooling and timeouts <a id="connection-pooling"></a>
...
#### Monitoring and troubleshooting performance <a id="monitoring-performance"></a>
...
#### Best practices summary <a id="performance-best-practices"></a>
...
#### Example: High-throughput configuration <a id="example-high-throughput"></a>
...
#### "State mismatch for topic `[someTopic]` partition `[0]`" <a id="state-mismatch-for-topic-sometopic-partition-0"></a>
...
#### "What errors will the connector retry?" <a id="what-errors-will-the-connector-retry"></a>
...
#### "All my data is blank/zeroes" <a id="all-my-data-is-blankzeroes"></a>
...
#### "I want to use my Kafka keys in ClickHouse" <a id="i-want-to-use-my-kafka-keys-in-clickhouse"></a>
