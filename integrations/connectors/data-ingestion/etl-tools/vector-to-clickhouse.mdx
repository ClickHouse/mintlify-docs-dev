...
<Image img="/static/images/integrations/data-ingestion/etl-tools/vector_01.png" size="lg" border alt="View ClickHouse logs in table format" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/vector_02.png" size="lg" border alt="View parsed ClickHouse logs in table format" />
