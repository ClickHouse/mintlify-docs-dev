...
<Steps>
<Step>
## Create a database and table <a id="1-create-a-database-and-table"></a>
...
<Step>
## Configure Nginx <a id="2--configure-nginx"></a>
...
<Step>
## Configure Vector <a id="3-configure-vector"></a>
...
<Step>
## Parse the Logs <a id="4-parse-the-logs"></a>
