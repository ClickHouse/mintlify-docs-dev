...
## Setup details <a id="setup-details"></a>

### User and role management <a id="user-and-role-management"></a>
...
## Type transformation mapping <a id="type-mapping"></a>
...
### Date and time value ranges <a id="date-and-time-value-ranges"></a>
...
## Destination tables <a id="table-structure"></a>
...
### Soft delete mode <a id="soft-delete-mode"></a>
...
#### Single primary key in the source table <a id="single-pk"></a>
...
#### Multiple primary keys in the source table <a id="multiple-pks"></a>
...
#### No primary keys in the source table <a id="no-pks"></a>
...
### History mode (SCD Type 2) <a id="history-mode"></a>
...
#### Single primary key in the source table <a id="history-single-pk"></a>
...
#### Multiple primary keys in the source table <a id="history-multiple-pks"></a>
...
#### No primary keys in the source table <a id="history-no-pks"></a>
...
### Selecting the latest version of the data without duplicates <a id="selecting-latest-version"></a>
...
## Retries on network failures <a id="retries-on-network-failures"></a>
