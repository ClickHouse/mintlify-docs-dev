...
### Grants test failed or operations are failing related to permissions <a id="grants-test-failed"></a>
...
### Error while waiting for all mutations to be completed <a id="mutations-not-completed"></a>
...
### Column mismatch error <a id="column-mismatch-error"></a>
...
### AST is too big (code 168) <a id="ast-too-big"></a>
...
### Memory limit exceeded / OOM (code 241) <a id="memory-limit-exceeded"></a>
...
### Unexpected EOF / Connection error <a id="unexpected-eof"></a>
...
### Can't map type UInt64 <a id="uint64-type-error"></a>
...
### No primary keys for table <a id="no-primary-keys"></a>
...
### Role-based grants failing <a id="role-based-grants"></a>
...
### Dedicated ClickHouse service for Fivetran <a id="dedicated-service"></a>
...
### Optimizing reading queries <a id="optimizing-reading-queries"></a>
...
### Primary key and ORDER BY optimization <a id="primary-key-optimization"></a>
...
### Don't manually modify Fivetran-managed tables <a id="dont-modify-tables"></a>
...
## Debugging operations <a id="debugging"></a>
...
### Debugging Fivetran syncs <a id="debugging-fivetran-syncs"></a>

Use the following queries to diagnose sync failures on the ClickHouse side.

#### Check recent ClickHouse errors related to Fivetran <a id="check-errors"></a>
...
#### Check recent Fivetran user activity <a id="check-activity"></a>
