...
<Steps>
<Step>
### Gather your ClickHouse connection details <a id="1-gather-your-connection-details"></a>

<ConnectionDetails />
</Step>
<Step>
### Apify prerequisites <a id="2-apify-prerequisites"></a>
...
<Step>
### Install dependencies <a id="3-install-dependencies"></a>
...
<Step>
### Create a target table in ClickHouse <a id="4-create-a-target-table"></a>
...
<Step>
### Fetch Apify dataset and load into ClickHouse <a id="5-fetch-and-load"></a>
...
<Step>
### Automate with webhooks <a id="6-automate-with-webhooks"></a>
...
### Fetching data from Apify <a id="fetching-data-from-apify"></a>
...
### Loading into ClickHouse <a id="loading-into-clickhouse"></a>
