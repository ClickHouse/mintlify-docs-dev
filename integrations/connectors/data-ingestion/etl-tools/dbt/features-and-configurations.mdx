...
## Profile.yml configurations <a id="profile-yml-configurations"></a>
...
```
### Schema vs Database <a id="schema-vs-database"></a>
...
### SET Statement Warning <a id="set-statement-warning"></a>
...
### Setting `quote_columns` <a id="setting-quote_columns"></a>
...
### About the ClickHouse Cluster <a id="about-the-clickhouse-cluster"></a>
...
#### Cluster Setting <a id="cluster-setting"></a>
...
#### Read-after-write Consistency <a id="read-after-write-consistency"></a>
...
## Additional ClickHouse macros <a id="additional-clickhouse-macros"></a>

### Model materialization utility macros <a id="model-materialization-utility-macros"></a>
...
### s3Source helper macro <a id="s3source-helper-macro"></a>
...
### Cross database macro support <a id="cross-database-macro-support"></a>
...
## Catalog Support <a id="catalog-support"></a>

### dbt Catalog Integration Status <a id="dbt-catalog-integration-status"></a>
...
### ClickHouse Catalog Support <a id="clickhouse-catalog-support"></a>
...
### Workarounds for Working with Iceberg and Catalogs <a id="workarounds-iceberg-catalogs"></a>
...
### Notes on the Workarounds <a id="benefits-workarounds"></a>
