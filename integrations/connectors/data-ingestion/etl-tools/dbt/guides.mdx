...
<Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_01.png" size="lg" alt="IMDB table schema" />
...
3. At this point, you will need the text editor of your choice. In the examples below, we use the popular VS Code. Opening the IMDB directory, you should see a collection of yml and sql files:
    ...
    <Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_02.png" size="lg" alt="New dbt project" />

4. Update your `dbt_project.yml` file to specify our first model - `actor_summary` and set profile to `clickhouse_imdb`.

    <Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_03.png" size="lg" alt="dbt profile" />

    <Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_04.png" size="lg" alt="dbt profile" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_05.png" size="lg" alt="incremental updates dbt" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_06.png" size="lg" alt="lightweight delete incremental" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/dbt/dbt_07.png" size="lg" alt="insert overwrite incremental" />
