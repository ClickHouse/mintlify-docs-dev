...
## General materialization configurations <a id="general-materialization-configurations"></a>
...
### Supported table engines <a id="supported-table-engines"></a>
...
#### Experimental supported table engines <a id="experimental-supported-table-engines"></a>
...
### A note on model settings <a id="a-note-on-model-settings"></a>
...
### Column Configuration <a id="column-configuration"></a>
...
#### Example of schema configuration <a id="example-of-schema-configuration"></a>
...
#### Adding complex types <a id="adding-complex-types"></a>
...
## Materialization: view <a id="materialization-view"></a>
...
## Materialization: table <a id="materialization-table"></a>
...
### Data skipping indexes <a id="data-skipping-indexes"></a>
...
## Materialization: incremental <a id="materialization-incremental"></a>
...
### Configurations <a id="incremental-configurations"></a>
...
### Incremental Model Strategies <a id="incremental-model-strategies"></a>

`dbt-clickhouse` supports three incremental model strategies.

#### The Default (Legacy) Strategy <a id="default-legacy-strategy"></a>
...
#### The Delete+Insert Strategy <a id="delete-insert-strategy"></a>
...
#### The Microbatch Strategy (Requires dbt-core >= 1.9) <a id="microbatch-strategy"></a>
...
##### Available Microbatch Configurations <a id="available-microbatch-configurations"></a>
...
#### The Append Strategy <a id="append-strategy"></a>
...
#### The insert_overwrite Strategy (Experimental) <a id="insert-overwrite-strategy"></a>
...
## Materialization: materialized_view <a id="materialized-view"></a>
...
## Materialization: dictionary (experimental) <a id="materialization-dictionary"></a>
...
## Materialization: distributed_table (experimental) <a id="materialization-distributed-table"></a>
...
### Distributed table model example <a id="distributed-table-model-example"></a>
...
### Generated migrations <a id="distributed-table-generated-migrations"></a>
...
### Configurations <a id="distributed-table-configurations"></a>
Configurations that are specific for this materialization type are listed below:
...
## materialization: distributed_incremental (experimental) <a id="materialization-distributed-incremental"></a>
...
### Distributed incremental model example <a id="distributed-incremental-model-example"></a>
...
### Generated migrations <a id="distributed-incremental-generated-migrations"></a>
...
## Contracts and Constraints <a id="contracts-and-constraints"></a>
