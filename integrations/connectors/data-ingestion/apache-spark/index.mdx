...
### Spark Runtime Environments <a id="spark-runtime-environment"></a>
#### Standard Spark runtimes <a id="standard-spark-runtime"></a>
...
#### Managed Spark platforms <a id="managed-spark-platforms"></a>
