...
## API Selection for Databricks <a id="api-selection"></a>
...
## Installation on Databricks <a id="installation"></a>

### Option 1: Upload JAR via Databricks UI <a id="installation-ui"></a>
...
### Option 2: Install via Databricks CLI <a id="installation-cli"></a>
...
### Option 3: Maven Coordinates (Recommended) <a id="installation-maven"></a>
...
## Using TableProvider API <a id="tableprovider-api"></a>
...
### Reading data <a id="reading-data-table-provider"></a>
...
### Writing data <a id="writing-data-unity"></a>
...
## Databricks-specific considerations <a id="considerations"></a>

### Access mode requirements <a id="access-mode"></a>
...
### ClickHouse Cloud connection <a id="clickhouse-cloud"></a>
...
### Complete workflow example <a id="workflow-example"></a>
