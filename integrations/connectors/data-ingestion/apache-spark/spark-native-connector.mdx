...
## Choosing Between Catalog API and TableProvider API <a id="choosing-between-apis"></a>
...
### Catalog API vs TableProvider API <a id="catalog-vs-tableprovider-comparison"></a>
...
### Import as a Dependency <a id="import-as-a-dependency"></a>
...
### Download the library <a id="download-the-library"></a>
...
## Register the catalog (required) <a id="register-the-catalog-required"></a>
...
## Using the TableProvider API (Format-based Access) <a id="using-the-tableprovider-api"></a>
...
### Format-based Read Example <a id="format-based-read"></a>
...
### Format-based Write Example <a id="format-based-write"></a>
...
### TableProvider Features <a id="tableprovider-features"></a>

The TableProvider API provides several powerful features:

#### Automatic Table Creation <a id="automatic-table-creation"></a>
...
### TableProvider Connection Options <a id="tableprovider-connection-options"></a>

When using the format-based API, the following connection options are available:

#### Connection Options <a id="connection-options"></a>
...
#### Table Creation Options <a id="table-creation-options"></a>
...
#### Writing Modes <a id="writing-modes"></a>
...
## Configuring ClickHouse Options <a id="configuring-clickhouse-options"></a>
...
### Using TableProvider API <a id="using-tableprovider-api-options"></a>
...
### Using Catalog API <a id="using-catalog-api-options"></a>
...
## ClickHouse Cloud settings <a id="clickhouse-cloud-settings"></a>
...
## DDL operations <a id="ddl-operations"></a>
...
## Working with VariantType <a id="working-with-varianttype"></a>
...
### ClickHouse Type Mapping <a id="clickhouse-type-mapping"></a>
...
### Reading VariantType Data <a id="reading-varianttype-data"></a>
...
### Writing VariantType Data <a id="writing-varianttype-data"></a>
...
### Creating VariantType Tables with Spark SQL <a id="creating-varianttype-tables-spark-sql"></a>
...
### Configuring Variant Types <a id="configuring-variant-types"></a>

When creating tables with VariantType columns, you can specify which ClickHouse types to use:

#### JSON Type (Default) <a id="json-type-default"></a>
...
#### Variant Type with Multiple Types <a id="variant-type-multiple-types"></a>
...
### Supported Variant Types <a id="supported-variant-types"></a>
...
### Read Format Configuration <a id="read-format-configuration"></a>
...
### Write Format Support <a id="write-format-support"></a>
...
### Best Practices <a id="varianttype-best-practices"></a>
...
### Example: Complete Workflow <a id="varianttype-example-workflow"></a>
...
### Reading data from ClickHouse into Spark <a id="reading-data-from-clickhouse-into-spark"></a>
...
### Inserting data from Spark into ClickHouse <a id="inserting-data-from-spark-into-clickhouse"></a>
...
## Contributing and support <a id="contributing-and-support"></a>
