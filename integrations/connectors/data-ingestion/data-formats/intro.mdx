...
### [**Binary**](/integrations/connectors/data-ingestion/data-formats/binary) {#binary}

Export and load binary formats such as ClickHouse Native, MessagePack, Protocol Buffers and Cap'n Proto.

### [**CSV and TSV**](/integrations/connectors/data-ingestion/data-formats/csv-tsv) {#csv-and-tsv}

Import and export the CSV family, including TSV, with custom headers and separators.

### [**JSON**](/integrations/connectors/data-ingestion/data-formats/json/intro) {#json}

Load and export JSON in various formats including as objects and line delimited NDJSON.

### [**Parquet data**](/integrations/connectors/data-ingestion/data-formats/parquet) {#parquet-data}

Handle common Apache formats such as Parquet and Arrow.

### [**SQL data**](/integrations/connectors/data-ingestion/data-formats/sql) {#sql-data}

Need a SQL dump to import into MySQL or Postgresql? Look no further.

If you're looking to connect a BI tool like Grafana, Tableau and others, check out the [Visualize category](/integrations/connectors/data-visualization) of the docs.
