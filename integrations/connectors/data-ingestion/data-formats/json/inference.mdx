...
If you have more dynamic JSON, to which new keys are added and multiple types are possible for the same path, see ["Working with semi-structured and dynamic data"](/integrations/connectors/data-ingestion/data-formats/json/inference#working-with-semi-structured-data).
...
To learn more about the data type inference, you can refer to [this](/integrations/connectors/data-integrations/drivers-and-interfaces/schema-inference) documentation page.
