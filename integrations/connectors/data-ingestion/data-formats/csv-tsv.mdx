...
We can also use [CustomSeparatedWithNames](/reference/formats/CustomSeparated/CustomSeparatedWithNames) to get headers exported and imported correctly. Explore [regex and template](/integrations/connectors/data-ingestion/data-formats/templates-regex) formats to deal with even more complex cases.
