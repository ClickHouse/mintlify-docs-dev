...
<Image img="/static/images/integrations/data-ingestion/etl-tools/image3.png" size="lg" />

#### What’s Happening Behind the Scenes {#whats-happening-behind-the-scenes}

<Image img="/static/images/integrations/data-ingestion/etl-tools/image1.png" size="lg" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/image2.png" size="lg" />
