...
## Why Stream Data from SQL Server to ClickHouse? <a id="why-stream-data-from-sql-server-to-clickhouse"></a>
...
## What You’ll Need to Get Started <a id="what-youll-need-to-get-started"></a>
...
### Connection Info <a id="connection-info"></a>
...
## Setting Up SQL Server as a Source <a id="setting-up-sql-server-as-a-source"></a>

Let’s get into it!

### Step 1: Creating a SQL Server Source in Streamkap <a id="step-1-creating-a-sql-server-source-in-streamkap"></a>
...
<Image img="/images/integrations/data-ingestion/etl-tools/image3.png" size="lg" />

#### What’s Happening Behind the Scenes <a id="whats-happening-behind-the-scenes"></a>

<Image img="/images/integrations/data-ingestion/etl-tools/image1.png" size="lg" />
...
## Creating a ClickHouse Destination <a id="creating-a-clickhouse-destination"></a>

Now let’s wire up the destination where we’ll send all this data.

### Step 2: Add a ClickHouse Destination in Streamkap <a id="step-2-add-a-clickhouse-destination-in-streamkap"></a>
...
### Upsert Mode: What Is That? <a id="upsert-mode-what-is-that"></a>
...
### Handling Schema Evolution <a id="handling-schema-evolution"></a>
...
## Building the Streaming Pipeline <a id="building-the-streaming-pipeline"></a>

With the source and destination set, it’s time for the fun part—streaming your data!

### Step 3: Set up the Pipeline in Streamkap <a id="step-3-set-up-the-pipeline-in-streamkap"></a>

#### Pipeline Setup <a id="pipeline-setup"></a>
...
#### Should You Backfill? <a id="should-you-backfill"></a>

<Image img="/images/integrations/data-ingestion/etl-tools/image2.png" size="lg" />
...
## Streaming in Action: What to Expect <a id="streaming-in-action-what-to-expect"></a>

Now your pipeline is set up and active!

### Step 4: Watch the Data Stream <a id="step-4-watch-the-data-stream"></a>
...
## Under the Hood: What’s Streamkap Actually Doing? <a id="under-the-hood-whats-streamkap-actually-doing"></a>
...
## Advanced Options <a id="advanced-options"></a>

### Upsert vs. Insert Modes <a id="upsert-vs-insert-modes"></a>
...
### Handling Schema Changes <a id="handling-schema-changes"></a>
...
## Real-World Monitoring: Keeping Tabs on the Pipeline <a id="real-world-monitoring-keeping-tabs-on-the-pipeline"></a>

### Checking Pipeline Health <a id="checking-pipeline-health"></a>
...
### Common Metrics to Watch <a id="common-metrics-to-watch"></a>

- Lag: How far is ClickHouse behind SQL Server?
- Throughput: Rows per second
- Error Rate: Should be near zero

## Going Live: Querying ClickHouse <a id="going-live-querying-clickhouse"></a>
...
## Next Steps and Deep Dives <a id="next-steps-and-deep-dives"></a>
...
## FAQ and Troubleshooting <a id="faq-and-troubleshooting"></a>
