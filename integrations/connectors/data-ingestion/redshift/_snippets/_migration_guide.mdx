...
* Enable data transformation scenarios (for example, see our [integration guide for dbt](/integrations/connectors/data-ingestion/etl-tools/dbt)).
...
<Note>
If you're using ClickHouse Cloud, you will need to run your ClickHouse JDBC Bridge on a separate environment and connect to ClickHouse Cloud using the [remoteSecure](/core/reference/functions/table-functions/remote) function
</Note>
</Step>
<Step>
