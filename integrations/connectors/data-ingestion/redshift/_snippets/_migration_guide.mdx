...
<Image img="/images/integrations/data-ingestion/redshift/redshift-to-clickhouse.png" size="md" alt="Redshift to ClickHouse Migration Options"/>
...
## Push Data from Redshift to ClickHouse <a id="push-data-from-redshift-to-clickhouse"></a>
...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="PUSH Redshift to ClickHouse"/>
...
## Pull Data from Redshift to ClickHouse <a id="pull-data-from-redshift-to-clickhouse"></a>
...
<Image img="/images/integrations/data-ingestion/redshift/pull.png" size="md" alt="PULL from Redshift to ClickHouse"/>
...
<Steps>
<Step>
#### Deploy ClickHouse JDBC Bridge <a id="deploy-clickhouse-jdbc-bridge"></a>
...
<Step>
#### Configure your Redshift datasource <a id="configure-your-redshift-datasource"></a>
...
<Step>
#### Query your Redshift instance from ClickHouse <a id="query-your-redshift-instance-from-clickhouse"></a>
...
<Step>
#### Import Data from Redshift to ClickHouse <a id="import-data-from-redshift-to-clickhouse"></a>
...
## Pivot Data from Redshift to ClickHouse using S3 <a id="pivot-data-from-redshift-to-clickhouse-using-s3"></a>
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.png" size="md" alt="PIVOT from Redshift using S3"/>
...
### Tutorial <a id="tutorial-1"></a>

<Steps>
<Step>
#### Export data into an S3 bucket using UNLOAD <a id="export-data-into-an-s3-bucket-using-unload"></a>
...
<Image img="/images/integrations/data-ingestion/redshift/s3-1.png" size="md" alt="UNLOAD from Redshift to S3" background="white"/>

It will generate part files containing the raw data in S3

<Image img="/images/integrations/data-ingestion/redshift/s3-2.png" size="md" alt="Data in S3" background="white"/>
</Step>
<Step>
#### Create the table in ClickHouse <a id="create-the-table-in-clickhouse"></a>
...
<Step>
#### Load S3 files into ClickHouse <a id="load-s3-files-into-clickhouse"></a>
