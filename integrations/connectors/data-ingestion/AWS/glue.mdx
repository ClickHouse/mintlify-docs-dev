...
<Image img="/static/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size='md' alt='Glue Notebook connections config' force='true' />
...
<Image img="/static/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size='md' alt='Glue Notebook JAR path options' force='true' />
