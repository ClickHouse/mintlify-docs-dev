...
<Image img="/static/images/integrations/data-ingestion/s3/s3-j.png" size="lg" border alt="S3 bucket view in AWS console showing ClickHouse data files stored in S3" />
...
Refer to the [installation instructions](/get-started/setup/self-managed/install) when performing the deployment steps on the ClickHouse server nodes.
...
Refer to the [installation instructions](/get-started/setup/self-managed/install) when performing the deployment steps on the ClickHouse Keeper nodes.
...
<Image img="/static/images/integrations/data-ingestion/s3/bucket1.png" size="lg" border alt="Size of data in first S3 bucket showing storage usage metrics" />

<Image img="/static/images/integrations/data-ingestion/s3/bucket2.png" size="lg" border alt="Size of data in second S3 bucket showing storage usage metrics" />
