...
## S3 table functions <a id="s3-table-functions"></a>
...
### Reading Data from S3 <a id="reading-data-from-s3"></a>
...
### Using clickhouse-local <a id="using-clickhouse-local"></a>
...
### Inserting Data from S3 <a id="inserting-data-from-s3"></a>
...
### Remote Insert using ClickHouse Local <a id="remote-insert-using-clickhouse-local"></a>
...
### Splitting large files <a id="splitting-large-files"></a>
...
### Utilizing clusters <a id="utilizing-clusters"></a>
...
## S3 table engines <a id="s3-table-engines"></a>
...
## Managing credentials <a id="managing-credentials"></a>
...
## Optimizing for performance <a id="s3-optimizing-performance"></a>
...
### S3 storage tuning <a id="s3-storage-tuning"></a>
...
## S3 backed MergeTree <a id="s3-backed-mergetree"></a>
...
### Storage Tiers <a id="storage-tiers"></a>
...
### Creating a disk <a id="creating-a-disk"></a>
...
### Creating a storage policy <a id="creating-a-storage-policy"></a>
...
### Modifying a table <a id="modifying-a-table"></a>
...
### Handling replication <a id="handling-replication"></a>
...
### Read & writes <a id="read--writes"></a>
...
## Use S3 object storage as a ClickHouse disk <a id="configuring-s3-for-clickhouse-use"></a>
...
### Configure ClickHouse to use the S3 bucket as a disk <a id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk"></a>
...
## Replicating a single shard across two AWS regions using S3 Object Storage <a id="s3-multi-region"></a>
...
### Plan the deployment <a id="plan-the-deployment"></a>
...
### Install software <a id="install-software"></a>

#### ClickHouse server nodes <a id="clickhouse-server-nodes"></a>
...
#### Deploy ClickHouse <a id="deploy-clickhouse"></a>
...
#### Deploy ClickHouse Keeper <a id="deploy-clickhouse-keeper"></a>
...
### Create S3 buckets <a id="create-s3-buckets"></a>
...
### Configure ClickHouse Keeper <a id="configure-clickhouse-keeper"></a>
...
### Configure ClickHouse server <a id="configure-clickhouse-server"></a>

#### Define a cluster <a id="define-a-cluster"></a>
...
#### Disable zero-copy replication <a id="disable-zero-copy-replication"></a>
...
### Configure networking <a id="configure-networking"></a>
...
### Start the servers <a id="start-the-servers"></a>

#### Run ClickHouse Keeper <a id="run-clickhouse-keeper"></a>
...
#### Check ClickHouse Keeper status <a id="check-clickhouse-keeper-status"></a>
...
#### Run ClickHouse server <a id="run-clickhouse-server"></a>
...
#### Verify ClickHouse server <a id="verify-clickhouse-server"></a>
...
<!-- anchors from _S3_authentication_and_bucket.mdx -->
<a id="create-an-aws-iam-user"></a>
<a id="create-an-s3-bucket"></a>
<!-- anchors from _S3_authentication_and_bucket.mdx -->
<a id="create-an-aws-iam-user"></a>
<a id="create-an-s3-bucket"></a>