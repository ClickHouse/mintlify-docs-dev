...
## Insert Mechanics (single node) <a id="insert-mechanics-single-node"></a>
...
### Insert block size <a id="insert-block-size"></a>
...
#### Be aware of merges <a id="be-aware-of-merges"></a>
...
### Insert parallelism <a id="insert-parallelism"></a>
...
## Measuring performance <a id="measuring-performance"></a>
...
## Impact of hardware size <a id="impact-of-hardware-size"></a>
...
## Region locality <a id="region-locality"></a>
...
## Example dataset <a id="example-dataset"></a>
...
## Using threads for reads <a id="using-threads-for-reads"></a>
...
## Tuning threads and block size for inserts <a id="tuning-threads-and-block-size-for-inserts"></a>
...
## Scaling with resources and nodes <a id="scaling-with-resources-and-nodes"></a>

Scaling with resources and nodes applies to both read and insert queries.

### Vertical scaling <a id="vertical-scaling"></a>
...
### Horizontal scaling <a id="horizontal-scaling"></a>
...
## Further tuning <a id="further-tuning"></a>

### Disable de-duplication <a id="disable-de-duplication"></a>
...
### Optimize on insert <a id="optimize-on-insert"></a>
