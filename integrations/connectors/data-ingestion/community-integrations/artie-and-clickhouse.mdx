...
<Image img="/static/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Artie signup page" />
...
<Image img="/static/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Artie Edit Pipeline interface" />
...
Analytics Portal
<Image img="/static/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="Analytics Portal"/>

Pipeline and table specific monitors
<Image img="/static/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="Built-in monitoring"/>

Daily schema change notifications
<Image img="/static/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="Schema notification"/>
