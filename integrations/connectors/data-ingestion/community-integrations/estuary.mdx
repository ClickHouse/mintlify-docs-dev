...
<Steps>
<Step>
### Create an Estuary materialization <a id="1-create-an-estuary-materialization"></a>
...
<Step>
### Enter Kafka connection details <a id="2-enter-kafka-connection-details"></a>
...
<Step>
### Configure incoming data <a id="3-configure-incoming-data"></a>
