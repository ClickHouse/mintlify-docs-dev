...
## Pipeline requirements <a id="pipeline-requirements"></a>
...
## Source and target tables schema <a id="source-and-target-tables-schema"></a>
...
## Data type mapping <a id="data-types-mapping"></a>
...
## Running the Template <a id="running-the-template"></a>
...
### Install & Configure `gcloud` CLI <a id="install--configure-gcloud-cli"></a>
...
### Run command <a id="run-command"></a>
...
### Command breakdown <a id="command-breakdown"></a>
...
### Expected response <a id="expected-response"></a>
...
### Monitor the job <a id="monitor-the-job"></a>
...
### Memory limit (total) exceeded error (code 241) <a id="code-241-dbexception-memory-limit-total-exceeded"></a>
...
## Template source code <a id="template-source-code"></a>
