...
## Message format and schema mapping <a id="message-format-and-schema-mapping"></a>
...
## Batching and windowing <a id="batching-and-windowing"></a>
...
## Dead-letter handling <a id="dead-letter-handling"></a>
...
### ClickHouse dead-letter table <a id="clickhouse-dead-letter-table"></a>
...
### Pub/Sub dead-letter topic <a id="pubsub-dead-letter-topic"></a>
...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="Dataflow console showing a running Pub/Sub to ClickHouse job" />
...
### All messages are going to the dead-letter destination <a id="all-messages-going-to-dlq"></a>
...
### Pipeline starts but no rows arrive in ClickHouse <a id="no-rows-arriving"></a>
