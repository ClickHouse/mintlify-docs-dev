...
<Note>
This guide uses the [New York City Taxi dataset](/core/get-started/sample-datasets/nyc-taxi). There are many other datasets that you can use from [our docs](http://localhost:3000/docs/getting-started/example-datasets).
</Note>
