...
<Image img="/static/images/integrations/splunk/splunk-1.png" size="lg" border alt="Splunk dashboard showing NYC taxi data visualizations" />
...
<Image img="/static/images/integrations/splunk/splunk-2.png" size="md" border alt="Splunk DB Connect settings page showing Java Home configuration" />
...
<Image img="/static/images/integrations/splunk/splunk-3.png" size="lg" border alt="Splunk DB Connect drivers page showing ClickHouse driver successfully installed" />
...
<Image img="/static/images/integrations/splunk/splunk-4.png" size="sm" border alt="Splunk DB Connect new connection button" />

<br />

Add ClickHouse host details and ensure "Enable SSL" is ticked:

<Image img="/static/images/integrations/splunk/splunk-5.png" size="md" border alt="Splunk connection configuration page for ClickHouse" />
...
<Image img="/static/images/integrations/splunk/splunk-6.png" size="md" border alt="Splunk SQL Explorer selecting connection to ClickHouse" />

Execute a SQL query on the `trips` table that returns the count of all the records in the table:

<Image img="/static/images/integrations/splunk/splunk-7.png" size="md" border alt="Splunk SQL query execution showing count of records in trips table" />
...
<Image img="/static/images/integrations/splunk/splunk-8.png" size="lg" border alt="Splunk column chart visualization showing top 10 pickup neighborhoods" />
...
<Image img="/static/images/integrations/splunk/splunk-9.png" size="lg" border alt="Splunk bar chart showing average fare by passenger count" />
...
<Image img="/static/images/integrations/splunk/splunk-10.png" size="lg" border alt="Final Splunk dashboard with multiple visualizations of NYC taxi data" />
