...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="Splunk dashboard showing NYC taxi data visualizations" />
...
## Install and configure DB Connect on Splunk Enterprise <a id="install-and-configure-db-connect-on-splunk-enterprise"></a>
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Splunk DB Connect settings page showing Java Home configuration" />

## Configure JDBC for ClickHouse <a id="configure-jdbc-for-clickhouse"></a>
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="Splunk DB Connect drivers page showing ClickHouse driver successfully installed" />

## Connect Splunk search to ClickHouse <a id="connect-splunk-search-to-clickhouse"></a>
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Splunk DB Connect new connection button" />

<br />

Add ClickHouse host details and ensure "Enable SSL" is ticked:

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="Splunk connection configuration page for ClickHouse" />
...
## Run a SQL query <a id="run-a-sql-query"></a>
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="Splunk SQL Explorer selecting connection to ClickHouse" />

Execute a SQL query on the `trips` table that returns the count of all the records in the table:

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="Splunk SQL query execution showing count of records in trips table" />

If your query is successful, you should see the results.

## Create a dashboard <a id="create-a-dashboard"></a>
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="Splunk column chart visualization showing top 10 pickup neighborhoods" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="Splunk bar chart showing average fare by passenger count" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="Final Splunk dashboard with multiple visualizations of NYC taxi data" />
