...
<Image size="md" img="/images/integrations/data-visualization/superset_12.png" alt="Superset dashboard showing UK property prices with multiple visualizations including pie charts and tables" border />
<br/>
...
## 1. Gather your connection details <a id="1-gather-your-connection-details"></a>
<ConnectionDetails />

## 2. Install the Driver <a id="2-install-the-driver"></a>
...
## 3. Connect Superset to ClickHouse <a id="3-connect-superset-to-clickhouse"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/superset_01.png" alt="Superset interface showing the Database menu with + Database button highlighted" border />
<br/>

2. In the first step, select **ClickHouse Connect** as the type of database:

<Image size="sm" img="/images/integrations/data-visualization/superset_02.png" alt="Superset database connection wizard showing ClickHouse Connect option selected" border />
<br/>
...
<Image size="sm" img="/images/integrations/data-visualization/superset_03.png" alt="Superset connection configuration form showing ClickHouse connection parameters" border />
<br/>
...
## 4. Add a Dataset <a id="4-add-a-dataset"></a>
...
<Image size="sm" img="/images/integrations/data-visualization/superset_04.png" alt="Superset dataset creation dialog showing available tables from ClickHouse database" border />
<br/>
...
## 5.  Creating charts and a dashboard in Superset <a id="5--creating-charts-and-a-dashboard-in-superset"></a>
...
<Image size="md" img="/images/integrations/data-visualization/superset_05.png" alt="Empty Superset dashboard named UK property prices ready for charts to be added" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/superset_06.png" alt="Superset chart creation interface with Pie Chart visualization type selected" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/superset_08.png" alt="Dimension configuration showing district field selected for pie chart" border />
<Image size="md" img="/images/integrations/data-visualization/superset_09.png" alt="Metric configuration showing AVG(price) aggregate function for pie chart" border />
<br/>

5. If you prefer doughnut charts over pie, then you can set that and other options  under **CUSTOMIZE**:

<Image size="sm" img="/images/integrations/data-visualization/superset_10.png" alt="Customize panel showing doughnut chart option and other pie chart configuration settings" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/superset_11.png" alt="Save chart dialog with dashboard selection dropdown and Save & Go to Dashboard button" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/superset_12.png" alt="Completed Superset dashboard with multiple visualizations of UK property price data from ClickHouse" border />
<br/>
