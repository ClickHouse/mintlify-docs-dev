...
Please refer to [the official documentation](/core/concepts/features/interfaces/mysql) on how to set up a ClickHouse server with enabled MySQL interface.
...
it is also _required_ to use [Double SHA1 password encryption](/core/concepts/features/configuration/settings/settings-users#user-namepassword) for the user that will be using MySQL interface.
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_01.png" alt="Amazon QuickSight dashboard showing the New dataset button in Datasets section" border />
<br/>

Search for the official MySQL connector bundled with QuickSight (named just **MySQL**):

<Image size="md" img="/images/integrations/data-visualization/quicksight_02.png" alt="QuickSight data source selection screen with MySQL highlighted in search results" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_03.png" alt="QuickSight MySQL connection configuration form with hostname, port, database and credential fields" border />
<br/>

Now, you have two options on how to fetch the data from ClickHouse. First, you could select a table from the list:

<Image size="md" img="/images/integrations/data-visualization/quicksight_04.png" alt="QuickSight table selection interface showing database tables available from ClickHouse" border />
<br/>

Alternatively, you could specify a custom SQL to fetch your data:

<Image size="md" img="/images/integrations/data-visualization/quicksight_05.png" alt="QuickSight custom SQL query editor for fetching data from ClickHouse" border />
<br/>
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_06.png" alt="QuickSight data preview showing table structure with columns and sample data" border />
<br/>

Make sure you have "Direct Query" mode selected in the bottom left corner of the UI:

<Image size="md" img="/images/integrations/data-visualization/quicksight_07.png" alt="QuickSight interface with Direct Query mode option highlighted in bottom corner" border />
<br/>
