...
| Aggregates | A list of [aggregate functions](/reference/functions/aggregate-functions). Allows for custom values for function and column. Only visible in Aggregate mode. |
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_table_query.png" alt="Example aggregate table query" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="Example OTel logs query" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="Example of extra fields on logs query" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="Example time series query" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="Example OTel trace query" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="Example raw SQL query" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/static/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="Trace links in table" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  Example of trace links in logs
  <Image size="md" img="/static/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="Trace links in logs" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/grafana/demo_data_links.png" alt="Example of data links linking" border />
</div>
