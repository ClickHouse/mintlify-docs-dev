...
<Image size="sm" img="/static/images/integrations/data-visualization/grafana/config_common.png" alt="Example secure native config" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/config_http.png" alt="Extra HTTP config options" border />
...
<Image size="sm" img="/static/images/integrations/data-visualization/grafana/config_additional.png" alt="Example additional settings" border />
...
<Image size="sm" img="/static/images/integrations/data-visualization/grafana/config_logs.png" alt="Logs config" border />
...
<Image size="sm" img="/static/images/integrations/data-visualization/grafana/config_traces.png" alt="Traces config" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Example alias table config" border />

Now Grafana will see the results of the alias table instead of the results from `DESC example_table`:
<Image size="md" img="/static/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Example alias table select" border />
