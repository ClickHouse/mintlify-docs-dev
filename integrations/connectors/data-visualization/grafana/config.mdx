...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="Example secure native config" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="Extra HTTP config options" border />

#### HTTP path <a id="http-path"></a>
...
#### Custom HTTP headers <a id="custom-http-headers"></a>
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="Example additional settings" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="Logs config" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="Traces config" border />
...
### Column aliases <a id="column-aliases"></a>
...
#### Table-defined ALIAS columns <a id="table-defined-alias-columns"></a>
...
#### Column alias tables <a id="column-alias-tables"></a>
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Example alias table config" border />

Now Grafana will see the results of the alias table instead of the results from `DESC example_table`:
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Example alias table select" border />

Both types of aliasing can be used to perform complex type conversions or JSON field extraction.

## All YAML options <a id="all-yaml-options"></a>
