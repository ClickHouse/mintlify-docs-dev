...
## MEDIAN() and PERCENTILE() functions <a id="median-and-percentile-functions"></a>
...
## Additional functions for calculated fields in Live mode <a id="additional-functions-for-calculated-fields-in-live-mode"></a>
