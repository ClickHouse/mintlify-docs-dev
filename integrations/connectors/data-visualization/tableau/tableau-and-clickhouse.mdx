...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_connecttoserver.png" alt="Tableau connection screen showing the connector selection menu with ClickHouse by ClickHouse option highlighted" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_connector_details.png" alt="Tableau connector installation dialog showing ClickHouse JDBC connector details and install button" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_connector_dialog.png" alt="ClickHouse connection dialog in Tableau showing fields for server, port, database, username and password" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_newworkbook.png" alt="New Tableau workbook showing the initial connection screen with database selection options" border />
<br/>

8. Select **TPCD** from the **Schema** dropdown and you should see the list of tables in **TPCD**:

<Image size="md" img="/static/images/integrations/data-visualization/tableau_tpcdschema.png" alt="Tableau schema selection showing TPCD database tables including CUSTOMER, LINEITEM, NATION, ORDERS, and others" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_workbook1.png" alt="Tableau workbook with CUSTOMER table dragged to canvas showing column headers but no data" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_workbook2.png" alt="Tableau relationship editor showing connection between CUSTOMER and ORDERS tables using Custkey field" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_workbook3.png" alt="Tableau worksheet showing the dimensions and measures from ClickHouse tables available for analysis" border />
<br/>
...
<Image size="sm" img="/static/images/integrations/data-visualization/tableau_workbook4.png" alt="Tableau line chart showing quantity ordered by year from ClickHouse data" border />
<br/>
...
<Image size="sm" img="/static/images/integrations/data-visualization/tableau_workbook5.png" alt="Tableau crosstab view with quarters as columns and shipment modes as rows" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_workbook6.png" alt="Tableau crosstab showing sum of total price by quarter and shipment mode" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/tableau_workbook7.png" alt="Tableau crosstab showing average order price by quarter and shipment mode with currency formatting" border />
<br/>
