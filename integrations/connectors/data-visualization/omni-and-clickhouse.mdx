...
<Image size="lg" img="/static/images/integrations/data-visualization/omni_01.png" alt="Omni admin interface showing the Add Connection button in the Connections section" border />
<br/>

Select `ClickHouse`. Enter your credentials in the form.

<Image size="lg" img="/static/images/integrations/data-visualization/omni_02.png" alt="Omni connection configuration interface for ClickHouse showing credential form fields" border />
<br/>
