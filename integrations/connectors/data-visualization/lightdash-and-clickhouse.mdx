...
<Image size="md" img="/static/images/integrations/data-visualization/lightdash_02.png" alt="Lightdash dashboard example" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/lightdash_01.png" alt="Example profiles.yml configuration for a lightdash-clickhouse project" border />
<br/>
...
<Image size="md" img="/static/images/integrations/data-visualization/lightdash_03.png" alt="Example of metrics being defined in the .yml file" border />
<br/>
...
<Image size="lg" img="/static/images/integrations/data-visualization/lightdash_04.png" alt="Lightdash Explore view showing dimensions, filters, chart, results, and SQL" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/lightdash_05.png" alt="Creating and organizing charts within a Lightdash dashboard" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/lightdash_06.png" alt="Lightdash Ask AI interface showing natural language query powered by dbt metrics" border />
