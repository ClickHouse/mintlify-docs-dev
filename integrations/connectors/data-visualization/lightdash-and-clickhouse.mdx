...
## Build an interactive dashboard with Lightdash and ClickHouse <a id="build-an-interactive-dashboard"></a>
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Lightdash dashboard example" border />

<Steps>
<Step>
### Gather connection data <a id="connection-data-required"></a>
...
<Step>
### Configure your dbt profile for ClickHouse <a id="configuring-your-dbt-profile-for-clickhouse"></a>
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="Example profiles.yml configuration for a lightdash-clickhouse project" border />
<br/>
</Step>
<Step>
### Create a Lightdash project connected to ClickHouse <a id="creating-a-lightdash-project-connected-to-clickhouse"></a>
...
<Step>
### Explore your ClickHouse data in Lightdash <a id="exploring-your-clickhouse-data-in-lightdash"></a>
...
<Step>
### Define metrics and dimensions in Lightdash <a id="defining-metrics-and-dimensions-in-lightdash"></a>
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="Example of metrics being defined in the .yml file" border />
<br/>
...
<Step>
### Query your data from tables <a id="querying-your-data-from-tables"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="Lightdash Explore view showing dimensions, filters, chart, results, and SQL" border />
...
<Step>
### Build dashboards <a id="building-dashboards"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Creating and organizing charts within a Lightdash dashboard" border />
...
<Step>
### Ask AI: self-serve analytics powered by dbt <a id="ask-ai"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Lightdash Ask AI interface showing natural language query powered by dbt metrics" border />
