...
If you don't have a dataset to work with, you can add one of the examples. This guide uses the [UK Price Paid](/core/get-started/sample-datasets/uk-price-paid) dataset.
</Tip>
