...
<Image img="/images/integrations/data-visualization/chartbrew_01.png" size="lg" alt="Chartbrew dashboard" />
...
## 2. Connect Chartbrew to ClickHouse <a id="2-connect-chartbrew-to-clickhouse"></a>
...
2. Click **Create connection** and select **ClickHouse** from the available database options.
   ...
   <Image img="/images/integrations/data-visualization/chartbrew_02.png" size="lg" alt="Select ClickHouse connection in Chartbrew" />
...
3. Enter the connection details for your ClickHouse database:
   ...
   <Image img="/images/integrations/data-visualization/chartbrew_03.png" size="lg" alt="ClickHouse connection settings in Chartbrew" />
...
5. If the test is successful, click **Save connection**. Chartbrew will automatically retrieve the schema from ClickHouse.
   ...
   <Image img="/images/integrations/data-visualization/chartbrew_04.png" size="lg" alt="ClickHouse JSON schema in Chartbrew" />

## 3. Create a dataset and run a SQL query <a id="3-create-a-dataset-and-run-a-sql-query"></a>
  ...
  <Image img="/images/integrations/data-visualization/chartbrew_05.png" size="lg" alt="Select ClickHouse connection for dataset" />
  ...
  <Image img="/images/integrations/data-visualization/chartbrew_07.png" size="lg" alt="ClickHouse SQL query in Chartbrew" />
...
<Image img="/images/integrations/data-visualization/chartbrew_06.png" size="lg" alt="ClickHouse AI SQL assistant in Chartbrew" />

Once the data is retrieved, click **Configure dataset** to set up the visualization parameters.

## 4. Create a visualization <a id="4-create-a-visualization"></a>
  ...
  <Image img="/images/integrations/data-visualization/chartbrew_08.png" size="lg" alt="Chartbrew dashboard with ClickHouse data" />
  ...
  <Image img="/images/integrations/data-visualization/chartbrew_01.png" size="lg" alt="Chartbrew dashboard with ClickHouse data" />

## 5. Automate data updates <a id="5-automate-data-updates"></a>
  ...
  <Image img="/images/integrations/data-visualization/chartbrew_09.png" size="lg" alt="Chartbrew dataset refresh settings" />
