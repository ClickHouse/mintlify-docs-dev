...
## 2. Sign in or sign up to Mitzu <a id="2-sign-in-or-sign-up-to-mitzu"></a>

As a first step, head to [https://app.mitzu.io](https://app.mitzu.io) to sign up.

<Image size="lg" img="/images/integrations/data-visualization/mitzu_01.png" alt="Mitzu sign-in page with email and password fields" border />

## 3. Configure your workspace <a id="3-configure-your-workspace"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_02.png" alt="Mitzu workspace setup page showing onboarding steps" border />

## 4. Connect Mitzu to ClickHouse <a id="4-connect-mitzu-to-clickhouse"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_03.png" alt="Mitzu connection setup page for ClickHouse with configuration form" border />

## 5. Configure event tables <a id="5-configure-event-tables"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_04.png" alt="Mitzu table selection interface showing database tables" border />
<br/>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_05.png" alt="Mitzu event catalog configuration showing column mapping options" border />
<br/>
...
## 4. Run segmentation queries <a id="4-run-segmentation-queries"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_06.png" alt="Mitzu segmentation query interface with event selection and time configuration" border />
...
## 5. Run funnel queries <a id="5-run-funnel-queries"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_07.png" alt="Mitzu funnel analysis view showing conversion rates between steps" border />
...
## 6. Run retention queries <a id="6-run-retention-queries"></a>

Select up to 2 steps for a retention rate calculation. Choose the retention window for the recurring window for
Get immediate conversion rate insights without writing a single line of SQL code.

<Image size="lg" img="/images/integrations/data-visualization/mitzu_08.png" alt="Mitzu retention analysis showing cohort retention rates" border />
...
## 7. Run journey queries <a id="7-run-journey-queries"></a>
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_09.png" alt="Mitzu journey visualization showing user path flow between events" border />
<br/>
...
## 8. Run revenue queries <a id="8-run-revenue-queries"></a>
If revenue settings are configured, Mitzu can calculate the total MRR and subscription count based on your payment events.

<Image size="lg" img="/images/integrations/data-visualization/mitzu_10.png" alt="Mitzu revenue analysis dashboard showing MRR metrics" border />

## 9. SQL native <a id="9-sql-native"></a>

Mitzu is SQL Native, which means it generates native SQL code from your chosen configuration on the Explore page.

<Image size="lg" img="/images/integrations/data-visualization/mitzu_11.png" alt="Mitzu SQL code generation view showing native ClickHouse query" border />
...
## Mitzu support <a id="mitzu-support"></a>
