...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_01.png" alt="Mitzu sign-in page with email and password fields" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_02.png" alt="Mitzu workspace setup page showing onboarding steps" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_03.png" alt="Mitzu connection setup page for ClickHouse with configuration form" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_04.png" alt="Mitzu table selection interface showing database tables" border />
<br/>
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_05.png" alt="Mitzu event catalog configuration showing column mapping options" border />
<br/>
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_06.png" alt="Mitzu segmentation query interface with event selection and time configuration" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_07.png" alt="Mitzu funnel analysis view showing conversion rates between steps" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_08.png" alt="Mitzu retention analysis showing cohort retention rates" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_09.png" alt="Mitzu journey visualization showing user path flow between events" border />
<br/>
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_10.png" alt="Mitzu revenue analysis dashboard showing MRR metrics" border />
...
<Image size="lg" img="/static/images/integrations/data-visualization/mitzu_11.png" alt="Mitzu SQL code generation view showing native ClickHouse query" border />
