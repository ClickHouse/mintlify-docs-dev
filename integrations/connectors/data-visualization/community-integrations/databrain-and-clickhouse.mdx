...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="Databrain dashboard interface showing ClickHouse data visualization" border />
...
## Steps to connect Databrain to ClickHouse <a id="steps-to-connect-databrain-to-clickhouse"></a>

### 1. Gather your connection details <a id="1-gather-your-connection-details"></a>

<ConnectionDetails />

### 2. Allow Databrain IP addresses (if required) <a id="2-allow-databrain-ip-addresses"></a>
...
### 3. Add ClickHouse as a data source in Databrain <a id="3-add-clickhouse-as-a-data-source"></a>
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Databrain data sources menu" border />

3. Click **Add a Data Source** or **Connect Data Source**.

4. Select **ClickHouse** from the list of available connectors.

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="Databrain connector selection showing ClickHouse option" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Databrain ClickHouse connection form with configuration fields" border />
...
### 4. Configure user permissions <a id="4-configure-user-permissions"></a>
...
## Using Databrain with ClickHouse <a id="using-databrain-with-clickhouse"></a>

### Explore your data <a id="explore-your-data"></a>
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="Databrain data explorer showing ClickHouse tables" border />

3. Click on a table to explore its schema and preview the data.

### Create metrics and visualizations <a id="create-metrics-and-visualizations"></a>
...
### Build dashboards <a id="build-dashboards"></a>
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="Databrain dashboard with multiple ClickHouse visualizations" border />
...
### Connection fails <a id="connection-fails"></a>
...
### Slow query performance <a id="slow-query-performance"></a>
