...
<Image size="md" img="/static/images/integrations/data-visualization/databrain_01.png" alt="Databrain dashboard interface showing ClickHouse data visualization" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/databrain_02.png" alt="Databrain data sources menu" border />

3. Click **Add a Data Source** or **Connect Data Source**.

4. Select **ClickHouse** from the list of available connectors.

<Image size="md" img="/static/images/integrations/data-visualization/databrain_03.png" alt="Databrain connector selection showing ClickHouse option" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/databrain_04.png" alt="Databrain ClickHouse connection form with configuration fields" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/databrain_05.png" alt="Databrain data explorer showing ClickHouse tables" border />
...
<Image size="md" img="/static/images/integrations/data-visualization/databrain_06.png" alt="Databrain dashboard with multiple ClickHouse visualizations" border />
