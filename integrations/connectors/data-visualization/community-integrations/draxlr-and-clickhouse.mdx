...
5. Add the connection details in the form.
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_01.png" alt="Draxlr connection form showing ClickHouse database configuration options" border />
...
3. You can start adding the filters, make joins and add sort to your data.
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_02.png" alt="Draxlr data exploration interface showing filters and sorting options" border />

4. You can also use the **Graph** button and select the graph type to visualize the data.

  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_05.png" alt="Draxlr graph visualization options for ClickHouse data" border />
...
2. Click the **Raw Query** button and enter your query in the text area.
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_03.png" alt="Draxlr SQL query interface for ClickHouse" border />
...
1. After executing your query, click on the **Save Query** button.
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_04.png" alt="Draxlr save query dialog with dashboard options" border />
...
1. Click on the **Dashboards** button on the navbar.
  ...
  <Image size="md" img="/static/images/integrations/data-visualization/draxlr_06.png" alt="Draxlr dashboard management interface" border />
