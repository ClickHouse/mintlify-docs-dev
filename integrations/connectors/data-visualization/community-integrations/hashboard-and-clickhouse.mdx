...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="Hashboard data explorer interface showing interactive query builder and visualization" border />
...
## Steps to connect Hashboard to ClickHouse <a id="steps-to-connect-hashboard-to-clickhouse"></a>

### 1. Gather your connection details <a id="1-gather-your-connection-details"></a>

<ConnectionDetails />

### 2. Add a new database connection in Hashboard <a id="2-add-a-new-database-connection-in-hashboard"></a>
