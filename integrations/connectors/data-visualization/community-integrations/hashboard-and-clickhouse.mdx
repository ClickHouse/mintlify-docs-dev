...
<Image size="md" img="/static/images/integrations/data-visualization/hashboard_01.png" alt="Hashboard data explorer interface showing interactive query builder and visualization" border />
