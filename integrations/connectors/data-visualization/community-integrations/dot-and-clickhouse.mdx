...
## Connecting Dot to ClickHouse <a id="connecting-dot-to-clickhouse"></a>

<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Configuring ClickHouse connection in Dot (light mode)" border />
<br/>
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="Connecting ClickHouse" size="sm"/>
...
## Security and governance <a id="security"></a>
