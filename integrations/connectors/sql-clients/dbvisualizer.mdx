...
## Start or download DbVisualizer <a id="start-or-download-dbvisualizer"></a>
...
## 2. Built-in JDBC driver management <a id="2-built-in-jdbc-driver-management"></a>
...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="DbVisualizer driver manager interface showing ClickHouse JDBC driver configuration" />
