...
## Open the TABLUM.IO startup page <a id="open-the-tablumio-startup-page"></a>

<Note>
  You can install a self-hosted version of TABLUM.IO on your Linux server in docker.
</Note>

## 1. Sign up or sign in to the service <a id="1-sign-up-or-sign-in-to-the-service"></a>

  First, sign up to TABLUM.IO using your email or use a quick-login via accounts in Google or Facebook.

<Image img="/images/integrations/sql-clients/tablum-ch-0.png" size="md" border alt="TABLUM.IO login page" />

## 2. Add a ClickHouse connector <a id="2-add-a-clickhouse-connector"></a>
...
<Image img="/images/integrations/sql-clients/tablum-ch-1.png" size="lg" border alt="Adding a ClickHouse connector in TABLUM.IO" />

## 3. Select the connector <a id="3-select-the-connector"></a>
...
<Image img="/images/integrations/sql-clients/tablum-ch-2.png" size="lg" border alt="Selecting the ClickHouse connector in TABLUM.IO" />

## 4. Input a SQL query and run it <a id="4-input-a-sql-query-and-run-it"></a>
...
<Image img="/images/integrations/sql-clients/tablum-ch-3.png" size="lg" border alt="Running a SQL query in TABLUM.IO" />
