...
## Start or download DataGrip <a id="start-or-download-datagrip"></a>
...
## 2. Load the ClickHouse driver <a id="2-load-the-clickhouse-driver"></a>

1. Launch DataGrip, and on the **Data Sources** tab in the **Data Sources and Drivers** dialog, click the **+** icon

<Image img="/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="DataGrip Data Sources tab with + icon highlighted" />
...
<Image img="/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="DataGrip selecting ClickHouse from the data sources list" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="DataGrip Drivers tab showing ClickHouse driver installation" />

## 3. Connect to ClickHouse <a id="3-connect-to-clickhouse"></a>
...
<Image img="/images/integrations/sql-clients/datagrip-7.png" border alt="DataGrip connection details form with ClickHouse settings" />
