...
<Note>
View the [MySQL table engine](/core/reference/engines/table-engines/integrations/mysql) doc page for a complete list of parameters.
</Note>
...
The `MySQL` table engine allows you to connect ClickHouse to MySQL to exchange data back and forth. For more details, be sure to check out the documentation page for the [MySQL table engine](/core/reference/functions/table-functions/mysql).
