...
## Connecting ClickHouse to MySQL using the MySQL Table Engine <a id="connecting-clickhouse-to-mysql-using-the-mysql-table-engine"></a>
...
### 1. Configure MySQL <a id="1-configure-mysql"></a>
