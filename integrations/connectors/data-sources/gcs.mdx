...
A complete list of settings relevant to this disk declaration can be found [here](/core/reference/engines/table-engines/mergetree-family/mergetree#table_engine-mergetree-s3).
