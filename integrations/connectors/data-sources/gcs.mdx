...
<Image img="/static/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="Replica one bucket in Google Cloud Storage showing folder structure with data partitions" />

#### Bucket for replica two {#bucket-for-replica-two}

<Image img="/static/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="Replica two bucket in Google Cloud Storage showing folder structure with data partitions" />
