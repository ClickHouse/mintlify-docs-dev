...
<Note>
    ...
    LIFETIME](/core/reference/statements/create/dictionary/lifetime).
</Note>
...
should only retrieve the columns you actually need.
  ...
  [ClickHouse tutorial]: /core/get-started/quickstarts/tutorial "ClickHouse Advanced Tutorial"
  [psql]: https://www.postgresql.org/docs/current/app-psql.html
    "PostgreSQL Client Applications: psql"
  [EXPLAIN]: https://www.postgresql.org/docs/current/sql-explain.html
    "SQL Commands: EXPLAIN"
  [dictionary]: /core/reference/statements/create/dictionary
  ...
  [Refreshing dictionary data using LIFETIME]: /core/reference/statements/create/dictionary/lifetime
