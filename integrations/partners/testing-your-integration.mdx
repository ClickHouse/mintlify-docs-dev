...
- **Self-hosted (OSS):** use the latest stable release from [GitHub releases](https://github.com/ClickHouse/ClickHouse/releases). The [install guide](/core/get-started/setup/install) is the fastest path to a local instance with Docker
...
The full set is at [Example datasets](/core/get-started/sample-datasets). These four cover most partner testing needs:
