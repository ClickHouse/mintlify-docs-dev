...
## Key features of Moose OLAP <a id="key-features"></a>
...
## Getting started in under 5 minutes <a id="getting-started"></a>
...
<Steps>
<Step>
### Install Moose <a id="step-1-install-moose"></a>
...
<Step>
### Set up your project <a id="step-2-set-up-project"></a>

#### Option A: Use your own existing ClickHouse deployment <a id="option-a-use-own-clickhouse"></a>
...
#### Option B: use ClickHouse playground <a id="option-b-use-clickhouse-playground"></a>
...
<Step>
### Install dependencies <a id="step-3-install-dependencies"></a>
...
<Step>
### Explore your generated models <a id="step-4-explore-models"></a>
...
<Step>
### Start development <a id="step-5-start-development"></a>
...
<Step>
### Seed your local database <a id="step-6-seed-database"></a>

Seed your data into your local ClickHouse instance:

#### From your own ClickHouse <a id="from-own-clickhouse"></a>

```bash
moose seed --connection-string <YOUR_CLICKHOUSE_CONNECTION_STRING> --limit 100
```

#### From ClickHouse playground <a id="from-clickhouse-playground"></a>
...
<Step>
### Building with Moose OLAP <a id="step-7-building-with-moose-olap"></a>
...
## Get help and stay connected <a id="get-help-stay-connected"></a>
