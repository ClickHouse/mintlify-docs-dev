...
### How ClickHouse converts DateTime strings <a id="clickhouse-datetime-string-conversion"></a>
...
### Writing timestamps across timezones <a id="writing-timestamps-across-timezones"></a>
...
### Java and JDBC timestamp APIs <a id="java-and-jdbc-timestamp-apis"></a>
...
### Using `java.time.LocalDate` <a id="using-localdate"></a>
...
### Using `java.sql.Date` <a id="using-java-sql-date"></a>
...
### Calendar-based reinterpretation <a id="calendar-based-reinterpretation"></a>
...
### ClickHouse Time types <a id="clickhouse-time-types"></a>
...
### Java type mapping <a id="java-type-mapping"></a>
...
### Using `java.sql.Time` <a id="using-java-sql-time"></a>
...
### The `toTime` function <a id="totime-function"></a>
...
### ClickHouse Timestamp types <a id="clickhouse-timestamp-types"></a>
...
### String representation and timezone behavior <a id="string-representation-and-timezone-behavior"></a>
...
### How the JDBC driver handles timestamps <a id="how-jdbc-driver-handles-timestamps"></a>
...
### Common pitfall with `toDateTime64` <a id="common-pitfall-todatetime64"></a>
...
## Conversion tables <a id="conversion-tables"></a>
...
### Writing values with `PreparedStatement#setObject` <a id="writing-values-setobject"></a>
...
### Reading values with `ResultSet#getObject` <a id="reading-values-getobject"></a>
...
### Using Calendar-based methods <a id="using-calendar-based-methods"></a>
