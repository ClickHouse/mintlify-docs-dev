...
### Client Identification <a id="client-identification"></a>
...
### Operation Identification <a id="operation-identification"></a>
...
### Server Settings <a id="server-settings"></a>
...
## Common Definitions <a id="common-definitions"></a>

### ClickHouseFormat <a id="clickhouseformat"></a>
...
## Insert API <a id="insert-api"></a>

### insert(String tableName, InputStream data, ClickHouseFormat format) <a id="insertstring-tablename-inputstream-data-clickhouseformat-format"></a>
...
### insert(String tableName, List&lt;?> data, InsertSettings settings) <a id="insertstring-tablename-listlt-data-insertsettings-settings"></a>
...
### InsertSettings <a id="insertsettings"></a>
...
### InsertResponse <a id="insertresponse"></a>
...
### query(String sqlQuery) <a id="querystring-sqlquery"></a>
...
### query(String sqlQuery, Map&lt;String, Object> queryParams, QuerySettings settings) <a id="querystring-sqlquery-mapltstring-object-queryparams-querysettings-settings"></a>
...
### queryAll(String sqlQuery) <a id="queryallstring-sqlquery"></a>
...
### QuerySettings <a id="querysettings"></a>
...
### QueryResponse <a id="queryresponse"></a>
...
## Common API <a id="common-api"></a>

### getTableSchema(String table) <a id="gettableschemastring-table"></a>
...
### getTableSchemaFromQuery(String sql) <a id="gettableschemafromquerystring-sql"></a>
...
### TableSchema <a id="tableschema"></a>

### register(Class&lt;?> clazz, TableSchema schema) <a id="registerclasslt-clazz-tableschema-schema"></a>
...
### Reading Arrays <a id="reading-arrays"></a>
...
## Migration Guide <a id="migration_guide"></a>
...
### Configuration Parameters Match <a id="migration_from_v1_config"></a>
...
## Initialization <a id="v1-initialization"></a>
...
## Streaming Query API <a id="v1-streaming-query-api"></a>
...
## Insert API <a id="v1-insert-api"></a>
...
## Features <a id="v1-features"></a>
### Compression <a id="v1-compression"></a>
...
### Multiple queries <a id="v1-multiple-queries"></a>
...
### Named Parameters <a id="v1-named-parameters"></a>
...
## Node Discovery <a id="v1-node-discovery"></a>
...
### Load Balancing <a id="v1-load-balancing"></a>
...
### Failover and retry <a id="v1-failover-and-retry"></a>
...
### Adding custom http headers <a id="v1-adding-custom-http-headers"></a>
...
## Java Client support <a id="v1-java-client-support"></a>

```java
options.put("custom_http_headers", "X-ClickHouse-Quota=test, X-ClickHouse-Test=test");
```

## JDBC Driver <a id="v1-jdbc-driver"></a>
