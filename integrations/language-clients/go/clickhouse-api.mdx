...
## Batch insert <a id="batch-insert"></a>
...
## Ephemeral columns <a id="ephemeral-columns"></a>
...
## Querying rows <a id="querying-rows"></a>
...
## Columnar insert <a id="columnar-insert"></a>
...
## Using structs <a id="using-structs"></a>
...
### Select with serialize <a id="select-with-serialize"></a>
...
### Scan struct <a id="scan-struct"></a>
...
### Append struct <a id="append-struct"></a>
...
## Parameter binding <a id="parameter-binding"></a>
...
### Special cases <a id="special-cases"></a>
...
## Using context <a id="using-context"></a>
...
## Progress, profile and log information <a id="progress-profile-log"></a>
...
## Dynamic scanning <a id="dynamic-scanning"></a>
...
## External tables <a id="external-tables"></a>
...
## Open telemetry <a id="open-telemetry"></a>
