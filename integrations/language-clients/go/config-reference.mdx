...
## How options are set <a id="how-options-are-set"></a>
...
### Protocol and connection <a id="protocol-and-connection"></a>
...
<Info>
**ClickHouse Cloud idle services**
...
### Connection pool <a id="connection-pool"></a>
...
### Standard database/sql pool settings <a id="sql-db-settings"></a>
...
### Buffers and memory <a id="buffers-and-memory"></a>
...
### HTTP-specific <a id="http-specific"></a>
...
### Advanced connection <a id="advanced-connection"></a>
...
### Client information <a id="client-information"></a>
...
### ClickHouse server settings <a id="server-settings"></a>
...
## Context-level query options <a id="context-options"></a>
...
## Batch options <a id="batch-options"></a>
...
## Quick reference tables <a id="quick-reference-tables"></a>

### Connection pool sizing recommendations <a id="pool-sizing"></a>
...
### Timeout recommendations <a id="timeout-recommendations"></a>
...
### DSN parameter quick reference <a id="dsn-parameters"></a>
...
### Connection pool exhausted: "acquire conn timeout" <a id="acquire-conn-timeout"></a>
...
### Read timeout and connection reset errors <a id="io-timeout"></a>
...
### "Code: 516. Authentication failed" <a id="auth-failed"></a>
...
### TLS certificate errors <a id="tls-errors"></a>
...
### Gradual memory growth <a id="memory-growth"></a>
