...
## Environment requirements (node.js) <a id="environment-requirements-nodejs"></a>
...
## Environment requirements (web) <a id="environment-requirements-web"></a>
...
## Compatibility with ClickHouse <a id="compatibility-with-clickhouse"></a>
...
#### Creating a client instance <a id="creating-a-client-instance"></a>
...
#### Node.js-specific configuration parameters <a id="nodejs-specific-configuration-parameters"></a>
...
| **http_agent**?: http.Agent \| https.Agent <br/><ExperimentalBadge/>       | Custom HTTP agent for the client.                           | -             | [HTTP agent docs](/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only)                           |
| **set_basic_auth_header**?: boolean <br/><ExperimentalBadge/>              | Set the `Authorization` header with basic auth credentials. | `true`        | [this setting usage in the HTTP agent docs](/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only) |

### URL configuration <a id="url-configuration"></a>
...
#### Connection overview <a id="connection-overview"></a>
...
#### Connection pool (Node.js only) <a id="connection-pool-nodejs-only"></a>
...
### Base parameters for all client methods <a id="base-parameters-for-all-client-methods"></a>
...
#### Result set and row abstractions <a id="result-set-and-row-abstractions"></a>
...
### Insert method <a id="insert-method"></a>
...
#### Insert method and streaming in Node.js <a id="insert-method-and-streaming-in-nodejs"></a>
...
#### Web version limitations <a id="web-version-limitations"></a>
...
### Command method <a id="command-method"></a>
...
### Exec method <a id="exec-method"></a>
...
### Close (Node.js only) <a id="close-nodejs-only"></a>
...
## Streaming files (Node.js only) <a id="streaming-files-nodejs-only"></a>
...
## Supported data formats <a id="supported-data-formats"></a>
...
## Supported ClickHouse data types <a id="supported-clickhouse-data-types"></a>
...
### Date/Date32 types caveats <a id="datedate32-types-caveats"></a>
...
### Decimal\* types caveats <a id="decimal-types-caveats"></a>
...
### Integral types: Int64, Int128, Int256, UInt64, UInt128, UInt256 <a id="integral-types-int64-int128-int256-uint64-uint128-uint256"></a>
...
## ClickHouse settings <a id="clickhouse-settings"></a>
...
### Queries with parameters <a id="queries-with-parameters"></a>
...
### Logging (Node.js only) <a id="logging-nodejs-only"></a>
...
### TLS certificates (Node.js only) <a id="tls-certificates-nodejs-only"></a>
...
### Keep-alive configuration (Node.js only) <a id="keep-alive-configuration-nodejs-only"></a>
...
#### Adjusting `idle_socket_ttl` <a id="adjusting-idle_socket_ttl"></a>
...
### Read-only users <a id="read-only-users"></a>
...
### Proxy with a pathname <a id="proxy-with-a-pathname"></a>
...
### Reverse proxy with authentication <a id="reverse-proxy-with-authentication"></a>
...
### Custom HTTP/HTTPS agent (experimental, Node.js only) <a id="custom-httphttps-agent-experimental-nodejs-only"></a>
...
#### Custom agent usage examples <a id="custom-agent-usage-examples"></a>
...
## Known limitations (Node.js/web) <a id="known-limitations-nodejsweb"></a>
...
## Known limitations (web) <a id="known-limitations-web"></a>
...
## Tips for performance optimizations <a id="tips-for-performance-optimizations"></a>
