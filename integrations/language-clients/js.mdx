...
| **roles**?: string \|  string[]                                          | ClickHouse role names to attach to the outgoing requests.                         | -                       | [Using roles with the HTTP interface](/integrations/connectors/data-integrations/drivers-and-interfaces/http#setting-role-with-query-parameters) |
