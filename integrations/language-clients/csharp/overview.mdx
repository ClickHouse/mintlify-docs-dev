...
## Supported .NET versions <a id="supported-net-versions"></a>
...
### Connection settings <a id="connection-settings"></a>
...
### Data format & serialization <a id="data-format-serialization"></a>
...
### HTTP client configuration <a id="http-client-configuration"></a>
...
### Logging & debugging <a id="logging-debugging"></a>
...
### Custom settings & roles <a id="custom-settings-roles"></a>
...
### Connection string examples <a id="connection-string-examples"></a>
...
#### With custom ClickHouse settings <a id="with-custom-clickhouse-settings"></a>
...
### QueryOptions <a id="query-options"></a>
...
### InsertOptions <a id="insert-options"></a>
...
#### Skipping the schema probe query <a id="skip-schema-query"></a>
...
## ClickHouseClient <a id="clickhouse-client"></a>
...
### Creating a client <a id="creating-a-client"></a>
...
<Image img="/images/_snippets/connection-details-csharp.png" size="md" alt="ClickHouse Cloud C# connection details" border />
...
### Executing queries <a id="executing-queries"></a>
...
### Inserting data <a id="inserting-data"></a>

#### Parameterized inserts <a id="parameterized-inserts"></a>
...
#### Bulk inserts <a id="bulk-insert"></a>
...
#### POCO inserts <a id="poco-insert"></a>
...
#### Schema evolution <a id="poco-insert-schema-evolution"></a>
...
### Reading data <a id="reading-data"></a>
...
### SQL parameters <a id="sql-parameters"></a>
...
### Custom parameter type mapping <a id="parameter-type-mapping"></a>
...
### Raw streaming <a id="raw-streaming"></a>
...
### Raw stream insert <a id="raw-stream-insert"></a>
...
### Lifetime management with ClickHouseDataSource <a id="ado-net-datasource"></a>
...
### Using ClickHouseCommand <a id="ado-net-command"></a>
...
### Using ClickHouseDataReader <a id="ado-net-reader"></a>
...
### Connection lifetime and pooling <a id="best-practices-connection-lifetime"></a>
...
### DateTime handling <a id="best-practice-datetime"></a>
...
### Async inserts <a id="async-inserts"></a>
...
### Sessions <a id="best-practices-sessions"></a>
...
## Supported data types <a id="supported-data-types"></a>
...
### Type mapping: reading from ClickHouse <a id="clickhouse-native-type-map-reading"></a>

#### Integer types <a id="type-map-reading-integer"></a>
...
#### Floating point types <a id="type-map-reading-floating-points"></a>
...
#### Decimal types <a id="type-map-reading-decimal"></a>
...
#### Boolean type <a id="type-map-reading-boolean"></a>
...
#### String types <a id="type-map-reading-strings"></a>
...
#### Date and time types <a id="type-map-reading-datetime"></a>
...
#### JSON type <a id="type-map-reading-json"></a>
...
#### Other types <a id="type-map-reading-other"></a>
...
#### Geometry types <a id="type-map-reading-geometry"></a>
...
### Type mapping: writing to ClickHouse <a id="clickhouse-native-type-map-writing"></a>
...
#### Integer types <a id="type-map-writing-integer"></a>
...
#### Floating point types <a id="type-map-writing-floating-point"></a>
...
#### Boolean type <a id="type-map-writing-boolean"></a>
...
#### String types <a id="type-map-writing-strings"></a>
...
#### Date and time types <a id="type-map-writing-datetime"></a>
...
#### HTTP parameters vs bulk copy <a id="datetime-http-param-vs-bulkcopy"></a>
...
#### Decimal types <a id="type-map-writing-decimal"></a>
...
#### JSON type <a id="type-map-writing-json"></a>
...
##### Typed JSON columns <a id="json-typed-columns"></a>
...
##### POCO serialization <a id="json-poco-serialization"></a>
...
#### Other types <a id="type-map-writing-other"></a>
...
#### Geometry types <a id="type-map-writing-geometry"></a>
...
#### Not supported for writing <a id="type-map-writing-not-supported"></a>
...
### Nested type handling <a id="nested-type-handling"></a>
...
## Logging and diagnostics <a id="logging-and-diagnostics"></a>
...
### Quick start <a id="logging-quick-start"></a>
...
#### Using appsettings.json <a id="logging-appsettings-config"></a>
...
#### Using in-memory configuration <a id="logging-inmemory-config"></a>
...
### Categories and emitters <a id="logging-categories"></a>
...
#### Example: Diagnosing connection issues <a id="logging-config-example"></a>
...
### Debug mode: network tracing and diagnostics <a id="logging-debugmode"></a>
...
### Enabling tracing <a id="opentelemetry-enabling"></a>
...
### Span attributes <a id="opentelemetry-attributes"></a>
...
### Configuration options <a id="opentelemetry-configuration"></a>
...
## TLS configuration <a id="tls-configuration"></a>

When connecting to ClickHouse over HTTPS, you can configure TLS/SSL behavior in several ways.

### Custom certificate validation <a id="custom-certificate-validation"></a>
...
## ORM support <a id="orm-support"></a>
...
### Dapper <a id="orm-support-dapper"></a>
...
#### Parameter passing styles <a id="dapper-parameter-passing"></a>
...
#### Querying into POCOs <a id="dapper-pocos"></a>
...
#### ClickHouse-native parameter syntax <a id="dapper-clickhouse-param-syntax"></a>
...
#### WHERE IN <a id="dapper-where-in"></a>
...
#### Custom type handlers <a id="dapper-type-handlers"></a>
...
#### Dapper.Contrib <a id="dapper-contrib"></a>
...
#### Limitations <a id="dapper-limitations"></a>
...
### Linq2db <a id="orm-support-linq2db"></a>
...
### Entity Framework Core <a id="orm-support-ef-core"></a>
...
#### Installation <a id="ef-core-installation"></a>
...
#### Quick start <a id="ef-core-quick-start"></a>
...
#### Supported types <a id="ef-core-types"></a>
...
#### Supported LINQ operations <a id="ef-core-linq"></a>
...
##### LEFT JOIN null semantics <a id="ef-core-join-nulls"></a>
...
#### Inserting data <a id="ef-core-insert"></a>
...
#### Bulk insert <a id="ef-core-bulk-insert"></a>
...
#### Custom type conversions <a id="ef-core-value-converters"></a>
...
#### Column type annotations <a id="ef-core-column-types"></a>
...
#### Variant and Dynamic columns <a id="ef-core-variant-dynamic"></a>
...
#### JSON columns <a id="ef-core-json"></a>
...
#### Table engines <a id="ef-core-engines"></a>
...
#### Migrations <a id="ef-core-migrations"></a>
...
#### Migration limitations <a id="ef-core-limitations"></a>
...
### AggregateFunction columns <a id="aggregatefunction-columns"></a>
