...
<Image img="/static/images/_snippets/cloud-connect-button.png" size="md" alt="ClickHouse Cloud service connect button" border />

Choose **C#**. Connection details are displayed below.

<Image img="/static/images/_snippets/connection-details-csharp.png" size="md" alt="ClickHouse Cloud C# connection details" border />
