...
## QueryContexts <a id="querycontexts"></a>
...
## Streaming queries <a id="streaming-queries"></a>
...
### HTTP data buffer for slow processing <a id="http-data-buffer-for-slow-processing"></a>
...
### StreamContexts <a id="streamcontexts"></a>
...
### Stream types <a id="stream-types"></a>
...
### Streaming examples <a id="streaming-examples"></a>

#### Stream rows <a id="stream-rows"></a>
...
#### Stream row blocks <a id="stream-row-blocks"></a>
...
#### Stream Pandas DataFrames <a id="stream-pandas-dataframes"></a>
...
#### Stream Arrow batches <a id="stream-arrow-batches"></a>
...
## NumPy, Pandas, and Arrow queries <a id="numpy-pandas-and-arrow-queries"></a>
...
### NumPy queries <a id="numpy-queries"></a>
...
### Pandas queries <a id="pandas-queries"></a>
...
### PyArrow queries <a id="pyarrow-queries"></a>
...
### Arrow-backed DataFrames <a id="arrow-backed-dataframes"></a>
...
#### Query to Arrow-backed DataFrame <a id="query-to-arrow-backed-dataframe"></a>
...
#### Notes and caveats <a id="notes-and-caveats"></a>
...
#### Mismatched ClickHouse/Arrow type conversion examples <a id="mismatched-clickhousearrow-type-conversion-examples"></a>
...
## Read formats <a id="read-formats"></a>
...
### Read format options (Python types) <a id="read-format-options-python-types"></a>
...
## External data <a id="external-data"></a>
...
| fmt       | str               | The ClickHouse [Input Format](/reference/formats/index) of the data. Defaults to `TSV`                                                      |
