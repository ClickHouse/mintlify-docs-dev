...
## HTTP proxy support <a id="http-proxy-support"></a>
...
## "Old" JSON data type <a id="old-json-data-type"></a>
...
## "New" Variant/Dynamic/JSON datatypes (experimental feature) <a id="new-variantdynamicjson-datatypes-experimental-feature"></a>
