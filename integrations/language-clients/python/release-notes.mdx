...
- Added support for special [interval types](/reference/data-types/special-data-types/interval). Closes [#391](https://github.com/ClickHouse/clickhouse-connect/issues/391)
...
See also the updated [run_async example](https://github.com/ClickHouse/clickhouse-connect/blob/main/examples/run_async.py).
