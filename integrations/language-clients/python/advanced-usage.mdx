...
### Client `raw_query` method <a id="client-rawquery-method"></a>
...
### Client `raw_stream` method <a id="client-rawstream-method"></a>
...
### Client `raw_insert` method <a id="client-rawinsert-method"></a>
...
## Saving query results as files <a id="saving-query-results-as-files"></a>
