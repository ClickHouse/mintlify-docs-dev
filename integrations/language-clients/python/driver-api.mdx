...
## Client Initialization <a id="client-initialization"></a>
...
### Connection arguments <a id="connection-arguments"></a>
...
### HTTPS/TLS arguments <a id="httpstls-arguments"></a>
...
### Settings argument <a id="settings-argument"></a>
...
### Client creation examples <a id="client-creation-examples"></a>
...
## Client Lifecycle and Best Practices <a id="client-lifecycle-and-best-practices"></a>
...
### Basic patterns <a id="basic-patterns"></a>
...
### Multi-threaded applications <a id="multi-threaded-applications"></a>
...
### Proper cleanup <a id="proper-cleanup"></a>
...
### When to use multiple clients <a id="when-to-use-multiple-clients"></a>
...
## Common method arguments <a id="common-method-arguments"></a>
...
### Parameters argument <a id="parameters-argument"></a>
...
#### Server-side binding <a id="server-side-binding"></a>
...
#### Client-side binding <a id="client-side-binding"></a>
...
### Settings argument <a id="settings-argument-1"></a>
...
## Client `command` Method <a id="client-command-method"></a>
...
### Command examples <a id="command-examples"></a>

#### DDL statements <a id="ddl-statements"></a>
...
#### Simple queries returning single values <a id="simple-queries-returning-single-values"></a>
...
#### Commands with parameters <a id="commands-with-parameters"></a>
...
#### Commands with settings <a id="commands-with-settings"></a>
...
## Client `query` Method <a id="client-query-method"></a>
...
#### Basic query <a id="basic-query"></a>
...
#### Accessing query results <a id="accessing-query-results"></a>
...
#### Query with client-side parameters <a id="query-with-client-side-parameters"></a>
...
#### Query with server-side parameters <a id="query-with-server-side-parameters"></a>
...
#### Query with settings <a id="query-with-settings"></a>
...
### The `QueryResult` object <a id="the-queryresult-object"></a>
...
## Consuming query results with NumPy, Pandas or Arrow <a id="consuming-query-results-with-numpy-pandas-or-arrow"></a>
...
## Client streaming query methods <a id="client-streaming-query-methods"></a>
...
## Client `insert` Method <a id="client-insert-method"></a>
...
#### Basic row-oriented insert <a id="basic-row-oriented-insert"></a>
...
#### Column-oriented insert <a id="column-oriented-insert"></a>
...
#### Insert with explicit column types <a id="insert-with-explicit-column-types"></a>
...
#### Insert into specific database <a id="insert-into-specific-database"></a>
...
## File Inserts <a id="file-inserts"></a>
...
## Utility classes and functions <a id="utility-classes-and-functions"></a>
...
### ClickHouse SQL utilities <a id="clickhouse-sql-utilities"></a>
...
## Multithreaded, multiprocess, and async/event driven use cases <a id="multithreaded-multiprocess-and-asyncevent-driven-use-cases"></a>
...
## AsyncClient wrapper <a id="asyncclient-wrapper"></a>
...
## Managing ClickHouse Session IDs <a id="managing-clickhouse-session-ids"></a>
...
## Customizing the HTTP connection pool <a id="customizing-the-http-connection-pool"></a>
