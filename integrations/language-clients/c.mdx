...
## What the library doesn't do <a id="non-goals"></a>
...
## How the library is organized <a id="headers"></a>
...
## Required server setting <a id="server-setting"></a>
...
## Adding it to your project <a id="adding-to-project"></a>
...
## Connecting over TCP <a id="connecting-over-tcp"></a>
...
## Reading column data <a id="reading-column-data"></a>
...
## Ioless (async) client <a id="async-client"></a>
...
## Memory and the allocator <a id="allocator"></a>
...
## Errors and server exceptions <a id="errors"></a>
...
## Supported data types <a id="supported-types"></a>
