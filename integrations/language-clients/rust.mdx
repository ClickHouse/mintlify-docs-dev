...
## Cargo features <a id="cargo-features"></a>
...
## ClickHouse versions compatibility <a id="clickhouse-versions-compatibility"></a>
...
If something is unclear or missing from the examples or from the following documentation, feel free to [contact us](/integrations/language-clients/rust#contact-us).
...
### HTTPS or ClickHouse Cloud connection <a id="https-or-clickhouse-cloud-connection"></a>
...
### Selecting rows <a id="selecting-rows"></a>
...
### Inserting rows <a id="inserting-rows"></a>
...
### Async insert (server-side batching) <a id="async-insert-server-side-batching"></a>
...
### Inserter feature (client-side batching) <a id="inserter-feature-client-side-batching"></a>
...
### Executing DDLs <a id="executing-ddls"></a>
...
### Custom HTTP client <a id="custom-http-client"></a>
