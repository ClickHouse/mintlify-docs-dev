...
<Steps>
<Step>
## Select the data source <a id="1-select-the-data-source"></a>
...
**2.** Click the **BigQuery** tile.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step1.png" alt="Select BigQuery tile" size="lg" border/>
</Step>
<Step>
## Set up your ClickPipe connection <a id="2-setup-your-clickpipe-connection"></a>
...
**1.** Upload the `.json` key for the service account you created for ClickPipes. Ensure the service account has the minimum required set of [permissions](/integrations/clickpipes/bigquery/overview#permissions).
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step2.png" alt="Upload service account key" size="lg" border/>    
...
<Step>
## Configure your ClickPipe <a id="3-configure-your-clickpipe"></a>
...
<Step>
## Configure tables <a id="4-configure-tables"></a>
...
**2.** Select the tables and, optionally, the columns you want to replicate. Only datasets that the provided service account has access to will be listed.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step3.png" alt="Permissions" size="lg" border/>
...
<Warning>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step4.png" alt="Permissions" size="lg" border/>
</Step>
<Step>
## Configure permissions <a id="6-configure-permissions"></a>
...
<Step>
## Complete setup <a id="7-complete-setup"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_step5.png" alt="Permissions" size="lg" border/>
</Step>
</Steps>
