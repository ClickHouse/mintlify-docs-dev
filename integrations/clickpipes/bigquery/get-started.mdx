...
**2.** Click the **BigQuery** tile.
    ...
    <Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_step1.png" alt="Select BigQuery tile" size="lg" border/>
...
**1.** Upload the `.json` key for the service account you created for ClickPipes. Ensure the service account has the minimum required set of [permissions](/integrations/clickpipes/bigquery/overview#permissions).
    ...
    <Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_step2.png" alt="Upload service account key" size="lg" border/>    
...
**2.** Select the tables and, optionally, the columns you want to replicate. Only datasets that the provided service account has access to will be listed.
    ...
    <Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_step3.png" alt="Permissions" size="lg" border/>
...
<Warning>
    ...
    <Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_step4.png" alt="Permissions" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_step5.png" alt="Permissions" size="lg" border/>
