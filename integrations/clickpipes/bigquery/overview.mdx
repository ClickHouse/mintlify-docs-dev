...
<Image img="/static/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Creating a service account key with BigQuery and Cloud Storage permissions" size="lg" border/>
