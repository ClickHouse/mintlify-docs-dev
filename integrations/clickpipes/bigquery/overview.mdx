...
### Initial load <a id="initial-load"></a>
...
### CDC (Change Data Capture) <a id="cdc"></a>
...
## Data type mapping <a id="data-type-mapping"></a>
...
#### Service account credentials <a id="service-account-credentials"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Creating a service account key with BigQuery and Cloud Storage permissions" size="lg" border/>
