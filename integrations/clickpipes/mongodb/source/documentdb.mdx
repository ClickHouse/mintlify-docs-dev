...
## Supported DocumentDB versions <a id="supported-documentdb-versions"></a>

ClickPipes supports DocumentDB version 5.0.

## Configure change stream log retention <a id="configure-change-stream-log-retention"></a>
...
### Update change stream log retention via AWS Console <a id="update-change-stream-log-retention-via-aws-console"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="Select parameter group" size="lg" border/>

2. Search for `change_stream_log_retention_duration`, select and edit it to `259200` (72 hours)
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="Modify parameter group" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="Apply parameter group" size="lg" border/>

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="Parameter group status" size="lg" border/>

### Update change stream log retention via AWS CLI <a id="update-change-stream-log-retention-via-aws-cli"></a>
