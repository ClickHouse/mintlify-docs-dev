...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/pause_button.png" border size="md"/>

4. A dialog box should appear for confirmation. Click on Pause again.

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/pause_dialog.png" border size="md"/>

4. Head over to the **Metrics** tab.
5. Wait for the status of the pipe to be **Paused**.

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/pause_status.png" border size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/resume_button.png" border size="md"/>

4. A dialog box should appear for confirmation. Click on Resume again.

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/resume_dialog.png" border size="md"/>
