...
### Can I query for individual fields in the JSON datatype? <a id="can-i-query-for-individual-fields-in-the-json-datatype"></a>
...
### How do I flatten the nested MongoDB documents in ClickHouse? <a id="how-do-i-flatten-the-nested-mongodb-documents-in-clickhouse"></a>
...
### Can I connect MongoDB databases that don't have a public IP or are in private networks? <a id="can-i-connect-mongodb-databases-that-dont-have-a-public-ip-or-are-in-private-networks"></a>
...
### What happens if I delete a database/table from my MongoDB database? <a id="what-happens-if-i-delete-a-database-table-from-my-mongodb-database"></a>
...
### How does MongoDB CDC Connector handle transactions? <a id="how-does-mongodb-cdc-connector-handle-transactions"></a>
...
### How do I handle `resume of change stream was not possible, as the resume point may no longer be in the oplog.` error? <a id="resume-point-may-no-longer-be-in-the-oplog-error"></a>
...
### How is replication managed? <a id="how-is-replication-managed"></a>
...
### Which read preference should I use? <a id="which-read-preference-should-i-use"></a>
...
### Does the MongoDB ClickPipe support Sharded Cluster? <a id="does-the-mongodb-clickpipe-support-sharded-cluster"></a>

Yes, the MongoDB ClickPipe supports both Replica Set and Sharded Cluster.

### Does MongoDB ClickPipe support Amazon DocumentDB? <a id="documentdb-support"></a>
...
### Does MongoDB ClickPipe support PrivateLink? <a id="privatelink-support"></a>
