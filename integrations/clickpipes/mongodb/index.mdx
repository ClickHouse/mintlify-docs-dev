...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="Select MongoDB" size="lg" border/>

### Add your source MongoDB database connection <a id="add-your-source-mongodb-database-connection"></a>
...
5. Here you can select the destination database for your ClickPipe. You can either select an existing database or create a new one.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="Select destination database" size="lg" border/>
