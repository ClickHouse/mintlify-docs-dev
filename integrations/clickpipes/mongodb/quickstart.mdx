...
## Table schema <a id="table-schema"></a>
...
### ReplacingMergeTree table engine <a id="replacingmergetree-table-engine"></a>
...
### Handling deletes <a id="handling-deletes"></a>
...
## Querying JSON data <a id="querying-json-data"></a>
...
### Dynamic type <a id="dynamic-type"></a>
...
### Field casting <a id="field-casting"></a>
...
## Flattening JSON <a id="flattening-json"></a>
