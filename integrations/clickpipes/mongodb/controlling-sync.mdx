...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="Create sync settings" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Edit sync button" size="md"/>

This will open a flyout with the sync settings, where you can change the sync interval and pull batch size:

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="Edit sync settings" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="CDC Syncs table" size="md"/>
