...
<Image img="/static/images/integrations/data-ingestion/clickpipes/securekinesis.jpg" alt="Secure Kinesis" size="lg" border/>
...
<Image img="/static/images/cloud/security/secures3_arn.png" alt="Secure S3 ARN" size="lg" border/>
