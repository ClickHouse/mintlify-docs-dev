...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="ClickPipes service" size="lg" border/>

2. Select the `Data Sources` button on the left-side menu and click on "Set up a ClickPipe"

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Select imports" size="lg" border/>

3. Select your data source.

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Select data source type" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.png" alt="Fill out connection details" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.png" alt="Set data format and topic" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Set table, schema, and settings" size="lg" border/>

  You can also customize the advanced settings using the controls provided

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="Set advanced controls" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="Use an existing table" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissions" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="Success notice" size="sm" border/>

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="Remove notice" size="lg" border/>

  The summary table provides controls to display sample data from the source or the destination table in ClickHouse

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_destination.png" alt="View destination" size="lg" border/>

  As well as controls to remove the ClickPipe and display a summary of the ingest job.

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="View overview" size="lg" border/>
