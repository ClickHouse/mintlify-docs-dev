...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Select data source type" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.png" alt="Fill out connection details" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.png" alt="Set data format and topic" size="lg" border/>
...
## Kinesis virtual columns <a id="kinesis-virtual-columns"></a>
...
### Active Shards <a id="active-shards"></a>
