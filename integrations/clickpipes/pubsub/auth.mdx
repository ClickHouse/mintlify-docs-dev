...
## Authentication model <a id="authentication-model"></a>
...
### Topic access (discovery and validation) <a id="topic-access"></a>
...
### Subscription lifecycle (discovery and ingestion) <a id="subscription-lifecycle"></a>
...
### Schema access (optional — only for native Avro/Protobuf topics) <a id="schema-access"></a>

| Permission           | Purpose                                                          |
|----------------------|------------------------------------------------------------------|
| `pubsub.schemas.get` | Retrieve native schema definitions from the Pub/Sub schema registry |

## Predefined roles <a id="predefined-roles"></a>
...
### Create a custom role (recommended) <a id="create-custom-role"></a>
...
### Create a service account <a id="create-service-account"></a>
...
### Grant the role to the service account <a id="grant-role"></a>
...
### Create and download a service account key <a id="create-key"></a>
