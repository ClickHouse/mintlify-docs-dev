...
- [Avro](/core/reference/formats/Avro/Avro) — via Pub/Sub native schemas (BINARY encoding)
- [Protobuf](/core/reference/formats/Protobuf/Protobuf) — via Pub/Sub native schemas (BINARY encoding)
