...
## Creating your first ClickPipe <a id="creating-your-first-clickpipe"></a>

1. Access the SQL Console for your ClickHouse Cloud Service.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="ClickPipes service" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1_pubsub.png" alt="Select GCP Pub/Sub as the data source" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_pubsub.png" alt="Fill out connection details" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_pubsub.png" alt="Set Pub/Sub topic, format, and starting offset" size="lg" border/>
...
## Managed subscriptions <a id="managed-subscriptions"></a>
...
### Standard types support <a id="standard-types-support"></a>
...
### Variant type support <a id="variant-type-support"></a>
...
### JSON type support <a id="json-type-support"></a>
...
## Pub/Sub virtual columns <a id="pubsub-virtual-columns"></a>
...
### Ordering keys <a id="ordering-keys"></a>
...
### Delivery semantics <a id="delivery-semantics"></a>
