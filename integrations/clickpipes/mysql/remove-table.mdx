...
## Steps to remove specific tables <a id="remove-tables-steps"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/remove_table.png" border size="md"/>
