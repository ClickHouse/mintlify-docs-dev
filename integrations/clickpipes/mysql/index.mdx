...
import ChangingTLSSettings from '@site/docs/_snippets/clickpipes/_changing_tls_settings.md'; {/* MIGRATE: snippet _changing_tls_settings.md not found */}
...
## Create your ClickPipe <a id="create-your-clickpipe"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="Select MySQL" size="lg" border/>

### Add your source MySQL database connection <a id="add-your-source-mysql-database-connection"></a>
...
#### (Optional) Changing TLS settings <a id="optional-changing-tls-settings"></a>

<ChangingTLSSettings/>

#### (Optional) Set up SSH Tunneling <a id="optional-set-up-ssh-tunneling"></a>
...
#### Configure advanced settings <a id="advanced-settings"></a>
...
### Configure the tables <a id="configure-the-tables"></a>
...
5. Here you can select the destination database for your ClickPipe. You can either select an existing database or create a new one.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="Select destination database" size="lg" border/>
...
### Review permissions and start the ClickPipe <a id="review-permissions-and-start-the-clickpipe"></a>
