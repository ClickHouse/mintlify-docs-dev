...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Enabling automated backups in RDS" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/rds_config.png" alt="Where to find parameter group in RDS" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Binlog row metadata to FULL" size="lg" border/>

3. `binlog_row_image` to `FULL`

<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Binlog row image to FULL" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Where to find security group in RDS MySQL?" size="lg" border/>
