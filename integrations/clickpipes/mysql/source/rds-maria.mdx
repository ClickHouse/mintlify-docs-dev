...
### 1. Enable binary logging via automated backup <a id="enable-binlog-logging-rds"></a>
...
### 2. Binlog retention hours <a id="binlog-retention-hours-rds"></a>
...
## Configure binlog settings in the parameter group <a id="binlog-parameter-group-rds"></a>
...
## Enabling GTID Mode <a id="gtid-mode-rds"></a>
...
## Configure a database user <a id="configure-database-user-rds"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Where to find security group in RDS?" size="lg" border/>
