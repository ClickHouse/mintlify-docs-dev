...
## Enable binary log retention <a id="enable-binlog-retention-gcp"></a>
...
### Enable binary logging via PITR <a id="enable-binlog-logging-gcp"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Enabling PITR in Cloud SQL" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="Edit button in GCP MySQL" size="lg" border/>

Then scroll down to the `Flags` section and add the above flags.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="Setting binlog flags in GCP" size="lg" border/>

## Configure a database user <a id="configure-database-user-gcp"></a>
...
## Configure network access <a id="configure-network-access-gcp-mysql"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="IP allowlisting in GCP MySQL" size="lg" border/>

## Download and use root CA certificate <a id="download-root-ca-certificate-gcp-mysql"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="Downloading GCP MySQL Cert" size="lg" border/>

5. In the ClickPipes UI, upload the downloaded certificate when creating a new MySQL ClickPipe.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="Using GCP MySQL Cert" size="lg" border/>
