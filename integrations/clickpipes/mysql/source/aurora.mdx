...
This step-by-step guide shows you how to configure Amazon Aurora MySQL to replicate data into ClickHouse Cloud using the [MySQL ClickPipe](/integrations/clickpipes/mysql). For common questions around MySQL CDC, see the [MySQL FAQs page](/integrations/clickpipes/mysql/faq).
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Enabling automated backups in Aurora" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/aurora_config.png" alt="Where to find parameter group in Aurora" size="lg" border/>

<br/>
Click the parameter group link, which will take you to its dedicated page. You should see an **Edit** button in the top right.

<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/edit_button.png" alt="Edit parameter group" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_format.png" alt="Binlog format to ROW" size="lg" border/>

2. `binlog_row_metadata` to `FULL`.

<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Binlog row metadata" size="lg" border/>

3. `binlog_row_image` to `FULL`.

<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Binlog row image" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/enable_gtid.png" alt="GTID enabled" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Where to find security group in Aurora MySQL?" size="lg" border/>

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="Edit inbound rules for the above security group" size="lg" border/>
