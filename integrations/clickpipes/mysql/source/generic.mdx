...
## Enable binary log retention <a id="enable-binlog-retention"></a>
...
### MySQL 8.x and newer <a id="binlog-v8-x"></a>
...
## SSL/TLS configuration (recommended) <a id="ssl-tls-configuration"></a>
