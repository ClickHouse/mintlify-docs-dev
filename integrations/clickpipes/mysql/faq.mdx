...
### Does the MySQL ClickPipe support MariaDB? <a id="does-the-clickpipe-support-mariadb"></a>
...
### Does the MySQL ClickPipe support PlanetScale, Vitess, or TiDB? <a id="does-the-clickpipe-support-planetscale-vitess"></a>
...
### Why is my pipe failing with a max_allowed_packet binlog error? <a id="binlog-event-exceeded-max-allowed-packet"></a>
...
### Why am I getting a TLS certificate validation error when connecting to MySQL? <a id="tls-certificate-validation-error"></a>
...
### Do you support replicating MySQL foreign key cascading deletes `ON DELETE CASCADE`? <a id="support-on-delete-cascade"></a>
