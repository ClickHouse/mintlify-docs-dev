...
## Overview <a id="overview-mysql-snapshot"></a>
...
### Partition key column <a id="key-mysql-snapshot"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/partition_key.png" alt="Partition key column" size="md"/>
...
### Logical partitioning <a id="logical-partitioning-mysql-snapshot"></a>

Let's talk about the below settings:

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/snapshot_params.png" alt="Snapshot parameters" size="md"/>

#### Snapshot number of rows per partition <a id="numrows-mysql-snapshot"></a>
...
#### Initial load parallelism <a id="parallelism-mysql-snapshot"></a>
...
#### Snapshot number of tables in parallel <a id="tables-parallel-mysql-snapshot"></a>
...
### Monitoring parallel snapshot in MySQL <a id="monitoring-parallel-mysql-snapshot"></a>
...
### Limitations <a id="limitations-parallel-mysql-snapshot"></a>
