...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/partition_key.png" alt="Partition key column" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/mysql/snapshot_params.png" alt="Snapshot parameters" size="md"/>
