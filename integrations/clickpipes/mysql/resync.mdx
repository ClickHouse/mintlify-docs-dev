...
### What does Resync do? <a id="what-mysql-resync-do"></a>
...
### Use cases for resyncing a ClickPipe <a id="use-cases-mysql-resync"></a>
...
### Resync ClickPipe Guide <a id="guide-mysql-resync"></a>
