...
All ClickPipes types can be created, updated, and deleted programmatically using the [ClickHouse Cloud OpenAPI](/api-reference/organization/get-list-of-available-organizations#tag/ClickPipes). This page covers authentication and the available ClickPipes endpoints, with example `curl` requests for each ClickPipe type.
...
For the full request and response schemas for each endpoint, see the [Swagger UI](/api-reference/organization/get-list-of-available-organizations#tag/ClickPipes).

## Examples <a id="examples"></a>

### List ClickPipes <a id="list-clickpipes"></a>
...
### Get a ClickPipe <a id="get-clickpipe"></a>
...
### Stop or start a ClickPipe <a id="stop-start-clickpipe"></a>
...
### Delete a ClickPipe <a id="delete-clickpipe"></a>
...
## Creating ClickPipes <a id="creating-clickpipes"></a>

The `POST /clickpipes` request body varies by source type. The examples below show the structure for each supported ClickPipe type. For the authoritative JSON schemas, refer to the [Swagger UI](/api-reference/organization/get-list-of-available-organizations#tag/ClickPipes).

### Kafka <a id="create-kafka"></a>
...
### Amazon Kinesis <a id="create-kinesis"></a>
...
### Google Cloud Storage <a id="create-gcs"></a>
...
### Azure Blob Storage <a id="create-abs"></a>
...
### Postgres CDC <a id="create-postgres"></a>
...
### MongoDB CDC <a id="create-mongodb"></a>
...
### BigQuery <a id="create-bigquery"></a>
