...
## Provider setup <a id="provider-setup"></a>
...
## Resource overview <a id="resource-overview"></a>
...
## Examples by ClickPipe type <a id="examples"></a>
...
#### Kafka with schema registry <a id="kafka-schema-registry"></a>
...
#### Kinesis with IAM role <a id="kinesis-iam-role"></a>
...
#### S3 continuous ingestion with SQS <a id="s3-continuous"></a>
...
### Google Cloud Storage <a id="gcs"></a>
...
#### Postgres with IAM role <a id="postgres-iam-role"></a>
...
## Importing existing ClickPipes <a id="import"></a>
