...
<Note>
  View the [PostgreSQL table engine](/core/reference/engines/table-engines/integrations/postgresql) doc page for a complete list of parameters.
</Note>
...
<Info>
For more features available for advanced options, please see the [reference documentation](/core/reference/engines/database-engines/materialized-postgresql).
</Info>
