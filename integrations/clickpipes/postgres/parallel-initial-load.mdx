...
## Overview <a id="overview-pg-snapshot"></a>
...
### CTID column in Postgres <a id="ctid-pg-snapshot"></a>
...
### Logical partitioning <a id="logical-partitioning-pg-snapshot"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/snapshot_params.png" alt="Snapshot parameters" size="md"/>

#### Snapshot number of rows per partition <a id="numrows-pg-snapshot"></a>
...
#### Initial load parallelism <a id="parallelism-pg-snapshot"></a>
...
#### Snapshot number of tables in parallel <a id="tables-parallel-pg-snapshot"></a>
...
### Monitoring parallel snapshot in Postgres <a id="monitoring-parallel-pg-snapshot"></a>
...
### Limitations <a id="limitations-parallel-pg-snapshot"></a>
