...
## How does data get replicated? <a id="how-does-data-get-replicated"></a>

### PostgreSQL logical decoding <a id="PostgreSQL-logical-decoding"></a>
...
###  Deduplicate using FINAL Keyword <a id="deduplicate-using-final-keyword"></a>
...
#### FINAL setting <a id="final-setting"></a>
...
### Query like with Postgres <a id="query-like-with-postgres"></a>
...
#### Refreshable materialized view <a id="refreshable-material-view"></a>
