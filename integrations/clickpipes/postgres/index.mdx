...
## Creating your ClickPipe <a id="creating-your-clickpipe"></a>
...
3. Select the `Postgres CDC` tile
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/postgres/postgres-tile.png" alt="Select Postgres" size="lg" border/>

### Adding your source Postgres database connection <a id="adding-your-source-postgres-database-connection"></a>
...
#### (Optional) Setting up AWS Private Link <a id="optional-setting-up-aws-private-link"></a>
...
#### (Optional) Setting up SSH tunneling <a id="optional-setting-up-ssh-tunneling"></a>
...
### Configuring the replication settings <a id="configuring-the-replication-settings"></a>
...
### Configuring the tables <a id="configuring-the-tables"></a>
