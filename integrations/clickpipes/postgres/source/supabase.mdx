...
## Creating a user with permissions and replication slot <a id="creating-a-user-with-permissions-and-replication-slot"></a>
...
## Connection details to use for Supabase <a id="connection-details-to-use-for-supabase"></a>
...
## Note on RLS <a id="note-on-rls"></a>
