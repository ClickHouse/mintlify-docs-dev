...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Where to find Parameter groups in RDS?" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modifying RDS Postgres with new parameter group" size="lg" border/>

3. Reboot your RDS instance to apply the changes

<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Reboot RDS Postgres" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="Where to find security group in RDS Postgres?" size="lg" border/>
