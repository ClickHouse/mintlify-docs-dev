...
<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enable-replication.png" alt="Enable logical replication" border/>

Click on **Enable** to be all set here. You should see the below success message once you enable it.

<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enabled-replication.png" alt="Logical replication enabled" border/>
...
<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-ip-allow.png" alt="Allow IPs screen" border/>
...
<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-conn-details.png" alt="Connection details" border/>
