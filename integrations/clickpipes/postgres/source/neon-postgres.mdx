...
## Creating a user with permissions <a id="creating-a-user-with-permissions"></a>
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enable-replication.png" alt="Enable logical replication" border/>

Click on **Enable** to be all set here. You should see the below success message once you enable it.

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enabled-replication.png" alt="Logical replication enabled" border/>
...
## IP whitelisting (for Neon enterprise plan) <a id="ip-whitelisting-for-neon-enterprise-plan"></a>
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-ip-allow.png" alt="Allow IPs screen" border/>

## Copy connection details <a id="copy-connection-details"></a>
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-conn-details.png" alt="Connection details" border/>
