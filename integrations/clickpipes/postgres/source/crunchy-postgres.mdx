...
<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/firewall_rules_crunchy_bridge.png" alt="Where to find Firewall Rules in Crunchy Bridge?" border/>

<Image size="lg" img="/static/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/add_firewall_rules_crunchy_bridge.png" alt="Add the Firewall Rules for ClickPipes" border/>
