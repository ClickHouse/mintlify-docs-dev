...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="Adjusting wal_level in PlanetScale console" size="md" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="Adjusting max_slot_wal_keep_size in PlanetScale console" size="md" border/>

## Creating a user with permissions and publication <a id="creating-a-user-with-permissions-and-publication"></a>
