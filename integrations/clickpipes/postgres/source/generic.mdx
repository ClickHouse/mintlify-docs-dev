...
## Enabling connections in pg_hba.conf to the ClickPipes User <a id="enabling-connections-in-pg_hbaconf-to-the-clickpipes-user"></a>
...
## Increase `max_slot_wal_keep_size` <a id="increase-max_slot_wal_keep_size"></a>
