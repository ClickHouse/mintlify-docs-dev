...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Server Parameters in Azure Flexible Server for Postgres" size="lg" border/>

2. Edit the `wal_level` to `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Change wal_level to logical in Azure Flexible Server for Postgres" size="lg" border/>

3. This change would require a server restart. So restart when requested.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="Restart server after changing wal_level" size="lg" border/>

## Creating ClickPipes users and granting permissions <a id="creating-clickpipes-user-and-granting-permissions"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Add ClickPipes IPs to Firewall in Azure Flexible Server for Postgres" size="lg"/>
