...
### Obtaining the ClickHouse service IAM role Arn <a id="obtaining-the-clickhouse-service-iam-role-arn"></a>
...
<Image img="/images/cloud/security/secures3_arn.png" alt="Secure S3 ARN" size="lg" border/>

Let's call this value `{ClickHouse_IAM_ARN}`. This is the IAM role that will be used to access your RDS/Aurora instance.

### Configuring the RDS/Aurora instance <a id="configuring-the-rds-aurora-instance"></a>

#### Enabling IAM DB Authentication <a id="enabling-iam-db-authentication"></a>
...
#### Obtaining the RDS/Aurora Resource ID <a id="obtaining-the-rds-resource-id"></a>
...
#### Setting up the Database User <a id="setting-up-the-database-user"></a>

##### PostgreSQL <a id="setting-up-the-database-user-postgres"></a>
...
##### MySQL / MariaDB <a id="setting-up-the-database-user-mysql"></a>
...
### Setting up the IAM role <a id="setting-up-iam-role"></a>

#### Manually create IAM role. <a id="manually-create-iam-role"></a>
