...
## Use refreshable materialized views <a id="use-refreshable-materialized-views"></a>
...
## Custom ordering keys without refreshable materialized views <a id="custom-ordering-keys-without-refreshable-materialized-views"></a>
...
### Choose ordering key columns that don't change for a given row <a id="choose-ordering-key-columns-that-dont-change-for-a-given-row"></a>
...
### Set Replica Identity on Postgres tables to custom ordering key <a id="set-replica-identity-on-postgres-tables-to-custom-ordering-key"></a>
