...
## What are TOAST columns in PostgreSQL? <a id="what-are-toast-columns-in-postgresql"></a>
...
## Identifying TOAST columns in a table <a id="identifying-toast-columns-in-a-table"></a>
...
## Ensuring proper handling of TOAST columns <a id="ensuring-proper-handling-of-toast-columns"></a>
...
## Replication behavior when REPLICA IDENTITY FULL isn't set <a id="replication-behavior-when-replica-identity-full-is-not-set"></a>
