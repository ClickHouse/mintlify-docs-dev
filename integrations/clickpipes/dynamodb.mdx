...
## 1. Set up Kinesis stream <a id="1-set-up-kinesis-stream"></a>
...
## 2. Create the snapshot <a id="2-create-the-snapshot"></a>
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="DynamoDB S3 Export" border/>

## 3. Load the snapshot into ClickHouse <a id="3-load-the-snapshot-into-clickhouse"></a>

### Create necessary tables <a id="create-necessary-tables"></a>
...
### Create the snapshot ClickPipe <a id="create-the-snapshot-clickpipe"></a>
...
## 4. Create the Kinesis ClickPipe <a id="4-create-the-kinesis-clickpipe"></a>
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="DynamoDB Map Columns" border/>

## 5. Cleanup (optional) <a id="5-cleanup-optional"></a>
