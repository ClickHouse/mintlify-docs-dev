...
<Image img="/static/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-kinesis-stream.png" size="lg" alt="DynamoDB Kinesis Stream" border/>
...
<Image img="/static/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="DynamoDB S3 Export" border/>
...
<Image img="/static/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="DynamoDB Map Columns" border/>
