...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="ClickPipes service" size="md" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="Select data source" size="lg" border/>

4. Select the `Reverse private endpoint` option.

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Select reverse private endpoint" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Select reverse private endpoint" size="lg" border/>

6. Provide the required parameters for the selected endpoint type.

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Select reverse private endpoint" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Select reverse private endpoint" size="lg" border/>
...
1. On a sidebar find the `Settings` button and click on it.
    ...
    <Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="ClickHouse Cloud settings" size="lg" border/>

2. Click on `Reverse private endpoints` in a `ClickPipe reverse private endpoints` section.

    <Image img="/static/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="ClickHouse Cloud settings" size="md" border/>
