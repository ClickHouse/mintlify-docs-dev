...
## Supported ClickPipes data sources <a id="supported-sources"></a>
...
## Supported AWS PrivateLink endpoint types <a id="aws-privatelink-endpoint-types"></a>
...
### VPC resource <a id="vpc-resource"></a>
...
<Steps>
<Step>
#### Create a resource gateway <a id="create-resource-gateway"></a>
...
<Step>
#### Create a VPC Resource-Configuration <a id="create-resource-configuration"></a>
...
<Step>
#### Create a Resource-Share <a id="create-resource-share"></a>
...
### MSK multi-VPC connectivity <a id="msk-multi-vpc"></a>
...
### VPC endpoint service <a id="vpc-endpoint-service"></a>
...
## Creating a ClickPipe with reverse private endpoint <a id="creating-clickpipe"></a>

1. Access the SQL Console for your ClickHouse Cloud Service.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="ClickPipes service" size="md" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="Select data source" size="lg" border/>

4. Select the `Reverse private endpoint` option.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Select reverse private endpoint" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Select reverse private endpoint" size="lg" border/>

6. Provide the required parameters for the selected endpoint type.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Select reverse private endpoint" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Select reverse private endpoint" size="lg" border/>
...
## Managing existing reverse private endpoints <a id="managing-existing-endpoints"></a>
...
1. On a sidebar find the `Settings` button and click on it.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="ClickHouse Cloud settings" size="lg" border/>

2. Click on `Reverse private endpoints` in a `ClickPipe reverse private endpoints` section.

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="ClickHouse Cloud settings" size="md" border/>
...
## Supported AWS regions <a id="aws-privatelink-regions"></a>
...
### Automatic cleanup of inactive endpoints <a id="automatic-cleanup"></a>
