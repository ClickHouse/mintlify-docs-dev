...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Select imports" size="md"/>

## Select a data source {#2-select-data-source}
Select your Kafka data source from the list.
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Select data source type" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Fill out connection details" size="md"/>

## Configure a schema registry (optional) {#4-configure-your-schema-registry}
A valid schema is required for Avro streams. See [Schema registries](/integrations/clickpipes/kafka/schema-registries) for more details on how to configure a schema registry.
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="SSH tunnel configuration" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Set your topic" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Set table, schema, and settings" size="md"/>

You can also customize the advanced settings using the controls provided

<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Set advanced controls" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissions" size="md"/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="View overview" size="md"/>
