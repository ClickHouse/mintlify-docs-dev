...
<Steps>
<Step>
## Navigate to data sources <a id="1-load-sql-console"></a>
Select the `Data Sources` button on the left-side menu and click on "Set up a ClickPipe".
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Select imports" size="md"/>
</Step>
<Step>
## Select a data source <a id="2-select-data-source"></a>
Select your Kafka data source from the list.
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Select data source type" size="md"/>
</Step>
<Step>
## Configure the data source <a id="3-configure-data-source"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Fill out connection details" size="md"/>
</Step>
<Step>
## Configure a schema registry (optional) <a id="4-configure-your-schema-registry"></a>
...
<Step>
## Configure a reverse private endpoint (optional) <a id="5-configure-reverse-private-endpoint"></a>
...
<Step>
## Configure SSH tunneling (optional) <a id="6-configure-ssh-tunneling"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="SSH tunnel configuration" size="md"/>
...
<Step>
## Select your topic <a id="7-select-your-topic"></a>
Select your topic and the UI will display a sample document from the topic.
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Set your topic" size="md"/>
</Step>
<Step>
## Configure your destination table <a id="8-configure-your-destination-table"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Set table, schema, and settings" size="md"/>

You can also customize the advanced settings using the controls provided

<Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Set advanced controls" size="md"/>
</Step>
<Step>
## Configure permissions <a id="9-configure-permissions"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissions" size="md"/>
</Step>
<Step>
## Complete setup <a id="10-complete-setup"></a>
Clicking on "Create ClickPipe" will create and run your ClickPipe. It will now be listed in the Data Sources section.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="View overview" size="md"/>
</Step>
</Steps>
