...
## Supported registries for Kafka ClickPipes <a id="supported-schema-registries"></a>
...
## Configuration <a id="schema-registry-configuration"></a>
...
## How it works <a id="how-schema-registries-work"></a>
...
## Schema mapping <a id="schema-mapping"></a>
