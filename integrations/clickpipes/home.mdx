...
<Image img="/static/images/integrations/data-ingestion/clickpipes/clickpipes_stack.png" alt="ClickPipes stack" size="lg" border/>
...
| Redpanda                                           | <Image img="/static/images/integrations/logos/logo_redpanda.png" size="logo" alt="Redpanda logo"/>                                     |Streaming| Stable           | Configure ClickPipes and start ingesting streaming data from Redpanda into ClickHouse Cloud.         |
...
| [Amazon Kinesis](/integrations/clickpipes/kinesis/overview) | <Amazonkinesis class="image" alt="Amazon Kenesis logo" style={{width: '3rem', height: 'auto'}}/> |Streaming| Stable           | Configure ClickPipes and start ingesting streaming data from Amazon Kinesis into ClickHouse cloud.   |
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_custom_role.png" alt="Assign a custom role" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="Advanced settings for ClickPipes" size="lg" border/>
