...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="HMAC credentials for GCS ClickPipes" size="lg" border/>

Follow [this guide](/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret) to create a service account with an HMAC key.
