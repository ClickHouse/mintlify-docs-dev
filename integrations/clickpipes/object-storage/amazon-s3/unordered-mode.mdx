...
<Steps>
<Step>
## Create an Amazon SQS queue <a id="create-sqs-queue"></a>
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_eb_s3_enable.png" alt="Enabling Amazon EventBridge notifications in S3 bucket properties" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_eb_rule_define.png" alt="Defining the EventBridge rule name and event bus" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_eb_rule_target.png" alt="Setting the SQS queue as the EventBridge rule target" size="lg" border/>

<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_eb_rule_created.png" alt="EventBridge rule successfully created" size="lg" border/>
...
<Step>
## Configure an IAM role <a id="configure-iam-role"></a>
...
<Step>
## Create a ClickPipe with unordered mode <a id="create-clickpipe"></a>
