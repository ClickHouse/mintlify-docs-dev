...
| **OVH Object Storage** <br></br> _S3-compatible_ | <img src="/images/integrations/logos/ovh.png" alt="Cloud Storage logo" width="32" />                         |  Continuous ingestion requires [lexicographical order](#continuous-ingestion-lexicographical-order). Unordered mode isn't supported. |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="IAM credentials for S3 ClickPipes" size="lg" border/>
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="IAM authentication for S3 ClickPipes" size="lg" border/>
...
| `Min insert block size bytes`      | 1GB           | [Minimum size of bytes in the block](/core/reference/settings/session-settings#min_insert_block_size_bytes) which can be inserted into a table. |
