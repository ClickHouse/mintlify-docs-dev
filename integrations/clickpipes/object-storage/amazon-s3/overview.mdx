...
| **OVH Object Storage** <br></br> _S3-compatible_ | <Image img="/images/integrations/logos/ovh.png" alt="Cloud Storage logo" size="logo" border/>                         |  Continuous ingestion requires [lexicographical order](#continuous-ingestion-lexicographical-order). Unordered mode isn't supported. |
