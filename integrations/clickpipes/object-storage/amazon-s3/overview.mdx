...
| **OVH Object Storage** <br></br> _S3-compatible_ | <Image img="/static/images/integrations/logos/ovh.png" alt="Cloud Storage logo" size="logo" border/>                         |  Continuous ingestion requires [lexicographical order](#continuous-ingestion-lexicographical-order). Unordered mode isn't supported. |
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="IAM credentials for S3 ClickPipes" size="lg" border/>
...
<Image img="/static/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="IAM authentication for S3 ClickPipes" size="lg" border/>
