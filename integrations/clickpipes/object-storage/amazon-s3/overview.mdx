...
## Supported data sources <a id="supported-data-sources"></a>
...
### One-time ingestion <a id="one-time-ingestion"></a>
...
### Continuous ingestion <a id="continuous-ingestion"></a>
...
#### Lexicographical order <a id="continuous-ingestion-lexicographical-order"></a>
...
#### Any order <a id="continuous-ingestion-any-order"></a>
...
##### EventBridge to SQS <a id="eb-to-sqs"></a>
...
### File pattern matching <a id="file-pattern-matching"></a>
...
#### Supported patterns <a id="supported-patterns"></a>
...
#### Unsupported patterns <a id="unsupported-patterns"></a>
...
### Exactly-once semantics <a id="exactly-once-semantics"></a>
...
#### IAM credentials <a id="iam-credentials"></a>
...
### View support <a id="view-support"></a>
