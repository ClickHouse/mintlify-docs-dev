                ...
                <>
                    ...
                    <div className="mt-6 grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4">
                        ...
                        <HeroCard
                            ...
                            href="/get-started/use-cases/machine-learning-and-genai/agent-facing-analytics"
                        />
                    </div>
                </>
            )}
...
<div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-24 max-w-6xl mx-auto">
        ...
        <div id="mcp-setup" style={{ marginTop: '64px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.08)', scrollMarginTop: '80px' }}>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-2">Setup docs MCP server</h2>
