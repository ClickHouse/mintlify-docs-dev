  ...
  "mcpServers": {
    ...
    return (
        <div className="text-xs font-normal" style={{ padding: '12px 0 4px' }}>
            ...
            {open && (
                <div className="text-left" style={{ maxWidth: '520px', margin: '8px auto 0' }}>
                    <Tabs>
                        <Tab title="Claude Code">
                            <p style={{ marginBottom: '8px', color: '#9ca3af', fontSize: '12px' }}>Run in your terminal:</p>
                            <CodeBlock language="bash">{`claude mcp add clickhouse-docs -- npx -y mintlify-mcp --doc-url https://clickhouse.com/docs`}</CodeBlock>
                        </Tab>
                        <Tab title="Claude Desktop">
                            <p style={{ marginBottom: '8px', color: '#9ca3af', fontSize: '12px' }}>Add to <code>claude_desktop_config.json</code>:</p>
                            <CodeBlock language="json">{jsonConfig}</CodeBlock>
                        </Tab>
                        <Tab title="Cursor">
                            <p style={{ marginBottom: '8px', color: '#9ca3af', fontSize: '12px' }}>Add to <code>.cursor/mcp.json</code>:</p>
                            <CodeBlock language="json">{jsonConfig}</CodeBlock>
                        </Tab>
                        <Tab title="Other">
                            <p style={{ marginBottom: '8px', color: '#9ca3af', fontSize: '12px' }}>Add to your MCP client config:</p>
                            <CodeBlock language="json">{jsonConfig}</CodeBlock>
                        </Tab>
                    </Tabs>
                </div>
