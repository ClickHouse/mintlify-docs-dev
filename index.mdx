...
export const HeroCard = ({ filename, darkFilename: darkFilenameProp, title, description, body, href, links, icon, showArrow, arrowBottom, extraStyle }) => {
    ...
    if (links && links.length > 0) {
        return <div className={cardClassName} style={{ color: 'inherit', ...extraStyle }}>{content}</div>;
    }

    return <a className={cardClassName} href={href} style={{ color: 'inherit', ...extraStyle }} onClick={(e) => { e.preventDefault(); window.location.href = href; }}>{content}</a>;
};
        ...
        <>
            ...
            {showProduct && (
                <>
                    ...
                    <p className="text-sm text-gray-500 dark:text-zinc-500" style={{ marginBottom: '24px' }}>Browse ClickHouse products and integrations, from the managed cloud service to open source projects.</p>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4" style={{ alignItems: 'stretch' }}>
                            <div style={{ gridColumn: 'span 2' }}>
                                <HeroCard
                                    ...
                                    body={<>
                                        <p className="text-[#6b7280] dark:text-[#a1a1aa]" style={{ marginTop: '8px', fontSize: '14px', lineHeight: '1.6' }}>
            ...
            <div id="mcp-setup" style={{ marginTop: '64px', scrollMarginTop: '80px' }}>
