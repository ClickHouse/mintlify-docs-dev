                    ...
                    <div className="mt-6 grid md:grid-cols-3 gap-x-6 gap-y-4">
                        <HeroCard
                            ...
                            links={[
                                ...
                                { label: "Migration guides", href: "/get-started/setup/migration-guides/01_overview" },
                        ...
                        <HeroCard
                            ...
                            links={[
                                { label: "Data modelling topics", href: "/guides/cloud-oss/data-modelling/schema-design" },
                                { label: "Performance and query optimization", href: "/guides/cloud-oss/performance_and_monitoring/query-optimization" },
                                { label: "ClickHouse Cloud topics", href: "/guides/cloud" },
