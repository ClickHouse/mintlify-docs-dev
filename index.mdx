    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
        ...
        <div id="mcp-setup" className="mt-16 scroll-mt-20">
            ...
            <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
                <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Add ClickHouse skills to your coding agent</p>
                <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Install the ClickHouse skills to give your agent expert ClickHouse knowledge and best practices.</p>
                <CodeBlock language="bash">{`npx skills add https://clickhouse.com`}</CodeBlock>
            </div>
        </div>
    </div>
</div>
