...
<div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-3 mx-auto mt-8">
            <button type="button" id="home-search-entry" className="flex pointer-events-auto items-center text-sm leading-6 h-9 pl-3.5 pr-3 text-gray-500 dark:text-white/50 dark:brightness-[1.1] dark:hover:brightness-[1.25] justify-between truncate gap-2 min-w-[43px] w-[320px] bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 shadow-none border border-white/10 ring-0 dark:ring-0 rounded" aria-label="Open search">
            ...
            <button type="button" className="flex-none hidden lg:flex items-center justify-center gap-1.5 pl-3 pr-3.5 h-9 shadow-none bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 border border-white/10 rounded" id="home-assistant-entry" aria-label="Open Ask AI" onClick={() => {
        ...
        <div className="flex items-center justify-center gap-2 my-6 text-xs">
            ...
            <a className="inline-flex items-center gap-1.5 text-gray-500 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-[#fdff75] transition-colors font-normal no-underline" href="/get-started/quickstarts/create-your-first-service-on-cloud">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
            <HeroCard
                ...
                links={[
                    ...
                    { label: "Install", href: "/get-started/setup/cloud" },
                    { label: "Quickstarts", href: "/get-started/quickstarts/home" },
                    { label: "ClickHouse concepts", href: "/concepts/core-concepts/index" },
            ...
            <HeroCard
                ...
                links={[
                    { label: "Modelling data", href: "/guides/clickhouse/data-modelling/schema-design" },
                    { label: "Optimizing performance", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
        ...
        <div className="space-y-4 mt-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    />
                    <HeroCard
                        logo="logo-integration.svg"
                        logoInvert
                        title="Integrations"
                        description="100+ integrations to connect the tools and services that you love with ClickHouse."
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <HeroCard
                    filename="thumbnail-langfuse-light.png"
                    title="LangFuse"
                ...
                />
                <HeroCard
                    filename="thumbnail-kubernetes-light.png"
                ...
                />
                <HeroCard
                    filename="thumbnail-chdb-light.png"
                    title="chDB"
        ...
        <div id="mcp-setup" className="mt-16 scroll-mt-20">
            ...
            <div className="mt-6"><McpSetup /></div>
        </div>
    </div>
</div>
