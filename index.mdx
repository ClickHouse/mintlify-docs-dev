                ...
                <ul style={{ marginTop: '24px', listStyle: 'none', padding: 0 }}>
                    {links.map((link, index) => (
                        <li key={index} style={{ marginTop: index > 0 ? '8px' : '0' }}>
                            <a href={link.href} onClick={(e) => { e.preventDefault(); window.location.href = link.href; }} className="goal-card-link flex items-center justify-between text-[#374151] dark:text-[#FCFF74]" style={{
                                fontSize: '14px',
                                fontWeight: '500',
                                textDecoration: 'none',
                                gap: '4px'
