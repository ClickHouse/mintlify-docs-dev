...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="مخطط معمارية لجزء بيانات واحد ونسختين متماثلتين باستخدام ReplicatedMergeTree" />
