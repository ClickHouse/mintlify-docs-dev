...
يدعم Databricks عدة تنسيقات بيانات في بيئة lakehouse الخاصة به. وباستخدام ClickHouse، يمكنك الاستعلام عن جداول Unity Catalog بصيغتَي Delta وIceberg.
...
للوصول إلى جداول Iceberg المُدارة:
