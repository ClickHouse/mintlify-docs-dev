...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="إضافة مجموعة بيانات تجريبية" />

حدِّد `Get started` في بطاقة بيانات أسعار العقارات المدفوعة في المملكة المتحدة (4GB):

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="تحديد مجموعة بيانات أسعار العقارات المدفوعة في المملكة المتحدة" />

ثم انقر على `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="استيراد مجموعة بيانات أسعار العقارات المدفوعة في المملكة المتحدة" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="أنشئ دفتر ملاحظات جديدًا" />

سيُطلب منك اختيار نواة.
اختر أي نواة بايثون متاحة لديك، وفي هذا المثال سنختار `ipykernel`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="اختر النواة" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="معاينة DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="معاينة إطار البيانات" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="معاينة إطار البيانات" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="رسم بياني لمجموعة بيانات بعيدة ومجموعة بيانات محلية" />
