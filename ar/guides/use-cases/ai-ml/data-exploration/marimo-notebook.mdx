...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="تحديد مجموعة بيانات أسعار العقارات المباعة في المملكة المتحدة" />

ثم انقر على `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="استيراد مجموعة بيانات أسعار العقارات المباعة في المملكة المتحدة" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="واجهة Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/5.png" alt="مرحبًا بالعالم في Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="تصور بيانات Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="مخطط Marimo الديناميكي" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="مخطط Marimo الديناميكي" />
