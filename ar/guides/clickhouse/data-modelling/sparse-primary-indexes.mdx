...
<Image img="/images/guides/best-practices/sparse-primary-indexes-01.png" size="lg" alt="الفهارس الأساسية المتناثرة 01" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-03a.png" size="lg" alt="الفهارس الأساسية المتفرقة 03a" />

إجمالًا، يحتوي الفهرس على 1083 إدخالًا لجدولنا الذي يضم 8.87 مليون صف و1083 حبيبة:

<Image img="/images/guides/best-practices/sparse-primary-indexes-03b.png" size="lg" alt="الفهارس الأساسية المتفرقة 03b" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-04.png" size="lg" alt="الفهارس الأساسية المتفرقة 04" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-05.png" size="lg" alt="الفهارس الأساسية المتفرقة 05" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-06.png" size="lg" alt="الفهارس الأساسية المتفرقة 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-07.png" size="lg" alt="الفهارس الأساسية المتفرقة 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-08.png" size="lg" alt="الفهارس الأساسية المتفرقة 06" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-13a.png" size="lg" alt="الفهارس الأساسية المتفرقة 13a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-09a.png" size="lg" alt="الفهارس الأساسية المتناثرة 09a" />

أما مع **عرض مادي**، فيُنشأ الجدول الإضافي ضمنيًا وتظل البيانات متزامنة تلقائيًا بين الجدولين:

<Image img="/images/guides/best-practices/sparse-primary-indexes-09b.png" size="lg" alt="الفهارس الأساسية المتناثرة 09b" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-09c.png" size="lg" alt="الفهارس الأساسية المتناثرة 09c" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-10.png" size="lg" alt="الفهارس الأساسية المتفرقة 10" />

وهذا هو المفتاح الأساسي الناتج:

<Image img="/images/guides/best-practices/sparse-primary-indexes-11.png" size="lg" alt="الفهارس الأساسية المتفرقة 11" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-14a.png" size="lg" alt="الفهارس الأساسية المتناثرة 14a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-14b.png" size="lg" alt="الفهارس الأساسية المتناثرة 14b" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-15a.png" size="lg" alt="الفهارس الأساسية المتناثرة 15a" />
...
<Image img="/images/guides/best-practices/sparse-primary-indexes-15b.png" size="lg" alt="الفهارس الأساسية المتناثرة 15b" />
