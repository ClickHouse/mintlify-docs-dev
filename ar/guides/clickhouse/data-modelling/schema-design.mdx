...
<Image img="/images/data-modeling/stackoverflow-schema.png" size="lg" alt="مخطط Stack Overflow" />
...
<Image img="/images/data-modeling/schema-design-indices.png" size="md" alt="الفهرسة المتفرقة في ClickHouse" />
