...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="عمود لكل مسار JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="إزاحات JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="عمود JSON مشترك" />
