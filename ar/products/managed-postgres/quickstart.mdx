...
keywords: ['managed postgres', 'الدليل السريع', 'البدء', 'إنشاء قاعدة بيانات', 'nvme', 'الأداء']
doc_type: 'guide'
---
...
<Image img="/images/managed-postgres/create-service.png" alt="إنشاء خدمة Managed Postgres" size="md" border />

أدخل اسمًا لمثيل قاعدة البيانات، ثم انقر على **Create service**. سيتم توجيهك إلى صفحة Overview.

<Image img="/images/managed-postgres/overview.png" alt="صفحة Overview لـ Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.png" alt="النافذة المنبثقة Connect في Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/integration-landing.png" alt="تكامل Managed Postgres فارغ" size="md" border />
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="نموذج تكامل Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/table-picker.png" alt="منتقي جداول Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="الحصول على مضيف ClickHouse" size="md" border />
...
<Image img="/images/managed-postgres/analytics-list.png" alt="قائمة تحليلات Managed Postgres" size="md" border />

انقر على اسم الخدمة لفتح وحدة تحكم ClickHouse والاطلاع على جداولك المنسوخة بالنسخ المتماثل.

<Image img="/images/managed-postgres/replicated-tables.png" alt="جداول Managed Postgres المنسوخة بالنسخ المتماثل في ClickHouse" size="md" border />
