...
<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="لوحة معلومات المراقبة تعرض IOPS، واستخدام CPU، والذاكرة، والقرص، وحركة مرور الشبكة، وحجم قاعدة البيانات، والاتصالات، ومعدل النقل، والمعاملات، ونسبة نجاح ذاكرة التخزين المؤقت، وحالات التوقف المتبادل" size="lg" border />
...
* [نقطة نهاية Prometheus](/ar/products/managed-postgres/monitoring/prometheus) — اجمع المقاييس نفسها في حزمة observability الخاصة بك
* [مرجع المقاييس](/ar/products/managed-postgres/monitoring/metrics) — القائمة الكاملة للمقاييس مع أنواعها وتسمياتها