...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="قائمة Users and roles" size="md" border />
...
<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="اختيار الكيان Postgres Service" size="md" border />

4. اختر خدمة Postgres التي تريد قصر الدور عليها، ثم حدِّد الأذونات المطلوب منحها.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="تهيئة أذونات Postgres على دور" size="md" border />
