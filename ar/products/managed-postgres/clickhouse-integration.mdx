...
<Image img="/images/managed-postgres/clickhouse-integration-intro.png" alt="الصفحة الرئيسية لـ تكامل ClickHouse التي تعرض خيار التكامل في الشريط الجانبي" size="md" border />
...
<Steps>
  <Step>
    ...
    * **طريقة النسخ المتماثل**: اختر أحد الخيارات التالية:
    ...
    <Image img="/images/managed-postgres/replication-service-step.png" alt="إعداد خدمة النسخ المتماثل الذي يعرض اسم التكامل وخدمة الوجهة وخيارات طريقة النسخ المتماثل" size="md" border />
  ...
  <Step>
    ...
    * **عدد الجداول في اللقطة بالتوازي**: عدد الجداول التي تؤخذ لها لقطات بالتزامن (الافتراضي: 1)
    ...
    <Image img="/images/managed-postgres/integration-replication-settings.png" alt="خطوة إعدادات النسخ المتماثل التي تعرض فاصل المزامنة والخيوط المتوازية وحجم دفعة السحب وخيارات إعداد اللقطة" size="md" border />
  ...
  <Step>
    ...
    اختر قاعدة بيانات الوجهة وحدد الجداول المطلوب نسخها متماثلًا:

    * **قاعدة بيانات الوجهة**: اختر قاعدة بيانات ClickHouse حالية أو أنشئ قاعدة بيانات جديدة
    * **إضافة اسم schema كبادئة لأسماء جداول الوجهة الافتراضية**: يضيف schema الخاصة بـ Postgres كبادئة لتجنب تعارضات التسمية
    * **الاحتفاظ بقيم NULL من المصدر**: يُبقي قيم NULL بدلًا من تحويلها إلى القيم الافتراضية
    * **إزالة الصفوف المحذوفة أثناء عمليات الدمج**: بالنسبة إلى جداول [ReplacingMergeTree](/ar/reference/engines/table-engines/mergetree-family/replacingmergetree)، يزيل الصفوف المحذوفة فعليًا أثناء عمليات الدمج في الخلفية
    ...
    <Image img="/images/managed-postgres/select-tables-step.png" alt="خطوة اختيار الجداول التي تعرض تحديد قاعدة البيانات وخيارات النسخ المتماثل ومحدد الجداول المجمّعة حسب schema" size="md" border />
  ...
  <Step>
    ...
    <Image img="/images/managed-postgres/integration-running.png" alt="قائمة تكامل ClickHouse تعرض ClickPipe قيد التشغيل مع خدمة الوجهة الخاصة به وحالته" size="md" border />
