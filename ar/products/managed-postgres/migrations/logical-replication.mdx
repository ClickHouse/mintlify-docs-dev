...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="إعداد النسخ المتماثل في PostgreSQL لقاعدة البيانات المصدر" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="إعداد جداول PostgreSQL المصدر" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="إنشاء مثيل ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="الإعداد الأولي لقاعدة بيانات ClickHouse Managed Postgres المستهدفة" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="نتيجة الترحيل بعد النسخ المتماثل المنطقي" size="xl" border />
