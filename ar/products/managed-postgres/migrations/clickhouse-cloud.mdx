...
<Image img="/images/managed-postgres/pgpg/servicecard.png" alt="بطاقة خدمة Managed Postgres في قائمة خدمات ClickHouse Cloud" size="lg" border />

في الشريط الجانبي الأيسر، انقر على **مصادر البيانات**.

<Image img="/images/managed-postgres/pgpg/overview.png" alt="إدخال مصادر البيانات في الشريط الجانبي لخدمة Managed Postgres" size="lg" border />

انقر على **Start import**.

<Image img="/images/managed-postgres/pgpg/startimport.png" alt="صفحة مصادر البيانات مع زر Start import" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationform.png" alt="الخطوة 1: نموذج الاتصال بقاعدة بيانات المصدر مع خيارات طريقة الإدخال" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.png" alt="مخرجات الطرفية بعد تشغيل استيراد المخطط عبر psql" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.png" alt="الخطوة 5: منتقي الجداول مُجمَّع حسب المخطط مع زر Create migration" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/migrationlist.png" alt="قائمة مصادر البيانات تعرض ترحيلاً قيد التشغيل" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/initialload.png" alt="عرض تفاصيل الترحيل يُظهر إحصاءات التحميل الأولي لكل جدول" size="lg" border />
