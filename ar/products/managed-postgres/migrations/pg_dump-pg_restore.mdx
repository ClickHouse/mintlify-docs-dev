...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="إعداد قاعدة بيانات PostgreSQL المصدر" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="تنفيذ أمر pg_dump" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="أنشئ مثيلاً من ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="تنفيذ أمر pg_restore" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="إعداد قاعدة بيانات Managed Postgres المستهدفة" size="xl" border />
