...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="إنشاء Source نظير" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="إنشاء نظير الهدف" size="md" border />

الآن، ينبغي أن ترى كلاً من نظير المصدر ونظير الهدف مدرجَين في قسم &quot;Peers&quot;.

<Image img="/images/managed-postgres/peerdb/peers.png" alt="قائمة نظراء" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="إنشاء مرآة" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="إعدادات المرآة" size="md" border />

4. اختر الجداول التي تريد ترحيلها. يمكنك اختيار جداول محددة أو تحديد جميع الجداول من قاعدة البيانات المصدر.

<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="منتقي الجداول" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="قائمة المرايا" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="تقدّم التحميل الأولي" size="md" border />
