...
[JupySQL](https://jupysql.ploomber.io/en/latest/quick-start.html) هي مكتبة Python تتيح لك تشغيل SQL في دفاتر Jupyter وواجهة IPython.
...
<Image img="/images/chdb/guides/players_per_rank.png" size="md" alt="مدرج تكراري لتصنيفات اللاعبين في مجموعة بيانات ATP" />