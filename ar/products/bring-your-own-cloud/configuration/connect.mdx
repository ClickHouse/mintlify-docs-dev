...
<Image img="/images/cloud/reference/byoc-connect-1.png" size="lg" alt="اتصال BYOC" background="black" />
...
2. **تأكّد من توفّر الاتصال بالشبكة**:
   * بالنسبة إلى VPC peering: أكمل إعداد VPC peering (راجع [إعداد الشبكات الخاصة](/ar/products/bring-your-own-cloud/onboarding/network))
