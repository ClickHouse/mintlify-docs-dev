...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC إنشاء peering connection" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-2.png" size="lg" alt="BYOC قبول peering connection" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC إضافة جدول توجيه" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC إضافة جدول توجيه" border />
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-1.png" size="lg" alt="نقطة نهاية خدمة BYOC PrivateLink" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-2.png" size="lg" alt="الموافقة على BYOC PrivateLink" border />
  </Step>
