...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-1.png" size="md" alt="BYOC إنشاء peering connection" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-2.png" size="md" alt="BYOC قبول peering connection" border />

    بعد إنشاء الاتصالين، يجب أن تصبح حالة الاتصالين &quot;Active&quot; بعد تحديث صفحة Google Cloud Console:

    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-3.png" size="lg" alt="BYOC قبول peering connection" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-1.png" size="lg" alt="نقطة نهاية BYOC PSC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-2.png" size="lg" alt="نقطة نهاية BYOC PSC" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-3.png" size="lg" alt="نقطة نهاية BYOC PSC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-4.png" size="lg" alt="نقطة نهاية BYOC PSC" border />
  </Step>
  ...
  <Step>
    ...
    * يجب أن تصبح حالة نقطة النهاية &quot;Accepted&quot;، وتواصل مع ClickHouse Support إذا لم يتم قبولها تلقائيًا.
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-5.png" size="lg" alt="إنشاء نقطة نهاية PSC لـ BYOC" border />
    ...
    * انقر على تفاصيل نقطة النهاية واحصل على &quot;PSC Connection ID&quot; لاستخدامه في الخطوة [Add endpoint&#39;s PSC Connection ID to service allowlist](#step-5-add-endpoint-id-allowlist)
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-6.png" size="lg" alt="تفاصيل نقطة نهاية PSC لـ BYOC" border />
  </Step>
