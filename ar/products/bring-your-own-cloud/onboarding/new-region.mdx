...
<Image img="/images/cloud/reference/byoc-new-infra-1.png" size="lg" alt="صفحة البنية الأساسية لـ BYOC" />

1. حدِّد &quot;Add new infrastructure&quot; واتبع الواجهة الإرشادية لإكمال عملية الإعداد.

<Image img="/images/cloud/reference/byoc-new-infra-2.png" size="lg" alt="صفحة البنية الأساسية لـ BYOC" />