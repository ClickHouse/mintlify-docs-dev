...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="الشبكة الفرعية لـ VPC في BYOC" />

    <Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="وسوم الشبكة الفرعية لـ VPC في BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="S3 Endpoint لـ BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="واجهة إعداد BYOC في ClickHouse Cloud مع تحديد استخدام VPC حالية" />
