...
<Steps>
  ...
  <Step title="اختر نموذجًا">
    ...
    <Image img="/images/agentic-data-stack/select-model.png" alt="محدِّد النماذج في LibreChat في الزاوية العلوية اليسرى، ويعرض النموذج الافتراضي مع تلميح Select a model" size="md" />
    ...
    <Accordion title="عيّن مفتاح مزوّد في واجهة المستخدم">
      ...
      <Image img="/images/agentic-data-stack/set-api-key.png" alt="محدِّد نماذج LibreChat مع زر Set API Key بجانب مزوّد Anthropic" size="md" />

      ألصق مفتاحك في مربع الحوار وانقر على **Submit**. يمكنك تعيين تاريخ انتهاء، أو الإبقاء على المفتاح بدون انتهاء.

      <Image img="/images/agentic-data-stack/set-api-key-modal.png" alt="مربع الحوار Set API Key for Anthropic مع قائمة منسدلة لتاريخ الانتهاء، وحقل Key، وزري Submit وRevoke" size="md" />
    </Accordion>
  </Step>
  ...
  <Step title="اختر خادم MCP">
    ...
    <Image img="/images/agentic-data-stack/select-clickhouse-local.png" alt="قائمة MCP Servers مفتوحة في منطقة الكتابة في LibreChat، وتعرض ClickHouse-Local مع نقطة اتصال خضراء وClickHouse-Cloud" size="md" />
  </Step>
  ...
  <Step title="اطرح سؤالك الأول">
    ...
    <Image img="/images/agentic-data-stack/prompt-chat.png" alt="LibreChat يجيب عن السؤال المثال عبر استدعاء أدوات ClickHouse-Local MCP وسرد قواعد البيانات والجداول المتاحة" size="md" />
  </Step>
</Steps>
