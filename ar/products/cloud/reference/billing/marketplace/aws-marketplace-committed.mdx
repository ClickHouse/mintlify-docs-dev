...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="رسالة البريد الإلكتروني الخاصة بالعرض الخاص في AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="رسالة البريد الإلكتروني الخاصة بالعرض الخاص في AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="رسالة البريد الإلكتروني الخاصة بالعرض الخاص في AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="أنشئ مؤسسة أو اخترها لتتم الفوترة على هذا الاشتراك" />

    بعد إكمال هذه الخطوة، سيتم ربط مؤسستك بعقد AWS committed spend الخاص بك، وستتم فوترة كل الاستخدام عبر AWS account الخاص بك.
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="أكّد اكتمال الإعداد" />
