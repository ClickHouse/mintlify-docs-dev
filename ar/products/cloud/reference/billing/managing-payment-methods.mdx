...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="إضافة طريقة الدفع" size="lg" />

3. إذا كنت ترغب في تعديل بطاقتك الائتمانية، فانقر على زر **تعديل بطاقتك الائتمانية** أعلى الصفحة.

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="تعديل بطاقتك الائتمانية" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="تعديل طريقة الدفع" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="تعديل طريقة الدفع" size="lg" />
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="إضافة بطاقة ائتمان احتياطية" size="lg" />
