...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="نظرة عامة على Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-create.png" size="lg" alt="نقاط النهاية الخاصة" border />
...
<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="افتح Private Service Connect في Google Cloud Console" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="فعّل Global Access لـ Private Service Connect" border />

لإنشاء PSC Endpoint، استخدم الزر **ADD ENDPOINT**.

سيتغير عمود **Status** من **Pending** إلى **Accepted** بمجرد الموافقة على الاتصال.

<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="انسخ PSC Connection ID" border />
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="إزالة Private Endpoint من ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="عامل تصفية Private Endpoints" border />
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="اسم DNS لنقطة النهاية الخاصة" border />
