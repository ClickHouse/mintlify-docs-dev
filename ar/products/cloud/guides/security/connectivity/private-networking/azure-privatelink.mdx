...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="نظرة عامة على PrivateLink" background="white" />
...
<Image img="/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="نقاط النهاية الخاصة" border />
...
<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="فتح Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="إنشاء الإعدادات الأساسية لـ Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="تحديد مورد Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="تحديد الشبكة الظاهرية لـ Private Endpoint" border />

انقر على زر **Next: Tags**.

***

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="تهيئة DNS لـ Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Tags الخاصة بـ Private Endpoint" border />

أخيرًا، انقر على زر **Create**.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="مراجعة Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="عنوان IP لـ Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="عرض Private Endpoint" border />

ضمن properties، ابحث عن الحقل `id` وانسخ هذه القيمة:

**الطريقة المفضلة: استخدام Resource ID**

<Image img="/images/cloud/security/azure-pe-resource-id.png" size="lg" alt="معرّف مورد Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-resource-guid.png" size="lg" alt="معرّف GUID لمورد Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="إعداد سجل DNS wildcard لـ Private Link" border />
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="إزالة Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="تصفية نقاط النهاية الخاصة" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="اسم DNS لـ Private Endpoint" border />
