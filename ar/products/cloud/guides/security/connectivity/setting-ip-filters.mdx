...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="قائمة وصول حالية في ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="إضافة عنوان IP واحد إلى access list في ClickHouse Cloud" border />
