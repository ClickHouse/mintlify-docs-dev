...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="طلب تمكين HIPAA" background="black" />

    <br />

    4. اتبع الإرشادات الظاهرة على الشاشة لتقديم طلب لاستكمال اتفاقية BAA.

    <br />

    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="إرسال طلب BAA" background="black" />

    <br />

    5. بعد اكتمال اتفاقية BAA، سيتم تمكين HIPAA للمؤسسة.

    <br />

    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="تم تمكين HIPAA" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="النشر في منطقة متوافقة مع HIPAA" background="black" />
