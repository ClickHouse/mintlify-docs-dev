...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="بدء إعداد SAML" force />
  </Step>
  ...
  <Step>
    ...
    * [إعداد Duo SAML](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="إنشاء تطبيق موفّر الهوية" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="إضافة عنوان URL للبيانات الوصفية" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="أضف نطاقًا للتحقق منه" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="تحقّق من نطاقك" force />
  </Step>
...
<Accordion title="إنشاء تطبيق ويب في Google">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="تطبيق Google SAML" force />
...
<Accordion title="إنشاء تطبيق Azure Enterprise">
  ...
  5. أدخل اسمًا وحدد **Integrate any other application you don&#39;t find in the gallery (Non-gallery)**، ثم انقر على **Create**.
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="تطبيق Azure غير الموجود في المعرض" force />
  ...
  10. أضف (A) أو حدّث (U) ما يلي ضمن Attributes &amp; Claims:
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="السمات والمطالبات" force />
