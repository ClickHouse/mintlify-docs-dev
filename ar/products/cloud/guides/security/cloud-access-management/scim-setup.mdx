...
<Steps>
  <Step>
    ...
    ![الانتقال إلى علامة تبويب تكوين SCIM في إعدادات المؤسسة](/images/cloud/security/scim-okta/scim-okta-01.png)

    انقر على `Enable SCIM`. يصبح SCIM متاحًا بمجرد ربط SAML SSO — إذا كان الخيار باللون الرمادي، فأكمِل إعداد SAML أولًا.

    ![تبديل Enable SCIM](/images/cloud/security/scim-okta/scim-okta-02.png)
  ...
  <Step>
    ...
    ![إنشاء مفتاح API جديد لـ SCIM](/images/cloud/security/scim-okta/scim-okta-07.png)
  </Step>
...
<Steps>
  <Step>
    ...
    ![عيّن وضع التوفير إلى SCIM في إعدادات تطبيق Okta](/images/cloud/security/scim-okta/scim-okta-03.png)

    يعرض التطبيق الآن علامة التبويب **Provisioning**.

    ![تظهر الآن علامة التبويب Provisioning في التطبيق](/images/cloud/security/scim-okta/scim-okta-05.png)
  </Step>
  ...
  <Step>
    ...
    * **Authentication Mode** — `Basic Auth`.
    ...
    ![أدخل عنوان URL لموصل SCIM واضبط المعرّف الفريد على userName](/images/cloud/security/scim-okta/scim-okta-06.png)

    ![أدخل بيانات اعتماد واجهة برمجة تطبيقات SCIM للمصادقة](/images/cloud/security/scim-okta/scim-okta-08.png)
    ...
    ![اختبر اتصال SCIM](/images/cloud/security/scim-okta/scim-okta-09.png)
  ...
  <Step>
    ...
    ![تمكين إجراءات توفير SCIM للمستخدمين](/images/cloud/security/scim-okta/scim-okta-10.png)

    انقر `Save`، ثم ارجع إلى علامتَي التبويب **Sign On** / **Provisioning** في التطبيق للتأكد من تطبيق الإعدادات.

    ![احفظ إعدادات التوفير وارجع إلى تبويب Sign On](/images/cloud/security/scim-okta/scim-okta-10b.png)
  </Step>
  ...
  <Step>
    ...
    **أنشئ مجموعات في Okta.** لكل تعيين أدوار أعددته سابقًا، أنشئ أو حدِّد مجموعة في Okta تحمل **اسم العرض نفسه تمامًا**. على سبيل المثال، إذا كان التعيين لديك يقول `ClickHouse-Admins → Admin`، فأنشئ مجموعة باسم `ClickHouse-Admins` في Okta.
    ...
    ![إنشاء مجموعة جديدة في Okta](/images/cloud/security/scim-okta/scim-okta-13.png)

    افتح المجموعة التي أنشأتها للتو وانقر على `Assign people` لإضافة عضو إليها.

    ![انقر على Assign people للمجموعة](/images/cloud/security/scim-okta/scim-okta-14.png)

    ![تعيين المستخدم إلى المجموعة](/images/cloud/security/scim-okta/scim-okta-15.png)

    ثم اربط تطبيق SCIM بالمجموعة نفسها حتى تظل عضوية الأدوار وإمكانية الوصول إلى التطبيق متزامنتين.

    ![تعيين التطبيق إلى المجموعة](/images/cloud/security/scim-okta/scim-okta-16.png)
    ...
    **ادفع المجموعات.** في علامة التبويب **Provisioning** الخاصة بالتطبيق، انقر على `Push Groups → Find groups by name`، وابحث عن مجموعتك، ثم انقر على `Save`. كرر ذلك لكل مجموعة أدوار. يجب أن تظهر لكل مجموعة **Push Status** بالقيمة **Active (Pushed)** بعد اكتمال التزويد.
    ...
    ![إعداد Group Push بالاسم في علامة التبويب Push Groups الخاصة بالتطبيق](/images/cloud/security/scim-okta/scim-okta-17.png)
...
![التحقق من مزامنة المستخدمين في Users and roles](/images/cloud/security/scim-okta/scim-okta-18.png)
