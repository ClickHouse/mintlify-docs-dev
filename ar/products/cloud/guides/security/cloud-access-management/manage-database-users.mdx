...
اضبط ما يلي على مستوى الخدمات وقواعد البيانات باستخدام عبارة SQL ‏[GRANT](/ar/reference/statements/grant).
...
يوضح الشكل أدناه الطرق المختلفة التي يمكن بها منح مستخدم أذونات.

<Image img="/images/cloud/security/cloud-access-management/user_grant_permissions_options.png" alt="رسم توضيحي يبيّن الطرق المختلفة التي يمكن بها منح مستخدم أذونات" size="md" background="black" />
...
<Steps>
  ...
  <Step>
    ...
    e. انقر على الرابط الذي يعرض عدد المستخدمين الذين لديهم وصول إلى قاعدة البيانات `There are # users with access to this service.` لعرض قائمة المستخدمين.
  </Step>
</Steps>
...
تتم مشاركة مستخدمي المستودع بين الخدمات ضمن المستودع نفسه. لمزيد من المعلومات، راجع [عناصر التحكم في الوصول إلى المستودع](/ar/products/cloud/features/infrastructure/warehouses#access-controls).