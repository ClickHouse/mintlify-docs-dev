...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="أنشئ خدمة جديدة" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="إعداد تفضيلات الخدمة" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="إعداد تفضيلات الخدمة" />
    ...
    * **IAM user** (`docs-s3-user`): يتيح لعنقود ClickHouse ذاتي الإدارة لديك أخذ نسخة احتياطية إلى S3
...
<Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="النسخة الاحتياطية والبيانات والبيانات الوصفية" />
