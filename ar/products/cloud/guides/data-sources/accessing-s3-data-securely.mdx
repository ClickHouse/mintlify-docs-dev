...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="نظرة عامة على الوصول الآمن إلى S3 باستخدام ClickHouse" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="الحصول على ARN لدور IAM الخاص بخدمة ClickHouse" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="مخرجات CloudFormation stack التي تعرض IAM Role ARN" border />
