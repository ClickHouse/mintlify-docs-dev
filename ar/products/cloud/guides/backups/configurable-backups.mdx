...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="إعداد إعدادات النسخ الاحتياطي" border />
...
<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="تحديد مدة الاحتفاظ بالنسخ الاحتياطي وتكراره" border />
