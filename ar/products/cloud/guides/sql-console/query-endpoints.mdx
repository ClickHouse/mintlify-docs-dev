...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="اختبر استعلام المثال" />

    بعد ذلك، احفظ الاستعلام:

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="احفظ استعلام المثال" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="هيئ نقطة نهاية الاستعلام" />
    ...
    * تحديد النطاقات المسموح بها لمشاركة الموارد عبر المصادر المختلفة (CORS)
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="أمر curl لنقطة النهاية" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="اختبار curl لنقطة النهاية" />
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="مراقبة نقطة النهاية" />
  </Step>
</Steps>
