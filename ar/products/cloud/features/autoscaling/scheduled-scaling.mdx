...
<Image img="/images/cloud/features/autoscaling/scheduled-scaling-1.png" size="md" alt="واجهة جداول التوسعة في ClickHouse Cloud console، تعرض قواعد التوسعة المستندة إلى الوقت" border />

<Image img="/images/cloud/features/autoscaling/scheduled-scaling-2.png" size="md" alt="تهيئة قاعدة توسعة مجدولة في ClickHouse Cloud console" border />
