...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="اختر MCP في نافذة Connect" size="md" />

بدّل الزر إلى وضع التشغيل لتمكين MCP لهذه الخدمة:

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="تمكين خادم MCP" size="md" />
