...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="النافذة المنبثقة Agent Tools تعرض تكاملات نماذج الصور، بما في ذلك OpenAI Image Tools وDALL-E-3 وStable Diffusion، إلى جانب أدوات أخرى تابعة لجهات خارجية" size="md" />
