...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="حقل كتابة الرسالة مع فتح قائمة مشبك الورق، وتظهر فيها خيارات التحميل إلى المزوّد، والتحميل كنص، والتحميل إلى بيئة البرمجة" size="lg" />
