...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/launch-ch-agents.png" alt="تنقّل خدمة Cloud مع تحديد ClickHouse agents (Beta)، مع ظهور صفحة الإطلاق التي تتضمن زر Launch ClickHouse agents" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Model** - اختر نموذجًا من القائمة المنسدلة.
    ...
    <Image img="/images/cloud/agent-builder/agent-builder.png" alt="لوحة Agent Builder تعرض القائمة المنسدلة Create New Agent، وحقول النموذج (Name وDescription وCategory وInstructions وModel)، وقسم Capabilities" size="lg" />
  </Step>
  ...
  <Step>
    ...
    **Capabilities** في اللوحة الرئيسية — ميزات أصلية مثل [Run Code](/ar/products/cloud/features/ai-ml/agents/builder/code-interpreter)، و[Web Search](/ar/products/cloud/features/ai-ml/agents/builder/web-search)، وFile Context، وArtifacts، و[MCP Servers](/ar/products/cloud/features/ai-ml/agents/builder/mcp-servers)، و[Skills](/ar/products/cloud/features/ai-ml/agents/builder/skills). فعّل ما يحتاجه الوكيل منها.
    ...
    <Image img="/images/cloud/agent-builder/capabilities.png" alt="قسم Capabilities في لوحة Agent Builder يعرض أزرار التبديل الخاصة بـ Run Code وWeb Search وFile Context وArtifacts وMCP Servers وSkills" size="sm" />
    ...
    **Tools** خلف زر **Add Tools** أسفل اللوحة — تكاملات خارجية مثل [توليد الصور](/ar/products/cloud/features/ai-ml/agents/builder/image-generation)، و[Vision](/ar/products/cloud/features/ai-ml/agents/builder/vision)، وواجهات برمجة تطبيقات البحث، والخدمات الخارجية.
    ...
    <Image img="/images/cloud/agent-builder/tools-button.png" alt="الجزء السفلي من لوحة Agent Builder مع تمييز زر Add Tools" size="sm" />

    انقر على **Add Tools** لاستعراض الكتالوج:

    <Image img="/images/cloud/agent-builder/tools-modal.png" alt="نافذة Agent Tools تعرض شبكة من التكاملات الخارجية، بما في ذلك Google وOpenAI Image Tools وWolfram وDALL-E-3 وTavily Search وCalculator وStable Diffusion" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/chat-query.png" alt="محادثة تعرض السؤال 'What are my top 10 tables by row count this week?' وردّ الوكيل — جدول Markdown يرتّب أفضل 10 جداول عبر الخدمات حسب عدد الصفوف، مع Key Observations في الأسفل" size="lg" />
  </Step>
</Steps>
...
* [شارك الوكيل](/ar/products/cloud/features/ai-ml/agents/sharing-and-access) مع زملائك.
