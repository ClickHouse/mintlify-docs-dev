...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="لوحة Prompts مع تمييز زر + على اليسار وفتح نموذج Create Prompt على اليمين، ويعرض حقول Prompt Name وText وCategory وSpecial variables وDescription وCommand، مع زر Create Prompt" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="لوحة Prompts مع تحديد موجّه، وظهور تفاصيله على اليمين، وقائمة سياقية تعرض خياري Preview وEdit" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="نافذة منبثقة لمعاينة موجّه تعرض عنوان موجّه، والمؤلف، والتاريخ، والمحتوى، وزر Use Prompt" size="md" />
