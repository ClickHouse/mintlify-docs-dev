...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="لوحة المعلومات المتقدمة في ClickHouse Cloud" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="نظرة عامة على واجهة مستخدم Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="مخطط زمن الاستجابة في Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="جدول الاستعلامات الأخيرة في Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="واجهة Query Insights للتعمّق في الاستعلام" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="واجهة Query Insights لمعلومات الاستعلام" border />
