...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="تهيئة نقطة نهاية مقاييس Grafana" border />

<br />

بعد إكمال التهيئة، ينبغي أن ترى المقاييس في القائمة المنسدلة التي يمكنك اختيارها لتهيئة لوحات المعلومات:

<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="القائمة المنسدلة في مستكشف مقاييس Grafana" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="مخطط في مستكشف مقاييس Grafana" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="مستكشف المقاييس في Grafana" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="تكامل Prometheus وDatadog" />
