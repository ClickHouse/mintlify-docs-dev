...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/console-api-keys.png" size="md" alt="مفاتيح API" />

    2. انقر على **Edit** بجوار مفتاح API المستخدم لـ Query API endpoints

    <Image img="/images/cloud/guides/query-endpoints/api-key-edit.png" size="md" alt="تحرير" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/guides/query-endpoints/specific-locations.png" size="md" alt="مواقع محددة" />
