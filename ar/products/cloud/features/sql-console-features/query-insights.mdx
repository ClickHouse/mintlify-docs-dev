...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="مخطط زمن الاستجابة في واجهة Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="واجهة Query Insights لجدول Recent queries" border />
