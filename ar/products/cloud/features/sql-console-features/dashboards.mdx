...
<Image img="/images/cloud/dashboards/2_dashboards.png" size="md" alt="إنشاء استعلام محفوظ" border />
...
<Image img="/images/cloud/dashboards/3_dashboards.png" size="md" alt="حفظ الاستعلام" border />
...
<Image img="/images/cloud/dashboards/4_dashboards.png" size="md" alt="تصور بمخطط شريطي لنتائج استعلام" border />
...
<Image img="/images/cloud/dashboards/5_dashboards.png" size="md" alt="إنشاء لوحة معلومات جديدة" border />
...
<Image img="/images/cloud/dashboards/6_dashboards.png" size="md" alt="إضافة تصور" border />
...
<Image img="/images/cloud/dashboards/7_dashboards.png" size="md" alt="عرض نتائج الاستعلام في جدول" border />
...
<Image img="/images/cloud/dashboards/8_dashboards.png" size="md" alt="حرّر الاستعلام الأساسي" border />
...
<Image img="/images/cloud/dashboards/9_dashboards.png" size="md" alt="اضبط عوامل التصفية العامة" border />
...
<Image img="/images/cloud/dashboards/10_dashboards.png" size="md" alt="تغيير معلمة الاستعلام" border />

الآن، يمكنك التحكم في عامل التصفية على المخطط الخطي مباشرةً من جدول queries by kind لجعل لوحة المعلومات تفاعلية.

<Image img="/images/cloud/dashboards/11_dashboards.png" size="md" alt="تحكم في عامل التصفية على المخطط الخطي" border />