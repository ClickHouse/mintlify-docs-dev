...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="البنية المُجزّأة" />
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="بنية غير مُشظّاة" />
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="النسخ المتماثلة المتوازية" />
...
<Image img="/images/deployment-guides/parallel-replicas-4.png" size="md" alt="الإعلانات" />

<ol className="docs-ordered-list">
  <li>
    يُرسَل الاستعلام من العميل إلى إحدى العُقد بعد مروره عبر
    موازن التحميل. وتصبح هذه العقدة المنسّق لهذا الاستعلام.
  </li>
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="التنسيق الديناميكي - الجزء 1" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="التنسيق الديناميكي - الجزء 2" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="التنسيق الديناميكي - الجزء 3" />
...
| التوافق مع المحلّل الجديد                              | قد يؤدي المحلّل الجديد إلى إبطاء تنفيذ الاستعلام أو تسريعه بشكل ملحوظ في سيناريوهات محددة.                                                                                                                                                                                                                                                                                                                     |
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="EXPLAIN بدون parallel_replica" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="EXPLAIN باستخدام parallel_replica" />