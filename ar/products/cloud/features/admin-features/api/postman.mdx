...
<Image img="/images/cloud/manage/postman/postman1.png" size="md" alt="موقع Postman" border />
...
<Image img="/images/cloud/manage/postman/postman2.png" size="md" alt="إنشاء مساحة عمل" border />
...
<Image img="/images/cloud/manage/postman/postman4.png" size="md" alt="إدخال عنوان URL لواجهة برمجة التطبيقات" border />
...
<Image img="/images/cloud/manage/postman/postman7.png" size="md" alt="استيراد واجهة برمجة تطبيقاتك" border />

* انقر على &quot;مواصفة واجهة برمجة تطبيقات ClickHouse Cloud&quot;. ومن الجزء الأوسط، اختر علامة التبويب &#39;Authorization&#39;:

<Image img="/images/cloud/manage/postman/postman8.png" size="md" alt="اكتمل الاستيراد" border />
...
<Image img="/images/cloud/manage/postman/postman9.png" size="md" alt="المصادقة الأساسية" border />

* أدخل اسم المستخدم وكلمة المرور اللذين تلقيتهما عند إعداد مفاتيح واجهة برمجة تطبيقات الخاصة بـ ClickHouse Cloud:

<Image img="/images/cloud/manage/postman/postman10.png" size="md" alt="بيانات الاعتماد" border />
...
<Image img="/images/cloud/manage/postman/postman11.png" size="md" alt="معرّف المؤسسة ومعرّف الخدمة" border />
...
<Image img="/images/cloud/manage/postman/postman12.png" size="md" alt="اختبار استرجاع organizations" border />
...
<Image img="/images/cloud/manage/postman/postman13.png" size="md" alt="الحالة" border />
...
<Image img="/images/cloud/manage/postman/postman14.png" size="md" alt="اختبار استرجاع تفاصيل المؤسسة" border />

* عدّل هذه القيمة إلى `orgid` بين أقواس معقوفة `{{orgid}}` (بعد ضبط هذه القيمة مسبقًا، ستظهر قائمة تتضمن القيمة):

<Image img="/images/cloud/manage/postman/postman15.png" size="md" alt="إرسال الاختبار" border />

* بعد الضغط على زر &quot;Save&quot;، اضغط على الزر الأزرق &quot;Send&quot; في أعلى يمين الشاشة.

<Image img="/images/cloud/manage/postman/postman16.png" size="md" alt="القيمة المُعادة" border />
...
<Image img="/images/cloud/manage/postman/postman17.png" size="md" alt="قائمة الخدمات" border />
