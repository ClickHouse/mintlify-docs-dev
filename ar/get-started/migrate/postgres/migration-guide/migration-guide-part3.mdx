...
<Image img="/images/migrations/postgres-b-tree.png" size="lg" alt="فهرس B-Tree في PostgreSQL" />

<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="الفهرس المتفرق في PostgreSQL" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="أقسام PostgreSQL إلى أقسام ClickHouse" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="إسقاطات PostgreSQL في ClickHouse" />
...
نظرًا إلى أن Postgres قاعدة بيانات علائقية، فإن نموذج بياناته يكون [مُطبَّعًا](https://en.wikipedia.org/wiki/Database_normalization) بدرجة كبيرة، وغالبًا ما يضم مئات الجداول. في ClickHouse، قد تكون إزالة التطبيع مفيدة أحيانًا لتحسين أداء عمليات JOIN.

يمكنك الرجوع إلى هذا [الدليل](/ar/guides/clickhouse/data-modelling/denormalization) الذي يوضح فوائد إزالة التطبيع لمجموعة بيانات Stack Overflow في ClickHouse.

بهذا نختتم دليلنا الأساسي إذا كنت تُرحِّل من Postgres إلى ClickHouse. ونوصي بقراءة [دليل نمذجة البيانات في ClickHouse](/ar/guides/clickhouse/data-modelling/schema-design) للتعرّف أكثر على ميزات ClickHouse المتقدمة.