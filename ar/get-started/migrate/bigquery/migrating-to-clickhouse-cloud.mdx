...
<Image img="/images/migrations/bigquery-2.png" size="md" alt="ClickHouse مقابل BigQuery" />
...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="التحميل المجمّع" />
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="المفاتيح الأساسية في ClickHouse" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="التقسيم" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="الإسقاطات" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="إعادة صياغة استعلامات BigQuery" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="الدوال التجميعية 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="الدوال التجميعية 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="الشروط والمصفوفات" />
