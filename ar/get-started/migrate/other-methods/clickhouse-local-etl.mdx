...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="ترحيل ClickHouse مُدار ذاتيًا" />
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="ترحيل ClickHouse المُدار ذاتيًا" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="ترحيل ClickHouse المُدار ذاتيًا" />
