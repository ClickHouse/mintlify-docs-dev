...
<Steps>
  <Step>
    ...
    * سجّل الدخول باستخدام اسم المستخدم وكلمة المرور اللذين أنشأتهما للتو
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="اختر الخطة" border />
    ...
    <Image img="/images/_snippets/createservice1.png" size="md" alt="خدمة ClickHouse جديدة" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="حدود التحجيم" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="مصادر البيانات" border />
    ...
    * ارفع البيانات من عنوان URL للملف
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="اختر مصدر البيانات" border />
    ...
    **فهرساً متفرقاً** يسهل احتواؤه في الذاكرة، وتمثل الحبيبات شريطاً يضم أصغر قدر من بيانات الأعمدة التي تُعالَج خلال استعلامات `SELECT`.
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="تفاصيل الاتصال بـ ClickHouse client" border />
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="صفوف جديدة من ملف CSV" />
