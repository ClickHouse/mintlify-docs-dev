...
<div className="installContainer">
  <a href="/ar/install/quick-install" style={{textDecoration: 'none'}}>
    <Card title="التثبيت السريع" />
  </a>

  <a href="/ar/install/clickhousectl" style={{textDecoration: 'none'}}>
    <Card title="clickhousectl (CLI)" icon="console" />
  </a>

  <a href="/ar/install/docker" style={{textDecoration: 'none'}}>
    <Card title="Docker" />
  </a>

  <a href="/ar/install/advanced" style={{textDecoration: 'none'}}>
...
<div className="installContainer">
  <a href="/ar/install/debian_ubuntu" style={{textDecoration: 'none'}}>
    <Card title="Debian/Ubuntu" />
  </a>

  <a href="/ar/install/redhat" style={{textDecoration: 'none'}}>
    <Card title="Redhat" />
  </a>

  <a href="/ar/install/nixos" style={{textDecoration: 'none'}}>
    <Card title="NixOS" />
  </a>

  <a href="/ar/install/linux_other" style={{textDecoration: 'none'}}>
