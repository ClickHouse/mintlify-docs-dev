...
<Image img="/images/use-cases/rta-considerations.png" alt="التحليلات في الوقت الفعلي: الوقت اللازم لاستيعاب البيانات وتحويلها والاستعلام عنها" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="كيف يُمكّن ClickHouse التحليلات في الوقت الفعلي" />
  </div>
