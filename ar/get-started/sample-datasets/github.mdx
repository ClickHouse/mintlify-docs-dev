...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="بالنسبة إلى الأسطر المضافة والمحذوفة" size="md" />

**بالنسبة إلى عمليات commit والمؤلفين:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="بالنسبة إلى عمليات commit والمؤلفين" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="مصفوفة المؤلفين في Superset" size="md" />

من الواضح أن Alexey يميل إلى إزالة شيفرة الآخرين. لنستبعده للحصول على عرض أكثر توازنًا لعمليات إزالة الشيفرة.

<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="مصفوفة المؤلفين في Superset الإصدار 2" size="md" />
