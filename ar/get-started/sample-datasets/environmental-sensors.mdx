...
<Image img="/images/getting-started/example-datasets/sensors_01.png" size="md" alt="عدد الأحداث يوميًا" />
...
<Image img="/images/getting-started/example-datasets/sensors_02.png" size="md" alt="أيام حارة ورطبة" />