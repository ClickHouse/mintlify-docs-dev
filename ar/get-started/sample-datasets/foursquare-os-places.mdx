...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="خريطة كثافة لنقاط الاهتمام في أوروبا" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="حانات الساكي في اليابان" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="أجهزة الصراف الآلي" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="خريطة لأوروبا مع نقاط اهتمام مصنّفة حسب البلد" />