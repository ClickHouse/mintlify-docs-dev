    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="منصة مفتوحة المصدر لهندسة نماذج اللغة الكبيرة من أجل observability والمقاييس والتقييمات وإدارة الموجّهات." href="https://langfuse.com/docs" showArrow />
