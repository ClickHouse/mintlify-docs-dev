  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <h1 className="block text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
        ابدأ مع <HighlightedClickHouse />
      </h1>

      <div className="mx-auto px-4 -mt-5 text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
        وثائق أسرع قاعدة بيانات تحليلية
      </div>

      <div className="flex items-center justify-center gap-3 mx-auto mt-8">
        <button type="button" id="home-search-entry" className="flex pointer-events-auto items-center text-sm leading-6 h-9 pl-3.5 pr-3 text-gray-500 dark:text-white/50 dark:brightness-[1.1] dark:hover:brightness-[1.25] justify-between truncate gap-2 min-w-[43px] w-[320px] bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 shadow-none border border-white/10 ring-0 dark:ring-0 rounded" aria-label="فتح البحث">
          <div className="flex items-center gap-2 min-w-[42px]"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-search min-w-4 flex-none text-gray-700 hover:text-gray-800 dark:text-gray-400 hover:dark:text-gray-200"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg><div className="truncate min-w-0">ابحث...</div></div>
          <span className="flex-none text-xs font-semibold">⌘K</span>
        </button>

        <button type="button" className="flex-none hidden lg:flex items-center justify-center gap-1.5 pl-3 pr-3.5 h-9 shadow-none bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 border border-white/10 rounded" id="home-assistant-entry" aria-label="فتح «اسأل الذكاء الاصطناعي»" onClick={() => {
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        <HeroCard
          title="البدء"
          description="أنا جديد هنا، وأريد البدء والتعرّف على المزيد"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "ما هو ClickHouse؟", href: "/get-started/about/intro" },
        { label: "التثبيت", href: "/get-started/setup/cloud" },
        { label: "Quickstarts", href: "/get-started/quickstarts/home" },
        { label: "مفاهيم ClickHouse", href: "/concepts/core-concepts/index" },
        { label: "مجموعات البيانات التجريبية", href: "/get-started/sample-datasets/index" },
        { label: "أدلة الترحيل", href: "/get-started/migrate/overview" },
        { label: "أفضل الممارسات", href: "/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "نمذجة البيانات", href: "/guides/clickhouse/data-modelling/schema-design" },
        { label: "تحسين الأداء", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/products/cloud/guides" },
        { label: "حالات الاستخدام", href: "/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "مرجع SQL", href: "/reference/statements" },
        { label: "الإعدادات", href: "/reference/settings/index" },
        { label: "الدوال", href: "/reference/functions/regular-functions/overview" },
        { label: "المحركات", href: "/reference/engines/engines" },
        { label: "جداول النظام", href: "/reference/system-tables" },
        { label: "التنسيقات", href: "/reference/formats/index" },
        { label: "أنواع البيانات", href: "/reference/data-types/index" }
    ]}
        />

        <HeroCard
          title="حلولنا"
          description="أرغب في استكشاف حلول ClickHouse"
          icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
        ...
        { label: "مشغّل Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">اكتشف كيف يُشغّل ClickHouse التحليلات الفورية، والرصد الشامل للأنظمة، وتخزين البيانات، والذكاء الاصطناعي الوكيل على أي نطاق.</p>

      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="التحليلات في الوقت الفعلي" description="قدّم رؤى ولوحات معلومات فورية على نطاق واسع. حلّل مليارات الصفوف في الوقت الفعلي بنتائج في أجزاء من الألف من الثانية." href="/ar/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observability" description="خزّن السجلات والمقاييس والتتبعات واستعلم عنها على نطاق واسع باستخدام ClickStack، حزمة Observability مفتوحة المصدر والمدعومة بـ ClickHouse." href="/ar/clickstack/overview" showArrow />

        <HeroCard title="مستودعات البيانات" description="حلّل البيانات واستكشفها فورًا للحصول على رؤى وبناء التطبيقات. وسّع نطاق عملك بسرعة أكبر عبر نقل أعباء العمل الثقيلة." href="/ar/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="تحليلات الوكلاء" description="أتِح لوكلاء الذكاء الاصطناعي الاستعلام مباشرةً عن بياناتك في الوقت الفعلي لتقديم رؤى وتصورات فورية بأسلوب حواري" href="/ar/get-started/use-cases/agentic-analytics" showArrow />
      </div>

      <FullWidthDivider style={{ margin: '40px 0 40px' }} />

      <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">استكشف حسب المنتج</h2>
      <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">تصفّح منتجات ClickHouse وتكاملاتها، من خدمة Cloud المُدارة إلى مشاريع المصدر المفتوح.</p>

      <div className="space-y-4 mt-6">
        {/* الصف 1: ClickHouse Cloud ‏(col-span-2) + 3 بطاقات متراصة ‏(col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              href="/ar/products/cloud/getting-started/intro"
              extraClassName="h-full"
              body={<>
              <p className="text-[#6b7280] dark:text-[#a1a1aa] mt-2 text-sm leading-[1.6]">
                  يوضح هذا القسم كيف يجعل ClickHouse مستودعات البيانات سريعة وبسيطة ويمكن التنبؤ بها. فبدلًا من التعامل مع مسارات بيانات هشة ومحركات استعلام بطيئة، يمكنك توحيد بيانات تطبيقاتك وخدماتك وأدواتك في غضون دقائق لا أسابيع. وبعد ذلك، يمكنك تشغيل لوحات معلومات آنية، وإطلاق التنبيهات، وتحليل الاتجاهات التاريخية، وبناء منتجات مدفوعة بالأحداث على المنصة نفسها.
              </p>
          </>}
              links={[
              { label: "كيفية إدخال البيانات من المصادر الشائعة بأقل قدر من الجهد", href: "/integrations" },
              { label: "أفضل الممارسات لتنظيم البيانات من أجل التحليلات والنمو", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "طرق الاستعلام عن مجموعات البيانات الكبيرة في الوقت الفعلي", href: "/get-started/use-cases/real-time-analytics" },
              { label: "كيفية بناء لوحات معلومات وتنبيهات وميزات مدفوعة بالأحداث اعتمادًا عليها", href: "/get-started/use-cases/data-warehousing" },
              { label: "نصائح للحفاظ على انخفاض التكاليف مع بقاء الأداء مرتفعًا", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="حزمة observability متكاملة All in one ومدعومة من ClickHouse، تمنحك استعلامات فائقة السرعة وعمليات aggregation قوية على السجلات والمقاييس وtraces وإعادة تشغيل الجلسات والأخطاء." href="/ar/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="خدمة Postgres سريعة وقابلة للتوسع وعلى مستوى المؤسسات، ومتكاملة أصلاً مع ClickHouse. يمكنك بسهولة الجمع بين Postgres للمعاملات وClickHouse للتحليلات." href="/ar/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard logo="logo-integration.svg" logoInvert title="Integrations" description="أكثر من 100 تكامل لربط الأدوات والخدمات التي تفضلها مع ClickHouse." href="/ar/integrations/home" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="منصة مفتوحة المصدر لهندسة نماذج اللغة الكبيرة من أجل observability والمقاييس والتقييمات وإدارة الموجّهات." href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.png" title="مشغّل Kubernetes" description="يؤتمت نشر مجموعات ClickHouse وClickHouse Keeper على Kubernetes وتهيئتها وإدارتها." href="/ar/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="قاعدة بيانات سريعة وموثوقة وقابلة للتوسع تعمل ضمن العملية. اختبر قوة ClickHouse ضمن العملية." href="/ar/products/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">استعلم عن وثائق ClickHouse مباشرةً من أدوات الذكاء الاصطناعي باستخدام بروتوكول Model Context Protocol.</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">أضِف مهارات ClickHouse إلى وكيلك البرمجي</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">ثبّت مهارات ClickHouse لتزويد وكيلك بخبرة متخصصة في ClickHouse وأفضل الممارسات.</p>
