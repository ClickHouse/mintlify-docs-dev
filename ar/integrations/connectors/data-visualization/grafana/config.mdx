...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="مثال على تهيئة آمنة للبروتوكول الأصلي" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="خيارات إعداد HTTP إضافية" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="مثال لإعدادات إضافية" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="إعداد السجلات" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="إعداد التتبعات" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="مثال على إعداد جدول الأسماء المستعارة" border />

سيعرض Grafana الآن نتائج جدول الأسماء المستعارة بدلًا من النتائج الناتجة عن `DESC example_table`:

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="مثال على استعلام جدول الأسماء المستعارة" border />
