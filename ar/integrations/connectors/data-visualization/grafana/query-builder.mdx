...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_table_query.png" alt="مثال على استعلام جدول تجميعي" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="مثال على استعلام سجلات OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="مثال على الحقول الإضافية في استعلام السجلات" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="مثال على استعلام سلاسل زمنية" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="مثال على استعلام تتبّع OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="مثال على استعلام SQL خام" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="روابط trace في جدول" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  مثال على روابط trace في logs

  <Image size="md" img="/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="روابط trace في logs" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/images/integrations/data-visualization/grafana/demo_data_links.png" alt="مثال على استخدام روابط البيانات للربط" border />
</div>
