...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="لوحة معلومات في Splunk تعرض تصورات لبيانات سيارات الأجرة في مدينة نيويورك" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="صفحة إعدادات Splunk DB Connect التي تعرض إعداد Java Home" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="صفحة برامج التشغيل في Splunk DB Connect تعرض تثبيت برنامج تشغيل ClickHouse بنجاح" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="زر اتصال جديد في Splunk DB Connect" />

<br />

أضف بيانات مضيف ClickHouse، وتأكد من تحديد &quot;Enable SSL&quot;:

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="صفحة إعداد اتصال Splunk لـ ClickHouse" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="يحدِّد SQL Explorer في Splunk اتصالًا بـ ClickHouse" />

نفِّذ استعلام SQL على جدول `trips` لإرجاع عدد جميع السجلات في الجدول:

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="تنفيذ استعلام SQL في Splunk لعرض عدد السجلات في جدول trips" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="تصور لمخطط أعمدة في Splunk يعرض أفضل 10 أحياء لالتقاط الركاب" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="مخطط أعمدة في Splunk يُظهر متوسط الأجرة حسب عدد الركاب" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="لوحة معلومات Splunk النهائية مع تصورات متعددة لبيانات سيارات الأجرة في نيويورك" />
