...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="تهيئة اتصال ClickHouse في Dot (الوضع الفاتح)" border />
...
3. أدخل تفاصيل الاتصال:
   ...
   * **Port**: `8443` (HTTPS لـ ClickHouse Cloud) أو `8123` (HTTP للاستضافة الذاتية)
   * **Username / Password**: مستخدم لديه صلاحية قراءة
   * **Database**: يمكن اختياريًا تعيين schema افتراضي
4. انقر على **Connect**.

<Image img="/images/integrations/data-visualization/dot_02.png" alt="الاتصال بـ ClickHouse" size="sm" />
