...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="واجهة مستكشف بيانات Hashboard تعرض أداة إنشاء استعلامات تفاعلية وتصورًا" border />
