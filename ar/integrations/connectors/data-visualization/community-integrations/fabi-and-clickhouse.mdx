...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="منصة Fabi.ai لاستكشاف البيانات وسير العمل" border />
...
1. سيُطلب منك ربط قاعدة البيانات عند إنشاء حسابك لأول مرة. وإذا كان لديك حساب بالفعل، فانقر على لوحة مصدر البيانات على يسار أي Smartbook، ثم اختر إضافة مصدر بيانات.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="إضافة مصدر بيانات" border />

2. سيُطلب منك بعد ذلك إدخال تفاصيل الاتصال.

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="نموذج بيانات اعتماد ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="الاستعلام في ClickHouse" border />
