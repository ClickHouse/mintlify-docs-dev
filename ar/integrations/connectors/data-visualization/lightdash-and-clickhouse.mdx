...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="مثال على لوحة معلومات في Lightdash" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="مثال على إعداد profiles.yml لمشروع lightdash-clickhouse" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="مثال على تعريف المقاييس في ملف .yml" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="عرض Explore في Lightdash يوضّح الأبعاد، وعوامل التصفية، والمخطط، والنتائج، وSQL" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="إنشاء المخططات وتنظيمها داخل لوحة معلومات في Lightdash" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="واجهة Ask AI في Lightdash تعرض استعلامًا بلغة طبيعية مدعومًا بمقاييس dbt" border />
