...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_install.png" alt="معالج تثبيت برنامج تشغيل ClickHouse ODBC يعرض خيارات التثبيت" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.png" alt="بحث Windows يُظهر خيار ODBC Data Sources (64-bit)" border />

<br />

تأكد من أن ClickHouse Driver مدرج في القائمة.

<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_verify.png" alt="تعرض ODBC Data Source Administrator برامج تشغيل ClickHouse في علامة التبويب Drivers" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="شاشة البدء في Power BI Desktop تعرض زر Get Data" border />

<br />

ابحث عن &quot;ClickHouse&quot;

<Image size="md" img="/images/integrations/data-visualization/powerbi_search_clickhouse.png" alt="مربع الحوار Get Data في Power BI مع البحث عن ClickHouse في شريط البحث" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_db.png" alt="مربع حوار اتصال ClickHouse يعرض حقول المضيف والمنفذ وقاعدة البيانات ووضع الاتصال" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_user.png" alt="مربع حوار بيانات اعتماد اتصال ClickHouse لاسم المستخدم وكلمة المرور" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="عرض Navigator في Power BI يُظهر جداول قاعدة بيانات ClickHouse وبيانات عيّنة" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_add_dsn.png" alt="ODBC Data Source Administrator مع تمييز زر Add لإنشاء DSN جديد" border />

<br />

اختر إصدار Unicode من برنامج تشغيل ODBC.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_unicode.png" alt="مربع حوار Create New Data Source يُظهر تحديد ClickHouse Unicode Driver" border />

<br />

أدخل تفاصيل الاتصال.

<Image size="sm" img="/images/integrations/data-visualization/powerbi_connection_details.png" alt="مربع حوار تهيئة ClickHouse ODBC Driver مع معلمات الاتصال" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="شاشة الصفحة الرئيسية في Power BI Desktop تعرض زر Get Data" border />

<br />

اختر &quot;Other&quot; -&gt; &quot;ODBC&quot;.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_odbc.png" alt="مربع حوار Get Data في Power BI مع تحديد خيار ODBC ضمن فئة Other" border />

<br />

اختر مصدر البيانات الذي أنشأته سابقًا من القائمة.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_dsn.png" alt="مربع حوار اختيار برنامج تشغيل ODBC يعرض ClickHouse DSN الذي تم إعداده" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_dsn_credentials.png" alt="مربع حوار بيانات الاعتماد لاتصال ODBC DSN" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="عرض Navigator في Power BI يعرض جداول قاعدة بيانات ClickHouse وبيانات sample" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_16.png" alt="محرر Power Query يعرض تحويل نوع البيانات لعمود UInt64" border />
