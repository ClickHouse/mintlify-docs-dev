...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="واجهة Tableau Online تعرض زر 'New' لإنشاء مصدر بيانات منشور" border />

<br />

حدّد &quot;MySQL&quot; من قائمة الموصلات المتاحة.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="شاشة اختيار الموصلات في Tableau Online مع تمييز خيار MySQL" border />

<br />

أدخِل تفاصيل الاتصال التي جمعتها أثناء إعداد ClickHouse.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="شاشة إعداد اتصال MySQL في Tableau Online مع حقول الخادم والمنفذ وقاعدة البيانات وبيانات الاعتماد" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="صفحة مصدر البيانات في Tableau Online تعرض جداول قاعدة البيانات على اليسار ومساحة العمل على اليمين مع وظيفة السحب والإفلات" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="واجهة Tableau Desktop تعرض قائمة Connect مع تمييز خيار MySQL" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="مربع حوار اتصال MySQL في Tableau Desktop مع تمكين خيار SSL ووجود حقول للخادم واسم المستخدم وكلمة المرور والشهادة" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Tableau Desktop يعرض قائمة Server مع تمييز خيار Publish Data Source" border />

<br />

مهم: تحتاج إلى اختيار &quot;Embedded password&quot; ضمن خيارات &quot;Authentication&quot;.

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="مربع حوار النشر في Tableau Desktop يعرض خيارات Authentication مع تحديد Embedded password" border />

<br />

بالإضافة إلى ذلك، اختر &quot;Update workbook to use the published data source&quot;.

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="مربع حوار النشر في Tableau Desktop مع تحديد خيار 'Update workbook to use the published data source'" border />
