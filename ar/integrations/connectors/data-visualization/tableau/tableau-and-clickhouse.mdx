...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="شاشة الاتصال في Tableau تعرض قائمة اختيار الموصّل مع تمييز خيار ClickHouse by ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="نافذة تثبيت موصّل Tableau تعرض تفاصيل موصّل ClickHouse JDBC وزر التثبيت" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="نافذة اتصال ClickHouse في Tableau تعرض حقول الخادم والمنفذ وقاعدة البيانات واسم المستخدم وكلمة المرور" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="مصنف Tableau جديد يعرض شاشة الاتصال الأولية مع خيارات اختيار قاعدة البيانات" border />

<br />

8. اختر **TPCD** من القائمة المنسدلة **Schema** ويُفترض أن ترى قائمة الجداول في **TPCD**:

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="اختيار المخطط في Tableau يعرض جداول قاعدة بيانات TPCD بما في ذلك CUSTOMER وLINEITEM وNATION وORDERS وغيرها" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="مصنف Tableau مع سحب جدول CUSTOMER إلى اللوحة وعرض رؤوس الأعمدة من دون بيانات" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="محرر العلاقات في Tableau يعرض الربط بين جدولي CUSTOMER وORDERS باستخدام الحقل Custkey" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="ورقة عمل Tableau تعرض الأبعاد والمقاييس من جداول ClickHouse المتاحة للتحليل" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="مخطط خطي في Tableau يعرض الكمية المطلوبة حسب السنة من بيانات ClickHouse" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="عرض جدولي متقاطع في Tableau مع الأرباع السنوية كأعمدة ووسائل الشحن كصفوف" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="جدول متقاطع في Tableau يعرض مجموع السعر الإجمالي حسب الربع السنوي ووسيلة الشحن" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="جدول متقاطع في Tableau يعرض متوسط سعر الطلب حسب الربع السنوي ووسيلة الشحن مع تنسيق العملة" border />
