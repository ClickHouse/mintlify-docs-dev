...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="حاوية النسخة المتماثلة الأولى في Google Cloud Storage تُظهر بنية المجلدات مع أقسام البيانات" />

<div id="bucket-for-replica-two">
  #### حاوية النسخة المتماثلة الثانية
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="حاوية النسخة المتماثلة الثانية في Google Cloud Storage تُظهر بنية المجلدات مع تقسيمات البيانات" />