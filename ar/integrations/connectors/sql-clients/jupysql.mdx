...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="مُدرَّج تكراري يوضح توزيع مسافات الرحلات ضمن 10 فئات من مجموعة بيانات الرحلات القصيرة" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="مُدرَّج تكراري يوضح توزيع مسافات الرحلات باستخدام 50 فئة مع شبكة، بعنوان 'Trip distance from trips < 6.3'" border />