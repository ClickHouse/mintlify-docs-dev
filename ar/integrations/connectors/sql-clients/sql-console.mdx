...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="lg" border alt="عرض قائمة الجداول والمخطط الذي يُظهر جداول قاعدة البيانات في الشريط الجانبي الأيسر" />

يمكن أيضًا توسيع الجداول في القائمة لعرض الأعمدة وأنواع البيانات

<Image img="/images/cloud/sqlconsole/view-columns.png" size="lg" border alt="عرض جدول موسَّع يُظهر أسماء الأعمدة وأنواع البيانات" />
...
<Image img="/images/cloud/sqlconsole/abc.png" size="lg" border alt="عرض Table View يوضّح بيانات يمكن تحديدها ونسخها" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="lg" border alt="مربع حوار Cell Inspector يعرض محتوى خلية محددة" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="lg" border alt="مربع حوار الفرز يعرض إعدادات الفرز التنازلي على أحد الأعمدة" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="lg" border alt="مربع حوار التصفية يعرض إعدادًا لتصفية عمود radio بحيث يساوي GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="lg" border alt="مربع حوار يوضح كيفية إضافة عامل تصفية إضافي إلى نطاق أكبر من 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="lg" border alt="واجهة تُظهر تطبيق التصفية والفرز معًا" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="lg" border alt="واجهة تعرض زر Create Query الذي يُنشئ SQL من عوامل التصفية وخيارات الفرز" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="lg" border alt="واجهة توضّح كيفية إنشاء استعلام جديد باستخدام زر + أو زر New Query" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="lg" border alt="واجهة توضّح كيفية تشغيل جزء محدد من استعلام SQL" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="lg" border alt="خيار التشغيل عند المؤشر في قائمة خيارات التشغيل الموسعة" />

* اختر &#39;Run at cursor&#39; من القائمة السياقية في SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="lg" border alt="خيار التشغيل عند المؤشر في القائمة السياقية لـ SQL Editor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="lg" border alt="زر Cancel الذي يظهر أثناء تنفيذ الاستعلام" />
...
<Image img="/images/cloud/sqlconsole/give-a-query-a-name.png" size="lg" border alt="واجهة توضّح كيفية إعادة تسمية استعلام من Untitled Query" />

يمكنك أيضًا استخدام زر الحفظ أو اختصار لوحة المفاتيح `cmd / ctrl + s` لحفظ الاستعلام.

<Image img="/images/cloud/sqlconsole/save-the-query.png" size="lg" border alt="زر الحفظ في شريط أدوات محرر الاستعلام" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="lg" border alt="البحث في بيانات Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="lg" border alt="مطابقة في المتن" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="lg" border alt="خيارات ترقيم الصفحات" />

سيؤدي تحديد حجم الصفحة إلى تطبيق ترقيم الصفحات فورًا على مجموعة النتائج، وستظهر خيارات التنقل في منتصف تذييل جزء النتائج

<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="lg" border alt="التنقل بين الصفحات" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="lg" border alt="تنزيل بتنسيق CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="lg" border alt="نتائج الاستعلام الجدولية" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="lg" border alt="التبديل من الاستعلام إلى المخطط" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="lg" border alt="إجمالي الرحلات حسب الأسبوع" />

تدعم معظم أنواع المخططات إضافة عدة حقول إلى المحاور الرقمية. وللتوضيح، سنسحب الحقل `fare_total` إلى المحور الصادي:

<Image img="/images/cloud/sqlconsole/bar-chart.png" size="lg" border alt="مخطط شريطي" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="lg" border alt="التغيير من مخطط أعمدة إلى مخطط مساحي" />

تتوافق عناوين المخططات مع اسم الاستعلام الذي يوفّر البيانات. وسيؤدي تحديث اسم الاستعلام إلى تحديث عنوان المخطط أيضًا:

<Image img="/images/cloud/sqlconsole/update-query-name.png" size="lg" border alt="تحديث اسم الاستعلام" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="lg" border alt="تحديث العنوان الفرعي وما إلى ذلك." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="lg" border alt="ضبط مقياس المحور" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="lg" border alt="زر Share في شريط أدوات الاستعلام" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="lg" border alt="مربع حوار لتحرير الوصول إلى استعلام مشترك" />

<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="lg" border alt="واجهة لإضافة فريق إلى استعلام مشترك" />

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="lg" border alt="واجهة لتحرير وصول أحد الأعضاء إلى استعلام مشترك" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="lg" border alt="قسم Shared with me في قائمة الاستعلامات" />