...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="واجهة مدير برامج التشغيل في DbVisualizer تعرض إعداد ClickHouse برنامج تشغيل JDBC" />
