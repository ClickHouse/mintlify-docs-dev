...
<Image img="/images/integrations/sql-clients/dbeaver-add-database.png" size="md" border alt="إضافة قاعدة بيانات جديدة" />

* حدِّد **Analytical** ثم **ClickHouse**:

* أنشئ **JDBC URL**. في علامة التبويب **Main**، اضبط **Host** و**Port** و**Username** و**Password** و**Database**:

<Image img="/images/integrations/sql-clients/dbeaver-host-port.png" size="md" border alt="تعيين اسم المضيف والمنفذ والمستخدم وكلمة المرور واسم قاعدة البيانات" />
...
<Image img="/images/integrations/sql-clients/dbeaver-use-ssl.png" size="md" border alt="فعّل SSL إذا لزم الأمر" />

* اختبر الاتصال:

<Image img="/images/integrations/sql-clients/dbeaver-test-connection.png" size="md" border alt="اختبر الاتصال" />

إذا اكتشف DBeaver أن برنامج تشغيل ClickHouse غير مثبّت لديك، فسيعرض عليك تنزيله:

<Image img="/images/integrations/sql-clients/dbeaver-download-driver.png" size="md" border alt="تنزيل برنامج تشغيل ClickHouse" />
...
<Image img="/images/integrations/sql-clients/dbeaver-sql-editor.png" size="md" border alt="افتح محرر SQL" />

* مثال على استعلام لـ `system.query_log`:

<Image img="/images/integrations/sql-clients/dbeaver-query-log-select.png" size="md" border alt="استعلام نموذجي" />
