...
<Image img="/images/integrations/data-ingestion/s3/s3-j.png" size="lg" border alt="عرض حاوية S3 في وحدة تحكم AWS يوضح ملفات بيانات ClickHouse المخزنة في S3" />
...
<Image img="/images/integrations/data-ingestion/s3/bucket1.png" size="lg" border alt="حجم البيانات في حاوية S3 الأولى مع إظهار مقاييس استخدام التخزين" />

<Image img="/images/integrations/data-ingestion/s3/bucket2.png" size="lg" border alt="حجم البيانات في حاوية S3 الثانية مع إظهار مقاييس استخدام التخزين" />
