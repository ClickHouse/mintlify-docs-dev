...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="إعدادات اتصالات Glue Notebook" force="true" />
  ...
  <Tab title="التثبيت اليدوي">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="خيارات مسار JAR في Glue Notebook" force="true" />
  </Tab>
</Tabs>
