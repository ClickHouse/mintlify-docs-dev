...
<Image img="/images/integrations/data-ingestion/s3/insert_mechanics.png" size="lg" border alt="آلية حجم كتلة الإدراج في ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/pull.png" size="lg" border alt="سحب البيانات من المصادر الخارجية في ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/merges.png" size="lg" border alt="عمليات الدمج في الخلفية في ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/resource_usage.png" size="lg" border alt="استخدام الموارد لتوازي الإدراج" />
...
<Image img="/images/integrations/data-ingestion/s3/insert_threads.png" size="lg" border alt="خيوط الإدراج المتوازية في ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/hardware_size.png" size="lg" border alt="تأثير حجم الموارد العتادية على أداء ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/s3Cluster.png" size="lg" border alt="الدالة s3Cluster في ClickHouse" />
