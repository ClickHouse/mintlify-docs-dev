...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="ضبط إعدادات Spark عبر دفتر الملاحظات" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="التحقق من إعدادات ClickHouse باستخدام Spark UI" border />
