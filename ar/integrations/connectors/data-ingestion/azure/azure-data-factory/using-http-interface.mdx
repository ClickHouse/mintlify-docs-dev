...
1. سجّل الدخول إلى [Microsoft Azure Portal](https://portal.azure.com/) وانقر على
   **إنشاء مورد**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-page.png" size="lg" alt="الصفحة الرئيسية لـ Azure Portal" border />

2. في جزء الفئات على اليسار، حدّد **التحليلات**، ثم انقر على
   **Data Factory** ضمن قائمة الخدمات الشائعة.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-resource-analytics.png" size="lg" alt="مورد جديد في Azure Portal" border />

3. حدّد اشتراكك ومجموعة الموارد، وأدخل اسمًا لمثيل Data
   Factory الجديد، واختر المنطقة، واترك الإصدار على V2.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory.png" size="lg" alt="Data Factory جديد في Azure Portal" border />

4. انقر على **مراجعة + إنشاء**، ثم انقر على **إنشاء** لبدء عملية النشر.

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-confirm.png" size="lg" alt="تأكيد Data Factory جديد في Azure Portal" border />

   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-new-data-factory-success.png" size="lg" alt="نجاح إنشاء Data Factory جديد في Azure Portal" border />
...
1. سجّل الدخول إلى Microsoft Azure Portal وافتح مثيل Data Factory الخاص بك.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.png" size="lg" alt="الصفحة الرئيسية لـ Azure Portal مع Data Factory" border />

2. في صفحة **Overview** الخاصة بـ Data Factory، انقر على **Launch Studio**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-factory-page.png" size="lg" alt="صفحة Azure Portal Data Factory" border />

3. من القائمة اليمنى، اختر **Manage**، ثم انتقل إلى **Linked services**،
   وانقر على **+ New** لإنشاء خدمة مرتبطة جديدة.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.png" size="lg" alt="زر Azure Data Factory New Linked Service" border />
...
4. في **شريط البحث New linked service**، اكتب **REST**، ثم اختر **REST**، وانقر على **Continue**
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.png" size="lg" alt="بحث Azure Data Factory New Linked Service" border />
...
5. في جزء تكوين الخدمة المرتبطة، أدخل اسمًا لخدمتك الجديدة،
   ...
   إلا عند تحديد الحقل).
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-lined-service-pane.png" size="lg" alt="جزء New Lined Service" border />
...
6. في جزء المحتوى الديناميكي، يمكنك إنشاء عنوان URL مُعلَّم بالمعلمات، ما
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.png" size="lg" alt="عنوان URL الأساسي الفارغ لـ New Linked Service" border />
...
7. انقر على **&quot;+&quot;** بجانب حقل التصفية وأضف parameter جديدًا، وسمّه
   ...
   ثم انقر على **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.png" size="lg" alt="Parameters الخاصة بـ New Linked Service" border />
...
8. في حقل expression، أدخل ما يلي ثم انقر على **OK**. استبدل
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.png" size="lg" alt="حقل Expression الممتلئ لـ New Linked Service" border />
...
9. بالعودة إلى النموذج الرئيسي، اختر Basic authentication، ثم أدخل username و
   ...
   نجاح.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-check-connection.png" size="lg" alt="فحص الاتصال لـ New Linked Service" border />

10. انقر على **Create** لإكمال الإعداد.
    <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-linked-services-list.png" size="lg" alt="قائمة Linked Services" border />
...
2. في Azure Data Factory Studio، حدِّد Author في الجزء الأيسر. مرِّر المؤشر
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-item.png" size="lg" alt="عنصر مجموعة بيانات جديدة" border />
...
3. في شريط البحث، اكتب **REST**، وحدِّد **REST**، ثم انقر **Continue**.
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-page.png" size="lg" alt="صفحة مجموعة بيانات جديدة" border />
...
4. ينبغي أن ترى الآن مجموعة البيانات التي أنشأتها حديثًا مُدرجة ضمن قسم Datasets
   ...
   content.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-properties.png" size="lg" alt="خصائص مجموعة بيانات جديدة" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-query.png" size="xl" alt="استعلام مجموعة بيانات جديدة" border />
...
6. انقر **OK** لحفظ التعبير. ثم انقر **Test connection**. إذا كان كل شيء
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-connection-successful.png" size="xl" alt="نجاح اتصال مجموعة البيانات الجديدة" border />
...
1. افتح **Azure Data Factory Studio**، ثم انتقل إلى **تبويب Author**. في جزء
   **Factory Resources**، مرّر المؤشر فوق **Pipeline**، وانقر على
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-pipeline-item.png" size="lg" alt="عنصر مسار معالجة جديد في ADF" border />

2. في جزء **Activities**، وسّع قسم **Move and transform**، ثم
   اسحب نشاط **Copy data** إلى اللوحة.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-copy-data-item.png" size="lg" alt="عنصر Copy Data جديد" border />

3. حدّد **تبويب Source**، ثم اختر مجموعة البيانات المصدر التي أنشأتها سابقًا.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-source.png" size="lg" alt="مصدر Copy Data" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-sink-select-post.png" size="lg" alt="اختيار POST لمصب Copy Data" border />
...
5. انقر على **Debug** أعلى اللوحة لتشغيل المسار. بعد انتظار قصير،
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-copy-data-debug-success.png" size="lg" alt="نجاح Debug في Copy Data" border />
