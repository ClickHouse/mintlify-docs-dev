...
2. من القائمة الموجودة على الجانب الأيسر، حدِّد **مفاتيح الوصول** ضمن قسم **الأمان +
   الشبكات**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="إعدادات مخزن بيانات Azure" border />

3. اختر **key1** أو **key2**، ثم انقر فوق الزر **إظهار** بجوار
   حقل **سلسلة الاتصال**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="مفاتيح الوصول إلى مخزن بيانات Azure" border />
