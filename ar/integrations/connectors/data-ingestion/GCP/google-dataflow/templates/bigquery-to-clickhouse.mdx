...
<Tabs>
  <Tab title="Google Cloud Console">
    ...
    1. اضغط على الزر `CREATE JOB FROM TEMPLATE`
       <Image img="/images/integrations/data-ingestion/google-dataflow/create_job_from_template_button.png" border alt="وحدة تحكم DataFlow" />
    2. بعد فتح نموذج قالب، أدخل اسم المهمة وحدد المنطقة المطلوبة.
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_initial_form.png" border alt="النموذج الأولي لـ DataFlow قالب" />
    3. في حقل `DataFlow Template`، اكتب `ClickHouse` أو `BigQuery`، ثم اختر قالب ‏`BigQuery to ClickHouse`
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_clickhouse_search.png" border alt="اختر قالب ‏BigQuery to ClickHouse" />
    ...
    <Image img="/images/integrations/data-ingestion/google-dataflow/extended_template_form.png" border alt="نموذج القالب الموسّع لـ BigQuery إلى ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/google-dataflow/dataflow-inqueue-job.png" size="lg" border alt="واجهة Dataflow تعرض مهمة قيد التشغيل لنقل البيانات من BigQuery إلى ClickHouse" />
