...
<Image img="/images/integrations/data-ingestion/google-dataflow/pubsub-inqueue-job.png" size="lg" border alt="واجهة Dataflow تعرض مهمة Pub/Sub إلى ClickHouse قيد التشغيل" />
