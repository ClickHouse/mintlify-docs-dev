...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_01.png" size="lg" alt="مخطط جداول IMDB" />
...
3. في هذه المرحلة، ستحتاج إلى محرر النصوص الذي تفضله. في الأمثلة أدناه، نستخدم VS Code الشهير. عند فتح دليل IMDB، ينبغي أن ترى مجموعة من ملفات yml وsql:
   ...
   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_02.png" size="lg" alt="مشروع dbt جديد" />

4. حدّث ملف `dbt_project.yml` لتحديد أول model لدينا، وهو `actor_summary`، واضبط profile على `clickhouse_imdb`.

   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_03.png" size="lg" alt="ملف تعريف dbt" />

   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_04.png" size="lg" alt="ملف تعريف dbt" />
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_05.png" size="lg" alt="التحديثات التزايدية في dbt" />
...
قدّم ClickHouse 22.8 [عمليات الحذف خفيفة الوزن](/ar/snippets/delete)، وقدّم ClickHouse 25.7 [عمليات التحديث خفيفة الوزن](/ar/reference/statements/update). ومع إتاحة هذه الميزات، تصبح التعديلات الناتجة عن استعلامات التحديث المفردة فورية من منظور المستخدم، حتى عند تطبيقها ماديًا بشكل غير متزامن.
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_06.png" size="lg" alt="حذف تزايدي خفيف الوزن" />
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_07.png" size="lg" alt="الزيادة التدريجية بأسلوب insert overwrite" />
