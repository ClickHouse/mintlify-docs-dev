...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_01.png" size="lg" border alt="عرض سجلات ClickHouse بتنسيق جدولي" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/vector_02.png" size="lg" border alt="اعرض سجلات ClickHouse المُحلَّلة بتنسيق جدولي" />
