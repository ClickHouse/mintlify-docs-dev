...
1. **[PUSH](#push-data-from-redshift-to-clickhouse)** دفع البيانات إلى ClickHouse باستخدام أداة أو خدمة ETL/ELT من جهة خارجية
...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="إرسال البيانات من Redshift إلى ClickHouse" />
...
لاستخدام هذا الخيار، تحتاج إلى إعداد ClickHouse JDBC Bridge. وClickHouse JDBC Bridge هو تطبيق Java مستقل يتولى اتصال JDBC ويعمل كوسيط بين مثيل ClickHouse ومصادر البيانات. في هذا البرنامج التعليمي، استخدمنا مثيل Redshift مملوءًا مسبقًا بالبيانات مع [قاعدة بيانات نموذجية](https://docs.aws.amazon.com/redshift/latest/dg/c_sampledb.html).
...
<Steps>
  ...
  <Step>
    #### تهيئة مصدر بيانات Redshift الخاص بك
  ...
  <Step>
    ...
    بعد نشر ClickHouse JDBC Bridge وتشغيله، يمكنك البدء في الاستعلام عن مثيل Redshift الخاص بك من ClickHouse
...
<Steps>
  <Step>
    #### تصدير البيانات إلى حاوية S3 باستخدام UNLOAD
