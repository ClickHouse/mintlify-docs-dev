...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="صفحة التسجيل في Artie" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="واجهة Edit Pipeline في Artie" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="بوابة التحليلات" />

شاشات مراقبة مخصّصة لمسار البيانات والجدول

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="المراقبة المدمجة" />

إشعارات يومية بتغييرات المخطط

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="إشعار المخطط" />