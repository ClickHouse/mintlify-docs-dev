...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="واجهة Confluent Cloud تعرض كيفية إنشاء موصل HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="واجهة Confluent Cloud تعرض إعدادات المصادقة لموصل HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="واجهة Confluent Cloud تعرض خيارات التكوين المتقدمة لموصل HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="واجهة Confluent Cloud تعرض كيفية إنشاء رسالة اختبار في topic Kafka" border />
