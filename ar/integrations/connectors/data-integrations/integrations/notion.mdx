...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="اختيار ClickHouse من منتقي Add connection في Notion" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="اتصال ClickHouse الموسّع في Notion مع إظهار مفاتيح التبديل لكل أداة" />
