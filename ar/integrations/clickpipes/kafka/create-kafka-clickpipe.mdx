...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="اختر الواردات" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="اختر نوع مصدر البيانات" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="املأ تفاصيل الاتصال" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="تكوين نفق SSH" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="حدّد الموضوع" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="هيّئ الجدول وبنيته وإعداداته" size="md" />

    يمكنك أيضًا تخصيص الإعدادات المتقدمة باستخدام عناصر التحكم المتاحة

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="هيّئ عناصر التحكم المتقدمة" size="md" />
  </Step>
  ...
  <Step>
    ...
    * `Only destination table`: يمنح أذونات `INSERT` على جدول الوجهة فقط.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="الأذونات" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="عرض النظرة العامة" size="md" />
  </Step>
</Steps>