...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="تمكين PITR في Cloud SQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="زر Edit في GCP MySQL" size="lg" border />

بعد ذلك، مرّر إلى أسفل حتى قسم `Flags` وأضف العلامات المذكورة أعلاه.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="ضبط علامات binlog في GCP" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="إضافة عناوين IP إلى قائمة السماح في GCP MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="تنزيل شهادة GCP MySQL" size="lg" border />

5. في واجهة ClickPipes، حمّل الشهادة التي نزّلتها عند إنشاء MySQL ClickPipe جديد.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="استخدام شهادة GCP MySQL" size="lg" border />