...
بعد ذلك، يجب أن تسمح لـ ClickPipes بالاتصال بـ مثيل Azure Flexible Server for MySQL.
...
<Tabs>
  <Tab title="السماح بعناوين IP الخاصة بـ ClickPipes">
    ...
    3. في قسم **Firewall rules**، أدخِل [قائمة عناوين IP الثابتة الخاصة بـ ClickPipes](/ar/integrations/clickpipes/home#list-of-static-ips) للمنطقة التي نُشرت فيها خدمتك.
       ...
       <Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/azure-flexible-server-mysql/1_configure_network_security.png" alt="تهيئة الشبكة للوصول العام باستخدام قائمة سماح لعناوين IP" size="lg" border />
  ...
  <Tab title="استخدام نفق SSH">
    ...
    1. أنشئ Azure Virtual Machine (VM) وابدأ تشغيله باتباع [الوثائق الرسمية](https://learn.microsoft.com/en-us/azure/virtual-machines/linux/quick-create-portal?tabs=ubuntu).
       * تأكد من أن الجهاز الظاهري موجود في Virtual Network ‏(VNet) نفسها الخاصة بـ مثيل Azure Flexible Server for MySQL، أو في VNet مقترنة مع توفر الاتصال.
    ...
    3. حدِّث قواعد firewall الخاصة بـ مثيل Azure Flexible Server for MySQL للسماح بحركة المرور من [عنوان IP الخاص](https://learn.microsoft.com/en-us/azure/virtual-network/ip-services/private-ip-addresses) لمضيف bastion عبر SSH.
  </Tab>
</Tabs>
...
يمكنك الآن [إنشاء ClickPipe الخاص بك](/ar/integrations/clickpipes/mysql/index) وبدء إدخال البيانات من مثيل Azure Flexible Server for MySQL إلى ClickHouse Cloud. احرص على تدوين تفاصيل الاتصال التي استخدمتها أثناء إعداد المثيل، لأنك ستحتاج إليها خلال عملية إنشاء ClickPipe.