...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="تمكين النسخ الاحتياطية التلقائية في RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="البيانات الوصفية لصفوف binlog إلى FULL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/enable_gtid.png" alt="تم تمكين GTID" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="أين يمكن العثور على مجموعة الأمان في RDS MySQL؟" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="حرّر Inbound rules لمجموعة الأمان المذكورة أعلاه" size="lg" border />
