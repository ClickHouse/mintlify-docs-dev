...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="تمكين النسخ الاحتياطية المؤتمتة في Aurora" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/aurora_config.png" alt="مكان العثور على مجموعة المعلمات في Aurora" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="البيانات الوصفية لصف binlog" size="lg" border />

3. تعيين `binlog_row_image` إلى `FULL`.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="صورة صف binlog" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="أين تجد مجموعة الأمان في Aurora MySQL؟" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="تحرير قواعد الدخول لمجموعة الأمان المذكورة أعلاه" size="lg" border />
