...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="إنشاء إعدادات المزامنة" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="زر تعديل المزامنة" size="md" />

سيؤدي ذلك إلى فتح لوحة جانبية تتضمن إعدادات المزامنة، حيث يمكنك تغيير فاصل المزامنة وحجم دفعة السحب:

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="تعديل إعدادات المزامنة" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="جدول CDC Syncs" size="md" />