...
يوفّر MySQL ClickPipe طريقة مُدارة بالكامل وموثوقة لإدخال البيانات من قواعد بيانات MySQL وMariaDB إلى ClickHouse Cloud. وهو يدعم كلاً من **عملية تحميل مجمّع** للإدخال لمرة واحدة و**التقاط تغيّر البيانات (CDC)** للإدخال المستمر.
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="تحديد MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="املأ تفاصيل الاتصال" size="lg" border />
...
5. هنا يمكنك تحديد قاعدة البيانات الوجهة لـ ClickPipe. يمكنك إما اختيار قاعدة بيانات موجودة أو إنشاء قاعدة بيانات جديدة.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="اختيار قاعدة البيانات الوجهة" size="lg" border />
