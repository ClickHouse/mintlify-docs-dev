...
1. [أوقِف](/ar/integrations/clickpipes/mysql/pause-and-resume) خط الأنابيب مؤقتًا.
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/add_table.png" border size="md" />

5. انقر على update.
6. عند نجاح التحديث، ستكون حالات خط الأنابيب `Setup` ثم `Snapshot` ثم `Running`. ويمكن تتبّع التحميل الأولي للجدول في علامة التبويب **Tables**.
