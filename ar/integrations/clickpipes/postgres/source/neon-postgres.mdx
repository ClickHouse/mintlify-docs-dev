...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enable-replication.png" alt="تمكين النسخ المتماثل المنطقي" border />

انقر على **Enable** لإتمام الإعداد هنا. وبمجرد تمكينه، ينبغي أن تظهر لك رسالة النجاح أدناه.

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-enabled-replication.png" alt="تم تمكين النسخ المتماثل المنطقي" border />
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-ip-allow.png" alt="شاشة السماح لعناوين IP" border />
...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/neon-postgres/neon-conn-details.png" alt="تفاصيل الاتصال" border />
