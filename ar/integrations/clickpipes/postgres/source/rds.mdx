...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="أين تجد مجموعات المعلمات في RDS؟" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="تعديل RDS Postgres باستخدام مجموعة المعلمات الجديدة" size="lg" border />

3. أعد تشغيل مثيل RDS لديك لتطبيق التغييرات

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="إعادة تشغيل RDS Postgres" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="أين يمكن العثور على مجموعة الأمان في RDS Postgres؟" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="تعديل قواعد الإدخال لمجموعة الأمان المذكورة أعلاه" size="lg" border />
