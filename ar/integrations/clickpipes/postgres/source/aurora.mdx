...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="مكان العثور على مجموعات المعلمات في Aurora" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/change_rds_logical_replication.png" alt="تغيير rds.logical_replication" size="lg" border />

2. طبّق مجموعة المعلمات الجديدة على عنقود Aurora PostgreSQL لديك

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="تعديل Aurora PostgreSQL باستخدام مجموعة معلمات جديدة" size="lg" border />

3. أعد تشغيل عنقود Aurora لتطبيق التغييرات

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="إعادة تشغيل Aurora PostgreSQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="أين يمكنك العثور على مجموعة الأمان في Aurora PostgreSQL؟" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="حرّر قواعد Inbound لمجموعة الأمان أعلاه" size="lg" border />
