...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.png" alt="ضبط wal_level في وحدة تحكم PlanetScale" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.png" alt="ضبط max_slot_wal_keep_size في وحدة تحكم PlanetScale" size="md" border />
