...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="زر Edit في Cloud SQL Postgres" size="lg" border />

2. انتقل إلى Flags وغيّر `cloudsql.logical_decoding` إلى on. سيتطلب هذا التغيير إعادة تشغيل خادم Postgres.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="غيّر cloudsql.logical_decoding إلى on" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding3.png" alt="أعد تشغيل الخادم" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="قسم Connections في Cloud SQL" size="lg" border />

2. انتقل إلى القسم الفرعي Networking

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="القسم الفرعي Networking في Cloud SQL" size="lg" border />

3. أضف [عناوين IP العامة الخاصة بـ ClickPipes](/ar/integrations/clickpipes/home#list-of-static-ips)

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="أضف شبكات ClickPipes إلى جدار الحماية" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="تمت إضافة شبكات ClickPipes إلى جدار الحماية" size="lg" border />
