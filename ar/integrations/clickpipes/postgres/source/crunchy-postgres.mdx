...
<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/firewall_rules_crunchy_bridge.png" alt="أين تجد قواعد جدار الحماية في Crunchy Bridge؟" border />

<Image size="lg" img="/images/integrations/data-ingestion/clickpipes/postgres/source/setup/crunchy-postgres/add_firewall_rules_crunchy_bridge.png" alt="أضف قواعد جدار الحماية الخاصة بـ ClickPipes" border />
