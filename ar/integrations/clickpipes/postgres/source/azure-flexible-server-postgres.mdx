...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Server Parameters في Azure Flexible Server for Postgres" size="lg" border />

2. عدّل قيمة `wal_level` إلى `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="تغيير wal_level إلى logical في Azure Flexible Server for Postgres" size="lg" border />

3. سيتطلب هذا التغيير إعادة تشغيل الخادم، لذا أعد تشغيله عند مطالبتك بذلك.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="إعادة تشغيل الخادم بعد تغيير wal_level" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="أضِف ClickPipes IPs إلى جدار الحماية في Azure Flexible Server for Postgres" size="lg" />
