...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="خدمة ClickPipes" size="lg" border />

2. اختر زر `Data Sources` من القائمة الجانبية اليسرى، ثم انقر على &quot;Set up a ClickPipe&quot;

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="تحديد عمليات الاستيراد" size="lg" border />

3. اختر **GCP Pub/Sub** كمصدر للبيانات.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1_pubsub.png" alt="تحديد GCP Pub/Sub كمصدر للبيانات" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_pubsub.png" alt="املأ تفاصيل الاتصال" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_pubsub.png" alt="تعيين موضوع Pub/Sub والتنسيق والإزاحة الابتدائية" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="تعيين الجدول والمخطط والإعدادات" size="lg" border />

يمكنك أيضًا تخصيص الإعدادات المتقدمة باستخدام عناصر التحكم المتاحة

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="تعيين عناصر التحكم المتقدمة" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="استخدام جدول موجود" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="الأذونات" border />

9. عند النقر على &quot;Complete Setup&quot;، سيسجل النظام ClickPipe الخاص بك، وستتمكن من رؤيته مدرجًا في جدول الملخص.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="إشعار النجاح" size="sm" border />

<Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="إشعار الإزالة" size="lg" border />

يوفّر جدول الملخّص عناصر تحكّم لعرض بيانات عيّنة من المصدر أو من الجدول الهدف في ClickHouse

<Image img="/images/integrations/data-ingestion/clickpipes/cp_destination.png" alt="عرض الوجهة" size="lg" border />

بالإضافة إلى عناصر تحكّم لإزالة ClickPipe وعرض ملخّص لمهمة إدخال البيانات.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="عرض النظرة العامة" size="lg" border />
...
يُجري ClickPipes for Pub/Sub المصادقة مع GCP باستخدام مفتاح JSON لحساب خدمة. ترفع ملف المفتاح عند إنشاء الـ pipe؛ ويشفّر ClickPipes هذا المفتاح عند تخزينه ويستخدمه في وقت التشغيل لاستهلاك الرسائل وإدارة دورة حياة الاشتراك المُدار.

للاطلاع على القائمة الدقيقة بأذونات IAM المطلوبة وتعريف دور مخصص مُوصى به، راجع [دليل أذونات IAM لـ Pub/Sub](/ar/integrations/clickpipes/pubsub/auth).