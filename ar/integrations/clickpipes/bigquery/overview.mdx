...
يُجري ClickPipes المصادقة على مشروعك في Google Cloud باستخدام [مفتاح حساب خدمة](https://docs.cloud.google.com/iam/docs/keys-create-delete). نوصي بإنشاء حساب خدمة مخصّص بأقل مجموعة مطلوبة من [الأذونات](#permissions) للسماح لـ ClickPipes بتصدير البيانات من BigQuery، وتحميلها إلى حاوية GCS مرحلية، ثم قراءتها إلى ClickHouse.

<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="إنشاء مفتاح حساب خدمة بأذونات BigQuery وCloud Storage" size="lg" border />
