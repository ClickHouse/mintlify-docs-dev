...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-kinesis-stream.png" size="lg" alt="دفق Kinesis في DynamoDB" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="تصدير DynamoDB إلى S3" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="تعيين أعمدة DynamoDB" border />
