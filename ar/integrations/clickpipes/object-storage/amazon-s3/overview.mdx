...
| **OVH Object Storage** <br /> *متوافق مع S3*  | <img src="/images/integrations/logos/ovh.png" alt="شعار Cloud Storage" width="32" />          | يتطلب الإدخال المستمر [الترتيب المعجمي](#continuous-ingestion-lexicographical-order). ولا يدعم الوضع غير المرتب.                                                                     |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="بيانات اعتماد IAM لـ S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="مصادقة IAM لـ S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="الإعدادات المتقدمة لـ ClickPipes" size="lg" border />
