...
| ------------------------------------ | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Max insert bytes`                   | 10GB          | عدد البايتات التي ستتم معالجتها في دفعة insert واحدة.                                                                                               |
| `Max file count`                     | 100           | الحد الأقصى لعدد الملفات التي ستتم معالجتها في دفعة insert واحدة.                                                                                   |
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_advanced_settings.png" alt="الإعدادات المتقدمة في ClickPipes" size="lg" border />
