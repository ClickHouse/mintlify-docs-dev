...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-cluster-overview-configuration.png" alt="الانتقال إلى تهيئة العنقود" size="lg" border />

2. انقر على `Additional Settings` ثم مرّر إلى أسفل وصولًا إلى `More Configuration Options`.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-expand-additional-settings.png" alt="توسيع الإعدادات الإضافية" size="lg" border />

3. انقر على `More Configuration Options` واضبط الحد الأدنى لنافذة oplog على `72 hours` أو أكثر.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-set-retention-hours.png" alt="ضبط ساعات الاحتفاظ بـ oplog" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-add-new-database-user.png" alt="إضافة مستخدم قاعدة بيانات" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-database-user-privilege.png" alt="إعداد أدوار المستخدم" size="lg" border />

يمكنك أيضًا تحديد العناقيد/المثيلات التي تريد منح مستخدم ClickPipes حق الوصول إليها بشكل أكثر دقة:

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-restrict-access.png" alt="تقييد الوصول إلى العنقود/المثيل" size="lg" border />
