...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="اختر مجموعة المعلمات" size="lg" border />

2. ابحث عن `change_stream_log_retention_duration`، ثم حدده وعدّله إلى `259200` (72 ساعة)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="عدّل مجموعة المعلمات" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="طبّق مجموعة المعلمات" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="حالة مجموعة المعلمات" size="lg" border />
