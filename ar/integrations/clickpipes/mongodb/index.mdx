...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="اختيار الواردات" size="lg" border />

3. حدّد بطاقة `MongoDB CDC`.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="اختيار MongoDB" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="املأ تفاصيل الاتصال" size="lg" border />
...
5. هنا يمكنك تحديد قاعدة البيانات الوجهة لـ ClickPipe. يمكنك إما تحديد قاعدة بيانات موجودة أو إنشاء قاعدة بيانات جديدة.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="تحديد قاعدة البيانات الوجهة" size="lg" border />
