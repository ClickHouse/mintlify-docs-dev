...
تُنظَّم بيانات كل جدول في ClickHouse ضمن [عائلة محركات MergeTree](/ar/reference/engines/table-engines/mergetree-family/index) على القرص في شكل مجموعة من `data parts` غير القابلة للتغيير.
