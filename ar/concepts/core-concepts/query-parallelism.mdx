...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="تحليل الفهرس" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 مسارات معالجة متوازية" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 مسارات معالجة متوازية" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="مسارات موزعة" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="مسار تنفيذ الاستعلام" />
