...
<Image img="/images/guides/best-practices/prewhere_01.gif" size="md" alt="معالجة الاستعلام بدون تحسين PREWHERE" />
...
<Image img="/images/guides/best-practices/prewhere_02.gif" size="md" alt="معالجة الاستعلام باستخدام تحسين PREWHERE" />
...
<Image img="/images/guides/best-practices/prewhere_03.gif" size="md" alt="الخطوة 1: التصفية حسب المدينة" />
...
<Image img="/images/guides/best-practices/prewhere_04.gif" size="md" alt="الخطوة 2: التصفية حسب التاريخ" />
...
<Image img="/images/guides/best-practices/prewhere_05.gif" size="md" alt="الخطوة 2: التصفية حسب السعر" />
