...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="حالات استخدام القاموس في ClickHouse" />
...
* [أفضل ممارسات القواميس](/ar/concepts/features/dictionaries/best-practices) — اختيار البنية، القواميس مقابل JOINs، المراقبة
* [استخدام القواميس لتسريع الاستعلامات](https://clickhouse.com/blog/faster-queries-dictionaries-clickhouse)
* [التهيئة المتقدمة للقواميس](/ar/reference/statements/create/dictionary)