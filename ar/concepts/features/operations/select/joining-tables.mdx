...
* إذا كان استعلامك يتطلب ربطًا مباشرًا، أي `LEFT ANY JOIN`، كما هو موضح أدناه، فنوصي باستخدام [Dictionaries](/ar/concepts/features/dictionaries/index) حيثما أمكن.
...
<Image img="/images/guides/joins-3.png" size="lg" alt="ميزات JOIN" />
...
<Image img="/images/guides/joins-4.png" size="lg" alt="مخطط انسيابي لـ JOIN" />
...
يعتمد تحديد أي من الخوارزميات الثلاث غير المقيّدة بالذاكرة هو الأسرع على حجم البيانات وأنواع البيانات وتوزيع قيم أعمدة مفتاح الـ JOIN. ومن الأفضل دائمًا إجراء بعض اختبارات الأداء باستخدام أحجام بيانات وبيانات واقعية لتحديد الخوارزمية الأسرع.
...
<Image img="/images/guides/joins-5.png" size="lg" alt="شجرة قرار لتحسين الذاكرة في JOIN" />
