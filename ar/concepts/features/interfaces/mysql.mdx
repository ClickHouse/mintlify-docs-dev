...
<Image img="/images/interfaces/mysql0.png" alt="شاشة بيانات الاعتماد - Prompt" size="md" />

2. غيّر خيار `Connect with` من القائمة المنسدلة إلى `MySQL`.

<br />

<Image img="/images/interfaces/mysql1.png" alt="شاشة بيانات الاعتماد - تم تحديد MySQL" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="شاشة بيانات الاعتماد - تم تمكين MySQL" size="md" />

انسخ سلسلة اتصال MySQL الظاهرة.

<Image img="/images/interfaces/mysql3.png" alt="شاشة بيانات الاعتماد - سلسلة الاتصال" size="md" />
