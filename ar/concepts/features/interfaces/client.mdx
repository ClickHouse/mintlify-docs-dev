...
<Image img="/images/_snippets/cloud-connect-button.png" size="md" alt="زر Connect لخدمة ClickHouse Cloud" />
...
<Image img="/images/_snippets/connection-details-native.png" size="md" alt="تفاصيل اتصال Native TCP لخدمة ClickHouse Cloud" />
