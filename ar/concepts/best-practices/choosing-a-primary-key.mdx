...
<Image img="/images/bestpractices/create_primary_key.gif" size="lg" alt="المفتاح الأساسي" />
...
<Image img="/images/bestpractices/primary_key.gif" size="lg" alt="المفتاح الأساسي" />
