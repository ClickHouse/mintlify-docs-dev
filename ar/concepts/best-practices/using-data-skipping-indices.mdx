...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="إنشاء فهارس تخطي البيانات" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="استخدام فهارس تخطي البيانات" />
