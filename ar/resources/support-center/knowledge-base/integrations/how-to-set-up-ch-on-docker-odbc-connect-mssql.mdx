...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="بنية قاعدة البيانات والجدول في MSSQL" border />

مستخدم تسجيل الدخول في MSSQL، `sql_user`:

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="إعداد مستخدم تسجيل الدخول في MSSQL" border />

أدوار عضوية قاعدة البيانات لـ `sql_user`:

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="أدوار عضوية قاعدة البيانات في MSSQL" border />

مستخدم قاعدة بيانات مرتبط بتسجيل دخول:

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="مستخدم قاعدة بيانات في MSSQL مرتبط بتسجيل دخول" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/ar/snippets/engines/table-engines/integrations/odbc)
