...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="مربع حوار خطأ التحقق من المطوّر في MacOS" border />
...
2. انتقل إلى **الخصوصية والأمان**:
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="العرض الافتراضي لإعدادات الخصوصية والأمان في macOS" border />

3. مرّر إلى أسفل النافذة حتى تجد رسالة تفيد بأن *&quot;clickhouse-macos-aarch64&quot;* تم حظره من الاستخدام لأنه ليس من مطوّر معروف.

4. انقر على **السماح على أي حال**.

   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="إعدادات الخصوصية والأمان في macOS مع ظهور زر السماح على أي حال" border />
