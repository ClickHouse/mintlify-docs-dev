...
<Image img="/images/use-cases/observability/clickstack-migrating-agents.png" alt="ترحيل الوكلاء" size="lg" background />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="مفاتيح إدخال البيانات" size="lg" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/add-logstash-output.png" alt="إضافة مخرج Logstash" size="md" />
    ...
    <Image img="/images/use-cases/observability/agent-output-settings.png" alt="إعدادات الوكيل" size="md" />
...
<Image img="/images/use-cases/observability/ingestion-keys.png" alt="مفاتيح الاستيعاب" size="lg" />
