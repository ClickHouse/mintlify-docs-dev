...
<Image img="/images/use-cases/observability/hyperdx-25.png" alt="إعداد مصدر HyperDX" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-config.png" alt="تهيئة السمات المميزة" size="md" />

تُعرض هذه السمات في اللوحة الجانبية بعد النقر على سجل أو `span`:

<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes.png" alt="السمات المميزة" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-search.png" alt="بحث السمات المميزة" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-26.png" alt="مصدر HyperDX المترابط" size="md" />
