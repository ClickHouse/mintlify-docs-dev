...
<Steps>
  ...
  <Step>
    ## أكّد ذلك في واجهة ClickStack

    افتح خدمتك في [وحدة تحكم ClickHouse Cloud](https://console.clickhouse.cloud) واختر **ClickStack** من القائمة اليمنى.

    <Image img="/images/use-cases/observability/clickstack-cloud-v2.png" size="lg" alt="تشغيل ClickStack" border />
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view-clickstack.png" size="lg" alt="عرض Search في ClickStack مع سجلات CloudWatch" />
    ...
    * `Body`: سطر السجل الأصلي
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-attributes-clickstack.png" size="lg" alt="عرض Search في ClickStack مع سجلات CloudWatch والسمات" />

    حدّد log entry لفحص بياناته الوصفية:

    <Image img="/images/clickstack/cloudwatch/error-log-column-values-clickstack.png" size="lg" alt="سمات CloudWatch في عرض تفاصيل السجل" />
  ...
  <Step>
    ## استيراد لوحة معلومات CloudWatch (اختياري)

    تتوفر للتنزيل لوحة معلومات جاهزة تعرض حجم السجلات، وتصنيف مستويات الخطورة، وتوزيع الأخطاء.

    <TrackedLink href={'/ar/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">نزّل `cloudwatch-logs-dashboard.json`</TrackedLink>، ثم انتقل في ClickStack UI إلى **Dashboards** وانقر على **Import**.

    <Image img="/images/clickstack/clickstack-import-dashboard.png" size="lg" alt="زر استيراد لوحة المعلومات" />

    ارفَع ملف JSON ثم انقر على **Finish Import**.

    <Image img="/images/clickstack/cloudwatch/finish-clickstack-import.png" size="lg" alt="مربع حوار إتمام الاستيراد" />
  </Step>
