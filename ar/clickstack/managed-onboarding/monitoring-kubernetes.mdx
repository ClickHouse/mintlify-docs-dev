...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-search-with-k8-logs.png" size="lg" alt="عرض Search في ClickStack مع سجلات Kubernetes" />
    ...
    <Image img="/images/use-cases/observability/clickstack-dashboard-kubernetes.png" size="lg" alt="لوحة معلومات Kubernetes في ClickStack" border />
