...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/getting-started/hackernews_main.png" alt="تطبيق HackerNews Analyzer يعمل محليًا" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-first-time.png" size="lg" alt="تشغيل ClickStack" border />
