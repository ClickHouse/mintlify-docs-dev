...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="عرض البحث لإعادة تشغيل الجلسة" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="تشغيل إعادة تشغيل الجلسة" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="الانتقال من إعادة تشغيل الجلسة إلى تتبّعات الخدمات الخلفية في ClickStack" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="عرض التتبّع ضمن إعادة تشغيل الجلسة" size="lg" />
