...
<Steps>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-2.png" alt="تصور بسيط" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-3.png" alt="تصور بسيط 2" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-duplicate-series.png" alt="أيقونة نسخ Duplicate series وتلميحها في صف سلسلة مخطط" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-1.png" alt="إنشاء لوحة معلومات" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * الاسم المستعار: `Average Time`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-2.png" alt="إنشاء تصور للوحة المعلومات" size="lg" />

    عدّل حجم التصور ليشغل كامل عرض لوحة المعلومات.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-3.png" alt="لوحة معلومات تحتوي على تصورات" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Alias: `Count of events`
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-4.png" alt="تصور لوحة المعلومات 2" size="lg" />

    غيّر حجم التصور ليشغل العرض الكامل للوحة المعلومات.

    <Image img="/images/use-cases/observability/hyperdx-dashboard-5.png" alt="لوحة المعلومات مع تصورات 2" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **العدد**: `count()`
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-editor.png" alt="محرر بطاقة Heatmap مع تعبئة القيم الافتراضية لمدة الـ span مسبقًا، ومرشح ServiceName payment، وزر إعدادات العرض" size="lg" />

    تُعرَض البطاقة المحفوظة كـ heatmap على لوحة المعلومات. مرّر المؤشر فوق أي خلية لرؤية حدود الحاوية وعدد الأحداث.

    <Image img="/images/clickstack/dashboards/heatmap-tile-rendered.png" alt="بطاقة heatmap على لوحة المعلومات تعرض توزيع مدة الـ span لخدمة payment على مدى 24 ساعة" size="lg" />
    ...
    <Image img="/images/clickstack/dashboards/heatmap-tile-drilldown.png" alt="يكشف النقر على خلية في heatmap إجراء View in Event Deltas" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-filter.png" alt="لوحة معلومات مع التصفية" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-dashboard-save.png" alt="حفظ لوحة المعلومات" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-search.png" alt="البحث في لوحة المعلومات" size="lg" />
...
<Image img="/images/clickstack/dashboards/filter-dropdown.png" alt="فلتر خدمات منسدل يعرض أسماء الخدمات المتاحة" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/edit-filters.png" alt="زر Edit Filters في شريط أدوات لوحة المعلومات" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/add-filter.png" alt="مربع حوار إضافة فلتر يحتوي على حقول Name وData source وFilter expression" size="md" />
    ...
    <Image img="/images/clickstack/dashboards/saved-filters.png" alt="النافذة المنبثقة Filters تعرض فلتر Services مُعدًّا" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/filtered-dashboard.png" alt="لوحة معلومات تمت تصفيتها إلى خدمة frontend" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/save-filter-values.png" alt="قائمة لوحة المعلومات تعرض خيار Save Query and Filters as Default" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/drilldown.png" alt="قائمة سياقية للتعمّق تعرض خياري عرض جميع الأحداث والتصفية حسب المجموعة" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-clickhouse.png" alt="لوحة معلومات ClickHouse" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-services.png" alt="خدمات ClickHouse" size="lg" />
