...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-login.png" alt="واجهة HyperDX" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-2.png" alt="تسجيل الدخول إلى HyperDX" size="md" />
