  ...
  <Tab title="Docker">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="المصادقة" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="إنشاء مصدر" size="lg" />
