  ...
  <Tab title="أنشئ خدمة جديدة">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/getting-started/new_service.png" size="lg" alt="الخدمة" border />
      </Step>
  ...
  <Tab title="استخدم خدمة حالية">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="حدد خدمة" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/getting-started/clickstack_managed_ui.png" size="lg" alt="واجهة ClickStack" />
      ...
      <Step>
        ...
        <Image img="/images/clickstack/clickstack-ui-setup-ingestion.png" alt="إعداد الاستيعاب في واجهة ClickStack" size="lg" />
        ...
        <Image img="/images/clickstack/select-source-clickstack-ui.png" size="lg" alt="اختر المصدر - واجهة ClickStack" border />
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/otel-collector-start-clickstack-ui.png" size="md" alt="مصدر OTel collector" />
            ...
            **عدّل هذا الأمر باستخدام بيانات اعتماد الخدمة الخاصة بك، التي دوّنتها عند إنشاء خدمتك.**
            ...
            <Image img="/images/clickstack/advanced-otel-collector-clickstack-ui.png" size="lg" alt="مصدر OTel collector المتقدم" />
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/vector-config-clickstack-ui.png" size="lg" alt="إعداد Vector" />
      ...
      <Step>
        ### الانتقال إلى واجهة مستخدم ClickStack
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/getting-started/clickstack_managed_ui.png" size="lg" alt="واجهة مستخدم ClickStack" />
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/create-vector-datasource.png" alt="إنشاء مصدر بيانات - vector" size="lg" />
...
<Image img="/images/clickstack/read-only-access.png" alt="ClickHouse Cloud للقراءة فقط" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx_cloud_datasource.png" alt="مصدر بيانات HyperDX في ClickHouse Cloud" size="lg" />

لإنشاء مصادر للتتبعات ومقاييس OTel، يمكنك اختيار `Create New Source` من القائمة العلوية.

<Image img="/images/use-cases/observability/hyperdx_create_new_source.png" alt="ClickStack: إنشاء مصدر جديد" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx_create_trace_datasource.png" alt="ClickStack: إنشاء مصدر تتبعات" size="lg" />
