  ...
  <Tab title="ClickStack المُدار">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="تشغيل ClickStack لـ Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="سجلات Nginx في ClickStack" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack مفتوح المصدر">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="واجهة Play في ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="تسجيل الدخول إلى ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="إنشاء مصدر بيانات - vector" size="lg" />
  ...
  <Tab title="ClickStack المُدار">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="واجهة مستخدم HyperDX" size="lg" />
      </Step>
    </Steps>
  </Tab>
