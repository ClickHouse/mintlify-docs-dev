...
<Tabs>
  <Tab title="Managed ClickStack">
    <Image img="/images/use-cases/observability/clickstack-managed-architecture-with-flow.png" alt="معمارية مُدارة مع التدفق" size="md" />
  </Tab>

  <Tab title="Open Source ClickStack">
    <Image img="/images/use-cases/observability/clickstack-oss-architecture-with-flow.png" alt="معمارية بسيطة مع التدفق" size="md" />
  </Tab>
</Tabs>
