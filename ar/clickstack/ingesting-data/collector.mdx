...
<Tabs>
  ...
  <Tab title="ClickStack مفتوح المصدر">
    ...
    <Image img="/images/use-cases/observability/ingestion-keys.png" alt="مفاتيح الإدخال" size="lg" />
...
<Image img="/images/use-cases/observability/observability-6.png" alt="عمليات الإدراج غير المتزامنة" size="md" />
...
<Image img="/images/use-cases/observability/clickstack-with-gateways.png" alt="التوسّع باستخدام البوابات" size="lg" />
...
<Image img="/images/use-cases/observability/observability-8.png" alt="إضافة Kafka" size="lg" />
...
ينشئ مُجمِّع ClickStack جداول تخزّن السمات في أعمدة من النوع `Map(LowCardinality(String), String)` افتراضيًا. وهذا هو المخطط الموصى به لأعباء عمل observability. كما يتوفر مخطط من النوع `JSON` بحالة Beta للتقييم في أعباء العمل التي تحتوي على مجموعة صغيرة ومستقرة من مفاتيح السمات.

للاطّلاع على المقارنة الكاملة، ومعرفة متى يكون كلٌّ منهما مناسبًا، ومتغيرات البيئة المطلوبة لتمكين المخطط من النوع JSON، ودليل الترحيل، راجع [Map vs JSON type](/ar/clickstack/ingesting-data/schema/map-vs-json).