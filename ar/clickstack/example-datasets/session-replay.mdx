...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="مفتاح API في ClickStack" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="التطبيق التجريبي لإعادة تشغيل الجلسة" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="البحث في إعادة تشغيل الجلسة" />

    يُفترض أن تظهر جلستك في القائمة مع مدتها وعدد الأحداث فيها. انقر على الزر ▶️ لإعادة تشغيلها.

    <Image img="/images/clickstack/session-replay/session-replay.png" alt="إعادة تشغيل الجلسة" />
