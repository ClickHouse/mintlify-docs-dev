...
<Tabs>
  <Tab title="ClickStack المُدار">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="اختر الخدمة" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="سجلات HyperDX المحلية" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="الذاكرة بمرور الوقت" size="lg" />

        لاحظ أن القيمة تُعرَض كنسبة مئوية `%` بصيغة عدد عشري. لعرضها بشكل أوضح، حدِّد `Set number format`.

        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="تنسيق الأرقام" size="lg" />

        من القائمة التالية، يمكنك اختيار `Percentage` من القائمة المنسدلة `Output format` قبل النقر على `Apply`.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="النسبة المئوية للذاكرة بمرور الوقت" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack مفتوح المصدر">
    ...
    <Image img="/images/use-cases/observability/hyperdx-20.png" alt="السجلات المحلية لـ HyperDX" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory بمرور الزمن" size="lg" />

    لاحظ أن الرقم يُرجَع كنقطة عائمة `%`. لعرضه بشكل أوضح، حدد `Set number format`.

    <Image img="/images/use-cases/observability/hyperdx-22.png" alt="تنسيق الرقم" size="lg" />

    من القائمة التالية، يمكنك اختيار `Percentage` من القائمة المنسدلة `Output format` ثم النقر على `Apply`.

    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="نسبة الذاكرة بمرور الوقت" size="lg" />
  </Tab>
</Tabs>