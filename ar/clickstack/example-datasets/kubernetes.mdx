...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/copy_api_key.png" alt="نسخ مفتاح API" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="بيانات HyperDX على Kubernetes" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="ClickHouse على Kubernetes" size="lg" />