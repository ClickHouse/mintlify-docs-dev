...
<Tabs>
  <Tab title="ClickStack المُدار">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="البنية المُدارة" size="lg" />
  ...
  <Tab title="ClickStack مفتوح المصدر">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="البنية" size="lg" />
