...
<Steps>
  <Step>
    ...
    5. هيّئ الاتصال:
       ...
       * **API Ingestion Key**: أدخل مفتاح API لإدخال البيانات الخاص بـ ClickStack
  ...
  <Step>
    ...
    يوفّر Bindplane إمكانات pipeline intelligence وتوصيات للمعالجات. يمكنك إضافة معالجات من أجل:
  ...
  <Step>
    ...
    1. أضف مجمّعًا (BDOT Collector) إلى التهيئة الخاصة بك:
    ...
    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="إشارات بيانات القياس عن بُعد في ClickStack عبر Bindplane" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="إشارات بيانات القياس عن بُعد في ClickStack عبر Bindplane" size="lg" />
  </Step>
</Steps>
