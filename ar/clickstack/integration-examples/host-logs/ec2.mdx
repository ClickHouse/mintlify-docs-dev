...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="عرض البحث لسجلات EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="تفاصيل سجل EC2 التي تعرض البيانات الوصفية" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="واجهة البحث لسجلات EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="تفاصيل سجل EC2 مع البيانات الوصفية" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="لوحة معلومات سجلات EC2" />
