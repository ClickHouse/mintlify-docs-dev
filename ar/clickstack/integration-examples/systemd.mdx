...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="واجهة البحث في السجلات" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="عرض البحث في السجلات" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    * معدلات الأخطاء
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="مثال على لوحة المعلومات" />
