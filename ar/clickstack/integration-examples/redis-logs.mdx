...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="عرض السجلات" />

    <Image img="/images/clickstack/redis/redis-log.png" alt="سجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="عرض السجل" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="لوحة معلومات نموذجية" />
  </Step>
</Steps>
