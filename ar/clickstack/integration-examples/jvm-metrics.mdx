...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="لوحة معلومات مقاييس Kafka" />
