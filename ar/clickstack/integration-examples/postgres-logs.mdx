...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="عرض البحث للسجلات" />

    <Image img="/images/clickstack/postgres/postgres-log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="عرض Search للسجلات" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-dashboard.png" alt="لوحة معلومات السجلات" />
