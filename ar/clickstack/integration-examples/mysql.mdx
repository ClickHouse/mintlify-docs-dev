...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="عرض البحث" />

    <Image img="/images/clickstack/mysql/log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="عرض Search" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ar/examples/mysql-logs-dashboard.json'} download="mysql-logs-dashboard.json" eventName="docs.mysql_logs_monitoring.dashboard_download">تنزيل</TrackedLink> إعداد لوحة المعلومات
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/finish-import.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/example-dashboard.png" alt="لوحة معلومات نموذجية" />
