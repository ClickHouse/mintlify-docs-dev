...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="عرض البحث في سجلات MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="عرض تفاصيل سجل MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="عرض Search لسجلات MongoDB" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/finish-import.png" alt="إنهاء استيراد لوحة معلومات سجلات MongoDB" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="لوحة معلومات سجلات MongoDB" />
  </Step>
</Steps>
