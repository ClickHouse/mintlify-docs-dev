...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="مقاييس Temporal" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="مربع حوار إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="لوحة معلومات Temporal Metrics" />
  </Step>
</Steps>
