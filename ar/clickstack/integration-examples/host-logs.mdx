...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/search-view.png" alt="عرض البحث" />

    <Image img="/images/clickstack/host-logs/log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="إتمام الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="لوحة معلومات السجلات" />
