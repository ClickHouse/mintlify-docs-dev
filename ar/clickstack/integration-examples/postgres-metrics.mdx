...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="مربع حوار إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="لوحة معلومات مقاييس PostgreSQL" />
