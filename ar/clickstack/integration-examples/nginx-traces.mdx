...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="عرض التتبعات" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="إتمام الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="لوحة معلومات نموذجية" />
  </Step>
</Steps>
