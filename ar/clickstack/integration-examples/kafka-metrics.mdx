...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="مربع حوار إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="لوحة معلومات مقاييس Kafka" />
