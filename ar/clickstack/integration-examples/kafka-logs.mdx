...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="واجهة البحث" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="واجهة السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="عرض البحث" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="إنهاء استيراد لوحة معلومات Kafka logs" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="لوحة معلومات Kafka logs التجريبية" />
  </Step>
</Steps>
