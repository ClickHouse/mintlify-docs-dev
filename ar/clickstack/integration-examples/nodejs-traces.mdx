...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="مفتاح واجهة برمجة تطبيقات لـ ClickStack" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="واجهة البحث عن التتبعات" />

    انقر على أي تتبع لعرض التفاصيل، بما في ذلك spans والتوقيت والسمات:

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="عرض تتبع فردي" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="مفتاح واجهة برمجة تطبيقات الخاص بـ ClickStack" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="عرض البحث للتتبعات" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="استيراد لوحة معلومات" />

    3. ارفع ملف `nodejs-traces-dashboard.json` وانقر على **إنهاء الاستيراد**

    <Image img="/images/clickstack/nodejs/finish-import.png" alt="إنهاء الاستيراد" />
  </Step>

  <Step>
    #### ستُنشأ لوحة المعلومات مع تهيئة جميع التصورات مسبقًا

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="لوحة معلومات نموذجية" />
