...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="عرض السجل" />

    <Image img="/images/clickstack/log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="عرض السجلات" />

    <Image img="/images/clickstack/log-view.png" alt="عرض السجلات" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="استيراد لوحة المعلومات" />

    3. ارفع ملف nginx-logs-dashboard.json ثم انقر على Finish Import.

    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="إنهاء الاستيراد" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="لوحة معلومات نموذجية" />
  </Step>
</Steps>
