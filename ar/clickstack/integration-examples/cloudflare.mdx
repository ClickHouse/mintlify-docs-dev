...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="إضافة مصدر" />

    2. انقر على **Add source** ثم هيّئ الإعدادات التالية. انقر على **Configure Optional Fields** للوصول إلى جميع الحقول:

    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="تهيئة الحقول الاختيارية" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="حفظ المصدر" />
  ...
  <Step>
    ...
    * سمات قابلة للبحث مثل `http.status_code` و`client.country` و`cache.status` و`bot.score`
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="عرض Search" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="عرض السجل" />
  </Step>
</Steps>
  ...
  <Step>
    ...
    <Info>
      **عرض timezone**
      ...
      يعرض HyperDX timestamps وفق timezone المحلية في متصفحك. تمتد البيانات التجريبية عبر **2026-02-24 00:00:00 - 2026-02-25 00:00:00 (UTC)**. يضمن النطاق الزمني الواسع ظهور السجلات التجريبية مهما كان موقعك. وبعد ظهور السجلات، يمكنك تضييق النطاق إلى فترة 24 ساعة للحصول على visualizations أوضح.
    </Info>
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/ar/examples/cloudflare-logs-dashboard.json'} download="cloudflare-logs-dashboard.json" eventName="docs.cloudflare_logs_monitoring.dashboard_download">تنزيل</TrackedLink> إعدادات لوحة المعلومات
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/import-dashboard.png" alt="استيراد لوحة معلومات" />

    2. حمّل `cloudflare-logs-dashboard.json` → **Finish Import**

    <Image img="/images/clickstack/cloudflare/finish-import.png" alt="استيراد لوحة معلومات" />
  </Step>

  <Step>
    #### عرض لوحة المعلومات

    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="مثال على لوحة معلومات" />
