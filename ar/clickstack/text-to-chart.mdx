...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/text-to-chart/chart-explorer.png" alt="مستكشف المخططات" />
  </Step>
  ...
  <Step>
    ...
    * `Count of events over time grouped by severity`
    ...
    <Image img="/images/clickstack/text-to-chart/text-to-chart.png" alt="تحويل النص إلى مخطط" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/text-to-chart/create-connection.png" alt="إنشاء اتصال" />
...
* [من النص إلى المخططات: طريقة أسرع للتصوّر باستخدام ClickStack](https://clickhouse.com/blog/text-to-charts-faster-way-to-visualize-clickstack) — تدوينة تعرّف بهذه الميزة
* [لوحات المعلومات والمرئيات](/ar/clickstack/features/dashboards/overview) — إنشاء المخططات يدويًا باستخدام Chart Explorer
* [البحث](/ar/clickstack/features/search) — صياغة البحث في النص الكامل والخصائص
* [التهيئة](/ar/clickstack/managing/config) — جميع متغيرات البيئة في ClickStack