...
## Account closure and deletion <a id="account-close--deletion"></a>
...
## Close versus delete your account <a id="close-vs-delete"></a>
...
## Preparing for closure <a id="preparing-for-closure"></a>

Before requesting account closure, please take the following steps to prepare the account.

<Steps>
<Step>
### 1. Export any data you need to keep. <a id="export-data"></a>
> Export service content<br/>
> Export console logs<br/>
> Export database logs<br/>
</Step>
<Step>
### 2. Stop and delete your services. <a id="stop-and-delete-services"></a>
> This will stop additional charges from accruing on your account
</Step>
<Step>
### 3. Remove all users except the admin that will request closure. <a id="remove-users"></a>
> This prevents unexpected activity on the account that could prevent closure
</Step>
<Step>
### 4. Review the 'Usage' and 'Billing' tabs to verify all charges have been paid. <a id="ensure-charges-are-paid"></a>
> We are not able to close accounts with unpaid balances.
</Step>
</Steps>

## Request an account closure <a id="request-account-closure"></a>
...
## Request deletion of your personal data <a id="request-personal-data-deletion"></a>
