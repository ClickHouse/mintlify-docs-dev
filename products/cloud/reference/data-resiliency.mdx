...
## Database backups <a id="database-backups"></a>
...
## Restoring from a Backup <a id="restoring-from-a-backup"></a>
...
## Backup and restore duration guidance <a id="backup-and-restore-duration-guidance"></a>
...
## Recovery process <a id="recovery-process"></a>

This section explains the various recovery options and the process that can be followed in each case.

### Primary service data corruption <a id="primary-service-data-corruption"></a>
...
#### Restoration steps <a id="restoration-steps"></a>
...
<Image img="/images/cloud/guides/restore_backup.png" size="md" alt="Restore from backup"/>

### Primary region downtime <a id="primary-region-downtime"></a>
