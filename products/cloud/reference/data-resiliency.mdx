...
By default, ClickHouse Cloud takes a [backup](/products/cloud/guides/backups) of your service every 24 hours.
...
<Image img="/static/images/cloud/guides/restore_backup.png" size="md" alt="Restore from backup"/>
