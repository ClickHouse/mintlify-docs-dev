...
[ClickHouse Assistant](/products/cloud/features/ai-ml/ask-ai) may be enabled at the service level within the SQL console. This feature enables two distinct pieces of functionality:
