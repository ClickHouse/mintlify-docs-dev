...
<Image img="/static/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="Where to find billing in the UI"/>

<Image img="/static/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="Bill"/>
