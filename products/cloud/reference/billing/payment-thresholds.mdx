...
## Payment thresholds <a id="threshholds"></a>
...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="Where to find billing in the UI"/>

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="Bill"/>
...
## Payment threshold notifications <a id="threshholds-notifications"></a>
