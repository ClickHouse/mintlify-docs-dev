...
## Billing compliance <a id="billing-compliance"></a>
...
### Pay-as-you-go billing with a credit card <a id="direct-payg"></a>
...
### Cloud marketplace pay-as-you-go billing <a id="cloud-marketplace-payg"></a>
...
### Committed contract billing <a id="committed-spend-contract"></a>
...
### How to pay using a credit card <a id="add-credit-card"></a>
...
<Image img="/images/cloud/manage/billing_compliance.png" size="md" alt="How to add a credit card" />

## How to pay via marketplaces <a id="marketplace-payg"></a>
