...
## What does the ClickPipes pricing structure look like? <a id="what-does-the-clickpipes-pricing-structure-look-like"></a>
...
## What are ClickPipes replicas? <a id="what-are-clickpipes-replicas"></a>
...
## What is the default number of replicas and their size? <a id="what-is-the-default-number-of-replicas-and-their-size"></a>
...
## What are the ClickPipes public prices? <a id="what-are-the-clickpipes-public-prices"></a>
...
## How does it look in an illustrative example? <a id="how-does-it-look-in-an-illustrative-example"></a>
...
## FAQ for streaming and object storage ClickPipes <a id="faq-streaming-and-object-storage"></a>
