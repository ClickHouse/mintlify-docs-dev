...
## Pricing dimensions <a id="pricing-dimensions"></a>
...
### Ingested data <a id="ingested-data"></a>
...
#### Monthly cost breakdown <a id="cost-breakdown"></a>
...
## FAQ for Postgres CDC ClickPipes <a id="faq-postgres-cdc-clickpipe"></a>
