...
## How spend alerts work <a id="how-spend-alerts-work"></a>
...
## Set up a spend alert <a id="set-up-spend-alert"></a>

<Steps>
<Step>
### Open the spend alerts dialog <a id="open-spend-alerts-dialog"></a>

1. Navigate to **Organization > Billing** in the ClickHouse Cloud console.
2. Click **Actions > Add spend alerts**.

<Image img="/images/cloud/reference/billing/spend-alerts-actions.png" alt="Billing page with the Actions menu open and Add spend alerts highlighted" size="lg"/>
</Step>
<Step>
### Configure and save the alert <a id="configure-and-save"></a>
...
## Automatic threshold alerts <a id="threshold-alerts"></a>
...
## Notification channels <a id="notification-channels"></a>
