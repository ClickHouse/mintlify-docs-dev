...
## Steps to sign up <a id="steps-to-sign-up"></a>

1. You should have received an email with a link to review and accept your private offer.

<br />

<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-1.png" size="md" alt="Azure Marketplace private offer email" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-2.png" size="md" alt="Azure Marketplace private offer details" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-3.png" size="md" alt="Azure Marketplace Private Offer Management page" border/>

<br />

<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-4.png" size="md" alt="Azure Marketplace Private Offer Management page loading" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-5.png" size="md" alt="Azure Marketplace Private Offer Management page purchase enabled" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-6.png" size="md" alt="Azure Marketplace subscription form" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-7.png" size="md" alt="Azure Marketplace subscription confirmation" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-8.png" size="md" alt="Azure Marketplace subscription submitting page" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-9.png" size="md" alt="Azure Marketplace configure account now button" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.png" size="md" alt="ClickHouse Cloud sign up info form" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-payg-11.png" size="sm" alt="ClickHouse Cloud sign up info form" border/>

<br />

<br />

<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-payg-12.png" size="md" alt="ClickHouse Cloud sign up info form" border/>
