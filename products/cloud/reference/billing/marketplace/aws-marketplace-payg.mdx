...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-1.png" alt="AWS Marketplace search for ClickHouse" border/>
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-2.png" alt="AWS Marketplace view purchase options" border/>

### Subscribe {#subscribe}

On the next screen, click subscribe.

<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-3.png" alt="AWS Marketplace subscribe" border/>
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-4.png" alt="Set up your account" border/>
...
<Accordion title="<strong>Steps for new users</strong>">
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-5.png" size="md" alt="ClickHouse Cloud sign-up"/>
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-6.png" size="md" alt="Before you start"/>

<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-7.png" size="md" alt="Before you start, continued"/>
</Accordion>
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.png" size="md" alt="Add marketplace subscription" border/>
...
<Image img="/static/images/cloud/manage/billing/marketplace/aws-marketplace-payg-9.png" size="lg" alt="Confirm billing page" border/>
