...
<Steps>
<Step>
### Search for ClickHouse Cloud - Pay as you go <a id="search-payg"></a>

Go to the [AWS Marketplace](https://aws.amazon.com/marketplace) and search for “ClickHouse Cloud - Pay As You Go”.

<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-1.png" alt="AWS Marketplace search for ClickHouse" border/>
</Step>
<Step>
### View purchase options <a id="purchase-options"></a>

Click on the [listing](https://aws.amazon.com/marketplace/pp/prodview-p4gwofrqpkltu) and then on **View purchase options**.

<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-2.png" alt="AWS Marketplace view purchase options" border/>
</Step>
<Step>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-3.png" alt="AWS Marketplace subscribe" border/>
</Step>
<Step>
### Set up your account <a id="set-up-your-account"></a>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-4.png" alt="Set up your account" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-5.png" size="md" alt="ClickHouse Cloud sign-up"/>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-6.png" size="md" alt="Before you start"/>

<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-7.png" size="md" alt="Before you start, continued"/>
</Accordion>

If you're an existing ClickHouse Cloud user, simply log in using your credentials.
</Step>
<Step>
### Add the marketplace subscription to an organization <a id="add-marketplace-subscription"></a>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.png" size="md" alt="Add marketplace subscription" border/>
...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-9.png" size="lg" alt="Confirm billing page" border/>
</Step>
</Steps>
