...
<Steps>
<Step>
### Accept your private offer <a id="private-offer-accept"></a>

You should have received an email with a link to review and accept your private offer.

<Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="AWS Marketplace private offer email"/>
</Step>
<Step>
### Review offer link <a id="review-offer-link"></a>
...
<Step>
### Set up your account <a id="setup-your-account"></a>
...
<Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="AWS Marketplace private offer email"/>
</Step>
<Step>
### Login to Cloud <a id="login-cloud"></a>
...
<Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="AWS Marketplace private offer email"/>
</Step>
<Step>
### Register if new <a id="register"></a>
...
<Step>
### Create or select organization to bill <a id="create-select-org-to-bill"></a>
...
<Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="Create or select an organization to bill to this subscription"/>
...
<Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="Confirm set up is complete"/>
