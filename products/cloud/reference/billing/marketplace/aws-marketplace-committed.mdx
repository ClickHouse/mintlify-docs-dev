...
<Image img="/static/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="AWS Marketplace private offer email"/>
...
<Image img="/static/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="AWS Marketplace private offer email"/>
...
<Image img="/static/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="AWS Marketplace private offer email"/>
...
<Image img="/static/images/cloud/reference/mp_committed_spend_4.png" size="md" alt="Provide business information"/>

<Image img="/static/images/cloud/reference/mp_committed_spend_5.png" size="md" alt="Provide business information"/>
...
<Image img="/static/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="Create or select an organization to bill to this subscription"/>
...
<Image img="/static/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="Confirm set up is complete"/>
