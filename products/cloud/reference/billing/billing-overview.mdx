...
## Amazon Web Services (AWS) example <a id="amazon-web-services-aws-example"></a>
...
### Basic: from $66.52 per month <a id="basic-from-6652-per-month"></a>
...
### Scale (always-on, auto-scaling): from $499.38 per month <a id="scale-always-on-auto-scaling-from-49938-per-month"></a>
...
### Enterprise: Starting prices vary <a id="enterprise-starting-prices-vary"></a>
...
### What is a ClickHouse Credit (CHC)? <a id="what-is-chc"></a>
...
### Where can I find legacy pricing? <a id="find-legacy-pricing"></a>

Legacy pricing information can be found [here](https://clickhouse.com/pricing?legacy=true).

### How is compute metered? <a id="how-is-compute-metered"></a>
...
### How is storage on disk calculated? <a id="how-is-storage-on-disk-calculated"></a>
...
### Do backups count toward total storage? <a id="do-backups-count-toward-total-storage"></a>
...
### How do I estimate compression? <a id="how-do-i-estimate-compression"></a>
...
### What tools does ClickHouse offer to estimate the cost of running a service in the cloud if I have a self-managed deployment? <a id="what-tools-does-clickhouse-offer-to-estimate-the-cost-of-running-a-service-in-the-cloud-if-i-have-a-self-managed-deployment"></a>
...
### What billing options are available for ClickHouse Cloud? <a id="what-billing-options-are-available-for-clickhouse-cloud"></a>
...
### Can I delete my credit card? <a id="can-i-delete-my-credit-card"></a>
...
### Where can I see my refunds? <a id="where-can-i-see-my-refunds"></a>
...
### How long does it take for a refund to appear? <a id="how-long-does-it-take-for-a-refund-to-appear"></a>
...
### How long is the billing cycle? <a id="how-long-is-the-billing-cycle"></a>
...
### If I have an active PAYG marketplace subscription and then sign a committed contract, will my committed credits be consumed first? <a id="committed-credits-consumed-first-with-active-payg-subscription"></a>
...
### What controls does ClickHouse Cloud offer to manage costs for Scale and Enterprise services? <a id="what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-scale-and-enterprise-services"></a>
...
### What controls does ClickHouse Cloud offer to manage costs for Basic services? <a id="what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-basic-services"></a>
...
### If I have multiple services, do I get an invoice per service or a consolidated invoice? <a id="if-i-have-multiple-services-do-i-get-an-invoice-per-service-or-a-consolidated-invoice"></a>

A consolidated invoice is generated for all services in a given organization for a billing period.

### If I add my credit card and upgrade before my trial period and credits expire, will I be charged? <a id="if-i-add-my-credit-card-and-upgrade-before-my-trial-period-and-credits-expire-will-i-be-charged"></a>
...
### How can I keep track of my spending? <a id="how-can-i-keep-track-of-my-spending"></a>
...
### How do I access my invoices for my subscription to the ClickHouse Cloud service? <a id="how-do-i-access-my-invoice-for-my-subscription-to-the-clickhouse-cloud-service"></a>
...
### Why do the dates on the Usage statements not match my Marketplace Invoice? <a id="why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice"></a>
...
### Are there any restrictions around the usage of prepaid credits? <a id="are-there-any-restrictions-around-the-usage-of-prepaid-credits"></a>
...
### Is there a difference in ClickHouse Cloud pricing, whether paying through the cloud provider marketplace or directly to ClickHouse? <a id="is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse"></a>
...
### How is compute-compute separation billed? <a id="how-is-compute-compute-separation-billed"></a>
...
## ClickPipes pricing <a id="clickpipes-pricing"></a>
