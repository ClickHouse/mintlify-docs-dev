...
<Image img="/static/images/cloud/reference/billing/01-add-payment-method.png" alt="Add a payment method" size="lg"/>

3. If you wish to edit your credit card, then at the top of the page, click the button to **edit your credit card**.

<Image img="/static/images/cloud/reference/billing/02-edit-credit-card.png" alt="Edit your credit card" size="lg"/>
...
<Image img="/static/images/cloud/reference/billing/03-edit-payment-method.png" alt="Edit payment method" size="lg"/>
...
<Image img="/static/images/cloud/reference/billing/04-edit-payment-method.png" alt="Edit payment method" size="lg"/>
...
<Image img="/static/images/cloud/reference/billing/05-add-backup.png" alt="Add backup credit card" size="lg"/>
