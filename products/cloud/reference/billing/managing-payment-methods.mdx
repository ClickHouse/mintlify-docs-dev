...
## Add or update a credit card payment method <a id="add-update-cc-payment-method"></a>

If your organization is currently billed via credit card, you can update your card details from the Billing page.

### Steps to add or update your credit card <a id="steps-add-update"></a>
...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="Add a payment method" size="lg"/>

3. If you wish to edit your credit card, then at the top of the page, click the button to **edit your credit card**.

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="Edit your credit card" size="lg"/>

4. In both cases, follow the instructions to add or update your credit card’s billing address details.

## Configure an organization's billing to an existing marketplace subscription <a id="configure-billing-to-existing-mp-sub"></a>
...
### Steps to switch an organization from credit card billing to a marketplace subscription that's already active on one of your other organizations <a id="steps-switch-org-already-active"></a>

1. Navigate to the **Billing** page in the ClickHouse Cloud console.
2. Click the edit icon next to the **payment method**.

<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="Edit payment method" size="lg"/>
...
### Steps to change an organization's current marketplace subscription to one that's used by a different organization <a id="steps-switch-org-different-org"></a>

1. Navigate to the **Billing** page in the ClickHouse Cloud console.
2. Click the edit icon next to the **payment method**.

<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="Edit payment method" size="lg"/>
...
## Adding a backup credit card to a marketplace organization <a id="add-backup-cc-to-marketplace-org"></a>
...
### Steps to add a backup credit card <a id="steps-add-backup-cc"></a>
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="Add backup credit card" size="lg"/>
...
## Set up marketplace billing from your cloud provider <a id="set-up-marketplace-billing-from-cp"></a>
...
### What happens to my usage charges if I switch billing methods mid billing cycle? <a id="what-happens-to-my-usage-charges-if-i-switch-billing-methods-mid-billing-cycle"></a>
