...
To learn more about the settings you can specify for your ClickHouse Cloud service, please see all possible settings by category in [our docs](/reference/settings).

<Image img="/static/images/cloud/manage/cloud-settings-sidebar.png" size="sm" alt="Cloud settings sidebar" border/>
