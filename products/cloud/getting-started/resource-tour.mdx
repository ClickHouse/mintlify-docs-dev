...
| [Cloud Monitoring Capabilities](/core/guides/use-cases/observability/cloud-monitoring) | Get an overview of built in monitoring capabilities and integration options   |
