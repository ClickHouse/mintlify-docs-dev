...
IP access lists only apply to connections from the public internet, outside of [PrivateLink](/products/cloud/guides/security/connectivity/private-networking).
...
<Image img="/static/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="Existing access list in ClickHouse Cloud" border/>
...
<Image img="/static/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="Adding a single IP to the access list in ClickHouse Cloud" border/>
