...
## Important considerations <a id="considerations"></a>
...
## Prerequisites for this process <a id="prerequisites"></a>
...
### Obtain endpoint "Service name" <a id="obtain-endpoint-service-info"></a>
...
### Create AWS endpoint <a id="create-aws-endpoint"></a>
...
#### Option 1: AWS console <a id="option-1-aws-console"></a>
...
#### Option 2: AWS CloudFormation <a id="option-2-aws-cloudformation"></a>
...
#### Option 3: Terraform <a id="option-3-terraform"></a>
...
### Accessing an instance using PrivateLink <a id="accessing-an-instance-using-privatelink"></a>
...
### Multiple PrivateLinks in one region <a id="multiple-privatelinks-in-one-region"></a>
...
### Connection to private endpoint timed out <a id="connection-to-private-endpoint-timed-out"></a>
...
### Private Hostname: Not found address of host <a id="private-hostname-not-found-address-of-host"></a>
