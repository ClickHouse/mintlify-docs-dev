...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="Overview of PrivateLink" background='white' />
...
## Obtain Azure connection alias for Private Link <a id="obtain-azure-connection-alias-for-private-link"></a>

### Option 1: ClickHouse Cloud console <a id="option-1-clickhouse-cloud-console"></a>
...
<Image img="/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="Private Endpoints" border />

Make a note of the `Service name` and `DNS name`, they will be needed in the next steps.

### Option 2: API <a id="option-2-api"></a>
...
## Create a private endpoint in Azure <a id="create-private-endpoint-in-azure"></a>
...
### Option 1: Using Azure Portal to create a private endpoint in Azure <a id="option-1-using-azure-portal-to-create-a-private-endpoint-in-azure"></a>

In the Azure Portal, open **Private Link Center → Private Endpoints**.

<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="Open Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Create Private Endpoint Basic" border />
...
<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="Private Endpoint Resource Selection" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Private Endpoint Virtual Network Selection" border />

Click the **Next: Tags** button.

---

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Private Endpoint DNS Configuration" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Private Endpoint Tags" border />

Finally, click the **Create** button.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="Private Endpoint Review" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="Private Endpoint IP Address" border />

### Option 2: Using Terraform to create a private endpoint in Azure <a id="option-2-using-terraform-to-create-a-private-endpoint-in-azure"></a>
...
### Obtaining the Private Endpoint Resource ID <a id="obtaining-private-endpoint-resourceid"></a>
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="Private Endpoint View" border />

Under properties, find `id` field and copy this value:

**Preferred method: Using Resource ID**
<Image img="/images/cloud/security/azure-pe-resource-id.png" size="lg" alt="Private Endpoint Resource ID" border />
...
<Image img="/images/cloud/security/azure-pe-resource-guid.png" size="lg" alt="Private Endpoint Resource GUID" border />

## Setting up DNS for Private Link <a id="setting-up-dns-for-private-link"></a>
...
### Create Private DNS zone <a id="create-private-dns-zone"></a>
...
### Create a wildcard DNS record <a id="create-a-wildcard-dns-record"></a>
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Private Link DNS Wildcard Setup" border />
...
### Create a virtual network link <a id="create-a-virtual-network-link"></a>
...
### Verify DNS setup <a id="verify-dns-setup"></a>
...
## Add the Private Endpoint Resource ID to your ClickHouse Cloud organization <a id="add-the-private-endpoint-id-to-your-clickhouse-cloud-organization"></a>

### Option 1: ClickHouse Cloud console <a id="option-1-clickhouse-cloud-console-1"></a>
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Remove Private Endpoint" border />

### Option 2: API <a id="option-2-api-1"></a>
...
## Add the Private Endpoint Resource ID to your services allow list <a id="add-private-endpoint-id-to-services-allow-list"></a>
...
### Option 1: ClickHouse Cloud console <a id="option-1-clickhouse-cloud-console-2"></a>
...
<Image img="/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="Private Endpoints Filter" border />

### Option 2: API <a id="option-2-api-2"></a>
...
## Access your ClickHouse Cloud service using Private Link <a id="access-your-clickhouse-cloud-service-using-private-link"></a>
...
### Obtaining the private DNS hostname <a id="obtaining-the-private-dns-hostname"></a>

#### Option 1: ClickHouse Cloud console <a id="option-1-clickhouse-cloud-console-3"></a>
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="Private Endpoint DNS Name" border />

#### Option 2: API <a id="option-2-api-3"></a>
...
### Test DNS setup <a id="test-dns-setup"></a>
...
### Connection reset by peer <a id="connection-reset-by-peer"></a>
...
### Private Endpoint is in pending state <a id="private-endpoint-is-in-pending-state"></a>

Most likely, the Private Endpoint Resource ID wasn't added to the service allow-list. Revisit the [_Add Private Endpoint Resource ID to your services allow-list_ step](#add-private-endpoint-id-to-services-allow-list).

### Test connectivity <a id="test-connectivity"></a>
...
### Checking private endpoint filters <a id="checking-private-endpoint-filters"></a>
