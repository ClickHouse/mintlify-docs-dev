...
<Image img="/static/images/cloud/security/azure-pe.png" size="lg" alt="Overview of PrivateLink" background='white' />
...
<Image img="/static/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="Private Endpoints" border />
...
<Image img="/static/images/cloud/security/azure-private-link-center.png" size="lg" alt="Open Azure Private Center" border />
...
<Image img="/static/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Create Private Endpoint Basic" border />
...
<Image img="/static/images/cloud/security/azure-pe-resource.png" size="md" alt="Private Endpoint Resource Selection" border />
...
<Image img="/static/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Private Endpoint Virtual Network Selection" border />

Click the **Next: Tags** button.

---

<Image img="/static/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Private Endpoint DNS Configuration" border />
...
<Image img="/static/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Private Endpoint Tags" border />

Finally, click the **Create** button.

<Image img="/static/images/cloud/security/azure-pe-create-review.png" size="md" alt="Private Endpoint Review" border />
...
<Image img="/static/images/cloud/security/azure-pe-ip.png" size="lg" alt="Private Endpoint IP Address" border />
...
<Image img="/static/images/cloud/security/azure-pe-view.png" size="lg" alt="Private Endpoint View" border />

Under properties, find `id` field and copy this value:

**Preferred method: Using Resource ID**
<Image img="/static/images/cloud/security/azure-pe-resource-id.png" size="lg" alt="Private Endpoint Resource ID" border />
...
<Image img="/static/images/cloud/security/azure-pe-resource-guid.png" size="lg" alt="Private Endpoint Resource GUID" border />
...
<Image img="/static/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Private Link DNS Wildcard Setup" border />
...
<Image img="/static/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Remove Private Endpoint" border />
...
<Image img="/static/images/cloud/security/azure-privatelink-pe-filter.png" size="lg" alt="Private Endpoints Filter" border />
...
<Image img="/static/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="Private Endpoint DNS Name" border />
