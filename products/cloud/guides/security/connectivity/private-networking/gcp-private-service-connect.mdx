...
<Image img="/static/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Overview of Private Service Connect" border />
...
<Image img="/static/images/cloud/security/gcp-privatelink-pe-create.png" size="lg" alt="Private Endpoints" border />
...
<Image img="/static/images/cloud/security/gcp-psc-open.png" size="lg" alt="Open Private Service Connect in Google Cloud console" border />
...
<Image img="/static/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="Enable Global Access for Private Service Connect" border />
...
<Image img="/static/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="Copy PSC Connection ID" border />
...
<Image img="/static/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="Remove Private Endpoint from ClickHouse Cloud" border />
...
<Image img="/static/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="Private Endpoints Filter" border />
...
<Image img="/static/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="Private Endpoint DNS Name" border />
