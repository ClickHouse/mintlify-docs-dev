...
<Image img="/images/cloud/security/gcp-psc-overview.png" size="lg" alt="Overview of Private Service Connect" border />
...
## Obtain GCP service attachment and DNS name for Private Service Connect <a id="obtain-gcp-service-attachment-and-dns-name-for-private-service-connect"></a>
...
<Image img="/images/cloud/security/gcp-privatelink-pe-create.png" size="lg" alt="Private Endpoints" border />
...
## Create service endpoint <a id="create-service-endpoint"></a>
...
### Adding a private service connection <a id="adding-a-private-service-connection"></a>

First, you'll create a Private Service Connection.

#### Option 1: Using Google Cloud console <a id="option-1-using-google-cloud-console"></a>

In the Google Cloud console, navigate to **Network services -> Private Service Connect**.

<Image img="/images/cloud/security/gcp-psc-open.png" size="lg" alt="Open Private Service Connect in Google Cloud console" border />
...
<Image img="/images/cloud/security/gcp-psc-enable-global-access.png" size="md" alt="Enable Global Access for Private Service Connect" border />
...
<Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="lg" alt="Copy PSC Connection ID" border />

Copy ***PSC Connection ID***; you'll use it as ***Endpoint ID*** in the next steps.

#### Option 2: Using Terraform <a id="option-2-using-terraform"></a>
...
## Set private DNS name for endpoint <a id="set-private-dns-name-for-endpoint"></a>
...
## Add Endpoint ID to ClickHouse Cloud organization <a id="add-endpoint-id-to-clickhouse-cloud-organization"></a>
...
<Image img="/images/cloud/security/gcp-pe-remove-private-endpoint.png" size="lg" alt="Remove Private Endpoint from ClickHouse Cloud" border />
...
## Add "Endpoint ID" to ClickHouse service allow list <a id="add-endpoint-id-to-services-allow-list"></a>
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="lg" alt="Private Endpoints Filter" border />
...
## Accessing instance using Private Service Connect <a id="accessing-instance-using-private-service-connect"></a>
...
### Getting private DNS hostname <a id="getting-private-dns-hostname"></a>
...
<Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="lg" alt="Private Endpoint DNS Name" border />
...
### Checking endpoint filters <a id="checking-endpoint-filters"></a>
...
### Connecting to a remote database <a id="connecting-to-a-remote-database"></a>
