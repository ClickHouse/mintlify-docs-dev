...
## Database level encryption <a id="database-encryption"></a>
...
### Transparent Data Encryption (TDE) <a id="transparent-data-encryption-tde"></a>
...
### Customer Managed Encryption Keys (CMEK) <a id="customer-managed-encryption-keys-cmek"></a>
...
#### KMS key poller <a id="kms-key-poller"></a>
...
<Image img="/images/_snippets/cmek-performance.png" size="lg" alt="CMEK Performance Penalty" />
