...
<Steps>
<Step>
### Enable invitations <a id="enable-invitations"></a>
...
<Step>
### Note users to be re-invited <a id="note-users-to-be-reinvited"></a>
...
## Add non-SAML users to the organization <a id="add-non-saml-users"></a>
...
<Step>
### Users accept the invitation <a id="accept-invitation"></a>
...
<Step>
### Save queries and dashboards <a id="save-queries-and-dashboards"></a>
...
## Remove SAML <a id="remove-saml"></a>
