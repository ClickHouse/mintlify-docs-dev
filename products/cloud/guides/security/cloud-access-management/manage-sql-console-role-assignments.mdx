...
<Image img="/static/images/cloud/guides/sql_console/service_level_access/1_service_settings.png" size="lg"/>

Select `settings` from the popup menu.

<Image img="/static/images/cloud/guides/sql_console/service_level_access/2_service_settings.png" size="lg"/>

### Adjust SQL console access {#adjust-sql-console-access}

Under the "Security" section, find the "SQL console access" area:

<Image img="/static/images/cloud/guides/sql_console/service_level_access/3_service_settings.png" size="md"/>
...
<Image img="/static/images/cloud/guides/sql_console/service_level_access/4_service_settings.png" size="md"/>
...
<Image img="/static/images/cloud/guides/sql_console/service_level_access/5_service_settings.png" size="md"/>
...
<Image img="/static/images/cloud/guides/sql_console/service_level_access/6_service_settings.png" size="md"/>

A tab will open to the right of the page showing the total number of users and their roles:

<Image img="/static/images/cloud/guides/sql_console/service_level_access/7_service_settings.png" size="md"/>
