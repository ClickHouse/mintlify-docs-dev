...
## Accept an invitation <a id="accept-invitation"></a>
...
### Email and password <a id="email-and-password"></a>
...
### SAML single sign-on (SSO) <a id="saml-sso"></a>
...
## Manage multi-factor authentication (MFA) <a id="mfa"></a>
...
### Obtain a new recovery code <a id="obtain-recovery-code"></a>
...
## Account recovery <a id="account-recovery"></a>

### Forgot password <a id="forgot-password"></a>
...
### MFA self-service recovery <a id="mfa-self-serivce-recovery"></a>
...
### Lost MFA and recovery code <a id="lost-mfa-and-recovery-code"></a>
