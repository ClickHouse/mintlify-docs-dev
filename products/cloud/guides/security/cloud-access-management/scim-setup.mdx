...
## How SCIM works with ClickHouse Cloud <a id="how-scim-works"></a>
...
## Configure SCIM on your ClickHouse Cloud organization <a id="configure-clickhouse-cloud"></a>

<Steps>
<Step>
### Enable SCIM <a id="enable-scim-provisioning"></a>
...
<Step>
### Generate a SCIM access token <a id="generate-scim-token"></a>
...
<Step>
### Define the role mapping <a id="define-role-mapping"></a>
...
## Configure the ClickHouse Cloud application in Okta <a id="configure-okta"></a>

<Steps>
<Step>
### Open your ClickHouse Cloud application in Okta <a id="open-clickhouse-cloud-app"></a>
...
<Step>
### Connect Okta to the SCIM endpoint <a id="connect-okta-scim"></a>
...
<Step>
### Configure provisioning behavior <a id="configure-provisioning-behavior"></a>
...
<Step>
### Map user attributes <a id="map-user-attributes"></a>
...
<Step>
### Push groups and assign users <a id="push-groups-and-assign-users"></a>
...
## Test the integration <a id="test-the-integration"></a>
...
## Best practices for production <a id="best-practices"></a>
...
### "Test connector configuration" fails in Okta <a id="test-credentials-fails"></a>
...
### Users get created but have no permissions <a id="users-no-permissions"></a>
...
### Duplicate user in the member list <a id="duplicate-user"></a>
...
### Group push fails with "displayName not recognised" <a id="group-display-name"></a>
...
### Deactivated users still show as members <a id="deactivated-users-remaining"></a>
...
### I rotated the SCIM token and now Okta is failing <a id="token-rotation-issue"></a>
...
### I lost the SCIM token <a id="lost-token"></a>
