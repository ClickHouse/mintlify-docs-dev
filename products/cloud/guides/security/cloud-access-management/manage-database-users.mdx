...
### SQL console passwordless authentication <a id="sql-console-passwordless-authentication"></a>
...
## SQL console users and roles <a id="sql-console-users-and-roles"></a>
...
<Steps>
<Step>
#### Create `database_developer` and grant permissions <a id="create-role-grant-permissions"></a>
...
<Step>
#### Create SQL console user role <a id="create-sql-console-user-role"></a>
...
<Step>
#### The user is assigned the new role when they use SQL console <a id="use-assigned-new-role"></a>

The user will be assigned the role associated with their email address whenever they use SQL console. 
</Step>
</Steps>

## Database authentication <a id="database-authentication"></a>

### Database user ID and password <a id="database-user-id--password"></a>
...
### Database user with secure shell (SSH) authentication <a id="database-ssh"></a>
...
## Database permissions <a id="database-permissions"></a>
...
<Image img="/images/cloud/security/cloud-access-management/user_grant_permissions_options.png" alt='An illustration showing the different ways a user could be granted permissions' size="md" background="black"/>
...
### Database access listings with SQL console users <a id="database-access-listings-with-sql-console-users"></a>
...
<Steps>
<Step>
#### Get a list of all database grants <a id="get-a-list-of-all-database-grants"></a>
...
<Step>
#### Associate grant list to Console users with access to SQL console <a id="associate-grant-list-to-console-users-with-access-to-sql-console"></a>
...
## Warehouse users <a id="warehouse-users"></a>
