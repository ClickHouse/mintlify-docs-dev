...
## Set up a service role <a id="setup-service-roles"></a>

<Steps>
<Step>
### Grant roles to the service account <a id="grant-roles-to-service-account"></a>
...
<Step>
### Use SET ROLE to define session boundaries <a id="define-permission-boundaries"></a>
...
<Step>
### Set default roles for the service account <a id="set-default-role"></a>
...
<Step>
### Using SET ROLE over HTTP / programmatically <a id="use-set-role-programmatically"></a>
