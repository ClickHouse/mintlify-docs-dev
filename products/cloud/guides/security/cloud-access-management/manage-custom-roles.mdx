...
## Create custom roles <a id="create-custom-role"></a>
...
<Step>
### Select the `Roles` tab <a id="roles-tab"></a>
...
<Step>
### Select `Create new role` from the upper right <a id="create-new-role"></a>
...
<Step>
### Name the role <a id="name-the-role"></a>
...
<Step>
### Click `Allow` and select permission scope <a id="scope-permissions"></a>
...
<Step>
### Review your new role <a id="review-role"></a>
...
## Update custom roles <a id="update-custom-role"></a>
...
## Delete custom roles <a id="delete-custom-role"></a>
