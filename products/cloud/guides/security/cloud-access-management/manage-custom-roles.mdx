...
<Image img="/static/images/cloud/guides/control_plane/1_users_and_roles.png" size="lg"/>

### Select the `Roles` tab {#roles-tab}

Select the `Roles` tab from the top middle of the screen.

<Image img="/static/images/cloud/guides/control_plane/manage_custom_roles/2_custom_role.png" size="lg"/>
...
<Image img="/static/images/cloud/guides/control_plane/manage_custom_roles/3_custom_role.png" size="lg"/>
...
<Image img="/static/images/cloud/guides/control_plane/manage_custom_roles/4_custom_role.png" size="md"/>
...
<Image img="/static/images/cloud/guides/control_plane/manage_custom_roles/5_custom_role.png" size="md"/>
...
<Image img="/static/images/cloud/guides/control_plane/manage_custom_roles/6_custom_role.png" size="md"/>
