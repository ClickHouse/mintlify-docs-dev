...
## How to configure your IdP <a id="how-to-configure-your-idp"></a>

### Steps <a id="steps"></a>

<Steps>
<Step>
### Access Organization settings <a id="access-organization-settings"></a>

Click on your organization name in the lower left corner and select Organization details.
</Step>
<Step>
### Enable SAML single sign-on <a id="enable-saml-sso"></a>
...
Click the toggle next to `Enable SAML single sign-on`. Leave this screen open as you will refer back to it several times during the setup process.
   ...
   <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="Start SAML setup" force/>
</Step>
<Step>
### Create an application in your identity provider <a id="create-idp-application"></a>
...
ClickHouse doesn't support identity provider initiated sign-in. To make it easy for your users to access ClickHouse Cloud, set up a bookmark for your users using this sign-in URL format: `https://console.clickhouse.cloud/?connection={orgId}` where the `{orgID}` is your organization ID on the Organization details page.
   ...
   <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="Create identity provider application" force/>
</Step>
<Step>
### Add the metadata URL to your SAML configuration <a id="add-metadata-url"></a>
...
Obtain the `Metadata URL` from your SAML provider. Return to ClickHouse Cloud, click `Next: Provide metadata URL` and paste the URL in the text box.
   ...
   <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="Add metadata URL" force/> 
</Step>
<Step>
### Get domain verification code <a id="get-domain-verification-code"></a>
...
Click `Next: Verify your domains`. Enter your domain in the text box and click `Check domain`. The system will generate a random verification code for you to add to a TXT record with your DNS provider. 
   ...
   <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="Add domain to verify" force/> 
</Step>
<Step>
### Verify your domain <a id="verify-your-domain"></a>
...
It may take several minutes for the DNS record to update and be verified. You may leave the setup page and return later to complete the process without restarting.
   ...
   <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="Verify your domain" force/> 
</Step>
<Step>
### Update default role and session timeout <a id="update-defaults"></a>
...
<Step>
### Configure your admin user <a id="configure-your-admin-user"></a>
...
<Step>
### Remove other authentication methods <a id="remove-other-auth-methods"></a>
...
### Configure Okta SAML <a id="configure-okta-saml"></a>
...
### Configure Google SAML <a id="configure-google-saml"></a>
...
<Accordion title="Create a Google Web App">
   ...
   <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Google SAML App" force/>
...
### Configure Azure (Microsoft) SAML <a id="configure-azure-microsoft-saml"></a>
...
<Accordion title="Create an Azure Enterprise Application">
   ...
   5. Enter a name and select **Integrate any other application you don't find in the gallery (Non-gallery)**, then click **Create**.
      ...
      <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Azure Non-Gallery App" force/>
   ...
   11. Add (A) or update (U) the following under Attributes & Claims:
       ...
       | (U) /identity/claims/name            | Omitted       | user.mail        |
         ...
         <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="Attributes and Claims" force/>
...
### Configure Duo SAML <a id="configure-duo-saml"></a>
...
### User management with SAML SSO <a id="user-management-with-saml-sso"></a>
...
### Service provider-initiated SSO <a id="service-provider-initiated-sso"></a>
...
### Multi-org SSO <a id="multi-org-sso"></a>
