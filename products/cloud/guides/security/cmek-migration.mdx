---
sidebarTitle: 'Legacy CMEK migration'
...
OpenAPI and Terraform are both supported for this new process. For more information, check out our docs ([Enhanced Encryption](/products/cloud/guides/security/cmek), [Cloud API](/products/cloud/features/admin-features/api/api-overview), [Official Terraform Provider](https://registry.terraform.io/providers/ClickHouse/clickhouse/latest/docs)). 
...
## Manual migration <a id="manual-migration"></a>
...
## Terraform migration <a id="terraform-migration"></a>
