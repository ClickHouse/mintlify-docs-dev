...
<Image img="/static/images/cloud/security/compliance/pci_1.png" size="md" alt="Enable PCI" background='black'/>
...
<Image img="/static/images/cloud/security/compliance/pci_2.png" size="md" alt="PCI enabled" background='black'/>
...
<Image img="/static/images/cloud/security/compliance/pci_3.png" size="md" alt="Deploy to PCI region" background='black'/>
