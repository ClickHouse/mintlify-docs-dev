...
<Image img="/static/images/cloud/security/compliance/hipaa_1.png" size="md" alt="Request HIPAA enablement" background='black'/>
...
<Image img="/static/images/cloud/security/compliance/hipaa_2.png" size="md" alt="Submit a BAA request" background='black'/>
...
<Image img="/static/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA enabled" background='black'/>
...
<Image img="/static/images/cloud/security/compliance/hipaa_4.png" size="md" alt="Deploy to HIPAA region" background='black'/>
