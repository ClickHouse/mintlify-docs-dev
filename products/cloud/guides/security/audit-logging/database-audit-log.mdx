...
## Security relevant logs <a id="security-relevant-logs"></a>
...
## Retaining log data within services <a id="reatining-log-data-within-services"></a>
...
## Exporting logs <a id="exporting-logs"></a>
