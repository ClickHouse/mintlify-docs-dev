...
## Access the console log via the user interface <a id="console-audit-log-ui"></a>

<Steps>
<Step>
## Select organization <a id="select-org"></a>

In ClickHouse Cloud, navigate to your organization details. 

<Image img="/images/cloud/security/activity_log1.png" size="md" alt="ClickHouse Cloud activity tab" border />

<br/>
</Step>
<Step>
## Select audit <a id="select-audit"></a>
...
<Image img="/images/cloud/security/activity_log2.png" size="md" alt="ClickHouse Cloud Activity Table" border />

<br/>
</Step>
<Step>
## Use the search bar <a id="use-search-bar"></a>
...
<div class="eighty-percent">
    <Image img="/images/cloud/security/activity_log3.png" size="lg" alt="ClickHouse Cloud Activity CSV export" border />
</div>

## Access the console audit log via the API <a id="console-audit-log-api"></a>
...
## Log integrations <a id="log-integrations"></a>
