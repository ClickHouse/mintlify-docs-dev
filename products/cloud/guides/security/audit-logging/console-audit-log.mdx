...
<Image img="/static/images/cloud/security/activity_log1.png" size="md" alt="ClickHouse Cloud activity tab" border />
...
<Image img="/static/images/cloud/security/activity_log2.png" size="md" alt="ClickHouse Cloud Activity Table" border />
...
<div class="eighty-percent">
    <Image img="/static/images/cloud/security/activity_log3.png" size="lg" alt="ClickHouse Cloud Activity CSV export" border />
</div>
