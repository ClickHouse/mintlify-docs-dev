...
## Use masking policies (ClickHouse Cloud) <a id="masking-policies"></a>
...
### Basic masking policy <a id="basic-maasking-policy"></a>
...
### Conditional masking <a id="conditional-masking"></a>
...
### Multiple policies with priority <a id="multiple-policies-with-priority"></a>
...
### Hash-based masking <a id="hash-based-masking"></a>
...
### Managing masking policies <a id="managing-masking-policies"></a>
...
## Use string replacement functions <a id="using-string-functions"></a>
...
## Create masked `VIEW`s <a id="masked-views"></a>
...
## Use `MATERIALIZED` columns and column-level access restrictions <a id="materialized-ephemeral-column-restrictions"></a>
...
## Use query masking rules for log data <a id="use-query-masking-rules"></a>
