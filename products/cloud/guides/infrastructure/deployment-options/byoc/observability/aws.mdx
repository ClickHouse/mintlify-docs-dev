...
<Image img="/static/images/cloud/reference/byoc-mixin-1.png" size="lg" alt="BYOC Mixin 1" background='black'/>

<Image img="/static/images/cloud/reference/byoc-mixin-2.png" size="lg" alt="BYOC Mixin 2" background='black'/>

<Image img="/static/images/cloud/reference/byoc-mixin-3.png" size="lg" alt="BYOC Mixin 3" background='black'/>
...
<Image img="/static/images/cloud/reference/byoc-mixin-4.png" size="lg" alt="BYOC Mixin 4" background='black'/>
...
<Image img="/static/images/cloud/reference/byoc-mixin-5.png" size="lg" alt="BYOC Mixin 5" background='black'/>