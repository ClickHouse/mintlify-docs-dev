...
## Benefits over open-source <a id="benefits-over-os"></a>
...
<Image img="/images/cloud/reference/private-gov-architecture.png" size="md" alt="ClickHouse Government Architecture" background='black'/>

<br />

## Supported configurations <a id="supported-configurations"></a>
...
## Onboarding process <a id="onboarding-process"></a>
