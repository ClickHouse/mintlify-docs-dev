...
<Image img="/static/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Test the example query" />

Next, save the query:

<Image img="/static/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Save example query" />
...
<Image img="/static/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="Configure query endpoint" />
...
<Image img="/static/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Endpoint curl command" />
...
<Image img="/static/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="endpoint curl test" />
...
<Image img="/static/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Endpoint monitoring" />
