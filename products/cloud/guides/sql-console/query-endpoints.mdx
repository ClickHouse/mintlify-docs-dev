...
## Pre-requisites <a id="quick-start-guide"></a>
...
<Steps>
<Step>
### Create a saved query <a id="creating-a-saved-query"></a>
...
<Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Test the example query" />

Next, save the query:

<Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Save example query" />
...
<Step>
### Configuring the query API endpoint <a id="configuring-the-query-api-endpoint"></a>
...
<Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="Configure query endpoint" />
...
<Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Endpoint curl command" />
...
<Step>
### Query API parameters <a id="query-api-parameters"></a>
...
<Step>
### Testing and monitoring <a id="testing-and-monitoring"></a>

Once a Query API endpoint is created, you can test that it works by using `curl` or any other HTTP client:

<Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="endpoint curl test" />
...
<Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Endpoint monitoring" />
</Step>
</Steps>
...
### Request configuration <a id="request-configuration"></a>

#### URL parameters <a id="url-params"></a>
...
#### Error handling best practices <a id="error-handling-best-practices"></a>
...
### Upgrading endpoint versions <a id="upgrading-endpoint-versions"></a>
...
### Basic request <a id="basic-request"></a>
...
### Request with query variables and version 2 on JSONCompactEachRow format <a id="request-with-query-variables-and-version-2-on-jsoncompacteachrow-format"></a>
...
### Request with array in the query variables that inserts data into a table <a id="request-with-array-in-the-query-variables-that-inserts-data-into-a-table"></a>
...
### Request with ClickHouse settings `max_threads` set to 8 <a id="request-with-clickhouse-settings-max_threads-set-to-8"></a>
...
### Request and parse the response as a stream <a id="request-and-parse-the-response-as-a-stream"></a>
...
### Insert a stream from a file into a table <a id="insert-a-stream-from-a-file-into-a-table"></a>
