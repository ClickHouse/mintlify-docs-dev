...
For comprehensive setup including detailed Prometheus/Grafana configuration and advanced alerting, see the [ClickHouse Cloud Observability Guide](/core/guides/use-cases/observability/cloud-monitoring#prometheus).
