...
## Shared table <a id="shared-table"></a>
...
### Example <a id="shared-table-example"></a>
...
## Separate tables <a id="separate-tables"></a>
...
### Example <a id="separate-tables-example"></a>
...
## Separate databases <a id="separate-databases"></a>
...
### Example <a id="separate-databases-example"></a>
...
## Separate cloud service <a id="separate-service"></a>
...
### Example <a id="separate-service-example"></a>
