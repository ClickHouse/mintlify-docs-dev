...
<Image img="/static/images/cloud/manage/backups/arn.png" alt="AWS S3 ARN" size="lg" />
...
<Image img="/static/images/cloud/manage/backups/change_external_backup.png" alt="Change external backup" size="lg" />
...
<Image img="/static/images/cloud/manage/backups/configure_arn_s3_details.png" alt="Configure AWS IAM Role ARN and S3 bucket details" size="lg" />
...
<Image img="/static/images/cloud/manage/backups/view_backups.png" alt="View backups stored in your bucket" size="lg" />
...
<Image img="/static/images/cloud/manage/backups/backup_command.png" alt="Get SQL command used to restore backup" size="md" />
...
<Image img="/static/images/cloud/manage/backups/gcp_configure.png" alt="Configure GCP HMAC Key and Secret" size="md" />
...
<Image img="/static/images/cloud/manage/backups/gcp_stored_backups.png" alt="View backups stored in your bucket" size="lg" />
...
<Image img="/static/images/cloud/manage/backups/gcp_restore_command.png" alt="Get SQL command used to restore backup" size="md" />
...
<Image img="/static/images/cloud/manage/backups/azure_connection_details.png" alt="Provide connection string and container name for your Azure storage account" size="md" />
...
<Image img="/static/images/cloud/manage/backups/view_backups_azure.png" alt="View backups stored in your bucket" size="md" />
...
<Image img="/static/images/cloud/manage/backups/restore_backups_azure.png" alt="Restore backups in Azure" size="md" />
