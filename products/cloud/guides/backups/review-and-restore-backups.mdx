...
## Backup status list <a id="backup-status-list"></a>
...
<Image img="/images/cloud/manage/backup-status-list.png" size="md" alt="List of backup statuses in ClickHouse Cloud" border/>

## Understanding backup cost <a id="understanding-backup-cost"></a>
...
<Image img="/images/cloud/manage/backup-usage.png" size="md" alt="Backup usage chart in ClickHouse Cloud" border/>
...
## Restore a backup <a id="restore-a-backup"></a>
...
<Image img="/images/cloud/manage/backup-restore.png" size="md" alt="Restoring a backup in ClickHouse Cloud" />

The new service will show in the services list as `Provisioning` until it is ready:

<Image img="/images/cloud/manage/backup-service-provisioning.png" size="md" alt="Provisioning service in progress" border/>

## Working with your restored service <a id="working-with-your-restored-service"></a>
...
### Use the **new restored service** <a id="use-the-new-restored-service"></a>
...
### Migrate data from the **newly restored service** back to the **original service** <a id="migrate-data-from-the-newly-restored-service-back-to-the-original-service"></a>
...
## Undeleting or undropping tables <a id="undeleting-or-undropping-tables"></a>
...
## Backup durations <a id="backup-durations"></a>
...
## Export backups to your own cloud account <a id="export-backups-to-your-own-cloud-account"></a>
