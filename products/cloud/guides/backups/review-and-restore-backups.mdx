...
<Image img="/static/images/cloud/manage/backup-status-list.png" size="md" alt="List of backup statuses in ClickHouse Cloud" border/>
...
<Image img="/static/images/cloud/manage/backup-usage.png" size="md" alt="Backup usage chart in ClickHouse Cloud" border/>
...
<Image img="/static/images/cloud/manage/backup-restore.png" size="md" alt="Restoring a backup in ClickHouse Cloud" />

The new service will show in the services list as `Provisioning` until it is ready:

<Image img="/static/images/cloud/manage/backup-service-provisioning.png" size="md" alt="Provisioning service in progress" border/>
