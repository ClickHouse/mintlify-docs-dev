...
ClickHouse Cloud supports HTTPS, native interfaces, and the [MySQL wire protocol](/integrations/connectors/data-integrations/drivers-and-interfaces/mysql). Support for more interfaces such as Postgres is coming soon.
...
User-defined functions in ClickHouse Cloud are in [private preview](/reference/functions/regular-functions/udf).
