...
## ClickHouse Cloud architecture <a id="clickhouse-cloud-architecture"></a>
...
### Database and table engines <a id="database-and-table-engines"></a>
...
### Federated queries <a id="federated-queries"></a>
...
### Named collections <a id="named-collections"></a>
...
## Operational defaults and considerations <a id="operational-defaults-and-considerations"></a>
...
### Operational limits <a id="operational-limits"></a>

#### `max_parts_in_total: 10,000` <a id="max_parts_in_total-10000"></a>
...
#### `max_concurrent_queries: 1,000` <a id="max_concurrent_queries-1000"></a>
...
#### `max_table_size_to_drop: 1,000,000,000,000` <a id="max_table_size_to_drop-1000000000000"></a>
Increased this setting from 50GB to allow for dropping of tables/partitions up to 1TB.

### System settings <a id="system-settings"></a>
...
### Advanced security administration <a id="advanced-security-administration"></a>
