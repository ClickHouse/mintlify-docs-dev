...
ClickHouse Cloud supports HTTPS, native interfaces, and the [MySQL wire protocol](/core/concepts/features/interfaces/mysql). Support for more interfaces such as Postgres is coming soon.
...
[Named collections](/core/concepts/features/configuration/server-config/named-collections) aren't currently supported in ClickHouse Cloud.
