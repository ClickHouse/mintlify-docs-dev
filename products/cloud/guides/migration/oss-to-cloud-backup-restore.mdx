...
## Overview <a id="overview-migration-approaches"></a>
...
## OSS preparation <a id="oss-setup"></a>
...
### From MergeTree table to ReplicatedMergeTree table <a id="mergetree-to-replicatedmergetree"></a>
...
### Distributed tables with ReplicatedMergeTree <a id="distributed-tables"></a>
...
## Cloud preparation <a id="cloud-setup"></a>
...
## Taking the backup (on self-managed deployment) <a id="taking-a-backup-on-oss"></a>
...
## Restore to ClickHouse Cloud <a id="restore-to-clickhouse-cloud"></a>
