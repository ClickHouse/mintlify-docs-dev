...
- Using the [`remoteSecure()`](/get-started/setup/migration-guides/oss-to-cloud/clickhouse-to-cloud) function in which data is directly pulled/pushed.
...
If you're running a single instance, follow the steps in ["Migrating between self-managed ClickHouse and ClickHouse Cloud using remoteSecure"](/get-started/setup/migration-guides/oss-to-cloud/clickhouse-to-cloud) instead.
</Info>
...
<Image img="/static/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="create a new service"/> 
...
<Image img="/static/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="setup service preferences"/> 

#### Create an access role {#create-an-access-role}

Open SQL console

<Image img="/static/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="setup service preferences"/>
...
<Image img="/static/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="backup, data and metadata"/>
