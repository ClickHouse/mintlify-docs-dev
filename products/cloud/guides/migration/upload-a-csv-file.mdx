...
<Image img="/static/images/cloud/migrate/csv_01.png" alt="upload_file_02" />

If your service is idle you will need to wake it.

Select `Data sources` in the left hand tab as shown below:

<Image img="/static/images/cloud/migrate/csv_02.png" alt="upload_file_03" />

Next select `Upload a file` on the right side of the data sources page:

<Image img="/static/images/cloud/migrate/csv_03.png" alt="upload_file_04" />
...
<Image img="/static/images/cloud/migrate/csv_04.png" alt="upload_file_05" />
...
<Image img="/static/images/cloud/migrate/csv_08.png" alt="upload_file_08" />
...
<Image img="/static/images/cloud/migrate/csv_05.png" alt="upload_file_05" />
...
<Image img="/static/images/cloud/migrate/csv_06.png" alt="upload_file_06" />
...
<Image img="/static/images/cloud/migrate/csv_07.png" alt="upload_file_07" />
...
<Image img="/static/images/cloud/migrate/csv_09.png" alt="upload_file_09" />
...
<Image img="/static/images/cloud/migrate/csv_10.png" alt="upload_file_11" />
