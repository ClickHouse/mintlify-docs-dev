...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="Overview of Secure S3 Access with ClickHouse"/>
<br/>
...
## Obtain the IAM role ARN of your ClickHouse service <a id="obtaining-the-clickhouse-service-iam-role-arn"></a>
...
### Deploying with CloudFormation stack <a id="option-1-deploying-with-cloudformation-stack"></a>
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="CloudFormation stack output showing IAM Role ARN" border />

### Manually create IAM role <a id="option-2-manually-create-iam-role"></a>
...
## Access your S3 bucket with the ClickHouseAccess role <a id="access-your-s3-bucket-with-the-clickhouseaccess-role"></a>
...
## Advanced action control <a id="advanced-action-control"></a>
