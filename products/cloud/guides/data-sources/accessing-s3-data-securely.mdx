...
<Image img="/static/images/cloud/security/secures3.png" size="lg" alt="Overview of Secure S3 Access with ClickHouse"/>
<br/>
...
<Image img="/static/images/cloud/security/secures3_arn.png" size="lg" alt="Obtaining ClickHouse service IAM Role ARN" border />
...
<Image img="/static/images/cloud/security/secures3_output.png" size="lg" alt="CloudFormation stack output showing IAM Role ARN" border />
