...
<Steps>
<Step>
### Create a Google Cloud service account <a id="create-gcs-account"></a>
...
<Step>
### Grant bucket access to the service account <a id="grant-bucket-access-to-service-account"></a>

You can grant access at either the project level or individual bucket level.

#### Option 1: Grant access to specific buckets (recommended) <a id="option-1"></a>
...
#### Option 2: Grant project-level access <a id="option-2"></a>
...
<Step>
### Generate HMAC keys for the service account <a id="generate-hmac-keys-for-service-account"></a>
...
## Use HMAC keys with ClickHouse Cloud <a id="use-hmac-keys-with-clickhouse-cloud"></a>
...
## HMAC authentication in ClickPipes for GCS <a id="hmac-authentication-clickpipes-for-gcs"></a>
...
### Use separate service accounts for different environments <a id="separate-service-accounts"></a>
...
### Apply least-privilege access <a id="apply-least-privilege-access"></a>
...
### Rotate HMAC keys regularly <a id="rotate-hmac-keys"></a>
...
### Monitor access with Cloud Audit Logs <a id="monitor-access"></a>
