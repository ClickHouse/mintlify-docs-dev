...
<Image img="/static/images/cloud/guides/accessing-data/GCS/IAM_and_admin.png" size="md" alt=""/>

2. Click `Service accounts` from the left-hand menu, then click `Create service account`:

<Image img="/static/images/cloud/guides/accessing-data/GCS/create_service_account.png" size="md" alt=""/>
...
<Image img="/static/images/cloud/guides/accessing-data/GCS/create_and_continue.png" size="sm" alt=""/>

Grant the service account the `Storage Object User` role:

<Image img="/static/images/cloud/guides/accessing-data/GCS/storage_object_user.png" size="sm" alt=""/>
...
<Image img="/static/images/cloud/guides/accessing-data/GCS/note_service_account_email.png" size="md" alt=""/>
...
<Image img="/static/images/cloud/guides/accessing-data/GCS/cloud_storage_settings.png" size="sm" alt=""/>
...
<Image img="/static/images/cloud/guides/accessing-data/GCS/create_key_for_service_account.png" size="md" alt=""/>

Select the service account you created earlier (e.g clickhouse-gcs-access@your-project.iam.gserviceaccount.com)

Click `Create key`:

<Image img="/static/images/cloud/guides/accessing-data/GCS/create_a_key.png" size="md" alt=""/>
...
<Image img="/static/images/cloud/guides/accessing-data/GCS/clickpipes_hmac_key.png" size="md" alt=""/>
