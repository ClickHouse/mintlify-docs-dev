...
## Static IPs API <a id="static-ips-api"></a>
...
<Image img="/images/_snippets/aws-rds-mysql.png" size="lg" alt="AWS Security group rules" border />
...
<Image img="/images/_snippets/gcp-authorized-network.png" size="md" alt="GCP Authorized networks" border />
