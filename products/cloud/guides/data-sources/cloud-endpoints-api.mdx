...
<Image img="/static/images/_snippets/aws-rds-mysql.png" size="lg" alt="AWS Security group rules" border />
...
<Image img="/static/images/_snippets/gcp-authorized-network.png" size="md" alt="GCP Authorized networks" border />
