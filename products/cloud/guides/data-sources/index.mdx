...
## Cloud integrations <a id="cloud-integrations"></a>
...
## Additional connections for external data sources <a id="additional-connections-for-external-data-sources"></a>

### ClickPipes for data ingestion <a id="clickpipes-for-data-ingestion"></a>
...
### Table functions as external data sources <a id="table-functions-as-external-data-sources"></a>
