...
ClickHouse supports a number of table functions to access external data sources. For more information, refer to [table functions](/reference/functions/table-functions) in the SQL reference section.
