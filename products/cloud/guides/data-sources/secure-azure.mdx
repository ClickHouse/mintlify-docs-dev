...
## Network configuration (Cross-region only) <a id="network-config"></a>
...
<Steps>
<Step>
### Find your ClickHouse Cloud egress IPs <a id="find-egress-ips"></a>
...
<Step>
### Configure Azure storage firewall <a id="configure-firewall"></a>
...
## ClickPipes configuration <a id="clickpipes-config"></a>
