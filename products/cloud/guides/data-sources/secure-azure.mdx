...
- Reading data from Azure Blob Storage using the [azureBlobStorage table function](/core/reference/functions/table-functions/azureBlobStorage)
- Creating external tables with the [AzureBlobStorage table engine](/core/reference/engines/table-engines/integrations/azureBlobStorage) 
