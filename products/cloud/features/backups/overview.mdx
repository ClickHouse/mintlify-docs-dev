...
<Image img="/static/images/cloud/manage/backup-chain.png" size="lg" alt="Backup chain example in ClickHouse Cloud" />
...
Currently, we don't support cross-cloud backups, nor backup / restore for services utilizing [Transparent Data Encryption (TDE)](/products/cloud/guides/security/cmek#transparent-data-encryption-tde) or for regulated services.
</Info>
