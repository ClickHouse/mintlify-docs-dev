...
### How backups work in ClickHouse Cloud <a id="how-backups-work-in-clickhouse-cloud"></a>
...
<Image img="/images/cloud/manage/backup-chain.png" size="lg" alt="Backup chain example in ClickHouse Cloud" />

### Default backup policy <a id="default-backup-policy"></a>
...
## Bring Your Own Bucket (BYOB) Backups <a id="byob"></a>
...
### Backup options <a id="backup-options"></a>

To export backups to your own cloud account, you have two options:

<Steps>
<Step>
##### Via Cloud Console UI <a id="via-ui"></a>
...
<Step>
##### Using SQL commands <a id="using-commands"></a>
