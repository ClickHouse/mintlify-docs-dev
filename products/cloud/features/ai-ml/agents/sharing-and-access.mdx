...
## Resource sharing <a id="resource-sharing"></a>
...
## Share an agent <a id="share-an-agent"></a>
...
<Image img="/images/cloud/agent-builder/sharing/sharing.png" alt="Bottom of the Agent Builder panel with the share icon highlighted and a badge showing one shared principal" size="sm"/>
...
<Image img="/images/cloud/agent-builder/sharing/share-agent-modal.png" alt="Share modal with User and Group Permissions section, a search input, an existing user with an Owner role, a Share with everyone in ClickHouse toggle, and Cancel and Save Changes buttons" size="md"/>
...
## Default agent <a id="default-agent"></a>
...
## Admin operations <a id="admin-operations"></a>
