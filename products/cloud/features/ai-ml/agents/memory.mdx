...
## How memory works <a id="how-it-works"></a>
...
## Manage your memories <a id="manage-your-memories"></a>
...
<Image img="/images/cloud/agent-builder/memory/memories.png" alt="Memories panel showing the brain icon highlighted in the left navigation, a filter input, an Add button, a Use memory checkbox, a memory entry with edit and delete controls, and an Admin Settings button" size="sm"/>

Memory is private to your user. Other people's agents never see your entries, and your agents never see theirs.

### Create a memory <a id="create-memory"></a>
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="Memory panel with the Create Memory + button highlighted" size="sm"/>

### Filter memories <a id="filter-memories"></a>

Use the **Filter memories** input at the top of the panel to find an entry by key.

<Image img="/images/cloud/agent-builder/memory/filter.png" alt="Memory panel with the Filter memories input highlighted and 'demo' typed in" size="sm"/>

### Edit a memory <a id="edit-memory"></a>

Click the pencil icon on a memory to open the **Edit Memory** dialog. Adjust the Key or Value and click **Save**.

<Image img="/images/cloud/agent-builder/memory/edit.png" alt="Memory entry with the Edit Memory pencil icon highlighted" size="sm"/>

### Delete a memory <a id="delete-memory"></a>

Click the trash icon on a memory to remove it.

<Image img="/images/cloud/agent-builder/memory/delete.png" alt="Memory entry with the Delete Memory trash icon highlighted" size="sm"/>

## Toggle memory <a id="toggle-memory"></a>
...
<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="Memory panel with the Use memory checkbox highlighted at the top" size="sm"/>

## Memory best practices <a id="memory-best-practices"></a>
