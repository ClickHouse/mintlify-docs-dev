...
## Provider and model <a id="provider-and-model"></a>
...
## Context and output limits <a id="context-and-output-limits"></a>
...
## Reasoning controls <a id="reasoning-controls"></a>
...
## Conversation behavior <a id="conversation-behavior"></a>
