...
<Image img="/images/cloud/agent-builder/web-search/web-search.png" alt="Capabilities panel with the Web Search section highlighted, showing the Web Search checkbox" size="sm"/>

## How a search round works <a id="how-a-search-round-works"></a>
