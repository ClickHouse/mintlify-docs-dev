...
## Enable vision capabilities <a id="enable-it"></a>
...
## Use vision capabilities <a id="use-it"></a>
...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="Message composer with the paperclip menu open showing Upload to Provider, Upload as Text, and Upload to Code Environment options" size="lg"/>
...
## Combine vision with other tools <a id="combine-with-other-tools"></a>
