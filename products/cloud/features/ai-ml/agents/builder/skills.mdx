...
## Anatomy of a skill <a id="anatomy-of-a-skill"></a>
...
## Use a skill <a id="use-a-skill"></a>
...
## Manage skills <a id="manage-skills"></a>
...
## Skills vs. instructions <a id="skills-vs-instructions"></a>
