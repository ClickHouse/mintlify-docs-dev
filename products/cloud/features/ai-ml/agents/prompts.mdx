...
## Create a prompt <a id="create-a-prompt"></a>
...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="Prompts panel with the + button highlighted on the left and the Create Prompt form open on the right showing Prompt Name, Text, Category, Special variables, Description, and Command fields, with a Create Prompt button" size="lg"/>

## Use a prompt <a id="use-a-prompt"></a>

In the Prompts panel, open the **...** menu on a prompt card and choose **Preview**:

<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="Prompts panel with a prompt selected, its details visible on the right, and a context menu showing Preview and Edit options" size="lg"/>
...
<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="Prompt preview modal showing the prompt title, author, date, body text, and a Use Prompt button" size="md"/>

## Share prompts <a id="share-prompts"></a>
...
## Prompts vs. skills vs. instructions <a id="prompts-vs-skills-vs-instructions"></a>
