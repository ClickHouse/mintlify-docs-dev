...
<Step>
## Open the AI Chat panel <a id="open-panel"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/1_open_chat.png" alt="Open AI Chat flyout" size="md"/>
</Step>
<Step>
## Accept the data usage consent (first run) <a id="consent"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/2_consent.png" alt="Consent dialog" size="md"/>
</Step>
<Step>
## Choose a chat mode <a id="modes"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/3_modes.png" alt="Mode selection" size="sm"/>
</Step>
<Step>
## Compose and send a message <a id="compose"></a>
...
<Step>
## Understanding “Agent” thinking steps <a id="thinking-steps"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/4_thinking.png" alt="Thinking steps" size="md"/>
</Step>
<Step>
## Starting new chats <a id="new-chats"></a>

Click the “New Chat” button to clear context and begin a fresh session.
</Step>
<Step>
## Viewing chat history <a id="history"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/5_history.png" alt="Chat history list" size="md"/>
</Step>
<Step>
## Working with generated SQL <a id="sql-actions"></a>
...
<Image img="/images/use-cases/AI_ML/AIChat/6_result_actions.png" alt="Result actions" size="md"/>

<Image img="/images/use-cases/AI_ML/AIChat/7_open_in_editor.png" alt="Open generated query in editor" size="md"/>
</Step>
<Step>
## Stopping or interrupting a response <a id="interrupt"></a>
...
<Step>
## Keyboard shortcuts <a id="shortcuts"></a>
