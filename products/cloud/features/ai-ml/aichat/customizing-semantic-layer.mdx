...
## Creating AGENTS.md <a id="creating-agents-md"></a>

<Steps>
<Step>
### Create the saved query <a id="create-query"></a>
...
<Step>
### Add your instructions <a id="add-instructions"></a>
...
### Treat context as a finite resource <a id="finite-resource"></a>
...
### Find the right altitude <a id="right-altitude"></a>
...
### Organize with structured sections <a id="structured-sections"></a>
...
### Provide diverse, canonical examples <a id="canonical-examples"></a>
...
### Keep it minimal yet complete <a id="minimal-complete"></a>
...
## Example: Calculated Metrics from raw data <a id="example-calculated-metrics"></a>
...
## Example: Business logic rules <a id="example-business-logic"></a>
...
## Example: Data structure quirks <a id="example-data-quirks"></a>
...
## Example: domain terminology <a id="example-terminology"></a>
