...
## Remote MCP server vs open-source MCP server <a id="remote-vs-oss"></a>
...
## Enabling the remote MCP server <a id="enabling"></a>
...
### Query and schema exploration <a id="query-and-schema"></a>
