...
## Enable remote MCP server for Cloud <a id="enable-remote-mcp-server"></a>
...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Select MCP in the Connect Modal" size="md"/>

Toggle the button on to enable MCP for the service:

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="Enable MCP Server" size="md"/>
...
## Setup remote MCP for development <a id="setup-clickhouse-cloud-remote-mcp-server"></a>
...
### Claude web UI <a id="claude-web"></a>
...
### Exploring your data <a id="exploring-data"></a>
...
### Running analytical queries <a id="running-queries"></a>
...
### Managing services and infrastructure <a id="managing-services"></a>
...
### Monitoring costs <a id="monitoring-costs"></a>
