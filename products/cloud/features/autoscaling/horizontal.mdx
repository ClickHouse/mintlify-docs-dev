...
<Image img="/static/images/cloud/manage/scaling-patch-request.png" size="lg" alt="Scaling PATCH request" border/>

*`PATCH` request to update `numReplicas`*

<Image img="/static/images/cloud/manage/scaling-patch-response.png" size="md" alt="Scaling PATCH response" border/>
...
<Image img="/static/images/cloud/manage/scaling-configure.png" size="md" alt="Scaling configuration settings" border/>
...
<Image img="/static/images/cloud/manage/scaling-memory-allocation.png" size="md" alt="Scaling memory allocation" border />
