...
<Image img="/static/images/cloud/features/autoscaling/scheduled-scaling-1.png" size="md" alt="The Scaling Schedules interface in the ClickHouse Cloud console, showing time-based scaling rules" border/>

<Image img="/static/images/cloud/features/autoscaling/scheduled-scaling-2.png" size="md" alt="Configuring a scheduled scaling rule in the ClickHouse Cloud console" border/>
