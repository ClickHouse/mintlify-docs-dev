...
<Image img="/static/images/cloud/features/mbb/vertical_scaling.png" size="lg" alt="Example diagram for a cluster with 3 replicas which gets vertically scaled" />
