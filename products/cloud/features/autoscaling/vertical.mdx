...
## Configuring vertical auto scaling <a id="configuring-vertical-auto-scaling"></a>
...
<Image img="/images/cloud/manage/AutoScaling.png" size="lg" alt="Scaling settings page" border/>
