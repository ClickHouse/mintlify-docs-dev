...
## CPU-based Scaling <a id="cpu-based-scaling"></a>
...
### Example <a id="cpu-scaling-example"></a>
...
## Memory-based recommendations <a id="memory-based-recommendations"></a>
...
### How headroom is calculated <a id="how-headroom-is-calculated"></a>
...
### Final recommendation <a id="final-recommendation"></a>
...
## Two-window recommender <a id="two-window-recommender"></a>
...
<Image img="/images/cloud/features/autoscaling/two-window-recommender.png" size="lg" alt="Two-window recommender merging logic" />
