...
<Image img="/static/images/cloud/dashboards/2_dashboards.png" size="md" alt="Create a saved query" border/>
...
<Image img="/static/images/cloud/dashboards/3_dashboards.png" size="md" alt="Save query" border/>
...
<Image img="/static/images/cloud/dashboards/4_dashboards.png" size="md" alt="A bar chart visualization of a query's results" border/>
...
<Image img="/static/images/cloud/dashboards/5_dashboards.png" size="md" alt="Create a new dashboard" border/>
...
<Image img="/static/images/cloud/dashboards/6_dashboards.png" size="md" alt="Add a visualization" border/>
...
<Image img="/static/images/cloud/dashboards/7_dashboards.png" size="md" alt="Visualize query results as a table" border/>
...
<Image img="/static/images/cloud/dashboards/8_dashboards.png" size="md" alt="Edit the underlying query" border/>
...
<Image img="/static/images/cloud/dashboards/9_dashboards.png" size="md" alt="Adjust global filters" border/>
...
<Image img="/static/images/cloud/dashboards/10_dashboards.png" size="md" alt="Changing query parameter" border/>
...
<Image img="/static/images/cloud/dashboards/11_dashboards.png" size="md" alt="Control the filter on the line chart" border/>
