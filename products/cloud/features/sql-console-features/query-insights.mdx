...
## Query overview <a id="query-overview"></a>
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Query Insights UI Latency Chart" border/>
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Query Insights UI Recent Queries Table" border/>
