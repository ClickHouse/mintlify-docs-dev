...
SQL UDFs can be created using the [`CREATE FUNCTION`](/core/reference/statements/create/function) statement from a lambda expression.
...
6. For this example, use the default settings. For a full list of configuration parameters, see [Executable user-defined functions](/core/reference/functions/regular-functions/udf#executable-user-defined-functions).
