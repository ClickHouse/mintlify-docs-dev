...
## SQL user-defined functions <a id="sql-udfs"></a>
...
## User-defined functions created via UI <a id="ui-udfs"></a>
...
<Steps>
<Step>
### Create the Python file <a id="create-python-file"></a>
...
<Step>
### Bundle dependencies and local files <a id="bundle-dependencies"></a>
...
<Step>
### Create a UDF via the UI <a id="create-udf-via-ui"></a>
...
<Step>
### Test your UDF <a id="test-your-udf"></a>
...
<Step>
### Create a new version <a id="create-new-version"></a>
