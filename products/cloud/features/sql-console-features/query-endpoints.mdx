...
<Image img="/static/images/cloud/guides/query-endpoints/console-api-keys.png" size="md" alt="API Keys"/>

2. Click **Edit** next to the API key used for Query API endpoints

<Image img="/static/images/cloud/guides/query-endpoints/api-key-edit.png" size="md" alt="Edit"/>
...
<Image img="/static/images/cloud/guides/query-endpoints/specific-locations.png" size="md" alt="Specific locations"/>
