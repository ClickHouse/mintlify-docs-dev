...
<Image img="/static/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Configure Grafana Metrics Endpoint" border/>

<br />

Once configured, you should see the metrics in the drop-down that you can select to configure dashboards:

<Image img="/static/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Grafana Metrics Explorer Drop-down" border/>

<br />

<Image img="/static/images/integrations/prometheus-grafana-chart.png" size="md" alt="Grafana Metrics Explorer Chart" border/>
...
<Image img="/static/images/integrations/prometheus-grafana-alloy.png" size="md" alt="Grafana Alloy" border/>
...
<Image img="/static/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Grafana Metrics Explorer" border/>
...
<Image img="/static/images/integrations/prometheus-datadog.png" size="md" alt="Prometheus Datadog Integration" />
