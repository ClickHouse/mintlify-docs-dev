...
## Receiving notifications <a id="receiving-notifications"></a>
...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="ClickHouse Cloud notifications flyout" border/>

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="ClickHouse Cloud notifications activity log" border/>

## Customizing notifications <a id="customizing-notifications"></a>
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="ClickHouse Cloud notifications settings screen" border/>

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="ClickHouse Cloud notification delivery settings" border/>

<Note>
Certain **required** notifications such as **Payment failed** aren't configurable.
</Note>

## Service notifications <a id="service-notifications"></a>
...
## ClickPipes notifications <a id="clickpipes-notifications"></a>

ClickHouse sends ClickPipes notifications when your ClickPipe is experiencing failures or issues. 

## Billing notifications <a id="billing-notifications"></a>
...
## Supported notifications <a id="supported-notifications"></a>
