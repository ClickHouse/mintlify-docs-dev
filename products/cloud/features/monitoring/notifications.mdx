...
<Image img="/static/images/cloud/manage/notifications-1.png" size="md" alt="ClickHouse Cloud notifications flyout" border/>

<Image img="/static/images/cloud/manage/notifications-2.png" size="md" alt="ClickHouse Cloud notifications activity log" border/>
...
<Image img="/static/images/cloud/manage/notifications-3.png" size="md" alt="ClickHouse Cloud notifications settings screen" border/>

<Image img="/static/images/cloud/manage/notifications-4.png" size="md" alt="ClickHouse Cloud notification delivery settings" border/>
