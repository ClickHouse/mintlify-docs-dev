...
All ClickHouse instances come with a set of [system tables](/core/reference/system-tables/overview) contained in the `system` database that contain information about:
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Native advanced observability dashboard" border/>
...
For more details, see [querying across nodes](/core/reference/system-tables/overview#querying-across-nodes).
...
- [System tables reference](/core/reference/system-tables/overview) — Full reference for all available system tables
