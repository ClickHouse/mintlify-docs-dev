...
<Image img="/static/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Advanced dashboard in ClickHouse Cloud" border/>
...
<Image img="/static/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Query Insights UI Overview" border/>
...
<Image img="/static/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Query Insights latency chart" border/>
...
<Image img="/static/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Query Insights recent queries table" border/>
...
<Image img="/static/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Query Insights UI Query Drill down" border/>
...
<Image img="/static/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Query Insights UI Query Information" border/>
