...
### Service health <a id="service-health"></a>
...
### Resource utilization <a id="resource-utilization"></a>
...
#### Memory and CPU <a id="memory-and-cpu"></a>
...
#### Data transfer <a id="data-transfer"></a>
...
### Advanced dashboard <a id="advanced-dashboard"></a>
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Advanced dashboard in ClickHouse Cloud" border/>
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Query Insights UI Overview" border/>

### Top-level metrics <a id="top-level-metrics"></a>
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Query Insights latency chart" border/>
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Query Insights recent queries table" border/>

### Query drill-down <a id="query-drill-down"></a>
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Query Insights UI Query Drill down" border/>
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Query Insights UI Query Information" border/>
