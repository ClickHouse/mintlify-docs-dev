...
## Accessing the advanced dashboard <a id="accessing-the-advanced-dashboard"></a>
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Advanced dashboard"/>

## Accessing the native advanced dashboard <a id="accessing-the-native-advanced-dashboard"></a>
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Advanced dashboard"/>
...
<Image img="/images/cloud/manage/monitoring/edit_visualization.png" size="lg" alt="Advanced dashboard"/>

## Out-of-box visualizations <a id="out-of-box-visualizations"></a>
...
### ClickHouse specific <a id="clickhouse-specific"></a>
...
### System health specific <a id="system-health-specific"></a>
...
## ClickHouse Cloud specific <a id="clickhouse-cloud-specific"></a>
...
## Identifying issues using the advanced dashboard <a id="identifying-issues-with-the-advanced-dashboard"></a>
...
### Unbatched inserts <a id="unbatched-inserts"></a>
...
<Image img="/images/cloud/manage/monitoring/inserted_rows_max_parts_for_partition.png" size="lg" alt="Unbatched inserts"/>
...
### Resource intensive query <a id="resource-intensive-query"></a>
...
<Image img="/images/cloud/manage/monitoring/resource_intensive_query.png" size="lg" alt="Resource intensive query"/>

### Bad primary key design <a id="bad-primary-key-design"></a>
...
<Image img="/images/cloud/manage/monitoring/selected_rows_sec.png" size="lg" alt="Resource intensive query"/>
