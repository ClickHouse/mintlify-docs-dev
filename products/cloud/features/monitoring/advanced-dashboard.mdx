...
<Image img="/static/images/cloud/manage/monitoring/edit_visualization.png" size="lg" alt="Advanced dashboard"/>
...
<Image img="/static/images/cloud/manage/monitoring/inserted_rows_max_parts_for_partition.png" size="lg" alt="Unbatched inserts"/>
...
<Image img="/static/images/cloud/manage/monitoring/resource_intensive_query.png" size="lg" alt="Resource intensive query"/>
...
As described in ["A practical introduction to primary indexes in ClickHouse"](/guides/cloud-oss/data-modelling/sparse-primary-indexes#a-table-with-a-primary-key),
...
<Image img="/static/images/cloud/manage/monitoring/selected_rows_sec.png" size="lg" alt="Resource intensive query"/>
