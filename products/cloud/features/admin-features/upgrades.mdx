...
## Version compatibility <a id="version-compatibility"></a>
...
## Maintenance mode <a id="maintenance-mode"></a>
...
## Release channels (upgrade schedule) <a id="release-channels-upgrade-schedule"></a>
...
### Fast release channel (early upgrades) <a id="fast-release-channel-early-upgrades"></a>
...
### Regular release channel <a id="regular-release-channel"></a>
...
### Slow release channel (deferred upgrades) <a id="slow-release-channel-deferred-upgrades"></a>
