...
With ClickHouse Cloud you never have to worry about patching and upgrades. We roll out upgrades that include fixes, new features and performance improvements on a periodic basis. For the full list of what is new in ClickHouse refer to our [Cloud changelog](/resources/changelogs/cloud).
...
When you create a service, the [`compatibility`](/core/reference/settings/session-settings#compatibility) setting is set to the most up-to-date ClickHouse version offered on ClickHouse Cloud at the time your service is initially provisioned.
...
<div class="eighty-percent">
    <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="Select release channel type" border/>
</div>
<br/>
...
<div class="eighty-percent">
    <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="Scheduled upgrades" border/>
</div>
<br/>
...
<div class="eighty-percent">
    <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="Scheduled upgrade window" border/>
</div>
<br/>
