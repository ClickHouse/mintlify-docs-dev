...
<Image img="/static/images/cloud/reference/compute-compute-1.png" size="md" alt="Single Service in ClickHouse Cloud" />
...
<Image img="/static/images/cloud/reference/compute-compute-2.png" size="md" alt="Compute separation in ClickHouse Cloud" />
...
<Image img="/static/images/cloud/reference/compute-compute-8.png" size="lg" alt="Warehouse example with primary and secondary services" background='white' />
...
<Image img="/static/images/cloud/reference/compute-compute-3.png" size="md" alt="User access across services sharing same data" />
...
<Image img="/static/images/cloud/reference/compute-compute-4.png" size="md" alt="Network access control settings"/>
...
<Image img="/static/images/cloud/reference/compute-compute-5.png" size="lg" alt="Read-write and Read-only services in a warehouse"/>
...
<Image img="/static/images/cloud/reference/compute-compute-7.png" size="md" alt="Creating a new service in a warehouse"/>
