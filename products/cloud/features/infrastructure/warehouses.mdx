...
## What is compute-compute separation? <a id="what-is-compute-compute-separation"></a>
...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="Single Service in ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="Compute separation in ClickHouse Cloud" />

<br/>

_Fig. 2 - Compute separation in ClickHouse Cloud_

## What is a warehouse? <a id="what-is-a-warehouse"></a>
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="Warehouse example with primary and secondary services" background='white' />
...
## Access controls <a id="access-controls"></a>
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="User access across services sharing same data" />
...
### Network access control <a id="network-access-control"></a>
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="Network access control settings"/>
...
### Read vs read-write services <a id="read-vs-read-write"></a>
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="Read-write and Read-only services in a warehouse"/>
...
## Changes in `clusterAllReplicas` behavior <a id="changes-in-behavior"></a>
...
### Workload isolation limitations <a id="workload-isolation-limitations"></a>
...
### Helpful callouts <a id="callouts"></a>
...
## How to set up a warehouse <a id="setup-warehouses"></a>

### Creating a warehouse <a id="creating-a-warehouse"></a>
...
<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="Creating a new service in a warehouse"/>
...
### Renaming a warehouse <a id="renaming-a-warehouse"></a>
...
### Deleting a warehouse <a id="deleting-a-warehouse"></a>
