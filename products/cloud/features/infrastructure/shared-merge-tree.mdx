...
<Image img="/static/images/cloud/reference/shared-merge-tree-1.png" alt="ReplicatedMergeTree Diagram" size="md"  />
...
<Image img="/static/images/cloud/reference/shared-merge-tree-2.png" alt="ReplicatedMergeTree Diagram with Metadata" size="md"  />
