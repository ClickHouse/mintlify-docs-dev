...
## Architecture and metadata storage <a id="architecture-and-metadata-storage"></a>
...
## Shared database engine <a id="shared-database-engine"></a>
...
## Usage in ClickHouse Cloud <a id="usage-in-clickhouse-cloud"></a>
