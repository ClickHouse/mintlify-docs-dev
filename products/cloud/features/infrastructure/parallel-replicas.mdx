...
## Sharded architecture <a id="sharded-architecture"></a>
...
<Image img="/images/deployment-guides/parallel-replicas-1.png" size="md" alt="sharded archtiecture" />
...
## Non-sharded architecture <a id="non-sharded-architecture"></a>
...
<Image img="/images/deployment-guides/parallel-replicas-2.png" size="md" alt="non sharded architecture" />
...
## Introducing parallel replicas <a id="introducing-parallel-replicas"></a>
...
<Image img="/images/deployment-guides/parallel-replicas-3.png" size="md" alt="Parallel replicas" />
...
<Image img="/images/deployment-guides/parallel-replicas-4.png" size="md" alt="Announcements" />
...
### Dynamic coordination <a id="dynamic-coordination"></a>
...
<Image img="/images/deployment-guides/parallel-replicas-5.png" size="md" alt="Dynamic Coordination - part 1" />
...
<Image img="/images/deployment-guides/parallel-replicas-6.png" size="md" alt="Dynamic Coordination - part 2" />
...
<Image img="/images/deployment-guides/parallel-replicas-7.png" size="md" alt="Dynamic Coordination - part 3" />
...
### Managing cache locality <a id="managing-cache-locality"></a>
...
### Task stealing <a id="task-stealing"></a>
...
## Settings related to parallel replicas <a id="settings-related-to-parallel-replicas"></a>
| Setting                                            | Description                                                                                                                                                                                                                                                         |
|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
## Investigating issues with parallel replicas <a id="investigating-issues-with-parallel-replicas"></a>
...
<Image img="/images/deployment-guides/parallel-replicas-8.png" size="lg" alt="EXPLAIN without parallel_replica" />
...
<Image img="/images/deployment-guides/parallel-replicas-9.png" size="lg" alt="EXPLAIN with parallel_replica"/>
