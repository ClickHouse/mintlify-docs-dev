...
will use a small portion of the table, called [granules](/core/guides/clickhouse/data-modelling/sparse-primary-indexes#data-is-organized-into-granules-for-parallel-data-processing),
as the unit of work.
...
The [`system.text_log`](/core/reference/system-tables/text_log) table also 
