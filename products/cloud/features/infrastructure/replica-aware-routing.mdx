...
## Limitations of Replica-aware routing <a id="limitations-of-replica-aware-routing"></a>

### Replica-aware routing doesn't guarantee isolation <a id="replica-aware-routing-does-not-guarantee-isolation"></a>
...
### Replica-aware routing doesn't work out of the box with private link <a id="replica-aware-routing-does-not-work-out-of-the-box-with-private-link"></a>
...
## Configuring replica-aware routing <a id="configuring-replica-aware-routing"></a>
