...
The CLI also manages local ClickHouse installations and servers. See the [quick install](/get-started/setup/self-managed/quick-install) page for getting started with local development.
