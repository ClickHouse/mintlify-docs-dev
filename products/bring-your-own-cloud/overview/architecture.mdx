...
<Image img="/images/cloud/reference/byoc-1.png" size="lg" alt="BYOC Architecture" background='black'/>
...
### Control Plane communication <a id="control-plane-communication"></a>
...
## Key Requirements for BYOC <a id="key-requirements"></a>
...
### Cross-account IAM permissions <a id="cross-account-iam-permissions"></a>
...
### Tailscale Private Network Connection <a id="tailscale-private-network"></a>
...
### Why These Requirements Matter <a id="why-requirements-matter"></a>
