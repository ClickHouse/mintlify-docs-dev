...
## Connections between ClickHouse Control Plane and Your BYOC VPC <a id="connection-between-clickhouse-and-byoc"></a>
...
## Tailscale Private Network <a id="tailscale-private-network"></a>
...
### Overview <a id="tailscale-overview"></a>
...
### How Tailscale Works in BYOC <a id="how-tailscale-works"></a>

<Image img="/images/cloud/reference/byoc-tailscale-1.png" size="lg" alt="BYOC Tailscale" border />
...
### Network Connection Process <a id="tailscale-connection-process"></a>
...
### Security features <a id="tailscale-security"></a>
...
### Management Services Access <a id="management-services-access"></a>
...
### Network Traffic Flow <a id="tailscale-traffic-flow"></a>
...
## Network boundaries <a id="network-boundaries"></a>
...
### Troubleshooting access <a id="troubleshooting-access"></a>
...
### Billing scraper <a id="billing-scraper"></a>
...
### Service state <a id="service-state"></a>
