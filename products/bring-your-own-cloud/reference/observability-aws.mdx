...
## Prometheus Monitoring Approaches <a id="prometheus-monitoring"></a>
...
### Comparing Monitoring Methods <a id="monitoring-approaches-comparison"></a>
...
## The Built-in BYOC Prometheus Stack <a id="builtin-prometheus-stack"></a>
...
### Accessing the Prometheus Stack <a id="accessing-prometheus-stack"></a>
...
### Integrating with Your Monitoring Tools <a id="prometheus-stack-integration"></a>
...
## ClickHouse service Prometheus Integration <a id="direct-prometheus-integration"></a>
...
### Accessing the Metrics Endpoint <a id="metrics-endpoint"></a>
...
## ClickHouse Mixin <a id="clickhouse-mixin"></a>
...
### Setting up Grafana & Importing the ClickHouse Mix-in <a id="setup-grafana-mixin"></a>
...
<Image img="/images/cloud/reference/byoc-mixin-1.png" size="lg" alt="BYOC Mixin 1" background='black'/>

<Image img="/images/cloud/reference/byoc-mixin-2.png" size="lg" alt="BYOC Mixin 2" background='black'/>

<Image img="/images/cloud/reference/byoc-mixin-3.png" size="lg" alt="BYOC Mixin 3" background='black'/>
...
<Image img="/images/cloud/reference/byoc-mixin-4.png" size="lg" alt="BYOC Mixin 4" background='black'/>
...
<Image img="/images/cloud/reference/byoc-mixin-5.png" size="lg" alt="BYOC Mixin 5" background='black'/>