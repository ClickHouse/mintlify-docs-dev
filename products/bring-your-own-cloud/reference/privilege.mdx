...
## AWS IAM roles <a id="aws-iam-roles"></a>

### Bootstrap IAM role <a id="bootstrap-iam-role"></a>
...
### Additional IAM roles created by the controller <a id="additional-iam-roles-created-by-the-controller"></a>
...
## GCP service accounts <a id="gcp-service-accounts"></a>

### Bootstrap service account <a id="bootstrap-service-account"></a>
...
### Additional service accounts created by the controller <a id="additional-service-accounts-created-by-the-controller"></a>
