...
## Public Load Balancer <a id="public-load-balancer"></a>
...
### Overview <a id="public-load-balancer-overview"></a>
...
### Connecting via Public Load Balancer <a id="connecting-via-public-load-balancer"></a>
...
<Image img="/images/cloud/reference/byoc-connect-1.png" size="lg" alt="BYOC connection" background='black'/>
...
### IP Filtering <a id="public-ip-filtering"></a>
...
## Private Load Balancer <a id="private-load-balancer"></a>
...
### Overview <a id="private-load-balancer-overview"></a>
...
### Connecting via Private Load Balancer <a id="connecting-via-private-load-balancer"></a>
...
### IP Filtering <a id="private-ip-filtering"></a>
...
### Security Group Configuration <a id="security-group-configuration"></a>
...
## PrivateLink or Private Service Connect <a id="privatelink-or-private-service-connect"></a>
...
### Overview <a id="privatelink-overview"></a>
...
### Connecting via PrivateLink/Private Service Connect <a id="connecting-via-privatelink"></a>
...
### Endpoint ID Allowlist <a id="endpoint-id-allowlist"></a>
...
## Choosing the Right Connection Method <a id="choosing-connection-method"></a>
...
## Troubleshooting Connection Issues <a id="troubleshooting"></a>
