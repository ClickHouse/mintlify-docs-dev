...
## Set up VPC peering <a id="aws-vpc-peering"></a>
...
<Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC Create Peering Connection" border />
</Step>
<Step>
### Accept the peering connection request <a id="step-2-accept-the-peering-connection-request"></a>
...
<Step>
### Add destination to ClickHouse VPC route tables <a id="step-3-add-destination-to-clickhouse-vpc-route-tables"></a>
...
<Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC Add route table" border />
</Step>
<Step>
### Add destination to the target VPC route tables <a id="step-4-add-destination-to-the-target-vpc-route-tables"></a>
...
<Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC Add route table" border />
</Step>
<Step>
### Edit security group to allow peered VPC access <a id="step-5-edit-security-group-to-allow-peered-vpc-access"></a>
...
## Set up PrivateLink <a id="setup-privatelink"></a>
...
<Steps>
<Step>
### Request PrivateLink Setup <a id="step-1-request-privatelink-setup"></a>
...
<Step>
### Create an Endpoint in Your VPC <a id="step-2-create-endpoint"></a>
...
<Step>
### Add Endpoint ID to Service Allowlist <a id="step-3-add-endpoint-id-allowlist"></a>
...
<Step>
### Connect to ClickHouse via PrivateLink <a id="step-4-connect-via-privatelink"></a>
...
### PrivateLink Access Control <a id="privatelink-access-control"></a>
...
### PrivateLink DNS <a id="privatelink-dns"></a>
