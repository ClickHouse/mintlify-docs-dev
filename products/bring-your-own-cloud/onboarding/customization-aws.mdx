...
<Image img="/static/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="BYOC VPC Subnet" />

<Image img="/static/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="BYOC VPC Subnet Tags" />
...
<Image img="/static/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="BYOC S3 Endpoint" />
...
<Image img="/static/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="ClickHouse Cloud BYOC setup UI with Use existing VPC selected" />
