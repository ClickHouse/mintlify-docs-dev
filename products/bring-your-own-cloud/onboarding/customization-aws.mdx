...
## Customer-managed VPC (BYO-VPC) for AWS <a id="customer-managed-vpc-aws"></a>
...
<Steps>
<Step>
### Configure your existing VPC <a id="configure-existing-vpc"></a>
...
<Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="BYOC VPC Subnet" />

<Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="BYOC VPC Subnet Tags" />
</Step>
<Step>
### Configure S3 Gateway Endpoint <a id="configure-s3-endpoint"></a>
...
<Step>
### Ensure network connectivity <a id="ensure-network-connectivity"></a>
...
<Step>
### Configure your AWS account <a id="configure-aws-account"></a>
...
#### Alternative Terraform module <a id="terraform-module-aws"></a>
...
<Step>
### Set up BYOC infrastructure <a id="set-up-byoc-infrastructure"></a>
...
## Customer-managed IAM roles <a id="customer-managed-iam-roles"></a>
