...
<Image img="/images/cloud/reference/byoc-privatelink.png" size="md" alt="BYOC PrivateLink Enable" />
</Step>
<Step>
...
3. In the opened flyout, copy the `Service name` and `DNS name` value — you'll use them in the next step. (It may take a while for the value to be generated after enabling private link.)
   <Image img="/images/cloud/security/gcp-privatelink-pe-create.png" size="md" alt="Private Endpoints" border />
</Step>
<Step>
...
2. Open the Private Service Connect creation dialog by clicking the "Connect Endpoint" button.
   <Image img="/images/cloud/security/gcp-psc-open.png" size="md" alt="Open Private Service Connect in Google Cloud console" border />
...
5. After creating the endpoint, copy the `PSC Connection ID` value — you'll use it in the next step.
   <Image img="/images/cloud/security/gcp-psc-copy-connection-id.png" size="md" alt="Copy PSC Connection ID" border />
</Step>
<Step>
...
<Image img="/images/cloud/security/gcp-privatelink-pe-filters.png" size="md" alt="Private Endpoints Filter" border />
</Step>
<Step>
...
3. In the opened flyout, copy the `DNS name`.
   <Image img="/images/cloud/security/gcp-privatelink-pe-dns.png" size="md" alt="Private Endpoint DNS Name" border />
   <Note>
