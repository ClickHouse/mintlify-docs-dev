...
<Steps>
<Step>
### 1. Apply the Terraform module <a id="apply-terraform-module"></a>
...
<Step>
### 2. Provide IDs to ClickHouse <a id="provide-ids"></a>
...
### How cross-tenant authentication works <a id="cross-tenant-auth"></a>
