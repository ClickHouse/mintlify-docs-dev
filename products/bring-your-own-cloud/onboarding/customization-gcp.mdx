...
<Image img="/static/images/cloud/reference/byoc-gcp-subnet.png" size="lg" alt="BYOC GCP Subnet details showing primary and secondary IPv4 ranges with Private Google Access enabled" />
