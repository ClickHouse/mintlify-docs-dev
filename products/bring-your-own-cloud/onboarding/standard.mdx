...
## What is standard onboarding? <a id="what-is-standard-onboarding"></a>
...
## Request access <a id="request-access"></a>
...
## Onboarding <a id="onboarding-process"></a>

### Prepare an AWS account/GCP project/Azure subscription <a id="prepare-an-aws-account"></a>

Prepare a fresh AWS account, GCP project, or Azure subscription under your organization.

<Steps>
<Step>
### Choose a Cloud Provider <a id="choose-cloud-provider"></a>

<Image img="/images/cloud/reference/byoc-onboarding-1.png" size="lg" alt="BYOC choose CSP" background='black'/>
</Step>
<Step>
### Account/project/subscription setup <a id="account-setup"></a>
...
#### Alternative Terraform Module for AWS <a id="terraform-module-aws"></a>
...
<Step>
### Set up BYOC infrastructure <a id="setup-byoc-infrastructure"></a>
...
### Create Your First BYOC ClickHouse Service <a id="create-clickhouse-service"></a>
...
<Image img="/images/cloud/reference/byoc-new-service-1.png" size="md" alt="BYOC create new service"/>
