...
<Image img="/static/images/cloud/reference/byoc-onboarding-1.png" size="lg" alt="BYOC choose CSP" background='black'/>
...
<Image img="/static/images/cloud/reference/byoc-onboarding-2.png" size="lg" alt="BYOC initialize account" background='black'/>
...
<Image img="/static/images/cloud/reference/byoc-onboarding-3.png" size="lg" alt="BYOC setup infra" background='black'/>
...
<Image img="/static/images/cloud/reference/byoc-new-service-1.png" size="md" alt="BYOC create new service"/>
