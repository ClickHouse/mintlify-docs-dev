...
First, try running [SYSTEM RESTART REPLICA](/core/reference/statements/system#restart-replica) for the affected tables. You can get the table names from the query mentioned above.
