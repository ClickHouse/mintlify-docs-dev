...
<Image img="/static/images/managed-postgres/instance-types.png" alt="Instance types" size="md" border/>
...
<Image img="/static/images/managed-postgres/scaling-settings.png" alt="Scaling Settings" size="md" border/>
