...
<img src="/images/managed-postgres/instance-types.png" alt="Instance types" />
...
<img src="/images/managed-postgres/scaling-settings.png" alt="Scaling Settings" />
...
<Warning title="Minimal downtime">
...
For read-heavy workloads, consider using [read replicas](/docs/managed-postgres/read-replicas) to scale read capacity horizontally:
...
If you're replicating data to ClickHouse using [ClickPipes](/docs/managed-postgres/clickhouse-integration), you can independently scale the CDC (Change Data Capture) pipeline:
...
- [Settings and configuration](/docs/managed-postgres/settings)
- [Read replicas](/docs/managed-postgres/read-replicas)
- [High availability](/docs/managed-postgres/high-availability)
- [Performance benchmarks](/docs/managed-postgres/benchmarks)
