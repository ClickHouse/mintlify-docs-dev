...
## Instance types and flexibility <a id="instance-types"></a>
...
<Image img="/images/managed-postgres/instance-types.png" alt="Instance types" size="md" border/>

### Choosing the right instance type <a id="choosing-instance"></a>
...
## How scaling works <a id="how-scaling-works"></a>
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="Scaling Settings" size="md" border/>

### Scaling process <a id="scaling-process"></a>
...
### Scaling duration <a id="scaling-duration"></a>
...
### Parallel restore with WAL-G <a id="parallel-restore"></a>
...
### Initiating a scaling operation <a id="initiating-scaling"></a>
...
## Scaling strategies <a id="scaling-strategies"></a>
...
### Read replicas for horizontal scaling <a id="read-replicas"></a>
...
### CDC scaling for ClickHouse integration <a id="cdc-scaling"></a>
