...
## How branching works <a id="branching"></a>
...
### Development and testing <a id="dev-and-testing"></a>
...
## Branch creation time <a id="branch-creation-time"></a>
...
## Branches vs local development <a id="branches-v-local-dev"></a>
