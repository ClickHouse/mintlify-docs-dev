...
<img src="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="IO Intensive Read+Write benchmark results" />
...
<img src="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="IO Intensive Read-Only benchmark results" />
...
<img src="/images/managed-postgres/benchmarks/compute-intensive.png" alt="CPU Intensive benchmark results" />
...
For more details on the performance benefits of NVMe storage, see [NVMe-powered performance](/docs/managed-postgres/overview#nvme-performance).
...
- [Managed Postgres overview](/docs/managed-postgres/overview)
- [Scaling your Postgres instance](/docs/managed-postgres/scaling)
