...
For more details on the performance benefits of NVMe storage, see [NVMe-powered performance](/managed-postgres/overview#nvme-performance).
...
- [Managed Postgres overview](/managed-postgres/overview)
- [Scaling your Postgres instance](/managed-postgres/scaling)
