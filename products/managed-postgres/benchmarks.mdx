...
## Benchmark overview <a id="overview"></a>
...
### Test 1: IO Intensive - Read+Write (500 GB dataset) <a id="test1"></a>

<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="IO Intensive Read+Write benchmark results" size="md" border/>
...
### Test 2: IO Intensive - Read-Only (500 GB dataset) <a id="test2"></a>

<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="IO Intensive Read-Only benchmark results" size="md" border/>
...
### Test 3: CPU Intensive (data fits in memory) <a id="test3"></a>

<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="CPU Intensive benchmark results" size="md" border/>
...
## Performance summary <a id="summary"></a>
...
### When Postgres by ClickHouse excels <a id="when-it-excels"></a>
...
### NVMe architecture advantage <a id="nvme-advantage"></a>
...
## Cost-effectiveness <a id="cost-effectiveness"></a>
