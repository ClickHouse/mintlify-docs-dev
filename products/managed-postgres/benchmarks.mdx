...
<Image img="/static/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="IO Intensive Read+Write benchmark results" size="md" border/>
...
<Image img="/static/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="IO Intensive Read-Only benchmark results" size="md" border/>
...
<Image img="/static/images/managed-postgres/benchmarks/compute-intensive.png" alt="CPU Intensive benchmark results" size="md" border/>
