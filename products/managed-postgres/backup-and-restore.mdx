...
<Image img="/images/managed-postgres/backup-and-restore.png" alt='Backups view showing backup history and point-in-time recovery options' size='lg' border/>

## Backups <a id="backups"></a>

### Backup frequency <a id="backup-frequency"></a>
...
### Retention period <a id="retention-period"></a>
...
### Storage and durability <a id="storage-and-durability"></a>
...
## Point-in-time recovery <a id="point-in-time-recovery"></a>
