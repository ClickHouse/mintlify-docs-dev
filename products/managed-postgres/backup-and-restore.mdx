...
<Image img="/static/images/managed-postgres/backup-and-restore.png" alt='Backups view showing backup history and point-in-time recovery options' size='lg' border/>
