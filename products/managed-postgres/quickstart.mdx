...
In the sidebar on the left, you will see a [**Connect** button](/managed-postgres/connection). Click on it to view your connection details and connection strings in multiple formats.
