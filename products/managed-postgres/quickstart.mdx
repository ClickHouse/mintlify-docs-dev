...
## Part 1: Get Started with NVMe Postgres <a id="part-1"></a>

### Create a database <a id="create-postgres-database"></a>
...
<Image img="/images/managed-postgres/create-service.png" alt="Create a managed Postgres service" size="md" border/>

Enter a name for your database instance and click on **Create service**. You will be taken to the overview page.

<Image img="/images/managed-postgres/overview.png" alt="Managed Postgres overview" size="md" border/>

Your Managed Postgres instance will be provisioned and ready for use in 3-5 minutes.

### Connect to your database <a id="connect"></a>
...
<Image img="/images/managed-postgres/connect-modal.png" alt="Managed Postgres connect modal" size="md" border/>
...
### Experience NVMe performance <a id="nvme-performance"></a>
...
### Run queries on your data <a id="run-queries"></a>
...
## Part 2: Add Real-Time Analytics with ClickHouse <a id="part-2"></a>
...
### Setup ClickHouse integration <a id="setup-integrate-clickhouse"></a>
...
<Image img="/images/managed-postgres/integration-landing.png" alt="Managed Postgres integration empty" size="md" border/>
...
<Image img="/images/managed-postgres/postgres-analytics-form.png" alt="Managed Postgres integration form" size="md" border/>
...
<Image img="/images/managed-postgres/table-picker.png" alt="Managed Postgres table picker" size="md" border/>
...
### Query ClickHouse from Postgres <a id="pg-clickhouse-extension"></a>
...
<Image img="/images/managed-postgres/get-clickhouse-host.png" alt="Get ClickHouse host" size="md" border/>
...
### See your analytics in action <a id="analytics-after-integration"></a>
...
<Image img="/images/managed-postgres/analytics-list.png" alt="Managed Postgres analytics list" size="md" border/>

Click on the service name to open the ClickHouse console and see your replicated tables.

<Image img="/images/managed-postgres/replicated-tables.png" alt="Managed Postgres replicated tables in ClickHouse" size="md" border/>

### Compare Postgres vs ClickHouse performance <a id="performance-comparison"></a>
