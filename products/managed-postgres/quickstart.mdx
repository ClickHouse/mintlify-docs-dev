...
<Image img="/static/images/managed-postgres/create-service.png" alt="Create a managed Postgres service" size="md" border/>

Enter a name for your database instance and click on **Create service**. You will be taken to the overview page.

<Image img="/static/images/managed-postgres/overview.png" alt="Managed Postgres overview" size="md" border/>
...
<Image img="/static/images/managed-postgres/connect-modal.png" alt="Managed Postgres connect modal" size="md" border/>
...
<Image img="/static/images/managed-postgres/integration-landing.png" alt="Managed Postgres integration empty" size="md" border/>
...
<Image img="/static/images/managed-postgres/postgres-analytics-form.png" alt="Managed Postgres integration form" size="md" border/>
...
<Image img="/static/images/managed-postgres/table-picker.png" alt="Managed Postgres table picker" size="md" border/>
...
The `pg_clickhouse` extension lets you query ClickHouse data directly from Postgres using standard SQL. This means your application can use Postgres as a unified query layer for both transactional and analytical data. See the [full documentation](/integrations/connectors/tools/pg_clickhouse/introduction) for details.
...
<Image img="/static/images/managed-postgres/get-clickhouse-host.png" alt="Get ClickHouse host" size="md" border/>
...
<Image img="/static/images/managed-postgres/analytics-list.png" alt="Managed Postgres analytics list" size="md" border/>

Click on the service name to open the ClickHouse console and see your replicated tables.

<Image img="/static/images/managed-postgres/replicated-tables.png" alt="Managed Postgres replicated tables in ClickHouse" size="md" border/>
