...
## Prerequisites <a id="migration-pgdump-pg-restore-prerequisites"></a>
...
## The setup <a id="migration-pgdump-pg-restore-setup"></a>
To go through the steps, let's use a sample RDS Postgres database as the source database. Something like this:
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Source PostgreSQL Database Setup" size="xl" border />
...
## Create a dump of the source database <a id="migration-pgdump-pg-restore-dump"></a>
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump Command Execution" size="xl" border />

## Migrate the dump to ClickHouse Managed Postgres <a id="migration-pgdump-pg-restore-restore"></a>
...
### Restore the dump <a id="migration-pgdump-pg-restore-restore-dump"></a>
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore Command Execution" size="xl" border />

## Verify the migration <a id="migration-pgdump-pg-restore-verify"></a>
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Target Managed Postgres Database Setup" size="xl" border />
We see that we have all our tables, indexes, views, and sequences intact, along with the data counts matching.

## Considerations <a id="migration-pgdump-pg-restore-considerations"></a>
