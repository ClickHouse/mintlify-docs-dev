...
<Image img="/static/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Source PostgreSQL Database Setup" size="xl" border />
...
<Image img="/static/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump Command Execution" size="xl" border />
...
<Image img="/static/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore Command Execution" size="xl" border />
...
<Image img="/static/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Target Managed Postgres Database Setup" size="xl" border />
