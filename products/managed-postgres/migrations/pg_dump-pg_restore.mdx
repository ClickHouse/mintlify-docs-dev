...
pg_restore \
  ...
  rds-dump
```
You can get the connection string for your Managed Postgres instance from the ClickHouse Cloud console, explained very simply [here](/managed-postgres/connection).
