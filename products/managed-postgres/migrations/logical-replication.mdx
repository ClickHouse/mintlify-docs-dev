...
<Image img="/static/images/managed-postgres/logical_replication/source-setup.png" alt="Source PostgreSQL Replication Setup" size="md" border />
...
<Image img="/static/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Source PostgreSQL Tables Setup" size="xl" border />
...
<Image img="/static/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Create ClickHouse Managed Postgres Instance" size="md" border />
...
<Image img="/static/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Target ClickHouse Managed Postgres Initial Setup" size="xl" border />
...
<Image img="/static/images/managed-postgres/logical_replication/migration-result.png" alt="Migration Result after Logical Replication" size="xl" border />
