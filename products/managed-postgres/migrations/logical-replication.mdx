...
## Prerequisites <a id="migration-logical-replication-prerequisites"></a>
...
## The setup <a id="migration-logical-replication-setup"></a>
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="Source PostgreSQL Replication Setup" size="md" border />

## Schema-only dump of the source database <a id="migration-logical-replication-schema-dump"></a>
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Source PostgreSQL Tables Setup" size="xl" border />

### Create a Managed Postgres instance <a id="migration-pgdump-pg-restore-create-pg"></a>
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Create ClickHouse Managed Postgres Instance" size="md" border />

## Restore the schema to ClickHouse Managed Postgres <a id="migration-logical-replication-restore-schema"></a>
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Target ClickHouse Managed Postgres Initial Setup" size="xl" border />

## Set up logical replication <a id="migration-logical-replication-setup-replication"></a>
...
### Create a publication on the source database <a id="migration-logical-replication-create-publication"></a>
...
### Create a subscription on the target ClickHouse Managed Postgres database <a id="migration-logical-replication-create-subscription"></a>
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="Migration Result after Logical Replication" size="xl" border />
...
## Caveats and considerations <a id="migration-logical-replication-caveats"></a>
