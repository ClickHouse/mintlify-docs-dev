...
## Prerequisites <a id="migration-peerdb-prerequisites"></a>
...
## Considerations before migration <a id="migration-peerdb-considerations-before"></a>
...
## Create peers <a id="migration-peerdb-create-peers"></a>
...
### Source peer creation <a id="migration-peerdb-source-peer"></a>
...
<Image img="/images/managed-postgres/peerdb/source-peer.png" alt="Source Peer Creation" size="md" border />

### Target peer creation <a id="migration-peerdb-target-peer"></a>
...
<Image img="/images/managed-postgres/peerdb/target-peer.png" alt="Target Peer Creation" size="md" border />

Now, you should see both the source and target peers listed in the "Peers" section.
<Image img="/images/managed-postgres/peerdb/peers.png" alt="Peers List" size="md" border />

### Obtain source schema dump <a id="migration-peerdb-source-schema-dump"></a>
...
#### Remove unique constraints and indexes from the schema dump <a id="migration-peerdb-remove-constraints-indexes"></a>
...
### Apply schema dump to target database <a id="migration-peerdb-apply-schema-dump"></a>
...
## Create a mirror <a id="migration-peerdb-create-mirror"></a>
...
<Image img="/images/managed-postgres/peerdb/create-mirror.png" alt="Create Mirror" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/settings.png" alt="Mirror Settings" size="md" border />
4. Select the tables you want to migrate. You can choose specific tables or select all tables from the source database.
<Image img="/images/managed-postgres/peerdb/table-picker.png" alt="Table Picker" size="md" border />
...
<Image img="/images/managed-postgres/peerdb/mirrors.png" alt="Mirrors List" size="md" border />

## Wait for the initial load <a id="migration-peerdb-initial-load"></a>
...
<Image img="/images/managed-postgres/peerdb/initial-load.png" alt="Initial Load Progress" size="md" border />
Once the initial load is complete, you should see a status indicating that the migration is finished.

## Monitoring initial load and replication <a id="migration-peerdb-monitoring"></a>
...
## Post-migration tasks <a id="migration-peerdb-considerations"></a>
<Note>
...
## References <a id="migration-peerdb-references"></a>
...
## Next steps <a id="migration-pgdump-pg-restore-next-steps"></a>
