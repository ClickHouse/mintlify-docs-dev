...
<Image img="/static/images/managed-postgres/peerdb/source-peer.png" alt="Source Peer Creation" size="md" border />
...
<Image img="/static/images/managed-postgres/peerdb/target-peer.png" alt="Target Peer Creation" size="md" border />

Now, you should see both the source and target peers listed in the "Peers" section.
<Image img="/static/images/managed-postgres/peerdb/peers.png" alt="Peers List" size="md" border />
...
<Image img="/static/images/managed-postgres/peerdb/create-mirror.png" alt="Create Mirror" size="md" border />
...
<Image img="/static/images/managed-postgres/peerdb/settings.png" alt="Mirror Settings" size="md" border />
4. Select the tables you want to migrate. You can choose specific tables or select all tables from the source database.
<Image img="/static/images/managed-postgres/peerdb/table-picker.png" alt="Table Picker" size="md" border />
...
<Image img="/static/images/managed-postgres/peerdb/mirrors.png" alt="Mirrors List" size="md" border />
...
<Image img="/static/images/managed-postgres/peerdb/initial-load.png" alt="Initial Load Progress" size="md" border />
