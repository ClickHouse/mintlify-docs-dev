...
### I'm seeing an "invalid input value for enum" error during replication <a id="invalid-enum-value"></a>
...
### I'm seeing a unique constraint violation error during replication <a id="unique-constraint-violation"></a>
