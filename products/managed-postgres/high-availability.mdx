...
## High availability options <a id="high-availability-options"></a>

### 2 Standbys <a id="two-standbys"></a>
...
## Standbys vs read replicas <a id="standbys-vs-read-replicas"></a>
...
### Why standbys don't serve read queries <a id="why-standbys-dont-serve-read-queries"></a>
...
## Handling failures <a id="handling-failures"></a>
