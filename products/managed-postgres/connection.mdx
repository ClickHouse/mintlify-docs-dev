...
## Accessing connection details <a id="accessing-connection-details"></a>

To connect your applications to Managed Postgres, navigate to the **Connect** view in the left sidebar of your instance.

<Image img="/images/managed-postgres/connect-button.png" alt="Click Connect in the left sidebar to view connection details" size="md" border/>

Clicking **Connect** opens a modal displaying your connection credentials and connection strings in multiple formats.

<Image img="/images/managed-postgres/connect-modal.png" alt="Connection modal showing credentials and connection string formats" size="md" border/>
...
## Connection string formats <a id="connection-string"></a>
...
## PgBouncer connection pooling <a id="pgbouncer"></a>
...
### Quick connection (TLS encrypted) <a id="quick-connection"></a>
...
### Verified TLS connection (recommended for production) <a id="verified-tls"></a>
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Download CA Certificate from the Settings tab" size="md" border/>
