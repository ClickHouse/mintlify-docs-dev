...
<Image img="/static/images/managed-postgres/connect-button.png" alt="Click Connect in the left sidebar to view connection details" size="md" border/>

Clicking **Connect** opens a modal displaying your connection credentials and connection strings in multiple formats.

<Image img="/static/images/managed-postgres/connect-modal.png" alt="Connection modal showing credentials and connection string formats" size="md" border/>
...
<Image img="/static/images/managed-postgres/tls-ca-bundle.png" alt="Download CA Certificate from the Settings tab" size="md" border/>
