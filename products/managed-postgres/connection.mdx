...
<img src="/images/managed-postgres/connect-button.png" alt="Click Connect in the left sidebar to view connection details" />

Clicking **Connect** opens a modal displaying your connection credentials and connection strings in multiple formats.

<img src="/images/managed-postgres/connect-modal.png" alt="Connection modal showing credentials and connection string formats" />
...
<Tip title="When to use PgBouncer">
...
<img src="/images/managed-postgres/tls-ca-bundle.png" alt="Download CA Certificate from the Settings tab" />
