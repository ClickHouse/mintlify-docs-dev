...
<Image img="/static/images/managed-postgres/postgres-parameters.png" alt="Postgres parameters configuration" size="md" border/>
...
<Image img="/static/images/managed-postgres/service-actions.png" alt="Service actions and scaling" size="md" border/>
...
<Image img="/static/images/managed-postgres/ip-filters.png" alt="IP Access List configuration" size="md" border/>
