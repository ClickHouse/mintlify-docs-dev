...
## Example development flow <a id="example-development-flow"></a>
...
## Run PostgreSQL locally with Docker <a id="run-postgresql-locally-with-docker"></a>
...
## Apply the application schema <a id="apply-the-application-schema"></a>
...
### Application migrations <a id="application-migrations"></a>
...
### Schema-only PostgreSQL dumps <a id="schema-only-postgresql-dumps"></a>
...
### Checked-in SQL definitions <a id="checked-in-sql-definitions"></a>
...
## Populate representative development data <a id="populate-representative-development-data"></a>
...
### Example multi-tenant schema <a id="example-multi-tenant-schema"></a>
...
### Generate sample data <a id="generate-sample-data"></a>
...
## PostgreSQL + ClickHouse development environment <a id="postgresql-clickhouse-development-environment"></a>
