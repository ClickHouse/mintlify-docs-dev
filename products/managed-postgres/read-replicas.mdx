...
<Image img="/static/images/managed-postgres/warehouse-view.png" alt="Warehouse view with edit icon" size="md" border/>

This opens the warehouse dialog where you can view existing services and create new read replicas:

<Image img="/static/images/managed-postgres/read-replica-dialog.png" alt="Read replica management dialog" size="md" border/>
