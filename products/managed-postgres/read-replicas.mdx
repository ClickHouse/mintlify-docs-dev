...
<img src="/images/managed-postgres/warehouse-view.png" alt="Warehouse view with edit icon" />

This opens the warehouse dialog where you can view existing services and create new read replicas:

<img src="/images/managed-postgres/read-replica-dialog.png" alt="Read replica management dialog" />
...
### WAL shipping from object storage
...
This architecture differs from [high availability standbys](/docs/managed-postgres/high-availability), which use streaming replication with a direct connection to the primary.
