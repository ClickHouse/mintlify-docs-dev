...
This architecture differs from [high availability standbys](/managed-postgres/high-availability), which use streaming replication with a direct connection to the primary.
