...
<Image img="/images/managed-postgres/warehouse-view.png" alt="Warehouse view with edit icon" size="md" border/>

This opens the warehouse dialog where you can view existing services and create new read replicas:

<Image img="/images/managed-postgres/read-replica-dialog.png" alt="Read replica management dialog" size="md" border/>

## Managing read replicas <a id="managing-read-replicas"></a>
...
<Image img="/images/managed-postgres/read-replicas-flow.png" alt="Read replicas flow view showing primary and replica topology" size="lg" border/>
...
<Image img="/images/managed-postgres/read-replicas-table.png" alt="Read replicas table view" size="lg" border/>

To create a new replica, click **Create read replica** in the top-right corner of either view.

## Why use read replicas <a id="why-use-read-replicas"></a>
...
### Business continuity <a id="business-continuity"></a>
...
## How read replicas work <a id="how-read-replicas-work"></a>
...
### WAL shipping from object storage <a id="wal-shipping-from-object-storage"></a>
...
### Why we chose this approach <a id="why-we-chose-this-approach"></a>
...
### Replication lag characteristics <a id="replication-lag-characteristics"></a>
