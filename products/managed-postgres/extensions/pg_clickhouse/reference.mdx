...
* `array_to_string`: [arrayStringConcat](/core/reference/functions/regular-functions/array-functions#arrayStringConcat)
...
* `ltrim`: [ltrim](/core/reference/functions/regular-functions/string-functions#ltrim)
* `rtrim`: [rtrim](/core/reference/functions/regular-functions/string-functions#rtrim)
...
* `reverse(bytea)`: [reverse](/core/reference/functions/regular-functions/string-functions#reverse)
...
* [dictGet](/core/reference/functions/regular-functions/ext-dict-functions#dictget-dictgetordefault-dictgetornull)
...
* `re2regexpextract` → [regexpExtract](/core/reference/functions/regular-functions/string-search-functions#regexpExtract)
