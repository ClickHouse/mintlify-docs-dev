...
## Start ClickHouse <a id="start-clickhouse"></a>
...
## Add the data set <a id="add-the-data-set"></a>
...
### Install pg_clickhouse <a id="install-pg_clickhouse"></a>
...
### Connect pg_clickhouse <a id="connect-pg_clickhouse"></a>
...
## Create a dictionary <a id="create-a-dictionary"></a>
...
## Perform a join <a id="perform-a-join"></a>
