...
## Test case: TPC-H <a id="test-case-tpc-h"></a>
...
### Compile from source <a id="compile-from-source"></a>

#### General Unix <a id="general-unix"></a>
...
#### Debian / Ubuntu / APT <a id="debian--ubuntu--apt"></a>
...
#### RedHat / CentOS / Yum <a id="redhat--centos--yum"></a>
...
#### Install from PGXN <a id="install-from-pgxn"></a>
...
#### Compile and Install <a id="compile-and-install"></a>
