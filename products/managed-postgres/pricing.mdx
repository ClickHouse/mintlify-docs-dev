...
## Price performance <a id="price-performance"></a>
...
## Pricing model <a id="pricing-model"></a>
...
### Tier-based pricing <a id="tier-based-pricing"></a>
...
### Instance types <a id="instance-types"></a>
...
## Pricing calculator <a id="pricing-calculator"></a>
...
## Beta pricing highlights <a id="beta-pricing-highlights"></a>
