...
## Monitoring and metrics <a id="monitoring-and-metrics"></a>

### How can I access metrics for my Managed Postgres instance? <a id="metrics-access"></a>
...
### What backup options are available? <a id="backup-options"></a>
...
## Infrastructure and automation <a id="infrastructure-and-automation"></a>

### Is Terraform support available for Managed Postgres? <a id="terraform-support"></a>
...
## Extensions and configuration <a id="extensions-and-configuration"></a>

### What extensions are supported? <a id="extensions-supported"></a>
...
### Can I customize PostgreSQL configuration parameters? <a id="config-customization"></a>
...
### Why am I seeing `prepared statement does not exist` errors through PgBouncer? <a id="prepared-statement-errors"></a>
...
### What does the `max_client_conn` setting in PgBouncer mean, and how does it relate to `max_connections` in Postgres? <a id="pgbouncer-vs-pg-connections"></a>
...
## Database capabilities <a id="database-capabilities"></a>

### Can I create multiple databases and schemas? <a id="multiple-databases-schemas"></a>
...
### Is role-based access control (RBAC) supported? <a id="rbac-support"></a>
...
## Upgrades <a id="upgrades"></a>

### How are PostgreSQL version upgrades handled? <a id="version-upgrades"></a>
...
### What tools are available for migrating to Managed Postgres? <a id="migration-tools"></a>
