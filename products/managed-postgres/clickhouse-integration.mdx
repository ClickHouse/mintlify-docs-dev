...
<Image img="/static/images/managed-postgres/clickhouse-integration-intro.png" alt="ClickHouse integration landing page showing the integration option in the sidebar" size="md" border/>
...
<Image img="/static/images/managed-postgres/replication-service-step.png" alt="Replication service configuration showing integration name, destination service, and replication method options" size="md" border/>
...
<Image img="/static/images/managed-postgres/select-tables-step.png" alt="Select tables step showing database selection, replication options, and table picker grouped by schema" size="md" border/>
...
<Image img="/static/images/managed-postgres/integration-running.png" alt="ClickHouse integration list showing a running ClickPipe with its destination service and status" size="md" border/>
