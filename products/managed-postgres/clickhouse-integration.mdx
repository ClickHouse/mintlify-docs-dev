...
- **Remove deleted rows during merges**: For [ReplacingMergeTree](/core/reference/engines/table-engines/mergetree-family/replacingmergetree) tables, physically removes deleted rows during background merges
