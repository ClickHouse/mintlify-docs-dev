...
<Image img="/images/managed-postgres/clickhouse-integration-intro.png" alt="ClickHouse integration landing page showing the integration option in the sidebar" size="md" border/>
...
<Steps>
<Step>
## Configure the replication service <a id="configure-replication-service"></a>
...
<Image img="/images/managed-postgres/replication-service-step.png" alt="Replication service configuration showing integration name, destination service, and replication method options" size="md" border/>

Click **Next** to proceed.
</Step>
<Step>
## Configure replication settings <a id="replication-settings"></a>
...
<Image img="/images/managed-postgres/integration-replication-settings.png" alt="Replication settings step showing sync interval, parallel threads, pull batch size, and snapshot configuration options" size="md" border/>

Click **Next** to proceed.
</Step>
<Step>
## Select tables to replicate <a id="select-tables"></a>
...
<Image img="/images/managed-postgres/select-tables-step.png" alt="Select tables step showing database selection, replication options, and table picker grouped by schema" size="md" border/>

Click **Replicate data to ClickHouse** to start the replication.
</Step>
<Step>
## Monitor your ClickPipe <a id="monitor-clickpipe"></a>
...
<Image img="/images/managed-postgres/integration-running.png" alt="ClickHouse integration list showing a running ClickPipe with its destination service and status" size="md" border/>
