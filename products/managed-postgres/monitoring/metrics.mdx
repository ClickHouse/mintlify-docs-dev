...
## Common labels <a id="common-labels"></a>
...
## Information metric <a id="information-metric"></a>
...
## Disk and network I/O <a id="io"></a>
...
## Database activity <a id="database-activity"></a>
...
## Connections, cache, and database size <a id="connections-cache-size"></a>
