...
## Scraping all services in an organization <a id="scrape-org"></a>
...
## Scraping a single service <a id="scrape-instance"></a>
...
## Pre-built Grafana dashboard <a id="grafana-dashboard"></a>
...
<Image img="/images/managed-postgres/monitoring/grafana-dashboard.png" alt="Grafana dashboard of Managed Postgres Services" size="md" border/>

### Importing the dashboard <a id="import-dashboard"></a>

<Steps>
<Step>
#### Download the dashboard JSON <a id="download"></a>
...
<Step>
#### Open the import flow in Grafana <a id="open-import"></a>

Go to **Dashboards → New → Import**. Upload the JSON file or paste its contents.
</Step>
<Step>
#### Pick your Prometheus datasource <a id="pick-datasource"></a>
...
### Template variables <a id="template-variables"></a>
...
### Filter to a single service for drill-in <a id="drill-in"></a>
...
## Integrating with Grafana and Datadog <a id="third-party-integrations"></a>
