...
<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="Monitoring dashboard showing IOPS, CPU usage, memory, disk, network traffic, database size, connections, throughput, transactions, cache hit ratio, and deadlocks" size="lg" border/>
...
## Time period <a id="time-period"></a>
