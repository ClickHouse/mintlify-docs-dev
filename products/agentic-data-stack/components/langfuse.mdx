...
For the full Langfuse-on-ClickHouse setup, see the [Langfuse companion guide](https://langfuse.com/integrations/agentic-data-stack) and the [Langfuse overview](/cloud/features/ai-ml/langfuse).
