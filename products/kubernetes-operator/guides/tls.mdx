...
## How the operator expects certificates <a id="secret-format"></a>
...
## Step 1 — Bootstrap a CA with cert-manager <a id="step-1-ca"></a>
...
## Step 2 — Issue the server certificate <a id="step-2-cert"></a>
...
## Step 3 — Enable TLS on the cluster <a id="step-3-enable"></a>
...
### What the operator does <a id="what-the-operator-does"></a>
...
## Step 4 — Connect over TLS <a id="step-4-connect"></a>
...
## Encrypting Keeper traffic <a id="keeper-tls"></a>
...
## Custom CA bundle <a id="custom-ca"></a>
...
## Customizing the TLS settings <a id="custom-tls-settings"></a>
...
## Verify and troubleshoot <a id="troubleshoot"></a>
