...
## ClickHouseCluster configuration <a id="clickhousecluster-configuration"></a>
...
### Replicas and shards <a id="replicas-and-shards"></a>
...
### Keeper integration <a id="keeper-integration"></a>
...
## KeeperCluster configuration <a id="keepercluster-configuration"></a>
...
## Storage configuration <a id="storage-configuration"></a>
...
## Pod configuration <a id="pod-configuration"></a>

### Automatic topology spread and affinity <a id="automatic-topology-spread-and-affinity"></a>
...
### Manual configuration <a id="manual-configuration"></a>
...
## Pod disruption budgets <a id="pod-disruption-budgets"></a>
...
### Overriding the defaults <a id="pdb-overrides"></a>
...
### Cluster-wide opt-out <a id="pdb-cluster-wide-disable"></a>
...
### Container resources <a id="container-resources"></a>
...
### Volume mounts <a id="volume-mounts"></a>
...
## TLS/SSL configuration <a id="tls-ssl-configuration"></a>
...
### Configure secure endpoints <a id="configure-secure-endpoints"></a>
...
### SSL certificate secret format <a id="ssl-certificate-secret-format"></a>
...
### ClickHouse-Keeper communication over TLS <a id="clickhouse-keeper-communication-over-tls"></a>
...
## External Secret <a id="external-secret"></a>
...
### Required keys <a id="external-secret-required-keys"></a>
...
### Policy: Observe vs Manage <a id="external-secret-policy"></a>
...
### Status condition and troubleshooting <a id="external-secret-status"></a>
...
## Additional ports <a id="additional-ports"></a>
...
### End-to-end example: MySQL wire protocol <a id="additional-ports-mysql-example"></a>
...
### Field constraints <a id="additional-ports-constraints"></a>
...
### Reserved ports and names <a id="additional-ports-reserved"></a>
...
## Version probe and upgrade channel <a id="version-probe-and-upgrade-channel"></a>
...
### Choosing a release channel <a id="upgrade-channel-choosing"></a>
...
### Status conditions <a id="version-status-conditions"></a>
...
### Overriding the version probe Job <a id="version-probe-template"></a>
...
### Operator-wide controls <a id="version-operator-flags"></a>
...
### Default user password <a id="default-user-password"></a>
...
#### Using ConfigMap for user passwords <a id="using-configmap-for-user-passwords"></a>
...
### Custom users in configuration <a id="custom-users-in-configuration"></a>
...
### Database sync <a id="database-sync"></a>
...
### Server logging <a id="server-logging"></a>
...
### Embedded extra configuration <a id="embedded-extra-configuration"></a>
...
### Embedded extra users configuration <a id="embedded-extra-users-configuration"></a>
