...
## Scaling replicas <a id="scaling-replicas"></a>
...
## Scaling shards <a id="scaling-shards"></a>
...
## Automatic schema sync <a id="automatic-schema-sync"></a>
...
## Conditions to watch <a id="scaling-conditions"></a>
...
## Scaling Keeper <a id="scaling-keeper"></a>
