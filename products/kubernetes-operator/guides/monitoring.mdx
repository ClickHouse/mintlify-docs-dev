...
## Operator binary flags <a id="operator-binary-flags"></a>
...
## Enable metrics via Helm <a id="enable-metrics-via-helm"></a>
...
## Securing the metrics endpoint <a id="securing-the-metrics-endpoint"></a>
...
## ServiceMonitor reference <a id="servicemonitor-reference"></a>
...
## Standalone Prometheus example <a id="standalone-prometheus-example"></a>
...
## Health probe endpoints <a id="health-probe-endpoints"></a>
...
## Metrics catalog <a id="metrics-catalog"></a>
...
### Reconciliation activity <a id="reconciliation-activity"></a>
...
### API server traffic <a id="api-server-traffic"></a>

| Metric | Type | Labels |
|---|---|---|
| `rest_client_requests_total` | counter | `code`, `method`, `host` |

### Leader election <a id="leader-election"></a>
...
## Useful PromQL queries <a id="useful-promql-queries"></a>
...
## Suggested alerts <a id="suggested-alerts"></a>
...
## Verifying the setup <a id="verifying-the-setup"></a>
...
## Related guides <a id="related-guides"></a>
