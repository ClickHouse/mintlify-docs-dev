...
<Image img="/images/use-cases/observability/hyperdx-demo/step_17.png" alt="Event deltas overview" size="lg"/>
...
<Image img="/images/clickstack/event-deltas/distribution-mode.png" alt="Distribution mode showing per-attribute value distributions across all spans" size="lg"/>
...
<Image img="/images/use-cases/observability/event_deltas_separation.png" alt="Heatmap selection over a slow band starting at a specific time, with comparison bars below" size="lg"/>
...
<Image img="/images/use-cases/observability/event_deltas_issue.png" alt="Bar popover showing filter, exclude and copy actions over a value isolated to one population" size="lg"/>
...
<Image img="/images/clickstack/event-deltas/settings-drawer.png" alt="Heatmap Settings drawer with Scale, Value and Count fields" size="lg"/>
