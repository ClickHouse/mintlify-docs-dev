...
<Image img="/static/images/use-cases/observability/hyperdx-27.png" alt="Search" size="md"/>
...
<Image img="/static/images/use-cases/observability/clickstack-saved-search-listing.png" alt="Saved Search Listing Page" size="lg" />
...
<Image img="/static/images/use-cases/observability/clickstack-saved-search.png" alt="Saving a Search" size="md" />
...
For more information on setting up and configuring alerts, see the [Alerts documentation](/products/clickstack/features/alerts).
