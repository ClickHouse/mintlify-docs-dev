...
<Image img="/static/images/use-cases/observability/event_patterns.png" alt="Event patterns" size="lg"/>
...
<Image img="/static/images/use-cases/observability/event_patterns_highlight.png" alt="Event patterns" size="lg"/>
...
For a live example, see how event patterns are used in the [Remote Demo Dataset](/products/clickstack/example-datasets/remote-demo-data#identify-error-patterns).
