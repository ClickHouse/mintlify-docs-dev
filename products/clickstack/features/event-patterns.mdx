...
<Image img="/images/use-cases/observability/event_patterns.png" alt="Event patterns" size="lg"/>
...
<Image img="/images/use-cases/observability/event_patterns_highlight.png" alt="Event patterns" size="lg"/>
