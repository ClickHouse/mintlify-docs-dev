...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Session replay search view" size="lg"/>
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="Session replay playback" size="lg"/>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Session replay trace view" size="lg"/>
