...
ClickHouse not only supports full SQL but extends it with a range of observability-focused functions, such as [`argMax`](/reference/functions/aggregate-functions/reference/argMax), [`histogram`](/reference/functions/aggregate-functions/parametric-functions#histogram), and [`quantileTiming`](/reference/functions/aggregate-functions/reference/quantileTiming), that simplify querying structured logs, metrics, and traces.
...
<Image img="/static/images/use-cases/observability/hyperdx-search.png" alt="Search" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-sql.png" alt="SQL" size="lg"/>
