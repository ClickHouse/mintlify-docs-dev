...
<Image img="/images/use-cases/observability/clickstack-migrating-agents.png" alt="Migrating agents" size="lg" background/>
...
<Image img="/images/use-cases/observability/add-logstash-output.png" alt="Add Logstash output" size="md"/>
...
<Image img="/images/use-cases/observability/agent-output-settings.png" alt="Agent settings" size="md"/>
