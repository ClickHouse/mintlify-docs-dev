...
For background on what session replay is and how it fits into ClickStack, see the [Session Replay](/products/clickstack/features/session-replay) feature page.
...
<Image img="/static/images/clickstack/session-replay/demo-app.png" alt="Session replay demo app"/>
...
<Image img="/static/images/clickstack/session-replay/replay-search-view.png" alt="Session replay search"/>

You should see your session listed with its duration and event count. Click the ▶️ button to replay it.

<Image img="/static/images/clickstack/session-replay/session-replay.png" alt="Session replay"/>
...
- [All Sample Datasets](/products/clickstack/example-datasets) — other example datasets and guides
