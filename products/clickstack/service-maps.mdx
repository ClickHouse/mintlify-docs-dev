...
Click **Service Map** in the left navigation panel to open the full graph. Services appear once you're [ingesting trace data](/products/clickstack/ingesting-data) with OpenTelemetry.

<Image img="/static/images/clickstack/service-maps/service-map-overview.png" alt="Service map showing service nodes and request flow between them" size="lg"/>
...
<Image img="/static/images/clickstack/service-maps/source-selector.png" alt="Source selector highlighted in the service map toolbar" size="lg"/>
...
<Image img="/static/images/clickstack/service-maps/sampling.png" alt="Sampling slider highlighted in the service map toolbar" size="lg"/>

**Date range picker** — set the time window for the trace data used to build the map.

<Image img="/static/images/clickstack/service-maps/date-selector.png" alt="Date range picker highlighted in the service map toolbar" size="lg"/>
