...
<Image img="/images/clickstack/rbac/team-page-cloud.png" alt="ClickHouse Cloud Users and roles page" size="lg"/>
</Tab>
<Tab title="ClickStack Team Settings">
<Image img="/images/clickstack/rbac/team-page-clickstack.png" alt="ClickStack Team Settings page showing team members and their roles" size="lg"/>
</Tab>
</Tabs>
...
<Image img="/images/clickstack/rbac/rbac-section.png" alt="RBAC Roles" size="lg"/>
</Step>
<Step>
...
<Image img="/images/clickstack/rbac/add-role-modal.png" alt="Add Role modal" size="md"/>
</Step>
</Steps>
...
<Image img="/images/clickstack/rbac/default-vs-fine-grained.png" alt="Default Access vs Fine-Grained Controls modes in the role editor" size="md"/>
...
<Image img="/images/clickstack/rbac/condition-tip.png" alt="Condition tooltip: match resources by Name or Tag (shown by the title) or by ID (found in the URL)" size="md"/>
...
<Image img="/images/clickstack/rbac/dashboard-id-and-tag-example.png" alt="Dashboard showing the resource ID in the URL bar and a tag in the top-right corner" size="lg"/>
...
<Image img="/images/clickstack/rbac/access-rules-tip.png" alt="Access rules with OR logic tooltip" size="md"/>
...
<Image img="/images/clickstack/rbac/dashboard-fine-grained-example.png" alt="Two fine-grained access rules joined by OR: Name contains testing with Read access, and Tag is testing with Read access" size="md"/>
...
<Image img="/images/clickstack/rbac/security-policies.png" alt="Security policies" size="lg"/>
