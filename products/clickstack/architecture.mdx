...
<Image img="/static/images/use-cases/observability/clickstack-managed-architecture.png" alt="Managed Architecture" size="lg"/>
...
<Image img="/static/images/use-cases/observability/clickstack-oss-architecture.png" alt="Architecture" size="lg"/>
