...
<Image img="/static/images/clickstack/lambda/lambda-log-view.png" alt="Lambda Log View"/>

<Image img="/static/images/clickstack/lambda/lambda-log.png" alt="Lambda Log Detail"/>
