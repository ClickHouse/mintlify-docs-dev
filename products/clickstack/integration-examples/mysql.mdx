...
If you would like to test the MySQL logs integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the ["Demo dataset"](/products/clickstack/integration-examples/mysql#demo-dataset) section.
...
<Image img="/static/images/clickstack/mysql/search-view.png" alt="Search view"/>

<Image img="/static/images/clickstack/mysql/log-view.png" alt="Log view"/>
...
#### <TrackedLink href={'/examples/mysql-logs-dashboard.json'} download="mysql-logs-dashboard.json" eventName="docs.mysql_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download}
...
<Image img="/static/images/clickstack/mysql/finish-import.png" alt="Finish import"/>

#### View the dashboard {#created-dashboard}

The dashboard will be created with all visualizations pre-configured.

<Image img="/static/images/clickstack/mysql/example-dashboard.png" alt="Example dashboard"/>
...
- Set up [alerts](/products/clickstack/features/alerts) for critical events (connection failures, slow queries exceeding thresholds, error spikes)
