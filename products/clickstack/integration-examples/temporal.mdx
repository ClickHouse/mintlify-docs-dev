...
<Image img="/static/images/clickstack/temporal/temporal-metrics.png" alt="Temporal Metrics" size="md"/>
...
#### <TrackedLink href={'/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download}
...
<Image img="/static/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="Finish import dialog"/>

#### View the dashboard {#created-dashboard}

The dashboard will be created with all visualizations pre-configured:

<Image img="/static/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Temporal Metrics dashboard"/>
...
- Set up [alerts](/products/clickstack/features/alerts) for critical metrics (workflow failure rates, task backlog growth, schedule-to-start latency)
