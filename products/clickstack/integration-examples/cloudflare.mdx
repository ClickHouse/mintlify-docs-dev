...
<Image img="/static/images/clickstack/cloudflare/clickpipe-s3.png" alt="Clickpipe s3"/>
...
<Image img="/static/images/clickstack/cloudflare/continuous-ingestion.png" alt="Continuous ingestion"/>
...
<Image img="/static/images/clickstack/cloudflare/parse-information.png" alt="Parse information"/>
...
<Image img="/static/images/clickstack/cloudflare/add-source.png" alt="Add source"/>

2. Click **Add source** and configure the following settings. Click **Configure Optional Fields** to access all fields:

<Image img="/static/images/clickstack/cloudflare/configure-optional-fields.png" alt="Configure optional"/>
...
<Image img="/static/images/clickstack/cloudflare/save-source.png" alt="Save source"/>
...
<Image img="/static/images/clickstack/cloudflare/search-view.png" alt="Search view"/>

<Image img="/static/images/clickstack/cloudflare/log-view.png" alt="Log view"/>
...
#### <TrackedLink href={'/examples/cloudflare-logs-dashboard.json'} download="cloudflare-logs-dashboard.json" eventName="docs.cloudflare_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download}

#### Import dashboard {#import-dashboard}

1. HyperDX → **Dashboards** → **Import Dashboard**

<Image img="/static/images/clickstack/cloudflare/import-dashboard.png" alt="Import dashboard"/>

2. Upload `cloudflare-logs-dashboard.json` → **Finish Import**

<Image img="/static/images/clickstack/cloudflare/finish-import.png" alt="Import dashboard"/>

#### View dashboard {#view-dashboard}

<Image img="/static/images/clickstack/cloudflare/example-dashboard.png" alt="Example dashboard"/>
...
- Set up [alerts](/products/clickstack/features/alerts) for security events (WAF blocks, bot traffic spikes, error rate thresholds)
- Optimize [retention policies](/products/clickstack/ttl) based on your data volume
