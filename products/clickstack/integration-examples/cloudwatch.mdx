...
<Image img="/static/images/clickstack/cloudwatch/log-search-view.png" alt="Log Search View"/>
...
<Image img="/static/images/clickstack/cloudwatch/error-log-column-values.png" alt="Error Log Column Values"/>
...
<Image img="/static/images/clickstack/cloudwatch/demo-search-view.png" alt="Demo search view"/>
...
#### <TrackedLink href={'/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download}
...
<Image img="/static/images/clickstack/cloudwatch/finish-import.png" alt="Finish import dialog"/>

#### View the dashboard {#created-dashboard}

The dashboard will be created with all visualizations pre-configured:

<Image img="/static/images/clickstack/cloudwatch/logs-dashboard.png" alt="CloudWatch Logs dashboard"/>
...
- Set up [alerts](/products/clickstack/features/alerts) for critical events (connection failures, error spikes)
