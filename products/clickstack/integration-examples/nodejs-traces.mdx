...
Install the `@hyperdx/node-opentelemetry` package and initialize it at the start of your application. See the [Node.js SDK guide](/products/clickstack/ingesting-data/sdks/nodejs#getting-started) for detailed installation steps.
...
<Image img="/static/images/clickstack/api-key.png" alt="ClickStack API Key"/>
...
<Image img="/static/images/clickstack/nodejs/traces-search-view.png" alt="Traces search view"/>

Click on any trace to see the detailed view with spans, timing, and attributes:

<Image img="/static/images/clickstack/nodejs/trace-view.png" alt="Individual trace view"/>
...
#### <TrackedLink href={'/examples/nodejs-traces-dashboard.json'} download="nodejs-traces-dashboard.json" eventName="docs.node_traces_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download-dashboard}
...
<Image img="/static/images/clickstack/nodejs/finish-import.png" alt="Finish import"/>

#### The dashboard will be created with all visualizations pre-configured {#created-dashboard}

<Image img="/static/images/clickstack/nodejs/example-traces-dashboard.png" alt="Example dashboard"/>
...
See [Ingesting with OpenTelemetry](/products/clickstack/ingesting-data/opentelemetry) for production deployment patterns and collector configuration examples.
