...
<Image img="/static/images/clickstack/systemd/systemd-search-view.png" alt="Log search view"/>

<Image img="/static/images/clickstack/systemd/systemd-log-view.png" alt="Log view"/>
...
#### <TrackedLink href={'/examples/systemd-logs-dashboard.json'} download="systemd-logs-dashboard.json" eventName="docs.systemd_logs_monitoring.dashboard_download">Download</TrackedLink> the dashboard configuration {#download}
...
<Image img="/static/images/clickstack/systemd/finish-import-systemd.png" alt="Finish import"/>
...
<Image img="/static/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Example dashboard"/>
...
- Set up [alerts](/products/clickstack/features/alerts) for critical system events (service failures, authentication failures, OOM kills)
- Create additional [dashboards](/products/clickstack/features/dashboards/overview) for specific use cases (SSH security monitoring, service health)
...
See [Ingesting with OpenTelemetry](/products/clickstack/ingesting-data/opentelemetry) for production deployment patterns.
