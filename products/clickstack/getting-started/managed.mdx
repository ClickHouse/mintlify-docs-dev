...
To create a Managed ClickStack service in [ClickHouse Cloud](https://console.clickhouse.cloud) first complete the **first step** of the [ClickHouse Cloud quickstart guide](/core/get-started/setup/cloud).
...
To perform tasks such as provisioning new users or adding further data sources, see the [deployment guide for Managed ClickStack](/products/clickstack/deployment/managed#additional-tasks).
</Step>
</Steps>
