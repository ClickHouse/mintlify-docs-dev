...
This page documents the **v2.x** subchart-based Helm chart. If you are still using the v1.x inline-template chart, see [Helm cloud deployments (v1.x)](/products/clickstack/deployment/helm-cloud-v1). For migration steps, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>

This guide covers cloud-specific configurations for deploying ClickStack on managed Kubernetes services. For basic installation, see the [main Helm deployment guide](/products/clickstack/deployment/helm).
...
For AWS ALB Ingress configurations, see the [Additional Manifests guide](/products/clickstack/deployment/helm-additional-manifests#aws-alb-ingress) and the [ALB example values](https://github.com/ClickHouse/ClickStack-helm-charts/tree/main/examples/alb-ingress).
...
See [Ingress configuration](/products/clickstack/deployment/helm-configuration#ingress-setup) for TLS setup instructions.

## Next steps {#next-steps}

- [Configuration guide](/products/clickstack/deployment/helm-configuration) - API keys, secrets, and ingress
- [Deployment options](/products/clickstack/deployment/helm-deployment-options) - External systems configuration
- [Upgrade guide](/products/clickstack/deployment/helm-upgrade) - Migrating from v1.x to v2.x
- [Additional manifests](/products/clickstack/deployment/helm-additional-manifests) - Custom Kubernetes objects
- [Main Helm guide](/products/clickstack/deployment/helm) - Basic installation
