...
This page documents cloud deployments for the **v1.x** inline-template Helm chart, which is in maintenance mode. For the v2.x chart, see [Helm cloud deployments](/products/clickstack/deployment/helm-cloud). To migrate, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>

This guide covers cloud-specific configurations for deploying ClickStack on managed Kubernetes services. For basic installation, see the [main Helm deployment guide](/products/clickstack/deployment/helm-v1).
...
See [Ingress configuration](/products/clickstack/deployment/helm-configuration-v1#ingress-setup) for TLS setup instructions.

## Next steps {#next-steps}

- [Configuration guide (v1.x)](/products/clickstack/deployment/helm-configuration-v1) - API keys, secrets, and ingress
- [Deployment options (v1.x)](/products/clickstack/deployment/helm-deployment-options-v1) - External systems configuration
- [Main Helm guide (v1.x)](/products/clickstack/deployment/helm-v1) - Basic installation
- [Cloud deployments (v2.x)](/products/clickstack/deployment/helm-cloud) - v2.x cloud guide
