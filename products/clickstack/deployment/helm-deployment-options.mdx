...
This page documents the **v2.x** subchart-based Helm chart. If you are still using the v1.x inline-template chart, see [Helm deployment options (v1.x)](/products/clickstack/deployment/helm-deployment-options-v1). For migration steps, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>

This guide covers advanced deployment options for ClickStack using Helm. For basic installation, see the [main Helm deployment guide](/products/clickstack/deployment/helm).
...
For instructions on exposing OTEL collector endpoints via ingress, see [Ingress Configuration](/products/clickstack/deployment/helm-configuration#otel-collector-ingress).
...
- [Cloud Deployments](/products/clickstack/deployment/helm-cloud) - GKE, EKS, and AKS specific configurations
