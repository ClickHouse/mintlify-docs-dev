...
Similar to the [all-in-one image](/products/clickstack/deployment/docker-compose), this comprehensive Docker image bundles all ClickStack components:
...
<Image img="/static/images/use-cases/observability/hyperdx-2.png" alt="Create login" size="md"/>
