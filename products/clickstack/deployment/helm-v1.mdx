...
This page documents the **v1.x** inline-template Helm chart, which is in maintenance mode and will no longer receive new features. For new deployments, use the [v2.x chart](/products/clickstack/deployment/helm). To migrate an existing v1.x deployment, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>
...
For production deployments, configure ingress with TLS instead of port forwarding. See the [Ingress Configuration guide](/products/clickstack/deployment/helm-configuration-v1#ingress-setup) for detailed setup instructions.
</Tip>
...
For detailed API key setup instructions including multiple configuration methods and pod restart procedures, see the [API Key Setup guide](/products/clickstack/deployment/helm-configuration-v1#api-key-setup).
</Tip>
...
For production deployments with secret-based configuration, external OTEL collectors, or minimal setups, see the [Deployment Options guide](/products/clickstack/deployment/helm-deployment-options-v1).
</Tip>
...
- [Configuration Guide](/products/clickstack/deployment/helm-configuration-v1) - Ingress, TLS, and secrets management
- [Cloud Deployments](/products/clickstack/deployment/helm-cloud-v1) - Cloud-specific settings and production checklist
</Tip>
...
If you want to migrate to the v2.x subchart-based chart, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade) for migration instructions. This is a breaking change — an in-place `helm upgrade` is not supported.
</Info>
...
- [Ingress Troubleshooting](/products/clickstack/deployment/helm-configuration-v1#troubleshooting-ingress) - Asset serving, path rewrites, browser issues
- [Cloud Deployments](/products/clickstack/deployment/helm-cloud-v1#loadbalancer-dns-resolution-issue) - GKE OpAMP issues and cloud-specific problems
</Tip>
...
- [Deployment options (v1.x)](/products/clickstack/deployment/helm-deployment-options-v1) - External ClickHouse, OTEL collector, and minimal deployments
- [Configuration guide (v1.x)](/products/clickstack/deployment/helm-configuration-v1) - API keys, secrets, and ingress setup
- [Cloud deployments (v1.x)](/products/clickstack/deployment/helm-cloud-v1) - GKE, EKS, AKS configurations and production best practices

### v2.x documentation {#v2x-documentation}
- [Helm (v2.x)](/products/clickstack/deployment/helm) - v2.x deployment guide
