...
<Image img="/static/images/use-cases/observability/hyperdx-2.png" alt="HyperDX Login" size="md"/>
...
You can modify the [Docker Compose configuration](/products/clickstack/deployment/docker-compose) to achieve the same effect as this guide, removing the OTel collector and ClickHouse instance from the manifest.
...
For details on deploying and configuring a standalone collector see ["Ingesting with OpenTelemetry"](/products/clickstack/ingesting-data/collector#modifying-otel-collector-configuration).
