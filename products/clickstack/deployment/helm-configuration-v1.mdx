...
This page documents configuration for the **v1.x** inline-template Helm chart, which is in maintenance mode. For the v2.x chart, see [Helm configuration](/products/clickstack/deployment/helm-configuration). To migrate, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>

This guide covers configuration options for ClickStack Helm deployments. For basic installation, see the [main Helm deployment guide](/products/clickstack/deployment/helm-v1).
...
- [Deployment options (v1.x)](/products/clickstack/deployment/helm-deployment-options-v1) - External systems and minimal deployments
- [Cloud deployments (v1.x)](/products/clickstack/deployment/helm-cloud-v1) - GKE, EKS, and AKS configurations
- [Main Helm guide (v1.x)](/products/clickstack/deployment/helm-v1) - Basic installation
- [Helm configuration (v2.x)](/products/clickstack/deployment/helm-configuration) - v2.x configuration guide
