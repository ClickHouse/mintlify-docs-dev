...
<Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="Authenticate" size="lg"/>
</Step>
<Step>
...
<Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="Create Source" size="lg"/>
