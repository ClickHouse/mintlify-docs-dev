...
This embedded version is **not designed for production use**. The following features are not available compared to the [production-ready OSS deployments](/products/clickstack/deployment/oss):

- [Alerting](/products/clickstack/features/alerts)
- [Dashboard](/products/clickstack/features/dashboards/overview) and [search](/products/clickstack/features/search) persistence — dashboards and saved searches are not retained across sessions
- Customizable query settings
- [Event patterns](/products/clickstack/features/event-patterns)
...
<Image img="/static/images/clickstack/deployment/embedded/authenticate.png" alt="Authenticate" size="lg"/>
...
<Image img="/static/images/clickstack/deployment/embedded/inferred-source.png" alt="Create Source" size="lg"/>

If you don't have data yet, see [Ingesting data](/products/clickstack/ingesting-data) for available options.
...
- [All-in-One](/products/clickstack/deployment/all-in-one) — single container with all components, including persistence and authentication
- [Docker Compose](/products/clickstack/deployment/docker-compose) — individual components for more control
- [Helm](/products/clickstack/deployment/helm) — recommended for production Kubernetes deployments
- [Managed ClickStack](/products/clickstack/getting-started/managed) — fully managed on ClickHouse Cloud
