...
This page documents deployment options for the **v1.x** inline-template Helm chart, which is in maintenance mode. For the v2.x chart, see [Helm deployment options](/products/clickstack/deployment/helm-deployment-options). To migrate, see the [Upgrade guide](/products/clickstack/deployment/helm-upgrade).
</Warning>

This guide covers advanced deployment options for ClickStack using Helm. For basic installation, see the [main Helm deployment guide](/products/clickstack/deployment/helm-v1).
...
For instructions on exposing OTEL collector endpoints via ingress, see [Ingress Configuration](/products/clickstack/deployment/helm-configuration-v1#otel-collector-ingress).
...
- [Cloud Deployments (v1.x)](/products/clickstack/deployment/helm-cloud-v1) - GKE, EKS, and AKS specific configurations
- [Main Helm Guide (v1.x)](/products/clickstack/deployment/helm-v1) - Basic installation
- [Deployment options (v2.x)](/products/clickstack/deployment/helm-deployment-options) - v2.x deployment options
