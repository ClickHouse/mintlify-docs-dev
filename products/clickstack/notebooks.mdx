...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-hero.png" alt="AI Notebook investigating a Visa cache full outage" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-ai-consent.png" alt="Generative AI toggle in Team Settings" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-list.png" alt="Notebook list page" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-tiles.png" alt="Notebook with AI-generated tiles" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-branch-modal.png" alt="Create New Branch dialog" size="md"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-branching.png" alt="Branch navigation arrows and 1/2 badge on a tile" size="lg"/>
...
| **Chart**    | `L`      | A time series line chart, using the same visualization builder as [Dashboards](/products/clickstack/features/dashboards/overview). |
| **Table**    | `T`      | A tabular aggregation view.                                                                                                     |
| **Markdown** | `M`      | Freeform text for notes, hypotheses, or conclusions.                                                                            |

After adding a tile, it opens in inline edit mode where you can configure the data source, filters, and aggregations — the same interface used when building [dashboard visualizations](/products/clickstack/features/dashboards/overview#creating-visualizations). Click **Save** to finalize the tile.
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-manual-tiles.png" alt="Manual tile buttons at the bottom of a notebook" size="lg"/>
...
<Image img="/static/images/use-cases/observability/hyperdx-notebook-agent-context.png" alt="Agent Settings panel for custom context" size="lg"/>
