...
- ClickStack API Ingestion Key (found in ClickStack Team Settings > API Keys, [view docs here for reference](/products/clickstack/ingesting-data/opentelemetry#sending-otel-data))
...
<Image img="/static/images/clickstack/bindplane/bindplane-configuration.png" alt="Telemetry Signals in ClickStack via Bindplane" size="lg"/>
...
<Image img="/static/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Telemetry Signals in ClickStack via Bindplane" size="lg"/>
