...
<Note>
If you're looking for session replay/browser-side monitoring, you'll want to install the [Browser integration](/products/clickstack/ingesting-data/sdks/browser) instead.
</Note>
