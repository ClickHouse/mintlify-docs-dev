...
<Image img="/static/images/use-cases/observability/observability-6.png" alt="Async inserts" size="md"/>
...
Full details on configuring this feature can be found on this [docs page](/concepts/operations/insert/asyncinserts#enabling-asynchronous-inserts), or with a deep dive [blog post](https://clickhouse.com/blog/asynchronous-data-inserts-in-clickhouse).
...
<Image img="/static/images/use-cases/observability/clickstack-with-gateways.png" alt="Scaling with gateways" size="lg"/>
...
<Image img="/static/images/use-cases/observability/observability-8.png" alt="Adding kafka" size="lg"/>
