...
<Tabs>
    <Tab title="Managed ClickStack">
        <Image img="/images/use-cases/observability/clickstack-managed-architecture-with-flow.png" alt="Managed architecture with flow" size="md"/>
    </Tab>
    <Tab title="Open Source ClickStack">
        <Image img="/images/use-cases/observability/clickstack-oss-architecture-with-flow.png" alt="Simple architecture with flow" size="md" />
    </Tab>
</Tabs>
