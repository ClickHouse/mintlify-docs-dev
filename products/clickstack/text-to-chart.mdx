...
<Image img="/images/clickstack/text-to-chart/chart-explorer.png" alt="Chart explorer" />
</Step>
<Step>
...
<Image img="/images/clickstack/text-to-chart/text-to-chart.png" alt="Text to chart" />
</Step>
</Steps>
...
<Image img="/images/clickstack/text-to-chart/create-connection.png" alt="Create connection" />
...
- [Configuration](/products/clickstack/managing/config) — all ClickStack environment variables
