...
<Image img="/static/images/use-cases/observability/hyperdx-landing.png" alt="Landing page" size="lg"/>
...
To get started, visit the [Getting started guide](/products/clickstack/getting-started) before loading a [sample dataset](/products/clickstack/example-datasets). You can also explore documentation on [deployment options](/products/clickstack/deployment) and [production best practices](/products/clickstack/managing).
...
<Image img="/static/images/use-cases/observability/clickstack-simple-managed-architecture.png" alt="Managed ClickStack architecture" size="md" />
...
<Image img="/static/images/use-cases/observability/clickstack-simple-oss-architecture.png" alt="OSS Simple architecture" size="md" />
...
For users interesting in deploying Open Source ClickStack to production, we recommend reading the ["Production"](/products/clickstack/managing) guide.
