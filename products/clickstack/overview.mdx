...
<Image img="/images/use-cases/observability/hyperdx-landing.png" alt="Landing page" size="lg"/>
...
To get started, visit the [Getting started guide](/products/clickstack/getting-started) before loading a [sample dataset](/products/clickstack/example-datasets). You can also explore documentation on [deployment options](/products/clickstack/deployment) and [production best practices](/products/clickstack/managing/production).
...
<Image img="/images/use-cases/observability/clickstack-simple-managed-architecture.png" alt="Managed ClickStack architecture" size="md" />
...
For users deploying ClickStack in production, Managed ClickStack is the recommended option. See the [Getting started guide](/products/clickstack/getting-started/managed) for instructions on deploying ClickStack with ClickHouse Cloud.
...
<Image img="/images/use-cases/observability/clickstack-simple-oss-architecture.png" alt="OSS Simple architecture" size="md" />
...
A full architectural diagram and deployment details can be found in the [Architecture section](/products/clickstack/architecture).

For users interesting in deploying Open Source ClickStack to production, we recommend reading the ["Production"](/products/clickstack/managing/production) guide.
