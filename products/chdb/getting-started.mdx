...
## Querying a JSON file in S3 <a id="querying-a-json-file-in-s3"></a>
...
## Configuring the output format <a id="configuring-the-output-format"></a>
...
## Creating a table from JSON file <a id="creating-a-table-from-json-file"></a>
...
## Querying a table <a id="querying-a-table"></a>
...
## Querying a Pandas dataframe <a id="querying-a-pandas-dataframe"></a>
