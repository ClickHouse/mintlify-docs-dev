...
The [YouTube dislikes dataset](/core/get-started/sample-datasets/youtube-dislikes) contains more than 4 billion rows of dislikes on YouTube videos up to 2021.
...
chDB supports the ClickHouse data formats, as well as [some of its own](/products/chdb/reference/data-formats), including `DataFrame`, which returns a Pandas DataFrame:
...
We'll use the [`schema_inference_make_columns_nullable`](/core/reference/settings/formats#schema_inference_make_columns_nullable) setting so that column types aren't all made `Nullable`.
...
You can also read more about querying Pandas DataFrames in the [Querying Pandas developer guide](/products/chdb/guides/querying-pandas).
...
* [Querying Pandas DataFrames](/products/chdb/guides/querying-pandas)
* [Querying Apache Arrow](/products/chdb/guides/querying-apache-arrow)
* [Using chDB in JupySQL](/products/chdb/guides/jupysql)
* [Using chDB with an existing clickhouse-local database](/products/chdb/guides/clickhouse-local)
