...
## Core Query Functions <a id="core-query-functions"></a>

### `chdb.query` <a id="chdb-query"></a>
...
### `chdb.to_arrowTable` <a id="chdb-state-sqlitelike-to_arrowtable"></a>
...
## Connection and Session Management <a id="connection-session-management"></a>

The following Session Functions are available:

### `chdb.connect` <a id="chdb-connect"></a>
...
## Exception Handling <a id="chdb-exceptions"></a>

### **class** `chdb.ChdbError` <a id="chdb_chdbError"></a>
...
### **class** `chdb.session.Session` <a id="chdb_session_session"></a>
...
#### `query` <a id="chdb-session-session-query"></a>
...
#### `send_query` <a id="chdb-session-session-send_query"></a>
...
#### `sql` <a id="chdb-session-session-sql"></a>
...
## State Management <a id="chdb-state-management"></a>

### `chdb.state.connect` <a id="chdb_state_connect"></a>
...
### **class** `chdb.state.sqlitelike.Connection` <a id="chdb-state-sqlitelike-connection"></a>
...
#### `close` <a id="chdb-session-session-close"></a>
...
#### `cursor` <a id="chdb-state-sqlitelike-connection-cursor"></a>
...
#### `query` <a id="chdb-state-sqlitelike-connection-query"></a>
...
#### `send_query` <a id="chdb-state-sqlitelike-connection-send_query"></a>
...
### **class** `chdb.state.sqlitelike.StreamingResult` <a id="chdb-state-sqlitelike-streamingresult"></a>
...
#### `fetch` <a id="streamingresult-fetch"></a>
...
#### `cancel` <a id="streamingresult-cancel"></a>
...
#### `close` <a id="streamingresult-close"></a>
...
#### `record_batch` <a id="streamingresult-record_batch"></a>
...
#### Iterator Protocol <a id="streamingresult-iterator"></a>
...
#### Context Manager Protocol <a id="streamingresult-context-manager"></a>
...
### **class** `chdb.state.sqlitelike.Cursor` <a id="chdb-state-sqlitelike-cursor"></a>
...
#### `close` <a id="cursor-close-none"></a>
...
#### `column_names` <a id="chdb-state-sqlitelike-cursor-column_names"></a>
...
#### `column_types` <a id="chdb-state-sqlitelike-cursor-column_types"></a>
...
#### `property description : list` <a id="chdb-state-sqlitelike-cursor-description"></a>
...
#### `fetchall` <a id="chdb-state-sqlitelike-cursor-fetchall"></a>
...
#### `fetchmany` <a id="chdb-state-sqlitelike-cursor-fetchmany"></a>
...
#### `fetchone` <a id="chdb-state-sqlitelike-cursor-fetchone"></a>
...
### `chdb.state.sqlitelike` <a id="state-sqlitelike-to_arrowtable"></a>
...
### `chdb.state.sqlitelike.to_df` <a id="state-sqlitelike-to_df"></a>
...
## DataFrame Integration <a id="dataframe-integration"></a>

### **class** `chdb.dataframe.Table` <a id="chdb-dataframe-table"></a>
...
## Database API (DBAPI) 2.0 Interface <a id="database-api-interface"></a>
...
#### `chdb.dbapi.get_client_info()` <a id="dbapi-get-client-info"></a>
...
#### `chdb.dbapi.Binary(x)` <a id="dbapi-binary"></a>
...
### Connection Class <a id="connection-class"></a>

#### **class** `chdb.dbapi.connections.Connection(path=None)` <a id="chdb-dbapi-connections-connection"></a>
...
#### `close` <a id="dbapi-connection-close"></a>
...
#### `escape_string` <a id="escape-string"></a>
...
#### `property open` <a id="property-open"></a>
...
#### `property resp` <a id="property-resp"></a>
...
### Cursor Class <a id="cursor-class"></a>

#### **class** `chdb.dbapi.cursors.Cursor` <a id="chdb-dbapi-cursors-cursor"></a>
...
#### `close` <a id="dbapi-cursor-close"></a>
...
#### `executemany(query, args)` <a id="chdb-dbapi-cursors-cursor-executemany"></a>
...
#### `fetchall()` <a id="dbapi-fetchall"></a>
...
#### `fetchmany` <a id="dbapi-fetchmany"></a>
...
#### `fetchone` <a id="dbapi-fetchone"></a>
...
#### `max_stmt_length = 1024000` <a id="max-stmt-length"></a>
...
#### `setinputsizes` <a id="setinputsizes"></a>
...
#### `setoutputsizes` <a id="setoutputsizes"></a>
...
### Error Classes <a id="error-classes"></a>
...
#### **exception** `chdb.dbapi.err.DataError` <a id="chdb-dbapi-err-dataerror"></a>
...
#### **exception** `chdb.dbapi.err.DatabaseError` <a id="chdb-dbapi-err-databaseerror"></a>
...
#### **exception** `chdb.dbapi.err.Error` <a id="chdb-dbapi-err-error"></a>
...
#### **exception** `chdb.dbapi.err.IntegrityError` <a id="chdb-dbapi-err-integrityerror"></a>
...
#### **exception** `chdb.dbapi.err.InterfaceError` <a id="chdb-dbapi-err-interfaceerror"></a>
...
#### **exception** `chdb.dbapi.err.InternalError` <a id="chdb-dbapi-err-internalerror"></a>
...
#### **exception** `chdb.dbapi.err.NotSupportedError` <a id="chdb-dbapi-err-notsupportederror"></a>
...
#### **exception** `chdb.dbapi.err.OperationalError` <a id="chdb-dbapi-err-operationalerror"></a>
...
#### **exception** `chdb.dbapi.err.ProgrammingError` <a id="chdb-dbapi-err-programmingerror"></a>
...
#### **exception** `chdb.dbapi.err.StandardError` <a id="chdb-dbapi-err-standarderror"></a>
...
#### **exception** `chdb.dbapi.err.Warning` <a id="chdb-dbapi-err-warning"></a>
...
### Module Constants <a id="module-constants"></a>

#### `chdb.dbapi.apilevel = '2.0'` <a id="apilevel"></a>
...
#### `chdb.dbapi.threadsafety = 1` <a id="threadsafety"></a>
...
#### `chdb.dbapi.paramstyle = 'format'` <a id="paramstyle"></a>
...
### Type Constants <a id="type-constants"></a>

#### `chdb.dbapi.STRING = frozenset({247, 253, 254})` <a id="string-type"></a>
...
#### `chdb.dbapi.BINARY = frozenset({249, 250, 251, 252})` <a id="binary-type"></a>
...
#### `chdb.dbapi.NUMBER = frozenset({0, 1, 3, 4, 5, 8, 9, 13})` <a id="number-type"></a>
...
#### `chdb.dbapi.DATE = frozenset({10, 14})` <a id="date-type"></a>
...
#### `chdb.dbapi.TIME = frozenset({11})` <a id="time-type"></a>
...
#### `chdb.dbapi.TIMESTAMP = frozenset({7, 12})` <a id="timestamp-type"></a>
...
#### `chdb.dbapi.DATETIME = frozenset({7, 12})` <a id="datetime-type"></a>
...
#### `chdb.dbapi.ROWID = frozenset({})` <a id="rowid-type"></a>
...
## User-Defined Functions (UDF) <a id="user-defined-functions"></a>
...
### `chdb.udf.chdb_udf` <a id="chdb-udf"></a>
...
### `chdb.udf.generate_udf` <a id="generate-udf"></a>
...
### `chdb.utils.convert_to_columnar` <a id="convert-to-columnar"></a>
...
### `chdb.utils.flatten_dict` <a id="flatten-dict"></a>
...
### `chdb.utils.infer_data_type` <a id="infer-data-type"></a>
...
### `chdb.utils.infer_data_types` <a id="infer-data-types"></a>
...
## Abstract Base Classes <a id="abstract-base-classes"></a>

### **class** `chdb.rwabc.PyReader`(data: Any)` <a id="pyreader"></a>
...
#### **abstractmethod** `read` <a id="read"></a>
...
### **class** `chdb.rwabc.PyWriter` <a id="pywriter"></a>
...
#### **abstractmethod** finalize <a id="finalize"></a>
...
#### **abstractmethod** `write` <a id="write"></a>
...
### **class** `chdb.ChdbError` <a id="chdberror"></a>
...
## Version Information <a id="version-information"></a>

### `chdb.chdb_version = ('3', '6', '0')` <a id="chdb-version"></a>
...
### `chdb.engine_version = '25.5.2.1'` <a id="engine-version"></a>
...
### `chdb.__version__ = '3.6.0'` <a id="version"></a>
