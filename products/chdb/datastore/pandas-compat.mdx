...
## Compatibility Approach <a id="approach"></a>
...
## Attributes and Properties <a id="attributes"></a>
...
## Indexing and Selection <a id="indexing"></a>
...
## Statistical Methods <a id="statistical"></a>
...
## Sorting and Ranking <a id="sorting"></a>
...
## Combining / Joining <a id="combining"></a>
...
## Binary Operations <a id="binary"></a>
...
## Comparison Operations <a id="comparison"></a>
...
## Function Application <a id="application"></a>
...
## Key Differences from Pandas <a id="differences"></a>

### 1. Return Types <a id="return-types"></a>
...
### 2. Lazy Execution <a id="lazy-execution"></a>
...
### 3. No inplace Parameter <a id="no-inplace-parameter"></a>
...
### 4. Comparing Results <a id="comparing-results"></a>
