...
### Parquet Files <a id="read-parquet"></a>
...
### Other Formats <a id="read-other"></a>
...
## Writing Data <a id="writing"></a>

### to_csv <a id="to-csv"></a>
...
### Other Export Methods <a id="to-other"></a>
...
## File Format Comparison <a id="format-comparison"></a>
...
## Compression Support <a id="compression"></a>

### Reading Compressed Files <a id="read-compressed"></a>
...
### Writing Compressed Files <a id="write-compressed"></a>
...
### Compression Options <a id="compression-options"></a>
...
## Streaming I/O <a id="streaming"></a>

For very large files that don't fit in memory:

### Chunked Reading <a id="chunked-read"></a>
...
### Using ClickHouse Streaming <a id="clickhouse-streaming"></a>
...
## Remote Data Sources <a id="remote"></a>
...
### 1. Use Parquet for Large Files <a id="use-parquet-for-large-files"></a>
...
### 2. Select Only Needed Columns <a id="select-only-needed-columns"></a>
...
### 3. Use Compression <a id="use-compression"></a>
...
### 4. Batch Writes <a id="batch-writes"></a>
