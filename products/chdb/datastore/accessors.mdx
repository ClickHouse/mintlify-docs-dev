...
### Length and Size <a id="str-length"></a>
...
### Substring and Slicing <a id="str-substring"></a>
...
### Search and Match <a id="str-search"></a>
...
### Character Tests <a id="str-tests"></a>
...
## DateTime Accessor (`.dt`) <a id="dt"></a>

All 42+ pandas `.dt` methods plus ClickHouse datetime functions.

### Date Components <a id="dt-components"></a>
...
### Truncation <a id="dt-truncation"></a>
...
### Arithmetic <a id="dt-arithmetic"></a>
...
### Boolean Checks <a id="dt-checks"></a>
...
### Formatting <a id="dt-formatting"></a>
...
## Array Accessor (`.arr`) <a id="arr"></a>

ClickHouse-specific array operations (37 methods).

### Properties <a id="arr-properties"></a>
...
### Element Access <a id="arr-access"></a>
...
### Aggregations <a id="arr-aggregations"></a>
...
### Transformations <a id="arr-transformations"></a>
...
### Modifications <a id="arr-modifications"></a>
...
### String Operations <a id="arr-string"></a>
...
## JSON Accessor (`.json`) <a id="json"></a>
...
## Geo Accessor (`.geo`) <a id="geo"></a>

ClickHouse-specific geo/distance operations (14 methods).

### Distance Functions <a id="geo-distance"></a>
...
### Vector Operations <a id="geo-vector"></a>
...
### Point Operations <a id="geo-point"></a>
...
## Using Accessors <a id="using-accessors"></a>
...
### Methods That Execute Immediately <a id="execute-immediately"></a>
...
### Chaining Accessors <a id="chaining"></a>
