...
## When to use DataStore <a id="when-to-use"></a>
...
## API statistics <a id="api-stats"></a>
...
## Documentation navigation <a id="navigation"></a>
...
### Configuration & debugging <a id="configuration-debugging"></a>
- [Configuration](/products/chdb/configuration/index) - All configuration options
- [Performance Mode](/products/chdb/configuration/performance-mode) - SQL-first mode for maximum throughput
- [Debugging](/products/chdb/debugging/index) - Explain, profiling, and logging

### Pandas user guides <a id="pandas-user-guides"></a>
...
## Quick example <a id="quick-example"></a>
