...
### Constructor <a id="datastore-constructor"></a>
...
### Properties <a id="datastore-properties"></a>
...
### Factory Methods <a id="datastore-factory"></a>
...
### Query Methods <a id="datastore-query"></a>
...
### Pandas-compatible methods <a id="datastore-pandas"></a>
...
### I/O Methods <a id="datastore-io"></a>
...
### Debugging Methods <a id="datastore-debug"></a>
...
### Magic Methods <a id="datastore-magic"></a>
...
### Properties <a id="columnexpr-properties"></a>
...
### Accessors <a id="columnexpr-accessors"></a>
...
### Arithmetic Operations <a id="columnexpr-arithmetic"></a>
...
### Comparison Operations <a id="columnexpr-comparison"></a>
...
### Logical Operations <a id="columnexpr-logical"></a>
...
### Methods <a id="columnexpr-methods"></a>
...
### Aggregation Methods <a id="columnexpr-aggregation"></a>
...
## LazyGroupBy <a id="lazygroupby"></a>
...
### Methods <a id="lazygroupby-methods"></a>
...
### Column Selection <a id="lazygroupby-columns"></a>
...
### Aggregation Specifications <a id="lazygroupby-agg"></a>
...
## LazySeries <a id="lazyseries"></a>

Represents a lazy Series (single column).

### Properties <a id="lazyseries-properties"></a>
...
### Methods <a id="lazyseries-methods"></a>
...
## Related Classes <a id="related"></a>

### F (Functions) <a id="f-class"></a>
...
### CaseWhen <a id="casewhen-class"></a>
