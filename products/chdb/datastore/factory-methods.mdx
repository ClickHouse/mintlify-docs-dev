...
## Universal URI Interface <a id="uri"></a>
...
### URI Syntax Reference <a id="uri-syntax"></a>
...
## File Sources <a id="file-sources"></a>

### `from_file` <a id="from-file"></a>
...
### Pandas-compatible read functions <a id="pandas-read"></a>
...
### `from_postgresql` <a id="from-postgresql"></a>
...
### `from_clickhouse` <a id="from-clickhouse"></a>
...
### `from_mongodb` <a id="from-mongodb"></a>
...
### `from_sqlite` <a id="from-sqlite"></a>
...
## Data Lakes <a id="data-lakes"></a>

### `from_iceberg` <a id="from-iceberg"></a>
...
## In-Memory Sources <a id="in-memory"></a>

### `from_df` / `from_dataframe` <a id="from-df"></a>
...
### `DataFrame` Constructor <a id="dataframe-constructor"></a>
...
## Special Sources <a id="special-sources"></a>

### `from_numbers` <a id="from-numbers"></a>
...
### `from_random` <a id="from-random"></a>
