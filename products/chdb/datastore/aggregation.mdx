...
## Basic Aggregations <a id="basic"></a>

### Built-in Methods <a id="builtin"></a>
...
## GroupBy Aggregations <a id="groupby"></a>

### Single Aggregation <a id="single-agg"></a>
...
### Multiple Aggregations <a id="multi-agg"></a>
...
### Named Aggregations <a id="named-agg"></a>
...
### Multiple GroupBy Keys <a id="multi-groupby"></a>
...
## Statistical Aggregations <a id="statistical"></a>
...
## Conditional Aggregations <a id="conditional"></a>
...
## Collection Aggregations <a id="collection"></a>
...
### Ranking Functions <a id="ranking"></a>
...
### Cumulative Functions <a id="cumulative"></a>
...
### Rolling Windows <a id="rolling"></a>
...
## F Namespace <a id="f-namespace"></a>

The `F` namespace provides access to ClickHouse functions.

### Import <a id="f-import"></a>

```python
from chdb.datastore import F, Field
```

### Using F Functions <a id="f-usage"></a>
...
### F with Window Functions <a id="f-window"></a>
...
## Common Aggregation Patterns <a id="patterns"></a>

### Top N per Group <a id="top-n"></a>
...
### Running Total <a id="running-total"></a>
...
### Moving Average <a id="moving-avg"></a>
...
### Year-over-Year Comparison <a id="yoy"></a>
...
### Percentile Ranking <a id="percentile"></a>
...
## Aggregation Methods Summary <a id="summary"></a>
