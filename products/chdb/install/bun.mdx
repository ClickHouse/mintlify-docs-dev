...
### Step 1: Install system dependencies <a id="install-system-dependencies"></a>
...
#### Install build tools <a id="install-build-tools"></a>

You'll need either `gcc` or `clang` installed on your system:

### Step 2: Install chDB-bun <a id="install-chdb-bun"></a>
...
### Ephemeral queries <a id="ephemeral-queries"></a>
...
### Persistent sessions <a id="persistent-sessions"></a>
