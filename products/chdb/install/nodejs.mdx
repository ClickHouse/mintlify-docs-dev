...
### Standalone queries <a id="standalone-queries"></a>
...
### Session-Based queries <a id="session-based-queries"></a>
...
### Processing external data <a id="processing-external-data"></a>
