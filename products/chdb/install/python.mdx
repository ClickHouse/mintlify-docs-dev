...
### Basic python usage <a id="basic-python-usage"></a>
...
### Connection-based API (recommended) <a id="connection-based-api"></a>
...
## Data input methods <a id="data-input"></a>

### File-based data sources <a id="file-based-data-sources"></a>
...
### Output format examples <a id="output-format-examples"></a>
...
### DataFrame operations <a id="dataframe-operations"></a>

#### Legacy DataFrame API <a id="legacy-dataframe-api"></a>
...
#### Python table engine (recommended) <a id="python-table-engine-recommended"></a>
...
### Stateful sessions <a id="stateful-sessions"></a>
...
### Advanced session features <a id="advanced-session-features"></a>
...
### Python DB-API 2.0 interface <a id="python-db-api-20"></a>
...
#### Basic UDF usage <a id="basic-udf-usage"></a>
...
#### Advanced UDF with custom return types <a id="advanced-udf-custom-return-types"></a>
...
#### UDF best practices <a id="udf-best-practices"></a>
...
### Streaming query processing <a id="streaming-queries"></a>
...
### Python table engine <a id="python-table-engine"></a>

#### Query Pandas DataFrames <a id="query-pandas-dataframes"></a>
...
#### Custom data sources with PyReader <a id="custom-data-sources-pyreader"></a>
...
### JSON Type Inference and Handling <a id="json-type-inference-handling"></a>
...
## Performance and optimization <a id="performance-optimization"></a>
...
## GitHub repository <a id="github-repository"></a>
