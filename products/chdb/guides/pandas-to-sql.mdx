...
## Viewing Generated SQL <a id="viewing-sql"></a>
...
## Basic Operations Mapping <a id="basic"></a>

### Filtering (WHERE) <a id="filtering-where"></a>
...
### Selection (SELECT) <a id="selection-select"></a>
...
### Sorting (ORDER BY) <a id="sorting-order-by"></a>
...
### Basic GroupBy <a id="basic-groupby"></a>
...
### HAVING Clause <a id="having-clause"></a>
...
### Join Example <a id="join-example"></a>
...
## Arithmetic Operations <a id="arithmetic"></a>
...
## Complete Example <a id="example"></a>

### pandas Code <a id="pandas-code"></a>
...
### Equivalent SQL <a id="equivalent-sql"></a>
...
### DataStore Code <a id="datastore-code"></a>
...
## SQL Keywords Summary <a id="summary"></a>
...
## Tips for pandas Users <a id="tips"></a>

### 1. Think in SQL Operations <a id="think-in-sql"></a>
...
### 2. Use to_sql() to Learn <a id="use-to-sql"></a>
...
### 3. Leverage SQL Features <a id="leverage-sql-features"></a>
