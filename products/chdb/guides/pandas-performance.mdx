...
## Why DataStore Is Faster <a id="why-faster"></a>

### 1. SQL Pushdown <a id="sql-pushdown"></a>
...
### 2. Column Pruning <a id="column-pruning"></a>
...
### 3. Lazy Evaluation <a id="lazy-evaluation"></a>
...
## Benchmark: DataStore vs pandas <a id="benchmark"></a>
...
## When DataStore Wins <a id="when-datastore-wins"></a>

### Heavy Aggregations <a id="heavy-aggregations"></a>
...
### Complex Pipelines <a id="complex-pipelines"></a>
...
### Large File Processing <a id="large-file-processing"></a>
...
### Multiple Column Operations <a id="multiple-column-operations"></a>
...
## When pandas Is Comparable <a id="when-pandas-wins"></a>
...
### Small Datasets (&lt;1,000 rows) <a id="small-datasets"></a>
...
### Simple Slice Operations <a id="simple-slice-operations"></a>
...
### Custom Python Lambda Functions <a id="custom-python-functions"></a>
...
For fine-grained control over execution, see [Execution Engine Configuration](/products/chdb/configuration/execution-engine).
</Info>

---

## Zero-Copy DataFrame Integration <a id="zero-copy"></a>
...
## Optimization Tips <a id="tips"></a>

### 1. Enable Performance Mode for Heavy Workloads <a id="use-performance-mode"></a>
...
See [Performance Mode](/products/chdb/configuration/performance-mode) for full details.

### 2. Use Parquet Instead of CSV <a id="use-parquet"></a>
...
### 3. Filter Early <a id="filter-early"></a>
...
### 4. Select Only Needed Columns <a id="select-only-needed-columns"></a>
...
### 5. Leverage SQL Aggregations <a id="leverage-sql-aggregations"></a>
...
### 6. Use head() Instead of Full Queries <a id="use-head"></a>
...
### 7. Batch Operations <a id="batch-operations"></a>
...
### 8. Use explain() to Optimize <a id="use-explain"></a>
...
## Profiling Your Workload <a id="profiling"></a>

### Enable Profiling <a id="enable-profiling"></a>
...
### Identify Bottlenecks <a id="identify-bottlenecks"></a>
...
### Compare Approaches <a id="compare-approaches"></a>
...
## Best Practices Summary <a id="summary"></a>
...
## Quick Decision Guide <a id="decision"></a>
...
See [Execution Engine](/products/chdb/configuration/execution-engine) and [Performance Mode](/products/chdb/configuration/performance-mode) for details.
</Tip>
