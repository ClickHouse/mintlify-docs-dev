...
[clickhouse-local](/core/concepts/features/tools-and-utilities/clickhouse-local) is a CLI with an embedded version of ClickHouse.
...
Downloading and installing clickhouse-local is the same as [downloading and installing ClickHouse](/core/get-started/setup/install).
