...
## Setting Log Level <a id="setting-level"></a>
...
## Log Format <a id="format"></a>

### Simple Format (Default) <a id="simple"></a>
...
## What Gets Logged <a id="what-logged"></a>

### DEBUG Level <a id="debug-logged"></a>
...
### WARNING Level <a id="warning-logged"></a>
...
### ERROR Level <a id="error-logged"></a>
...
## Custom Logging Configuration <a id="custom"></a>

### Using Python Logging <a id="python-logging"></a>
...
### Suppress Logging <a id="suppress"></a>
...
## Debugging Scenarios <a id="scenarios"></a>

### Debug SQL Generation <a id="debug-sql"></a>
...
### Debug Engine Selection <a id="debug-engine"></a>
...
### Debug Cache Operations <a id="debug-cache"></a>
...
### Debug Performance Issues <a id="debug-performance"></a>
...
## Production Configuration <a id="production"></a>

### Recommended Settings <a id="recommended"></a>
