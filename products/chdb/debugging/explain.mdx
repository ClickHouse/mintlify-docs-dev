...
### Standard Output <a id="standard"></a>
...
## Three Execution Phases <a id="phases"></a>
...
### Phase 3: DataFrame Operations <a id="phase-3"></a>
...
## Understanding the Plan <a id="understanding"></a>

### Source Information <a id="source"></a>
...
### Filter Operations <a id="filter"></a>
...
### GroupBy and Aggregate <a id="groupby"></a>
...
## Engine Information <a id="engine"></a>
...
### Simple Query <a id="example-simple"></a>
...
### Complex Aggregation <a id="example-complex"></a>
...
### Mixed SQL and pandas <a id="example-mixed"></a>
...
## Debugging with explain() <a id="debugging"></a>

### Check Filter Logic <a id="debug-filter"></a>
...
### Verify Column Selection <a id="debug-select"></a>
...
### Understand Aggregation <a id="debug-agg"></a>
...
### 1. Check Before Executing Large Queries <a id="best-practice-1"></a>
...
### 2. Use Verbose for Debugging <a id="best-practice-2"></a>
...
### 3. Compare with to_sql() <a id="best-practice-3"></a>
...
### 4. Check Pushdown Status <a id="best-practice-4"></a>
