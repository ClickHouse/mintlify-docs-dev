...
## Function Engine Configuration <a id="function-engine"></a>

Override the execution engine for specific functions.

### Setting Function Engines <a id="setting-engines"></a>
...
### Example <a id="function-example"></a>
...
## Overlapping Functions <a id="overlapping"></a>
...
## chdb-Only Functions <a id="chdb-only"></a>
...
## pandas-Only Functions <a id="pandas-only"></a>
...
## Dtype Correction <a id="dtype-correction"></a>

Configure how DataStore corrects data types between engines.

### Correction Levels <a id="correction-levels"></a>
...
### Correction Level Details <a id="level-details"></a>
...
### When Types Need Correction <a id="when-correction"></a>
...
### Example <a id="correction-example"></a>
...
## Function Configuration API <a id="api"></a>

### function_config Object <a id="function-config-object"></a>
...
### Per-Call Override <a id="per-call"></a>
...
### 1. Start with Defaults <a id="start-with-defaults"></a>
...
### 2. Configure for Specific Workloads <a id="configure-for-specific-workloads"></a>
...
### 3. Use Appropriate Correction Level <a id="use-appropriate-correction-level"></a>
...
### 4. Test Both Engines <a id="test-both-engines"></a>
