...
### What Performance Mode Disables <a id="what-it-disables"></a>
...
## Enabling Performance Mode <a id="enabling"></a>

### Using config object <a id="using-config"></a>
...
### Using module-level functions <a id="using-functions"></a>
...
### Using convenience imports <a id="using-imports"></a>
...
## When to Use Performance Mode <a id="when-to-use"></a>
...
## Behavior Differences <a id="behavior-differences"></a>

### Row Order <a id="row-order"></a>
...
### GroupBy Results <a id="groupby-results"></a>
...
### Single-SQL Execution <a id="single-sql"></a>
...
## Comparison with Execution Engine <a id="vs-execution-engine"></a>
...
## Testing with Performance Mode <a id="testing"></a>
...
### Sort-then-compare (aggregations, filters) <a id="sort-then-compare"></a>
...
### Value-range check (first/last) <a id="value-range-check"></a>
...
### Schema-and-count (LIMIT without ORDER BY) <a id="schema-and-count"></a>
...
### 1. Enable early in your script <a id="enable-early"></a>
...
### 2. Add explicit sorting when order matters <a id="explicit-sort"></a>
...
### 3. Use for batch/ETL workloads <a id="batch-etl"></a>
...
### 4. Switch modes within a session <a id="switch-modes"></a>
...
## Related Documentation <a id="related"></a>

- [Execution Engine](/products/chdb/configuration/execution-engine) — Engine selection (auto/chdb/pandas)
- [Performance Guide](/products/chdb/guides/pandas-performance) — General optimization tips
- [Key Differences from pandas](/products/chdb/guides/pandas-differences) — Behavioral differences
