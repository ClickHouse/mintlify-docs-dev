...
- **Multiple data formats** - Input & Output support for Parquet, CSV, JSON, Arrow, ORC and [70+ more formats](/reference/formats)
...
Learn more: [DataStore Documentation](/products/chdb/datastore)
...
* [Configuration](/products/chdb/configuration) - Engine, logging, profiling
* [Debugging](/products/chdb/debugging) - explain(), profiling, logging
...
- **[DataStore vs Pandas](/products/chdb/datastore#performance)** - Up to 20x faster than pandas on common operations

<Image img="/static/images/chdb/df_bench.png" alt='DataFrame benchmark results' size="md"/>
