...
Em alguns aspectos, as projeções são semelhantes a [visões materializadas](/pt-BR/concepts/features/materialized-views)
...
<Image img="/images/data-modeling/projections_1.png" size="md" alt="Projeções no ClickHouse" />
...
<Image img="/images/data-modeling/projections_2.png" size="md" alt="Visualização da tabela principal uk_price_paid_with_projections e de suas duas projeções" />
...
* [Visões materializadas](/pt-BR/concepts/features/materialized-views)
