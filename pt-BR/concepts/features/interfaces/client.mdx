...
<Image img="/images/_snippets/cloud-connect-button.png" size="md" alt="Botão Connect do serviço no ClickHouse Cloud" />
...
<Image img="/images/_snippets/connection-details-native.png" size="md" alt="Detalhes da conexão TCP Native do ClickHouse Cloud" />
