...
<Image img="/images/interfaces/mysql0.png" alt="Tela de credenciais - Prompt" size="md" />

2. Altere o menu suspenso `Connect with` para `MySQL`.

<br />

<Image img="/images/interfaces/mysql1.png" alt="Tela de credenciais - MySQL selecionado" size="md" />
...
<Image img="/images/interfaces/mysql2.png" alt="Tela de credenciais - MySQL habilitado" size="md" />

Copie a string de conexão MySQL exibida.

<Image img="/images/interfaces/mysql3.png" alt="Tela de credenciais - String de conexão" size="md" />
