...
O ClickHouse reconhece, pela extensão do nome do arquivo, que ele usa um formato separado por tabulação. Se precisar especificar explicitamente o formato, basta adicionar um dos [muitos formatos de entrada do ClickHouse](/pt-BR/reference/formats):
...
* `--echo` — imprime a consulta antes da execução.
