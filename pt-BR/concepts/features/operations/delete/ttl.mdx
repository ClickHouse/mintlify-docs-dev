...
description: 'TTL (tempo de vida) refere-se à capacidade de mover, excluir ou agregar linhas ou colunas após um determinado intervalo de tempo.'
...
<div id="manage-data-with-ttl-time-to-live">
  # Gerencie dados com TTL (tempo de vida)
</div>
