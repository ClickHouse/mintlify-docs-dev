...
* Se a sua consulta exigir uma junção direta, ou seja, um `LEFT ANY JOIN`, como mostrado abaixo, recomendamos usar [Dictionaries](/pt-BR/concepts/features/dictionaries) sempre que possível.

<Image img="/images/guides/joins-1.png" size="sm" alt="Junção LEFT ANY" />
...
<Image img="/images/guides/joins-3.png" size="lg" alt="recursos de junção" />
...
<Image img="/images/guides/joins-4.png" size="lg" alt="fluxograma de junção" />
...
<Image img="/images/guides/joins-5.png" size="lg" alt="Árvore de decisão para otimização de memória de junção" />
