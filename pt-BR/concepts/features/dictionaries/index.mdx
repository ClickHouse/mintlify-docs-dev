...
description: 'Um dicionário fornece uma representação de dados em pares chave-valor para buscas rápidas.'
doc_type: 'guide'
---
...
<Image img="/images/dictionary/dictionary-use-cases.png" size="lg" alt="Casos de uso do Dicionário no ClickHouse" />
