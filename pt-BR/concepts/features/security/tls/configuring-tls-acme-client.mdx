...
sidebarTitle: 'Configuração automática de TLS via ACME'
title: 'Configuração do cliente ACME'
description: 'Este guia apresenta as configurações simples e mínimas para configurar o ClickHouse a usar certificados OpenSSL para validar conexões.'
keywords: ['Configuração do ACME', 'configuração de TLS', 'certificados OpenSSL', 'conexões seguras', 'guia de SRE', 'Let`s Encrypt']
doc_type: 'guide'
---
...
<div id="configuring-automatic-tls-provisioning-via-acme">
