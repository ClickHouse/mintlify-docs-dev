...
<Image img="/images/bestpractices/insert_process.png" size="lg" alt="Processos de inserção" background="black" />
...
Ao contrário de muitos bancos de dados tradicionais, o ClickHouse também oferece uma interface HTTP. **Ela, por sua vez, prioriza compatibilidade e flexibilidade.** Ela permite enviar dados em [qualquer formato compatível](/pt-BR/guides/clickhouse/data-formats/intro) — incluindo JSON, CSV, Parquet e outros — e tem amplo suporte na maioria dos clientes ClickHouse, incluindo Python, Java, JavaScript e Rust.
...
Para uma descrição mais detalhada dessas interfaces, consulte [aqui](/pt-BR/concepts/features/interfaces/overview).