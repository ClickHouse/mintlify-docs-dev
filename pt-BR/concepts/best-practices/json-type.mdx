...
Embora o JSON aqui seja complexo, com estruturas aninhadas, ele é previsível. A quantidade e o tipo dos campos não vão mudar. Embora fosse possível usar o tipo JSON neste exemplo, também podemos simplesmente definir a estrutura explicitamente usando os tipos [Tuples](/pt-BR/reference/data-types/tuple) e [Nested](/pt-BR/reference/data-types/nested-data-structures):
