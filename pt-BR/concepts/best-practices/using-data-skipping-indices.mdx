...
<Image img="/images/bestpractices/building_skipping_indices.gif" size="lg" alt="Criando índices de omissão" />
...
<Image img="/images/bestpractices/using_skipping_indices.gif" size="lg" alt="Usando índices de omissão" />
