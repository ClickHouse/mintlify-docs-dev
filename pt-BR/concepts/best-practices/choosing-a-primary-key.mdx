...
<Image img="/images/bestpractices/create_primary_key.gif" size="lg" alt="Chave primária" />
...
<Image img="/images/bestpractices/primary_key.gif" size="lg" alt="Chave primária" />
