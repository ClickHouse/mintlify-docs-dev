...
<Image img="/images/guides/best-practices/query-parallelism_01.gif" size="md" alt="Análise do índice" />
...
<Image img="/images/guides/best-practices/query-parallelism_02.gif" size="md" alt="4 lanes de processamento paralelas" />
...
<Image img="/images/guides/best-practices/query-parallelism_03.gif" size="md" alt="8 lanes de processamento paralelas" />
...
<Image img="/images/guides/best-practices/query-parallelism_04.gif" size="md" alt="Vias distribuídas" />
...
<Image img="/images/guides/best-practices/query-parallelism_05.png" alt="Pipeline da consulta" />
