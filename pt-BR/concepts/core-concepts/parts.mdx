...
Os dados de cada tabela da família de motores [MergeTree](/pt-BR/reference/engines/table-engines/mergetree-family) no ClickHouse são organizados em disco como uma coleção de `data parts` imutáveis.
