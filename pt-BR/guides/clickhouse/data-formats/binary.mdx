...
Vamos usar some&#95;data [table](/pt-BR/assets/some_data.sql) e [data](/pt-BR/assets/some_data.tsv) para demonstração; sinta-se à vontade para reproduzir isso na sua instância do ClickHouse.
...
Isso criará o arquivo [data.clickhouse](/pt-BR/assets/data.clickhouse) no formato Native.
...
Isso gerará o arquivo [data.binary](/pt-BR/assets/data.binary) em formato binário de linhas.
...
Para importar dados de um [arquivo no formato MessagePack](/pt-BR/assets/data.msgpk):
...
Para trabalhar com [Protocol Buffers](/pt-BR/reference/formats/Protobuf/Protobuf), primeiro precisamos definir um [arquivo de esquema](/pt-BR/assets/schema.proto):
...
Outro formato popular de serialização binária compatível com o ClickHouse é o [Cap&#39;n Proto](https://capnproto.org/). Assim como no formato `Protobuf`, precisamos definir um arquivo de esquema ([`schema.capnp`](/pt-BR/assets/schema.capnp)) no nosso exemplo:
