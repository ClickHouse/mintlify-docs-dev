---
title: 'Projetando o esquema JSON'
slug: /integrations/data-formats/json/schema
description: 'Como projetar esquemas JSON de forma otimizada'
keywords: ['json', 'clickhouse', 'inserção', 'carregamento', 'formatos', 'esquema', 'estruturados', 'semi-estruturados']
score: 20
doc_type: 'guide'
---
...
<div id="designing-your-schema">
  # Projetando seu esquema
</div>
...
<Image img="/images/integrations/data-ingestion/data-formats/json_column_per_type.png" size="md" alt="Uma coluna por caminho JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_offsets.png" size="md" alt="Offsets de JSON" />
...
<Image img="/images/integrations/data-ingestion/data-formats/json_shared_column.png" size="md" alt="Coluna JSON compartilhada" />
