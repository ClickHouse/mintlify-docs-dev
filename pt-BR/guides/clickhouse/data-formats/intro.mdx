...
Se você quer conectar uma ferramenta de BI, como Grafana, Tableau e outras, confira a categoria [Visualize](/pt-BR/integrations/connectors/data-visualization) da documentação.