...
<Image img="/images/starter_guides/joins/imdb_schema.png" alt="Esquema do IMDB" />
...
<Image img="/images/starter_guides/joins/inner_join.png" alt="Inner Join" />
...
<Image img="/images/starter_guides/joins/outer_join.png" alt="Junção externa" />
...
<Image img="/images/starter_guides/joins/cross_join.png" alt="Junção cruzada" />
...
<Image img="/images/starter_guides/joins/semi_join.png" alt="Junção semi" />
...
O exemplo a seguir demonstra o `LEFT ANY JOIN` com um exemplo abstrato usando duas tabelas temporárias (`left_table` e `right_table`) criadas com a [função de tabela](/pt-BR/reference/functions/table-functions) [values](https://github.com/ClickHouse/ClickHouse/blob/23.2/src/TableFunctions/TableFunctionValues.h):
...
Este guia mostra como o ClickHouse oferece suporte a todos os tipos padrão de junção do SQL, além de junções especializadas para dar suporte a consultas analíticas.
Consulte a documentação da instrução [JOIN](/pt-BR/reference/statements/select/join) para mais detalhes sobre as junções.