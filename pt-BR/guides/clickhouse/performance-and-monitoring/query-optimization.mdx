...
title: 'Guia de otimização de consultas'
description: 'Um guia simples de otimização de consultas que descreve formas comuns de melhorar o desempenho das consultas'
doc_type: 'guide'
keywords: ['otimização de consultas', 'desempenho', 'melhores práticas', 'ajuste de consultas', 'eficiência']
---
...
<Image img="/images/guides/best-practices/query_optimization_diagram_1.png" size="lg" alt="Fluxo de trabalho de otimização" />
