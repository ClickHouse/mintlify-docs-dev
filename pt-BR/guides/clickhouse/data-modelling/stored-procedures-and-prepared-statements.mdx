...
title: 'Procedimentos armazenados e parâmetros de consulta'
doc_type: 'guide'
---

<div id="stored-procedures-and-query-parameters-in-clickhouse">
  # Procedimentos armazenados e parâmetros de consulta no ClickHouse
</div>

Se você vem de um banco de dados relacional tradicional, talvez esteja procurando por procedimentos armazenados e instruções preparadas no ClickHouse.
Este guia explica como o ClickHouse aborda esses conceitos e apresenta alternativas recomendadas.
...
Para usar parâmetros de consulta em [clientes para linguagens](/pt-BR/integrations/language-clients), consulte a documentação do
