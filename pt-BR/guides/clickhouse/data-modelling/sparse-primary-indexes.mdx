...
<Accordion title="Inspecionando o conteúdo do índice primário">
  <p>
    ...
    Para isso, primeiro precisamos copiar o arquivo do índice primário para o <a href="/pt-BR/reference/settings/server-settings/settings#user_files_path" target="_blank">user&#95;files&#95;path</a> de um nó do cluster ativo:
