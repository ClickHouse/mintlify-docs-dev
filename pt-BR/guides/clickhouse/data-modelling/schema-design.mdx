...
<Image img="/images/data-modeling/stackoverflow-schema.png" size="lg" alt="Esquema do Stack Overflow" />
...
<Image img="/images/data-modeling/schema-design-indices.png" size="md" alt="Indexação esparsa no ClickHouse" />
...
* [**Dictionaries**](/pt-BR/concepts/features/dictionaries) - Um recurso específico do ClickHouse para lidar com direct joins e lookups de chave-valor.
