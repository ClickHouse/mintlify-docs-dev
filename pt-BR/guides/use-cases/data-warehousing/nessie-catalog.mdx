...
Você pode usar o [setup oficial do Docker Compose do Nessie](https://projectnessie.org/guides/setting-up/), que fornece um ambiente completo com Nessie, repositório de versões em memória e MinIO para armazenamento de objetos.
