---
title: 'Primeiros passos com formatos de tabela abertos'
...
<Info>
  **TL;DR**
  ...
  Um passo a passo prático para consultar tabelas em lago de dados, acelerá-las com MergeTree e gravar os resultados de volta no Iceberg. Todas as etapas usam conjuntos de dados públicos e funcionam tanto no Cloud quanto no OSS.
</Info>

As capturas de tela deste guia são do [Console SQL do ClickHouse Cloud](https://console.clickhouse.cloud). Todas as consultas funcionam tanto no Cloud quanto em implantações autogerenciadas.
...
<Steps>
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-direct.png" alt="Consulta do Iceberg" />
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query-engine.png" alt="Consulta no Iceberg" />
  ...
  <Step>
    ...
    Cada tipo de catálogo exige suas próprias configurações de conexão — consulte os [guias de Catálogos](/pt-BR/guides/use-cases/data-warehousing/reference) para ver a lista completa de catálogos compatíveis e suas opções de configuração.
  ...
  <Step>
    ...
    <Image img="/images/datalake/iceberg-query.png" alt="Consulta no Iceberg" />
    ...
    <Image img="/images/datalake/clickhouse-query.png" alt="Consulta do ClickHouse" />
