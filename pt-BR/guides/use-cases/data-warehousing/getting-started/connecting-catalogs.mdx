...
O Databricks oferece suporte a vários formatos de dados para seu lakehouse. Com o ClickHouse, você pode consultar tabelas do Unity Catalog tanto em Delta quanto em Iceberg.

<Note>
  A integração com o Unity Catalog funciona com tabelas gerenciadas e tabelas externas.
  No momento, essa integração é compatível apenas com a AWS.
</Note>
