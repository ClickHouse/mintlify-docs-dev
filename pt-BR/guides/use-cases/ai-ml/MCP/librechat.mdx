...
title: 'Configure o servidor MCP ClickHouse com o LibreChat e o ClickHouse Cloud'
...
<div id="using-clickhouse-mcp-server-with-librechat">
  # Usando o servidor MCP ClickHouse com o LibreChat
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/MCP/librechat.png" alt="Selecione seu servidor MCP" size="md" />
