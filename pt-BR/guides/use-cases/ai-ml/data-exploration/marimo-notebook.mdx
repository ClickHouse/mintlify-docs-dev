...
Neste guia, você aprenderá a explorar, em um notebook do Marimo, um conjunto de dados do ClickHouse Cloud com a ajuda do [chDB](/pt-BR/products/chdb) — um mecanismo SQL OLAP rápido executado no próprio processo, baseado em ClickHouse.
...
* Aproveitar o modelo de execução reativo do Marimo para explorar dados de forma interativa
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/4.png" alt="interface do Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/5.png" alt="Marimo hello world" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/6.png" alt="Visualização de dados do Marimo" />
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/7.gif" alt="Gráfico dinâmico do Marimo" />
...
# cria um gráfico de caixa interativo.
fig_box = go.Figure()
...
fig_box.add_trace(
    go.Box(
        ...
        boxmean='sd',  # Exibe média e desvio padrão
        marker_color='lightblue',
        boxpoints='outliers'  # Exibe pontos discrepantes
    )
)
...
<Image size="md" img="/images/use-cases/AI_ML/Marimo/8.gif" alt="Gráfico dinâmico do Marimo" />
