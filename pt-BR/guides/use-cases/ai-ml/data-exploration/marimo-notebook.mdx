...
Neste guia, você aprenderá a explorar, em um notebook do Marimo, um conjunto de dados do ClickHouse Cloud com a ajuda do [chDB](/pt-BR/products/chdb/index) — um mecanismo SQL OLAP rápido executado no próprio processo, baseado em ClickHouse.
