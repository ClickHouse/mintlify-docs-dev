...
sidebarTitle: 'Explorando dados com notebooks Jupyter e chDB'
title: 'Explorando dados em notebooks Jupyter com chDB'
description: 'Este guia explica como configurar e usar o chDB para explorar dados do ClickHouse Cloud ou de arquivos locais em notebooks Jupyer'
...
Neste guia, você aprenderá a explorar um conjunto de dados no ClickHouse Cloud em um Jupyter notebook com a ajuda do [chDB](/pt-BR/products/chdb) — um mecanismo SQL OLAP in-process rápido, baseado em ClickHouse.
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/1.png" alt="Adicionar conjunto de dados de exemplo" />

Selecione `Get started` no cartão de dados de preços pagos de imóveis do Reino Unido (4GB):

<Image size="md" img="/images/use-cases/AI_ML/jupyter/2.png" alt="Selecionar conjunto de dados de preços pagos do Reino Unido" />

Em seguida, clique em `Import dataset`:

<Image size="md" img="/images/use-cases/AI_ML/jupyter/3.png" alt="Importar conjunto de dados de preços pagos do Reino Unido" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/4.png" alt="Criar um novo notebook" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/5.png" alt="Selecionar kernel" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/6.png" alt="pré-visualização do dataframe" />
...
# Mostrar a cada 2 anos para evitar sobreposição
years_to_show = df['year'][::2]  # A cada 2 anos
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/7.png" alt="prévia do DataFrame" />
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/8.png" alt="prévia do DataFrame" />
...
# Plotar casas vendidas no eixo y esquerdo
color = 'tab:blue'
ax1.set_xlabel('Year')
...
<Image size="md" img="/images/use-cases/AI_ML/jupyter/9.png" alt="Gráfico do conjunto de dados remoto e do conjunto de dados local" />
