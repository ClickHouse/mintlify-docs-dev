...
Neste guia, você aprenderá a explorar um conjunto de dados no ClickHouse Cloud em um Jupyter notebook com a ajuda do [chDB](/pt-BR/products/chdb/index) — um mecanismo SQL OLAP in-process rápido, baseado em ClickHouse.
