...
<div id="using-clickhouse-for-observability">
  # Usando ClickHouse para observabilidade
</div>
...
<Image img="/images/use-cases/observability/observability-2.png" alt="Exemplo de trace" size="lg" border />
