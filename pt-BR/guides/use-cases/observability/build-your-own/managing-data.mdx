...
<Image img="/images/use-cases/observability/observability-14.png" alt="Partições" size="md" />
...
--mover dados para a tabela de arquivo
ALTER TABLE otel_logs
        (MOVE PARTITION tuple('2019-01-26') TO TABLE otel_logs_archive
--confirmar que os dados foram movidos
SELECT
