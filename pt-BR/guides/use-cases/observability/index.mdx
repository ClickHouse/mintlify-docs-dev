...
| [Primeiros passos](/pt-BR/clickstack/getting-started)               | Guia de início rápido e instruções básicas de configuração  |
| [Conjuntos de dados de exemplo](/pt-BR/clickstack/example-datasets) | Conjuntos de dados de exemplo e casos de uso                |
| [Arquitetura](/pt-BR/clickstack/architecture)                       | Visão geral da arquitetura do sistema e de seus componentes |
| [Implantação](/pt-BR/clickstack/deployment)                         | Guias e opções de implantação                               |
| [Configuração](/pt-BR/clickstack/managing/config)                   | Opções detalhadas de configuração e ajustes                 |
| [Ingestão de dados](/pt-BR/clickstack/ingesting-data)               | Diretrizes para ingestão de dados no ClickStack             |
