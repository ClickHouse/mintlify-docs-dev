...
<div id="cloud-monitoring">
  # Monitoramento autogerenciado
</div>

Este guia fornece às equipes corporativas que estão avaliando o ClickHouse open-source informações abrangentes sobre os recursos de monitoramento e observabilidade para implantações em produção. Clientes corporativos frequentemente perguntam sobre recursos de monitoramento prontos para uso, integração com stacks de observabilidade existentes, incluindo ferramentas como Datadog e AWS CloudWatch, e como o monitoramento do ClickHouse se compara ao de implantações autogerenciadas.
