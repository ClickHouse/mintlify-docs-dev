...
> Este tutorial mostra como manter rollups pré-agregados de uma tabela de eventos de alto volume usando [**visões materializadas**](/pt-BR/concepts/features/materialized-views).
...
<Steps>
  ...
  <Step>
    ...
    (
        bucket_start  DateTime,            -- início da hora
        country       LowCardinality(String),
        event_type    LowCardinality(String),
