...
O ClickHouse oferece tracing com OpenTelemetry para solicitações do [ClickHouse Keeper](/pt-BR/guides/oss/deployment-and-scaling/keeper) (serviço de coordenação compatível com ZooKeeper). Esse recurso oferece visibilidade detalhada do ciclo de vida das operações do Keeper, desde o envio da solicitação pelo cliente até o processamento no servidor.
