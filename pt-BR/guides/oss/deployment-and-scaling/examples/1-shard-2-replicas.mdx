...
<Image img="/images/deployment-guides/replication-sharding-examples/replication.png" size="md" alt="Diagrama de arquitetura para 1 shard e 2 réplicas com ReplicatedMergeTree" />
...
<Steps>
  ...
  <Step>
    ...
    abaixo precisam ser ajustadas de acordo com cada nó:
  ...
  <Step>
    ...
    Mas o que acontece se um dos hosts estiver fora do ar? Para simular isso, pare
