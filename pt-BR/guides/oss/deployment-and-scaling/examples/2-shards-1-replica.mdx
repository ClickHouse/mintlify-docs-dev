...
<Image img="/images/deployment-guides/replication-sharding-examples/sharding.png" size="md" alt="Diagrama de arquitetura para 2 shards e 1 réplica" />
...
<Steps>
  ...
  <Step>
    ...
    abaixo precisam ser ajustadas para cada nó específico:
