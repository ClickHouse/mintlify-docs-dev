...
O ClickHouse Keeper é recomendado para substituir o ZooKeeper em clusters do ClickHouse.  Consulte a documentação do [ClickHouse Keeper](/pt-BR/guides/oss/deployment-and-scaling/keeper)
