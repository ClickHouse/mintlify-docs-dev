...
Permite executar consultas [SELECT](/pt-BR/reference/statements/select).
...
Permite executar consultas [ALTER](/pt-BR/reference/statements/alter) de acordo com a seguinte hierarquia de privilégios:
...
Permite executar instruções DDL [CREATE](/pt-BR/reference/statements/create) e [ATTACH](/pt-BR/reference/statements/attach) de acordo com a seguinte hierarquia de privilégios:
...
Permite usar fontes externas de dados. Aplica-se a [motores de tabela](/pt-BR/reference/engines/table-engines) e [funções de tabela](/pt-BR/reference/functions/table-functions).
...
Permite usar um motor de tabela específico ao criar uma tabela. Aplica-se a [motores de tabela](/pt-BR/reference/engines/table-engines).
...
Alguns motores de tabela com fontes externas podem exigir permissões `READ`/`WRITE` na fonte correspondente. Veja [Sources](#sources).
