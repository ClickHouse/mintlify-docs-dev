...
Esse formato também é conhecido como `JSONEachRow`, `NDJSON` (JSON delimitado por novas linhas) ou `JSONL` (`JSONLines`). Todos esses nomes são aliases do mesmo formato e podem ser usados indistintamente.
