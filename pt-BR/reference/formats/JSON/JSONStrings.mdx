---
alias: []
description: 'Documentação do formato JSONStrings'
input_format: true
...
Difere do formato [JSON](/pt-BR/reference/formats/JSON/JSON) apenas no fato de que os campos de dados são gerados como strings, e não como valores JSON tipados.
...
Leia os dados usando o formato `JSONStrings`:
