...
A configuração [`format_capn_proto_use_autogenerated_schema`](/pt-BR/reference/settings/formats#format_capn_proto_use_autogenerated_schema) vem habilitada por padrão e se aplica quando [`format_schema`](/pt-BR/reference/formats/index#formatschema) não está definida.
