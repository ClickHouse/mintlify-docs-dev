...
<Info>
  Este é um recurso experimental que pode mudar de forma incompatível com versões anteriores em lançamentos futuros.
  Habilite o uso do motor de tabela `Alias`
  com a configuração [allow&#95;experimental&#95;alias&#95;table&#95;engine](/pt-BR/reference/settings/session-settings#allow_experimental_alias_table_engine).
  Execute o comando `set allow_experimental_alias_table_engine = 1`.
</Info>
