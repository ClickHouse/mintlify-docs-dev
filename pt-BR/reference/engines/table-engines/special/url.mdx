...
* O `Format` deve ser um formato que o ClickHouse possa usar em consultas `SELECT` e, se necessário, em `INSERT`. Para a lista completa de formatos compatíveis, consulte [Formats](/pt-BR/reference/formats#formats-overview).
