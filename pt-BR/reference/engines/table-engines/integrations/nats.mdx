---
description: 'Este motor permite integrar o ClickHouse ao NATS para publicar em ou assinar
...
title: 'Motor de tabela NATS'
doc_type: 'guide'
---

Este motor permite integrar o ClickHouse ao [NATS](https://nats.io/).
...
* `nats_format` – Formato da mensagem. Usa a mesma notação da função SQL `FORMAT`, como `JSONEachRow`. Para mais informações, consulte a seção [Formatos](/pt-BR/reference/formats).
...
O engine NATS oferece suporte a todos os [formatos](/pt-BR/reference/formats) compatíveis com o ClickHouse.
