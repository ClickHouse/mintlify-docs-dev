...
O destino do backup pode ser qualquer [destino](/pt-BR/concepts/features/backup-restore/local-disk#configure-backup-destinations-for-disk) de backup válido, como `Disk`, `S3`, `File`.

Com o destino de backup `Disk`, a consulta para criar um banco de dados a partir do backup fica assim:
