...
title: UDFs Funções definidas pelo usuário
doc_type: 'reference'
---
...
| `format`                      | Um [formato](/pt-BR/reference/formats) no qual os argumentos são passados para o comando. Também se espera que a saída do comando use o mesmo formato                                                                                                                                                                                                                                                                                                          | Sim         | -                         |
