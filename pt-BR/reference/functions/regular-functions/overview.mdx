...
<Note>
  Há um terceiro tipo de função, ao qual a [função &#39;arrayJoin&#39;](/pt-BR/reference/functions/regular-functions/array-join) pertence. E as [funções de tabela](/pt-BR/reference/functions/table-functions) também podem ser mencionadas separadamente.
</Note>
