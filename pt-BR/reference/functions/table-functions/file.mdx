---
description: 'Um motor de tabela que fornece uma interface do tipo tabela para fazer SELECT
  de arquivos e INSERT neles, semelhante à função de tabela s3. Use `file()` ao trabalhar
  com arquivos locais e `s3()` ao trabalhar com buckets em armazenamento de objetos, como
  S3, GCS ou MinIO.'
sidebarTitle: 'file'
