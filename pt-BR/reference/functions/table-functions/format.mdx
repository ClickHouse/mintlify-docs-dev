---
description: 'Interpreta os dados dos argumentos de acordo com o formato de entrada especificado. Se o argumento de estrutura não for especificado, ele será extraído dos dados.'
...
* `format_name` — O [formato](/pt-BR/reference/formats) dos dados.
...
* [Formatos](/pt-BR/reference/formats)