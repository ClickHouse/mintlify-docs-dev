...
Cria uma tabela a partir de arquivos no HDFS. Esta função de tabela é semelhante às funções de tabela [url](/pt-BR/reference/functions/table-functions/url) e [file](/pt-BR/reference/functions/table-functions/file).
