...
<VersionHistory rows={[{"id": "row-1","items": [{"label": "26.2"},{"label": "1"},{"label": "Limita o tamanho das partes mesmo com min_age_to_force_merge_seconds por padrão"}]}, {"id": "row-2","items": [{"label": "25.1"},{"label": "0"},{"label": "Adicionada nova configuração para limitar o número máximo de bytes para min_age_to_force_merge."}]}, {"id": "row-3","items": [{"label": "25.1"},{"label": "0"},{"label": "Nova configuração"}]}]} />
