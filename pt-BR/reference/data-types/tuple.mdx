...
Uma tupla de elementos, cada elemento com um [tipo](/pt-BR/reference/data-types) próprio. Tuple deve conter pelo menos um elemento.
...
<Warning>
  **Funcionalidade experimental**
  ...
  Requer `SET allow_experimental_nullable_tuple_type = 1`
