...
Família de tipos de dados que representa intervalos de data e hora. Os tipos resultantes do operador [INTERVAL](/pt-BR/reference/operators#interval).
...
* operador [INTERVAL](/pt-BR/reference/operators#interval)
