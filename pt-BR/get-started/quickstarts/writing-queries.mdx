...
<Note>
  Consulte a [Referência SQL](/pt-BR/reference/statements/select) para mais detalhes sobre a sintaxe, as cláusulas e as opções disponíveis.
</Note>
...
Adicione uma cláusula `FORMAT` para especificar um dos [muitos formatos de saída compatíveis com o ClickHouse](/pt-BR/reference/formats#formats-overview):
