...
<Image img="/images/use-cases/rta-considerations.png" alt="Analytics em tempo real: tempo de ingestão, transformação e consulta" />
...
<Columns cols={2}>
  <div>
    <Image img="/images/use-cases/real-time-analytics-architecture.png" alt="Como o ClickHouse viabiliza analytics em tempo real" />
  </div>
