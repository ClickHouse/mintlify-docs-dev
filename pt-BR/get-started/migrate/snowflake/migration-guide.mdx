...
keywords: ['Snowflake']
title: 'Migração do Snowflake para o ClickHouse'
...
<div id="migrate-from-snowflake-to-clickhouse">
  # Migrar do Snowflake para o ClickHouse
</div>
...
<Steps>
  <Step>
    ...
    <Image img="/images/migrations/migrate_snowflake_clickhouse.png" size="md" alt="Migrando do Snowflake para o ClickHouse" />
