...
description: 'Migração do Snowflake para o ClickHouse'
keywords: ['Snowflake']
title: 'Migrar do Snowflake para o ClickHouse'
...
<div id="snowflake-to-clickhouse-migration">
...
<Image img="/images/cloud/onboard/discover/use_cases/snowflake_architecture.png" size="md" alt="Arquitetura do Snowflake" />
...
<Image img="/images/cloud/onboard/discover/use_cases/cloud_architecture.png" size="md" alt="Arquitetura do ClickHouse Cloud" />
