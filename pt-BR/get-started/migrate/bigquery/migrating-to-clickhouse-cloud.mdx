...
<Image img="/images/migrations/bigquery-4.png" size="md" alt="Carregamento em massa" />
...
<Image img="/images/migrations/bigquery-5.png" size="md" alt="Chaves primárias do ClickHouse" />
...
<Image img="/images/migrations/bigquery-6.png" size="md" alt="Partições" />
...
<Image img="/images/migrations/bigquery-7.png" size="md" alt="Projeções" />
...
<Image img="/images/migrations/bigquery-8.png" size="sm" alt="Reescrevendo consultas do BigQuery" border />
...
<Image img="/images/migrations/bigquery-10.png" border size="sm" alt="Funções de agregação 1" />

<Image img="/images/migrations/bigquery-11.png" border size="sm" alt="Funções de agregação 2" />
...
<Image img="/images/migrations/bigquery-12.png" size="sm" border alt="Condicionais e arrays" />
