...
<div id="comparing-clickhouse-cloud-and-bigquery">
  # Comparação entre ClickHouse Cloud e BigQuery
</div>
...
<Image img="/images/migrations/bigquery-1.png" size="md" alt="Organização dos recursos" />
...
| [STRUCT](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-types#constructing_a_struct) | [Tuple](/pt-BR/reference/data-types/tuple), [Nested](/pt-BR/reference/data-types/nested-data-structures)                                                                                                     |
