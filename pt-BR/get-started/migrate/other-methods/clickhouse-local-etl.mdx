...
<Image img="/images/integrations/migration/ch-local-01.png" size="lg" alt="Migrando o ClickHouse autogerenciado" />
...
[motor de integração](/pt-BR/reference/engines/table-engines#integration-engines) fornecido pelo ClickHouse ou uma [função de tabela](/pt-BR/reference/functions/table-functions),
...
<Image img="/images/integrations/migration/ch-local-02.png" size="lg" alt="Migrando ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/ch-local-03.png" size="lg" alt="Migrando o ClickHouse autogerenciado" />
