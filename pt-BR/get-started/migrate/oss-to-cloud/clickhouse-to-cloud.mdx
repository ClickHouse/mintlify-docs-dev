...
title: 'Migrando entre o ClickHouse autogerenciado e o ClickHouse Cloud'
description: 'Página que descreve como migrar entre o ClickHouse autogerenciado e o ClickHouse Cloud'
doc_type: 'guide'
keywords: ['migração', 'ClickHouse Cloud', 'OSS', 'Migrar do autogerenciado para a Cloud']
---
...
<div id="migrating-between-self-managed-clickhouse-and-clickhouse-cloud-using-remotesecure">
  # Migrando entre ClickHouse autogerenciado e ClickHouse Cloud usando remoteSecure
</div>

<Image img="/images/integrations/migration/self-managed-01.png" size="lg" alt="Migrando ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/self-managed-02.png" size="lg" alt="Migrando ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/self-managed-03.png" size="lg" alt="Migrando o ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/self-managed-04.png" size="lg" alt="Migrando o ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/self-managed-05.png" size="lg" alt="Migração de ClickHouse autogerenciado" />
...
<Image img="/images/integrations/migration/self-managed-06.png" size="lg" alt="Migração de ClickHouse autogerenciado" />
