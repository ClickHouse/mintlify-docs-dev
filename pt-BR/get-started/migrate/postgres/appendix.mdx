...
<Image img="/images/integrations/data-ingestion/dbms/postgres-replicas.png" size="md" alt="Consistência eventual" />
...
| `JSON`                   | [String](/pt-BR/reference/data-types/string), [Variant](/pt-BR/reference/data-types/variant), [Nested](/pt-BR/reference/data-types/nested-data-structures#nestedname1-type1-name2-type2-), [Tuple](/pt-BR/reference/data-types/tuple) |
