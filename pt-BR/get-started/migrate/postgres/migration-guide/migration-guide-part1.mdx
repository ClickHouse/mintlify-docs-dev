...
<Image img="/images/migrations/postgres-stackoverflow-schema.png" size="lg" alt="Esquema PostgreSQL do Stack Overflow" />
...
Consulte este [guia](/pt-BR/integrations/clickpipes/postgres) para configurar o ClickPipes para PostgreSQL. O guia aborda vários tipos diferentes de instâncias de origem do Postgres.
