...
<Image img="/images/migrations/postgres-b-tree.png" size="lg" alt="Índice B-Tree do PostgreSQL" />

<Image img="/images/migrations/postgres-sparse-index.png" size="lg" alt="Índice esparso do PostgreSQL" />
...
<Image img="/images/migrations/postgres-partitions.png" size="md" alt="Partições do PostgreSQL para partições do ClickHouse" />
...
<Image img="/images/migrations/postgres-projections.png" size="md" alt="Projeções do PostgreSQL no ClickHouse" />
...
Como o Postgres é um banco de dados relacional, seu modelo de dados é altamente [normalizado](https://en.wikipedia.org/wiki/Database_normalization), muitas vezes envolvendo centenas de tabelas. No ClickHouse, a desnormalização pode, em alguns casos, ser vantajosa para otimizar o desempenho de JOIN.

Consulte este [guia](/pt-BR/guides/clickhouse/data-modelling/denormalization), que mostra os benefícios de desnormalizar o conjunto de dados do Stack Overflow no ClickHouse.
