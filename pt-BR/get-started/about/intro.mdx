...
<Image img="/images/column-oriented-example-query.png" alt="Exemplo de consulta em um banco de dados orientado a colunas" size="lg" />
...
<Image img="/images/column-oriented.gif" alt="Estrutura de um banco de dados orientado a colunas" size="lg" />
