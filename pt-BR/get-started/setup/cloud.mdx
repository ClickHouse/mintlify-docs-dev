...
<Steps>
  <Step>
    ...
    * Faça login usando o nome de usuário e a senha que você acabou de criar
    ...
    <Image img="/images/_snippets/signup_page.png" size="md" alt="Selecionar plano" border />
    ...
    <Image img="/images/_snippets/createservice1.png" size="md" alt="Novo serviço ClickHouse" border />
    ...
    <Image img="/images/_snippets/scaling_limits.png" size="md" alt="Limites de escalonamento" border />
  ...
  <Step>
    ...
    <Image img="/images/_snippets/data_sources.png" size="md" alt="Fontes de dados" border />
    ...
    * Carregar dados de uma URL de arquivo
    ...
    <Image img="/images/_snippets/select_data_source.png" size="md" alt="Selecione a fonte de dados" border />
    ...
    * as chaves primárias no ClickHouse ***não são únicas*** para cada linha de uma tabela
    ...
    Para uma análise aprofundada dos conceitos fundamentais do ClickHouse, consulte [&quot;Conceitos Fundamentais&quot;](/pt-BR/concepts/core-concepts).
    ...
    <Note>
      Observe que a coluna `timestamp` é preenchida com várias funções [**Date**](/pt-BR/reference/data-types/date) e [**DateTime**](/pt-BR/reference/data-types/datetime). O ClickHouse tem centenas de funções úteis que você pode [consultar na seção **Functions**](/pt-BR/reference/functions).
    </Note>
    ...
    <Image img="/images/_snippets/client_details.png" size="md" alt="detalhes da conexão do ClickHouse client" border />
    ...
    4. Adicione uma cláusula [`FORMAT`](/pt-BR/reference/statements/select/format) para especificar um dos [muitos formatos de saída suportados pelo ClickHouse](/pt-BR/reference/formats):
    ...
    <Image img="/images/_snippets/new_rows_from_csv.png" size="md" alt="Novas linhas do arquivo CSV" />
...
* Temos uma lista de [datasets de exemplo](/pt-BR/get-started/sample-datasets) com instruções sobre como inseri-los
* Confira nosso vídeo de 25 minutos sobre [Primeiros passos com ClickHouse](https://clickhouse.com/company/events/getting-started-with-clickhouse/)
...
* Se você estiver usando uma ferramenta de visualização/BI, consulte os [guias do usuário para conectar uma UI ao ClickHouse](/pt-BR/integrations/connectors/data-visualization)
