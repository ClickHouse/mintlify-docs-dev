...
<div className="installContainer">
  <a href="/pt-BR/install/quick-install" style={{textDecoration: 'none'}}>
    <Card title="Instalação rápida" />
  </a>

  <a href="/pt-BR/install/clickhousectl" style={{textDecoration: 'none'}}>
    <Card title="clickhousectl (CLI)" icon="console" />
  </a>

  <a href="/pt-BR/install/docker" style={{textDecoration: 'none'}}>
    <Card title="Docker" />
  </a>

  <a href="/pt-BR/install/advanced" style={{textDecoration: 'none'}}>
...
<div className="installContainer">
  <a href="/pt-BR/install/debian_ubuntu" style={{textDecoration: 'none'}}>
    <Card title="Debian/Ubuntu" />
  </a>

  <a href="/pt-BR/install/redhat" style={{textDecoration: 'none'}}>
    <Card title="Redhat" />
  </a>

  <a href="/pt-BR/install/nixos" style={{textDecoration: 'none'}}>
    <Card title="NixOS" />
  </a>

  <a href="/pt-BR/install/linux_other" style={{textDecoration: 'none'}}>
