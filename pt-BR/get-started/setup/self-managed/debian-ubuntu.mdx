...
<Steps>
  ...
  <Step>
    ...
    * Você pode baixar e instalar os pacotes manualmente em [packages.clickhouse.com](https://packages.clickhouse.com/deb/pool/main/c/).
    ...
    <Accordion title="Método para instalar pacotes deb em distribuições antigas">
      ```bash
      # Instale os pacotes de pré-requisito
...
<Info>
  Se você precisar instalar uma versão específica do ClickHouse, deverá instalar todos os pacotes na mesma versão:
