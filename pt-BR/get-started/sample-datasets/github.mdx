...
<Image img="/images/getting-started/example-datasets/superset-github-lines-added-deleted.png" alt="Para linhas adicionadas e removidas" size="md" />

**Para commits e autores:**

<Image img="/images/getting-started/example-datasets/superset-commits-authors.png" alt="Para commits e autores" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix.png" alt="Matriz de autores do Superset" size="md" />
...
<Image img="/images/getting-started/example-datasets/superset-authors-matrix_v2.png" alt="Matriz de autores do Superset v2" size="md" />
