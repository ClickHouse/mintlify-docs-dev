...
<Image img="/images/getting-started/example-datasets/visualization_1.png" size="md" alt="Mapa de densidade de pontos de interesse na Europa" />

<Image img="/images/getting-started/example-datasets/visualization_2.png" size="md" alt="Bares de saquê no Japão" />

<Image img="/images/getting-started/example-datasets/visualization_3.png" size="md" alt="Caixas eletrônicos" />

<Image img="/images/getting-started/example-datasets/visualization_4.png" size="md" alt="Mapa da Europa com pontos de interesse categorizados por país" />