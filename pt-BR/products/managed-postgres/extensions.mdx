...
Consulte a [documentação do pg&#95;clickhouse](/pt-BR/integrations/connectors/tools/pg_clickhouse/introduction) para ver as instruções de configuração e os detalhes de uso.
