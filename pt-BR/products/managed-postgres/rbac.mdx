...
<Image img="/images/managed-postgres/rbac/usersandroles.png" alt="Menu Usuários e funções" size="md" border />
...
<Image img="/images/managed-postgres/rbac/postgresentity.png" alt="Selecionando a entidade Serviço Postgres" size="md" border />

4. Escolha o serviço Postgres ao qual a função se aplicará e selecione as permissões a serem concedidas.

<Image img="/images/managed-postgres/rbac/newpostgresperms.png" alt="Configurando permissões do Postgres em uma função" size="md" border />
