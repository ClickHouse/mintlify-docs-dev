...
| -------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------- |
| [Dashboard](/pt-BR/products/managed-postgres/monitoring/dashboard)               | Gráficos integrados no Cloud Console para uso de recursos e atividade do banco de dados                   | Nenhuma                           |
