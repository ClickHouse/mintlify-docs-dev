...
title: 'endpoint do Prometheus do Managed Postgres'
...
<Image img="/images/managed-postgres/monitoring/grafana-dashboard.png" alt="Dashboard do Grafana dos serviços do Managed Postgres" size="md" border />
...
[cloud-api]: /products/cloud/features/admin-features/api "API do Cloud"
