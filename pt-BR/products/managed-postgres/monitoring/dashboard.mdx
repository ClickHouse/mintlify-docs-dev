...
<Image img="/images/managed-postgres/monitoring/dashboard.png" alt="Dashboard de monitoramento mostrando IOPS, uso de CPU, memória, disco, tráfego de rede, tamanho do banco de dados, conexões, taxa de transferência, transações, taxa de acerto do cache e deadlocks" size="lg" border />
