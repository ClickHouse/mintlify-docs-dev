...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readwrite.png" alt="Resultados do benchmark de Leitura+Escrita Intensiva de E/S" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/io-intensive-readonly.png" alt="Resultados do benchmark Intensivo de E/S Somente leitura" size="md" border />
...
<Image img="/images/managed-postgres/benchmarks/compute-intensive.png" alt="Resultados do benchmark intensivo em CPU" size="md" border />
