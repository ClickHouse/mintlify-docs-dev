...
title: 'OpenAPI'
description: 'Gerencie seus serviços do Managed Postgres com nossa OpenAPI'
...
{/*
  ...
  TODO: Descomentar e inserir a saída de exemplo correta quando a API for lançada.
...
{/*
  ...
  TODO: Expandir quando isso for implementado.

  A OpenAPI fornece endpoints adicionais para atualizar propriedades não suportadas
  pela [patch API]. Por exemplo, para atualizar a [configuração do Postgres],
  use a [config API]:
  ...
  A saída mostrará a configuração atualizada:
