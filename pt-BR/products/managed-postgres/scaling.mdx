...
<Image img="/images/managed-postgres/instance-types.png" alt="Tipos de instância" size="md" border />
...
<Image img="/images/managed-postgres/scaling-settings.png" alt="Configurações de escalonamento" size="md" border />
