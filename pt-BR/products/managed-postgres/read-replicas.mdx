...
<Image img="/images/managed-postgres/warehouse-view.png" alt="Visualização do warehouse com ícone de edição" size="md" border />

Isso abre a caixa de diálogo do warehouse, onde você pode ver os serviços existentes e criar novas réplicas de leitura:

<Image img="/images/managed-postgres/read-replica-dialog.png" alt="Caixa de diálogo de gerenciamento de réplicas de leitura" size="md" border />
...
<Image img="/images/managed-postgres/read-replicas-flow.png" alt="Visualização Flow de réplicas de leitura mostrando a topologia da primária e das réplicas" size="lg" border />
...
<Image img="/images/managed-postgres/read-replicas-table.png" alt="Visualização Table de réplicas de leitura" size="lg" border />
