...
<Image img="/images/managed-postgres/backup-and-restore.png" alt="Visualização Backups mostrando o histórico de backups e opções de recuperação em um ponto no tempo" size="lg" border />
