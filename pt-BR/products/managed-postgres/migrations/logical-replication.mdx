...
title: 'Migre os dados do PostgreSQL usando replicação lógica'
...
<div id="logical-replication-migration">
  # Migre para o Managed Postgres usando replicação lógica
</div>
...
<Image img="/images/managed-postgres/logical_replication/source-setup.png" alt="Configuração da replicação do PostgreSQL de origem" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuração das tabelas de origem no PostgreSQL" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/target-initial-setup.png" alt="Configuração inicial do ClickHouse Managed Postgres de destino" size="xl" border />
...
<Image img="/images/managed-postgres/logical_replication/migration-result.png" alt="Resultado da migração após a replicação lógica" size="xl" border />
