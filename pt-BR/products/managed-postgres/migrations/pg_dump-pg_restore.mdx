...
title: 'Migre os dados do PostgreSQL usando pg_dump e pg_restore'
...
<div id="pg-dump-pg-restore">
  # Migre para o Managed Postgres com pg_dump e pg_restore
</div>

Este guia apresenta instruções passo a passo para migrar seu banco de dados PostgreSQL para o ClickHouse Managed Postgres usando os utilitários `pg_dump` e `pg_restore`.
...
<Image img="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Configuração do banco de dados PostgreSQL de origem" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="Execução do comando pg_dump" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/create-pg-for-migration.png" alt="Criar instância do ClickHouse Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="Execução do comando pg_restore" size="xl" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Configuração do banco de dados de destino do Managed Postgres" size="xl" border />
