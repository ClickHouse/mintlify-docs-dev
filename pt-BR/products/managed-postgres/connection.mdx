...
<Image img="/images/managed-postgres/connect-button.png" alt="Clique em Connect na barra lateral esquerda para ver os detalhes da conexão" size="md" border />

Ao clicar em **Connect**, um modal é aberto exibindo suas credenciais de conexão e strings de conexão em múltiplos formatos.

<Image img="/images/managed-postgres/connect-modal.png" alt="Modal de conexão mostrando credenciais e formatos de string de conexão" size="md" border />
...
<Image img="/images/managed-postgres/tls-ca-bundle.png" alt="Baixar certificado da CA na aba Settings" size="md" border />
