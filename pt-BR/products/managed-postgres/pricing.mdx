...
Postgres managed by ClickHouse é baseado em armazenamento NVMe local, o que permite oferecer desempenho pronto para produção e integração nativa com ClickHouse sem a sobrecarga de custos das arquiteturas tradicionais de armazenamento conectado via rede. Esta página aborda o modelo de preços, os tipos de instância disponíveis e a comparação entre os tiers do serviço.
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', margin: '24px 0'}}>
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Ótimo para testar novas ideias ou projetos iniciais. Armazenamento e memória limitados.</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Para ambientes de produção, grandes volumes de dados ou casos de uso profissionais.</p>
  ...
  <div style={{border: '1px solid #e5e7eb', borderTop: '3px solid #faff69', borderRadius: '8px', padding: '20px'}}>
    ...
    <p style={{textAlign: 'center', fontSize: '0.85rem', minHeight: '3.5em', marginBottom: '16px'}}>Para trabalhar com ambientes de produção, grandes volumes de dados em escala ou casos de uso corporativos.</p>
    ...
    <ul style={{paddingLeft: '20px', margin: 0, fontSize: '0.9rem'}}>
      ...
      <li><a href="/pt-BR/products/cloud/guides/infrastructure/deployment-options/clickhouse-private">Regiões privadas</a></li>
...
* O Provisioning de scaling, failover e standby executa brevemente duas instâncias em paralelo para manter seu banco de dados online — você poderá ver cobranças sobrepostas para ambas as instâncias enquanto a transição é concluída. A duração dessa janela varia com base no tipo de instância e no volume de armazenamento.
* Quando o tipo de instância selecionado estiver temporariamente indisponível na região escolhida, poderemos provisionar um tipo de instância comparável para manter seu banco de dados online. Você será cobrado pela tarifa da instância provisionada.
