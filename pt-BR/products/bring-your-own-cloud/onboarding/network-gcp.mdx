...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-1.png" size="md" alt="BYOC Criar conexão de peering" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-2.png" size="md" alt="BYOC Aceitar conexão de peering" border />
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-gcp-3.png" size="lg" alt="BYOC Aceitar conexão de peering" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-1.png" size="lg" alt="Endpoint PSC do BYOC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-2.png" size="lg" alt="Endpoint PSC do BYOC" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-3.png" size="lg" alt="Endpoint PSC do BYOC" border />

    <Image img="/images/cloud/reference/byoc-privatelink-gcp-4.png" size="lg" alt="Endpoint PSC do BYOC" border />
  </Step>
  ...
  <Step>
    ...
    * O status do endpoint deve mudar para &quot;Accepted&quot;; entre em contato com o suporte do ClickHouse se ele não for aceito automaticamente.
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-5.png" size="lg" alt="Criação de endpoint PSC do BYOC" border />
    ...
    * Clique no endpoint para abrir os detalhes e obtenha o &quot;PSC Connection ID&quot; para usar na etapa [Adicionar o PSC Connection ID do endpoint à allowlist do serviço](#step-5-add-endpoint-id-allowlist)
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-gcp-6.png" size="lg" alt="Detalhes do endpoint PSC do BYOC" border />
  </Step>
