...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-subnet-1.png" size="lg" alt="Sub-rede da VPC BYOC" />

    <Image img="/images/cloud/reference/byoc-subnet-2.png" size="lg" alt="Tags da sub-rede da VPC BYOC" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-s3-endpoint.png" size="lg" alt="Endpoint S3 do BYOC" />
  </Step>
  ...
  <Step>
    ...
    No console do ClickHouse Cloud, acesse a [página de configuração do BYOC](https://console.clickhouse.cloud/byocOnboarding) e configure o seguinte:
    ...
    5. Clique em **Setup Infrastructure** para iniciar o provisionamento.

    <Image img="/images/cloud/reference/byoc-aws-existing-vpc-ui.png" size="lg" alt="UI de configuração do BYOC no ClickHouse Cloud com Usar VPC existente selecionado" />
