...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-gcp-existing-vpc-ui.png" size="lg" alt="UI de configuração do BYOC do ClickHouse Cloud com Use existing VPC selecionado para GCP" />
  </Step>
</Steps>