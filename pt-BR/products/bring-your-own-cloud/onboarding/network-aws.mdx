...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-1.png" size="lg" alt="BYOC Criar conexão de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-2.png" size="lg" alt="BYOC Aceitar conexão de peering" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-3.png" size="lg" alt="BYOC Adicionar tabela de rotas" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-vpcpeering-4.png" size="lg" alt="BYOC Adicionar tabela de rotas" border />
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-1.png" size="lg" alt="Endpoint de serviço BYOC PrivateLink" border />
    ...
    <Image img="/images/cloud/reference/byoc-privatelink-2.png" size="lg" alt="Aprovação do BYOC PrivateLink" border />
  </Step>
