...
<Image img="/images/cloud/reference/byoc-new-infra-1.png" size="lg" alt="Página de infraestrutura do BYOC" />

1. Selecione &quot;Add new infrastructure&quot; e siga as instruções na interface guiada para concluir o processo de configuração.

<Image img="/images/cloud/reference/byoc-new-infra-2.png" size="lg" alt="Página de infraestrutura do BYOC" />