...
<Steps>
  ...
  <Step title="Selecione um modelo">
    ...
    <Image img="/images/agentic-data-stack/select-model.png" alt="O seletor de modelos do LibreChat no canto superior esquerdo, mostrando o modelo padrão com uma dica de ferramenta Select a model" size="md" />
    ...
    <Accordion title="Defina uma chave do provedor na UI">
      ...
      <Image img="/images/agentic-data-stack/set-api-key.png" alt="Seletor de modelos do LibreChat com o botão Set API Key ao lado do provedor Anthropic" size="md" />

      Cole sua chave na caixa de diálogo e clique em **Submit**. Você pode definir uma expiração ou manter a chave sem expiração.

      <Image img="/images/agentic-data-stack/set-api-key-modal.png" alt="A caixa de diálogo Set API Key for Anthropic com uma lista suspensa de expiração, um campo Key e os botões Submit e Revoke" size="md" />
    </Accordion>
  </Step>
  ...
  <Step title="Selecione o servidor MCP">
    ...
    <Image img="/images/agentic-data-stack/select-clickhouse-local.png" alt="O menu MCP Servers aberto na área de composição do LibreChat, mostrando ClickHouse-Local com um ponto verde indicando conexão e ClickHouse-Cloud" size="md" />
  </Step>
  ...
  <Step title="Faça sua primeira pergunta">
    ...
    <Image img="/images/agentic-data-stack/prompt-chat.png" alt="O LibreChat respondendo à pergunta de exemplo ao chamar as ferramentas MCP do ClickHouse-Local e listar os bancos de dados e tabelas disponíveis" size="md" />
  </Step>
</Steps>
