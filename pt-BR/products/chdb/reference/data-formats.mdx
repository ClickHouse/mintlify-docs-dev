...
* `DataFrame` como formato de entrada e saída; o tipo é Python `pandas.DataFrame`. Para exemplos, consulte [`test_joindf.py`](https://github.com/chdb-io/chdb/blob/main/tests/test_joindf.py)
...
Para mais informações e exemplos, consulte [formatos para dados de entrada e saída do ClickHouse](/pt-BR/reference/formats).