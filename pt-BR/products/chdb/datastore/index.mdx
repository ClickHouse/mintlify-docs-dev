---
title: 'DataStore - API compatível com o Pandas'
sidebarTitle: 'Visão geral'
slug: /chdb/datastore
description: 'DataStore oferece uma API compatível com o Pandas, com otimização SQL para análise de dados de alto desempenho'
...
<div id="datastore-pandas-compatible-api-with-sql-optimization">
  # DataStore: API compatível com pandas com otimização de consultas SQL
</div>

DataStore é a API compatível com pandas do chDB que combina a conhecida interface DataFrame do pandas com o poder da otimização de consultas SQL, permitindo que você escreva código no estilo do pandas e obtenha o desempenho do ClickHouse.
...
* [Configuração](/pt-BR/products/chdb/configuration) - Todas as opções de configuração
* [Modo de desempenho](/pt-BR/products/chdb/configuration/performance-mode) - Modo SQL-first para máxima taxa de transferência
* [Depuração](/pt-BR/products/chdb/debugging) - Explain, profiling e logging
