...
<Image img="/images/cloud/security/aws-privatelink-pe-create.png" size="md" alt="Endpoints privados" border />
...
<Image img="/images/cloud/security/aws-privatelink-endpoint-settings.png" size="md" alt="Configurações do endpoint do AWS PrivateLink" border />
...
<Image img="/images/cloud/security/aws-privatelink-select-vpc-and-subnets.png" size="md" alt="Selecione a VPC e as sub-redes" border />
...
<Image img="/images/cloud/security/aws-privatelink-vpc-endpoint-id.png" size="md" alt="ID do endpoint da VPC" border />
...
<Image img="/images/cloud/security/aws-privatelink-pe-dns-name.png" size="md" alt="Nome DNS do endpoint privado" border />
