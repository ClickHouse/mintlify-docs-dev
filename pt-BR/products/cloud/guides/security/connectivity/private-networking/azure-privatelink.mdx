...
<Image img="/images/cloud/security/azure-pe.png" size="lg" alt="Visão geral do PrivateLink" background="white" />
...
<Image img="/images/cloud/security/azure-privatelink-pe-create.png" size="lg" alt="Endpoints privados" border />
...
<Image img="/images/cloud/security/azure-private-link-center.png" size="lg" alt="Abrir o Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.png" size="md" alt="Criar Private Endpoint Basic" border />
...
<Image img="/images/cloud/security/azure-pe-resource.png" size="md" alt="Seleção de recurso do Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-vnet.png" size="md" alt="Seleção da Virtual Network do Private Endpoint" border />

Clique no botão **Next: Tags**.

***

<Image img="/images/cloud/security/azure-pe-create-dns.png" size="md" alt="Configuração de DNS do Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-create-tags.png" size="md" alt="Tags do Private Endpoint" border />

Por fim, clique no botão **Create**.

<Image img="/images/cloud/security/azure-pe-create-review.png" size="md" alt="Revisão do Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-ip.png" size="lg" alt="Endereço IP do Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pe-view.png" size="lg" alt="Exibição do Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-pl-dns-wildcard.png" size="lg" alt="Configuração de DNS curinga do Private Link" border />
...
<Image img="/images/cloud/security/azure-pe-remove-private-endpoint.png" size="lg" alt="Remover Private Endpoint" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.png" size="lg" alt="Nome DNS do Private Endpoint" border />
