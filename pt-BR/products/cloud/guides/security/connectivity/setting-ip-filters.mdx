...
<Info>
  **Aplicável apenas a conexões fora do PrivateLink**
  ...
  As listas de acesso IP se aplicam apenas a conexões vindas da internet pública, fora do [PrivateLink](/pt-BR/products/cloud/guides/security/connectivity/private-networking).
...
<Image img="/images/cloud/security/ip-filtering-after-provisioning.png" size="md" alt="Lista de acesso existente no ClickHouse Cloud" border />
...
<Image img="/images/cloud/security/ip-filter-add-single-ip.png" size="md" alt="Adicionando um único IP à lista de acesso no ClickHouse Cloud" border />
