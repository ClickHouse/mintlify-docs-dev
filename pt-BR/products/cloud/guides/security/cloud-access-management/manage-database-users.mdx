...
<Image img="/images/cloud/security/cloud-access-management/user_grant_permissions_options.png" alt="Uma ilustração mostrando as diferentes formas pelas quais um usuário pode receber permissões" size="md" background="black" />
