...
<Steps>
  ...
  <Step>
    ### Selecione &#39;Invite members&#39; no canto superior esquerdo
  ...
  <Step>
    ### Insira o endereço de e-mail dos novos membros e atribua funções
...
<div id="manage-role-assignments">
  ## Gerenciar atribuições de funções de usuário
</div>
...
<Steps>
  <Step>
    ### Acesse configuração da organização e selecione Users and roles
  ...
  <Step>
    ### Selecione o usuário a ser atualizado e selecione Edit
