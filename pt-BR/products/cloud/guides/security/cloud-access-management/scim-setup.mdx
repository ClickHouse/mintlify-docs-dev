...
<Steps>
  <Step>
    ...
    ![Acesse a guia de configuração do SCIM em Organization settings](/images/cloud/security/scim-okta/scim-okta-01.png)
    ...
    ![Ative Enable SCIM](/images/cloud/security/scim-okta/scim-okta-02.png)
  ...
  <Step>
    ...
    ![Gere uma nova chave de API do SCIM](/images/cloud/security/scim-okta/scim-okta-07.png)
  </Step>
...
<Steps>
  <Step>
    ...
    ![Defina o modo de provisionamento como SCIM nas configurações do aplicativo no Okta](/images/cloud/security/scim-okta/scim-okta-03.png)

    O aplicativo agora exibe uma guia **Provisioning**.

    ![A guia Provisioning agora aparece no aplicativo](/images/cloud/security/scim-okta/scim-okta-05.png)
  </Step>
  ...
  <Step>
    ...
    * **Modo de autenticação** — `Basic Auth`.
    ...
    ![Insira a URL do conector SCIM e defina o identificador exclusivo como userName](/images/cloud/security/scim-okta/scim-okta-06.png)

    ![Insira as credenciais da API para autenticação SCIM](/images/cloud/security/scim-okta/scim-okta-08.png)
    ...
    ![Teste a conexão SCIM](/images/cloud/security/scim-okta/scim-okta-09.png)
  ...
  <Step>
    ...
    ![Ative as ações de Provisioning do SCIM para usuários](/images/cloud/security/scim-okta/scim-okta-10.png)
    ...
    ![Salve as configurações de Provisioning e volte para a aba Sign On](/images/cloud/security/scim-okta/scim-okta-10b.png)
  </Step>
  ...
  <Step>
    ...
    **Crie grupos no Okta.** Para cada mapeamento de função que você configurou anteriormente, crie ou identifique um grupo no Okta com o **mesmo nome de exibição exato**. Por exemplo, se o seu mapeamento diz `ClickHouse-Admins → Admin`, crie um grupo chamado `ClickHouse-Admins` no Okta.
    ...
    ![Crie um novo grupo no Okta](/images/cloud/security/scim-okta/scim-okta-13.png)

    Abra o grupo que você acabou de criar e clique em `Assign people` para adicionar um membro.

    ![Clique em Assign people no grupo](/images/cloud/security/scim-okta/scim-okta-14.png)

    ![Atribua o usuário ao grupo](/images/cloud/security/scim-okta/scim-okta-15.png)
    ...
    ![Atribua o aplicativo ao grupo](/images/cloud/security/scim-okta/scim-okta-16.png)
    ...
    **Envie os grupos.** Na guia **Provisioning** do aplicativo, clique em `Push Groups → Find groups by name`, procure seu grupo e clique em `Save`. Repita o processo para cada grupo de função. Cada um deverá exibir **Push Status** como **Active (Pushed)** depois de provisionado.
    ...
    ![Configure o Group Push por nome na guia Push Groups do aplicativo](/images/cloud/security/scim-okta/scim-okta-17.png)
...
![Verifique a sincronização de usuários em Users and roles](/images/cloud/security/scim-okta/scim-okta-18.png)
