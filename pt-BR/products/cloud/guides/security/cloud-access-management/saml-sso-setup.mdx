...
doc_type: 'guide'
keywords: ['ClickHouse Cloud', 'SAML', 'SSO', 'login único', 'IdP', 'Okta', 'Google']
---
...
No momento, oferecemos suporte a SSO iniciado pelo provedor de serviço, várias organizações usando conexões separadas e provisionamento just-in-time. Ainda não oferecemos suporte a System for Cross-domain Identity Management (SCIM) nem a mapeamento de atributos.
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-1.png" size="lg" alt="Iniciar a configuração do SAML" force />
  </Step>
  ...
  <Step>
    ...
    * [Configurar o SAML no Duo](#configure-duo-saml)
    ...
    <Image img="/images/cloud/security/saml-self-serve-2.png" size="lg" alt="Criar aplicativo no provedor de identidade" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-3.png" size="lg" alt="Adicionar URL de metadados" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-4.png" size="lg" alt="Adicionar domínio para verificar" force />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/saml-self-serve-5.png" size="lg" alt="Verifique seu domínio" force />
  </Step>
...
<Accordion title="Criar um aplicativo da Web no Google">
  ...
  <Image img="/images/cloud/security/saml-google-app.png" size="md" alt="Aplicativo SAML do Google" force />
...
<Accordion title="Criar um aplicativo Enterprise no Azure">
  ...
  5. Digite um nome, selecione **Integrate any other application you don&#39;t find in the gallery (Non-gallery)** e clique em **Create**.
     ...
     <Image img="/images/cloud/security/saml-azure-app.png" size="md" alt="Aplicativo do Azure fora da galeria" force />
  ...
  10. Adicione (A) ou atualize (U) os itens a seguir em Attributes &amp; Claims:
      ...
      <Image img="/images/cloud/security/saml-azure-claims.png" size="md" alt="Atributos e declarações" force />
