...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_1.png" size="md" alt="Solicitar ativação da HIPAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_2.png" size="md" alt="Enviar uma solicitação de BAA" background="black" />
    ...
    <Image img="/images/cloud/security/compliance/hipaa_3.png" size="md" alt="HIPAA ativada" background="black" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/security/compliance/hipaa_4.png" size="md" alt="Implantar em uma região compatível com a HIPAA" background="black" />
