...
As atividades no Console são registradas no log de auditoria. Se você tiver a Role de organização Admin ou Developer, poderá consultar o log e integrá-lo aos seus sistemas de logging.
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/security/activity_log1.png" size="md" alt="Aba de atividade do ClickHouse Cloud" border />
  ...
  <Step>
    ...
    * **Time:** O timestamp do evento
    ...
    <Image img="/images/cloud/security/activity_log2.png" size="md" alt="Tabela de atividade do ClickHouse Cloud" border />
...
<div class="eighty-percent">
  <Image img="/images/cloud/security/activity_log3.png" size="lg" alt="Exportação CSV de atividade do ClickHouse Cloud" border />
</div>
