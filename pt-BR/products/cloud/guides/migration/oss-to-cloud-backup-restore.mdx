...
title: 'Migração entre ClickHouse autogerenciado e ClickHouse Cloud com BACKUP/RESTORE'
...
<div id="migrating-from-self-managed-clickhouse-to-clickhouse-cloud-using-backup-commands">
  # Migração de ClickHouse autogerenciado para o ClickHouse Cloud com comandos de backup
</div>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/create_service.png" size="md" alt="criar um novo serviço" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/service_details.png" size="md" alt="definir preferências do serviço" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/open_console.png" size="md" alt="definir preferências do serviço" />
...
<Image img="/images/cloud/onboard/migrate/oss_to_cloud_via_backup/backup_in_s3_bucket.png" size="md" alt="backup, dados e metadados" />
