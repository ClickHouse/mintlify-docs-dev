...
<div id="review-and-restore-backups">
  # Verificar e restaurar backups
</div>

Este guia explica como os backups funcionam no ClickHouse Cloud, quais opções você tem para configurar backups para o seu serviço e como restaurar a partir de um backup.

**Pré-requisitos**

* Você leu [&quot;Como os backups funcionam no ClickHouse Cloud&quot;](/pt-BR/products/cloud/features/backups/overview#how-backups-work-in-clickhouse-cloud) (página de visão geral da funcionalidade)
...
<Image img="/images/cloud/manage/backup-status-list.png" size="md" alt="Lista de status de backups no ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-usage.png" size="md" alt="Gráfico de uso de backups no ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/backup-restore.png" size="md" alt="Restaurando um backup no ClickHouse Cloud" />

O novo serviço aparecerá na lista de serviços como `Provisioning` até ficar pronto:

<Image img="/images/cloud/manage/backup-service-provisioning.png" size="md" alt="Provisionamento do serviço em andamento" border />
