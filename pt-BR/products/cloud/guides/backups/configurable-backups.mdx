...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="Configurar definições de backup" border />
...
<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="Selecionar retenção e frequência de backup" border />
