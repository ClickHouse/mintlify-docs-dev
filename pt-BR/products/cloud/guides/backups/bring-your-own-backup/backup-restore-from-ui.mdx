...
title: 'Criar um backup ou restaurar um backup pela UI'
...
<div id="ui-experience">
  # Backup / restauração pela interface do usuário
</div>

<Note>
  Os backups automatizados no seu bucket externo são configurados para serem executados como backups &quot;completos&quot; a cada 24 horas, e a frequência não pode ser alterada.
</Note>
...
<Steps>
  ...
  <Step>
    ...
    * a. Obtenha o ARN na página de configurações do serviço ClickHouse Cloud, em Network security information, que será semelhante a este:
    ...
    <Image img="/images/cloud/manage/backups/arn.png" alt="ARN do AWS S3" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/change_external_backup.png" alt="Alterar o backup externo" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/configure_arn_s3_details.png" alt="Configurar o ARN da IAM role da AWS e os detalhes do bucket do S3" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups.png" alt="Ver backups armazenados no seu bucket" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/backup_command.png" alt="Obter comando SQL usado para restaurar backup" size="md" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/change_external_backup.png" alt="Alterar backup externo" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_configure.png" alt="Configurar a chave HMAC e o Secret do GCP" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_stored_backups.png" alt="Ver backups armazenados no seu bucket" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/gcp_restore_command.png" alt="Obter o comando SQL usado para restaurar o backup" size="md" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/azure_connection_details.png" alt="Informe a Connection String e o nome do Container da sua conta de armazenamento do Azure" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/view_backups_azure.png" alt="Ver backups armazenados no seu bucket" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/restore_backups_azure.png" alt="Restaurar backups no Azure" size="md" />
