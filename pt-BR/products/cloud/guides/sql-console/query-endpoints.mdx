...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-testquery.png" size="md" alt="Testar a consulta de exemplo" />

    Em seguida, salve a consulta:

    <Image img="/images/cloud/sqlconsole/endpoints-savequery.png" size="md" alt="Salvar consulta de exemplo" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-configure.png" size="md" alt="Configurar endpoint de consulta" />
    ...
    * Especifique os domínios permitidos para compartilhamento de recursos entre origens (CORS)
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-completed.png" size="md" alt="Comando curl do endpoint" />
  ...
  <Step>
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-curltest.png" size="md" alt="teste curl do endpoint" />
    ...
    <Image img="/images/cloud/sqlconsole/endpoints-monitoring.png" size="sm" alt="Monitoramento do endpoint" />
  </Step>
</Steps>
