...
<Image img="/images/cloud/security/secures3.png" size="lg" alt="Visão geral do acesso seguro ao S3 com ClickHouse" />
...
<Image img="/images/cloud/security/secures3_arn.png" size="lg" alt="Obtendo o ARN da função do IAM do serviço ClickHouse" border />
...
<Image img="/images/cloud/security/secures3_output.png" size="lg" alt="Saída da stack do CloudFormation mostrando o ARN da função do IAM" border />
