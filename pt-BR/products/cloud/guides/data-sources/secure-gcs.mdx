...
<Steps>
  <Step>
    ...
    ```text
    Service account name: clickhouse-gcs-access (ou o nome de sua preferência)
    Service account description: Service account para o ClickHouse Cloud acessar buckets do GCS
    ```
