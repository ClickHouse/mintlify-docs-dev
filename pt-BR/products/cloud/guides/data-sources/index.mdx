...
O ClickHouse oferece suporte a várias funções de tabela para acessar fontes de dados externas. Para mais informações, consulte [funções de tabela](/pt-BR/reference/functions/table-functions) na seção de referência de SQL.