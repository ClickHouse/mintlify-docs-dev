...
<Image img="/images/_snippets/aws-rds-mysql.png" size="lg" alt="Regras do Security Group da AWS" border />
...
<Image img="/images/_snippets/gcp-authorized-network.png" size="md" alt="Redes autorizadas do GCP" border />