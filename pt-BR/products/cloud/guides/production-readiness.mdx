...
<div id="user-lifecycle-management">
  ### Limitações no gerenciamento do ciclo de vida de usuários
</div>

No momento, o ClickHouse Cloud não oferece suporte a SCIM nem ao provisionamento/desprovisionamento automatizado por provedores de identidade. Os usuários precisam ser removidos manualmente do console do ClickHouse Cloud depois de serem removidos do seu IdP. Planeje processos manuais de gerenciamento de usuários até que esses recursos estejam disponíveis.

Saiba mais sobre [Cloud Access Management](/pt-BR/products/cloud/guides/security/cloud-access-management) e [SAML SSO setup](/pt-BR/products/cloud/guides/security/cloud-access-management/saml-sso-setup).
...
Quando as atuais [limitações do plano de serviço](/pt-BR/products/cloud/features/cloud-tiers) afetarem suas operações de produção, considere opções de upgrade para obter recursos avançados, como [rede privada](/pt-BR/products/cloud/guides/security/connectivity/private-networking), [TDE/CMEK](/pt-BR/products/cloud/guides/security/cmek) (Transparent Data Encryption com chaves de criptografia gerenciadas pelo cliente) ou [opções avançadas de backup](/pt-BR/products/cloud/guides/backups/configurable-backups).