...
<Image img="/images/cloud/features/autoscaling/scheduled-scaling-1.png" size="md" alt="A interface de agendamentos de escalonamento no console do ClickHouse Cloud, mostrando regras de escalonamento baseadas em horário" border />

<Image img="/images/cloud/features/autoscaling/scheduled-scaling-2.png" size="md" alt="Configurando uma regra de Scheduled Scaling no console do ClickHouse Cloud" border />
