...
Você pode usar as [APIs públicas](/api-reference/organization/get-list-of-available-organizations#/paths/~1v1~1organizations~1:organizationId~1services~1:serviceId~1scaling/patch) do ClickHouse Cloud para escalar seu serviço atualizando as configurações de escalonamento do serviço ou ajustar o número de réplicas no console do ClickHouse Cloud.
...
<Image img="/images/cloud/manage/scaling-patch-request.png" size="lg" alt="Solicitação PATCH de escalonamento" border />

*Solicitação `PATCH` para atualizar `numReplicas`*

<Image img="/images/cloud/manage/scaling-patch-response.png" size="md" alt="Resposta PATCH de escalonamento" border />
...
<Image img="/images/cloud/manage/scaling-configure.png" size="md" alt="Configurações de escalonamento" border />
...
<Image img="/images/cloud/manage/scaling-memory-allocation.png" size="md" alt="Alocação de memória do escalonamento" border />