...
A CLI também gerencia instalações e servidores locais do ClickHouse. Consulte a página de [instalação rápida](/pt-BR/get-started/setup/self-managed/quick-install) para dar os primeiros passos no desenvolvimento local.
