...
<Image img="/images/use-cases/AI_ML/MCP/1connectmcpmodal.png" alt="Selecione MCP no modal Connect" size="md" />

Ative o botão para habilitar o MCP no serviço:

<Image img="/images/use-cases/AI_ML/MCP/2enable_mcp.png" alt="Habilitar servidor MCP" size="md" />
...
Consulte o guia dedicado de [integração Conectando o Notion ao ClickHouse](/pt-BR/integrations/connectors/data-integrations/integrations/notion) para conectar o servidor MCP remoto do ClickHouse Cloud a um Custom Agent do Notion.
