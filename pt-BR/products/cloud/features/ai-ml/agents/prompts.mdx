...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.png" alt="Painel Prompts com o botão + destacado à esquerda e o formulário Criar prompt aberto à direita, mostrando os campos Nome do prompt, Texto, Categoria, Variáveis especiais, Descrição e Comando, com um botão Criar prompt" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/preview.png" alt="Painel Prompts com um prompt selecionado, seus detalhes visíveis à direita e um menu de contexto mostrando as opções Preview e Edit" size="lg" />
...
<Image img="/images/cloud/agent-builder/prompts/use-prompt-modal.png" alt="Modal de visualização do prompt mostrando o título, o autor, a data, o texto e o botão Use Prompt" size="md" />
