...
<Tip>
  Ainda não conhece o ClickHouse Agents? Comece pelo [Quickstart](/pt-BR/products/cloud/features/ai-ml/agents/quickstart). As páginas abaixo detalham cada parte do builder.
</Tip>
...
| Página                                                                                    | Descrição                                            |
| ----------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| [Parâmetros do modelo](/pt-BR/products/cloud/features/ai-ml/agents/builder/model-parameters)    | Escolha um modelo e ajuste os parâmetros de geração. |
