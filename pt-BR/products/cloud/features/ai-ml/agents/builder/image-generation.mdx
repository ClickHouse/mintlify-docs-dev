...
<Image img="/images/cloud/agent-builder/tools-modal.png" alt="Janela modal Agent Tools mostrando integrações de modelos de imagem, incluindo OpenAI Image Tools, DALL-E-3 e Stable Diffusion, ao lado de outras ferramentas de terceiros" size="md" />
