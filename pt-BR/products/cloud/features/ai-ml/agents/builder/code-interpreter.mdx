...
<Image img="/images/cloud/agent-builder/run-code/run-code.png" alt="Seção Run Code do painel Capabilities, com a caixa de seleção Run Code habilitada e um botão Upload to Code Environment" size="sm" />
