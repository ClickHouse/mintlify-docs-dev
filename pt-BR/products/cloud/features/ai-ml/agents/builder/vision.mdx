...
Mude para um modelo compatível com Vision em [parâmetros do modelo](/pt-BR/products/cloud/features/ai-ml/agents/builder/model-parameters) para reativá-lo.
...
<Image img="/images/cloud/agent-builder/vision/vision.png" alt="Área de composição da mensagem com o menu do clipe de papel aberto, mostrando as opções Upload to Provider, Upload as Text e Upload to Code Environment" size="lg" />
