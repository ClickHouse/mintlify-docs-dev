...
<Image img="/images/cloud/agent-builder/web-search/web-search.png" alt="Painel de Capabilities com a seção Web Search destacada, mostrando a caixa de seleção de Web Search" size="sm" />
