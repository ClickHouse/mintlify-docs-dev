...
<Image img="/images/cloud/agent-builder/marketplace/marketplace.png" alt="Interface de chat com a opção Agent Marketplace destacada na barra lateral esquerda" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/browse.png" alt="Tela do Agent Marketplace com o título, a barra de pesquisa, as abas de categoria (Geral, Recursos Humanos, Pesquisa e Desenvolvimento, Finanças, TI, Vendas, Pós-vendas, Todas) e um cartão de agente visível" size="lg" />
...
<Image img="/images/cloud/agent-builder/marketplace/use-agent.png" alt="Modal de detalhes do agente mostrando o nome do agente, um ícone e as ações Pin, Copy link e Start Chat" size="md" />
