...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/agent-builder/launch-ch-agents.png" alt="Navegação do serviço Cloud com ClickHouse agents (Beta) selecionado, mostrando a central dos agentes com o botão Launch ClickHouse agents" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Model** - escolha um modelo na lista suspensa. Ajuste a temperature e outras configurações de geração em [model parameters](/pt-BR/products/cloud/features/ai-ml/agents/builder/model-parameters).

    <Image img="/images/cloud/agent-builder/agent-builder.png" alt="Painel do Agent Builder mostrando o menu suspenso Create New Agent, os campos do formulário (Name, Description, Category, Instructions, Model) e a seção Capabilities" size="lg" />
  </Step>
  ...
  <Step>
    ...
    **Capabilities** no painel principal — recursos nativos como [Run Code](/pt-BR/products/cloud/features/ai-ml/agents/builder/code-interpreter), [Web Search](/pt-BR/products/cloud/features/ai-ml/agents/builder/web-search), File Context, Artifacts, [MCP Servers](/pt-BR/products/cloud/features/ai-ml/agents/builder/mcp-servers) e [Skills](/pt-BR/products/cloud/features/ai-ml/agents/builder/skills). Ative os que o agente precisar.
    ...
    <Image img="/images/cloud/agent-builder/capabilities.png" alt="Seção Capabilities do painel do Agent Builder mostrando os controles de Run Code, Web Search, File Context, Artifacts, MCP Servers e Skills" size="sm" />
    ...
    **Tools** no botão **Add Tools** na parte inferior do painel — integrações de terceiros como [image generation](/pt-BR/products/cloud/features/ai-ml/agents/builder/image-generation), [vision](/pt-BR/products/cloud/features/ai-ml/agents/builder/vision), APIs de busca e serviços externos.
    ...
    <Image img="/images/cloud/agent-builder/tools-button.png" alt="Parte inferior do painel do Agent Builder com o botão Add Tools destacado" size="sm" />

    Clique em **Add Tools** para navegar pelo catálogo:

    <Image img="/images/cloud/agent-builder/tools-modal.png" alt="Modal Agent Tools mostrando uma grade de integrações de terceiros, incluindo Google, OpenAI Image Tools, Wolfram, DALL-E-3, Tavily Search, Calculator e Stable Diffusion" size="lg" />
