...
Memory é um armazenamento por usuário que o agente pode recuperar em várias conversas. Ele é composto por várias entradas, cada uma delas um par chave-valor — seu
...
Abra o painel de memória pelo ícone **Memories** (cérebro) na navegação à esquerda. O painel lista as memórias armazenadas, com controles para criar, editar, excluir e filtrar entradas.

<Image img="/images/cloud/agent-builder/memory/memories.png" alt="Painel Memories mostrando o ícone de cérebro destacado na navegação à esquerda, um campo de filtro, um botão Add, uma caixa de seleção Use memory, uma entrada de memória com controles de edição e exclusão e um botão Admin Settings" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/create.png" alt="Painel de Memory com o botão + de Criar Memory destacado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/filter.png" alt="Painel de Memory com o campo Filtrar Memories destacado e 'demo' digitado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/edit.png" alt="Entrada de Memory com o ícone de lápis de Editar Memory destacado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/delete.png" alt="Entrada de Memory com o ícone de lixeira Excluir Memory destacado" size="sm" />
...
<Image img="/images/cloud/agent-builder/memory/toggle.png" alt="Painel de Memory com a caixa de seleção Use memory destacada na parte superior" size="sm" />
