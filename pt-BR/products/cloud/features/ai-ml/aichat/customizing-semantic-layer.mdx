...
title: 'Otimizando as conversas do agente do ClickHouse Assistant com uma camada semântica'
description: 'Guia para usar o AGENTS.md e fornecer lógica de negócios personalizada e instruções específicas dos dados ao agente de chat do ClickHouse Assistant'
keywords: ['AI', 'ClickHouse Cloud', 'Agente', 'AGENTS.md', 'Camada Semântica', 'Instruções Personalizadas', 'Prompt de Sistema']
show_related_blogs: true
doc_type: 'guide'
---

O agente de chat do ClickHouse Assistant pode ser personalizado para entender a lógica de negócios específica, as estruturas de dados e o conhecimento de domínio da sua organização por meio do **AGENTS.md** — uma consulta salva especial que atua como uma camada semântica sobre o prompt de sistema do agente.
