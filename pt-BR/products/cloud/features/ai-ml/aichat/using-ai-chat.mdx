...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/1_open_chat.png" alt="Abrir o flyout do AI Chat" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/2_consent.png" alt="Caixa de diálogo de consentimento" size="md" />
  </Step>
  ...
  <Step>
    ...
    * **Docs AI (Ask)**: Perguntas e respostas focadas, fundamentadas na documentação oficial do ClickHouse e em referências de boas práticas.
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/3_modes.png" alt="Seleção de modo" size="sm" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/4_thinking.png" alt="Etapas de thinking" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/5_history.png" alt="Lista do histórico de chats" size="md" />
  </Step>
  ...
  <Step>
    ...
    * Modifique e execute no Console.
    ...
    <Image img="/images/use-cases/AI_ML/AIChat/6_result_actions.png" alt="Ações de resultado" size="md" />

    <Image img="/images/use-cases/AI_ML/AIChat/7_open_in_editor.png" alt="Abrir consulta gerada no editor" size="md" />
  </Step>
