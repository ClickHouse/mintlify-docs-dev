...
<Image img="/images/cloud/dashboards/2_dashboards.png" size="md" alt="Criar uma consulta salva" border />
...
<Image img="/images/cloud/dashboards/3_dashboards.png" size="md" alt="Salvar consulta" border />
...
<Image img="/images/cloud/dashboards/4_dashboards.png" size="md" alt="Uma visualização em gráfico de barras dos resultados de uma consulta" border />

Agora que há duas consultas, vamos criar um dashboard para visualizá-las e reuni-las em um só lugar.

<div id="create-a-dashboard">
  ### Crie um dashboard
</div>

No painel Painéis, clique em “New Dashboard”. Depois de dar um nome a ele, você terá criado seu primeiro dashboard com sucesso!

<Image img="/images/cloud/dashboards/5_dashboards.png" size="md" alt="Criar um novo dashboard" border />
...
<Image img="/images/cloud/dashboards/6_dashboards.png" size="md" alt="Adicionar uma visualização" border />
...
<Image img="/images/cloud/dashboards/7_dashboards.png" size="md" alt="Visualizar resultados da consulta como uma tabela" border />

Você criou seu primeiro dashboard ao visualizar duas consultas salvas!

<div id="configure-a-filter">
  ### Configure um filtro
</div>

Vamos tornar este dashboard interativo adicionando um filtro para o tipo de consulta, para que você possa exibir apenas as tendências relacionadas a consultas Insert. Faremos isso usando [parâmetros de consulta](/pt-BR/reference/syntax#defining-and-using-query-parameters).

Clique nos três pontos ao lado do gráfico de linhas e, em seguida, no botão de lápis ao lado da consulta para abrir o editor de consulta embutido. Aqui, podemos editar diretamente do dashboard a consulta salva subjacente.

<Image img="/images/cloud/dashboards/8_dashboards.png" size="md" alt="Edite a consulta subjacente" border />
...
<Image img="/images/cloud/dashboards/9_dashboards.png" size="md" alt="Ajuste os filtros globais" border />
...
<Image img="/images/cloud/dashboards/10_dashboards.png" size="md" alt="Alterando o parâmetro de consulta" border />

Agora, você pode controlar o filtro do gráfico de linhas diretamente da tabela de consultas por tipo, tornando seu dashboard interativo.

<Image img="/images/cloud/dashboards/11_dashboards.png" size="md" alt="Controle o filtro no gráfico de linha" border />