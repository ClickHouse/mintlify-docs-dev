...
description: 'Visualize dados do system.query_log para simplificar a depuração de consultas e a otimização do desempenho'
keywords: ['query insights', 'log de consultas', 'UI de log de consultas', 'insights de system.query_log']
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Visão geral da UI do Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Gráfico de latência da UI do Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="UI do Query Insights: tabela de Consultas recentes" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="UI do Query Insights: detalhamento da consulta" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="UI do Query Insights: informações da consulta" border />
