...
description: 'Execute consultas e crie visualizações usando o SQL Console.'
...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="md" alt="lista de tabelas e esquema" />

As tabelas na lista também podem ser expandidas para visualizar colunas e tipos

<Image img="/images/cloud/sqlconsole/view-columns.png" size="md" alt="visualizar colunas" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="md" alt="inspecionando o conteúdo da célula" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="md" alt="ordenar em ordem decrescente por uma coluna" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="md" alt="filtro na coluna radio igual a GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="md" alt="Adicionar um filtro com intervalo maior que 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="md" alt="Adicionar um filtro para intervalo maior que 2000" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="md" alt="Criar uma consulta a partir de ordenações e filtros" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="md" alt="Criando uma consulta" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="md" alt="executar consulta selecionada" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="md" alt="executar na posição do cursor" />

* Selecione &#39;Run at cursor&#39; no menu de contexto do SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="md" alt="executar na posição do cursor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="md" alt="Cancelar uma consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-save-query.png" size="md" alt="Salvar consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-rename.png" size="md" alt="Renomear consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="md" alt="Compartilhar consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="md" alt="Editar acesso" />
...
<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="md" alt="Adicionar membro da equipe" />

Após selecionar um membro da equipe, uma nova linha deverá aparecer com um seletor de nível de acesso:

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="md" alt="Editar acesso do membro da equipe" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="md" alt="Acessar consultas" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="md" alt="Pesquisar dados do Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="md" alt="Correspondência no corpo" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="md" alt="Opções de paginação" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="md" alt="Navegação da paginação" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="md" alt="Baixar como CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="md" alt="Resultados tabulares da consulta" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="md" alt="Alternar da consulta para o gráfico" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="md" alt="Total de viagens por semana" />
...
<Image img="/images/cloud/sqlconsole/bar-chart.png" size="md" alt="Gráfico de barras" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="md" alt="Mudar de gráfico de Barra para Área" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="md" alt="Atualizar nome da consulta" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="md" alt="Atualizar subtítulo etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="md" alt="Ajustar escala do eixo" />