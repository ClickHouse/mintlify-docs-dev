...
* Oferece suporte a recursos como:
  * [Suporte a rede privada](/pt-BR/products/cloud/guides/security/connectivity/private-networking).
  * [Compute-compute separation](/pt-BR/products/cloud/features/infrastructure/warehouses#what-is-compute-compute-separation).
  * Opções de [escalonamento flexível](/pt-BR/products/cloud/features/autoscaling/overview) (aumentar/reduzir verticalmente, expandir/reduzir horizontalmente).
