...
<div id="what-is-compute-compute-separation">
  ## O que é compute-compute separation?
</div>

Antes de discutir o que é compute-compute separation, é útil entender o que é um **serviço** no ClickHouse Cloud.
...
<Image img="/images/cloud/reference/compute-compute-1.png" size="md" alt="Serviço único no ClickHouse Cloud" />

<br />

*Fig. 1 - Serviço único no ClickHouse Cloud*

Em vez de ter um único serviço, você pode criar vários serviços com acesso ao mesmo armazenamento compartilhado, o que permite dedicar recursos a workloads específicos sem precisar duplicar os dados.
Esse conceito é chamado de **compute-compute separation**.

Compute-compute separation significa que cada serviço tem seu próprio conjunto de réplicas e um endpoint, mas usa a mesma pasta de armazenamento de objetos e acessa as mesmas tabelas, views etc.
Isso significa que você pode escolher o tamanho de compute adequado para o seu workload. Alguns workloads podem ser atendidos com apenas uma réplica pequena, enquanto outros podem exigir alta disponibilidade (HA) completa e centenas de gigabytes de memória em várias réplicas.

Compute-compute separation também permite separar operações de leitura de operações de gravação para que não interfiram umas nas outras:

<Image img="/images/cloud/reference/compute-compute-2.png" size="md" alt="Separação de compute no ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.png" size="lg" alt="Exemplo de warehouse com serviços primário e secundário" background="white" />
...
<Image img="/images/cloud/reference/compute-compute-3.png" size="md" alt="Acesso de usuários entre serviços que compartilham os mesmos dados" />
...
<Image img="/images/cloud/reference/compute-compute-4.png" size="md" alt="Configurações de controle de acesso à rede" />
...
Às vezes, convém isolar workloads críticos de leitura da sobrecarga de escrita/merge tornando um serviço read-only.
...
<Image img="/images/cloud/reference/compute-compute-5.png" size="lg" alt="Serviços read-write e read-only em um warehouse" />
...
Para criar um warehouse, você precisa criar um segundo serviço que compartilhará dados com um serviço existente. Isso pode ser feito clicando no sinal de mais em qualquer um dos serviços existentes:

<Image img="/images/cloud/reference/compute-compute-7.png" size="md" alt="Criando um novo serviço em um warehouse" />
