...
Os serviços no ClickHouse Cloud vêm com componentes de monitoramento prontos para uso, que oferecem aos usuários dashboards e notificações. Por padrão, todos os usuários no Console do ClickHouse Cloud podem acessar esses dashboards.
...
<Image img="/images/cloud/manage/monitoring/advanced_dashboard.png" size="lg" alt="Dashboard avançado no ClickHouse Cloud" border />
...
<Image img="/images/cloud/sqlconsole/insights_overview.png" size="md" alt="Visão geral da interface do Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_latency.png" size="md" alt="Gráfico de latência do Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_recent.png" size="md" alt="Tabela de Recent queries no Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_drilldown.png" size="md" alt="Detalhamento da consulta na UI do Query Insights" border />
...
<Image img="/images/cloud/sqlconsole/insights_query_info.png" size="sm" alt="Informações da consulta na UI do Query Insights" border />
