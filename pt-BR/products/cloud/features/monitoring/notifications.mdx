...
<Image img="/images/cloud/manage/notifications-1.png" size="md" alt="painel lateral de notificações do ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-2.png" size="md" alt="log de atividades das notificações do ClickHouse Cloud" border />
...
<Image img="/images/cloud/manage/notifications-3.png" size="md" alt="Tela de configurações de notificações do ClickHouse Cloud" border />

<Image img="/images/cloud/manage/notifications-4.png" size="md" alt="Configurações de entrega de notificações do ClickHouse Cloud" border />
