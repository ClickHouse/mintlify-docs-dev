...
title: 'endpoint de métricas compatível com Prometheus'
...
Para começar, [gere uma API key](/pt-BR/products/cloud/features/admin-features/api/openapi).
...
<Image img="/images/integrations/prometheus-grafana-metrics-endpoint.png" size="md" alt="Configurar o Endpoint de Métricas do Grafana" border />
...
<Image img="/images/integrations/prometheus-grafana-dropdown.png" size="md" alt="Menu suspenso do Explorador de Métricas do Grafana" border />

<br />

<Image img="/images/integrations/prometheus-grafana-chart.png" size="md" alt="Gráfico do Explorador de Métricas do Grafana" border />
...
<Image img="/images/integrations/prometheus-grafana-metrics-explorer.png" size="md" alt="Explorador de Métricas do Grafana" border />
...
<Image img="/images/integrations/prometheus-datadog.png" size="md" alt="Integração do Prometheus com o Datadog" />
