---
title: 'Consultando as tabelas de sistema'
slug: /cloud/monitoring/system-tables
description: 'Monitore o ClickHouse Cloud consultando diretamente as tabelas de sistema'
keywords: ['cloud', 'monitoramento', 'tabelas de sistema', 'query_log', 'clusterAllReplicas', 'painel de observabilidade']
...
<div id="querying-clickhouses-system-database">
  # Consultando o banco de dados `system` do ClickHouse
</div>
...
<Image img="/images/cloud/manage/monitoring/native_advanced_dashboard.png" size="lg" alt="Dashboard avançado nativo de observabilidade" border />
