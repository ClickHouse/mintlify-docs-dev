...
<Image img="/images/cloud/manage/postman/postman1.png" size="md" alt="Site do Postman" border />
...
<Image img="/images/cloud/manage/postman/postman2.png" size="md" alt="Criar espaço de trabalho" border />
...
<Image img="/images/cloud/manage/postman/postman4.png" size="md" alt="Campo de URL da API" border />
...
<Image img="/images/cloud/manage/postman/postman7.png" size="md" alt="Importe sua API" border />

* Clique em &quot;API spec for ClickHouse Cloud&quot;. No painel central, selecione a guia &#39;Authorization&#39;:

<Image img="/images/cloud/manage/postman/postman8.png" size="md" alt="Importação concluída" border />
...
<Image img="/images/cloud/manage/postman/postman9.png" size="md" alt="Autenticação básica" border />

* Insira o nome de usuário e a senha que você recebeu ao configurar suas chaves de API do ClickHouse Cloud:

<Image img="/images/cloud/manage/postman/postman10.png" size="md" alt="credenciais" border />
...
<Image img="/images/cloud/manage/postman/postman11.png" size="md" alt="ID da organização e ID do serviço" border />
...
<Image img="/images/cloud/manage/postman/postman12.png" size="md" alt="Testar a recuperação das organizações" border />
...
<Image img="/images/cloud/manage/postman/postman14.png" size="md" alt="Testar a recuperação de detalhes organizacionais" border />

* Edite esse valor para `orgid`, entre chaves: `{{orgid}}` (como esse valor foi definido anteriormente, um menu aparecerá com o valor):

<Image img="/images/cloud/manage/postman/postman15.png" size="md" alt="Enviar teste" border />

* Após clicar no botão &quot;Save&quot;, clique no botão azul &quot;Send&quot; no canto superior direito da tela.

<Image img="/images/cloud/manage/postman/postman16.png" size="md" alt="Valor retornado" border />
...
<Image img="/images/cloud/manage/postman/postman17.png" size="md" alt="Lista de serviços" border />
