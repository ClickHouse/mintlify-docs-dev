...
description: 'O ClickHouse Cloud disponibiliza uma API baseada em OpenAPI que permite gerenciar programaticamente sua conta e aspectos dos seus serviços.'
doc_type: 'guide'
keywords: ['api', 'openapi', 'rest api', 'documentação', 'cloud management']
---
...
<Image img="/images/cloud/manage/openapi1.png" size="sm" alt="Aba API Keys" border />
...
<Image img="/images/cloud/manage/openapi4.png" size="md" alt="Detalhes da chave de API" border />
...
<Image img="/images/cloud/manage/openapi5.png" size="md" alt="Página de gerenciamento de API Keys" border />
