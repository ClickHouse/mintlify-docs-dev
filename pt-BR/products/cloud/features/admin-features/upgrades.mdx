...
slug: /manage/updates
title: 'Atualizações'
description: 'Com o ClickHouse Cloud, você nunca precisa se preocupar em aplicar patches e atualizações. Implementamos atualizações periodicamente, incluindo correções, novos recursos e melhorias de desempenho.'
doc_type: 'guide'
keywords: ['atualizações', 'gerenciamento de versões', 'recursos da nuvem', 'manutenção', 'atualizações']
---
...
Com o ClickHouse Cloud, você nunca precisa se preocupar com patches e upgrades. Lançamos upgrades que incluem correções, novos recursos e melhorias de desempenho periodicamente. Para ver a lista completa de novidades do ClickHouse, consulte nosso [changelog da Cloud](/pt-BR/resources/changelogs/cloud).
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/fast_release.png" size="lg" alt="Selecione o tipo de canal de release" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrades.png" size="lg" alt="Upgrades agendados" border />
</div>
...
<div class="eighty-percent">
  <Image img="/images/cloud/manage/scheduled_upgrade_window.png" size="lg" alt="Janela de upgrade agendado" border />
</div>
