...
<div id="clickpipes-for-streaming-object-storage">
  # ClickPipes para streaming e armazenamento de objetos
</div>

Esta seção apresenta o modelo de preços do ClickPipes para streaming e armazenamento de objetos.
