...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" alt="Página Billing com o menu Actions aberto e Add spend alerts em destaque" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" alt="Caixa de diálogo de alertas de gastos da organização com limite de gastos, alertas automáticos de limite e canais de notificação" size="md" />
  </Step>
</Steps>
