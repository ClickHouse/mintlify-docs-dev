...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-actions.png" size="lg" alt="Página Billing com o menu Actions aberto e Add spend alerts em destaque" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.png" size="md" alt="Caixa de diálogo de alertas de gastos da organização com limite de gastos, alertas automáticos de limite e canais de notificação" />
  </Step>
</Steps>
