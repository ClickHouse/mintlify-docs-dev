...
<Image img="/images/cloud/reference/billing_payment_threshhold.png" size="sm" alt="Onde encontrar billing na UI" />

<Image img="/images/cloud/reference/billing_payment_threshhold_2.png" size="lg" alt="Fatura" />
