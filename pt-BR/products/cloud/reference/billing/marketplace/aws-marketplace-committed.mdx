...
<Steps>
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_1.png" size="md" alt="E-mail de oferta privada do AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_2.png" size="md" alt="E-mail de oferta privada do AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_3.png" size="md" alt="E-mail de oferta privada do AWS Marketplace" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_6.png" size="md" alt="Crie ou selecione uma organização para faturar nesta assinatura" />
    ...
    <Image img="/images/cloud/reference/mp_committed_spend_7.png" size="md" alt="Confirme que a configuração foi concluída" />
