...
<Image img="/images/cloud/manage/billing/marketplace/marketplace_signup_and_org_linking.png" size="md" alt="Inscrição no marketplace e vinculação da organização" border />
...
Consulte a [página de visão geral do faturamento](/pt-BR/products/cloud/reference/billing).
