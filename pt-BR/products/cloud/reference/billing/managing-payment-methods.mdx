...
<Image img="/images/cloud/reference/billing/01-add-payment-method.png" alt="Adicionar uma forma de pagamento" size="lg" />

3. Se quiser editar seu cartão de crédito, no topo da página, clique no botão para **editar seu cartão de crédito**.

<Image img="/images/cloud/reference/billing/02-edit-credit-card.png" alt="Editar seu cartão de crédito" size="lg" />
...
<Image img="/images/cloud/reference/billing/03-edit-payment-method.png" alt="Editar forma de pagamento" size="lg" />
...
<Image img="/images/cloud/reference/billing/04-edit-payment-method.png" alt="Editar forma de pagamento" size="lg" />
...
<Image img="/images/cloud/reference/billing/05-add-backup.png" alt="Adicionar cartão de crédito de backup" size="lg" />
