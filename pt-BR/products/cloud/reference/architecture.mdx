...
<Image img="/images/cloud/reference/architecture.png" size="lg" alt="Arquitetura da Cloud" />
...
Não há limite para o número de consultas por segundo (QPS) no seu serviço ClickHouse Cloud. No entanto, há um limite de 1000 consultas simultâneas por réplica. No fim das contas, o QPS depende do tempo médio de execução das consultas e do número de réplicas no seu serviço.

Um grande benefício do ClickHouse Cloud em comparação com uma instância autogerenciada do ClickHouse ou outros bancos de dados/data warehouses é que você pode aumentar facilmente a concorrência [adicionando mais réplicas (escalonamento horizontal)](/pt-BR/products/cloud/features/autoscaling/horizontal#manual-horizontal-scaling).