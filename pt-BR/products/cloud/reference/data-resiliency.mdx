...
description: 'Este guia apresenta uma visão geral da recuperação de desastres.'
doc_type: 'referência'
...
Por padrão, o ClickHouse Cloud faz um [backup](/pt-BR/products/cloud/guides/backups) do seu serviço a cada 24 horas.
...
<Image img="/images/cloud/guides/restore_backup.png" size="md" alt="Restaurar a partir de um backup" />
