...
Para saber mais sobre as configurações que você pode especificar para seu serviço do ClickHouse Cloud, consulte todas as configurações possíveis por categoria em [nossa documentação](/pt-BR/reference/settings).

<Image img="/images/cloud/manage/cloud-settings-sidebar.png" size="sm" alt="Barra lateral das configurações do Cloud" border />