...
| `additionalPorts`      | [AdditionalPort](#additionalport) array                                                                                             | AdditionalPorts declara portas TCP extras para expor no pod do Kubernetes do ClickHouse e no Service headless gerenciado pelo operador.<br />O operador apenas adiciona as portas aos recursos do Kubernetes; ele não configura o servidor ClickHouse para escutar nelas. | false       |               |
