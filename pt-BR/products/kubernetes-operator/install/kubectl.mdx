...
4. Implantar o controller manager do operator
...
Se quiser configurar as opções de implantação do operator, siga as etapas abaixo.
...
<Steps>
  ...
  <Step>
    ...
    * Para ativar as políticas de rede do operator, descomente a seção `[NETWORK POLICY]`.
  </Step>

  <Step>
    ### Compilar e implantar

    Compile os manifestos do operator e aplique-os:
