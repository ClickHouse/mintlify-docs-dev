...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_01.png" size="lg" alt="Esquema de tabelas do IMDB" />
...
3. Neste ponto, você precisará de um editor de texto de sua preferência. Nos exemplos abaixo, usamos o popular VS Code. Ao abrir o diretório IMDB, você deverá ver uma coleção de arquivos yml e sql:
   ...
   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_02.png" size="lg" alt="Novo projeto dbt" />
...
4. Atualize o arquivo `dbt_project.yml` para especificar nosso primeiro modelo, `actor_summary`, e defina o profile como `clickhouse_imdb`.
   ...
   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_03.png" size="lg" alt="profile do dbt" />

   <Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_04.png" size="lg" alt="profile do dbt" />
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_05.png" size="lg" alt="atualizações incrementais no dbt" />

Essa estratégia pode apresentar desafios em modelos muito grandes. Para mais detalhes, consulte [Limitações](/pt-BR/integrations/connectors/data-ingestion/etl-tools/dbt#limitations).
...
Historicamente, o ClickHouse oferecia apenas suporte limitado a atualizações e exclusões, na forma de [mutações](/pt-BR/reference/statements/alter) assíncronas. Elas podem exigir uso de E/S extremamente intensivo e, em geral, devem ser evitadas.
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_06.png" size="lg" alt="incremental com exclusão leve" />
...
<Image img="/images/integrations/data-ingestion/etl-tools/dbt/dbt_07.png" size="lg" alt="incremental insert overwrite" />
...
O dbt permite carregar dados de arquivos CSV. Esse recurso não é adequado para carregar grandes exportações de um banco de dados; ele foi projetado mais para arquivos pequenos, normalmente usados para tabelas de códigos e [dicionários](/pt-BR/concepts/features/dictionaries), por exemplo, para mapear códigos de países para nomes de países. Neste exemplo simples, geramos e depois carregamos uma lista de códigos de gênero usando a funcionalidade de seed.
