...
description: 'Documentação específica sobre a materialização materialized_view'
keywords: ['clickhouse', 'dbt', 'materialized_view', 'refreshable', 'visões materializadas', 'catchup']
title: 'Materialização: materialized_view'
doc_type: 'guide'
---
