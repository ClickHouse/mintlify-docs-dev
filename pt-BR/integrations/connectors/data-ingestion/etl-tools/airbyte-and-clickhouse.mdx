...
<Steps>
  <Step>
    ...
    3. Assim que o banner do Airbyte aparecer no terminal, você poderá acessar <a href="http://localhost:8000" target="_blank">localhost:8000</a>
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_01.png" size="lg" border alt="Banner do Airbyte" />

    <Note>
      Como alternativa, você pode se cadastrar e usar o <a href="https://docs.airbyte.com/deploying-airbyte/on-cloud" target="_blank">Airbyte Cloud</a>
    </Note>
  </Step>

  <Step>
    ## Adicione o ClickHouse como destino
    ...
    2. No Airbyte, selecione a página &quot;Destinations&quot; e adicione um novo destino:
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_02.png" size="lg" border alt="Adicionar um destino no Airbyte" />
    ...
    3. Selecione ClickHouse na lista suspensa &quot;Destination type&quot; e preencha o formulário &quot;Set up the destination&quot; informando o hostname e as portas do seu ClickHouse, o nome do banco de dados, o nome de usuário e a senha, e selecione se a connection é SSL (equivalente à flag `--secure` no `clickhouse-client`):
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_03.png" size="lg" border alt="Criação do destino ClickHouse no Airbyte" />
  ...
  <Step>
    ## Adicione um conjunto de dados como fonte
    ...
    1. No Airbyte, selecione a página &quot;Sources&quot; e adicione uma nova fonte do tipo arquivo.
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_04.png" size="lg" border alt="Adicionar uma fonte no Airbyte" />
    ...
    2. Preencha o formulário &quot;Set up the source&quot;, dando um nome à fonte e informando a URL do arquivo NYC Taxi de janeiro de 2022 (veja abaixo). Certifique-se de escolher `parquet` como formato de arquivo, `HTTPS Public Web` como provedor de armazenamento e `nyc_taxi_2022` como nome do conjunto de dados.
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_05.png" size="lg" border alt="Criação de fonte no Airbyte" />

    3. Parabéns! Agora você adicionou um arquivo como fonte no Airbyte.
  </Step>

  <Step>
    ## Criar uma conexão e carregar o dataset no ClickHouse

    1. No Airbyte, selecione a página &quot;Conexões&quot; e adicione uma nova conexão

    <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_06.png" size="lg" border alt="Adicionar uma conexão no Airbyte" />
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_07.png" size="lg" border alt="Criação de uma conexão no Airbyte" />
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_08.png" size="lg" border alt="Sincronize agora no Airbyte" />
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/airbyte_09.png" size="lg" border alt="Concluído com sucesso" />
