...
<Steps>
  ...
  <Step>
    ...
    1. Para configurar um Controller Service no Apache NiFi, acesse a página NiFi Flow Configuration clicando no botão de &quot;engrenagem&quot;
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_01.png" size="sm" border alt="Página NiFi Flow Configuration com o botão de engrenagem destacado" />

    2. Selecione a aba Controller Services e adicione um novo Controller Service clicando no botão `+` no canto superior direito

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_02.png" size="lg" border alt="Aba Controller Services com o botão de adicionar destacado" />

    3. Procure por `DBCPConnectionPool` e clique no botão &quot;Add&quot;

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_03.png" size="lg" border alt="Caixa de diálogo de seleção de Controller Service com DBCPConnectionPool destacado" />
    ...
    4. O `DBCPConnectionPool` recém-adicionado ficará no estado Invalid por padrão. Clique no botão de &quot;engrenagem&quot; para iniciar a configuração
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_04.png" size="lg" border alt="Lista de Controller Services mostrando o DBCPConnectionPool inválido com o botão de engrenagem destacado" />
    ...
    6. Na seção Settings, altere o nome do Controller Service para &quot;ClickHouse JDBC&quot; para facilitar a identificação
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_05.png" size="lg" border alt="Caixa de diálogo de configuração do DBCPConnectionPool mostrando as propriedades preenchidas" />

    7. Ative o Controller Service `DBCPConnectionPool` clicando no botão de &quot;raio&quot; e depois no botão &quot;Enable&quot;

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_06.png" size="lg" border alt="Lista de Controller Services com o botão de raio destacado" />

       <br />

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_07.png" size="lg" border alt="Caixa de diálogo de confirmação para ativar o Controller Service" />

    8. Verifique a aba Controller Services e confirme que o Controller Service está ativado

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_08.png" size="lg" border alt="Lista de Controller Services mostrando o serviço ClickHouse JDBC ativado" />
  </Step>
  ...
  <Step>
    ...
    1. Adicione um processador `ExecuteSQL`, junto com os processadores upstream e downstream apropriados
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_09.png" size="md" border alt="Canvas do NiFi mostrando o processador ExecuteSQL em um fluxo de trabalho" />
    ...
    3. Inicie o processador `ExecuteSQL`
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_10.png" size="lg" border alt="Configuração do processador ExecuteSQL com as propriedades preenchidas" />

    4. Para confirmar que a consulta foi processada com sucesso, inspecione um dos `FlowFile` na fila de saída

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_11.png" size="lg" border alt="Caixa de diálogo de listagem da fila mostrando FlowFiles prontos para inspeção" />

    5. Mude a visualização para &quot;formatted&quot; para ver o resultado do `FlowFile` de saída

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_12.png" size="lg" border alt="Visualizador de conteúdo do FlowFile mostrando os resultados da consulta na visualização formatada" />
  </Step>
  ...
  <Step>
    ...
    3. Para confirmar que vários registros foram mesclados em um só, examine a entrada e a saída do processador `MergeRecord`. Observe que a saída é um array com vários registros de entrada
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_13.png" size="sm" border alt="Entrada do processador MergeRecord mostrando registros individuais" />

       Saída

       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_14.png" size="sm" border alt="Saída do processador MergeRecord mostrando array mesclado de registros" />
    ...
    5. Para confirmar que cada insert contém várias linhas, verifique se a contagem de linhas na tabela está aumentando em pelo menos o valor de &quot;Número mínimo de registros&quot; definido em `MergeRecord`.
       ...
       <Image img="/images/integrations/data-ingestion/etl-tools/nifi_15.png" size="sm" border alt="Resultados da consulta mostrando a contagem de linhas na tabela de destino" />
