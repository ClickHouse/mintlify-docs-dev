...
<Image img="/images/integrations/data-ingestion/redshift/push.png" size="md" alt="ENVIAR Redshift para ClickHouse" />
...
* Permite cenários de transformação de dados (por exemplo, consulte nosso [guia de integração do dbt](/pt-BR/integrations/connectors/data-ingestion/etl-tools/dbt)).
