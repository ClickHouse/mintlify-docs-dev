...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_signup.png" size="md" border alt="Página de cadastro da Artie" />
  </Step>

  <Step>
    ## Encontre suas credenciais do ClickHouse
  ...
  <Step>
    ## Crie um novo pipeline na Artie
    ...
    <Image img="/images/integrations/data-ingestion/etl-tools/artie/artie_edit_pipeline.png" size="lg" border alt="Interface Edit Pipeline da Artie" />
  </Step>
</Steps>
...
<Image img="/images/integrations/data-ingestion/etl-tools/artie/analytics.png" size="md" border alt="Portal de analytics" />

Monitoramento específico de pipeline e tabela

<Image img="/images/integrations/data-ingestion/etl-tools/artie/monitor.png" size="md" border alt="Monitoramento nativo" />

Notificações diárias de alterações no esquema

<Image img="/images/integrations/data-ingestion/etl-tools/artie/schema_notification.png" size="md" border alt="Notificação de alteração de esquema" />