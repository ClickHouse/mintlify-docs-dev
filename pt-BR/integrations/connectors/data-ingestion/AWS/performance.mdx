...
<Image img="/images/integrations/data-ingestion/s3/insert_mechanics.png" size="lg" border alt="Mecânica do tamanho do bloco de inserção no ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/pull.png" size="lg" border alt="Extração de dados de fontes externas no ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/merges.png" size="lg" border alt="Mesclagens em segundo plano no ClickHouse" />
...
```bash
① Decidir quais partes mesclar a seguir e carregar essas partes como blocos na memória.

② Mesclar os blocos carregados na memória em um bloco maior.

③ Gravar o bloco mesclado em uma nova parte no disco.
...
<Image img="/images/integrations/data-ingestion/s3/resource_usage.png" size="lg" border alt="Uso de recursos no paralelismo de inserção" />
...
<Image img="/images/integrations/data-ingestion/s3/insert_threads.png" size="lg" border alt="Threads de insert paralelas no ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/s3/hardware_size.png" size="lg" border alt="Impacto da capacidade do hardware no desempenho do ClickHouse" />
...
O ClickHouse pode ler arquivos armazenados em buckets do S3 nos [formatos compatíveis](/pt-BR/reference/formats#formats-overview) usando a função `s3` e o engine `S3`. Ao ler arquivos brutos, alguns desses formatos têm vantagens específicas:
...
<Image img="/images/integrations/data-ingestion/s3/s3Cluster.png" size="lg" border alt="função s3Cluster no ClickHouse" />
