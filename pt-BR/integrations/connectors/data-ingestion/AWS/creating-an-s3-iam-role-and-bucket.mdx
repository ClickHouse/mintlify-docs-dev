...
<Image size="lg" img="/images/_snippets/s3/2025/s3-1.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

3. Insira um nome de usuário

<Image size="lg" img="/images/_snippets/s3/2025/s3-2.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

4. Selecione `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-3.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

5. Selecione `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-4.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-5.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

7. Selecione `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-6.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

8. Selecione `Application running outside AWS`

<Image size="lg" img="/images/_snippets/s3/2025/s3-7.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

9. Selecione `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-8.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

10. Baixe sua chave de acesso e sua chave secreta como um arquivo .csv para usar mais tarde

<Image size="lg" img="/images/_snippets/s3/2025/s3-9.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-10.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

2. Insira um nome para o bucket e deixe as demais opções com os valores padrão

<Image size="lg" img="/images/_snippets/s3/2025/s3-11.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-12.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

4. Selecione **Create Bucket** na parte inferior da página

<Image size="lg" img="/images/_snippets/s3/2025/s3-13.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

5. Selecione o link, copie o ARN e salve-o para usar ao configurar a política de acesso do bucket

<Image size="lg" img="/images/_snippets/s3/2025/s3-14.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-15.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-16.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

9. A pasta agora deve estar visível na lista do bucket

<Image size="lg" img="/images/_snippets/s3/2025/s3-17.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-18.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />

11. Selecione a guia **Permissions** e clique no botão **Edit** na seção **Bucket Policy**

<Image size="lg" img="/images/_snippets/s3/2025/s3-19.png" alt="Console de Gerenciamento do AWS IAM - Adicionando um novo usuário" />
