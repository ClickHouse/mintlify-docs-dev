...
<Tabs>
  <Tab title="AWS Marketplace">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/notebook-connections-config.png" size="md" alt="Configuração de conexões do notebook do Glue" force="true" />
  ...
  <Tab title="Instalação manual">
    ...
    <Image img="/images/integrations/data-ingestion/aws-glue/dependent_jars_path_option.png" size="md" alt="Opções de caminho de JAR do notebook do Glue" force="true" />
  </Tab>
</Tabs>
...
Para mais detalhes, consulte a nossa [documentação do Spark](/pt-BR/integrations/connectors/data-ingestion/apache-spark/index).