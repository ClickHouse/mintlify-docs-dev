...
| ------------------------------------------------------------------------------------------------- | --------------------------------- | :-------------------: | :-------------------: | :-------------------: |
| [ClickPipes for Kafka](/pt-BR/integrations/clickpipes/kafka)                                            | [Cloud], [BYOC] (em breve!)       |           ✅           |           ✅           |                       |
...
* **Código personalizado** - O uso de código personalizado com Kafka e [bibliotecas de cliente](/pt-BR/integrations/language-clients) do ClickHouse pode ser apropriado quando for necessário processar eventos de forma personalizada.
