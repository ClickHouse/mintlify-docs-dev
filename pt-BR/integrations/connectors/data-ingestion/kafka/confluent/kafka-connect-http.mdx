...
title: 'Confluent conector HTTP Sink'
doc_type: 'guide'
keywords: ['Confluent conector HTTP Sink', 'HTTP Sink ClickHouse', 'conector HTTP do Kafka
...
O HTTP Sink Connector é agnóstico quanto a tipos de dados e, portanto, não requer um schema do Kafka, além de oferecer suporte a tipos de dados específicos do ClickHouse, como Map e Array. Essa flexibilidade adicional traz um pequeno aumento na complexidade da configuração.
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_http_sink.png" size="sm" alt="Interface do Confluent Cloud mostrando como criar um conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_auth.png" size="lg" alt="Interface do Confluent Cloud mostrando as configurações de autenticação do conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/http_advanced.png" size="sm" alt="Interface do Confluent Cloud mostrando opções avançadas de configuração do conector HTTP Sink" border />
...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.png" size="md" alt="Interface do Confluent Cloud mostrando como criar uma mensagem de teste em um tópico do Kafka" border />
