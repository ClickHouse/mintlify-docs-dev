...
O conector HTTP Sink é agnóstico quanto a tipos de dados e, portanto, não requer um schema do Kafka, além de oferecer suporte a tipos de dados específicos do ClickHouse, como Map e Array. Essa flexibilidade adicional traz um pequeno aumento na complexidade da configuração.
