...
Você pode encontrar a lista de formatos de entrada disponíveis do ClickHouse [nesta página da documentação](/pt-BR/reference/formats#formats-overview) e em [ClickHouseFormat.java](https://github.com/ClickHouse/clickhouse-java/blob/main/clickhouse-data/src/main/java/com/clickhouse/data/ClickHouseFormat.java).
