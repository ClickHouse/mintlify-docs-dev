...
<Tabs>
  <Tab title="Google Cloud Console">
    ...
    2. Quando o formulário do template abrir, informe um nome para o job e selecione a região desejada.
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_initial_form.png" border alt="formulário inicial do template do DataFlow" />
    3. No campo `DataFlow Template`, digite `ClickHouse` ou `BigQuery` e selecione o template `BigQuery to ClickHouse`
       <Image img="/images/integrations/data-ingestion/google-dataflow/template_clickhouse_search.png" border alt="Selecionar template BigQuery para ClickHouse" />
    ...
    <Image img="/images/integrations/data-ingestion/google-dataflow/extended_template_form.png" border alt="formulário expandido do template BigQuery para ClickHouse" />
...
<Image img="/images/integrations/data-ingestion/google-dataflow/dataflow-inqueue-job.png" size="lg" border alt="Console do Dataflow mostrando um job do BigQuery para o ClickHouse em execução" />
