...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_notebook_conf.png" size="xl" alt="Definindo configurações do Spark em um notebook" border />
...
<Image img="/images/integrations/data-ingestion/azure-synapse/spark_ui_ch_settings.png" size="xl" alt="Verificando as configurações do ClickHouse usando a UI do Spark" border />

<div id="additional-resources">
  ## Recursos adicionais
</div>

* [Documentação do ClickHouse Spark Connector](/pt-BR/integrations/connectors/data-ingestion/apache-spark)
