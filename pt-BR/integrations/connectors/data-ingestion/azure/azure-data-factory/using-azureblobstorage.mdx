...
title: 'Usando a função de tabela azureBlobStorage do ClickHouse para importar dados do Azure para o ClickHouse'
doc_type: 'guide'
integration:
   - support_level: 'core'
...
`TSV`, `ORC`, `Avro` e outros. Para ver a lista completa, consulte [&quot;Formatos de dados&quot;](/pt-BR/reference/formats).
...
2. No menu à esquerda, selecione **Chaves de acesso** na seção **Segurança +
   rede**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-settings.png" size="lg" alt="Configurações do armazenamento de dados do Azure" border />

3. Escolha **key1** ou **key2** e clique no botão **Mostrar** ao lado do
   campo **String de conexão**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-store-access-keys.png" size="lg" alt="Chaves de acesso do armazenamento de dados do Azure" border />
...
* [Formatos para dados de entrada e saída](/pt-BR/reference/formats)
