...
Isso é útil quando não há um [integration engine](/pt-BR/reference/engines/table-engines/integrations), uma table function ou um dicionário externo nativo disponível para a fonte de dados externa, mas existe um JDBC driver para essa fonte de dados.
