...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_1.png" size="sm" border alt="Interface de implantação do serviço do ClickHouse Cloud mostrando a seleção da região da AWS" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_2.png" size="sm" border alt="Configurações de conexão do ClickHouse Cloud mostrando a configuração de acesso por IP" />

Em seguida, você precisa salvar seu nome de usuário e sua senha para uso futuro.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_3.png" size="sm" border alt="Tela de credenciais do ClickHouse Cloud mostrando nome de usuário e senha" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_4.png" size="lg" border alt="Painel da instância em execução do ClickHouse Cloud com opções de conexão" />

Clique em &quot;Connect to SQL Console&quot; para criar o banco de dados e a tabela para a integração com o EMQX Cloud.

<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_5.png" size="lg" border alt="Interface do SQL Console do ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_cloud_6.png" size="lg" border alt="Execução da consulta SQL para criar banco de dados e tabela no ClickHouse Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_sign_up.png" size="lg" border alt="Página de cadastro do EMQX Cloud com formulário de registro" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_create_1.png" size="lg" border alt="Etapa 1 da criação da implantação no EMQX Cloud, mostrando as opções de implantação" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_overview.png" size="lg" border alt="Painel de visão geral do EMQX Cloud, mostrando métricas do broker" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_auth.png" size="lg" border alt="Interface de configuração de autenticação do EMQX Cloud para adicionar credenciais" />
...
<Image img="/images/integrations/data-ingestion/emqx/emqx_cloud_nat_gateway.png" size="lg" border alt="Painel de configuração do NAT Gateway do EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_clickhouse.png" size="lg" border alt="Detalhes do conector de integração de dados do ClickHouse no EMQX Cloud" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_resource.png" size="lg" border alt="Formulário de configuração do recurso ClickHouse do EMQX Cloud com detalhes de conexão" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.png" size="md" border alt="Etapa 1 da criação da regra de integração de dados do EMQX Cloud mostrando a consulta SQL" />

Você pode usar o teste de SQL para verificar os resultados.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.png" size="md" border alt="Etapa 2 da criação da regra de integração de dados do EMQX Cloud mostrando os resultados do teste" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_action.png" size="md" border alt="Configuração da ação da regra de integração de dados do EMQX Cloud com modelo SQL" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_details.png" size="md" border alt="Detalhes da regra de integração de dados do EMQX Cloud mostrando o resumo da configuração" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-overview.png" size="lg" border alt="Visão geral do MQTTX mostrando a interface do cliente" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-new.png" size="lg" border alt="Formulário de configuração de nova conexão do MQTTX com os detalhes da conexão" />
...
<Image img="/images/integrations/data-ingestion/emqx/mqttx-publish.png" size="lg" border alt="Tela do MQTTX Publish exibindo a composição da mensagem MQTT" />
...
<Image img="/images/integrations/data-ingestion/emqx/rule_monitor.png" size="lg" border alt="Painel de monitoramento das regras do EMQX Cloud mostrando métricas de processamento de mensagens" />
...
<Image img="/images/integrations/data-ingestion/emqx/clickhouse_result.png" size="lg" border alt="Resultados de consulta no ClickHouse mostrando dados de IoT persistidos" />
