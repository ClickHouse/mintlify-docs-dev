...
<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-1.png" size="lg" border alt="Bucket da réplica um no Google Cloud Storage, mostrando a estrutura de pastas com partições de dados" />

<div id="bucket-for-replica-two">
  #### Bucket da réplica 2
</div>

<Image img="/images/integrations/data-ingestion/s3/GCS-examine-bucket-2.png" size="lg" border alt="Bucket da réplica 2 no Google Cloud Storage mostrando a estrutura de pastas com partições de dados" />