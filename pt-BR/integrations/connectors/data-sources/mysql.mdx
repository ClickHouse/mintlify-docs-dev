...
<Note>
  No ClickHouse Cloud, você também pode usar o [ClickPipe do MySQL](/pt-BR/integrations/clickpipes/mysql) (atualmente em beta pública) para mover dados das suas tabelas MySQL para o ClickHouse com facilidade.
</Note>
