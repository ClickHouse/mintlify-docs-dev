...
<div id="integrating-mysql-with-clickhouse">
  # Integrando o MySQL ao ClickHouse
</div>

Esta página aborda o uso do motor de tabela `MySQL` para ler dados de uma tabela MySQL.

<Note>
  No ClickHouse Cloud, você também pode usar o [MySQL ClickPipe](/pt-BR/integrations/clickpipes/mysql) (atualmente em beta pública) para mover dados das suas tabelas MySQL para o ClickHouse com facilidade.
</Note>
