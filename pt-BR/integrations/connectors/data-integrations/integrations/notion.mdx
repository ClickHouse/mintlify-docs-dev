...
<Image img="/images/integrations/tools/data-integration/notion/add-clickhouse-connection.png" size="md" alt="Selecionando ClickHouse no picker Add connection do Notion" />
...
<Image img="/images/integrations/tools/data-integration/notion/clickhouse-tools-toggles.png" size="md" alt="A conexão expandida do ClickHouse no Notion mostrando os toggles de cada ferramenta" />
