...
doc_type: 'guide'
keywords: ['PostgreSQL', 'Postgres', 'FDW', 'foreign data wrapper', 'pg_clickhouse', 'extensão', 'tutorial', 'táxi']
---
...
Compile e instale o pg&#95;clickhouse pelo [PGXN] ou pelo [GitHub]. Ou inicie um
contêiner Docker usando a [imagem do pg&#95;clickhouse], que simplesmente adiciona
pg&#95;clickhouse à [imagem do Postgres] no Docker:
...
Observe como a consulta foi executada rapidamente. O pg&#95;clickhouse faz o pushdown de toda a
