...
<Image img="/images/integrations/sql-clients/dbeaver-add-database.png" size="md" border alt="Adicionar um novo banco de dados" />

* Selecione **Analytical** e, em seguida, **ClickHouse**:

* Monte a URL JDBC. Na guia **Main**, defina Host, Port, Username, Password e Database:

<Image img="/images/integrations/sql-clients/dbeaver-host-port.png" size="md" border alt="Defina o hostname, a porta, o usuário, a senha e o nome do banco de dados" />
...
<Image img="/images/integrations/sql-clients/dbeaver-use-ssl.png" size="md" border alt="Ative SSL, se necessário" />

* Teste a conexão:

<Image img="/images/integrations/sql-clients/dbeaver-test-connection.png" size="md" border alt="Teste a conexão" />

Se o DBeaver detectar que você não tem o driver do ClickHouse instalado, ele oferecerá baixá-lo para você:

<Image img="/images/integrations/sql-clients/dbeaver-download-driver.png" size="md" border alt="Baixe o driver do ClickHouse" />
...
<Image img="/images/integrations/sql-clients/dbeaver-sql-editor.png" size="md" border alt="Abrir o editor SQL" />

* Exemplo de consulta em `system.query_log`:

<Image img="/images/integrations/sql-clients/dbeaver-query-log-select.png" size="md" border alt="Uma consulta de exemplo" />
