...
<Image img="/images/integrations/sql-clients/marimo/clickhouse-connect.gif" size="md" border alt="Conectar ao ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/panel-arrow.png" size="sm" border alt="Adicionar um novo banco de dados" />

Você deverá preencher os detalhes do banco de dados.

<Image img="/images/integrations/sql-clients/marimo/add-db-details.png" size="md" border alt="Preencha os detalhes do banco de dados" />

Em seguida, você terá uma célula que poderá ser executada para estabelecer uma conexão.

<Image img="/images/integrations/sql-clients/marimo/run-cell.png" size="md" border alt="Execute a célula para se conectar ao ClickHouse" />
...
<Image img="/images/integrations/sql-clients/marimo/choose-sql-engine.png" size="md" border alt="Escolha o mecanismo SQL" />
...
<Image img="/images/integrations/sql-clients/marimo/results.png" size="lg" border alt="Resultados em um DataFrame" />
...
<Image img="/images/integrations/sql-clients/marimo/dropdown-cell-chart.png" size="lg" border alt="Combinação de lista suspensa, tabela e gráfico" />
...
<Image img="/images/integrations/sql-clients/marimo/run-app-view.png" size="md" border alt="Executar App View" />