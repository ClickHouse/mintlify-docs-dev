...
<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.png" size="lg" border alt="Interface do gerenciador de drivers do DbVisualizer mostrando a configuração do driver JDBC do ClickHouse" />
