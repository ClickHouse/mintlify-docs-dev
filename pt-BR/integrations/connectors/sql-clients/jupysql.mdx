...
<Image img="/images/integrations/sql-clients/jupysql-plot-1.png" size="md" alt="Histograma mostrando a distribuição das distâncias de viagem em 10 intervalos no conjunto de dados short-trips" border />
...
<Image img="/images/integrations/sql-clients/jupysql-plot-2.png" size="md" alt="Histograma que mostra a distribuição das distâncias de viagem, com 50 intervalos e grade, intitulado 'Distância da viagem de trips < 6.3'" border />