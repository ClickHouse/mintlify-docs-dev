...
<Image img="/images/integrations/sql-clients/datagrip-5.png" size="lg" border alt="Guia Data Sources do DataGrip com o ícone + destacado" />
...
<Image img="/images/integrations/sql-clients/datagrip-6.png" size="sm" border alt="DataGrip selecionando ClickHouse na lista de fontes de dados" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.png" size="lg" border alt="Guia Drivers do DataGrip mostrando a instalação do driver do ClickHouse" />
...
<Image img="/images/integrations/sql-clients/datagrip-7.png" border alt="Formulário de detalhes da conexão do DataGrip com configurações do ClickHouse" />
