...
<Image img="/images/cloud/sqlconsole/table-list-and-schema.png" size="lg" border alt="Lista de tabelas e visualização do esquema mostrando as tabelas do banco de dados na barra lateral esquerda" />

As tabelas da lista também podem ser expandidas para ver colunas e tipos de dados

<Image img="/images/cloud/sqlconsole/view-columns.png" size="lg" border alt="Visualização de uma tabela expandida mostrando nomes de colunas e tipos de dados" />
...
<Image img="/images/cloud/sqlconsole/abc.png" size="lg" border alt="Visualização da tabela mostrando dados que podem ser selecionados e copiados" />
...
<Image img="/images/cloud/sqlconsole/inspecting-cell-content.png" size="lg" border alt="Janela do Cell Inspector mostrando o conteúdo de uma célula selecionada" />
...
<Image img="/images/cloud/sqlconsole/sort-descending-on-column.png" size="lg" border alt="Caixa de diálogo de ordenação mostrando a configuração de ordenação decrescente em uma coluna" />
...
<Image img="/images/cloud/sqlconsole/filter-on-radio-column-equal-gsm.png" size="lg" border alt="Caixa de diálogo de filtro mostrando a configuração para filtrar a coluna de rádio igual a GSM" />
...
<Image img="/images/cloud/sqlconsole/add-more-filters.png" size="lg" border alt="Caixa de diálogo mostrando como adicionar um filtro adicional para um intervalo maior que 2000" />
...
<Image img="/images/cloud/sqlconsole/filtering-and-sorting-together.png" size="lg" border alt="Interface mostrando filtragem e ordenação aplicadas simultaneamente" />
...
<Image img="/images/cloud/sqlconsole/create-a-query-from-sorts-and-filters.png" size="lg" border alt="Interface mostrando o botão Create Query, que gera SQL a partir de filtros e ordenações" />
...
<Image img="/images/cloud/sqlconsole/creating-a-query.png" size="lg" border alt="Interface mostrando como criar uma nova consulta usando o botão + ou o botão New Query" />
...
<Image img="/images/cloud/sqlconsole/run-selected-query.png" size="lg" border alt="Interface mostrando como executar uma parte selecionada de uma consulta SQL" />
...
<Image img="/images/cloud/sqlconsole/run-at-cursor-2.png" size="lg" border alt="Opção Run at cursor no menu expandido de opções de execução" />

* Selecione &#39;Run at cursor&#39; no menu de contexto do SQL Editor

<Image img="/images/cloud/sqlconsole/run-at-cursor.png" size="lg" border alt="Opção Run at cursor no menu de contexto do SQL Editor" />
...
<Image img="/images/cloud/sqlconsole/cancel-a-query.png" size="lg" border alt="Botão 'Cancel' exibido durante a execução da consulta" />
...
<Image img="/images/cloud/sqlconsole/give-a-query-a-name.png" size="lg" border alt="Interface mostrando como renomear uma consulta a partir de Untitled Query" />

Você também pode usar o botão Salvar ou o atalho de teclado `cmd / ctrl + s` para salvar uma consulta.

<Image img="/images/cloud/sqlconsole/save-the-query.png" size="lg" border alt="Botão Salvar na barra de ferramentas do editor de consultas" />
...
<Image img="/images/cloud/sqlconsole/search-hn.png" size="lg" border alt="Buscar dados do Hacker News" />
...
<Image img="/images/cloud/sqlconsole/match-in-body.png" size="lg" border alt="Correspondência no corpo" />
...
<Image img="/images/cloud/sqlconsole/pagination.png" size="lg" border alt="Opções de paginação" />
...
<Image img="/images/cloud/sqlconsole/pagination-nav.png" size="lg" border alt="Navegação da paginação" />
...
<Image img="/images/cloud/sqlconsole/download-as-csv.png" size="lg" border alt="Baixar como CSV" />
...
<Image img="/images/cloud/sqlconsole/tabular-query-results.png" size="lg" border alt="Resultados tabulares da consulta" />
...
<Image img="/images/cloud/sqlconsole/switch-from-query-to-chart.png" size="lg" border alt="Alternar da consulta para o gráfico" />
...
<Image img="/images/cloud/sqlconsole/trip-total-by-week.png" size="lg" border alt="Total de viagens por semana" />
...
<Image img="/images/cloud/sqlconsole/change-from-bar-to-area.png" size="lg" border alt="Alterar de gráfico de Barras para Área" />
...
<Image img="/images/cloud/sqlconsole/update-query-name.png" size="lg" border alt="Atualizar nome da consulta" />
...
<Image img="/images/cloud/sqlconsole/update-subtitle-etc.png" size="lg" border alt="Atualizar subtítulo etc." />
...
<Image img="/images/cloud/sqlconsole/adjust-axis-scale.png" size="lg" border alt="Ajustar escala do eixo" />
...
<Image img="/images/cloud/sqlconsole/sql-console-share.png" size="lg" border alt="Botão Share na barra de ferramentas da consulta" />
...
<Image img="/images/cloud/sqlconsole/sql-console-edit-access.png" size="lg" border alt="Caixa de diálogo para editar o acesso a uma consulta compartilhada" />

<Image img="/images/cloud/sqlconsole/sql-console-add-team.png" size="lg" border alt="Interface para adicionar uma equipe a uma consulta compartilhada" />

<Image img="/images/cloud/sqlconsole/sql-console-edit-member.png" size="lg" border alt="Interface para editar o acesso de um membro a uma consulta compartilhada" />
...
<Image img="/images/cloud/sqlconsole/sql-console-access-queries.png" size="lg" border alt="Seção Shared with me na lista de consultas" />