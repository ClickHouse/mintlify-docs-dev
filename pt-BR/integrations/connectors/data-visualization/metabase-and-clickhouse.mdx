...
<Image size="md" img="/images/integrations/data-visualization/metabase_08.png" alt="Visualização de gráfico de pizza no Metabase mostrando dados do ClickHouse" border />
...
3. Se a instalação do driver tiver funcionado, você verá **ClickHouse** no menu suspenso de **Tipo de banco de dados**:
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_01.png" alt="Seleção de banco de dados no Metabase mostrando ClickHouse como uma opção" border />
...
5. Insira os detalhes de conexão do seu banco de dados ClickHouse. Ative uma conexão segura se o servidor ClickHouse estiver configurado para usar SSL. Por exemplo:
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_02.png" alt="Formulário de detalhes de conexão do Metabase para banco de dados ClickHouse" border />
...
2. No canto superior direito, clique no menu **+ Novo** e observe que você pode fazer perguntas, executar consultas SQL e criar um dashboard:
   ...
   <Image size="sm" img="/images/integrations/data-visualization/metabase_03.png" alt="Menu Novo do Metabase mostrando opções para criar perguntas, consultas SQL e dashboards" border />
...
3. Por exemplo, aqui está uma consulta SQL executada em uma tabela chamada `uk_price_paid`, que retorna o preço médio pago por ano de 1995 a 2022:
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_04.png" alt="SQL Editor do Metabase mostrando uma consulta sobre dados de preços pagos no Reino Unido" border />
...
1. Clique em **+ Novo** e selecione **Question**. Observe que é possível criar uma pergunta começando por um banco de dados e uma tabela. Por exemplo, a pergunta a seguir é feita à tabela `uk_price_paid` no banco de dados `default`. Aqui está uma pergunta simples que calcula o preço médio por cidade no condado de Greater Manchester:
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_06.png" alt="Interface do criador de perguntas do Metabase com dados de preços do Reino Unido" border />

2. Clique no botão **Visualize** para ver os resultados em formato de tabela.

   <Image size="md" img="/images/integrations/data-visualization/metabase_07.png" alt="Visualização do Metabase mostrando resultados em tabela dos preços médios por cidade" border />
...
3. Abaixo dos resultados, clique no botão **Visualization** para mudar a visualização para um gráfico de barras (ou qualquer uma das outras opções disponíveis):
   ...
   <Image size="md" img="/images/integrations/data-visualization/metabase_08.png" alt="Visualização de gráfico de pizza no Metabase com os preços médios por cidade em Greater Manchester" border />
