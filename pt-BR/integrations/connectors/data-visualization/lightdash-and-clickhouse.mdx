...
keywords: ['clickhouse', 'lightdash', 'visualização de dados', 'BI', 'camada semântica', 'dbt', 'análises de autoatendimento', 'conectar']
description: 'O Lightdash é uma ferramenta moderna de BI de código aberto baseada em dbt, que permite às equipes explorar e visualizar dados do ClickHouse por meio de uma camada semântica. Saiba como conectar o Lightdash ao ClickHouse para fazer análises rápidas com governança, usando dbt.'
title: 'Conectar o Lightdash ao ClickHouse'
doc_type: 'guide'
integration:
...
<Image size="md" img="/images/integrations/data-visualization/lightdash_02.png" alt="Exemplo de painel do Lightdash" border />
...
<Steps>
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_01.png" alt="Exemplo de configuração do profiles.yml para um projeto lightdash-clickhouse" border />
  ...
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/lightdash_03.png" alt="Exemplo de métricas sendo definidas no arquivo .yml" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_04.png" alt="Visualização Explore do Lightdash mostrando dimensões, filtros, gráfico, resultados e SQL" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_05.png" alt="Criando e organizando gráficos em um dashboard do Lightdash" border />
  ...
  <Step>
    ...
    **Agentes de IA** no Lightdash tornam a exploração de dados verdadeiramente self-service.
    ...
    <Image size="lg" img="/images/integrations/data-visualization/lightdash_06.png" alt="Interface do Ask AI do Lightdash mostrando uma consulta em linguagem natural com base em métricas do dbt" border />
