...
description: 'Holistics é uma plataforma de BI de autoatendimento e análises incorporadas com tecnologia de IA que ajuda todos a tomar decisões melhores com métricas governadas e facilmente acessíveis.'
title: 'Conectar o ClickHouse ao Holistics'
doc_type: 'guide'
---
...
<div id="connecting-clickhouse-to-holistics">
  # Conectando o ClickHouse ao Holistics
</div>
...
<Steps>
  <Step>
    ...
    <Image size="md" img="/images/integrations/data-visualization/holistics_01.png" alt="Localização do botão Connect no console do ClickHouse Cloud" border />
  </Step>
  ...
  <Step>
    ...
    1. **Conexão direta (recomendada):** Adicione os endereços IP do Holistics à lista de permissões no seu firewall ou na IP Access List do ClickHouse Cloud. Você pode encontrar a lista de IPs no guia de [IP Whitelisting](https://docs.holistics.io/docs/connect/ip-whitelisting).
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_02.png" alt="Exemplo de inclusão de IPs na lista de permissões no ClickHouse Cloud" border />
  ...
  <Step>
    ...
    1. No Holistics, vá para **Settings → Data Sources**.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_03.png" alt="Navegando até Data Sources nas configurações do Holistics" border />

    2. Clique em **New Data Source** e selecione **ClickHouse**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_04.png" alt="Selecionando ClickHouse na lista de novas fontes de dados" border />
    ...
    3. Preencha o formulário com os detalhes coletados na Etapa 1.
       ...
       <Image size="md" img="/images/integrations/data-visualization/holistics_05.png" alt="Preenchendo os detalhes de conexão do ClickHouse no Holistics" border />

    4. Clique em **Test Connection**.

       <Image size="md" img="/images/integrations/data-visualization/holistics_06.png" alt="Teste de conexão com ClickHouse bem-sucedido no Holistics" border />
