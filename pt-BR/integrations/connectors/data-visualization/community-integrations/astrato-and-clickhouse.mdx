...
* Selecione **Data** na barra lateral e, em seguida, a guia **Data Connection**
  (ou acesse este link: https://app.astrato.io/data/sources)
  ​
* Clique no botão **New Data Connection** no canto superior direito da tela.

<Image size="sm" img="/images/integrations/data-visualization/astrato_1_dataconnection.png" alt="Conexão de dados do Astrato" border />

* Selecione **ClickHouse**.

<Image size="sm" img="/images/integrations/data-visualization/astrato_2a_clickhouse_connection.png" alt="Conexão de dados do Astrato com ClickHouse" border />

* Preencha os campos obrigatórios na caixa de diálogo da conexão

<Image size="sm" img="/images/integrations/data-visualization/astrato_2b_clickhouse_connection.png" alt="Campos obrigatórios do Astrato para conexão com o ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/astrato_3_user_access.png" alt="Acesso do usuário no Astrato para conexão com o ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4a_clickhouse_data_view.png" alt="Astrato se conecta ao Acesso do usuário do ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4b_clickhouse_data_view_joins.png" alt="Astrato se conecta ao Acesso do usuário do ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_4c_clickhouse_completed_data_view.png" alt="Astrato se conecta ao Acesso do usuário do ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5a_clickhouse_build_chart.png" alt="Astrato conectado ao Acesso do usuário do ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5b_clickhouse_view_sql.png" alt="Astrato conectado ao ClickHouse Acesso do usuário" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5c_clickhouse_complete_dashboard.png" alt="Astrato conecta ao ClickHouse Acesso do usuário" border />