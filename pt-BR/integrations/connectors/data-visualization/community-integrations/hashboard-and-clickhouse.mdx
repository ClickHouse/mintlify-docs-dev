...
<Image size="md" img="/images/integrations/data-visualization/hashboard_01.png" alt="Interface do explorador de dados do Hashboard mostrando construtor de consultas interativo e visualização" border />
