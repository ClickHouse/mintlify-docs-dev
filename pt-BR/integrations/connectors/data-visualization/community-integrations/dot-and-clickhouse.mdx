...
<Image size="md" img="/images/integrations/data-visualization/dot_01.png" alt="Configurando a conexão com o ClickHouse no Dot (modo claro)" border />
...
<Image img="/images/integrations/data-visualization/dot_02.png" alt="Conectando ao ClickHouse" size="sm" />
