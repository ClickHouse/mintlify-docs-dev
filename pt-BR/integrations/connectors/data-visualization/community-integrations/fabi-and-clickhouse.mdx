...
keywords: ['clickhouse', 'Fabi.ai', 'conectar', 'integrar', 'notebook', 'UI', 'analytics']
description: 'Fabi.ai é uma plataforma colaborativa completa de análise de dados. Você pode usar SQL, Python, IA e no-code para criar dashboards e fluxos de trabalho de dados com mais rapidez do que nunca'
title: 'Conecte o ClickHouse ao Fabi.ai'
doc_type: 'guide'
integration:
...
<div id="connecting-clickhouse-to-fabiai">
  # Conectando o ClickHouse ao Fabi.ai
</div>
...
<Image size="md" img="/images/integrations/data-visualization/fabi_01.png" alt="Plataforma Fabi.ai de exploração de dados e fluxos de trabalho" border />
...
1. Ao criar sua conta pela primeira vez, você deverá conectar seu banco de dados. Se já tiver uma conta, clique no painel de fonte de dados à esquerda de qualquer Smartbook e selecione Add Data Source.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/fabi_02.png" alt="Adicionar fonte de dados" border />

2. Em seguida, você deverá informar os detalhes da conexão.

   <Image size="md" img="/images/integrations/data-visualization/fabi_03.png" alt="Formulário de credenciais do ClickHouse" border />
...
<Image size="lg" img="/images/integrations/data-visualization/fabi_04.png" alt="Consultando o ClickHouse" border />
