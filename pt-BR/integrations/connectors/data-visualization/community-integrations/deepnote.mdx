...
<Image size="lg" img="/images/integrations/data-visualization/deepnote_01.png" alt="Bloco de integração do ClickHouse" border />

2. Informe os detalhes de conexão da sua instância do ClickHouse:

<ConnectionDetails />

<Image size="md" img="/images/integrations/data-visualization/deepnote_02.png" alt="caixa de diálogo de detalhes do ClickHouse" border />

***OBSERVAÇÃO:*** Se a sua conexão com o ClickHouse estiver protegida por uma lista de acesso por IP, talvez seja necessário permitir os endereços IP do Deepnote. Leia mais sobre isso na [documentação do Deepnote](https://docs.deepnote.com/integrations/authorize-connections-from-deepnote-ip-addresses).
...
1. Comece se conectando à integração do ClickHouse à direita do seu notebook.
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.png" alt="Caixa de diálogo de detalhes do ClickHouse" border />
