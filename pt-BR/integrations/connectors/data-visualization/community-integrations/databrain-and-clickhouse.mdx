...
<Image size="md" img="/images/integrations/data-visualization/databrain_01.png" alt="Interface de dashboard do Databrain mostrando visualização de dados do ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_02.png" alt="Menu de fontes de dados do Databrain" border />

3. Clique em **Add a Data Source** ou **Connect Data Source**.

4. Selecione **ClickHouse** na lista de conectores disponíveis.

<Image size="md" img="/images/integrations/data-visualization/databrain_03.png" alt="Tela de seleção de conectores do Databrain mostrando a opção ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_04.png" alt="Formulário de conexão do ClickHouse no Databrain com campos de configuração" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_05.png" alt="Explorador de dados do Databrain mostrando tabelas do ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/databrain_06.png" alt="Dashboard do Databrain com várias visualizações do ClickHouse" border />
