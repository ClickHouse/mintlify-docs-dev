...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_install.png" alt="Assistente de instalação do driver ODBC do ClickHouse mostrando as opções de instalação" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.png" alt="Pesquisa do Windows mostrando a opção ODBC Data Sources (64-bit)" border />

<br />

Verifique se o ClickHouse Driver aparece na lista.

<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_verify.png" alt="Administrador de Fonte de Dados ODBC mostrando drivers do ClickHouse na guia Drivers" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.png" alt="Tela inicial do Power BI Desktop mostrando o botão &#x22;Obter Dados&#x22;" border />

<br />

Pesquise por &quot;ClickHouse&quot;

<Image size="md" img="/images/integrations/data-visualization/powerbi_search_clickhouse.png" alt="Caixa de diálogo &#x22;Obter Dados&#x22; do Power BI com &#x22;ClickHouse&#x22; pesquisado na barra de pesquisa" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_db.png" alt="Caixa de diálogo de conexão do ClickHouse mostrando os campos de host, porta, banco de dados e modo de conectividade" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_connect_user.png" alt="Caixa de diálogo de credenciais de conexão do ClickHouse para nome de usuário e senha" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Visualização Navigator do Power BI mostrando tabelas do banco de dados ClickHouse e dados de exemplo" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_add_dsn.png" alt="Administrador de fonte de dados ODBC com o botão Add destacado para criar um novo DSN" border />

<br />

Escolha a versão Unicode do driver ODBC.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_unicode.png" alt="Caixa de diálogo Create New Data Source mostrando a seleção do ClickHouse Unicode Driver" border />

<br />

Preencha os detalhes da conexão.

<Image size="sm" img="/images/integrations/data-visualization/powerbi_connection_details.png" alt="Caixa de diálogo de configuração do ClickHouse ODBC Driver com parâmetros de conexão" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_select_odbc.png" alt="Caixa de diálogo Obter Dados do Power BI com a opção ODBC selecionada na categoria Outro" border />

<br />

Selecione na lista a fonte de dados criada anteriormente.

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_dsn.png" alt="Caixa de diálogo de seleção do driver ODBC mostrando o DSN do ClickHouse configurado" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_dsn_credentials.png" alt="Caixa de diálogo de credenciais para a conexão DSN ODBC" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_table_navigation.png" alt="Navigator view do Power BI mostrando tabelas do banco de dados ClickHouse e dados de exemplo" border />
...
**Abordagem recomendada para grandes conjuntos de dados:** em vez de consultar tabelas brutas diretamente, crie `visões materializadas` dedicadas no ClickHouse para cada visualização do painel. Isso oferece:
...
<Warning>
  Se seus painéis estiverem lentos, verifique o [`query_log`](/pt-BR/reference/system-tables/query_log) do ClickHouse para ver quais consultas SQL o Power BI está realmente executando. Problemas comuns incluem subconsultas aninhadas, varredura de tabelas inteiras ou junções ineficientes. Depois de identificar o problema, crie [visões materializadas](/pt-BR/concepts/features/materialized-views) para resolver esses problemas específicos.
</Warning>
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_16.png" alt="Power Query Editor mostrando a transformação do tipo de dados da coluna UInt64" border />
