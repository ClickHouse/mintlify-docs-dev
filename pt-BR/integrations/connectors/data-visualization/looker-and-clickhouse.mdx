...
<Image size="md" img="/images/integrations/data-visualization/looker_01.png" alt="Adicionando uma nova conexão na interface de gerenciamento de banco de dados do Looker" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_02.png" alt="Informando suas credenciais do ClickHouse no formulário de conexão do Looker" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_03.png" alt="Ativando SSL para a conexão com o ClickHouse nas configurações do Looker" border />

<br />

Primeiro, teste a conexão e, quando isso for concluído, conecte-se à sua nova fonte de dados do ClickHouse.

<Image size="md" img="/images/integrations/data-visualization/looker_04.png" alt="Testando e conectando-se à fonte de dados do ClickHouse" border />
