...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_common.png" alt="Exemplo de configuração nativa segura" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/config_http.png" alt="Opções extras de configuração de HTTP" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_additional.png" alt="Exemplo de configurações adicionais" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_logs.png" alt="Configuração de logs" border />
...
<Image size="sm" img="/images/integrations/data-visualization/grafana/config_traces.png" alt="Configuração de traces" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_config_example.png" alt="Exemplo de configuração de tabela de aliases" border />

Agora o Grafana verá os resultados da tabela de aliases em vez dos resultados de `DESC example_table`:

<Image size="md" img="/images/integrations/data-visualization/grafana/alias_table_select_example.png" alt="Exemplo de seleção de tabela de aliases" border />
