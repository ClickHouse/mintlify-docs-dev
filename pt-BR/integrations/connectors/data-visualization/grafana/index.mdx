...
2. Procure por **ClickHouse** e clique no plugin assinado da Grafana Labs:
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/search.png" alt="Selecione o plugin do ClickHouse na página Connections" border />

3. Na tela seguinte, clique no botão **Install**:

   <Image size="md" img="/images/integrations/data-visualization/grafana/install.png" alt="Instale o plugin do ClickHouse" border />
...
1. Quando a instalação for concluída, clique no botão **Add new data source**. (Você também pode adicionar uma fonte de dados pela aba **Data sources** na página **Connections**.)
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/add_new_ds.png" alt="Criar uma fonte de dados do ClickHouse" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/quick_config.png" alt="Página de configuração da conexão" border />
...
4. Clique no botão **Save &amp; test** para verificar se o Grafana consegue se conectar ao seu serviço ClickHouse. Se a conexão for bem-sucedida, você verá a mensagem **Data source is working**:
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/valid_ds.png" alt="Selecione Save & test" border />
