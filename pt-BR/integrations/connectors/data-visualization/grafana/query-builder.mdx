...
| Agregações         | Uma lista de [funções de agregação](/pt-BR/reference/functions/aggregate-functions). Permite valores personalizados para função e coluna. Visível apenas no modo Aggregate.                                                       |
| Agrupar por        | Uma lista de expressões [GROUP BY](/pt-BR/reference/statements/select/group-by). Visível apenas no modo Aggregate.                                                                                                                |
| Ordenar por        | Uma lista de expressões [ORDER BY](/pt-BR/reference/statements/select/order-by).                                                                                                                                                  |
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_table_query.png" alt="Exemplo de consulta de tabela agregada" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query.png" alt="Exemplo de consulta de logs OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_logs_query_fields.png" alt="Exemplo de campos extras na consulta de logs" border />
...
| Aggregates         | Uma lista de [funções de agregação](/pt-BR/reference/functions/aggregate-functions). Permite valores personalizados para função e coluna. Visível apenas no modo Aggregate.                                                                               |
| Group By           | Uma lista de expressões [GROUP BY](/pt-BR/reference/statements/select/group-by). Visível apenas no modo Aggregate.                                                                                                                                        |
| Order By           | Uma lista de expressões [ORDER BY](/pt-BR/reference/statements/select/order-by).                                                                                                                                                                          |
| Limit              | Adiciona uma instrução [LIMIT](/pt-BR/reference/statements/select/limit) ao final da consulta. Se for definido como `0`, ele será omitido; isso é recomendado para alguns conjuntos de dados de séries temporais a fim de exibir a visualização completa. |
| Filters            | Uma lista de filtros a serem aplicados na cláusula `WHERE`.                                                                                                                                                                                         |

<Image size="md" img="/images/integrations/data-visualization/grafana/demo_time_series_query.png" alt="Exemplo de consulta de séries temporais" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_trace_query.png" alt="Exemplo de consulta de rastreamento OTel" border />
...
<Image size="md" img="/images/integrations/data-visualization/grafana/demo_raw_sql_query.png" alt="Exemplo de consulta SQL pura" border />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
  ...
  <Image size="sm" img="/images/integrations/data-visualization/grafana/trace_id_in_table.png" alt="Links de trace em uma tabela" border />
</div>

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  Exemplo de links de trace em logs

  <Image size="md" img="/images/integrations/data-visualization/grafana/trace_id_in_logs.png" alt="Links de trace em logs" border />
</div>
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <Image size="md" img="/images/integrations/data-visualization/grafana/demo_data_links.png" alt="Exemplo de vinculação por links de dados" border />
</div>
