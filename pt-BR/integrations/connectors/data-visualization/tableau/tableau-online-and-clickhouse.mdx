...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_01.png" alt="Interface do Tableau Online mostrando o botão 'New' para criar uma fonte de dados publicada" border />

<br />

Selecione &quot;MySQL&quot; na lista de conectores disponíveis.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_02.png" alt="Tela de seleção de conectores do Tableau Online com a opção MySQL destacada" border />

<br />

Informe os detalhes da conexão obtidos durante a configuração do ClickHouse.

<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.png" alt="Tela de configuração da conexão MySQL no Tableau Online com campos de servidor, porta, banco de dados e credenciais" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_04.png" alt="Página da fonte de dados do Tableau Online mostrando as tabelas do banco de dados à esquerda e a área à direita com funcionalidade de arrastar e soltar" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_01.png" alt="Interface do Tableau Desktop mostrando o menu Connect com a opção MySQL destacada" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_02.png" alt="Caixa de diálogo de conexão MySQL do Tableau Desktop com a opção SSL habilitada e campos para servidor, nome de usuário, senha e certificado" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_03.png" alt="Tableau Desktop mostrando o menu Server com a opção Publish Data Source destacada" border />

<br />

IMPORTANTE: você precisa selecionar &quot;Embedded password&quot; nas opções de &quot;Authentication&quot;.

<Image size="md" img="/images/integrations/data-visualization/tableau_desktop_04.png" alt="Caixa de diálogo de publicação do Tableau Desktop mostrando as opções de Authentication com Embedded password selecionada" border />

<br />

Além disso, escolha &quot;Update workbook to use the published data source&quot;.

<Image size="sm" img="/images/integrations/data-visualization/tableau_desktop_05.png" alt="Caixa de diálogo de publicação do Tableau Desktop com a opção 'Update workbook to use the published data source' marcada" border />
