...
<Image size="md" img="/images/integrations/data-visualization/tableau_connecttoserver.png" alt="Tela de conexão do Tableau mostrando o menu de seleção de conectores com a opção ClickHouse by ClickHouse destacada" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_details.png" alt="Caixa de diálogo de instalação do conector no Tableau mostrando os detalhes do conector ClickHouse JDBC e o botão de instalação" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_connector_dialog.png" alt="Caixa de diálogo de conexão do ClickHouse no Tableau mostrando campos para servidor, porta, banco de dados, nome de usuário e senha" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_newworkbook.png" alt="Nova pasta de trabalho do Tableau mostrando a tela inicial de conexão com opções de seleção de banco de dados" border />

<br />

8. Selecione **TPCD** na lista suspensa **Schema** e você deverá ver a lista de tabelas em **TPCD**:

<Image size="md" img="/images/integrations/data-visualization/tableau_tpcdschema.png" alt="Seleção de esquema no Tableau mostrando as tabelas do banco de dados TPCD, incluindo CUSTOMER, LINEITEM, NATION, ORDERS e outras" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook1.png" alt="Pasta de trabalho do Tableau com a tabela CUSTOMER arrastada para a área de trabalho, mostrando cabeçalhos de coluna, mas sem dados" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook2.png" alt="Editor de relacionamento do Tableau mostrando a conexão entre as tabelas CUSTOMER e ORDERS usando o campo Custkey" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook3.png" alt="Planilha do Tableau mostrando as dimensões e medidas das tabelas do ClickHouse disponíveis para análise" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook4.png" alt="Gráfico de linhas do Tableau mostrando a quantidade pedida por ano a partir de dados do ClickHouse" border />
...
<Image size="sm" img="/images/integrations/data-visualization/tableau_workbook5.png" alt="Visualização de tabela cruzada do Tableau com trimestres como colunas e modos de envio como linhas" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook6.png" alt="Tabela cruzada do Tableau mostrando a soma do preço total por trimestre e modo de envio" border />
...
<Image size="md" img="/images/integrations/data-visualization/tableau_workbook7.png" alt="Tabela cruzada do Tableau mostrando o preço médio dos pedidos por trimestre e modo de envio com formatação de moeda" border />
