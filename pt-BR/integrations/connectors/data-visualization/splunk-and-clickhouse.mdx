...
<Image img="/images/integrations/splunk/splunk-1.png" size="lg" border alt="Dashboard do Splunk mostrando visualizações de dados de táxis de NYC" />
...
<Image img="/images/integrations/splunk/splunk-2.png" size="md" border alt="Página de configurações do Splunk DB Connect mostrando a configuração do Java Home" />
...
<Image img="/images/integrations/splunk/splunk-3.png" size="lg" border alt="Página de drivers do Splunk DB Connect mostrando o driver do ClickHouse instalado com sucesso" />
...
<Image img="/images/integrations/splunk/splunk-4.png" size="sm" border alt="Botão de nova conexão do Splunk DB Connect" />

<br />

Adicione os detalhes do host do ClickHouse e verifique se &quot;Enable SSL&quot; está marcado:

<Image img="/images/integrations/splunk/splunk-5.png" size="md" border alt="Página de configuração de conexão do Splunk para ClickHouse" />
...
<Image img="/images/integrations/splunk/splunk-6.png" size="md" border alt="SQL Explorer do Splunk selecionando a conexão com o ClickHouse" />

Execute uma consulta SQL na tabela `trips` que retorne a contagem de todos os registros da tabela:

<Image img="/images/integrations/splunk/splunk-7.png" size="md" border alt="Execução de consulta SQL no Splunk mostrando a contagem de registros na tabela trips" />
...
<Image img="/images/integrations/splunk/splunk-8.png" size="lg" border alt="Visualização do gráfico de colunas do Splunk mostrando os 10 principais bairros de embarque" />
...
<Image img="/images/integrations/splunk/splunk-9.png" size="lg" border alt="Gráfico de barras no Splunk mostrando a tarifa média por número de passageiros" />
...
<Image img="/images/integrations/splunk/splunk-10.png" size="lg" border alt="Dashboard final do Splunk com várias visualizações de dados de táxi de Nova York" />
