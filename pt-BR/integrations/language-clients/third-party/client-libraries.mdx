---
description: 'Visão geral das bibliotecas cliente de terceiros disponíveis para diferentes linguagens
  de programação'
sidebarTitle: 'Bibliotecas cliente'
slug: /interfaces/third-party/client-libraries
title: 'Bibliotecas cliente de desenvolvedores terceirizados'
doc_type: 'reference'
---

<Note>
  A ClickHouse Inc **não** mantém as bibliotecas listadas abaixo nem realizou testes extensivos para garantir a qualidade delas.
</Note>
...
* [cliente C++ do SeasClick](https://github.com/SeasX/SeasClick)
...
* [extensão PHP do ClickHouse da kolya7k](https://github.com//kolya7k/clickhouse-php)
...
* [driver do ClickHouse para o framework userver](https://userver.tech/dd/ddb/clickhouse_driver.html)
