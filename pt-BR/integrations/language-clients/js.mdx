...
Para Parquet, o principal caso de uso de instruções `SELECT` provavelmente será gravar o fluxo resultante em um arquivo. Veja [o exemplo](https://github.com/ClickHouse/clickhouse-js/blob/main/examples/node/performance/select_parquet_as_file.ts) no repositório da biblioteca cliente.
...
[aqui](/pt-BR/reference/data-types).
...
* `data_type` - [Tipo de dado](/pt-BR/reference/data-types) do valor do parâmetro da aplicação.
