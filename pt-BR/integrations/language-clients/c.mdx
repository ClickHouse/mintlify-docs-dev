...
`clickhouse-c` é um cliente C header-only para o ClickHouse [protocolo nativo](/pt-BR/interfaces/tcp).
...
codifica blocos no formato [Native](/pt-BR/interfaces/formats/Native) por meio de um callback de E/S fornecido por você. Você é responsável
...
* Protocolo HTTP. Encapsule o libcurl diretamente para a [interface HTTP](/pt-BR/interfaces/http).
...
[ClickHouse Cloud](/pt-BR/cloud/overview) e outras implantações com TLS ativado usam o protocolo nativo na
