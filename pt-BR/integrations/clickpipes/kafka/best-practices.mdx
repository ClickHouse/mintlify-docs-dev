...
* As mensagens individuais são limitadas, por padrão, a 2 MB (sem compactação) ao usar o menor tamanho de réplica (XS), e a 8 MB (sem compactação) com réplicas maiores.  As mensagens que excederem esse limite serão rejeitadas com erro.  Se precisar de mensagens maiores, entre em contato com o suporte.
