...
<div id="creating-your-first-kafka-clickpipe">
  # Criando seu primeiro ClickPipe do Kafka
</div>
...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Selecionar importações" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step1.png" alt="Selecione o tipo de fonte de dados" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step2.png" alt="Preencha os detalhes da conexão" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_ssh_tunnel.png" alt="Configuração do túnel SSH" size="md" />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3.png" alt="Selecione seu tópico" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Defina a tabela, o esquema e as configurações" size="md" />

    Você também pode personalizar as configurações avançadas usando os controles disponíveis

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_table_settings.png" alt="Defina controles avançados" size="md" />
  </Step>
  ...
  <Step>
    ...
    * `Only destination table`: apenas com permissões `INSERT` na tabela de destino.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissões" size="md" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Ver Overview" size="md" />
  </Step>
</Steps>