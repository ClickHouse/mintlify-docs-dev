...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-pitr.png" alt="Habilitando o PITR no Cloud SQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-edit-button.png" alt="Botão Edit no MySQL do GCP" size="lg" border />

Em seguida, role a página até a seção `Flags` e adicione as flags acima.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-flags.png" alt="Definindo as flags do binlog no GCP" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-ip.png" alt="Lista de permissões de IP no GCP MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/gcp-mysql-cert.png" alt="Baixando certificado do MySQL no GCP" size="lg" border />

5. Na interface do ClickPipes, faça upload do certificado baixado ao criar um novo ClickPipe para MySQL.

<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/gcp/rootca.png" alt="Usando certificado do MySQL no GCP" size="lg" border />