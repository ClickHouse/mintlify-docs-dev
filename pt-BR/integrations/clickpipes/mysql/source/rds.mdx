...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Onde encontrar o Security Group no RDS MySQL?" size="lg" border />
