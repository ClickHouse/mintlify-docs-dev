...
Agora você pode [criar seu ClickPipe](/pt-BR/integrations/clickpipes/mysql) e começar a fazer a ingestão de dados da sua instância do MariaDB para o ClickHouse Cloud.
