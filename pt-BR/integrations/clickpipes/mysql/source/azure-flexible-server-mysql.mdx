...
<Tabs>
  <Tab title="Permitir IPs do ClickPipes">
    ...
    3. Na seção **Firewall rules**, insira a [lista de endereços IP estáticos do ClickPipes](/pt-BR/integrations/clickpipes/home#list-of-static-ips) da região em que seu serviço está implantado.
       ...
       <Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/azure-flexible-server-mysql/1_configure_network_security.png" alt="Configurar rede para acesso público com uma lista de IPs permitidos" size="lg" border />
