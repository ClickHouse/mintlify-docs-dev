...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/partition_key.png" alt="Coluna de chave de partição" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/snapshot_params.png" alt="Parâmetros do snapshot" size="md" />
