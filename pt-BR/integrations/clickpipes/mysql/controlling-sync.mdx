...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="Criar opções de sincronização" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="Editar opções de sincronização" size="md" />
