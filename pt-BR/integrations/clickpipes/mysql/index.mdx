...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-tile.png" alt="Selecionar MySQL" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/mysql-connection-details.png" alt="Preencha os detalhes da conexão" size="lg" border />
...
5. Aqui, você pode selecionar o banco de dados de destino do seu ClickPipe. Você pode escolher um banco de dados existente ou criar um novo.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mysql/select-destination-db.png" alt="Selecionar banco de dados de destino" size="lg" border />
