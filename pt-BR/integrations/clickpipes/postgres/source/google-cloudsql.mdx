...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/edit.png" alt="Botão Edit no Cloud SQL Postgres" size="lg" border />

2. Vá para Flags e altere `cloudsql.logical_decoding` para on. Essa alteração exigirá a reinicialização do servidor Postgres.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding1.png" alt="Altere cloudsql.logical_decoding para on" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/cloudsql_logical_decoding3.png" alt="Reiniciar servidor" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections.png" alt="Seção Connections no Cloud SQL" size="lg" border />

2. Vá para a subseção **Networking**

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/connections_networking.png" alt="Subseção Networking no Cloud SQL" size="lg" border />

3. Adicione os [IPs públicos do ClickPipes](/pt-BR/integrations/clickpipes/home#list-of-static-ips)

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall1.png" alt="Adicionar redes do ClickPipes ao firewall" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/google-cloudsql/firewall2.png" alt="Redes do ClickPipes adicionadas ao firewall" size="lg" border />
