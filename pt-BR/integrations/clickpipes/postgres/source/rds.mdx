...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/parameter_group_in_blade.png" alt="Onde encontrar grupos de parâmetros no RDS?" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.png" alt="Modificando o Postgres no RDS com o novo grupo de parâmetros" size="lg" border />

3. Reinicie a sua instância do RDS para aplicar as alterações

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.png" alt="Reiniciando o Postgres no RDS" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/security_group_in_rds_postgres.png" alt="Onde encontrar o grupo de segurança no RDS Postgres?" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/edit_inbound_rules.png" alt="Editar as regras de entrada do grupo de segurança acima" size="lg" border />
