...
<div id="azure-flexible-server-for-postgres-source-setup-guide">
  # Guia de configuração da fonte do Azure Flexible Server for Postgres
</div>
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/server_parameters.png" alt="Parâmetros do servidor no Azure Flexible Server for Postgres" size="lg" border />

2. Altere `wal_level` para `logical`

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/wal_level.png" alt="Alterar wal_level para logical no Azure Flexible Server for Postgres" size="lg" border />

3. Essa alteração exigirá uma reinicialização do servidor. Portanto, reinicie-o quando solicitado.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/restart.png" alt="Reiniciar o servidor após alterar wal_level" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.png" alt="Adicione os IPs do ClickPipes ao firewall no Azure Flexible Server for Postgres" size="lg" />
