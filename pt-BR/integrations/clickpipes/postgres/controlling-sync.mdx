...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/create_sync_settings.png" alt="Criar configurações de sincronização" size="md" />

Ao editar um ClickPipe existente, vá até a guia **Settings** do pipe, pause-o e clique em **Configure** aqui:

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/edit_sync_button.png" alt="Botão para editar a sincronização" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/sync_settings_edit.png" alt="Editar configurações de sincronização" size="md" />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/cdc_syncs.png" alt="tabela CDC Syncs" size="md" />