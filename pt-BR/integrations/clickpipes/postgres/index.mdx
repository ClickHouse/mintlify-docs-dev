---
sidebarTitle: 'Ingestão de dados do Postgres para o ClickHouse'
description: 'Conecte o Postgres ao ClickHouse Cloud sem complicações.'
slug: /integrations/clickpipes/postgres
title: 'Ingestão de dados do Postgres para o ClickHouse (usando CDC)'
keywords: ['PostgreSQL', 'ClickPipes', 'CDC', 'captura de alterações de dados', 'replicação de banco de dados']
doc_type: 'guide'
integration:
  - support_level: 'core'
  - category: 'clickpipes'
...
<div id="ingesting-data-from-postgres-to-clickhouse-using-cdc">
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Serviço do ClickPipe" size="lg" border />
...
3. Selecione o bloco `Postgres CDC`
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/postgres/postgres-tile.png" alt="Selecionar Postgres" size="lg" border />
