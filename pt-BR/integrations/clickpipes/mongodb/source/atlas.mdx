...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-cluster-overview-configuration.png" alt="Acesse a configuração do cluster" size="lg" border />

2. Clique em `Additional Settings` e role a tela para baixo até `More Configuration Options`.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-expand-additional-settings.png" alt="Expanda as configurações adicionais" size="lg" border />

3. Clique em `More Configuration Options` e defina a janela mínima do oplog como `72 hours` ou mais.

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-set-retention-hours.png" alt="Defina as horas de retenção do oplog" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-add-new-database-user.png" alt="Adicionar usuário de banco de dados" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-database-user-privilege.png" alt="Configurar funções do usuário" size="lg" border />

Também é possível especificar os clusters/instâncias aos quais você deseja conceder acesso ao usuário do ClickPipes:

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongo-atlas-restrict-access.png" alt="Restringir acesso a cluster/instância" size="lg" border />

<div id="whats-next">
  ## O que vem a seguir?
</div>

Agora você pode [criar seu ClickPipe](/pt-BR/integrations/clickpipes/mongodb) e começar a ingerir dados da sua instância do MongoDB no ClickHouse Cloud.
