...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png" alt="Selecionar grupo de parâmetros" size="lg" border />

2. Procure por `change_stream_log_retention_duration`, selecione o parâmetro e altere-o para `259200` (72 horas)

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png" alt="Modificar grupo de parâmetros" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png" alt="Aplicar grupo de parâmetros" size="lg" border />

<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png" alt="Status do grupo de parâmetros" size="lg" border />
...
Agora você pode [criar seu ClickPipe](/pt-BR/integrations/clickpipes/mongodb) e começar a fazer a ingestão de dados da sua instância do DocumentDB para o ClickHouse Cloud.
