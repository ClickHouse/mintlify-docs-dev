...
Agora você pode [criar seu ClickPipe](/pt-BR/integrations/clickpipes/mongodb) e começar a fazer a ingestão de dados da sua instância do MongoDB no ClickHouse Cloud.
