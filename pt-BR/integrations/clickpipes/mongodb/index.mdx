...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Serviço do ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-tile.png" alt="Selecionar MongoDB" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/mongodb/mongodb-connection-details.png" alt="Preencha os detalhes da conexão" size="lg" border />
...
5. Aqui, você pode selecionar o banco de dados de destino do seu ClickPipe. Você pode escolher um banco de dados existente ou criar um novo.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/mongodb/select-destination-db.png" alt="Selecionar banco de dados de destino" size="lg" border />
