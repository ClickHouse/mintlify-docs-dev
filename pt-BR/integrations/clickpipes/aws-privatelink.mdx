...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Serviço do ClickPipes" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_select.png" alt="Selecionar fonte de dados" size="lg" border />

4. Selecione a opção `Reverse private endpoint`.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step0.png" alt="Selecionar endpoint privado reverso" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step1.png" alt="Selecionar endpoint privado reverso" size="lg" border />

6. Forneça os parâmetros obrigatórios para o tipo de endpoint selecionado.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step2.png" alt="Selecionar endpoint privado reverso" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_step3.png" alt="Selecionar endpoint privado reverso" size="lg" border />
...
1. Na barra lateral, localize o botão `Settings` e clique nele.
   ...
   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings0.png" alt="Configurações do ClickHouse Cloud" size="lg" border />

2. Clique em `Reverse private endpoints` na seção `ClickPipe reverse private endpoints`.

   <Image img="/images/integrations/data-ingestion/clickpipes/cp_rpe_settings1.png" alt="Configurações do ClickHouse Cloud" size="md" border />
