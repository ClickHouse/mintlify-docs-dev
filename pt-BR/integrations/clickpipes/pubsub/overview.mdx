...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_service.png" alt="Serviço ClickPipes" size="lg" border />

2. Selecione o botão `Data Sources` no menu à esquerda e clique em &quot;Configurar um ClickPipe&quot;

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="Selecionar importações" size="lg" border />

3. Selecione **GCP Pub/Sub** como sua fonte de dados.

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step1_pubsub.png" alt="Selecionar GCP Pub/Sub como fonte de dados" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_pubsub.png" alt="Preencher detalhes da conexão" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_pubsub.png" alt="Definir tópico do Pub/Sub, formato e offset inicial" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="Definir tabela, esquema e configurações" size="lg" border />

Você também pode personalizar as configurações avançadas usando os controles fornecidos

<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="Definir controles avançados" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="Usar uma tabela existente" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="Permissões" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_success.png" alt="Aviso de sucesso" size="sm" border />

<Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.png" alt="Aviso de remoção" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_overview.png" alt="Ver visão geral" size="lg" border />
...
O ClickPipes para Pub/Sub se autentica no GCP usando uma chave JSON de conta de serviço. Você faz upload do arquivo de chave ao criar o pipe; o ClickPipes o criptografa em repouso e o usa em tempo de execução para consumir mensagens e gerenciar o ciclo de vida da assinatura gerenciada.

Para consultar a lista exata de permissões do IAM necessárias e uma definição recomendada de role personalizado, veja o [guia de permissões do IAM do Pub/Sub](/pt-BR/integrations/clickpipes/pubsub/auth).