...
<Image img="/images/integrations/data-ingestion/clickpipes/bigquery/cp_iam.png" alt="Criando uma chave de conta de serviço com permissões do BigQuery e do Cloud Storage" size="lg" border />
