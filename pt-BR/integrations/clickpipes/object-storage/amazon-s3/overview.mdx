...
| **OVH Object Storage** <br /> *compatível com S3*  | <img src="/images/integrations/logos/ovh.png" alt="logo do Cloud Storage" width="32" />         | A ingestão contínua exige [ordem lexicográfica](#continuous-ingestion-lexicographical-order). O modo não ordenado não é compatível.                                                                           |
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_credentials.png" alt="Credenciais IAM para S3 ClickPipes" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/amazon-s3/cp_iam.png" alt="Autenticação IAM para ClickPipes do S3" size="lg" border />
