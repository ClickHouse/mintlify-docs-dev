...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/google-cloud-storage/cp_credentials.png" alt="Credenciais HMAC para o ClickPipes do GCS" size="lg" border />

Siga [este guia](/pt-BR/integrations/connectors/data-ingestion/GCP#create-a-service-account-hmac-key-and-secret) para criar uma conta de serviço com uma chave HMAC.
