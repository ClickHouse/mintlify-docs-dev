...
title: 'Criando seu primeiro ClickPipe do Google Cloud Storage'
doc_type: 'guide'
---

import CreateClickPipe from '/snippets/pt-BR/_create_clickpipe.mdx';

<div id="creating-your-first-gcs-clickpipe">
  # Criando seu primeiro ClickPipe do GCS
</div>
