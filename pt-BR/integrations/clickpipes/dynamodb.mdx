...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-s3-export.png" size="md" alt="Exportação do DynamoDB para S3" border />
...
<Image img="/images/integrations/data-ingestion/dbms/dynamodb/dynamodb-map-columns.png" size="md" alt="Mapeamento de colunas do DynamoDB" border />
