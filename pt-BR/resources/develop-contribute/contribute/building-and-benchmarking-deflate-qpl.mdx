...
* Para os requisitos gerais, consulte as instruções gerais de [compilação do ClickHouse](/pt-BR/resources/develop-contribute/build){/* MIGRATE: unknown slug */}{/* MIGRATE: unknown slug */}
