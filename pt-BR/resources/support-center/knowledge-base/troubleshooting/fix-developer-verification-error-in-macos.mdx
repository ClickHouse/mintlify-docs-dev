...
<Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="md" alt="Caixa de diálogo de erro de verificação do desenvolvedor no macOS" border />
...
2. Vá para **Privacidade e Segurança**:
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="Visualização padrão dos ajustes de Privacidade e Segurança do macOS" border />
...
4. Clique em **Permitir Mesmo Assim**.
   ...
   <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="Ajustes de Privacidade e Segurança do macOS mostrando o botão Permitir Mesmo Assim" border />
