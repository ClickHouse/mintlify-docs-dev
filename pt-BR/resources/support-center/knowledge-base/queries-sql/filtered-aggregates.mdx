...
description: Aprenda a usar agregações filtradas no ClickHouse com os combinadores de agregação `-If` e `-Distinct` para simplificar a sintaxe das consultas e aprimorar as análises.
date: 2023-03-01
tags: ['Funções']
