...
<Image img="/images/knowledgebase/ikb273/c8a5492f-5910-4454-bfbc-5c6ceda15ccd.png" size="md" alt="Estrutura do banco de dados e da tabela no MSSQL" border />

Login do MSSQL, `sql_user`:

<Image img="/images/knowledgebase/ikb273/568f1143-475e-422f-a26a-2c23ac324771.png" size="md" alt="Configuração do login do MSSQL" border />

Roles de associação ao banco de dados para `sql_user`:

<Image img="/images/knowledgebase/ikb273/63992978-7078-4985-b661-a3c095099ea7.png" size="md" alt="Roles de associação ao banco de dados no MSSQL" border />

Usuário do banco de dados com login:

<Image img="/images/knowledgebase/ikb273/15a407ca-53c1-45b1-9beb-ddd8eedde64a.png" size="md" alt="Usuário do banco de dados no MSSQL com login" border />
...
* [https://clickhouse.com/docs/engines/table-engines/integrations/odbc](/pt-BR/snippets/engines/table-engines/integrations/odbc)
