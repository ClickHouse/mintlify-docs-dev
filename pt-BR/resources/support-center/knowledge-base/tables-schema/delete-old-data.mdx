...
Mais detalhes sobre [mutações](/pt-BR/reference/statements/alter#mutations).
...
Pode parecer radical remover todos os dados de uma tabela, mas, em alguns casos, isso pode ser exatamente o que você precisa.

Mais detalhes sobre [truncamento de tabela](/pt-BR/reference/statements/truncate).