...
description: "Saiba como resolver falhas de ingestão causadas por uma verificação de permissões mais rigorosa introduzida no ClickHouse 23.9 para tabelas que usam `async_inserts`. Atualize as permissões para corrigir os erros."
date: 2022-11-17
