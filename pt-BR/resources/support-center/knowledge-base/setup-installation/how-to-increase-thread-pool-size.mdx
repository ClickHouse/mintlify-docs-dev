...
Consulte a [documentação](/pt-BR/reference/settings/server-settings/settings#max-thread-pool-size) para mais detalhes sobre as configurações acima e outras que afetam o pool global de threads.