...
<Image img="/images/knowledgebase/lets-encrypt-ssl/port_80_security_group.png" size="md" alt="Configuração do grupo de segurança da AWS mostrando a porta 80 aberta" border />
