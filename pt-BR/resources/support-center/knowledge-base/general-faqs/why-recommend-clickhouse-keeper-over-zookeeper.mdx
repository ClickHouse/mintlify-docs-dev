...
Confira a [página de documentação do Keeper](/pt-BR/guides/oss/deployment-and-scaling/keeper) para mais detalhes sobre como configurar e executar o ClickHouse Keeper.