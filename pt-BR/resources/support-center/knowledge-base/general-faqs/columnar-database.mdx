...
<Image img="/images/row-oriented.gif" alt="Ilustração do armazenamento tradicional de banco de dados orientado a linhas" size="md" />

**Colunar**

<Image img="/images/column-oriented.gif" alt="Ilustração do armazenamento de banco de dados colunar" size="md" />
