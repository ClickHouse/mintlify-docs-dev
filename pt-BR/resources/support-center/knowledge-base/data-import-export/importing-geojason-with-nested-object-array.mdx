...
description: “Importando GeoJSON com um array de objetos altamente aninhado“
date: 2024-12-18
...
Para isso, podemos usar a função [arrayMap(func,arr1,...)](/pt-BR/reference/functions/regular-functions/array-functions#arraymapfunc-arr1-).
