...
Se o ClickHouse não conseguir determinar o formato pela extensão do arquivo, o formato de saída padrão para os dados de saída será [TabSeparated](/pt-BR/reference/formats). Para especificar o [formato de saída](/pt-BR/reference/formats), use a [cláusula FORMAT](/pt-BR/reference/statements/select/format).
