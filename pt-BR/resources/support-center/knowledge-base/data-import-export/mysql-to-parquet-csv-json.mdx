...
É impressionante como a ferramenta `clickhouse-local` é, ao mesmo tempo, simples e poderosa. Você pode facilmente ler dados de um banco de dados como o MySQL e gerá-los em [todos os tipos de formatos de saída diferentes](/pt-BR/reference/formats).