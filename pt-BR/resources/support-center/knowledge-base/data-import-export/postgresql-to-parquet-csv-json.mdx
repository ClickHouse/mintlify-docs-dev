...
O formato de saída pode ser qualquer um dos [formatos de saída](/pt-BR/reference/formats) compatíveis com o ClickHouse. Vamos ver alguns exemplos...
...
<Note>
  Você não precisa parar por aqui: é possível usar `clickhouse-local` para extrair dados do PostgreSQL e enviá-los para [todos os formatos de saída](/pt-BR/reference/formats).
