...
description: "Saiba como carregar mensagens JSON do Apache Kafka diretamente em uma única coluna JSON no ClickHouse usando o mecanismo de tabela Kafka e o tipo de dados JSON."
date: 2024-11-06
