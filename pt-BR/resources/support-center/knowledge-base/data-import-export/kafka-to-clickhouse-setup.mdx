---
title: Como fazer ingestão de dados do Kafka no ClickHouse
...
Este artigo apresenta o processo de envio de dados de um tópico do Kafka para uma tabela no ClickHouse. Usaremos o feed de alterações recentes da Wiki, que fornece um [fluxo de eventos](https://stream.wikimedia.org/v2/stream/recentchange) que representa mudanças feitas em várias propriedades da Wikimedia. As etapas incluem:

1. Como configurar o Kafka no Ubuntu
2. Fazer a ingestão de um fluxo de dados em um tópico do Kafka
3. Criar uma tabela no ClickHouse que consome o tópico

<div id="1-setup-kafka-on-ubuntu">
  # 1. Configure o Kafka no Ubuntu
</div>
