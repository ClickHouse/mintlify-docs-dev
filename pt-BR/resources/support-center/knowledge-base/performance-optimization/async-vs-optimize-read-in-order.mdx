...
Normalmente, a configuração [max&#95;threads](/pt-BR/reference/settings/session-settings#settings-max_threads) [controla](https://clickhouse.com/company/events/query-performance-introspection) o número de threads de leitura paralelas e de processamento paralelo da consulta:
