...
description: Saiba como usar a opção `skip_check_for_incorrect_settings` para permitir que o ClickHouse inicie mesmo quando configurações em nível de usuário forem especificadas incorretamente.
date: 2023-03-01
tags: ['Configurações']
