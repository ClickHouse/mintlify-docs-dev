---
title: Exceção ao alterar configurações do usuário
description: Tratando a exceção lançada ao alterar as configurações do usuário
date: 2023-08-26
tags: ['Configurações', 'Erros e Exceções']
keywords: ['Exceção', 'Configurações do Usuário']
---
