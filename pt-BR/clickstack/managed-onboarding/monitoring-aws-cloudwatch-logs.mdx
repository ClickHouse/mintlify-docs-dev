...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-v2.png" size="lg" alt="Iniciar o ClickStack" border />
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view-clickstack.png" size="lg" alt="Visualização Busca do ClickStack com logs do CloudWatch" />
    ...
    * `Body`: a linha de log original
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-attributes-clickstack.png" size="lg" alt="Visualização Busca do ClickStack com logs e atributos do CloudWatch" />

    Selecione uma entrada de log para inspecionar seus metadados:

    <Image img="/images/clickstack/cloudwatch/error-log-column-values-clickstack.png" size="lg" alt="Atributos do CloudWatch na visualização de detalhes do log" />
  ...
  <Step>
    ...
    <TrackedLink href={'/pt-BR/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Baixe `cloudwatch-logs-dashboard.json`</TrackedLink> e, em seguida, na ClickStack UI, navegue até **Dashboards** e clique em **Import**.

    <Image img="/images/clickstack/clickstack-import-dashboard.png" size="lg" alt="Botão de importação de dashboard" />

    Faça upload do arquivo JSON e clique em **Finish Import**.

    <Image img="/images/clickstack/cloudwatch/finish-clickstack-import.png" size="lg" alt="Janela de diálogo Finish Import" />
  </Step>
