...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-v2.png" size="lg" alt="Abrir o ClickStack" border />
    ...
    <Image img="/images/use-cases/observability/clickstack-search-with-k8-logs.png" size="lg" alt="Visualização Busca do ClickStack com logs do Kubernetes" />
    ...
    <Image img="/images/use-cases/observability/clickstack-dashboard-kubernetes.png" size="lg" alt="Dashboard Kubernetes do ClickStack" border />
