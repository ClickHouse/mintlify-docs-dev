...
<Steps>
  <Step>
    ## Tenha suas credenciais em mãos

    <GatherCredentials />
  </Step>

  <Step>
    ## Criar um usuário para ingestão

    <CreateIngestionUser />
  </Step>

  <Step>
    ## Implantar o collector
  ...
  <Step>
    ## Conecte a aplicação ao seu collector
  ...
  <Step>
    ## Inicie o ClickStack e explore sua telemetria
    ...
    <Image img="/images/use-cases/observability/clickstack-cloud-first-time.png" size="lg" alt="Iniciar o ClickStack" border />
...
* [Monitoramento dos logs do AWS CloudWatch](/pt-BR/clickstack/managed-onboarding/monitoring-aws-cloudwatch-logs): encaminhe logs do CloudWatch por meio do receiver CloudWatch do OpenTelemetry.
...
* [Entrando em produção](/pt-BR/clickstack/managing/production) com recomendações para entrada em produção.