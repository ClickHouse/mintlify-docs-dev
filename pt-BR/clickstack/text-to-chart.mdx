...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/text-to-chart/chart-explorer.png" alt="Explorador de gráficos" />
  </Step>
  ...
  <Step>
    ...
    * `Count of events over time grouped by severity`
    ...
    <Image img="/images/clickstack/text-to-chart/text-to-chart.png" alt="Texto para gráfico" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/text-to-chart/create-connection.png" alt="Criar conexão" />
