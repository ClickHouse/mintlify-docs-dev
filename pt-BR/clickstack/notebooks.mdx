...
<Image img="/images/use-cases/observability/hyperdx-notebook-hero.png" alt="AI Notebook investigando uma indisponibilidade total da Visa causada por cache cheio" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-ai-consent.png" alt="Opção de Generative AI em Team Settings" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-list.png" alt="Página de lista de notebooks" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-tiles.png" alt="Notebook com tiles gerados por IA" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branch-modal.png" alt="Caixa de diálogo Create New Branch" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-branching.png" alt="Setas de navegação entre ramificações e indicador 1/2 em um tile" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-manual-tiles.png" alt="Botões de tiles manuais na parte inferior de um notebook" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx-notebook-agent-context.png" alt="Painel de Agent Settings para contexto personalizado" size="lg" />