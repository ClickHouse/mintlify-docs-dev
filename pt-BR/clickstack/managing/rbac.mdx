...
<Tabs>
  <Tab title="Usuários e funções do Cloud">
    <Image img="/images/clickstack/rbac/team-page-cloud.png" alt="Página de usuários e funções do ClickHouse Cloud" size="lg" />
  </Tab>

  <Tab title="Configurações da equipe do ClickStack">
    <Image img="/images/clickstack/rbac/team-page-clickstack.png" alt="Página Configurações da equipe do ClickStack mostrando os membros da equipe e suas funções" size="lg" />
  </Tab>
</Tabs>
...
<Image img="/images/clickstack/rbac/default-vs-fine-grained.png" alt="Modos de Acesso padrão vs. Controles granulares no editor da função" size="md" />
...
<Image img="/images/clickstack/rbac/condition-tip.png" alt="Dica da condição: corresponda recursos por Nome ou Tag (mostrado no título) ou por ID (encontrado na URL)" size="md" />
...
<Image img="/images/clickstack/rbac/dashboard-id-and-tag-example.png" alt="Dashboard mostrando o ID do recurso na barra de URL e uma tag no canto superior direito" size="lg" />
...
<Image img="/images/clickstack/rbac/access-rules-tip.png" alt="Dica das regras de acesso com lógica OR" size="md" />
...
<Image img="/images/clickstack/rbac/dashboard-fine-grained-example.png" alt="Duas regras de acesso granular unidas por OR: Name contains testing com acesso Read e Tag is testing com acesso Read" size="md" />
...
<Image img="/images/clickstack/rbac/security-policies.png" alt="Políticas de segurança" size="lg" />