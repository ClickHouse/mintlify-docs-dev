...
<Image img="/images/use-cases/observability/hyperdx-25.png" alt="Configuração de fonte do HyperDX" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-config.png" alt="Configuração de Atributos destacados" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-highlighted-attributes-search.png" alt="Busca de Atributos destacados" size="md" />
...
<Image img="/images/use-cases/observability/hyperdx-26.png" alt="Fonte correlacionada do HyperDX" size="md" />
