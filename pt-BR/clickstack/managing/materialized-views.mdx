...
<Image img="/images/clickstack/materialized_views/generated_sql.png" size="lg" alt="SQL gerado" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/edit_source.png" size="lg" alt="Editar fontes" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/add_view.png" size="lg" alt="Editar fontes" />
  </Step>
  ...
  <Step>
    ...
    * A coluna agregada correspondente na visão materializada, por exemplo, `avg__Duration`
    ...
    <Image img="/images/clickstack/materialized_views/select_metrics.png" size="lg" alt="Selecionar métricas" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_time_granularity.png" size="lg" alt="Selecionar granularidade de tempo" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/select_min_time.png" size="lg" alt="Selecionar tempo mínimo" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/materialized_views/save_source.png" size="lg" alt="Salvar fonte" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/materialized_views/accelerated_visual.png" size="lg" alt="Visualização acelerada" />
