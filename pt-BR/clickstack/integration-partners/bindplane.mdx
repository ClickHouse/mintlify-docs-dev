...
<Steps>
  <Step>
    #### Configure o ClickStack como destino
  ...
  <Step>
    ...
    4. Adicione origens:
       * Clique em **Add Source** para selecionar entre mais de 80 origens disponíveis
       * Para testes, você pode adicionar uma origem geradora de telemetria para simular tráfego
       * Para produção, adicione origens para sua telemetria real (logs, métricas, traces)
  ...
  <Step>
    #### Adicione processadores (opcional)
  ...
  <Step>
    #### Implante coletores e inicie o rollout
    ...
    <Tip>
      **Principais pontos**
      ...
      O Bindplane oferece rollouts seguros com um clique e validação. Você pode monitorar a integridade do coletor, a taxa de transferência e eventuais erros em tempo real pela interface do Bindplane.
    </Tip>

    <Image img="/images/clickstack/bindplane/bindplane-configuration.png" alt="Sinais de telemetria no ClickStack via Bindplane" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/bindplane/bindplane-hyperdx.png" alt="Sinais de telemetria no ClickStack via Bindplane" size="lg" />
  </Step>
</Steps>
