...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/alerts_search_view.png" alt="Visualização de alertas de busca" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * Escolher um destino de webhook para notificações. Você pode adicionar um novo webhook diretamente desta visualização. Consulte [Adicionando um webhook](#add-webhook) para mais detalhes.
    ...
    <Image img="/images/use-cases/observability/search_alert.png" alt="Alertas de busca" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/use-cases/observability/multiple_search_alerts.png" alt="Vários alertas" size="md" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/edit_chart_alert.png" alt="Editar alerta do gráfico" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/add_chart_alert.png" alt="Adicionar alerta ao gráfico" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/create_chart_alert.png" alt="Criar alerta para gráfico" size="lg" />
...
<Image img="/images/use-cases/observability/add_new_webhook.png" alt="Adicionar novo webhook" size="lg" />

Isso abre a caixa de diálogo de criação de webhook, na qual você pode criar um novo webhook:

<Image img="/images/use-cases/observability/add_webhook_dialog.png" alt="Criação de webhook" size="md" />
...
<Image img="/images/use-cases/observability/manage_alerts.png" alt="Gerenciar alertas" size="lg" />

Nesta visualização, você pode ver todos os alertas que foram criados e que estão ativos no momento no ClickStack.

<Image img="/images/use-cases/observability/alerts_view.png" alt="Visualização de alertas" size="lg" />
...
<Image img="/images/use-cases/observability/remove_chart_alert.png" alt="Remover alerta do gráfico" size="lg" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/open_sql_chart_mode.png" alt="Criar gráfico SQL" size="lg" />
  </Step>
  ...
  <Step>
    ...
    * **Webhook**: o canal de notificação usado quando o alerta é disparado. Consulte [Como adicionar um webhook](#add-webhook).
    ...
    <Image img="/images/use-cases/observability/add_raw_sql_alert.png" alt="Editar alerta do gráfico" size="lg" />
