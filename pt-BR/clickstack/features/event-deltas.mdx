...
<Image img="/images/clickstack/event-deltas/overview.png" alt="Visão geral de Event deltas no serviço de pagamento, com a faixa brilhante subindo no meio da janela e sem recuperação visível" size="lg" />
...
<Image img="/images/clickstack/event-deltas/before-after.png" alt="Modo de comparação no serviço de pagamento, com o retângulo desenhado do ponto de inflexão da subida até a borda direita, com a base apoiada na linha de base de 1 ms" size="lg" />
...
<Image img="/images/clickstack/event-deltas/slow-vs-fast.png" alt="Comparação entre lento e rápido no frontend-proxy, com o retângulo cobrindo apenas a faixa superior claramente separada, bem distante da massa densa" size="lg" />
...
<Image img="/images/clickstack/event-deltas/drill-down.png" alt="Popover aberto ao clicar em uma barra de ScopeVersion, mostrando percentuais de Selection vs Background e ações de filtrar, excluir e copiar" size="lg" />
...
<Image img="/images/clickstack/event-deltas/settings-drawer.png" alt="Painel lateral Display Settings com os campos Scale, Value e Count" size="lg" />
