...
<Steps>
  ...
  <Step>
    ...
    * `P95 Duration`: o percentil 95 de `Duration`. Defina o formato numérico da coluna como duração para que ela seja exibida como `288ms`, e não como nanossegundos brutos.
    ...
    <Image img="/images/clickstack/dashboards/row-click-catalog.png" alt="Tabela de inventário de serviços com colunas RED (Requests, Errors, P95 Duration) para cada serviço, ordenada por volume de requisições, acima de uma tendência de requisições ao longo do tempo" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/row-click-drilldown.png" alt="Dashboard Service Detail após um clique em uma linha, com o filtro Service definido para o serviço clicado e os indicadores RED principais, percentis de latência e detalhamento por endpoint todos restritos a ele" size="lg" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/dashboards/row-click-search-drilldown.png" alt="Página Busca aberta na fonte de traces após um clique na linha, filtrada para o serviço clicado" size="lg" />
  </Step>
</Steps>
...
<Image img="/images/clickstack/dashboards/row-click-drawer.png" alt="Painel lateral de Row Click Action no modo Dashboard, com o dashboard Service Detail selecionado como destino e um filtro ServiceName gerado a partir da linha clicada" size="lg" />
