...
<Steps>
  ...
  <Step>
    ...
    * Alias: `Average Time`
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-2.png" alt="Visualização simples" size="lg" />
    ...
    <Image img="/images/use-cases/observability/clickstack-visualization-3.png" alt="Visualização simples 2" size="lg" />
...
<Image img="/images/clickstack/dashboards/number-tile-background-chart.png" alt="Painel Configurações de exibição de um tile Number, com Gráfico de fundo definido como Área" size="lg" />
