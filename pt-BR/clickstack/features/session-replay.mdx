...
<Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Visualização de pesquisa de replay de sessão" size="lg" />
...
<Image img="/images/clickstack/session-replay/session-replay.png" alt="Reprodução de replay de sessão" size="lg" />
...
<Frame>
  <img src="/images/clickstack/session-replay/clickpy-trace.gif" alt="Navegando de uma reprodução de sessão para traces de backend no ClickStack" />
</Frame>
...
<Image img="/images/clickstack/session-replay/trace-to-replay.png" alt="Visualização do trace na reprodução de sessão" size="lg" />
