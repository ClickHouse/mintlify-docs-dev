...
<Image img="/images/use-cases/observability/hyperdx-27.png" alt="Pesquisa" size="md" />
...
<Image img="/images/use-cases/observability/clickstack-saved-search-listing.png" alt="Página de listagem de pesquisas salvas" size="lg" />
...
<Image img="/images/use-cases/observability/clickstack-saved-search.png" alt="Salvando uma pesquisa" size="md" />
