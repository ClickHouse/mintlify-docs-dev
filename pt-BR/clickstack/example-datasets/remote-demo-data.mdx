...
<Steps>
  <Step>
    ...
    <Image img="/images/use-cases/observability/edit_connection.png" alt="Editar conexão" size="lg" />
    ...
    * `Password`: Deixe em branco
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/edit_demo_connection.png" alt="Editar conexão Demo" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/edit_demo_source.png" alt="Editar fonte Demo" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_2.png" alt="Etapa 2" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_3.png" alt="Passo 3" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_4.png" alt="Passo 4" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_5.png" alt="Passo 5" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_6.png" alt="Passo 6" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_7.png" alt="Etapa 7" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_8.png" alt="Passo 8" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_9.png" alt="Passo 9" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_10.png" alt="Etapa 10" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_11.png" alt="Etapa 11" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_12.png" alt="Etapa 12" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_13.png" alt="Etapa 13" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_14.png" alt="Etapa 14" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_15.png" alt="Etapa 15" size="lg" />

    Remova o filtro de erros e selecione `Event Deltas` no menu `Analysis Mode`, à esquerda.

    <Image img="/images/use-cases/observability/hyperdx-demo/step_16.png" alt="Etapa 16" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_17.png" alt="Etapa 17" size="lg" />
  ...
  <Step>
    ...
    * `Timespan`: `Last 1 day`
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_18.png" alt="Etapa 18" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_19.png" alt="Etapa 19" size="lg" />
  ...
  <Step>
    ...
    * `Group By`: `<empty>`
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_20.png" alt="Passo 20" size="lg" />
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_21.png" alt="Etapa 21" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_22.png" alt="Etapa 22" size="lg" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_23.png" alt="Passo 23" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-demo/step_24.png" alt="Passo 24" size="lg" />
  </Step>
</Steps>
