...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.png" alt="Aplicativo de demonstração de replay de sessão" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.png" alt="Busca de replay de sessão" />

    Você deverá ver sua sessão listada com a duração e a contagem de eventos. Clique no botão ▶️ para reproduzi-la.

    <Image img="/images/clickstack/session-replay/session-replay.png" alt="Replay de sessão" />
