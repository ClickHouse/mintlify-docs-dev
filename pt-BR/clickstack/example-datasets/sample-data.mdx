...
title: 'ClickStack - logs, traces e métricas de exemplo'
  ...
  <Tab title="ClickStack Gerenciado">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-10.png" alt="Busca do HyperDX" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-11.png" alt="Sessões" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-13.png" alt="Erro na sessão" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-14.png" alt="Trace da sessão" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-16.png" alt="Valores da coluna" size="lg" />
