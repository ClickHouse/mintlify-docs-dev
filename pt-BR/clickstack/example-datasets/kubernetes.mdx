...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-kubernetes-data.png" alt="Dados do Kubernetes no HyperDX" size="lg" />
  </Step>
...
<Image img="/images/use-cases/observability/hyperdx-dashboard-kubernetes.png" alt="ClickHouse no Kubernetes" size="lg" />