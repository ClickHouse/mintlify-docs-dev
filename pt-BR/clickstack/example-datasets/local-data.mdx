...
<Tabs>
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-20.png" alt="Logs locais do HyperDX" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memória ao longo do tempo" size="lg" />
        ...
        <Image img="/images/use-cases/observability/hyperdx-22.png" alt="Formato do número" size="lg" />

        No menu seguinte, você pode selecionar `Percentage` no menu suspenso `Output format` antes de clicar em `Apply`.

        <Image img="/images/use-cases/observability/hyperdx-23.png" alt="Memória % ao longo do tempo" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.png" alt="Memory com o passar do tempo" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-23.png" alt="% do tempo de memória" size="lg" />
  </Tab>
</Tabs>