...
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Elastic Stack](/pt-BR/clickstack/migration/elastic) | Guia completo para migrar do Elastic Stack para o ClickStack, cobrindo migração de dados, transição de agentes e recursos de busca |