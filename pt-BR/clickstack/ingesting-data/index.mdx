...
| [SDKs para linguagens](/pt-BR/clickstack/ingesting-data/sdks)                         | SDKs do ClickStack para instrumentar linguagens de programação e coletar dados de telemetria |