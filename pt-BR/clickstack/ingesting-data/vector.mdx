  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Abrir o ClickStack para o Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Logs do Nginx no ClickStack" size="lg" />
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="ClickStack open source">
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/play-ui-clickstack.png" alt="UI Play do ClickStack" size="lg" />
      ...
      <Step>
        ...
        <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Login do ClickStack" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/create-vector-datasource-oss.png" alt="Criar fonte de dados - vector" size="lg" />
  ...
  <Tab title="Managed ClickStack">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/launch-clickstack-vector.png" alt="Iniciar o ClickStack para o Vector" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/nginx-logs-vector-search.png" alt="Interface do HyperDX" size="lg" />
      </Step>
    </Steps>
  </Tab>
