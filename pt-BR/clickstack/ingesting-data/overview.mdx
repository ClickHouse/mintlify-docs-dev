...
<Tabs>
  <Tab title="Managed ClickStack">
    <Image img="/images/use-cases/observability/clickstack-managed-architecture-with-flow.png" alt="Arquitetura gerenciada com fluxo" size="md" />
  </Tab>

  <Tab title="Open Source ClickStack">
    <Image img="/images/use-cases/observability/clickstack-oss-architecture-with-flow.png" alt="Arquitetura simples com fluxo" size="md" />
  </Tab>
</Tabs>
