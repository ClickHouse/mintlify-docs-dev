...
<Image img="/images/clickstack/trace-sampling-source-settings.png" alt="Campo Expressão da taxa de amostragem nas Configurações da fonte do ClickStack" size="lg" />
