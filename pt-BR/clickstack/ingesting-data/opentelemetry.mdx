...
<Tabs>
  <Tab title="ClickStack Gerenciado">
    ...
    * **gRPC (OTLP):** `localhost:4317`
    ...
    Para [SDKs de linguagem](/pt-BR/clickstack/ingesting-data/sdks) e bibliotecas de telemetria compatíveis com OpenTelemetry, você pode simplesmente definir a variável de ambiente `OTEL_EXPORTER_OTLP_ENDPOINT` na sua aplicação:
