...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-log-view.png" alt="Visualização de logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.png" alt="Dashboard de exemplo" />
  </Step>
</Steps>
