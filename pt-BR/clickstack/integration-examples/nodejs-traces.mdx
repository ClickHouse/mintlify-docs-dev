...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Tela de busca de traces" />

    Clique em qualquer trace para ver a visualização detalhada com spans, duração e atributos:

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Visualização de trace individual" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.png" alt="Visualização Search de traces" />

    <Image img="/images/clickstack/nodejs/trace-view.png" alt="Visualização de um trace individual" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/finish-import.png" alt="Concluir importação" />
  </Step>

  <Step>
    #### O dashboard será criado com todas as visualizações pré-configuradas

    <Image img="/images/clickstack/nodejs/example-traces-dashboard.png" alt="Dashboard de exemplo" />
