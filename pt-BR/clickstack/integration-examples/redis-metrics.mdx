...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-redis-metrics-dashboard.png" alt="Caixa de diálogo para concluir a importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis-metrics-dashboard.png" alt="Dashboard de métricas do Redis" />
