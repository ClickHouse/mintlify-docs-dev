...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-search-view.png" alt="Visualização de logs" />

    <Image img="/images/clickstack/log-view.png" alt="Visualização de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-logs-import.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-logs-dashboard.png" alt="Dashboard de exemplo" />
  </Step>
</Steps>
