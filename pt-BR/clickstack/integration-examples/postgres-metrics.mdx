...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/import-dashboard.png" alt="Caixa de diálogo Finish Import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-metrics-dashboard.png" alt="Dashboard de métricas do PostgreSQL" />
