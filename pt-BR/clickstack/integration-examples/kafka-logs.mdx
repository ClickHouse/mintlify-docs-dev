...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/search-view.png" alt="Tela de pesquisa" />

    <Image img="/images/clickstack/kafka/logs/log-view.png" alt="Tela de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/finish-import.png" alt="Concluir a importação do dashboard de logs do Kafka" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/logs/example-dashboard.png" alt="Dashboard de exemplo de logs do Kafka" />
  </Step>
</Steps>
