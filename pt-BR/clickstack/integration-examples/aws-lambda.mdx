...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/lambda/lambda-log-view.png" alt="Visualização de logs do Lambda" />

    <Image img="/images/clickstack/lambda/lambda-log.png" alt="Detalhes do log do Lambda" />
