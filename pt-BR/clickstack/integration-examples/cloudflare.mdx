...
<Steps>
  ...
  <Step>
    ...
    * **Ordenação**: Ordem lexicográfica
    ...
    <Image img="/images/clickstack/cloudflare/continuous-ingestion.png" alt="Ingestão contínua" />
    ...
    **Mapeamento de esquema:**
    ...
    <Image img="/images/clickstack/cloudflare/parse-information.png" alt="Informações de parsing" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/add-source.png" alt="Adicionar fonte" />

    2. Clique em **Add source** e configure as seguintes opções. Clique em **Configure Optional Fields** para acessar todos os campos:

    <Image img="/images/clickstack/cloudflare/configure-optional-fields.png" alt="Configurar opcionais" />
    ...
    <Image img="/images/clickstack/cloudflare/save-source.png" alt="Salvar fonte" />
  ...
  <Step>
    ...
    * Atributos pesquisáveis, como `http.status_code`, `client.country`, `cache.status` e `bot.score`
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Tela de Busca" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Tela de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/search-view.png" alt="Visualização de Busca" />

    <Image img="/images/clickstack/cloudflare/log-view.png" alt="Visualização de logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudflare/example-dashboard.png" alt="Dashboard de exemplo" />
