...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view.png" alt="Tela de busca de logs do EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view.png" alt="Detalhes do log do EC2 mostrando metadados" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/ec2/search-view-demo.png" alt="Search view de logs da EC2" />

    <Image img="/images/clickstack/host-logs/ec2/log-view-demo.png" alt="detalhes do log da EC2 com metadados" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/pt-BR/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Baixar</TrackedLink> a configuração do dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/import-dashboard.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/host-logs/host-logs-dashboard.png" alt="Dashboard de logs do EC2" />
