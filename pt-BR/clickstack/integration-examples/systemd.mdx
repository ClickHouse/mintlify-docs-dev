...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/systemd/systemd-search-view.png" alt="Visualização de busca de logs" />

    <Image img="/images/clickstack/systemd/systemd-log-view.png" alt="Visualização de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botão de importação de dashboard" />

    3. Faça upload do arquivo `systemd-logs-dashboard.json` e clique em **Finish Import**

    <Image img="/images/clickstack/systemd/finish-import-systemd.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    * Taxas de erro
    ...
    <Image img="/images/clickstack/systemd/systemd-logs-dashboard.png" alt="Dashboard de exemplo" />
