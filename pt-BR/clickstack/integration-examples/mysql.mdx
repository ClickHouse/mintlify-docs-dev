...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="Visualização Busca" />

    <Image img="/images/clickstack/mysql/log-view.png" alt="Visualização de logs" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/search-view.png" alt="Tela de Busca" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botão de importação de painel" />

    3. Faça upload do arquivo `mysql-logs-dashboard.json` e clique em **Finish Import**

    <Image img="/images/clickstack/mysql/finish-import.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mysql/example-dashboard.png" alt="Painel de exemplo" />
