...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-import.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/jvm/jvm-metrics-dashboard.png" alt="Dashboard de métricas do Kafka" />
