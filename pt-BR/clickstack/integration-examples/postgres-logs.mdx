...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/postgres/postgres-logs-search-view.png" alt="Search view de logs" />
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botão de importar dashboard" />

    3. Faça upload do arquivo `postgresql-logs-dashboard.json` e clique em **Finish Import**

    <Image img="/images/clickstack/postgres/import-logs-dashboard.png" alt="Concluir importação" />
  </Step>
