...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics.png" alt="Métricas do Temporal" size="md" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/import-temporal-metrics-dashboard.png" alt="Caixa de diálogo para concluir a importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/temporal/temporal-metrics-dashboard.png" alt="Dashboard do Temporal Metrics" />
  </Step>
</Steps>
