...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/import-kafka-dashboard.png" alt="Caixa de diálogo Finish Import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/kafka/kafka-metrics-dashboard.png" alt="Dashboard de métricas do Kafka" />
