...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Visualização de pesquisa dos logs do MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Visualização detalhada dos logs do MongoDB" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/search-view.png" alt="Visualização de pesquisa de logs do MongoDB" />

    <Image img="/images/clickstack/mongodb/log-view.png" alt="Visualização detalhada do log do MongoDB" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/pt-BR/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">Baixar</TrackedLink> a configuração do dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Importar dashboard" />

    3. Faça upload do arquivo mongodb-logs-dashboard.json e clique em &quot;Finish Import&quot;.

    <Image img="/images/clickstack/mongodb/finish-import.png" alt="Concluir importação do dashboard de logs do MongoDB" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/mongodb/example-dashboard.png" alt="Dashboard de logs do MongoDB" />
  </Step>
</Steps>
