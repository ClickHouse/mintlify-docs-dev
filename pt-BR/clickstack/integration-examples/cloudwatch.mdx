...
<Steps>
  <Step>
    ...
    <Image img="/images/clickstack/api-key.png" alt="API key do ClickStack" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/log-search-view.png" alt="Visualização de pesquisa de logs" />
    ...
    * `Body`: O conteúdo da mensagem de log
    ...
    <Image img="/images/clickstack/cloudwatch/error-log-column-values.png" alt="Valores da coluna de logs de erro" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/demo-search-view.png" alt="Visualização de busca de demonstração" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/pt-BR/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Baixe</TrackedLink> a configuração do dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/import-dashboard.png" alt="Botão Import dashboard" />

    3. Faça upload do arquivo `cloudwatch-logs-dashboard.json` e clique em **Finish Import**

    <Image img="/images/clickstack/cloudwatch/finish-import.png" alt="Caixa de diálogo Finish import" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.png" alt="Dashboard do CloudWatch Logs" />
