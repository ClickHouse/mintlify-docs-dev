...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-search-view.png" alt="Ver traces" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'/pt-BR/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">Baixar</TrackedLink> a configuração do dashboard
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/finish-nginx-traces-dashboard.png" alt="Concluir importação" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nginx-traces-dashboard.png" alt="Dashboard de exemplo" />
  </Step>
</Steps>
