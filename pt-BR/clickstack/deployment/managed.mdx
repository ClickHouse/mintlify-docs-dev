  ...
  <Tab title="Crie um novo serviço">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/getting-started/new_service.png" size="lg" alt="Serviço" border />
      </Step>
  ...
  <Tab title="Use um serviço existente">
    ...
    <Steps>
      <Step>
        ...
        <Image img="/images/clickstack/select_service.png" alt="Selecionar serviço" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/getting-started/clickstack_managed_ui.png" size="lg" alt="UI do ClickStack" />
      ...
      <Step>
        ...
        <Image img="/images/clickstack/clickstack-ui-setup-ingestion.png" alt="Configuração da ingestão na UI do ClickStack" size="lg" />
        ...
        <Image img="/images/clickstack/select-source-clickstack-ui.png" size="lg" alt="Selecionar source - UI do ClickStack" border />
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/otel-collector-start-clickstack-ui.png" size="md" alt="Origem do OTel collector" />
            ...
            **Modifique este comando com as credenciais do seu serviço, anotadas quando você criou o serviço.**
            ...
            <Image img="/images/clickstack/advanced-otel-collector-clickstack-ui.png" size="lg" alt="Origem avançada do OTel collector" />
            ...
            Para instrumentar suas aplicações para coletar traces e logs, use os [SDKs de linguagem compatíveis](/pt-BR/clickstack/ingesting-data/sdks), que enviam dados para seu OpenTelemetry Collector, atuando como gateway para ingestão no Managed ClickStack.
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/vector-config-clickstack-ui.png" size="lg" alt="Configuração do Vector" />
      ...
      <Step>
        ...
        <Tabs>
          <Tab title="OpenTelemetry">
            ...
            <Image img="/images/clickstack/getting-started/clickstack_managed_ui.png" size="lg" alt="interface do ClickStack" />
          ...
          <Tab title="Vector">
            ...
            <Image img="/images/clickstack/create-vector-datasource.png" alt="Criar fonte de dados - Vector" size="lg" />
...
1. Navegue até seu serviço no console do ClickHouse Cloud
...
<Image img="/images/clickstack/read-only-access.png" alt="ClickHouse Cloud Somente Leitura" size="md" />

<Warning>
  **Alertas exigem acesso de administrador**

  Para habilitar alertas, pelo menos um usuário com permissões de **Service Admin** (mapeadas para **Full Access** no menu suspenso de Acesso ao SQL Console) precisa fazer login no HyperDX pelo menos uma vez. Isso provisiona um usuário dedicado no banco de dados para executar as consultas de alerta.
</Warning>
...
<Image img="/images/use-cases/observability/hyperdx_cloud_datasource.png" alt="Fonte de dados do HyperDX no ClickHouse Cloud" size="lg" />

Para criar fontes para traces e métricas do OTel, você pode selecionar `Criar Nova Fonte de Dados` no menu superior.

<Image img="/images/use-cases/observability/hyperdx_create_new_source.png" alt="ClickStack criar nova fonte de dados" size="lg" />
...
<Image img="/images/use-cases/observability/hyperdx_create_trace_datasource.png" alt="ClickStack criar fonte de traces" size="lg" />
