...
As opções de implantação estão resumidas abaixo. O [Guia de primeiros passos](/pt-BR/clickstack/getting-started) demonstra especificamente as opções 1 e 2. Elas foram incluídas aqui para fins de completude.
