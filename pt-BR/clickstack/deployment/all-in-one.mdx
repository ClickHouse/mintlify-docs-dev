...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/use-cases/observability/hyperdx-login.png" alt="Interface do HyperDX" size="lg" />
  ...
  <Step>
    ...
    Para ingerir dados, consulte [&quot;Ingerindo dados&quot;](/pt-BR/clickstack/ingesting-data).
  </Step>
</Steps>
