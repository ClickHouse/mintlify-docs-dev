  ...
  <Tab title="Docker">
    <Steps>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/authenticate.png" alt="Autenticar" size="lg" />
      </Step>
      ...
      <Step>
        ...
        <Image img="/images/clickstack/deployment/embedded/inferred-source.png" alt="Criar fonte" size="lg" />

        Se você ainda não tiver dados, consulte [Ingestão de dados](/pt-BR/clickstack/ingesting-data) para ver as opções disponíveis.
      </Step>
    </Steps>
  </Tab>
