...
<Image img="/images/clickstack/service-maps/service-map-overview.png" alt="Mapa de serviço mostrando nós de serviço e o fluxo de solicitações entre eles" size="lg" />
...
<Image img="/images/clickstack/service-maps/source-selector.png" alt="Seletor de fonte destacado na barra de ferramentas do mapa de serviço" size="lg" />
...
<Image img="/images/clickstack/service-maps/sampling.png" alt="Controle deslizante de sampling destacado na barra de ferramentas do mapa de serviço" size="lg" />

**Seletor de intervalo de datas** — defina a janela de tempo dos dados de trace usados para criar o mapa.

<Image img="/images/clickstack/service-maps/date-selector.png" alt="Seletor de intervalo de datas destacado na barra de ferramentas do mapa de serviço" size="lg" />
