...
<Tabs>
  <Tab title="ClickStack gerenciado">
    ...
    <Image img="/images/use-cases/observability/clickstack-managed-architecture.png" alt="Arquitetura gerenciada" size="lg" />
  ...
  <Tab title="Open Source ClickStack">
    ...
    <Image img="/images/use-cases/observability/clickstack-oss-architecture.png" alt="Arquitetura" size="lg" />
