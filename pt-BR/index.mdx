...
<style>
  {`
          ...
          /* Oculta a barra lateral imediatamente na página inicial (evita o efeito de piscada) */
          ...
          #navbar-transition-maple {
            ...
            /* Corresponde ao padding direito da própria barra de navegação (3rem) */
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <HeroCard
          ...
          { label: "Kubernetes operator", href: "/products/kubernetes-operator/overview" },
      ]}
        />
      </div>
    ...
    { label: "Dicas para manter os custos baixos sem comprometer o desempenho", href: "/concepts/best-practices/index" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plataforma de engenharia de LLM de código aberto para observabilidade, métricas, avaliações e gerenciamento de prompts." href="https://langfuse.com/docs" showArrow external />
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Adicione skills do ClickHouse ao seu agente de código</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Instale as skills do ClickHouse para dar ao seu agente conhecimento especializado sobre ClickHouse e boas práticas.</p>
