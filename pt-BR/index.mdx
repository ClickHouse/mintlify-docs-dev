...
export const HeroCard = ({ filename, darkFilename: darkFilenameProp, title, description, body, href, links, icon, showArrow, arrowBottom, extraStyle, logo, logoInvert, overlayImg, fullWidthImage, imageHeight = 'h-48' }) => {
                ...
                <ul className="mt-6 list-none p-0">
                    {links.map((link, index) => (
                        <li key={index} className={index > 0 ? 'mt-2' : 'mt-0'}>
                            <a href={withBase(link.href)} onClick={(e) => { e.preventDefault(); window.location.href = withBase(link.href); }} className="goal-card-link flex items-center justify-between text-[#374151] dark:text-[#FCFF74] text-sm font-medium no-underline gap-1">
    ...
    return <a className={cardClassName} href={withBase(href)} style={extraStyle} onClick={(e) => { e.preventDefault(); window.location.href = withBase(href); }}>{content}</a>;
};
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        links={[
            ...
            { label: "Instalação", href: "/get-started/setup/cloud" },
            { label: "Guias de início rápido", href: "/get-started/quickstarts/home" },
            { label: "Conceitos do ClickHouse", href: "/concepts/core-concepts/index" },
      ...
      <HeroCard
        ...
        links={[
            { label: "Modelagem de dados", href: "/guides/clickhouse/data-modelling/schema-design" },
            { label: "Otimização de desempenho", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
            { label: "ClickHouse Cloud", href: "/products/cloud/guides" },
            { label: "Casos de uso", href: "/guides/use-cases" }
        ]}
      />
      ...
      <HeroCard
        ...
        links={[
            ...
            { label: "Settings", href: "/reference/settings/index" },
