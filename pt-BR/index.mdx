...
export const HeroCard = ({ filename, darkFilename: darkFilenameProp, title, description, body, href, links, icon, showArrow, arrowBottom, extraStyle, logo, logoInvert, overlayImg, fullWidthImage, imageHeight = 'h-48' }) => {
                ...
                <div className={`${overlayImg ? 'relative mb-12' : ''}${fullWidthImage ? ' -mx-4 -mt-4' : ''}`}>
                    ...
                    {overlayImg && (
                        <img
                            ...
                            alt=""
                            className="absolute right-4 bottom-0 translate-y-[40%] w-[46%] rounded-xl pointer-events-none z-20"
                ...
                <ul className="mt-6 list-none p-0">
                    {links.map((link, index) => (
                        <li key={index} className={index > 0 ? 'mt-2' : 'mt-0'}>
                            <a href={link.href} onClick={(e) => { e.preventDefault(); window.location.href = link.href; }} className="goal-card-link flex items-center justify-between text-[#374151] dark:text-[#FCFF74] text-sm font-medium no-underline gap-1">
    ...
    return <a className={cardClassName} href={href} style={extraStyle} onClick={(e) => { e.preventDefault(); window.location.href = href; }}>{content}</a>;
};
...
export const McpSetup = () => {
  ...
  "mcpServers": {
    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon={`${assetBase}/images/logo-claudecode-color.svg`}>
            ...
            <Tab title="Claude Desktop" icon={`${assetBase}/images/logo-claude.svg`}>
            ...
            <Tab title="Cursor" icon={`${assetBase}/images/logo-cursor.png`}>
                <p className="mb-2 text-[#9ca3af] text-[13px]">Add to <code>.cursor/mcp.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon={`${assetBase}/images/logo-windsurf.svg`}>
...
<style>
  {`
            ...
            #navbar-transition-maple {
              ...
              /* Corresponde ao preenchimento à direita da própria barra de navegação (3rem) */
...
<div className="relative">
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    <h1 className="block text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      Comece a desenvolver com <HighlightedClickHouse />
    </h1>

    <div className="mx-auto px-4 -mt-5 text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      Documentação do banco de dados analítico mais rápido
    </div>

    <div className="flex items-center justify-center gap-3 mx-auto mt-8">
      <button type="button" id="home-search-entry" className="flex pointer-events-auto items-center text-sm leading-6 h-9 pl-3.5 pr-3 text-gray-500 dark:text-white/50 dark:brightness-[1.1] dark:hover:brightness-[1.25] justify-between truncate gap-2 min-w-[43px] w-[320px] bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 shadow-none border border-white/10 ring-0 dark:ring-0 rounded" aria-label="Abrir busca">
        <div className="flex items-center gap-2 min-w-[42px]"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-search min-w-4 flex-none text-gray-700 hover:text-gray-800 dark:text-gray-400 hover:dark:text-gray-200"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg><div className="truncate min-w-0">Pesquisar...</div></div>
        <span className="flex-none text-xs font-semibold">⌘K</span>
      </button>

      <button type="button" className="flex-none hidden lg:flex items-center justify-center gap-1.5 pl-3 pr-3.5 h-9 shadow-none bg-gray-950/[0.03] dark:bg-white/[0.03] hover:bg-gray-950/10 dark:hover:bg-white/10 border border-white/10 rounded" id="home-assistant-entry" aria-label="Abrir Ask AI" onClick={() => {
    ...
    <div className="flex items-center justify-center gap-2 my-6 text-xs">
      ...
      <a className="inline-flex items-center gap-1.5 text-gray-500 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-[#fdff75] transition-colors font-normal no-underline" href="/pt-BR/get-started/quickstarts/create-your-first-service-on-cloud">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        description="Sou novo aqui e quero começar e aprender mais"
        icon={
        ...
        links={[
            { label: "O que é ClickHouse?", href: "/get-started/about/intro" },
            { label: "Configuração/instalação", href: "/get-started/setup/cloud" },
            { label: "Explore os guias de início rápido", href: "/get-started/quickstarts/home" },
            { label: "Guias de migração", href: "/get-started/migrate/overview" },
            { label: "Fundamentos do ClickHouse", href: "/concepts/core-concepts/index" },
            { label: "Conceitos (recursos)", href: "/concepts/features/index" },
            { label: "Boas práticas", href: "/concepts/best-practices/index" },
            { label: "Conjuntos de dados de exemplo", href: "/get-started/sample-datasets/index" }
        ]}
      />
      ...
      <HeroCard
        ...
        links={[
            { label: "Tópicos sobre modelagem de dados", href: "/guides/clickhouse/data-modelling/schema-design" },
            { label: "Desempenho e otimização", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
            { label: "Tópicos do ClickHouse Cloud", href: "/products/cloud/guides" },
            { label: "Guias de casos de uso", href: "/guides/use-cases" },
        ]}
      />

      <HeroCard
        title="Referência"
        description="Sei o que quero fazer - só preciso dos detalhes"
        icon={
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
      ...
      <HeroCard
        ...
        description="Quero explorar as soluções do ClickHouse"
        icon={
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
      <HeroCard title="Analytics em tempo real" description="Obtenha insights instantâneos e dashboards em escala. Analise bilhões de linhas em tempo real com resultados em milissegundos." href="/pt-BR/get-started/use-cases/real-time-analytics" showArrow />

      <HeroCard title="Observabilidade" description="Armazene e consulte logs, métricas e traces em escala usando o ClickStack, a stack open source de observabilidade baseada em ClickHouse." href="/pt-BR/clickstack/overview" showArrow />

      <HeroCard title="Armazenamento de dados" description="Analise e explore dados instantaneamente para obter insights e criar aplicativos. Escale mais rápido ao descarregar cargas de trabalho pesadas." href="/pt-BR/get-started/use-cases/data-warehousing" showArrow />

      <HeroCard title="Analytics com agentes de IA" description="Permita que agentes de IA consultem diretamente seus dados em tempo real para fornecer insights instantâneos, conversacionais, e visualizações" href="/pt-BR/get-started/use-cases/agentic-analytics" showArrow />
    </div>

    <FullWidthDivider style={{ margin: '40px 0 40px' }} />

    <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">Explore por produto</h2>
    <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Navegue pelos produtos e integrações do ClickHouse, do serviço Cloud gerenciado a projetos open source.</p>

    <div className="space-y-4 mt-6">
      {/* Linha 1: ClickHouse Cloud (col-span-2) + 3 cards empilhados (col-span-1) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        <div className="col-span-2">
          <HeroCard
            ...
            href="/pt-BR/products/cloud/getting-started/intro"
            extraStyle={{ height: '100%' }}
            body={<>
        <p className="text-[#6b7280] dark:text-[#a1a1aa] mt-2 text-sm leading-[1.6]">
            Esta seção mostra como o ClickHouse torna o armazenamento de dados rápido, simples e previsível. Em vez de lidar com pipelines frágeis e motores de consulta lentos, você centraliza os dados dos seus aplicativos, serviços e ferramentas em minutos, não em semanas. A partir daí, você pode alimentar dashboards em tempo real, disparar alertas, analisar tendências históricas e criar produtos orientados por eventos na mesma plataforma.
        </p>
    </>}
            links={[
        { label: "Como fazer a ingestão de dados de fontes comuns com o mínimo de esforço", href: "/integrations" },
        { label: "Boas práticas para organizar dados para analytics e crescimento", href: "/guides/clickhouse/data-modelling/schema-design" },
        { label: "Formas de consultar grandes conjuntos de dados em tempo real", href: "/get-started/use-cases/real-time-analytics" },
        { label: "Como criar dashboards, alertas e funcionalidades orientadas por eventos na plataforma", href: "/get-started/use-cases/data-warehousing" },
        { label: "Dicas para manter os custos baixos sem comprometer o desempenho", href: "/concepts/best-practices/index" },
    ]}
          />
        </div>

        <div className="flex flex-col gap-4">
          <HeroCard logo="logo-ch.svg" logoInvert title="ClickStack" description="A stack de observabilidade tudo em um com tecnologia ClickHouse, que oferece consultas extremamente rápidas e agregações poderosas em logs, métricas, traces, session replays e erros." href="/pt-BR/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard logo="logo-postgres.svg" title="Managed Postgres" description="Serviço Postgres rápido, escalável e de nível empresarial, integrado nativamente ao ClickHouse. Combine facilmente o Postgres para transações e o ClickHouse para analytics." href="/pt-BR/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard logo="logo-integration.svg" logoInvert title="Integrações" description="Mais de 100 integrações para conectar as ferramentas e os serviços que você adora ao ClickHouse." href="/pt-BR/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="thumbnail-langfuse-light.png" title="LangFuse" description="Plataforma de engenharia de LLM de código aberto para observabilidade, métricas, avaliações e gerenciamento de prompts." href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="thumbnail-kubernetes-light.png" title="Operator para Kubernetes" description="Automatiza a implantação, a configuração e o gerenciamento de clusters do ClickHouse e ClickHouse Keeper no Kubernetes." href="/pt-BR/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="thumbnail-chdb-light.png" title="chDB" description="Um banco de dados in-process rápido, confiável e escalável. Experimente o poder do ClickHouse in-process." href="/pt-BR/products/chdb/index" showArrow />
      </div>
    </div>
    ...
    <div id="mcp-setup" className="mt-16 scroll-mt-20">
      <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">Configure o servidor MCP da documentação</h2>
      <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Consulte diretamente a documentação do ClickHouse nas suas ferramentas de IA usando o Model Context Protocol.</p>
