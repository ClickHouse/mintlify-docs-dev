    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          <HeroCard title="ClickStack" description="A stack de observabilidade tudo em um com tecnologia ClickHouse, que oferece consultas extremamente rápidas e agregações poderosas em logs, métricas, traces, session replays e erros." href="/pt-BR/clickstack/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Managed Postgres" description="Serviço Postgres rápido, escalável e de nível empresarial, integrado nativamente ao ClickHouse. Combine facilmente o Postgres para transações e o ClickHouse para analytics." href="/pt-BR/products/managed-postgres/overview" extraStyle={{ flex: 1 }} showArrow arrowBottom />

          <HeroCard title="Integrações" description="Mais de 100 integrações para conectar as ferramentas e os serviços que você adora ao ClickHouse." href="/pt-BR/integrations/home" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
