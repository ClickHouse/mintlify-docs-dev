        ...
        <div className="col-span-2">
          <HeroCard
            ...
            links={[
                ...
                { label: "Boas práticas para organizar dados para analytics e crescimento", href: "/data-modeling/schema-design" },
                ...
                { label: "Dicas para manter os custos baixos sem comprometer o desempenho", href: "/operations/best-practices" },
            ]}
          />
        </div>
