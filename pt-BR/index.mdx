...
export const HeroCard = ({ filename, darkFilename: darkFilenameProp, title, description, body, href, links, icon, showArrow, arrowBottom, extraStyle }) => {
    ...
    const content = (
        <>
            ...
            {body ? body : (
                <span className="text-[#6b7280] dark:text-[#a1a1aa] line-clamp-2 mt-2 text-sm font-normal leading-normal h-[42px]">{description}</span>
            )}
  ...
  <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
      <HeroCard
        ...
        description="Sou novo aqui, quero começar ou explorar a documentação do ClickHouse"
        icon={
      ...
      <HeroCard
        title="Guias"
        description="Quero aprender a usar os recursos do ClickHouse ou explorar tópicos avançados"
        icon={
        ...
        links={[
          ...
          { label: "Performance and query optimization", href: "/guides/clickhouse/performance-and-monitoring/query-optimization" },
      ...
      <HeroCard
        ...
        description="Faça a ingestão de logs, métricas e traces para monitorar sistemas e alimentar dashboards de observabilidade"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
    ...
    <div className="space-y-4 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4">
          ...
          <HeroCard title="chDB" description="Um banco de dados em processo rápido, confiável e escalável. Experimente o poder do ClickHouse em processo." href="/pt-BR/products/chdb" extraStyle={{ flex: 1 }} showArrow arrowBottom />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <HeroCard filename="product-langfuse-light.png" title="LangFuse" description="Plataforma de engenharia de LLM de código aberto para observabilidade, métricas, avaliações e gerenciamento de prompts." href="https://langfuse.com/docs" showArrow />

        <HeroCard filename="product-cloud-light.png" title="Operator para Kubernetes" description="Automatiza a implantação, a configuração e o gerenciamento de clusters do ClickHouse e ClickHouse Keeper no Kubernetes." href="/pt-BR/products/kubernetes-operator/overview" showArrow />

        <HeroCard filename="product-chdb-light.png" title="chDB" description="Um banco de dados in-process rápido, confiável e escalável. Experimente o poder do ClickHouse in-process." href="/pt-BR/products/chdb" showArrow />
      </div>
    </div>
